...
url: https://skills.sh/borghei/claude-skills/product-designer
---

# product-designer

skills/borghei/claude-skills/product-designer
product-designer
Installation
...
Provides design token system (color, typography, spacing), component structure with variants and states, and accessibility foundations (4.5:1 contrast, focus indicators, screen reader support)
