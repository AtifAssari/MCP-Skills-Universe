---
title: create-team
url: https://skills.sh/pjt222/development-guides/create-team
---

# create-team

skills/pjt222/development-guides/create-team
create-team
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill create-team
SKILL.md
Create a New Team
...
YAML frontmatter: name, description, lead, version ("1.0.0"), author, created, updated, tags, coordination, members[] (each with id, role, responsibilities)
Title: # Team Name (human-readable, title case)
...
Find the team file at teams/<team-name>.md
Identify the lead and members
Follow the coordination pattern described in the file
