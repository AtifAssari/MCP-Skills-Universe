---
rating: ⭐⭐⭐
title: agent-project-board-sync
url: https://skills.sh/ruvnet/ruflo/agent-project-board-sync
---

# agent-project-board-sync

skills/ruvnet/ruflo/agent-project-board-sync
agent-project-board-sync
Installation
$ npx skills add https://github.com/ruvnet/ruflo --skill agent-project-board-sync
SKILL.md
