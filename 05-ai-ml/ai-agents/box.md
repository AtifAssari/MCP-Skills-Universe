---
title: box
url: https://skills.sh/box/box-for-ai/box
---

# box

skills/box/box-for-ai/box
box
Installation
...
Read the reference for the selected tool (references/mcp-tool-patterns.md for MCP, references/box-cli.md for CLI, references/rest-calls.md for direct REST fallback) and the domain reference from the routing table:
