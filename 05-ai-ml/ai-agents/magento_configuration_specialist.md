---
rating: ⭐⭐
title: magento-configuration-specialist
url: https://skills.sh/maxnorm/magento2-agent-skills/magento-configuration-specialist
---

# magento-configuration-specialist

skills/maxnorm/magento2-agent-skills/magento-configuration-specialist
magento-configuration-specialist
Installation
$ npx skills add https://github.com/maxnorm/magento2-agent-skills --skill magento-configuration-specialist
SKILL.md
Magento 2 Configuration Specialist
