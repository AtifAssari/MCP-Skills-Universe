---
rating: ⭐⭐⭐
title: subagents-creator
url: https://skills.sh/mineru98/skills-store/subagents-creator
---
...
subagents-creator
Installation
$ npx skills add https://github.com/mineru98/skills-store --skill subagents-creator
SKILL.md
Subagents Creator
...
Background everything: Use background_task for explore and librarian
Explicit tool lists: Prevent subagents from using unauthorized tools
