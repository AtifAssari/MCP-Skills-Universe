...
url: https://skills.sh/shihyuho/skills/writing-agents-md
---

# writing-agents-md

skills/shihyuho/skills/writing-agents-md
writing-agents-md
Installation
$ npx skills add https://github.com/shihyuho/skills --skill writing-agents-md
SKILL.md
Writing Agents MD
Overview
...
If AGENTS.md or CLAUDE.md already exists, read it only after that analysis as historical input, not as the source of truth. If it conflicts with what the repo shows, trust the repo.
Classify each item as keep, rewrite, delete, move-to-skill, or stale.
