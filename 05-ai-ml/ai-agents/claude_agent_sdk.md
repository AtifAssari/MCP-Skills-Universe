...
url: https://skills.sh/basher83/lunar-claude/claude-agent-sdk
---

# claude-agent-sdk

skills/basher83/lunar-claude/claude-agent-sdk
claude-agent-sdk
Installation
...
Next Steps
For Beginners
Start with examples/quick_start.py - Learn basic query() usage
Try assets/sdk-template.py - Template for new projects
Review examples/basic-orchestrator.py - See orchestrator pattern
