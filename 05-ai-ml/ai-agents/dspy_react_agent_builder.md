---
title: dspy-react-agent-builder
url: https://skills.sh/omidzamani/dspy-skills/dspy-react-agent-builder
---

# dspy-react-agent-builder

skills/omidzamani/dspy-skills/dspy-react-agent-builder
dspy-react-agent-builder
Installation
...
Limit iterations - Set reasonable max_iters to prevent infinite loops (default is 20, but 5-10 often sufficient for simpler tasks)
Limitations
