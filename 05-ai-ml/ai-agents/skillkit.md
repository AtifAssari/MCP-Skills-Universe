---
title: skillkit
url: https://skills.sh/rfxlamia/claude-skillkit/skillkit
---

# skillkit

skills/rfxlamia/claude-skillkit/skillkit
skillkit
Installation
...
Explicit flag: --mode fast or --mode full
Skill marker: .skillkit-mode file content
If unknown: stop and ask user to choose fast or full
...
Validate skill — structure + security + tokens (validate_skill.py, no flags needed)
...
Run decision_helper.py with json file.
