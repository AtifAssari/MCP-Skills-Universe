...
url: https://skills.sh/rysweet/amplihack/investigation-workflow
---

# investigation-workflow

skills/rysweet/amplihack/investigation-workflow
investigation-workflow
Installation
...
Use investigation findings from memory (via get_recent_discoveries()) and session logs to inform design decisions
...
Edit ~/.amplihack/.claude/workflow/INVESTIGATION_WORKFLOW.md to modify, add, or remove phases
Adjust agent deployment strategies for your needs
