...
url: https://skills.sh/francyjglisboa/agent-skill-creator/agent-skill-creator
---

# agent-skill-creator

skills/francyjglisboa/agent-skill-creator/agent-skill-creator
agent-skill-creator
Installation
$ npx skills add https://github.com/francyjglisboa/agent-skill-creator --skill agent-skill-creator
Summary

Generate production-ready agent skills from workflow descriptions, transcripts, code, and documentation without requiring users to write specifications or code.

Activates on natural language triggers like "create a skill for," "automate this workflow," "every day I have to," or explicit /agent-skill-creator invocation; supports single skills, multi-agent suites, transcript processing, and template-based creation
Operates in two stages: discovery and specification (reading all provided material to uncover implicit requirements), then autonomous implementation (building complete, validated, cross-platform skills with no placeholders or TODOs)
Generates self-contained, installable skills that work identically across 20+ platforms (Claude Code, GitHub Copilot, Cursor, Windsurf, Cline, VS Code Copilot, and others) using the Agent Skills Open Standard
Includes automated validation, security scanning, platform detection for auto-install, team registry setup, and one-liner sharing for colleagues; optionally publishes to GitHub or GitLab with topic tagging for organizational discovery
SKILL.md
