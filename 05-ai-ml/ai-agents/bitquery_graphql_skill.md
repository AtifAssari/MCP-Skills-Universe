---
rating: ⭐⭐
title: bitquery-graphql-skill
url: https://skills.sh/holon-run/uxc/bitquery-graphql-skill
---

# bitquery-graphql-skill

skills/holon-run/uxc/bitquery-graphql-skill
bitquery-graphql-skill
Installation
$ npx skills add https://github.com/holon-run/uxc --skill bitquery-graphql-skill
SKILL.md
Bitquery GraphQL Skill
...
amounts
timestamps
Narrow with GraphQL arguments inside _select:
limit
orderBy
where
