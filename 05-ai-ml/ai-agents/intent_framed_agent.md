---
rating: ⭐⭐⭐
title: intent-framed-agent
url: https://skills.sh/pskoett/pskoett-ai-skills/intent-framed-agent
---

# intent-framed-agent

skills/pskoett/pskoett-ai-skills/intent-framed-agent
intent-framed-agent
Installation
...
If user changes direction mid-task, resolve current intent as Abandoned or Pivoted, then open a new frame.
