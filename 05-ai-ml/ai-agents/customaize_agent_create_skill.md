---
rating: ⭐⭐⭐⭐⭐
title: customaize-agent:create-skill
url: https://skills.sh/neolabhq/context-engineering-kit/customaize-agent:create-skill
---

# customaize-agent:create-skill

skills/neolabhq/context-engineering-kit/customaize-agent:create-skill
customaize-agent:create-skill
Installation
...
Create the skill folder: mkdir -p skills/<skill-name>
...
Add resource subdirectories only if needed:
...
Frontmatter — YAML contains only name and description (max 1024 chars total)
Name — uses only letters, numbers, and hyphens
Description — starts with "Use when...", written in third person, includes specific triggers
Structure — SKILL.md exists at skills/<skill-name>/SKILL.md
Resources — any referenced scripts, references, or assets exist at their declared paths
Step 6: Iterate
