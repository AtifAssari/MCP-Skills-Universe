---
rating: ⭐⭐⭐
title: subagent-driven
url: https://skills.sh/sipengxie2024/superpower-planning/subagent-driven
---

# subagent-driven

skills/sipengxie2024/superpower-planning/subagent-driven
subagent-driven
Installation
...
Spec Compliance Review — Dispatch ./spec-reviewer-prompt.md subagent
Code Quality Review — Dispatch ./quality-reviewer-prompt.md subagent (only after spec review passes)
...
Read the agent's .planning/agents/{role}/findings.md and progress.md
Extract items marked with > **Critical for Orchestrator:** plus any errors and test results
Append extracted items to top-level .planning/findings.md under a task heading
Update top-level .planning/progress.md:
