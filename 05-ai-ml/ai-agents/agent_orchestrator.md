...
url: https://skills.sh/mrclrchtr/skills/agent-orchestrator
---

# agent-orchestrator

skills/mrclrchtr/skills/agent-orchestrator
agent-orchestrator
Installation
$ npx skills add https://github.com/mrclrchtr/skills --skill agent-orchestrator
SKILL.md
Agent Orchestrator
Overview
