...
url: https://skills.sh/oocx/tfplan2md/create-agent-skill
---

# create-agent-skill

skills/oocx/tfplan2md/create-agent-skill
create-agent-skill
Installation
$ npx skills add https://github.com/oocx/tfplan2md --skill create-agent-skill
SKILL.md
Create Agent Skill
Purpose
