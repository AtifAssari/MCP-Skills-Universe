---
rating: ⭐⭐
title: forge-setup-project
url: https://skills.sh/mgratzer/forge/forge-setup-project
---

# forge-setup-project

skills/mgratzer/forge/forge-setup-project
forge-setup-project
Installation
...
Core principles — "What 3-5 rules should always guide development?" Offer examples from what you observed.
Failure modes — "What mistakes do agents or new developers repeat? What breaks?" Each entry must trace to an observed mistake.
Domain invariants — "What rules must never be violated? What causes silent bugs?"

Ask only if ambiguous from code:

Conventions with enforcement mechanisms
Confirm detected commands if multiple options exist
How to handle existing meta files (if found without AGENTS.md)
