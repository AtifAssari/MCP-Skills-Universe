---
title: codex
url: https://skills.sh/longranger2/claude-gpt-workflow/codex
---

# codex

skills/longranger2/claude-gpt-workflow/codex
codex
Installation
...
Run the script with a clear, concise task description. Tell CodeX the goal and constraints, not step-by-step implementation details — it figures those out itself. For discussion, use a question-oriented task with --read-only.
Pass relevant files with --file (2-6 high-signal entry points; CodeX has full workspace access and will discover related files on its own).
