---
title: writing-evals
url: https://skills.sh/axiomhq/skills/writing-evals
---

# writing-evals

skills/axiomhq/skills/writing-evals
writing-evals
Installation
...
Step 4: Generate
Create the .eval.ts file colocated next to the source file
...
If flags exist, use pickFlags to scope them
...
Workflow
Initialize: scripts/eval-init to create app-scope + config
Scaffold: scripts/eval-scaffold <type> <capability> [step]
