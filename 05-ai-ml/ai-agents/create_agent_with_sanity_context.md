---
rating: ⭐⭐
title: create-agent-with-sanity-context
url: https://skills.sh/sanity-io/agent-context/create-agent-with-sanity-context
---

# create-agent-with-sanity-context

skills/sanity-io/agent-context/create-agent-with-sanity-context
create-agent-with-sanity-context
Installation
...
Tools not appearing
Check that mcpClient.tools() returns tools (log it)
