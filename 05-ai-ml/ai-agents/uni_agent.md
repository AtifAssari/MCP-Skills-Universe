...
rating: ⭐⭐⭐
title: uni-agent
url: https://skills.sh/zrt-ai-lab/opencode-skills/uni-agent
---

# uni-agent

skills/zrt-ai-lab/opencode-skills/uni-agent
uni-agent
Installation
...
扩展新协议
创建适配器文件 adapters/new_protocol.py
继承 ProtocolAdapter 基类
实现 connect、call、discover、close 方法
在 adapters/__init__.py 注册
