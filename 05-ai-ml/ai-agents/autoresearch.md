---
title: autoresearch
url: https://skills.sh/olelehmann100kmrr/autoresearch-skill/autoresearch
---

# autoresearch

skills/olelehmann100kmrr/autoresearch-skill/autoresearch
autoresearch
Installation
$ npx skills add https://github.com/olelehmann100kmrr/autoresearch-skill --skill autoresearch
SKILL.md
...
Create a working directory: autoresearch-[skill-name]/ inside the skill's folder
Create results.tsv with the header row
Create results.json and dashboard.html, then open the dashboard in the browser
Back up the original SKILL.md as SKILL.md.baseline
Run the skill [N] times using the test inputs
...
Score summary: Baseline score → Final score (percent improvement)
...
The improved SKILL.md (already saved in place)
Location of results.tsv and changelog.md for reference
output format
...
Kept a complete log — every experiment recorded, kept or discarded
