...
url: https://skills.sh/spm1001/claude-suite/server-checkup
---

# server-checkup

skills/spm1001/claude-suite/server-checkup
server-checkup
Installation
$ npx skills add https://github.com/spm1001/claude-suite --skill server-checkup
SKILL.md
Server Maintenance
...
Security Impact: Does this expose the system?
Blast Radius: Local vs network vs internet exposure?
Exploit Difficulty: Easy (remote) vs Hard (local only)?
