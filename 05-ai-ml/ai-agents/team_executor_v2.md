---
title: team-executor-v2
url: https://skills.sh/catlog22/claude-code-workflow/team-executor-v2
---

# team-executor-v2

skills/catlog22/claude-code-workflow/team-executor-v2
team-executor-v2
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill team-executor-v2
SKILL.md
Team Executor v2
...
Keep Active	Update session status="paused" -> output: "Resume with: Skill(skill='team-executor', args='--session=')"
