---
title: alibabacloud-das-agent
url: https://skills.sh/aliyun/alibabacloud-aiops-skills/alibabacloud-das-agent
---

# alibabacloud-das-agent

skills/aliyun/alibabacloud-aiops-skills/alibabacloud-das-agent
alibabacloud-das-agent
Installation
...
Instance enrollment: The target database instance must be enrolled under the DAS Agent. If you see error code -1810006, it means the agent is not associated with any instance — guide the user to the DAS console settings to associate instances.

Include instance ID in questions: DAS Agent resolves instances by ID (e.g., rm-bp1xxx, pc-2zeyyy). Always include the specific instance ID in the question for accurate results. If the user hasn't provided one, ask them or first query the instance list.
