---
title: ccbox-insights
url: https://skills.sh/diskd-ai/ccbox/ccbox-insights
---

# ccbox-insights

skills/diskd-ai/ccbox/ccbox-insights
ccbox-insights
Installation
$ npx skills add https://github.com/diskd-ai/ccbox --skill ccbox-insights
SKILL.md
ccbox-insights
...
Inspect the latest session timeline (increase --limit if needed):
