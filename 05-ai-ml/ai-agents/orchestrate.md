---
title: orchestrate
url: https://skills.sh/hyperb1iss/hyperskills/orchestrate
---

# orchestrate

skills/hyperb1iss/hyperskills/orchestrate
orchestrate
Installation
...
No agent should run git add . -- only specific files
Monitor with git log --oneline -20 periodically
No agent should push -- orchestrator handles push after integration
