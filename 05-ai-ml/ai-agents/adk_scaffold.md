...
rating: ⭐⭐⭐
title: adk-scaffold
url: https://skills.sh/google/adk-docs/adk-scaffold
---

# adk-scaffold

skills/google/adk-docs/adk-scaffold
adk-scaffold
Installation
...
Create temp project: uvx agent-starter-pack create /tmp/ref --agent adk --deployment-target cloud_run -y
...
uvx agent-starter-pack create my-a2a-agent --agent adk_a2a --deployment-target cloud_run --prototype -y Result: Valid A2A imports and Dockerfile — no manual A2A code written.
Troubleshooting
