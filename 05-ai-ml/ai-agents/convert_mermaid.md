---
title: convert-mermaid
url: https://skills.sh/richfrem/agent-plugins-skills/convert-mermaid
---

# convert-mermaid

skills/richfrem/agent-plugins-skills/convert-mermaid
convert-mermaid
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill convert-mermaid
SKILL.md
Dependencies
