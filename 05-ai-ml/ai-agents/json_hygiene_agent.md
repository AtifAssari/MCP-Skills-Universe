---
rating: ⭐⭐
title: json-hygiene-agent
url: https://skills.sh/richfrem/agent-plugins-skills/json-hygiene-agent
---

# json-hygiene-agent

skills/richfrem/agent-plugins-skills/json-hygiene-agent
json-hygiene-agent
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill json-hygiene-agent
SKILL.md
