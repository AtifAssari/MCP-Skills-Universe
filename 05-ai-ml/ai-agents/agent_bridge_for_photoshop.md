---
rating: ⭐⭐
title: agent-bridge-for-photoshop
url: https://skills.sh/site/agent-bridge-for-photoshop.jaredverdi.com/agent-bridge-for-photoshop
---

# agent-bridge-for-photoshop

skills/agent-bridge-for-photoshop.jaredverdi.com/agent-bridge-for-photoshop
agent-bridge-for-photoshop
...
Start psagent mcp-serve in a terminal
Agent client connects via JSON-RPC over stdio
Call tools in order:
