...
url: https://skills.sh/sipengxie2024/superpower-planning/planning-foundation
---

# planning-foundation

skills/sipengxie2024/superpower-planning/planning-foundation
planning-foundation
Installation
...
Create .planning/ directory with init script or manually
Create progress.md — Use templates/progress.md (includes Task Status Dashboard)
