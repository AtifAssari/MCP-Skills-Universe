...
url: https://skills.sh/github/awesome-copilot/entra-agent-user
---

# entra-agent-user

skills/github/awesome-copilot/entra-agent-user
entra-agent-user
Installation
...
agentUser resource type (Graph API)
Create agentUser (Graph API)
Weekly Installs
8.3K
Repository
