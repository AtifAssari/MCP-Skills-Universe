---
rating: ⭐⭐
title: tdd:write-tests
url: https://skills.sh/neolabhq/context-engineering-kit/tdd:write-tests
---

# tdd:write-tests

skills/neolabhq/context-engineering-kit/tdd:write-tests
tdd:write-tests
Installation
...
Read TDD skill for best practices on writing tests
Read the target file {FILE_PATH} and understand the logic
Review existing test files for patterns and style, if not exists then create it.
Analyse which tests cases should be added to cover the changes.
Create comprehensive tests for all identified cases
Run the test command identified before.
Iterate and fix any issues until all tests pass
