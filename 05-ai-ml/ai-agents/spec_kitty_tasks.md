---
title: spec-kitty-tasks
url: https://skills.sh/richfrem/agent-plugins-skills/spec-kitty-tasks
---

# spec-kitty-tasks

skills/richfrem/agent-plugins-skills/spec-kitty-tasks
spec-kitty-tasks
Installation
...
Source: This skill augments the baseline workflow located at ./workflows/spec-kitty.tasks.md. It acts as an intelligent wrapper that is continuously improved with each execution.
