---
rating: ⭐⭐
title: proactive-agent-lite
url: https://skills.sh/aaaaqwq/claude-code-skills/proactive-agent-lite
---

# proactive-agent-lite

skills/aaaaqwq/claude-code-skills/proactive-agent-lite
proactive-agent-lite
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill proactive-agent-lite
SKILL.md
Proactive Agent Lite
Author: Daniel Li
