...
url: https://skills.sh/ar4mirez/samuel/generate-agents-md
---

# generate-agents-md

skills/ar4mirez/samuel/generate-agents-md
generate-agents-md
Installation
$ npx skills add https://github.com/ar4mirez/samuel --skill generate-agents-md
SKILL.md
Generate AGENTS.md
...
Claude Code reads CLAUDE.md (primary)
If CLAUDE.md not found, reads AGENTS.md (fallback)
...
AGENTS.md (primary)
May also read CLAUDE.md if present
Troubleshooting
