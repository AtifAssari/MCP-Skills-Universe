...
rating: ⭐⭐⭐
title: rust-daily
url: https://skills.sh/actionbook/rust-skills/rust-daily
---

# rust-daily

skills/actionbook/rust-skills/rust-daily
rust-daily
Originally fromzhanghandong/rust-skills
Installation
$ npx skills add https://github.com/actionbook/rust-skills --skill rust-daily
SKILL.md
Rust Daily Report
