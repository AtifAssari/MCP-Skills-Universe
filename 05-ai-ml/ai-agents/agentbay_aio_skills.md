---
rating: ⭐⭐⭐
title: agentbay-aio-skills
url: https://skills.sh/agentbay-ai/agentbay-skills/agentbay-aio-skills
---

# agentbay-aio-skills

skills/agentbay-ai/agentbay-skills/agentbay-aio-skills
agentbay-aio-skills
Installation
...
示例（macOS/Linux）：mkdir -p ~/.config/agentbay，再将密钥写入 ~/.config/agentbay/api_key。Windows：在 %USERPROFILE%\.config\agentbay 下创建名为 api_key 的无扩展名文件。
告知用户完成后重试，不要只复述报错。
使用场景
