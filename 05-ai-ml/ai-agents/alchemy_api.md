...
rating: ⭐⭐⭐
title: alchemy-api
url: https://skills.sh/alchemyplatform/skills/alchemy-api
---

# alchemy-api

skills/alchemyplatform/skills/alchemy-api
alchemy-api
Installation
...
Check $ALCHEMY_API_KEY is set (e.g. echo $ALCHEMY_API_KEY).
If $ALCHEMY_API_KEY is unset or empty, take the first of these that applies:
