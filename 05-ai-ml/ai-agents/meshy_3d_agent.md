---
rating: ⭐⭐⭐
title: meshy-3d-agent
url: https://skills.sh/meshy-dev/meshy-3d-agent/meshy-3d-agent
---

# meshy-3d-agent

skills/meshy-dev/meshy-3d-agent/meshy-3d-agent
meshy-3d-agent
Installation
$ npx skills add https://github.com/meshy-dev/meshy-3d-agent --skill meshy-3d-agent
SKILL.md
...
Click "Create API Key", name it, and copy the key (starts with msy_)
...
Available formats (list model_urls keys)
Credits consumed + current balance
