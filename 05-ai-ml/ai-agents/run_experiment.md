...
url: https://skills.sh/orq-ai/assistant-plugins/run-experiment
---

# run-experiment

skills/orq-ai/assistant-plugins/run-experiment
run-experiment
Installation
$ npx skills add https://github.com/orq-ai/assistant-plugins --skill run-experiment
SKILL.md
Run Experiment
...
orq MCP tools — query live data first (create_experiment, get_experiment_run, list_experiment_runs); API responses are always authoritative
