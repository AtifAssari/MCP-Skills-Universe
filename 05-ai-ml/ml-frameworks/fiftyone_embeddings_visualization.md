...
url: https://skills.sh/voxel51/fiftyone-skills/fiftyone-embeddings-visualization
---

# fiftyone-embeddings-visualization

skills/voxel51/fiftyone-skills/fiftyone-embeddings-visualization
fiftyone-embeddings-visualization
Installation
...
Solutions:
Install umap-learn: Ask user if they want to run pip install umap-learn
Use t-SNE instead: Change method to "tsne" (no extra dependencies)
Use PCA instead: Change method to "pca" (fastest, no extra dependencies)
