---
rating: ⭐⭐⭐
title: vercel-ai-sdk-v5
url: https://skills.sh/horuz-ai/claude-plugins/vercel-ai-sdk-v5
---

# vercel-ai-sdk-v5

skills/horuz-ai/claude-plugins/vercel-ai-sdk-v5
vercel-ai-sdk-v5
Installation
...
Transient parts only in onData - never in message.parts
sendStart: false when using custom start - avoid duplicate start events
result.consumeStream() - call without await for disconnect handling
Weekly Installs
9
Repository
