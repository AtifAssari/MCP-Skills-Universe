---
rating: ⭐⭐⭐
title: comm-lit-review-claude-single
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/comm-lit-review-claude-single
---

# comm-lit-review-claude-single

skills/wanshuiyin/auto-claude-code-research-in-sleep/comm-lit-review-claude-single
comm-lit-review-claude-single
Installation
$ npx skills add https://github.com/wanshuiyin/auto-claude-code-research-in-sleep --skill comm-lit-review-claude-single
SKILL.md
Comm Lit Review Claude Single
...
Custom path specified by the user in CLAUDE.md under ## Paper Library
...
locate PDFs from papers/**/*.pdf and literature/**/*.pdf
...
how papers cluster into 2-4 approaches
