...
rating: ⭐⭐⭐
title: search-skill
url: https://skills.sh/gbsoss/skill-from-masters/search-skill
---

# search-skill

skills/gbsoss/skill-from-masters/search-skill
search-skill
Installation
...
Ranks recommendations using a weighted scoring system that prioritizes official sources and community adoption
Returns top 5–10 results with install commands, star counts, and last-update timestamps for informed selection
SKILL.md
Search Skill
