...
rating: ⭐⭐
title: skill-maker
url: https://skills.sh/alpoxdev/hypercore/skill-maker
---

# skill-maker

skills/alpoxdev/hypercore/skill-maker
skill-maker
Installation
...
The core SKILL.md to decide whether this is create or refactor mode and what output the skill owns.
rules/trigger-design.md, rules/skill-anatomy.md, rules/progressive-disclosure.md, and rules/resource-placement.md when changing trigger wording, anatomy, or file split.
rules/validation-and-iteration.md and rules/anti-patterns.md before declaring the skill done.
