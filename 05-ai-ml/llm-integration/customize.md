---
title: customize
url: https://skills.sh/darraghh1/my-claude-setup/customize
---

# customize

skills/darraghh1/my-claude-setup/customize
customize
Installation
...
Project name and description — "What is your project name and a one-line description?"

Example: "Acme SaaS — workforce management platform"

App structure — "Is this a monorepo or single app?"
...
Remove all <!-- CUSTOMIZE --> comments — they served as prompts and should be deleted after customization. The content they prompted for is now filled in.
Remove the template instruction block at the top of CLAUDE.md (the HTML comment with "SETUP INSTRUCTIONS").
Update file headers — Change generic titles to project-specific ones:
