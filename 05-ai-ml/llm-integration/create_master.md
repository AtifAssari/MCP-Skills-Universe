---
title: create-master
url: https://skills.sh/xr843/master-skill/create-master
---

# create-master

skills/xr843/master-skill/create-master
create-master
Installation
$ npx skills add https://github.com/xr843/master-skill --skill create-master
SKILL.md
...
确保 masters/ 目录在 Claude Code 的 skill 搜索路径中（检查 .claude/settings.json 的 skillDirs 配置）
完成后自动可通过 /{slug} 命令触发

OpenClaw 用户：

将 masters/{slug}/ 目录复制到 OpenClaw 的 skills 目录
...
以 ## Correction 块格式追加到对应文件末尾，包含时间戳和原始反馈
