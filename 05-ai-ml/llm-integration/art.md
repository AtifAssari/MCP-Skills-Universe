---
title: art
url: https://skills.sh/danielmiessler/personal_ai_infrastructure/art
---

# art

skills/danielmiessler/personal_ai_infrastructure/Art
Art
Installation
$ npx skills add https://github.com/danielmiessler/personal_ai_infrastructure --skill Art
SKILL.md
Art Skill
...
file ~/Downloads/[name].png → must report PNG image data, ... RGBA (8-bit/color RGBA). If it says JPEG or 8-bit colormap without alpha, transparency failed.
