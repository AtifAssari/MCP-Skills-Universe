---
title: claude-md-author
url: https://skills.sh/petekp/claude-code-setup/claude-md-author
---

# claude-md-author

skills/petekp/claude-code-setup/claude-md-author
claude-md-author
Installation
...
Remove task-specific content: Move specialized instructions to .claude/docs/
Use pointers: Replace code snippets with file:line references
Test for universality: Ask "Will this help in every Claude session?"
Template
# Project Name
