---
title: instrumenting-with-mlflow-tracing
url: https://skills.sh/mlflow/skills/instrumenting-with-mlflow-tracing
---
...
Confirm traces are logged — use mlflow.search_traces() or MlflowClient().search_traces() to check that traces appear in the experiment:
import mlflow
