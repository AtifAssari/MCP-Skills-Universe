---
title: paper-write
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/paper-write
---

# paper-write

skills/wanshuiyin/auto-claude-code-research-in-sleep/paper-write
paper-write
Installation
...
Add citations — for ML conferences (ICLR/NeurIPS/ICML/CVPR/ACL/AAAI): use \citep{} / \citet{} (natbib). For IEEE venues: use \cite{} (numeric style via cite package). Never mix natbib and cite commands.
...
Scan all citation references in the drafted sections (\citep{}/\citet{} for ML conferences, \cite{} for IEEE venues)
