...
url: https://skills.sh/rfxlamia/claude-skillkit/prompt-engineering
---
...
2. Target LLM?
Claude → XML format (see references/xml-format.md)
GPT → JSON format (see references/json-format.md)
Multi-LLM → JSON (portable)
Human-editable → YAML (see references/yaml-format.md)
3. Output Use?
Code/API → JSON
...
decision_matrix.md - Comprehensive decision framework
zero-shot.md - Zero-shot prompting guide
few-shot.md - Few-shot prompting guide
chain-of-thought.md - CoT prompting guide
react.md - ReAct prompting guide
tree-of-thoughts.md - ToT prompting guide
self-consistency.md - Self-consistency guide
xml-format.md - XML format best practices
json-format.md - JSON format best practices
yaml-format.md - YAML format best practices
natural-language.md - Natural language best practices
pitfalls.md - Common mistakes and solutions
advanced-combinations.md - Combining techniques
prompt-chaining.md - Sequential prompt patterns
Assets (Templates)
