---
title: memos
url: https://skills.sh/jmagar/claude-homelab/memos
---

# memos

skills/jmagar/claude-homelab/memos
memos
Installation
...
"Save this to my memos" → Extract key content, create memo with appropriate tags
"What did I write about X?" → Search memos by content/tags, present results
"Find my notes on project Y" → Use tag search or content filter
"Update my memo about Z" → Search for memo, get ID, update content
"Delete that memo" → Confirm with user, then delete by ID
...
Best Practices
Use descriptive content: First line is preview in UI
Tag consistently: Use lowercase, hyphens for multi-word (e.g., "project-alpha")
Archive old memos: Keep workspace clean
Link related memos: Use memo relations for context
Common Errors
