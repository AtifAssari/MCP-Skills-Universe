...
rating: ⭐⭐
title: chatgpt-apps
url: https://skills.sh/openai/skills/chatgpt-apps
---

# chatgpt-apps

skills/openai/skills/chatgpt-apps
chatgpt-apps
Installation
...
Version-matched @modelcontextprotocol/ext-apps examples when the user needs a lower-level or more portable MCP Apps baseline.
...
Doc pages/URLs used from $openai-docs
