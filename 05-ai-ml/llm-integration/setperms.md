---
title: setperms
url: https://skills.sh/0xdarkmatter/claude-mods/setperms
---

# setperms

skills/0xdarkmatter/claude-mods/setperms
setperms
Installation
...
Permissions (.claude/settings.local.json) - Pre-approved CLI tools
Rules (.claude/rules/cli-tools.md) - Instructions to prefer modern tools
