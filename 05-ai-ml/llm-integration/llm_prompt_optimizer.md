...
url: https://skills.sh/jmsktm/claude-settings/llm-prompt-optimizer
---

# llm prompt optimizer

skills/jmsktm/claude-settings/LLM Prompt Optimizer
LLM Prompt Optimizer
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'LLM Prompt Optimizer'
SKILL.md
LLM Prompt Optimizer
