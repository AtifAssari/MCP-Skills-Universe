---
rating: ⭐⭐⭐
title: llm-wiki-bootstrap
url: https://skills.sh/nanzhipro/karpathy-llm-wiki-bootstrap-skill/llm-wiki-bootstrap
---

# llm-wiki-bootstrap

skills/nanzhipro/karpathy-llm-wiki-bootstrap-skill/llm-wiki-bootstrap
llm-wiki-bootstrap
Installation
...
LLM-native — all instructions are written as executable protocols for language models, not prose for humans
Source of truth separation — raw sources are immutable; the wiki is derived and regenerable
Incremental compilation — each source is integrated once; knowledge compounds, not re-derived
Convention over configuration — sensible defaults, minimal required decisions
Editor-agnostic core — markdown files work everywhere; editor-specific features are optional layers
Git-friendly — plain text, no binary blobs in wiki/, version history for free
Weekly Installs
121
Repository
nanzhipro/karpa…ap-skill
GitHub Stars
32
First Seen
3 days ago
