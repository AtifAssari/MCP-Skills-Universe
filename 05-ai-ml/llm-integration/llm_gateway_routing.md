...
url: https://skills.sh/phrazzld/claude-config/llm-gateway-routing
---

# llm-gateway-routing

skills/phrazzld/claude-config/llm-gateway-routing
llm-gateway-routing
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill llm-gateway-routing
SKILL.md
LLM Gateway & Routing
