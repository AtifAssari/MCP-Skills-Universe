...
skills/supercent-io/skills-template/llm-monitoring-dashboard
llm-monitoring-dashboard
Installation
$ npx skills add https://github.com/supercent-io/skills-template --skill llm-monitoring-dashboard
Summary
...
Set STORE_PREVIEW=true in the .env file (do not modify code directly)
...
Set retention_days explicitly to define the retention period
