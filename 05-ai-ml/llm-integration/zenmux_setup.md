---
title: zenmux-setup
url: https://skills.sh/zenmux/skills/zenmux-setup
---

# zenmux-setup

skills/zenmux/skills/zenmux-setup
zenmux-setup
Installation
...
Toggle on Override OpenAI Base URL → enter https://zenmux.ai/api/v1
Click + Add Custom Model → enter the model slug (e.g., anthropic/claude-sonnet-4.5)
Cline
...
Model ID: Enter the model slug (e.g., anthropic/claude-sonnet-4.5)
Cherry Studio
Settings → Model Provider → Click "Add"
Provider Type: Select "OpenAI"
API Key: Paste the ZenMux API Key
API Host: https://zenmux.ai/api/v1/ (trailing slash is important!)
Click "Manager" to auto-discover models, or manually add model slugs
...
Best practices for specific tools: https://docs.zenmux.ai/zh/best-practices/
Weekly Installs
60
Repository
zenmux/skills
