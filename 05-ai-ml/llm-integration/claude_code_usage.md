...
url: https://skills.sh/0xlayerghost/solidity-agent-kit/claude-code-usage
---

# claude-code-usage

skills/0xlayerghost/solidity-agent-kit/claude-code-usage
claude-code-usage
Installation
...
Scope — Which files / contracts / functions could be affected?
Action — What operation is intended? (add / modify / delete / refactor / fix)
Skill match — Which skills are relevant? Map each interpretation to applicable /skill
Impact — What side effects could each interpretation have?
Constraints — Are there implicit boundaries the user might assume?
Output Format
