...
rating: ⭐⭐⭐
title: setup-claude
url: https://skills.sh/ansarullahanasz360/cc-guide/setup-claude
---

# setup-claude

skills/ansarullahanasz360/cc-guide/setup-claude
setup-claude
Installation
...
Explicit mode: If the user specifies init or audit, use that mode
Auto-detect mode: Otherwise, analyze the current directory:
