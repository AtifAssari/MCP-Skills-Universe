---
title: auth-js
url: https://skills.sh/jackspace/claudeskillz/auth-js
---

# auth-js

skills/jackspace/claudeskillz/auth-js
auth-js
Installation
...
Prevent known issues listed in references/common-errors.md
...
NEVER throw errors in authorize() - always return null
Why? Throwing errors causes CallbackRouteError instead of CredentialsSignin
Always validate with Zod before checking credentials
...
Return null (not throw) in Credentials authorize()
...
Check references/common-errors.md first
