...
url: https://skills.sh/jmsktm/claude-settings/sentiment-analyzer
---

# sentiment analyzer

skills/jmsktm/claude-settings/Sentiment Analyzer
Sentiment Analyzer
Installation
...
Aggregate aspect sentiments across documents
Quick Reference
