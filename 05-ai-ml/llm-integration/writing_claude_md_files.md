---
title: writing-claude-md-files
url: https://skills.sh/ed3dai/ed3d-plugins/writing-claude-md-files
---

# writing-claude-md-files

skills/ed3dai/ed3d-plugins/writing-claude-md-files
writing-claude-md-files
Installation
...
Update the freshness date using Bash date +%Y-%m-%d
Verify contracts still hold - read the code, check invariants
Remove stale content - better short and accurate than long and wrong
Keep token-efficient - <300 lines top-level, <100 lines subdirectory
Common Mistakes
Mistake	Fix
