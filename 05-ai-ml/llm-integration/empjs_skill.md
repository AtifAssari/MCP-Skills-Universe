---
title: empjs-skill
url: https://skills.sh/steelan9199/wechat-publisher/empjs-skill
---

# empjs-skill

skills/steelan9199/wechat-publisher/empjs-skill
empjs-skill
Installation
...
构建命令: 根据提取的信息构建完整的 eskill 命令
执行命令: 使用适当的工具执行命令（注意不同 shell 环境的语法差异）
返回结果: 将命令输出返回给用户
支持的 AI Agent 平台
...
在 Windows 环境下使用 PowerShell 时，命令连接符应使用;而不是&&，目录切换应使用Set-Location而非cd
Weekly Installs
22
Repository
