---
title: starwave:requirements
url: https://skills.sh/arjenschwarz/agentic-coding/starwave:requirements
---

# starwave:requirements

skills/arjenschwarz/agentic-coding/starwave:requirements
starwave:requirements
Installation
...
FIRST: Use the Task tool with subagent_type="general-purpose" to run the design-critic skill (invoke the Skill tool with skill="design-critic") to perform a critical review that challenges assumptions, identifies gaps, and questions necessity
SECOND: Use the Task tool with subagent_type="peer-review-validator" to validate the requirements and critical review findings by consulting external AI systems (Gemini, Codex, Q Developer)
The model MUST synthesize the findings from both reviews and present the key insights, questions, and recommendations to the user
