---
title: lean4
url: https://skills.sh/cameronfreer/lean4-skills/lean4
---

# lean4

skills/cameronfreer/lean4-skills/lean4
lean4
Installation
...
Live file + MCP tools (lean_goal, lean_multi_attempt, lean_diagnostic_messages)
lean_run_code for isolated experiments
/tmp scratch files only when lean_run_code is unavailable and the experiment must not touch the live file
