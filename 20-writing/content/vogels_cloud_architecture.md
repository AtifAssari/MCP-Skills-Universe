---
rating: ⭐⭐⭐
title: vogels-cloud-architecture
url: https://skills.sh/copyleftdev/sk1llz/vogels-cloud-architecture
---

# vogels-cloud-architecture

skills/copyleftdev/sk1llz/vogels-cloud-architecture
vogels-cloud-architecture
Installation
...
APIs are Forever: Once published, an API is a contract. Design APIs for the long term.

Decentralize Everything: Centralized components become bottlenecks and single points of failure.

Automate Everything: If a human has to do it more than once, automate it.
...
Assume failure: What breaks when this component fails?
Measure the customer impact: How does this affect user experience?
Design for recovery: How quickly can we recover?
Automate operations: Can this be done without human intervention?
Iterate: Ship, measure, improve.
The Amazon Tenets
...
For references (papers, talks, blog), see references.md
Weekly Installs
8
Repository
copyleftdev/sk1llz
