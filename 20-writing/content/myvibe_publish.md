...
url: https://skills.sh/arcblock/myvibe-skills/myvibe-publish
---

# myvibe-publish

skills/arcblock/myvibe-skills/myvibe-publish
myvibe-publish
Installation
...
Step 2 - Evaluate and generate: If the extracted title is generic or meaningless (e.g. "Document", "Untitled", "index", "app", "React App", "Vite App", single characters, or package-name-style like "my-app"), generate a better title based on:
