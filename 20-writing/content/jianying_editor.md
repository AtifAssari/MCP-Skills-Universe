---
title: jianying-editor
url: https://skills.sh/luoluoluo22/jianying-editor-skill/jianying-editor
---

# jianying-editor

skills/luoluoluo22/jianying-editor-skill/jianying-editor
jianying-editor
Installation
...
脚本位置：禁止在 Skill 内部目录创建剪辑脚本。所有的剪辑逻辑实现代码（.py 脚本）必须存放在用户当前项目的根目录（或子目录，如 scripts/），以保持 Skill 库的纯净和可移植性。
配乐选择：
