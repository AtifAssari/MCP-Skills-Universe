...
url: https://skills.sh/joeseesun/anything-to-notebooklm/anything-to-notebooklm
---

# anything-to-notebooklm

skills/joeseesun/anything-to-notebooklm/anything-to-notebooklm
anything-to-notebooklm
Installation
$ npx skills add https://github.com/joeseesun/anything-to-notebooklm --skill anything-to-notebooklm
Summary
...
Automatically converts all file types to text using markitdown, then uploads to NotebookLM for processing
Maps natural language instructions to 9 NotebookLM generation modes: audio podcasts, slide decks, mind maps, quizzes, videos, reports, infographics, data tables, and flashcards
Requires MCP server configuration for WeChat article extraction and NotebookLM CLI authentication before first use
SKILL.md
