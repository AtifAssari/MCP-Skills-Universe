...
url: https://skills.sh/tencentcloudbase/skills/cloudbase-document-database-web-sdk
---

# cloudbase-document-database-web-sdk

skills/tencentcloudbase/skills/cloudbase-document-database-web-sdk
cloudbase-document-database-web-sdk
Installation
...
Requires SDK initialization with environment ID and authentication before database operations; returns up to 100 records by default (max 1000)
Emphasizes type definitions for collections, security rule configuration, and error handling on all database calls via return code checking
SKILL.md
