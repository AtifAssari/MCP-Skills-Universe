...
url: https://skills.sh/groeimetai/snow-flow/knowledge-management
---

# knowledge-management

skills/groeimetai/snow-flow/knowledge-management
knowledge-management
Installation
$ npx skills add https://github.com/groeimetai/snow-flow --skill knowledge-management
SKILL.md
...
Structured Content - Use headings and lists
Keywords - Add relevant keywords
Categories - Proper categorization
Review Process - Quality control workflow
Expiration - Set article validity dates
Feedback - Enable user ratings
