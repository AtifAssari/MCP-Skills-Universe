---
title: qa-docs-coverage
url: https://skills.sh/vasilyu1983/ai-agents-public/qa-docs-coverage
---

# qa-docs-coverage

skills/vasilyu1983/ai-agents-public/qa-docs-coverage
qa-docs-coverage
Installation
...
Inventory docs and classify by type (Tutorial, How-to, Reference, Explanation).
...
Enforce lifecycle metadata for non-canonical docs (status, integrates_into, owner, last_verified, delete_by).
