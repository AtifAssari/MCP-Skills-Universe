...
url: https://skills.sh/jwilger/agent-skills/architecture-decisions
---

# architecture-decisions

skills/jwilger/agent-skills/architecture-decisions
architecture-decisions
Installation
...
Assumptions not verified by research
Dependencies not investigated
Questions the research didn't answer
Constraints that may conflict with existing architectural decisions
...
Claims that don't cite a research finding
Internal inconsistencies
Missing constraints (what could go wrong that isn't addressed)
Conflicts with other documented architectural decisions
...
Inventory decision points across categories (see references/adr-template.md for the categories checklist)
Present the agenda to the human for review
For each decision: run the full four-phase lifecycle independently
Never batch -- one decision per record, each reviewed independently
