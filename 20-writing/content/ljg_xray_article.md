---
title: ljg-xray-article
url: https://skills.sh/lijigang/ljg-skill-xray-article/ljg-xray-article
---

# ljg-xray-article

skills/lijigang/ljg-skill-xray-article/ljg-xray-article
ljg-xray-article
Installation
$ npx skills add https://github.com/lijigang/ljg-skill-xray-article --skill ljg-xray-article
SKILL.md
LJG-Xray-Article: 文章解读

你要做两件事，仅两件：

文章说了什么：作者的真问题 → 真回答 → 论证骨架
对我意味着什么：认知碰撞卡片
...
步骤 5：生成 Org 报告
运行 date +%Y%m%dT%H%M%S 和 date "+%Y-%m-%d %a %H:%M"
文件名：{时间戳}--article-{简短标题}__read.org
读取 references/template.org 获取报告结构，按模板填充
写入 ~/Documents/notes/{文件名}
输出质量标准
