...
url: https://skills.sh/zephyrwang6/myskill/article-review
---

# article-review

skills/zephyrwang6/myskill/article-review
article-review
Installation
$ npx skills add https://github.com/zephyrwang6/myskill --skill article-review
SKILL.md
文章评价写作指南
...
传播热点：文章在圈子里传播的原因是什么？大众关注的焦点是什么？
表层关注 vs 深层价值：读者表面关注的点（如"作者被裁"）与文章真正的价值所在（如"费米能级"概念）
...
识别核心概念：找出文章中最关键、最有价值的概念
通俗化表达：用更简单、更有画面感的语言重新解释
逻辑链条梳理：把作者的推理过程清晰地呈现出来
...
开篇引入（1-2段）：点明传播情况，引出核心价值
背景介绍（1段）：简述作者背景
核心解读（3-5段）：提炼并通俗化核心概念
金句引用（穿插其中）：突出原文亮点
升华总结（1-2段）：提炼启示，收尾有力
