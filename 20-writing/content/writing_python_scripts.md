...
url: https://skills.sh/quick-brown-foxxx/coding_rules_python/writing-python-scripts
---

# writing-python-scripts

skills/quick-brown-foxxx/coding_rules_python/writing-python-scripts
writing-python-scripts
Installation
$ npx skills add https://github.com/quick-brown-foxxx/coding_rules_python --skill writing-python-scripts
SKILL.md
Writing Python Scripts
