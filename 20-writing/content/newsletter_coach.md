---
title: newsletter-coach
url: https://skills.sh/nicepkg/ai-workflow/newsletter-coach
---
...
newsletter-coach
Installation
$ npx skills add https://github.com/nicepkg/ai-workflow --skill newsletter-coach
SKILL.md
...
Generate all 10 headline options
Identify the 3 strongest headlines from your list
Invoke hook-stack-evaluator for each with: "Target audience: [audience from Phase 2]"
Receive scores (X/15) for each
...
Complete the draft using the style guide above
Invoke ai-slop-detector on the full draft text
Receive the cleaned version with AI patterns removed
Present the cleaned version to the writer
