---
rating: ⭐⭐
title: kids-book-writer
url: https://skills.sh/jamesrochabrun/skills/kids-book-writer
---

# kids-book-writer

skills/jamesrochabrun/skills/kids-book-writer
kids-book-writer
Installation
$ npx skills add https://github.com/jamesrochabrun/skills --skill kids-book-writer
SKILL.md
Kids Book Writer
...
Ages 6-7 (Beginning Readers): Focus on:
...
Opening - Meet character in their world
Inciting Incident - Problem appears
Rising Action - Character tries to solve problem, faces obstacles
Climax - Biggest challenge, character must be brave/kind/clever
Resolution - Problem solved, lesson learned
Ending - New normal, satisfying close
...
Age Range: 4-6 years Theme: Creativity, problem-solving, making mistakes okay Format: 32-page rhyming picture book Word Count: ~650 words
...
[Story continues with Max's attempts, failures, and eventual realization that mistakes lead to new ideas. Culminates in Max creating something even better using his "failed" pieces.]
...
✅ Read your work aloud multiple times ✅ Test rhythm by clapping or stomping along ✅ Use strong, vivid verbs ✅ Create memorable, diverse characters ✅ Include visual storytelling opportunities ✅ Show emotions through actions ✅ End with hope and possibility ✅ Use age-appropriate vocabulary ✅ Respect your young readers' intelligence ✅ Have fun with language and sound ✅ Create page-turn moments ✅ Build in re-read value

DON'T:

❌ Force rhymes with awkward inversions ("Said the cat happy") ❌ Use words kids can't relate to ❌ Be preachy or didactic ❌ Create flat, one-dimensional characters ❌ Make lessons too obvious ❌ Use inconsistent meter ❌ Write down to children ❌ Include scary content inappropriate for age ❌ Forget the importance of humor ❌ Sacrifice story for rhyme ❌ Use near-rhymes as crutch ❌ Include too much text per page
...
Response: Creates complete 32-page rhyming picture book with:
...
Response: Creates soothing bedtime story with:
...
Response: Creates fun, educational song with:
...
Response: Creates first-person chapter with:
