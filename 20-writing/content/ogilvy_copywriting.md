---
title: ogilvy-copywriting
url: https://skills.sh/boraoztunc/skills/ogilvy-copywriting
---

# ogilvy-copywriting

skills/boraoztunc/skills/ogilvy-copywriting
ogilvy-copywriting
Installation
$ npx skills add https://github.com/boraoztunc/skills --skill ogilvy-copywriting
SKILL.md
...
Do the homework. The more you know the product, the more likely a big idea surfaces.
Study what has worked and failed for similar products.
Study consumer research — what do they actually think, want, fear?
The promise should be important and unique. Use research to identify which promise is most persuasive.
...
What is the positioning? (What does it do, who is it for?)
What is the single promise? (One benefit, competitive, deliverable)
What is the big idea? (Simple, memorable, built to last)
Who is the reader/viewer? (Demographic + psychological profile)
What does the headline do? (Brand name + promise + news?)
What proof exists? (Facts, demos, testimonials, before/after?)
What does the image say? (Does it support the promise? Does it have story appeal?)
Does the caption work as a standalone ad?
Is this boring? (Would this make someone lean forward or away?)
Is the product the hero? (Or is the clever idea the hero?)
