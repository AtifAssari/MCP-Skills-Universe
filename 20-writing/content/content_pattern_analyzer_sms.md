...
url: https://skills.sh/blacktwist/social-media-skills/content-pattern-analyzer-sms
---

# content-pattern-analyzer-sms

skills/blacktwist/social-media-skills/content-pattern-analyzer-sms
content-pattern-analyzer-sms
Installation
...
list_posts — retrieve the full post history, paginating until you have 30+ posts (use larger date ranges if needed)
get_post_analytics — pull per-post metrics for every post: impressions, likes, comments, reposts, saves, link clicks, profile visits
get_metric_timeseries — pull engagement rate over time to identify trend direction (weekly view recommended)
get_consistency — check posting frequency and cadence to identify whether consistency correlates with pattern shifts
