---
title: deep-work
url: https://skills.sh/petekp/agent-skills/deep-work
---

# deep-work

skills/petekp/agent-skills/deep-work
deep-work
Installation
...
Write a detailed report to .claude/research.md
...
Read .claude/plan.md thoroughly, finding all user annotations
User annotations are any text that wasn't in your original plan — look for corrections, questions, overrides, and constraints
...
After completing each task, update .claude/plan.md — change - [ ] to - [x]
Do not stop until all tasks are completed
Run the project's type checker / linter after each phase to catch issues early
Do not add unnecessary comments, docstrings, or type workarounds (any, unknown)
