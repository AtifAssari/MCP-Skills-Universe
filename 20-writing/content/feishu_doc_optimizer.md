---
title: feishu-doc-optimizer
url: https://skills.sh/aaaaqwq/claude-code-skills/feishu-doc-optimizer
---

# feishu-doc-optimizer

skills/aaaaqwq/claude-code-skills/feishu-doc-optimizer
feishu-doc-optimizer
Installation
...
注意事项
登录状态：浏览器编辑需要已登录飞书
API 限制：飞书 API 不支持直接删除文档块
编辑模式：确保文档处于"编辑"模式而非"阅读"模式
保存确认：编辑后等待"已保存到云端"提示
相关文件
