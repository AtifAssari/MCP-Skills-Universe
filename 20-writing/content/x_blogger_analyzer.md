---
title: x-blogger-analyzer
url: https://skills.sh/zephyrwang6/myskill/x-blogger-analyzer
---

# x-blogger-analyzer

skills/zephyrwang6/myskill/x-blogger-analyzer
x-blogger-analyzer
Installation
$ npx skills add https://github.com/zephyrwang6/myskill --skill x-blogger-analyzer
SKILL.md
X Blogger Analyzer
...
保存位置： 05 笔记/01 博主分析/ 命名规范： MMDD博主分析-用户名.md（如 0111博主分析-elonmusk.md）
