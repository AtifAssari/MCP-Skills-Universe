...
url: https://skills.sh/sugarforever/01coder-agent-skills/diagram-to-image
---

# diagram-to-image

skills/sugarforever/01coder-agent-skills/diagram-to-image
diagram-to-image
Installation
...
File size in bytes (printed by the script)
...
Detect ./images/ exists
Analyze content → authentication flow
Generate filename: login-flow.png
Save content to /tmp/diagram.mmd
Run: node ~/.claude/skills/diagram-to-image/scripts/diagram-to-image.mjs /tmp/diagram.mmd -o ./images/login-flow.png
...
Save content to /tmp/diagram.mmd
Run: node ~/.claude/skills/diagram-to-image/scripts/diagram-to-image.mjs /tmp/diagram.mmd -o ./ai-agent-flow.png --theme ocean
...
Save content to /tmp/table.md
Run: node ~/.claude/skills/diagram-to-image/scripts/diagram-to-image.mjs /tmp/table.md -o ./model-comparison.png (auto-detects as table)
