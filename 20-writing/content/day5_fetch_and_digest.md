---
rating: ⭐⭐⭐
title: day5-fetch-and-digest
url: https://skills.sh/ai-native-camp/camp-1/day5-fetch-and-digest
---

# day5-fetch-and-digest

skills/ai-native-camp/camp-1/day5-fetch-and-digest
day5-fetch-and-digest
Installation
...
Build content-digest with Quiz-First learning methodology, which improves retention by 9–12% by presenting questions before summaries
Chain all three skills together in Block 4 to digest real-world content end-to-end, with estimated total time of ~95 minutes across five blocks
SKILL.md
...
Block 0에서 콘텐츠 소화 파이프라인(fetch → digest) 개념을 이해한다
Block 1에서 fetch-tweet 스킬을 직접 만든다 (API 활용 + 번역 파이프라인)
Block 2에서 fetch-youtube 스킬을 직접 만든다 (자막 추출 + Web Search 보정)
Block 3에서 content-digest 스킬을 직접 만든다 (Quiz-First 학습)
Block 4에서 3개 스킬을 연결하여 실제 콘텐츠로 실습한다
