---
title: visionera
url: https://skills.sh/jgabor/agentera/visionera
---

# visionera

skills/jgabor/agentera/visionera
visionera
Installation
...
Map structure: directory layout, key modules, entry points
Read dependency manifests: stack, libraries, what choices reveal
Read README.md, CLAUDE.md, AGENTS.md if they exist
Read key source files to understand what the software does today
Read PROGRESS.md, TODO.md, DECISIONS.md for trajectory
Read HEALTH.md for current quality
Read DESIGN.md for existing visual identity
Decision profile: read $PROFILERA_PROFILE_DIR/PROFILE.md (default: $XDG_DATA_HOME/agentera/PROFILE.md) directly per contract profile consumption conventions. If missing, proceed without persona grounding.
git log --oneline -30 for recent story
...
What exists: similar tools, competing approaches, adjacent projects
State of the art: recent developments, emerging patterns
What's missing: suite gaps this project could fill
Who talks about it: communities, forums, common frustrations
...
Read the codebase (same depth as Create Step 1)
Read PROGRESS.md for what's been built since the vision was created
Read DECISIONS.md for what decisions have shifted thinking
Read HEALTH.md for what structural realities constrain the vision
Read TODO.md for what recurring problems suggest the vision needs adjustment
...
Getting started
New project
/visionera: deep creation of VISION.md through codebase exploration, domain research, and aspirational conversation
/planera: plan the first features (if complex)
/realisera or /loop 10m /realisera: start building
Existing project without a vision
/visionera: reads the codebase, understands what exists, then pushes the user to articulate where it should go
Vision refinement
/visionera: detects existing VISION.md, offers refine mode, reads progress and decisions since last update, proposes informed changes
