...
rating: ⭐⭐⭐
title: typefully
url: https://skills.sh/typefully/agent-skills/typefully
---

# typefully

skills/typefully/agent-skills/typefully
typefully
Installation
$ npx skills add https://github.com/typefully/agent-skills --skill typefully
Summary

Draft, schedule, and publish social media content across X, LinkedIn, Threads, Bluesky, and Mastodon.

Supports drafting, scheduling, and publishing to five platforms with single or multi-platform posts, including cross-platform content tailoring via a single draft
Features queue management, analytics for X posts, tag organization, media uploads, and LinkedIn organization mentions via URL resolution
Includes thread creation (split with ---), replies, quote posts, community posts, and scratchpad notes for internal draft organization
Requires API key setup via interactive or non-interactive CLI; supports default social set configuration to streamline repeated commands
SKILL.md
Typefully Skill
