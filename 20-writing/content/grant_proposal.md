...
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/grant-proposal
---

# grant-proposal

skills/wanshuiyin/auto-claude-code-research-in-sleep/grant-proposal
grant-proposal
Installation
$ npx skills add https://github.com/wanshuiyin/auto-claude-code-research-in-sleep --skill grant-proposal
SKILL.md
...
Read idea-stage/IDEA_REPORT.md if it exists (from /idea-discovery); fall back to ./IDEA_REPORT.md if not found
Read refine-logs/FINAL_PROPOSAL.md if it exists (from /research-refine)
Read refine-logs/EXPERIMENT_PLAN.md if it exists (from /experiment-plan)
...
Read NARRATIVE_REPORT.md or STORY.md if they exist
Read any existing literature notes or survey documents
Scan for the user's publication list (e.g., publications.md, cv.md, bio.md, CV.pdf)
...
Budget Justification — narrative only (leave dollar/yen amounts as [AMOUNT] placeholders).
...
Write complete prose — no [TODO] except for PI-specific information
Include figure/table placeholders where appropriate (e.g., [Figure 1: System architecture])
