---
title: medical-newsletter-writer
url: https://skills.sh/drshailesh88/integrated_content_os/medical-newsletter-writer
---

# medical-newsletter-writer

skills/drshailesh88/integrated_content_os/medical-newsletter-writer
medical-newsletter-writer
Installation
$ npx skills add https://github.com/drshailesh88/integrated_content_os --skill medical-newsletter-writer
SKILL.md
Medical Newsletter Writer
...
Upload PDF - Upload your PDF with topic ideas in the chat
Select Topic - Review engagement predictions and pick one topic
Get Newsletter - Receive complete, publication-ready newsletter (~3,000 words with 20-30 PubMed citations)
...
Extract Topics from PDF - Read user's uploaded PDF of topic ideas
Trend Analysis - Analyze each topic for engagement potential
Topic Selection - User approves topics based on data-driven predictions
Deep Research - Comprehensive PubMed literature review
Newsletter Writing - Write complete newsletter in Topol's style
...
Readability: Can this be explained clearly to physicians?
Controversy: Is there debate/opposing views?
Clinical Relevance: Will this affect patient care?
Timeliness: How current is this? Breaking news?
Share Potential: Will physicians share with colleagues?
...
Critical thinking: Discuss limitations, not just positives
Voice consistency: Sound like Topol throughout
Comprehensive: Cover topic thoroughly with multiple studies
Accessible: Technical accuracy without excessive jargon
Timely: Focus on recent developments
Visual: Include tables/figures to enhance understanding
Engaging: Hook readers immediately, maintain interest
