---
title: slide-outline
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/slide-outline
---

# slide-outline

skills/manojbajaj95/claude-gtm-plugin/slide-outline
slide-outline
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill slide-outline
SKILL.md
Slide Outline Skill
...
Ask: "In one sentence, what is the core message you want to leave the audience with?"
Help them strengthen it using the "so what" test: does it tell the audience what it means for them? (e.g., "iPod stores 1000 songs in your pocket" beats "iPod has 1GB storage")
Ask: "What are the 2–4 key arguments or insights that support this message?"
For each argument, ask: "What facts or data back this up?"
Display the tree structure and ask: "Does this tree tell the full story? Are there gaps or anything that feels out of place?"
...
Show the slide card from the storyboard as a reminder (title, type, body guideline)
Ask: "Let's write Slide [N] — [title]. What content, data, or arguments do you want to include in the body?"
Shape the content using the DDR process:
...
Ask: "How does this look? Any changes before we move to the next slide?"
Incorporate feedback, then move to the next slide.
