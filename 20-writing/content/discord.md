---
title: discord
url: https://skills.sh/vm0-ai/vm0-skills/discord
---

# discord

skills/vm0-ai/vm0-skills/discord
discord
Installation
...
15	Forum
Guidelines
Rate limits: Check X-RateLimit-* headers; implement backoff
Token security: Never expose bot tokens
Permissions: Bot needs appropriate permissions for each action
Intents: Enable required intents in Developer Portal
API version: Use /v10 for latest stable API
Weekly Installs
111
Repository
vm0-ai/vm0-skills
