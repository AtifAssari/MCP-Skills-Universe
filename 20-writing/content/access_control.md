...
url: https://skills.sh/hack23/homepage/access-control
---

# access-control

skills/hack23/homepage/access-control
access-control
Installation
$ npx skills add https://github.com/hack23/homepage --skill access-control
SKILL.md
