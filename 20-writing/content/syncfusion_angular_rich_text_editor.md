---
rating: ⭐⭐
title: syncfusion-angular-rich-text-editor
url: https://skills.sh/syncfusion/angular-ui-components-skills/syncfusion-angular-rich-text-editor
---

# syncfusion-angular-rich-text-editor

skills/syncfusion/angular-ui-components-skills/syncfusion-angular-rich-text-editor
syncfusion-angular-rich-text-editor
Installation
$ npx skills add https://github.com/syncfusion/angular-ui-components-skills --skill syncfusion-angular-rich-text-editor
SKILL.md
