...
url: https://skills.sh/rohitg00/awesome-claude-code-toolkit/api-design-patterns
---

# api-design-patterns

skills/rohitg00/awesome-claude-code-toolkit/api-design-patterns
api-design-patterns
Installation
$ npx skills add https://github.com/rohitg00/awesome-claude-code-toolkit --skill api-design-patterns
SKILL.md
API Design Patterns
Resource Naming
