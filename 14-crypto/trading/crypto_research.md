...
url: https://skills.sh/coinmarketcap-official/skills-for-ai-agents-by-coinmarketcap/crypto-research
---

# crypto-research

skills/coinmarketcap-official/skills-for-ai-agents-by-coinmarketcap/crypto-research
crypto-research
Installation
$ npx skills add https://github.com/coinmarketcap-official/skills-for-ai-agents-by-coinmarketcap --skill crypto-research
SKILL.md
...
search_cryptos fails: Cannot proceed without token ID. Ask user to verify spelling or try the contract address.
get_crypto_info fails: Skip Overview section, note "Project details unavailable" in report.
get_crypto_quotes_latest fails: Report is incomplete without price data. Retry once, then note "Market data unavailable."
get_crypto_metrics fails: Skip Holder Analysis section, note "Distribution data unavailable."
get_crypto_technical_analysis fails: Skip Technical Outlook section, note "Technical analysis unavailable."
get_crypto_latest_news fails: Skip Recent News section, proceed with other data.
