...
url: https://skills.sh/xbklairith/kisune/market-analysis
---

# market-analysis

skills/xbklairith/kisune/market-analysis
market-analysis
Installation
...
Analyzes chart patterns (reversals, continuations, price action) and multi-timeframe structure to align higher-timeframe trends with lower-timeframe entries
Activates deep thinking for complex market conditions with conflicting signals, then provides analysis with confidence levels and clear invalidation points
Delivers structured output including risk/reward ratios, bullish/bearish scenarios, and cross-market intelligence (Bitcoin dominance, sector rotation, funding rates, macro correlations)
SKILL.md
