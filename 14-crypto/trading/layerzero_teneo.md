---
title: layerzero-teneo
url: https://skills.sh/teneoprotocolai/teneo-skills/layerzero-teneo
---

# layerzero-teneo

skills/teneoprotocolai/teneo-skills/layerzero-teneo
layerzero-teneo
Installation
$ npx skills add https://github.com/teneoprotocolai/teneo-skills --skill layerzero-teneo
SKILL.md
...
Approval — Approves the token contract to spend your tokens
Bridge — Executes the cross-chain transfer via LayerZero
...
bridge		Free	Bridge tokens across chains. Fetches a quote from LayerZero, then walks through approval and bridge steps automatically.
Quick Reference
# Agent ID: layerzero
