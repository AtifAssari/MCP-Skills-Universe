...
url: https://skills.sh/binance/binance-skills-hub/trading-signal
---

# trading-signal

skills/binance/binance-skills-hub/trading-signal
trading-signal
Installation
...
Supports pagination with configurable page size (max 100 items) and filters by signal type
Returns comprehensive price data including alert price at trigger time, current market cap, highest price reached, and performance analysis for strategy validation
SKILL.md
