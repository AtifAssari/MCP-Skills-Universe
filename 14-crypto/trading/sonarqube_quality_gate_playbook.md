---
rating: ⭐⭐
title: sonarqube-quality-gate-playbook
url: https://skills.sh/agustinalbonico/ai-customizations/sonarqube-quality-gate-playbook
---

# sonarqube-quality-gate-playbook

skills/agustinalbonico/ai-customizations/sonarqube-quality-gate-playbook
sonarqube-quality-gate-playbook
Installation
$ npx skills add https://github.com/agustinalbonico/ai-customizations --skill sonarqube-quality-gate-playbook
SKILL.md
SonarQube Quality Gate Playbook
...
Security Hotspots en estado TO_REVIEW
Coverage en modulos criticos y tocados por el PR
...
Rutas SF: con backslashes (\\) en lcov.info generadas en Windows.
SonarQube ejecutando en Linux/containers sin poder mapear rutas con \\.
Packages compartidos con cobertura baja (ejemplo packages/utils) tirando abajo el global.
Diagnostico rapido
Revisar primeras entradas SF: del lcov.info de cada app/package.
Verificar en logs de sonar-scanner si hay archivos de coverage no mapeados o ignorados.
Comparar cobertura por modulo (backend/frontend/packages) para detectar outliers.
...
Normalizar rutas a forward slash (/) en todos los lcov.info antes de sonar-scanner.
Re-ejecutar tests de coverage y scan.
...
salida de sonar-scanner con sonar.qualitygate.wait=true
salida de APIs de metricas/issues/hotspots
