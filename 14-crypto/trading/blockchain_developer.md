...
url: https://skills.sh/sickn33/antigravity-awesome-skills/blockchain-developer
---

# blockchain-developer

skills/sickn33/antigravity-awesome-skills/blockchain-developer
blockchain-developer
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill blockchain-developer
Summary

Production-ready Web3 applications, smart contracts, DeFi protocols, NFT platforms, and enterprise blockchain systems.

Covers smart contract development across Solidity, Rust, and Vyper with advanced patterns, security auditing, gas optimization, and formal verification tools
Supports multiple blockchain ecosystems: Ethereum mainnet, Layer 2 solutions (Polygon, Arbitrum, Optimism), Solana, Cosmos, Polkadot, NEAR, and enterprise chains like Hyperledger Fabric
Includes DeFi protocol architecture (AMMs, lending, yield farming, derivatives), NFT standards and marketplaces, and Web3 frontend integration with wallet connectivity and dApp development
Addresses oracle integration, tokenomics design, cross-chain bridges, and enterprise use cases including supply chain, digital identity, and asset tokenization
Emphasizes security best practices, comprehensive testing, regulatory compliance, and production deployment strategies with monitoring and analytics
SKILL.md
Use this skill when
