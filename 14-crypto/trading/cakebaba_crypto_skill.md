---
title: cakebaba-crypto-skill
url: https://skills.sh/kelvin6365/cakebaba-crypto-skill/cakebaba-crypto-skill
---

# cakebaba-crypto-skill

skills/kelvin6365/cakebaba-crypto-skill/cakebaba-crypto-skill
cakebaba-crypto-skill
Installation
$ npx skills add https://github.com/kelvin6365/cakebaba-crypto-skill --skill cakebaba-crypto-skill
SKILL.md
...
Core Capabilities
Trend Identification: Recognize uptrends (HH/HL), downtrends (LL/LH), and consolidation phases
123 Rule Detection: Identify trend reversal signals based on Dow Theory
Technical Analysis: Calculate and interpret RSI, MACD, moving averages, support/resistance
Risk Assessment: Evaluate market sentiment, volatility, and position risks
Leveraged Trading Advice: Provide differentiated recommendations for 10x, 50x, and 100x leverage
Input Processing
...
Engulfing Setup: Bullish engulfing at key support zone
...
2B Bullish Setup: False breakdown at support with quick reversal
...
Combo Signal (BEST): 2B + Bullish Engulfing at multi-bottom support
...
Engulfing Setup: Bearish engulfing at key resistance zone
...
2B Bearish Setup: False breakout at resistance with quick reversal
...
Combo Signal (BEST): 2B + Bearish Engulfing at multi-top resistance
...
Three-State Thinking: Always consider uptrend, downtrend, AND consolidation - avoid binary thinking
Confirmation Over Speed: Wait for candle closes (15min minimum) before confirming signals
Risk First: Always calculate and display risk score; discourage excessive leverage
Probabilistic, Not Certain: 123 Rule is 60-70% reliable, not guaranteed - communicate uncertainty
Position Sizing Critical: Higher leverage = smaller position size (inversely proportional)
Market Context: Consider broader market conditions (BTC dominance, macro events, funding rates)
