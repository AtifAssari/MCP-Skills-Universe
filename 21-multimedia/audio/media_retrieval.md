...
url: https://skills.sh/qodex-ai/ai-agent-skills/media-retrieval
---

# media-retrieval

skills/qodex-ai/ai-agent-skills/media-retrieval
media-retrieval
Installation
$ npx skills add https://github.com/qodex-ai/ai-agent-skills --skill media-retrieval
SKILL.md
Video Downloader
