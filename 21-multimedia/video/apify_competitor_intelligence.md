...
url: https://skills.sh/apify/agent-skills/apify-competitor-intelligence
---

# apify-competitor-intelligence

skills/apify/agent-skills/apify-competitor-intelligence
apify-competitor-intelligence
Installation
...
Supports three output formats: quick chat display, CSV export, or JSON export with configurable result limits
Includes structured workflow with schema fetching, user preference collection, script execution, and findings summarization
SKILL.md
