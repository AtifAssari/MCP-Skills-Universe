...
rating: ⭐⭐⭐
title: ffmpeg-usage
url: https://skills.sh/zephyrwang6/myskill/ffmpeg-usage
---

# ffmpeg-usage

skills/zephyrwang6/myskill/ffmpeg-usage
ffmpeg-usage
Installation
$ npx skills add https://github.com/zephyrwang6/myskill --skill ffmpeg-usage
SKILL.md
ffmpeg 使用指南
概述
