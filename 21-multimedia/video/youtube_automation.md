...
url: https://skills.sh/aaaaqwq/claude-code-skills/youtube-automation
---

# youtube-automation

skills/aaaaqwq/claude-code-skills/youtube-automation
youtube-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill youtube-automation
SKILL.md
...
YOUTUBE_SUBSCRIBE_CHANNEL - Subscribe to a channel [Optional]
YOUTUBE_UNSUBSCRIBE_CHANNEL - Unsubscribe from a channel [Optional]
YOUTUBE_LIST_USER_SUBSCRIPTIONS - List subscriptions [Optional]
YOUTUBE_LIST_COMMENT_THREADS - List comments on a video [Optional]
