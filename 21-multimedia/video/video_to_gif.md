---
title: video-to-gif
url: https://skills.sh/microsoft/hve-core/video-to-gif
---

# video-to-gif

skills/microsoft/hve-core/video-to-gif
video-to-gif
Installation
$ npx skills add https://github.com/microsoft/hve-core --skill video-to-gif
SKILL.md
...
Workspace root (if inside a project)
~/Movies/ (macOS) or ~/Videos/ (Linux)
~/Downloads/
~/Desktop/
