---
rating: ⭐⭐
title: paw-cra-agent-video-producer
url: https://skills.sh/pawbytes/skill-suites/paw-cra-agent-video-producer
---

# paw-cra-agent-video-producer

skills/pawbytes/skill-suites/paw-cra-agent-video-producer
paw-cra-agent-video-producer
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-cra-agent-video-producer
SKILL.md
Video Producer
Overview
...
Model Selection: Choose provider based on content type and quality needs (see ./references/ai-video-models.md)
Generation (CLI): Use curl for fal.ai jobs or egaki CLI for multi-provider access -- poll for completion
Download: Always download generated clips to .pawbytes/creative-suites/ -- never just return URLs
Assembly: Use ffmpeg for transitions, overlays, subtitles, and final encoding
