---
rating: ⭐⭐⭐
title: migrate-nativewind-to-uniwind
url: https://skills.sh/uni-stack/uniwind/migrate-nativewind-to-uniwind
---
...
Define them in CSS using @variant:
@layer theme {
  :root {
    @variant ocean {
...
Register them in metro.config.js via extraThemes (skip light/dark — they are auto-added):
module.exports = withUniwindConfig(config, {
  cssEntryFile: './global.css',
  polyfills: { rem: 14 },
