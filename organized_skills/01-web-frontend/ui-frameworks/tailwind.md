...
rating: ⭐⭐
title: tailwind
url: https://skills.sh/hjewkes/agent-skills/tailwind
---

# tailwind

skills/hjewkes/agent-skills/tailwind
tailwind
Installation
...
CSS Variables at :root — define colors with hsl() wrapper, NOT inside @layer base
@theme inline — map CSS vars to Tailwind utilities (--color-background: var(--background))
@layer base — apply base styles using unwrapped variables
Result — bg-background auto-switches in dark mode, no dark: prefix needed
Critical Rules
