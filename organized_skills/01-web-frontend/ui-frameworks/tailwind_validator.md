---
rating: ⭐⭐⭐
title: tailwind-validator
url: https://skills.sh/shipshitdev/library/tailwind-validator
---

# tailwind-validator

skills/shipshitdev/library/tailwind-validator
tailwind-validator
Installation
...
Verify components.json uses CSS variables
Check that generated components use v4 patterns
Ensure @theme includes shadcn color tokens:
@theme {
