...
url: https://skills.sh/masonjames/shadcnblocks-skill/shadcn-ui-&-blocks
---

# shadcn ui & blocks

skills/masonjames/shadcnblocks-skill/Shadcn UI & Blocks
Shadcn UI & Blocks
Installation
...
Add to .env: SHADCNBLOCKS_API_KEY=<key>
...
Environment variable (simplest): Set SHADCNBLOCKS_API_KEY in your shell or .env file
1Password CLI: The helper script uses op read to retrieve the key. Set OP_SHADCNBLOCKS_REF to your 1Password reference path, or it defaults to op://Platform Infra/ShadcnBlocks API Key/credential
