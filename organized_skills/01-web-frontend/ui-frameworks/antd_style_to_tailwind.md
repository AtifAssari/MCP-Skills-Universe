---
rating: ⭐⭐⭐
title: antd-style-to-tailwind
url: https://skills.sh/dtyq/magic/antd-style-to-tailwind
---

# antd-style-to-tailwind

skills/dtyq/magic/antd-style-to-tailwind
antd-style-to-tailwind
Installation
...
Scan for hardcoded light colors without dark:
...
Use that interface as the parent's prop type:
...
Run lint. If you get "Unused '@ts-expect-error' directive" → the line is already clean, just delete the comment entirely.
- // @ts-ignore
...
Color mapping details: color-mapping.md
Weekly Installs
13
Repository
dtyq/magic
