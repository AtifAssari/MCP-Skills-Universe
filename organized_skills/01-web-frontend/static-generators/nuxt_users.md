...
rating: ⭐⭐
title: nuxt-users
url: https://skills.sh/rrd108/nuxt-users/nuxt-users
---

# nuxt-users

skills/rrd108/nuxt-users/nuxt-users
nuxt-users
Installation
...
Run migrations From the project root (where nuxt.config.ts lives):
...
Configure permissions (required for protected routes) Without auth.permissions, authenticated users cannot access protected routes. Prefer early configuration:
