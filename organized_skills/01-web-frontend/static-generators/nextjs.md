...
skills/jezweb/claude-skills/nextjs
nextjs
...
Update config: matcher → config.matcher (same syntax)
...
experimental.ppr flag - Evolved into Cache Components. Use "use cache" directive.
Automatic scroll-behavior: smooth - Add manually if needed.
