...
rating: ⭐⭐
title: ios-ux-design
url: https://skills.sh/mosif16/codex-skills/ios-ux-design
---

# ios-ux-design

skills/mosif16/codex-skills/ios-ux-design
ios-ux-design
Installation
...
Touch interaction and gesture verification ensuring 44x44pt minimum targets, standard iOS gestures, and thumb-zone optimization for one-handed use
Accessibility-first approach including VoiceOver support, Dynamic Type scaling, semantic colors, SF Symbols integration, and dark mode compliance
Implementation specifications with SwiftUI code examples, design tokens, typography standards, and handoff documentation for developer implementation
SKILL.md
