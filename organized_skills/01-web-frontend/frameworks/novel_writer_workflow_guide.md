---
rating: ⭐⭐
title: novel-writer-workflow-guide
url: https://skills.sh/wordflowlab/novel-writer-skills/novel-writer-workflow-guide
---

# novel-writer-workflow-guide

skills/wordflowlab/novel-writer-skills/novel-writer-workflow-guide
novel-writer-workflow-guide
Installation
$ npx skills add https://github.com/wordflowlab/novel-writer-skills --skill novel-writer-workflow-guide
Summary
...
Automatically activates genre-specific skills (Romance, Mystery, Fantasy) and writing technique skills (Dialogue, Scene Structure) based on project context
Supports multiple project scales from short stories to serialized novels with adjustable workflow intensity and pacing recommendations
Maintains visual progress tracking, decision history, and consistency validation across all chapters to catch problems early and enable rapid revisions
SKILL.md
