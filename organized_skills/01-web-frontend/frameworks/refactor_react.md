---
rating: ⭐⭐
title: refactor:react
url: https://skills.sh/snakeo/claude-debug-and-refactor-skills-plugin/refactor:react
---

# refactor:react

skills/snakeo/claude-debug-and-refactor-skills-plugin/refactor:react
refactor:react
Installation
...
Read the entire component and understand its purpose
Identify responsibilities (data fetching, state management, UI rendering, event handling)
List all props, state, and effects
Note any code smells or anti-patterns
Step 2: Plan the Refactoring
Determine if the component should be split
Identify logic that can be extracted to custom hooks
Plan prop/state restructuring
Consider TypeScript improvements
Step 3: Execute Incrementally
Extract custom hooks first (preserves behavior)
Split large components into smaller ones
Apply memoization where needed (pre-React 19)
...
Component is under 100 lines and has single responsibility
State is colocated - each piece of state is as close as possible to where it's used
Props are minimal - component receives only what it needs
No obvious code smells remain
TypeScript is happy - no any types, no type errors
Tests pass - behavior is preserved
Further changes would be premature optimization - don't optimize without evidence of performance issues
References
React 19 Official Blog
React Server Components
React Design Patterns
Josh Comeau's React Server Components Guide
Weekly Installs
34
Repository
