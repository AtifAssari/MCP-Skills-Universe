...
url: https://skills.sh/hieutrtr/ai1-skills/react-frontend-expert
---
...
Labels: Every form input has a <label> with matching htmlFor/id
ARIA only when needed: aria-label for icon-only buttons, aria-live for dynamic updates, role="alert" for errors
...
Alt text: All <img> tags have descriptive alt (or alt="" for decorative images)
Examples
