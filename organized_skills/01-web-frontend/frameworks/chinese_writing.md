...
url: https://skills.sh/miantiao-me/aigc-weekly/chinese-writing
---

# chinese-writing

skills/miantiao-me/aigc-weekly/chinese-writing
chinese-writing
Installation
$ npx skills add https://github.com/miantiao-me/aigc-weekly --skill chinese-writing
Summary

High-quality Chinese writing guide for newsletters, blogs, and tech content with anti-AI patterns.

Core principles emphasize warmth, clarity, and human voice—delete filler phrases, vary sentence rhythm, and trust readers to understand without hand-holding
Six anti-AI rules: remove padding words, break formula structures, mix long and short sentences, skip softening language, delete quotable phrases, and prioritize concrete details over abstract adjectives
Covers newsletter structure (headlines under 15 characters, 2–5 sentence summaries per item, embedded links), article techniques (small subheadings, clear viewpoints, personal tone), and vocabulary simplification (replace overused terms like "至关重要" with "重要")
Includes detailed anti-pattern tables identifying and fixing common AI writing tells: vague attribution, negation-based phrasing, overuse of em dashes, filler expressions, and passive constructions
Quick checklist for final review: sentence length variation, source specificity, list structure (avoid three-item lists), and readability tests
SKILL.md
中文写作技能指南
...
去 AI 味六原则
删除填充短语：去除「值得注意的是」「首先」等开场白和拐杖词
打破公式结构：避免二元对比、戏剧性分段、三段式列举（两项或四项更自然）
变化节奏：长短句混合，段落结尾多样化
信任读者：直接陈述，跳过软化、辩解和手把手引导
删除金句：如果听起来像可引用的语句，重写它
具体细节优先：用事实、数据、场景替代抽象形容词
2. 通用写作建议
2.1 基本原则
