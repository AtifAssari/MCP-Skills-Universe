---
rating: ⭐⭐
title: using-reacticx
url: https://skills.sh/rit3zh/reacticx/using-reacticx
---

# using-reacticx

skills/rit3zh/reacticx/using-reacticx
using-reacticx
Installation
$ npx skills add https://github.com/rit3zh/reacticx --skill using-reacticx
SKILL.md
Using Reacticx
Overview
...
Run npx reacticx add <cli-key>.
Install any missing dependencies listed in the component's docs.
Import and use the component from your outDir.
