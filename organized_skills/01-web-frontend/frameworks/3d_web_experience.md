...
url: https://skills.sh/davila7/claude-code-templates/3d-web-experience
---

# 3d-web-experience

skills/davila7/claude-code-templates/3d-web-experience
3d-web-experience
...
Enables scroll-driven 3D interactions using ScrollControls and GSAP integration for camera movement, model rotation, and reveal animations
Includes anti-patterns guidance on avoiding performance pitfalls: unnecessary 3D, desktop-only implementations, and missing loading states
SKILL.md
3D Web Experience
