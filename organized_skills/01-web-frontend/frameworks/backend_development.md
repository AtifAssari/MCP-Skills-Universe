...
url: https://skills.sh/mrgoonie/claudekit-skills/backend-development
---

# backend-development

skills/mrgoonie/claudekit-skills/backend-development
backend-development
Installation
...
Addresses scalability and performance through caching, database optimization, microservices architecture, and deployment strategies (Docker, Kubernetes, blue-green/canary)
Provides testing frameworks and CI/CD guidance with emphasis on the 70-20-10 testing pyramid and contract testing for microservices
Covers monitoring, logging, and debugging for production systems with OpenTelemetry and Prometheus/Grafana integration
SKILL.md
