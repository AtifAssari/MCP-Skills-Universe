...
url: https://skills.sh/tanstack-skills/tanstack-skills/tanstack-query
---

# tanstack-query

skills/tanstack-skills/tanstack-skills/tanstack-query
tanstack-query
Installation
...
Includes Suspense integration via useSuspenseQuery, SSR/hydration support, prefetching, and devtools for cache inspection
Offers TypeScript-first queryOptions helper for type-safe, reusable query configurations and full type inference across hooks and QueryClient methods
SKILL.md
Overview
...
Package: @tanstack/react-query Devtools: @tanstack/react-query-devtools Current Version: v5
...
Set appropriate staleTime - 0 means always refetch on mount (default), increase for less dynamic data
