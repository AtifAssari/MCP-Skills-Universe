...
url: https://skills.sh/sickn33/antigravity-awesome-skills/youtube-summarizer
---

# youtube-summarizer

skills/sickn33/antigravity-awesome-skills/youtube-summarizer
youtube-summarizer
Installation
...
Supports multiple YouTube URL formats and handles language preferences with fallback to English
Displays visual progress tracking throughout the workflow with step-by-step status updates and error handling for private videos, disabled transcripts, or unavailable content
SKILL.md
youtube-summarizer
Purpose
