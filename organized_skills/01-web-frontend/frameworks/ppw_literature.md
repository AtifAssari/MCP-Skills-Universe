---
rating: ⭐⭐
title: ppw:literature
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:literature
---

# ppw:literature

skills/lylll9436/paper-polish-workflow-skill/ppw:literature
ppw:literature
Installation
$ npx skills add https://github.com/lylll9436/paper-polish-workflow-skill --skill ppw:literature
SKILL.md
Purpose
...
Search query (required): the topic or keyword to search — ask only if not provided in the trigger message.
Result count (optional): how many results to display. Default: 5. Maximum: 10.
...
Add the Semantic Scholar server (server key: semanticscholar)
Restart Claude Code and retry"

Do NOT proceed past this point if MCP is unavailable.

Step 2: Collect Search Query
Extract the search topic from the trigger message if present.
If topic not provided, ask: "What topic or keywords should I search for?"
Confirm result count (default: 5).
