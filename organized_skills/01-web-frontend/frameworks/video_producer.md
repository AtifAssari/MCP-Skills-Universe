...
url: https://skills.sh/daffy0208/ai-dev-standards/video-producer
---

# video-producer

skills/daffy0208/ai-dev-standards/video-producer
video-producer
Installation
...
Includes fullscreen, picture-in-picture, volume control, playback speed adjustment, and subtitle/caption tracks
Provides quality selection UI, thumbnail preview on hover, and video upload with progress tracking
Built with React hooks and hls.js library for cross-browser compatibility
SKILL.md
