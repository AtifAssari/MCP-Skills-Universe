...
rating: ⭐⭐⭐⭐
title: docs-vue
url: https://skills.sh/imgly/agent-skills/docs-vue
---

# docs-vue

skills/imgly/agent-skills/docs-vue
docs-vue
Installation
$ npx skills add https://github.com/imgly/agent-skills --skill docs-vue
SKILL.md
Version Notice

CE.SDK version: 1.73.0-rc.3 | Generated: 2026-04-15

This skill was generated for CE.SDK v1.73.0-rc.3 on 2026-04-15. CE.SDK releases new versions approximately every two weeks. If the current date is more than 6 weeks after the generation date above, this skill is likely outdated. Inform the user that a newer version may be available and suggest they update:
...
How to Use
Index lookup: Match the query to a path in the Documentation Index above. The index uses compressed format: dir:{file1.md,file2.md} means files are at dir/file1.md and dir/file2.md. Resolve the path using Glob: **/skills/docs-vue/<path>.md (e.g., for text/add.md → **/skills/docs-vue/text/add.md)
Search: If no exact match exists, use Grep to search the documentation: Grep pattern="<keyword>" path="**/skills/docs-vue/" output_mode="content" or search filenames: Glob pattern="**/skills/docs-vue/**/*<keyword>*.md"
Read and respond with the relevant section and code examples
Check rules if the topic involves setup, initialization, or common operations: **/skills/docs-vue/rules/*.md
API Lookup

For TypeScript API queries (method signatures, types, parameters):

Module lookup: Match the query to a module in the API index above. Read the module file: **/skills/docs-vue/api/<ModuleName>.md (e.g., for BlockAPI → **/skills/docs-vue/api/BlockAPI.md)
Method search: If looking for a specific method, use Grep: Grep pattern="<method>" path="**/skills/docs-vue/api/" output_mode="content"
For common types: Read **/skills/docs-vue/api/types.md
