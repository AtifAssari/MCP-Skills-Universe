...
url: https://skills.sh/jsonlee12138/agent-team/task-splitting
---

# task-splitting

skills/jsonlee12138/agent-team/task-splitting
task-splitting
Installation
$ npx skills add https://github.com/jsonlee12138/agent-team --skill task-splitting
SKILL.md
Task Splitting
...
Workflow
Intake the source document.
Extract goals, constraints, deliverables, non-goals, and ambiguities.
Decide whether brainstorming is needed.
Draft tasks by function boundary.
Validate every task boundary.
Write one task file per task.
Ask for confirmation.
Create agent-team task packages from the approved files.
1. Intake the source
...
Use the template in references/task-file-template.md.
