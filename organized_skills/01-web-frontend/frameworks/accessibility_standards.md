...
url: https://skills.sh/maxritter/claude-codepro/accessibility-standards
---

# accessibility standards

skills/maxritter/claude-codepro/Accessibility Standards
Accessibility Standards
Installation
...
Don't override native semantics (<button role="link"> is wrong)
All interactive ARIA roles need keyboard support
