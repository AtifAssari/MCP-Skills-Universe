...
url: https://skills.sh/dpearson2699/swift-ios-skills/swiftui-uikit-interop
---

# swiftui-uikit-interop

skills/dpearson2699/swift-ios-skills/swiftui-uikit-interop
swiftui-uikit-interop
Installation
...
Set the delegate in makeUIView/makeUIViewController, never in updateUIView. The update method runs on every state change -- setting the delegate there causes redundant assignment and can trigger unexpected side effects.

The coordinator's parent property is updated automatically. SwiftUI updates the coordinator's reference to the latest representable struct value before each call to updateUIView. This means the coordinator always sees current @Binding values through parent.
