...
rating: ⭐⭐
title: nerdzao-elite
url: https://skills.sh/sickn33/antigravity-awesome-skills/nerdzao-elite
---

# nerdzao-elite

skills/sickn33/antigravity-awesome-skills/nerdzao-elite
nerdzao-elite
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill nerdzao-elite
SKILL.md
@nerdzao-elite
...
Planejamento (@concise-planning + @brainstorming)
Arquitetura sólida
Implementação com TDD completo
Código limpo
Validação técnica
Validação visual UX OBRIGATÓRIA (@ui-visual-validator + @ui-ux-pro-max) → corrija imediatamente qualquer duplicação, inconsistência de cor/label, formatação de moeda, alinhamento etc.
Revisão de produção
Verificação final
