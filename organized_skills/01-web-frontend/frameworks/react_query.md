...
rating: ⭐⭐
title: react-query
url: https://skills.sh/umxr/react-query-skills/react-query
---

# react-query

skills/umxr/react-query-skills/react-query
react-query
Installation
$ npx skills add https://github.com/umxr/react-query-skills --skill react-query
SKILL.md
