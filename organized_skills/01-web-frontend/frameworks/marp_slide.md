...
skills/softaworks/agent-toolkit/marp-slide
marp-slide
Installation
...
Supports image integration using Marp syntax for side layouts, full backgrounds, and multi-image compositions
Handles vague design requests ("make it look good," "make it cool") by inferring appropriate theme and applying automatic formatting improvements
SKILL.md
Marp Slide Creator
