...
rating: ⭐⭐
title: react-i18next
url: https://skills.sh/yildizberkay/skills/react-i18next
---
...
Create a resources type definition file
Augment the i18next module with your resource types
The t function then uses accessor syntax: t($ => $.my.key)
