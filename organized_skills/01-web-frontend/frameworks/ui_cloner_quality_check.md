---
rating: ⭐⭐
title: ui-cloner-quality-check
url: https://skills.sh/ragnar-pwninskjold/tech-snacks/ui-cloner-quality-check
---

# ui-cloner-quality-check

skills/ragnar-pwninskjold/tech-snacks/ui-cloner-quality-check
ui-cloner-quality-check
Installation
...
Generate the missing content inline using the correct format from the Site DNA (don't soften or approximate)
Insert it into the correct location in the prompt
Re-check that item before proceeding
...
Save output: Write the final verified prompt to plans/04-final-prompt.md in the current project directory.
Output the complete final prompt in a single fenced code block so the user can copy and paste it cleanly.
Confirm: "Your replication prompt is ready. Paste it into Claude or your preferred code generation tool to build the site. All phase outputs are saved in plans/."
Weekly Installs
13
Repository
