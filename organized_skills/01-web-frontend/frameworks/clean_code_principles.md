...
url: https://skills.sh/asyrafhussin/agent-skills/clean-code-principles
---

# clean-code-principles

skills/asyrafhussin/agent-skills/clean-code-principles
clean-code-principles
Installation
...
Provides quick reference tables, TypeScript code examples, and an audit output format for code reviews
Triggered by keywords like "review architecture," "SOLID principles," "design patterns," or "clean code"
SKILL.md
Clean Code Principles
