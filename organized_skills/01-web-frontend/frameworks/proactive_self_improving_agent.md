---
rating: ⭐⭐⭐⭐⭐
title: proactive-self-improving-agent
url: https://skills.sh/yanhongxi-openclaw/proactive-self-improving-agent/proactive-self-improving-agent
---

# proactive-self-improving-agent

skills/yanhongxi-openclaw/proactive-self-improving-agent/proactive-self-improving-agent
proactive-self-improving-agent
Installation
...
精炼：把冗长的经验浓缩为一条简洁的规则
写入：添加到目标文件的对应章节
更新原条目：Status → promoted，填写 Promoted-To
记录日志：在 CHANGELOG.md 追加一条 promote 记录
3.2 递归模式检测
...
将解决方案写成独立的、自包含的技能说明
更新原条目：Status → promoted_to_skill
记录日志：CHANGELOG.md 追加 extract 记录
3.4 安全护栏
