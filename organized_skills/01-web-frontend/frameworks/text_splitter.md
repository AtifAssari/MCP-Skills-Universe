...
rating: ⭐⭐⭐
title: text-splitter
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/text-splitter
---

# text-splitter

skills/vangongwanxiaowan/screen-creative-skills/text-splitter
text-splitter
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill text-splitter
SKILL.md
文本分割工具
功能
