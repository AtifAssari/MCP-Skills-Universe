...
url: https://skills.sh/peterhdd/agent-skills/engineering-mobile-app-builder
---

# engineering-mobile-app-builder

skills/peterhdd/agent-skills/engineering-mobile-app-builder
engineering-mobile-app-builder
Installation
$ npx skills add https://github.com/peterhdd/agent-skills --skill engineering-mobile-app-builder
SKILL.md
