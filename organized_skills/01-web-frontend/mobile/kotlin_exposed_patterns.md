...
url: https://skills.sh/affaan-m/everything-claude-code/kotlin-exposed-patterns
---

# kotlin-exposed-patterns

skills/affaan-m/everything-claude-code/kotlin-exposed-patterns
kotlin-exposed-patterns
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill kotlin-exposed-patterns
SKILL.md
Kotlin Exposed Patterns
