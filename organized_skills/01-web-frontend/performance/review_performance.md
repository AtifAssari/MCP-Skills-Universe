...
url: https://skills.sh/nesnilnehc/ai-cortex/review-performance
---

# review-performance

skills/nesnilnehc/ai-cortex/review-performance
review-performance
Installation
...
I/O 和网络成本：频繁的远程调用、缺少批处理、关键路径上的阻​​塞调用、无限制的重试/超时以及不良的退避行为。
