---
rating: ⭐⭐
title: roblox-performance
url: https://skills.sh/sentinelcore/roblox-skills/roblox-performance
---

# roblox-performance

skills/sentinelcore/roblox-skills/roblox-performance
roblox-performance
Installation
...
Press Ctrl+F6 in-game to open MicroProfiler.
Press Ctrl+P to pause and inspect a single frame.
Look for wide bars in heartbeatSignal (Lua), physicsStepped (physics), or render (GPU).
Label your own code:
RunService.Heartbeat:Connect(function()
