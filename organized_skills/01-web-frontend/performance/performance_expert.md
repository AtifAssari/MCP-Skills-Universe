...
url: https://skills.sh/shipshitdev/library/performance-expert
---

# performance-expert

skills/shipshitdev/library/performance-expert
performance-expert
Installation
...
Check .agents/SYSTEM/ARCHITECTURE.md for performance architecture
Identify performance tools (Lighthouse CI, APM)
Review existing optimizations and caching strategies
