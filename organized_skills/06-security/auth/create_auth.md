...
rating: ⭐⭐
title: create-auth
url: https://skills.sh/himself65/auth-spec/create-auth
---

# create-auth

skills/himself65/auth-spec/create-auth
create-auth
Installation
...
Look for framework config files (e.g., next.config.*, package.json, go.mod, Cargo.toml, pyproject.toml, build.gradle*, pom.xml)
Look for existing database/ORM setup (e.g., prisma/schema.prisma, drizzle.config.*, alembic/, diesel.toml, ormconfig.*)
