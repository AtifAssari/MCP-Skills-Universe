---
rating: ⭐⭐
title: vtex-io-auth-tokens-and-context
url: https://skills.sh/vtex/skills/vtex-io-auth-tokens-and-context
---

# vtex-io-auth-tokens-and-context

skills/vtex/skills/vtex-io-auth-tokens-and-context
vtex-io-auth-tokens-and-context
Installation
...
Reference
App authentication using auth tokens - Official token model for AUTH_TOKEN, STORE_TOKEN, and ADMIN_TOKEN
Using VTEX IO clients - Client usage patterns that complement token selection
