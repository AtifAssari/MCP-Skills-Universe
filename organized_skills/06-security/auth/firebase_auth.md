...
rating: ⭐⭐⭐
title: firebase-auth
url: https://skills.sh/jezweb/claude-skills/firebase-auth
---

# firebase-auth

skills/jezweb/claude-skills/firebase-auth
firebase-auth
Installation
...
#3	auth/requires-recent-login	Sensitive operations need fresh login	Re-authenticate before password change, delete	Docs
