...
rating: ⭐⭐
title: xhtml-author
url: https://skills.sh/profpowell/vanilla-breeze/xhtml-author
---

# xhtml-author

skills/profpowell/vanilla-breeze/xhtml-author
xhtml-author
Installation
...
Lowercase everything: Tags and attributes must be lowercase
Quote all attributes: Always use double quotes attr="value"
Close all tags: No implicit closing
Single h1: One <h1> per page only
Lowercase doctype: Use <!doctype html> not <!DOCTYPE html>
