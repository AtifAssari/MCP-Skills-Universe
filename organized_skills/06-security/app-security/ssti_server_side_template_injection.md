...
url: https://skills.sh/yaklang/hack-skills/ssti-server-side-template-injection
---

# ssti-server-side-template-injection

skills/yaklang/hack-skills/ssti-server-side-template-injection
ssti-server-side-template-injection
Installation
...
Application path — app.py or the real main filename
