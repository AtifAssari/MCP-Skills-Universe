...
url: https://skills.sh/yaklang/hack-skills/csrf-cross-site-request-forgery
---

# csrf-cross-site-request-forgery

skills/yaklang/hack-skills/csrf-cross-site-request-forgery
csrf-cross-site-request-forgery
Installation
...
Sends victim the crafted URL: https://target.com/oauth/callback?code=ATTACKER_CODE
...
Exploit XSS on blog.target.com
From XSS context, fetch API at api.target.com (CORS allows subdomain)
Read CSRF token from response
