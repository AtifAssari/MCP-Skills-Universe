...
rating: ⭐⭐⭐⭐⭐
title: api-security
url: https://skills.sh/hardw00t/ai-security-arsenal/api-security
---

# api-security

skills/hardw00t/ai-security-arsenal/api-security
api-security
Installation
$ npx skills add https://github.com/hardw00t/ai-security-arsenal --skill api-security
SKILL.md
...
GET /api/v1/users/456 HTTP/1.1 Authorization: Bearer <user_a_token>
