...
url: https://skills.sh/yaklang/hack-skills/xslt-injection
---

# xslt-injection

skills/yaklang/hack-skills/xslt-injection
xslt-injection
Installation
...
0. QUICK START
Find sinks: parameters named xslt, stylesheet, transform, template, SOAP stylesheets, report generators, XML→HTML converters.
Probe reflection: inject unique namespace or xsl:value-of select="'marker'" — if output changes, execution likely.
Fingerprint processor (§1).
