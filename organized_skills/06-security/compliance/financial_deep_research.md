...
url: https://skills.sh/eng0ai/eng0-template-skills/financial-deep-research
---

# financial-deep-research

skills/eng0ai/eng0-template-skills/financial-deep-research
financial-deep-research
Installation
$ npx skills add https://github.com/eng0ai/eng0-template-skills --skill financial-deep-research
Summary

Comprehensive financial research with multi-source synthesis, regulatory compliance tracking, and verified market analysis.

Executes 8-phase research pipeline (scope, plan, retrieve, triangulate, synthesize, critique, refine, package) with parallel data gathering across 5-10 concurrent sources and agents
Prioritizes Tier 1 regulatory sources (SEC EDGAR, Federal Reserve, company filings) with credibility scoring and citation verification to prevent hallucinated financial claims
Supports four execution modes (quick 2-5 min, standard 5-10 min, deep 10-20 min, ultradeep 20-45+ min) with progressive report assembly enabling unlimited output length
Generates three output formats (markdown, McKinsey-style HTML, professional PDF) with financial metrics dashboards, data tables, and organized folder structure for easy accessibility
Enforces strict anti-hallucination protocols: every financial claim requires immediate source citation [N], explicit fact-vs-analysis distinction, and automated validation of 9 quality checks including source count, citation accuracy, and financial data consistency
SKILL.md
Financial Deep Research
