...
skills/wshobson/agents/gdpr-data-handling
gdpr-data-handling
Installation
...
Covers privacy-by-design patterns including data minimization, encryption, pseudonymization, and separation of PII from behavioral data
Offers compliance checklist and best practices for legal bases, transparency, security, and documentation requirements
SKILL.md
GDPR Data Handling
