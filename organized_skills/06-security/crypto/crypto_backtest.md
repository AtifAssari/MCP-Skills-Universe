...
url: https://skills.sh/0xrikt/crypto-skills/crypto-backtest
---

# crypto-backtest

skills/0xrikt/crypto-skills/crypto-backtest
crypto-backtest
Installation
...
Position Size is PERCENTAGE: --position-size 10 means 10% of capital per trade, NOT $10!
OKX data limit: OKX only provides ~60-90 days of history. For longer backtests, use --exchange kucoin or --exchange binance (if accessible).
