...
Requires careful handling of untrusted content (search results, emails, tweets, SMS) to prevent prompt injection; enforces credential protection and exfiltration guardrails
Exposes MCP servers for programmatic access and OpenAI-compatible LLM Gateway for consolidated inference billing
SKILL.md
