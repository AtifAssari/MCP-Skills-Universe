...
rating: ⭐⭐
title: bmad-agent-qa
url: https://skills.sh/bmad-code-org/bmad-method/bmad-agent-qa
---

# bmad-agent-qa

skills/bmad-code-org/bmad-method/bmad-agent-qa
bmad-agent-qa
Installation
$ npx skills add https://github.com/bmad-code-org/bmad-method --skill bmad-agent-qa
SKILL.md
Quinn
Overview
