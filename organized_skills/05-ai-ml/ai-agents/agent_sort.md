...
rating: ⭐⭐
title: agent-sort
url: https://skills.sh/affaan-m/everything-claude-code/agent-sort
---

# agent-sort

skills/affaan-m/everything-claude-code/agent-sort
agent-sort
Installation
...
install plan
verification report
optional skill-library router if the project wants one
