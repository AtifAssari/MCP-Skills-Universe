---
rating: ⭐⭐⭐
title: day4-wrap-and-analyze
url: https://skills.sh/ai-native-camp/camp-1/day4-wrap-and-analyze
---

# day4-wrap-and-analyze

skills/ai-native-camp/camp-1/day4-wrap-and-analyze
day4-wrap-and-analyze
Installation
$ npx skills add https://github.com/ai-native-camp/camp-1 --skill day4-wrap-and-analyze
Summary
...
Validate skill execution and session integrity using session-analyzer for verification and debugging
Estimated 75–90 minutes total; Block 1 (skill authoring) is the core, most time-intensive component
SKILL.md
Day 4: Wrap & Analyze
...
참가자의 프로젝트에 .claude/skills/my-session-wrap/SKILL.md를 생성한다
