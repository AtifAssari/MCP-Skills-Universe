---
rating: ⭐⭐⭐
title: playwright-local
url: https://skills.sh/jezweb/claude-skills/playwright-local
---

# playwright-local

skills/jezweb/claude-skills/playwright-local
playwright-local
Installation
...
Write script with Bash tool: npx tsx scrape.ts https://example.com
Capture JSON output
...
Check references/common-blocks.md for site-specific blocks
Verify stealth setup at https://bot.sannysoft.com/
Check official docs: https://playwright.dev/docs/intro
Ensure browser binaries are installed: npx playwright install chromium
