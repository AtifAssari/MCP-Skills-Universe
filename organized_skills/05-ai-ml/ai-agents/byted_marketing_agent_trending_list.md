...
url: https://skills.sh/bytedance/agentkit-samples/byted-marketing-agent-trending-list
---

# byted-marketing-agent-trending-list

skills/bytedance/agentkit-samples/byted-marketing-agent-trending-list
byted-marketing-agent-trending-list
Installation
$ npx skills add https://github.com/bytedance/agentkit-samples --skill byted-marketing-agent-trending-list
SKILL.md
趋势榜单（TrendingList）
When to Use
