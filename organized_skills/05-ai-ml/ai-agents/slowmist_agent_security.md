---
rating: ⭐⭐
title: slowmist-agent-security
url: https://skills.sh/slowmist/slowmist-agent-security/slowmist-agent-security
---

# slowmist-agent-security

skills/slowmist/slowmist-agent-security/slowmist-agent-security
slowmist-agent-security
Installation
$ npx skills add https://github.com/slowmist/slowmist-agent-security --skill slowmist-agent-security
SKILL.md
