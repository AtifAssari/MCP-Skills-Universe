...
rating: ⭐⭐⭐
title: agent-factory
url: https://skills.sh/alirezarezvani/claude-code-skill-factory/agent-factory
---

# agent-factory

skills/alirezarezvani/claude-code-skill-factory/agent-factory
agent-factory
Installation
...
Copy entire prompt - Include filled variables
Paste into Claude - Claude.ai, Claude Code, or API
Receive agent file - Complete .md file ready to use
Install agent - Copy to .claude/agents/ or ~/.claude/agents/
Example Invocation
@agent-factory
