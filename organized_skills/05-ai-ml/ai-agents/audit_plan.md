...
rating: ⭐⭐⭐
title: audit-plan
url: https://skills.sh/darraghh1/my-claude-setup/audit-plan
---

# audit-plan

skills/darraghh1/my-claude-setup/audit-plan
audit-plan
Installation
...
Phase table — all phases with titles, status, and any noted issues
...
Context hygiene: "Consider running /compact before starting the next workflow step."
