...
url: https://skills.sh/codexclawd/codexclawd/finance-research-agent
---

# finance-research-agent

skills/codexclawd/codexclawd/finance-research-agent
finance-research-agent
Installation
...
Customization: Reports use Jinja2 templates. Edit templates in assets/templates/ to change format, add sections, or modify branding.
...
Calculate RSI(14)
Generate snapshot_report.md using template
Output report + key takeaways
...
Generate full report with charts (matplotlib plots saved to assets/charts/)
...
Save full report to memory/daily_briefings/YYYY-MM-DD.md
Configuration
