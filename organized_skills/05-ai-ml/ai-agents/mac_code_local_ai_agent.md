---
rating: ⭐⭐⭐
title: mac-code-local-ai-agent
url: https://skills.sh/aradotso/trending-skills/mac-code-local-ai-agent
---

# mac-code-local-ai-agent

skills/aradotso/trending-skills/mac-code-local-ai-agent
mac-code-local-ai-agent
Installation
