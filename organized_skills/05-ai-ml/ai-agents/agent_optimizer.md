...
url: https://skills.sh/chujianyun/skills/agent-optimizer
---

# agent-optimizer

skills/chujianyun/skills/agent-optimizer
agent-optimizer
Installation
$ npx skills add https://github.com/chujianyun/skills --skill agent-optimizer
SKILL.md
Agent Optimizer
...
弄清楚用户的目标和约束（单 Agent 还是多 Agent？是否已有工作流？）
对照 12 个因素，给出具体设计建议
按层次推进：先基础层够用再考虑规模层
提供具体的结构示例（文件结构、Prompt 设计、交接格式等）
