---
rating: ⭐⭐⭐
title: openclaw-audit-watchdog
url: https://skills.sh/prompt-security/clawsec/openclaw-audit-watchdog
---

# openclaw-audit-watchdog

skills/prompt-security/clawsec/openclaw-audit-watchdog
openclaw-audit-watchdog
Installation
...
Supports environment variable provisioning for MDM/automated deployments, with minimal interactive prompts as fallback
Includes opt-in suppression mechanism to allowlist reviewed findings while preserving them in reports under an informational section
Requires bash and curl; integrates with the cron tool for job scheduling and the message tool for report delivery
SKILL.md
