...
url: https://skills.sh/nickcrew/claude-ctx-plugin/testing-skills-with-subagents
---

# testing-skills-with-subagents

skills/nickcrew/claude-ctx-plugin/testing-skills-with-subagents
testing-skills-with-subagents
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill testing-skills-with-subagents
SKILL.md
Testing Skills With Subagents
Overview
