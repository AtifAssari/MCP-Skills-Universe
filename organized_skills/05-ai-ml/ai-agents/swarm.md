...
rating: ⭐⭐⭐
title: swarm
url: https://skills.sh/boshu2/agentops/swarm
---

# swarm

skills/boshu2/agentops/swarm
swarm
Installation
...
Serial-first for monolith packages: If multiple workers target the same package AND that package has a shared testutil_test.go or >5 existing test files, force serial execution within that package.
...
If worktreePath is absent but isolation: worktree was specified:
