...
rating: ⭐⭐
title: agent-creator
url: https://skills.sh/krzysztofsurdy/code-virtuoso/agent-creator
---

# agent-creator

skills/krzysztofsurdy/code-virtuoso/agent-creator
agent-creator
Installation
$ npx skills add https://github.com/krzysztofsurdy/code-virtuoso --skill agent-creator
SKILL.md
Agent Creator
...
Decision tree
Does the agent do one repeatable task type (review this PR, investigate this area, audit dependencies)? -> Specialist
Does the agent own a domain across many task types and benefit from remembering context across sessions (requirements, architecture decisions, risk register)? -> Role
Does the agent need to spawn and coordinate other agents working in parallel (research teams, multi-layer refactors)? -> Team-Lead
