---
rating: ⭐⭐
title: qcsd-ideation-swarm
url: https://skills.sh/proffesor-for-testing/agentic-qe/qcsd-ideation-swarm
---

# qcsd-ideation-swarm

skills/proffesor-for-testing/agentic-qe/qcsd-ideation-swarm
qcsd-ideation-swarm
Installation
...
Steps
Flag Detection -- steps/01-flag-detection.md -- Fetch URL content (browser cascade), detect all 7 flags (HAS_UI, HAS_SECURITY, HAS_UX, HAS_VIDEO, HAS_MIDDLEWARE, HAS_SAP_INTEGRATION, HAS_AUTHORIZATION)
Core Agents -- steps/02-core-agents.md -- Spawn qe-quality-criteria-recommender, qe-risk-assessor, qe-requirements-validator in parallel
...
Decision Synthesis -- steps/05-decision-synthesis.md -- Apply GO/CONDITIONAL/NO-GO logic
Report Generation -- steps/06-report-generation.md -- Generate executive summary and full report
Learning Persistence -- steps/07-learning-persistence.md -- Store findings to memory, save persistence record, include video follow-up recommendation
Final Output -- steps/08-final-output.md -- Display completion summary with all scores and follow-up recommendations
Execution Instructions
Use the Read tool to load the current step file (e.g., Read({ file_path: ".claude/skills/qcsd-ideation-swarm/steps/01-flag-detection.md" }))
