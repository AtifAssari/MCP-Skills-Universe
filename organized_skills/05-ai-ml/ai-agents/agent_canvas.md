...
rating: ⭐⭐⭐
title: agent-canvas
url: https://skills.sh/whq25/agent-canvas/agent-canvas
---

# agent-canvas

skills/whq25/agent-canvas/agent-canvas
agent-canvas
Installation
...
Coordinates: Origin (0,0) is top-left. X→right, Y→down. Colors in hex (#FF5733) or transparent.
...
Batch Commands: Chain with && for efficiency. DO NOT WRITE BASH COMMENT IN DRAWING COMMANDS
