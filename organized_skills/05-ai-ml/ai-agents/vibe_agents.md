...
rating: ⭐⭐⭐
title: vibe-agents
url: https://skills.sh/khazp/vibe-coding-prompt-template/vibe-agents
---

# vibe-agents

skills/khazp/vibe-coding-prompt-template/vibe-agents
vibe-agents
Installation
...
Prerequisites
Look for docs/PRD-*.md - REQUIRED
Look for docs/TechDesign-*.md - REQUIRED
