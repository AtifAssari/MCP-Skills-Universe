---
rating: ⭐⭐
title: dbs-agent-migration
url: https://skills.sh/dontbesilent2025/dbskill/dbs-agent-migration
---

# dbs-agent-migration

skills/dontbesilent2025/dbskill/dbs-agent-migration
dbs-agent-migration
Installation
...
已有 CLAUDE.md + AGENTS.md + skills/
只有 CLAUDE.md
只有 AGENTS.md
skill 散落在项目各处，根本没有 skills/
...
扫描类似 SKILL.md、*skill*.md、带明确触发方式和执行步骤的文件
排除文章、备份、测试案例、导出稿
生成“候选真源清单”
告诉用户哪些建议收编、哪些不建议
用户确认后，再新建项目级 skills/
