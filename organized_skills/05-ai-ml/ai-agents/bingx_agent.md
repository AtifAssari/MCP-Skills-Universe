...
rating: ⭐⭐⭐
title: bingx-agent
url: https://skills.sh/bingx-api/api-ai-skills/bingx-agent
---

# bingx-agent

skills/bingx-api/api-ai-skills/bingx-agent
bingx-agent
Installation
$ npx skills add https://github.com/bingx-api/api-ai-skills --skill bingx-agent
SKILL.md
BingX Agent
