...
skills/supercent-io/skills-template/bmad-idea
bmad-idea
Installation
...
Brainstorming agent covers 36 techniques across 7 categories; storytelling agent provides 25 proven story frameworks; problem-solving agent uses TRIZ, Theory of Constraints, and Five Whys
All workflows available immediately without sequential phases; load individual agents directly or run "creative squad" for a full cross-functional session
Supports Mermaid diagrams, Excalidraw flowcharts, and optional AI image generation via Gemini Nano
SKILL.md
