...
url: https://skills.sh/galaxy-dawn/claude-scholar/agent-identifier
---

# agent-identifier

skills/galaxy-dawn/claude-scholar/agent-identifier
agent-identifier
Installation
$ npx skills add https://github.com/galaxy-dawn/claude-scholar --skill agent-identifier
SKILL.md
