...
skills/supercent-io/skills-template/oh-my-codex
oh-my-codex
Installation
...
Offers workflow skills for autonomous development, test-driven development, security audits, build fixing, and comprehensive code review with configurable reasoning levels
Provides hook extensions for lifecycle events, project-level agent customization via AGENTS.md injection, and diagnostic tools for setup validation
SKILL.md
