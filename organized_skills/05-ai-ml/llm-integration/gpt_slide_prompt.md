---
rating: ⭐⭐
title: gpt-slide-prompt
url: https://skills.sh/jyoung105/future-slide-skill/gpt-slide-prompt
---

# gpt-slide-prompt

skills/jyoung105/future-slide-skill/gpt-slide-prompt
gpt-slide-prompt
Installation
$ npx skills add https://github.com/jyoung105/future-slide-skill --skill gpt-slide-prompt
SKILL.md
...
select the correct layout family from DESIGN.md
map the content into a clear slide hierarchy
...
Do not paste raw text into prompts. Instead:
...
every slide prompt matches a slide in the plan
numbering is sequential and complete
body-slide consistency rules are repeated where needed
the deck still reflects the extracted DESIGN.md
page prompts are detailed enough to generate slides without guessing the whole layout
title page, body pages, and end page each preserve their intended flow
header / body / footer placement is explicit
icon / infographic / diagram usage is explicit where relevant
table / chart usage is explicit where relevant
Weekly Installs
28
Repository
