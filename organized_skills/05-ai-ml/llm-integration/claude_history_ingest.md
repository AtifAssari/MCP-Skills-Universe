...
url: https://skills.sh/ar9av/obsidian-wiki/claude-history-ingest
---

# claude-history-ingest

skills/ar9av/obsidian-wiki/claude-history-ingest
claude-history-ingest
Installation
...
Before You Start
Read .env to get OBSIDIAN_VAULT_PATH and CLAUDE_HISTORY_PATH (defaults to ~/.claude)
