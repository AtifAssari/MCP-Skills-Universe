---
rating: ⭐⭐⭐
title: fastgpt-workflow-generator
url: https://skills.sh/yyh211/claude-meta-skill/fastgpt-workflow-generator
---

# fastgpt-workflow-generator

skills/yyh211/claude-meta-skill/fastgpt-workflow-generator
fastgpt-workflow-generator
Installation
$ npx skills add https://github.com/yyh211/claude-meta-skill --skill fastgpt-workflow-generator
SKILL.md
FastGPT Workflow Generator
...
Fixed IDs: workflowStart, userGuide (systemConfig)
Semantic naming: Generate based on node name (remove spaces and Chinese, convert to camelCase)
Uniqueness guarantee: If conflict, add _1, _2 suffix
