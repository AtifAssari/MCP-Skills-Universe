...
url: https://skills.sh/vtex/skills/marketplace-fulfillment
---

# marketplace-fulfillment

skills/vtex/skills/marketplace-fulfillment
marketplace-fulfillment
Installation
$ npx skills add https://github.com/vtex/skills --skill marketplace-fulfillment
SKILL.md
...
Order Invoice Notification API — POST invoice to OMS (orderId in path = marketplace order)
Update Order Tracking API — PATCH tracking on an invoice
Order Flow and Status — Order status lifecycle
