---
rating: ⭐⭐⭐
title: claude-code-history-files-finder
url: https://skills.sh/daymade/claude-code-skills/claude-code-history-files-finder
---

# claude-code-history-files-finder

skills/daymade/claude-code-skills/claude-code-history-files-finder
claude-code-history-files-finder
Installation
