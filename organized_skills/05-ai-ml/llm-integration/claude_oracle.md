...
rating: ⭐⭐
title: claude-oracle
url: https://skills.sh/vvkmnn/claude-oracle-mcp/claude-oracle
---

# claude-oracle

skills/vvkmnn/claude-oracle-mcp/claude-oracle
claude-oracle
Installation
$ npx skills add https://github.com/vvkmnn/claude-oracle-mcp --skill claude-oracle
SKILL.md
Claude Oracle
