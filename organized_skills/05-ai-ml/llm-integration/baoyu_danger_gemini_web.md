...
url: https://skills.sh/questnova502/claude-skills-sync/baoyu-danger-gemini-web
---

# baoyu-danger-gemini-web

skills/questnova502/claude-skills-sync/baoyu-danger-gemini-web
baoyu-danger-gemini-web
Installation
$ npx skills add https://github.com/questnova502/claude-skills-sync --skill baoyu-danger-gemini-web
SKILL.md
Gemini Web Client
...
.baoyu-skills/baoyu-danger-gemini-web/EXTEND.md (project)
~/.baoyu-skills/baoyu-danger-gemini-web/EXTEND.md (user)
