...
url: https://skills.sh/enderfga/openclaw-claude-code-skill/claude-code-skill
---

# claude-code-skill

skills/enderfga/openclaw-claude-code-skill/claude-code-skill
claude-code-skill
Installation
$ npx skills add https://github.com/enderfga/openclaw-claude-code-skill --skill claude-code-skill
SKILL.md
Claude Code Skill
