...
rating: ⭐⭐⭐
title: claude-code
url: https://skills.sh/hw10181913/openclaw-skill-claude-code/claude-code
---

# claude-code

skills/hw10181913/openclaw-skill-claude-code/claude-code
claude-code
Installation
...
Follow Order: constitution → specify → plan → tasks → implement
Validate: Use /speckit.checklist before declaring done
