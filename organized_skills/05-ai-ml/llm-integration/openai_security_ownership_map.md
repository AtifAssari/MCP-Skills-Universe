---
rating: ⭐⭐⭐
title: openai-security-ownership-map
url: https://skills.sh/trailofbits/skills-curated/openai-security-ownership-map
---

# openai-security-ownership-map

skills/trailofbits/skills-curated/openai-security-ownership-map
openai-security-ownership-map
Installation
$ npx skills add https://github.com/trailofbits/skills-curated --skill openai-security-ownership-map
SKILL.md
