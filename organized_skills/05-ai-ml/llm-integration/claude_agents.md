...
rating: ⭐⭐⭐
title: claude-agents
url: https://skills.sh/vinnie357/claude-skills/claude-agents
---

# claude-agents

skills/vinnie357/claude-skills/claude-agents
claude-agents
Installation
$ npx skills add https://github.com/vinnie357/claude-skills --skill claude-agents
SKILL.md
Claude Code Agents
