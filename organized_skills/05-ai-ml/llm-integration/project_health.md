...
url: https://skills.sh/jezweb/claude-skills/project-health
---

# project-health

skills/jezweb/claude-skills/project-health
project-health
Installation
...
Audits existing projects via parallel sub-agents: Permission Auditor scans for leaked secrets, stale MCP servers, permission gaps, and legacy syntax; Context Auditor checks CLAUDE.md quality, detects oversized files, and flags missing documentation
Supports six modes: full health check, new project setup, permission tidying, session learnings capture, preset addition, and context restructuring with size targets (root CLAUDE.md 50–150 lines, sub-directory 15–50 lines)
Uses sub-agents for heavy analysis to keep main context clean; launches Permission and Context Auditors in parallel for efficiency
SKILL.md
Project Health
...
Optionally (ask first): git init + gh repo create
...
Present plan, apply after approval
Size Targets
File	Target	Maximum
