...
url: https://skills.sh/astro-han/karpathy-llm-wiki/karpathy-llm-wiki
---

# karpathy-llm-wiki

skills/astro-han/karpathy-llm-wiki/karpathy-llm-wiki
karpathy-llm-wiki
Installation
...
Scan wiki/index.md entries in other topics for articles covering related concepts.
Update every article whose content is materially affected. Each updated file gets its Updated date refreshed.
...
Read those articles and synthesize an answer.
Prefer wiki content over your own training knowledge. Cite sources with markdown links: [Article Title](wiki/topic/article.md) (project-root-relative paths for in-conversation citations; within wiki/ files, use paths relative to the current file).
...
Write the answer as a new wiki page. See references/archive-template.md. When converting conversation citations to the archive page, rewrite project-root-relative paths (e.g., wiki/topic/article.md) to file-relative paths (e.g., ../topic/article.md or article.md for same-directory).
