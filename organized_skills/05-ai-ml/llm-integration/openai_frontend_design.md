---
rating: ⭐⭐
title: openai-frontend-design
url: https://skills.sh/fcakyon/claude-codex-settings/openai-frontend-design
---

# openai-frontend-design

skills/fcakyon/claude-codex-settings/openai-frontend-design
openai-frontend-design
Installation
$ npx skills add https://github.com/fcakyon/claude-codex-settings --skill openai-frontend-design
SKILL.md
