---
rating: ⭐⭐⭐
title: gpt-slide-design
url: https://skills.sh/jyoung105/future-slide-skill/gpt-slide-design
---

# gpt-slide-design

skills/jyoung105/future-slide-skill/gpt-slide-design
gpt-slide-design
Installation
$ npx skills add https://github.com/jyoung105/future-slide-skill --skill gpt-slide-design
SKILL.md
...
This is not an OCR task. This is not a slide-summary task. This is not a content-rewrite task.
...
Use the strongest available design reference, not only a single screenshot. Recommended inputs include:
...
When a PDF is available, prefer report PDFs or structured analytical documents over loose text documents. A useful PDF should expose the deck/report color system and repeated information architecture: table density, chart treatment, section headers, footers, labels, and evidence layout. Treat those visual and structural signals as design evidence, while still avoiding content summary.
...
DESIGN.md is a semantic presentation design specification. It is the slide deck equivalent of a design system or style guide. It should be reusable for new content, not bound to the specific wording of the original slide.
...
You must explicitly define what “body slides” should look like across the deck. This is critical. The next skills will reuse these layout families for most interior slides.
...
You described design, not content.
You separated observed vs inferred.
You included reusable layout families.
You included chart style and table style if visible or likely relevant.
You stated body-slide consistency rules.
You listed anti-patterns.
You defined header / body / footer flow.
You covered title page, body page, and end page behavior.
You described icon usage and infographic / diagram behavior.
Weekly Installs
28
Repository
jyoung105/futur…de-skill
GitHub Stars
56
First Seen
3 days ago
