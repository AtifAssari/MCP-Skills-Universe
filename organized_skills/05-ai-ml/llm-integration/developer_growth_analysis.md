...
url: https://skills.sh/composiohq/awesome-claude-skills/developer-growth-analysis
---

# developer-growth-analysis

skills/composiohq/awesome-claude-skills/developer-growth-analysis
developer-growth-analysis
Installation
$ npx skills add https://github.com/composiohq/awesome-claude-skills --skill developer-growth-analysis
Summary

Analyzes your recent Claude Code chats to identify coding patterns, skill gaps, and curates personalized learning resources delivered to Slack.

Reads your local chat history from the past 24-48 hours to understand projects, technologies, and challenges you've encountered
Identifies 3-5 prioritized improvement areas with evidence-based recommendations grounded in your actual work patterns
Searches HackerNews to curate 2-3 high-quality learning resources for each improvement area, tailored to your specific gaps
Generates a comprehensive report covering work summary, improvement areas, observed strengths, action items, and curated resources
Automatically sends the complete formatted report to your Slack DMs for easy reference throughout the week
SKILL.md
Developer Growth Analysis
