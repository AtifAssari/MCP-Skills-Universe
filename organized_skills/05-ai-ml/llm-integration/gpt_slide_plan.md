---
rating: ⭐⭐
title: gpt-slide-plan
url: https://skills.sh/jyoung105/future-slide-skill/gpt-slide-plan
---

# gpt-slide-plan

skills/jyoung105/future-slide-skill/gpt-slide-plan
gpt-slide-plan
Installation
$ npx skills add https://github.com/jyoung105/future-slide-skill --skill gpt-slide-plan
SKILL.md
...
It is also a page-system architecture step. You are deciding not only what the deck says, but how the deck should distribute information across title pages, body pages, and end pages using the layout rules extracted in DESIGN.md.
...
the deck begins in a way that orients the audience
the middle advances the argument rather than repeating it
the end resolves with action, implication, or takeaway
each slide maps to evidence
the chosen layout family is compatible with DESIGN.md
interior/body slides follow a coherent layout system
any split topic has a clear multi-slide progression rather than repeated pages
title page, body pages, and end page each have clear and distinct jobs
icon / infographic / diagram usage is explicitly planned where relevant
header / body / footer placement logic is explicit rather than implied
table-heavy or chart-heavy evidence is explicitly planned where relevant
Weekly Installs
27
Repository
