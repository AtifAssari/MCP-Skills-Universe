---
rating: ⭐⭐⭐
title: pw-danger-gemini-web
url: https://skills.sh/plugins-world/pw-skills/pw-danger-gemini-web
---

# pw-danger-gemini-web

skills/plugins-world/pw-skills/pw-danger-gemini-web
pw-danger-gemini-web
Installation
$ npx skills add https://github.com/plugins-world/pw-skills --skill pw-danger-gemini-web
SKILL.md
Gemini Web 客户端
...
.pw-skills/pw-danger-gemini-web/EXTEND.md (项目级)
~/.pw-skills/pw-danger-gemini-web/EXTEND.md (用户级)
