---
rating: ⭐⭐
title: claude-docs-consultant
url: https://skills.sh/zpankz/mcp-skillset/claude-docs-consultant
---

# claude-docs-consultant

skills/zpankz/mcp-skillset/claude-docs-consultant
claude-docs-consultant
Installation
...
Identify need: Not covered by the 4 common docs
Fetch docs map: claude_code_docs_map.md
Discover: Find relevant doc (e.g., settings.md)
Fetch specific doc: https://docs.claude.com/en/docs/claude-code/settings.md
Apply: Configure settings.json correctly
Best Practices
Token Efficiency
