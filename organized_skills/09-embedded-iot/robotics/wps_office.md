...
rating: ⭐⭐
title: wps-office
url: https://skills.sh/lc2panda/wps-skills/wps-office
---

# wps-office

skills/lc2panda/wps-skills/wps-office
wps-office
Installation
...
Supports batch operations including format conversion, multi-file processing, and template application across documents
Routes single-application requests to specialized skills while coordinating multi-app scenarios through intelligent request analysis and error handling
SKILL.md
WPS Office 跨应用智能助手
