---
rating: ⭐⭐⭐
title: marketing-skills-collection
url: https://skills.sh/supercent-io/skills-template/marketing-skills-collection
---

# marketing-skills-collection

skills/supercent-io/skills-template/marketing-skills-collection
marketing-skills-collection
Installation
$ npx skills add https://github.com/supercent-io/skills-template --skill marketing-skills-collection
Summary

Generate marketing deliverables across CRO, copywriting, SEO, analytics, and growth using 23 specialized sub-skills.

Covers five marketing domains with 23 sub-skills: CRO (landing pages, signup flows, forms, paywalls), copywriting (ads, email sequences, social content), SEO (audits, programmatic pages, schema markup), ads/analytics (tracking, paid ads, A/B testing), and strategy/growth (launch, pricing, retention, churn, experiments, referral programs, content strategy)
Structured workflow: define objective and constraints, select the appropriate sub-skill, build a prompt with product context and audience details, generate and validate output, then implement with tracking and measurement
Each deliverable includes KPI alignment, target audience fit, brand voice consistency, and actionable outputs with A/B test proposals and success metrics
Designed for repeatable, high-quality asset generation tied to single marketing KPIs across channels (landing pages, email, social, SEO, paid ads)
SKILL.md
Marketing Skills Collection
...
Cause: Vague product/audience information Solution: Provide positioning, competitors, and proof points

Issue: Output conflicts with brand voice

Cause: No tone/voice constraints provided Solution: Provide brand do/don't list and sample copy
