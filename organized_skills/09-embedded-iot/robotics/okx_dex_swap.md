...
rating: ⭐⭐⭐
title: okx-dex-swap
url: https://skills.sh/okx/onchainos-skills/okx-dex-swap
---

# okx-dex-swap

skills/okx/onchainos-skills/okx-dex-swap
okx-dex-swap
Installation
...
CLI TOKEN_MAP (pass directly as --from/--to): native: sol eth bnb okb matic pol avax ftm trx sui; stablecoins: usdc usdt dai; wrapped: weth wbtc wbnb wmatic
onchainos token search --query <symbol> --chains <chain> — for all other symbols
