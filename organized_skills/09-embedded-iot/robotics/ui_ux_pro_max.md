...
rating: ⭐⭐⭐
title: ui-ux-pro-max
url: https://skills.sh/davila7/claude-code-templates/ui-ux-pro-max
---

# ui-ux-pro-max

skills/davila7/claude-code-templates/ui-ux-pro-max
ui-ux-pro-max
...
Covers 9 implementation stacks: HTML/Tailwind, React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, and shadcn/ui with stack-specific best practices
Pre-delivery checklist covering visual quality, interaction, light/dark mode contrast, layout, and accessibility to catch common professional UI issues
SKILL.md
