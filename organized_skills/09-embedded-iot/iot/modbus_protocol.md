...
url: https://skills.sh/jnzader/project-starter-framework/modbus-protocol
---

# modbus-protocol

skills/jnzader/project-starter-framework/modbus-protocol
modbus-protocol
Installation
$ npx skills add https://github.com/jnzader/project-starter-framework --skill modbus-protocol
SKILL.md
Modbus Protocol
