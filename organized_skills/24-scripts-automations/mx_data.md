...
rating: ⭐⭐
title: mx-data
url: https://skills.sh/site/skills.volces.com/mx-data
---

# mx-data

skills/skills.volces.com/mx_data
mx_data
...
返回给用户 – 将 title、关键指标值、关联证券（entityTagDTO）以可读表格或简要文字形式呈现。必要时可将完整 JSON 保存到工作目录（mx_data_result.json）。
Example
