...
rating: ⭐⭐⭐
title: xhs-analytics
url: https://skills.sh/site/skills.volces.com/xhs-analytics
---

# xhs-analytics

skills/skills.volces.com/xhs-analytics
xhs-analytics
$ npx skills add https://skills.volces.com/skills/clawhub/legou20221023
SKILL.md
小红书数据分析技能
...
注意事项
遵守平台规则: 请勿高频请求，注意请求间隔
数据安全: 采集数据仅供分析使用，勿传播
API限制: 注意第三方 API 的调用限制
隐私保护: 勿采集个人隐私信息
故障排除
