...
url: https://skills.sh/davila7/claude-code-templates/scientific-writing
---

# scientific-writing

skills/davila7/claude-code-templates/scientific-writing
scientific-writing
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill scientific-writing
Summary
...
Handles citations in APA, AMA, Vancouver, Chicago, and IEEE styles; includes figures, tables, and reporting guidelines (CONSORT, STROBE, PRISMA, STARD, TRIPOD, ARRIVE, CARE, SQUIRE, SPIRIT, CHEERS)
Mandatory integration with scientific-schematics skill for publication-quality diagrams; requires at least one figure per paper
Journal-specific formatting, section-by-section guidance (abstract, introduction, methods, results, discussion), and common rejection pitfalls
SKILL.md
Scientific Writing
Overview
