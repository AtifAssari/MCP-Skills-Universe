...
rating: ⭐⭐⭐
title: qt-resources
url: https://skills.sh/l3digital-net/claude-code-plugins/qt-resources
---

# qt-resources

skills/l3digital-net/claude-code-plugins/qt-resources
qt-resources
Installation
$ npx skills add https://github.com/l3digital-net/claude-code-plugins --skill qt-resources
SKILL.md
Qt Resource System
.qrc File Format
