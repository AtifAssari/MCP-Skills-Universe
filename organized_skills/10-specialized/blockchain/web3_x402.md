...
rating: ⭐⭐⭐
title: web3-x402
url: https://skills.sh/noditlabs/skills/web3-x402
---

# web3-x402

skills/noditlabs/skills/web3-x402
web3-x402
Installation
$ npx skills add https://github.com/noditlabs/skills --skill web3-x402
SKILL.md
Web3 x402
...
Look up the expected cost from references/pricing-data-api.md or references/pricing-node-api.md.
Show the wallet address and estimated cost: "Your asset will be charged approximately $XX USDC. May I proceed?"
