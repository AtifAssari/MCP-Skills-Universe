...
rating: ⭐⭐⭐
title: blender 3d
url: https://skills.sh/site/smithery.ai/blender-3d
---

# blender 3d

skills/smithery.ai/Blender 3D
Blender 3D
$ npx skills add https://smithery.ai/skills/pacphi/blender-3d
SKILL.md
Blender 3D Skill
...
Download addon/blender_mcp_addon.py from this skill directory
Open Blender → Edit → Preferences → Add-ons
Click "Install..." and select the addon file
Enable "Blender MCP" in the addon list
Find the BlenderMCP panel in 3D View sidebar (press N)
Click "Start Server" to begin listening on port 9876
...
FLUX2 generates reference image (Phase 1, ~41GB VRAM)
Free GPU memory via ComfyUI /free endpoint
SAM3D reconstructs mesh.glb from image (Phase 2, ~23GB VRAM)
Blender imports the mesh via MCP socket
Validation renders from multiple orbit camera angles
Quality feedback determines if retry needed with improved prompt
...
Custom/unique items: Hyper3D Rodin → Hunyuan3D
Environment lighting: PolyHaven HDRIs
Materials/textures: PolyHaven textures
Fallback: Python scripting for primitives
Troubleshooting
Connection Issues
