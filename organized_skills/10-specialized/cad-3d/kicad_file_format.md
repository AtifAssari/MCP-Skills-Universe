---
rating: ⭐⭐⭐
title: kicad-file-format
url: https://skills.sh/o2scale/electronics-agent-kit/kicad-file-format
---

# kicad-file-format

skills/o2scale/electronics-agent-kit/kicad-file-format
kicad-file-format
Installation
...
Find the net number for the connection
Add (segment ...) block with:
...
Unique UUID
Creating a Net
In PCB file, add: (net N "NetName")
Reference the net number in pads and segments
...
Open in KiCad to verify parsing
