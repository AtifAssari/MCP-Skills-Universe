...
url: https://skills.sh/astronomer/agents/migrating-airflow-2-to-3
---

# migrating-airflow-2-to-3

skills/astronomer/agents/migrating-airflow-2-to-3
migrating-airflow-2-to-3
Installation
...
Includes manual migration checklist for issues Ruff cannot auto-fix: cron scheduling semantics, .airflowignore glob syntax, OAuth callback URL prefixes, and shared utility imports
Recommends upgrade path: Airflow 2.11 → 3.0.11+ (ideally 3.1) to avoid rollback issues and early 3.0 bugs
SKILL.md
Contains Hooks
...
reference/config-changes.md - airflow.cfg section moves, renames, and removals
...
Resources
Astronomer Airflow 3 Upgrade Guide
Airflow 3 Release Notes
Ruff Airflow Rules
Related Skills
