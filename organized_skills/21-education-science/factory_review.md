...
url: https://skills.sh/jwilger/agent-skills/factory-review
---

# factory-review

skills/jwilger/agent-skills/factory-review
factory-review
Installation
...
What changed: Feature or fix description in plain language
Which slice: The vertical slice ID this PR implements
Which pair: The two engineers who built it
Gate results: Pass/fail for each quality gate (tdd, review, ci, mutation)
Rework count: Number of rework cycles before all gates passed
...
Validate: Check that the change is consistent (e.g., cannot enable auto-merge at conservative autonomy level; cannot disable a gate that another setting depends on)
Explain implications: What will change in behavior if this setting is modified? Be specific.
Apply or reject: If valid, apply the change. If invalid, explain why and suggest the nearest valid alternative.
...
Which gate: The quality gate that triggered the escalation
Rework attempts: How many rework cycles were attempted
What was tried: Brief summary of each rework attempt
Current state: What the code looks like now (diff or description)
Recommendation: The team's suggested resolution (if any)
