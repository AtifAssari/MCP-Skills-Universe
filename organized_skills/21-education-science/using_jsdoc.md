...
rating: ⭐⭐
title: using-jsdoc
url: https://skills.sh/jrodrigopuca/skills/using-jsdoc
---

# using-jsdoc

skills/jrodrigopuca/skills/using-jsdoc
using-jsdoc
Installation
...
Describe the "what" and "why", not the "how" (the code already shows that)
Document optional parameters with [param] or [param=default]
Use @example for non-obvious use cases
Mark obsolete code with @deprecated including an alternative
In TypeScript, prioritize native types over JSDoc annotations
...
Resources
Official JSDoc documentation - Complete tag reference and usage guides
TypeScript JSDoc support - TS-specific JSDoc features
Google Closure Compiler types - Advanced type expressions
JSDoc CLI tool - Generate HTML documentation from JSDoc comments
Better Comments extension - VS Code syntax highlighting for comments
references/tags.md - Complete table of all JSDoc tags with examples
references/best-practices.md - Detailed good/bad examples and common mistakes
Weekly Installs
12
Repository
jrodrigopuca/skills
