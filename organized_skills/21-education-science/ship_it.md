...
rating: ⭐⭐⭐
title: ship-it
url: https://skills.sh/whatifwedigdeeper/agent-skills/ship-it
---

# ship-it

skills/whatifwedigdeeper/agent-skills/ship-it
ship-it
Installation
...
Compare the current PR title and body against all commits on the branch (git log <default-branch>..HEAD --oneline)
If the title or body no longer reflects the full set of changes (e.g. new commits were added), update them with gh pr edit <number> --title "<new title>" --body "<new body>"
Report the PR URL and any updates made, then jump to Step 7
