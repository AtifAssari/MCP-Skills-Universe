...
rating: ⭐⭐
title: learning-loop
url: https://skills.sh/richfrem/agent-plugins-skills/learning-loop
---

# learning-loop

skills/richfrem/agent-plugins-skills/learning-loop
learning-loop
Installation
...
Synthesis: Perform your research. Aggregate findings into clear, modular markdown files in the project's designated learning/ or memory/ directory.
...
Phase VIII: Handoff
Verify Exit Condition: Confirm research/synthesis acceptance criteria met, survey saved, metrics emitted, memory written.
Return Data: Pass synthesized documents and context back up to the Orchestrator.
Terminate Loop: Explicitly state "Learning Loop Complete. Survey saved. Metrics emitted. Passing control to Orchestrator."
Phase Reference
