...
rating: ⭐⭐⭐
title: contributor
url: https://skills.sh/majiayu000/claude-arsenal/contributor
---

# contributor

skills/majiayu000/claude-arsenal/contributor
contributor
Installation
...
No assignee
No open PR already fixing it (check both linked PRs and title/body search)
Fewer than 5 competing PRs
Prefer labels: bug, good first issue, help wanted
Prefer issues with maintainer comments suggesting a fix direction
...
Wrong base branch: PRing against main when the project develops on dev. Prevention: Phase 3.2 branch detection.
