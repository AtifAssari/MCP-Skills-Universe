---
rating: ⭐⭐
title: moral-parallax
url: https://skills.sh/jwynia/agent-skills/moral-parallax
---

# moral-parallax

skills/jwynia/agent-skills/moral-parallax
moral-parallax
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill moral-parallax
SKILL.md
...
What comfortable distance does your world maintain?
Who benefits from maintaining that distance?
Who pays the cost of that distance?
What would collapse the distance?
How would characters navigate without distance?
What systems would emerge to manage visible proximity?
How do people live knowing the true proximity of harm?
Design Process
...
Feel true — We live in systems that export harm
Resist simplification — No clean moral position exists
Create complicity — Readers recognize themselves
Reveal systems — Personal stories illuminate structural oppression
Prevent heroes — Everyone is compromised by proximity
...
If not found, ask user: "Where should I save moral parallax designs?"
Suggest: stories/concepts/ or explorations/stories/
Primary Output
