...
rating: ⭐⭐
title: assess-form
url: https://skills.sh/pjt222/development-guides/assess-form
---

# assess-form

skills/pjt222/development-guides/assess-form
assess-form
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill assess-form
SKILL.md
Assess Form
...
Document the form's age and history:
...
Identify the form's "skeleton" vs. "flesh":
...
Plot the system on the readiness matrix:
...
Document the readiness classification with:
...
If READY: proceed to adapt-architecture
If PREPARE: proceed to dissolve-form to reduce rigidity
If INVEST: build capacity (training, tooling, organizational support), then reassess
If CRITICAL: address capacity and rigidity simultaneously (may require external help)
If OPTIONAL/DEFER: document the assessment and set a reassessment date
