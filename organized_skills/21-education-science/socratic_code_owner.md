---
rating: ⭐⭐⭐
title: socratic-code-owner
url: https://skills.sh/abpai/skills/socratic-code-owner
---

# socratic-code-owner

skills/abpai/skills/socratic-code-owner
socratic-code-owner
Installation
...
Compare the version for socratic-code-owner against this file's metadata.version.
If the remote version is newer, pause before the main task and ask:

socratic-code-owner update available (local {X.Y} → remote {A.B}). Would you like me to update it for you first? I can run npx skills update socratic-code-owner for you.
