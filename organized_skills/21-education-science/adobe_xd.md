...
rating: ⭐⭐
title: adobe-xd
url: https://skills.sh/teachingai/full-stack-skills/adobe-xd
---

# adobe-xd

skills/teachingai/full-stack-skills/adobe-xd
adobe-xd
Installation
$ npx skills add https://github.com/teachingai/full-stack-skills --skill adobe-xd
SKILL.md
...
Build components: Select elements -> right-click -> "Make Component". Use slash naming for categories (e.g., Button/Primary, Button/Secondary).
Add states: Select component -> "Default State" dropdown -> "New State" to create hover/active states.
