...
rating: ⭐⭐⭐
title: mol-2d-viewer
url: https://skills.sh/internscience/chemclaw/mol-2d-viewer
---

# mol-2d-viewer

skills/internscience/chemclaw/mol-2d-viewer
mol-2d-viewer
Installation
...
iupac_to_smiles: 将 IUPAC 名称（包括聚合物）转换为 SMILES
mol_2d_viewer: 将 SMILES 转换为可视化的 2D 结构图
# 完整流程示例
# 1. 转换
