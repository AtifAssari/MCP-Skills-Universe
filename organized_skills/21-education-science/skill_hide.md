...
rating: ⭐⭐⭐
title: skill-hide
url: https://skills.sh/steelan9199/wechat-publisher/skill-hide
---

# skill-hide

skills/steelan9199/wechat-publisher/skill-hide
skill-hide
Installation
$ npx skills add https://github.com/steelan9199/wechat-publisher --skill skill-hide
SKILL.md
...
配置文件: skill-hide/.skill-config.json
⚠️ 重要：AI 使用指南
如何判断技能是否隐藏
