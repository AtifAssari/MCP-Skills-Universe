---
rating: ⭐⭐⭐
title: hickey-simple-made-easy
url: https://skills.sh/copyleftdev/sk1llz/hickey-simple-made-easy
---

# hickey-simple-made-easy

skills/copyleftdev/sk1llz/hickey-simple-made-easy
hickey-simple-made-easy
Installation
...
Values Over State: Immutable values simplify everything.

Data > Objects: Plain data with generic functions beats object hierarchies.

Explicit State: When state is needed, manage it explicitly.
...
Is state complected with identity? Separate them with values + refs.
Is behavior complected with data? Use data + functions, not objects.
Is order complected with logic? Use declarative over imperative.
Is specificity complected with generality? Use generic data structures.
Mental Model

Hickey approaches design by asking:

Is this simple or just easy? Familiar ≠ simple
What is this complected with? Find the intertwining
Is this data or process? Separate them
Where does state live? Make it explicit
What happens over time? Values + references
