---
rating: ⭐⭐⭐
title: dev-workflow-planning
url: https://skills.sh/vasilyu1983/ai-agents-public/dev-workflow-planning
---

# dev-workflow-planning

skills/vasilyu1983/ai-agents-public/dev-workflow-planning
dev-workflow-planning
Installation
...
Create one isolated worktree per feature.
Execute only the approved plan scope in that worktree.
Run repo-defined quality gate(s) before PR (example: npm run test:analytics-gate).
Open one focused PR per feature branch.
...
pwd / git branch --show-current / ls -la
test -e <path> to verify target paths before heavy commands
npx <tool> --help to validate flags before first use
Quote paths containing [], *, ?, or spaces
