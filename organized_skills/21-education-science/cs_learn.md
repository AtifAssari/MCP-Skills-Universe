...
rating: ⭐⭐⭐
title: cs-learn
url: https://skills.sh/liuzhengdongfortest/codestable/cs-learn
---

# cs-learn

skills/liuzhengdongfortest/codestable/cs-learn
cs-learn
Installation
...
"你最开始观察到的现象是什么？"
"哪些解法试过但没用？"（鼓励写，失败的尝试是后人最宝贵的信息——知道哪条路不通能省下大量时间）
"最终怎么发现真正原因的？"
"下次可以更早发现吗？怎么发现？"
...
不混入 spec——learning 不放进 features/ 或 issues/；spec 也不放进 compound/
只认自己的 doc_type——只读写 doc_type: learning
Weekly Installs
324
Repository
