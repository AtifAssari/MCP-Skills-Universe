...
url: https://skills.sh/chrislemke/stoffy/dialectical-method
---

# dialectical-method

skills/chrislemke/stoffy/dialectical-method
dialectical-method
Installation
$ npx skills add https://github.com/chrislemke/stoffy --skill dialectical-method
SKILL.md
...
Cancel (aufheben = to abolish)
Preserve (aufheben = to keep)
Elevate (aufheben = to lift up)
...
Contradiction reveals one-sidedness
Forces movement to higher ground
Synthesis preserves what's true in both
Output Format
