...
rating: ⭐⭐
title: build-persona
url: https://skills.sh/readwiseio/readwise-skills/build-persona
---

# build-persona

skills/readwiseio/readwise-skills/build-persona
build-persona
Installation
...
Show the file link. Always tell the user: reader_persona.md was written to {absolute_path}. Display the full path so they can open it.
Show a summary of the persona (use the subagent's returned summary).
