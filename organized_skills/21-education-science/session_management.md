...
url: https://skills.sh/nickcrew/claude-ctx-plugin/session-management
---

# session-management

skills/nickcrew/claude-ctx-plugin/session-management
session-management
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill session-management
SKILL.md
Session Management
Overview
