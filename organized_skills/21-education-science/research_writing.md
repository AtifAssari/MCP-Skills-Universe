...
url: https://skills.sh/alfonso0512/research-writing-skill/research-writing
---

# research-writing

skills/alfonso0512/research-writing-skill/research-writing
research-writing
Installation
$ npx skills add https://github.com/alfonso0512/research-writing-skill --skill research-writing
SKILL.md
...
本 Skill 提供 30 个论文写作场景的 Prompt 模板，覆盖文献调研→大纲撰写→初稿写作→润色修改→图表制作→投稿回复→基金申请全流程。
...
申请基金	#28-30（基金 + 演讲）
最佳实践
组合使用: 多个 Prompt 可以串联使用，如先用#21 生成大纲，再用#22-25 扩展各章节
迭代优化: 对 AI 生成的内容，可用#3-10 进行多轮润色和优化
保持批判: 使用#16 模拟审稿人视角，提前发现论文问题
数据真实: 所有实验数据和结论必须基于真实研究，AI 仅辅助表达
Weekly Installs
16
Repository
alfonso0512/res…ng-skill
GitHub Stars
121
First Seen
Mar 22, 2026
