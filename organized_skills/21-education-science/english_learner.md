...
url: https://skills.sh/learnwy/skills/english-learner
---

# english-learner

skills/learnwy/skills/english-learner
english-learner
Installation
...
Rules
Never block the task — always complete the user's original request after the teaching moment
Max 3 corrections per message — don't overwhelm; pick the most important ones
Be encouraging — frame as tips, not errors
Skip trivial issues — don't correct informal style, abbreviations, or intentional slang
Skip when user is copy-pasting — if the text is clearly copied content (code, quotes, etc.), don't correct
Auto-save new vocabulary — any corrected words/phrases should be saved to the vocabulary store via batch_save
Track teaching frequency — don't repeat the same correction within the same session
