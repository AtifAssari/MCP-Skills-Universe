...
Preserves LaTeX syntax, citations, references, labels, and math environments by default; returns findings in diff-comment style for easy integration.
Designed for IEEE, ACM, Springer, NeurIPS, and ICML submission workflows; includes venue-specific formatting expectations and reviewer-perspective heuristics.
Routes requests to the smallest matching module to keep workflows low-friction; supports section-specific analysis and optional bibliography paths.
SKILL.md
