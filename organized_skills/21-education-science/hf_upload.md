...
rating: ⭐⭐⭐
title: hf-upload
url: https://skills.sh/richfrem/agent-plugins-skills/hf-upload
---

# hf-upload

skills/richfrem/agent-plugins-skills/hf-upload
hf-upload
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill hf-upload
SKILL.md
Dependencies
...
Prerequisites
Run hf-init first to validate credentials and dataset structure
Requires huggingface_hub installed (pip install huggingface_hub)
Environment variables: HUGGING_FACE_USERNAME, HUGGING_FACE_TOKEN
Error Handling
