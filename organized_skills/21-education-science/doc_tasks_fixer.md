---
rating: ⭐⭐⭐⭐⭐
title: doc-tasks-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-tasks-fixer
---

# doc-tasks-fixer

skills/vladm3105/aidoc-flow-framework/doc-tasks-fixer
doc-tasks-fixer
Installation
...
Generate new task IDs for added requirements
Update existing task references to new upstream versions
...
Mark affected tasks with [DRIFT-REVIEWED] marker
Increment minor version (e.g., 1.0.1 -> 1.1.0)
Update dependency links
Flag for optional human review
...
Archive current TASKS version
Trigger full TASKS regeneration via doc-tasks-autopilot
...
Create backup in tmp/backup/TASKS-NN_YYYYMMDD_HHMMSS/
Copy all TASKS files to backup location
