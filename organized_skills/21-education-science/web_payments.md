...
rating: ⭐⭐⭐
title: web-payments
url: https://skills.sh/alinaqi/claude-bootstrap/web-payments
---

# web-payments

skills/alinaqi/claude-bootstrap/web-payments
web-payments
Installation
...
Server-side only for secrets - Never expose STRIPE_SECRET_KEY
