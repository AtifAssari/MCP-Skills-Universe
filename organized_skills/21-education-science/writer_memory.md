...
rating: ⭐⭐⭐
title: writer-memory
url: https://skills.sh/yeachan-heo/oh-my-claudecode/writer-memory
---

# writer-memory

skills/yeachan-heo/oh-my-claudecode/writer-memory
writer-memory
Installation
...
Behavior
On Init: Creates .writer-memory/memory.json with project metadata and empty collections
Auto-Backup: Changes are backed up before modification to .writer-memory/backups/
Korean-First: Emotion vocabulary uses Korean terms throughout
...
Backup Before Major Changes: Use /backup before significant story pivots
Troubleshooting
