...
url: https://skills.sh/pjt222/development-guides/manage-changelog
---

# manage-changelog

skills/pjt222/development-guides/manage-changelog
manage-changelog
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill manage-changelog
SKILL.md
Manage Changelog
...
[Unreleased] section with pending changes
Versioned sections in reverse chronological order ([1.2.0] before [1.1.0])
Comparison links at the bottom (optional)
...
Create a new section heading: ## [1.3.0] - 2026-02-17
Move all entries from [Unreleased] to the new section
Leave [Unreleased] empty (but keep the heading)
