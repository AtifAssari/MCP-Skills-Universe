---
rating: ⭐⭐⭐⭐⭐
title: sadd:do-in-parallel
url: https://skills.sh/neolabhq/context-engineering-kit/sadd:do-in-parallel
---

# sadd:do-in-parallel

skills/neolabhq/context-engineering-kit/sadd:do-in-parallel
sadd:do-in-parallel
Installation
...
If retries < 3: -> Dispatch retry implementation agent with judge feedback -> Return to judge verification with same target-specific meta-judge specification
