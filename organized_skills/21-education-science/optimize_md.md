...
rating: ⭐⭐
title: optimize-md
url: https://skills.sh/jkappers/agent-skills/optimize-md
---

# optimize-md

skills/jkappers/agent-skills/optimize-md
optimize-md
Installation
$ npx skills add https://github.com/jkappers/agent-skills --skill optimize-md
SKILL.md
Document Optimizer
...
Workflow
Read the file at $ARGUMENTS. If no path is provided, ask for one
Analyze the document for optimization opportunities using the principles below
