...
rating: ⭐⭐⭐
title: seo-local
url: https://skills.sh/agricidaniel/claude-seo/seo-local
---

# seo-local

skills/agricidaniel/claude-seo/seo-local
seo-local
Installation
$ npx skills add https://github.com/agricidaniel/claude-seo --skill seo-local
SKILL.md
...
Add geo coordinates with 5+ decimal precision
Ensure phone number uses tel: link for click-to-call
