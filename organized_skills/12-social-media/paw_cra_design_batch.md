---
rating: ⭐⭐⭐
title: paw-cra-design-batch
url: https://skills.sh/pawbytes/skill-suites/paw-cra-design-batch
---

# paw-cra-design-batch

skills/pawbytes/skill-suites/paw-cra-design-batch
paw-cra-design-batch
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-cra-design-batch
SKILL.md
...
Load platform specs — Confirm dimensions, safe zones, format requirements
Generate AI imagery — Use fal.ai with the resolved prompt and parameters. Use the Designer's AI model selection guide for model choice. Download all generated images to local paths.
Apply template/text overlay — If the asset uses a code-based template, render the HTML/CSS overlay with the generated background. If pure AI generation, apply any text overlays via image editing.
Brand validate — Check output against brand guidelines: correct colors, typography, logo placement, visual style consistency. Flag any deviations.
Export with sequential naming — Save to the campaign asset folder with the naming convention from Step 3.
