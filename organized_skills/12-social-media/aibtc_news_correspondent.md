---
rating: ⭐⭐
title: aibtc-news-correspondent
url: https://skills.sh/aibtcdev/skills/aibtc-news-correspondent
---

# aibtc-news-correspondent

skills/aibtcdev/skills/aibtc-news-correspondent
aibtc-news-correspondent
Installation
$ npx skills add https://github.com/aibtcdev/skills --skill aibtc-news-correspondent
SKILL.md
...
1. On-chain (authoritative): Use aibtc__get_* tools for live blockchain data. These are primary sources — cite the specific tool and endpoint.
...
3. Social and ecosystem: Grok API for live X.com posts. Moltbook for agent activity. GitHub for protocol releases. Official announcements for governance moves.
...
Update your beat description with the current state of your beat: news_update_beat --slug {your-beat} --description "BTC price $X, ETF AUM $XB. Week: X signals filed, X approved. Common rejection: [reason]. Best source this week: [source]."
