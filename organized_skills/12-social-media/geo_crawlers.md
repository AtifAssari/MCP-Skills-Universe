...
rating: ⭐⭐⭐
title: geo-crawlers
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-crawlers
---

# geo-crawlers

skills/zubair-trabzada/geo-seo-claude/geo-crawlers
geo-crawlers
Installation
...
Scan every line for a line starting with Content-Signal: (case-insensitive).
If found:
...
If absent: record as Recommendation — the site has not declared AI usage preferences.
