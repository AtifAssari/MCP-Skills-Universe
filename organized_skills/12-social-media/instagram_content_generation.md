---
title: instagram-content-generation
url: https://skills.sh/eachlabs/skills/instagram-content-generation
---

# instagram-content-generation

skills/eachlabs/skills/instagram-content-generation
instagram-content-generation
Installation
...
Content Type: Feed post, Story, Reel cover, carousel slide number
Brand/Niche: What type of account is this for?
Aesthetic: Minimalist, bold, vintage, modern, etc.
Color Palette: Specific colors or general mood (warm, cool, neutral)
Composition: Flat lay, portrait, lifestyle, close-up, etc.
Text Space: If you need room for captions or overlay text
