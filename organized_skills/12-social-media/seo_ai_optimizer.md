...
url: https://skills.sh/luongnv89/skills/seo-ai-optimizer
---

# seo-ai-optimizer

skills/luongnv89/skills/seo-ai-optimizer
seo-ai-optimizer
Installation
...
Title/description quality -- Are they compelling and keyword-relevant? (not just present)
Structured data accuracy -- Does JSON-LD match visible page content?
Internal linking -- Are pages reachable within 3 clicks? Descriptive anchors?
Content depth -- Sufficient E-E-A-T signals? Author bios? Source citations?
Framework-specific config -- Are SEO packages properly configured?
...
Re-run the audit script on modified files:
