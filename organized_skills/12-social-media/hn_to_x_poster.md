---
rating: ⭐⭐
title: hn-to-x-poster
url: https://skills.sh/hexbee/hello-skills/hn-to-x-poster
---

# hn-to-x-poster

skills/hexbee/hello-skills/hn-to-x-poster
hn-to-x-poster
Installation
$ npx skills add https://github.com/hexbee/hello-skills --skill hn-to-x-poster
SKILL.md
HN to X Poster
Overview
