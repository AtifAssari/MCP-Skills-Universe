...
url: https://skills.sh/ognjengt/founder-skills/product-hunt-launch-plan
---

# product-hunt-launch-plan

skills/ognjengt/founder-skills/product-hunt-launch-plan
product-hunt-launch-plan
Installation
$ npx skills add https://github.com/ognjengt/founder-skills --skill product-hunt-launch-plan
SKILL.md
Product Hunt Launch Plan
Purpose
...
Respond with: "product-hunt-launch-plan loaded. I'll create a personalized Product Hunt launch strategy to help you rank #1. Let me gather some information about your product first."
...
Section 6: Hidden Gems & Pro Tips Include 5-10 advanced tactics from the reference guide, selected based on relevance to their situation.

Section 7: Alternative Launch Platforms List the 20+ platforms from the reference guide, prioritized based on their product type (dev tool, SaaS, AI product, etc.).
