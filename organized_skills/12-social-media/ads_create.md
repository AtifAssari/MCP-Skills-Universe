...
rating: ⭐⭐⭐
title: ads-create
url: https://skills.sh/agricidaniel/claude-ads/ads-create
---

# ads-create

skills/agricidaniel/claude-ads/ads-create
ads-create
Installation
...
Run /ads dna <url> first to extract brand DNA automatically
Describe your brand manually (I'll create a basic profile from your description)"
