...
url: https://skills.sh/aaaaqwq/claude-code-skills/openclaw-config-helper
---

# openclaw-config-helper

skills/aaaaqwq/claude-code-skills/openclaw-config-helper
openclaw-config-helper
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill openclaw-config-helper
SKILL.md
