...
url: https://skills.sh/davila7/claude-code-templates/marketing-strategy-pmm
---

# marketing-strategy-pmm

skills/davila7/claude-code-templates/marketing-strategy-pmm
marketing-strategy-pmm
Installation
...
Provides competitive intelligence templates (battlecards, win/loss analysis) and GTM motion guidance (PLG vs. Sales-Led vs. Hybrid) with 90-day launch playbooks
Covers international market entry strategy (US, UK, DACH, France, Canada) with localization checklists and phased rollout timelines
Includes sales enablement assets (decks, one-pagers, demo scripts, email templates), monthly PMM checklists, and HubSpot reporting dashboards for tracking KPIs like win rate, deal size, and sales velocity
SKILL.md
