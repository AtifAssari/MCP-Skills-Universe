---
rating: ⭐⭐⭐
title: app-marketing-copy
url: https://skills.sh/ckorhonen/claude-skills/app-marketing-copy
---

# app-marketing-copy

skills/ckorhonen/claude-skills/app-marketing-copy
app-marketing-copy
Installation
...
Produce 2–3 variants per high-impact field, then recommend a "best pick" with 1-sentence rationale.
Examples
...
Run intake questions to clarify missing details
Generate 3 subtitle variants, recommend best
Create keyword set optimized for student productivity searches
Write full description with feature bullets
Generate 5 screenshot captions in narrative order
Validate with scripts/check_app_store_limits.py
...
Review current listing (if provided)
Ask: "What makes PhotoFix different from competitors?"
Identify ASO keyword stuffing issues
Generate 3 new subtitle variants (specific, benefit-focused)
Rewrite full description with user benefits (not tech specs)
Create fresh screenshot captions
Compare before/after character counts
...
Complete intake (audience, differentiators, proof points)
Generate iOS listing (subtitle, keywords, description)
Generate Google Play listing (short desc, feature bullets, full desc)
Create marketing pack (10 taglines, 3 hero sections, 6 feature blurbs, 10 CTAs)
Generate screenshot copy pack (8 captions + image prompts)
Validate all with scripts/check_app_store_limits.py
...
Ask user: "What's one thing your app does that competitors don't?"
Ask for numbers: "How many users? How much time saved?"
Find the contrast: "What do users do today that sucks?"
Example transform:
...
Check if files exist: ls skills/app-marketing-copy/references/
If missing, proceed without them:
Use inline limits instead of app-store-metadata.md
Manually validate character counts instead of running scripts
Recommend to user: "For automated validation, create scripts/check_app_store_limits.py"
Included resources
