...
url: https://skills.sh/imlewc/video-to-subtitle-summary-skill/video-to-subtitle-summary
---

# video-to-subtitle-summary

skills/imlewc/video-to-subtitle-summary-skill/video-to-subtitle-summary
video-to-subtitle-summary
Installation
...
详细申请教程见 TikHub 申请指南 和 火山引擎开通指南
...
本地视频文件（.mp4、.mov、.avi、.mkv 等）→ 从步骤3（提取音频）开始
本地音频文件（.mp3、.wav、.m4a、.flac 等）→ 跳过步骤3，直接从步骤4（语音识别）开始
步骤0.5: 环境检查（必须首先执行）
...
常见问题
问题	解决方案
缺少环境变量	在 .env 文件或 ~/.zshrc/~/.bashrc 中配置，详见 申请教程
