...
rating: ⭐⭐⭐
title: tool-openclaw
url: https://skills.sh/heyvhuang/ship-faster/tool-openclaw
---

# tool-openclaw

skills/heyvhuang/ship-faster/tool-openclaw
tool-openclaw
Installation
$ npx skills add https://github.com/heyvhuang/ship-faster --skill tool-openclaw
SKILL.md
OpenClaw Expert
