...
url: https://skills.sh/anit-1to10x/10x-accountability-coach/ai-product-video
---

# ai-product-video

skills/anit-1to10x/10x-accountability-coach/ai-product-video
ai-product-video
Installation
$ npx skills add https://github.com/anit-1to10x/10x-accountability-coach --skill ai-product-video
SKILL.md
AI Product Video
...
Use this skill when: You have a product image to animate or need product-focused video content. Route here from: ai-product-photo after image approval, or ai-creative-workflow for direct video needs.

Why This Skill Exists

The problem: Video content converts dramatically better than static images, but:

Traditional product video requires expensive shoots
Most AI video prompts produce generic, floaty results
Different platforms need different video styles
Wrong motion can cheapen even premium products
...
Best styles: Floating Premium, Slow Reveal Avoid: Chaotic motion, uncontrolled reflections
...
Best styles: Slow Reveal, Contextual Avoid: Stiff fabric, unnatural movement
...
Best styles: Slow Reveal, Contextual Key elements: Steam, pour, drip, fresh
...
Best styles: Slow Reveal, Floating Premium Avoid: Fast motion, harsh lighting
...
Best styles: Slow Reveal, Orbit Showcase Key: Controlled sparkle, not chaotic reflections
...
Best styles: Contextual, Slow Reveal Key: Show scale, show in use
...
Option B: Generate image first Route to ai-product-photo → approve → return here
...
Problem: Almost there but something's off Strategy: Targeted prompt adjustments
...
Problem: Output doesn't match intent Strategy: Different approach entirely

Don't iterate on broken foundation:

Try different motion style
Try different model
Simplify prompt dramatically
Check source image quality
When Technical Issues Occur

Problem: Artifacts, morphing, glitches Strategy: Technical fixes
...
Motion matches positioning — Premium products need premium motion
Less is often more — Subtle motion > chaotic movement
First frame matters — Thumbnail is first impression
Consistency throughout — Product should be recognizable entire duration
Purpose-driven motion — Every movement should have reason
Common Mistakes to Avoid
Over-animated — Too much motion cheapens products
Wrong speed — Fast motion for luxury = mistake
Generic prompts — "Product reveal" is too vague
Ignoring source — Bad source image = bad video
Single model reliance — Different models excel differently
The 80/20 of Product Video

80% of results come from:

Quality source image (I2V workflow)
Appropriate motion style for product
Speed matching product positioning
Clean, simple motion prompts
