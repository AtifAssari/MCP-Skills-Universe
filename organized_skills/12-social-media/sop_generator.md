...
rating: ⭐⭐⭐
title: sop-generator
url: https://skills.sh/jk-0001/skills/sop-generator
---

# sop-generator

skills/jk-0001/skills/sop-generator
sop-generator
Installation
$ npx skills add https://github.com/jk-0001/skills --skill sop-generator
SKILL.md
SOP Generator
Overview
...
Read through transcript and identify:
...
Map transcript to SOP structure (see Step 3)
Watch video one more time while reading SOP draft to catch missed steps
Test the SOP yourself or have someone else follow it
...
Generate transcript if not already text (Whisper, Otter.ai, or Claude)
Identify the core process being described (ignore context/small talk)
Pull out:
What triggers the process ("We do this when...")
The steps in order
Tools or people involved
What success looks like
Map to SOP structure
Fill gaps (voice memos often skip "obvious" steps — add them)
From Messy Notes or Brain Dump

Extraction workflow:

Read through notes and identify:
Is this one process or multiple? (If multiple, split into separate SOPs)
What's the goal of the process?
What's the order of operations?
Reorder notes chronologically (most brain dumps are non-linear)
Map to SOP structure
Add missing details (tools, exact steps, decision points)
