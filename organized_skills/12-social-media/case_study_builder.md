...
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/case-study-builder
---

# case-study-builder

skills/brianrwagner/ai-marketing-claude-code-skills/case-study-builder
case-study-builder
Installation
$ npx skills add https://github.com/brianrwagner/ai-marketing-claude-code-skills --skill case-study-builder
SKILL.md
Case Study Builder
