...
rating: ⭐⭐⭐
title: turix-cua
url: https://skills.sh/shiehxj/turix-cua-skill/turix-cua
---

# turix-cua

skills/shiehxj/turix-cua-skill/turix-cua
turix-cua
Installation
...
Configure API in examples/config.json:
...
Updates examples/config.json with task and options
Sets PATH correctly (includes /usr/sbin for screencapture)
...
Use Python to create documents (faster, more reliable)
