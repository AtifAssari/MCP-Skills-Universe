...
url: https://skills.sh/canatufkansu/claude-skills/json-ld-schemas
---

# json-ld-schemas

skills/canatufkansu/claude-skills/json-ld-schemas
json-ld-schemas
Installation
$ npx skills add https://github.com/canatufkansu/claude-skills --skill json-ld-schemas
SKILL.md
JSON-LD Schemas
