...
url: https://skills.sh/shipshitdev/library/brand-name-generator
---

# brand-name-generator

skills/shipshitdev/library/brand-name-generator
brand-name-generator
Installation
$ npx skills add https://github.com/shipshitdev/library --skill brand-name-generator
SKILL.md
Brand Name Generator
...
Keywords: Core concepts, values, emotional associations
Constraints: Name length, TLD preferences, names to avoid
Naming Strategies
...
Suffixes: -ify, -ly, -io, -hub, -ment, -able Prefixes: get-, try-, go-, my-, super-
