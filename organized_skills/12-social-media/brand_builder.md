...
rating: ⭐⭐⭐
title: brand-builder
url: https://skills.sh/phrazzld/claude-config/brand-builder
---

# brand-builder

skills/phrazzld/claude-config/brand-builder
brand-builder
Installation
...
Current directory (if in a project)
Or ~/.claude/skills/brand-builder/profiles/[product].yaml as fallback
Integration
...
Ask if user wants to update specific sections
