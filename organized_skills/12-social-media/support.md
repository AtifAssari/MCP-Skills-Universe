...
rating: ⭐⭐⭐
title: support
url: https://skills.sh/whawkinsiv/claude-code-skills/support
---

# support

skills/whawkinsiv/claude-code-skills/support
support
Installation
$ npx skills add https://github.com/whawkinsiv/claude-code-skills --skill support
SKILL.md
