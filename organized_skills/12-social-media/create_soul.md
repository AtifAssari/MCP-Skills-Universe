...
rating: ⭐⭐⭐⭐⭐
title: create-soul
url: https://skills.sh/larashero3-dotcom/soul.skill/create-soul
---

# create-soul

skills/larashero3-dotcom/soul.skill/create-soul
create-soul
Installation
$ npx skills add https://github.com/larashero3-dotcom/soul.skill --skill create-soul
SKILL.md
/create-soul
