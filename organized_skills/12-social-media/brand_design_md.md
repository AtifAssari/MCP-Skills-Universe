...
url: https://skills.sh/zephyrwang6/brand-design-md/brand-design-md
---

# brand-design-md

skills/zephyrwang6/brand-design-md/brand-design-md
brand-design-md
Installation
...
识别品牌名称并映射到正确的 slug
通过 npx getdesign@latest add <slug> 获取完整的 DESIGN.md 规范
读取内容，作为设计上下文生成 UI 代码
品牌 Slug 注册表
科技 / AI 产品
用户可能说的	Slug
苹果、Apple	apple
