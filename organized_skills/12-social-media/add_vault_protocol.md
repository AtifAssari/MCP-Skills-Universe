...
url: https://skills.sh/tradingstrategy-ai/web3-ethereum-defi/add-vault-protocol
---

# add-vault-protocol

skills/tradingstrategy-ai/web3-ethereum-defi/add-vault-protocol
add-vault-protocol
Installation
...
Risk level: Optional. If not given, set to None
...
Use eth_defi/abi/lagoon/ as a reference for structure
...
In create_probe_calls(), add a probe call that uniquely identifies this protocol:
...
In identify_vault_features(), add detection logic:
...
Set the initial risk level for the protocol in VAULT_PROTOCOL_RISK_MATRIX. USe None if not given and this will be later updated by human judgement.
