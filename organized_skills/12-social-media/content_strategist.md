...
url: https://skills.sh/vuralserhat86/antigravity-agentic-skills/content_strategist
---

# content_strategist

skills/vuralserhat86/antigravity-agentic-skills/content_strategist
content_strategist
Installation
$ npx skills add https://github.com/vuralserhat86/antigravity-agentic-skills --skill content_strategist
SKILL.md
SEO Content Writer
...
Structure Content with SEO Headers
...
Tips for Success
Match search intent - Informational queries need guides, not sales pages
Front-load value - Put key information early for readers and snippets
Use data and examples - Specific beats generic every time
Write for humans first - SEO optimization should feel natural
Include visual elements - Break up text with images, tables, lists
Update regularly - Fresh content signals to search engines
🔄 Workflow

Kaynak: Google Search Central E-E-A-T Standards & Ahrefs Content Strategy Guide 2025
