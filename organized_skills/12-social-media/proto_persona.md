...
rating: ⭐⭐⭐
title: proto-persona
url: https://skills.sh/deanpeters/product-manager-skills/proto-persona
---

# proto-persona

skills/deanpeters/product-manager-skills/proto-persona
proto-persona
Installation
$ npx skills add https://github.com/deanpeters/product-manager-skills --skill proto-persona
Summary
...
Designed to align teams early, guide initial design decisions, and explicitly surface assumptions that require validation through research
Distinguishes proto-personas from validated personas and includes anti-patterns to avoid (treating assumptions as fact, fabricating quotes, creating too many personas)
SKILL.md
Purpose
