---
rating: ⭐⭐⭐
title: tarkov-data-patterns
url: https://skills.sh/tarkovtracker-org/tarkovtracker/tarkov-data-patterns
---

# tarkov-data-patterns

skills/tarkovtracker-org/tarkovtracker/tarkov-data-patterns
tarkov-data-patterns
Installation
$ npx skills add https://github.com/tarkovtracker-org/tarkovtracker --skill tarkov-data-patterns
SKILL.md
...
Query Optimization
Start narrow: Use specific IDs/names before broad searches
Use filters: trader, map, caliber reduce result sets
Paginate early: Use limit/offset in concise mode
Cache results: Don't re-query same data in one session
Error Handling
