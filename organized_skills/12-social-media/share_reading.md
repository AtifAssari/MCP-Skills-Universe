...
rating: ⭐⭐⭐
title: share-reading
url: https://skills.sh/sugarforever/01coder-agent-skills/share-reading
---

# share-reading

skills/sugarforever/01coder-agent-skills/share-reading
share-reading
Installation
...
Critical Rules
Always include the source link — never omit it
Don't fabricate content — only reference what's actually in the article
Match source language — Chinese content gets Chinese posts, English gets English
Multiple candidates — always offer 2-3 options, not just one
No auto-publishing — only generate text, don't execute any publishing
Genuine tone — avoid marketing speak and excessive superlatives
Weekly Installs
102
Repository
