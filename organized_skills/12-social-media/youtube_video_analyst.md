...
url: https://skills.sh/shipshitdev/library/youtube-video-analyst
---

# youtube-video-analyst

skills/shipshitdev/library/youtube-video-analyst
youtube-video-analyst
Installation
$ npx skills add https://github.com/shipshitdev/library --skill youtube-video-analyst
Summary

Forensic deconstruction of YouTube videos to extract viral formulas, hooks, and retention mechanics.
...
Includes implementation playbook with top 10 steal-this elements, niche adaptation guides, and A/B test recommendations
Requires transcript input (auto-fetchable from YouTube URL or manually pasted) and user context on niche, tone, platform, and target video length
SKILL.md
YouTube Video Analyst
