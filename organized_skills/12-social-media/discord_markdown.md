...
url: https://skills.sh/frizzle-chan/mudd/discord-markdown
---

# discord-markdown

skills/frizzle-chan/mudd/discord-markdown
discord-markdown
Installation
...
Formatted user mention: <@user_id> Formatted channel: <#channel_id> Formatted role: <@&role_id> Custom emoji: <:name:id> or <a:name:id> (animated) Timestamp: <t:unix_timestamp:format>
