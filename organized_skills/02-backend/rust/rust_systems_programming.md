...
url: https://skills.sh/manutej/luxor-claude-marketplace/rust-systems-programming
---

# rust-systems-programming

skills/manutej/luxor-claude-marketplace/rust-systems-programming
rust-systems-programming
Installation
...
Best Practices
API Design
Use References by Default: Accept &T instead of T unless you need ownership
Return Owned Types: Return String instead of &str for simpler APIs
Implement Standard Traits: Debug, Clone, PartialEq, Send, Sync
Use Into<T> for Flexibility: fn set_name(&mut self, name: impl Into<String>)
