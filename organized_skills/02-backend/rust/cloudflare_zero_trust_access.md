...
url: https://skills.sh/jackspace/claudeskillz/cloudflare-zero-trust-access
---

# cloudflare-zero-trust-access

skills/jackspace/claudeskillz/cloudflare-zero-trust-access
cloudflare-zero-trust-access
Installation
...
jwt-validation-manual.ts - Manual JWT verification
...
access-policy-setup.md (~1,400 words)
...
test-access-jwt.sh - JWT testing tool
...
create-service-token.sh - Service token setup guide
...
Create application for your Worker domain
Create policy (e.g., "Emails ending in @company.com")
...
Assess Pattern: Which integration pattern fits? (Hono middleware, manual, service tokens, CORS, multi-tenant)

Check Templates: Copy relevant template from templates/

Configure Environment: Set ACCESS_TEAM_DOMAIN and ACCESS_AUD in wrangler.jsonc

Setup Dashboard: Guide user through Access policy creation (use references/access-policy-setup.md)

Prevent Errors: Apply solutions from references/common-errors.md

Test: Deploy and verify authentication flow
