...
skills/wshobson/agents/mtls-configuration
mtls-configuration
Installation
...
Provides debugging commands for TLS handshake issues, certificate expiry verification, and peer authentication validation across service meshes
Addresses migration patterns (PERMISSIVE to STRICT modes), multi-cluster communication, and compliance requirements (PCI-DSS, HIPAA)
SKILL.md
mTLS Configuration
