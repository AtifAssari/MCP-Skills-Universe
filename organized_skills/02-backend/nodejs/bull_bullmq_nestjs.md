---
rating: ⭐⭐
title: bull-bullmq-nestjs
url: https://skills.sh/davidcastagnetoa/skills/bull-bullmq-nestjs
---

# bull-bullmq-nestjs

skills/davidcastagnetoa/skills/bull-bullmq-nestjs
bull-bullmq-nestjs
Installation
...
Guía completa de implementación de colas con Bull/BullMQ en NestJS. Cubre configuración, processors, jobs programados con delay, retry, dead letter queue, monitorización y la estrategia de migración de Bull (desarrollo local) a Cloud Tasks (producción GCP).
