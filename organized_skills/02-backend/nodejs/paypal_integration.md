...
skills/wshobson/agents/paypal-integration
paypal-integration
Installation
...
Handles payment status flows (completed, refunded, reversed/chargeback) with duplicate transaction prevention and error handling
SKILL.md
PayPal Integration
