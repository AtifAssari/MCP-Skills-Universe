...
rating: ⭐⭐
title: canvas-design
url: https://skills.sh/composiohq/awesome-claude-skills/canvas-design
---

# canvas-design

skills/composiohq/awesome-claude-skills/canvas-design
canvas-design
Originally fromanthropics/skills
Installation
$ npx skills add https://github.com/composiohq/awesome-claude-skills --skill canvas-design
Summary
...
Emphasizes sparse, essential-only text integrated as visual element; ideas communicate through spatial relationships, color zones, typography, and composition rather than explanation
Deduces subtle conceptual threads embedded within the design—refined references that reward deeper viewing without announcing themselves literally
Produces museum or magazine-quality work using systematic visual language, repeating patterns, and expert-level craftsmanship that appears labored over with painstaking attention to detail
SKILL.md
