...
rating: ⭐⭐⭐
title: spec-shaping
url: https://skills.sh/nweii/agent-stuff/spec-shaping
---

# spec-shaping

skills/nweii/agent-stuff/spec-shaping
spec-shaping
Installation
$ npx skills add https://github.com/nweii/agent-stuff --skill spec-shaping
SKILL.md
Spec Shaping
...
Scan for: specs/, planning/, docs/specs/, product/.
If found: Use that directory.
Default: Create and use specs/.
Vaults: If external, check agents.md/claude.md for overrides.
