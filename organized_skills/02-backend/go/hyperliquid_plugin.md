...
url: https://skills.sh/okx/plugin-store/hyperliquid-plugin
---

# hyperliquid-plugin

skills/okx/plugin-store/hyperliquid-plugin
hyperliquid-plugin
Installation
...
The command will either report "status": "ready" (no extra setup needed) or "status": "setup_required" with two options:
...
Look up asset index from meta endpoint
...
Build withdraw3 user-signed EIP-712 action (domain: HyperliquidSignTransaction, chainId 0x66eee)
Sign via onchainos wallet sign-message --type eip712 with main wallet key
