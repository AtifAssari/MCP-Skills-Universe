---
rating: ⭐⭐
title: svg-animation-engineer
url: https://skills.sh/liuyunlong2021-wq/svg-skills/svg-animation-engineer
---

# svg-animation-engineer

skills/liuyunlong2021-wq/svg-skills/svg-animation-engineer
svg-animation-engineer
Installation
...
Advanced Animation See references/motion-examples.md for exact CSS implementations of Squash & Stretch, Overlapping Action, and exact easing parameters.
...
分析角色的几何解构和色彩系统。
拆解关键运动层次（背景层视差、前景主体）。
构建具备完善 xml 头、defs、style 和 g 标签的分组。
输出遵循结构模板的代码块。不要寒暄，直接输出包含完整内容的最终 SVG 代码块。
