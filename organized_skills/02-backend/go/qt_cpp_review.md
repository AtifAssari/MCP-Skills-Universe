...
rating: ⭐⭐⭐
title: qt-cpp-review
url: https://skills.sh/theqtcompanyrnd/agent-skills/qt-cpp-review
---

# qt-cpp-review

skills/theqtcompanyrnd/agent-skills/qt-cpp-review
qt-cpp-review
Installation
...
Pass --framework to the linter (if supported)
Load references/qt-framework-checklist.md alongside the universal checklist
Include framework rules in each agent's mission context
Scope detection
