...
url: https://skills.sh/eddiebe147/claude-settings/summarization-engine
---

# summarization engine

skills/eddiebe147/claude-settings/Summarization Engine
Summarization Engine
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Summarization Engine'
SKILL.md
Summarization Engine
