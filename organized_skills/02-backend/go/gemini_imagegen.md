...
url: https://skills.sh/everyinc/compound-engineering-plugin/gemini-imagegen
---

# gemini-imagegen

skills/everyinc/compound-engineering-plugin/gemini-imagegen
gemini-imagegen
Installation
...
Requires GEMINI_API_KEY environment variable; returns JPEG format by default
SKILL.md
