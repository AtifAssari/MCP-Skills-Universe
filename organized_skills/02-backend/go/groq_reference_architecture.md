---
rating: ⭐⭐⭐
title: groq-reference-architecture
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-reference-architecture
---

# groq-reference-architecture

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-reference-architecture
groq-reference-architecture
Installation
