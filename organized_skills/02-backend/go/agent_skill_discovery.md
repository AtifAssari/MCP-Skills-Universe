...
url: https://skills.sh/ericgandrade/claude-superskills/agent-skill-discovery
---

# agent-skill-discovery

skills/ericgandrade/claude-superskills/agent-skill-discovery
agent-skill-discovery
Installation
...
Parse YAML frontmatter: Extract the YAML block between --- delimiters:
