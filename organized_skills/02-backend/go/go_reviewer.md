...
rating: ⭐⭐
title: go-reviewer
url: https://skills.sh/googlecloudplatform/devrel-demos/go-reviewer
---

# go-reviewer

skills/googlecloudplatform/devrel-demos/go-reviewer
go-reviewer
Installation
$ npx skills add https://github.com/googlecloudplatform/devrel-demos --skill go-reviewer
SKILL.md
...
Workflow: Review
explain_symbol / smart_read: Understand the code deeply.
Analyze: Check against the rules above.
