...
skills/supercent-io/skills-template/technical-writing
technical-writing
Installation
...
Offers visual aid support via Mermaid diagrams, flowcharts, tables, and code examples with syntax highlighting
Covers best practices for clarity, structure, consistency, and maintenance, plus a self-review checklist and common mistakes to avoid
SKILL.md
Technical Writing
