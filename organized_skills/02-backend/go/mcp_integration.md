...
url: https://skills.sh/anthropics/claude-plugins-official/mcp-integration
---

# mcp-integration

skills/anthropics/claude-plugins-official/mcp-integration
mcp-integration
...
Tools available as mcp__plugin_...__...
...
Install plugin locally (.claude-plugin/)
Run /mcp to verify server appears
Test tool calls in commands
Check claude --debug logs for connection issues
...
Create .mcp.json at plugin root with configuration
Use ${CLAUDE_PLUGIN_ROOT} for all file references
Document required environment variables in README
Test locally with /mcp command
Pre-allow MCP tools in relevant commands
