...
rating: ⭐⭐⭐
title: go-mode
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/go-mode
---

# go-mode

skills/brianrwagner/ai-marketing-claude-code-skills/go-mode
go-mode
Installation
...
Parse the goal — What's the desired outcome? What does "done" look like?
Break into steps — Ordered task list, each step concrete and actionable
Identify tools — Which skills, APIs, agents, or CLI tools are needed?
Estimate effort — Time per step, total duration, API costs if applicable
Flag risks — What could go wrong? What needs human approval?
...
Announce the current step: "Step 2/5: Researching competitor pricing..."
Execute using the identified tool/skill
Checkpoint after each major step — brief status update
Pause if:
A guardrail is triggered (external action, spend, irreversible)
Something unexpected happens
A decision point requires human judgment
Adapt — If a step fails, try alternatives before escalating
Phase 4: REPORT
...
Safety — Never take external actions without approval
Efficiency — Use the cheapest/fastest tool for each step
Resilience — Try alternatives before giving up
Accountability — Report everything that was done
Respect time — Estimate honestly, checkpoint if running long
Weekly Installs
76
Repository
