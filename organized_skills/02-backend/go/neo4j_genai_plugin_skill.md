...
url: https://skills.sh/neo4j-contrib/neo4j-skills/neo4j-genai-plugin-skill
---

# neo4j-genai-plugin-skill

skills/neo4j-contrib/neo4j-skills/neo4j-genai-plugin-skill
neo4j-genai-plugin-skill
Installation
...
Count nodes first: MATCH (c:Chunk) WHERE c.embedding IS NULL RETURN count(c)
Verify config with one test node before batch
Use CALL { ... } IN TRANSACTIONS OF 500 ROWS for batches > 1000 nodes
