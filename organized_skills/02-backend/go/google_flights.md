...
url: https://skills.sh/skillhq/flight-search/google-flights
---

# google-flights

skills/skillhq/flight-search/google-flights
google-flights
Installation
...
Provides booking provider links (airlines, OTAs) after results; keeps session alive for user-selected flight handoff to booking sites
SKILL.md
