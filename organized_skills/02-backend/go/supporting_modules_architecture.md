---
rating: ⭐⭐
title: supporting-modules-architecture
url: https://skills.sh/tencentblueking/bk-ci/supporting-modules-architecture
---

# supporting-modules-architecture

skills/tencentblueking/bk-ci/supporting-modules-architecture
supporting-modules-architecture
Installation
$ npx skills add https://github.com/tencentblueking/bk-ci --skill supporting-modules-architecture
SKILL.md
支撑模块架构指南
Skill 概述
