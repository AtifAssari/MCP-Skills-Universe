...
url: https://skills.sh/google/agents-cli/google-agents-cli-deploy
---

# google-agents-cli-deploy

skills/google/agents-cli/google-agents-cli-deploy
google-agents-cli-deploy
Installation
...
If prototype (no deployment target), first enhance: agents-cli scaffold enhance . --deployment-target <target>
Notify the human: "Eval scores meet thresholds and tests pass. Ready to deploy to dev?"
Wait for explicit approval
Once approved: agents-cli deploy
