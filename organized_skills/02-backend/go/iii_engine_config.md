---
rating: ⭐⭐⭐
title: iii-engine-config
url: https://skills.sh/iii-hq/skills/iii-engine-config
---

# iii-engine-config

skills/iii-hq/skills/iii-engine-config
iii-engine-config
Installation
$ npx skills add https://github.com/iii-hq/skills --skill iii-engine-config
SKILL.md
Engine Config
