...
rating: ⭐⭐⭐
title: cook-auto
url: https://skills.sh/duc01226/easyplatform/cook-auto
---

# cook-auto

skills/duc01226/easyplatform/cook-auto
cook-auto
Installation
$ npx skills add https://github.com/duc01226/easyplatform --skill cook-auto
SKILL.md
...
Analyze — Understand task requirements from arguments
Plan & Execute — Create plan and implement directly
Verify — Run tests and review changes
...
Workflow:
Trigger slash command /plan <detailed-instruction-prompt> to create an implementation plan based on the given tasks.
...
Finally use AskUserQuestion tool to ask user if he wants to commit to git repository, if yes trigger /commit slash command to create a commit.
