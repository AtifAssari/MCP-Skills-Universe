---
rating: ⭐⭐
title: china-growth-ops
url: https://skills.sh/abyssallobsterv587-arch/china-growth-ops-skill/china-growth-ops
---

# china-growth-ops

skills/abyssallobsterv587-arch/china-growth-ops-skill/china-growth-ops
china-growth-ops
Installation
$ npx skills add https://github.com/abyssallobsterv587-arch/china-growth-ops-skill --skill china-growth-ops
SKILL.md
...
Use docs/install.md for quick install and execution guidance
Use scripts/doctor.sh for a lightweight local readiness check
...
Pick one product, offer, or campaign goal.
Choose one primary platform and one secondary platform.
Produce platform-specific copy from a single source offer.
Prepare browser steps and field values.
Stop at login, captcha, payment, publish, or other irreversible actions unless the user explicitly wants blind GUI attempts.
Record outputs and next actions for reuse.
Core Workflow
...
Read references/platforms.md for platform-specific product and content angles. For vertical-specific offer angles and output packs, read references/verticals.md.
...
Read references/templates.md for reusable copy patterns. For a full example of one end-to-end run, read references/example-run.md. For product scoring before execution, read references/product-scorecard.md.
...
Platform plan
Copy pack
Browser-ready fields
Risks and blockers
KPI checklist

For publish preparation and review, use:

references/publish-checklists.md
references/daily-review.md

For service packaging and client delivery, use:

references/service-packages.md
references/client-delivery.md
Weekly Installs
16
Repository
abyssallobsterv…ps-skill
GitHub Stars
3
First Seen
Mar 6, 2026
