...
rating: ⭐⭐
title: django-models
url: https://skills.sh/kjnez/claude-code-django/django-models
---

# django-models

skills/kjnez/claude-code-django/django-models
django-models
Installation
$ npx skills add https://github.com/kjnez/claude-code-django --skill django-models
SKILL.md
