...
url: https://skills.sh/samber/cc-skills-golang/golang-samber-mo
---

# golang-samber-mo

skills/samber/cc-skills-golang/golang-samber-mo
golang-samber-mo
Installation
...
Option for nullable fields, not zero values — Option[string] distinguishes "absent" from "empty string"; use plain string when empty string is a valid value
Chain, don't nest — result.Map(...).FlatMap(...).OrElse(default) reads left-to-right; avoid nested if/else patterns when monadic chaining is cleaner
