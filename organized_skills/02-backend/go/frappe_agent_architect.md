---
rating: ⭐⭐⭐
title: frappe-agent-architect
url: https://skills.sh/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-agent-architect
---

# frappe-agent-architect

skills/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-agent-architect
frappe-agent-architect
Installation
