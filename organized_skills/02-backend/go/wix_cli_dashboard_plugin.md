---
rating: ⭐⭐⭐
title: wix-cli-dashboard-plugin
url: https://skills.sh/wix/skills/wix-cli-dashboard-plugin
---

# wix-cli-dashboard-plugin

skills/wix/skills/wix-cli-dashboard-plugin
wix-cli-dashboard-plugin
Installation
...
Follow these steps in order when creating a dashboard plugin:
 ...
 Create plugin folder: src/extensions/dashboard/plugins/<plugin-name>/
 Create <plugin-name>.extension.ts with extensions.dashboardPlugin() and unique UUID
 Create <plugin-name>.tsx with React component wrapped in WixDesignSystemProvider
...
Logical Integration — Implementing communication between the plugin and the host page's data via observeState()
