...
rating: ⭐⭐⭐
title: se-dev-plugin
url: https://skills.sh/viktor-ferenczi/se-dev-skills/se-dev-plugin
---

# se-dev-plugin

skills/viktor-ferenczi/se-dev-skills/se-dev-plugin
se-dev-plugin
Installation
...
PatchInjections.md - Special parameters: __instance, __result, ___fields, __state
AccessTools.md - Reflection utilities for finding methods, fields, and types
