...
rating: ⭐⭐⭐
title: agora
url: https://skills.sh/geekjourneyx/agora/agora
---

# agora

skills/geekjourneyx/agora/agora
agora
Installation
...
The central square of the deliberation ecosystem. Named for the ancient Greek gathering place where citizens brought every kind of question.
...
Pure technical question (code + no life context) → /forge
Pure business question (market + no personal context) → /bazaar
Cross-domain: life + work (e.g., "辞职去创业" / "quit job to start company") → /oracle first (life direction takes precedence over business analysis)
Cross-domain: relationship + work (e.g., "manager conflict") → /hearth for interpersonal, /oracle if career direction question
Psychological + life direction → /clinic for the symptom, but note /oracle if the root is directional
Creative + life meaning → /atelier for the creative dimension, note /oracle if deeper
...
/oracle — life direction is the foundation of all else
/hearth — relationship quality shapes everything downstream
/clinic — psychological health enables everything else
/bazaar — commercial strategy builds on healthy foundations
/forge — technical execution serves the strategy
/atelier — creative practice expresses the person
