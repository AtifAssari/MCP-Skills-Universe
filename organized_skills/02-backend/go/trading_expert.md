...
url: https://skills.sh/personamanagmentlayer/pcl/trading-expert
---
...
Provides risk management tools: position sizing via Kelly Criterion, Value at Risk calculation, portfolio risk limits, and stop-loss mechanisms
Handles real-time market data processing including order book management, VWAP calculation, and bid-ask spread analysis
Best practices section covers backtesting discipline, transaction cost awareness, paper trading validation, and latency monitoring for live systems
SKILL.md
Trading Expert
