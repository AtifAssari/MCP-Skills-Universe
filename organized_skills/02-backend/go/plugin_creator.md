...
url: https://skills.sh/krzysztofsurdy/code-virtuoso/plugin-creator
---

# plugin-creator

skills/krzysztofsurdy/code-virtuoso/plugin-creator
plugin-creator
Installation
$ npx skills add https://github.com/krzysztofsurdy/code-virtuoso --skill plugin-creator
SKILL.md
Plugin Creator
...
Reject reserved marketplace names (claude-code-marketplace, anthropic-marketplace, etc. -- full list in references/marketplace-manifest.md).
