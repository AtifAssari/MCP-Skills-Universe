---
rating: ⭐⭐⭐
title: ros2-engineering-skills
url: https://skills.sh/dbwls99706/ros2-engineering-skills/ros2-engineering-skills
---

# ros2-engineering-skills

skills/dbwls99706/ros2-engineering-skills/ros2-engineering-skills
ros2-engineering-skills
Installation
...
references/*.md — load on demand. Use the Decision Router below to pick the 1–2 files relevant to the user's current task. Do NOT read all 20 reference files — that wastes context and causes confusion.
scripts/ — run only when the user needs code generation, QoS checking, or launch validation. These are tools, not reading material.

Steps:

If .skill-runs.log exists in the workspace, read the last few lines to understand what was done and what issues occurred in previous sessions.
Identify what the user is building (see Decision Router below).
Read only the matching references/*.md file(s) for detailed guidance.
