...
url: https://skills.sh/duc01226/easyplatform/design-screenshot
---

# design-screenshot

skills/duc01226/easyplatform/design-screenshot
design-screenshot
Installation
$ npx skills add https://github.com/duc01226/easyplatform --skill design-screenshot
SKILL.md
...
Workflow:
Use ai-multimodal skills to describe super details of the screenshot (design style, trends, fonts, colors, border, spacing, elements' positions, size, shape, texture, material, light, shadow, reflection, refraction, blur, glow, image, background transparency, transition, etc.)
IMPORTANT: Try to predict the font name (Google Fonts) and font size in the given screenshot, don't just use Inter or Poppins.
Use ui-ux-designer subagent to create a design plan following the progressive disclosure structure so the final result matches the screenshot:
