---
rating: ⭐⭐
title: messaging-testing-kafka
url: https://skills.sh/claude-dev-suite/claude-dev-suite/messaging-testing-kafka
---

# messaging-testing-kafka

skills/claude-dev-suite/claude-dev-suite/messaging-testing-kafka
messaging-testing-kafka
Installation
