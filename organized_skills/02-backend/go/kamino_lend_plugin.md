---
rating: ⭐⭐⭐
title: kamino-lend-plugin
url: https://skills.sh/okx/plugin-store/kamino-lend-plugin
---

# kamino-lend-plugin

skills/okx/plugin-store/kamino-lend-plugin
kamino-lend-plugin
Installation
$ npx skills add https://github.com/okx/plugin-store --skill kamino-lend-plugin
SKILL.md
...
Ensure kamino-lend binary is installed and in PATH
Ensure onchainos is installed and you are logged in: onchainos wallet balance --chain 501
Wallet is on Solana mainnet (chain 501)
Commands
