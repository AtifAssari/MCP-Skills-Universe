...
url: https://skills.sh/jeffallan/claude-skills/websocket-engineer
---

# websocket-engineer

skills/jeffallan/claude-skills/websocket-engineer
websocket-engineer
Installation
...
Validate locally — Test connection handling, auth, and room behavior before scaling (e.g., npx wscat -c ws://localhost:3000); confirm auth rejection on missing/invalid tokens, room join/leave events, and message delivery
