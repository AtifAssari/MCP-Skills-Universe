...
rating: ⭐⭐⭐
title: playwriter
url: https://skills.sh/supercent-io/skills-template/playwriter
---

# playwriter

skills/supercent-io/skills-template/playwriter
playwriter
Installation
...
Includes built-in helpers for accessibility snapshots, screenshots with element labels, network interception, and screen recording
Session-based state management allows multi-step workflows with persistent variables across sequential commands
Supports remote browser control via tunneled relay server with token authentication
SKILL.md
