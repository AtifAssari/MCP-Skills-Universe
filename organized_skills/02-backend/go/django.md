...
rating: ⭐⭐⭐
title: django
url: https://skills.sh/claude-dev-suite/claude-dev-suite/django
---

# django

skills/claude-dev-suite/claude-dev-suite/django
django
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill django
SKILL.md
