...
url: https://skills.sh/cloudzun/teaching-assistant-skill/teaching-assistant
---

# teaching-assistant

skills/cloudzun/teaching-assistant-skill/teaching-assistant
teaching-assistant
Installation
$ npx skills add https://github.com/cloudzun/teaching-assistant-skill --skill teaching-assistant
SKILL.md
技术教学助手 V1.0
版本历史
V1.0.0 (2026-02-23)
...
按照 templates/lesson_template.md 模板生成课程内容
每个概念必须包含：
一句话解释（是什么）
生活类比（像什么）
代码示例（怎么用）
