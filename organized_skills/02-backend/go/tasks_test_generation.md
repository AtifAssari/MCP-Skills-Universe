---
rating: ⭐⭐
title: tasks-test-generation
url: https://skills.sh/duc01226/easyplatform/tasks-test-generation
---

# tasks-test-generation

skills/duc01226/easyplatform/tasks-test-generation
tasks-test-generation
Installation
...
Read Patterns — MUST READ references/test-patterns.md for 5 canonical patterns
Write Tests — Follow Arrange-Act-Assert, mock dependencies, cover happy + edge + error paths
