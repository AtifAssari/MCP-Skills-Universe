...
url: https://skills.sh/pjt222/development-guides/configure-nginx
---

# configure-nginx

skills/pjt222/development-guides/configure-nginx
configure-nginx
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill configure-nginx
SKILL.md
Configure Nginx
