---
rating: ⭐⭐⭐
title: clawgod-claude-code-patch
url: https://skills.sh/aradotso/trending-skills/clawgod-claude-code-patch
---

# clawgod-claude-code-patch

skills/aradotso/trending-skills/clawgod-claude-code-patch
clawgod-claude-code-patch
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill clawgod-claude-code-patch
SKILL.md
