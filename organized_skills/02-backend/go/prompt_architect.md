...
url: https://skills.sh/samhvw8/dotfiles/prompt-architect
---
...
prompt-architect
Installation
$ npx skills add https://github.com/samhvw8/dotfiles --skill prompt-architect
SKILL.md
...
Soul — Identity, thinking style, dynamic tensions, instincts, boundaries
Mental Models — How experts conceptualize
Thinking Approaches — Questions experts ask
