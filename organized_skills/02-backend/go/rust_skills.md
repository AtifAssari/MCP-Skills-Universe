...
rating: ⭐⭐⭐
title: rust-skills
url: https://skills.sh/leonardomso/rust-skills/rust-skills
---

# rust-skills

skills/leonardomso/rust-skills/rust-skills
rust-skills
Installation
...
Provides medium-priority guidance on naming conventions, type safety, testing, documentation, and project structure
References anti-patterns and common pitfalls to avoid, plus recommended Cargo.toml settings for release builds
Organized by prefix (e.g., own-, err-, async-) for quick lookup during code generation and review workflows
SKILL.md
Rust Best Practices
