...
rating: ⭐⭐⭐
title: compound-docs
url: https://skills.sh/everyinc/compound-engineering-plugin/compound-docs
---
...
Add to docs/solutions/patterns/critical-patterns.md
...
Run python3 .claude/skills/skill-creator/scripts/init_skill.py [skill-name]
