---
rating: ⭐⭐⭐
title: nginx-config-optimizer
url: https://skills.sh/patricio0312rev/skills/nginx-config-optimizer
---
...
nginx-config-optimizer
Installation
$ npx skills add https://github.com/patricio0312rev/skills --skill nginx-config-optimizer
SKILL.md
Nginx Config Optimizer
