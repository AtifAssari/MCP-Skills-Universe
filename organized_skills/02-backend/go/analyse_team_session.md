---
rating: ⭐⭐⭐
title: analyse-team-session
url: https://skills.sh/sammcj/agentic-coding/analyse-team-session
---

# analyse-team-session

skills/sammcj/agentic-coding/analyse-team-session
analyse-team-session
Installation
...
https://code.claude.com/docs/en/agent-teams - best practices, when to use, architecture, limitations
https://code.claude.com/docs/en/costs - the "Agent team token costs" and "Manage agent team costs" sections
...
Common Pitfalls
Vague ratings: Saying "Communication was Partial" without quoting the actual messages (or lack thereof). Always cite evidence.
Hedging the verdict: If it was a poor fit for agent teams, say so. The point of the analysis is honest feedback, not diplomacy.
Generic recommendations: "Improve task sizing" is useless. "Split the single review task into 3 focused sub-tasks (voice, engagement, accuracy) with 2-3 checkpoints each" is actionable.
Weekly Installs
11
Repository
