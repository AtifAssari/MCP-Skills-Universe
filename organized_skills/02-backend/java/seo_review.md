...
rating: ⭐⭐⭐⭐⭐
title: seo-review
url: https://skills.sh/leonardomso/33-js-concepts/seo-review
---

# seo-review

skills/leonardomso/33-js-concepts/seo-review
seo-review
Installation
$ npx skills add https://github.com/leonardomso/33-js-concepts --skill seo-review
Summary

Perform focused SEO audits on JavaScript concept pages to maximize search visibility and ranking potential.
...
Offers detailed checklists for title tags, meta descriptions, keyword placement, content structure, featured snippets, internal linking, and technical SEO with scoring rubric (30 points total)
Supplies comprehensive audit report template, common issue fixes, and implementation checklist to guide optimization work
SKILL.md
...
Search the codebase for links to this concept: grep -r "/concepts/[slug]" docs/
