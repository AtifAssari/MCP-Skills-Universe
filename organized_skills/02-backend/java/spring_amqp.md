...
rating: ⭐⭐
title: spring-amqp
url: https://skills.sh/claude-dev-suite/claude-dev-suite/spring-amqp
---

# spring-amqp

skills/claude-dev-suite/claude-dev-suite/spring-amqp
spring-amqp
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill spring-amqp
SKILL.md
Spring AMQP (RabbitMQ) - Quick Reference

Full Reference: See advanced.md for exchange types (topic, fanout), consumer patterns (multi-method, request-reply), error handling, DLQ processing, and testing.
