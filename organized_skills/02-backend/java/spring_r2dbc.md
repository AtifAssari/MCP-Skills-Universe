...
rating: ⭐⭐
title: spring-r2dbc
url: https://skills.sh/claude-dev-suite/claude-dev-suite/spring-r2dbc
---

# spring-r2dbc

skills/claude-dev-suite/claude-dev-suite/spring-r2dbc
spring-r2dbc
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill spring-r2dbc
SKILL.md
Spring Data R2DBC
Quick Start
<!-- pom.xml -->
