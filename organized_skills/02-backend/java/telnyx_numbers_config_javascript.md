---
rating: ⭐⭐
title: telnyx-numbers-config-javascript
url: https://skills.sh/team-telnyx/skills/telnyx-numbers-config-javascript
---

# telnyx-numbers-config-javascript

skills/team-telnyx/skills/telnyx-numbers-config-javascript
telnyx-numbers-config-javascript
Installation
$ npx skills add https://github.com/team-telnyx/skills --skill telnyx-numbers-config-javascript
SKILL.md
Telnyx Numbers Config - JavaScript
Installation
npm install telnyx
