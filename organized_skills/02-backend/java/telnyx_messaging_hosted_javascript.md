---
rating: ⭐⭐
title: telnyx-messaging-hosted-javascript
url: https://skills.sh/team-telnyx/skills/telnyx-messaging-hosted-javascript
---

# telnyx-messaging-hosted-javascript

skills/team-telnyx/skills/telnyx-messaging-hosted-javascript
telnyx-messaging-hosted-javascript
Installation
$ npx skills add https://github.com/team-telnyx/skills --skill telnyx-messaging-hosted-javascript
SKILL.md
Telnyx Messaging Hosted - JavaScript
Installation
npm install telnyx
