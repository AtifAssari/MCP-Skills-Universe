---
rating: ⭐⭐
title: python-package-migrator
url: https://skills.sh/jorgealves/agent_skills/python-package-migrator
---

# python-package-migrator

skills/jorgealves/agent_skills/python-package-migrator
python-package-migrator
Installation
