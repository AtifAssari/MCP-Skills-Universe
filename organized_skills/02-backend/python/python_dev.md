...
rating: ⭐⭐⭐
title: python-dev
url: https://skills.sh/tenequm/skills/python-dev
---

# python-dev

skills/tenequm/skills/python-dev
python-dev
Installation
$ npx skills add https://github.com/tenequm/skills --skill python-dev
SKILL.md
