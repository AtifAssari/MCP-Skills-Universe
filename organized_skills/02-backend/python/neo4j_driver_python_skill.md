---
rating: ⭐⭐⭐
title: neo4j-driver-python-skill
url: https://skills.sh/neo4j-contrib/neo4j-skills/neo4j-driver-python-skill
---
...
references/transactions.md — explicit transactions, rollback, commit uncertainty, unit_of_work details
