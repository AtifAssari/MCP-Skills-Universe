---
rating: ⭐⭐
title: architect-python-uv-batch
url: https://skills.sh/ajrlewis/ai-skills/architect-python-uv-batch
---

# architect-python-uv-batch

skills/ajrlewis/ai-skills/architect-python-uv-batch
architect-python-uv-batch
Installation
...
Scaffold Workflow
Initialize project (production-default or local-no-docker):
...
If USE_RAG=yes, add RAG dependencies:
...
.dockerignore
docker-compose.yml
Wire command entrypoint in pyproject.toml:
[project.scripts]
