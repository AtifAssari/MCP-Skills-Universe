---
rating: ⭐⭐⭐
title: python-database-ops
url: https://skills.sh/0xdarkmatter/claude-mods/python-database-ops
---

# python-database-ops

skills/0xdarkmatter/claude-mods/python-database-ops
python-database-ops
Installation
$ npx skills add https://github.com/0xdarkmatter/claude-mods --skill python-database-ops
SKILL.md
