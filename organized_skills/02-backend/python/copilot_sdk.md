...
skills/github/awesome-copilot/copilot-sdk
copilot-sdk
Installation
...
Best Practices
Always cleanup: Use try-finally or defer to ensure client.stop() is called
Set timeouts: Use sendAndWait with timeout for long operations
