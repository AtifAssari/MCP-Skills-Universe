...
rating: ⭐⭐
title: seo
url: https://skills.sh/whawkinsiv/claude-code-skills/seo
---

# seo

skills/whawkinsiv/claude-code-skills/seo
seo
Installation
...
Do keyword research first using a free tool: Google Search Console (what you already rank for), Google autocomplete (type your topic and note suggestions), or AnswerThePublic
Then paste results into your AI tool:
...
Pillar page — Comprehensive overview (e.g., "Complete Guide to [Topic]")
Cluster pages — Specific subtopics (e.g., "How to [specific action]")
Internal links — Every cluster page links to the pillar. Pillar links to all clusters.
...
Bottom-of-funnel first: Comparison pages, pricing page, feature pages — these convert
Mid-funnel: How-to guides, use case pages — these build authority
Top-of-funnel: Glossary, broad guides — these drive volume (but lower conversion)
