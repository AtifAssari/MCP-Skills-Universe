---
rating: ⭐⭐⭐
title: gate-exchange-spot
url: https://skills.sh/gate/gate-skills/gate-exchange-spot
---
...
Account query (list spot balances / 查看现货账户余额, total assets, per-coin balance checks, tradability checks)
...
Place order with gate-exchange-spot (Case 2/9/23)
