---
rating: ⭐⭐⭐
title: analyze-chat-export
url: https://skills.sh/oocx/tfplan2md/analyze-chat-export
---

# analyze-chat-export

skills/oocx/tfplan2md/analyze-chat-export
analyze-chat-export
Installation
...
Focus the chat panel for the agent session to export.
Run command: workbench.action.chat.export
Save to: docs/features/NNN-<feature-slug>/<agent-name>.chat.json (e.g., developer.chat.json, architect.chat.json)
