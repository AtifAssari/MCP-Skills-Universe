...
url: https://skills.sh/qodex-ai/ai-agent-skills/media-transformation
---

# media-transformation

skills/qodex-ai/ai-agent-skills/media-transformation
media-transformation
Installation
...
Extract all field names from all objects
Count how many objects have the most common set of fields
Calculate: (objects with common fields / total objects) × 100
If ≥60%, uniformity is good for TOON
...
Detect array type (inline/tabular/expanded)
Choose delimiter (comma/tab/pipe)
Apply key folding if nested objects
Build TOON header: [N]{fields}: or key[N]: values
Output formatted TOON
...
Performance Tips
Batch processing: Convert large datasets once, reuse TOON format
Uniformity matters: Higher field overlap = better savings
Nested arrays: TOON supports nested structures but savings diminish
Type coercion: TOON preserves types (numbers, booleans, dates)
Examples
