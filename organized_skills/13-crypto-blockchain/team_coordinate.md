...
url: https://skills.sh/catlog22/claude-code-workflow/team-coordinate
---

# team-coordinate

skills/catlog22/claude-code-workflow/team-coordinate
team-coordinate
Installation
...
Create missing tasks, set dependencies via TaskUpdate({ addBlockedBy })
