---
rating: ⭐⭐⭐
title: memory-metadata-search
url: https://skills.sh/basicmachines-co/basic-memory-skills/memory-metadata-search
---

# memory-metadata-search

skills/basicmachines-co/basic-memory-skills/memory-metadata-search
memory-metadata-search
Installation
