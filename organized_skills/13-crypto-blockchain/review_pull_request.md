...
url: https://skills.sh/pjt222/development-guides/review-pull-request
---

# review-pull-request

skills/pjt222/development-guides/review-pull-request
review-pull-request
Installation
...
For small/medium PRs, read the entire diff sequentially
...
Re-review only the changes that address your feedback:
gh pr diff <number>  # check new commits

Verify Blocking items are resolved before approving
