...
rating: ⭐⭐
title: daxledger-api
url: https://skills.sh/daxledger/skills/daxledger-api
---

# daxledger-api

skills/daxledger/skills/daxledger-api
daxledger-api
Installation
$ npx skills add https://github.com/daxledger/skills --skill daxledger-api
SKILL.md
DAX Ledger API
...
Filter transactions	GET /api/portfolio/{portfolioId}/transactions?filter=	references/apis.md
