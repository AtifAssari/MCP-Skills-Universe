---
rating: ⭐⭐
title: rive-script-builder
url: https://skills.sh/sanqiushili/rive_skills/rive-script-builder
---

# rive-script-builder

skills/sanqiushili/rive_skills/rive-script-builder
rive-script-builder
Installation
...
scripts/sync_rive_docs.py (secondary fallback)
