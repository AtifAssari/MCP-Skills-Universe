---
rating: ⭐⭐⭐
title: use-typescript-sdk
url: https://skills.sh/iskysun96/aptos-agent-skills/use-typescript-sdk
---

# use-typescript-sdk

skills/iskysun96/aptos-agent-skills/use-typescript-sdk
use-typescript-sdk
Installation
...
Write data -> Use aptos.transaction.build.simple() + aptos.signAndSubmitTransaction()
...
NEVER use scriptComposer - it was removed in v6.0; use batch transactions or separate calls instead
NEVER use getAccountCoinAmount or getAccountAPTAmount - deprecated; use getBalance() instead
