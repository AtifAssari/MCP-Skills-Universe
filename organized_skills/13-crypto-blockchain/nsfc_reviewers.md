---
rating: ⭐⭐
title: nsfc-reviewers
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-reviewers
---

# nsfc-reviewers

skills/huangwb8/chineseresearchlatex/nsfc-reviewers
nsfc-reviewers
Installation
...
准备中间目录。
基于 references/expert_*.md 和 references/master_prompt_template.md 生成 master prompt。
用 scripts/build_parallel_vibe_plan.py 生成 plan.json。
调用 parallel-vibe 执行 N 组独立评审。
收集每组 panel_output_filename，允许个别 thread 缺失但不能中断整体汇总。
