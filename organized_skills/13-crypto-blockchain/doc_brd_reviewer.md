---
rating: ⭐⭐⭐
title: doc-brd-reviewer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-brd-reviewer
---

# doc-brd-reviewer

skills/vladm3105/aidoc-flow-framework/doc-brd-reviewer
doc-brd-reviewer
Installation
...
Create the nested folder docs/01_BRD/BRD-NN_{slug}/
...
Map file to section number from filename pattern
Validate section content within that file
Cross-reference section numbering consistency
...
Simple legacy	`(FR	AC
Compound legacy	`(FR	AC
Domain-prefixed	`(FR	NFR)-[A-Z]+-[0-9]+`
...
Read YAML frontmatter custom_fields.upstream_mode
Apply behavior:
...
Read stored hash from .drift_cache.json
Validate stored hash - if placeholder, flag REV-D009 and compute real hash
Compute current hash via bash:
...
Update cache with current hash and timestamp
9.4 Error Codes
...
Versioning Rules
First Review: Creates BRD-NN.R_review_report_v001.md
