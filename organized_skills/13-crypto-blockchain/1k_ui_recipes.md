...
rating: ⭐⭐
title: 1k-ui-recipes
url: https://skills.sh/onekeyhq/app-monorepo/1k-ui-recipes
---

# 1k-ui-recipes

skills/onekeyhq/app-monorepo/1k-ui-recipes
1k-ui-recipes
Installation
...
Carousel on Home tab has autoPlayInterval={5000} → triggers scroll every 5s
Web PagerView uses <ScrollView keyboardDismissMode="on-drag"> → dismissKeyboard() on scroll
dismissKeyboard() → TextInputState.blurTextInput(currentlyFocusedField()) → blurs Perps input
