---
rating: ⭐⭐⭐
title: project-discover-products-ops-dod
url: https://skills.sh/zixun-github/aisdlc/project-discover-products-ops-dod
---

# project-discover-products-ops-dod

skills/zixun-github/aisdlc/project-discover-products-ops-dod
project-discover-products-ops-dod
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill project-discover-products-ops-dod
SKILL.md
...
数据主责：哪个组件主写哪些核心对象（来自模块页 ## Data Contract）
对外能力边界：哪些 API 是稳定承诺（来自模块页 ## API Contract）
组织边界：owner/team 划分（来自 components/index.md）
运行边界：独立部署/SLO 的单元（如果证据存在）
...
若存在缺口，必须写入 ## Evidence Gaps（缺口清单），且不得打勾
P1 模块允许 - [x] 的降级条件
...
识别受影响模块（根据变更文件列表与模块页 source_files）
只更新这些模块的：
