...
url: https://skills.sh/likaihz/tz-agent-skills/technical-research
---

# technical-research

skills/likaihz/tz-agent-skills/technical-research
technical-research
Installation
...
读取现有索引：检查 research/SUMMARY.md 是否存在
确定分类：根据文档 topic 字段归类
添加条目：按日期倒序插入到对应分类
验证链接：确保文件路径正确
