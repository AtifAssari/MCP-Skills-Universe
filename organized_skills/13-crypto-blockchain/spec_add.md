...
rating: ⭐⭐⭐
title: spec-add
url: https://skills.sh/catlog22/claude-code-workflow/spec-add
---

# spec-add

skills/catlog22/claude-code-workflow/spec-add
spec-add
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill spec-add
SKILL.md
Spec Add Command
Overview
