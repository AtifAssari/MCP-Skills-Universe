...
rating: ⭐⭐⭐
title: signoz
url: https://skills.sh/absolutelyskilled/absolutelyskilled/signoz
---

# signoz

skills/absolutelyskilled/absolutelyskilled/signoz
signoz
Installation
...
Add filters (e.g. service.name = my-app)
Choose aggregation (Count, Avg, P99, Rate, etc.)
Group by attributes (e.g. method, status_code)
Set visualization type (time series, bar, pie chart, table)
