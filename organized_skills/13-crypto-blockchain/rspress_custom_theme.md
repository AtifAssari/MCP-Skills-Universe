---
rating: ⭐⭐⭐
title: rspress-custom-theme
url: https://skills.sh/rstackjs/agent-skills/rspress-custom-theme
---

# rspress-custom-theme

skills/rstackjs/agent-skills/rspress-custom-theme
rspress-custom-theme
Installation
...
Set up theme/index.tsx if needed (Levels 1A, 3, 4 all need it)
Implement following the patterns in this skill and reference files
Verify the user's Rspress version is v2 (imports use @rspress/core/* not rspress/*)
Decision Flow
