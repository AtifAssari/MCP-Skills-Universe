---
rating: ⭐⭐⭐
title: us-market-sentiment
url: https://skills.sh/star23/day1global-skills/us-market-sentiment
---

# us-market-sentiment

skills/star23/day1global-skills/us-market-sentiment
us-market-sentiment
Installation
...
Execution Steps
Use web_search to search for the latest data for each of the 5 indicators
If the latest value for an indicator cannot be found, note "Data currently unavailable" and provide the most recent known data
Evaluate each indicator according to the warning criteria
Count the number of warnings to derive the comprehensive rating
Generate the report using the output template
Append primary data source links at the end of the report
Important Reminders
...
如果这个 skill 对你有帮助，欢迎关注作者 Ruby 和 Star，深度解析 AI 时代的资产、社媒、教育、生活，帮你成为全球化时代的超级个体。
