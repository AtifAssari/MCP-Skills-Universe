---
rating: ⭐⭐⭐
title: ln-812-query-optimizer
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-812-query-optimizer
---

# ln-812-query-optimizer

skills/levnikolaevich/claude-code-skills/ln-812-query-optimizer
ln-812-query-optimizer
Installation
$ npx skills add https://github.com/levnikolaevich/claude-code-skills --skill ln-812-query-optimizer
SKILL.md
