---
rating: ⭐⭐
title: paw-mkt-product-context
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-product-context
---

# paw-mkt-product-context

skills/pawbytes/skill-suites/paw-mkt-product-context
paw-mkt-product-context
Installation
...
"I've extracted the following from your SOSTAC plan: ✓ Product overview (Situation Analysis) ✓ Target audience + 2 personas (Strategy) ✓ Competitive landscape — 4 competitors mapped ✗ Customer language — need verbatim phrases your customers actually use ✗ Proof points — need specific numbers and case study results
...
Route the starting context — Read ./references/shared-patterns.md for Starting Context Router. Decide: new brand (blank-page), existing SOSTAC (extract-first), or update (gap-scan).
Read strategic context — Pre-Flight: check for existing brand-context.md and SOSTAC files. Extract positioning intelligence before asking questions.
Assess document completeness — Load ./references/check-existing.md to evaluate which of the 12 sections are complete, partial, or missing.
Conduct focused interview — Ask only for gaps not answered by existing materials. Use verbatim customer language whenever possible.
Build or update the document — Follow ./references/document-template.md for the 12-section structure. Sync with brand-context.md.
Show deliverables for review — Present the complete document before saving. Ask: "Anything you'd change before I save this?"
Save deliverables after confirmation — Write to the resolved path.
Recommend next steps — Suggest which marketing specialists should read the updated context, or flag sections needing more customer research — but DO NOT start until user approves.
Saving Protocol
