...
rating: ⭐⭐⭐
title: charting
url: https://skills.sh/starchild-ai-agent/official-skills/charting
---
...
Read template from skills/charting/scripts/
Write script to scripts/
Run script with bash
Call read_file on the output PNG, then display it using markdown image syntax: ![Chart description](output/filename.png)
