...
url: https://skills.sh/qodex-ai/ai-agent-skills/pattern-generator
---

# pattern-generator

skills/qodex-ai/ai-agent-skills/pattern-generator
pattern-generator
Installation
$ npx skills add https://github.com/qodex-ai/ai-agent-skills --skill pattern-generator
SKILL.md
