...
url: https://skills.sh/clerk/skills/clerk-backend-api
---

# clerk-backend-api

skills/clerk/skills/clerk-backend-api
clerk-backend-api
Installation
...
Run the mandatory checks from the CRITICAL section above.
...
Build and execute a direct curl command (see How to execute requests above). Do NOT use scripts/execute-request.sh.
Parse the JSON response and display it clearly. Extract and summarize key fields for the user.
