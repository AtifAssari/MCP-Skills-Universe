...
url: https://skills.sh/jwynia/agent-skills/docx-generator
---

# docx-generator

skills/jwynia/agent-skills/docx-generator
docx-generator
Installation
...
Run analyze-template.ts to verify exact tag text
Tags may be split across XML runs - the script consolidates these automatically
Ensure includeHeaders and includeFooters are true if placeholders are there
