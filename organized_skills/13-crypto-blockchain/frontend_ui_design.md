...
url: https://skills.sh/pixel-process-ug/superkit-agents/frontend-ui-design
---

# frontend-ui-design

skills/pixel-process-ug/superkit-agents/frontend-ui-design
frontend-ui-design
Installation
...
Selection Heuristic
Start with useState — only escalate when you hit a real limitation
If prop drilling exceeds 2 levels, consider Context or state library
