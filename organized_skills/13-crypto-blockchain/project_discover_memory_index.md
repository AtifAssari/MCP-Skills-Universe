---
rating: ⭐⭐⭐⭐⭐
title: project-discover-memory-index
url: https://skills.sh/zixun-github/aisdlc/project-discover-memory-index
---

# project-discover-memory-index

skills/zixun-github/aisdlc/project-discover-memory-index
project-discover-memory-index
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill project-discover-memory-index
SKILL.md
