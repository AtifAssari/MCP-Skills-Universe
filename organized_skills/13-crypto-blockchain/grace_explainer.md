---
rating: ⭐⭐
title: grace-explainer
url: https://skills.sh/osovv/grace-marketplace/grace-explainer
---

# grace-explainer

skills/osovv/grace-marketplace/grace-explainer
grace-explainer
Installation
...
$grace-plan — architect modules, data flows, and verification refs
...
$grace-refactor — rename, move, split, merge, or extract modules without drift
$grace-refresh — sync graph and verification refs after manual changes
$grace-fix error-description — debug via semantic navigation
$grace-status — health report
$grace-ask — grounded Q&A over the project artifacts
Detailed References
