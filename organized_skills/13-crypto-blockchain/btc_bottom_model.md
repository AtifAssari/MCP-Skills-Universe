---
rating: ⭐⭐⭐
title: btc-bottom-model
url: https://skills.sh/star23/day1global-skills/btc-bottom-model
---

# btc-bottom-model

skills/star23/day1global-skills/btc-bottom-model
btc-bottom-model
Installation
...
Execution Steps
Primary data source (one call gets everything): Fetch all 13 indicators, pre-calculated scores, and BTC price from a single endpoint:
...
Fallback: If the API is unavailable, use web_search to find each indicator's latest data from the fallback sources listed below
