...
url: https://skills.sh/eddiebe147/claude-settings/legal-assistant
---

# legal assistant

skills/eddiebe147/claude-settings/Legal Assistant
Legal Assistant
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Legal Assistant'
SKILL.md
Legal Assistant
...
Document Intake - Upload or paste contract text
Structural Analysis - Identify contract type, parties, term, and key sections
Clause-by-Clause Review - Analyze each provision for:
...
Risk Flagging - Highlight unusual, one-sided, or problematic clauses
Plain English Summary - Translate legal language into clear business terms
Negotiation Recommendations - Suggest specific revisions or counterproposals
Redline Document - Provide marked-up version with suggested changes
...
Requirements Gathering - Understand document purpose, parties, and key terms
Template Selection - Choose appropriate legal framework:
Service Agreement
...
Licensing Agreement
Customization - Adapt template to specific situation with:
...
Plain Language Option - Provide simplified version alongside legal text
Checklist Generation - Create execution checklist (signatures, witnesses, notarization)
...
Identify Applicable Regulations - Determine which laws apply based on:
Industry (healthcare, finance, retail, tech)
Geography (federal, state, local)
Business activity (data collection, employment, sales)
Compliance Audit - Review current practices against requirements for:
...
Tax obligations
Gap Analysis - Identify areas of non-compliance or risk
Action Plan - Create prioritized remediation steps with:
Required policy updates
Process changes
Documentation needs
Training requirements
Policy Template Provision - Provide customizable compliance policies
...
Issue Identification - Clarify the legal question or concept
Jurisdictional Research - Identify relevant laws, regulations, and standards
Precedent Review - Examine common industry practices and standard clauses
Case Law Summary - Provide overview of relevant legal principles (general education)
Practical Guidance - Translate findings into actionable business advice
Further Resources - Recommend specific attorneys or legal resources for formal advice
