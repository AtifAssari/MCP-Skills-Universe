...
url: https://skills.sh/jk-0001/skills/reclaim-your-brain
---

# reclaim-your-brain

skills/jk-0001/skills/reclaim-your-brain
reclaim-your-brain
Installation
$ npx skills add https://github.com/jk-0001/skills --skill reclaim-your-brain
SKILL.md
Reclaim Your Brain
Overview
...
Start with simple questions to build foundational understanding
Guide you to discover concepts through questions
Ask you to explain back in your own words
Layer complexity gradually
Connect everything to knowledge you already have
...
Questions > Answers — If Claude gave you the answer directly, you're not learning, you're copying
Explain-back is mandatory — Understanding feels like understanding, but explaining reveals gaps
Build layer by layer — Resist the urge to skip ahead. Master the foundation first.
Connect to what you know — Every new concept should link to something familiar
Slow down to speed up — Learning deeply takes longer upfront, but you retain 10x more
