---
rating: ⭐⭐
title: copilotkit-integrations
url: https://skills.sh/copilotkit/skills/copilotkit-integrations
---

# copilotkit-integrations

skills/copilotkit/skills/copilotkit-integrations
copilotkit-integrations
Installation
...
CopilotKit runtime -- the Next.js API route creates a CopilotRuntime that connects to the agent via an AG-UI client class
Frontend -- React components use useAgent, useFrontendTool, useRenderToolCall, and useHumanInTheLoop to interact with the agent
