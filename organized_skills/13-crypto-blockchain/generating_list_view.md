---
rating: ⭐⭐
title: generating-list-view
url: https://skills.sh/forcedotcom/afv-library/generating-list-view
---

# generating-list-view

skills/forcedotcom/afv-library/generating-list-view
generating-list-view
Installation
...
force-app/main/default/objects//listViews/.listView-meta.xml Only if the user requests are they to be included in the object's metadata file:
...
Place files under the object's listViews directory or deployments will fail to resolve components. Only if a user requests it, may the listView may be included inline in force-app/main/default/objects//.object-meta.xml
...
"Component not found at path"	Wrong folder or file name	Place in objects//listViews and align file name with fullName
