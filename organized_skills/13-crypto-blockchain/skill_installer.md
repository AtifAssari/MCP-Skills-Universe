...
url: https://skills.sh/davila7/claude-code-templates/skill-installer
---

# skill-installer

skills/davila7/claude-code-templates/skill-installer
skill-installer
Originally fromopenai/skills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill skill-installer
SKILL.md
Skill Installer
