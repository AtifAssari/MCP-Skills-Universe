---
rating: ⭐⭐⭐
title: pre-publish-post-assistant
url: https://skills.sh/nicepkg/ai-workflow/pre-publish-post-assistant
---

# pre-publish-post-assistant

skills/nicepkg/ai-workflow/pre-publish-post-assistant
pre-publish-post-assistant
Installation
...
Static dist folder - Parse from built site (/category/, /tag/ pages)
Cached taxonomy file - Pre-generated taxonomy.json
Distribution Data
