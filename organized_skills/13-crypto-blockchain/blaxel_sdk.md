...
rating: ⭐⭐⭐
title: blaxel-sdk
url: https://skills.sh/blaxel-ai/agent-skills/blaxel-sdk
---

# blaxel-sdk

skills/blaxel-ai/agent-skills/blaxel-sdk
blaxel-sdk
Installation
$ npx skills add https://github.com/blaxel-ai/agent-skills --skill blaxel-sdk
SKILL.md
...
Environment variables in .env file (BL_WORKSPACE, BL_API_KEY)
System environment variables
Blaxel configuration file (~/.blaxel/config.yaml)
