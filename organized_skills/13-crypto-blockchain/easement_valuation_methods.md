---
rating: ⭐⭐
title: easement-valuation-methods
url: https://skills.sh/reggiechan74/vp-real-estate/easement-valuation-methods
---

# easement-valuation-methods

skills/reggiechan74/vp-real-estate/easement-valuation-methods
easement-valuation-methods
Installation
$ npx skills add https://github.com/reggiechan74/vp-real-estate --skill easement-valuation-methods
SKILL.md
...
Determine annual rent for comparable agricultural land without easement
Calculate percentage loss of agricultural productivity from easement (tower footprints, restricted areas, field division)
Apply loss percentage to annual rent to determine annual easement impact
Capitalize impact at risk-adjusted rate to determine easement value
...
Research market rates for comparable telecom sites (size, location, coverage importance)
Verify typical lease terms (20-25 year initial term, 3-5% annual escalations, renewal options)
Forecast cash flow including escalations
Select capitalization rate (6-8% depending on location stability and carrier creditworthiness)
Calculate NPV of perpetual income stream (assuming renewals)
...
Property rights: Fee simple vs. leasehold vs. life estate
Financing terms: Cash equivalent adjustment for seller financing
Conditions of sale: Arm's length, market exposure time, motivation
Market conditions/time: Trend analysis, quarterly price indices
Location: Micro-market differences, accessibility, development potential
Physical characteristics: Size, shape, topography, soil class, drainage, services
Easement characteristics: Type, width, restrictions, permanence, operator
...
Run regression on paired sales dataset
Check R-squared, coefficient significance, signs
Extract percentage from β₅ coefficient
Compare to percentage-of-fee ranges (10-25% for transmission easements)
Reconcile with income capitalization approach if applicable
Document methodology and confidence level
...
Research comparable land rental rates (similar use, location, duration)
Apply rental rate to affected area
Prorate for actual duration (days, months, years)
Add compensation for physical damage and restoration
...
Legal entitlement (expropriation-compensation-entitlement-analysis) → Confirm statutory authority, compensable components
Technical specifications (right-of-way-expert) → Define easement area, access requirements, restrictions
Easement valuation (this skill) → Value permanent easement using percentage of fee, income capitalization, before/after methods
Severance damages (severance-damages-quantification) → Quantify access loss, field division impacts to remainder 85 acres
TCE valuation (this skill) → Value 6-month construction easement using rate-of-return method
Construction impacts (injurious-affection-assessment) → Quantify noise, dust, vibration during installation
Agricultural impacts (cropland-out-of-production-agreements) → Analyze annual compensation for ongoing tower impacts vs. lump-sum
Negotiation strategy (agricultural-easement-negotiation-frameworks) → Structure offer considering farm succession, compensation preferences
Reconciliation (this skill) → Final compensation package integrating all components
