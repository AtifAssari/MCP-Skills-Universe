---
rating: ⭐⭐
title: ln-631-test-business-logic-auditor
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-631-test-business-logic-auditor
---

# ln-631-test-business-logic-auditor

skills/levnikolaevich/claude-code-skills/ln-631-test-business-logic-auditor
ln-631-test-business-logic-auditor
Installation
...
Write Report: Build full markdown report in memory per shared/templates/audit_worker_report_template.md, write to {output_dir}/ln-631--global.md in single Write call
