---
rating: ⭐⭐⭐
title: convert-web-app
url: https://skills.sh/modelcontextprotocol/ext-apps/convert-web-app
---

# convert-web-app

skills/modelcontextprotocol/ext-apps/convert-web-app
convert-web-app
Installation
...
Two-Phase Build
Vite bundles the UI → dist/mcp-app.html (single file with all assets inlined)
Server is compiled separately (TypeScript → JavaScript)
