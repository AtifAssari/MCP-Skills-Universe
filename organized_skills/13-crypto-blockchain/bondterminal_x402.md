---
rating: ⭐⭐
title: bondterminal-x402
url: https://skills.sh/0juano/agent-skills/bondterminal-x402
---

# bondterminal-x402

skills/0juano/agent-skills/bondterminal-x402
bondterminal-x402
Installation
...
How x402 Works
Call any x402 endpoint without auth → server returns 402 with PAYMENT-REQUIRED header
Decode the header (base64 JSON) to get payment requirements (amount, asset, network, payTo)
Sign an EIP-3009 transferWithAuthorization via the x402 client library
Retry the request with the signed payment in the PAYMENT-SIGNATURE header (v2), with X-PAYMENT as legacy fallback
Server verifies payment via Coinbase facilitator, returns data + PAYMENT-RESPONSE header
Setup
