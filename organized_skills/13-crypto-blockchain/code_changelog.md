...
url: https://skills.sh/bear2u/my-skills/code-changelog
---

# code-changelog

skills/bear2u/my-skills/code-changelog
code-changelog
Installation
...
📝 Best Practices
서버 항상 실행: 개발 중에는 서버를 계속 켜두기
작은 단위: 각 작업을 작은 단위로 나누어 문서화
명확한 제목: 프로젝트명을 명확하게 작성
정기적 백업: reviews 폴더를 Git으로 관리
브라우저 북마크: http://localhost:4000 북마크 추가
🎓 활용 예시
회원 가입 기능 구현
logger = CodeChangeLogger(
