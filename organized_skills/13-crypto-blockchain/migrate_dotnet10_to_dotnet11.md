...
url: https://skills.sh/dotnet/skills/migrate-dotnet10-to-dotnet11
---
...
Run dotnet --version to confirm the .NET 11 SDK is installed. If it is not, stop and inform the user.
...
Do a clean build (dotnet build --no-incremental or delete bin/obj) on the current net10.0 target to establish a clean baseline. Record any pre-existing warnings.
