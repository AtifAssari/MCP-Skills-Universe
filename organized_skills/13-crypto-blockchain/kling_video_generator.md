...
url: https://skills.sh/wells1137/kling-video-generator/kling-video-generator
---

# kling-video-generator

skills/wells1137/kling-video-generator/kling-video-generator
kling-video-generator
Installation
...
Consult the Prompting Guide: Read /home/ubuntu/skills/kling-video-generator/references/prompt_guide.md to understand the core principles, official formula, and few-shot examples for writing effective prompts.

Identify the Scenario: Determine which of the following scenarios the user is requesting:
...
Set Environment Variables: Ensure KLING_ACCESS_KEY and KLING_SECRET_KEY are set.

Construct the Payload: Follow the workflow above to create the JSON payload for the API call.
