...
rating: ⭐⭐⭐
title: xtquant
url: https://skills.sh/site/skills.volces.com/xtquant
---

# xtquant

skills/skills.volces.com/xtquant
xtquant
$ npx skills add https://skills.volces.com/c/arkclaw-personal/skills/clawhub/coderwpf
SKILL.md
...
Subscribe (subscribe): subscribe_quote, subscribe_whole_quote — real-time push
Download (download): download_history_data, download_financial_data — download from server to local cache (synchronous/blocking)
Retrieve (get): get_market_data_ex, get_financial_data — read from local cache (fast)
xttrade回调系统
