---
rating: ⭐⭐
title: flowglad-usage-tracking
url: https://skills.sh/flowglad/skills/flowglad-usage-tracking
---

# flowglad-usage-tracking

skills/flowglad/skills/flowglad-usage-tracking
flowglad-usage-tracking
Installation
...
Create a usage price in your Flowglad dashboard (e.g., api-calls-standard at $0.001/call)
Set it as the default price for the meter, OR
Reference it directly with priceSlug: 'api-calls-standard'
