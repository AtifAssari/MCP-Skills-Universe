...
rating: ⭐⭐⭐
title: manage-memory
url: https://skills.sh/pjt222/development-guides/manage-memory
---

# manage-memory

skills/pjt222/development-guides/manage-memory
manage-memory
Installation
...
Create <memory-dir>/<topic-name>.md with a descriptive header
Move the detailed content from MEMORY.md to the topic file
