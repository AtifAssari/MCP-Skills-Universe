...
url: https://skills.sh/lingfengqaq/webnovel-writer/webnovel-dashboard
---

# webnovel-dashboard

skills/lingfengqaq/webnovel-writer/webnovel-dashboard
webnovel-dashboard
Installation
$ npx skills add https://github.com/lingfengqaq/webnovel-writer --skill webnovel-dashboard
SKILL.md
Webnovel Dashboard
目标
在本地启动只读 Web 面板。
