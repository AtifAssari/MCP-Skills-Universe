...
rating: ⭐⭐
title: bitcoin
url: https://skills.sh/phrazzld/claude-config/bitcoin
---

# bitcoin

skills/phrazzld/claude-config/bitcoin
bitcoin
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill bitcoin
SKILL.md
/bitcoin
