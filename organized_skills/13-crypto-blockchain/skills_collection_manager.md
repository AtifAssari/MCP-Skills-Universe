---
rating: ⭐⭐⭐
title: skills-collection-manager
url: https://skills.sh/jackspace/claudeskillz/skills-collection-manager
---

# skills-collection-manager

skills/jackspace/claudeskillz/skills-collection-manager
skills-collection-manager
Installation
$ npx skills add https://github.com/jackspace/claudeskillz --skill skills-collection-manager
SKILL.md
Skills Collection Manager
...
Pros: Simple, easy to navigate Cons: Hard to manage at scale (100+ skills)
...
Pros: Organized, scalable Cons: Requires categorization logic
...
Pros: Best of both worlds Cons: More complex to maintain
...
Version: 1.0.0 Author: Harvested from your_claude_skills repository (270+ skills managed) Last Updated: 2025-11-18 License: MIT
