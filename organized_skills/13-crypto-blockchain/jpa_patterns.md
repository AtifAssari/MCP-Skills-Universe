...
rating: ⭐⭐⭐
title: jpa-patterns
url: https://skills.sh/decebals/claude-code-java/jpa-patterns
---

# jpa-patterns

skills/decebals/claude-code-java/jpa-patterns
jpa-patterns
Installation
$ npx skills add https://github.com/decebals/claude-code-java --skill jpa-patterns
SKILL.md
JPA Patterns Skill
