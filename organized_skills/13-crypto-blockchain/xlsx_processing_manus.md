---
rating: ⭐⭐⭐
title: xlsx-processing-manus
url: https://skills.sh/lawvable/awesome-legal-skills/xlsx-processing-manus
---

# xlsx-processing-manus

skills/lawvable/awesome-legal-skills/xlsx-processing-manus
xlsx-processing-manus
Installation
$ npx skills add https://github.com/lawvable/awesome-legal-skills --skill xlsx-processing-manus
SKILL.md
...
What does the user need? — Not "an Excel file", but what problem are they solving?
What can I provide? — Which features will help them?
How to match? — Select the right combination for this specific scenario.
...
Every numeric cell must have number_format set — both input values AND formula results
Same column = same precision — never mix 0.1074 and 1.0 in one column
Formula results have no default format — they display raw precision unless explicitly formatted
...
Scan from Section Header downward
Non-empty row starts a Data Block
Empty row ends the current Data Block
Each Data Block gets its own outer frame
