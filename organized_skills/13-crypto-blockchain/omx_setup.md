...
rating: ⭐⭐
title: omx-setup
url: https://skills.sh/yeachan-heo/oh-my-codex/omx-setup
---

# omx-setup

skills/yeachan-heo/oh-my-codex/omx-setup
omx-setup
Installation
...
Configure notify hook references outside plugin mode and write ./.omx/hud-config.json
...
Run omx setup --verbose in the intended scope.
Run omx doctor and check the reported setup scope, Codex home, skill root, and hook/config status.
If using project scope, confirm ./.codex/skills/omx-setup/SKILL.md exists.
If using user scope, confirm ${CODEX_HOME:-~/.codex}/skills/omx-setup/SKILL.md exists in legacy mode, or that the oh-my-codex plugin is installed/discovered in plugin mode.
