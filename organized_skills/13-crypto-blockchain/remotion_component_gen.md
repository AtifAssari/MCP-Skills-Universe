---
rating: ⭐⭐⭐⭐⭐
title: remotion-component-gen
url: https://skills.sh/ncklrs/startup-os-skills/remotion-component-gen
---

# remotion-component-gen

skills/ncklrs/startup-os-skills/remotion-component-gen
remotion-component-gen
Installation
...
Scene components — Complete TSX implementation for individual scenes
Animation integration — Applies spring/interpolate from animation configs
Visual layout — Implements positioning, sizing, layout logic
Asset integration — StaticFile imports and asset usage
TypeScript types — Props interfaces for scene components
Scope Boundaries
...
Move to next scene via another /remotion-component-gen call
Checklist
...
Receive visual direction → Input to this skill
Generate scene component → SCENE_COMPONENT.md
