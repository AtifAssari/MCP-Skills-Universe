...
rating: ⭐⭐
title: typo3-docs
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-docs
---

# typo3-docs

skills/dirnbauer/webconsulting-skills/typo3-docs
typo3-docs
Installation
$ npx skills add https://github.com/dirnbauer/webconsulting-skills --skill typo3-docs
SKILL.md
...
Code blocks have :caption:, inline code uses proper roles
Screenshots exist with :alt: and :zoom: lightbox
