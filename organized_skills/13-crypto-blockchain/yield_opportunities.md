...
url: https://skills.sh/kukapay/crypto-skills/yield-opportunities
---

# yield-opportunities

skills/kukapay/crypto-skills/yield-opportunities
yield-opportunities
Installation
$ npx skills add https://github.com/kukapay/crypto-skills --skill yield-opportunities
SKILL.md
Yield Opportunities
...
Librarian Agents (3-6 concurrent) - Best for external research:
...
Direct Tools - Use in parallel with librarian agents:
...
Bridge Risk (if bridging recommended)
