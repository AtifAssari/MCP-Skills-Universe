...
rating: ⭐⭐⭐
title: memory-init
url: https://skills.sh/yunshu0909/yunshu_skillshub/memory-init
---

# memory-init

skills/yunshu0909/yunshu_skillshub/memory-init
memory-init
Installation
$ npx skills add https://github.com/yunshu0909/yunshu_skillshub --skill memory-init
SKILL.md
记忆系统初始化
功能说明
