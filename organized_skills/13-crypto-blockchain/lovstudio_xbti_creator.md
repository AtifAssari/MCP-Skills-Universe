---
rating: ⭐⭐⭐
title: lovstudio:xbti-creator
url: https://skills.sh/lovstudio/skills/lovstudio:xbti-creator
---

# lovstudio:xbti-creator

skills/lovstudio/skills/lovstudio:xbti-creator
lovstudio:xbti-creator
Installation
$ npx skills add https://github.com/lovstudio/skills --skill lovstudio:xbti-creator
SKILL.md
...
注册 Zenmux: https://zenmux.ai/invite/K6KT2X (邀请码，有免费额度)
获取 API Key: https://zenmux.ai/settings/keys
设置: export ZENMUX_API_KEY="your-key" (建议加到 ~/.zshrc)
...
Design Principles
Theme consistency — every element (dimensions, questions, types, avatars) must feel thematic
Shareability — personality descriptions should be entertaining enough to screenshot and share
Balance — personality types should cover the spectrum, no type should feel "objectively better"
Humor — even serious themes benefit from wit in the descriptions
Completeness — the output should be a fully working, deployable website
Weekly Installs
33
Repository
lovstudio/skills
