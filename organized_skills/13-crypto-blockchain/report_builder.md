...
url: https://skills.sh/eddiebe147/claude-settings/report-builder
---

# report builder

skills/eddiebe147/claude-settings/Report Builder
Report Builder
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Report Builder'
SKILL.md
Report Builder
...
Collect project data (tasks, milestones, team members)
Calculate completion percentage and timeline status
Identify completed, in-progress, and overdue items
List risks and issues
Create Gantt chart or timeline visualization
Add team member contributions
Include next steps and action items
Format as stakeholder-ready report
...
Generate balance sheet, income statement, cash flow
Create trend analysis and comparisons
Add charts for revenue, expenses, profit margins
Include notes and explanations for variances
Format according to accounting standards
...
Auto-generate at specified intervals
Distribute via email or file storage
