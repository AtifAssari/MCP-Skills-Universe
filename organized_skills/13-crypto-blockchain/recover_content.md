...
url: https://skills.sh/calm-north/seojuice-skills/recover-content
---

# recover-content

skills/calm-north/seojuice-skills/recover-content
recover-content
Installation
...
Refresh playbooks tailored to content type (blog posts, how-to guides, data roundups) with specific checklists and time estimates for each recovery approach
Prioritization matrix ranks pages by traffic value, decay severity, competitive opportunity, and effort to focus recovery work on highest-impact pages first
SKILL.md
Recover Content
