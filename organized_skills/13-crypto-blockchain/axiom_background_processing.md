---
rating: ⭐⭐
title: axiom-background-processing
url: https://skills.sh/charleswiltgen/axiom/axiom-background-processing
---

# axiom-background-processing

skills/charleswiltgen/axiom/axiom-background-processing
axiom-background-processing
Installation
...
Pause in debugger
Run _simulateLaunchForTaskWithIdentifier command
Resume — breakpoint should hit
Test expiration with _simulateExpirationForTaskWithIdentifier
Testing Checklist
...
Use BGProcessingTask with requiresExternalPower = true (runs overnight)
iOS 26+: Use BGContinuedProcessingTask for user-initiated work
...
Check backgroundRefreshStatus at launch, log it
Log when tasks are scheduled and completed
