---
rating: ⭐⭐⭐
title: data-viz-plots
url: https://skills.sh/starlitnightly/omicverse/data-viz-plots
---

# data-viz-plots

skills/starlitnightly/omicverse/data-viz-plots
data-viz-plots
Installation
...
Colors: Use colorblind-friendly palettes (e.g., viridis, Set2, tab10)
...
Layout: Always call plt.tight_layout() before saving to prevent label clipping
File Format: PNG for general use, SVG for vector graphics (editable in Illustrator)
Close Figures: Call plt.close() after saving to free memory when generating many plots
