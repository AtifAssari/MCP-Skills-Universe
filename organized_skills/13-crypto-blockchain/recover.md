...
rating: ⭐⭐⭐
title: recover
url: https://skills.sh/boshu2/agentops/recover
---
...
Agent runs ao lookup --query "rpi recovery context" to load relevant knowledge
Agent shows goal, current phase (plan), cycle 1, started 2 hours ago
Agent lists 2 in-progress issues and 3 ready issues
Agent shows clean git state, recent commit
Agent suggests: "Review plan: /pre-mortem to validate before coding"
...
Agent loads knowledge with ao lookup --query "evolve cycle recovery"
Agent suggests: "Continue autonomous improvements: /evolve --resume"
...
Agent suggests: "Session recovered. Start with /status to plan next work"
