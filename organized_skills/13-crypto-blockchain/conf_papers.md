...
rating: ⭐⭐⭐
title: conf-papers
url: https://skills.sh/juliye2025/evil-read-arxiv/conf-papers
---

# conf-papers

skills/juliye2025/evil-read-arxiv/conf-papers
conf-papers
Installation
...
DBLP 搜索：调用 DBLP API 获取指定会议和年份的全部论文
轻量过滤：凭标题关键词匹配研究兴趣，大幅缩小范围（~200篇）
S2 补充：仅对过滤后的论文查询 Semantic Scholar，获取摘要和引用数
三维评分：相关性(40%) + 热门度(40%) + 质量(20%)，排序取 top N
...
对前 3 篇论文执行深度分析（仅有 arXiv ID 的论文）
