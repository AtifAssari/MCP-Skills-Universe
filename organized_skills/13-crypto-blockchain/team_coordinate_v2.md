---
rating: ⭐⭐⭐
title: team-coordinate-v2
url: https://skills.sh/catlog22/claude-code-workflow/team-coordinate-v2
---

# team-coordinate-v2

skills/catlog22/claude-code-workflow/team-coordinate-v2
team-coordinate-v2
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill team-coordinate-v2
SKILL.md
Team Coordinate v2
...
discuss	subagents/discuss-subagent.md	any role	Multi-perspective critique (dynamic perspectives)
explore	subagents/explore-subagent.md	any role	Codebase exploration with cache
Dispatch
