---
rating: ⭐⭐⭐
title: byted-text-to-speech
url: https://skills.sh/bytedance/agentkit-samples/byted-text-to-speech
---

# byted-text-to-speech

skills/bytedance/agentkit-samples/byted-text-to-speech
byted-text-to-speech
Installation
$ npx skills add https://github.com/bytedance/agentkit-samples --skill byted-text-to-speech
SKILL.md
