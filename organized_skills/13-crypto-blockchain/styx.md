...
rating: ⭐⭐
title: styx
url: https://skills.sh/aibtcdev/skills/styx
---

# styx

skills/aibtcdev/skills/styx
styx
Installation
$ npx skills add https://github.com/aibtcdev/skills --skill styx
SKILL.md
Styx Skill
...
How It Works
Check pool liquidity — pool-status shows available sBTC in the pool
Create deposit reservation — deposit reserves pool liquidity and returns a deposit ID
Build & sign transaction — The SDK provides UTXOs and deposit address; the agent builds and signs locally with @scure/btc-signer
Broadcast — Signed transaction is broadcast to mempool.space
Track status — status monitors the deposit through confirmation
Pools
