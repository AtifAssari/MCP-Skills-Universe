---
rating: ⭐⭐⭐
title: indicator-scanner
url: https://skills.sh/marketcalls/openalgo-indicator-skills/indicator-scanner
---

# indicator-scanner

skills/marketcalls/openalgo-indicator-skills/indicator-scanner
indicator-scanner
Installation
...
Create scanners/{scan_type}/ directory (on-demand)
Create {scan_type}_scanner.py
The script must:
