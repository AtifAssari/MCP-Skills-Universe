...
url: https://skills.sh/mjunaidca/polymarket-skills/polymarket-analyzer
---

# polymarket-analyzer

skills/mjunaidca/polymarket-skills/polymarket-analyzer
polymarket-analyzer
Installation
...
Workflow
Run find_edges.py to scan for arbitrage across all active markets
For interesting markets, run analyze_orderbook.py to check if the edge is executable
Run momentum_scanner.py to find markets with directional momentum
Combine findings to identify the best opportunities
Fee Awareness
