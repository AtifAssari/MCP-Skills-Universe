---
rating: ⭐⭐⭐
title: qqbrowser-skill
url: https://skills.sh/qqbrowserteam/qqbrowser-skill/qqbrowser-skill
---

# qqbrowser-skill

skills/qqbrowserteam/qqbrowser-skill/qqbrowser-skill
qqbrowser-skill
Installation
$ npx skills add https://github.com/qqbrowserteam/qqbrowser-skill --skill qqbrowser-skill
SKILL.md
qqbrowser-skill
Platform Support
...
Each command will return a snapshot of the current page after execution, including the index of elements. Please call the standalone qqbrowser-skill browser_snapshot command only when necessary to avoid unnecessary token consumption.

Core Workflow

Every browser automation follows this pattern:

Navigate: qqbrowser-skill browser_go_to_url --url <url>
Snapshot: qqbrowser-skill browser_snapshot (get indexed element refs)
