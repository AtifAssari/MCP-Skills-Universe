...
rating: ⭐⭐⭐
title: takt-task
url: https://skills.sh/j5ik2o/takt-sdd/takt-task
---

# takt-task

skills/j5ik2o/takt-sdd/takt-task
takt-task
Installation
$ npx skills add https://github.com/j5ik2o/takt-sdd --skill takt-task
SKILL.md
TAKT Task Creator
...
タスク内容: 何を実行するタスクか
ピース: 使用するpiece名（default, dual, カスタム等）
