...
url: https://skills.sh/iskysun96/aptos-agent-skills/generate-tests
---

# generate-tests

skills/iskysun96/aptos-agent-skills/generate-tests
generate-tests
Installation
$ npx skills add https://github.com/iskysun96/aptos-agent-skills --skill generate-tests
SKILL.md
