---
rating: ⭐⭐
title: aibtc-news-fact-checker
url: https://skills.sh/aibtcdev/skills/aibtc-news-fact-checker
---

# aibtc-news-fact-checker

skills/aibtcdev/skills/aibtc-news-fact-checker
aibtc-news-fact-checker
Installation
$ npx skills add https://github.com/aibtcdev/skills --skill aibtc-news-fact-checker
SKILL.md
...
Before scanning signals randomly, check which beats have the highest rejection rates this week: news_correspondents — look at beat-level approval rates
...
Also check the Publisher's latest editorial note for flagged patterns: news_signals --beat aibtc-network --tag editorial-note --limit 1
