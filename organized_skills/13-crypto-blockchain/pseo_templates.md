...
url: https://skills.sh/lisbeth718/pseo-skills/pseo-templates
---

# pseo-templates

skills/lisbeth718/pseo-skills/pseo-templates
pseo-templates
Installation
$ npx skills add https://github.com/lisbeth718/pseo-skills --skill pseo-templates
SKILL.md
pSEO Page Templates
...
Core Principles
One template, many unique pages: Templates are content-agnostic shells that render data
No thin pages: Every generated page must have substantial, differentiated content
Intent matching: Each page targets a specific search intent derived from its data
Semantic HTML: Use correct heading hierarchy, landmarks, and elements
...
Bad: "Best {keyword} in {city}" for every page. Better: Titles that incorporate multiple data dimensions (type, location, attribute, use case).
