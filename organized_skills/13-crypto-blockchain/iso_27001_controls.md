...
url: https://skills.sh/hack23/cia/iso-27001-controls
---

# iso-27001-controls

skills/hack23/cia/iso-27001-controls
iso-27001-controls
Installation
...
Compliance Checklist - Complete Annex A control mapping to policies
Information Security Policy - Master governance framework
Information Security Strategy - Strategic control implementation
Secure Development Policy - A.8.28, A.14.2 implementation
Access Control Policy - A.8.2, A.8.3, A.5.15 implementation
Cryptography Policy - A.8.24 implementation
Incident Response Plan - A.16.1 implementation
Risk Assessment Methodology - A.5.7, A.8.8 implementation
Vulnerability Management - A.8.8 SLAs and procedures
Data Classification Policy - A.5.12, A.5.13 implementation
Physical Security Policy - A.7 controls
Asset Register - A.5.9 asset inventory
Risk Register - Risk treatment evidence
Segregation of Duties Policy - A.5.3 compensating controls
Change Management - A.8.9, A.8.32 procedures
Business Continuity Plan - A.17 resilience
Backup Recovery Policy - A.8.13 data backup

All Hack23 ISMS Policies: https://github.com/Hack23/ISMS-PUBLIC

CIA Platform Architecture References
Security Architecture: CIA SECURITY_ARCHITECTURE.md - Current control implementation
Future Security: CIA FUTURE_SECURITY_ARCHITECTURE.md - Planned improvements
Threat Model: CIA THREAT_MODEL.md - STRIDE analysis
System Architecture: CIA ARCHITECTURE.md - C4 models
Data Model: CIA DATA_MODEL.md - Database schema
References
