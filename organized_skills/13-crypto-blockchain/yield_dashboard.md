...
url: https://skills.sh/aibtcdev/skills/yield-dashboard
---

# yield-dashboard

skills/aibtcdev/skills/yield-dashboard
yield-dashboard
Installation
$ npx skills add https://github.com/aibtcdev/skills --skill yield-dashboard
SKILL.md
