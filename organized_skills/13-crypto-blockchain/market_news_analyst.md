...
url: https://skills.sh/tradermonty/claude-trading-skills/market-news-analyst
---

# market-news-analyst

skills/tradermonty/claude-trading-skills/market-news-analyst
market-news-analyst
Installation
...
Analyzes multi-asset reactions (equities, bonds, commodities, currencies) and compares actual market responses against historical patterns from knowledge base
Generates structured Markdown reports with detailed event analysis, thematic synthesis, commodity deep-dive, and forward-looking risk scenarios
Identifies anomalies, reinforcing/offsetting event interactions, and geopolitical-commodity correlations using specialized reference frameworks
SKILL.md
Market News Analyst
Overview
