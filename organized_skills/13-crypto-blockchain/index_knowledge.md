...
url: https://skills.sh/maxmurr/skills/index-knowledge
---

# index-knowledge

skills/maxmurr/skills/index-knowledge
index-knowledge
Installation
$ npx skills add https://github.com/maxmurr/skills --skill index-knowledge
SKILL.md
index-knowledge
...
Symlinks - CLAUDE.md → AGENTS.md per directory (see Phase 5)
TodoWrite([
...
Discover targets — find all AGENTS.md under the repo (exclude node_modules, .git, vendored trees). For each …/AGENTS.md, the sibling …/CLAUDE.md should be -> AGENTS.md.
Skip intentional exceptions — If CLAUDE.md must differ from AGENTS.md (rare), leave as a regular file and note in the final report.
Replace — In each target directory: remove any existing CLAUDE.md file, then ln -sf AGENTS.md CLAUDE.md. Use /bin/rm -f CLAUDE.md (or command rm) if the shell aliases rm to something that breaks on symlinks (e.g. rimraf).
Verify — ls -la …/CLAUDE.md shows -> AGENTS.md; git stores mode 120000 for symlinks.
