---
rating: ⭐⭐⭐
title: tw-edu-research-viz
url: https://skills.sh/fw1201/tw-edu-skills/tw-edu-research-viz
---

# tw-edu-research-viz

skills/fw1201/tw-edu-skills/tw-edu-research-viz
tw-edu-research-viz
Installation
...
Step 0：讀取必要文件
references/academic_viz_types.md — 學術圖表類型與規範
references/apa7_figure_format.md — APA/APA 7th 圖表格式要求
...
使用 Python matplotlib 生成 .png 靜態圖表
生成 SVG 代碼（可貼入 Inkscape 或 Figma 繼續編輯）
生成 Mermaid 語法（flowchart/graph）輸出供用戶複製
提供 draw.io XML（可匯入 diagrams.net 編輯）
Step 7：品質確認清單
 圖表邏輯清晰，看圖能理解研究核心
 元素大小與字型符合學術出版標準
