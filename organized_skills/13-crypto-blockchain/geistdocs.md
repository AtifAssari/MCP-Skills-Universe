...
rating: ⭐⭐⭐⭐⭐
title: geistdocs
url: https://skills.sh/vercel-labs/vercel-plugin/geistdocs
---

# geistdocs

skills/vercel-labs/vercel-plugin/geistdocs
geistdocs
Installation
...
Deployment
Push to GitHub
Import at vercel.com/new → select repo
Framework: Next.js (auto-detected), Build: pnpm build, Output: .next
Add environment variables (AI_GATEWAY_API_KEY, NEXT_PUBLIC_VERCEL_PROJECT_PRODUCTION_URL)
Deploy
Key Commands
Command	Description
