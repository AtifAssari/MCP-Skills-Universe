---
rating: ⭐⭐⭐
title: octocode-pull-request-reviewer
url: https://skills.sh/bgauryy/octocode-mcp/octocode-pull-request-reviewer
---

# octocode-pull-request-reviewer

skills/bgauryy/octocode-mcp/octocode-pull-request-reviewer
octocode-pull-request-reviewer
Installation
...
Expanded verification checklist </execution_lifecycle_base>
Phase 4: Analysis
...
Validate schemas/APIs/dependencies using matchString targeting (PR Mode: githubGetFileContent; Local Mode: localGetFileContent + localSearchCode)
