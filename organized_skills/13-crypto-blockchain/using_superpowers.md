...
url: https://skills.sh/pcvelz/superpowers/using-superpowers
---

# using-superpowers

skills/pcvelz/superpowers/using-superpowers
using-superpowers
Originally fromobra/superpowers
Installation
$ npx skills add https://github.com/pcvelz/superpowers --skill using-superpowers
SKILL.md
