---
rating: ⭐⭐⭐
title: okx-cex-portfolio
url: https://skills.sh/okx/agent-skills/okx-cex-portfolio
---

# okx-cex-portfolio

skills/okx/agent-skills/okx-cex-portfolio
okx-cex-portfolio
Installation
...
okx account asset-balance --valuation → look at each details.* field
If details.funding is large and details.trading is small → the funds are in the funding account
Transfer: okx account transfer --ccy USDT --amt <n> --from 6 --to 18
Confirm: okx account balance USDT → equity should now reflect the transferred amount
Edge Cases
