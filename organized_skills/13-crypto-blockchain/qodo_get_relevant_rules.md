---
rating: ⭐⭐⭐
title: qodo-get-relevant-rules
url: https://skills.sh/qodo-ai/qodo-skills/qodo-get-relevant-rules
---

# qodo-get-relevant-rules

skills/qodo-ai/qodo-skills/qodo-get-relevant-rules
qodo-get-relevant-rules
Installation
$ npx skills add https://github.com/qodo-ai/qodo-skills --skill qodo-get-relevant-rules
SKILL.md
...
See repository scope detection for the git check command.
...
See query generation guidelines for the full strategy, category descriptions, and examples.
...
See search endpoint for the full request/response contract, top_k defaults, error handling, and API URL construction.
