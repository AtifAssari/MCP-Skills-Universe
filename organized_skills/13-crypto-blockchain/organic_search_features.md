---
rating: ⭐⭐
title: organic-search-features
url: https://skills.sh/dmend3z/tribo-skills/organic-search-features
---
...
organic-search-features
Installation
$ npx skills add https://github.com/dmend3z/tribo-skills --skill organic-search-features
SKILL.md
Organic Search Features
Overview
...
What is the URL of the website you want to optimize?
What are the primary goals for improving your organic search presence? (e.g., increase traffic, generate leads, build brand awareness)
Who is your target audience? Can you describe your ideal customer?
What are the most important keywords or search queries for your business?
Do you have a physical business location that serves a local area?
Have you already implemented any SEO or structured data (like Schema.org) on your site?
Who are your main competitors in search results?
Are there any specific SERP features (like featured snippets or review stars) you are particularly interested in capturing?
What is your level of technical expertise with website development and SEO?
Are there any constraints or limitations I should be aware of, such as budget, technical resources, or content creation capabilities?
Instructions
...
Workflow
Assess the User's Website and Goals: Start by understanding the user's business, target audience, and current SEO performance.
Prioritize S-Tier Tactics: Guide the user to implement optimizations for Featured Snippets, Rich Snippets, and the Local Pack first.
Implement A-Tier Tactics: Once the foundation is strong, move on to optimizing for People Also Ask, Image Packs, and Video Carousels.
Review and Refine: Continuously monitor performance, analyze results, and refine the strategy based on what's working.
Educate on D-Tier Mistakes: Throughout the process, remind the user to avoid common pitfalls like keyword stuffing and neglecting mobile UX.
Weekly Installs
10
Repository
