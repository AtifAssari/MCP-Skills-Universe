...
rating: ⭐⭐
title: mb-init
url: https://skills.sh/mrvladd-d/memobank/mb-init
---

# mb-init

skills/mrvladd-d/memobank/mb-init
mb-init
Installation
...
Each proxy contains: Read and follow the instructions in .memory-bank/commands/<name>.md. This registers commands natively: /mb in Claude Code, $mb in Codex, /mb in OpenCode.
