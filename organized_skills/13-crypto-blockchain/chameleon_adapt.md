---
rating: ⭐⭐⭐
title: chameleon-adapt
url: https://skills.sh/autumnsgrove/groveengine/chameleon-adapt
---

# chameleon-adapt

skills/autumnsgrove/groveengine/chameleon-adapt
chameleon-adapt
Installation
...
TEXTURE — "Load references/nature-components.md and references/glass-components.md. Add randomized aspen/birch trees, FallingLeavesLayer, autumn birds (cardinals), Lucide icons."

ADAPT — "Responsive density, reduced-motion support, GroveTerm for 'Welcome, Wanderer' greeting, 44px touch targets, dark mode verified. Run gw ci --affected."
