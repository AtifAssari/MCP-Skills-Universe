---
rating: ⭐⭐⭐
title: groq-multi-env-setup
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-multi-env-setup
---

# groq-multi-env-setup

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-multi-env-setup
groq-multi-env-setup
Installation
