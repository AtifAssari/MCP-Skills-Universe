...
rating: ⭐⭐⭐
title: create-plans
url: https://skills.sh/glittercowboy/taches-cc-resources/create-plans
---

# create-plans

skills/glittercowboy/taches-cc-resources/create-plans
create-plans
Installation
$ npx skills add https://github.com/glittercowboy/taches-cc-resources --skill create-plans
SKILL.md
