...
rating: ⭐⭐
title: fusion-mcp
url: https://skills.sh/equinor/fusion-skills/fusion-mcp
---

# fusion-mcp

skills/equinor/fusion-skills/fusion-mcp
fusion-mcp
Installation
...
When MCP setup fails, MCP behavior is incorrect, or the user asks to file a bug, produce a bug report draft from assets/bug-report-template.md.
