...
url: https://skills.sh/contextvm/cvmi/typescript-sdk
---

# typescript-sdk

skills/contextvm/cvmi/typescript-sdk
typescript-sdk
Installation
...
explicit operational relays from relayHandler
relay hints embedded in nprofile
CEP-17 relay-list discovery via discoveryRelayUrls
fallbackOperationalRelayUrls
SDK bootstrap discovery relays when discoveryRelayUrls is omitted
...
relayHandler remains the explicit authoritative operational relay set.
discoveryRelayUrls remains discovery-only.
fallbackOperationalRelayUrls is non-authoritative and should not replace published kind:10002 metadata when that metadata resolves in time.
Encryption Modes
enum EncryptionMode {
