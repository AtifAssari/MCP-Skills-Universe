...
rating: ⭐⭐⭐
title: ppw:polish
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:polish
---

# ppw:polish

skills/lylll9436/paper-polish-workflow-skill/ppw:polish
ppw:polish
Installation
...
Which section this text belongs to (only if ambiguous from content or headers)
In guided mode only: confirm scope before starting
