...
url: https://skills.sh/mgd34msu/goodvibes-plugin/ai-integration
---

# ai-integration

skills/mgd34msu/goodvibes-plugin/ai-integration
ai-integration
Installation
...
See: references/ai-patterns.md for provider comparison.
...
See: references/ai-patterns.md for vector database comparison.
...
Common Pitfalls
Forgetting to stream: Always stream for chat interfaces to improve UX
Ignoring rate limits: Implement backoff and retry logic
Hardcoding prompts: Use template systems for maintainability
Not chunking documents: Large documents need chunking for RAG
Skipping cost tracking: AI costs can escalate quickly
Trusting user input: Always sanitize and validate
No error boundaries: Failures should degrade gracefully
Oversized context: Limit context to stay within token budgets
...
See references/ai-patterns.md for detailed provider comparisons and architecture patterns.
