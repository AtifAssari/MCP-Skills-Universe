...
rating: ⭐⭐⭐
title: keep
url: https://skills.sh/hughpyle/keep/keep
---

# keep

skills/hughpyle/keep/keep
keep
Installation
...
Gathering — see what is, before analyzing. Search for past breakdowns and learnings.
The Mirror — did this action lead to harm? Name it honestly.
The Conversation — what kind of conversation is this? What commitments are open?
Ownership — what patterns are forming? What am I becoming through this work?
Updating — capture learnings, update intentions
...
docs/TAGGING.md — Tags, speech acts, project/topic
docs/QUICKSTART.md — Installation and setup
keep/data/system/conversations.md — Full conversation framework (.conversations)
keep/data/system/domains.md — Domain-specific organization (.domains)
Weekly Installs
65
Repository
hughpyle/keep
