...
rating: ⭐⭐⭐
title: dev-rfc
url: https://skills.sh/pproenca/dot-skills/dev-rfc
---

# dev-rfc

skills/pproenca/dot-skills/dev-rfc
dev-rfc
Installation
...
Tell the user: "I've opened the RFC review in your browser at http://localhost:3118. Add feedback to any section, highlight text for inline comments, then click Submit Feedback (for revisions) or Approve (if it looks good). Your feedback auto-saves as you type."
...
Inline comments (inline_comments) — targeted at specific text. Address each one.
Section feedback (sections[].feedback) — per-section concerns. Revise the relevant section.
Overall feedback (overall_feedback) — broad themes. Apply across the document.
...
Tell the user: "I've opened the RFC in live authoring mode at http://localhost:3118. I'll write each section one at a time — you can approve or request changes on each section before I move to the next."
