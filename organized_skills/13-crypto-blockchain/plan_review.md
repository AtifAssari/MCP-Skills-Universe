...
rating: ⭐⭐⭐
title: plan-review
url: https://skills.sh/yelban/orz99-skills/plan-review
---

# plan-review

skills/yelban/orz99-skills/plan-review
plan-review
Installation
...
ARGUMENTS 指定路徑 → 直接讀取
codex-plan.md（當前目錄）→ codex-plan 產出
.claude/plans/ → 取最新的 .md 檔
都找不到 → 用 AskUserQuestion 請使用者指定
