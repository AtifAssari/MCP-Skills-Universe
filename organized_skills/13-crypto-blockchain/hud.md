...
rating: ⭐⭐
title: hud
url: https://skills.sh/yeachan-heo/oh-my-claudecode/hud
---

# hud

skills/yeachan-heo/oh-my-claudecode/hud
hud
Installation
...
Check if ~/.claude/hud/omc-hud.mjs exists
Check if statusLine is configured in ~/.claude/settings.json
If missing, create the HUD wrapper script and configure settings
...
Run /oh-my-claudecode:hud setup to auto-install and configure
Restart Claude Code after setup completes
If still not working, run /oh-my-claudecode:omc-doctor for full diagnostics
