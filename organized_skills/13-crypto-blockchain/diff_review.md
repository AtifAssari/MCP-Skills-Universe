...
rating: ⭐⭐⭐
title: diff-review
url: https://skills.sh/mitchellx/diff-reviewer-multi-agent/diff-review
---

# diff-review

skills/mitchellx/diff-reviewer-multi-agent/diff-review
diff-review
Installation
...
Check if diff content matches trigger_patterns
Check if changed files match file_patterns
If matched, load the corresponding expertise/*.md file
...
The reviewer's role file (e.g., reviewers/gemini-role.md)
Any matched expertise prompts from Step 3
The review target context (commit hash, diff stats)
...
Parse all three reviews into structured format
Identify similar issues across reviewers
Merge similar issues while preserving source attribution
Preserve unique issues found by only one reviewer
Sort by severity: Critical > High > Medium > Low
Generate unified report using templates/report.md
...
Output the full report to terminal
Write the report to $REPORT_FILE in the current working directory
