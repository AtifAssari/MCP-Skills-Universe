---
rating: ⭐⭐
title: bknd-bulk-operations
url: https://skills.sh/cameronapak/bknd-skills/bknd-bulk-operations
---

# bknd-bulk-operations

skills/cameronapak/bknd-skills/bknd-bulk-operations
bknd-bulk-operations
Installation
$ npx skills add https://github.com/cameronapak/bknd-skills --skill bknd-bulk-operations
SKILL.md
Bulk Operations
...
Performance Tips
Optimal chunk size: 100-500 records per chunk (balance speed vs memory)
Avoid parallel writes to same entity (can cause locks)
Use server-side seed for initial large datasets
Index fields used in bulk update/delete where clauses
Monitor memory when processing very large datasets client-side
Common Pitfalls
