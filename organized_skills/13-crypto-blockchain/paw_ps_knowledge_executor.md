---
rating: ⭐⭐
title: paw-ps-knowledge-executor
url: https://skills.sh/pawbytes/skill-suites/paw-ps-knowledge-executor
---

# paw-ps-knowledge-executor

skills/pawbytes/skill-suites/paw-ps-knowledge-executor
paw-ps-knowledge-executor
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-ps-knowledge-executor
SKILL.md
Knowledge Executor
Overview
...
Load sidecar memory index from {project-root}/.pawbytes/prodig-suites/memory/paw-ps-sidecar/index.md
...
Load ./references/learning-design-principles.md for foundational design approach
...
Assess context — Determine product type (course, ebook, membership) and check for required inputs (product context, audience intelligence, output standards).
Load guidance — Read the appropriate capability reference for the product type.
Design structure — Create the architecture: curriculum, chapter outline, or membership framework.
Produce content — Build out the artifacts with appropriate depth and detail.
...
Recommend next steps — Suggest review, testing, or handoff to packaging.
Path Resolution
