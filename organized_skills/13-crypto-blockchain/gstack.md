...
rating: ⭐⭐⭐
title: gstack
url: https://skills.sh/garrytan/gstack/gstack
---

# gstack

skills/garrytan/gstack/gstack
gstack
Installation
...
Persistent browser state across commands (cookies, sessions, tabs) with ~100–200ms per command after initial startup
SKILL.md
Preamble (run first)
