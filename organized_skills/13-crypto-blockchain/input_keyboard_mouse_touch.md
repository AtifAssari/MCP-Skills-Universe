---
rating: ⭐⭐
title: input-keyboard-mouse-touch
url: https://skills.sh/phaserjs/phaser/input-keyboard-mouse-touch
---

# input-keyboard-mouse-touch

skills/phaserjs/phaser/input-keyboard-mouse-touch
input-keyboard-mouse-touch
Installation
$ npx skills add https://github.com/phaserjs/phaser --skill input-keyboard-mouse-touch
SKILL.md
...
Game Object: gameObject.on('pointerdown', (pointer, localX, localY, event) => {})
Scene per-object: this.input.on('gameobjectdown', (pointer, gameObject, event) => {})
Scene global: this.input.on('pointerdown', (pointer, currentlyOver) => {})
