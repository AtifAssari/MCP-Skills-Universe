...
rating: ⭐⭐
title: seo-backlinks
url: https://skills.sh/agricidaniel/claude-seo/seo-backlinks
---

# seo-backlinks

skills/agricidaniel/claude-seo/seo-backlinks
seo-backlinks
Installation
...
DataForSEO MCP (premium): Check if dataforseo_backlinks_summary tool is available
Moz API (free signup): python scripts/backlinks_auth.py --check moz --json
Bing Webmaster (free signup): python scripts/backlinks_auth.py --check bing --json
Common Crawl (always available): Domain-level graph with PageRank
