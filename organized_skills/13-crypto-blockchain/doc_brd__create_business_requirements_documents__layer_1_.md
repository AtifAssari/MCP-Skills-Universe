...
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-brd:-create-business-requirements-documents-(layer-1)
---

# doc-brd: create business requirements documents (layer 1)

skills/vladm3105/aidoc-flow-framework/doc-brd: Create Business Requirements Documents (Layer 1)
doc-brd: Create Business Requirements Documents (Layer 1)
Installation
$ npx skills add https://github.com/vladm3105/aidoc-flow-framework --skill 'doc-brd: Create Business Requirements Documents (Layer 1)'
SKILL.md
doc-brd
Purpose
...
Template: ai_dev_flow/BRD/BRD-TEMPLATE.md
Creation Rules: ai_dev_flow/BRD/BRD_CREATION_RULES.md
Validation Rules: ai_dev_flow/BRD/BRD_VALIDATION_RULES.md
...
✅ Read ai_dev_flow/ID_NAMING_STANDARDS.md - Element Type Codes table
✅ Element ID format: BRD.{DOC_NUM}.{ELEM_TYPE}.{SEQ} (4 segments, dots)
...
{project_root}/strategy/README.md - Performance targets, strategy goals
{project_root}/strategy/strategy_overview.md - Strategic framework
{project_root}/strategy/core_algorithm.md - Primary algorithm specifications
{project_root}/strategy/risk_management.md - Risk management policies
{project_root}/strategy/selection_criteria/ - Entry criteria
...
Create folder: docs/BRD/BRD-NN_{slug}/ (folder slug MUST match index file slug)
Create index file: docs/BRD/BRD-NN_{slug}/BRD-NN.0_{section_type}.md (shortened, PREFERRED)
Create section files: docs/BRD/BRD-NN_{slug}/BRD-NN.S_{section_type}.md (shortened, PREFERRED)
...
Missing strategy references: Every BRD must cite {project_root}/strategy/ sections
