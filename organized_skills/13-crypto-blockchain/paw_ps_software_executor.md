---
rating: ⭐⭐
title: paw-ps-software-executor
url: https://skills.sh/pawbytes/skill-suites/paw-ps-software-executor
---
...
paw-ps-software-executor
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-ps-software-executor
SKILL.md
Software Executor
Overview
...
Load ./references/feature-definition.md for foundational feature specification approach
