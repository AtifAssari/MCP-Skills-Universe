...
rating: ⭐⭐⭐
title: doc-tspec
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-tspec
---

# doc-tspec

skills/vladm3105/aidoc-flow-framework/doc-tspec
doc-tspec
Installation
...
Wrong tag format: Use TSPEC.NN.xxxx for elements, TYPE-NN for documents
Missing cumulative tags: Layer 10 requires all 8-9 upstream tags
Legacy test IDs: Use TSPEC.NN.xxxx, NOT TC-XXX, UT-XXX, etc.
...
Sibling to TSPEC file: UTEST/UTEST_MVP_SCHEMA.yaml
Parent directory: 10_TSPEC/UTEST/UTEST_MVP_SCHEMA.yaml
Search upward to TSPEC or 10_TSPEC directory
