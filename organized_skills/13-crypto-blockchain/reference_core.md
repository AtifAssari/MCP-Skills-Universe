...
url: https://skills.sh/angular/angular/reference-core
---
...
The Render Cycle
Creation Mode: Instructions create DOM nodes and store them in LView.
Update Mode: Instructions check current values against previous values stored in LView. If changed, they update the DOM.
...
Understand the Instruction: If modifying runtime behavior, find the corresponding instruction in src/render3/instructions.
Check LView/TView Impact: If adding state, understand where it fits in the LView array.
