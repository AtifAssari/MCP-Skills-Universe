...
rating: ⭐⭐⭐
title: starter
url: https://skills.sh/popup-studio-ai/bkit-claude-code/starter
---

# starter

skills/popup-studio-ai/bkit-claude-code/starter
starter
Installation
$ npx skills add https://github.com/popup-studio-ai/bkit-claude-code --skill starter
SKILL.md
