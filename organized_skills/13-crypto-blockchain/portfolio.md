...
rating: ⭐⭐⭐
title: portfolio
url: https://skills.sh/alsk1992/cloddsbot/portfolio
---

# portfolio

skills/alsk1992/cloddsbot/portfolio
portfolio
Installation
$ npx skills add https://github.com/alsk1992/cloddsbot --skill portfolio
SKILL.md
Portfolio Skill
...
User: "What's my portfolio looking like?" → Show all positions with current prices and P&L

User: "How much am I up today?" → Calculate daily P&L across all positions

User: "What's my exposure to politics markets?" → Filter positions by category, sum exposure

User: "Show my Binance positions" → Filter to Binance futures positions with leverage info
