---
rating: ⭐⭐⭐
title: alibabacloud-yike-storyboard
url: https://skills.sh/aliyun/alibabacloud-aiops-skills/alibabacloud-yike-storyboard
---

# alibabacloud-yike-storyboard

skills/aliyun/alibabacloud-aiops-skills/alibabacloud-yike-storyboard
alibabacloud-yike-storyboard
Installation
$ npx skills add https://github.com/aliyun/alibabacloud-aiops-skills --skill alibabacloud-yike-storyboard
SKILL.md
...
Script: Dominated by scenes, dialogue, action descriptions
...
High dialogue ratio (short dramas, chat format, comedy) → Recommend dialogue
First person narration → Recommend firstPersonNarration
Pure inner monologue/narration (prose, reflections) → Recommend firstPersonNarrationPureVO
Third person narration → Recommend thirdPersonNarration

Novel:

"I" perspective + has dialogue (urban romance, mystery) → Recommend firstPersonNarration
Pure inner monologue/narration (prose, reflections) → Recommend firstPersonNarrationPureVO
Third person narration (fairy tales, mythology, history) → Recommend thirdPersonNarration
...
Edit shot script - Adjust shot content, descriptions, and prompts
