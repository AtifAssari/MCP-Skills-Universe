---
rating: ⭐⭐⭐
title: cloudflare-full-stack-integration
url: https://skills.sh/jackspace/claudeskillz/cloudflare-full-stack-integration
---

# cloudflare-full-stack-integration

skills/jackspace/claudeskillz/cloudflare-full-stack-integration
cloudflare-full-stack-integration
Installation
...
Call useApiClient() in App component
Use apiClient.get() instead of raw fetch()
// In App.tsx
import { useApiClient } from '@/lib/api-client'
function App() {
