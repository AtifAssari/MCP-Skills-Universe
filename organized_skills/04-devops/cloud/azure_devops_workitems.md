---
rating: ⭐⭐⭐
title: azure-devops-workitems
url: https://skills.sh/bar2133/skills/azure-devops-workitems
---

# azure-devops-workitems

skills/bar2133/skills/azure-devops-workitems
azure-devops-workitems
Installation
...
If the user provides a project name, use it (pass --project <name>)
Else read default: az devops configure --list | grep project
...
Fetch child User Stories via Hierarchy-Forward relations.

For each User Story, fetch child Tasks via Hierarchy-Forward relations.
