---
rating: ⭐⭐
title: qwencloud-video-generation
url: https://skills.sh/qwencloud/qwencloud-ai/qwencloud-video-generation
---

# qwencloud-video-generation

skills/qwencloud/qwencloud-ai/qwencloud-video-generation
qwencloud-video-generation
Installation
...
No signal, clear task → defaults: t2v → wan2.6-t2v, i2v → wan2.6-i2v-flash, kf2v → wan2.2-kf2v-flash, r2v → wan2.6-r2v-flash, vace → wan2.1-vace-plus. For wan2.7 features, explicitly set --model wan2.7-t2v or --model wan2.7-i2v.
Models
t2v (Text-to-Video)
Model	Features
