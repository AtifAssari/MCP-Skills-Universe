---
rating: ⭐⭐⭐
title: qwencloud-image-generation
url: https://skills.sh/qwencloud/qwencloud-ai/qwencloud-image-generation
---

# qwencloud-image-generation

skills/qwencloud/qwencloud-ai/qwencloud-image-generation
qwencloud-image-generation
Installation
$ npx skills add https://github.com/qwencloud/qwencloud-ai --skill qwencloud-image-generation
SKILL.md
...
Text-to-image (prompt only, no reference images) → use wan2.6-t2i (default) or wan2.7-image / wan2.7-image-pro (multi-function, higher quality). NEVER use wan2.6-image for pure text-to-image — it will error without reference images or enable_interleave: true.
Reference images / image editing / interleaved output → wan2.7-image-pro (recommended), wan2.7-image, or wan2.6-image.
...
Look for qwencloud-update-check/SKILL.md in sibling skill directories.
