...
rating: ⭐⭐⭐
title: cloudinary
url: https://skills.sh/vm0-ai/vm0-skills/cloudinary
---

# cloudinary

skills/vm0-ai/vm0-skills/cloudinary
cloudinary
Installation
...
Auto optimization: Add f_auto,q_auto to URLs for automatic format/quality
Folders: Use public_id="folder/subfolder/name" to organize media
Video concatenation: Keep URLs short; for 10+ videos use external tools
API Reference
