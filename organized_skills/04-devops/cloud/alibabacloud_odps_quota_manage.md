---
rating: ⭐⭐⭐
title: alibabacloud-odps-quota-manage
url: https://skills.sh/aliyun/alibabacloud-aiops-skills/alibabacloud-odps-quota-manage
---
...
mkdir -p outputs ran_scripts — ensure directories exist first
Save quota query/list results to outputs/existing_quotas.json
Save a log of all actions performed to ran_scripts/actions_log.txt
