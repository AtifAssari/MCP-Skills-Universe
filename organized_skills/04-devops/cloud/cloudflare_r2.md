...
rating: ⭐⭐⭐
title: cloudflare-r2
url: https://skills.sh/jackspace/claudeskillz/cloudflare-r2
---

# cloudflare-r2

skills/jackspace/claudeskillz/cloudflare-r2
cloudflare-r2
Installation
$ npx skills add https://github.com/jackspace/claudeskillz --skill cloudflare-r2
SKILL.md
...
✅ Always Do:
Set appropriate contentType for all uploads
Use batch delete for multiple objects (up to 1000)
Set cache headers (cacheControl) for static assets
