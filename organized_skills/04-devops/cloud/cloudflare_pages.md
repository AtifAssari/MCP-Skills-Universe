...
url: https://skills.sh/baphomet480/claude-skills/cloudflare-pages
---

# cloudflare-pages

skills/baphomet480/claude-skills/cloudflare-pages
cloudflare-pages
Installation
...
Registers the domain on the Pages project via Cloudflare API
Creates a proxied CNAME DNS record pointing to <project>.pages.dev
