...
rating: ⭐⭐⭐
title: container
url: https://skills.sh/vinnie357/claude-skills/container
---

# container

skills/vinnie357/claude-skills/container
container
Installation
...
Replace --disable-progress-updates with --progress none in scripts
Update any paths referencing .build directory to builder
Review subnet configurations (allocation defaults changed in 0.8.0)
Update API consumers for client API reorganization (0.8.0)
Test build workflows with updated dependencies
Update API consumers for generic ClientContainer interface (0.10.0)
Move bundle creation code from main container operations to SandboxService (0.10.0)
Review network configurations for multiple network plugins model (0.10.0)
Dependencies
