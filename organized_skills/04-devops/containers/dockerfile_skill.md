...
url: https://skills.sh/zjy365/seakills/dockerfile-skill
---

# dockerfile-skill

skills/zjy365/seakills/dockerfile-skill
dockerfile-skill
Installation
$ npx skills add https://github.com/zjy365/seakills --skill dockerfile-skill
SKILL.md
...
Execute docker buildx build --platform linux/amd64 --load
...
Container Startup: docker-compose up -d and verify no crashes
Database Migration:
