---
rating: ⭐⭐
title: qcsd-cicd-swarm
url: https://skills.sh/proffesor-for-testing/agentic-qe/qcsd-cicd-swarm
---

# qcsd-cicd-swarm

skills/proffesor-for-testing/agentic-qe/qcsd-cicd-swarm
qcsd-cicd-swarm
Installation
$ npx skills add https://github.com/proffesor-for-testing/agentic-qe --skill qcsd-cicd-swarm
SKILL.md
...
Steps
Flag Detection -- steps/01-flag-detection.md -- Scan pipeline artifacts, detect all 6 flags
Core Agents -- steps/02-core-agents.md -- Spawn qe-quality-gate, qe-regression-analyzer, qe-flaky-hunter in parallel
...
Decision Synthesis -- steps/05-decision-synthesis.md -- Apply RELEASE/REMEDIATE/BLOCK logic
...
Deployment Advisor -- steps/08-deployment-advisor.md -- Run qe-deployment-advisor analysis on all pipeline data
Final Output -- steps/09-final-output.md -- Display completion summary with all scores
Execution Instructions
Use the Read tool to load the current step file (e.g., Read({ file_path: ".claude/skills/qcsd-cicd-swarm/steps/01-flag-detection.md" }))
