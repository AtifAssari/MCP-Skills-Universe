...
url: https://skills.sh/jackspace/claudeskillz/content-collections
---

# content-collections

skills/jackspace/claudeskillz/content-collections
content-collections
Installation
...
Use kill -9 <pid> when it hangs
Use content-collections watch separately (not plugin) for more control
Add cleanup handler in vite.config.ts (advanced)
...
Check references/ directory for deep dives
