...
url: https://skills.sh/nomadamas/k-skill/korean-spell-check
---

# korean-spell-check

skills/nomadamas/k-skill/korean-spell-check
korean-spell-check
Installation
...
Policy first
https://nara-speller.co.kr/old_speller/ 는 비상업적 용도 안내와 개인이나 학생만 무료라는 문구를 명시한다.
...
주요 변경점 목록
각 변경점의 원문, 교정안, 이유
필요하면 공개 웹 검사기 기준 결과이며, 최종 문맥 판단은 사람이 확인 문구
