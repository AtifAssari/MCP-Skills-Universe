...
rating: ⭐⭐⭐
title: swiss-design
url: https://skills.sh/zeke/swiss-design-skill/swiss-design
---

# swiss-design

skills/zeke/swiss-design-skill/swiss-design
swiss-design
Installation
...
Mobile first, always. Design for the smallest viewport first, then expand. Every layout must work at 320px and at 1440px. Use sm:, md:, lg: Tailwind prefixes systematically.
...
Narrow columns. Body text never exceeds max-w-[60ch]. Wider columns hurt legibility.
Typography
