...
url: https://skills.sh/mono0926/skills-sync/skills-optimizer
---

# skills-optimizer

skills/mono0926/skills-sync/skills-optimizer
skills-optimizer
Installation
$ npx skills add https://github.com/mono0926/skills-sync --skill skills-optimizer
SKILL.md
Skills Optimizer
...
Update skills.yaml based on the user's choices.
Maintain the original structure of YAML comments and formatting.
Ask for permission to apply changes: DO NOT run skills_sync sync automatically. Instead, ask the user if they would like to apply the configuration changes now.
Execute skills_sync sync only after receiving explicit confirmation.
[TIP] Use skills_sync sync --no-clean for a faster synchronization when only adding new skills or updating existing ones.
Confirm successful synchronization with the user.
Best Practices
