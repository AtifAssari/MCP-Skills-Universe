...
rating: ⭐⭐⭐
title: ssh-hardening
url: https://skills.sh/mikr13/secure-server-setup-skills/ssh-hardening
---

# ssh-hardening

skills/mikr13/secure-server-setup-skills/ssh-hardening
ssh-hardening
Installation
...
Use the new port when connecting: ssh -p 2222 user@host
...
Monitor authentication logs - Check /var/log/auth.log regularly
Use fail2ban - Add automated banning for repeated failed attempts
