...
rating: ⭐⭐⭐⭐⭐
title: write-skills
url: https://skills.sh/halcyon666/write-skills/write-skills
---

# write-skills

skills/halcyon666/write-skills/write-skills
write-skills
Installation
...
When should an agent activate this skill? (trigger phrases, task types)
What does the agent NOT already know? (only add novel context)
What's the failure mode without this skill? (guides what to include)
...
Push the skill directory to a GitHub repository
Users install with: npx skills add owner/repo
The skill appears on the skills.sh leaderboard via anonymous telemetry when installed
To list without installing: npx skills add owner/repo --list
