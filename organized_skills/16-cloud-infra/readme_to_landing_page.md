...
url: https://skills.sh/luongnv89/skills/readme-to-landing-page
---

# readme-to-landing-page

skills/luongnv89/skills/readme-to-landing-page
readme-to-landing-page
Installation
...
If working tree is dirty: git stash push -u -m "pre-sync", sync, then git stash pop. If origin is missing or conflicts occur, stop and ask the user.
...
Who — primary audience (developers, data scientists, ops teams, etc.)
Pain — what's frustrating about the status quo
Benefit — one sentence, becomes the H1 headline
...
Framework chosen
Where original content lives (README.backup.md + collapsed sections)
