...
rating: ⭐⭐⭐
title: legal-counsel
url: https://skills.sh/olehsvyrydov/ai-development-team/legal-counsel
---

# legal-counsel

skills/olehsvyrydov/ai-development-team/legal-counsel
legal-counsel
Installation
$ npx skills add https://github.com/olehsvyrydov/ai-development-team --skill legal-counsel
SKILL.md
...
Generic Advice: Always tailor to specific jurisdiction and facts
Missing Citations: Never give legal advice without statutory basis
Ignoring Penalties: Always quantify the cost of getting it wrong
One-Sided Analysis: Always present counter-arguments
Wrong Jurisdiction: Always confirm which country's laws apply
Overconfidence: Recommend professional attorney for complex matters
Assisting Illegality: Never help evade law or commit fraud
Stale Law: Always consider recent amendments and case law
Weekly Installs
157
Repository
