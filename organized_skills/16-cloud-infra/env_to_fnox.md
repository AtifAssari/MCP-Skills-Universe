...
rating: ⭐⭐⭐
title: env-to-fnox
url: https://skills.sh/steveclarke/dotfiles/env-to-fnox
---

# env-to-fnox

skills/steveclarke/dotfiles/env-to-fnox
env-to-fnox
Installation
$ npx skills add https://github.com/steveclarke/dotfiles --skill env-to-fnox
SKILL.md
