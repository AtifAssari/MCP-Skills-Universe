...
url: https://skills.sh/williacj/claude-skills/biblical-accuracy
---

# biblical-accuracy

skills/williacj/claude-skills/biblical-accuracy
biblical-accuracy
Installation
$ npx skills add https://github.com/williacj/claude-skills --skill biblical-accuracy
SKILL.md
...
Confirm book, chapter, and verse exist
Check quoted text matches the biblical source
Verify translation used (ESV, NIV, NASB, KJV, etc.)
Flag misquotes or incorrect citations
...
Read verses before and after the citation
Understand the passage's literary context (narrative, poetry, epistle, etc.)
Consider the author's intent and audience
Check if the interpretation fits the context
...
Identify key Greek words in the passage
...
Cross-reference usage: How is this word used elsewhere in the NT?
For Old Testament (Hebrew)
Identify key Hebrew words in the passage
Analyze word meanings:
Root word (shoresh)
...
Consider poetic devices: Parallelism, chiasm, wordplay
...
Proof-texting: Using verses without context
Root fallacy: Assuming etymology determines meaning
Illegitimate totality transfer: Loading all word meanings into one usage
One-meaning fallacy: Assuming words always mean the same thing
Concordance abuse: Relying on Strong's without understanding grammar
Genre confusion: Reading poetry as prose or vice versa
Eisegesis: Reading modern ideas into the text
Cultural imperialism: Ignoring ancient Near Eastern context
Quality Checklist
