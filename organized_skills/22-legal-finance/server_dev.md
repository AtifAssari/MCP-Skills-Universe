...
rating: ⭐⭐
title: server-dev
url: https://skills.sh/contextvm/cvmi/server-dev
---
...
server-dev
Installation
$ npx skills add https://github.com/contextvm/cvmi --skill server-dev
SKILL.md
...
Once stable, swap the transport to NostrServerTransport.
