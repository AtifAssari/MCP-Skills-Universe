...
rating: ⭐⭐⭐
title: zapsign
url: https://skills.sh/vm0-ai/vm0-skills/zapsign
---

# zapsign

skills/vm0-ai/vm0-skills/zapsign
zapsign
Installation
...
Store tokens: Save token and signers[].token for future API calls
File URLs expire: original_file and signed_file URLs expire in 60 minutes
Use webhooks: Instead of polling, set up webhooks for real-time notifications
