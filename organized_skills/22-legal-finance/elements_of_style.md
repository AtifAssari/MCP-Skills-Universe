...
url: https://skills.sh/penkzhou/swiss-army-knife-plugin/elements-of-style
---

# elements-of-style

skills/penkzhou/swiss-army-knife-plugin/elements-of-style
elements-of-style
Installation
$ npx skills add https://github.com/penkzhou/swiss-army-knife-plugin --skill elements-of-style
SKILL.md
...
先生成草稿
使用 Read 工具读取 elements-of-style.md
逐条检查 Section V（常见误用词）
优化并定稿
受限上下文策略
...
根据规则摘要独立完成草稿
派发子 agent，携带草稿和 elements-of-style.md
让子 agent 进行编辑润色并返回修订版
规则摘要
