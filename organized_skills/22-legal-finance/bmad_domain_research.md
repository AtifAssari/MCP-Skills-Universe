...
url: https://skills.sh/bmad-code-org/bmad-method/bmad-domain-research
---

# bmad-domain-research

skills/bmad-code-org/bmad-method/bmad-domain-research
bmad-domain-research
Installation
$ npx skills add https://github.com/bmad-code-org/bmad-method --skill bmad-domain-research
SKILL.md
...
Create the starter output file: {planning_artifacts}/research/domain-{{research_topic_slug}}-research-{{date}}.md with exact copy of the ./research.template.md contents
