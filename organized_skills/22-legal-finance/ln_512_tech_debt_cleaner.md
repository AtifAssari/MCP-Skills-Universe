---
rating: ⭐⭐⭐
title: ln-512-tech-debt-cleaner
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-512-tech-debt-cleaner
---

# ln-512-tech-debt-cleaner

skills/levnikolaevich/claude-code-skills/ln-512-tech-debt-cleaner
ln-512-tech-debt-cleaner
Installation
...
Verify each finding (confidence check): MANDATORY READ: Load shared/references/clean_code_checklist.md For each candidate fix: a) Read the target file at specified location b) Confirm the finding still exists (file may have changed since audit) c) Confirm removal is safe:
