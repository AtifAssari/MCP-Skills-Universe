...
url: https://skills.sh/jmsktm/claude-settings/cost-optimizer
---

# cost optimizer

skills/jmsktm/claude-settings/Cost Optimizer
Cost Optimizer
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Cost Optimizer'
SKILL.md
Cost Optimizer
