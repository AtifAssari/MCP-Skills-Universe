---
rating: ⭐⭐⭐
title: spec-kitty-plan
url: https://skills.sh/richfrem/agent-plugins-skills/spec-kitty-plan
---

# spec-kitty-plan

skills/richfrem/agent-plugins-skills/spec-kitty-plan
spec-kitty-plan
Installation
...
immediately after parsing setup-plan --json
again in the final report before suggesting /spec-kitty.tasks
...
Resolve feature context deterministically (CRITICAL - prevents wrong feature selection):
...
Setup: If step 2 did not already return a successful setup payload, run spec-kitty agent feature setup-plan --feature <feature-slug> --json from the repository root and parse JSON for:
