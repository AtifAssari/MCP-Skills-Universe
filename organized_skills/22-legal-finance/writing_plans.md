...
rating: ⭐⭐⭐⭐⭐
title: writing-plans
url: https://skills.sh/pcvelz/superpowers/writing-plans
---

# writing-plans

skills/pcvelz/superpowers/writing-plans
writing-plans
...
Can it be verified independently? (if no → too small)
Does it touch more than one concern? (if yes → too big)
Would it get its own commit? (if no → merge with adjacent task)
