...
url: https://skills.sh/sylla-bv/sylla-skills/ticket-creator
---

# ticket-creator

skills/sylla-bv/sylla-skills/ticket-creator
ticket-creator
Installation
...
What are we building/fixing and why? What's the scope?
Is there an existing pattern to follow? (most critical)
Technical details — types, contracts, file paths
Side effects, integration points, permissions
