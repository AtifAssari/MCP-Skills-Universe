...
url: https://skills.sh/launchdarkly/agent-skills/launchdarkly-flag-cleanup
---

# launchdarkly-flag-cleanup

skills/launchdarkly/agent-skills/launchdarkly-flag-cleanup
launchdarkly-flag-cleanup
Installation
...
Note the scope. How many files, components, or modules does this flag touch? A flag used in one if block is simpler than one threaded through multiple layers.
...
LaunchDarkly action — confirm the flag will be archived after code changes are complete.
...
Archive the flag in LaunchDarkly using archive-flag. Archival is reversible; deletion is not. Always archive first.
Notify other teams if check-removal-readiness reported code references in other repositories.
If the flag had targeting changes pending, they can be ignored: the flag is being removed.
References
