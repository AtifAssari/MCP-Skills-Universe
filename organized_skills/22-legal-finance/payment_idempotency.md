...
url: https://skills.sh/vtex/skills/payment-idempotency
---
...
payment-idempotency
Installation
$ npx skills add https://github.com/vtex/skills --skill payment-idempotency
SKILL.md
...
PPP endpoint response shapes and HTTP methods — use payment-provider-protocol
Async callback URL notification logic — use payment-async-flow
PCI compliance and Secure Proxy — use payment-pci-security
Decision rules
...
payment-async-flow — Callback URL notification and the 7-day retry window
payment-pci-security — PCI compliance and Secure Proxy
vtex-io-application-performance — VBase write correctness (await in critical paths), per-client timeout/retry config, and caching rules for IO-based connectors
Reference
