...
rating: ⭐⭐⭐
title: pr-guardian
url: https://skills.sh/s-hiraoku/synapse-a2a/pr-guardian
---

# pr-guardian

skills/s-hiraoku/synapse-a2a/pr-guardian
pr-guardian
Installation
...
Invoke /fix-conflict
After resolution, the push triggers new CI runs — go back to Step 1
...
Invoke /fix-ci
After the fix commit is pushed, go back to Step 1
...
Invoke /fix-review
/fix-review will verify each finding against current code before fixing
After the fix commit is pushed, go back to Step 1
...
All green (all_green == true): Print success message and exit
Max iterations reached: Print summary of remaining issues and exit
