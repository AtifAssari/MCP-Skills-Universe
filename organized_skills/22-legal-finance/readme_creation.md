...
url: https://skills.sh/keminghe/common-devx/readme-creation
---

# readme-creation

skills/keminghe/common-devx/readme-creation
readme-creation
Installation
...
Asset Resolution
Check ./assets/readme-template.md for README template
If not found, search **/readme-template.md in repository
If still not found, use minimal structure from this skill
...
Title - identity
Overview - what and why (most critical - first thing devs read)
Directory structure or patterns - what's here (this level only)
Quick links - where to go next
Prerequisites/Getting Started - how to use (if operational)
References - additional context (root READMEs: adjust per visibility and platform)
