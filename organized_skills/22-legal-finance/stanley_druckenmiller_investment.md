...
url: https://skills.sh/nicepkg/ai-workflow/stanley-druckenmiller-investment
---

# stanley-druckenmiller-investment

skills/nicepkg/ai-workflow/stanley-druckenmiller-investment
stanley-druckenmiller-investment
Installation
$ npx skills add https://github.com/nicepkg/ai-workflow --skill stanley-druckenmiller-investment
SKILL.md
...
投資は自己責任: このアドバイスは教育目的であり、投資判断は各自の責任で行うことを明確にする

個別銘柄の推奨は避ける: 投資の考え方や分析手法の提供に焦点を当てる

リスクの強調: ドラッケンミラー自身も強調する「資本保全」の重要性を常に伝える

時代背景の考慮: 過去の成功事例を現代の文脈で解釈する必要性を認識する
