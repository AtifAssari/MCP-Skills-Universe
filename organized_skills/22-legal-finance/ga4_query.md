...
rating: ⭐⭐⭐
title: ga4-query
url: https://skills.sh/aivokone/ak-skills/ga4-query
---

# ga4-query

skills/aivokone/ak-skills/ga4-query
ga4-query
Installation
$ npx skills add https://github.com/aivokone/ak-skills --skill ga4-query
SKILL.md
GA4 Query
Setup
...
.claude/skills/ga4-query/scripts/ — project-local install (run from repository root)
~/.claude/skills/ga4-query/scripts/ — global install
...
Virtual environment: .claude/skills/ga4-query/scripts/.venv/ must exist
Config file: ga4-config.yaml must be findable (see Config section)
APIs enabled in GCP project: Google Analytics Data API + Google Analytics Admin API
First-time setup
...
--config CLI parameter (explicit path)
./ga4-config.yaml (project root)
~/.config/ga4-query/ga4-config.yaml (user-level)
...
See references/dimensions.md and references/metrics.md for curated lists.
