---
rating: ⭐⭐
title: antv-s2-expert
url: https://skills.sh/antvis/chart-visualization-skills/antv-s2-expert
---

# antv-s2-expert

skills/antvis/chart-visualization-skills/antv-s2-expert
antv-s2-expert
Installation
...
Prefer TypeScript
For React, use <SheetComponent> from @antv/s2-react
Data config uses S2DataConfig type with fields (rows/columns/values) and data
Table config uses S2Options type
Event listeners use s2.on(S2Event.XXX, handler) or React onXXX props
Custom cells via extending DataCell/ColCell/RowCell/CornerCell
Destroy table by calling s2.destroy()
How to Use
