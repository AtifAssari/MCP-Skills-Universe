---
rating: ⭐⭐⭐
title: verify-email-snapshots
url: https://skills.sh/aaronontheweb/dotnet-skills/verify-email-snapshots
---

# verify-email-snapshots

skills/aaronontheweb/dotnet-skills/verify-email-snapshots
verify-email-snapshots
Installation
...
Run test - First run creates .verified.html
Review - Open in browser, verify rendering
Commit - Include .verified.html in source control
Iterate - Changes fail test, review diff, accept if correct
Resources
