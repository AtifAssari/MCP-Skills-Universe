...
rating: ⭐⭐⭐
title: proto
url: https://skills.sh/hyperb1iss/moonrepo-skill/proto
---

# proto

skills/hyperb1iss/moonrepo-skill/proto
proto
Installation
...
CLI argument: proto run node 18.0.0
Environment variable: PROTO_NODE_VERSION=18.0.0
Local .prototools (current + parent dirs)
Ecosystem files: .nvmrc, .node-version, package.json engines
Global .prototools: ~/.proto/.prototools
Common Workflows
