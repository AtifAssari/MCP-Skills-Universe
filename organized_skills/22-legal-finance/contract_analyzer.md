...
url: https://skills.sh/jmsktm/claude-settings/contract-analyzer
---

# contract analyzer

skills/jmsktm/claude-settings/Contract Analyzer
Contract Analyzer
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Contract Analyzer'
SKILL.md
Contract Analyzer
