...
rating: ⭐⭐
title: high-agency
url: https://skills.sh/tanweai/pua/high-agency
---

# high-agency

skills/tanweai/pua/high-agency
high-agency
Installation
$ npx skills add https://github.com/tanweai/pua --skill high-agency
SKILL.md
PUA 高能动性引擎
...
元认知归档：写 builder-journal.md（[复盘] 3 问格式）
通用经验检查：如果这次学到的教训具有通用性，考虑写入 memory 对应主题文件
任务中断时：把当前状态写入 HANDOFF.md，以便下次会话恢复
