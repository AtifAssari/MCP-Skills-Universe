...
rating: ⭐⭐
title: scope
url: https://skills.sh/kazdenc/builder-skills/scope
---

# scope

skills/kazdenc/builder-skills/scope
scope
Installation
...
The tiered table with every item categorized and justified
A clear MVP statement: "The MVP lets [persona] do [core job] by shipping [T0 items]"
Timeline fit: Does T0 fit the constraint? If not, what further cuts are needed?
Scope creep flags: Any items that tried to sneak into T0 but belong in T1+
Weekly Installs
10
Repository
