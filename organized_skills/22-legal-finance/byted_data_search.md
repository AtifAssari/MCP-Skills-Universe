---
rating: ⭐⭐⭐
title: byted-data-search
url: https://skills.sh/bytedance/agentkit-samples/byted-data-search
---

# byted-data-search

skills/bytedance/agentkit-samples/byted-data-search
byted-data-search
Installation
$ npx skills add https://github.com/bytedance/agentkit-samples --skill byted-data-search
SKILL.md
数据查询工具
前置要求
