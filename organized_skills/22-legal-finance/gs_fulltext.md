...
rating: ⭐⭐⭐
title: gs-fulltext
url: https://skills.sh/cookjohn/gs-skills/gs-fulltext
---

# gs-fulltext

skills/cookjohn/gs-skills/gs-fulltext
gs-fulltext
Installation
$ npx skills add https://github.com/cookjohn/gs-skills --skill gs-fulltext
SKILL.md
...
fullTextUrl (direct PDF/HTML, usually free)
DOI link (may require subscription)
