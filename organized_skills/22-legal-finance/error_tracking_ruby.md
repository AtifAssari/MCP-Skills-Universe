---
rating: ⭐⭐
title: error-tracking-ruby
url: https://skills.sh/posthog/skills/error-tracking-ruby
---

# error-tracking-ruby

skills/posthog/skills/error-tracking-ruby
error-tracking-ruby
Installation
$ npx skills add https://github.com/posthog/skills --skill error-tracking-ruby
SKILL.md
