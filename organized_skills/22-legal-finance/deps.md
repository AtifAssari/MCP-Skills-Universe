...
rating: ⭐⭐⭐
title: deps
url: https://skills.sh/boshu2/agentops/deps
---

# deps

skills/boshu2/agentops/deps
deps
Installation
...
Rules
Flag all copyleft licenses (GPL, AGPL, SSPL) as Critical in proprietary projects.
Flag weak copyleft (MPL, LGPL) as Medium -- review usage pattern.
Flag missing licenses as High -- unknown license is treated as all-rights-reserved.
Flag license changes between versions -- an update may change the license.
