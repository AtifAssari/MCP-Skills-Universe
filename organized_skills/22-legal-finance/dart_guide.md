...
rating: ⭐⭐⭐
title: dart-guide
url: https://skills.sh/ar4mirez/samuel/dart-guide
---

# dart-guide

skills/ar4mirez/samuel/dart-guide
dart-guide
Installation
...
Immutability First: Prefer final locals, const constructors, and immutable data structures
Composition Over Inheritance: Use mixins, extension methods, and sealed class hierarchies
...
references/patterns.md -- Stream patterns, Isolate communication, sealed class hierarchies
External References
Effective Dart
Dart Language Tour
