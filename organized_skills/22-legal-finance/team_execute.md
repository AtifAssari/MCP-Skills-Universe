...
rating: ⭐⭐⭐
title: team-execute
url: https://skills.sh/wjaszczuk/agent-team-skills/team-execute
---

# team-execute

skills/wjaszczuk/agent-team-skills/team-execute
team-execute
Installation
...
Read .state.json — it has current state
Skip completed tasks
Resume from first pending or in_progress task
Continue per-task loop as normal
Red Flags
