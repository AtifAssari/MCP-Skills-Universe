...
rating: ⭐⭐⭐
title: sherlock
url: https://skills.sh/codeminer42/skills/sherlock
---

# sherlock

skills/codeminer42/skills/sherlock
sherlock
Installation
$ npx skills add https://github.com/codeminer42/skills --skill sherlock
SKILL.md
...
Determine the project context. Read the project's CLAUDE.md, package.json, Cargo.toml, pyproject.toml, go.mod, Gemfile, or equivalent to understand:
...
Create the results log. Create .claude/sherlock/ directory and a results file:
...
Create a branch. git checkout -b sherlock/YYYY-MM-DD from current HEAD.
...
Categories: flaky-test, slow-test, perf, memory, error-handling, intermittent, resource-leak Severities: critical, high, medium, low Statuses: baseline, keep, discard, crash
