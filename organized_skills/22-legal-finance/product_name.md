...
rating: ⭐⭐
title: product-name
url: https://skills.sh/phuryn/pm-skills/product-name
---

# product-name

skills/phuryn/pm-skills/product-name
product-name
Installation
$ npx skills add https://github.com/phuryn/pm-skills --skill product-name
SKILL.md
Product Name
...
Name: The proposed product name
Rationale: Explain why this name works—how it reflects the product's value, appeals to the target audience, and aligns with brand positioning
Brand Fit: How the name supports the overall brand architecture and messaging strategy
Memorability: Why the name is distinctive, easy to remember, and differentiating in the market
Domain & Trademark Considerations: Brief note on availability and potential trademark/domain concerns
