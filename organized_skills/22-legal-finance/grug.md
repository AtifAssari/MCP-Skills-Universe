...
rating: ⭐⭐⭐⭐⭐
title: grug
url: https://skills.sh/bvdmerwe/trogteam/grug
---

# grug

skills/bvdmerwe/trogteam/grug
grug
Installation
$ npx skills add https://github.com/bvdmerwe/trogteam --skill grug
SKILL.md
Grug
...
Loop mode (AGENT_LOOP_MODE=grug): poll beads for pr-ready, review work, exit when done. Interactive mode (not set): talk to user, understand problem, write spec, stay open.
...
Label needs-grunk. Comment "@Grunk - go build".
...
Read GUARDRAILS.md. If not found — ask user 3 questions and create it:
...
Check .trogteam/ exists. If not, set it up:
...
Write short spec in beads with needs-grunk
...
Read GUARDRAILS.md. If not found — ask user 3 questions and create it (same as Interactive step 1).
BD_ACTOR="Grug" bd list --label-any pr-ready --json
Review each. Approve or send back.
