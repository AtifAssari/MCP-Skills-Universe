...
url: https://skills.sh/galz10/pickle-rick-extension/ticket-manager
---

# ticket-manager

skills/galz10/pickle-rick-extension/ticket-manager
ticket-manager
Installation
...
Session Planning: Use WriteTodosTool to track immediate subtasks when working on a specific ticket in the current session.
...
Output Promise: You MUST output <promise>TICKET_SELECTED</promise>.
