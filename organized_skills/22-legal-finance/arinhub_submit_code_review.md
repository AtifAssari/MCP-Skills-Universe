---
rating: ⭐⭐⭐⭐⭐
title: arinhub-submit-code-review
url: https://skills.sh/arinhubcom/arinhub/arinhub-submit-code-review
---

# arinhub-submit-code-review

skills/arinhubcom/arinhub/arinhub-submit-code-review
arinhub-submit-code-review
Installation
...
Review file: If a review file path is provided (e.g., from arinhub-code-reviewer orchestrator), read the file and extract all issues from the ## Issues section.
...
Review file: If a review file was used, look for a ## Requirements Coverage section and extract its full content.
Current chat session: If no review file was used, look for any Requirements Coverage report or coverage summary produced during the current chat session.
