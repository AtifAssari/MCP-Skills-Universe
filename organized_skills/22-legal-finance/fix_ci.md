...
rating: ⭐⭐⭐
title: fix-ci
url: https://skills.sh/phrazzld/claude-config/fix-ci
---

# fix-ci

skills/phrazzld/claude-config/fix-ci
fix-ci
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill fix-ci
SKILL.md
