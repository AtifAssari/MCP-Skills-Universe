---
rating: ⭐⭐⭐
title: devdocs-insights
url: https://skills.sh/ab300819/skills/devdocs-insights
---
...
devdocs-insights
Installation
$ npx skills add https://github.com/ab300819/skills --skill devdocs-insights
SKILL.md
洞察收集
...
降级为变更日志——仅记录 INS 编号、来源、确认时间和转化目标，不重复需求内容。避免 05-insights.md 与 01-requirements.md 之间的双写不同步风险。
...
收集建议时，必须读取 source-types.md 获取各来源类型的输入方式、关注点和示例。
