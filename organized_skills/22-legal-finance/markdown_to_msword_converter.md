---
rating: ⭐⭐
title: markdown-to-msword-converter
url: https://skills.sh/richfrem/agent-plugins-skills/markdown-to-msword-converter
---

# markdown-to-msword-converter

skills/richfrem/agent-plugins-skills/markdown-to-msword-converter
markdown-to-msword-converter
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill markdown-to-msword-converter
SKILL.md
Dependencies
