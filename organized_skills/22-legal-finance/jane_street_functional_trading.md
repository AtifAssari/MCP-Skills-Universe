---
rating: ⭐⭐
title: jane-street-functional-trading
url: https://skills.sh/copyleftdev/sk1llz/jane-street-functional-trading
---

# jane-street-functional-trading

skills/copyleftdev/sk1llz/jane-street-functional-trading
jane-street-functional-trading
Installation
...
Correctness by Construction: Design types so invalid states cannot be represented.

Immutability by Default: Mutable state is explicit and contained.

Types as Documentation: The type signature should tell you what a function does.

Explicit Effects: Side effects are visible in the type system.
...
What are the states? Model them as sum types
What transitions are valid? Encode in the type system
What can go wrong? Return Result types, not exceptions
Is it testable? Pure functions, property-based tests
Can I reason about it? If the code is confusing, redesign it
