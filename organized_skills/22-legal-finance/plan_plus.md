...
rating: ⭐⭐⭐
title: plan-plus
url: https://skills.sh/popup-studio-ai/bkit-claude-code/plan-plus
---

# plan-plus

skills/popup-studio-ai/bkit-claude-code/plan-plus
plan-plus
Installation
...
Check existing docs/01-plan/ documents (prevent duplication)
Check .bkit-memory.json (check ongoing PDCA status)
...
Architecture overview → "Does this direction look right?"
Key components/modules → "Does this structure look right?"
Data flow → "Does this flow look right?"
