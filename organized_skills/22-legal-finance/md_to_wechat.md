...
rating: ⭐⭐⭐
title: md-to-wechat
url: https://skills.sh/zhenxuanshi-ship-it/meatpiegua_skills/md-to-wechat
---

# md-to-wechat

skills/zhenxuanshi-ship-it/meatpiegua_skills/md-to-wechat
md-to-wechat
Installation
...
方式三：API 一键发布
首次使用先运行 --setup 配置凭据
执行 --publish 命令，脚本自动创建草稿并发布
注意：API 发布的文章不会推送给粉丝，如需推送请在后台手动群发
可用主题
