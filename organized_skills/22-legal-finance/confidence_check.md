...
url: https://skills.sh/unix2dos/skills/confidence-check
---

# confidence-check

skills/unix2dos/skills/confidence-check
confidence-check
Installation
$ npx skills add https://github.com/unix2dos/skills --skill confidence-check
SKILL.md
实施前置信度检查
