...
rating: ⭐⭐⭐
title: bun-elysia
url: https://skills.sh/ymc182/bun-elysia-skill/bun-elysia
---

# bun-elysia

skills/ymc182/bun-elysia-skill/bun-elysia
bun-elysia
Installation
...
Monorepo with workspaces → monorepo.md

Use Bun native APIs:

PostgreSQL/MySQL/SQLite → native-apis/sql.md
Redis/Valkey → native-apis/redis.md
S3/Object storage → native-apis/s3.md
HTTP server basics → native-apis/http-server.md

Build with Elysia:

Routing and handlers → elysia/core.md
Request/response validation → elysia/validation.md
Hooks, middleware, plugins → elysia/lifecycle.md
WebSocket support → elysia/websocket.md
OpenAPI/Swagger docs → elysia/swagger.md
Type-safe client (Eden) → elysia/eden.md

Migrate from Fastify:

Routing, params, body → migration/fastify-basics.md
Schema validation → migration/fastify-validation.md
Lifecycle hooks → migration/fastify-hooks.md
Plugin architecture → migration/fastify-plugins.md
Authentication → migration/fastify-auth.md
WebSocket, Swagger, files → migration/fastify-advanced.md
Common Patterns
