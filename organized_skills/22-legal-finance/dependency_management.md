...
url: https://skills.sh/dralgorhythm/claude-agentic-framework/dependency-management
---

# dependency-management

skills/dralgorhythm/claude-agentic-framework/dependency-management
dependency-management
Installation
$ npx skills add https://github.com/dralgorhythm/claude-agentic-framework --skill dependency-management
SKILL.md
Dependency Management
Workflows
