---
rating: ⭐⭐⭐
title: tools-p4-basics
url: https://skills.sh/tjboudreaux/cc-plugin-perforce/tools-p4-basics
---

# tools-p4-basics

skills/tjboudreaux/cc-plugin-perforce/tools-p4-basics
tools-p4-basics
Installation
...
Revert unchanged files with p4 revert -a
Check p4 opened before leaving for the day
Use p4 reconcile to catch local changes
Preview with -n before destructive operations
