...
rating: ⭐⭐⭐
title: gtm-testing
url: https://skills.sh/aimonk2025/google-tag-manager-automation/gtm-testing
---

# gtm-testing

skills/aimonk2025/google-tag-manager-automation/gtm-testing
gtm-testing
Installation
...
Next.js Link components (navigation, course buttons): Do NOT use page.click() — it triggers navigation before the onClick handler fires. Use dispatchEvent instead:
