---
rating: ⭐⭐
title: staged-review-validator
url: https://skills.sh/adonis0123/adonis-skills/staged-review-validator
---

# staged-review-validator

skills/adonis0123/adonis-skills/staged-review-validator
staged-review-validator
Installation
...
明确提示“请先粘贴 staged-changes-review 结果”
提供一个最小输入模板（见 references/output-template.md）
不自动改为扫描 git diff --cached
核验流程
1. 解析问题清单
