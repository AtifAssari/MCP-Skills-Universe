...
rating: ⭐⭐
title: product-lens
url: https://skills.sh/affaan-m/everything-claude-code/product-lens
---

# product-lens

skills/affaan-m/everything-claude-code/product-lens
product-lens
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill product-lens
SKILL.md
