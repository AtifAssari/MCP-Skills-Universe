...
rating: ⭐⭐⭐
title: design-sync
url: https://skills.sh/chmouel/lazyworktree/design-sync
---

# design-sync

skills/chmouel/lazyworktree/design-sync
design-sync
Installation
...
📝 Recommended Actions
Specific edits with DESIGN.md line numbers to update
New sections to add (with suggested content outline)
Sections to remove or rewrite
Line number corrections for all file references
Usage Workflow
