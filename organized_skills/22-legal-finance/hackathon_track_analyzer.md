---
rating: ⭐⭐
title: hackathon-track-analyzer
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-track-analyzer
---

# hackathon-track-analyzer

skills/bernieweb3/hackathon-ai-devkit/hackathon-track-analyzer
hackathon-track-analyzer
Installation
$ npx skills add https://github.com/bernieweb3/hackathon-ai-devkit --skill hackathon-track-analyzer
SKILL.md
hackathon-track-analyzer
Goal
...
Rules
Extract only what is explicitly stated or strongly implied; do not fabricate constraints.
Prioritize mandatory constraints over optional ones.
Flag ambiguous language with [AMBIGUOUS] marker.
Map each sponsor's stated priorities to 1–3 concrete actionable requirements.
Identify at least one underexplored strategic opportunity per track.
Output recommended_skills drawn only from the hackathon-ai-devkit skill list.
Output Format
