...
rating: ⭐⭐⭐
title: pre-deploy
url: https://skills.sh/alpoxdev/hypercore/pre-deploy
---

# pre-deploy

skills/alpoxdev/hypercore/pre-deploy
pre-deploy
Installation
$ npx skills add https://github.com/alpoxdev/hypercore --skill pre-deploy
SKILL.md
