...
rating: ⭐⭐⭐
title: fp-implement
url: https://skills.sh/fiberplane/claude-code-plugins/fp-implement
---

# fp-implement

skills/fiberplane/claude-code-plugins/fp-implement
fp-implement
Installation
$ npx skills add https://github.com/fiberplane/claude-code-plugins --skill fp-implement
SKILL.md
FP Implement Skill
