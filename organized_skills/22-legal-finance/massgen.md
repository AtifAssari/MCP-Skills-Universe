...
rating: ⭐⭐⭐
title: massgen
url: https://skills.sh/massgen/skills/massgen
---

# massgen

skills/massgen/skills/massgen
massgen
Installation
...
Agent (text-based): Fetch diffs via GET /api/sessions/{id}/review, show the user a summary, then submit their decision:
# Approve all
