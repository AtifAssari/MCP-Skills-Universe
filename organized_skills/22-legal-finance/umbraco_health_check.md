---
rating: ⭐⭐⭐
title: umbraco-health-check
url: https://skills.sh/umbraco/umbraco-cms-backoffice-skills/umbraco-health-check
---

# umbraco-health-check

skills/umbraco/umbraco-cms-backoffice-skills/umbraco-health-check
umbraco-health-check
Installation
$ npx skills add https://github.com/umbraco/umbraco-cms-backoffice-skills --skill umbraco-health-check
SKILL.md
Umbraco Health Check
What is it?
...
Ask questions - What should be checked? What actions to provide?
Generate files - Create manifest + context based on latest docs
