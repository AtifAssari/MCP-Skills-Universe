...
url: https://skills.sh/avdlee/xcode-build-optimization-agent-skill/xcode-build-orchestrator
---

# xcode-build-orchestrator

skills/avdlee/xcode-build-optimization-agent-skill/xcode-build-orchestrator
xcode-build-orchestrator
Installation
...
Generate the markdown optimization report using generate_optimization_report.py and save it to .build-benchmark/optimization-plan.md. This report includes the build settings audit, timing analysis, prioritized recommendations, and an approval checklist.
Stop and present the plan to the developer for review.
...
Read .build-benchmark/optimization-plan.md and identify the approved items from the approval checklist.
Hand off to xcode-build-fixer with the approved plan. The fixer applies each approved change, verifies compilation, and re-benchmarks.
Append verification results to the optimization plan: post-change medians, absolute and percentage deltas, and confidence notes.
