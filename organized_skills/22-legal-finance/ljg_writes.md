...
rating: ⭐⭐⭐
title: ljg-writes
url: https://skills.sh/lijigang/ljg-skills/ljg-writes
---

# ljg-writes

skills/lijigang/ljg-skills/ljg-writes
ljg-writes
Installation
...
输出
初稿 + 中文重写，两稿择优
date +%Y%m%dT%H%M%S 和 date "+%Y-%m-%d %a %H:%M" 获取时间戳
从观点中提取关键词作为标题
写入 ~/Documents/notes/{时间戳}==z--{标题关键词}__write.org
报告路径
Weekly Installs
1.7K
Repository
