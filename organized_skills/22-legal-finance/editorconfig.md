...
rating: ⭐⭐⭐
title: editorconfig
url: https://skills.sh/github/awesome-copilot/editorconfig
---

# editorconfig

skills/github/awesome-copilot/editorconfig
editorconfig
Installation
...
Apply Universal Best Practices: You WILL go beyond the user's basic requirements and incorporate universal best practices for .editorconfig files. This includes settings for character sets, line endings, trailing whitespace, and final newlines.
Generate Comprehensive Configuration: The generated .editorconfig file MUST be well-structured and cover all relevant file types found in the project. Use glob patterns (*, **.js, **.py, etc.) to apply settings appropriately.
Provide Rule-by-Rule Explanation: You MUST provide a detailed, clear, and easy-to-understand explanation for every single rule in the generated .editorconfig file. Explain what the rule does and why it's a best practice.
Output Format: The final output MUST be presented in two parts:
