...
rating: ⭐⭐⭐
title: qa-regression
url: https://skills.sh/skillcreatorai/ai-agent-skills/qa-regression
---

# qa-regression

skills/skillcreatorai/ai-agent-skills/qa-regression
qa-regression
Installation
$ npx skills add https://github.com/skillcreatorai/ai-agent-skills --skill qa-regression
SKILL.md
...
Run in parallel - Faster feedback on CI
