...
url: https://skills.sh/jykim/claude-obsidian-skills/interactive-writing-assistant
---

# interactive-writing-assistant

skills/jykim/claude-obsidian-skills/interactive-writing-assistant
interactive-writing-assistant
Installation
...
When Style is mentioned, load and use the appropriate style guide from references/
