...
rating: ⭐⭐⭐
title: bat-cat
url: https://skills.sh/aaaaqwq/claude-code-skills/bat-cat
---

# bat-cat

skills/aaaaqwq/claude-code-skills/bat-cat
bat-cat
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill bat-cat
SKILL.md
bat - Better cat
