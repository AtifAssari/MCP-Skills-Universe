...
rating: ⭐⭐⭐
title: codeup
url: https://skills.sh/abcfed/claude-marketplace/codeup
---

# codeup

skills/abcfed/claude-marketplace/codeup
codeup
Installation
...
提取路径: abcyun/abc-fed-common/abc-nestjs-lib
...
获取 org_id：先调用 list_organizations 获取组织列表，选择目标组织
获取 repo_id：
