...
rating: ⭐⭐⭐
title: synthesizer
url: https://skills.sh/liangdabiao/claude-code-stock-deep-research-agent/synthesizer
---

# synthesizer

skills/liangdabiao/claude-code-stock-deep-research-agent/synthesizer
synthesizer
Installation
$ npx skills add https://github.com/liangdabiao/claude-code-stock-deep-research-agent --skill synthesizer
SKILL.md
Synthesizer
Role
