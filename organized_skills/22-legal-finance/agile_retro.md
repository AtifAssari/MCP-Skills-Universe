...
rating: ⭐⭐
title: agile-retro
url: https://skills.sh/djalmajr/essential-skills/agile-retro
---

# agile-retro

skills/djalmajr/essential-skills/agile-retro
agile-retro
Installation
$ npx skills add https://github.com/djalmajr/essential-skills --skill agile-retro
SKILL.md
Retrospective
...
If $ARGUMENTS is filled, use as reference (e.g., period, sprint, initiative, delivery). If empty, ask which period or delivery will be analyzed.
