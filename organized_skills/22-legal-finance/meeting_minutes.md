...
url: https://skills.sh/github/awesome-copilot/meeting-minutes
---

# meeting-minutes

skills/github/awesome-copilot/meeting-minutes
meeting-minutes
Installation
...
Accepts multiple input formats: transcripts, recordings, slides, raw notes, or live meeting capture
Asks up to three clarifying questions upfront if critical details (title, date, organizer, source material) are missing before drafting
SKILL.md
