---
rating: ⭐⭐⭐
title: report-print-pdf
url: https://skills.sh/peterbamuhigire/skills-web-dev/report-print-pdf
---

# report-print-pdf

skills/peterbamuhigire/skills-web-dev/report-print-pdf
report-print-pdf
Installation
$ npx skills add https://github.com/peterbamuhigire/skills-web-dev --skill report-print-pdf
SKILL.md
Platform Notes
...
Build minimal HTML (shared by PDF + Print)
...
UI calls report API endpoint with filters (date range, status, warehouse, etc.)
API renders full HTML report and returns it as text/html
UI opens a new window/tab, writes HTML, waits for load, then calls window.print()
Print CSS mirrors the PDF layout (compact header, repeating thead, small footer)
User prints or saves as PDF from the browser dialog
Auto-Print Helper
