...
rating: ⭐⭐
title: skills-sync
url: https://skills.sh/mono0926/skills-sync/skills-sync
---

# skills-sync

skills/mono0926/skills-sync/skills-sync
skills-sync
Installation
$ npx skills add https://github.com/mono0926/skills-sync --skill skills-sync
SKILL.md
Skills Sync
...
Project-specific: ./skills.yaml
Global: ~/.config/skills_sync/skills.yaml
...
Identify the config file: Check if a project-local skills.yaml exists. If not, use the global ~/.config/skills_sync/skills.yaml.
Modify the configuration: Edit the identified skills.yaml file according to the user's instructions or your optimization logic.
Apply the changes: Execute skills_sync sync via the command line to ensure the changes take effect.
Verify: Optionally, run skills_sync list to confirm the installation matches expectations.
Best Practices
