...
rating: ⭐⭐⭐
title: graph
url: https://skills.sh/zpankz/mcp-skillset/graph
---

# graph

skills/zpankz/mcp-skillset/graph
graph
Installation
...
Quick Start
Basic Extraction
Load schema: Read /mnt/skills/user/knowledge-graph/schemas/core_ontology.md for entity/relationship types
Extract entities and relationships using the schema as a guide
Format as JSON following /mnt/skills/user/knowledge-graph/templates/extraction_template.md
