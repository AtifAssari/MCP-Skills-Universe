...
url: https://skills.sh/galaxy-dawn/claude-scholar/obsidian-synthesis-map
---

# obsidian-synthesis-map

skills/galaxy-dawn/claude-scholar/obsidian-synthesis-map
obsidian-synthesis-map
Installation
$ npx skills add https://github.com/galaxy-dawn/claude-scholar --skill obsidian-synthesis-map
SKILL.md
Obsidian Synthesis Map
