...
url: https://skills.sh/aaaaqwq/claude-code-skills/linear-automation
---

# linear-automation

skills/aaaaqwq/claude-code-skills/linear-automation
linear-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill linear-automation
SKILL.md
...
LINEAR_LIST_LINEAR_PROJECTS - List existing projects [Optional]
LINEAR_CREATE_LINEAR_PROJECT - Create a new project [Optional]
LINEAR_UPDATE_LINEAR_PROJECT - Update project details [Optional]
...
LINEAR_GET_ALL_LINEAR_TEAMS - Get team ID [Prerequisite]
LINEAR_GET_CYCLES_BY_TEAM_ID / LINEAR_LIST_LINEAR_CYCLES - List cycles [Required]
...
LINEAR_CREATE_LINEAR_LABEL - Create a new label [Optional]
LINEAR_CREATE_LINEAR_COMMENT - Comment on an issue [Optional]
LINEAR_UPDATE_LINEAR_COMMENT - Edit a comment [Optional]
