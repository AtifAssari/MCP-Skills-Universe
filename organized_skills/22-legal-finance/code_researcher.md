...
url: https://skills.sh/galz10/pickle-rick-extension/code-researcher
---

# code-researcher

skills/galz10/pickle-rick-extension/code-researcher
code-researcher
Installation
$ npx skills add https://github.com/galz10/pickle-rick-extension --skill code-researcher
SKILL.md
...
MANDATORY START
READ THE TICKET: You are FORBIDDEN from starting research without reading the ticket at ${SESSION_ROOT}/[ticket_id]/linear_ticket_[id].md.
DOCUMENT REALITY: Your job is to document what IS, not what SHOULD BE. If you start solutioning, you have failed.
Workflow
...
Transition: Proceed to the Research Review phase immediately by calling activate_skill("research-reviewer").
