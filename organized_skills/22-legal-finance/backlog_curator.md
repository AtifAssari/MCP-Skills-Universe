...
url: https://skills.sh/rysweet/amplihack/backlog-curator
---

# backlog-curator

skills/rysweet/amplihack/backlog-curator
backlog-curator
Installation
...
Run scripts/analyze_backlog.py --project-root <root> --max-recommendations 3
Parse JSON output
