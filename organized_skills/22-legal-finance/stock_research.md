...
url: https://skills.sh/z1993/alphamao_skills/stock-research
---

# stock-research

skills/z1993/alphamao_skills/stock-research
stock-research
Installation
$ npx skills add https://github.com/z1993/alphamao_skills --skill stock-research
SKILL.md
股票投资研究自动化
...
资料搜集（NotebookLM）：创建笔记本 → Deep Research → 导入资料
结构化提取（NotebookLM）：从 40-50 个文件中提取结构化数据
深度分析（代理）：基于结构化数据执行 6 阶段专业分析
输出报告：生成完整投资研究报告
...
注意事项
代理配置：如果用户网络需要代理，确保在所有 notebooklm 命令前设置环境变量。
时间预估：完整流程约需 20-30 分钟（Deep Research 15-30 分钟 + 提取和分析 5-10 分钟）。
数据时效性：报告基于 Deep Research 搜集的公开资料，时效性取决于资料发布时间。
投资建议免责：本 Skill 生成的报告仅供参考，不构成投资建议。
Weekly Installs
21
Repository
z1993/alphamao_skills
GitHub Stars
88
First Seen
Feb 13, 2026
