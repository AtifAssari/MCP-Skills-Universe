...
url: https://skills.sh/smallnest/langgraphgo/wechat-article-writer
---

# wechat-article-writer

skills/smallnest/langgraphgo/wechat-article-writer
wechat-article-writer
Installation
$ npx skills add https://github.com/smallnest/langgraphgo --skill wechat-article-writer
SKILL.md
微信公众号文章创作助手
概述
...
需求确认 询问用户以下关键信息（如未提供）：

目标受众是谁？（普通消费者/专业人士/特定行业）
文章风格偏好？（正式官方/亲和友好/专业严谨）
核心传递信息是什么？
文章长度要求？（800-1500字/1500-3000字/3000+字）
是否有特定的关键词或话题要求？
步骤2：内容研究与补充
...
注意事项
始终使用MCP工具：不要依赖过时的知识，通过搜索获取最新信息
尊重原创：引用内容时注明来源，不抄袭
保持客观：避免过度营销和夸大宣传
遵守规范：符合微信公众号平台规则
用户优先：以读者需求为中心，提供有价值的内容
持续优化：根据用户反馈不断改进写作策略
常见问题

Q: 如何平衡专业性和可读性？ A: 使用"通俗解释+专业术语"的方式，先用通俗语言解释概念，再引入专业术语。

Q: 文章长度如何控制？ A: 一般建议1500-2500字为宜。太短内容不够丰富，太长影响阅读体验。根据话题复杂度调整。

Q: 如何提高文章的传播性？ A: 1) 标题吸引眼球但不做标题党 2) 开头引发共鸣 3) 内容有价值可分享 4) 结尾引导转发

Q: 遇到敏感话题怎么办？ A: 保持客观中立，避免极端观点，引用官方权威说法，必要时建议用户调整选题。
