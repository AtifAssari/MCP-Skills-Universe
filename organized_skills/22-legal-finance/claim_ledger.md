...
rating: ⭐⭐
title: claim-ledger
url: https://skills.sh/hexbee/hello-skills/claim-ledger
---

# claim-ledger

skills/hexbee/hello-skills/claim-ledger
claim-ledger
Installation
$ npx skills add https://github.com/hexbee/hello-skills --skill claim-ledger
SKILL.md
Claim Ledger
何时使用
...
Type：事实/解释/预测/建议
Confidence：高/中/低
Evidence：E01,E02...（至少 2 条）
Source Grade：S/A/B/⚠️
Counter：至少 1 条反证/反例；无则写“未找到，风险=高”
Boundary：成立条件 + 失效条件
Publishability：可发/需改写/不可发
Evidence Card 规范
...
结论 -> 证据 -> 反方风险 -> 边界 -> 小结/清单
默认输出格式
Claim Ledger 表（至少 3 条 Claim）
Evidence Cards（与 Ledger 的 E# 对齐）
Gate Check（逐条列出通过/失败项）
若 Gate 全通过，才生成目标内容（线程/长文/脚本）
执行指令模板
