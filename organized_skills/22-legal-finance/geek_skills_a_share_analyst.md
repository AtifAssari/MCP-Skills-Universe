---
rating: ⭐⭐⭐
title: geek-skills-a-share-analyst
url: https://skills.sh/staruhub/claudeskills/geek-skills-a-share-analyst
---

# geek-skills-a-share-analyst

skills/staruhub/claudeskills/Geek-skills-a-share-analyst
Geek-skills-a-share-analyst
Installation
$ npx skills add https://github.com/staruhub/claudeskills --skill Geek-skills-a-share-analyst
SKILL.md
A股分析师 Skill
...
获取历史K线数据（至少60日）
计算技术指标（见 references/technical_indicators.md）
识别K线形态（见 references/candlestick_patterns.md）
判断趋势和支撑/阻力位
生成技术面评分
3. 基本面分析
