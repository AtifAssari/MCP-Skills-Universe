...
rating: ⭐⭐⭐⭐⭐
title: cts-triage
url: https://skills.sh/gfx-rs/wgpu/cts-triage
---

# cts-triage

skills/gfx-rs/wgpu/cts-triage
cts-triage
Installation
...
Add error variants if needed (in wgpu-core/src/pipeline.rs)
Add helper methods (in wgpu-types if checking properties)
Add validation checks (in wgpu-core/src/device/resource.rs)
Test the fix with specific failing tests
Run full subcategory to verify all related tests pass
Check you didn't break passing tests
...
Maintain alphabetical order roughly in the file
