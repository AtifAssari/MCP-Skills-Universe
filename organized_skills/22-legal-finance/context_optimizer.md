...
url: https://skills.sh/rohitg00/pro-workflow/context-optimizer
---

# context-optimizer

skills/rohitg00/pro-workflow/context-optimizer
context-optimizer
Installation
$ npx skills add https://github.com/rohitg00/pro-workflow --skill context-optimizer
SKILL.md
Context Optimizer
...
Quick Diagnosis
Run /context to check current usage
If > 70% → compact now before it degrades
...
Manual /compact
If still bad: new session with /resume
For recurring issues: reduce CLAUDE.md size, disable MCPs
Weekly Installs
20
Repository
