...
rating: ⭐⭐
title: pmf-survey
url: https://skills.sh/pmprompt/claude-plugin-product-management/pmf-survey
---

# pmf-survey

skills/pmprompt/claude-plugin-product-management/pmf-survey
pmf-survey
Installation
$ npx skills add https://github.com/pmprompt/claude-plugin-product-management --skill pmf-survey
SKILL.md
Domain Context
