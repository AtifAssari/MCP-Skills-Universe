...
rating: ⭐⭐⭐
title: prd-drafter
url: https://skills.sh/galz10/pickle-rick-extension/prd-drafter
---

# prd-drafter

skills/galz10/pickle-rick-extension/prd-drafter
prd-drafter
Installation
$ npx skills add https://github.com/galz10/pickle-rick-extension --skill prd-drafter
SKILL.md
...
Analyze USER_PROMPT: Look at the initial request provided in the context.
Fast Track: If the prompt is specific (e.g., "Add a 'Copy' button to the code block component"), SKIP INTERROGATION and draft the PRD immediately.
...
Filename: prd.md.
Path: Save the PRD to ${SESSION_ROOT}/prd.md.
Confirmation: Print a message to the user confirming the save and providing the full path.
PRD Template
# [Feature Name] PRD
...
Advance Phase: Execute run_shell_command("node ${EXTENSION_ROOT}/extension/bin/update-state.js step breakdown ${SESSION_ROOT}").
Output Promise: You MUST output <promise>PRD_COMPLETE</promise>.
YIELD CONTROL: You MUST output [STOP_TURN] and stop generating.
