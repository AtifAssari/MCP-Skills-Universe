...
url: https://skills.sh/ahgraber/skills/spec-kit-constitution
---

# spec-kit-constitution

skills/ahgraber/skills/spec-kit-constitution
spec-kit-constitution
Installation
$ npx skills add https://github.com/ahgraber/skills --skill spec-kit-constitution
SKILL.md
Spec Kit Constitution
...
Prepend a Sync Impact Report HTML comment to memory/constitution.md containing:
...
Write memory/constitution.md and report results to the user.
Output
