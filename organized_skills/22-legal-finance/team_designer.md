...
rating: ⭐⭐⭐
title: team-designer
url: https://skills.sh/catlog22/claude-code-workflow/team-designer
---

# team-designer

skills/catlog22/claude-code-workflow/team-designer
team-designer
Installation
...
v4 Architecture Compliance: Generated skills follow team-lifecycle-v4 pattern — SKILL.md = pure router, beat model = coordinator-only, unified structure (roles/ + specs/ + templates/)
Golden Sample Reference: Uses team-lifecycle-v4 as reference implementation at ~ or <project>/.claude/skills/team-lifecycle-v4/
...
Core Rules
Start Immediately: First action is Phase 1 execution
