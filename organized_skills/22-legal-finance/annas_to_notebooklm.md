---
rating: ⭐⭐⭐⭐⭐
title: annas-to-notebooklm
url: https://skills.sh/zstmfhy/annas-to-notebooklm/annas-to-notebooklm
---

# annas-to-notebooklm

skills/zstmfhy/annas-to-notebooklm/annas-to-notebooklm
annas-to-notebooklm
Installation
...
访问下载页面
查找下载链接：在 span.bg-gray-200 标签中查找包含下载 URL 的文本
导航到下载地址：直接访问下载链接
保存文件：下载到 ~/Downloads 目录
...
PDF：直接使用（保留排版）
EPUB：转换为 Markdown（使用 convert_epub.py）
大文件：自动分块（>350k 词）
...
Skill Version: 1.0.0 Last Updated: 2025-01-17 Author: Adapted from zstmfhy/zlibrary-to-notebooklm License: MIT

Weekly Installs
12
Repository
zstmfhy/annas-t…tebooklm
GitHub Stars
201
First Seen
Jan 20, 2026
