...
rating: ⭐⭐
title: xcrawl-crawl
url: https://skills.sh/xcrawl-api/xcrawl-skills/xcrawl-crawl
---

# xcrawl-crawl

skills/xcrawl-api/xcrawl-skills/xcrawl-crawl
xcrawl-crawl
Installation
$ npx skills add https://github.com/xcrawl-api/xcrawl-skills --skill xcrawl-crawl
SKILL.md
XCrawl Crawl
Overview
...
Poll GET /v1/crawl/{crawl_id} until terminal state.
