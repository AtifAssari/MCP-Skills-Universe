---
rating: ⭐⭐⭐
title: groq-enterprise-rbac
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-enterprise-rbac
---

# groq-enterprise-rbac

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-enterprise-rbac
groq-enterprise-rbac
Installation
$ npx skills add https://github.com/jeremylongshore/claude-code-plugins-plus-skills --skill groq-enterprise-rbac
SKILL.md
Groq Enterprise RBAC
Overview
