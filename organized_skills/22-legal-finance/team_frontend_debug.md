---
rating: ⭐⭐⭐
title: team-frontend-debug
url: https://skills.sh/catlog22/claude-code-workflow/team-frontend-debug
---

# team-frontend-debug

skills/catlog22/claude-code-workflow/team-frontend-debug
team-frontend-debug
Installation
...
Run Bash({ command: "pwd" }) → capture project_root (absolute path)
skill_root = <project_root>/.claude/skills/team-frontend-debug
Store in team-session.json:
{ "project_root": "/abs/path/to/project", "skill_root": "/abs/path/to/skill" }

All worker role_spec values MUST use <skill_root>/roles/<role>/role.md (absolute)
