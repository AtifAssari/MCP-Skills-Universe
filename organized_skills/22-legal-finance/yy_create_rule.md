---
rating: ⭐⭐⭐
title: yy-create-rule
url: https://skills.sh/bulls-cows/skills/yy-create-rule
---

# yy-create-rule

skills/bulls-cows/skills/yy-create-rule
yy-create-rule
Installation
$ npx skills add https://github.com/bulls-cows/skills --skill yy-create-rule
SKILL.md
yy-create-rule
...
检查 AGENTS.md 中是否存在 ## Rules 章节
如果不存在，在文件末尾添加 ## Rules 章节
在 Rules 章节中添加引用：- [规则目录路径]/[文件名].md: [简要说明]
