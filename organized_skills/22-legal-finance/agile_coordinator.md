...
url: https://skills.sh/jwynia/agent-skills/agile-coordinator
---

# agile-coordinator

skills/jwynia/agent-skills/agile-coordinator
agile-coordinator
Installation
...
Run agile-workflow with autonomous mode
Write progress to .coordinator/workers/{worker-id}/progress.json
Do NOT self-merge - signal ready-to-merge status instead
