...
url: https://skills.sh/dtyq/magic/bugfix-workflow
---

# bugfix-workflow

skills/dtyq/magic/bugfix-workflow
bugfix-workflow
Installation
$ npx skills add https://github.com/dtyq/magic --skill bugfix-workflow
SKILL.md
Bugfix Workflow
何时使用
用户要修 bug，而不是加功能
...
模板见 tasks-template.md。

执行要求
先确认 bug 范围，再写文档，再改代码。
若有辅助资料，先整理到 archives/<bug-id>/assets/ 并统一命名。
实施后运行最小必要测试集；若存在相邻行为风险，再覆盖相邻不变场景。
汇报时明确根因、改动边界、新增或更新的测试、以及仍未验证的风险。
硬规则
