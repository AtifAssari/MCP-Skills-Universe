---
rating: ⭐⭐
title: implementing-figma-ui-tempad-dev
url: https://skills.sh/ecomfe/tempad-dev/implementing-figma-ui-tempad-dev
---

# implementing-figma-ui-tempad-dev

skills/ecomfe/tempad-dev/implementing-figma-ui-tempad-dev
implementing-figma-ui-tempad-dev
Installation
...
tempad-dev:get_code (authoritative: explicit values, layout intent, warnings, assets, tokens, codegen, lang)
tempad-dev:get_structure (hierarchy, overlap, bounds clarification)
