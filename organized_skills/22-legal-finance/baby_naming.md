...
rating: ⭐⭐⭐
title: baby-naming
url: https://skills.sh/hhk0571/skills/baby-naming
---

# baby-naming

skills/hhk0571/skills/baby-naming
baby-naming
Installation
...
核心功能
生成推荐名字：根据八字、性别、姓氏推荐5-10个名字
评估已有名字：分析已有名字与八字的匹配度并打分
依赖项
...
完整名字：姓+名（2字或3字）
评分：基于五行匹配、文化内涵、音韵美感等维度，总分100分
五行属性：标注名字中每个字的五行
寓意解释：说明名字的含义和文化出处
推荐理由：简要说明为何推荐此名（五行匹配度、寓意等）
5. 取名原则
...
纳音辅助：考虑年柱纳音五行，若名字五行与纳音五行和谐（相生或比和），可额外加分
...
注意事项
准确性：八字计算基于公历时间，需要准确的出生时辰（精确到小时）
平衡性：不要过度强调单一五行，注重整体协调
文化性：名字应体现中华文化的美好寓意
实用性：避免生僻字和过于复杂的字
个性化：根据具体八字情况灵活调整，不要生搬硬套
典型使用场景
