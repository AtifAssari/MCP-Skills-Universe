...
url: https://skills.sh/luongnv89/skills/docs-generator
---

# docs-generator

skills/luongnv89/skills/docs-generator
docs-generator
Installation
...
Check the repo for branch naming conventions by running git branch -r | head -20 (e.g., feat/, feature/, etc.)
Create and switch to a new branch following the repo's convention, or fallback to: feat/docs-generator
1. Analyze Project
...
Confirm no orphaned docs (files not linked from anywhere)
Present a summary of changes to the user before committing
