...
rating: ⭐⭐⭐
title: uifork
url: https://skills.sh/sambernhardt/uifork/uifork
---

# uifork

skills/sambernhardt/uifork/uifork
uifork
Installation
...
Install uifork: npm install uifork
Add <UIFork /> component to app root
Initialize: npx uifork src/components/MyComponent.tsx (or npx uifork init src/components/MyComponent.tsx)
Start watch server: npx uifork watch
...
Selecting a version updates localStorage, triggering ForkedComponent to re-render
Watch server monitors file system for new version files and updates versions.ts automatically
