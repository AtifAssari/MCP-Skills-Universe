---
rating: ⭐⭐
title: wtf.feature-to-tasks
url: https://skills.sh/xiduzo/wtf/wtf.feature-to-tasks
---

# wtf.feature-to-tasks

skills/xiduzo/wtf/wtf.feature-to-tasks
wtf.feature-to-tasks
Installation
...
Follow the wtf.write-task process, passing:
...
Before moving to the next Task, ask "Task [N] created. Ready to continue to Task [N+1]: [next task description]?" — header Continue? (replace [N] and [N+1] with actual numbers and description):
