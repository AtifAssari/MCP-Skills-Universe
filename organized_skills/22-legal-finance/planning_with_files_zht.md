---
rating: ⭐⭐⭐
title: planning-with-files-zht
url: https://skills.sh/othmanadi/planning-with-files/planning-with-files-zht
---

# planning-with-files-zht

skills/othmanadi/planning-with-files/planning-with-files-zht
planning-with-files-zht
Installation
...
如果 task_plan.md 存在，立即讀取 task_plan.md、progress.md 和 findings.md。
然後檢查上一個會話是否有未同步的上下文：
# Linux/macOS
...
建立 task_plan.md — 參考 templates/task_plan.md 範本
建立 findings.md — 參考 templates/findings.md 範本
建立 progress.md — 參考 templates/progress.md 範本
決策前重新讀取計畫 — 在注意力視窗中重新整理目標
每個階段完成後更新 — 標記完成，記錄錯誤
