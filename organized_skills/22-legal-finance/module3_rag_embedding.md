---
rating: ⭐⭐
title: module3-rag-embedding
url: https://skills.sh/olorolor/fundamentals-with-ai/module3-rag-embedding
---

# module3-rag-embedding

skills/olorolor/fundamentals-with-ai/module3-rag-embedding
module3-rag-embedding
Installation
$ npx skills add https://github.com/olorolor/fundamentals-with-ai --skill module3-rag-embedding
SKILL.md
...
retrieval + grounding — "검색해서 근거를 붙여주는" RAG의 기본 흐름
chunking + embedding — 문서를 잘라서 벡터로 바꾸는 과정 (Module 2의 chunking 재등장)
vector search — 키워드 검색과 의미 기반 검색의 차이
