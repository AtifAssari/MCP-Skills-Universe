...
rating: ⭐⭐
title: ljg-rank
url: https://skills.sh/lijigang/ljg-skills/ljg-rank
---

# ljg-rank

skills/lijigang/ljg-skills/ljg-rank
ljg-rank
Installation
...
生成性——生成器能把每个现象推回来
最小性——拿掉任何一根，就有现象解释不了
独立性——每对都能找到"一个变另一个没变"的案例
预测力——能推出清单外的现象，现实中确实存在
...
写入 ~/Documents/notes/{时间戳}--{领域}的秩__rank.org
报告文件路径给用户
Weekly Installs
1.6K
Repository
