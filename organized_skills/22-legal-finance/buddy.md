...
rating: ⭐⭐⭐
title: buddy
url: https://skills.sh/rajveer-mahida/buddy-skills/buddy
---

# buddy

skills/rajveer-mahida/buddy-skills/buddy
buddy
Installation
...
Read agents/linear-reader/SKILL.md and follow its instructions
Use Linear MCP to list assigned issues
...
Continue to Step 0 below with --issue-id and --branch flags
...
Read agents/linear-watcher/SKILL.md and follow those instructions
Use Linear MCP tools to fetch and manage issues
Track seen issues in .buddy/watcher-state.json
The user invokes you repeatedly (you set reminders for next check)
...
Load state from .buddy/watcher-state.json (or create new)
Use MCP to fetch assigned issues via mcp__linear__search_issues
Filter out seen issues using the seen_issues list
Present new issues to the user based on current mode
Work on issues per user preference (single or automated mode)
Save state with updated seen_issues
Remind user when to check again (e.g., "Check again in 5 minutes")
Watcher Modes
