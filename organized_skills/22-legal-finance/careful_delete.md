---
rating: ⭐⭐⭐
title: careful-delete
url: https://skills.sh/elliotjlt/claude-skill-potions/careful-delete
---

# careful-delete

skills/elliotjlt/claude-skill-potions/careful-delete
careful-delete
Installation
...
Execute the exact command discussed (no modifications)
Capture the output
Note the timestamp
## Execution Log
