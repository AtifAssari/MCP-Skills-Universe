...
url: https://skills.sh/yyh211/claude-meta-skill/planning-with-files
---

# planning-with-files

skills/yyh211/claude-meta-skill/planning-with-files
planning-with-files
Installation
$ npx skills add https://github.com/yyh211/claude-meta-skill --skill planning-with-files
SKILL.md
Planning with Files
