...
url: https://skills.sh/richfrem/agent-plugins-skills/tool-inventory
---

# tool-inventory

skills/richfrem/agent-plugins-skills/tool-inventory
tool-inventory
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill tool-inventory
SKILL.md
Dependencies
