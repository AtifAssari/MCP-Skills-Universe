---
rating: ⭐⭐⭐
title: text-logic-diagram
url: https://skills.sh/zephyrwang6/draw-skill/text-logic-diagram
---

# text-logic-diagram

skills/zephyrwang6/draw-skill/text-logic-diagram
text-logic-diagram
Installation
...
页面布局
页眉 - 标题 + 源文本简述 + 主题切换按钮
概览卡片 - 显示检测到的关系类型和概念数量
图表区域 - 多张 SVG 图按顺序排列，每张图带标题标签
页脚 - 元数据
多图排列模板
