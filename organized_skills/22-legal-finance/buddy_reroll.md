...
rating: ⭐⭐⭐
title: buddy-reroll
url: https://skills.sh/kevintsai1202/buddy/buddy-reroll
---

# buddy-reroll

skills/kevintsai1202/buddy/buddy-reroll
buddy-reroll
Installation
$ npx skills add https://github.com/kevintsai1202/buddy --skill buddy-reroll
SKILL.md
...
步驟 3：重啟並領取
關閉 Claude Code 主程式（Terminal / Desktop App），VSCode 擴充不需關閉
正常重新開啟
輸入 /buddy 領取新寵物
可用物種
物種	中文名	Emoji
