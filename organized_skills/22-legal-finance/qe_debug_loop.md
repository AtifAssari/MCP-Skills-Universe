...
rating: ⭐⭐
title: qe-debug-loop
url: https://skills.sh/proffesor-for-testing/agentic-qe/qe-debug-loop
---

# qe-debug-loop

skills/proffesor-for-testing/agentic-qe/qe-debug-loop
qe-debug-loop
Installation
$ npx skills add https://github.com/proffesor-for-testing/agentic-qe --skill qe-debug-loop
SKILL.md
Debug Loop
...
Run a REAL command to test it (e.g., sqlite3 [db path] '.tables' then SELECT COUNT(*) FROM [table])
Record whether the hypothesis was confirmed or rejected
