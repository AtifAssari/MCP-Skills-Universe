...
url: https://skills.sh/popup-studio-ai/bkit-claude-code/phase-1-schema
---

# phase-1-schema

skills/popup-studio-ai/bkit-claude-code/phase-1-schema
phase-1-schema
Installation
$ npx skills add https://github.com/popup-studio-ai/bkit-claude-code --skill phase-1-schema
SKILL.md
