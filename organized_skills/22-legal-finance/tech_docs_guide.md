---
rating: ⭐⭐⭐⭐⭐
title: tech-docs-guide
url: https://skills.sh/chenmijiang/ai-notebook/tech-docs-guide
---

# tech-docs-guide

skills/chenmijiang/ai-notebook/tech-docs-guide
tech-docs-guide
Installation
$ npx skills add https://github.com/chenmijiang/ai-notebook --skill tech-docs-guide
SKILL.md
什么时候使用
创建新的技术指南文档
编辑现有文档使其符合写作规范
