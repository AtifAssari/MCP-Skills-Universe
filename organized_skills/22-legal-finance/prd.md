...
rating: ⭐⭐
title: prd
url: https://skills.sh/tai-ch0802/skills-bundle/prd
---

# prd

skills/tai-ch0802/skills-bundle/prd
prd
Installation
$ npx skills add https://github.com/tai-ch0802/skills-bundle --skill prd
SKILL.md
...
Drafting: Use template_comprehensive.md (full version) or template_simple.md (simple version) to draft the PRD.
Review: Have the user review the draft to confirm it meets expectations.
