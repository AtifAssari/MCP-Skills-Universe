---
rating: ⭐⭐
title: highlight-graph
url: https://skills.sh/readwiseio/readwise-skills/highlight-graph
---

# highlight-graph

skills/readwiseio/readwise-skills/highlight-graph
highlight-graph
Installation
...
Group highlights by source (book_id).
Split sources into batches of ~8 sources each.
For each batch pair (including within-batch), launch an agent with the highlight texts from those sources.
Each agent should find 5-10 genuine conceptual connections — shared themes, ideas, or language across different sources.
