...
url: https://skills.sh/vincentkoc/dotskills/technical-integrations
---

# technical-integrations

skills/vincentkoc/dotskills/technical-integrations
technical-integrations
Installation
$ npx skills add https://github.com/vincentkoc/dotskills --skill technical-integrations
SKILL.md
Technical Integrations
Purpose
...
Workflow
Classify mode: discover, design, review, or implementation-plan.
Run references/hunt-and-inventory.md to gather current integration evidence and patterns.
Use references/principles.md to enforce vendor/framework-agnostic constraints.
For architecture and proposal work, follow references/design-and-rfc.md.
For execution sequencing, follow references/implementation-plan.md.
For QA pass, apply references/review-checklist.md.
