...
rating: ⭐⭐⭐
title: deep-research
url: https://skills.sh/z0gsh1u/oh-my-writing-skill/deep-research
---

# deep-research

skills/z0gsh1u/oh-my-writing-skill/deep-research
deep-research
Installation
$ npx skills add https://github.com/z0gsh1u/oh-my-writing-skill --skill deep-research
SKILL.md
深度研究 Skill
...
Claude 内置 WebSearch：Claude 原生模型的默认搜索工具
MCP 搜索工具：自定义模型厂商提供的搜索工具，常见名称如mcp__minimax__web_search，或其他包含 search 或 web 关键词的 MCP 工具
DDGS 回退：当以上工具均不可用时，使用 ddgs Python 库
检测流程
开始搜索
    │
...
语言偏好：中文主题建议使用 zh-cn 区域设置
何时使用：仅当没有可用的联网搜索工具时自动回退
Weekly Installs
71
Repository
