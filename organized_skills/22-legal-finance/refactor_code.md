...
rating: ⭐⭐
title: refactor-code
url: https://skills.sh/zbruhnke/claude-code-starter/refactor-code
---

# refactor-code

skills/zbruhnke/claude-code-starter/refactor-code
refactor-code
Installation
$ npx skills add https://github.com/zbruhnke/claude-code-starter --skill refactor-code
SKILL.md
...
Check for recently modified files: git diff --name-only HEAD~5
If unclear, ask: "What code would you like me to refactor?"
