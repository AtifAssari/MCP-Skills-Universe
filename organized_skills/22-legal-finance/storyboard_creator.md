...
url: https://skills.sh/benzema216/dreamina-claude-skills/storyboard-creator
---

# storyboard-creator

skills/benzema216/dreamina-claude-skills/storyboard-creator
storyboard-creator
Installation
$ npx skills add https://github.com/benzema216/dreamina-claude-skills --skill storyboard-creator
SKILL.md
分镜表创作技能
...
详见 references/shot-logic.md

第三步：管理场景状态

标记场景状态变化点（如：杀人前→杀人后），确保后续分镜反映正确状态。

详见 references/scene-state.md
