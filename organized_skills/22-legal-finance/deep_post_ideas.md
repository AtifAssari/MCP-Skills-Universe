...
url: https://skills.sh/hoangvantuan/claude-plugin/deep-post-ideas
---

# deep-post-ideas

skills/hoangvantuan/claude-plugin/deep-post-ideas
deep-post-ideas
Installation
$ npx skills add https://github.com/hoangvantuan/claude-plugin --skill deep-post-ideas
SKILL.md
Deep Post Ideas
...
Develop short, practical examples
Build a narrative arc: destruction/challenge -> revelation -> transcendence
...
See references/example-phrasing.md for example phrasing styles and language techniques to apply across all outlines.
