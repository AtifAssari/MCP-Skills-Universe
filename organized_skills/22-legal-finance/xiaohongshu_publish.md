---
rating: ⭐⭐⭐
title: xiaohongshu-publish
url: https://skills.sh/dingkwang/openclaw_superskill/xiaohongshu-publish
---

# xiaohongshu-publish

skills/dingkwang/openclaw_superskill/xiaohongshu-publish
xiaohongshu-publish
Installation
...
前置条件
需要小红书cookie（存放在 ~/.openclaw/secrets/xiaohongshu.json）
需要安装 playwright 和 stealth.min.js
