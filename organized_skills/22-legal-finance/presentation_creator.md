...
url: https://skills.sh/ntaksh42/agents/presentation-creator
---

# presentation-creator

skills/ntaksh42/agents/presentation-creator
presentation-creator
Installation
$ npx skills add https://github.com/ntaksh42/agents --skill presentation-creator
SKILL.md
Presentation Creator

技術選定、方式比較、提案書作成のための構造化されたMarp資料を作成する。 課題提示、複数案の比較検討、メリット・デメリット整理を含む意思決定支援資料に特化。
