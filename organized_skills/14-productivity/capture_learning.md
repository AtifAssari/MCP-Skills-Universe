...
url: https://skills.sh/petekp/agent-skills/capture-learning
---

# capture-learning

skills/petekp/agent-skills/capture-learning
capture-learning
Installation
...
CLAUDE.md (project root or .claude/) - General learnings, setup issues
.claude/docs/troubleshooting.md - If exists, for debugging insights
.claude/docs/setup.md - If exists, for environment/build issues
Create new file only if user requests it
...
Filename - troubleshooting.md, setup.md, patterns.md
Location - .claude/docs/ for references, .claude/plans/ for planning
Content - Existing section headers indicate file's scope
