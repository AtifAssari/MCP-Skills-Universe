...
url: https://skills.sh/n8n-io/n8n/content-design
---

# content-design

skills/n8n-io/n8n/content-design
content-design
Installation
...
i18n.baseText('key') — preferred, most common
$t('key') / t('key') — Vue i18n plugin shorthand
locale.baseText('key') — legacy pattern, still present in older code
