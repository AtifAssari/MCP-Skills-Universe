---
rating: ⭐⭐⭐
title: cyrus-setup-slack
url: https://skills.sh/ceedaragents/cyrus/cyrus-setup-slack
---

# cyrus-setup-slack

skills/ceedaragents/cyrus/cyrus-setup-slack
cyrus-setup-slack
Installation
...
If claude-in-chrome MCP tools are available → use Path A-1 (claude-in-chrome)
If agent-browser is installed and a Chrome debug session is connected → use Path A-2 (agent-browser)
...
Select From a manifest in the modal
Pick the workspace
Click Next
Select JSON tab and paste the manifest from Step 3 (fully substituted with real values)
...
Bot User OAuth Token — go to your app's OAuth & Permissions page, copy the Bot User OAuth Token (starts with xoxb-), and paste it after SLACK_BOT_TOKEN=

Signing Secret — go to your app's Basic Information page, scroll to App Credentials, click Show next to Signing Secret, copy it, and paste it after SLACK_SIGNING_SECRET=
