...
url: https://skills.sh/vivy-yi/xiaohongshu-skills/publishing-timing
---

# publishing-timing

skills/vivy-yi/xiaohongshu-skills/publishing-timing
publishing-timing
Installation
$ npx skills add https://github.com/vivy-yi/xiaohongshu-skills --skill publishing-timing
SKILL.md
...
Audience Activity - When followers are online and scrolling
Competition Level - When others post (avoid saturation)
Algorithm Freshness - Early engagement signals boost reach
Content Type - Video vs图文 perform best at different times
Seasonality - Time of day, day of week, holidays
Quick Reference
