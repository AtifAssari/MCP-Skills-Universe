---
rating: ⭐⭐
title: paw-ps-template-executor
url: https://skills.sh/pawbytes/skill-suites/paw-ps-template-executor
---
...
Clarify the outcome — What specific problem does this solve? What does success look like for the customer?
Define scope — What's included, what's explicitly excluded, what's the 80% use case?
Structure the asset — Apply the appropriate capability reference for template/prompt pack/kit structure
Build for adoption — Include onboarding instructions, examples, and support materials
Quality check — Verify against ./references/asset-quality-standards.md
Package for delivery — Organize files, write instructions, create preview assets
Save artifacts — Write to product workspace artifacts/{product-slug}/
Log activity — Append to daily/YYYY-MM-DD.md
Update memory — Refine guidance in curated/product-types/ based on learnings
Path Resolution
...
Load the appropriate capability reference based on request type
Cross-reference with curated/product-types/template-products.md for product-specific guidance
Check curated/audience-intelligence.md for target user context
Apply curated/output-standards.md for quality thresholds
Escalation Routes
Signal	Routes To
