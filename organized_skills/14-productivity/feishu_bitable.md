...
url: https://skills.sh/larksuite/openclaw-lark/feishu-bitable
---

# feishu-bitable

skills/larksuite/openclaw-lark/feishu-bitable
feishu-bitable
Installation
...
先调用 feishu_bitable_app_table_field.list 获取字段的 type 和 ui_type
根据上表或 record-values.md 构造正确格式
错误码 125406X 或 1254015 → 检查字段值格式
