---
rating: ⭐⭐
title: seeding-content-creation
url: https://skills.sh/vivy-yi/xiaohongshu-skills/seeding-content-creation
---

# seeding-content-creation

skills/vivy-yi/xiaohongshu-skills/seeding-content-creation
seeding-content-creation
Installation
$ npx skills add https://github.com/vivy-yi/xiaohongshu-skills --skill seeding-content-creation
SKILL.md
...
Problem Introduction - Relatable pain point audience experiences
Solution Discovery - How you found the product (authentic journey)
Detailed Experience - Real usage, honest results (not just positives)
Value Demonstration - Before/after, specific benefits, proof
Natural Purchase Path - Product tag, subtle link, easy next step
Quick Reference
