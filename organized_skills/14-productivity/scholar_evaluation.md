...
url: https://skills.sh/kjgarza/marketplace-claude/scholar-evaluation
---

# scholar-evaluation

skills/kjgarza/marketplace-claude/scholar-evaluation
scholar-evaluation
Installation
$ npx skills add https://github.com/kjgarza/marketplace-claude --skill scholar-evaluation
SKILL.md
Scholar Evaluation
Overview
...
Load references/evaluation_framework.md for detailed criteria
