...
rating: ⭐⭐⭐
title: portless
url: https://skills.sh/vercel-labs/portless/portless
---

# portless

skills/vercel-labs/portless/portless
portless
Installation
...
portless <name> <cmd> assigns a random free port (4000-4999) via the PORT env var and registers the app with the proxy
The browser hits https://<name>.localhost; the proxy forwards to the app's assigned port
