...
url: https://skills.sh/alinaqi/claude-bootstrap/team-coordination
---

# team-coordination

skills/alinaqi/claude-bootstrap/team-coordination
team-coordination
Installation
...
Claim a Todo
Edit _project_specs/todos/active.md
Add claim annotation to todo
Update _project_specs/team/state.md
Commit and push
Release a Claim
...
Run /check-contributors
Create _project_specs/team/ structure
Initialize state.md and contributors.md
Add claim annotations to active todos
