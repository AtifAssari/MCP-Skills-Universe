...
rating: ⭐⭐⭐
title: xhs-spider
url: https://skills.sh/divxpro/xhs-spider/xhs-spider
---

# xhs-spider

skills/divxpro/xhs-spider/xhs-spider
xhs-spider
Installation
$ npx skills add https://github.com/divxpro/xhs-spider --skill xhs-spider
SKILL.md
xhs-spider
...
Name: xhs-spider Type: CLI Tool Language: TypeScript/Node.js Repository: https://github.com/DivXPro/xhs-spider
...
读取优先级
优先读取本地数据 - 当笔记已下载过时，优先从 datas/media_datas/{笔记ID}/note.yaml 读取
按需抓取最新数据 - 仅当用户明确要求（添加 --refresh、--force 或 --latest 等参数）时，才重新从网络抓取
适用场景
查看历史下载的笔记数据
避免重复请求，提高响应速度
减少对小红书服务器的压力
