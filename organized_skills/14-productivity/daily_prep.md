...
rating: ⭐⭐
title: daily-prep
url: https://skills.sh/github/awesome-copilot/daily-prep
---
...
Read open task files for tasks related to customer names or attendees in tomorrow's meetings
Search workspace folders for recent files related to those customers or topics
Check recent meeting summaries or plans for relevant prep context
Use this to generate actionable prep bullets per meeting
...
Morning Focus confirmation — Verify the morning focus window is clear. If any non-self-organized event exists there, flag it.

Learning Slots — Find gaps ≥ 30 min in the morning window and any other free slots suitable for upskilling. Target: 1.5h/day. For each slot: time range, duration, suggested activity.

Deep Work Blocks — Find continuous free gaps in the 13:00–15:30 zone for deliverables. For each block: time range, duration, suggested task from open tasks.
