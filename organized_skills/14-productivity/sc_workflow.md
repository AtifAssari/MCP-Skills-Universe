...
rating: ⭐⭐⭐
title: sc-workflow
url: https://skills.sh/tony363/superclaude/sc-workflow
---

# sc-workflow

skills/tony363/superclaude/sc-workflow
sc-workflow
Installation
$ npx skills add https://github.com/tony363/superclaude --skill sc-workflow
SKILL.md
...
Behavioral Flow
Analyze - Parse PRD and feature specifications
Plan - Generate workflow structure with dependencies
Coordinate - Activate personas for domain expertise
Execute - Create step-by-step workflows
Validate - Apply quality gates and completeness checks
Flags
