...
url: https://skills.sh/peterbamuhigire/skills-web-dev/healthcare-ui-design
---

# healthcare-ui-design

skills/peterbamuhigire/skills-web-dev/healthcare-ui-design
healthcare-ui-design
Installation
...
Mobile patterns (iOS/Android)	references/mobile-patterns.md
Tablet patterns	references/tablet-patterns.md
Desktop / clinician workstation	references/desktop-patterns.md
Color system & typography	references/color-typography.md
