...
url: https://skills.sh/vinnie357/claude-skills/anti-fabrication
---

# anti-fabrication

skills/vinnie357/claude-skills/anti-fabrication
anti-fabrication
Installation
...
Count files that need modification (using Glob)
Measure code complexity (using Read and analysis)
Assess dependencies (using Grep for imports/references)
Review similar past work (if available)
...
Identify Claims: List all factual assertions being made
Check Evidence: For each claim, determine what tool can verify it
Execute Validation: Run Read, Grep, Glob, Bash, or other tools
Report Results: State only what tools confirmed
Mark Uncertainty: Clearly label anything not verified
Examples
