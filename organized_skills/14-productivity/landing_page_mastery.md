...
url: https://skills.sh/alexdcd/mafia-claude-skills/landing-page-mastery
---

# landing-page-mastery

skills/alexdcd/mafia-claude-skills/landing-page-mastery
landing-page-mastery
Installation
$ npx skills add https://github.com/alexdcd/mafia-claude-skills --skill landing-page-mastery
SKILL.md
Landing Page Mastery
...
Titular Hero → Usa la Fórmula de Resultado Específico
Sección de Problema → Usa PAS (Problema-Agitación-Solución)
Características → Mapeo Beneficio > Característica
Testimonios → Usa el formato STAR
Texto de CTA → Usa verbos de acción personalizados
Paso 4: Diseño y Construcción

Sigue las guías de diseño de references/design.md:

Selecciona paleta de colores basada en psicología del producto
Elige tipografía (evita fuentes genéricas)
Implementa diseño responsive mobile-first
Añade micro-interacciones para engagement
Optimiza para tiempo de carga < 2 segundos
...
❌ Titulares genéricos ("Bienvenido al Futuro")
❌ Múltiples enlaces de navegación (mata 15% de conversiones)
❌ Fotos de stock de gente genérica
❌ "Enviar" como texto de CTA
❌ Formularios con >4 campos inicialmente
❌ Sin prueba social "above the fold" (parte visible sin scroll)
❌ Propuestas de valor vagas ("Hacemos las cosas mejor")
❌ Testimonios anónimos ("¡Genial! - J.")
❌ Degradados púrpuras sobre blanco (estilo "AI-slop" genérico)
❌ Falta de Sticky CTA en móvil
