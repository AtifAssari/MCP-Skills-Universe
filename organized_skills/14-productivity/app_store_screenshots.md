...
url: https://skills.sh/inference-sh/skills/app-store-screenshots
---

# app-store-screenshots

skills/inference-sh/skills/app-store-screenshots
app-store-screenshots
Originally frominfsh-skills/skills
Installation
$ npx skills add https://github.com/inference-sh/skills --skill app-store-screenshots
SKILL.md
App Store Screenshots
