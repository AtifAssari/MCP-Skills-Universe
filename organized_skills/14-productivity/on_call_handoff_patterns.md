...
skills/wshobson/agents/on-call-handoff-patterns
on-call-handoff-patterns
Installation
...
Features escalation reminders, common commands reference, and pre-handoff checklists for both outgoing and incoming on-call engineers
SKILL.md
On-Call Handoff Patterns
