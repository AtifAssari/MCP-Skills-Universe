...
url: https://skills.sh/pjt222/development-guides/build-consensus
---

# build-consensus

skills/pjt222/development-guides/build-consensus
build-consensus
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill build-consensus
SKILL.md
Build Consensus
...
Assign scouts to independently explore the option space:
...
Aggregate scout reports without filtering — all options above a minimum quality threshold enter the advocacy phase
