...
rating: ⭐⭐⭐
title: sdd:implement
url: https://skills.sh/neolabhq/context-engineering-kit/sdd:implement
---

# sdd:implement

skills/neolabhq/context-engineering-kit/sdd:implement
sdd:implement
Installation
$ npx skills add https://github.com/neolabhq/context-engineering-kit --skill sdd:implement
SKILL.md
...
Read the step's #### Verification section in the task file
Extract: Level, Artifact paths, Threshold, Rubric, Reference Pattern
