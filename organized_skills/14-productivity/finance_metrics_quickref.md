---
rating: ⭐⭐
title: finance-metrics-quickref
url: https://skills.sh/deanpeters/product-manager-skills/finance-metrics-quickref
---

# finance-metrics-quickref

skills/deanpeters/product-manager-skills/finance-metrics-quickref
finance-metrics-quickref
Installation
...
Organized for speed: scan the reference table, check red flags by category, apply the relevant framework to your decision
Designed as a cheat sheet, not a teaching tool; links to deep-dive skills for detailed calculations and examples
SKILL.md
Purpose
