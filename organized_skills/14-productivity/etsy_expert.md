...
rating: ⭐⭐
title: etsy-expert
url: https://skills.sh/mmcmedia/openclaw-agents/etsy-expert
---

# etsy-expert

skills/mmcmedia/openclaw-agents/etsy-expert
etsy-expert
Installation
...
✅ Use 8-10 images (max allowed) ✅ First image = hero shot (best mockup) ✅ Show variations (colors, sizes) ✅ Include size chart/details ✅ Consistent brand aesthetic ❌ No pixelated images ❌ No watermarks (except subtle branding) ❌ No misleading photos (physical vs digital)
...
✅ Shop name: Clear, memorable, brandable ✅ Logo/banner: Professional, cohesive ✅ Shop icon: Recognizable at small size ✅ About section: Your story, values, expertise ✅ Policies: Clear, professional ✅ FAQ section: Answer common questions
