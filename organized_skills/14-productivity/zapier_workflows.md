...
url: https://skills.sh/davila7/claude-code-templates/zapier-workflows
---

# zapier-workflows

skills/davila7/claude-code-templates/zapier-workflows
zapier-workflows
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill zapier-workflows
SKILL.md
...
Use Edit tool to add new pattern with:
Pattern name
Trigger phrases
When/why to use it
...
Check references/mcp-patterns.md has your tools
Verify skill location: ~/.claude/skills/ (global) vs ./.claude/skills/ (project)
If project-level, copy to global for cross-project persistence
...
Check if it was added to references/zaps.md
...
Copy fresh template to ~/.claude/skills/
