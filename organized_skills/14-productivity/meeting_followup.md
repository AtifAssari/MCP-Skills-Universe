...
url: https://skills.sh/casper-studios/casper-marketplace/meeting-followup
---

# meeting-followup

skills/casper-studios/casper-marketplace/meeting-followup
meeting-followup
Installation
$ npx skills add https://github.com/casper-studios/casper-marketplace --skill meeting-followup
SKILL.md
Meeting Follow-Up
...
If the search returns multiple matches, present the top 2-3 candidates with their titles and dates and ask the user which one they mean. Don't guess.
...
Use both sources. The Fireflies summary is a good starting point but often misses nuance or context that matters. The raw transcript lets you catch things the auto-summary didn't.
...
Gmail search — search for the meeting title or calendar invite to find attendee emails (e.g., subject:"Meeting Title" or search for the calendar event notification)
Ask the user — if you can't find emails for some attendees, list who you're missing and ask
