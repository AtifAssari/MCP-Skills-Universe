...
url: https://skills.sh/aaaaqwq/claude-code-skills/permission-manager
---

# permission-manager

skills/aaaaqwq/claude-code-skills/permission-manager
permission-manager
Installation
...
创建临时脚本文件 update_permissions.js
读取现有配置
添加/合并 allowedTools 数组
保存并覆盖原配置
验证修改结果
...
权限问题：确保有写入 ~/.claude.json 的权限
重启生效：修改后必须重启 Claude Code
可用工具
读取配置：Read 工具
