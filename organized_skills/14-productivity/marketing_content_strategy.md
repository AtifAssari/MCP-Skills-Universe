...
url: https://skills.sh/vasilyu1983/ai-agents-public/marketing-content-strategy
---

# marketing-content-strategy

skills/vasilyu1983/ai-agents-public/marketing-content-strategy
marketing-content-strategy
Installation
...
Clarify: product, ICP, stage, constraints, primary channel(s), and success metric.
Select module(s) via the decision tree.
Produce 1–3 concrete artifacts using the templates in assets/ (not just advice).
Add a trust + compliance pass (claims, proof, disclosures; especially for sensitive data).
Add measurement: define 1–3 leading indicators + 1–2 business outcomes.
Close with next steps: what to validate, what to publish, what to instrument.
...
Expert mental models (how to decide): references/expert-mental-models.md
Positioning: references/positioning-framework.md and assets/positioning-canvas.md
Trust-building: references/trust-building-playbook.md and assets/trust-signals-checklist.md
Brand architecture: references/brand-architecture-guide.md and assets/brand-connection-template.md
Messaging hierarchy: references/message-hierarchy.md and assets/messaging-matrix.md
Content pillars and video: references/content-pillars.md and assets/content-pillar-plan.md
Fintech/regulated messaging: references/fintech-compliance-messaging.md
Content ROI: references/content-roi-attribution.md and assets/content-roi-calculator.md
Content ops and SOPs: references/content-ops-checklist.md and assets/editorial-calendar.md
Resources & Templates
...
Related Skills
marketing-geo-localization - International marketing, regional platforms, cultural adaptation
...
marketing-seo-complete - Search visibility for content
...
startup-growth-playbooks - Content-led growth case studies (Zapier, Ahrefs, HubSpot)
Usage Notes
