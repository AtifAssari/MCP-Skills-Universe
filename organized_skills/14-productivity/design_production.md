...
url: https://skills.sh/mevans2120/design-suite-claude-skills/design-production
---

# design-production

skills/mevans2120/design-suite-claude-skills/design-production
design-production
Installation
$ npx skills add https://github.com/mevans2120/design-suite-claude-skills --skill design-production
SKILL.md
Design - Production
...
Handoff Review: Understand approved concept, technical constraints
System Setup: Establish or use design system (components, tokens)
Detailed Design: Create high-fidelity screens with all states
Specification: Document spacing, behavior, interactions, edge cases
Asset Preparation: Export icons, images, animations at correct sizes
Developer Handoff: Package everything with clear documentation
...
Each production design project should be saved in its own folder with the feature name: docs/design/{feature-name}-production-{MMDDYY}/
...
Page 3: Developer specs & annotations Naming: {feature-name}-component-name, {feature-name}-screen-name (kebab-case) Note: Link to Figma file in design specification document
High-Fidelity Prototypes

Location: docs/design/{feature-name}-production-{MMDDYY}/ File: {feature-name}-prototype.jsx or .html Format: React with full design system (or HTML/CSS) Include:
...
Location: docs/design/{feature-name}-production-{MMDDYY}/ File: {feature-name}-design-specification.md Format: Markdown with embedded images Include:
...
Location: docs/design/{feature-name}-production-{MMDDYY}/{feature-name}-animations/ File: {animation-name}.json Format: Lottie JSON Use cases: Loading indicators, success confirmations, illustrations Tools: Export from After Effects or create programmatically

Design System Documentation

Location: docs/design/{feature-name}-production-{MMDDYY}/ File: {feature-name}-design-system.md Format: Markdown with code examples Include:
...
Review concept thoroughly - Understand what was validated before detailing
Start with design system - Establish tokens and components first
Design the hard parts first - Complex interactions, edge cases
Use real content - Exposes layout issues placeholder text hides
Design all states - Default, hover, active, focus, disabled, loading, error, empty
Be pixel-precise - Use 4px/8px grid, align everything
Test responsiveness - Check all breakpoints, don't assume
Document your thinking - Explain non-obvious decisions for developers
Organize files clearly - Developers should find what they need easily
Include accessibility specs - Keyboard nav, screen readers, contrast
Handoff Checklist
