---
rating: ⭐⭐
title: content-platform-analyzer
url: https://skills.sh/linyuan3421/content-analysis-skill/content-platform-analyzer
---

# content-platform-analyzer

skills/linyuan3421/content-analysis-skill/content-platform-analyzer
content-platform-analyzer
Installation
$ npx skills add https://github.com/linyuan3421/content-analysis-skill --skill content-platform-analyzer
SKILL.md
内容平台分析技能
...
内容基础：发布频率、内容长度、发布节奏
爆款模式：Top 10-20内容为什么火？标题、结构、手法
主题分析：高频主题、主题组合、内容领域
内容类型：教程型、观点型、故事型、种子型
写作/表达手法：案例驱动、数据支撑、情绪调动、结构框架
...
相关性验证：验证内容模式与数据表现的关系
示例：数字型标题是否真的阅读量更高？
时间趋势：识别阅读量的时间模式和成长轨迹
分位数分析：对比Top 20% vs Bottom 20%的内容特征差异
标签效果：哪些主题/标签更容易出爆款
...
内容深度：完整性、独特性、实用性
写作技巧：标题技巧、内容结构、情绪调动
数据表现：平均阅读量、爆款率、内容长度、发布频率
优势劣势：自己的独特优势 vs 明显短板
...
自己账号概况（10-15行）
内容基础诊断（20-30行）：发布节奏、内容特征
内容质量评估（40-60行）：标题质量、内容结构、写作手法、内容价值
数据表现分析（30-40行）：整体表现、爆款分析、低表现分析
主题与内容类型（20-30行）
优势与问题总结（20-25行）：核心优势、核心问题、快速改进点
Module 3: 差距分析与增长建议（200-250行，约35%）
数据表现对比（20-30行）：核心指标差距、数据结论
内容质量对比（40-60行）：内容深度、写作技巧对比
优势与劣势识别（30-40行）：核心优势、劣势、差异化定位
可学习的写作模板（40-60行）⭐核心
基于对标账号提取2-3个可复用的内容模板
每个模板：结构框架+写作要点+适用场景
标题优化建议（15-20行）：3-5个标题公式
内容结构优化建议（15-20行）：推荐的内容框架
可执行的内容策略（30-40行）：
