...
rating: ⭐⭐⭐
title: maths
url: https://skills.sh/udnisap/skills/maths
---

# maths

skills/udnisap/skills/maths
maths
Installation
$ npx skills add https://github.com/udnisap/skills --skill maths
SKILL.md
Maths
...
Import only the submodule you need (e.g. scipy.optimize, sympy.solvers).
Prefer library functions over custom loops (vectorize with NumPy; use scipy.integrate, sympy.integrate, etc.).
