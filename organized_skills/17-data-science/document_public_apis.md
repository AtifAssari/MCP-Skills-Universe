...
url: https://skills.sh/pytorch/pytorch/document-public-apis
---

# document-public-apis

skills/pytorch/pytorch/document-public-apis
document-public-apis
Installation
...
Where to add them in the docs (e.g., # torch.ao.quantization.fx.convert → the functions go under torch.ao.quantization.fx.convert in the doc file)
Instructions
