---
rating: ⭐⭐⭐
title: build-evaluator
url: https://skills.sh/orq-ai/assistant-plugins/build-evaluator
---

# build-evaluator

skills/orq-ai/assistant-plugins/build-evaluator
build-evaluator
Installation
$ npx skills add https://github.com/orq-ai/assistant-plugins --skill build-evaluator
SKILL.md
Build Evaluator
...
orq MCP tools — query live data first (create_llm_eval, create_python_eval); API responses are always authoritative
