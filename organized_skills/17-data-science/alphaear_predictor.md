---
rating: ⭐⭐
title: alphaear-predictor
url: https://skills.sh/rkiding/awesome-finance-skills/alphaear-predictor
---

# alphaear-predictor

skills/rkiding/awesome-finance-skills/alphaear-predictor
alphaear-predictor
Installation
...
Generate Base Forecast: Use scripts/kronos_predictor.py (via KronosPredictorUtility) to generate the technical/quantitative forecast.
Adjust Forecast (Agentic): Use the Forecast Adjustment Prompt in references/PROMPTS.md to subjectively adjust the numbers based on latest news/logic.
