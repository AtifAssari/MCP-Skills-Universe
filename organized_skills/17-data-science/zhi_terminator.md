---
rating: ⭐⭐
title: zhi-terminator
url: https://skills.sh/jung217/zhi-terminator/zhi-terminator
---

# zhi-terminator

skills/jung217/zhi-terminator/zhi-terminator
zhi-terminator
Installation
...
強制替換：在 README、註解、Commit Message 及 UI 字串中，必須無條件終結左欄詞彙。
語境相容性：
Windows 環境：優先使用「設定檔、擴充功能、建置、資料夾」。
macOS 環境：優先使用「描述檔、延伸功能、建構、檔案夾」。
字體修正：嚴格執行將所有「台」正名為「臺」。
專有名詞保護：如 Transformer 或程式碼 API（如 process.env）等不可隨意翻譯。

TERMINATION REPORT:

Input: "激活軟體後，優化算法內存，設置默認智能設備接口。"
Corrected: "啟用軟體後，最佳化演算法記憶體，設定預設智慧裝置介面。"
Weekly Installs
9
Repository
jung217/zhi-terminator
First Seen
Jan 27, 2026
Security Audits
