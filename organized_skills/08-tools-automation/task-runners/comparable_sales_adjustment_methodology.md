---
rating: ⭐⭐
title: comparable-sales-adjustment-methodology
url: https://skills.sh/reggiechan74/vp-real-estate/comparable-sales-adjustment-methodology
---

# comparable-sales-adjustment-methodology

skills/reggiechan74/vp-real-estate/comparable-sales-adjustment-methodology
comparable-sales-adjustment-methodology
Installation
...
Gather property data: Subject property characteristics, comparable sales, market parameters
Create JSON input file: Use sample templates as starting point
Run calculator: Execute with appropriate input file
Analyze results: Review adjustment grid, validation flags, reconciled value
Document findings: Explain adjustment methodology and value conclusion
Output Format
...
Apply conservative adjustments (when uncertain, adjust less rather than more)
Sensitivity test (vary adjustment, assess impact on conclusion)
Seek market participant input (interviews with brokers, developers, buyers)
...
Identify key adjustments (largest adjustments or most uncertain)
Vary adjustment by ±20-50%
Re-calculate adjusted sale prices
Assess impact on reconciled value
