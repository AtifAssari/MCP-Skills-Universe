...
url: https://skills.sh/akin-ozer/cc-devops-skills/makefile-generator
---

# makefile-generator

skills/akin-ozer/cc-devops-skills/makefile-generator
makefile-generator
Installation
...
Preferred path: run devops-skills:makefile-validator.
If validator skill is unavailable: run local fallback checks:
...
If make is unavailable: run structural checks only, report "partial validation due to missing make binary", and request user confirmation before claiming production readiness.
...
Parallel Safety for Docker targets:
