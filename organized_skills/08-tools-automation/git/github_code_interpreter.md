---
rating: ⭐⭐
title: github-code-interpreter
url: https://skills.sh/chujianyun/skills/github-code-interpreter
---

# github-code-interpreter

skills/chujianyun/skills/github-code-interpreter
github-code-interpreter
Installation
$ npx skills add https://github.com/chujianyun/skills --skill github-code-interpreter
SKILL.md
GitHub 源码解读助手
设计模式
...
用户明确指定的目录
当前上下文里已存在且明显合适的 ~/Documents/working 子目录
默认使用 ~/Documents/working/github-analysis/<repo_name>
