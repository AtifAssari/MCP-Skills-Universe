...
rating: ⭐⭐⭐
title: cicd-expert
url: https://skills.sh/martinholovsky/claude-skills-generator/cicd-expert
---

# cicd-expert

skills/martinholovsky/claude-skills-generator/cicd-expert
cicd-expert
Installation
...
Deployment automation patterns including blue/green, canary, rolling updates, and ArgoCD GitOps with automated rollback on failure
Comprehensive security hardening: OIDC authentication, least-privilege permissions, environment protection rules, and OWASP CI/CD risk mitigation
SKILL.md
...
See references/pipeline-examples.md
...
See references/security-gates.md
...
See references/security-gates.md#owasp-cicd-security
