---
rating: ⭐⭐⭐
title: chinese-git-workflow
url: https://skills.sh/jnmetacode/superpowers-zh/chinese-git-workflow
---

# chinese-git-workflow

skills/jnmetacode/superpowers-zh/chinese-git-workflow
chinese-git-workflow
Installation
...
前缀明确分支类型：feat/、fix/、hotfix/、release/
关联任务管理平台的编号（如有）：feat/TAPD-12345-description
长度适中，能看出分支目的即可
