...
url: https://skills.sh/sanyuan0704/sanyuan-skills/code-review-expert
---

# code-review-expert

skills/sanyuan0704/sanyuan-skills/code-review-expert
code-review-expert
Originally fromsanyuan0704/code-review-expert
Installation
...
Flags code quality issues: error handling gaps, N+1 queries, boundary condition bugs, and silent failure risks
Review-first workflow; no changes implemented until user explicitly confirms which findings to address
SKILL.md
Code Review Expert
Overview
