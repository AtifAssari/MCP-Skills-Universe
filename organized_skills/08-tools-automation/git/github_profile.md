...
url: https://skills.sh/jdevalk/skills/github-profile
---

# github-profile

skills/jdevalk/skills/github-profile
github-profile
Installation
...
Workflow
Gather profile context — Understand who this person/org is and what they want to showcase
Audit the current profile — Score every element of the profile's public presence
Generate the profile README — Write a polished, scannable README.md
Recommend metadata and configuration — Advise on bio, pinned repos, settings, and widgets
Verify — Confirm rendering, badge URLs, and summarize next steps
...
metadata-check skill — run on the GitHub bio (160 chars) and any pinned repo descriptions you rewrote. Front-loading, concreteness, active voice, truncation fit (GitHub shows ~100 chars in profile cards).
readability-check skill — run on the profile README body. Profile READMEs are skimmed; one passive or long sentence stands out.
