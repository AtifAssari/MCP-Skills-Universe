---
rating: ⭐⭐⭐⭐⭐
title: github-skill-forge
url: https://skills.sh/yujunzhixue/github-skill-forge/github-skill-forge
---

# github-skill-forge

skills/yujunzhixue/github-skill-forge/github-skill-forge
github-skill-forge
Installation
...
运行锻造脚本
读取 context_bundle.md 了解 seaborn 的 API
识别依赖项（numpy, pandas, matplotlib）
编写简化的使用脚本到 scripts/ 目录
更新 SKILL.md 添加使用示例
示例 4：CLI 工具安装
...
症状： 生成的 context_bundle.md 超过预期大小
