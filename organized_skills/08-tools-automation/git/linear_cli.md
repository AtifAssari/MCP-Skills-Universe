...
rating: ⭐⭐⭐
title: linear-cli
url: https://skills.sh/schpet/linear-cli/linear-cli
---

# linear-cli

skills/schpet/linear-cli/linear-cli
linear-cli
Installation
...
Requires the linear CLI tool to be installed and available on PATH; authentication managed through linear auth
SKILL.md
Linear CLI
