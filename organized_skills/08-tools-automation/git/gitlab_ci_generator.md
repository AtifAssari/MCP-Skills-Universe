...
url: https://skills.sh/akin-ozer/cc-devops-skills/gitlab-ci-generator
---

# gitlab-ci-generator

skills/akin-ozer/cc-devops-skills/gitlab-ci-generator
gitlab-ci-generator
Installation
...
references/best-practices.md - baseline security, performance, naming
references/common-patterns.md - starting pattern selection
Matching template from assets/templates/:
...
references/gitlab-ci-reference.md - keyword/syntax edge cases
references/security-guidelines.md - security-sensitive controls
...
Use assets/templates/basic-pipeline.yml as structural foundation
Reference references/best-practices.md for implementation patterns
Reference references/common-patterns.md for standard pipeline patterns
...
Use assets/templates/docker-build.yml as foundation
Implement Docker-in-Docker or Kaniko for builds
...
Use assets/templates/kubernetes-deploy.yml as foundation
Configure cluster authentication (service accounts, kubeconfig)
...
Use assets/templates/multi-project.yml or parent-child templates
Configure proper artifact passing
...
Organize into separate files with include
ALWAYS validate using devops-skills:gitlab-ci-validator skill
...
Try Context7 first: mcp__context7__resolve-library-id -> mcp__context7__query-docs
If needed, run web.search_query scoped to docs.gitlab.com
Open specific pages with web.open and extract only required syntax/variables
...
Generated Pipeline (the .gitlab-ci.yml content)
...
Lookup Docs When Needed - Context7 first, then web.search_query/web.open, with offline fallback notes when constrained.
Validate - Use devops-skills:gitlab-ci-validator, script fallback if needed.
