---
rating: ⭐⭐⭐
title: aile-git-worktrees
url: https://skills.sh/zhucl1006/ailesuperpowers/aile-git-worktrees
---

# aile-git-worktrees

skills/zhucl1006/ailesuperpowers/aile-git-worktrees
aile-git-worktrees
Installation
$ npx skills add https://github.com/zhucl1006/ailesuperpowers --skill aile-git-worktrees
SKILL.md
使用 Git 工作樹
概述
...
如果找到： 使用該目錄。如果兩者都存在，.worktrees獲勝。
...
**修復：**始終使用git check-ignore在建立專案本機工作樹之前
假設目錄位置
問題： 造成不一致，違反專案約定
