...
url: https://skills.sh/neolabhq/context-engineering-kit/git:create-worktree
---

# git:create-worktree

skills/neolabhq/context-engineering-kit/git:create-worktree
git:create-worktree
Installation
...
Auto-detect branch type from name: Check if the first word is a known branch type. If yes, use it as the prefix and the rest as the name. If no, default to feature/.
