...
url: https://skills.sh/openshift/hypershift/git-commit-format
---

# git commit format

skills/openshift/hypershift/Git Commit Format
Git Commit Format
Installation
$ npx skills add https://github.com/openshift/hypershift --skill 'Git Commit Format'
SKILL.md
...
Environment variables: $GIT_AUTHOR_NAME and $GIT_AUTHOR_EMAIL
Git config: git config user.name and git config user.email
If neither configured, ask user to provide details
