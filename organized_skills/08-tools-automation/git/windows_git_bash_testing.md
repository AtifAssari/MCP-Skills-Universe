---
rating: ⭐⭐⭐
title: windows-git-bash-testing
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/windows-git-bash-testing
---

# windows-git-bash-testing

skills/josiahsiegel/claude-plugin-marketplace/windows-git-bash-testing
windows-git-bash-testing
Installation
