---
rating: ⭐⭐⭐
title: git:compare-worktrees
url: https://skills.sh/neolabhq/context-engineering-kit/git:compare-worktrees
---

# git:compare-worktrees

skills/neolabhq/context-engineering-kit/git:compare-worktrees
git:compare-worktrees
Installation
