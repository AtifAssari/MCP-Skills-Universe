...
rating: ⭐⭐⭐
title: git-workflow
url: https://skills.sh/kambleakash0/agent-skills/git-workflow
---

# git-workflow

skills/kambleakash0/agent-skills/git-workflow
git-workflow
Installation
$ npx skills add https://github.com/kambleakash0/agent-skills --skill git-workflow
SKILL.md
Git Workflow Skill
...
Confirm the base branch (usually main or develop).
Pull the latest changes: git pull origin <base>.
Create a descriptive branch name following the pattern <type>/<short-description>:
feat/add-login-page
...
For each file, show the conflict markers and explain both sides.
Suggest the correct resolution based on the intent of each change.
After resolving, stage the file: git add <file>.
Continue the rebase or merge: git rebase --continue / git merge --continue.
