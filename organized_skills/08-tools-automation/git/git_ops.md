...
rating: ⭐⭐
title: git-ops
url: https://skills.sh/nickcrew/claude-ctx-plugin/git-ops
---

# git-ops

skills/nickcrew/claude-ctx-plugin/git-ops
git-ops
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill git-ops
SKILL.md
Git Ops
Overview
