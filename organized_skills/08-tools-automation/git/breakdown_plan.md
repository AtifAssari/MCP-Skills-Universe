...
url: https://skills.sh/github/awesome-copilot/breakdown-plan
---

# breakdown-plan

skills/github/awesome-copilot/breakdown-plan
breakdown-plan
Installation
...
Includes priority and value matrix (P0–P3), Fibonacci story point estimation, and t-shirt sizing for capacity planning and sprint allocation
Offers Kanban board configuration, automated issue creation via GitHub Actions, and status update workflows for continuous project tracking
Requires complete feature artifacts (PRD, UX design, technical breakdown, testing plan) as input to generate the project plan and issues checklist
SKILL.md
