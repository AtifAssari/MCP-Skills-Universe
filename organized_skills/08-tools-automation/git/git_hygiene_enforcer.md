...
url: https://skills.sh/monkey1sai/openai-cli/git-hygiene-enforcer
---

# git-hygiene-enforcer

skills/monkey1sai/openai-cli/git-hygiene-enforcer
git-hygiene-enforcer
Installation
$ npx skills add https://github.com/monkey1sai/openai-cli --skill git-hygiene-enforcer
SKILL.md
Git Hygiene Enforcer
