...
url: https://skills.sh/mindrally/skills/turbopack-bundler
---

# turbopack-bundler

skills/mindrally/skills/turbopack-bundler
turbopack-bundler
Installation
...
Common Issues
Slow initial build: Normal, subsequent builds are fast
Module not found: Check path aliases in tsconfig.json
CSS not loading: Ensure proper import syntax
