---
rating: ⭐⭐⭐
title: cli-anything-blender
url: https://skills.sh/hkuds/cli-anything/cli-anything-blender
---

# cli-anything-blender

skills/hkuds/cli-anything/cli-anything-blender
cli-anything-blender
Installation
...
Use preview capture or preview live ... for visual verification instead of inferring scene quality from JSON alone
Read returned artifact paths such as hero.png and workbench.png; the JSON payload references files, it does not inline image bytes
Treat _bundle_dir as one snapshot only; for stable live history, use _session_dir plus _trajectory_path
Use cli-hub previews ... only to inspect/open existing previews; preview generation itself always happens through cli-anything-blender preview ...
More Information
