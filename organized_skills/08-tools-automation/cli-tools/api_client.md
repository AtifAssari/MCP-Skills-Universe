...
rating: ⭐⭐⭐
title: api-client
url: https://skills.sh/profpowell/vanilla-breeze/api-client
---

# api-client

skills/profpowell/vanilla-breeze/api-client
api-client
Installation
$ npx skills add https://github.com/profpowell/vanilla-breeze --skill api-client
SKILL.md
API Client Skill
