...
rating: ⭐⭐⭐
title: silent-cli
url: https://skills.sh/viktor-ferenczi/skills/silent-cli
---

# silent-cli

skills/viktor-ferenczi/skills/silent-cli
silent-cli
Installation
$ npx skills add https://github.com/viktor-ferenczi/skills --skill silent-cli
SKILL.md
