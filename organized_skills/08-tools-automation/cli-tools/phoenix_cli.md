...
rating: ⭐⭐⭐
title: phoenix-cli
url: https://skills.sh/github/awesome-copilot/phoenix-cli
---

# phoenix-cli

skills/github/awesome-copilot/phoenix-cli
phoenix-cli
Installation
$ npx skills add https://github.com/github/awesome-copilot --skill phoenix-cli
SKILL.md
Phoenix CLI
Invocation
