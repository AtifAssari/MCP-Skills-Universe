...
url: https://skills.sh/hkuds/cli-anything/cli-anything-obsidian
---

# cli-anything-obsidian

skills/hkuds/cli-anything/cli-anything-obsidian
cli-anything-obsidian
Installation
...
Set OBSIDIAN_API_KEY environment variable to avoid passing --api-key on every call
Verify Obsidian is running with server status before other commands
More Information
