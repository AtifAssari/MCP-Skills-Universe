---
rating: ⭐⭐
title: nextjs-server-client-components
url: https://skills.sh/wsimmonds/claude-nextjs-skills/nextjs-server-client-components
---

# nextjs-server-client-components

skills/wsimmonds/claude-nextjs-skills/nextjs-server-client-components
nextjs-server-client-components
Installation
