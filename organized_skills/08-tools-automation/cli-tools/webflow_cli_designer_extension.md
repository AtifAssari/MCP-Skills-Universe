---
rating: ⭐⭐⭐
title: webflow-cli:designer-extension
url: https://skills.sh/webflow/webflow-skills/webflow-cli:designer-extension
---

# webflow-cli:designer-extension

skills/webflow/webflow-skills/webflow-cli:designer-extension
webflow-cli:designer-extension
Installation
...
Check project state: Check if already in an extension project (look for webflow.json with extension schema)
...
List templates (if user asks or before init): Run webflow extension list
...
Run init command: Execute webflow extension init <project-name> <template>
Read generated schema: Use Read tool to examine webflow.json
...
Install dependencies: Run npm install in project directory
Phase 4: Local Development
Start dev server: Execute webflow extension serve [port]
Show dev server info:
...
Run bundle command: Execute webflow extension bundle
Show bundle output: Display bundle.zip location and size
