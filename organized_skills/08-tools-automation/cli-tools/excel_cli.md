...
rating: ⭐⭐⭐
title: excel-cli
url: https://skills.sh/sbroenne/mcp-server-excel/excel-cli
---

# excel-cli

skills/sbroenne/mcp-server-excel/excel-cli
excel-cli
Installation
...
CLI command reference and common pitfalls
Weekly Installs
612
Repository
sbroenne/mcp-se…er-excel
GitHub Stars
147
First Seen
Today
