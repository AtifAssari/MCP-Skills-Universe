...
rating: ⭐⭐⭐
title: cli-sentry
url: https://skills.sh/paulrberg/agent-skills/cli-sentry
---

# cli-sentry

skills/paulrberg/agent-skills/cli-sentry
cli-sentry
Installation
...
Inspect - For each issue, fetch its latest event to examine the stack trace:
