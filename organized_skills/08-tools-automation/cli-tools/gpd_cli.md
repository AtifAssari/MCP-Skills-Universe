...
rating: ⭐⭐
title: gpd-cli
url: https://skills.sh/rudrankriyam/app-store-connect-cli-skills/gpd-cli
---

# gpd-cli

skills/rudrankriyam/app-store-connect-cli-skills/gpd-cli
gpd-cli
Installation
...
Check exit codes: 0=success, 2=auth failure, 3=permission denied, 4=validation error, 5=rate limited, 6=network error, 7=not found, 8=conflict
Use edit lifecycle for complex multi-step publishing with --edit-id and --no-auto-commit
Common Workflows
