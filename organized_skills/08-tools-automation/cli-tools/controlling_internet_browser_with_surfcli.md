---
rating: ⭐⭐⭐
title: controlling-internet-browser-with-surfcli
url: https://skills.sh/zenobi-us/dotfiles/controlling-internet-browser-with-surfcli
---

# controlling-internet-browser-with-surfcli

skills/zenobi-us/dotfiles/controlling-internet-browser-with-surfcli
controlling-internet-browser-with-surfcli
Installation
$ npx skills add https://github.com/zenobi-us/dotfiles --skill controlling-internet-browser-with-surfcli
SKILL.md
...
Window isolation - Use window.new + --window-id to keep agent work separate from your browsing
