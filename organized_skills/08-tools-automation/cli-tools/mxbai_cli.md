...
rating: ⭐⭐⭐
title: mxbai-cli
url: https://skills.sh/mixedbread-ai/skills/mxbai-cli
---

# mxbai-cli

skills/mixedbread-ai/skills/mxbai-cli
mxbai-cli
Installation
...
Flag: --api-key mxb_xxxxx or --saved-key <name>
Environment variable: export MXBAI_API_KEY=mxb_xxxxx
Config file: mxbai config set api_key mxb_xxxxx
