---
rating: ⭐⭐
title: ln-821-npm-upgrader
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-821-npm-upgrader
---

# ln-821-npm-upgrader

skills/levnikolaevich/claude-code-skills/ln-821-npm-upgrader
ln-821-npm-upgrader
Installation
$ npx skills add https://github.com/levnikolaevich/claude-code-skills --skill ln-821-npm-upgrader
SKILL.md
...
Rollback: Restore package.json and the lock file, then run a clean install to restore the previous state.
