---
rating: ⭐⭐⭐
title: canghe-image-gen
url: https://skills.sh/freestylefly/canghe-skills/canghe-image-gen
---

# canghe-image-gen

skills/freestylefly/canghe-skills/canghe-image-gen
canghe-image-gen
Installation
...
Provider Selection
--ref provided + no --provider → auto-select Google first, then OpenAI, then Canghe
--provider specified → use it (if --ref, must be google or openai or canghe)
