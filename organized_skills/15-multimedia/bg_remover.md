...
rating: ⭐⭐⭐
title: bg-remover
url: https://skills.sh/wyq09/bg-remover/bg-remover
---

# bg-remover

skills/wyq09/bg-remover/bg-remover
bg-remover
Installation
$ npx skills add https://github.com/wyq09/bg-remover --skill bg-remover
SKILL.md
图片背景移除 Skill
环境要求与自动修复
环境要求
...
内存不足：使用轻量级模型 u2netp 或缩小图片尺寸
处理速度慢：使用 GPU 版本或轻量级模型
