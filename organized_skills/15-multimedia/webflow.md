...
rating: ⭐⭐
title: webflow
url: https://skills.sh/vm0-ai/vm0-skills/webflow
---

# webflow

skills/vm0-ai/vm0-skills/webflow
webflow
Installation
$ npx skills add https://github.com/vm0-ai/vm0-skills --skill webflow
SKILL.md
Troubleshooting
...
Guidelines
Start with /v2/token/authorized_by: Always verify auth first before calling other endpoints
Get site ID first: Most operations require a site ID — call List Sites first
CMS workflow: List collections -> get collection schema -> CRUD items -> publish items
Staged vs Live items: By default, item endpoints work with staged (draft) items. Use /items/live path for published items
Pagination: List endpoints support offset and limit query parameters (default limit is 100)
Rate limits: 60 requests per minute; back off on 429 responses
Field data: When creating/updating items, field values go inside the fieldData object, keyed by field slug
Weekly Installs
20
Repository
vm0-ai/vm0-skills
