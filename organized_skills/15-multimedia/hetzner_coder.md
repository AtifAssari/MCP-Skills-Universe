...
rating: ⭐⭐⭐
title: hetzner-coder
url: https://skills.sh/majesticlabs-dev/majestic-marketplace/hetzner-coder
---

# hetzner-coder

skills/majesticlabs-dev/majestic-marketplace/hetzner-coder
hetzner-coder
Installation
$ npx skills add https://github.com/majesticlabs-dev/majestic-marketplace --skill hetzner-coder
SKILL.md
Provider Setup
terraform {
  required_providers {
...
See references/hetzner-server-types.md for all server types (CX, CPX, CAX, CCX).
...
References
references/hetzner-server-types.md - All server types with specs
references/ansible-integration.md - Hetzner+Ansible patterns, Kamal-ready playbooks
references/best-practices.md - Labels, cost optimization, placement groups, snapshots
references/object-storage.md - S3-compatible Object Storage with AWS provider
references/production-stack.md - Complete production setup
references/storage-box.md - CIFS-mounted backup storage for Litestream and docker-volume-backup
Weekly Installs
39
Repository
