---
rating: ⭐⭐⭐
title: ai-interview-article
url: https://skills.sh/kimny1143/claude-code-template/ai-interview-article
---

# ai-interview-article

skills/kimny1143/claude-code-template/ai-interview-article
ai-interview-article
Installation
$ npx skills add https://github.com/kimny1143/claude-code-template --skill ai-interview-article
SKILL.md
...
基底プロンプトをGeminiのスレッドに最初に送る（スタイル固定）
続けて Subject: 以降に具体的な画像内容を記述する
1記事につき見出し画像1枚 + 本文中の図解0〜3枚が目安
...
複数記事を同日に公開する → エンゲージメントが分散して全記事が沈む。同日複数本厳禁（有料記事は週1本ルールも適用）
