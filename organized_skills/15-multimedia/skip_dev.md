...
rating: ⭐⭐⭐
title: skip-dev
url: https://skills.sh/bphvz/skip-skills/skip-dev
---

# skip-dev

skills/bphvz/skip-skills/skip-dev
skip-dev
Installation
...
Android Studio — open the generated Gradle project:
...
View generated Kotlin code — invaluable for debugging transpilation issues:
...
Crash traces — demangle Swift symbols:
...
Trigger a build (xcodebuild, Xcode Run, or skip test) and capture the first Kotlin error.
Open the generated Kotlin file and line from the compiler output (SkipStone/plugins for apps, SkipLink for frameworks).
Identify the original Swift declaration that produced that Kotlin block.
