---
rating: ⭐⭐⭐
title: ai-vibe-slides
url: https://skills.sh/unclecatvn/agent-skills/ai-vibe-slides
---

# ai-vibe-slides

skills/unclecatvn/agent-skills/ai-vibe-slides
ai-vibe-slides
Installation
$ npx skills add https://github.com/unclecatvn/agent-skills --skill ai-vibe-slides
SKILL.md
...
16:9 aspect ratio: Always use width: 100vw; height: 100vh — each slide fills the entire screen
...
No placeholder images: Never use <img src="placeholder">. Replace with CSS shapes, gradients, icons (emoji or Lucide for React), or inline SVGs
...
Print-ready: Include @media print rules so each slide becomes one printed page
