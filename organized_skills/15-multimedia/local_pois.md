...
rating: ⭐⭐⭐
title: local-pois
url: https://skills.sh/brave/brave-search-skills/local-pois
---

# local-pois

skills/brave/brave-search-skills/local-pois
local-pois
Installation
...
Call web-search with result_filter=locations to get POI IDs from locations.results[].id
