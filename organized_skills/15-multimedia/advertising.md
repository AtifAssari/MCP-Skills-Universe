...
rating: ⭐⭐⭐
title: advertising
url: https://skills.sh/vivy-yi/xiaohongshu-skills/advertising
---

# advertising

skills/vivy-yi/xiaohongshu-skills/advertising
advertising
Installation
$ npx skills add https://github.com/vivy-yi/xiaohongshu-skills --skill advertising
SKILL.md
Advertising (广告投放)
Overview
...
Feed Ads - Promoted posts in discovery feed
Search Ads - Appear when searching keywords
Banner Ads - Top/Bottom of screen
Story Ads - Full-screen vertical video
Product Carousel - Multiple product showcase
Quick Reference
