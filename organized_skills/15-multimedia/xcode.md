...
rating: ⭐⭐⭐
title: xcode
url: https://skills.sh/bjesuiter/skills/xcode
---

# xcode

skills/bjesuiter/skills/xcode
xcode
Installation
...
Check doctor for environment issues - Run doctor if tools aren't working
Use preferXcodebuild=true if incremental builds fail - Falls back to standard xcodebuild
Weekly Installs
27
Repository
bjesuiter/skills
