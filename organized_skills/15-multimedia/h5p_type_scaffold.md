---
rating: ⭐⭐
title: h5p-type-scaffold
url: https://skills.sh/chandima/agent-skills/h5p-type-scaffold
---

# h5p-type-scaffold

skills/chandima/agent-skills/h5p-type-scaffold
h5p-type-scaffold
Installation
...
How It Works
Choose package intent: library-install (default) or content-import (advanced).
...
Provide starter library.json, semantics.json, and JS/CSS entrypoints.
Outline build and packaging steps using h5p-cli.
Concepts
