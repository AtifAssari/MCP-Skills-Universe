...
url: https://skills.sh/orchestra-research/ai-research-skills/ml-paper-writing
---

# ml-paper-writing

skills/orchestra-research/ai-research-skills/ml-paper-writing
ml-paper-writing
Originally fromzechenzhangagi/ai-research-skills
Installation
$ npx skills add https://github.com/orchestra-research/ai-research-skills --skill ml-paper-writing
SKILL.md
...
Systems Conferences (OSDI, NSDI, ASPLOS, SOSP): See the systems-paper-writing skill for page limits, templates, deadlines, and submission rules.
...
Systems Conference Templates (OSDI, NSDI, ASPLOS, SOSP): See the systems-paper-writing skill.
...
ML → Systems Conversion: When converting to OSDI, NSDI, ASPLOS, or SOSP, see the systems-paper-writing skill for format conversion guidance, templates, and structural differences.
...
Systems Venues (OSDI, NSDI, ASPLOS, SOSP): See the systems-paper-writing skill for venue-specific requirements, checklists, and reviewer guidelines.
