...
url: https://skills.sh/dkyazzentwatwa/chatgpt-skills/background-remover
---

# background-remover

skills/dkyazzentwatwa/chatgpt-skills/background-remover
background-remover
Installation
...
White/Solid Backgrounds: Use remove_color() method
Complex Backgrounds: Use grabcut() method
High Contrast Subjects: Edge detection works well
