---
rating: ⭐⭐
title: liveavatar-debug
url: https://skills.sh/heygen-com/liveavatar-agent-skills/liveavatar-debug
---

# liveavatar-debug

skills/heygen-com/liveavatar-agent-skills/liveavatar-debug
liveavatar-debug
Installation
...
Check session state: GET /v1/sessions/{id}
Check transcript: GET /v1/sessions/{id}/transcript
Check credits: GET /v1/users/credits
Verify you're not mixing FULL and LITE event systems
Weekly Installs
133
Repository
