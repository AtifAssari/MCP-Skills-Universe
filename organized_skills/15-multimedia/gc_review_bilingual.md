---
rating: ⭐⭐⭐
title: gc-review-bilingual
url: https://skills.sh/dougkeefe/gc-code-skills/gc-review-bilingual
---

# gc-review-bilingual

skills/dougkeefe/gc-code-skills/gc-review-bilingual
gc-review-bilingual
Installation
...
Text content between HTML/JSX tags — e.g., <h1>Welcome</h1>, <p>Submit your application</p>
Translatable attributes — placeholder, label, title, aria-label, alt, aria-placeholder with literal string values
JSX expressions with literal strings — e.g., {condition && "Show this text"}
Template literals with user-visible text — e.g., `Hello ${name}`
String assignments rendered in UI — e.g., const label = "Submit" where label is rendered
