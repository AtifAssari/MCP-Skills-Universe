...
rating: ⭐⭐⭐
title: clone-page
url: https://skills.sh/lintendo/axhub-skills/clone-page
---

# clone-page

skills/lintendo/axhub-skills/clone-page
clone-page
Installation
...
看 screenshot.png，理解页面整体布局
读 theme.json，提取关键设计令牌（主色、字体、间距、圆角、阴影）
粗读 skeleton.json --depth=2，了解大的 section 划分
按 header → main → footer 的顺序，参照截图逐 section 写 HTML/CSS
...
如果需要 hover/focus 态，使用 interact 命令采集
使用 assets/ 目录中的图片和字体
采集命令速查
命令	用途	产出
