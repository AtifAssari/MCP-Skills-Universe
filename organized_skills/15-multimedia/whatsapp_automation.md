...
url: https://skills.sh/aaaaqwq/claude-code-skills/whatsapp-automation
---

# whatsapp-automation

skills/aaaaqwq/claude-code-skills/whatsapp-automation
whatsapp-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill whatsapp-automation
SKILL.md
...
WHATSAPP_SEND_MEDIA_BY_ID - Send media using the uploaded media ID [Required] OR
