---
rating: ⭐⭐
title: brightcove-video-downloader
url: https://skills.sh/serpdownloaders/skills/brightcove-video-downloader
---

# brightcove-video-downloader

skills/serpdownloaders/skills/brightcove-video-downloader
brightcove-video-downloader
Installation
$ npx skills add https://github.com/serpdownloaders/skills --skill brightcove-video-downloader
SKILL.md
...
Navigate to any webpage that contains an embedded Brightcove video player.
The extension will scan the page and detect all Brightcove player instances.
Click the extension icon to see a list of detected videos on the current page.
Select the video you want to download from the list.
Choose your preferred quality or resolution if multiple renditions are available.
Click download and the extension will resolve the full video source.
The MP4 file will be saved directly to your local downloads folder.
Expected Formats
