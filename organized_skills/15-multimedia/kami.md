...
rating: ⭐⭐⭐
title: kami
url: https://skills.sh/tw93/kami/kami
---

# kami

skills/tw93/kami/kami
kami
Installation
$ npx skills add https://github.com/tw93/kami --skill kami
SKILL.md
kami · 紙
...
Classify: map each extract to the target template's sections (see references/writing.md for section structure per doc type)
...
KAMI_AUTHOR environment variable (fallback)
"Kami" (final fallback)
