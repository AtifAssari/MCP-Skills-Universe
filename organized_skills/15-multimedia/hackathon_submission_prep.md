...
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-submission-prep
---

# hackathon-submission-prep

skills/bernieweb3/hackathon-ai-devkit/hackathon-submission-prep
hackathon-submission-prep
Installation
...
Rules
submission_description must include: problem, solution, tech stack, team, and demo link.
short_description must be 280 characters or fewer.
artifact_checklist must verify: repo URL accessible, README exists, demo video linked, team listed.
Assign submission_quality_score using: completeness (40%), clarity (30%), impact framing (30%).
last_mile_actions must be ordered by priority with estimated time per action.
Flag any missing required field from custom_fields as a blocking missing_artifact.
Do not submit placeholder text; flag any [TBD] fields as incomplete in missing_artifacts.
Output Format
