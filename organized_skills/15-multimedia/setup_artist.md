...
rating: ⭐⭐
title: setup-artist
url: https://skills.sh/recoupable/setup-artist/setup-artist
---

# setup-artist

skills/recoupable/setup-artist/setup-artist
setup-artist
Installation
...
Updates the RECOUP.md marker file from not-setup to active and generates a root README with setup checklist and directory reference tables
SKILL.md
Setup Artist
