...
url: https://skills.sh/hainrixz/claude-webkit/chrome-bridge-automation
---

# chrome bridge automation

skills/hainrixz/claude-webkit/Chrome Bridge Automation
Chrome Bridge Automation
Installation
$ npx skills add https://github.com/hainrixz/claude-webkit --skill 'Chrome Bridge Automation'
SKILL.md
Chrome Bridge Automation
