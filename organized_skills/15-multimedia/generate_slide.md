...
url: https://skills.sh/chachamaru127/claude-code-harness/generate-slide
---

# generate-slide

skills/chachamaru127/claude-code-harness/generate-slide
generate-slide
Installation
$ npx skills add https://github.com/chachamaru127/claude-code-harness --skill generate-slide
SKILL.md
...
ユーザー指定テキスト: 引数でプロジェクト説明が渡された場合はそれを使用
コードベース自動分析: 引数がない場合、以下を自動分析
README.md — プロジェクト概要
...
各画像を Read で読み込み
5段階スコアリング（情報伝達力、レイアウト、テキスト可読性、プロフェッショナル感、ブランド整合性）
パターン内でスコアが高い方を採用候補
両方スコア2以下 → プロンプト改善して再生成（最大3回）
Step 5: 結果出力
# 最良画像を selected/ にコピー
