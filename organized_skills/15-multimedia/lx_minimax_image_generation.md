---
rating: ⭐⭐⭐
title: lx-minimax-image-generation
url: https://skills.sh/site/skills.volces.com/lx-minimax-image-generation
---

# lx-minimax-image-generation

skills/skills.volces.com/minimax-image
minimax-image
$ npx skills add https://skills.volces.com/skills/clawhub/lixiang92229@lx-minimax-image-generation
SKILL.md
Minimax Image Generation Skill
概述 | Overview

通过 MiniMax API 实现**文生图（T2I）和图生图（I2I）**功能。
