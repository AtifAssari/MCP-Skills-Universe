---
rating: ⭐⭐⭐
title: uploadthing-nextjs
url: https://skills.sh/flohhhhh/skills/uploadthing-nextjs
---

# uploadthing-nextjs

skills/flohhhhh/skills/uploadthing-nextjs
uploadthing-nextjs
Installation
...
Store UploadThing file identifier
Store public or signed file URL
Store ownership metadata
Link file to domain entity (post, profile, asset, etc.)
.onUploadComplete(async ({ metadata, file }) => {
...
Server returns presigned upload URL
Client uploads directly to storage
Upload completion handler runs server logic
