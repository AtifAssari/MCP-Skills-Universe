...
rating: ⭐⭐
title: tables
url: https://skills.sh/mwguerra/claude-code-plugins/tables
---

# tables

skills/mwguerra/claude-code-plugins/tables
tables
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill tables
SKILL.md
