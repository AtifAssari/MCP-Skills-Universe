...
rating: ⭐⭐
title: heygen-skills
url: https://skills.sh/heygen-com/skills/heygen-skills
---

# heygen-skills

skills/heygen-com/skills/heygen-skills
heygen-skills
Installation
$ npx skills add https://github.com/heygen-com/skills --skill heygen-skills
SKILL.md
HeyGen Skills
Files & Paths
...
Read workspace files before asking. SOUL.md, IDENTITY.md, and AVATAR-<NAME>.md at the workspace root contain identity and existing avatar state. Check them first. Only ask the user for what's genuinely missing.
...
Never narrate transport choice. MCP vs CLI is an internal implementation detail. Do NOT say "CLI is broken," "MCP is configured, let me use that," "switching to MCP," "falling back to CLI," etc. Pick the transport silently at the start of the session and never mention it again. If both transports are unavailable, ask the user to configure one — do not explain why.
Language Awareness
