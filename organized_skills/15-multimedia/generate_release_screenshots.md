---
rating: ⭐⭐⭐
title: generate-release-screenshots
url: https://skills.sh/oocx/tfplan2md/generate-release-screenshots
---

# generate-release-screenshots

skills/oocx/tfplan2md/generate-release-screenshots
generate-release-screenshots
Installation
$ npx skills add https://github.com/oocx/tfplan2md --skill generate-release-screenshots
SKILL.md
Skill Instructions
Purpose
...
Markdown → HTML: src/tools/Oocx.TfPlan2Md.HtmlRenderer renders markdown to HTML
HTML → PNG: src/tools/Oocx.TfPlan2Md.ScreenshotGenerator (Playwright) captures PNG screenshots
Repository scripts wrap these tools with:
