...
rating: ⭐⭐⭐
title: debug-ui
url: https://skills.sh/hhx465453939/claude_skill_pool/debug-ui
---

# debug-ui

skills/hhx465453939/claude_skill_pool/debug-ui
debug-ui
Installation
$ npx skills add https://github.com/hhx465453939/claude_skill_pool --skill debug-ui
SKILL.md
...
输出: 针对当前场景的设计隐喻 (Design Metaphor) 和 视觉策略 (Visual Strategy)。
...
呼吸感 (Rhythm): 留白是主动的设计，而非被动的间隙。
张力 (Tension): 是否因过度统一而乏味？是否需要一点"破坏"来制造焦点？
质感 (Texture): 光影、模糊、噪点是否传递了正确的物理隐喻？
微交互 (Micro-interactions): 动效是否符合物理惯性？是否提供了足够的心理反馈？
