...
url: https://skills.sh/sammcj/agentic-coding/storytelling-with-data
---

# storytelling-with-data

skills/sammcj/agentic-coding/storytelling-with-data
storytelling-with-data
Installation
$ npx skills add https://github.com/sammcj/agentic-coding --skill storytelling-with-data
SKILL.md
