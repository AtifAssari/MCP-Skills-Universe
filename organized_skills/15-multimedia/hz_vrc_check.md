...
rating: ⭐⭐⭐
title: hz-vrc-check
url: https://skills.sh/meta-quest/agentic-tools/hz-vrc-check
---

# hz-vrc-check

skills/meta-quest/agentic-tools/hz-vrc-check
hz-vrc-check
Installation
...
Development -- App ID, Platform SDK, entitlement check, engine config
Testing -- Playtest, internal QA, release channel distribution (Alpha/Beta/RC)
Pre-submission -- VRC self-check, manifest audit, permissions audit, APK packaging
Data Use Checkup -- Required if the app uses platform features (submit before app review)
Production upload -- Upload build to the Production channel on the Developer Dashboard
Technical review -- Meta verifies VRC requirements
Content review -- Meta evaluates UX quality, content guidelines, polish
Approval and release -- App goes live on Meta Horizon Store
...
Project config -- App ID, Platform SDK, entitlement check
Manifest -- SDK versions, required elements, debug flag
Permissions -- No prohibited, review-requiring justified, unnecessary removed
Packaging -- Signature, size, 64-bit, expansion files
Performance -- Framerate, thermal, load time
Functional -- Pause, focus-aware, input, tracking, multi-user, localization
Content -- UX quality, guidelines adherence, policies
Data Use -- DUC submitted and complete (if applicable)
Metadata -- Name, descriptions, keywords, URLs, privacy policy
Assets -- Cover art, screenshots, trailer, logo
