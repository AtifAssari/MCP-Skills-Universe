...
rating: ⭐⭐
title: nature-data
url: https://skills.sh/yuan1z0825/nature-skills/nature-data
---

# nature-data

skills/yuan1z0825/nature-skills/nature-data
nature-data
Installation
...
Classify each dataset into one access route: public repository, controlled access repository, within paper or supplement, reused public source, third-party restricted, available on justified request, or not applicable.
Choose repository and identifier strategy before drafting text. Prefer DOI, accession number, Handle, ARK, or stable repository record over personal websites and temporary cloud links.
