...
skills/softaworks/agent-toolkit/ship-learn-next
ship-learn-next
Installation
...
Emphasizes doing over studying—each rep produces a tangible artifact and builds one new skill, designed to complete in 1–7 days
Generates 5-rep progression maps that reference source material while keeping focus on the smallest shippable version first, not the full journey
SKILL.md
