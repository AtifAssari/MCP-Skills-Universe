...
rating: ⭐⭐⭐
title: skill-master
url: https://skills.sh/itechmeat/llm-code/skill-master
---

# skill-master

skills/itechmeat/llm-code/skill-master
skill-master
Installation
...
Discovery: Agent loads only name + description of each skill (~50-100 tokens)
Activation: When task matches, agent reads full SKILL.md into context
Execution: Agent follows instructions, loads referenced files as needed
...
Phase 1: Scaffold
Create skill folder with SKILL.md skeleton
Create plan.md for progress tracking
...
Fetch one page
Create references/<topic>.md with actionable summary
Update plan.md checkbox
Update SKILL.md if it adds a useful recipe/rule
