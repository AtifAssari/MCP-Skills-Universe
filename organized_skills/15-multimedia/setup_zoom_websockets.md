...
url: https://skills.sh/anthropics/knowledge-work-plugins/setup-zoom-websockets
---

# setup-zoom-websockets

skills/anthropics/knowledge-work-plugins/setup-zoom-websockets
setup-zoom-websockets
Installation
...
Select events to subscribe to (e.g., meeting.created, meeting.started)
Save - an endpoint URL will be generated
