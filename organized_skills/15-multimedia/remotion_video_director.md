---
rating: ⭐⭐⭐
title: remotion-video-director
url: https://skills.sh/bayramannakov/remotion-video-director/remotion-video-director
---

# remotion-video-director

skills/bayramannakov/remotion-video-director/remotion-video-director
remotion-video-director
Installation
$ npx skills add https://github.com/bayramannakov/remotion-video-director --skill remotion-video-director
SKILL.md
Remotion Video Director
...
Download/save to public/music.mp3
Add <Audio> component with fade-in/fade-out volume curve
Lower music volume during data-heavy scenes (0.30 -> 0.15)
If track is longer than video, use startFrom to play the ending section

If user wants voice-over:

Generate narration script from scene content (~3 words/second)
User records or uses ElevenLabs
Integrate with music ducking (music drops to 0.10-0.12 during narration)
...
Verdict - ship as-is, needs one more pass, or needs significant rework
...
Which scenes work well?
Which scenes need changes? (screenshot specific frames if possible)
Any text, timing, or visual issues?
Anything missing or that should be cut?"

WAIT for the user's feedback.

When the user provides feedback:

Acknowledge what they liked (reinforces the direction)
List the specific changes you'll make based on their notes
Make the changes - edit scene components, adjust timing, fix text
Re-render and present the updated video
Ask again: "Better? Anything else to adjust?"
