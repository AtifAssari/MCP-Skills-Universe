...
rating: ⭐⭐⭐
title: xiaohongshu
url: https://skills.sh/majiayu000/claude-arsenal/xiaohongshu
---

# xiaohongshu

skills/majiayu000/claude-arsenal/xiaohongshu
xiaohongshu
Installation
$ npx skills add https://github.com/majiayu000/claude-arsenal --skill xiaohongshu
SKILL.md
小红书内容生成器
...
软性种草，避免硬广
结尾必须提问
配图比例推荐 3:4 竖版（1080x1440）
避免纯 AI 味，加入个人口吻
功能描述要转化成用户价值（差："新增 pages 参数" → 好："大PDF不用全部加载了，省token"）
发布失败最常见原因：标题超20字
MCP 发布后无法编辑/删除，发布前务必确认内容
Weekly Installs
128
Repository
