---
rating: ⭐⭐
title: reading-deduction-cert
url: https://skills.sh/kazukinagata/shinkoku/reading-deduction-cert
---

# reading-deduction-cert

skills/kazukinagata/shinkoku/reading-deduction-cert
reading-deduction-cert
Installation
...
抽出テキストに必要な情報（保険料額・証明額等）が含まれていれば、テキストから構造化データを生成する
