...
url: https://skills.sh/sammcj/agentic-coding/diagrams-as-code
---

# diagrams-as-code

skills/sammcj/agentic-coding/diagrams-as-code
diagrams-as-code
Installation
...
Write the diagram script to a .py file in the user's working directory
Run it with python3 <file>.py
