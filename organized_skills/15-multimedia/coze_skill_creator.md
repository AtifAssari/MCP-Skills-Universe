---
rating: ⭐⭐
title: coze-skill-creator
url: https://skills.sh/morning-start/coze-skills/coze-skill-creator
---
...
coze-skill-creator
Installation
$ npx skills add https://github.com/morning-start/coze-skills --skill coze-skill-creator
SKILL.md
Coze Skill Creator
任务目标
...
当 仅需生成工作流设计:参考 references/workflow-guide.md，智能体生成工作流图和节点定义
当 仅需配置工具集成:参考 references/tool-reference.md，智能体生成工具配置
资源索引
必要脚本:
