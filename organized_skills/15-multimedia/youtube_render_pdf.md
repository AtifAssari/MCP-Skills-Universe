---
rating: ⭐⭐
title: youtube-render-pdf
url: https://skills.sh/wdkns/wdkns-skills/youtube-render-pdf
---

# youtube-render-pdf

skills/wdkns/wdkns-skills/youtube-render-pdf
youtube-render-pdf
Installation
...
Acquire the video's original cover image before writing the .tex. Prefer the highest-resolution thumbnail exposed by the platform metadata. Save the selected cover locally and reference that local asset from the front page. Do not substitute a random video frame when an official cover image is available.
