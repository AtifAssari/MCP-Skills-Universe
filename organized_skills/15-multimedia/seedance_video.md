...
url: https://skills.sh/freestylefly/canghe-skills/seedance-video
---

# seedance-video

skills/freestylefly/canghe-skills/seedance-video
seedance-video
Installation
...
编辑 .canghe-skills/.env 文件，填写你的 API Key：
...
加载优先级
系统环境变量 (process.env)
当前目录 .canghe-skills/.env
用户主目录 ~/.canghe-skills/.env
提示词优化建议

根据 Seedance-1.5-pro 提示词指南：

具体描述: 描述场景、主体、动作、环境等细节
风格明确: 指定摄影风格（如"电影感"、"纪录片风格"）
光线描述: 说明光线条件（如"黄金时刻"、"柔和自然光"）
镜头语言: 描述镜头运动（如"缓慢推进"、"稳定器拍摄"）
示例提示词
