...
rating: ⭐⭐⭐
title: cine-shot
url: https://skills.sh/yelban/orz99-skills/cine-shot
---

# cine-shot

skills/yelban/orz99-skills/cine-shot
cine-shot
Installation
$ npx skills add https://github.com/yelban/orz99-skills --skill cine-shot
SKILL.md
核心公式
...
擴寫場景：將簡短描述擴展為具體視覺細節（動作、環境、材質、色彩）
選配攝影機模組：依氛圍自動匹配（寫實→A, 史詩→B, 賽博→C），或遵從使用者指定
選配光影預設：依 Step 2 氛圍選擇對應預設關鍵詞
禁詞檢查：確認無禁止清單中的空洞修飾詞
Step 4 — 組裝輸出
...
輸入：一個孤獨的太空人站在火星表面 氛圍：Desolate / 全景 / 2.35:1
