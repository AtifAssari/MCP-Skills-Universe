...
url: https://skills.sh/questnova502/claude-skills-sync/baoyu-infographic
---

# baoyu-infographic

skills/questnova502/claude-skills-sync/baoyu-infographic
baoyu-infographic
Installation
$ npx skills add https://github.com/questnova502/claude-skills-sync --skill baoyu-infographic
SKILL.md
...
Example: "Machine Learning Basics" → ml-basics
...
Read layout definition from references/layouts/<layout>.md
Read style definition from references/styles/<style>.md
Read base prompt template from references/base-prompt.md
Combine with structured content from Step 2
...
.baoyu-skills/baoyu-infographic/EXTEND.md (project)
~/.baoyu-skills/baoyu-infographic/EXTEND.md (user)
