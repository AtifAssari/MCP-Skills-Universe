...
rating: ⭐⭐⭐
title: asset-audit
url: https://skills.sh/webflow/webflow-skills/asset-audit
---

# asset-audit

skills/webflow/webflow-skills/asset-audit
asset-audit
Installation
$ npx skills add https://github.com/webflow/webflow-skills --skill asset-audit
SKILL.md
Asset Audit
...
Fetch all assets: Use Webflow MCP's asset_tool to get all assets from the site
