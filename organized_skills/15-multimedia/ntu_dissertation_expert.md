---
rating: ⭐⭐⭐
title: ntu-dissertation-expert
url: https://skills.sh/jackieyyang/skills/ntu-dissertation-expert
---

# ntu-dissertation-expert

skills/jackieyyang/skills/ntu-dissertation-expert
ntu-dissertation-expert
Installation
...
Summary of work done (similar to abstract)
Conclusion highlighting significance and consequences of results
Recommendations / Future Work identifying gaps and suggesting improvements
General Rules
...
Create directory: latex/chapter-N/
Create file: latex/chapter-N/chapter-N.tex
Use this structure:
...
Add \input{chapter-N/chapter-N} in latex/main.tex (Main Content section)
Adding a Figure
\begin{figure}[h]
    \centering
...
Adding a Reference
Add BibTeX entry to latex/c-back-matter/references.bib:
@article{authorYear,
...
Cite in text: \cite{authorYear} or \cite{key1,key2} for multiple
Adding an Appendix
Create latex/c-back-matter/appendix-X.tex
Add \input{c-back-matter/appendix-X} in latex/main.tex after existing appendices
Compilation
...
For complete NTU formatting guidelines, see ntu-guidelines.md
For LaTeX command quick reference, see latex-cheatsheet.md
Weekly Installs
29
Repository
jackieyyang/skills
