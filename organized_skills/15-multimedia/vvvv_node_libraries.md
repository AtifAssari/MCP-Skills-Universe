---
rating: ⭐⭐⭐
title: vvvv-node-libraries
url: https://skills.sh/tebjan/vvvv-skills/vvvv-node-libraries
---

# vvvv-node-libraries

skills/tebjan/vvvv-skills/vvvv-node-libraries
vvvv-node-libraries
Installation
...
The type is public (and lives in an imported assembly).
The type's C# namespace is covered by an [assembly: ImportAsIs] / [assembly: ImportNamespace] declaration, OR the type is listed by an [assembly: ImportType] declaration.
...
[ProcessNode(Category = "X")] on the class itself — wins.
[assembly: ImportType(typeof(T), Category = "X", NamespacePrefixToStrip = "...")] — per-type override.
[assembly: ImportNamespace("X.Sub", Category = "Y")] matching the class's namespace — wins by longest prefix.
[assembly: ImportAsIs(Namespace = "X", Category = "Y")] — applies to types under X not covered above.
