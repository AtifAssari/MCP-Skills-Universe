---
rating: ⭐⭐⭐
title: concept-workflow
url: https://skills.sh/leonardomso/33-js-concepts/concept-workflow
---

# concept-workflow

skills/leonardomso/33-js-concepts/concept-workflow
concept-workflow
Installation
...
Conceptual (skip)
Create test file at tests/{category}/{concept}/{concept}.test.js
Create DOM test file (if needed) at tests/{category}/{concept}/{concept}.dom.test.js
