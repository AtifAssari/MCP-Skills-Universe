...
url: https://skills.sh/mineru98/skills-store/frontend-master
---

# frontend-master

skills/mineru98/skills-store/frontend-master
frontend-master
Installation
...
Construct Gemini command with --yolo flag
Execute via bash tool
Verify results with lsp_diagnostics
Apply changes if output is satisfactory
Example Commands
