---
rating: ⭐⭐⭐⭐⭐
title: ppw:repo-to-paper
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:repo-to-paper
---

# ppw:repo-to-paper

skills/lylll9436/paper-polish-workflow-skill/ppw:repo-to-paper
ppw:repo-to-paper
Installation
...
Repo path (required): "Which repository should I scan?" -- use Structured Interaction if available
Target journal (optional): "Which journal is this paper targeting?" -- options: CEUS, Other, None/General. If CEUS, load template at Step 2. If Other, ask for journal name. If None, use IMRaD default
