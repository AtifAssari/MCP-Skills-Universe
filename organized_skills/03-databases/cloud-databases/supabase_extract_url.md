---
rating: ⭐⭐
title: supabase-extract-url
url: https://skills.sh/yoanbernabeu/supabase-pentest-skills/supabase-extract-url
---

# supabase-extract-url

skills/yoanbernabeu/supabase-pentest-skills/supabase-extract-url
supabase-extract-url
Installation
...
Run supabase-extract-service-key to check for leaked service keys
