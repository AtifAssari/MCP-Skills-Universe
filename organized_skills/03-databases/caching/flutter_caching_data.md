...
url: https://skills.sh/flutter/skills/flutter-caching-data
---
...
Instantiate and pre-warm the engine in the Application class.
Store it in the FlutterEngineCache.
Retrieve it using withCachedEngine in the FlutterActivity or FlutterFragment.
