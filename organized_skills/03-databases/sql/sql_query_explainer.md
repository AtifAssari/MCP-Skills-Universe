...
url: https://skills.sh/mohitagw15856/pm-claude-skills/sql-query-explainer
---

# sql-query-explainer

skills/mohitagw15856/pm-claude-skills/sql-query-explainer
sql-query-explainer
Installation
$ npx skills add https://github.com/mohitagw15856/pm-claude-skills --skill sql-query-explainer
SKILL.md
