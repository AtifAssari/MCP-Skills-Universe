...
url: https://skills.sh/elastic/agent-skills/elasticsearch-esql
---

# elasticsearch-esql

skills/elastic/agent-skills/elasticsearch-esql
elasticsearch-esql
Installation
...
Field doesn't exist → Always use get_schema and list_indices before writing a query. Never guess field or index names — they vary across deployments.
