...
rating: ⭐⭐⭐
title: better-forms
url: https://skills.sh/alexeira/skills/better-forms
---

# better-forms

skills/alexeira/skills/better-forms
better-forms
Installation
...
Avoid: Submit
Prefer: Create Account, Publish Listing, Update Profile Tip: Update button text dynamically based on form state (e.g., "Saving..." vs "Save Changes").
"Optional" Label > Asterisks

Concept: Red asterisks (*) are aggressive and ambiguous (sometimes meaning "error"). Implementation: Mark required fields by default (no indicator) and explicitly label optional ones.
...
Concept: Masking passwords by default prevents error correction. Implementation: Always include a toggle button inside the input wrapper.
