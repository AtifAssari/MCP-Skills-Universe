...
skills/wshobson/agents/hybrid-cloud-networking
hybrid-cloud-networking
Installation
...
Includes high-availability configurations with dual tunnels, active-active setups, and ECMP failover for redundancy
Provides security best practices (encryption, private endpoints, network ACLs, monitoring) and troubleshooting commands for connection health and BGP session status
SKILL.md
Hybrid Cloud Networking
