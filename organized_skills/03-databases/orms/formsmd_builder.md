---
rating: ⭐⭐⭐
title: formsmd-builder
url: https://skills.sh/eng0ai/eng0-template-skills/formsmd-builder
---

# formsmd-builder

skills/eng0ai/eng0-template-skills/formsmd-builder
formsmd-builder
Installation
$ npx skills add https://github.com/eng0ai/eng0-template-skills --skill formsmd-builder
SKILL.md
Forms.md Builder
...
Quick Start
Create an HTML file with Forms.md boilerplate
Write form content in the DSL (Markdown-like syntax)
Add Typeform-style CSS theme for polish
...
Complete Workflow
Create form backend - Call the Forms API to create storage
Build the HTML form - Use the submitUrl in the form's post-url
Deploy the form - Host the HTML file anywhere
View results - Use the resultsUrl to see submissions
