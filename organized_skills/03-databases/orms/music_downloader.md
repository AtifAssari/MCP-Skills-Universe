...
url: https://skills.sh/nymbo/skills/music-downloader
---

# music-downloader

skills/nymbo/skills/music-downloader
music-downloader
Installation
...
Offers format flexibility (MP3, Opus, custom bitrates up to 320k) and advanced features like time-based extraction, speed limiting, and duplicate file handling
Includes web search integration to find content when users don't provide direct links
SKILL.md
Music Downloader
Overview
