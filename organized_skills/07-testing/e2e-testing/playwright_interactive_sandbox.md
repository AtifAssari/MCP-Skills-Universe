---
rating: ⭐⭐
title: playwright-interactive-sandbox
url: https://skills.sh/customware-ai/skills/playwright-interactive-sandbox
---

# playwright-interactive-sandbox

skills/customware-ai/skills/playwright-interactive-sandbox
playwright-interactive-sandbox
Installation
$ npx skills add https://github.com/customware-ai/skills --skill playwright-interactive-sandbox
SKILL.md
Core Workflow
