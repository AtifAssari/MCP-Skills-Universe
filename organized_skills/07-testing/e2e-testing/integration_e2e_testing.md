...
url: https://skills.sh/shinpr/claude-code-workflows/integration-e2e-testing
---

# integration-e2e-testing

skills/shinpr/claude-code-workflows/integration-e2e-testing
integration-e2e-testing
Installation
$ npx skills add https://github.com/shinpr/claude-code-workflows --skill integration-e2e-testing
SKILL.md
