...
rating: ⭐⭐⭐
title: e2e-ci-debug
url: https://skills.sh/lgariv-dn/frontend-skills/e2e-ci-debug
---

# e2e-ci-debug

skills/lgariv-dn/frontend-skills/e2e-ci-debug
e2e-ci-debug
Installation
...
.github/workflows/dispatcher.yml - PR entry point
.github/workflows/pr-core.yaml - Runs test, lint, docker, deploy jobs
pr-processor.yml (external) - Handles deployment and E2E execution
Local Debugging
