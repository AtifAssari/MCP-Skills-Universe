...
url: https://skills.sh/monkey1sai/openai-cli/load-test-builder
---

# load-test-builder

skills/monkey1sai/openai-cli/load-test-builder
load-test-builder
Installation
$ npx skills add https://github.com/monkey1sai/openai-cli --skill load-test-builder
SKILL.md
Load Test Builder
