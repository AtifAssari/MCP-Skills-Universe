...
rating: ⭐⭐⭐
title: k6-load-test
url: https://skills.sh/dengineproblem/agents-monorepo/k6-load-test
---

# k6-load-test

skills/dengineproblem/agents-monorepo/k6-load-test
k6-load-test
Installation
$ npx skills add https://github.com/dengineproblem/agents-monorepo --skill k6-load-test
SKILL.md
