---
rating: ⭐⭐⭐
title: vitest-3-features
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/vitest-3-features
---

# vitest-3-features

skills/josiahsiegel/claude-plugin-marketplace/vitest-3-features
vitest-3-features
Installation
$ npx skills add https://github.com/josiahsiegel/claude-plugin-marketplace --skill vitest-3-features
SKILL.md
🚨 CRITICAL GUIDELINES
