...
rating: ⭐⭐⭐⭐⭐
title: doc-bdd-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-bdd-fixer
---

# doc-bdd-fixer

skills/vladm3105/aidoc-flow-framework/doc-bdd-fixer
doc-bdd-fixer
Installation
...
Parse new EARS requirements not covered by existing BDD scenarios
Generate new scenarios with auto-generated tags
Append to appropriate feature file
...
Parse all new/modified EARS requirements
Generate new scenarios for additions
Mark existing scenarios for review if source requirement modified
...
Run /doc-bdd-fixer BDD-01 --acknowledge-drift
Fixer prompts: "Review drift for EARS-01.md?"
User confirms no BDD changes needed
Fixer adds to acknowledged_drift array
Future reviews skip this drift until upstream changes again
Command Usage
Basic Usage
...
Select latest report by timestamp.
If timestamps are equal, prefer BDD-NN.A_audit_report_vNNN.md over BDD-NN.R_review_report_vNNN.md.
Fix Types
Type	Description
...
Create backup in tmp/backup/BDD-NN_YYYYMMDD_HHMMSS/
Copy all BDD files and linked feature files to backup location
