...
url: https://skills.sh/alexpl292/awesome-claude-spinners/install-spinner
---

# install-spinner

skills/alexpl292/awesome-claude-spinners/install-spinner
install-spinner
Installation
...
Present the packs to the user in a table with three columns: Pack name, a short description, and a couple of example verbs. Use this reference:
