...
url: https://skills.sh/rudrankriyam/asc-skills/asc-app-create-ui
---

# asc-app-create-ui

skills/rudrankriyam/asc-skills/asc-app-create-ui
asc-app-create-ui
...
Scroll the radio element into view (scrollIntoView).
Click the radio ref directly (not via offset or label click).
