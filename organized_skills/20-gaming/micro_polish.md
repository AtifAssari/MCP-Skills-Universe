...
rating: ⭐⭐
title: micro-polish
url: https://skills.sh/justingoertz/micro-polish-skill/micro-polish
---

# micro-polish

skills/justingoertz/micro-polish-skill/micro-polish
micro-polish
Installation
$ npx skills add https://github.com/justingoertz/micro-polish-skill --skill micro-polish
SKILL.md
Micro Polish
...
/micro-polish Apply micro-refinement sensibility to any work in this conversation.

/micro-polish <file> Review the file for micro-polish opportunities and output:
...
Context understood — What you inferred about the work and its users. What "polish" means here.
Changes made — Refinements applied, with the specific observation that prompted each.
Rationale — Why each choice fits this context. Not generic craft principles—the specific reasoning for this work.
Left alone — Details you noticed but chose not to change, and why they're right as-is for this context.
Trust your eye
