...
rating: ⭐⭐⭐
title: world-fates
url: https://skills.sh/jwynia/agent-skills/world-fates
---

# world-fates

skills/jwynia/agent-skills/world-fates
world-fates
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill world-fates
SKILL.md
...
Scripts calculate fate pressure and generate weighted probability rolls
LLM synthesizes proposals based on rolls and entity state
Human approves, modifies, or rejects before changes apply to world bible
...
Pressure builds visibly (player can voluntary exit)
Fate offers a dramatic choice (player decides)
Only if refused does the die roll happen
...
Character is in active danger (combat, peril, hostile situation)
Fate pressure is High or above (> 0.5)
Fortune buffer is depleted (< 1)
...
Transparency: Players can see fate pressure accumulating
Choice-driven: Vulnerabilities come from character choices
Gradual: Pressure builds over time, not sudden
Probabilistic: Dice create genuine uncertainty
Survivable: Fortune buffers allow heroic escapes
Meaningful: Deaths have narrative weight and world impact
Proposal Generation
...
Create entry for the fate-shift event in history/events/
Update affected entity entries with new status
Mark all changes as Proposed ? until approved
Human approval moves to Established ✓
