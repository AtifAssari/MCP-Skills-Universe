---
rating: ⭐⭐
title: cardiology-editorial
url: https://skills.sh/drshailesh88/integrated_content_os/cardiology-editorial
---

# cardiology-editorial

skills/drshailesh88/integrated_content_os/cardiology-editorial
cardiology-editorial
Installation
$ npx skills add https://github.com/drshailesh88/integrated_content_os --skill cardiology-editorial
SKILL.md
...
Importance Assessment - Apply hybrid scoring (rules + LLM reasoning)
Editorial Type Selection - Full paper vs abstract-only approach
Research & Citation - Use PubMed MCP for comprehensive references
Editorial Writing - Eric Topol style, 500 words, well-cited
Authority Positioning - User portrayed as knowledgeable expert
