...
rating: ⭐⭐⭐
title: stitch-design
url: https://skills.sh/nguyenthienthanh/aura-frog/stitch-design
---

# stitch-design

skills/nguyenthienthanh/aura-frog/stitch-design
stitch-design
Installation
...
Optimized Stitch prompt (formatted for copy-paste)
Link: https://stitch.withgoogle.com
Step-by-step instructions
Export guidance (Figma vs HTML/CSS)
