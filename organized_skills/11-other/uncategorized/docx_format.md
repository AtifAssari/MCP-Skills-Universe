...
rating: ⭐⭐⭐
title: docx-format
url: https://skills.sh/ninestep/docx-format-skill/docx-format
---

# docx-format

skills/ninestep/docx-format-skill/docx-format
docx-format
Installation
...
确认文件路径：询问用户 Word 文档的完整路径
明确需求：确认是分析格式还是修改格式，目标规范是什么
选择模板：根据需求选择合适的代码模板或脚本
生成脚本：创建独立的 Python 脚本文件
执行验证：使用 uv run 执行并检查结果
...
注意事项
只支持 .docx：不支持旧版 .doc
表格内容：学术论文、报告等正文常在表格内，必须处理
单位转换：font.size 返回 EMU，需转换（÷ 914400 × 72）
备份原文件：修改前建议备份
Markdown 转换：使用 pandoc 转换后再格式化
Weekly Installs
104
Repository
ninestep/docx-f…at-skill
GitHub Stars
40
First Seen
Jan 28, 2026
