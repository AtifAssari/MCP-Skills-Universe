...
rating: ⭐⭐⭐
title: auto-skill
url: https://skills.sh/matrixy/auto-skill/auto-skill
---

# auto-skill

skills/matrixy/auto-skill/auto-skill
auto-skill
Installation
...
Observes your tool usage patterns in real-time
Detects repeated workflows (3+ occurrences)
Discovers relevant community skills from skills.sh
Recommends when to generate local skills vs use community skills
Learns continuously from your sessions
...
4. Submit to skills.sh: Visit skills.sh and submit the GitHub repo URL.
...
Users run Auto-Skill locally → workflows are detected
High-value patterns are refined and generalized
Users publish to GitHub + skills.sh
Others discover via Auto-Skill's proactive search
Community curates and improves shared workflows
