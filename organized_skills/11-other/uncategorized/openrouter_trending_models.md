---
rating: ⭐⭐⭐
title: openrouter-trending-models
url: https://skills.sh/madappgang/claude-code/openrouter-trending-models
---

# openrouter-trending-models

skills/madappgang/claude-code/openrouter-trending-models
openrouter-trending-models
Installation
...
Run script once: bun run scripts/get-trending-models.ts > trending-models.json
Commit to repository (under skills/openrouter-trending-models/)
Agents read from file instead of re-running script
