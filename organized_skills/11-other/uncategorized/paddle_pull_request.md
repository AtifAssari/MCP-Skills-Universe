---
rating: ⭐⭐⭐
title: paddle-pull-request
url: https://skills.sh/pfcclab/paddle-skills/paddle-pull-request
---
...
paddle-pull-request
Installation
$ npx skills add https://github.com/pfcclab/paddle-skills --skill paddle-pull-request
SKILL.md
Paddle 仓库 PR 创建与更新
流程
1. 检查分支状态
