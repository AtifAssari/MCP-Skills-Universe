---
rating: ⭐⭐
title: tw-edu-rubric-designer
url: https://skills.sh/fw1201/tw-edu-skills/tw-edu-rubric-designer
---

# tw-edu-rubric-designer

skills/fw1201/tw-edu-skills/tw-edu-rubric-designer
tw-edu-rubric-designer
Installation
$ npx skills add https://github.com/fw1201/tw-edu-skills --skill tw-edu-rubric-designer
SKILL.md
評量規準設計工具
Step 0：讀取參考文件
...
評量的任務/作業名稱？
科目與年級？
整體式（Holistic）or 分析式（Analytic）規準？
評量向度有哪些？（教師可自訂，或由 Claude 建議）
幾個等第？（建議 4 等第：傑出/精熟/基礎/待加強）
Step 2：生成評量規準文件
