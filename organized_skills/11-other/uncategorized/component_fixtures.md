...
url: https://skills.sh/microsoft/vscode/component-fixtures
---

# component-fixtures

skills/microsoft/vscode/component-fixtures
component-fixtures
Installation
...
Use the mcp_component-exp_list_fixtures tool to see all available fixtures and their URLs
Use the mcp_component-exp_screenshot tool to capture screenshots programmatically
File Structure
