...
rating: ⭐⭐⭐
title: sc-principles
url: https://skills.sh/tony363/superclaude/sc-principles
---

# sc-principles

skills/tony363/superclaude/sc-principles
sc-principles
Installation
...
Version: 2.1.0 Validators: validate_kiss.py, validate_purity.py, validate_solid.py, validate_crash.py Shared: shared.py (common find_python_files utility) Agent: code-warden Traits: principles-enforced Tests: 59 passing (all 4 validators)
