...
rating: ⭐⭐⭐
title: rollbar
url: https://skills.sh/robzolkos/rollbar-cli/rollbar
---

# rollbar

skills/robzolkos/rollbar-cli/rollbar
rollbar
Installation
$ npx skills add https://github.com/robzolkos/rollbar-cli --skill rollbar
SKILL.md
...
List recent errors: rollbar items --since "8 hours ago" --level error,critical
Identify the issue: Look at error titles and occurrence counts
Get full context: rollbar context <item-number> for the specific error
Analyze stack trace: The context output includes file paths and line numbers
Check patterns: Look at multiple occurrences to understand the trigger
Fix and resolve: After deploying a fix, mark the item as resolved: rollbar resolve <item-number>
