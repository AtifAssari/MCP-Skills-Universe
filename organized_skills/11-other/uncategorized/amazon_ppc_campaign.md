...
url: https://skills.sh/nexscope-ai/amazon-skills/amazon-ppc-campaign
---
...
amazon-ppc-campaign
Installation
$ npx skills add https://github.com/nexscope-ai/amazon-skills --skill amazon-ppc-campaign
SKILL.md
...
From competitor ASINs: User provides 1-3 competitor ASINs → run scripts/fetch-competitor.sh <ASIN> for each → extract keywords from their titles and bullet points. The script returns title, brand, bullets, price, category, BSR, and review count.
