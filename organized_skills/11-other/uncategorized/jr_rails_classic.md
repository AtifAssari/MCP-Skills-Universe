---
rating: ⭐⭐⭐
title: jr-rails-classic
url: https://skills.sh/julianrubisch/skills/jr-rails-classic
---

# jr-rails-classic

skills/julianrubisch/skills/jr-rails-classic
jr-rails-classic
Installation
$ npx skills add https://github.com/julianrubisch/skills --skill jr-rails-classic
SKILL.md
...
Core Workflow
Use generators first — rails g model, rails g controller, rails g migration. Generators produce correct file structure, test stubs, and route entries in one shot.
...
Always set :dependent on has_many/has_one. Use :inverse_of when Rails can't infer it.
