...
rating: ⭐⭐
title: arcgis-layers
url: https://skills.sh/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-layers
---

# arcgis-layers

skills/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-layers
arcgis-layers
Installation
...
Missing outFields: Queries return no attribute values unless outFields is specified.
...
Not waiting for layer load: Layer metadata (fields, extent, renderer) is unavailable until the layer finishes loading.
...
Wrong layer for MapView vs SceneView: Some layers only work in 3D (SceneLayer, IntegratedMeshLayer, PointCloudLayer).

Spatial reference mismatch: Adding layers with a different spatial reference than the view without projection support.
