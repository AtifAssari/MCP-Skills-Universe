---
rating: ⭐⭐⭐
title: commands-creator
url: https://skills.sh/mineru98/skills-store/commands-creator
---

# commands-creator

skills/mineru98/skills-store/commands-creator
commands-creator
Installation
...
Analyze requirements: What do you want the command to do?
Choose scope: Project (.claude/commands/) or Personal (~/.claude/commands/)
Write frontmatter: Add metadata (description, allowed-tools, etc.)
Write prompt content: Define what Claude should execute
Test the command: Invoke it and verify behavior
...
Reference Files
command-types.md - Detailed information on command types
syntax-and-arguments.md - Syntax and argument handling
frontmatter-reference.md - Complete frontmatter reference
advanced-features.md - Bash execution, hooks, thinking mode
best-practices.md - Naming, namespacing, permissions
examples.md - Additional command examples
Weekly Installs
15
Repository
