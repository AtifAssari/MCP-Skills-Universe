---
rating: ⭐⭐⭐
title: audiocut-keyword
url: https://skills.sh/wlzh/skills/audiocut-keyword
---

# audiocut-keyword

skills/wlzh/skills/audiocut-keyword
audiocut-keyword
Installation
...
可配置: 支持自定义关键字列表和缓冲时间
使用场景
YouTube 转播客: 删除视频中的"关注"、"订阅"、"点赞"等引导语
广告过滤: 自动删除音频中的广告和推广内容
内容清理: 批量处理音频，删除不需要的关键字片段
快速开始
基本用法
...
注意事项
首次运行: 需要下载 FunASR 模型，可能需要几分钟
音频格式: 支持 MP3, WAV, M4A 等常见格式
关键字匹配: 精确匹配，不支持模糊匹配
缓冲时间: 建议设置 0.5-1.0 秒，避免删除不完整
长音频: 30s 分段策略确保时间戳精确，无长度限制
常见问题
Q1: 转录准确率低
