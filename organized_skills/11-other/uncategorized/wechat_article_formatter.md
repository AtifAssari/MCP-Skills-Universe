...
url: https://skills.sh/iamzifei/wechat-article-formatter-skill/wechat-article-formatter
---

# wechat-article-formatter

skills/iamzifei/wechat-article-formatter-skill/wechat-article-formatter
wechat-article-formatter
Installation
...
Overview
Read markdown file (typically wechat.md from article directory)
Upload local images to WeChat CDN via media/uploadimg API
Replace local image paths with WeChat CDN URLs in markdown
Render markdown to styled HTML via bm.md API with custom CSS
Publish to WeChat draft via official draft/add API
...
Brand config author field
Brand config 品牌名称 field
