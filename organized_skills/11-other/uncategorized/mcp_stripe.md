...
rating: ⭐⭐
title: mcp-stripe
url: https://skills.sh/heyvhuang/ship-faster/mcp-stripe
---

# mcp-stripe

skills/heyvhuang/ship-faster/mcp-stripe
mcp-stripe
Installation
...
Three Hard Rules
Read before write - Before creating customer/product/price, first use list_* or search_stripe_resources to check if it already exists, avoid duplicate objects
Money and contracts require confirmation - create_refund, cancel_subscription, update_subscription, update_dispute must display content and get explicit user confirmation before execution
When in doubt, search - If unsure about object ID, fields, or approach, first call search_stripe_documentation or search_stripe_resources, don't guess parameters
Available Tools
