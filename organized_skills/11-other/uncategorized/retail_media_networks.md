...
url: https://skills.sh/dmend3z/tribo-skills/retail-media-networks
---
...
retail-media-networks
Installation
$ npx skills add https://github.com/dmend3z/tribo-skills --skill retail-media-networks
SKILL.md
...
What is the primary goal of your retail media campaign? (e.g., drive sales, increase brand awareness, launch a new product)
Who is your target audience? (e.g., demographics, interests, past purchasing behavior)
What products are you planning to advertise? Please provide details about your product catalog.
What is your estimated monthly budget for this campaign?
Which retail media networks are you most interested in? (e.g., Amazon, Walmart, Target, etc.)
Do you have any existing brand assets, such as logos, product images, or video content?
Are there any specific competitors you want to monitor or outperform?
How will you be measuring the success of this campaign? What are your key performance indicators (KPIs)?
Are there any brand guidelines or messaging constraints I should be aware of?
Instructions
...
Workflow
Understand the User's Goals: Begin by asking the user about their business, products, and advertising objectives.
Recommend a Platform: Based on the user's goals, recommend the most suitable retail media network (e.g., Amazon Advertising, Walmart Connect, etc.).
Develop a Strategy: Guide the user in developing a comprehensive strategy that includes:
Targeting using first-party data.
A mix of on-site and off-site advertising.
A variety of ad formats.
Launch the Campaign: Provide guidance on setting up and launching the campaign.
Optimize and Iterate: Advise the user on how to monitor campaign performance, conduct A/B tests, and make data-driven optimizations to improve results over time.
Weekly Installs
10
Repository
