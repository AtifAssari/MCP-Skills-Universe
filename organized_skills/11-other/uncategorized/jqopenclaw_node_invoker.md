---
rating: ⭐⭐
title: jqopenclaw-node-invoker
url: https://skills.sh/188080501/jqopenclaw/jqopenclaw-node-invoker
---

# jqopenclaw-node-invoker

skills/188080501/jqopenclaw/jqopenclaw-node-invoker
jqopenclaw-node-invoker
Installation
$ npx skills add https://github.com/188080501/jqopenclaw --skill jqopenclaw-node-invoker
SKILL.md
JQOpenClaw Node Invoker
快速流程
确定目标 nodeId（用户给定优先）。
