...
url: https://skills.sh/dirnbauer/webconsulting-skills/legal-impressum
---

# legal-impressum

skills/dirnbauer/webconsulting-skills/legal-impressum
legal-impressum
Installation
$ npx skills add https://github.com/dirnbauer/webconsulting-skills --skill legal-impressum
SKILL.md
...
SKILL-GERMANY.md - German requirements
SKILL-EU.md - EU-wide requirements
SKILL-WORLD.md - International requirements
...
For penalties, legal source links, and attribution notes, see references/penalties-and-sources.md. For notice requirements and compliance checklists, see references/compliance.md.
