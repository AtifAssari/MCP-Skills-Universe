---
rating: ⭐⭐
title: pixijs-scene-core-concepts
url: https://skills.sh/pixijs/pixijs-skills/pixijs-scene-core-concepts
---

# pixijs-scene-core-concepts

skills/pixijs/pixijs-skills/pixijs-scene-core-concepts
pixijs-scene-core-concepts
Installation
...
References
references/constructor-options.md: the ~30 fields inherited by every Container-derived node (transform, display, hierarchy, sorting, layout, effects, callbacks), with defaults, types, and when line-by-line assignment is appropriate. Shared reference for all leaf skills.
...
references/layers.md: RenderLayer, attach/detach, sorted layers, layer + logical parent split.
references/render-groups.md: isRenderGroup, GPU-level transforms, when to use, render-groups vs cacheAsTexture.
references/scene-management.md: combined view; render groups, RenderLayer, culling, zIndex sorting, boundsArea.
Common Mistakes
