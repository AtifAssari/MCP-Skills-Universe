---
rating: ⭐⭐⭐⭐⭐
title: generate-standard-readme
url: https://skills.sh/nesnilnehc/ai-cortex/generate-standard-readme
---

# generate-standard-readme

skills/nesnilnehc/ai-cortex/generate-standard-readme
generate-standard-readme
Installation
...
为任何软件项目（开源、内部服务、微服务、工具）创建专业、一致、高度可读的首页文档。标准化的信息布局可降低协作成本、提高工程规范并保持核心资产的可发现性。
...
范围：该技能强调固定的输出结构和治理（统一风格、审计、可发现性）；输出契约嵌入在技能中。对于按项目类型创建模板或引导式问答创建，请使用 Skills.sh 的“crafting-efficient-readmes”（例如 softaworks/agent-toolkit）。
...
语气和风格
使用中立、客观的语言；避免炒作（“最好的”、“革命性的”），除非有数据支持。
...
该程序处理图像。 安装：pip install 。 运行：python run.py
