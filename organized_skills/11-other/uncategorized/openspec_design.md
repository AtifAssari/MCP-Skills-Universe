...
url: https://skills.sh/wghust/stark-skills/openspec-design
---

# openspec-design

skills/wghust/stark-skills/openspec-design
openspec-design
Installation
...
Workflow step: In the "Creating Changes" workflow, between "Choose change-id" and "Scaffold", insert: "Design Extension (if Figma in prompt): If the prompt contains a Figma link, the agent MUST call call_mcp_tool to run Figma MCP, create design/, and generate design-map.md. Do not skip."

Design Extension section: Between "Proposal Structure" and "Spec File Format", insert the following Design Extension section. If it already exists, overwrite it.
...
Parse Figma link from prompt (e.g. figma.com/design/pxhnkHfGrSwHbxT1pfV0T4/xxx?node-id=2496-1199)
Use parse_figma_url or manual parse to get file key, node-id
Call get_file / get_node to fetch design details
Call export_images to export images
Save exports to design/, naming convention: figma-<node-name>-<index>.png
