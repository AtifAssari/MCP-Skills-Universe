...
rating: ⭐⭐⭐
title: doc-sys-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-sys-fixer
---

# doc-sys-fixer

skills/vladm3105/aidoc-flow-framework/doc-sys-fixer
doc-sys-fixer
Installation
...
Parse new ADR decisions/constraints
Generate new SYS element IDs (auto-increment sequence)
Insert new elements in appropriate sections
...
Add [MODIFIED] markers to affected elements
...
Create archive of current SYS version
Generate archive manifest
Flag for regeneration via doc-sys-autopilot
Increment major version (e.g., 1.1.0 -> 2.0.0)
Preserve deprecated elements with [DEPRECATED] markers
...
Create backup in tmp/backup/SYS-NN_YYYYMMDD_HHMMSS/
Copy all SYS files to backup location
