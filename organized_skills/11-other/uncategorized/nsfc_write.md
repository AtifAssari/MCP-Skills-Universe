...
rating: ⭐⭐
title: nsfc-write
url: https://skills.sh/njzjz/nsfc-agent-skills/nsfc-write
---

# nsfc-write

skills/njzjz/nsfc-agent-skills/nsfc-write
nsfc-write
Installation
$ npx skills add https://github.com/njzjz/nsfc-agent-skills --skill nsfc-write
SKILL.md
NSFC 申请书撰写指南
⚠️ 关键警告：提纲标题不可修改
...
后果：修改或遗漏提纲标题会导致形式审查不合格，直接初筛被毙，连送审的机会都没有。
...
正在承担的与本项目相关的科研项目情况（申请人正在承担的与本项目相关的科研项目情况，包括国家自然科学基金的项目和国家其他科技计划项目，要注明项目的资助机构、项目类别、批准号、项目名称、获资助金额、起止年月、与本项目的关系及负责的内容等）；
...
好奇心引导 — 保持对科学问题的好奇心和探索欲
无穷追问迭代 — 反复追问"为什么"，环环相扣直到找到本质
反常之中深挖 — 重视实验中的异常现象
范式变革催生 — 关注新范式（如AI）带来的新可能
同行交流收敛 — 通过深度交流碰撞出火花
透视需求抽象 — 从应用需求中抽提基础科学问题
...
学术思想（科学原理）— 重点，可加入已发表论文
研究方案（技术路线）— 重点，可加入已发表论文
研究条件（物）— 实验设备、场地、环境
研究队伍（人）— 团队能力
7. 特色与创新
2-3条，具有必要性，不为创新而创新
