---
rating: ⭐⭐⭐⭐⭐
title: xanoscript-docs-expert
url: https://skills.sh/xano-inc/xano-developer-mcp/xanoscript-docs-expert
---

# xanoscript-docs-expert

skills/xano-inc/xano-developer-mcp/xanoscript-docs-expert
xanoscript-docs-expert
Installation
...
Create src/tools/my_tool.ts with tool definition and handler
Register in src/tools/index.ts: add to toolDefinitions array and handleTool switch
Export from src/lib.ts if needed for standalone usage
Testing
