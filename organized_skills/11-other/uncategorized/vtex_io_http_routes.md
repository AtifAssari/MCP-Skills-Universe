---
rating: ⭐⭐
title: vtex-io-http-routes
url: https://skills.sh/vtex/skills/vtex-io-http-routes
---
...
Related skills
vtex-io-events-and-workers - Use when expensive or retry-prone work should move out of HTTP handlers into async flows
vtex-io-auth-and-policies - Use when deciding which policies or access rules should protect HTTP routes
Reference
Service - Route declaration and service exposure
Node Builder - Backend file layout and route implementation context
Using Node Clients - Client usage from route handlers
Weekly Installs
164
Repository
vtex/skills
