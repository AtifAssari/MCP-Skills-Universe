...
rating: ⭐⭐
title: appveyor
url: https://skills.sh/membranedev/application-skills/appveyor
---

# appveyor

skills/membranedev/application-skills/appveyor
appveyor
Installation
$ npx skills add https://github.com/membranedev/application-skills --skill appveyor
SKILL.md
AppVeyor
