---
rating: ⭐⭐
title: pre-write-checklist
url: https://skills.sh/wordflowlab/novel-writer-skills/pre-write-checklist
---

# pre-write-checklist

skills/wordflowlab/novel-writer-skills/pre-write-checklist
pre-write-checklist
Installation
$ npx skills add https://github.com/wordflowlab/novel-writer-skills --skill pre-write-checklist
SKILL.md
写作前强制检查清单
核心功能
