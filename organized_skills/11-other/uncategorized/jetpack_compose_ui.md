...
url: https://skills.sh/peterbamuhigire/skills-web-dev/jetpack-compose-ui
---

# jetpack-compose-ui

skills/peterbamuhigire/skills-web-dev/jetpack-compose-ui
jetpack-compose-ui
Installation
...
Visible affordances over guesswork - Interactive elements must look tappable without relying on motion or discovery
...
Colour and first impressions — Users form visual judgments quickly; use visuals and colour to communicate primary meaning instantly.
