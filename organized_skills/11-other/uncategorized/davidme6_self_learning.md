---
rating: ⭐⭐⭐
title: davidme6-self-learning
url: https://skills.sh/site/skills.volces.com/davidme6-self-learning
---

# davidme6-self-learning

skills/skills.volces.com/self-learning
self-learning
$ npx skills add https://skills.volces.com/skills/clawhub/davidme6
SKILL.md
...
主动性：不等待指令，主动发现知识盲区
持续性：每次任务后复盘，每日总结，每周迭代
实用性：学以致用，立即应用到项目中
可验证：学习效果可量化、可检验
用户主导：用户可随时叫停/纠正/调整方向
不重复犯错：永远不被同一块石头绊倒两次
举一反三：从一个问题学到一类问题的解决方案 ⭐ NEW
🧠 举一反三学习系统 ⭐ NEW
核心理念
