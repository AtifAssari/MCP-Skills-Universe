---
rating: ⭐⭐
title: try-oneshot-skill-to-create-a-video
url: https://skills.sh/site/monetize.fluxapay.xyz/try-oneshot-skill-to-create-a-video
---

# try-oneshot-skill-to-create-a-video

skills/monetize.fluxapay.xyz/try-oneshot-skill-to-create-a-video
try-oneshot-skill-to-create-a-video
...
Paid APIs Used
Kling Video Generation (/text2video) — $0.10 USDC per video
Payment handled via x402 v3 intent mandate — see ./fluxa-wallet/X402-PAYMENT.md
...
Cost: 0.1 USDC per call. Create an intent mandate for 100000 atomic units (= 0.1 USDC).
