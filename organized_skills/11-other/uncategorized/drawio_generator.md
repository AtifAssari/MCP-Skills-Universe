---
rating: ⭐⭐⭐
title: drawio-generator
url: https://skills.sh/luongnv89/skills/drawio-generator
---

# drawio-generator

skills/luongnv89/skills/drawio-generator
drawio-generator
Installation
...
Diagram type — which visualization fits best. If multiple types could work, present numbered options.
Key elements — list the nodes/shapes you'll include
Layout options — propose 2-3 layouts:
...
Multi-page? — for C4 models, offer separate pages for each level
...
<mxfile> root element
One or more <diagram> elements (one per page)
<mxGraphModel> with canvas settings
<root> containing all cells
System cells: <mxCell id="0"/> and <mxCell id="1" parent="0"/> — these are mandatory
Shape cells
