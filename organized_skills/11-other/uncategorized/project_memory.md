...
url: https://skills.sh/jamditis/claude-skills-journalism/project-memory
---

# project-memory

skills/jamditis/claude-skills-journalism/project-memory
project-memory
Installation
$ npx skills add https://github.com/jamditis/claude-skills-journalism --skill project-memory
SKILL.md
...
Copy the appropriate template to your project root as CLAUDE.md
Fill in the bracketed placeholders with YOUR specifics
