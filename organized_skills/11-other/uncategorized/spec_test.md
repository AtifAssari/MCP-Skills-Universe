...
rating: ⭐⭐
title: spec-test
url: https://skills.sh/zixun-github/aisdlc/spec-test
---

# spec-test

skills/zixun-github/aisdlc/spec-test
spec-test
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill spec-test
SKILL.md
