...
rating: ⭐⭐⭐
title: filing
url: https://skills.sh/spm1001/claude-suite/filing
---

# filing

skills/spm1001/claude-suite/filing
filing
Installation
$ npx skills add https://github.com/spm1001/claude-suite --skill filing
SKILL.md
Filing
...
Transcribe with ~/.claude/scripts/transcribe-jpr.sh --new
Review transcript in Work Inbox/Voice Transcripts/
Audio moves to Processed/ subfolder automatically
...
Create Project folder if needed: {Area} - {Outcome statement}
Convert to Google Doc: mcp__mise__create
