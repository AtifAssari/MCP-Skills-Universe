...
url: https://skills.sh/sachacoldiq/coldiq-s-gtm-skills/ai-personalization-prompts
---

# ai-personalization-prompts

skills/sachacoldiq/coldiq-s-gtm-skills/ai-personalization-prompts
ai-personalization-prompts
Installation
$ npx skills add https://github.com/sachacoldiq/coldiq-s-gtm-skills --skill ai-personalization-prompts
SKILL.md
AI Personalization Prompts (lemlist Style)

Quick reference for AI prompts. For full prompts with rules, see references/prompts.md.
...
Prompt 1-5: Use for variable generation in Clay/lemlist Prompt 6-7: Use as full email templates with AI-generated variables
