---
rating: ⭐⭐⭐
title: figma-driven-nextjs
url: https://skills.sh/zekiwest/agent-skills/figma-driven-nextjs
---

# figma-driven-nextjs

skills/zekiwest/agent-skills/figma-driven-nextjs
figma-driven-nextjs
Installation
...
/styles/tokens/colors.ts - 颜色令牌（含 Light/Dark）
/styles/tokens/typography.ts - 字体令牌
/styles/tokens/spacing.ts - 间距令牌
/styles/tokens/shadows.ts - 阴影令牌
/styles/tokens/index.ts - 统一导出
/styles/globals.css - 全局样式
/docs/component-mapping.md - 组件命名映射规则
/components/ThemeProvider.tsx - 主题提供者
/tailwind.config.ts - Tailwind 配置（含设计令牌）
触发条件
...
确认当前工作区根目录：IDE 打开的文件夹是哪个？
安装到正确位置：技能必须安装到工作区根目录
# 正确示例：工作区是 web 子项目
project/
├── web/                    # ← 工作区根目录
│   ├── .agents/           # ← 技能安装位置
