---
rating: ⭐⭐
title: dont-use-use-effect
url: https://skills.sh/jonmumm/skills/dont-use-use-effect
---

# dont-use-use-effect

skills/jonmumm/skills/dont-use-use-effect
dont-use-use-effect
Installation
$ npx skills add https://github.com/jonmumm/skills --skill dont-use-use-effect
SKILL.md
Don't Use useEffect
...
Add the ignore cleanup flag to prevent race conditions
Extract the logic into a reusable custom hook (e.g. useData(url))
...
Can I calculate this from existing props/state? → Derive it during render (or useMemo).
...
Am I subscribing to an external store? → Use useSyncExternalStore or the library's hook.
Am I resetting state when a prop changes? → Use the key prop.
Am I syncing with an external system that React doesn't control? → ✅ This is a valid useEffect.
Summary Checklist
