...
url: https://skills.sh/site/open.feishu.cn/lark-workflow-standup-report
---

# lark-workflow-standup-report

skills/open.feishu.cn/lark-workflow-standup-report
lark-workflow-standup-report
...
时间转换：API 返回 Unix timestamp，需根据 timezone 字段（通常为 Asia/Shanghai）转换为 HH:mm 格式
RSVP 状态映射：
API 值	显示文案
accept	已接受
decline	已拒绝
