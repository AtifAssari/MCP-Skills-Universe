...
rating: ⭐⭐⭐
title: hotel
url: https://skills.sh/jinfanzheng/kode-sdk-csharp/hotel
---

# hotel

skills/jinfanzheng/kode-sdk-csharp/hotel
hotel
Installation
$ npx skills add https://github.com/jinfanzheng/kode-sdk-csharp --skill hotel
SKILL.md
...
城市/区域 + 入住退房日期（几晚）——这是查“实时价”的必要条件
人数/房间数 + 预算（默认 RMB/晚/每间房，但请用户确认口径）
必须条件（最多 3 条）：例如“可免费取消/含早/禁烟/近地铁/安静/带娃友好/可开发票”等
