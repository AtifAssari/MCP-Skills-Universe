...
rating: ⭐⭐
title: generate2dmap
url: https://skills.sh/0x0funky/agent-sprite-forge/generate2dmap
---

# generate2dmap

skills/0x0funky/agent-sprite-forge/generate2dmap
generate2dmap
Installation
...
Generate assets/map/<name>-base.png as ground-only terrain.
Make the base image visible in conversation context. If the base is a local file, use view_image before calling built-in image_gen; do not rely on a path string as the reference.
Generate assets/map/<name>-dressed-reference.png from the visible base, preserving camera, terrain, size, road/water shapes, anchor pads, and boundaries. Treat this as a planning/reference image, not the final runtime map.
