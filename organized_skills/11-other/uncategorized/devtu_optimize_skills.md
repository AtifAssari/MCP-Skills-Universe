---
rating: ⭐⭐⭐
title: devtu-optimize-skills
url: https://skills.sh/mims-harvard/tooluniverse/devtu-optimize-skills
---
...
Schema must match API reality — run python3 -m tooluniverse.cli run <Tool> '<json>' to verify
Coverage transparency — state what data is NOT included
