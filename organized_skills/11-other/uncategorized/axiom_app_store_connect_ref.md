---
rating: ⭐⭐⭐
title: axiom-app-store-connect-ref
url: https://skills.sh/charleswiltgen/axiom/axiom-app-store-connect-ref
---

# axiom-app-store-connect-ref

skills/charleswiltgen/axiom/axiom-app-store-connect-ref
axiom-app-store-connect-ref
Installation
...
Right-click → "Show in Finder" → right-click .xcarchive → "Show Package Contents"
Check dSYMs/ folder contains .dSYM bundles
