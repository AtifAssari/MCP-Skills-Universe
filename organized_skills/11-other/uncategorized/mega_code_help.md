---
rating: ⭐⭐⭐
title: mega-code-help
url: https://skills.sh/wisdomgraph/mega-code/mega-code-help
---

# mega-code-help

skills/wisdomgraph/mega-code/mega-code-help
mega-code-help
Installation
$ npx skills add https://github.com/wisdomgraph/mega-code --skill mega-code-help
SKILL.md
MEGA-Code Help
Available Commands
Command	Description
...
Run /mega-code:skill-enhance to improve an existing skill and review ROI
...
Run /mega-code:wisdom-curate to get a curated workflow with relevant skills
