---
rating: ⭐⭐⭐
title: paw-ps-publish-ready-check
url: https://skills.sh/pawbytes/skill-suites/paw-ps-publish-ready-check
---

# paw-ps-publish-ready-check

skills/pawbytes/skill-suites/paw-ps-publish-ready-check
paw-ps-publish-ready-check
Installation
...
Identify active product from .pawbytes/prodig-suites/active-product.md if it exists
If no active product and not in headless mode, prompt user to specify:
...
Read ./references/readiness-criteria.csv — lightweight index of criteria by product type
Match product type to relevant criteria rows
Apply matched criteria during Stage 2 assessment
Reference full standards from ./references/frameworks/ only when needed
Output Contract
...
Default target readiness level to publish-ready unless specified via args
...
No rubber-stamping — Every verdict must be justified with evidence
Gap visibility — All blocking issues documented, none hidden
Honest assessment — Better to delay release than ship broken products
User clarity — Fix list must be actionable and specific
Standards matter — Apply the criteria, don't lower the bar
Escalation Routes
