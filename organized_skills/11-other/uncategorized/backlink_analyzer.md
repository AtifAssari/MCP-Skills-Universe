...
url: https://skills.sh/manojbajaj95/gtm-skills/backlink-analyzer
---

# backlink-analyzer

skills/manojbajaj95/gtm-skills/backlink-analyzer
backlink-analyzer
Installation
$ npx skills add https://github.com/manojbajaj95/gtm-skills --skill backlink-analyzer
SKILL.md
Backlink Analyzer
...
Profile Analysis: Comprehensive backlink profile overview
Quality Assessment: Evaluates link authority and relevance
Toxic Link Detection: Identifies harmful links
Competitor Analysis: Compares link profiles across competitors
Opportunity Discovery: Finds link building prospects
Trend Monitoring: Tracks link acquisition over time
Disavow Guidance: Helps create disavow files
How to Use
...
Backlink export CSV (with source domains, anchor text, link type)
Referring domains list with authority metrics
Competitor domains for comparison
Recent link gains/losses if tracking changes
Any known toxic or spammy links
