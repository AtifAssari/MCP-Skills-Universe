---
rating: ⭐⭐⭐
title: openclaw-complete-deployment-guide
url: https://skills.sh/nathansteelqoder/openclaw-config-qoder-integration/openclaw-complete-deployment-guide
---

# openclaw-complete-deployment-guide

skills/nathansteelqoder/openclaw-config-qoder-integration/openclaw-complete-deployment-guide
openclaw-complete-deployment-guide
Installation
$ npx skills add https://github.com/nathansteelqoder/openclaw-config-qoder-integration --skill openclaw-complete-deployment-guide
SKILL.md
...
确认应用已在「版本管理与发布」中正式发布（仅保存不够）
确认所有机器人权限已申请并审批通过
核对 Client ID 和 Client Secret 无误
查看连接器日志：openclaw logs dingtalk -f
确认 Stream 模式已启用
确认机器人已添加到目标群聊
问题 3：无法将机器人添加到群聊
