...
rating: ⭐⭐⭐
title: kimi-docx
url: https://skills.sh/thvroyal/kimi-skills/kimi-docx
---

# kimi-docx

skills/thvroyal/kimi-skills/kimi-docx
kimi-docx
Installation
...
Design Flow
Read example: Read scripts/generate_backgrounds.py for HTML/CSS techniques (radial-gradient, transparency, positioning)
Choose direction: Select a style direction from the table below based on document scenario
Create original: Write new HTML/CSS from scratch—the example shows ONE style, yours should be different
...
Multi-level: create AbstractNum with multiple Levels. Formats: Decimal, UpperLetter, LowerRoman, Bullet, ChineseCounting.
