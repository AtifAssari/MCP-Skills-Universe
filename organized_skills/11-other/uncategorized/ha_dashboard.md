...
rating: ⭐⭐⭐
title: ha-dashboard
url: https://skills.sh/nodnarbnitram/claude-code-extensions/ha-dashboard
---

# ha-dashboard

skills/nodnarbnitram/claude-code-extensions/ha-dashboard
ha-dashboard
Installation
...
Invalid entity ID format (must be domain.entity_name)
Missing required card properties (e.g., entity for button cards)
Incorrect view type configuration
