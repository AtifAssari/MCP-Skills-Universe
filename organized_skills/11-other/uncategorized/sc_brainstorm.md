...
rating: ⭐⭐⭐
title: sc-brainstorm
url: https://skills.sh/tony363/superclaude/sc-brainstorm
---

# sc-brainstorm

skills/tony363/superclaude/sc-brainstorm
sc-brainstorm
Installation
$ npx skills add https://github.com/tony363/superclaude --skill sc-brainstorm
SKILL.md
...
Behavioral Flow
Explore - Transform ambiguous ideas through Socratic dialogue
Analyze - Coordinate multiple personas for domain expertise
Validate - Apply feasibility assessment across domains
Specify - Generate concrete specifications
Handoff - Create actionable briefs for implementation
Flags
