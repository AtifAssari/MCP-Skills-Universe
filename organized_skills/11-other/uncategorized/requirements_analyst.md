...
url: https://skills.sh/nahisaho/musubi/requirements-analyst
---

# requirements-analyst

skills/nahisaho/musubi/requirements-analyst
requirements-analyst
Installation
...
既存の steering/product.md を読み込む（存在する場合）
今回定義した要件から重要な情報を抽出
product.md の該当セクションに追記または更新
英語版と日本語版の両方を更新
🤖 Steering更新中...
...
docs/progress-report.mdの「現在進行中のステップ」セクション更新
