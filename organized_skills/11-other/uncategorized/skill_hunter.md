...
rating: ⭐⭐
title: skill-hunter
url: https://skills.sh/jdluther2020/ai-claude-code-talk/skill-hunter
---

# skill-hunter

skills/jdluther2020/ai-claude-code-talk/skill-hunter
skill-hunter
Installation
$ npx skills add https://github.com/jdluther2020/ai-claude-code-talk --skill skill-hunter
SKILL.md
Skill Hunter
Overview
...
Search the skill ecosystem for code review-related skills
Extract the top-quality examples
Analyze their structure and patterns
Show you how professional skills approach this domain
...
Identify skills with high documentation quality
Show the structure of top-rated skills
Explain what patterns they follow
Provide excerpts you can learn from
...
Analyze recent skills and updates
Identify emerging patterns
Compare with historical baselines
Highlight innovation areas
...
Filter for methodology vs. tool-based skills
Extract those specific types
...
Recommend official Anthropic examples to study
Show production-quality community skills
Explain common patterns you'll see
Provide a learning progression
...
Production Community Skills (obra/superpowers)
Experimental Skills (obra/superpowers-lab)
Skill Hunter Resources
Source Code & Data
Blog Series — Deep dive into findings
...
Provide context — Tell me what you're trying to build
Be specific — Domain, use case, skill type helps narrow results
Start with examples — "Show me a well-made skill for X"
Then learn patterns — "What makes this one well-designed?"
Finally, build — Use patterns to create your own
...
Learn how skills work (by studying SKILL.md files)
Understand how others structure skills (by analyzing examples)
Get better at building skills (by learning from excellence)
Teach others about skills (by providing evidence-based insights)
