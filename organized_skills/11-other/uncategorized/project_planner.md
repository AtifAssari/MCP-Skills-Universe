...
url: https://skills.sh/samhvw8/dot-claude/project-planner
---

# project-planner

skills/samhvw8/dot-claude/project-planner
project-planner
Installation
...
Generate plan file in docs/plans/
Update docs/plan.md:
...
Update plan file status: completed
Update docs/plan.md:
...
Update plan file status: on_hold
Update docs/plan.md:
...
Load active plan from docs/plan.md
Check phase:
...
Checks docs/plan.md - no active plan
Asks clarifying questions:
Who is the target audience?
What's the launch date goal?
What's the budget?
Creates PLAN-20251118-1430-mobile-app-launch.md:
...
Updates docs/plan.md with active plan
