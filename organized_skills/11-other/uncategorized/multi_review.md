...
rating: ⭐⭐⭐
title: multi-review
url: https://skills.sh/shhac/skills/multi-review
---

# multi-review

skills/shhac/skills/multi-review
multi-review
Installation
...
Gather the diff and list of changed files, then decide how reviewers will access the content:
...
Create tasks for each reviewer with TaskCreate
Spawn 5 general-purpose teammates in parallel using Task with team_name, one per lens:
security-reviewer
