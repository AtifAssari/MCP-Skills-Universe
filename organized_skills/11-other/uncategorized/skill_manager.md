...
rating: ⭐⭐⭐
title: skill-manager
url: https://skills.sh/cleanexpo/nodejs-starter-v1/skill-manager
---

# skill-manager

skills/cleanexpo/nodejs-starter-v1/skill-manager
skill-manager
Installation
...
Behavioural Rules
Never hardcode paths — always use relative paths from project root
Always en-AU — colour, analyse, catalogue, optimise, centre, behaviour
Under 500 lines — every generated SKILL.md must be under 500 lines
No self-generation without analysis — MODE 2 should follow MODE 1 or explicit user request
Registry consistency — every generated skill must be registered in .skills/AGENTS.md
Respect hierarchy — Skill Manager is a peer to Orchestrator, not subordinate
Token economy — load only the reference file needed for the current mode
Australian Localisation (en-AU)
Date Format: DD/MM/YYYY
