...
url: https://skills.sh/jwilger/agent-skills/memory-protocol
---

# memory-protocol

skills/jwilger/agent-skills/memory-protocol
memory-protocol
Installation
...
Traverse: Follow relations on opened entities to discover connected knowledge. Call open_nodes on each related entity. Continue traversing until results are no longer relevant. Relations like depends_on, contradicts, supersedes, and part_of frequently point to information that changes how you should act — a fix that depends on a workaround, a convention that was later corrected, a decision that was superseded.
...
Technical query: the specific topic, error, feature, or domain concept
Process query: learnings about this type of work — mistakes, corrections, workflow insights, conventions for this kind of task
