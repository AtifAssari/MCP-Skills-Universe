...
url: https://skills.sh/ck42bb/procedural-landscapes-threejs/procedural-landscapes
---

# procedural-landscapes

skills/ck42bb/procedural-landscapes-threejs/procedural-landscapes
procedural-landscapes
Installation
...
Common Pitfalls
Normals not recomputed after vertex modification → flat/unlit terrain. Always call geometry.computeVertexNormals().
Chunk seams → sample identical world-space noise at shared edges.
Z-fighting on water → use polygonOffset or small Y offset.
Memory leaks → dispose geometries on chunk removal. Monitor with renderer.info.
WebGPU silent failure → always gate behind WebGPU.isAvailable().
References
