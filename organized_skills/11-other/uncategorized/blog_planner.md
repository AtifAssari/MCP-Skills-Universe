...
rating: ⭐⭐⭐
title: blog-planner
url: https://skills.sh/electric-sql/electric/blog-planner
---

# blog-planner

skills/electric-sql/electric/blog-planner
blog-planner
Installation
...
TLDR opener — 1-2 short paragraphs stating what this is and why it matters. Compressed, no setup, no marketing tone. Technical audience wants the point immediately. Followed by an info box with key links.
Format-specific body — Section structure per the chosen format reference. Inline HTML comments guide the author on each section's purpose and tone.
Next steps — CTAs, links, what to do now.
*** separator
Commented meta footer — Intent, title brief, description brief, excerpt brief, image prompt, asset checklist, open questions. Prefixed with instruction to delete before publishing.
Inline comments
