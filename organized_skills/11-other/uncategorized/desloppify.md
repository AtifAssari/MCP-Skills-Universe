...
rating: ⭐⭐
title: desloppify
url: https://skills.sh/fasalzein/desloppify/desloppify
---

# desloppify

skills/fasalzein/desloppify/desloppify
desloppify
Installation
$ npx skills add https://github.com/fasalzein/desloppify --skill desloppify
SKILL.md
Desloppify
...
.desloppify/reports/latest.wiki.json or .desloppify/reports/latest.handoff.md
...
the worktree path
the saved report path or a focused scan slice
desloppify fix . --safe first
a re-scan after edits
...
Treat GOD_FILE as a refactor signal, not a blind split command. Inspect why it tripped:
