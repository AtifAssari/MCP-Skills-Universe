---
rating: ⭐⭐⭐
title: huashu-xhs-image
url: https://skills.sh/alchaincyf/huashu-skills/huashu-xhs-image
---

# huashu-xhs-image

skills/alchaincyf/huashu-skills/huashu-xhs-image
huashu-xhs-image
Installation
$ npx skills add https://github.com/alchaincyf/huashu-skills --skill huashu-xhs-image
SKILL.md
小红书配图工作流
⚠️ 核心原则：先提案，后生成
...
提案原则
每个方向要有明确差异（风格、情绪、色彩至少有一个完全不同）
标注推荐（基于内容特征说明为什么推荐某个方向）
文案要具体（不是"标题放大"，而是「"28"做200px的hero元素，橙色强调」）
不要超过3个方向（选择太多反而难选）
提案示例
