...
rating: ⭐⭐⭐
title: wiki-ingest
url: https://skills.sh/ar9av/obsidian-wiki/wiki-ingest
---

# wiki-ingest

skills/ar9av/obsidian-wiki/wiki-ingest
wiki-ingest
Installation
$ npx skills add https://github.com/ar9av/obsidian-wiki --skill wiki-ingest
SKILL.md
...
Before You Start
Read ~/.obsidian-wiki/config (preferred) or .env (fallback) to get OBSIDIAN_VAULT_PATH, OBSIDIAN_SOURCES_DIR, and OBSIDIAN_LINK_FORMAT (default: wikilink). Only read the specific variables you need — do not log, echo, or reference any other values from these files.
