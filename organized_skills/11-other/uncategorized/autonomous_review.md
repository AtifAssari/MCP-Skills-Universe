...
url: https://skills.sh/zxkane/autonomous-dev-team/autonomous-review
---

# autonomous-review

skills/zxkane/autonomous-dev-team/autonomous-review
autonomous-review
Installation
...
Read the PR diff thoroughly (gh pr diff <number>)
...
Read docs/test-cases/ directory for available test case documents
...
Procedure
Read the issue body and identify the ## Acceptance Criteria section
For each criterion: a. Verify it via Chrome DevTools MCP, code inspection, or CI check results b. If it passes, mark the checkbox:
...
The script uses gh (which picks up the active App token via GH_TOKEN_FILE), so edits appear as the configured review bot
Important Rules
