---
rating: ⭐⭐⭐
title: html-ppt-designer
url: https://skills.sh/andyhuo520/html-ppt-designer/html-ppt-designer
---

# html-ppt-designer

skills/andyhuo520/html-ppt-designer/html-ppt-designer
html-ppt-designer
Installation
...
填写应用信息（用途可填：PPT 配图）
创建后获取 Access Key
设置环境变量：export UNSPLASH_ACCESS_KEY="your-key"
ZENMUX API 申请步骤
访问 https://zenmux.ai
注册账号并登录
在控制台获取 API Key
设置环境变量：export ZENMUX_API_KEY="your-key"
🆕 v4.0 核心架构升级
设计理念转变
