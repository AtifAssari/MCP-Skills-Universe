...
url: https://skills.sh/sanky369/vibe-building-skills/frontend-orchestrator
---

# frontend-orchestrator

skills/sanky369/vibe-building-skills/frontend-orchestrator
frontend-orchestrator
Installation
...
design-foundation — Design tokens, system structure, principles
design-engineer-mindset — Bridge design and implementation, code as material
...
design-foundation — Establish tokens, system structure, component library
design-engineer-mindset — Understand code as design material
layout-system — Create responsive, accessible layout patterns
typography-system — Define type scales and hierarchy
visual-hierarchy-refactoring — Establish clear visual hierarchy through size, weight, contrast
color-system — Establish color system with accessibility in mind
component-architecture — Build reusable, well-documented components
loading-states — Design loading and empty states
error-handling-recovery — Design error states and recovery
interaction-physics — Add intentionality to animations and transitions
performance-optimization — Optimize perceived performance
accessibility-excellence — Audit and improve accessibility across all layers

Path B: Formalizing Existing Design (Inconsistent → System-Driven)

design-foundation — Document and formalize existing patterns
visual-hierarchy-refactoring — Audit and improve visual hierarchy
component-architecture — Extract and document existing components
layout-system — Audit and standardize layout patterns
typography-system — Audit and standardize typography
color-system — Audit and standardize color usage
design-engineer-mindset — Establish design-code alignment
accessibility-excellence — Audit and improve accessibility
loading-states — Standardize loading and empty states
error-handling-recovery — Standardize error handling
interaction-physics — Add intentionality to interactions
performance-optimization — Optimize perceived performance

Path C: Improving Mature System (System-Driven → Transcendent)

design-engineer-mindset — Deepen implementation fidelity
interaction-physics — Add delight and intentionality
visual-hierarchy-refactoring — Refine visual hierarchy
performance-optimization — Optimize perceived performance
loading-states — Enhance loading state design
error-handling-recovery — Enhance error state design
accessibility-excellence — Audit and enhance accessibility
typography-system — Refine typography and readability
color-system — Refine color system and theming
component-architecture — Enhance component library

Path D: Fixing Performance Issues (Slow → Responsive)

performance-optimization — Measure and optimize perceived latency
design-engineer-mindset — Understand rendering pipeline
loading-states — Implement skeleton screens and progress bars
interaction-physics — Optimize animation performance
error-handling-recovery — Improve error feedback
accessibility-excellence — Ensure accessibility during optimization

Path E: Improving Accessibility (Partial → Excellent)

accessibility-excellence — Audit and establish accessibility baseline
error-handling-recovery — Ensure error messages are accessible
loading-states — Ensure loading states are accessible
component-architecture — Build accessible components
interaction-physics — Ensure animations respect prefers-reduced-motion
visual-hierarchy-refactoring — Ensure sufficient contrast and hierarchy
typography-system — Ensure readable typography
performance-optimization — Ensure performance doesn't impact accessibility
How to Use the Orchestrator
Step 1: Assess Your Current State

Ask yourself these questions:

What's your design maturity level? (1-5)
What's your biggest pain point? (Inconsistency, performance, accessibility, interactions, etc.)
What's your primary goal? (Ship fast, improve retention, build brand love, etc.)
What's your team size and expertise? (Solo developer, junior designer, experienced team, etc.)
