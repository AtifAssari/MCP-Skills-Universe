...
rating: ⭐⭐
title: workiq
url: https://skills.sh/github/copilot-plugins/workiq
---

# workiq

skills/github/copilot-plugins/workiq
workiq
Installation
$ npx skills add https://github.com/github/copilot-plugins --skill workiq
SKILL.md
WorkIQ
