---
rating: ⭐⭐
title: newebpay-checkout
url: https://skills.sh/paid-tw/skills/newebpay-checkout
---

# newebpay-checkout

skills/paid-tw/skills/newebpay-checkout
newebpay-checkout
Installation
...
encrypt(data) - AES256 加密
decrypt(data) - AES256 解密
generateSha(tradeInfo) - SHA256 簽章
createOrder(orderData) - 建立訂單並回傳表單資料
handleNotify(payload) - 處理回調通知
Step 4: 建立支付表單頁面
...
使用測試環境 https://ccore.newebpay.com
