...
url: https://skills.sh/krzysztofsurdy/code-virtuoso/ticket-delivery
---

# ticket-delivery

skills/krzysztofsurdy/code-virtuoso/ticket-delivery
ticket-delivery
Installation
...
Version control -- Bitbucket / GitHub / GitLab? CLI tool (gh, glab)? Main branch name?
Error tracking -- Bugsnag / Datadog / Sentry / none? Integration tool name?
...
CI/CD hooks -- Pre-commit hooks to skip? (e.g., SKIP=lint,test git commit)
Testing framework -- Go test / Jest / PHPUnit / pytest / RSpec / other? TDD style preference (London / Chicago)?
...
Write the test
Run it to confirm it fails: $TEST_COMMAND path/to/TestFile
...
Run the specific test: $TEST_COMMAND path/to/TestFile
Confirm it passes
Step 6.3 -- Refactor

After tests pass:

Look for duplication, unclear naming, or structural improvements
...
Reference Files
Reference	Contents
supplement-questions	Full details on each supplement question, options, follow-ups, and example entries
