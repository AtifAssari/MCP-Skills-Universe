---
rating: ⭐⭐⭐⭐⭐
title: ln-512-manual-tester
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-512-manual-tester
---

# ln-512-manual-tester

skills/levnikolaevich/claude-code-skills/ln-512-manual-tester
ln-512-manual-tester
Installation
...
Read docs/project/runbook.md — get Docker commands, API base URL, test prerequisites, environment setup
