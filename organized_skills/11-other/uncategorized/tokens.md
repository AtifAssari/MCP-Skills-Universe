...
rating: ⭐⭐
title: tokens
url: https://skills.sh/aibtcdev/skills/tokens
---

# tokens

skills/aibtcdev/skills/tokens
tokens
Installation
$ npx skills add https://github.com/aibtcdev/skills --skill tokens
SKILL.md
Tokens Skill
...
Supports well-known tokens by symbol: sBTC, USDCx, ALEX, DIKO Or use the full contract ID: SP2...address.contract-name
