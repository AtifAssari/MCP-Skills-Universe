...
rating: ⭐⭐⭐
title: one-way-door
url: https://skills.sh/jamditis/claude-skills-journalism/one-way-door
---

# one-way-door

skills/jamditis/claude-skills-journalism/one-way-door
one-way-door
Installation
$ npx skills add https://github.com/jamditis/claude-skills-journalism --skill one-way-door
SKILL.md
One-way door check
...
The hook intercepts every Write tool call (new file creation)
It extracts the file path and checks it against known one-way-door patterns
If the file matches, the hook exits with code 2 (block) and sends a message to stderr
Claude receives the block message and must use AskUserQuestion to discuss the decision with the user
Two-way door files pass through silently (exit 0)
