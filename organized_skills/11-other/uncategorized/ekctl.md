...
rating: ⭐⭐⭐
title: ekctl
url: https://skills.sh/mcoquet/mac-calendar-ekctl/ekctl
---

# ekctl

skills/mcoquet/mac-calendar-ekctl/ekctl
ekctl
Installation
...
Workflow
First run: List calendars to get IDs: ekctl list calendars
Set aliases for frequently used calendars: ekctl alias set work <id>
Use aliases in commands: ekctl list events --calendar work --from ... --to ...
