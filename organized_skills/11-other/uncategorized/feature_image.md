...
rating: ⭐⭐
title: feature-image
url: https://skills.sh/shpigford/skills/feature-image
---

# feature-image

skills/shpigford/skills/feature-image
feature-image
Installation
$ npx skills add https://github.com/shpigford/skills --skill feature-image
SKILL.md
...
6.3: Typography
Font imports (search for @import with font URLs, @font-face, or Google Fonts links)
Tailwind fontFamily config
CSS font-family declarations on body/headings
Package.json for font packages (e.g., @fontsource/*, next/font)
