---
rating: ⭐⭐⭐
title: sentry-elixir-sdk
url: https://skills.sh/getsentry/sentry-for-ai/sentry-elixir-sdk
---

# sentry-elixir-sdk

skills/getsentry/sentry-for-ai/sentry-elixir-sdk
sentry-elixir-sdk
Installation
...
Set config :sentry, log_level: :debug for verbose SDK output
Verify SENTRY_DSN is set and the project exists
Confirm :environment_name is not set to a value Sentry filters in your alert rules
Phase 4: Cross-Link
