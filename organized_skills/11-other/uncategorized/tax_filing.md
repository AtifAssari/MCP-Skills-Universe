...
rating: ⭐⭐
title: tax-filing
url: https://skills.sh/robbalian/claude-tax-filing/tax-filing
---

# tax-filing

skills/robbalian/claude-tax-filing/tax-filing
tax-filing
Installation
$ npx skills add https://github.com/robbalian/claude-tax-filing --skill tax-filing
SKILL.md
Tax Filing Skill
...
NEVER read the same document twice. Save extracted figures to work/tax_data.txt on first read.
Run field discovery ONCE per form as a bulk JSON dump to work/. Do NOT use --search repeatedly.
Save all computed values to work/computations.txt so they survive compaction.
Workflow
