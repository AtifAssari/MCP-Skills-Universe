---
rating: ⭐⭐⭐
title: typo3-powermail
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-powermail
---

# typo3-powermail

skills/dirnbauer/webconsulting-skills/typo3-powermail
typo3-powermail
Installation
...
Compatibility: Powermail 13.x currently targets TYPO3 13.4 per Packagist — do not assume v14 until the package declares it. Examples use modern TYPO3 APIs where possible; adjust for your Core version. All examples use PHP 8.2+.
...
User submits form
Mail is saved with hidden=1
Opt-in email sent with confirmation link (HMAC-secured)
User clicks link -> optinConfirmAction unhides the mail
Receiver email sent after confirmation
11. Backend Module
...
Create records in workspace → t3ver_wsid = <ws_id>, t3ver_state = 1
Stage for review → t3ver_stage = 1
Publish via backend module or CLI → records become live (t3ver_wsid = 0)
