...
rating: ⭐⭐⭐⭐⭐
title: analyze-repo
url: https://skills.sh/miles990/claude-software-skills/analyze-repo
---

# analyze-repo

skills/miles990/claude-software-skills/analyze-repo
analyze-repo
Installation
...
✅ 必須遵守
完整讀取 — 確保足夠檔案進行準確分析
客觀評估 — 基於實際品質評分，避免過度樂觀或悲觀
具體量化 — 盡可能提供數字而非模糊描述
圖表正確 — 確保 Mermaid 語法正確可渲染
可行建議 — 每項建議必須具體可執行
❌ 避免事項
沒有根據的推測
過度技術術語（根據 perspective 調整）
模糊的評語（如「還不錯」、「有待改進」）
遺漏關鍵風險
參考資源
