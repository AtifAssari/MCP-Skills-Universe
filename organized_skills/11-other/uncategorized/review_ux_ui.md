...
rating: ⭐⭐⭐
title: review-ux-ui
url: https://skills.sh/pjt222/development-guides/review-ux-ui
---

# review-ux-ui

skills/pjt222/development-guides/review-ux-ui
review-ux-ui
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill review-ux-ui
SKILL.md
Review UX/UI
...
Expected: WCAG 2.1 AA criteria systematically checked with pass/fail per criterion. On failure: Use automated tools (axe-core, Lighthouse) for initial scan, then manual testing for criteria that require human judgement.
...
Expected: Each form assessed against the checklist with specific issues documented. On failure: If there are many forms, prioritize the highest-traffic forms (registration, checkout, contact).
