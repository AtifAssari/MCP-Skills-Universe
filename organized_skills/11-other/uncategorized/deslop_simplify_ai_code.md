---
rating: ⭐⭐⭐
title: deslop-simplify-ai-code
url: https://skills.sh/adibfirman/dotfiles/deslop-simplify-ai-code
---

# deslop-simplify-ai-code

skills/adibfirman/dotfiles/deslop-simplify-ai-code
deslop-simplify-ai-code
Installation
...
Get the code to review: via git diff, PR review, file selection, or paste — don't assume branch naming or tooling
Identify slop patterns across the entire file if it's been touched
