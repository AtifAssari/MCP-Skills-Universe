...
rating: ⭐⭐⭐
title: i18n-rtl
url: https://skills.sh/lobbi-docs/claude/i18n-rtl
---

# i18n-rtl

skills/lobbi-docs/claude/i18n-rtl
i18n-rtl
Installation
...
The CacheProvider with rtlCache wraps the app root
...
Check createTheme({ direction: 'rtl' }) is configured
Confirm CacheProvider with rtlCache wraps the app
Test all Dialogs, Menus, and Drawers open/close correctly
Verify navigation icons (arrows, chevrons) point correctly
Check form layouts and label alignment
Verify DataGrid column order and sort icons
Test text truncation with ellipsis in RTL
Check absolute/fixed positioned elements
Verify scrollbar position (should be on the left in RTL)
Weekly Installs
9
Repository
lobbi-docs/claude
