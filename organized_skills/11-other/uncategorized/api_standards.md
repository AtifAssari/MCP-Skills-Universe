...
rating: ⭐⭐
title: api standards
url: https://skills.sh/maxritter/claude-codepro/api-standards
---

# api standards

skills/maxritter/claude-codepro/API Standards
API Standards
Installation
$ npx skills add https://github.com/maxritter/claude-codepro --skill 'API Standards'
SKILL.md
API Standards
