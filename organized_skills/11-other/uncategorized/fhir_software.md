...
rating: ⭐⭐⭐
title: fhir-software
url: https://skills.sh/topologyhealth/claudefhirskill/fhir-software
---

# fhir-software

skills/topologyhealth/claudefhirskill/fhir-software
fhir-software
Installation
$ npx skills add https://github.com/topologyhealth/claudefhirskill --skill fhir-software
SKILL.md
...
Key Rules
Declare slices before constraining them — contains rule must precede slice-specific rules
Declare extensions before constraining sub-elements — same ordering requirement
fsh-generated/ is owned by SUSHI — never edit it; it is deleted and regenerated on each build
Caret (^) rules are forbidden in Instances — use them only in Profiles, Extensions, ValueSets, CodeSystems
