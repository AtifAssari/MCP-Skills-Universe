...
rating: ⭐⭐
title: openmaic
url: https://skills.sh/thu-maic/openmaic/openmaic
---

# openmaic

skills/thu-maic/openmaic/openmaic
openmaic
Installation
$ npx skills add https://github.com/thu-maic/openmaic --skill openmaic
SKILL.md
OpenMAIC Skill
...
Use hosted OpenMAIC (recommended for quick start) — Requires an access code from open.maic.chat. No local setup needed.
