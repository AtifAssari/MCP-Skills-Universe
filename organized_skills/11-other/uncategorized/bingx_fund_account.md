---
rating: ⭐⭐⭐
title: bingx-fund-account
url: https://skills.sh/bingx-api/api-ai-skills/bingx-fund-account
---

# bingx-fund-account

skills/bingx-api/api-ai-skills/bingx-fund-account
bingx-fund-account
Installation
...
Ask for coin (e.g., USDT) and amount.
...
If phone number: ask for calling code (e.g., 86 for China).
Ask for source wallet:
