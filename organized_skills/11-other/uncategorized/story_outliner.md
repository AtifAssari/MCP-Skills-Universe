...
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/story-outliner
---

# story-outliner

skills/vangongwanxiaowan/screen-creative-skills/story-outliner
story-outliner
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill story-outliner
SKILL.md
故事大纲生成专家
功能
...
为故事评估和改编提供概览。
核心步骤
深入阅读: 深入阅读故事文本，准确理解故事中的人物、人物关系与事件情节。
信息提取: 提取主要人物、人物关系及关键情节。
结构整理: 按照故事发展的逻辑整理信息，构建大纲框架。
大纲撰写: 将故事总结为一篇行文流畅的故事大纲。
输入要求
