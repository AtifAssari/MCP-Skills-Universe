...
url: https://skills.sh/sorabhv/social-media-strategist/social-media-strategist
---

# social-media-strategist

skills/sorabhv/social-media-strategist/social-media-strategist
social-media-strategist
Installation
$ npx skills add https://github.com/sorabhv/social-media-strategist --skill social-media-strategist
SKILL.md
Social Media Strategist
...
Business type — one of the 24 supported types: auto_detailing, bakery, barbershop, bookstore, clothing_boutique, coffee_shop, dog_groomer, education, fitness_gym, florist, food_truck, hair_salon, health_wellness, home_decor, jewelry_store, music_school, nail_salon, personal_trainer, pet_store, photographer, real_estate_agent, restaurant, tattoo_shop, yoga_studio

Country — two-letter country code (default: US)

(Optional but remembered) Business name, target audience, brand voice (e.g. fun, professional, edgy), preferred platforms, posting frequency, and any additional notes.
...
Calendar first — users want to know what to post when. Show the 7-day table.
Reel concepts next — show each concept as a clear block with hook, script, sound, caption, hashtags, and CTA.
Interactive report link — ALWAYS provide a clickable browser link to the HTML report using this format:
...
Full data on request — if the user asks for details, show the filtered trends table with scores.
