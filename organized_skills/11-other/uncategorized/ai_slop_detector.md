...
url: https://skills.sh/nicepkg/ai-workflow/ai-slop-detector
---

# ai-slop-detector

skills/nicepkg/ai-workflow/ai-slop-detector
ai-slop-detector
Installation
...
Scan the text for patterns listed below
Rewrite each flagged section using the suggested fixes
Output the cleaned text immediately - no preamble, no explanation
...
The text to clean is the draft just generated
Process it immediately
Return the cleaned version for the calling skill to present
...
No promotional language about "rich heritage" or "cultural significance"
...
No direct contrast formulations ("This isn't X—it's Y")
No throat-clearing openers ("Here's the thing", "Let me be clear")
No emphasis crutches ("That's it. That's the [noun].")
Varied paragraph lengths (not all one-sentence or all same length)
Output Format
