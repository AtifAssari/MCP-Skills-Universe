...
rating: ⭐⭐⭐
title: dev-builder
url: https://skills.sh/zinohome/cozyengine/dev-builder
---

# dev-builder

skills/zinohome/cozyengine/dev-builder
dev-builder
Installation
$ npx skills add https://github.com/zinohome/cozyengine --skill dev-builder
SKILL.md
