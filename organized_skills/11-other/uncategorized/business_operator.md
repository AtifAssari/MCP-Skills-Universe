...
url: https://skills.sh/shipshitdev/library/business-operator
---

# business-operator

skills/shipshitdev/library/business-operator
business-operator
Installation
$ npx skills add https://github.com/shipshitdev/library --skill business-operator
SKILL.md
...
Revenue Potential (1-10): How much can this make?
Current Traction (1-10): Is it already working?
Effort Required (1-10, inverted): How much of YOUR time does it need?
Leverage (1-10): Does it scale without you?
...
Could a single change (offer, price, channel) fix this?
Would I start this business today knowing what I know?
Is my emotional attachment clouding judgment?
Best Practices
Weekly Reviews: Run a portfolio check every week
One Primary: Never have two businesses at "primary focus"
Time Tracking: Actually track hours to validate effort scores
Quarterly Kills: Review what to kill every quarter
Stack Rankings: Always rank, never tie - forces prioritization
Exit Criteria: Define what would make you kill each business upfront
When to Escalate
