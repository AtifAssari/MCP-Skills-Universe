...
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/paid-advertising
---

# paid-advertising

skills/indranilbanerjee/digital-marketing-pro/paid-advertising
paid-advertising
Installation
...
Define objectives -- Clarify the primary KPI and success metric. Map to the correct campaign type per platform.
Audience architecture -- Design the full-funnel audience strategy: cold prospecting segments, warm retargeting pools, and hot remarketing lists. Define exclusions.
Campaign structure -- Build the campaign hierarchy with naming conventions. Determine budget allocation across campaigns.
Bid strategy selection -- Choose the appropriate bid strategy based on data maturity, conversion volume, and goals. Reference bid-strategy.md for decision trees.
Creative strategy -- Define ad formats, messaging angles, and creative variations. Map creative to funnel stage and audience segment.
Tracking validation -- Confirm pixel/tag setup, conversion actions, and attribution model before launch.
Launch plan -- Set launch budgets (often lower than steady-state), define learning phase expectations, and establish the first optimization checkpoint (typically 7-14 days).
Optimization cadence -- Define weekly/biweekly optimization actions: bid adjustments, audience refinements, creative refreshes, budget reallocation.
Campaign Audit Process
Account structure review -- Assess campaign organization, naming conventions, and segmentation logic.
Audience overlap analysis -- Check for audience fragmentation or cannibalization across campaigns.
Bid strategy assessment -- Evaluate whether current bid strategies match conversion volume and goals.
Creative performance -- Identify top/bottom performers, creative fatigue signals, and testing gaps.
Budget efficiency -- Analyze spend distribution vs performance distribution. Flag underspending winners and overspending losers.
Tracking audit -- Verify conversion tracking accuracy, attribution consistency, and data freshness.
Reference Files
