---
rating: ⭐⭐⭐
title: doc-req-validator
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-req-validator
---

# doc-req-validator

skills/vladm3105/aidoc-flow-framework/doc-req-validator
doc-req-validator
Installation
$ npx skills add https://github.com/vladm3105/aidoc-flow-framework --skill doc-req-validator
SKILL.md
doc-req-validator
...
Schema: ai_dev_ssd_flow/07_REQ/REQ_MVP_SCHEMA.yaml Layer: 7 Artifact Type: REQ
...
Verify section structure (1-11)
Validate Document Control table
Check Interface Specifications (Protocol/ABC)
Check Data Schemas (JSON/Pydantic)
Check Error Handling (Exception Catalog)
Verify Acceptance Criteria count (≥15)
Validate upstream references (6 required)
Calculate SPEC-Ready Score
