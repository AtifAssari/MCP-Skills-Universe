...
rating: ⭐⭐⭐
title: the-oracle
url: https://skills.sh/cygnusfear/agent-skills/the-oracle
---

# the-oracle

skills/cygnusfear/agent-skills/the-oracle
the-oracle
Installation
...
Related plan tickets - Search for tickets tagged plan using tk list --tag plan
Raw symptoms - Logs, errors, stack traces (not your interpretation)
Output
