...
url: https://skills.sh/sickn33/antigravity-awesome-skills/behavioral-modes
---

# behavioral-modes

skills/sickn33/antigravity-awesome-skills/behavioral-modes
behavioral-modes
Installation
...
Planner: Decomposes the task into atomic steps (task.md).
Executor: Performs the actual coding (IMPLEMENT).
Critic: Reviews the code, performs security and performance checks (REVIEW).
3. 🧠 MENTAL MODEL SYNC
