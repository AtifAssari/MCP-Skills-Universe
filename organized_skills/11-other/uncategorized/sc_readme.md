...
rating: ⭐⭐⭐
title: sc-readme
url: https://skills.sh/tony363/superclaude/sc-readme
---

# sc-readme

skills/tony363/superclaude/sc-readme
sc-readme
Installation
...
Behavioral Flow
DISCOVER - Run git diff or git log to find changed files
...
Only modify .md files in the documented scope
Git-based rollback always available via git checkout
Related Skills
