---
rating: ⭐⭐⭐
title: xiaomi-cam-snapshot
url: https://skills.sh/tiancheng91/skills/xiaomi-cam-snapshot
---

# xiaomi-cam-snapshot

skills/tiancheng91/skills/xiaomi-cam-snapshot
xiaomi-cam-snapshot
Installation
$ npx skills add https://github.com/tiancheng91/skills --skill xiaomi-cam-snapshot
SKILL.md
小米摄像头截图技能
...
密码: 保存到 MILOCO_PASSWORD 环境变量或配置文件
摄像头列表: 记录摄像头 ID 和名称的对应关系
