...
rating: ⭐⭐⭐
title: omni-ai-eval
url: https://skills.sh/exploreomni/omni-agent-skills/omni-ai-eval
---

# omni-ai-eval

skills/exploreomni/omni-agent-skills/omni-ai-eval
omni-ai-eval
Installation
...
Workflow
Run eval suite with configuration A → save as results_a.jsonl
Run eval suite with configuration B → save as results_b.jsonl
...
Docs Reference
AI API · Query API · Models API · Optimizing Models for AI
Related Skills
