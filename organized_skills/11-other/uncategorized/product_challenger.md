...
url: https://skills.sh/guangtouwangba/weaver/product-challenger
---

# product-challenger

skills/guangtouwangba/weaver/product-challenger
product-challenger
Installation
...
Design Workflow
快速验证：用 1-2 个问题确认核心需求
交互流程：用 Mermaid flowchart 画用户路径
布局设计：用 ASCII 线框图表达
关键交互：说明 hover/点击/状态变化
设计决策：解释为什么这样设计
