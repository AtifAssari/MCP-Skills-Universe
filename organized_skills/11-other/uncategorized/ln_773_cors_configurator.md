---
rating: ⭐⭐
title: ln-773-cors-configurator
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-773-cors-configurator
---

# ln-773-cors-configurator

skills/levnikolaevich/claude-code-skills/ln-773-cors-configurator
ln-773-cors-configurator
Installation
...
Check for frontend in same repository (/frontend, /client, /web)
Read .env or appsettings.json for CORS_ORIGINS
