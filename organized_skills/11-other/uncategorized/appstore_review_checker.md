---
rating: ⭐⭐⭐
title: appstore-review-checker
url: https://skills.sh/luongnv89/skills/appstore-review-checker
---

# appstore-review-checker

skills/luongnv89/skills/appstore-review-checker
appstore-review-checker
Installation
$ npx skills add https://github.com/luongnv89/skills --skill appstore-review-checker
SKILL.md
...
Without Subagent Tool (Fallback): If Agent is not available, the skill still runs a complete audit in a single conversation, though without the structured intermediate data format. The end result (APPSTORE_AUDIT.md report) is the same.
