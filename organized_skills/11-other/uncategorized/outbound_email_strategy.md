---
rating: ⭐⭐
title: outbound-email-strategy
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/outbound-email-strategy
---

# outbound-email-strategy

skills/manojbajaj95/claude-gtm-plugin/outbound-email-strategy
outbound-email-strategy
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill outbound-email-strategy
SKILL.md
Outbound Email Strategy
