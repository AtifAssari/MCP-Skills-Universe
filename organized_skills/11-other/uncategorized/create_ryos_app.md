---
rating: ⭐⭐⭐
title: create-ryos-app
url: https://skills.sh/ryokun6/ryos/create-ryos-app
---

# create-ryos-app

skills/ryokun6/ryos/create-ryos-app
create-ryos-app
Installation
...
Sync other locales (e.g. bun run scripts/sync-translations.ts --mark-untranslated).
