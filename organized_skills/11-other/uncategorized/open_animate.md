...
rating: ⭐⭐
title: open-animate
url: https://skills.sh/jacobcwright/open-animate/open-animate
---

# open-animate

skills/jacobcwright/open-animate/open-animate
open-animate
Installation
$ npx skills add https://github.com/jacobcwright/open-animate --skill open-animate
SKILL.md
