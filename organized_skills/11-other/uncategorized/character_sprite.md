...
url: https://skills.sh/paulrobello/claude-office/character-sprite
---

# character-sprite

skills/paulrobello/claude-office/character-sprite
character-sprite
Installation
...
FFmpeg geq filter: Removes pixels where R≈B and G is low (purple/magenta hues)
ImageMagick multi-pass: Catches remaining bright magenta shades
...
Try increasing fuzz value: -fuzz 45% or -fuzz 50% (but watch for character edge erosion above 50%)
If that erodes character edges, reduce fuzz and manually check the raw image
Raw images with anti-aliased edges against magenta will always have fringing issues - regenerate the raw image with stronger "NO ANTI-ALIASING" emphasis
