...
rating: ⭐⭐⭐
title: fmp-api
url: https://skills.sh/adaptationio/skrillz/fmp-api
---

# fmp-api

skills/adaptationio/skrillz/fmp-api
fmp-api
Installation
...
Extended hours data
Unique FMP Features
Pre-computed DCF - Ready-to-use valuations
Congressional Trading - Senate/House STOCK Act data
13F Filings - Institutional holdings analysis
Standardized Financials - Normalized line items
Company Outlook - All data in one endpoint
Rating System - Proprietary company ratings
Best Practices
Use stable endpoints - /stable/ not /api/v3/
Cache static data - Profiles, historical data
Monitor daily limits - 250 calls goes fast
Batch symbol lookups - Where supported
Store financials - They only update quarterly
Use company-outlook - Single call for all data
Installation
