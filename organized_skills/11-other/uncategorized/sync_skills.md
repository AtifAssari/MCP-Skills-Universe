...
rating: ⭐⭐⭐
title: sync-skills
url: https://skills.sh/chujianyun/skills/sync-skills
---

# sync-skills

skills/chujianyun/skills/sync-skills
sync-skills
Installation
$ npx skills add https://github.com/chujianyun/skills --skill sync-skills
SKILL.md
Sync Skills
...
必须包含 ~/.agents/skills 作为同步目标（不存在则自动创建）
必须使用 AskUserQuestion 让用户选择目标目录
展示同步计划 并等待用户最终确认
同名 skill 直接覆盖，不单独提示
When to Use
...
不使用 AskUserQuestion	必须使用让用户选择目标
不展示同步计划	必须展示并等待用户确认
