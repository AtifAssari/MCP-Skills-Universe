---
rating: ⭐⭐
title: amazon-video-downloader
url: https://skills.sh/serpdownloaders/skills/amazon-video-downloader
---

# amazon-video-downloader

skills/serpdownloaders/skills/amazon-video-downloader
amazon-video-downloader
Installation
$ npx skills add https://github.com/serpdownloaders/skills --skill amazon-video-downloader
SKILL.md
...
Open Prime Video's web player and sign in to your Amazon account.
Navigate to the movie, series, or episode you want to save.
Begin playback so the browser loads the video stream.
Open the extension popup to see the detected video source.
Select the title or episode you want to export.
...
When will Amazon Video Downloader be released? A release date has not been set. Sign up at the waitlist link above to be notified as soon as it is available.

Will it work with the Prime Video desktop app? No. This extension is built for the Prime Video web player in the browser, not the standalone desktop or mobile application.

What video quality will it support? Quality will depend on what the Prime Video web player delivers to the browser, which can vary by title, account plan, and browser capabilities.

Will it preserve title metadata? The plan is to embed title, season, episode number, and description metadata in exported files where that information is available from the page.

Is it free? Pricing details will be announced closer to launch. SERP extensions typically include a free trial period.

Can I download an entire season at once? Batch episode downloading is a planned feature, though the exact implementation will depend on browser and playback constraints.
