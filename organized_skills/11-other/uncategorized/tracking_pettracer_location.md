---
rating: ⭐⭐
title: tracking-pettracer-location
url: https://skills.sh/tristanmanchester/agent-skills/tracking-pettracer-location
---

# tracking-pettracer-location

skills/tristanmanchester/agent-skills/tracking-pettracer-location
tracking-pettracer-location
Installation
...
Use PETTRACER_TOKEN if already available.
Else login with PETTRACER_USERNAME + PETTRACER_PASSWORD (or PETTRACER_EMAIL).
