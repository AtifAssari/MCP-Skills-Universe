...
url: https://skills.sh/cloudai-x/claude-workflow-v2/devops-infrastructure
---

# devops-infrastructure

skills/cloudai-x/claude-workflow-v2/devops-infrastructure
devops-infrastructure
Installation
$ npx skills add https://github.com/cloudai-x/claude-workflow-v2 --skill devops-infrastructure
SKILL.md
DevOps & Infrastructure
When to Load
