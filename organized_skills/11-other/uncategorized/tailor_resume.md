...
rating: ⭐⭐
title: tailor-resume
url: https://skills.sh/proficientlyjobs/proficiently-claude-skills/tailor-resume
---

# tailor-resume

skills/proficientlyjobs/proficiently-claude-skills/tailor-resume
tailor-resume
Installation
...
Is there filler? Cut any phrase that doesn't add information. "Demonstrating ability to identify and execute on AI-driven product opportunities from ideation through production" → "Built an AI product from idea to production."
Are there stacked buzzwords? "Cross-functional, data-driven, customer-centric leadership" → pick the one that matters for this job and give a concrete example.
...
Tailored Resume — the full resume text
Tailoring Notes — key changes made (reordered bullets, rewritten sections, added content from profile) and the narrative pitch
What's Next — suggest iterating on tone/emphasis, or writing a cover letter with /proficiently:cover-letter
