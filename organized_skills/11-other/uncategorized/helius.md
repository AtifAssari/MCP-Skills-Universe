...
rating: ⭐⭐
title: helius
url: https://skills.sh/raintree-technology/claude-starter/helius
---

# helius

skills/raintree-technology/claude-starter/helius
helius
Installation
$ npx skills add https://github.com/raintree-technology/claude-starter --skill helius
SKILL.md
...
Use RPC URL: https://mainnet.helius-rpc.com/?api-key=YOUR_API_KEY
