...
url: https://skills.sh/jamditis/claude-skills-journalism/source-verification
---

# source-verification

skills/jamditis/claude-skills-journalism/source-verification
source-verification
Installation
$ npx skills add https://github.com/jamditis/claude-skills-journalism --skill source-verification
SKILL.md
