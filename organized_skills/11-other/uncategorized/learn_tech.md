...
rating: ⭐⭐
title: learn-tech
url: https://skills.sh/unix2dos/skills/learn-tech
---

# learn-tech

skills/unix2dos/skills/learn-tech
learn-tech
Installation
$ npx skills add https://github.com/unix2dos/skills --skill learn-tech
SKILL.md
技术知识学习
...
保存目录：learn-tech_outputs/（若不存在则创建）
文件命名：{YYYY-MM-DD}_{学习主题}.md
...
"需要导入 context、fmt、time 三个包。核心代码如下：" 然后代码块只包含 func main() 的内容
