...
rating: ⭐⭐⭐
title: cs-decide
url: https://skills.sh/liuzhengdongfortest/codestable/cs-decide
---

# cs-decide

skills/liuzhengdongfortest/codestable/cs-decide
cs-decide
Installation
...
architecture/ARCHITECTURE.md 的"关键架构决定"节是否应引用——architecture 或 tech-stack 通常应该
AGENTS.md 的"禁止事项"或"代码规范"节是否应追加——constraint 或 convention 通常应该
搜索工具
