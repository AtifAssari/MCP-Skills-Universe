---
rating: ⭐⭐⭐
title: create-beads-orchestration
url: https://skills.sh/avivk5498/the-claude-protocol/create-beads-orchestration
---

# create-beads-orchestration

skills/avivk5498/the-claude-protocol/create-beads-orchestration
create-beads-orchestration
Installation
...
Tell me "Continue orchestration setup" or run /create-beads-orchestration again
I will run the discovery agent to complete setup
...
Verify bootstrap completed (check for .claude/agents/scout.md) - already done in Step 0
