---
rating: ⭐⭐⭐
title: implementing-dapper-queries
url: https://skills.sh/bitwarden/ai-plugins/implementing-dapper-queries
---
...
Workflow
Define/update the stored procedure in src/Sql/dbo/Stored Procedures/ — use plain CREATE PROCEDURE (SSDT syntax)
Create a migration script in util/Migrator/DbScripts/ that deploys it — use CREATE OR ALTER PROCEDURE (idempotent)
