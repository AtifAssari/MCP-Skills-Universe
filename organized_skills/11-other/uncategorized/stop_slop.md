...
rating: ⭐⭐
title: stop-slop
url: https://skills.sh/alfredolopez80/multi-agent-ralph-loop/stop-slop
---

# stop-slop

skills/alfredolopez80/multi-agent-ralph-loop/stop-slop
stop-slop
Installation
$ npx skills add https://github.com/alfredolopez80/multi-agent-ralph-loop --skill stop-slop
SKILL.md
Stop Slop
...
Scan for banned phrases — Remove throat-clearing openers
Fix structural clichés — Break binary contrasts, reduce tripling
Check rhythm — Vary sentence length and structure
Respect trust — Don't over-explain, don't state obvious
Verify authenticity — Does it sound like a human wrote it?
Trim density — Cut anything that doesn't add value
What to Remove
