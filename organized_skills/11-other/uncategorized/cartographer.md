...
rating: ⭐⭐⭐⭐⭐
title: cartographer
url: https://skills.sh/kingbootoshi/cartographer/cartographer
---

# cartographer

skills/kingbootoshi/cartographer/cartographer
cartographer
Installation
...
Update last_mapped timestamp (run date -u +"%Y-%m-%dT%H:%M:%SZ" to get actual time)
