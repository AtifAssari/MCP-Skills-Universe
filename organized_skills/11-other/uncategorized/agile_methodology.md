...
url: https://skills.sh/dralgorhythm/claude-agentic-framework/agile-methodology
---

# agile-methodology

skills/dralgorhythm/claude-agentic-framework/agile-methodology
agile-methodology
Installation
$ npx skills add https://github.com/dralgorhythm/claude-agentic-framework --skill agile-methodology
SKILL.md
Agile Methodology
Agile Principles
