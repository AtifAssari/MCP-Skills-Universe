---
rating: ⭐⭐
title: commit-pr-contract
url: https://skills.sh/dbvc/skills/commit-pr-contract
---

# commit-pr-contract

skills/dbvc/skills/commit-pr-contract
commit-pr-contract
Installation
$ npx skills add https://github.com/dbvc/skills --skill commit-pr-contract
SKILL.md
Commit/PR Contract
目标
...
使用四块结构（中文标题）：
做了什么/为什么（What/Why）
证明它可行（Proof it works）
风险与 AI 参与（Risk + AI role）
评审关注点（Review focus）
