---
rating: ⭐⭐⭐
title: spec-kit-tasks
url: https://skills.sh/ahgraber/skills/spec-kit-tasks
---

# spec-kit-tasks

skills/ahgraber/skills/spec-kit-tasks
spec-kit-tasks
Installation
...
[P] marker: Include ONLY if the task is parallelizable (different files, no dependencies on incomplete tasks).
