...
rating: ⭐⭐
title: design-draft
url: https://skills.sh/l3digital-net/claude-code-plugins/design-draft
---

# design-draft

skills/l3digital-net/claude-code-plugins/design-draft
design-draft
Installation
$ npx skills add https://github.com/l3digital-net/claude-code-plugins --skill design-draft
SKILL.md
