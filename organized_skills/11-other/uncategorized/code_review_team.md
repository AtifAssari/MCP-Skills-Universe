...
url: https://skills.sh/khw1031/ai-library/code-review-team
---

# code-review-team

skills/khw1031/ai-library/code-review-team
code-review-team
Installation
$ npx skills add https://github.com/khw1031/ai-library --skill code-review-team
SKILL.md
...
경로: .ai/tasks/{TICKET_ID}/review.md 형식: 리뷰 문서 템플릿
...
Worker들이 작업을 완료하면 SendMessage로 결과를 보고합니다. 자동으로 수신됩니다. 모든 Worker의 보고가 도착할 때까지 대기합니다.
