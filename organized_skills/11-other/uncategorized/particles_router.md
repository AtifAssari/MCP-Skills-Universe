---
rating: ⭐⭐
title: particles-router
url: https://skills.sh/bbeierle12/skill-mcp-claude/particles-router
---

# particles-router

skills/bbeierle12/skill-mcp-claude/particles-router
particles-router
Installation
...
Performance concern — "millions of particles" → particles-gpu first
Motion type — "swirling", "attracted to" → particles-physics
Emission pattern — "burst", "continuous", "trails" → particles-lifecycle
Default — All three skills usually needed together
Confidence Scoring
