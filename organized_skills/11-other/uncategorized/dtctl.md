...
rating: ⭐⭐⭐
title: dtctl
url: https://skills.sh/dynatrace-oss/dtctl/dtctl
---

# dtctl

skills/dynatrace-oss/dtctl/dtctl
dtctl
Installation
...
First consult references/DQL-reference.md
Build/validate the query using the documented patterns
Execute with dtctl query ... -o json --plain (or dtctl wait query ... when waiting for results)
# Inline query
