---
rating: ⭐⭐⭐
title: obsidian-markdown-mastery
url: https://skills.sh/richfrem/agent-plugins-skills/obsidian-markdown-mastery
---

# obsidian-markdown-mastery

skills/richfrem/agent-plugins-skills/obsidian-markdown-mastery
obsidian-markdown-mastery
Installation
...
Extracts all Obsidian-specific metadata (links, embeds, blocks) from a given markdown file or string. Command: python ./parser.py analyze --file <path_to_md>

Inject Callout

Wraps a target text block in an Obsidian-flavored callout. Command: python ./parser.py callout --type <type> --title <title> --text <content>
