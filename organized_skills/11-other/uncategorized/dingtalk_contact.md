---
rating: ⭐⭐⭐
title: dingtalk-contact
url: https://skills.sh/breath57/dingtalk-skills/dingtalk-contact
---

# dingtalk-contact

skills/breath57/dingtalk-skills/dingtalk-contact
dingtalk-contact
Installation
...
获取 Token → 直接调用 bash scripts/dt_helper.sh
执行操作 → 复杂的创建临时文件再执行，简单的直接执行；禁止 heredoc
按任务校验配置（必须先做）
