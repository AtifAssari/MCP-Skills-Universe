---
rating: ⭐⭐
title: workflow-brainstorm
url: https://skills.sh/heyvhuang/ship-faster/workflow-brainstorm
---

# workflow-brainstorm

skills/heyvhuang/ship-faster/workflow-brainstorm
workflow-brainstorm
Installation
...
Enter implementation directly (recommend workflow-ship-faster or workflow-feature-shipper)
Write implementation plan first (persist as checklist items in run_dir/tasks.md, then wait for confirmation)
Need research/code reading first (split to run_dir/evidence/parallel/<task-name>/ and do in parallel)
Key Principles
