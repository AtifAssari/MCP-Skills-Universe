---
rating: ⭐⭐⭐
title: dot-ai-prd-create
url: https://skills.sh/vfarcic/dot-ai/dot-ai-prd-create
---

# dot-ai-prd-create

skills/vfarcic/dot-ai/dot-ai-prd-create
dot-ai-prd-create
Installation
$ npx skills add https://github.com/vfarcic/dot-ai --skill dot-ai-prd-create
SKILL.md
...
Create PRD File: Detailed document using actual issue ID: prds/[issue-id]-[feature-name].md
Update GitHub Issue: Add link to PRD file now that filename is known
