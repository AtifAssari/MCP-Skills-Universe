...
rating: ⭐⭐⭐
title: testing-qa
url: https://skills.sh/jmsktm/claude-settings/testing-qa
---

# testing-qa

skills/jmsktm/claude-settings/testing-qa
testing-qa
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill testing-qa
SKILL.md
Testing & QA Skill
Overview
