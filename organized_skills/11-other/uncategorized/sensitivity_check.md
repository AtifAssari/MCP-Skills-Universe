...
url: https://skills.sh/jwynia/agent-skills/sensitivity-check
---

# sensitivity-check

skills/jwynia/agent-skills/sensitivity-check
sensitivity-check
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill sensitivity-check
SKILL.md
...
Pattern: {story}-sensitivity-{date}.md Example: novel-sensitivity-2025-01-15.md
