...
rating: ⭐⭐⭐
title: blog-post
url: https://skills.sh/jim60105/blog/blog-post
---

# blog-post

skills/jim60105/blog/blog-post
blog-post
Installation
$ npx skills add https://github.com/jim60105/blog --skill blog-post
SKILL.md
...
Is there English term appears multiple times? Present the original term with its Chinese equivalent the first time, then use only the Chinese version thereafter.
Is there any chat shortcode that violates the rules (starting with 「所以」「對，」 or similar, or not ending with two spaces)?
Are all URLs correctly linked to the cited paper or source?
