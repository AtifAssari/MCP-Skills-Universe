---
rating: ⭐⭐
title: drama-analyzer
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/drama-analyzer
---

# drama-analyzer

skills/vangongwanxiaowan/screen-creative-skills/drama-analyzer
drama-analyzer
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill drama-analyzer
SKILL.md
剧本分析专家
功能
...
学习优秀作品的戏剧结构和情节设计技巧
核心步骤
深度阅读: 充分阅读和理解故事文本内容，把握整体结构和主题
情节点识别: 根据情节点定义，识别并总结故事中的主要情节点
戏剧功能分析: 深入分析每个情节点在故事中的戏剧作用、推动力和情感影响
结构化输出: 按照指定格式输出分析结果，确保清晰准确
输入要求
