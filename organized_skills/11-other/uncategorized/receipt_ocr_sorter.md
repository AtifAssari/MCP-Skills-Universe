---
rating: ⭐⭐⭐
title: receipt-ocr-sorter
url: https://skills.sh/aktsmm/agent-skills/receipt-ocr-sorter
---

# receipt-ocr-sorter

skills/aktsmm/agent-skills/receipt-ocr-sorter
receipt-ocr-sorter
Installation
...
Core Workflow
入力フォルダの画像 / PDF / ZIP / 動画を受け取る
OCR で日付・金額・国・カード・用途を抽出する
品質補正をかけて標準ファイル名へ正規化する
プロジェクト単位で仕分ける
Markdown サマリーを出す
Architecture
...
国コード一覧、分類一覧、D365 カテゴリ対応、添付手順は references/d365-expense-guide.md を参照。
...
詳細は references/d365-expense-guide.md を参照。
