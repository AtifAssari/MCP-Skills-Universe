...
url: https://skills.sh/tencentcloudbase/skills/data-model-creation
---

# data-model-creation

skills/tencentcloudbase/skills/data-model-creation
data-model-creation
Installation
...
After modeling, hand off actual SQL/table work to relational-database-tool when needed.
Weekly Installs
728
Repository
