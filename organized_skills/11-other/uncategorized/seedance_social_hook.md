---
rating: ⭐⭐⭐
title: seedance-social-hook
url: https://skills.sh/beshuaxian/higgsfield-seedance2-jineng/seedance-social-hook
---

# seedance-social-hook

skills/beshuaxian/higgsfield-seedance2-jineng/seedance-social-hook
seedance-social-hook
Installation
$ npx skills add https://github.com/beshuaxian/higgsfield-seedance2-jineng --skill seedance-social-hook
SKILL.md
...
Using Trending Audio in Hooks: The audio should start within first 0.5 seconds. Don't let hook play silent then add audio.
...
Original Audio in Hooks: Must be high quality (good microphone, clean audio). Voiceover should sound like real person, not AI (viewer can tell the difference, and it matters for connection).
...
Version A: Curiosity gap hook (half-reveal) Version B: Emotional trigger hook (fear, awe, cute) Version C: Visual shock hook (impossible physics, color explosion)
...
Problem: Hook promises something exciting, video doesn't deliver. Example: hook shows impossible physics moment, full video is boring talking-head explanation.
...
Problem: First 2 seconds is person talking to camera with no visual interest. Example: "Hey guys, so today I want to talk about..." [SWIPE]
...
Problem: Using trending audio that doesn't match the hook's vibe. Example: sad story with upbeat dancing music.
...
Read the hook script - understand the exact timing and cuts
Film according to technical specs - shoot what's described
Edit using the checklist - follow the precise structure
Add text/audio per specifications
Use the caption and hashtags when posting
Track the metrics against predicted performance
