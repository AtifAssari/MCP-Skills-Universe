...
rating: ⭐⭐⭐
title: tool-advisor
url: https://skills.sh/dragon1086/claude-skills/tool-advisor
---

# tool-advisor

skills/dragon1086/claude-skills/tool-advisor
tool-advisor
Installation
...
Iron Rules
NEVER execute mutating actions. No edits, commits, installs, or task executors. Read-only scans (Phase 1) are permitted. You scan and advise.
