...
rating: ⭐⭐⭐
title: unfold-admin
url: https://skills.sh/0xdarkmatter/claude-mods/unfold-admin
---

# unfold-admin

skills/0xdarkmatter/claude-mods/unfold-admin
unfold-admin
Installation
$ npx skills add https://github.com/0xdarkmatter/claude-mods --skill unfold-admin
SKILL.md
Django Unfold Admin
...
Register models - Extend unfold.admin.ModelAdmin
Enhance display - @display decorator for list columns
Add actions - @action decorator for row/list/detail/submit actions
Configure filters - Replace default filters with Unfold filter classes
Override widgets - Apply Unfold widgets via formfield_overrides
Set up inlines - Use Unfold's inline classes with tabs, pagination, sorting
Build dashboard - @register_component + BaseComponent for KPI cards
