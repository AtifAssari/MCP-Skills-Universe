---
rating: ⭐⭐⭐
title: redbook-creator-publish
url: https://skills.sh/yanquankun/redbook-creator-publish/redbook-creator-publish
---

# redbook-creator-publish

skills/yanquankun/redbook-creator-publish/redbook-creator-publish
redbook-creator-publish
Installation
...
从网络下载公开图片(Unsplash/Pexels/Pixabay)
AI 生成补充(可选,如果模型无法生成则跳过)
...
读取模板:/Users/a58/.claude/skills/redbook-creator-publish/assets/preview-template.html
替换变量:
{{TITLE}} → 标题
{{CONTENT}} → 正文
{{DATE}} → 日期
...
按顺序上传图片(cover.png 第一张)
从 preview.html 复制标题和正文
添加标签
点击发布
参考文档
references/style-guide.md - 小红书内容风格规范
scripts/auto_upload_playwright.py - Playwright 自动上传脚本
assets/preview-template.html - Newsprint 风格预览模板
更新日志
v5.4 (2026-01-27)
✅ 新增精准配图关键词生成策略
✅ 添加不同主题的关键词构建规则表
