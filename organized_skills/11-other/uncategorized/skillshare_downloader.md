---
rating: ⭐⭐
title: skillshare-downloader
url: https://skills.sh/serpdownloaders/skills/skillshare-downloader
---

# skillshare-downloader

skills/serpdownloaders/skills/skillshare-downloader
skillshare-downloader
Installation
$ npx skills add https://github.com/serpdownloaders/skills --skill skillshare-downloader
SKILL.md
...
Navigate to Skillshare and sign in to your account.
Open the class page containing the lessons you want to save.
Start playback of the lesson so the browser loads the video stream.
Click the extension icon to open the popup and view detected lessons.
Select individual lessons or choose the entire class for batch download.
Pick your preferred resolution if the player offers multiple quality levels.
...
When will Skillshare Downloader be released? A release date has not been set. Sign up at the waitlist link above to be notified as soon as it is available.

Does it work with the Skillshare mobile app? No. This extension is built for the Skillshare website in a desktop browser, not the iOS or Android application.

What video quality will it support? Output quality will match what Skillshare's player delivers to the browser, which can vary depending on the class and your account type.

Will it save class project files and resources? The initial release is focused on video downloads. Supplementary resources like project guides and attachments are not part of the current scope but may be considered later.

Is it free? Pricing details will be announced closer to launch. SERP extensions typically include a free trial period.

Can I download all lessons in a class at once? Batch downloading of an entire class is a planned feature. The exact implementation will depend on how the player handles sequential lesson loading.
