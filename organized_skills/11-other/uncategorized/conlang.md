...
rating: ⭐⭐⭐
title: conlang
url: https://skills.sh/jwynia/agent-skills/conlang
---

# conlang

skills/jwynia/agent-skills/conlang
conlang
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill conlang
SKILL.md
...
Generate: phonology.ts --preset elvish_like --complexity naming
Review inventory with writer; adjust if needed
Generate: words.ts --categories for sample names
...
Generate: phonology.ts --complexity flavor --seed [timestamp]
Generate: words.ts --syllables 2-3 --count 20
