---
rating: ⭐⭐⭐
title: dot-ai-prd-start
url: https://skills.sh/vfarcic/dot-ai/dot-ai-prd-start
---

# dot-ai-prd-start

skills/vfarcic/dot-ai/dot-ai-prd-start
dot-ai-prd-start
Installation
$ npx skills add https://github.com/vfarcic/dot-ai --skill dot-ai-prd-start
SKILL.md
...
Available PRDs Discovery - List all PRDs in prds/ directory
...
If on main or master: Create and switch to feature branch:
