---
rating: ⭐⭐⭐
title: groq-ci-integration
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-ci-integration
---

# groq-ci-integration

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-ci-integration
groq-ci-integration
Installation
$ npx skills add https://github.com/jeremylongshore/claude-code-plugins-plus-skills --skill groq-ci-integration
SKILL.md
Groq CI Integration
Overview
