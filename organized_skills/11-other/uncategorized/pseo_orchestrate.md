---
rating: ⭐⭐
title: pseo-orchestrate
url: https://skills.sh/lisbeth718/pseo-skills/pseo-orchestrate
---

# pseo-orchestrate

skills/lisbeth718/pseo-skills/pseo-orchestrate
pseo-orchestrate
Installation
...
Phase 0: Discovery
Run pseo-discovery with scope all
Present the discovery report: data assets found, proposed page types, rejected candidates
...
Phase 1: Audit
Run pseo-audit with scope full, informed by the discovery output (what page types are planned)
...
Phase 6: Validation
Run pseo-quality-guard with scope all (or delta at 10K+ pages)
Present quality report to the user
