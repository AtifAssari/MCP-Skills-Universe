...
rating: ⭐⭐⭐⭐⭐
title: code-hygiene
url: https://skills.sh/ggwicz/skills/code-hygiene
---

# code-hygiene

skills/ggwicz/skills/code-hygiene
code-hygiene
Installation
$ npx skills add https://github.com/ggwicz/skills --skill code-hygiene
SKILL.md
Code Hygiene Review
...
Review each file — Read each file and check against all 10 principles. Load detailed reference files on demand as violations are detected (see "When to Load Reference Files").
...
Assemble report — Write findings to code-hygiene-findings-YYYYMMDD.md in the project root (use today's date). Group findings by file, then by severity (high first). End with the summary block.
Output Format
