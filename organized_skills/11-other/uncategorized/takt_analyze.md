...
rating: ⭐⭐⭐⭐⭐
title: takt-analyze
url: https://skills.sh/j5ik2o/takt-sdd/takt-analyze
---
...
takt-analyze
Installation
$ npx skills add https://github.com/j5ik2o/takt-sdd --skill takt-analyze
SKILL.md
TAKT Analyzer
...
チェック	内容	重大度
initial_movement存在	initial_movementがmovements配列内に存在するか	Critical
遷移先の有効性	全rules.nextが有効なムーブメント名 or COMPLETE/ABORTか	Critical
