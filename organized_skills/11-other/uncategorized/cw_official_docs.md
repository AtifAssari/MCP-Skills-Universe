---
rating: ⭐⭐⭐
title: cw-official-docs
url: https://skills.sh/haowjy/creative-writing-skills/cw-official-docs
---

# cw-official-docs

skills/haowjy/creative-writing-skills/cw-official-docs
cw-official-docs
Installation
$ npx skills add https://github.com/haowjy/creative-writing-skills --skill cw-official-docs
SKILL.md
...
Decide what needs documenting - Character? Location? System? Event?
Choose relevant structure - See references/page-patterns.md for common patterns
Write what matters - Skip irrelevant sections, adapt structure to content
Add citations - See references/citation-guide.md for formats
Cross-reference - Link related pages for discoverability
...
Check project documentation for organization
Common locations: docs/, wiki/, docs/reference/, reference/
