---
rating: ⭐⭐⭐
title: arcgis-core-maps
url: https://skills.sh/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-core-maps
---

# arcgis-core-maps

skills/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-core-maps
arcgis-core-maps
Installation
...
Map Components fire DOM events on the <arcgis-map> / <arcgis-scene> element itself, prefixed with arcgisView. These mirror the view events but can be handled via addEventListener on the element — including before the view is ready.
...
Most view events have a corresponding arcgisView* component event. See the arcgis-map component reference for the full list.
...
Layers belong to exactly one Map: Adding a layer to a second Map silently removes it from the first.
