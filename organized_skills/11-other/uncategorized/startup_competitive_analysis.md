...
url: https://skills.sh/vasilyu1983/ai-agents-public/startup-competitive-analysis
---

# startup-competitive-analysis

skills/vasilyu1983/ai-agents-public/startup-competitive-analysis
startup-competitive-analysis
Installation
$ npx skills add https://github.com/vasilyu1983/ai-agents-public --skill startup-competitive-analysis
SKILL.md
Startup Competitive Analysis
...
Workflow
Define the competitive set: direct/indirect/substitutes/status quo, segmented by ICP and job-to-be-done.
Collect evidence: product/docs/pricing, changelogs, job postings, reviews/VoC, partnerships, distribution signals.
Analyze on buyer criteria: switching costs, time-to-value, risk/procurement, integration ecosystem, ROI proof.
Synthesize into decisions: match/ignore/bet, wedge, proof points, landmines, and “walk-away” criteria.
Produce artifacts: narrative brief, landscape, battlecards, win/loss summary (use bundled templates).
Operationalize: set an update cadence and monitoring sources; refresh battlecards and decisions as signals change.
...
positioning-playbook.md	Positioning methodology
industry-structure-and-differentiation.md	Porter 5 Forces + JTBD alternatives + strategy canvas
win-loss-analysis-guide.md	Win/loss interview methodology, loss reason taxonomy, reporting
competitive-monitoring-setup.md	CI monitoring sources, cadence, tools, zero-budget setup
category-creation-strategy.md	Category creation vs competition, Play Bigger framework, case studies
Templates
Template	Purpose
competitive-analysis-brief.md	Decision-oriented narrative brief
