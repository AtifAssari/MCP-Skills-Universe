---
rating: ⭐⭐⭐
title: laravel:config-env-storage
url: https://skills.sh/jpcaparas/superpowers-laravel/laravel:config-env-storage
---

# laravel:config-env-storage

skills/jpcaparas/superpowers-laravel/laravel:config-env-storage
laravel:config-env-storage
Installation
$ npx skills add https://github.com/jpcaparas/superpowers-laravel --skill laravel:config-env-storage
SKILL.md
