...
rating: ⭐⭐⭐
title: assistant
url: https://skills.sh/mwguerra/claude-code-plugins/assistant
---

# assistant

skills/mwguerra/claude-code-plugins/assistant
assistant
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill assistant
SKILL.md
Assistant Skill
