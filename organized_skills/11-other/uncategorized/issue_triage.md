...
rating: ⭐⭐⭐⭐⭐
title: issue-triage
url: https://skills.sh/sunny0826/open-source-skills/issue-triage
---

# issue-triage

skills/sunny0826/open-source-skills/issue-triage
issue-triage
Installation
$ npx skills add https://github.com/sunny0826/open-source-skills --skill issue-triage
SKILL.md
Issue Triage Skill
...
Format the Output: Use the standard Triage Report template below. Ensure the tone is objective and helpful.
