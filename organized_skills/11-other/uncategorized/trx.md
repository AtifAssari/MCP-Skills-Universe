...
rating: ⭐⭐⭐
title: trx
url: https://skills.sh/crafter-station/trx/trx
---

# trx

skills/crafter-station/trx/trx
trx
Installation
...
Speaker attribution: If user provides speaker names, insert [Speaker Name]: markers.
Filler words: Remove "um", "uh", "este", "o sea" if user wants clean output.
Timestamp alignment: If editing .srt, preserve the timestamp structure. Only modify text between timestamps.
