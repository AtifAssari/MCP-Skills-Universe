---
title: fusion-backend-dev
url: https://skills.sh/equinor/fusion-skills/fusion-backend-dev
---

# fusion-backend-dev

skills/equinor/fusion-skills/fusion-backend-dev
fusion-backend-dev
Installation
...
Capture metadata.repository, metadata.service, metadata.filePath
Extract minimal code snippets that show the pattern (method signature, type contract, authorization check)
