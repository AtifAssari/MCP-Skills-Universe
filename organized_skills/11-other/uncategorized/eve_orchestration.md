---
title: eve-orchestration
url: https://skills.sh/incept5/eve-skillpacks/eve-orchestration
---

# eve-orchestration

skills/incept5/eve-skillpacks/eve-orchestration
eve-orchestration
Installation
...
Fetch context (eve job current --json).
Determine depth:
...
Write self-contained child descriptions (see template below).
Add relations:
Use waits_for for standard gating.
Use blocks only for strict ordering constraints.
Return waiting signal after relations exist.
Resume when children complete; read summaries, verify, and continue.
Creating Child Jobs
