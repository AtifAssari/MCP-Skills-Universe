...
rating: ⭐⭐⭐
title: minimax-image
url: https://skills.sh/nmvr2600/minimax-token-plan-skills/minimax-image
---

# minimax-image

skills/nmvr2600/minimax-token-plan-skills/minimax-image
minimax-image
Installation
$ npx skills add https://github.com/nmvr2600/minimax-token-plan-skills --skill minimax-image
SKILL.md
MiniMax Image 文生图技能
...
批量生成前检查配额：使用 minimax-usage skill 先检查余额
提示词优化：详细描述场景、光线、风格，效果更好
指定输出目录：使用 --output-dir 避免图片散落在当前目录
自定义文件名前缀：使用 --prefix 方便管理生成的图片
合理的 n 值：批量生成时 n=4 是较好的平衡点
图生图参考图：使用单人正面清晰照片，效果最佳
Weekly Installs
18
Repository
nmvr2600/minima…n-skills
GitHub Stars
7
First Seen
Mar 30, 2026
