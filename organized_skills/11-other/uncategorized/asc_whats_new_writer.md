...
url: https://skills.sh/rudrankriyam/app-store-connect-cli-skills/asc-whats-new-writer
---

# asc-whats-new-writer

skills/rudrankriyam/app-store-connect-cli-skills/asc-whats-new-writer
asc-whats-new-writer
Installation
$ npx skills add https://github.com/rudrankriyam/app-store-connect-cli-skills --skill asc-whats-new-writer
SKILL.md
...
Before You Start
Read references/release_notes_guidelines.md for tone, structure, and examples.
Identify the latest version directory under metadata/version/ (highest semver). Use this for all metadata reads.
...
Read keywords from metadata/version/{latest}/{primary-locale}.json
...
Read keywords from metadata/version/{latest}/{locale}.json
