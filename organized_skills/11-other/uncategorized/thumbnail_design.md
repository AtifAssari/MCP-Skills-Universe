...
url: https://skills.sh/thecraighewitt/skills/thumbnail-design
---

# thumbnail-design

skills/thecraighewitt/skills/thumbnail-design
thumbnail-design
Installation
$ npx skills add https://github.com/thecraighewitt/skills --skill thumbnail-design
SKILL.md
Thumbnail Design
...
Context Questions
What's the video title? (Thumbnails complement titles, never repeat them.)
What's the one emotion you want the viewer to feel? (Curiosity, surprise, fear, excitement, relief.)
Do you appear on camera? (Face thumbnails generally outperform non-face thumbnails.)
What's your current thumbnail style? (Consistent branding or testing different looks.)
Is there a specific result, number, or transformation to visualize?
Core Principles
Thumbnails are billboards, not posters. You have less than 1 second and the size of a postage stamp. If the concept doesn't read at that size, it fails. Design for tiny, not full-screen.
Emotion beats aesthetics every time. A technically perfect thumbnail with no emotional trigger gets scrolled past. A rough thumbnail with genuine surprise on someone's face gets clicked.
3 elements maximum. The most effective thumbnails have 2-3 elements: typically a face + text, face + object, or text + visual metaphor. More than 3 elements creates visual noise.
Complement the title, never repeat it. The title tells. The thumbnail shows. Together they create the full story. If your title says "I Automated 80% of My Business" your thumbnail should show the transformation, not the words "80% automated."
Contrast is survival. Your thumbnail competes against 20+ others on a YouTube page. High contrast, saturated colors, and clear focal points are not optional -- they're how you survive the feed.
Consistency creates recognition. You don't need a rigid template, but returning viewers should recognize your thumbnails at a glance. Consistent colors, text style, or composition pattern builds brand.
The 1-Second Test

Before finalizing any thumbnail concept, run this test:

Shrink the thumbnail to the size of a phone screen suggestion (roughly 168x94 pixels)
Can you read the text?
Can you see the expression on the face?
Can you understand the concept?
Does it stand out against a white and dark background?
...
Process
Get the video title (or generate one with title-craft).
Determine the primary emotion.
Choose the composition type (face + text, before/after, result visual, etc.).
Write a specific thumbnail brief.
Run the 1-Second Test mentally.
Present the concept with notes on execution.
Output Format
