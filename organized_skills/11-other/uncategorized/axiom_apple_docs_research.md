---
rating: ⭐⭐⭐
title: axiom-apple-docs-research
url: https://skills.sh/charleswiltgen/axiom/axiom-apple-docs-research
---

# axiom-apple-docs-research

skills/charleswiltgen/axiom/axiom-apple-docs-research
axiom-apple-docs-research
Installation
...
Case-insensitive - Both SwiftUI and swiftui work, but lowercase is recommended
...
Find latest session: ls -lt ~/Library/Caches/superpowers/browser/*/
Session directory format: YYYY-MM-DD/session-TIMESTAMP/
...
Check sosumi.ai format: /documentation/[frameworkname]
Fallback: Use developer.apple.com but expect HTML
