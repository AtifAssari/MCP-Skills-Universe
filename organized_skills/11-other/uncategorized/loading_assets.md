...
url: https://skills.sh/phaserjs/phaser/loading-assets
---

# loading-assets

skills/phaserjs/phaser/loading-assets
loading-assets
Installation
$ npx skills add https://github.com/phaserjs/phaser --skill loading-assets
SKILL.md
Loading Assets
...
'start' - Loader begins
'fileprogress' - Per-file progress (repeats per file, if available)
'load' - Each file finishes downloading
'filecomplete-{type}-{key}' - Specific file processed and cached
'filecomplete' - Generic per-file completion
'progress' - Overall progress updated
'postprocess' - All files done, before cleanup
