...
url: https://skills.sh/sanky369/vibe-building-skills/interaction-physics
---

# interaction-physics

skills/sanky369/vibe-building-skills/interaction-physics
interaction-physics
Installation
...
Trigger — What initiates the interaction? (user action, system event, time-based)
Rules — What happens as a result? (what animates, what changes, how long)
Feedback — What does the user see/hear? (animation, sound, haptic)
Loops & Modes — Does it repeat? Can it be interrupted?
