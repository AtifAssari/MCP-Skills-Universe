---
rating: ⭐⭐⭐
title: groq-migration-deep-dive
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-migration-deep-dive
---

# groq-migration-deep-dive

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-migration-deep-dive
groq-migration-deep-dive
Installation
$ npx skills add https://github.com/jeremylongshore/claude-code-plugins-plus-skills --skill groq-migration-deep-dive
SKILL.md
Groq Migration Deep Dive
Overview
