---
rating: ⭐⭐
title: email-smtp-send
url: https://skills.sh/tiangong-ai/skills/email-smtp-send
---

# email-smtp-send

skills/tiangong-ai/skills/email-smtp-send
email-smtp-send
Installation
$ npx skills add https://github.com/tiangong-ai/skills --skill email-smtp-send
SKILL.md
Email SMTP Send
Core Goal
...
Workflow
Configure SMTP env vars (see references/env.md and assets/config.example.env).
Optional: configure IMAP sent-sync env vars and install imapclient when sync is enabled.
