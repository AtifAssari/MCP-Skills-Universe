...
url: https://skills.sh/davila7/claude-code-templates/content-research-writer
---

# content-research-writer

skills/davila7/claude-code-templates/content-research-writer
content-research-writer
...
Guides collaborative outlining, research compilation with citations, and iterative feedback on each section as you write
Preserves your unique voice and writing style while strengthening clarity, flow, and evidence
Handles citation management in multiple formats (inline, numbered, footnote) and maintains running reference lists
Supports diverse workflows: blog posts, newsletters, technical tutorials, thought leadership, and case studies
Provides section-by-section feedback covering clarity, flow, evidence, and style, plus comprehensive final review before publishing
SKILL.md
Content Research Writer
