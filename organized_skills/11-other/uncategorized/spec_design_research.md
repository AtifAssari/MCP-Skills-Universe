---
rating: ⭐⭐
title: spec-design-research
url: https://skills.sh/zixun-github/aisdlc/spec-design-research
---

# spec-design-research

skills/zixun-github/aisdlc/spec-design-research
spec-design-research
Installation
...
复制 <本SKILL.md目录>/assets/research-template.md 的内容
粘贴到 {FEATURE_DIR}/design/research.md
按模板把占位符补齐（尤其是“研究任务 → 结论（Decision/Rationale/Alternatives）”必须完整）
