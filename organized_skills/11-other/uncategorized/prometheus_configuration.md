...
skills/wshobson/agents/prometheus-configuration
prometheus-configuration
Installation
...
Covers alert rule examples for service availability, error rates, latency thresholds, and resource constraints with severity labeling
Includes validation tools (promtool), troubleshooting queries, and best practices for metric naming, scrape intervals, and high-availability setups
SKILL.md
Prometheus Configuration
