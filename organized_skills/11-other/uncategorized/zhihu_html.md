...
rating: ⭐⭐⭐
title: zhihu-html
url: https://skills.sh/chouheiwa/skill-zhihu-html/zhihu-html
---

# zhihu-html

skills/chouheiwa/skill-zhihu-html/zhihu-html
zhihu-html
Installation
$ npx skills add https://github.com/chouheiwa/skill-zhihu-html --skill zhihu-html
SKILL.md
...
AI 根据 url、originalText、context 信息（也可访问 URL 获取页面标题）， 为 type: "external" 的引用填写 dataText 字段。站内链接（type: "internal"）不需要填写 dataText。
