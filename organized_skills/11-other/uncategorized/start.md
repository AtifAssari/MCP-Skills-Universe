...
rating: ⭐⭐
title: start
url: https://skills.sh/iankiku/forwward-teams/start
---

# start

skills/iankiku/forwward-teams/start
start
Installation
...
What are you working on? — Product, business, project, or problem. One sentence.
What stage are you at? — Idea, MVP, launched, scaling? (Or: just getting started, mid-project, established)
Who's your customer or audience? — B2B, B2C, internal team? What industry?
What kind of help do you need most? — Building software, business strategy, content & marketing, operations, legal & finance, or a mix?
What's your biggest bottleneck right now? — The one thing that, if solved, would unblock everything else.
