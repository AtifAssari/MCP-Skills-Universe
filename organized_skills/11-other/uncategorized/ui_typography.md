...
rating: ⭐⭐⭐
title: ui-typography
url: https://skills.sh/bencium/bencium-marketplace/ui-typography
---

# ui-typography

skills/bencium/bencium-marketplace/ui-typography
ui-typography
Installation
...
HTML entity (HTML files only): Use &rsquo; — but this does NOT work in JSX/React.
...
Space above > space below (heading relates to text that follows)
Keep heading with next paragraph (page-break-after: avoid)
Tiered numbers (1.1, 2.1) over roman numerals (I.A.1.a.i)
Block Quotations
...
Don't use ch unit for exact measurement (only measures zero width)
clamp() for fluid scaling: font-size: clamp(16px, 2.5vw, 20px)
Mobile minimum: padding: 0 1rem on text containers
The common failure: images/nav scale carefully, body text ignored
