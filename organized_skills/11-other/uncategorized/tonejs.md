...
rating: ⭐⭐⭐
title: tonejs
url: https://skills.sh/plyght/tonejs-skill/tonejs
---

# tonejs

skills/plyght/tonejs-skill/tonejs
tonejs
Installation
...
Play notes using triggerAttackRelease
import * as Tone from "tone";
...
Use PolySynth to wrap a monophonic synth
Pass multiple notes to play chords
...
Create a Player or Sampler
Wait for Tone.loaded() promise
Start playback
...
Use Tone.Loop or Tone.Sequence for patterns
Pass the time parameter to instrument triggers
...
Access parameter via property (e.g., frequency, volume)
Use methods like rampTo, linearRampTo, exponentialRampTo
Schedule changes with time parameter
...
Use Tone.Draw.schedule() for visual updates
Schedule in the same callback as audio events
