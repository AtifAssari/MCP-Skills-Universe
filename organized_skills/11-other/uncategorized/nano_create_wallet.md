---
rating: ⭐⭐⭐
title: nano-create-wallet
url: https://skills.sh/casualsecurityinc/xno-skills/nano-create-wallet
---

# nano-create-wallet

skills/casualsecurityinc/xno-skills/nano-create-wallet
nano-create-wallet
Installation
$ npx skills add https://github.com/casualsecurityinc/xno-skills --skill nano-create-wallet
SKILL.md
...
Creation: Use the separate OWS skill to create the wallet.
Discovery: Use wallets (in xno-mcp) to see your OWS wallets and Nano addresses.
Sending/Receiving: Use send and receive (in xno-mcp). These tools will automatically bridge your OWS wallet with the Nano RPC to construct and publish blocks.
