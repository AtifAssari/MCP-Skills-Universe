---
rating: ⭐⭐
title: nano-block-lattice-expert
url: https://skills.sh/casualsecurityinc/xno-skills/nano-block-lattice-expert
---

# nano-block-lattice-expert

skills/casualsecurityinc/xno-skills/nano-block-lattice-expert
nano-block-lattice-expert
Installation
$ npx skills add https://github.com/casualsecurityinc/xno-skills --skill nano-block-lattice-expert
SKILL.md
...
High Uptime: Must be online 24/7 to vote.
Low Voting Weight: Avoid "whale" representatives. Spreading weight improves decentralization.
Trustworthy: Run by a known community member, organization, or yourself.
Updated: Runs a recent node version.
