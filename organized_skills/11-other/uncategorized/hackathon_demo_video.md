...
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-demo-video
---

# hackathon-demo-video

skills/bernieweb3/hackathon-ai-devkit/hackathon-demo-video
hackathon-demo-video
Installation
...
Rules
The first 5 seconds must state the problem or hook — no introductions.
wow_factor must appear before the 60% mark of video_duration_seconds.
Every mvp_demo_flow step must map to at least one shot.
Narration sentences must be under 15 words each.
Reserve the final 10% of video time for a summary and call-to-action.
recording_checklist must include at least: notifications off, test data ready, screen resolution set.
fallback_plan must be a static slide or pre-recorded segment, never "we'll skip this part."
Output Format
