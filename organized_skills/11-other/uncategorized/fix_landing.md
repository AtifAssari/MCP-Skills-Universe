...
rating: ⭐⭐⭐
title: fix-landing
url: https://skills.sh/phrazzld/claude-config/fix-landing
---

# fix-landing

skills/phrazzld/claude-config/fix-landing
fix-landing
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill fix-landing
SKILL.md
/fix-landing
