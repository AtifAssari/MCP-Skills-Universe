...
url: https://skills.sh/kimny1143/claude-code-template/email-sequence
---

# email-sequence

skills/kimny1143/claude-code-template/email-sequence
email-sequence
Installation
$ npx skills add https://github.com/kimny1143/claude-code-template --skill email-sequence
SKILL.md
