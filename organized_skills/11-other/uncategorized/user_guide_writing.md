...
skills/supercent-io/skills-template/user-guide-writing
user-guide-writing
Installation
...
Follows plain-language principles, avoiding technical jargon and keeping explanations concise and scannable
SKILL.md
User Guide Writing
...
Constraints
Required Rules (MUST)
Include Screenshots: Visual guides
Step-by-Step Instructions: 1, 2, 3 format
User Language: Avoid technical jargon
Forbidden (MUST NOT)
Technical Jargon Overload: API, endpoint, etc.
Long Paragraphs: Keep short and clear
Best practices
User-Centric: Write from the user's perspective
Show, Don't Tell: Screenshots, GIFs, videos
Update Regularly: Update docs when UI changes
References
Docs as Code
Good Docs Project
Metadata
