...
rating: ⭐⭐⭐
title: geo-compare
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-compare
---

# geo-compare

skills/zubair-trabzada/geo-seo-claude/geo-compare
geo-compare
Installation
...
Look in ~/.geo-prospects/audits/ for files matching <domain>-*.md
Sort by date
Use oldest as baseline, newest as current
If only one file exists: use it as baseline, run a fresh quick audit as current
If no files exist: suggest running /geo prospect audit <domain> first
...
Output
Save report to ~/.geo-prospects/reports/<domain>-monthly-<YYYY-MM>.md
Print confirmation with key stats:
...
Suggest next action: "Share with client or run /geo report-pdf for a visual version"
Weekly Installs
161
Repository
