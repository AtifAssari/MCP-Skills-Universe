---
rating: ⭐⭐
title: nuwa-world-osint-human-research
url: https://skills.sh/site/skills.volces.com/nuwa-world-osint-human-research
---

# nuwa-world-osint-human-research

skills/skills.volces.com/nuwa-world-api
nuwa-world-api
$ npx skills add https://skills.volces.com/skills/clawhub/andrewchen-oss
SKILL.md
Nuwa World API
...
Base URL: https://gateway.nuwa.world/api/v1 Auth: X-API-Key: $NUWA_API_KEY header on every request. Get your key at https://platform.nuwa.world
