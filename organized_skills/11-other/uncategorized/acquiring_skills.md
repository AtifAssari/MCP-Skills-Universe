...
url: https://skills.sh/letta-ai/letta-code/acquiring-skills
---

# acquiring-skills

skills/letta-ai/letta-code/acquiring-skills
acquiring-skills
Installation
...
Inspect scripts: Read any .py or .ts files before using them
Invoke: Skill(skill: "webapp-testing")
Use: Follow the skill's instructions for the user's task
Weekly Installs
57
Repository
letta-ai/letta-code
