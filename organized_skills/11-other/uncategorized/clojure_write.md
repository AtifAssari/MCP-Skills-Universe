...
rating: ⭐⭐
title: clojure-write
url: https://skills.sh/metabase/metabase/clojure-write
---

# clojure-write

skills/metabase/metabase/clojure-write
clojure-write
Installation
...
Call functions in the namespace with test inputs, and observe that the outputs are correct Feel free to copy these REPL session trials into actual test cases using deftest and is.
Once you know these functions are good, return to 1, and compose them into the task that you need to build.
