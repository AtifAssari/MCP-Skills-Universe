---
rating: ⭐⭐
title: artifact-sbom-publisher
url: https://skills.sh/patricio0312rev/skills/artifact-sbom-publisher
---

# artifact-sbom-publisher

skills/patricio0312rev/skills/artifact-sbom-publisher
artifact-sbom-publisher
Installation
$ npx skills add https://github.com/patricio0312rev/skills --skill artifact-sbom-publisher
SKILL.md
Artifact & SBOM Publisher
...
Multiple formats: SPDX and CycloneDX
Scan vulnerabilities: Before release
Sign artifacts: For verification
Include provenance: SLSA attestation
Retention policy: Keep artifacts 30 days
Metadata: Version, commit, timestamp
Automate: Part of every build
Output Checklist
