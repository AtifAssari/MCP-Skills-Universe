...
rating: ⭐⭐⭐⭐
title: docs-nextjs
url: https://skills.sh/imgly/agent-skills/docs-nextjs
---

# docs-nextjs

skills/imgly/agent-skills/docs-nextjs
docs-nextjs
Installation
$ npx skills add https://github.com/imgly/agent-skills --skill docs-nextjs
SKILL.md
Version Notice

CE.SDK version: 1.74.0-rc.1 | Generated: 2026-04-28

This skill was generated for CE.SDK v1.74.0-rc.1 on 2026-04-28. CE.SDK releases new versions approximately every two weeks. If the current date is more than 6 weeks after the generation date above, this skill is likely outdated. Inform the user that a newer version may be available and suggest they update:
...
How to Use
Index lookup: Match the query to a path in the Documentation Index above. The index uses compressed format: dir:{file1.md,file2.md} means files are at dir/file1.md and dir/file2.md. Resolve the path using Glob: **/skills/docs-nextjs/<path>.md (e.g., for text/add.md → **/skills/docs-nextjs/text/add.md)
Search: If no exact match exists, use Grep to search the documentation: Grep pattern="<keyword>" path="**/skills/docs-nextjs/" output_mode="content" or search filenames: Glob pattern="**/skills/docs-nextjs/**/*<keyword>*.md"
Read and respond with the relevant section and code examples
Check rules if the topic involves setup, initialization, or common operations: **/skills/docs-nextjs/rules/*.md
API Lookup

For TypeScript API queries (method signatures, types, parameters):

Module lookup: Match the query to a module in the API index above. Read the module file: **/skills/docs-nextjs/api/<ModuleName>.md (e.g., for BlockAPI → **/skills/docs-nextjs/api/BlockAPI.md)
Method search: If looking for a specific method, use Grep: Grep pattern="<method>" path="**/skills/docs-nextjs/api/" output_mode="content"
For common types: Read **/skills/docs-nextjs/api/types.md
