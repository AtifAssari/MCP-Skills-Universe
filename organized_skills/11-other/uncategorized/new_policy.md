...
rating: ⭐⭐⭐
title: new-policy
url: https://skills.sh/ywj3493/claude-skills/new-policy
---

# new-policy

skills/ywj3493/claude-skills/new-policy
new-policy
Installation
...
Adds a new policy document to the project following the standard format, with an automatic Korean translation in docs/ko/policy/.
...
Consider adding an @-reference to this new policy in docs/en/policy/policy.md under the "Related Policy Files" section: - [@docs/en/policy/<policy-name>.md](docs/en/policy/<policy-name>.md) — <description>

Do not automatically edit policy.md — show the suggested line and let the user decide.
