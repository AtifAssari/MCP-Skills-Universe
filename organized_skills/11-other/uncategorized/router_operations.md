...
url: https://skills.sh/vasilyu1983/ai-agents-public/router-operations
---

# router-operations

skills/vasilyu1983/ai-agents-public/router-operations
router-operations
Installation
...
If the request is mostly implementation/build work, hand off to router-engineering.
