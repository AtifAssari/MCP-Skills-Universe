---
rating: ⭐⭐⭐
title: vtex-io-service-configuration-apps
url: https://skills.sh/vtex/skills/vtex-io-service-configuration-apps
---

# vtex-io-service-configuration-apps

skills/vtex/skills/vtex-io-service-configuration-apps
vtex-io-service-configuration-apps
Installation
$ npx skills add https://github.com/vtex/skills --skill vtex-io-service-configuration-apps
SKILL.md
...
The service app defines accepted structure in configuration/schema.json.
The configuration app declares the service as a builder and supplies values in configuration.json.
The service reads the injected configuration through ctx.vtex.settings.
...
Builders - Overview of the configuration builder
Service - Service configuration context for node and GraphQL services
Weekly Installs
161
Repository
vtex/skills
