---
rating: ⭐⭐⭐
title: jr-rails-phlex
url: https://skills.sh/julianrubisch/skills/jr-rails-phlex
---

# jr-rails-phlex

skills/julianrubisch/skills/jr-rails-phlex
jr-rails-phlex
Installation
...
Core Workflow
Use the scaffold generator — custom PhlexControllerGenerator produces Phlex views instead of ERB. See reference/coding-phlex.md § Scaffolding for the full generator code and all 5 templates.
...
Full Phlex coding guide (generator templates, all examples): reference/coding-phlex.md
Design patterns (form objects, query objects, strategies): reference/patterns.md
Testing guide: reference/shared/testing.md
Hotwire (Turbo + Stimulus): reference/shared/hotwire.md
Components reference: reference/shared/components.md
