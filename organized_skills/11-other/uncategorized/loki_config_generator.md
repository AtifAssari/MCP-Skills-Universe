...
url: https://skills.sh/akin-ozer/cc-devops-skills/loki-config-generator
---

# loki-config-generator

skills/akin-ozer/cc-devops-skills/loki-config-generator
loki-config-generator
Installation
$ npx skills add https://github.com/akin-ozer/cc-devops-skills --skill loki-config-generator
SKILL.md
