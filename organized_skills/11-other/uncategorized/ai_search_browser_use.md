---
rating: ⭐⭐⭐
title: ai-search-browser-use
url: https://skills.sh/jwcodewrote/agent_skills_plugin/ai-search-browser-use
---

# ai-search-browser-use

skills/jwcodewrote/agent_skills_plugin/ai-search-browser-use
ai-search-browser-use
Installation
$ npx skills add https://github.com/jwcodewrote/agent_skills_plugin --skill ai-search-browser-use
SKILL.md
AI Search Browser Use
Overview
...
Allows running alongside your normal Chrome: By using a separate --user-data-dir, the CDP Chrome runs as an independent process. You can continue using your regular Chrome without any conflicts.
Preserves login state: By cloning your existing Chrome profile, the CDP Chrome inherits your logged-in sessions for Gemini, Qwen, and other sites.
...
Best Practices
Always use CDP as the primary method for authenticated queries.
Clone the profile each time to ensure a fresh, logged-in state.
Wait longer for complex prompts (30–60 seconds).
Close the CDP Chrome instance after use to release port 9222.
Update the cloned profile if login expires.
