...
rating: ⭐⭐⭐
title: dataforseo
url: https://skills.sh/nikhilbhansali/dataforseo-skill-claude/dataforseo
---

# dataforseo

skills/nikhilbhansali/dataforseo-skill-claude/dataforseo
dataforseo
Installation
$ npx skills add https://github.com/nikhilbhansali/dataforseo-skill-claude --skill dataforseo
SKILL.md
...
Extract results: Use extract_results(response)
Export to CSV: Use to_csv(results, "filename")
import sys, os
sys.path.insert(0, os.path.expanduser('~/.agents/skills/dataforseo/scripts'))
...
Limits: Increase limit parameter for comprehensive data (default 100, max usually 1000)
Multiple keywords: Pass as list: keywords=["kw1", "kw2", "kw3"]
Weekly Installs
105
Repository
nikhilbhansali/…l-claude
GitHub Stars
27
First Seen
Feb 7, 2026
