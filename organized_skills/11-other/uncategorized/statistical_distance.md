...
url: https://skills.sh/jwynia/agent-skills/statistical-distance
---

# statistical-distance

skills/jwynia/agent-skills/statistical-distance
statistical-distance
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill statistical-distance
SKILL.md
...
Mounting debts (financial crisis)
Blackmail (secret held)
Contract/obligation (legal binding)
Protecting someone (they'll be hurt)
...
If not found, ask user: "Where should I save statistical distance work?"
Suggest: stories/elements/ or explorations/stories/
Primary Output
