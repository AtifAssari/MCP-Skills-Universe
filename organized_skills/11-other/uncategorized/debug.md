...
rating: ⭐⭐
title: debug
url: https://skills.sh/whawkinsiv/claude-code-skills/debug
---

# debug

skills/whawkinsiv/claude-code-skills/debug
debug
Installation
$ npx skills add https://github.com/whawkinsiv/claude-code-skills --skill debug
SKILL.md
Debug
The golden rule
