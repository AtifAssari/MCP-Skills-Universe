---
rating: ⭐⭐⭐
title: starting-an-implementation-plan
url: https://skills.sh/ed3dai/ed3d-plugins/starting-an-implementation-plan
---

# starting-an-implementation-plan

skills/ed3dai/ed3d-plugins/starting-an-implementation-plan
starting-an-implementation-plan
Installation
...
Implementation plan directory name (docs/implementation-plans/YYYY-MM-DD-{slug}/)
Worktree directory name (.worktrees/{slug})
Scoping all AC identifiers — every acceptance criterion uses the format {slug}.AC{N}.{M}
...
Announce: "Worktree created at .worktrees/[friendly-name] on branch [branch-name]"
...
If "Use current branch": Continue with current branch (no git commands)
