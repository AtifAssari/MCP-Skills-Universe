...
url: https://skills.sh/crazyswami/wordpress-dev-skills/wordpress-admin
---

# wordpress-admin

skills/crazyswami/wordpress-dev-skills/wordpress-admin
wordpress-admin
Installation
$ npx skills add https://github.com/crazyswami/wordpress-dev-skills --skill wordpress-admin
SKILL.md
...
Create page with slug privacy-policy
Set template to page-privacy-policy.php
Set focus keyphrase: "CSR privacy policy"
Set meta description (~155 chars with keyphrase)
Upload relevant featured image
Create Terms of Service Page
Create page with slug terms
Set template to page-terms.php
Set focus keyphrase: "CSR terms of service"
Set meta description (~155 chars with keyphrase)
Upload relevant featured image
Reference
