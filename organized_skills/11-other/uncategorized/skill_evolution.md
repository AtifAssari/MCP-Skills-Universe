...
url: https://skills.sh/heyvhuang/ship-faster/skill-evolution
---

# skill-evolution

skills/heyvhuang/ship-faster/skill-evolution
skill-evolution
Installation
...
How to evolve
Hooks create evolution-candidates.md + evolution-review.md with the latest signals.
At the end of a big task, ask the 3 checkpoint questions (above) and let the user decide.
If user chooses to evolve: run skill-improver with the best run_dir (the workflow run_dir is usually better than evolution run_dir).
Apply the patch manually and re-validate skills.
Example event
