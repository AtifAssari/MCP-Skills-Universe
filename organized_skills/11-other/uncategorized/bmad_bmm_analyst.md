---
rating: ⭐⭐
title: bmad-bmm-analyst
url: https://skills.sh/404kidwiz/claude-supercode-skills/bmad-bmm-analyst
---

# bmad-bmm-analyst

skills/404kidwiz/claude-supercode-skills/bmad-bmm-analyst
bmad-bmm-analyst
Installation
$ npx skills add https://github.com/404kidwiz/claude-supercode-skills --skill bmad-bmm-analyst
SKILL.md
...
Market Research: Analyzed target demographic (18-24 year olds), investment behaviors, and competitor apps (Acorns, Stash, Robinhood)
User Research: Conducted 30 interviews with potential users to understand pain points
Competitive Analysis: Mapped feature sets, pricing models, and user experience gaps
Business Case Development: Created financial projections with three scenarios (conservative, base, optimistic)
...
Stakeholder Interviews: Interviewed 15 enterprise customers and internal sales team
Data Analysis: Analyzed feature requests, support tickets, and usage analytics
Value Mapping: Scored features by revenue impact, customer count, and strategic fit
Workshop Facilitation: Led prioritization workshop with product and engineering leadership
...
Current State Mapping: Documented patient journey from arrival to discharge
Data Collection: Analyzed 10,000 patient records and time-stamped events
Bottleneck Identification: Used process mining to identify waiting points
Root Cause Analysis: Conducted interviews with clinical staff
