---
rating: ⭐⭐⭐
title: typo3-datahandler
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-datahandler
---

# typo3-datahandler

skills/dirnbauer/webconsulting-skills/typo3-datahandler
typo3-datahandler
Installation
...
Obtain a DataHandler via GeneralUtility::makeInstance(DataHandler::class) or constructor DI — avoid new DataHandler() so Core wiring (hooks, collaborators) stays consistent.
