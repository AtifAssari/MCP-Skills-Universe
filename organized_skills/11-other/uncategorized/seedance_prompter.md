...
url: https://skills.sh/pexoai/pexo-skills/seedance-prompter
---

# seedance-prompter

skills/pexoai/pexo-skills/seedance-prompter
seedance-prompter
Installation
$ npx skills add https://github.com/pexoai/pexo-skills --skill seedance-prompter
SKILL.md
...
Agent using seedance-prompter: The agent internally processes the request and assets, then outputs the final JSON to the next skill in the chain.
