...
url: https://skills.sh/aaaaqwq/claude-code-skills/trello-automation
---

# trello-automation

skills/aaaaqwq/claude-code-skills/trello-automation
trello-automation
Installation
...
Call RUBE_MANAGE_CONNECTIONS with toolkit trello
...
TRELLO_ADD_CARDS_ATTACHMENTS_BY_ID_CARD - Attach a file or URL [Optional]
