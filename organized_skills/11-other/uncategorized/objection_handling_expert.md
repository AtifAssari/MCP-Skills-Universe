---
rating: ⭐⭐
title: objection-handling-expert
url: https://skills.sh/reggiechan74/vp-real-estate/objection-handling-expert
---

# objection-handling-expert

skills/reggiechan74/vp-real-estate/objection-handling-expert
objection-handling-expert
Installation
$ npx skills add https://github.com/reggiechan74/vp-real-estate --skill objection-handling-expert
SKILL.md
Objection Handling Expert
...
Acknowledge their data: "I see you're using [X comparables]..."
Present your counter-evidence: "Here's what I'm seeing [attach toolkit analysis]..."
Calibrated question to reconcile: "How do we account for the difference in clear height / parking / age?"
Value trade if needed: "If TI is the constraint, would you consider higher rent with full TI coverage?"
...
Acknowledge: "I appreciate you sharing the comp data. Let me take a look at those three properties..."
Analyze: [Review their comps - likely older buildings, different submarket, or lower quality]
Counter-evidence: "I ran a competitive analysis [reference /relative-valuation results] of all comparable properties built after 2015 with 30'+ clear height in this submarket. The median is $18.50/sf, with a range of $17-20."
Calibrated question: "Your three comps are all pre-2010 construction with 24' clear height. How do you adjust for the 6 feet of additional clear height and 15 years of building age difference?"
Reframe: "If we normalize for those features using standard adjustment factors, your comps would be $17-18 range, which is right where I'm positioned."
...
Mirror to get specifics: "Too high?" or "Above market?"
Calibrated question to shift burden: "What comparables are you using to arrive at that?"
Evidence anchor to establish your position: "Here's the market data I'm seeing..."
Make them attack your evidence: Force them to either provide data or concede
...
Mirror: "Too high?"
Let them elaborate: [Wait for them to explain]
Calibrated question: "What rent level were you expecting, and what are you basing that on?"
Evidence anchor: "I'm basing $18/sf on [X market data from /market-comparison]. Every comparable transaction in the last 6 months for this building class has been $17.50-19.50."
Shift burden: "What market evidence are you seeing that suggests a lower number?"
...
Accusation audit to defuse: "You probably think I'm anchoring too high..."
Evidence anchor: "Here's why market data supports this number..."
No-oriented question: "Is it unreasonable to expect market rent for brand-new Class A space?"
Strategic concession (if needed): Offer something that costs you little but has value to them
...
Accusation audit: "I know it might seem like I'm being inflexible here..."
Evidence anchor: "But I need to show you the market data I'm working with [attach /relative-valuation or /market-comparison results]. Every comparable property is leasing for $17.50-19.50."
Calibrated question: "How am I supposed to justify $14/sf when the market shows $18? What am I missing in your analysis?"
Label if they push back: "It sounds like you have budget constraints beyond just the market rent..."
Uncover interest: "What would it take to make $18 work for you? Is it TI, free rent, term length, or something else?"
...
Label to confirm constraint: "It sounds like cash flow during construction is the real challenge..."
Calibrated question to understand: "What specifically about the budget creates the constraint?"
Value engineering: Find ways to address their need without sacrificing your economics
Trade, don't concede: "If I solve X, can you give me Y?"
...
Label: "It sounds like the challenge is cash outlay for the gap, not the overall economics..."
Calibrated question: "What if we structured this differently—would higher base rent with full $40/sf TI work better than lower rent with $25/sf TI?"
Run the math: [Use /effective-rent calculator to model both scenarios]
Present options:
...
Calibrated close: "Which structure works better for your cash flow situation?"
...
Gather their evidence: "What comparables are you using?"
Present your evidence: [Reference /relative-valuation or /market-comparison results]
Reconcile differences: "How do you adjust for clear height / dock doors / parking / age?"
Calibrated question: "If we're both looking at market data, what explains the gap in our conclusions?"
...
Label to understand: "It seems like cash flow during the transition is a concern..."
Calibrated question: "What's driving the free rent requirement—construction timeline, budget timing, or lease overlap?"
Evidence anchor: "Market deals for [X]-year terms are giving [Y] months free [cite /market-comparison]. The gap is worth $[Z] in lost rent."
Value trade: "If I gave you [X] months free, what could you give me on term length / base rent / renewal options?"
...
Calibrated question: "What about your business planning makes [X] years challenging?"
Uncover interest: "Is it uncertainty about growth, market conditions, or something else?"
Present tradeoff: "Here's the challenge: my TI investment of $[Y] needs to amortize over the term. On a 3-year term, that's $[Z]/sf added to base rent. On 7 years, it's $[A]/sf. How do you want to structure this?"
Alternative structures:
...
Get specifics: "What specifically are they offering? I want to make sure I understand what I'm competing against."
Analyze: [If possible, review the competitive property features, age, etc.]
Evidence-based comparison: "Let me show you how this building compares to that one [reference /relative-valuation if available showing feature-by-feature comparison]"
Calibrated question: "If Building X has [inferior features], how do you adjust for that difference in the pricing?"
Test seriousness: "If they're offering objectively better value, what would it take for you to choose this building instead?"

If bluff: They'll back down when you engage with specifics If real: Focus on differentiating value or match if justified
...
Evidence anchor: "Based on the credit analysis [reference /tenant-credit report], your [debt ratios / credit score / financial position] puts you in the [X] risk category. Comparable tenants provide [Y] months security."
Calibrated question: "How do you see us addressing the security requirement given the credit profile?"
Alternatives: "Would a letter of credit or parent guarantee work better than cash deposit?"
Stepdown provision: "What if we structured it as [X] months security for Years 1-2, stepping down to [Y] months if you maintain timely payment?"
...
Understand scope: "Walk me through what drives the $[X] requirement. Do you have a preliminary cost estimate?"
Evidence anchor: "Market TI for comparable space/term is running $[Y]/sf [cite market data]"
Calibrated question: "What specifically about your build-out justifies $[Z]/sf above market standard?"
Value engineering:
...
Rent/TI trade: "If I go to $[X] TI, I need $[Y] higher base rent to maintain my returns. Does that work?"
