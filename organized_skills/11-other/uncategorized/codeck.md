...
rating: ⭐⭐⭐
title: codeck
url: https://skills.sh/hiyeshu/codeck/codeck
---

# codeck

skills/hiyeshu/codeck/codeck
codeck
Installation
...
Simplify — plain language. Assume user hasn't looked at screen for 20 minutes.
Recommend — Suggest [X] because [reason].
Options — A) B) C), one click.
...
Three signals
Domain — what field? Determines outline role.
Expression challenge — what's hardest to convey? Determines design role.
Audience starting point — what do they know / not know? Determines review role (inverse selection: the listener most likely to struggle).
...
Materials — file types and counts from Phase 2
STALE — one-line explanation if any stage is stale
...
What your content is really about — the core tension, in one sentence. Not the topic, the underlying struggle. ("Your material isn't about microservices — it's about convincing a team to accept short-term pain for long-term sanity.")

Who I'm bringing in, and why — the derivation, not just the name. Connect the person's way of thinking to the content's tension. ("For the outline, I'm thinking of Feynman — not because this is physics, but because your argument needs to make the invisible feel obvious. He did that better than anyone.")

What this changes — one concrete consequence. ("This means the outline won't start with background. It'll start with the one thing your audience already knows is broken.")
