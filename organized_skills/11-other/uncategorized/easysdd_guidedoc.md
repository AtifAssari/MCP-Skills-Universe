---
rating: ⭐⭐⭐
title: easysdd-guidedoc
url: https://skills.sh/liuzhengdongfortest/easysdd/easysdd-guidedoc
---

# easysdd-guidedoc

skills/liuzhengdongfortest/easysdd/easysdd-guidedoc
easysdd-guidedoc
Installation
...
guidedoc 产物不在 easysdd/ 下——指南是面向外部读者的可发布产物，和 spec 工件分开。
...
发现已有 guide 标 outdated → 任务定性为更新而非新建。
...
写入对应路径
status 从 draft 改为 current，last_reviewed 填当天
更新已有文档时：小修直接在原文件上改，last_reviewed 填当天；大改（结构重组、读者定位调整）先把旧文档 status 改为 outdated 留作参考，再新写一份
与其他工作流的关系
来源	关系
