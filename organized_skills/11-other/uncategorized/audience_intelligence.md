...
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/audience-intelligence
---

# audience-intelligence

skills/indranilbanerjee/digital-marketing-pro/audience-intelligence
audience-intelligence
Installation
$ npx skills add https://github.com/indranilbanerjee/digital-marketing-pro --skill audience-intelligence
SKILL.md
Audience Intelligence
...
Business Description: What does the company sell, to whom, and what problem does it solve?
Existing Customer Data: Any analytics, CRM data, survey results, or customer interviews available
Product/Service Details: Features, pricing, positioning, and key differentiators
Current Audience Assumptions: Who does the team think their customers are today?
Market Context: Industry, competitive landscape, market maturity
Geographic Scope: Local, regional, national, or global audience
Business Model: B2B, B2C, B2B2C, D2C — this fundamentally shapes persona structure
Sales Process: Self-serve, sales-assisted, enterprise sales — determines decision-maker mapping
