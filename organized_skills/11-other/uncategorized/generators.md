...
rating: ⭐⭐
title: generators
url: https://skills.sh/rshankras/claude-code-apple-skills/generators
---

# generators

skills/rshankras/claude-code-apple-skills/generators
generators
Installation
...
How to Use
User requests a component (e.g., "add logging to my app")
Read the relevant skill's SKILL.md
Run pre-generation checks (conflicts, deployment target, etc.)
Ask configuration questions via AskUserQuestion
Generate code from templates, adapting to project context
