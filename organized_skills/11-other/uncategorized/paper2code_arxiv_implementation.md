---
rating: ⭐⭐⭐
title: paper2code-arxiv-implementation
url: https://skills.sh/aradotso/trending-skills/paper2code-arxiv-implementation
---

# paper2code-arxiv-implementation

skills/aradotso/trending-skills/paper2code-arxiv-implementation
paper2code-arxiv-implementation
Installation
...
Run: /paper2code https://arxiv.org/abs/XXXX.XXXXX
Save output to skills/paper2code/worked/{paper_slug}/
Write review.md evaluating correctness, flagged ambiguities, and any mistakes
Submit PR
Improve guardrails
