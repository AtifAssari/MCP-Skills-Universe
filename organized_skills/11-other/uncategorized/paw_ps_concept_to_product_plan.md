---
rating: ⭐⭐
title: paw-ps-concept-to-product-plan
url: https://skills.sh/pawbytes/skill-suites/paw-ps-concept-to-product-plan
---

# paw-ps-concept-to-product-plan

skills/pawbytes/skill-suites/paw-ps-concept-to-product-plan
paw-ps-concept-to-product-plan
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-ps-concept-to-product-plan
SKILL.md
...
On Activation
Load shared context from {project-root}/.pawbytes/prodig-suites/index.md
Load product context: .pawbytes/prodig-suites/products/{product-slug}/product-context.md
If no product slug provided, list available products for selection
Path Resolution
