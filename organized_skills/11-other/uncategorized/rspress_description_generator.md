---
rating: ⭐⭐
title: rspress-description-generator
url: https://skills.sh/rstackjs/agent-skills/rspress-description-generator
---

# rspress-description-generator

skills/rstackjs/agent-skills/rspress-description-generator
rspress-description-generator
Installation
...
Find the Rspress config file. Search for rspress.config.ts, .js, .mjs, or .cjs. It may be at the project root or inside a subdirectory like website/.
Read the config and extract the root option.
...
Confirm the directory exists. If neither docs nor the configured root exists, check for doc as a fallback.
...
Read the file.
Check for existing description in frontmatter. If it exists and is non-empty, skip.
Check pageType in frontmatter. For home pages, derive the description from the hero.text / hero.tagline fields or the features list, not from body content.
