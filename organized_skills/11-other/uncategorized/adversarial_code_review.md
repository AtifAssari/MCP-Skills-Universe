...
url: https://skills.sh/third774/dotfiles/adversarial-code-review
---

# adversarial-code-review

skills/third774/dotfiles/adversarial-code-review
adversarial-code-review
Installation
$ npx skills add https://github.com/third774/dotfiles --skill adversarial-code-review
SKILL.md
Adversarial Code Review
...
High-risk areas first — Auth, payments, user input handling
Recently changed code — git log --since="3 months ago" --name-only
Complex code — High cyclomatic complexity, many dependencies
Code with no tests — Higher likelihood of hidden bugs
...
Apply Malicious User lens → Note findings
Apply Careless Colleague lens → Note findings
Continue through remaining lenses
