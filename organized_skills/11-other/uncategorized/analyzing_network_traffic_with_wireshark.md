...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/analyzing-network-traffic-with-wireshark
---

# analyzing-network-traffic-with-wireshark

skills/mukul975/anthropic-cybersecurity-skills/analyzing-network-traffic-with-wireshark
analyzing-network-traffic-with-wireshark
Installation
$ npx skills add https://github.com/mukul975/anthropic-cybersecurity-skills --skill analyzing-network-traffic-with-wireshark
SKILL.md
Analyzing Network Traffic with Wireshark
When to Use
