...
url: https://skills.sh/markpitt/claude-skills/home-assistant-api
---

# home-assistant-api

skills/markpitt/claude-skills/home-assistant-api
home-assistant-api
Installation
...
resources/core-concepts.md - Understand authentication and basics
resources/state-management.md - Learn to query state
resources/service-reference.md - Learn to control devices
resources/examples.md - See working code

Building an integration?

resources/core-concepts.md - Error handling, timeouts
resources/examples.md - Client setup, retry logic
resources/service-reference.md - Available operations
resources/templates.md - Complex queries

Power user optimizations?

resources/templates.md - Server-side queries
resources/system-config.md - Discovery, caching
resources/examples.md - Performance patterns
