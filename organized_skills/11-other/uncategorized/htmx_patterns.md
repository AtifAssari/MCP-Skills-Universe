...
rating: ⭐⭐⭐
title: htmx-patterns
url: https://skills.sh/kjnez/claude-code-django/htmx-patterns
---

# htmx-patterns

skills/kjnez/claude-code-django/htmx-patterns
htmx-patterns
Installation
$ npx skills add https://github.com/kjnez/claude-code-django --skill htmx-patterns
SKILL.md
