...
url: https://skills.sh/google-gemini/gemini-cli/docs-changelog
---
...
Initial Processing
Analyze Version: Determine the release path based on the version string.
...
Process Time: Convert the TIME input into two formats for later use: yyyy-mm-dd and Month dd, yyyy.
Process Body:
...
Update the version in the main header. The line should read, # Latest stable release: {{version}}
...
Update the version in the main header. The line should read, # Preview release: {{version}}
