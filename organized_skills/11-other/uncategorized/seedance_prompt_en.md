---
rating: ⭐⭐
title: seedance-prompt-en
url: https://skills.sh/dexhunter/seedance2-skill/seedance-prompt-en
---

# seedance-prompt-en

skills/dexhunter/seedance2-skill/seedance-prompt-en
seedance-prompt-en
Installation
...
Reference 15+ camera techniques (push in, orbit, Hitchcock zoom, whip pan, crane shot) and shot sizes to control visual composition precisely
Handle specialized workflows including character consistency, effects replication, video extension/editing, beat-matching to music, product showcases, and educational visualizations
Work within system constraints: up to 12 combined files (9 images, 3 videos, 3 audio tracks), 4–15 second output duration, no realistic human faces in uploads
SKILL.md
