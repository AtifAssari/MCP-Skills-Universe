...
rating: ⭐⭐
title: gmx-trading
url: https://skills.sh/gmx-io/gmx-ai/gmx-trading
---

# gmx-trading

skills/gmx-io/gmx-ai/gmx-trading
gmx-trading
Installation
...
Key gap: There is no sdk.orders.close(). To close a position, use getDecreasePositionAmounts() from @gmx-io/sdk/utils/trade + createDecreaseOrder(). See Step 3: Close a position for the full pattern.
...
Limitations
GM pool deposits/withdrawals: See the gmx-liquidity skill for contract-level operations. SDK convenience methods not yet available.
GLV vault operations: See the gmx-liquidity skill for contract-level operations. SDK convenience methods not yet available.
...
References
SDK Reference — Full module and method documentation
API Endpoints — Oracle, OpenAPI, and GraphQL endpoint details
Contract Addresses — Deployed contracts per chain
Order Types — Detailed order type behavior and trigger logic
GMX Documentation — Official protocol documentation
GMX App — Trading interface
@gmx-io/sdk on npm — SDK package
gmx-io/gmx-interface — Frontend source code
Weekly Installs
13
Repository
gmx-io/gmx-ai
