...
rating: ⭐⭐
title: im-reminder
url: https://skills.sh/agentbay-ai/agentbay-skills/im-reminder
---

# im-reminder

skills/agentbay-ai/agentbay-skills/im-reminder
im-reminder
Installation
...
频道检测
获取频道类型：从运行时 channel 属性获取（如 feishu）
获取用户 ID：从当前会话或消息上下文获取（如 ou_xxxx）
始终自动检测：使用发起请求的原始频道，不要硬编码
消息内容指南
