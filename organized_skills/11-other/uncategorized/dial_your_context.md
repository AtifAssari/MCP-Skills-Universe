---
rating: ⭐⭐⭐
title: dial-your-context
url: https://skills.sh/sanity-io/agent-context/dial-your-context
---

# dial-your-context

skills/sanity-io/agent-context/dial-your-context
dial-your-context
Installation
...
Write the instructions and groqFilter fields to the draft context doc
Verify by querying the draft MCP endpoint — confirm the instructions appear in ## Custom instructions
Promote to production: Either update the production context doc's instructions and groqFilter fields to match, or update the production agent's MCP URL to point to the new slug
