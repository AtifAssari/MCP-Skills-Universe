---
rating: ⭐⭐⭐
title: skill-system-tmux
url: https://skills.sh/arthur0824hao/skills/skill-system-tmux
---

# skill-system-tmux

skills/arthur0824hao/skills/skill-system-tmux
skill-system-tmux
Installation
...
Look for shell prompt at end of output (regex: /(\\$|>|#)\s*$/m)
If prompt appears, command has finished
