...
rating: ⭐⭐⭐
title: web-monitor
url: https://skills.sh/rogue-agent1/web-monitor/web-monitor
---

# web-monitor

skills/rogue-agent1/web-monitor/web-monitor
web-monitor
Installation
$ npx skills add https://github.com/rogue-agent1/web-monitor --skill web-monitor
SKILL.md
Web Monitor
