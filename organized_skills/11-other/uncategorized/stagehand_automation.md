...
url: https://skills.sh/adaptationio/skrillz/stagehand-automation
---

# stagehand-automation

skills/adaptationio/skrillz/stagehand-automation
stagehand-automation
Installation
...
ID/Class Changes: Button ID changes from #old-id to #new-id
Structure Changes: Element moves in DOM tree
