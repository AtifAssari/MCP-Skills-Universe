...
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/research-pipeline
---

# research-pipeline

skills/wanshuiyin/auto-claude-code-research-in-sleep/research-pipeline
research-pipeline
Installation
$ npx skills add https://github.com/wanshuiyin/auto-claude-code-research-in-sleep --skill research-pipeline
SKILL.md
...
Read the idea details from idea-stage/IDEA_REPORT.md (hypothesis, experimental design, pilot code) (fall back to ./IDEA_REPORT.md if not found)
