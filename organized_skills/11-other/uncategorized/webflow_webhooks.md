...
url: https://skills.sh/224-industries/webflow-skills/webflow-webhooks
---

# webflow-webhooks

skills/224-industries/webflow-skills/webflow-webhooks
webflow-webhooks
Installation
$ npx skills add https://github.com/224-industries/webflow-skills --skill webflow-webhooks
SKILL.md
Webflow Webhooks
...
Verify signatures: Validate x-webflow-signature and x-webflow-timestamp headers
Process events: Route events by triggerType and handle each accordingly
Acknowledge: Return 200 to confirm receipt (other statuses trigger retries)
