---
rating: ⭐⭐⭐
title: hz-api-upgrade
url: https://skills.sh/meta-quest/agentic-tools/hz-api-upgrade
---

# hz-api-upgrade

skills/meta-quest/agentic-tools/hz-api-upgrade
hz-api-upgrade
Installation
...
References
Deprecation Guide -- Common deprecated APIs and their replacements
SDK Migration Guide -- Step-by-step platform-specific migration instructions
API Changelog -- Summary of changes across recent SDK versions
Weekly Installs
11
Repository
