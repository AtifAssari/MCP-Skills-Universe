...
rating: ⭐⭐⭐
title: youtube-feed
url: https://skills.sh/zephyrwang6/myskill/youtube-feed
---

# youtube-feed

skills/zephyrwang6/myskill/youtube-feed
youtube-feed
Installation
...
标题翻译：将英文标题翻译成中文，保留关键术语
嘉宾介绍：详细介绍嘉宾背景（100-150字），包含：
嘉宾姓名和当前职位
所在公司/机构及其知名度
嘉宾的代表作品或成就
为什么这个人值得关注
内容摘要：用中文描述播客主要讨论的话题（150-200字）
推荐理由：说明为什么这期播客值得听
输出模板
### {序号}. [{中文标题}]({链接})
**{频道}** | {日期} | ⏱ {时长} | 👁 {播放量}
...
打开频道页面
查看页面源码，搜索 "channelId"
或使用在线工具如 https://commentpicker.com/youtube-channel-id.php
与其他 Skill 配合
