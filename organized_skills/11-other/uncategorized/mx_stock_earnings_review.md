---
rating: ⭐⭐⭐
title: mx-stock-earnings-review
url: https://skills.sh/site/skills.volces.com/mx-stock-earnings-review
---

# mx-stock-earnings-review

skills/skills.volces.com/stock-earnings-review
stock-earnings-review
$ npx skills add https://skills.volces.com/skills/clawhub/gracexiaoo
SKILL.md
...
scripts/validate_entity.py 获得实体
scripts/normalize_report_period.py 获得报告期候选
大模型基于用户语义选择 reportDate
scripts/call_review_api.py 生成点评并保存附件
...
STOCK_EARNINGS_REVIEW_OUTPUT_DIR	日志与附件的根目录（其下仍按每次 run 分子目录）	miaoxiang/stock-earnings-review（相对当前工作目录）
