...
url: https://skills.sh/patternsdev/skills/compound-pattern
---

# compound-pattern

skills/patternsdev/skills/compound-pattern
compound-pattern
Installation
...
Source
patterns.dev/react/compound-pattern
References
Render Props - React
React Hooks: Compound Components - Kent C. Dodds
Weekly Installs
332
Repository
patternsdev/skills
