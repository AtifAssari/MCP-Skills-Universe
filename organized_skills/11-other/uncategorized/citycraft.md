...
rating: ⭐⭐⭐
title: citycraft
url: https://skills.sh/oil-oil/citycraft/citycraft
---

# citycraft

skills/oil-oil/citycraft/citycraft
citycraft
Installation
$ npx skills add https://github.com/oil-oil/citycraft --skill citycraft
SKILL.md
...
For testimonials use: A, B, C, D, E, F For conversion sections use: PRICING, COMPARE_PRICING, BRAND_WALL, CTA, FAQ_A, FAQ_B
...
Paste texture + clip-path CSS from _texture.css
Nav CSS matching the selected nav style (from references/nav-catalog.md)
...
Paste the relevant functions from _gsap-base.js — required minimum:
...
Call sequence at bottom; ScrollTrigger.refresh() after fonts load
...
No #ffffff backgrounds. Not on sections, not on cards. Warm neutrals: #f5ede0. Cool: #edf0ee. Dark: #08060f. Cards get a slight tint, never pure white.
No #6366f1. Color comes from the city style palette.
...
Two typefaces minimum. Display/serif for headlines + clean sans for body. From references/city-styles.md. Decorative/script accent fonts (when a city style mentions one) go on watermarks, pull quotes, or ornamental elements — never on buttons, nav, or body copy.
Nav must surprise. Use the chosen nav from references/nav-catalog.md with its full surprise element implemented.
