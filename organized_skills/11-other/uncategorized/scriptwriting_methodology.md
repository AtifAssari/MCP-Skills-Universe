---
rating: ⭐⭐
title: scriptwriting-methodology
url: https://skills.sh/mike-coulbourn/claude-vibes/scriptwriting-methodology
---

# scriptwriting-methodology

skills/mike-coulbourn/claude-vibes/scriptwriting-methodology
scriptwriting-methodology
Installation
$ npx skills add https://github.com/mike-coulbourn/claude-vibes --skill scriptwriting-methodology
SKILL.md
...
PROBLEM (3-7 seconds): Make them feel understood
SOLUTION (7-12 seconds): Introduce the product
VALUE PROP (12-15 seconds): Why this product is different
SOCIAL PROOF (15-18 seconds): Results and credibility
CTA (18-20 seconds): Clear call to action
Key Principle
...
Problem (15%): Identify the specific problem
Agitate (25%): Intensify the pain — make them FEEL it
Solution (60%): Present the product as the answer
...
Agitate: Intensify emotional response
Intrigue: Create curiosity about the solution
Positive Future: Paint a picture of life after the problem is solved
...
Match urgency to context: Don't fake scarcity
Use action words: grab, snag, check out, try
