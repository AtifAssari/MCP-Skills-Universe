...
url: https://skills.sh/figma/mcp-server-guide/code-connect-components
---

# code-connect-components

skills/figma/mcp-server-guide/code-connect-components
code-connect-components
Installation
...
Present to user: "The following components match the design:
