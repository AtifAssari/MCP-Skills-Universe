---
rating: ⭐⭐
title: x402-video-generator
url: https://skills.sh/andy-t-wang/x402-worldchain/x402-video-generator
---

# x402-video-generator

skills/andy-t-wang/x402-worldchain/x402-video-generator
x402-video-generator
Installation
$ npx skills add https://github.com/andy-t-wang/x402-worldchain --skill x402-video-generator
SKILL.md
...
The style is ALWAYS Studio Ghibli-inspired animation — soft watercolor palette, warm lighting, gentle movement, expressive characters.
The prompt should use specific details from what the user told you.
Structure: Morning → Afternoon → Night.
Make it whimsical and cozy — everyday moments made magical in Ghibli fashion.
...
Install dependencies: npm install @x402/fetch @x402/evm siwe viem
Copy the COMPLETE script below into a .ts file
Replace ONLY the prompt string on the line marked REPLACE THIS
Run with npx tsx <file>
Wait for the video URL (2-5 minutes)
Share the video URL with the user
