---
rating: ⭐⭐⭐
title: tooyoung:openclash-merger
url: https://skills.sh/shiqkuangsan/oh-my-daily-skills/tooyoung:openclash-merger
---

# tooyoung:openclash-merger

skills/shiqkuangsan/oh-my-daily-skills/tooyoung:openclash-merger
tooyoung:openclash-merger
Installation
$ npx skills add https://github.com/shiqkuangsan/oh-my-daily-skills --skill tooyoung:openclash-merger
SKILL.md
OpenClash 订阅配置合并
...
工作原理
获取配置 - 从订阅链接下载或读取本地文件
提取节点 - 从 proxies: 部分提取所有代理节点
分类节点 - 按地区关键字分类（11 个地区 + 其他）
填充模板 - 将节点填入模板的占位符
