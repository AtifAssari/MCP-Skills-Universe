---
rating: ⭐⭐
title: using-typescript-lsp
url: https://skills.sh/mhagrelius/dotfiles/using-typescript-lsp
---

# using-typescript-lsp

skills/mhagrelius/dotfiles/using-typescript-lsp
using-typescript-lsp
Installation
...
Language server installed: npm install -g typescript-language-server typescript
Project configured: tsconfig.json or jsconfig.json present (recommended for accuracy)
...
Document the limitation - explicitly state: "LSP unavailable, using text search as fallback"
Use Grep with caution - understand it may miss aliased imports or re-exports
Verify manually - for refactoring, double-check results make sense semantically
Suggest fix - remind user to ensure typescript-language-server is installed and plugin enabled
