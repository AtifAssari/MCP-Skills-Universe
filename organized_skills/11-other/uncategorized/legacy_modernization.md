...
url: https://skills.sh/nickcrew/claude-ctx-plugin/legacy-modernization
---

# legacy-modernization

skills/nickcrew/claude-ctx-plugin/legacy-modernization
legacy-modernization
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill legacy-modernization
SKILL.md
Legacy Modernization
