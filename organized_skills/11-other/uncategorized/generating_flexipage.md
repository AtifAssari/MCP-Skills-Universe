---
rating: ⭐⭐⭐
title: generating-flexipage
url: https://skills.sh/forcedotcom/afv-library/generating-flexipage
---

# generating-flexipage

skills/forcedotcom/afv-library/generating-flexipage
generating-flexipage
Installation
...
Retry the sf template generate flexipage command
...
Cause: Added <mode> tag to region Fix: Remove <mode> tags - they're not needed for standard regions
...
Location: Must be in header region. Explicit Fields (via CLI): Use the most important fields to show a summary of the record. The single primary field is used to identify the record, like a name. The secondary fields (max 12, recommended 6) are used as a summary of the record.
