...
rating: ⭐⭐⭐
title: spec-to-plan
url: https://skills.sh/kambleakash0/agent-skills/spec-to-plan
---

# spec-to-plan

skills/kambleakash0/agent-skills/spec-to-plan
spec-to-plan
Installation
...
Behavior and Rules
Stay at the plan level. Do not drop into detailed implementation plans or specific file edits; that is work for execution skills like /tdd.
Think in risk and value. Earlier phases should de-risk core architecture and ship something demoable quickly.
Keep slices vertical. Avoid phases that are purely “set up database” or “build UI” without delivering end-to-end value.
Make decisions explicit. Put durable architectural decisions in the plan header so downstream skills and humans can reuse them.
Write for future you and agents. Plans should be readable, skimmable, and easy to hand to another engineer or AI agent as a starting point.
Weekly Installs
10
Repository
