...
url: https://skills.sh/jmsktm/claude-settings/monitoring-setup
---

# monitoring-setup

skills/jmsktm/claude-settings/monitoring-setup
monitoring-setup
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill monitoring-setup
SKILL.md
