...
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-demo-script
---

# hackathon-demo-script

skills/bernieweb3/hackathon-ai-devkit/hackathon-demo-script
hackathon-demo-script
Installation
$ npx skills add https://github.com/bernieweb3/hackathon-ai-devkit --skill hackathon-demo-script
SKILL.md
hackathon-demo-script
Goal
...
Rules
Total demo_flow timing must be within demo_duration_seconds ± 10 seconds.
Open with the problem or a user story — never with "Hi, we're team X and we built..."
primary_wow_moment must appear before 60% of demo_duration_seconds.
Every step in mvp_demo_flow must map to at least one demo_flow step.
Spoken lines per step must be 15 words or fewer — short enough to say confidently while operating the UI.
wow_moment_staging must include: pause instruction, what to say, what the audience sees.
rehearsal_checklist must include: demo account state, test data loaded, browser/app state, notifications disabled.
Output Format
demo_narrative: |
