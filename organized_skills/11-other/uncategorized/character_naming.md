...
url: https://skills.sh/jwynia/agent-skills/character-naming
---

# character-naming

skills/jwynia/agent-skills/character-naming
character-naming
Installation
...
Diagnostic Process
Listen for symptoms — Identify which state applies
Establish context — Get setting, period, cultures before any generation
Check existing cast — What names are already committed?
...
Generate with entropy — Run scripts, never "think of" names
Validate against cast — Check for collisions before finalizing
Available Tools
character-name.ts
...
Ask about the cultural makeup of the specific neighborhoods featured
Ask how many main characters need names
Ask what names, if any, are already locked in
Generate from appropriate cultural pools using entropy
Check each suggestion against cast for collisions
...
Ask about the aesthetic—high fantasy, dark, whimsical?
Ask if there are naming conventions (clan names, true names, etc.)
Generate from elvish-like phoneme preset
Ensure consistency within the culture
