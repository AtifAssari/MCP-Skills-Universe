---
rating: ⭐⭐⭐
title: wechat-article-aggregator
url: https://skills.sh/wwwzhouhui/skills_collection/wechat-article-aggregator
---
...
定位 id="js_content" 的 div 元素
移除 script、style、noscript 标签内容
提取文本内容，保留段落换行
使用 html2text 转换为 Markdown（如已安装）
预置公众号列表
序号	公众号名称	分类	FakeID
