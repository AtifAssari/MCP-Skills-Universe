...
rating: ⭐⭐⭐
title: hccl-test
url: https://skills.sh/ascend-ai-coding/awesome-ascend-skills/hccl-test
---

# hccl-test

skills/ascend-ai-coding/awesome-ascend-skills/hccl-test
hccl-test
Installation
...
8.3 其他注意事项
Docker 容器：如果使用 Docker 容器进行测试，需要使用 host 网络模式
日志查看：测试失败时可查看 ~/ascend/log/debug/plog 中的最新日志
进程清理：测试前检查卡上是否有其他进程占用，如有需要手动清理

详细故障排除见 references/common-issues.md
