...
rating: ⭐⭐⭐
title: ppw:update
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:update
---

# ppw:update

skills/lylll9436/paper-polish-workflow-skill/ppw:update
ppw:update
Installation
...
Fetch the remote file content via gh api with base64 decode.
Read the local references/{filename} if it exists.
Compare and apply the same NEW/UPDATED/UNCHANGED logic as Step 3.
For subdirectories (e.g., references/journals/, references/expression-patterns/), recurse into each file.
