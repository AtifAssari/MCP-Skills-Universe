...
url: https://skills.sh/martinffx/atelier/spec:implement
---

# spec:implement

skills/martinffx/atelier/spec:implement
spec:implement
Installation
...
Approved spec — docs/specs/YYYY-MM-DD-<feature>/spec.md
Approved plan — docs/specs/YYYY-MM-DD-<feature>/plan.json
Tasks created — In beads or plan.json task list
...
Run full test suite — all tests must pass, not just the new ones
Run type check / lint — clean output, no new warnings
Verify beads tasks — bd list --label <feature> --json — all tasks must be closed
Diff review — review the full diff against main/master. Look for:
