...
rating: ⭐⭐⭐
title: videodb
url: https://skills.sh/affaan-m/everything-claude-code/videodb
---

# videodb

skills/affaan-m/everything-claude-code/videodb
videodb
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill videodb
SKILL.md
VideoDB Skill
...
Quick Start
Choose state dir: STATE_DIR="${VIDEODB_EVENTS_DIR:-$HOME/.local/state/videodb}"
Start listener: VIDEODB_EVENTS_DIR="$STATE_DIR" python scripts/ws_listener.py --clear "$STATE_DIR" &
Get WebSocket ID: cat "$STATE_DIR/videodb_ws_id"
