---
rating: ⭐⭐
title: naver-blog-research
url: https://skills.sh/nomadamas/k-skill/naver-blog-research
---

# naver-blog-research

skills/nomadamas/k-skill/naver-blog-research
naver-blog-research
Installation
...
--timeout	X	요청 타임아웃(초)	15
추천 워크플로우
naver_search.py로 검색 → 상위 3~5개 결과 확인
관련도 높은 포스트를 naver_read.py로 원문 읽기
필요 시 naver_download_images.py로 이미지 저장
