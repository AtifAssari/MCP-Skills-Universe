...
rating: ⭐⭐⭐
title: system-doctor
url: https://skills.sh/majiayu000/claude-arsenal/system-doctor
---

# system-doctor

skills/majiayu000/claude-arsenal/system-doctor
system-doctor
Installation
$ npx skills add https://github.com/majiayu000/claude-arsenal --skill system-doctor
SKILL.md
系统性能诊断工具
...
关闭某个占用高的进程（通过 kill PID）
关闭某个应用的所有进程（通过 killall 应用名）
查看某个进程的详细信息（通过 ps -p PID -o pid,ppid,%cpu,%mem,rss,etime,command）
