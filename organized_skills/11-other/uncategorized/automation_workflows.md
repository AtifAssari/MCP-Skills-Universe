...
url: https://skills.sh/jk-0001/skills/automation-workflows
---

# automation-workflows

skills/jk-0001/skills/automation-workflows
automation-workflows
Installation
$ npx skills add https://github.com/jk-0001/skills --skill automation-workflows
Summary
...
Emphasizes error handling, monitoring, and maintenance to prevent silent failures and keep automations reliable
Provides decision frameworks for tool selection based on complexity and budget, plus a checklist of low-hanging fruit automation opportunities to start with
SKILL.md
Automation Workflows
Overview
