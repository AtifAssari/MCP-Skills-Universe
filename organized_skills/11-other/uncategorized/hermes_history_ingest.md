---
rating: ⭐⭐⭐
title: hermes-history-ingest
url: https://skills.sh/ar9av/obsidian-wiki/hermes-history-ingest
---

# hermes-history-ingest

skills/ar9av/obsidian-wiki/hermes-history-ingest
hermes-history-ingest
Installation
...
Before You Start
Read .env to get OBSIDIAN_VAULT_PATH and HERMES_HISTORY_PATH (default to ~/.hermes if unset)
