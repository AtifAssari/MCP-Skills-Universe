...
url: https://skills.sh/chouheiwa/skill-mermaid-render/mermaid-render
---

# mermaid-render

skills/chouheiwa/skill-mermaid-render/mermaid-render
mermaid-render
Installation
...
User mentions "hand-drawn", "sketch", or "rough" style — keep default or add --pencil-filter
User wants clean/standard Mermaid output (no hand-drawn) — use --no-handdrawn
