---
rating: ⭐⭐⭐
title: archon manager
url: https://skills.sh/daffy0208/ai-dev-standards/archon-manager
---

# archon manager

skills/daffy0208/ai-dev-standards/Archon Manager
Archon Manager
Installation
...
Check MCP configuration in .claude/mcp-settings.json
Restart AI assistant after config changes
Check Archon logs: docker logs archon-api
...
Verify knowledge base has content: archon:list_sources()
Check embeddings generated (wait for processing)
Lower similarity_threshold (default 0.7, try 0.5)
Broader query terms
Check source tags match filter_tags
...
Verify project exists: archon:list_projects()
...
Use match_count appropriately (5-10, not 100)
...
✅ Always know what's next: get_next_task guides daily work
✅ Rich knowledge base: RAG queries return relevant, useful results
