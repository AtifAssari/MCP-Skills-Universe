---
rating: ⭐⭐
title: nsfc-research-foundation-writer
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-research-foundation-writer
---

# nsfc-research-foundation-writer

skills/huangwb8/chineseresearchlatex/nsfc-research-foundation-writer
nsfc-research-foundation-writer
Installation
...
写入安全约束（必须遵守）
仅编辑两份 extraTex/3.*.tex 文件；不得修改 main.tex、extraTex/@config.tex、任何 .cls/.sty
目标文件若已包含标题命令（如 \\subsection{...} / \\subsubsection{...}），只替换正文内容，不改标题与结构层级
信息不全时先提问补齐；不得捏造论文题目/期刊/专利号/样本量/指标等“看起来像真的”细节
工作流（按顺序执行）
定位项目与目标文件：
