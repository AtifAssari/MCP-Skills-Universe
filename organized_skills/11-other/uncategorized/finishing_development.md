...
url: https://skills.sh/zixun-github/aisdlc/finishing-development
---

# finishing-development

skills/zixun-github/aisdlc/finishing-development
finishing-development
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill finishing-development
SKILL.md
开发收尾确认（仅验证，不做合并/清理）
概述
