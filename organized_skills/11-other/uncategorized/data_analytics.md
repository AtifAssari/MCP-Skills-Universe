...
url: https://skills.sh/vivy-yi/xiaohongshu-skills/data-analytics
---

# data-analytics

skills/vivy-yi/xiaohongshu-skills/data-analytics
data-analytics
Installation
$ npx skills add https://github.com/vivy-yi/xiaohongshu-skills --skill data-analytics
SKILL.md
Data Analytics (数据分析)
Overview
...
Exposure (浏览量) - Reach and discovery
Engagement (互动率) - Likes, comments, shares
Conversion (转化率) - Follows, saves, clicks
Growth (粉丝增长) - New followers, unfollows
Audience (用户画像) - Demographics, behavior patterns
Quick Reference
