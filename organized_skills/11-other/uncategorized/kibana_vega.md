...
rating: ⭐⭐⭐
title: kibana-vega
url: https://skills.sh/elastic/agent-skills/kibana-vega
---

# kibana-vega

skills/elastic/agent-skills/kibana-vega
kibana-vega
Installation
...
Sort bars by value — pre-sort in ES|QL with SORT field DESC and use sort: null in encoding (preserves data order); avoid sort: "-x" in layered specs (bar + text labels) as it causes "conflicting sort properties" warnings
