...
rating: ⭐⭐
title: tmuxx
url: https://skills.sh/ladderchaos/tmuxx/tmuxx
---

# tmuxx

skills/ladderchaos/tmuxx/tmuxx
tmuxx
Installation
...
Run tmuxx agent task-report <branch> --json (if branch-based).
Run tmuxx agent list-sessions --json and tmuxx agent list-worktrees --json.
If still blocked, return the exact command, error text, and suggested next command.
Known Limitations
