---
rating: ⭐⭐⭐
title: planning-with-files-zh
url: https://skills.sh/othmanadi/planning-with-files/planning-with-files-zh
---
...
创建 task_plan.md — 参考 templates/task_plan.md 模板
创建 findings.md — 参考 templates/findings.md 模板
创建 progress.md — 参考 templates/progress.md 模板
决策前重新读取计划 — 在注意力窗口中刷新目标
每个阶段完成后更新 — 标记完成，记录错误
