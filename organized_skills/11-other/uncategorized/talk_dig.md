...
rating: ⭐⭐⭐
title: talk-dig
url: https://skills.sh/ppx123-web/claude-config/talk-dig
---

# talk-dig

skills/ppx123-web/claude-config/talk-dig
talk-dig
Installation
$ npx skills add https://github.com/ppx123-web/claude-config --skill talk-dig
SKILL.md
...
最佳实践
使用建议
提前使用: 在参加talk前1-2天使用，留出阅读时间
质量检查: 如果提取的信息不准确，可以手动修正
深度阅读: 对于高度相关的论文，建议阅读全文
问题准备: 基于论文内容准备提问
提高准确性
确保海报图片清晰，文字可读
如果讲者有重名，提供额外的上下文信息
...
错误处理
常见问题
信息提取失败: 海报模糊或格式特殊 → 提供手动输入信息
找不到论文: 讲者是新人或领域冷门 → 扩大搜索范围
论文太多: 搜索结果过多 → 限制时间范围或相关性过滤
无法访问: 论文在付费墙后 → 寻找open access版本
解决方案
使用多个搜索引擎交叉验证
优先查找arXiv等开放获取平台
必要时使用机构访问权限
