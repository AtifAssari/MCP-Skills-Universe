---
rating: ⭐⭐
title: webnovel-write
url: https://skills.sh/lingfengqaq/webnovel-writer/webnovel-write
---

# webnovel-write

skills/lingfengqaq/webnovel-writer/webnovel-write
webnovel-write
Installation
...
本章硬性约束：chapter_directive.goal/time_anchor/chapter_span/countdown/chapter_end_open_question
CBN/CPNs/CEN 与 must_cover_nodes
本章禁区：forbidden_zones，违反即不通过
风格指引：reasoning、主角卡 OOC 警戒、anti_patterns
场景写法补充：dynamic_context，仅作风格参考，不能覆盖章纲约束
...
正文文件存在且非空
审查已落库（--minimal 除外）
blocking=true 必须停在 Step 3
anti_ai_force_check=pass（--minimal 除外）
accepted CHAPTER_COMMIT，projection 五项 done/skipped
chapter_status=committed（projection 自动推进）
失败恢复
