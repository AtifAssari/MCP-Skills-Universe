---
rating: ⭐⭐⭐
title: binary-re:tool-setup
url: https://skills.sh/2389-research/claude-plugins/binary-re:tool-setup
---

# binary-re:tool-setup

skills/2389-research/claude-plugins/binary-re:tool-setup
binary-re:tool-setup
Installation
