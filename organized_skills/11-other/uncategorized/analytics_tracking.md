...
url: https://skills.sh/sickn33/antigravity-awesome-skills/analytics-tracking
---

# analytics-tracking

skills/sickn33/antigravity-awesome-skills/analytics-tracking
analytics-tracking
Installation
...
Includes validation guidance for real-time verification, duplicate detection, cross-browser testing, and consent-state validation to catch common failure modes
Emphasizes decision alignment: track only signals that directly support business actions, working backwards from questions rather than tracking "just in case"
SKILL.md
