...
url: https://skills.sh/itechmeat/llm-code/project-creator
---

# project-creator

skills/itechmeat/llm-code/project-creator
project-creator
Installation
...
Standard Flow
Load guide from references/
Check if document exists — read and assess if yes
Create/update using template from assets/
Interview user with questions from guide
Draft content based on responses
Present draft, ask for feedback
