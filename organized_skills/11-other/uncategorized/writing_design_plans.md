---
rating: ⭐⭐⭐
title: writing-design-plans
url: https://skills.sh/ed3dai/ed3d-plugins/writing-design-plans
---

# writing-design-plans

skills/ed3dai/ed3d-plugins/writing-design-plans
writing-design-plans
Installation
$ npx skills add https://github.com/ed3dai/ed3d-plugins --skill writing-design-plans
SKILL.md
Writing Design Plans
Overview
...
Generates Acceptance Criteria (inline) and gets human validation
Generates Summary and Glossary to replace the placeholders
Legibility Header
...
Success cases: What are all the ways this can succeed? List each distinctly.
...
Important failure cases: What should the system reject or handle gracefully?
