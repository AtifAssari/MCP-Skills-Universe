...
url: https://skills.sh/jmsktm/claude-settings/ci-cd-pipeline-builder
---

# ci-cd-pipeline-builder

skills/jmsktm/claude-settings/ci-cd-pipeline-builder
ci-cd-pipeline-builder
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill ci-cd-pipeline-builder
SKILL.md
