...
rating: ⭐⭐⭐
title: js-deps
url: https://skills.sh/whatifwedigdeeper/agent-skills/js-deps
---

# js-deps

skills/whatifwedigdeeper/agent-skills/js-deps
js-deps
Installation
...
Search for version references using patterns like grep -r "v<old-major>" --include="*.md" across CLAUDE.md, README.md, docs/*.md
Also check the engines field in package.json (e.g., "engines": { "node": ">=18" }) and update if needed
Include changes in report/PR description
