...
rating: ⭐⭐⭐
title: gpu-use
url: https://skills.sh/majiayu000/claude-arsenal/gpu-use
---

# gpu-use

skills/majiayu000/claude-arsenal/gpu-use
gpu-use
Installation
$ npx skills add https://github.com/majiayu000/claude-arsenal --skill gpu-use
SKILL.md
GPU 使用情况诊断
