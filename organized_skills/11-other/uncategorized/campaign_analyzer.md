...
url: https://skills.sh/eddiebe147/claude-settings/campaign-analyzer
---

# campaign analyzer

skills/eddiebe147/claude-settings/Campaign Analyzer
Campaign Analyzer
Installation
...
Goal Alignment - Compare results to objectives
KPI Dashboard - Track primary and secondary metrics
Funnel Analysis - Identify conversion bottlenecks
Channel Attribution - Understand contribution by source
Spend Efficiency - Calculate cost metrics (CPM, CPC, CPA, ROAS)
Audience Performance - Segment by demographic/behavior
Creative Analysis - Identify top-performing assets
Recommendation Synthesis - Actionable next steps
Workflow 2: Multi-Channel Analysis
Channel Mapping - All touchpoints in customer journey
Attribution Modeling - First touch, last touch, multi-touch
Cross-Channel Synergies - How channels work together
Budget Allocation Review - Spend vs performance by channel
Audience Overlap - Reach and frequency across channels
Journey Mapping - Path to conversion analysis
Optimization Recommendations - Reallocation suggestions
Workflow 3: Creative Performance Analysis
Asset Inventory - All creative variations tested
Performance Ranking - Best to worst performers
Element Analysis - What elements drive performance
Format Comparison - Static vs video vs carousel
Message Testing - Which value props resonate
Creative Fatigue - Performance over time
Learning Documentation - Insights for future creative
Workflow 4: ROI & Attribution Analysis
Revenue Attribution - Connect marketing to revenue
Customer Acquisition Cost - Fully-loaded CAC calculation
Lifetime Value Analysis - LTV by acquisition channel
ROAS Calculation - Return on ad spend by campaign
Payback Period - Time to recoup acquisition cost
Incrementality Testing - True marketing impact
Budget Optimization Model - Optimal allocation recommendations
Quick Reference
