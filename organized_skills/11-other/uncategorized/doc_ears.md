...
rating: ⭐⭐⭐⭐⭐
title: doc-ears
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-ears
---

# doc-ears

skills/vladm3105/aidoc-flow-framework/doc-ears
doc-ears
Installation
...
Template: ai_dev_ssd_flow/03_EARS/EARS-MVP-TEMPLATE.md (Template Version 1.1, primary authority)
Schema: ai_dev_ssd_flow/03_EARS/EARS_MVP_SCHEMA.yaml (machine-readable validation rules)
...
Create EARS-{NN}.0_index.md using EARS-SECTION-0-TEMPLATE.md
Create section files EARS-{NN}.{S}_{slug}.md using EARS-SECTION-TEMPLATE.md
...
Create folder: docs/03_EARS/EARS-NN_{slug}/
...
Read EARS_SCHEMA.yaml for current metadata requirements
Verify tag standards: ears (not ears-requirements)
Verify document_type: ears
Verify architecture format: architecture_approaches: [value] (array)
Every 5-Document Checkpoint

After creating every 5 EARS documents:

Run validation: python scripts/validate_ears.py --path docs/03_EARS/
...
Run full validation: python scripts/validate_ears.py
Verify 0 errors
