...
rating: ⭐⭐⭐
title: php-upgrade
url: https://skills.sh/krzysztofsurdy/code-virtuoso/php-upgrade
---

# php-upgrade

skills/krzysztofsurdy/code-virtuoso/php-upgrade
php-upgrade
Installation
...
Search the web for PHP X.Y migration guide (e.g., PHP 8.4 migration guide php.net)
Or ask the user to provide the changelog / release notes
Read the official migration page at https://www.php.net/manual/en/migrationXY.php
...
Run composer outdated to check if all dependencies support the target version
Review the official migration guide at php.net for the target version
Check PHP extensions for compatibility (ext-intl, ext-mbstring, etc.)
Phase 2: Automate
...
Update composer.json with the new PHP version constraint: "php": ">=8.4"
Update config.platform.php to match the target version
