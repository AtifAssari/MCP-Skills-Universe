...
rating: ⭐⭐⭐
title: zeptomail
url: https://skills.sh/vm0-ai/vm0-skills/zeptomail
---

# zeptomail

skills/vm0-ai/vm0-skills/zeptomail
zeptomail
Installation
$ npx skills add https://github.com/vm0-ai/vm0-skills --skill zeptomail
SKILL.md
Troubleshooting
...
Track reference - Use client_reference to correlate emails with your transactions
TLS required - API only supports TLS v1.2+
Weekly Installs
63
Repository
vm0-ai/vm0-skills
