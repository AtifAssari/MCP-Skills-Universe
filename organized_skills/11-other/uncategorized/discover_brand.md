...
url: https://skills.sh/anthropics/knowledge-work-plugins/discover-brand
---

# discover-brand

skills/anthropics/knowledge-work-plugins/discover-brand
discover-brand
Installation
...
Save — Guidelines are saved to .claude/brand-voice-guidelines.md in your working folder once you approve them. Nothing is written until that step.
...
Generate guidelines now — chain to /brand-voice:generate-guidelines using discovery report as input
