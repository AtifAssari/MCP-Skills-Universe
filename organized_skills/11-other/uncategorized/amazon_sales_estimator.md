...
url: https://skills.sh/nexscope-ai/amazon-skills/amazon-sales-estimator
---
...
Workflow
Receive input: BSR, Category, Price, Marketplace
Look up base sales: Use BSR-to-sales reference table for the marketplace
Apply category multiplier: Adjust based on category (Electronics 1.2x, Clothing 0.8x, etc.)
Calculate monthly units: Base sales × category multiplier
Calculate revenue: Monthly units × price
Output results: Monthly units, daily units, monthly revenue
Output
# 📊 Sales Estimate
...
Workflow
Fetch product data using web_fetch on Amazon product page
Extract: Title, Price, BSR, Category, Rating, Reviews
Apply BSR-to-sales formula for the category and marketplace
Calculate revenue: Monthly units × Price
Output
...
Workflow
Search products using web_search for site:amazon.com "{keyword}"
Fetch top 10-20 product pages to get BSR data
Estimate sales for each product using Mode A formula
Aggregate total market size
Analyze price distribution and competition
Output
