---
rating: ⭐⭐
title: spec-requesting-code-review
url: https://skills.sh/zixun-github/aisdlc/spec-requesting-code-review
---

# spec-requesting-code-review

skills/zixun-github/aisdlc/spec-requesting-code-review
spec-requesting-code-review
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill spec-requesting-code-review
SKILL.md
请求代码审查
