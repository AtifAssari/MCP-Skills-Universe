...
url: https://skills.sh/secondsky/claude-skills/nano-banana-prompts
---

# nano-banana-prompts

skills/secondsky/claude-skills/nano-banana-prompts
nano-banana-prompts
Installation
$ npx skills add https://github.com/secondsky/claude-skills --skill nano-banana-prompts
SKILL.md
...
Lighting - Natural/artificial light sources and quality
Mood - Emotional tone or atmosphere
Technical Details - Camera, lens, style specifics
Format - Aspect ratio or dimensions
Prompt Length
...
"Create professional headshot of woman in business attire"
"Change background to modern office"
"Make her wearing glasses"
"Add warmer lighting"
Product Photography
Template
...
✅ Subject clearly described ✅ Action or pose specified ✅ Environment/setting detailed ✅ Lighting source and quality ✅ Mood or atmosphere ✅ Style or technical specs ✅ Aspect ratio chosen ✅ Complete sentences, not keywords

Common Issues & Solutions
Prompt Quality Issues

Issue: Generic or vague output Cause: Prompt too short or lacks specificity Solution: Expand to 50-100 words. Add lighting details, mood, and specific technical specs (lens, style, etc.).
...
Issue: Conflicting style instructions Cause: Mixing incompatible styles (e.g., "photorealistic watercolor") Solution: Choose one primary style. For photography, use camera terminology. For art, use medium/technique terminology.

Issue: Text rendering failures Cause: Too much text, complex fonts, or unclear positioning Solution:
...
Issue: Unwanted elements in image Cause: Ambiguous phrasing or conflicting descriptors Solution: Be explicit about what should NOT appear. Use precise, unambiguous language.

Generation Issues

Issue: Image doesn't match prompt Cause: Prompt too complex or contradictory elements Solution:

Simplify prompt to core concept
Use multi-turn editing workflow
Start basic, refine iteratively

Issue: Inconsistent results across generations Cause: Vague descriptors allowing wide interpretation Solution: Add specific details about colors, materials, lighting angles, camera settings, and composition rules (rule of thirds, golden ratio).

Issue: Poor composition Cause: No compositional guidance in prompt Solution: Explicitly mention composition rules:
...
Issue: Too many changes at once causing confusion Cause: Requesting multiple edits simultaneously Solution: Make one change per turn. Wait for result before next edit.

Example sequence:

✅ "Change background to sunset"
✅ "Make the lighting warmer"
✅ "Add reflections on water" vs.
❌ "Change background to sunset with warmer lighting and add reflections"

Issue: Losing context from earlier turns Cause: Vague references without reinforcing key details Solution: Briefly reinforce context: "In this mountain landscape, add a hiking trail in the foreground"
...
Subject accuracy: Is the main subject as described?
Composition: Does layout match prompt intent?
Lighting: Is lighting source and quality correct?
Style: Does aesthetic match requested style?
Technical specs: Are camera/art specs honored?
Mood: Does image convey intended atmosphere?
Refinement Workflow
...
Version A: Medium detail (50-75 words) Version B: High detail (100-150 words) Version C: Different style/lighting approach
