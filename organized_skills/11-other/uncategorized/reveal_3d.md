...
rating: ⭐⭐⭐
title: reveal-3d
url: https://skills.sh/cognitedata/dune-skills/reveal-3d
---

# reveal-3d

skills/cognitedata/dune-skills/reveal-3d
reveal-3d
Installation
...
The app already has a DMInstanceRef in scope — passed in as a prop or route param, not something to be fetched
The user has confirmed that instance has CogniteVisualizable.object3D → CogniteCADNode linkage in their CDF data model
The user explicitly asked for FDM-linked 3D, not just "show a 3D viewer"
