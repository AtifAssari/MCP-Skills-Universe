...
url: https://skills.sh/aradotso/trending-skills/antigravity-manager
---

# antigravity-manager

skills/aradotso/trending-skills/antigravity-manager
antigravity-manager
Installation
...
Open Antigravity Manager desktop app or web UI (http://localhost:8045)
