---
rating: ⭐⭐⭐
title: bankr x402 sdk - project templates
url: https://skills.sh/bankrbot/claude-plugins/bankr-x402-sdk---project-templates
---

# bankr x402 sdk - project templates

skills/bankrbot/claude-plugins/Bankr x402 SDK - Project Templates
Bankr x402 SDK - Project Templates
Installation
...
Configure wallet: Copy .env.example to .env and add BANKR_PRIVATE_KEY
Fund wallet: Add USDC on Base ($1-2 recommended for API costs)
Customize: Modify the template for your use case
Run: bun dev or npm run dev for development
Build: bun run build or npm run build for production
Weekly Installs
–
Repository
