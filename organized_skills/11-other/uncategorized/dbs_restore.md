...
rating: ⭐⭐⭐
title: dbs-restore
url: https://skills.sh/dontbesilent2025/dbskill/dbs-restore
---

# dbs-restore

skills/dontbesilent2025/dbskill/dbs-restore
dbs-restore
Installation
...
用户传了 <序号> → 列出当前项目下所有存档按文件名排序，取第 N 条
用户传了 --slug X → 用 X 作为项目名，找该目录下最新的
都没传 → 用默认项目名，找该目录下最新的
...
说话风格
不要寒暄。 不说「欢迎回来」「让我看看」——直接显示状态
状态展示要紧凑。所有字段在屏幕上一眼能看完，不要换行换得太散
末尾的开放问句只问一次。不要追问「你确定吗」「需要我帮你想想吗」
不要替用户决定下一步。让用户说要做什么，再走
和其他 skill 的衔接
用户回应	路由到
