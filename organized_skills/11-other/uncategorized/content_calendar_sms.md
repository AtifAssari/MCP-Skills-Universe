...
url: https://skills.sh/blacktwist/social-media-skills/content-calendar-sms
---

# content-calendar-sms

skills/blacktwist/social-media-skills/content-calendar-sms
content-calendar-sms
Installation
...
Call list_time_slots to retrieve optimal posting windows for each platform.
Map calendar entries to the best available slots.
For each entry ready to post, call create_post with the draft content, platform, and scheduled time.
Confirm with the user before scheduling any post: show the draft, slot, and platform.
