...
rating: ⭐⭐⭐
title: ia-presenter
url: https://skills.sh/spm1001/claude-suite/ia-presenter
---

# ia-presenter

skills/spm1001/claude-suite/ia-presenter
ia-presenter
Installation
...
Create MyPresentation.iapresenter/ directory
Create assets/ subdirectory (can be empty)
Create info.json with the template above
Create text.md with your markdown content
When to Use
...
Tab characters exist — Visible body text MUST start with a literal tab (not spaces)
Slides are separated — --- between each slide
One idea per slide — Keep slides focused
Headings are concise — They're always visible; make them count
Speaker notes are useful — Don't waste the teleprompter space
Images have paths — URLs or local paths on their own lines
Common Mistakes
Mistake	Problem	Fix
...
Start with the story — Write the narrative first
Identify key points — These become headings
Decide what audience sees — Tab-indent only essential text
Add speaker notes — Context, examples, transitions
Add images last — URLs/paths with positioning metadata
Review slide count — --- separators should match intended slides
