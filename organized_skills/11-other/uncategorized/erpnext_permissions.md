---
rating: ⭐⭐⭐
title: erpnext-permissions
url: https://skills.sh/openaec-foundation/erpnext_anthropic_claude_development_skill_package/erpnext-permissions
---

# erpnext-permissions

skills/openaec-foundation/erpnext_anthropic_claude_development_skill_package/erpnext-permissions
erpnext-permissions
Installation
...
ALWAYS escape SQL - frappe.db.escape(user)
...
ALWAYS mask manually - In custom SQL queries (v16+)
Anti-Patterns
❌ Don't	✅ Do
