---
rating: ⭐⭐⭐
title: anything-analyzer-cdp
url: https://skills.sh/aradotso/trending-skills/anything-analyzer-cdp
---

# anything-analyzer-cdp

skills/aradotso/trending-skills/anything-analyzer-cdp
anything-analyzer-cdp
Installation
...
Attaches CDP to WebContentsView tabs
Enables Fetch.enable for request interception
Injects JS hooks via Page.addScriptToEvaluateOnNewDocument
Collects storage snapshots periodically
...
Click New Session → enter name + target URL (e.g. https://example.com/register)
Click Start Capture
...
SQLite inspection: Use DB Browser for SQLite on %APPDATA%/anything-analyzer/analyzer.db (Windows) or ~/Library/Application Support/anything-analyzer/analyzer.db (macOS)
