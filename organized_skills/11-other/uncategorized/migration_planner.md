...
url: https://skills.sh/jmsktm/claude-settings/migration-planner
---

# migration planner

skills/jmsktm/claude-settings/Migration Planner
Migration Planner
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Migration Planner'
SKILL.md
Migration Planner
