...
rating: ⭐⭐
title: cost-mode
url: https://skills.sh/sagargupta16/claude-cost-optimizer/cost-mode
---

# cost-mode

skills/sagargupta16/claude-cost-optimizer/cost-mode
cost-mode
Installation
$ npx skills add https://github.com/sagargupta16/claude-cost-optimizer --skill cost-mode
SKILL.md
