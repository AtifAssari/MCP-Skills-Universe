---
rating: ⭐⭐
title: rw-generate-video
url: https://skills.sh/runwayml/skills/rw-generate-video
---

# rw-generate-video

skills/runwayml/skills/rw-generate-video
rw-generate-video
Installation
...
Preflight
command -v uv must succeed. If not, tell the user to install uv: curl -LsSf https://astral.sh/uv/install.sh | sh
