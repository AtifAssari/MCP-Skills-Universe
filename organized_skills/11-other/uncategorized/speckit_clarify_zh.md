---
rating: ⭐⭐⭐
title: speckit-clarify-zh
url: https://skills.sh/forztf/open-skilled-sdd/speckit-clarify-zh
---

# speckit-clarify-zh

skills/forztf/open-skilled-sdd/speckit-clarify-zh
speckit-clarify-zh
Installation
...
加载当前规格文件。使用此分类法执行结构化歧义和覆盖扫描。对于每个类别，标记状态：清晰 / 部分 / 缺失。生成用于优先级排序的内部覆盖图（除非不问问题，否则不要输出原始图）。
