---
rating: ⭐⭐⭐
title: rw-integrate-characters
url: https://skills.sh/runwayml/skills/rw-integrate-characters
---

# rw-integrate-characters

skills/runwayml/skills/rw-integrate-characters
rw-integrate-characters
Installation
...
<<<<<<< HEAD:skills/rw-integrate-characters/SKILL.md For local files over ~3.5 MB, use the upload flow (+rw-integrate-uploads) to get a runway:// URI instead of a data URI.
