...
rating: ⭐⭐⭐
title: openbabel
url: https://skills.sh/tondevrel/scientific-agent-skills/openbabel
---

# openbabel

skills/tondevrel/scientific-agent-skills/openbabel
openbabel
Installation
...
Preserve stereochemistry - Use explicit SMILES notation with @ and / when needed.
Use fingerprints for similarity - Before expensive operations, filter with Tanimoto coefficients.
Close file writers explicitly - Use context managers or .close() to ensure data is written.
