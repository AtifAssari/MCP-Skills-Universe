---
rating: ⭐⭐⭐
title: legal-risk-visualization
url: https://skills.sh/zh-xx/legal-assistant-skills/legal-risk-visualization
---

# legal-risk-visualization

skills/zh-xx/legal-assistant-skills/legal-risk-visualization
legal-risk-visualization
Installation
$ npx skills add https://github.com/zh-xx/legal-assistant-skills --skill legal-risk-visualization
SKILL.md
Legal Risk Visualization
Overview
输入： 法律分析文本（简要或详尽均可）
...
使用 references/anchoring-tables.md 中的锚定表校准等级标签
...
References
references/formulas.md — 完整计算模型（风险指数、传导风险值、映射公式、分叉/汇聚/环路规则）
references/causal-patterns.md — 因果关系识别（显式+隐含模式+置信度）
references/anchoring-tables.md — 各维度 1-5 等级锚定表
references/case-example.md — 技术服务合同纠纷端到端案例
Example
