...
rating: ⭐⭐⭐
title: qe-a11y-ally
url: https://skills.sh/proffesor-for-testing/agentic-qe/qe-a11y-ally
---

# qe-a11y-ally

skills/proffesor-for-testing/agentic-qe/qe-a11y-ally
qe-a11y-ally
Installation
$ npx skills add https://github.com/proffesor-for-testing/agentic-qe --skill qe-a11y-ally
SKILL.md
...
Generic tools output: aria-label="[DESCRIPTION]" You output: aria-label="Add to shopping cart" because you understand context.
...
Document the failure reason in audit-summary.md
Still create video-captions violation in violations.json
Add remediation instructions WITHOUT generated captions
Mark video pipeline as "blocked" not "skipped"
