...
url: https://skills.sh/ntaksh42/agents/document-formatter
---

# document-formatter

skills/ntaksh42/agents/document-formatter
document-formatter
Installation
...
問題: テーブルが崩れる 解決: パイプ文字のエスケープ、列数の確認

問題: コードブロックが正しく表示されない 解決: 言語指定の確認、バックティックの数

問題: リンクが機能しない 解決: アンカーテキストの正規化、パスの確認

問題: 日本語の折り返しがおかしい 解決: word-break設定、フォント指定
