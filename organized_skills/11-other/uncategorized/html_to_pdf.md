...
rating: ⭐⭐⭐
title: html-to-pdf
url: https://skills.sh/aviz85/claude-skills-library/html-to-pdf
---

# html-to-pdf

skills/aviz85/claude-skills-library/html-to-pdf
html-to-pdf
Installation
...
Background on html/body - always put on .container instead
Content overflow - use overflow: hidden
Margins/padding pushing content out
...
Set lang attribute: <html lang="he" dir="rtl">
Use UTF-8: <meta charset="UTF-8">
CSS direction: Add direction: rtl; text-align: right; to body
Fonts: Use web fonts that support Hebrew (Noto Sans Hebrew, Heebo, Assistant)
