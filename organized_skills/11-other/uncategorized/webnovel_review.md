---
rating: ⭐⭐
title: webnovel-review
url: https://skills.sh/lingfengqaq/webnovel-writer/webnovel-review
---

# webnovel-review

skills/lingfengqaq/webnovel-writer/webnovel-review
webnovel-review
Installation
...
成功标准
已解析真实书项目根目录。
已通过 reviewer 输出结构化问题 JSON。
审查报告已生成。
review_metrics 已写入 index.db。
审查记录已写入 .webnovel/state.json 兼容投影。
如存在阻断问题，用户已明确选择处理策略。
Weekly Installs
146
Repository
