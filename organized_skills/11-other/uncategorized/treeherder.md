...
rating: ⭐⭐⭐
title: treeherder
url: https://skills.sh/jwmossmoz/agent-skills/treeherder
---

# treeherder

skills/jwmossmoz/agent-skills/treeherder
treeherder
Installation
...
Workflow
Get failing job IDs from treeherder-cli JSON output
Query the bug suggestions endpoint for each job
Aggregate results to identify known intermittents vs novel failures
API Endpoint
