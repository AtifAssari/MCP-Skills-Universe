...
rating: ⭐⭐⭐
title: deep-review
url: https://skills.sh/ben2pc/g-claude-code-plugins/deep-review
---

# deep-review

skills/ben2pc/g-claude-code-plugins/deep-review
deep-review
Installation
$ npx skills add https://github.com/ben2pc/g-claude-code-plugins --skill deep-review
SKILL.md
Deep Review
...
Target PR is identified — either the current branch's PR or an explicit PR number
You have git / gh read access to the repo
Steps
