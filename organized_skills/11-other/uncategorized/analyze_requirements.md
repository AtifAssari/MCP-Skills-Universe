...
url: https://skills.sh/nesnilnehc/ai-cortex/analyze-requirements
---

# analyze-requirements

skills/nesnilnehc/ai-cortex/analyze-requirements
analyze-requirements
Installation
$ npx skills add https://github.com/nesnilnehc/ai-cortex --skill analyze-requirements
SKILL.md
技能（Skill）：分析需求
目的 (Purpose)
...
✅ 文档持久化：需求文档按照 docs/ARTIFACT_NORMS.md 写入 docs/requirements-planning/<topic>.md 并提交
...
第 2 阶段：验证 — 与用户确认
以结构化格式呈现需求摘要（参见输出部分）
请求明确批准：“这些需求是否准确地反映了您的需求？”
如果需要则迭代：如果发现差距则返回相关状态
第 3 阶段：坚持 — 编写文档
确定输出位置：
...
如果该项目失败，最有可能与需求相关的原因是什么？
开发人员正在构建他们需要的东西或者他们知道如何构建的东西吗？
什么明确不在范围内？
在实际限制下，范围是否可以实现？
哪些假设尚未验证？
不熟悉的人能否正确解释需求？
