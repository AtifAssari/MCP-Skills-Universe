...
rating: ⭐⭐
title: interview
url: https://skills.sh/kazdenc/builder-skills/interview
---

# interview

skills/kazdenc/builder-skills/interview
interview
Installation
$ npx skills add https://github.com/kazdenc/builder-skills --skill interview
SKILL.md
User Interviews
...
Read the full transcript before highlighting anything.
Tag each meaningful quote with one or more of the five categories above.
Group related quotes into clusters. Name each cluster with a short theme label.
For each cluster, write one insight statement: "[Who] needs to [job] but struggles with [pain] because [root cause]."
Rank opportunities by how often they appear and how strongly participants reacted.
Output
