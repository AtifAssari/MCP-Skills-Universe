---
rating: ⭐⭐⭐⭐⭐
title: zero-script-qa
url: https://skills.sh/popup-studio-ai/bkit-claude-code/zero-script-qa
---

# zero-script-qa

skills/popup-studio-ai/bkit-claude-code/zero-script-qa
zero-script-qa
Installation
$ npx skills add https://github.com/popup-studio-ai/bkit-claude-code --skill zero-script-qa
SKILL.md
...
Guide to run docker compose logs -f
Request manual UX testing from user
Real-time log monitoring
