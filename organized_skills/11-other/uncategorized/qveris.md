...
rating: ⭐⭐⭐
title: qveris
url: https://skills.sh/qverisai/qverisai/qveris
---

# qveris

skills/qverisai/qverisai/qveris
qveris
Installation
...
Call search_tools with a functionality description (not parameter names) — limit results to 10
Call execute_tool to test a candidate, passing parameters via params_to_tool
Repeat or broaden the search if no suitable tool is found
