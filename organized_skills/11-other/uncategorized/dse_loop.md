...
rating: ⭐⭐⭐
title: dse-loop
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/dse-loop
---

# dse-loop

skills/wanshuiyin/auto-claude-code-research-in-sleep/dse-loop
dse-loop
Installation
...
Read DSE_STATE.json for current iteration, best params, patience counter
Read dse_log.csv for full history
