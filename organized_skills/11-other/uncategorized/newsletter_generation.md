...
url: https://skills.sh/bytedance/deer-flow/newsletter-generation
---

# newsletter-generation

skills/bytedance/deer-flow/newsletter-generation
newsletter-generation
Installation
$ npx skills add https://github.com/bytedance/deer-flow --skill newsletter-generation
SKILL.md
...
Core facts — What happened, who is involved, when
Context — Why this matters, background information
Data points — Specific numbers, metrics, or statistics
Quotes — Relevant expert quotes or official statements
