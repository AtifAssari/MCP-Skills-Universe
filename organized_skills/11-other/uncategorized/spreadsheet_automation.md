...
url: https://skills.sh/jk-0001/skills/spreadsheet-automation
---

# spreadsheet-automation

skills/jk-0001/skills/spreadsheet-automation
spreadsheet-automation
Installation
$ npx skills add https://github.com/jk-0001/skills --skill spreadsheet-automation
SKILL.md
Spreadsheet Automation
Overview
...
List tasks you do in Sheets manually (copy/paste, data entry, formatting, updating other sheets)
...
Save (Ctrl/Cmd + S)
Set up trigger: Triggers (clock icon) → Add Trigger → onEdit → From spreadsheet → On edit → Save
...
Paste code, replace url and YOUR_API_KEY
Run once manually to test (click Run button)
Set up time-based trigger: Triggers → Add Trigger → fetchAPIData → Time-driven → Hour timer → Every hour
...
Use QUERY instead of FILTER + SORT: More efficient
Limit ARRAYFORMULA range: A2:A1000 instead of A:A (entire column)
Use static values instead of formulas where possible: Copy → Paste Values
