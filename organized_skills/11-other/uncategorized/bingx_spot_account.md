---
rating: ⭐⭐⭐
title: bingx-spot-account
url: https://skills.sh/bingx-api/api-ai-skills/bingx-spot-account
---

# bingx-spot-account

skills/bingx-api/api-ai-skills/bingx-spot-account
bingx-spot-account
Installation
...
Ask for asset (e.g., USDT) and amount.
For prod-live: ask for CONFIRM.
Execute POST /openApi/api/asset/v1/transfer.
Step 4 — Transfer Records Query
Optionally ask for type (transfer direction) and time range.
Execute GET /openApi/api/v3/asset/transferRecord.
Present results in a table format: asset, amount, type, timestamp, status.
Weekly Installs
68
Repository
