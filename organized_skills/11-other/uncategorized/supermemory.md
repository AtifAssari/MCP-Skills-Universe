...
rating: ⭐⭐⭐
title: supermemory
url: https://skills.sh/supermemoryai/skills/supermemory
---

# supermemory

skills/supermemoryai/skills/supermemory
supermemory
Installation
...
TypeScript/JavaScript: npm install supermemory (npm)
Python: pip install supermemory (PyPI)
...
Thresholds: Start with threshold: 0.3 for balanced precision/recall
Static Memories: Mark permanent facts as isStatic: true for better performance
Batch Operations: Use bulk endpoints for multiple documents
