...
url: https://skills.sh/sickn33/antigravity-awesome-skills/prompt-library
---

# prompt-library

skills/sickn33/antigravity-awesome-skills/prompt-library
prompt-library
Installation
...
Provides a prompt improvement checklist covering objective clarity, context, format specification, examples, constraints, and success criteria
Organized by use case (role-based, task-specific, analysis, creative, transformation) to help agents quickly find relevant templates
SKILL.md
📝 Prompt Library
