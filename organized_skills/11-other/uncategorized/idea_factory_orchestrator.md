---
rating: ⭐⭐⭐
title: idea-factory-orchestrator
url: https://skills.sh/monicajeon28/gmcruise/idea-factory-orchestrator
---

# idea-factory-orchestrator

skills/monicajeon28/gmcruise/idea-factory-orchestrator
idea-factory-orchestrator
Installation
$ npx skills add https://github.com/monicajeon28/gmcruise --skill idea-factory-orchestrator
SKILL.md
...
agents/02-category-classifier.md에서 카테고리 목록 수정

전문가 에이전트 추가
agents/ 폴더에 새 에이전트 파일 생성
메타데이터에 03x- 프리픽스 사용
SKILL.md의 Stage 3 섹션에 추가
리뷰 프로세스 변경
...
버전: v1.0 AGENTIC PIPELINE 품질: 95/100 (Enterprise-Grade) 호환: Claude Code Global Skills 작성: Claude Code AI
