---
rating: ⭐⭐
title: hackathon-scope-cutter
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-scope-cutter
---

# hackathon-scope-cutter

skills/bernieweb3/hackathon-ai-devkit/hackathon-scope-cutter
hackathon-scope-cutter
Installation
...
Rules
Include a feature in MVP only if it is required to demonstrate core_mechanism or wow_factor.
Default to cutting any feature that cannot be implemented in less than 20% of total time.
Preserve at least one visually compelling UI moment in mvp_demo_flow.
Total time_budget must not exceed 70% of hackathon_duration_hours (reserve 30% for polish and presentation).
Mark features as [FAKE-OK] if they can be simulated or hardcoded for demo purposes.
Do not cut the feature that delivers wow_factor.
Output Format
mvp_features:
  - feature: "<name>"
