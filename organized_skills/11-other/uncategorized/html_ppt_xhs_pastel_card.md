---
rating: ⭐⭐
title: html-ppt-xhs-pastel-card
url: https://skills.sh/nexu-io/open-design/html-ppt-xhs-pastel-card
---

# html-ppt-xhs-pastel-card

skills/nexu-io/open-design/html-ppt-xhs-pastel-card
html-ppt-xhs-pastel-card
Installation
$ npx skills add https://github.com/nexu-io/open-design --skill html-ppt-xhs-pastel-card
SKILL.md
HTML PPT · 柔和马卡龙慢生活
...
Start from the matching template folder: skills/html-ppt/templates/full-decks/xhs-pastel-card/ — copy index.html and style.css into the project, keep the .tpl-xhs-pastel-card body class.
...
Replace demo content, not classes. The .tpl-xhs-pastel-card scoped CSS only recognises the structural classes shipped in the template — keep them.
