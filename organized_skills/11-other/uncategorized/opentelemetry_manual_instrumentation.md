---
rating: ⭐⭐
title: opentelemetry-manual-instrumentation
url: https://skills.sh/niwoerner/opentelemetry-agent-skills/opentelemetry-manual-instrumentation
---

# opentelemetry-manual-instrumentation

skills/niwoerner/opentelemetry-agent-skills/opentelemetry-manual-instrumentation
opentelemetry-manual-instrumentation
Installation
$ npx skills add https://github.com/niwoerner/opentelemetry-agent-skills --skill opentelemetry-manual-instrumentation
SKILL.md
OpenTelemetry Manual Instrumentation
...
Workflow
Identify the task mode: planning, implementation, or review.
For each instrumentation point, decide:
the runtime boundary
the signal
the semantic convention group if one exists
the key attributes and cardinality risks
the propagation requirements
Implement or review the code.
