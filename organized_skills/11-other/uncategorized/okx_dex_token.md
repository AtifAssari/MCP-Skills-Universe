...
rating: ⭐⭐⭐
title: okx-dex-token
url: https://skills.sh/okx/onchainos-skills/okx-dex-token
---

# okx-dex-token

skills/okx/onchainos-skills/okx-dex-token
okx-dex-token
Installation
...
View top traders and profit addresses for a token; inspect liquidity pools and recent buy/sell trade activity with optional tag-based filtering
Supports 6 chains (XLayer, Solana, Ethereum, Base, BSC, Arbitrum) with automatic chain name resolution
SKILL.md
