---
rating: ⭐⭐⭐
title: backblaze-coder
url: https://skills.sh/majesticlabs-dev/majestic-marketplace/backblaze-coder
---

# backblaze-coder

skills/majesticlabs-dev/majestic-marketplace/backblaze-coder
backblaze-coder
Installation
$ npx skills add https://github.com/majesticlabs-dev/majestic-marketplace --skill backblaze-coder
SKILL.md
...
References
references/b2-cli-setup.md - CLI installation and authentication
references/b2-key-capabilities.md - Application key capabilities and sync flags
references/production-setup.md - Complete production setup
Weekly Installs
38
Repository
