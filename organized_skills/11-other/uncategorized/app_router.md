...
rating: ⭐⭐⭐
title: app-router
url: https://skills.sh/davepoon/buildwithclaude/app-router
---

# app-router

skills/davepoon/buildwithclaude/app-router
app-router
Installation
$ npx skills add https://github.com/davepoon/buildwithclaude --skill app-router
SKILL.md
...
Private folders: Use _folder for non-route files
Route groups: Use (folder) to organize without URL impact
Parallel routes: Use @slot for complex layouts
Intercepting routes: Use (.) patterns for modals
Resources
