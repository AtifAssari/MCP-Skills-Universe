...
rating: ⭐⭐
title: spec-kit
url: https://skills.sh/ahgraber/skills/spec-kit
---

# spec-kit

skills/ahgraber/skills/spec-kit
spec-kit
Installation
...
Sequence Rules
Never run spec-kit-plan without spec.md.
Never run spec-kit-implement without tasks.md.
Run spec-kit-clarify before planning when ambiguity can change architecture, data model, testing, UX, operations, or compliance.
Run spec-kit-reconcile whenever drift is detected at any stage before continuing.
Router Behavior
...
Route developer-reported drift directly to spec-kit-reconcile, even if raised outside analyze/implement.
