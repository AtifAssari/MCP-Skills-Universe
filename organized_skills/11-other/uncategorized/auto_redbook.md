...
rating: ⭐⭐⭐
title: auto-redbook
url: https://skills.sh/comeonzhj/auto-redbook-skills/auto-redbook
---

# auto-redbook

skills/comeonzhj/auto-redbook-skills/Auto-Redbook
Auto-Redbook
Installation
$ npx skills add https://github.com/comeonzhj/auto-redbook-skills --skill Auto-Redbook
SKILL.md
小红书笔记创作技能
...
内容长度：建议每个 --- 分隔的内容块控制在 200 字以内
Cookie 有效期：发布功能的 Cookie 有过期限制，过期后需要重新获取
发布依赖：发布功能依赖 xhs 库，需要安装：pip install xhs
智能分页说明
