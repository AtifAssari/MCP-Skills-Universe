...
url: https://skills.sh/absolutelyskilled/absolutelyskilled/growth-hacking
---

# growth-hacking

skills/absolutelyskilled/absolutelyskilled/growth-hacking
growth-hacking
Installation
$ npx skills add https://github.com/absolutelyskilled/absolutelyskilled --skill growth-hacking
SKILL.md
...
Always diagnose which stage is broken before prescribing a fix. See references/growth-frameworks.md for the full AARRR diagnostic template.
...
Loops compound; funnels don't. Design for loops. See references/growth-frameworks.md for loop templates.
...
A good north star is: measurable, leads revenue, reflects user value, actionable by the team. See references/growth-frameworks.md for the selection template.
...
Run the highest-scoring experiments first. Document hypothesis, metric, baseline, result, and learning for every experiment regardless of outcome. See references/growth-frameworks.md for the full ICE scoring template.
