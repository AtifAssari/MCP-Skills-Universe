---
rating: ⭐⭐⭐
title: typescript-devdependencies
url: https://skills.sh/marius-townhouse/effective-typescript-skills/typescript-devdependencies
---

# typescript-devdependencies

skills/marius-townhouse/effective-typescript-skills/typescript-devdependencies
typescript-devdependencies
Installation
...
Ask: Does this run in production? TypeScript and @types don't
Use --save-dev for types: Always for @types packages
Check before publishing: npm pack shows what gets published
Review package.json: Ensure correct categorization
Red Flags
