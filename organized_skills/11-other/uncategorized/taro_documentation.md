---
rating: ⭐⭐⭐
title: taro documentation
url: https://skills.sh/whinc/my-claude-plugins/taro-documentation
---

# taro documentation

skills/whinc/my-claude-plugins/Taro Documentation
Taro Documentation
Installation
...
Component References (files prefixed with components-)
...
Guide References (files prefixed with guides-)
...
Search within files: Use Grep with wildcards to scan the relevant file family:
...
Provide contextual answers: Combine documentation with understanding of user's context to give relevant, actionable guidance
...
Identify the problem area: API, component, configuration, or build issue
Check documentation: Reference relevant documentation section
Verify platform compatibility: Ensure feature is supported on target platform
Review configuration: Check if configuration is correct
Consult guides: Look for similar issues in troubleshooting guides
Provide solutions: Offer concrete fixes or workarounds
...
Approach
Listen for Taro mentions: Activate when user mentions Taro-related topics
Assess question type: Determine if question is about API, component, config, or general guidance
Load relevant documentation: Read appropriate reference file or search within it
Provide contextual answer: Combine documentation with user's specific context
Include code examples: Show practical usage when relevant
Note platform considerations: Mention compatibility if relevant
Response Format
