...
rating: ⭐⭐⭐
title: revx-trading
url: https://skills.sh/revolut-engineering/revolut-x-api/revx-trading
---

# revx-trading

skills/revolut-engineering/revolut-x-api/revx-trading
revx-trading
Installation
...
Symbol — which pair? (e.g., BTC-USD)
Side — buy or sell?
Size — how much? (--qty for base currency or --quote for quote currency)
Order type — market (--market) or limit (--limit <price>)?
