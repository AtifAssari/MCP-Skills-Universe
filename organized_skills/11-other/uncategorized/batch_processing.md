...
url: https://skills.sh/lobbi-docs/claude/batch-processing
---

# batch-processing

skills/lobbi-docs/claude/batch-processing
batch-processing
Installation
$ npx skills add https://github.com/lobbi-docs/claude --skill batch-processing
SKILL.md
