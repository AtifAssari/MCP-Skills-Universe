...
rating: ⭐⭐
title: nsfc-writer
url: https://skills.sh/huang19910918/vibe-grant-writer/nsfc-writer
---

# nsfc-writer

skills/huang19910918/vibe-grant-writer/nsfc-writer
nsfc-writer
Installation
$ npx skills add https://github.com/huang19910918/vibe-grant-writer --skill nsfc-writer
SKILL.md
国自然标书写作专家
...
预实验数据积累
选题生成流程
基于用户研究方向，使用 WebSearch 查找最新研究热点和临床瓶颈
识别"小切口"机会：聚焦明确的科学问题
评估创新机制：新思路、新方法、新角度
设计可行方案：3年内可完成的技术路线
生成 3-5 个候选选题方向
...
按 critical-reviewer.md 六维框架扫描该段，重点检查因果链中每一个"→"是否有具体分子事件支撑（防止"表型冒充机制"）
若发现问题，当场修复并重新扫描，直至通过
通过后方可进入下一段写作
第一部分：立项依据（最重要）
...
最佳实践
💡 重视创新性设计：在选题和立项依据中突出创新点，确保能通过"创意盲审"
🎯 聚焦小切口：选择明确具体的科学问题，避免大而全的研究范围
📝 逐步确认完善：每个阶段的确认有助于保证质量，特别是创新性表述
🔍 充分文献调研：深入了解研究现状，找准创新切入点
✅ 最后必须人工校验：AI 生成内容需要人工审核和调整，确保符合个人研究特色
注意事项

🆕 适应新评审机制（2024年起）：

创新性为王：初筛阶段只看创新性，务必在标书中突出新思路、新方法、新机制
idea优先：对青年学者是机遇，即使前期基础薄弱但创新性强也有机会通过
临床导向：选题最好源于临床瓶颈或实际需求，体现转化应用价值

传统注意事项：

数据真实性：所有实验数据、研究基础必须真实
引用准确性：文献引用需核对原文
个性化调整：标书需体现申请人的研究特色
时间规划：建议预留时间进行多轮修改
格式转换：最终需转换为国自然系统要求的格式
附加资源
选题指导：详细的选题策略和方法
模拟评审：完整标书评审流程
批判性审查：逐段质疑与逻辑漏洞修复
标书框架与写作指南：完整框架、字数要求及各部分详细写作方法
青年项目模板：标书模板
成功案例：优秀标书示例
工作流程图
开始
