---
rating: ⭐⭐⭐
title: tool-plan-interviewer
url: https://skills.sh/hungv47/agent-skills/tool-plan-interviewer
---

# tool-plan-interviewer

skills/hungv47/agent-skills/tool-plan-interviewer
tool-plan-interviewer
Installation
...
Read existing artifacts: If a plan file or spec file exists (or is mentioned), read it first to understand current state
Identify the domain: Determine whether this is frontend, backend, full-stack, infrastructure, data, etc.
Assess complexity: Estimate how many rounds of questioning are needed
...
Summarize findings: Recap the key decisions made during interview
Write specification: Create or update the spec/plan file with:
