---
rating: ⭐⭐⭐
title: daily-briefing-builder
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/daily-briefing-builder
---

# daily-briefing-builder

skills/brianrwagner/ai-marketing-claude-code-skills/daily-briefing-builder
daily-briefing-builder
Installation
$ npx skills add https://github.com/brianrwagner/ai-marketing-claude-code-skills --skill daily-briefing-builder
SKILL.md
Daily Briefing Builder
...
Actions accuracy — Was the actions file found? Did numbered items extract correctly? If the file exists but no items were found, note the potential heading mismatch.
Content completeness — Count the ITEM| lines in Step 2 output. Does the number shown in the brief match? Were any files skipped?
Weather result — Did curl return valid output? Is the fallback shown if it failed?
Format cleanliness — No raw bash output. No placeholder text. All three sections present.
Example Output
