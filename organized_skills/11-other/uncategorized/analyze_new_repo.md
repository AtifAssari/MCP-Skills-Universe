---
rating: ⭐⭐
title: analyze-new-repo
url: https://skills.sh/johnlee6511/analyze-new-repo/analyze-new-repo
---

# analyze-new-repo

skills/johnlee6511/analyze-new-repo/analyze-new-repo
analyze-new-repo
Installation
...
AGENTS.md
README*
top-level docs such as docs/, CONTRIBUTING*, ARCHITECTURE*, CHANGELOG*
recent git history if it exists
