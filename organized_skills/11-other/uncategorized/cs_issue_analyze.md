---
rating: ⭐⭐⭐
title: cs-issue-analyze
url: https://skills.sh/liuzhengdongfortest/codestable/cs-issue-analyze
---

# cs-issue-analyze

skills/liuzhengdongfortest/codestable/cs-issue-analyze
cs-issue-analyze
Installation
...
启动检查
问题报告存在且已确认——读 {slug}-report.md，确认 doc_type=issue-report 且 status=confirmed，5 节都有内容。不完整 / 状态不对 → 回 cs-issue-report。cs-issue-report 已判走标准路径就按标准路径走，不二次改判
断点恢复——{slug}-analysis.md 已存在则检查 5 节哪些已填：
