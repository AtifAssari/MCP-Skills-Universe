...
rating: ⭐⭐⭐
title: gs-cited-by
url: https://skills.sh/cookjohn/gs-skills/gs-cited-by
---

# gs-cited-by

skills/cookjohn/gs-skills/gs-cited-by
gs-cited-by
Installation
$ npx skills add https://github.com/cookjohn/gs-skills --skill gs-cited-by
SKILL.md
...
Use gs-search with the title as keywords
Match the target paper in results by title similarity
Extract its dataCid
