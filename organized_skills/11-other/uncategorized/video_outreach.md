...
url: https://skills.sh/chadboyda/agent-gtm-skills/video-outreach
---

# video-outreach

skills/chadboyda/agent-gtm-skills/video-outreach
video-outreach
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill video-outreach
SKILL.md
...
Current outreach volume (videos per week/month)
Target buyer persona and deal size (SMB vs mid-market vs enterprise)
Existing tech stack (CRM, email sequencer, video tools)
Whether the team records video today or is starting from scratch
Primary goal: book meetings, accelerate deals, or replace live demos
Budget range for video tooling ($0-50/mo, $50-200/mo, $200-500/mo, $500+/mo)
...
Batch-record the "body" of similar videos for a persona segment
Use AI tools (Tavus, Sendspark) to personalize the first 5 seconds per prospect
Create reusable deliverable templates that only need 2-3 fields swapped per prospect
Build a library of common audit frameworks you can apply to any company
...
Record a 2-minute executive summary they can forward to their boss
Create an interactive demo (Navattic/Supademo) their team can explore independently
Build a one-page ROI doc they can attach to budget requests
Frame everything around THEIR goals, not your product features
...
Common Mistakes
Opening with filler - "Hey, hope you're having a great week" wastes your best seconds. Lead with their name and a trigger.
Making it about you - Start with their problem, not your company story.
Going too long - Cold videos over 90 seconds see dramatic drop-off.
Poor audio - Bad audio kills engagement faster than bad video. Use a decent mic.
No clear CTA - Every video needs exactly one next step.
Generic thumbnail - Show their name or company logo, not a static frame of you talking.
Embedding video directly - Email clients block embeds. Use a GIF thumbnail linking to a landing page.
Skipping follow-up - 48% of reps never send a second message. Build follow-up into the sequence.
...
Questions to Ask
What is your current cold outreach reply rate? (Sets the baseline to beat)
How many prospects do you contact per week? (Determines tool tier)
What does your prospect see in the first 5 seconds? (Tests personalization quality)
Are you comfortable with AI-generated video of your face? (Synthetic vs human)
Do you have a deliverable you can create for prospects? ("Made This For You" readiness)
How do you currently follow up on engagement signals? (Analytics workflow)
What is your average deal size? (ROI threshold for video investment)
Do you sell internationally or in English only? (Language requirements)
Can your sales sequencer embed video thumbnails? (Technical integration)
Who watches the videos internally at the prospect's company? (Multi-threading readiness)
Related Skills
