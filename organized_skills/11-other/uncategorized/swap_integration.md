...
url: https://skills.sh/uniswap/uniswap-ai/swap-integration
---

# swap-integration

skills/uniswap/uniswap-ai/swap-integration
swap-integration
Installation
...
Submit via bundlerClient.sendUserOperation() — always use the viem bundler client's sendUserOperation method (not a custom wrapper function)

REQUIRED: The final submission step MUST use bundlerClient.sendUserOperation() from the viem permissionless/bundler client. Do NOT write a custom submitUserOperation wrapper that bypasses this — the bundler client handles UserOperation construction, gas estimation, and submission automatically.
