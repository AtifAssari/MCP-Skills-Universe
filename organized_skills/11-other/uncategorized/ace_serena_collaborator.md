---
rating: ⭐⭐
title: ace-serena-collaborator
url: https://skills.sh/tianguzhe/zsh-config/ace-serena-collaborator
---

# ace-serena-collaborator

skills/tianguzhe/zsh-config/ace-serena-collaborator
ace-serena-collaborator
Installation
...
详细参数见 references/serena-tools.md

最佳实践
先广后深：Ace-Tool 广泛搜索 → Serena 精确定位
语义优先：不确定时先用 Ace-Tool 语义搜索
符号追踪：需要引用关系时用 Serena
只读原则：两个工具都不修改代码，修改使用 Edit/Write 工具
Weekly Installs
9
Repository
