...
url: https://skills.sh/phaserjs/phaser/render-textures
---

# render-textures

skills/phaserjs/phaser/render-textures
render-textures
Installation
...
Must call render(). In Phaser 4, drawing methods buffer commands. Nothing appears until render() is called (unless using renderMode: 'all' or 'redraw').
