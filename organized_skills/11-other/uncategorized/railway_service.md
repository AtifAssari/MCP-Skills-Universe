...
url: https://skills.sh/davila7/claude-code-templates/railway-service
---

# railway-service

skills/davila7/claude-code-templates/railway-service
railway-service
Installation
...
Create empty service: serviceCreate(input: {projectId: "...", name: "my-service"})
Use railway-environment skill to configure source via staged changes API
