---
rating: ⭐⭐⭐
title: knowledge-pipline
url: https://skills.sh/yesiamgodt/knowledge-pipline/knowledge-pipline
---

# knowledge-pipline

skills/yesiamgodt/knowledge-pipline/knowledge-pipline
knowledge-pipline
Installation
...
~/.agents/skills/knowledge-pipline
...
技能目录下的 .llm_config.json
当前工作目录下的 .llm_config.json
LLM_CONFIG_JSON 环境变量指定的路径
配置向导
...
绝对路径（如 D:\docs\report.pdf）→ 直接使用
以 raw/ 开头 → 相对于技能目录的 raw/
其他相对路径 → 相对于当前工作目录（CWD）
命令：摄入文档
