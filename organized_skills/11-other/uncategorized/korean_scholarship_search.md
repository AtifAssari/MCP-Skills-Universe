---
rating: ⭐⭐
title: korean-scholarship-search
url: https://skills.sh/nomadamas/k-skill/korean-scholarship-search
---

# korean-scholarship-search

skills/nomadamas/k-skill/korean-scholarship-search
korean-scholarship-search
Installation
$ npx skills add https://github.com/nomadamas/k-skill --skill korean-scholarship-search
SKILL.md
장학금 검색 및 조회
...
한국장학재단 공식 페이지 (kosaf.go.kr)
대학 공식 도메인 (*.ac.kr)의 학생지원처/장학공지/학사공지
공공기관/지자체/재단 공식 페이지 (*.go.kr, *.or.kr, 공식 재단 도메인)
기업 공식 CSR/재단/채용·공지 페이지
비공식 모음글/블로그/커뮤니티는 lead source 로만 사용하고, 공식 공고로 교차검증되지 않으면 제외
...
학교 대표 도메인 확인
학생지원처 / 장학팀 / 학사공지 게시판 확인
단과대학 공지 확인
학과 / 전공 / 대학원 과정 홈페이지 공지 확인
첨부 PDF/HWP가 있으면 같이 열어 조건을 확인
교내 장학과 외부 추천 장학을 분리해서 정리
