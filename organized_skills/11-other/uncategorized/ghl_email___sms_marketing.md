---
rating: ⭐⭐
title: ghl email & sms marketing
url: https://skills.sh/justin322322/ghl-skills/ghl-email-&-sms-marketing
---
...
GHL Email & SMS Marketing
Installation
$ npx skills add https://github.com/justin322322/ghl-skills --skill 'GHL Email & SMS Marketing'
SKILL.md
GHL Email & SMS Marketing
Overview
...
Respond within 5 minutes — Speed-to-lead is critical for conversion
Use canned responses — Pre-write responses for common questions
Assign conversations — Route to the right team member
Mark as read/unread — Keep inbox organized
Use internal notes — Coordinate with team members on a conversation
Set up notifications — Get alerted for new messages across all channels
Email Marketing
...
Email Configuration
Connect email service in Settings → Email Services
Verify sending domain — Add DNS records (SPF, DKIM, DMARC)
Set default "From" address — yourname@yourdomain.com
Configure tracking — Open tracking, click tracking, unsubscribe link
...
Subject lines — Keep under 50 characters; personalize with first name
Preview text — Add compelling preview text (shown in inbox next to subject)
Mobile-first design — 70%+ of emails are opened on mobile
Single CTA — One clear action per email
Personalization — Use merge fields and behavioral segmentation
Send time — Test optimal send times for your audience
Clean your list — Remove bounced, unsubscribed, and inactive contacts
Warm up new domains — Start with small volumes and increase gradually
...
SMS Marketing
Setup
Get an LC Phone number in Settings → Phone Numbers
Register for A2P (Application-to-Person) — Required for US businesses
Verify your brand through The Campaign Registry (TCR)
Set up compliance — Opt-in confirmation, opt-out handling
SMS Best Practices
Practice	Details
...
Campaign Registration — Register each use case (marketing, support, etc.)
Approval — Wait for carrier approval (2-15 business days)
Monitor — Track message delivery rates and carrier feedback
...
Setup
Connect WhatsApp Business API through GHL settings
Verify your business phone number
Create message templates (pre-approved by WhatsApp)
Configure in Conversation AI or Workflow actions
WhatsApp Features
