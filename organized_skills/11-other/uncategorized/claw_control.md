...
rating: ⭐⭐⭐⭐⭐
title: claw-control
url: https://skills.sh/adarshmishra07/claw-control/claw-control
---

# claw-control

skills/adarshmishra07/claw-control/claw-control
claw-control
Installation
...
Create a task on Mission Control
Spawn a subagent via sessions_spawn
Subagent executes autonomously (code, research, deployment, etc.)
Results report back to the main session
