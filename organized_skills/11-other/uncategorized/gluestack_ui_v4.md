...
url: https://skills.sh/gluestack/agent-skills/gluestack-ui-v4
---

# gluestack-ui-v4

skills/gluestack/agent-skills/gluestack-ui-v4
gluestack-ui-v4
Installation
...
Semantic tokens ONLY - NO EXCEPTIONS - NEVER use generic tokens (typography-*, neutral-*, gray-*) or numbered colors (red-500, blue-600). ONLY use semantic tokens (text-foreground, bg-primary, border-border, etc.) with optional alpha values
