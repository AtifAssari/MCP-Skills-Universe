...
url: https://skills.sh/sammcj/agentic-coding/home-assistant
---

# home-assistant

skills/sammcj/agentic-coding/home-assistant
home-assistant
Installation
...
Find similar entities - Use ha_search_similar_entities.py to find relevant entities
Search for similar automations - Use ha_get_automations.py with search terms to find examples
...
Check automation status - Use uv run scripts/ha_get_state.py automation.automation_name to check:
...
Check related entities - Use uv run scripts/ha_get_state.py to verify trigger entities are in expected states
Review the automation configuration - Use uv run scripts/ha_get_automations.py to see the full automation details
...
Get the Telegram bot config_entry_id - Use uv run scripts/ha_get_config_entries.py telegram_bot to find the config entry ID
