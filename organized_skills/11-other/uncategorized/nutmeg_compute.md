---
rating: ⭐⭐
title: nutmeg-compute
url: https://skills.sh/withqwerty/nutmeg/nutmeg-compute
---

# nutmeg-compute

skills/withqwerty/nutmeg/nutmeg-compute
nutmeg-compute
Installation
...
Per-90 normalisation for player-level stats: (stat / minutes) * 90
Minimum sample sizes before drawing conclusions (~10 matches for team metrics, ~900 minutes for player metrics)
