...
rating: ⭐⭐
title: get-started
url: https://skills.sh/different-ai/openwork/get-started
---

# get-started

skills/different-ai/openwork/get-started
get-started
Installation
$ npx skills add https://github.com/different-ai/openwork --skill get-started
SKILL.md
When to use
