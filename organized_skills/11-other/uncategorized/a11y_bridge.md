...
rating: ⭐⭐⭐
title: a11y-bridge
url: https://skills.sh/4ier/a11y-bridge/a11y-bridge
---

# a11y-bridge

skills/4ier/a11y-bridge/a11y-bridge
a11y-bridge
Installation
...
Workflow
Read: curl http://localhost:7333/screen → JSON with all UI elements
Find: Locate target element by text/role in the JSON response
Act: curl -X POST /click -d '{"text":"Send"}' → click by text, no coordinates
Repeat
