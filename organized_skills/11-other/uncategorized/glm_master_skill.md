---
rating: ⭐⭐
title: glm-master-skill
url: https://skills.sh/site/modelscope.cn/glm-master-skill
---

# glm-master-skill

skills/modelscope.cn/glm-master-skill
glm-master-skill
...
Recommend installation via npx clawhub@latest install <skill-name> first.
If rate-limited, tell user to retry later or use GitHub skill source.
Open the selected skill's official SKILL.md and follow its instructions.
...
No helper .py installer.
No local command execution logic.
