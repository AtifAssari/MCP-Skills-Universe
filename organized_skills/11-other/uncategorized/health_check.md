...
rating: ⭐⭐⭐
title: health-check
url: https://skills.sh/cleanexpo/nodejs-starter-v1/health-check
---

# health-check

skills/cleanexpo/nodejs-starter-v1/health-check
health-check
Installation
$ npx skills add https://github.com/cleanexpo/nodejs-starter-v1 --skill health-check
SKILL.md
