...
url: https://skills.sh/aaaaqwq/claude-code-skills/team-coordinator
---

# team-coordinator

skills/aaaaqwq/claude-code-skills/team-coordinator
team-coordinator
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill team-coordinator
SKILL.md
...
任务下达时: 明确目标、格式、约束条件
执行过程中: 关键节点检查进度
交付时: 审核产出是否达标，不达标则反馈修改
汇总时: 整合多员工产出，统一口径交付用户
执行哲学：MVP 优先
