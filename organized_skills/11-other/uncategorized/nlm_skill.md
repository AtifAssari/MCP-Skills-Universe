...
rating: ⭐⭐⭐⭐⭐
title: nlm-skill
url: https://skills.sh/jacob-bd/notebooklm-mcp-cli/nlm-skill
---

# nlm-skill

skills/jacob-bd/notebooklm-mcp-cli/nlm-skill
nlm-skill
Installation
$ npx skills add https://github.com/jacob-bd/notebooklm-mcp-cli --skill nlm-skill
SKILL.md
...
DO NOT launch REPL: Never use nlm chat start - it opens an interactive REPL that AI tools cannot control. Use nlm notebook query for one-shot Q&A instead.
