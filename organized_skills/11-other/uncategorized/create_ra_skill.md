---
rating: ⭐⭐⭐
title: create-ra-skill
url: https://skills.sh/t46/ra-skills/create-ra-skill
---

# create-ra-skill

skills/t46/ra-skills/create-ra-skill
create-ra-skill
Installation
...
最終確認後、ファイルを保存する
Phase 4: ファイル保存
スキル名を kebab-case に変換（例: 「予算執行管理」→ budget-execution）
skills/{skill-name}/SKILL.md として保存
保存先のパスをユーザーに通知
Phase 5: 次のステップの案内
