...
rating: ⭐⭐
title: wfdata-search
url: https://skills.sh/wanfangdata/wfdata-open-skills/wfdata-search
---

# wfdata-search

skills/wanfangdata/wfdata-open-skills/wfdata-search
wfdata-search
Installation
$ npx skills add https://github.com/wanfangdata/wfdata-open-skills --skill wfdata-search
SKILL.md
万方数据搜索技能
