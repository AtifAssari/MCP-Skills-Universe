---
rating: ⭐⭐⭐
title: arcgis-starter-app
url: https://skills.sh/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-starter-app
---

# arcgis-starter-app

skills/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-starter-app
arcgis-starter-app
Installation
$ npx skills add https://github.com/saschabrunnerch/arcgis-maps-sdk-js-ai-context --skill arcgis-starter-app
SKILL.md
ArcGIS Starter App
...
API key not configured: The app references an environment variable that does not exist or is empty.
