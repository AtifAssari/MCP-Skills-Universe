...
rating: ⭐⭐⭐
title: channel3-api
url: https://skills.sh/channel3-ai/skills/channel3-api
---

# channel3-api

skills/channel3-ai/skills/channel3-api
channel3-api
Installation
...
Full docs: docs.trychannel3.com (SDK setup, per-endpoint refs, error handling, retries, async usage)
...
Set CHANNEL3_API_KEY in the environment (free key at trychannel3.com). Then the minimum end-to-end call:
...
Per-call locale override: config: { country: 'GB', currency: 'GBP' }. Pure keyword matching (skip semantic search): config: { keyword_search_only: true } — incompatible with image input. Full filter shape in references/api-reference.md; full per-endpoint schema at docs.trychannel3.com/api-reference.
...
If the goal is to give an existing AI agent product superpowers without writing code, the Channel3 MCP (https://mcp.trychannel3.com/, free tier, append ?apiKey=<key> for pay-as-you-go) is lower friction — see docs.trychannel3.com/mcp-overview.

When stuck
SDK guide (install, async, errors, retries, logging): docs.trychannel3.com/sdk
Full API reference (try-it examples, schemas): docs.trychannel3.com/api-reference
Offline quick-card: references/api-reference.md
Support: support@trychannel3.com
Weekly Installs
18
Repository
channel3-ai/skills
