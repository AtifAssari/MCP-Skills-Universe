...
rating: ⭐⭐⭐
title: geo-update
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-update
---

# geo-update

skills/zubair-trabzada/geo-seo-claude/geo-update
geo-update
Installation
$ npx skills add https://github.com/zubair-trabzada/geo-seo-claude --skill geo-update
SKILL.md
...
For each component directory, compare the installed files against the cloned files using diff --recursive --brief.
