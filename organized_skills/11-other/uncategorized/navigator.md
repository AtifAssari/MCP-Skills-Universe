...
rating: ⭐⭐
title: navigator
url: https://skills.sh/srbhr/resume-matcher/navigator
---

# navigator

skills/srbhr/resume-matcher/navigator
navigator
Installation
...
Read docs/agent/architecture/backend-architecture.md for backend structure
Read docs/agent/architecture/frontend-architecture.md for frontend structure
Check docs/agent/apis/api-flow-maps.md for endpoint mappings
Quick paths
