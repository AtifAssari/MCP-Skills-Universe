...
url: https://skills.sh/chujianyun/skills/paper-interpreter
---
...
paper-interpreter
Installation
$ npx skills add https://github.com/chujianyun/skills --skill paper-interpreter
SKILL.md
论文解读助手
适用场景
...
metadata.json
arXiv 摘要页
TeX Source（如果下载成功，优先用它确认公式、模块名、算法步骤）
PDF 文件（以论文标题命名）
