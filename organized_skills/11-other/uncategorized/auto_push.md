...
rating: ⭐⭐⭐
title: auto-push
url: https://skills.sh/luongnv89/skills/auto-push
---

# auto-push

skills/luongnv89/skills/auto-push
auto-push
Installation
...
Interactive staging: git add -p for patch selection
PR workflow: Create branch → push → PR (use /pr command)
