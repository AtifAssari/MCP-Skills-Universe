---
rating: ⭐⭐⭐
title: fluxwing screen scaffolder
url: https://skills.sh/jackspace/claudeskillz/fluxwing-screen-scaffolder
---

# fluxwing screen scaffolder

skills/jackspace/claudeskillz/Fluxwing Screen Scaffolder
Fluxwing Screen Scaffolder
Installation
$ npx skills add https://github.com/jackspace/claudeskillz --skill 'Fluxwing Screen Scaffolder'
SKILL.md
Fluxwing Screen Scaffolder
...
Phase 1 (Parallel): Spawn multiple designer agents - one per missing component using multiple Task tool calls in ONE message
Phase 2 (Sequential): After all components exist, spawn composer agent
...
User-created: ./fluxwing/components/ (FIRST PRIORITY)
Library: ./fluxwing/library/ (customized templates)
Bundled examples: {SKILL_ROOT}/../uxscii-component-creator/templates/ (READ-ONLY)
...
⚠️ DO NOT create TodoWrite list and work through it yourself
⚠️ DO NOT create components yourself using Write/Edit tools
✅ DO use Task tool to spawn one agent per missing component
✅ DO send ONE message with ALL Task calls (parallel execution)
✅ DO use FAST MODE (creates .uxm only, <10s per component)
...
Generates missing component .md files
Loads documentation ONCE (not per component)
Creates screen .uxm + .md + .rendered.md
Focuses quality on .rendered.md (main deliverable)
Task({
  subagent_type: "general-purpose",
