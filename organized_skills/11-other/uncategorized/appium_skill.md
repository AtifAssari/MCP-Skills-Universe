...
rating: ⭐⭐
title: appium-skill
url: https://skills.sh/lambdatest/agent-skills/appium-skill
---

# appium-skill

skills/lambdatest/agent-skills/appium-skill
appium-skill
Installation
...
App upload: Use lt:// URL for cloud, local path for emulator
Timeout: 30s+ for real devices (slower than emulators)
Quick Reference
Task	Code
