...
rating: ⭐⭐
title: r3f-router
url: https://skills.sh/bbeierle12/skill-mcp-claude/r3f-router
---

# r3f-router

skills/bbeierle12/skill-mcp-claude/r3f-router
r3f-router
Installation
...
Explicit component — "add OrbitControls" → r3f-drei
Specific technique — "use instancing" → r3f-geometry
Problem domain — "custom shader" → r3f-materials
Default tier — Fall back to r3f-fundamentals
Confidence Scoring
