---
rating: ⭐⭐
title: rw-fetch-api-reference
url: https://skills.sh/runwayml/skills/rw-fetch-api-reference
---

# rw-fetch-api-reference

skills/runwayml/skills/rw-fetch-api-reference
rw-fetch-api-reference
Installation
$ npx skills add https://github.com/runwayml/skills --skill rw-fetch-api-reference
SKILL.md
