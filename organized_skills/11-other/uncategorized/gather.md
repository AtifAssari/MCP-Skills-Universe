...
rating: ⭐⭐⭐
title: gather
url: https://skills.sh/kazukinagata/shinkoku/gather
---

# gather

skills/kazukinagata/shinkoku/gather
gather
Installation
...
区分（報酬/料金/契約金等）
shinkoku での取り込み:
import_data.py payment-statement --file-path PATH で PDF/画像からデータ抽出
ledger.py add-business-withholding --db-path DB --input FILE で取引先別に登録
源泉徴収税額の合計が確定申告で控除される
