...
url: https://skills.sh/shopify/shopify-ai-toolkit/shopify-admin-execution
---

# shopify-admin-execution

skills/shopify/shopify-ai-toolkit/shopify-admin-execution
shopify-admin-execution
Installation
...
Search the Admin API documentation with scripts/search_docs.mjs to find the correct operation
Write and validate the GraphQL query or mutation with scripts/validate.mjs
