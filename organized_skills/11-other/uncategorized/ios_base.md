...
rating: ⭐⭐
title: ios-base
url: https://skills.sh/choshimwy/iosagentskills/ios-base
---

# ios-base

skills/choshimwy/iosagentskills/ios-base
ios-base
Installation
$ npx skills add https://github.com/choshimwy/iosagentskills --skill ios-base
SKILL.md
iOS/Swift 核心开发
角色定位
默认型主 skill。
...
当且仅当你确定本 Skill 已被加载并用于当前任务时，在回复末尾追加： // skill-used: ios-base
