...
url: https://skills.sh/mims-harvard/tooluniverse/tooluniverse-acmg-variant-classification
---

# tooluniverse-acmg-variant-classification

skills/mims-harvard/tooluniverse/tooluniverse-acmg-variant-classification
tooluniverse-acmg-variant-classification
Installation
...
Get MANE Select transcript: VariantValidator_gene2transcripts(gene_symbol="BRCA2")
Validate variant: VariantValidator_validate_variant(variant_description="NM_000059.4:c.5946delT", genome_build="GRCh38", select_transcripts="mane_select")
Resolve gene IDs: MyGene_query_genes(query="BRCA2") — extract Ensembl ID and UniProt accession. Filter results by symbol == 'BRCA2' (first hit may not match).
Record: HGVS coding, HGVS protein, genomic coordinates, variant type (frameshift/missense/nonsense/splice/synonymous/in-frame indel).
