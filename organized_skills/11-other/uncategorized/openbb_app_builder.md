---
rating: ⭐⭐⭐
title: openbb-app-builder
url: https://skills.sh/openbb-finance/backends-for-openbb/openbb-app-builder
---

# openbb-app-builder

skills/openbb-finance/backends-for-openbb/openbb-app-builder
openbb-app-builder
Installation
...
apps.json must be array format, served via /apps.json endpoint - app objects are served here.
...
Table metadata: Use data.table.columnsDefs, not columns or data.columnsDefs
