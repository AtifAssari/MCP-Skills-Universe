---
rating: ⭐⭐
title: qiaomu-smart-search
url: https://skills.sh/joeseesun/opencli-skill/qiaomu-smart-search
---

# qiaomu-smart-search

skills/joeseesun/opencli-skill/qiaomu-smart-search
qiaomu-smart-search
Installation
...
当用户没有指定网站时，优先只选择一个 AI 源：grok、doubao、gemini 三选一。
当 AI 返回内容不足、缺少原始数据、需要权威佐证或需要垂直结果时，再补充 1-2 个专用源。
单题预算与频率限制
