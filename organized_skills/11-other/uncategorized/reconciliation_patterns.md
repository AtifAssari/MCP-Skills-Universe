...
url: https://skills.sh/phrazzld/claude-config/reconciliation-patterns
---

# reconciliation-patterns

skills/phrazzld/claude-config/reconciliation-patterns
reconciliation-patterns
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill reconciliation-patterns
SKILL.md
Reconciliation Patterns
...
Process webhooks for real-time updates (optimistic)
Run periodic reconciliation to catch and fix drift (defensive)
