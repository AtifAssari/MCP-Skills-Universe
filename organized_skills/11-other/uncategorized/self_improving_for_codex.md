---
rating: ⭐⭐
title: self-improving-for-codex
url: https://skills.sh/godgod126/self-improving-for-codex/self-improving-for-codex
---

# self-improving-for-codex

skills/godgod126/self-improving-for-codex/self-improving-for-codex
self-improving-for-codex
Installation
...
AGENTS.md points Codex to PROFILE.md and ACTIVE.md
the five memory files exist and have sane content
promotion rules are explicit
if automation was requested, the automation prompt clearly explains the refinement-only role and promotion rules
Promotion Rules
