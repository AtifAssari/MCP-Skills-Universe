---
rating: ⭐⭐⭐
title: efecto-graphic-design
url: https://skills.sh/pablostanley/efecto-plugin/efecto-graphic-design
---

# efecto-graphic-design

skills/pablostanley/efecto-plugin/efecto-graphic-design
efecto-graphic-design
Installation
$ npx skills add https://github.com/pablostanley/efecto-plugin --skill efecto-graphic-design
SKILL.md
...
How It Works
Your agent creates an Efecto session via MCP (create_session)
...
30pt rule. At 1920px width, nothing smaller than text-3xl (30px). If projected, even text-4xl is the minimum.
...
Title is king. The page title or article headline should dominate the image. text-5xl to text-6xl.
