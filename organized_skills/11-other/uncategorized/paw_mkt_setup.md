...
rating: ⭐⭐⭐
title: paw-mkt-setup
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-setup
---

# paw-mkt-setup

skills/pawbytes/skill-suites/paw-mkt-setup
paw-mkt-setup
Installation
...
Check if {project-root}/.pawbytes/config/config.yaml exists — if a section matching the module's code is already present, inform the user this is an update
Detect legacy paths for auto-migration:
