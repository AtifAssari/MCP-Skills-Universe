...
rating: ⭐⭐⭐
title: zlib-download
url: https://skills.sh/psylch/media-master/zlib-download
---

# zlib-download

skills/psylch/media-master/zlib-download
zlib-download
Installation
...
Create the .env file (or .env.example template)
Tell the user to edit ~/.claude/book-tools/.env with their credentials
