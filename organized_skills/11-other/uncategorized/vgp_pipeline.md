...
rating: ⭐⭐⭐
title: vgp-pipeline
url: https://skills.sh/delphine-l/claude_global/vgp-pipeline
---

# vgp-pipeline

skills/delphine-l/claude_global/vgp-pipeline
vgp-pipeline
Installation
$ npx skills add https://github.com/delphine-l/claude_global --skill vgp-pipeline
SKILL.md
