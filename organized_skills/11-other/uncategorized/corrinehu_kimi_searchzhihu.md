---
rating: ⭐⭐⭐
title: corrinehu-kimi-searchzhihu
url: https://skills.sh/corrinehu/agent-skills/corrinehu-kimi-searchzhihu
---

# corrinehu-kimi-searchzhihu

skills/corrinehu/agent-skills/corrinehu-kimi-searchzhihu
corrinehu-kimi-searchzhihu
Installation
$ npx skills add https://github.com/corrinehu/agent-skills --skill corrinehu-kimi-searchzhihu
SKILL.md
知乎搜索指南
核心要点
...
未登录或会话过期
切换了访问模式（登录用 --headed，搜索时去掉 --headed）

解决：

全程使用 --headed 模式，不要切换
确保使用 --session-name zhihu
如果仍报错，清除会话重新登录：npx agent-browser state clear zhihu
超时错误
