...
rating: ⭐⭐
title: minimax
url: https://skills.sh/vm0-ai/vm0-skills/minimax
---

# minimax

skills/vm0-ai/vm0-skills/minimax
minimax
Installation
...
Guidelines
Use correct host: China uses api.minimax.io, global uses api.minimaxi.chat
Streaming for reasoning: M1/M2 models work best with stream: true
Camera syntax: Video commands go in [brackets] within prompts
Emotion in TTS: Only works with speech-02-* and speech-01-* models
Async video: Video generation returns task ID - poll for completion
