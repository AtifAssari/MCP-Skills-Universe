...
rating: ⭐⭐⭐
title: qmt
url: https://skills.sh/site/skills.volces.com/qmt
---

# qmt

skills/skills.volces.com/qmt
qmt
...
数据为空	股票代码错误或停牌	校验代码格式（如000001.SZ），检查是否停牌
Python版本不兼容	内置Python版本受限	改用miniQMT模式
策略运行缓慢	数据量过大	减少get_history_data的count参数
内置函数参考
行情数据函数
函数	说明	返回值
