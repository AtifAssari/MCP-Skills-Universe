...
rating: ⭐⭐⭐
title: z-image
url: https://skills.sh/yangliu2060/smith--skills/z-image
---

# z-image

skills/yangliu2060/smith--skills/z-image
z-image
Installation
...
--api-key 命令行参数
MODELSCOPE_API_KEY 环境变量
~/.claude/skills/z-image/config/secrets.md 文件
# 方式1: 环境变量
