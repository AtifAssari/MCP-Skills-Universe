---
rating: ⭐⭐
title: rxjs-like-a-pro
url: https://skills.sh/bjoerge/rxjs-skills/rxjs-like-a-pro
---

# rxjs-like-a-pro

skills/bjoerge/rxjs-skills/rxjs-like-a-pro
rxjs-like-a-pro
Installation
$ npx skills add https://github.com/bjoerge/rxjs-skills --skill rxjs-like-a-pro
SKILL.md
RxJS Like a Pro
...
Don't subscribe at all — let the framework handle subscription lifecycle where possible
Use operators that complete naturally — first(), take(n), takeUntil(destroy$)
Use takeUntil with a notifier:
...
Compose into a single subscription — if you have multiple independent streams with side effects, merge them into one and subscribe once.
Hot vs Cold
