...
url: https://skills.sh/k-dense-ai/scientific-agent-skills/what-if-oracle
---

# what-if-oracle

skills/k-dense-ai/scientific-agent-skills/what-if-oracle
what-if-oracle
Installation
$ npx skills add https://github.com/k-dense-ai/scientific-agent-skills --skill what-if-oracle
SKILL.md
