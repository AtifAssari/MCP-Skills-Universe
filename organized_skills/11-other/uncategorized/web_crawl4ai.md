...
rating: ⭐⭐⭐
title: web-crawl4ai
url: https://skills.sh/nikhilmaddirala/gtd-cc/web-crawl4ai
---

# web-crawl4ai

skills/nikhilmaddirala/gtd-cc/web-crawl4ai
web-crawl4ai
Installation
$ npx skills add https://github.com/nikhilmaddirala/gtd-cc --skill web-crawl4ai
SKILL.md
Crawl4AI Toolkit
Overview
...
Process
Verify crawl4ai installation with crawl4ai-doctor
Configure browser and crawler settings based on target site
