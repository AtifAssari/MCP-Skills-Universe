---
rating: ⭐⭐
title: building-ui-bundle-frontend
url: https://skills.sh/forcedotcom/afv-library/building-ui-bundle-frontend
---

# building-ui-bundle-frontend

skills/forcedotcom/afv-library/building-ui-bundle-frontend
building-ui-bundle-frontend
Installation
...
Edit src/appLayout.tsx — the layout used by routes.tsx
Replace all default/template nav items and labels with app-specific links and names
Replace placeholder app name everywhere: header, nav brand, footer, <title> in index.html
...
Access control? (public, authenticated via PrivateRoute, or unauthenticated via AuthenticationRoute)
