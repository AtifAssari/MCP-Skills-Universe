...
url: https://skills.sh/rysweet/amplihack/knowledge-extractor
---

# knowledge-extractor

skills/rysweet/amplihack/knowledge-extractor
knowledge-extractor
Installation
...
Extraction: Stored in memory via store_discovery() during session
Visibility: Retrieved by get_recent_discoveries() at session start
Action: Agents can query memory when solving similar problems
...
Teaching: Used in documentation and onboarding
Refinement: Improved as more usage data collected
Agent Creation Lifecycle
Recommendation: Identified as valuable automation candidate
Proposal: Presented to system with expected value
Creation: New agent created with clear scope/boundaries
Integration: Added to delegation triggers in CLAUDE.md
Usage: Available for orchestration across workflows
