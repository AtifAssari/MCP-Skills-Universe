...
url: https://skills.sh/rhavekost/author-toolkit/narrative-nonfiction
---

# narrative-nonfiction

skills/rhavekost/author-toolkit/narrative-nonfiction
narrative-nonfiction
Installation
$ npx skills add https://github.com/rhavekost/author-toolkit --skill narrative-nonfiction
SKILL.md
...
Initial Questions
Target reader? (Demographics + psychographics)
Transformation promise?
Central metaphor/framing?
Reader's "before" and "after" states?
Book's unique angle?
How much outlined vs. drafted?
Core Components
...
Purpose Check: Key takeaway? Where in arc? What must reader believe before next chapter?

Outline Beats: Hook options, teaching points (2-4), stories/examples, exercises, bridge

Draft: Write chapter. Use "write like you talk" voice.

Layer Metaphor: Present but not forced.

Add Exercises: Use references/exercise-design.md

Polish: Check voice, pacing, reader energy

Editing Workflow

Read as Target Reader: Engaged? Understand? Believe I can do this? Overwhelmed or ready?

Diagnose: Confusion → clarify | Boredom → add story | Resistance → address objections | Overwhelm → simplify

Invoke Mode: Load relevant reference file

Implement: Use str_replace
...
Promise Delivery: Book delivers promise? Transformation clear and achievable?
Pacing: Change speed appropriate? Integration plateaus? Energy builds?
Metaphor: Maintained throughout? Breaks or contradicts? Still serves at end?
Reveal (if applicable): Twist earned? Seeds planted? Reframe lands emotionally?
Exercise Progression: Build on each other? Difficulty matches stage? Variety?
Common Issues
Symptom	Cause	Fix
