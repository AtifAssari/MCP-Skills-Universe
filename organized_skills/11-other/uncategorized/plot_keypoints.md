---
rating: ⭐⭐
title: plot-keypoints
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/plot-keypoints
---

# plot-keypoints

skills/vangongwanxiaowan/screen-creative-skills/plot-keypoints
plot-keypoints
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill plot-keypoints
SKILL.md
大情节点分析专家
功能
...
剧本改编前进行结构梳理。
核心步骤
阅读理解: 充分阅读并理解故事文本，把握整体结构和主题。
脉络梳理: 梳理故事准确完整的脉络，识别关键转折点。
情节点提炼: 根据情节点定义，准确总结主要情节点，确保完整准确。
阶段划分: 按故事发展阶段（如三幕式结构）进行划分和排列。
结构化输出: 按照指定格式输出，确保清晰易读。
输入要求
完整的故事文本（小说、剧本、故事大纲等）
