---
rating: ⭐⭐⭐
title: gsd-orchestration
url: https://skills.sh/natilevyy/claude-production-skills/gsd-orchestration
---

# gsd-orchestration

skills/natilevyy/claude-production-skills/gsd-orchestration
gsd-orchestration
Installation
...
Generate .gsd/phases/phase-N/CONTEXT.md
...
Document results
If all pass → suggest gsd complete [N]
If any fail → identify failing task, suggest fix
...
Prompts as markdown files - For agent projects, store prompts in prompts/*.md
