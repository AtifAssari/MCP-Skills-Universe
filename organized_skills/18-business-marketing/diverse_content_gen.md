---
rating: ⭐⭐
title: diverse-content-gen
url: https://skills.sh/rfxlamia/claude-skillkit/diverse-content-gen
---

# diverse-content-gen

skills/rfxlamia/claude-skillkit/diverse-content-gen
diverse-content-gen
Installation
...
Start here: references/vs-core-technique.md
...
Load: references/task-workflows.md
...
Load: vs-core-technique.md (if not already loaded)
Execute: VS prompt with k=5
...
Load: vs-core-technique.md + tool-integration.md
Execute: VS with k=5, make 2 calls
...
Load: advanced-techniques.md
Execute: VS-Multi workflow (initial VS → user selects → refine)
