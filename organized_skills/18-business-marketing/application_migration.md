...
url: https://skills.sh/dauquangthanh/hanoi-rainbow/application-migration
---

# application-migration

skills/dauquangthanh/hanoi-rainbow/application-migration
application-migration
Installation
...
Dependency mapping - Unknown dependencies cause 60% of migration failures
Data validation - Verify data integrity before AND after migration (row counts, checksums, business rules)
Performance testing - Test with 2x expected peak load
Rollback testing - Execute full rollback procedure in staging before cutover
Incremental deployment - Use feature flags and canary releases (10% → 25% → 50% → 100%)
