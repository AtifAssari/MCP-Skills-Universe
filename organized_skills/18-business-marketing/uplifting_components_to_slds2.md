---
rating: ⭐⭐
title: uplifting-components-to-slds2
url: https://skills.sh/forcedotcom/afv-library/uplifting-components-to-slds2
---

# uplifting-components-to-slds2

skills/forcedotcom/afv-library/uplifting-components-to-slds2
uplifting-components-to-slds2
Installation
...
CSS: Rename .slds-* selector → {componentName}-{sldsElementPart} (camelCase)
Markup: Add the new class alongside the SLDS class — never remove the SLDS class
...
Rule: LWC Token to SLDS Hook — Deprecated --lwc-* token replacement patterns
Rule: No Deprecated Tokens SLDS1 — Legacy t()/token() Aura syntax replacement patterns
