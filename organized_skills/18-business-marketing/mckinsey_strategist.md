...
url: https://skills.sh/ericgandrade/claude-superskills/mckinsey-strategist
---

# mckinsey-strategist

skills/ericgandrade/claude-superskills/mckinsey-strategist
mckinsey-strategist
Installation
$ npx skills add https://github.com/ericgandrade/claude-superskills --skill mckinsey-strategist
SKILL.md
💼 McKinsey Strategist
...
Output (Executive Synthesis): "Revenue erosion is primarily driven by mobile conversion inefficiency and stockouts on key items, requiring immediate restructuring of UX and the supply chain."
...
Each agent prompt begins with: # {AgentName} — Strategic Framework Analyst Input: Full problem statement + context provided by user.
...
Second-Order Thinking: 1st, 2nd, and 3rd order consequences.
Impact vs. Effort Matrix: Prioritization by ROI.
...
Decision: [Action] Immediate Consequence: [1st order effect] Systemic Impact: [2nd/3rd order effect] Mitigation: [Corrective action]
