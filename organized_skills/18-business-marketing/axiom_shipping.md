---
rating: ⭐⭐
title: axiom-shipping
url: https://skills.sh/charleswiltgen/axiom/axiom-shipping
---

# axiom-shipping

skills/charleswiltgen/axiom/axiom-shipping
axiom-shipping
Installation
...
App was rejected? → skills/app-store-diag.md
Post-submission crash data/metrics? → skills/app-store-connect-ref.md
Beta crash triage/symbolication? → skills/testflight-triage.md
Automate ASC via MCP tools? → skills/asc-mcp.md
Validate screenshots? → screenshot-validator (Agent)
Need specific metadata/guideline specs? → skills/app-store-ref.md
IAP submission issue? → iap-auditor (Agent)
Want pre-submission code scan? → security-privacy-scanner (Agent)
ITMS signing/certificate/profile error on upload? → See axiom-security (skills/code-signing-diag.md)
General submission preparation? → skills/app-store-submission.md
...
User: "What's new in App Store Connect for 2025?" → See skills/app-store-ref.md
