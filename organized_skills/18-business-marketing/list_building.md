...
rating: ⭐⭐
title: list-building
url: https://skills.sh/sachacoldiq/coldiq-s-gtm-skills/list-building
---

# list-building

skills/sachacoldiq/coldiq-s-gtm-skills/list-building
list-building
Installation
...
Use Glob to search for **/list-building/SKILL.md
...
Response Format
Identify which sub-skill(s) the user needs
If full workflow requested, present the beginner template first, then offer to deep-dive into any step
Always clarify ICP if not provided (industry, company size, titles, geo, tech stack)
Provide specific, actionable steps with tool recommendations
Include relevant numbers (list size estimates, cost expectations, timeline)
Weekly Installs
43
Repository
