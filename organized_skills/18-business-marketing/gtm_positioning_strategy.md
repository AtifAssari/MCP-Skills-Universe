...
url: https://skills.sh/github/awesome-copilot/gtm-positioning-strategy
---

# gtm-positioning-strategy

skills/github/awesome-copilot/gtm-positioning-strategy
gtm-positioning-strategy
Installation
$ npx skills add https://github.com/github/awesome-copilot --skill gtm-positioning-strategy
SKILL.md
...
Collect competitor messaging
Identify your actual strengths (ask customers)
Find under-served position
Stake clear, defensible claim

Defensibility hierarchy:

Structural advantage (unique data, deployment flexibility, pricing model)
Market position (category ownership)
Product feature (weakest, easily copied)

Testing hierarchy (signal strength):

Outbound reply rates (highest)
Sales call conversion (high)
Website CTR (moderate)
Related Skills
