---
rating: ⭐⭐
title: psychological-trigger-marketing
url: https://skills.sh/timlai666/skills/psychological-trigger-marketing
---

# psychological-trigger-marketing

skills/timlai666/skills/psychological-trigger-marketing
psychological-trigger-marketing
Installation
$ npx skills add https://github.com/timlai666/skills --skill psychological-trigger-marketing
SKILL.md
Psychological Trigger Marketing
Overview
...
詳細定義、文案動作與台灣示例，讀 references/01-trigger-playbook.md。
...
依 channel 與目標的套用方式，讀 references/02-application-matrix.md。
...
Workflow
先跑 Data Sufficiency Gate
判斷目前是 cold / warm / hot 哪一段轉換
從三個主驅動中選 1-2 個，從四個輔助模組中選 1-2 個
先寫 strategy_summary，再展開 message_angles
最後才寫 headline_options 與 cta_options
補上 risk_flags 與 assumptions_used
Hard Rules
...
References
Trigger 定義與案例：references/01-trigger-playbook.md
Channel 套用矩陣：references/02-application-matrix.md
Suggested Prompts
