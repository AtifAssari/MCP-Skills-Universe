...
rating: ⭐⭐
title: analytics
url: https://skills.sh/whawkinsiv/claude-code-skills/analytics
---

# analytics

skills/whawkinsiv/claude-code-skills/analytics
analytics
Installation
...
Landing page visits (traffic source)
Waitlist/signup conversions
Where visitors drop off
0-$1K MRR (Add These)
Signup → activation rate (completed key action)
Time to activate (hours from signup to key action)
D7 retention (% returning after 1 week)
Free-to-paid conversion
$1K-$10K MRR (Add These)
Feature adoption (% of users using each feature weekly)
Cohort retention curves (track each month's signups over time)
