---
rating: ⭐⭐
title: building-ui-bundle-app
url: https://skills.sh/forcedotcom/afv-library/building-ui-bundle-app
---

# building-ui-bundle-app

skills/forcedotcom/afv-library/building-ui-bundle-app
building-ui-bundle-app
Installation
...
Execute: Run sf template generate ui-bundle, install dependencies (npm install), configure meta XML, ui-bundle.json, and CSP trusted sites
...
Load skill: Invoke building-ui-bundle-frontend
