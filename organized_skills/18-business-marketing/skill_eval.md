...
rating: ⭐⭐
title: skill-eval
url: https://skills.sh/notque/claude-code-toolkit/skill-eval
---

# skill-eval

skills/notque/claude-code-toolkit/skill-eval
skill-eval
Installation
$ npx skills add https://github.com/notque/claude-code-toolkit --skill skill-eval
SKILL.md
