...
rating: ⭐⭐⭐
title: skill-search
url: https://skills.sh/aaaaqwq/claude-code-skills/skill-search
---

# skill-search

skills/aaaaqwq/claude-code-skills/skill-search
skill-search
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill skill-search
SKILL.md
Skill 搜索与安装助手（v2）
...
安装流程
去重检查：ls ~/.claude/skills/ ~/clawd/skills/ 是否已存在
clone + 定位：git clone --depth 1 → find -name SKILL.md
双路径安装：
