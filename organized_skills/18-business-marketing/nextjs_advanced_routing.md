...
url: https://skills.sh/wsimmonds/claude-nextjs-skills/nextjs-advanced-routing
---

# nextjs-advanced-routing

skills/wsimmonds/claude-nextjs-skills/nextjs-advanced-routing
nextjs-advanced-routing
Installation
...
Create the server action in a SEPARATE file with 'use server' directive
Import and use it in the client component
...
Throw errors if validation fails (don't return error objects)
Process the request
Don't return anything (return void)
...
✅ Pass TypeScript checks (returns void)
✅ Validate all inputs before processing
✅ Throw error if validation fails (prevents database save)
✅ Not return an error object (which would break form action typing)
