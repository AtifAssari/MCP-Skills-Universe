...
rating: ⭐⭐⭐⭐⭐
title: mermaid-gen
url: https://skills.sh/vladm3105/aidoc-flow-framework/mermaid-gen
---

# mermaid-gen

skills/vladm3105/aidoc-flow-framework/mermaid-gen
mermaid-gen
Installation
...
Give subgraph an ID without special chars: subgraph ID["Display Name"]
Reference the ID in style directive: style ID fill:#color
...
Locate problem: Edge label has nested quotes: Request "data"
Apply fix: Remove inner quotes: Request data
Validate: Test corrected syntax in Mermaid Live Editor
Return fixed code
...
charts-flow skill invoked for file management
charts-flow internally calls mermaid-gen for diagram generation
mermaid-gen returns validated Mermaid code
charts-flow creates diagram file, generates SVG, embeds in parent document
