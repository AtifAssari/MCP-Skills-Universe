---
rating: ⭐⭐
title: copilot objection
url: https://skills.sh/sixtysecondsapp/use60/copilot-objection
---

# copilot objection

skills/sixtysecondsapp/use60/Copilot Objection
Copilot Objection
Installation
...
Parse the objection: Classify into a category (see Objection Taxonomy below)
Fetch deal context: execute_action("get_deal", { id: deal_id }) -- stage, amount, competitive situation, close date
Fetch contact context: execute_action("get_contact", { id: contact_id }) -- role, seniority, previous concerns, communication style
Fetch recent activities: Last 30 days of meetings, emails, calls involving this contact
Fetch organization playbook: Check Organization Context for objection handling frameworks, approved responses, and case studies
Layer 2: Enrichment (Web Search)

Expand beyond CRM with external intelligence relevant to the objection category:

Competitor claims (for competition objections): executeWebSearch("{competitor_name} vs {your_product} reviews comparison", 5) -- find real claims to counter
Industry benchmarks (for price objections): executeWebSearch("{prospect_industry} {product_category} pricing benchmarks ROI", 3) -- market-rate validation
Proof points (all categories): executeWebSearch("{your_product} customer results {prospect_industry}", 3) -- case studies and testimonials
Market context (for timing/need objections): executeWebSearch("{prospect_industry} trends challenges 2025 2026", 3) -- urgency signals
...
"objections raised by {contact}" -- past objections from this specific person
"objection about {category} from {company}" -- similar objections from the same account
"how {category} objection was handled" -- successful responses across all deals
"{competitor_name} mentioned by" -- competitor claims surfaced in meetings (for competition objections)
"pricing concerns in {prospect_industry}" -- industry-specific objection patterns
