---
rating: ⭐⭐⭐
title: story-long-scan
url: https://skills.sh/worldwonderer/oh-story-claudecode/story-long-scan
---

# story-long-scan

skills/worldwonderer/oh-story-claudecode/story-long-scan
story-long-scan
Installation
...
references/genre-trends.md	查看当前题材趋势和切入建议时
references/publishing-guide.md	平台选择+推荐机制+数据指标+简介设计
references/scan-output-format.md	browser-cdp采集字段定义+输出模板+文件命名规范
...
scripts/qidian-rank-scraper.js	起点榜单采集（畅销/月票/新书等），SSR 直出提取
