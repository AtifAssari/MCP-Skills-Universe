---
rating: ⭐⭐
title: paw-mkt-analytics
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-analytics
---

# paw-mkt-analytics

skills/pawbytes/skill-suites/paw-mkt-analytics
paw-mkt-analytics
Installation
...
Route the starting context — Read ./references/shared-patterns.md for Starting Context Router. Decide: strategy (measurement plan from scratch), codebase implementation (tracking setup), or live URL audit (existing analytics review).
