---
rating: ⭐⭐⭐
title: frappe-impl-serverscripts
url: https://skills.sh/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-serverscripts
---

# frappe-impl-serverscripts

skills/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-serverscripts
frappe-impl-serverscripts
Installation
$ npx skills add https://github.com/openaec-foundation/erpnext_anthropic_claude_development_skill_package --skill frappe-impl-serverscripts
SKILL.md
...
Enable server scripts: bench set-config server_script_enabled true
Navigate to Setup > Server Script (or awesomebar: "New Server Script")
