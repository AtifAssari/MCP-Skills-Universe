...
rating: ⭐⭐
title: animate
url: https://skills.sh/delphi-ai/animate-skill/animate
---

# animate

skills/delphi-ai/animate-skill/animate
animate
Installation
...
Golden Rules
Exits faster than enters: Exit animations should be ~75% of enter duration
Only animate transform and opacity: These are GPU-accelerated
200-300ms is the sweet spot: Most animations should be in this range
Always respect prefers-reduced-motion: See accessibility section in references
Use springs for interruptible animations: Better UX when users interrupt
Examples
