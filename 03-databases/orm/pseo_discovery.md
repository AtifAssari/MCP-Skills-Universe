---
title: pseo-discovery
url: https://skills.sh/lisbeth718/pseo-skills/pseo-discovery
---

# pseo-discovery

skills/lisbeth718/pseo-skills/pseo-discovery
pseo-discovery
Installation
...
Flag the risk explicitly in the discovery report
Elevate content quality requirements: Every page needs cited authoritative sources, expert attribution, and review processes
Evaluate if pSEO is appropriate at all: YMYL content often requires human expert review per page, which conflicts with the "programmatic" approach. Be honest about this tension.
Recommend stricter quality guard thresholds: Higher minimum word counts, stricter uniqueness requirements, mandatory E-E-A-T fields
Consider hybrid approach: Programmatic data structure + human-reviewed content per page
