---
rating: ⭐⭐
title: mongodb-query-optimizer
url: https://skills.sh/mongodb/agent-skills/mongodb-query-optimizer
---

# mongodb-query-optimizer

skills/mongodb/agent-skills/mongodb-query-optimizer
mongodb-query-optimizer
Installation
...
Diagnose and Recommend: Based on slow query logs and performance advisor advice, you can create the compound index {status: 1, region: 1, date: -1} on the db.orders collection to optimize queries such as find({status: 'shipped', region: 'US'}).sort({date: -1})
