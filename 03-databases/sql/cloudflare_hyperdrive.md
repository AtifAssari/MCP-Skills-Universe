...
url: https://skills.sh/jezweb/claude-skills/cloudflare-hyperdrive
---

# cloudflare-hyperdrive

skills/jezweb/claude-skills/cloudflare-hyperdrive
cloudflare-hyperdrive
Installation
...
ALWAYS use ctx.waitUntil(client.end()) - non-blocking cleanup after response sent NEVER use await client.end() - blocks response, adds latency
...
Use prepared statements - Enables query caching (postgres.js: prepare: true)
Set max: 5 for pools - Stays within Workers' 6 connection limit
