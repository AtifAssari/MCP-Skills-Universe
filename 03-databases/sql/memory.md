---
title: memory
url: https://skills.sh/rjyo/memory-search/memory
---

# memory

skills/rjyo/memory-search/memory
memory
Installation
$ npx skills add https://github.com/rjyo/memory-search --skill memory
SKILL.md
Memory
...
If they want more detail, use Read to get the full file content
If no results found, offer to search with different terms
Saving to Memory
