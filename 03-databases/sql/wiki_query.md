---
title: wiki-query
url: https://skills.sh/kfchou/wiki-skills/wiki-query
---

# wiki-query

skills/kfchou/wiki-skills/wiki-query
wiki-query
Installation
$ npx skills add https://github.com/kfchou/wiki-skills --skill wiki-query
SKILL.md
Wiki Query
