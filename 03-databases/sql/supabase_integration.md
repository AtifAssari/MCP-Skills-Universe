...
url: https://skills.sh/vanman2024/ai-dev-marketplace/supabase-integration
---

# supabase-integration

skills/vanman2024/ai-dev-marketplace/supabase-integration
supabase-integration
Installation
$ npx skills add https://github.com/vanman2024/ai-dev-marketplace --skill supabase-integration
SKILL.md
...
Verifies extension is active
Checks PostgreSQL version compatibility (>= 12)
...
Export memories from Platform API
Transform format (Platform JSON → Postgres schema)
Generate embeddings if missing
Validate data integrity
Batch insert to Supabase
Verify counts and sample queries
Update application configs to use OSS
