---
title: session-index
url: https://skills.sh/lee-fuhr/claude-session-index/session-index
---

# session-index

skills/lee-fuhr/claude-session-index/session-index
session-index
Installation
$ npx skills add https://github.com/lee-fuhr/claude-session-index --skill session-index
SKILL.md
Session index skill
...
Search: sessions "topic" -n 10
For the top 3-5 results, extract context: sessions context <id> "topic" -n 3
Spawn a Task with model="haiku" to synthesize:
What approaches were tried?
What worked / what failed?
Recurring patterns?
Current state?
Present the synthesis conversationally with claude --resume <id> links for each source session
