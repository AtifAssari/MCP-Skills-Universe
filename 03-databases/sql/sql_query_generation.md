...
url: https://skills.sh/seb1n/awesome-ai-agent-skills/sql-query-generation
---

# sql-query-generation

skills/seb1n/awesome-ai-agent-skills/sql-query-generation
sql-query-generation
Installation
...
Sequential scan on orders — no index on order_date
Implicit join syntax hides join order from optimizer
Sort spilling to disk due to insufficient work_mem
