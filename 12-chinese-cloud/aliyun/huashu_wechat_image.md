---
title: huashu-wechat-image
url: https://skills.sh/alchaincyf/huashu-skills/huashu-wechat-image
---

# huashu-wechat-image

skills/alchaincyf/huashu-skills/huashu-wechat-image
huashu-wechat-image
Installation
...
文字准确吗？（中文无乱码/错字）
比例正确吗？（封面 2.35:1、正文 16:9 或 4:3）
封面安全区：核心信息在中央正方形内？（封面特有）
深色模式：是否避免了纯白底和纯黑底？
风格满意吗？
