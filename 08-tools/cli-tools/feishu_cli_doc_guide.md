---
rating: ⭐⭐⭐⭐⭐
title: feishu-cli-doc-guide
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-doc-guide
---

# feishu-cli-doc-guide

skills/riba2534/feishu-cli/feishu-cli-doc-guide
feishu-cli-doc-guide
Installation
...
❌ 避免 skinparam、!define、颜色、字体、对齐控制等样式指令
⚠️ 避免方向控制指令（left to right direction 等在部分场景不可靠）
各图类型注意事项
图类型	安全语法	禁忌
...
遇到 ![alt](url) 时，自动下载网络图片或读取本地图片
通过素材上传 API 上传到飞书，获取 file_token
创建 Image 块并引用 file_token，实现图片插入
上传失败时降级为占位块，导入报告显示失败数量
注意事项
