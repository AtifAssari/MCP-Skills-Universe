...
rating: ⭐⭐
title: gogcli-ops
url: https://skills.sh/chachamaru127/claude-code-harness/gogcli-ops
---

# gogcli-ops

skills/chachamaru127/claude-code-harness/gogcli-ops
gogcli-ops
Installation
$ npx skills add https://github.com/chachamaru127/claude-code-harness --skill gogcli-ops
SKILL.md
Gogcli Ops
Overview
