---
rating: ⭐⭐⭐
title: mcp oauth cloudflare
url: https://skills.sh/jezweb/claude-skills/mcp-oauth-cloudflare
---

# mcp oauth cloudflare

skills/jezweb/claude-skills/MCP OAuth Cloudflare
MCP OAuth Cloudflare
Installation
...
Add authorized redirect URI: https://your-worker.workers.dev/callback
...
Ensure all tokens include correct aud claim
