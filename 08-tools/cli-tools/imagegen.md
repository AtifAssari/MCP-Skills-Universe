...
rating: ⭐⭐
title: imagegen
url: https://skills.sh/openai/skills/imagegen
---

# imagegen

skills/openai/skills/imagegen
imagegen
Installation
...
If the image is only for preview or brainstorming, render it inline; the underlying file can remain at the default $CODEX_HOME/* path.
