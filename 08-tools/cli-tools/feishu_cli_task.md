---
rating: ⭐⭐⭐
title: feishu-cli-task
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-task
---

# feishu-cli-task

skills/riba2534/feishu-cli/feishu-cli-task
feishu-cli-task
Installation
...
注意事项
任务 ID：UUID 格式，如 e297ddff-06ca-4166-b917-4ce57cd3a7a0
截止时间：支持 YYYY-MM-DD HH:mm:ss 或 YYYY-MM-DD 格式
来源链接：可关联外部系统（如 GitHub、Jira）的链接
权限要求：需要应用具有任务相关权限
权限要求（重要）
