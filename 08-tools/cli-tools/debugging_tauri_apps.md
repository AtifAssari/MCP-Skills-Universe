---
title: debugging-tauri-apps
url: https://skills.sh/dchuk/claude-code-tauri-skills/debugging-tauri-apps
---

# debugging-tauri-apps

skills/dchuk/claude-code-tauri-skills/debugging-tauri-apps
debugging-tauri-apps
Installation
...
Press F5 or select debug configuration from Run menu
The preLaunchTask runs the dev server automatically
Debugger attaches and stops at breakpoints
...
Common Issues
Breakpoints not hit: Ensure --no-default-features is set when building
Dev server not starting: Configure preLaunchTask or start manually
App not loading frontend: Dev server must be running before Tauri app starts
