---
rating: ⭐⭐⭐
title: yandex-cloud-cli
url: https://skills.sh/elsvv/yandex-cloud-cli-skill/yandex-cloud-cli
---

# yandex-cloud-cli

skills/elsvv/yandex-cloud-cli-skill/yandex-cloud-cli
yandex-cloud-cli
Installation
...
OAuth token (personal use): yc config set token <OAUTH-TOKEN>
Service account key (automation): yc config set service-account-key key.json
Instance metadata (on YC VMs): yc config set instance-service-account true
Federation (SSO): yc init --federation-id <ID>
