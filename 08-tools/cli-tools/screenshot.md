---
title: screenshot
url: https://skills.sh/spm1001/claude-suite/screenshot
---

# screenshot

skills/spm1001/claude-suite/screenshot
screenshot
Installation
$ npx skills add https://github.com/spm1001/claude-suite --skill screenshot
SKILL.md
Screenshotting
...
Capture: Uses screencapture -l<windowid> for windows, screencapture -x for screen
Resize: Uses sips --resampleHeightWidthMax for efficient scaling
