...
url: https://skills.sh/dotnet/skills/migrate-vstest-to-mtp
---

# migrate-vstest-to-mtp

skills/dotnet/skills/migrate-vstest-to-mtp
migrate-vstest-to-mtp
Installation
$ npx skills add https://github.com/dotnet/skills --skill migrate-vstest-to-mtp
SKILL.md
...
Check the .NET SDK version (dotnet --version) -- this determines how dotnet test integrates with MTP
...
Update NUnit3TestAdapter to 5.0.0+:
...
Microsoft.Testing.Platform CLI options
