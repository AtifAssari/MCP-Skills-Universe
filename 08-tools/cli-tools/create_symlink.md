...
url: https://skills.sh/steelan9199/wechat-publisher/create-symlink
---

# create-symlink

skills/steelan9199/wechat-publisher/create-symlink
create-symlink
Installation
$ npx skills add https://github.com/steelan9199/wechat-publisher --skill create-symlink
SKILL.md
...
查看环境变量中的系统信息：如 process.platform（在 Node.js 环境中）
分析用户提供的路径格式：
