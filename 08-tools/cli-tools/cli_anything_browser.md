...
url: https://skills.sh/hkuds/cli-anything/cli-anything-browser
---

# cli-anything-browser

skills/hkuds/cli-anything/cli-anything-browser
cli-anything-browser
Installation
...
Start daemon: cli-anything-browser session daemon-start
Run commands: Each command reuses the MCP connection
Stop daemon: cli-anything-browser session daemon-stop
...
Using the --json flag for structured output that's easier to parse safely
