---
rating: ⭐⭐
title: grimoire-morpho-blue
url: https://skills.sh/franalgaba/grimoire/grimoire-morpho-blue
---

# grimoire-morpho-blue

skills/franalgaba/grimoire/grimoire-morpho-blue
grimoire-morpho-blue
Installation
...
Use apy(morpho, asset[, selector]) for Morpho Blue market APY comparisons. Use metric("vault_apy", morpho, asset, selector) or metric("vault_net_apy", morpho, asset, selector) for MetaMorpho vault comparisons.
