---
rating: ⭐⭐
title: wix-cli-dashboard-page
url: https://skills.sh/wix/skills/wix-cli-dashboard-page
---

# wix-cli-dashboard-page

skills/wix/skills/wix-cli-dashboard-page
wix-cli-dashboard-page
Installation
...
Follow these steps in order when creating a dashboard page:
 ...
 Create page folder: src/extensions/dashboard/pages/<page-name>/
 Create page.tsx with WDS components wrapped in WixDesignSystemProvider
 Create extensions.ts with extensions.dashboardPage() and unique UUID
...
Consistent: Maintain repetitive layouts and content patterns for intuitive and easy-to-read pages.
Inclusive: Create layouts and content that adapt well to various screen sizes.
Balanced: Emphasize the priority of regions and content elements through deliberate management of size and white space.
Connected: Minimize the distance between related regions or content elements to enhance cohesion and navigation.
Screen Size
...
The core frame of the app (Application frame)
The placement and alignment of each segment within the grid layout (Grid layout)
The content to appear in the grid (Common layouts)
Application Frame
...
Promo messaging
Visual representation of product and features
