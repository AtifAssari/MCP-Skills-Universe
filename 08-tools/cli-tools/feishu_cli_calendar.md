---
rating: ⭐⭐⭐
title: feishu-cli-calendar
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-calendar
---

# feishu-cli-calendar

skills/riba2534/feishu-cli/feishu-cli-calendar
feishu-cli-calendar
Installation
...
注意事项
日历 ID：创建日程前需要先通过 calendar list 获取日历 ID
时间格式：必须使用 RFC3339 格式，包含时区信息
权限要求：需要应用具有日历相关权限
