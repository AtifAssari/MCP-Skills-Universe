...
rating: ⭐⭐
title: box
url: https://skills.sh/membranedev/application-skills/box
---

# box

skills/membranedev/application-skills/box
box
Installation
...
Built-in pagination, field mapping, and error handling through pre-built actions; raw API access available as fallback
SKILL.md
Box
