...
rating: ⭐⭐⭐
title: gitea-tea
url: https://skills.sh/beshkenadze/claude-skills-marketplace/gitea-tea
---

# gitea-tea

skills/beshkenadze/claude-skills-marketplace/gitea-tea
gitea-tea
Installation
...
Instructions
Verify authentication: Run tea whoami to confirm login
Check context: Run in git repo for auto-detection, or use --repo owner/repo
Use non-interactive mode: Always use --output flag and provide all arguments
