---
rating: ⭐⭐⭐
title: wecomcli-create-meeting
url: https://skills.sh/wecomteam/wecom-cli/wecomcli-create-meeting
---

# wecomcli-create-meeting

skills/wecomteam/wecom-cli/wecomcli-create-meeting
wecomcli-create-meeting
Installation
...
通讯录查询: 调用 wecomcli-lookup-contact 技能获取通讯录成员, 按姓名筛选出参与者的 userid.
