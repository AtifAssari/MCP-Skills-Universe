---
title: clig-eval-prompt
url: https://skills.sh/samzong/samzong/clig-eval-prompt
---

# clig-eval-prompt

skills/samzong/samzong/clig-eval-prompt
clig-eval-prompt
Installation
$ npx skills add https://github.com/samzong/samzong --skill clig-eval-prompt
SKILL.md
Clig Eval Prompt
Overview
...
Workflow
Output the canonical prompt below verbatim unless the user requests modifications.
If user requests changes (weights/thresholds/language/format), update only those parts; keep the rest intact.
If the user asks for a shorter version, compress wording but preserve all hard gates, thresholds, and dimensions.
Output Rules
