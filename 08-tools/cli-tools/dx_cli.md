...
rating: ⭐⭐
title: dx-cli
url: https://skills.sh/get-dx/cli/dx-cli
---

# dx-cli

skills/get-dx/cli/dx-cli
dx-cli
Installation
$ npx skills add https://github.com/get-dx/cli --skill dx-cli
SKILL.md
DX CLI
...
Snapshot analysis — Analyze snapshot scores, driver comments, and CSAT comments.
Weekly Installs
18
Repository
get-dx/cli
