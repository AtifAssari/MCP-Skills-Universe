---
title: cli-anything-iterm2-ctl
url: https://skills.sh/hkuds/cli-anything/cli-anything-iterm2-ctl
---

# cli-anything-iterm2-ctl

skills/hkuds/cli-anything/cli-anything-iterm2-ctl
cli-anything-iterm2-ctl
Installation
...
Prerequisites
macOS + iTerm2 running: brew install --cask iterm2
Python API enabled: iTerm2 → Preferences → General → Magic → Enable Python API
Install: pip install cli-anything-iterm2 (or pip install -e . from source)
Basic Syntax
