...
url: https://skills.sh/patricio0312rev/skills/curl-command-generator
---

# curl-command-generator

skills/patricio0312rev/skills/curl-command-generator
curl-command-generator
Installation
$ npx skills add https://github.com/patricio0312rev/skills --skill curl-command-generator
SKILL.md
cURL Command Generator
...
Pretty print: Pipe to jq for readable JSON output
Save responses: Use -o to save responses for analysis
Check status: Use -w "%{http_code}" to see status codes
Silent mode: Use -sS for scripts to hide progress
