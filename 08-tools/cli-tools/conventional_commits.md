...
url: https://skills.sh/knoopx/pi/conventional-commits
---

# conventional-commits

skills/knoopx/pi/conventional-commits
conventional-commits
Installation
$ npx skills add https://github.com/knoopx/pi --skill conventional-commits
SKILL.md
...
Add a BREAKING CHANGE: footer (recommended when you need an explanation):
feat(api): remove deprecated v1 endpoints
