---
title: skill-extract-scripts
url: https://skills.sh/codewithjv/agent-skills/skill-extract-scripts
---

# skill-extract-scripts

skills/codewithjv/agent-skills/skill-extract-scripts
skill-extract-scripts
Installation
...
Call the script first (Run ./script-name.sh)
Read the script's output
Do only the judgment work with that output
...
Classification table — every step labeled S or A with reasoning
Shell script — handles all S steps
Rewritten skill — calls the script, then does only A steps
Tips
