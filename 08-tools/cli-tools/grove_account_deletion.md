---
title: grove-account-deletion
url: https://skills.sh/autumnsgrove/groveengine/grove-account-deletion
---

# grove-account-deletion

skills/autumnsgrove/groveengine/grove-account-deletion
grove-account-deletion
Installation
...
Check for active subscriptions - Warn if platform_billing.status = 'active' or LemonSqueezy subscription exists
Test accounts are still accounts - Same process, same confirmation, same verification
