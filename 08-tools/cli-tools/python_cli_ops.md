---
title: python-cli-ops
url: https://skills.sh/0xdarkmatter/claude-mods/python-cli-ops
---

# python-cli-ops

skills/0xdarkmatter/claude-mods/python-cli-ops
python-cli-ops
Installation
$ npx skills add https://github.com/0xdarkmatter/claude-mods --skill python-cli-ops
SKILL.md
Python CLI Patterns
