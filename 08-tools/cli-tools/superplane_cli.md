...
url: https://skills.sh/superplanehq/skills/superplane-cli
---

# superplane-cli

skills/superplanehq/skills/superplane-cli
superplane-cli
Installation
...
superplane integrations list — confirm the provider is connected
superplane integrations get <id> — inspect the connection
Add integration.id to the node in the canvas YAML
superplane integrations list-resources --id <id> --type <type> — find valid resource values
superplane canvases update <name-or-id> --draft --file canvas.yaml — apply the fix
superplane canvases get <name> — verify errors are cleared
