...
rating: ⭐⭐⭐
title: ccw-cli-tools
url: https://skills.sh/catlog22/claude-code-workflow/ccw-cli-tools
---

# ccw-cli-tools

skills/catlog22/claude-code-workflow/ccw-cli-tools
ccw-cli-tools
Installation
...
Add --includeDirs parameter
Reference in CONTEXT with @ patterns
# Single directory
...
Check secondaryModel for same tool (use secondaryModel from config)
