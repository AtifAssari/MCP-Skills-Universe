---
title: spec-kit-plan
url: https://skills.sh/ahgraber/skills/spec-kit-plan
---
...
Resolve active feature paths and initialize plan.md:
...
Run Phase 0 research (research.md):
