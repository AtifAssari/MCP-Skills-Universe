...
url: https://skills.sh/wghust/stark-skills/git-intelligence
---

# git-intelligence

skills/wghust/stark-skills/git-intelligence
git-intelligence
Installation
$ npx skills add https://github.com/wghust/stark-skills --skill git-intelligence
SKILL.md
...
Omit empty sections. If no commits found: "No commits found since ."
...
Compute risk score (same rules as Step 3D)
Map changed files → logical modules (group by top 2 path segments)
Parse blame output → count lines per author email → take top 3 authors by blame-line count
If fewer than 2 blame authors found, add role fallbacks: auth/ → "security team", payment/ → "payments team", infra/ → "infra team"
Suggest test cases based on affected modules and sensitive areas
