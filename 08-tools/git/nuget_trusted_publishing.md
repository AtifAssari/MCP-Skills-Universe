...
url: https://skills.sh/dotnet/skills/nuget-trusted-publishing
---

# nuget-trusted-publishing

skills/dotnet/skills/nuget-trusted-publishing
nuget-trusted-publishing
Installation
...
For tools/MCP servers: install from ./artifacts, run --help, uninstall
For libraries: inspect the .nupkg contents (it's a zip)
