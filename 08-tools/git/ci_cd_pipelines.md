...
url: https://skills.sh/rohitg00/awesome-claude-code-toolkit/ci-cd-pipelines
---

# ci-cd-pipelines

skills/rohitg00/awesome-claude-code-toolkit/ci-cd-pipelines
ci-cd-pipelines
Installation
$ npx skills add https://github.com/rohitg00/awesome-claude-code-toolkit --skill ci-cd-pipelines
SKILL.md
CI/CD Pipelines
