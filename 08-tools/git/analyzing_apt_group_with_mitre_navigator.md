...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/analyzing-apt-group-with-mitre-navigator
---

# analyzing-apt-group-with-mitre-navigator

skills/mukul975/anthropic-cybersecurity-skills/analyzing-apt-group-with-mitre-navigator
analyzing-apt-group-with-mitre-navigator
Installation
$ npx skills add https://github.com/mukul975/anthropic-cybersecurity-skills --skill analyzing-apt-group-with-mitre-navigator
SKILL.md
...
Navigator Layer Format v4.5
CISA Best Practices for MITRE ATT&CK Mapping
Picus: Leverage MITRE ATT&CK for Threat Intelligence
Weekly Installs
62
Repository
