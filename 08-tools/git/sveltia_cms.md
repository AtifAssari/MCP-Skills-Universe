...
rating: ⭐⭐⭐
title: sveltia-cms
url: https://skills.sh/jezweb/claude-skills/sveltia-cms
---

# sveltia-cms

skills/jezweb/claude-skills/sveltia-cms
sveltia-cms
Installation
...
Supports YAML, TOML, JSON, and Markdown formats with field-level media folder overrides, raw format for config files, and global slug configuration (case preservation, max length, accent handling)
Recent updates: v0.128.0 adds lowercase slug option, v0.127.0 deprecates slug_length in favor of slug.maxlength, v0.126.0 adds raw format and locale URL parameters, v0.125.0 adds number string encoding and root folder collection fixes
SKILL.md
Sveltia CMS Skill
