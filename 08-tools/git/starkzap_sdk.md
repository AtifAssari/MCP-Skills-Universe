---
title: starkzap-sdk
url: https://skills.sh/keep-starknet-strange/starknet-agentic/starkzap-sdk
---

# starkzap-sdk

skills/keep-starknet-strange/starknet-agentic/starkzap-sdk
starkzap-sdk
Installation
$ npx skills add https://github.com/keep-starknet-strange/starknet-agentic --skill starkzap-sdk
SKILL.md
Starkzap SDK
...
Instantiate StarkSDK with network or rpcUrl + chainId.
Use sdk.onboard(...) or sdk.connectWallet(...).
Call wallet.ensureReady({ deploy: "if_needed" }) before user-pays writes.
