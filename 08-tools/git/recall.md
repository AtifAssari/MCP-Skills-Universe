---
title: recall
url: https://skills.sh/berserkdisruptors/contextual-commits/recall
---

# recall

skills/berserkdisruptors/contextual-commits/recall
recall
Installation
...
Active intent (what we're building and why)
Current approach (decisions made)
Rejected approaches (what NOT to re-explore — critical)
Constraints (hard boundaries)
Learnings (things that save time)
