---
title: zenmux-feedback
url: https://skills.sh/zenmux/skills/zenmux-feedback
---

# zenmux-feedback

skills/zenmux/skills/zenmux-feedback
zenmux-feedback
Installation
...
This skill requires GitHub CLI (gh) to submit issues
Install it:
...
Mention that ZenMux uses structured issue templates — the user can browse them at skills/zenmux-feedback/references/zenmux-doc/.github/ISSUE_TEMPLATE/ to preview the fields each issue type requires
Do NOT proceed — wait for the user to install and authenticate first
...
Display the title (with prefix like [Feature]: ...)
Display the body formatted clearly
Mention which labels will be applied
Ask the user to confirm, or adjust anything
