---
title: amis-builder
url: https://skills.sh/bamzc/claude-skills-frontend/amis-builder
---

# amis-builder

skills/bamzc/claude-skills-frontend/amis-builder
amis-builder
Installation
...
将生成的 HTML 保存为文件（如 preview.html）
直接在浏览器中打开即可预览效果
支持所有 amis 组件和功能
