---
title: upgrade-js-deps
url: https://skills.sh/saaspegasus/django-skills/upgrade-js-deps
---

# upgrade-js-deps

skills/saaspegasus/django-skills/upgrade-js-deps
upgrade-js-deps
Installation
$ npx skills add https://github.com/saaspegasus/django-skills --skill upgrade-js-deps
SKILL.md
Your task
...
TypeScript type checking: Run make npm-type-check and report any new type errors.
Build: Run make npm-build to verify the production build still works.
