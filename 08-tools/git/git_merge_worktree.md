---
rating: ⭐⭐⭐
title: git:merge-worktree
url: https://skills.sh/neolabhq/context-engineering-kit/git:merge-worktree
---

# git:merge-worktree

skills/neolabhq/context-engineering-kit/git:merge-worktree
git:merge-worktree
Installation
