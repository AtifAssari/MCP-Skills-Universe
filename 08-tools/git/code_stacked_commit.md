---
title: code:stacked-commit
url: https://skills.sh/martinffx/atelier/code:stacked-commit
---

# code:stacked-commit

skills/martinffx/atelier/code:stacked-commit
code:stacked-commit
Installation
$ npx skills add https://github.com/martinffx/atelier --skill code:stacked-commit
SKILL.md
...
Creates a new branch on top of the current stack
Opens editor for commit message (or use -m for inline)
...
Best Practices
One logical change per commit - Each commit should be reviewable independently
Meaningful commit messages - Use conventional commit format
Restack before submit - Always gt branch restack before submitting to ensure clean history
Keep stack small - Deep stacks can be hard to manage; 3-5 commits is ideal
Sync regularly - Run gt branch sync often when working with others
Troubleshooting
Issue	Solution
