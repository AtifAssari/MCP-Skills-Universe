---
rating: ⭐⭐
title: ln-511-code-quality-checker
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-511-code-quality-checker
---

# ln-511-code-quality-checker

skills/levnikolaevich/claude-code-skills/ln-511-code-quality-checker
ln-511-code-quality-checker
Installation
...
Collect changed files (changed_files[]): MANDATORY READ: Load shared/references/git_scope_detection.md
...
Analyze code for static issues (assign prefixes): MANDATORY READ: Load shared/references/clean_code_checklist.md, shared/references/destructive_operation_safety.md
...
Output verdict with score and structured issues. MANDATORY READ: Load references/output_schema.md Format output per schema. Add Linear comment with findings.
