---
title: review-fix-gemini
url: https://skills.sh/willbooster/agent-skills/review-fix-gemini
---

# review-fix-gemini

skills/willbooster/agent-skills/review-fix-gemini
review-fix-gemini
Installation
$ npx skills add https://github.com/willbooster/agent-skills --skill review-fix-gemini
SKILL.md
Review workflow
Run the following command with a 1-hour timeout (RUN IT AS A BLOCKING, FOREGROUND TASK TO PREVENT PREMATURE TERMINATION): bunx @willbooster/agent-skills@latest review --agent gemini
