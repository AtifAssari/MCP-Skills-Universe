...
My Org (default) — https://orgfbb52bb7.crm.dynamics.com (already configured)
Another Env — https://orgabc123.crm.dynamics.com
...
Generally Available (GA) — /api/mcp (recommended)
Preview — /api/mcp_preview (latest features, may be unstable)
...
Prepend DataverseMcp to create the server name
