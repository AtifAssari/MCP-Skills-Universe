---
title: apiops-deployment
url: https://skills.sh/thomast1906/github-copilot-agent-skills/apiops-deployment
---

# apiops-deployment

skills/thomast1906/github-copilot-agent-skills/apiops-deployment
apiops-deployment
Installation
...
Delegate subnet to Microsoft.ApiManagement/service:
delegations: [
  {
    name: 'delegation'
    properties: {
...
Approve Private Endpoint connection in APIM:
