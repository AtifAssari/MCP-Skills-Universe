---
title: github-triage
url: https://skills.sh/code-yeongyu/oh-my-openagent/github-triage
---

# github-triage

skills/code-yeongyu/oh-my-openagent/github-triage
github-triage
Installation
...
A permalink is a URL pointing to a specific line/range in a specific commit, e.g.: https://github.com/{owner}/{repo}/blob/{commit_sha}/{path}#L{start}-L{end}

How to generate permalinks
Find the relevant file and line(s) via Grep/Read.
Get the current commit SHA: git rev-parse HEAD
Construct: https://github.com/{REPO}/blob/{SHA}/{filepath}#L{line} (or #L{start}-L{end} for ranges)
Rules
