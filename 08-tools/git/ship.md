---
title: ship
url: https://skills.sh/webriq/claude-skills/ship
---

# ship

skills/webriq/claude-skills/ship
ship
Installation
$ npx skills add https://github.com/webriq/claude-skills --skill ship
SKILL.md
...
Identify which changes belong to which task
Generate accurate PR descriptions
Reference specific commits in the PR body
...
Know which items need to be included in the release
Properly track which release each feature belongs to
...
Revert: git revert {commit} and create PR
Document: Add to test report what was missed
Summary Output
...
vercel-react-best-practices	vercel-labs/agent-skills	React/Next.js code fixes
supabase-postgres-best-practices	supabase/agent-skills	Database-related fixes
Weekly Installs
31
Repository
