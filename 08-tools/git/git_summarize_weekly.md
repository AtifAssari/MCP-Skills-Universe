---
title: git-summarize-weekly
url: https://skills.sh/zc277584121/mygitplugin/git-summarize-weekly
---

# git-summarize-weekly

skills/zc277584121/mygitplugin/git-summarize-weekly
git-summarize-weekly
Installation
...
计算日期范围：计算本周一的日期到今天。使用 date 命令计算。
