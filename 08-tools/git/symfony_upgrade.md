---
title: symfony-upgrade
url: https://skills.sh/krzysztofsurdy/code-virtuoso/symfony-upgrade
---

# symfony-upgrade

skills/krzysztofsurdy/code-virtuoso/symfony-upgrade
symfony-upgrade
Installation
...
Search the web for Symfony UPGRADE-X.Y.md (e.g., Symfony UPGRADE-7.0.md github)
Or ask the user to provide the changelog / release notes
Read the UPGRADE file in the Symfony repository: https://github.com/symfony/symfony/blob/X.Y/UPGRADE-X.Y.md
Check the Symfony blog for the release announcement with highlighted changes
...
Check compatibility -- look at each bundle's composer.json for Symfony version constraints
Update bundles first -- composer update before bumping Symfony version
Check for forks -- if a bundle is abandoned, look for maintained forks on Packagist
