...
skills/github/awesome-copilot/breakdown-test
breakdown-test
Installation
...
Maps all eight ISO 25010 quality characteristics with prioritization matrices, validation approaches, and quality gates with entry/exit criteria
Provides GitHub issue templates for test strategy, Playwright test implementation, and quality assurance with standardized labeling, estimation guidelines, and dependency documentation
SKILL.md
