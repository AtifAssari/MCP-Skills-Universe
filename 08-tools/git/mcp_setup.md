---
title: mcp-setup
url: https://skills.sh/yeachan-heo/oh-my-claudecode/mcp-setup
---

# mcp-setup

skills/yeachan-heo/oh-my-claudecode/mcp-setup
mcp-setup
Installation
...
For stdio: Command and arguments (e.g., npx my-mcp-server)
For http: URL (e.g., https://example.com/mcp)
