---
title: html-to-image-render
url: https://skills.sh/hanfangyuan4396/text-card-skills/html-to-image-render
---

# html-to-image-render

skills/hanfangyuan4396/text-card-skills/html-to-image-render
html-to-image-render
Installation
...
工作流
从磁盘读取 HTML 文件内容。
如有必要，先查看 references/html-to-image-api.md 中的接口约定。
运行 scripts/render-html-to-image.ts，传入输入 HTML 路径和输出图片路径。
确认生成的图片文件已经落到目标位置。
脚本说明
