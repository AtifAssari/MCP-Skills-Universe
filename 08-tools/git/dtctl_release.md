---
title: dtctl-release
url: https://skills.sh/dynatrace-oss/dtctl/dtctl-release
---

# dtctl-release

skills/dynatrace-oss/dtctl/dtctl-release
dtctl-release
Installation
...
Use this to track progress:
 ...
 Analyzed all commits since last release
 Determined version number (semver)
 Updated pkg/version/version.go
 Updated CHANGELOG.md (entries + comparison link)
 Tests pass (go test ./...)
 Build succeeds (make build)
 Committed release changes on main
 Pushed to origin/main
 Created and pushed tag vX.Y.Z
 GitHub release notes written via gh release edit
Weekly Installs
35
Repository
dynatrace-oss/dtctl
