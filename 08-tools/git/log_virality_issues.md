---
rating: ⭐⭐⭐⭐⭐
title: log-virality-issues
url: https://skills.sh/phrazzld/claude-config/log-virality-issues
---

# log-virality-issues

skills/phrazzld/claude-config/log-virality-issues
log-virality-issues
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill log-virality-issues
SKILL.md
/log-virality-issues
