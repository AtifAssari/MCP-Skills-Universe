---
title: story-type-analyzer
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/story-type-analyzer
---

# story-type-analyzer

skills/vangongwanxiaowan/screen-creative-skills/story-type-analyzer
story-type-analyzer
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill story-type-analyzer
SKILL.md
题材类型与创意提炼专家
功能
...
为故事改编和商业化提供深度参考依据。
核心步骤
题材识别: 分析故事的主要题材类型和次要题材元素。
创意提炼: 识别并提炼故事中的核心创意元素与创新点。
特色分析: 分析故事的独特性、创新点及风格特征。
风格解读: 解读故事的叙事风格和艺术特色，把握作品基调。
价值评估: 综合评估题材的商业价值与艺术价值。
输入要求
