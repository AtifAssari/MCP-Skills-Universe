---
rating: ⭐⭐
title: test-json-sql-setup
url: https://skills.sh/bdambrosio/cognitive_workbench/test-json-sql-setup
---

# test-json-sql-setup

skills/bdambrosio/cognitive_workbench/test-json-sql-setup
test-json-sql-setup
Installation
$ npx skills add https://github.com/bdambrosio/cognitive_workbench --skill test-json-sql-setup
SKILL.md
Test JSON SQL Setup
