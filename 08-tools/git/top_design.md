...
rating: ⭐⭐⭐
title: top-design
url: https://skills.sh/wondelai/skills/top-design
---

# top-design

skills/wondelai/skills/top-design
top-design
Installation
$ npx skills add https://github.com/wondelai/skills --skill top-design
Summary
...
What will people screenshot?
What will they describe to colleagues?
What will they try to reverse-engineer?
What makes this unmistakably THIS project?
...
Start with the signature moment -- design the thing that defines the experience first
Conceptualize desktop-first, build mobile-first -- dream big, implement progressively
Prototype animations early -- motion is not a polish step, it is core to the design
Test on real devices -- simulators lie about performance and feel
Ship with restraint -- 3 things perfect beats 10 things mediocre
Sweat the micro-details -- craft lives in the 1% others skip
Design the states -- hover, focus, loading, empty, error all matter
Own your constraints -- every limitation is a design opportunity
Use project conventions -- if Tailwind 4+ and/or shadcn/ui are available, build on top of them rather than fighting them. Extend their design tokens, customize their components, and use their patterns as a foundation for 10/10 craft
Reference Files
...
Further Reading
Designing with Type by James Craig -- the foundational text on typographic principles, hierarchy, and the architecture of type in design
Grid Systems in Graphic Design by Josef Muller-Brockmann -- the definitive work on grid-based composition, proportional systems, and the mathematical foundations of visual layout
The Elements of Typographic Style by Robert Bringhurst -- the typographer's bible covering rhythm, proportion, and the craft of setting type beautifully
Interaction of Color by Josef Albers -- essential reading on color perception, contrast, and how colors behave in relation to each other
Layout Essentials: 100 Design Principles for Using Grids by Beth Tondreau -- practical grid-based layout principles applied to real design scenarios
Awwwards Annual: The Best 365 Websites Around the World -- yearly collection of the web's most innovative designs, serving as a benchmark for 10/10 craft
About the Author
