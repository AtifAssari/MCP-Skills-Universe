---
title: review-fix-claude
url: https://skills.sh/willbooster/agent-skills/review-fix-claude
---

# review-fix-claude

skills/willbooster/agent-skills/review-fix-claude
review-fix-claude
Installation
$ npx skills add https://github.com/willbooster/agent-skills --skill review-fix-claude
SKILL.md
Review workflow
Run the following command with a 1-hour timeout (RUN IT AS A BLOCKING, FOREGROUND TASK TO PREVENT PREMATURE TERMINATION): bunx @willbooster/agent-skills@latest review --agent claude
