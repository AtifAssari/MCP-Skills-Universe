---
title: windows-git-bash-compatibility
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/windows-git-bash-compatibility
---

# windows-git-bash-compatibility

skills/josiahsiegel/claude-plugin-marketplace/windows-git-bash-compatibility
windows-git-bash-compatibility
Installation
...
Resources
Git for Windows Path Conversion
...
Use export MSYS_NO_PATHCONV=1 to disable conversion
Detect shell environment using $MSYSTEM variable
