---
title: telegram
url: https://skills.sh/pytaichukbohdan/danacockfightbot/telegram
---

# telegram

skills/pytaichukbohdan/danacockfightbot/telegram
telegram
Installation
...
Run python telegram_dl.py and follow interactive prompts
Verify with python3 scripts/telegram_fetch.py setup
Quick Start
...
@username - Resolves Telegram username directly
Numeric ID - Resolves chat by Telegram ID
