---
title: simplify
url: https://skills.sh/karlorz/agent-skills/simplify
---

# simplify

skills/karlorz/agent-skills/simplify
simplify
Installation
$ npx skills add https://github.com/karlorz/agent-skills --skill simplify
SKILL.md
Simplify
...
Quick Mode (QUICK_MODE=true): Do a single-pass review yourself, combining reuse, quality, and efficiency checks. Focus only on high-impact issues. Skip spawning parallel sub-agents.
...
Report-Only Mode (REPORT_ONLY=true): Do not make any changes. Instead, compile findings into a report. If JSON_OUTPUT=true, format as JSON array:
