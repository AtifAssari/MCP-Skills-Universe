...
url: https://skills.sh/jh941213/my-claude-code-asset/stitch-enhance-prompt
---

# stitch-enhance-prompt

skills/jh941213/my-claude-code-asset/stitch-enhance-prompt
stitch-enhance-prompt
Installation
...
디자인 시스템 컨텍스트: DESIGN.md에서 스타일 정보 통합
구조화된 출력: 최적의 생성 결과를 위한 프롬프트 구조화
Stitch 프롬프팅 원칙
효과적인 프롬프트의 3요소
요소	설명	예시
