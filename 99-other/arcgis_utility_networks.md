---
rating: ⭐⭐
title: arcgis-utility-networks
url: https://skills.sh/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-utility-networks
---

# arcgis-utility-networks

skills/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-utility-networks
arcgis-utility-networks
Installation
...
Authentication required: Utility network services typically require authentication — configure esriConfig.portalUrl and credentials.

WebMap required: Utility networks must be accessed through a WebMap — they cannot be created client-side.

High zoom for associations: Associations only display at very high zoom levels — use TileInfo.create({ numLODs: 32 }) and set snapToZoom: false.

Load order: Must load WebMap first, then load UtilityNetwork before creating widgets.

Enterprise portals: Often hosted on ArcGIS Enterprise — set esriConfig.portalUrl to the portal URL.
