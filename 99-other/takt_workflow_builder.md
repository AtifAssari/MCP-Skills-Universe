---
title: takt-workflow-builder
url: https://skills.sh/j5ik2o/ai-tools/takt-workflow-builder
---

# takt-workflow-builder

skills/j5ik2o/ai-tools/takt-workflow-builder
takt-workflow-builder
Installation
$ npx skills add https://github.com/j5ik2o/ai-tools --skill takt-workflow-builder
SKILL.md
TAKT Workflow Builder
...
目的: このワークフローで何を達成するか
ステップ構成: どんなステップが必要か（plan→implement→review→supervise等）
レビュー体制: 並列レビューの有無、レビュアーの種類
ループ制御: 修正ループの有無と閾値
出力先: ワークフローとファセットの配置場所（デフォルト: ~/.takt/workflows/）
Step 2: ビルトイン参照
