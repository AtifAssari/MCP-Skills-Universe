---
title: tw-edu-citation-checker
url: https://skills.sh/fw1201/tw-edu-skills/tw-edu-citation-checker
---

# tw-edu-citation-checker

skills/fw1201/tw-edu-skills/tw-edu-citation-checker
tw-edu-citation-checker
Installation
$ npx skills add https://github.com/fw1201/tw-edu-skills --skill tw-edu-citation-checker
SKILL.md
學術文獻嚴格查核與格式驗證系統 v1.0
核心原則

「寧可說查無，也不給假答案。 查不到的文獻直接標示 ❌ 查無；格式錯誤直接標出錯誤位置，不美化。」

Step 0：讀取必要文件
references/citation_formats.md — 各格式完整規範（APA 7th / MLA / 臺灣格式）
references/verification_protocol.md — 文獻查核流程與標準
../../tw_edu_guided_collection.md — 引導式收集框架

MCP 查核工具（依優先順序）：

Consensus MCP（學術論文搜尋）
WebSearch（Google Scholar / CrossRef / DOI resolver）
