...
url: https://skills.sh/tjboudreaux/cc-thinking-skills/thinking-inversion
---

# thinking-inversion

skills/tjboudreaux/cc-thinking-skills/thinking-inversion
thinking-inversion
Installation
...
Inversion: List ways the project could fail (theoretical)
Pre-Mortem: Imagine it DID fail, explain why (narrative)
Synthesize: Combine both lists, prioritize, mitigate
