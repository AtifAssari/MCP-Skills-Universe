---
title: decontextualize-text
url: https://skills.sh/nesnilnehc/ai-cortex/decontextualize-text
---

# decontextualize-text

skills/nesnilnehc/ai-cortex/decontextualize-text
decontextualize-text
Installation
$ npx skills add https://github.com/nesnilnehc/ai-cortex --skill decontextualize-text
SKILL.md
...
步骤 (Steps)
识别敏感术语：扫描包含内部上下文的公司名称、项目代号、内部 URL、人员姓名、路径字符串和文件/文件夹名称（例如 acme-internal/、team-alpha-output/）。
提取核心逻辑：确定步骤的本质（例如“JIRA批准”→“任务状态变更审核”）。
一般性重写：对已识别的部分使用中性措辞。
