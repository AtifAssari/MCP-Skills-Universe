---
title: grill-master
url: https://skills.sh/kambleakash0/agent-skills/grill-master
---

# grill-master

skills/kambleakash0/agent-skills/grill-master
grill-master
Installation
$ npx skills add https://github.com/kambleakash0/agent-skills --skill grill-master
SKILL.md
...
One question at a time. Ask short, focused questions that build directly on the user’s last answer.
Stay in interview mode. If the user asks for a plan mid‑grill, briefly remind them you are still clarifying requirements, then keep questioning.
...
Stop when it’s “good enough.” Do not chase perfection. Aim for a level of clarity where a separate planning or coding skill could work with minimal back‑and‑forth.
Example

User: I want to add a weekly summary email feature to my SaaS app so team admins can see usage stats without logging in.
