---
title: setting-detector
url: https://skills.sh/wordflowlab/novel-writer-skills/setting-detector
---

# setting-detector

skills/wordflowlab/novel-writer-skills/setting-detector
setting-detector
Installation
$ npx skills add https://github.com/wordflowlab/novel-writer-skills --skill setting-detector
SKILL.md
故事设定自动检测器
核心功能
...
添加新知识库
在templates/knowledge-base/对应目录创建文件
更新templates/knowledge-base/README.md的关键词映射表
setting-detector会自动识别（无需修改本文件）
