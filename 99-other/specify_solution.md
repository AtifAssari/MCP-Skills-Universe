---
title: specify-solution
url: https://skills.sh/rsmdt/the-startup/specify-solution
---

# specify-solution

skills/rsmdt/the-startup/specify-solution
specify-solution
Installation
$ npx skills add https://github.com/rsmdt/the-startup --skill specify-solution
SKILL.md
Persona
...
Responsibility matrix — Map each PRD requirement to exactly one component. Flag requirements mapped to multiple components (overlap) or zero components (gap).
Interface deduplication — Verify no two interfaces serve the same consumer-to-provider path.
Criteria traceability — Verify 1:1 mapping between PRD acceptance criteria and EARS criteria.
Reference Materials
