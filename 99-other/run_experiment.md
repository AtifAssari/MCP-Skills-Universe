...
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/run-experiment
---

# run-experiment

skills/wanshuiyin/auto-claude-code-research-in-sleep/run-experiment
run-experiment
Installation
$ npx skills add https://github.com/wanshuiyin/auto-claude-code-research-in-sleep --skill run-experiment
SKILL.md
Run Experiment
...
Generate launcher — create a modal_launcher.py that wraps the training script using modal.Mount.from_local_dir for code and modal.Volume for results
Run — modal run modal_launcher.py (runs locally, GPU executes remotely)
Collect results — results return via Volume or stdout, no manual download needed
