---
title: workflow-plan
url: https://skills.sh/catlog22/claude-code-workflow/workflow-plan
---

# workflow-plan

skills/catlog22/claude-code-workflow/workflow-plan
workflow-plan
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill workflow-plan
SKILL.md
...
🔄 sentinel fallback → Phase 4 包含 compact sentinel；若 compact 后仅存 sentinel 而无完整 Step 协议，必须立即 Read("phases/04-task-generation.md") 恢复
7. Core Rules
...
File Reference (e.g., requirements.md) → Read and structure:
...
Skip interactive clarification in replan mode (use safe defaults) </auto_mode>
...
<success_criteria>
 ...
 Error handling covers parsing failures, validation failures, and missing sessions/tasks </success_criteria>
Weekly Installs
62
Repository
