---
title: set-note-description
url: https://skills.sh/nweii/agent-stuff/set-note-description
---

# set-note-description

skills/nweii/agent-stuff/set-note-description
set-note-description
Installation
...
Identity & routing (aliases, icon, publish, permalink, url)
Content/classification (tags, description) ← INSERT HERE
People/time/relations (author, members, meeting time, related)
Status/provenance (reviewed, created, modified)
Critical rules
...
Check if the child notes already have description properties in their frontmatter
If they do, synthesize the parent note's summary from those existing summaries rather than re-reading all original content
Create increasingly high-level overviews as you move up the hierarchy:
