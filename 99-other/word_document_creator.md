...
url: https://skills.sh/eddiebe147/claude-settings/word-document-creator
---

# word document creator

skills/eddiebe147/claude-settings/Word Document Creator
Word Document Creator
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Word Document Creator'
SKILL.md
Word Document Creator
...
Import docx library and create Document instance
...
Load template .docx file using pizzip and docxtemplater
