---
title: multiversx-constant-time
url: https://skills.sh/multiversx/mx-ai-skills/multiversx-constant-time
---

# multiversx-constant-time

skills/multiversx/mx-ai-skills/multiversx-constant-time
multiversx-constant-time
Installation
...
7. Key Principles
Prefer VM Functions: self.crypto().* methods are optimized and likely constant-time
Avoid DIY Crypto: Custom implementations are rarely necessary and often wrong
