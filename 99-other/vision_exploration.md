...
url: https://skills.sh/yunshu0909/yunshu_skillshub/vision-exploration
---

# vision-exploration

skills/yunshu0909/yunshu_skillshub/vision-exploration
vision-exploration
Installation
$ npx skills add https://github.com/yunshu0909/yunshu_skillshub --skill vision-exploration
SKILL.md
...
演化路径图 — 从起点到终局的完整链路
终局方案对比 — 每个方案的核心理念、适用场景、信息架构差异
用户偏好 — 用户对哪些方向有感觉（如果已表态）
...
每一步主动推进，不等用户问"下一步呢"
每个关键结论都让用户确认后再往下走
用户说的模糊的话，AI 负责结构化和追问
用户跑偏了（比如太早关注细节），AI 负责拉回来
必须问用户的
时机	问什么
第 1 步	"我理解的对吗？" + 追问价值
第 2 步	"你使用这个功能的场景是什么？"
