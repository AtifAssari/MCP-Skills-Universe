---
title: c4-modeling
url: https://skills.sh/hack23/homepage/c4-modeling
---

# c4-modeling

skills/hack23/homepage/c4-modeling
c4-modeling
Installation
$ npx skills add https://github.com/hack23/homepage --skill c4-modeling
SKILL.md
C4 Model Skill
Purpose
...
Secure Development Policy - Architecture documentation requirements
Information Security Policy - Security architecture
Related Documentation
SECURITY_ARCHITECTURE.md - Security-focused C4 diagrams
security-architecture SKILL.md - Security architecture patterns
documentation-portfolio SKILL.md - Complete documentation set
Tool Support
Mermaid Live Editor
