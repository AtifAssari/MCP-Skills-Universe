---
title: chart
url: https://skills.sh/pvergaraf/chart-skill/chart
---

# chart

skills/pvergaraf/chart-skill/chart
chart
Installation
...
Build the Chart.js configuration using this shadcn-style template. Every Y-axis must have visible ticks — never omit them:
...
Show the result by reading the generated image file with the Read tool
