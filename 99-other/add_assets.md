---
title: add-assets
url: https://skills.sh/opusgamelabs/game-creator/add-assets
---

# add-assets

skills/opusgamelabs/game-creator/add-assets
add-assets
Installation
...
Step 3: Implement
Create src/core/PixelRenderer.js — the renderPixelArt() and renderSpriteSheet() utility functions
Create src/sprites/palette.js — the shared color palette
Create sprite data files in src/sprites/:
