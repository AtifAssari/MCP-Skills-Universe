...
url: https://skills.sh/j5ik2o/okite-ai/repository-design
---

# repository-design

skills/j5ik2o/okite-ai/repository-design
repository-design
Installation
...
チェック手順
リポジトリのインターフェース/トレイトを特定する
命名が 集約名 + Repository であるか確認する
各メソッドがCQSに従っているか確認する
Query: 集約を返す、副作用なし
