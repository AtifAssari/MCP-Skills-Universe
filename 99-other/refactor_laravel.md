---
title: refactor:laravel
url: https://skills.sh/snakeo/claude-debug-and-refactor-skills-plugin/refactor:laravel
---

# refactor:laravel

skills/snakeo/claude-debug-and-refactor-skills-plugin/refactor:laravel
refactor:laravel
Installation
...
DRY (Don't Repeat Yourself): Extract duplicate code into reusable services, traits, or helper methods. If you see the same logic twice, it should be abstracted.
...
Modularity: Organize code into logical namespaces and directories. Related functionality should be grouped together using domain-driven design principles.
