---
title: easysdd-explore
url: https://skills.sh/liuzhengdongfortest/easysdd/easysdd-explore
---

# easysdd-explore

skills/liuzhengdongfortest/easysdd/easysdd-explore
easysdd-explore
Installation
...
用户话里含"更新 / 复查 / 某次 explore / 这个模块之前探过"或明确指向某份旧 explore → 直接走更新或 supersede 路径。explore 的特性是：代码已经变了导致旧结论失效时，旧文档标 status=outdated 并新建一份（supersede）；只是补证据 / 收紧结论但核心结论未变时走"更新已有条目"
