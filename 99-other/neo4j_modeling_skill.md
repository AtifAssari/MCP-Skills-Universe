---
title: neo4j-modeling-skill
url: https://skills.sh/neo4j-contrib/neo4j-skills/neo4j-modeling-skill
---

# neo4j-modeling-skill

skills/neo4j-contrib/neo4j-skills/neo4j-modeling-skill
neo4j-modeling-skill
Installation
...
No generic labels (:Entity, :Node, :Thing); no generic rel types (:RELATED_TO, :HAS)
Rel direction encodes semantic meaning — not arbitrary
Inspect schema before proposing any change on an existing database
All constraint/index DDL uses IF NOT EXISTS — safe to rerun
Key Patterns
