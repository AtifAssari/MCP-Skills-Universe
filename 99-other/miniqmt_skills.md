...
url: https://skills.sh/nnquant/miniqmt-skills/miniqmt-skills
---

# miniqmt-skills

skills/nnquant/miniqmt-skills/miniqmt-skills
miniqmt-skills
Installation
...
安装64位 Python 3.6-3.12
下载并安装 MiniQMT 客户端
安装 xtquant 库：pip install xtquant

第二步：学习基础

阅读 getting_started.md 了解整体架构
运行"快速参考"中的示例1（行情数据获取）
理解数据下载和读取的流程
