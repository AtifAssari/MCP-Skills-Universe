...
url: https://skills.sh/mjunaidca/polymarket-skills/polymarket-monitor
---

# polymarket-monitor

skills/mjunaidca/polymarket-skills/polymarket-monitor
polymarket-monitor
Installation
...
Data Flow
Run polymarket-scanner/scripts/scan_markets.py to find markets and get token IDs
Pass token IDs to monitor_prices.py for multi-market alerting
Or pass a single token ID to watch_market.py for detailed single-market tracking
Monitoring Guide
