---
title: frappe-impl-whitelisted
url: https://skills.sh/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-whitelisted
---

# frappe-impl-whitelisted

skills/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-whitelisted
frappe-impl-whitelisted
Installation
$ npx skills add https://github.com/openaec-foundation/erpnext_anthropic_claude_development_skill_package --skill frappe-impl-whitelisted
SKILL.md
...
ALWAYS check role with frappe.only_for() before using ignore_permissions=True
NEVER expose internal errors — log details, return generic message
NEVER use methods=["GET"] for endpoints that modify data
NEVER trust data dicts from guest APIs — use explicit parameter names
ALWAYS include X-Frappe-CSRF-Token header in fetch() calls from browser
