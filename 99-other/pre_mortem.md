---
title: pre-mortem
url: https://skills.sh/elliotjlt/claude-skill-potions/pre-mortem
---

# pre-mortem

skills/elliotjlt/claude-skill-potions/pre-mortem
pre-mortem
Installation
...
Address HIGH risk mitigations first
Build verification/detection early
Create rollback path before risky changes
Add logging before complex logic
Then proceed with main implementation
