...
url: https://skills.sh/z-soulx/ai-toolkit/markdown-to-pdf
---

# markdown-to-pdf

skills/z-soulx/ai-toolkit/markdown-to-pdf
markdown-to-pdf
Installation
$ npx skills add https://github.com/z-soulx/ai-toolkit --skill markdown-to-pdf
SKILL.md
...
图片处理: 自动检测和转换 WebP 图片,处理无扩展名图片
一键工作流: 从图片处理到 PDF 生成的完整自动化流程
使用方法
方式 1: 基础转换
# 转换单个文件
