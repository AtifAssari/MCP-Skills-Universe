---
title: pnpm
url: https://skills.sh/claude-dev-suite/claude-dev-suite/pnpm
---

# pnpm

skills/claude-dev-suite/claude-dev-suite/pnpm
pnpm
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill pnpm
SKILL.md
