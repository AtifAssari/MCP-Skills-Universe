---
rating: ⭐⭐⭐
title: blitzreels-motion-graphics
url: https://skills.sh/blitzreels/agent-skills/blitzreels-motion-graphics
---

# blitzreels-motion-graphics

skills/blitzreels/agent-skills/blitzreels-motion-graphics
blitzreels-motion-graphics
Installation
...
Browse presets — playground.sh list-presets for inspiration
Build composition spec — JSON describing canvas, elements, and animations
Create composition — playground.sh create
Iterate — Update elements, adjust timing, add animations
Export — playground.sh export
Scripts
