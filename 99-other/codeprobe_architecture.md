---
rating: ⭐⭐
title: codeprobe-architecture
url: https://skills.sh/nishilbhave/codeprobe/codeprobe-architecture
---

# codeprobe-architecture

skills/nishilbhave/codeprobe/codeprobe-architecture
codeprobe-architecture
Installation
...
Read ../codeprobe/shared-preamble.md for the output contract, execution modes, and constraints.
Load applicable reference files from ../codeprobe/references/ based on the project's tech stack.
Default to full mode unless the user specifies otherwise.
