---
title: sketch-image-prompt
url: https://skills.sh/okooo5km/skills4u/sketch-image-prompt
---

# sketch-image-prompt

skills/okooo5km/skills4u/sketch-image-prompt
sketch-image-prompt
Installation
$ npx skills add https://github.com/okooo5km/skills4u --skill sketch-image-prompt
SKILL.md
Sketch Image Prompt
...
配色：背景色（含色号）+ black #000000 主色 + 强调色（如有）

构图与元素：布局方式 + 每个元素的视觉描述 + 连接方式
...
排版：rounded handwritten-style font, casual and friendly
