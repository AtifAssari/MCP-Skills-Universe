---
title: frappe-impl-scheduler
url: https://skills.sh/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-scheduler
---

# frappe-impl-scheduler

skills/openaec-foundation/erpnext_anthropic_claude_development_skill_package/frappe-impl-scheduler
frappe-impl-scheduler
Installation
$ npx skills add https://github.com/openaec-foundation/erpnext_anthropic_claude_development_skill_package --skill frappe-impl-scheduler
SKILL.md
...
ALWAYS bench migrate after hooks.py changes - Required to register events
Jobs run as Administrator - ALWAYS commit explicitly
Commit in batches - NEVER per-record (every 100-500 records)
ALWAYS use job_id for user-triggered jobs - Prevents duplicates
Use enqueue_after_commit=True from document events - Ensures data exists
Scheduler events should be thin - Enqueue heavy work to background
Version Differences
Aspect	v14	v15	v16
