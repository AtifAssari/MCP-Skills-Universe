...
url: https://skills.sh/nickcrew/claude-ctx-plugin/requirements-discovery
---

# requirements-discovery

skills/nickcrew/claude-ctx-plugin/requirements-discovery
requirements-discovery
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill requirements-discovery
SKILL.md
Requirements Discovery
