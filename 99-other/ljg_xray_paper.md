---
title: ljg-xray-paper
url: https://skills.sh/lijigang/ljg-skill-xray-paper/ljg-xray-paper
---

# ljg-xray-paper

skills/lijigang/ljg-skill-xray-paper/ljg-xray-paper
ljg-xray-paper
Installation
$ npx skills add https://github.com/lijigang/ljg-skill-xray-paper --skill ljg-xray-paper
SKILL.md
LJG-Xray-Paper: 论文解读
...
先找一个读者亲身经历过的场景（群聊记录、排队、找路...）
在场景中逐步展开——至少 3 级渐进，让读者在熟悉的事情上"感受到"这个概念在变化
最后才贴技术名字。此时名字是标签，不是定义
...
步骤 5：生成 Org 报告
按 Denote 文件规范（见约束 L0）获取时间戳
文件名：{时间戳}--paper-{简短标题}__read.org
