...
url: https://skills.sh/hungv47/agent-skills/design-user-flow
---

# design-user-flow

skills/hungv47/agent-skills/design-user-flow
design-user-flow
Installation
...
Gather context and understand objectives
Conduct pre-design research (if needed)
Define flow structure and decision points
