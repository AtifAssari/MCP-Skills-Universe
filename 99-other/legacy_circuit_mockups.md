...
url: https://skills.sh/github/awesome-copilot/legacy-circuit-mockups
---

# legacy-circuit-mockups

skills/github/awesome-copilot/legacy-circuit-mockups
legacy-circuit-mockups
Installation
...
Includes step-by-step workflows for common builds: LED circuits, 555 astable oscillators, and full 6502 microcomputer layouts with address/data bus wiring
Bundled reference files provide complete pinout specifications, timing formulas, resistor calculations, and troubleshooting guides for all supported components
SKILL.md
Legacy Circuit Mockups
