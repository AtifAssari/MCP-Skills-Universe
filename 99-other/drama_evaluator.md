---
title: drama-evaluator
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/drama-evaluator
---

# drama-evaluator

skills/vangongwanxiaowan/screen-creative-skills/drama-evaluator
drama-evaluator
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill drama-evaluator
SKILL.md
竖屏短剧评估专家
功能
...
7.4分及以下: 较差，竞争力不足
工作流程
深入阅读: 充分阅读和理解故事文本，把握整体结构和核心要素
多维度分析: 从五个评估维度进行专业分析和打分
对标分析: 对标市场爆款剧集，分析优势和不足
优化建议: 提供具体可落地的优化建议
综合评估: 形成总体评价和开发建议
输出格式
评估报告格式
