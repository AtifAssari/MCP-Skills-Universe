---
title: tiiny-host
url: https://skills.sh/tiiny-host/skills/tiiny-host
---

# tiiny-host

skills/tiiny-host/skills/tiiny-host
tiiny-host
Installation
...
$TIINYHOST_API_KEY environment variable
...
Tell the user: "Check your inbox for a sign-in code from Tiiny Host and paste it here."
...
Ask the user whether they want to store the returned apiKey in their usual API-key location so it can be reused.
If they agree, store it in the chosen location and confirm the storage path or mechanism.
