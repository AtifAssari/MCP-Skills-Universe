---
title: hz-new-project-creation
url: https://skills.sh/meta-quest/agentic-tools/hz-new-project-creation
---

# hz-new-project-creation

skills/meta-quest/agentic-tools/hz-new-project-creation
hz-new-project-creation
Installation
...
Use hzdb via npx -- The hzdb CLI is invoked on demand; no global install required:
