---
title: ljg-xray-book
url: https://skills.sh/lijigang/ljg-skill-xray-book/ljg-xray-book
---

# ljg-xray-book

skills/lijigang/ljg-skill-xray-book/ljg-xray-book
ljg-xray-book
Installation
$ npx skills add https://github.com/lijigang/ljg-skill-xray-book --skill ljg-xray-book
SKILL.md
LJG-Xray-Book: 深度拆书机
...
步骤 5：保存并打开
生成时间戳：使用 Bash 执行 date +%Y%m%dT%H%M%S 获取当前时间
文件名格式：{时间戳}--{书名}__book.org
书名：中文保留，英文小写，空格转连字符
示例：20260207T220000--思考快与慢__book.org
保存路径：~/Documents/notes/{文件名}
使用 Bash 执行：open ~/Documents/notes/{文件名}
输出质量标准
