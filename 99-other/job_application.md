...
url: https://skills.sh/skillcreatorai/ai-agent-skills/job-application
---

# job-application

skills/skillcreatorai/ai-agent-skills/job-application
job-application
Installation
$ npx skills add https://github.com/skillcreatorai/ai-agent-skills --skill job-application
SKILL.md
...
Say: "Write a cover letter for this"
