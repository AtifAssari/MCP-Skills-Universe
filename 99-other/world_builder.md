---
title: world-builder
url: https://skills.sh/charlie85270/dorothy/world-builder
---

# world-builder

skills/charlie85270/dorothy/world-builder
world-builder
Installation
$ npx skills add https://github.com/charlie85270/dorothy --skill world-builder
SKILL.md
World Builder Skill
...
Required Elements
ROUTE_EXIT tiles (10) — At least 2-3 exit tiles at a map edge so the player can leave
playerStart — Must be on a walkable tile, near the zone entrance
Boundary — Use TREE, WATER, or FENCE tiles to define map edges (doesn't have to be a uniform border — can be irregular, thematic)
...
Use the socialdata MCP tools to fetch actual tweets, profile info, and engagement data:
...
Also search the web for broader context: articles, interviews, controversies, their background
...
Named Characters (path format: /pokemon/pnj/<name>.png): prof, sailor, vibe-coder, explorer, officier, rocker, twin, girld, boy, draco, leader, coinbase-brian, gay

Anime Characters (path format: /pokemon/pnj/anime-<name>.png): anime-brock, anime-misty, anime-gary-oak, anime-jessie, anime-james, anime-meowth, anime-officer-jenny, anime-prof-ivy, anime-sabrina, anime-samuel-oak, anime-samurai, anime-tracy, anime-lorelei, anime-bruno, anime-brockfather, anime-butch, anime-cassidy, anime-delia-ketchum, anime-blaine-in-disguise, anime-salesman

47 generic anime NPCs: anime-npc-01 through anime-npc-47

Trainer Types (path format: /pokemon/pnj/trainer_<TYPE>.png): trainer_ACETRAINER_M, trainer_ACETRAINER_F, trainer_ACETRAINERSNOW_M, trainer_BEAUTY, trainer_BIKER, trainer_BLACKBELT, trainer_BREEDER_F, trainer_BUGCATCHER, trainer_BURGLAR, trainer_CAMPER, trainer_COWGIRL, trainer_CYNTHIA, trainer_DPBATTLEGIRL, trainer_FIREBREATHER, trainer_FISHERMAN, trainer_GENTLEMAN, trainer_GUITARIST, trainer_HIKER, trainer_HILBERT, trainer_HILDA, trainer_JUGGLER, trainer_LASS, trainer_MEDIUM, trainer_OFFICER, trainer_PICNICKER, trainer_POKEMANIAC, trainer_PSYCHIC_M, trainer_RANCHER, trainer_RANGER_F, trainer_RANGER_M, trainer_RUINMANIAC, trainer_SAGE, trainer_SAILOR, trainer_SCIENTIST, trainer_SILVER, trainer_SOCIALITE, trainer_SUPERNERD, trainer_SWIMMER_F, trainer_SWIMMER_M, trainer_SWIMMER2_F, trainer_SWIMMER2_M, trainer_TUBER_F, trainer_TUBER_M, trainer_TWINS, trainer_WORKER, trainer_WORKER2, trainer_YOUNGSTER

Generic NPCs (path format: /pokemon/pnj/NPC_<Name>.png or /pokemon/pnj/npc-<name>.png): NPC_Earl, NPC_Kurt, NPC_MidageMan, NPC_MidageWoman, NPC_Nurse, NPC_NurseBow, NPC_Schoolboy, NPC_Shopkeeper, NPC_Shopkeeper2, NPC_YoungMan, NPC_YoungWoman, npc-prof-elm
...
list_sprites (1 call)
Data gathering — up to 6 calls (socialdata profile, tweet searches, web searches)
create_zone (1 call)
Done. Exit. Do not continue chatting.
...
Workflow
Gather data — Up to 6 tool calls. Use socialdata AND web search to get rich content. More data = better world. But stop at 6 and start building.
Call list_sprites once — Pick exact paths from the catalog. NEVER guess paths.
Design with intention — Choose a map shape and layout that embodies the theme, not just decorates it
Build the tilemap — Use terrain creatively. Draw logos/symbols with flower tiles. Every zone should look different.
Place NPCs — 3–10 NPCs with dialogue that reflects the source material. Every NPC MUST have a valid spritePath from the catalog.
Add buildings with interiors — 2–5 buildings with thematic labels. Add interiors for at least the 2 most important buildings.
Add signs and graves — Flavor text that enriches the world
Call create_zone with everything in one shot (including interiors)
STOP. The zone is done. Do not continue.
Key Tips
...
list_sprites — call once to get the sprite catalog
Gather data (up to 6 tool calls): Use socialdata for profile + tweets, web search for broader context. More content = richer world.
Design a zone that embodies the data — not just references it
Include interiors for main buildings with interior NPCs that add story depth
create_zone — one call with everything (tilemap + NPCs + buildings + interiors)
STOP. The zone appears in-game within seconds via live file watching. Do not continue.
