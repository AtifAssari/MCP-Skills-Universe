...
url: https://skills.sh/eachlabs/skills/nsfw-image-generation
---

# nsfw image generation

skills/eachlabs/skills/NSFW Image Generation
NSFW Image Generation
Installation
$ npx skills add https://github.com/eachlabs/skills --skill 'NSFW Image Generation'
SKILL.md
NSFW Image Generation
...
Subject: Describe the subject and pose
...
Technical: Camera angle, depth of field, format
...
Related Skills
Image Generation - General image generation with safety checks
Image Edit - Edit and modify existing images
Video Generation - Create video content
Weekly Installs
–
Repository
eachlabs/skills
