---
title: create-prd
url: https://skills.sh/pmyangkun/create-prd-skill/create-prd
---

# create-prd

skills/pmyangkun/create-prd-skill/create-prd
create-prd
Installation
$ npx skills add https://github.com/pmyangkun/create-prd-skill --skill create-prd
SKILL.md
create-prd
...
区分产品类型：商业化产品与企业自研系统的内容侧重点不同，严格按照产品定型结果调整。
理论框架外显：在关键章节中，用简短提示说明所使用的方法论框架，帮助用户理解设计依据。
结构化优先：表格、列表、Mermaid 图表优先于大段叙述。
图表使用 Mermaid：架构图、流程图、状态机、ER 模型等全部使用 Mermaid 代码块生成，不使用 ASCII 伪图。
图表生成规则

第10章产品框架概述中，以下图表必须使用 Mermaid 语法：
