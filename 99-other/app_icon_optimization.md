...
url: https://skills.sh/eronred/aso-skills/app-icon-optimization
---

# app-icon-optimization

skills/eronred/aso-skills/app-icon-optimization
app-icon-optimization
Installation
$ npx skills add https://github.com/eronred/aso-skills --skill app-icon-optimization
SKILL.md
App Icon Optimization
