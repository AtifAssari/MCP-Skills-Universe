...
rating: ⭐⭐⭐
title: antd
url: https://skills.sh/ant-design/ant-design-cli/antd
---

# antd

skills/ant-design/ant-design-cli/antd
antd
Installation
...
Match the user's version — If the project uses antd 3.x or 4.x, pass --version 3.26.0 or --version 4.24.0. The CLI auto-detects from node_modules if no flag is given.
...
Report antd bugs — When the user asks to report an antd bug, use antd bug. Always preview first, get user confirmation, then submit.
Report CLI issues — When the user asks about a CLI problem, use antd bug-cli to help them file a report. Always preview first, get user confirmation, then submit.
Weekly Installs
1.1K
Repository
ant-design/ant-…sign-cli
GitHub Stars
197
First Seen
Mar 24, 2026
