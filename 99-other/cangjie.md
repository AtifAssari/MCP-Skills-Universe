---
title: cangjie
url: https://skills.sh/yeadon8888/cangjie-skill/cangjie
---

# cangjie

skills/yeadon8888/cangjie-skill/cangjie
cangjie
Installation
$ npx skills add https://github.com/yeadon8888/cangjie-skill --skill cangjie
SKILL.md
仓颉 · 认知植入术
...
写入提取记录：按 research-guide.md 中的文件格式规范，写入 references/research/02-extraction-notes.md。每条提取标注优先级、原文出处和提取类型。
