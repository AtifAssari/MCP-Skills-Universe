---
title: wiki-init
url: https://skills.sh/kfchou/wiki-skills/wiki-init
---

# wiki-init

skills/kfchou/wiki-skills/wiki-init
wiki-init
Installation
$ npx skills add https://github.com/kfchou/wiki-skills --skill wiki-init
SKILL.md
Wiki Init
...
Where should the wiki live? (absolute path, e.g. ~/wikis/ml-research)
What is the domain/purpose? (one sentence)
What types of sources will you add? (papers, URLs, code files, transcripts, etc.)
What categories should index.md use?
...
[[attention-is-all-you-need]] §3.2.2 — "We employ h = 8 parallel attention layers" ↩

[[attention-is-all-you-need]] §3.2-3.4 [synthesis] — encoder, decoder, and attention sections together describe the full multi-head architecture ↩
