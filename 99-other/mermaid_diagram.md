...
url: https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/mermaid-diagram
---

# mermaid-diagram

skills/wanshuiyin/auto-claude-code-research-in-sleep/mermaid-diagram
mermaid-diagram
Installation
...
Fix the syntax issue in both .mmd and .md files
Re-run verification
...
Use \text{} for non-math text inside a $$ block:
