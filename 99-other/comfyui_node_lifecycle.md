---
title: comfyui-node-lifecycle
url: https://skills.sh/jtydhr88/comfyui-custom-node-skills/comfyui-node-lifecycle
---

# comfyui-node-lifecycle

skills/jtydhr88/comfyui-custom-node-skills/comfyui-node-lifecycle
comfyui-node-lifecycle
Installation
...
Identifies output nodes (is_output_node=True)
