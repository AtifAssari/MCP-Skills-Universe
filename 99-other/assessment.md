---
title: assessment
url: https://skills.sh/borisghidaglia/science-based-lifter/assessment
---

# assessment

skills/borisghidaglia/science-based-lifter/assessment
assessment
Installation
...
Read ../rp-training/references/07-individualization.md → Extract individual factors: work capacity, recovery ability, training age, biological age, lifestyle (sleep, stress, nutrition), diet phase

Read ../schoenfeld-hypertrophy/references/07-individual-factors.md → Extract individual factors: genetics, training status, age considerations, sex differences, muscle memory

Read ../rp-diet/references/10-designing-your-diet.md → Extract: activity level classification (non-training/light/moderate/hard), weight for calorie calculations

Read ../rp-diet/references/07-diet-adherence.md → Extract: adherence factors, hunger tolerance, deficit/surplus sustainability, schedule stability

Read ../sbs-training/SKILL.md → Extract: SBS program catalog, decision guide for matching users to the right autoregulated program (novice vs intermediate, strength vs hypertrophy, autoregulation preference)
