---
title: session4-polish
url: https://skills.sh/rich00lee/liveklass-ai-native-camp/session4-polish
---

# session4-polish

skills/rich00lee/liveklass-ai-native-camp/session4-polish
session4-polish
Installation
$ npx skills add https://github.com/rich00lee/liveklass-ai-native-camp --skill session4-polish
SKILL.md
...
핵심 금지 사항 (절대 위반 금지)
Phase A에서 AskUserQuestion을 호출하지 않는다 (Block 0 제외) — Block 0은 개선할 Skill 선택이 필수이므로 예외
...
Block 0의 Phase A는 AskUserQuestion을 사용한다. 개선할 Skill 선택이 이후 모든 블록의 전제 조건이므로 반드시 사용자 입력을 받아야 한다.

Phase A 진행 순서:

references/block0-review.md의 EXPLAIN 섹션을 읽고 설명한다
AskUserQuestion으로 가장 먼저 개선하고 싶은 포인트를 선택받는다
선택된 포인트의 개선 방향을 정리하여 보여준다
Stop한다
References 파일 맵
블록	파일	내용
