---
title: lyric-diagnostic
url: https://skills.sh/jwynia/agent-skills/lyric-diagnostic
---

# lyric-diagnostic

skills/jwynia/agent-skills/lyric-diagnostic
lyric-diagnostic
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill lyric-diagnostic
SKILL.md
...
Lines 1-2: Model has freedom, may find something interesting
Lines 3+: Rhyme constraint activates, model optimizes for completion over originality
By verse 2: Fully in statistical default mode—stock phrases, lazy rhyme clusters
...
Generate hook/title concepts (no full lyrics)
Generate verse 1 alone (no chorus yet)
Generate chorus treating verse 1 as context
Generate verse 2 with explicit differentiation requirement
Generate bridge with perspective shift requirement
