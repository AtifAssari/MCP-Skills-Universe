---
title: minimax-usage
url: https://skills.sh/nmvr2600/minimax-token-plan-skills/minimax-usage
---

# minimax-usage

skills/nmvr2600/minimax-token-plan-skills/minimax-usage
minimax-usage
Installation
$ npx skills add https://github.com/nmvr2600/minimax-token-plan-skills --skill minimax-usage
SKILL.md
MiniMax Usage Query
...
Resets In	配额重置倒计时
注意事项
额度周期：MiniMax 配额按自然月重置，非购买日起算
多模型配额：不同模型可能有独立的配额限制
缓存延迟：API 返回的数据可能有短暂延迟（通常 < 5 分钟）
Weekly Installs
14
Repository
