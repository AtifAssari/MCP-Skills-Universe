...
url: https://skills.sh/deanpeters/product-manager-skills/user-story-splitting
---

# user-story-splitting

skills/deanpeters/product-manager-skills/user-story-splitting
user-story-splitting
Installation
...
"As a user, I want to verify my email via a confirmation link"
"As a user, I want to complete onboarding by answering 3 profile questions"
...
Split:
"As a member, I want to apply a 10% discount at checkout"
"As a VIP, I want to apply a 20% discount at checkout"
"As a first-time buyer, I want to apply a 5% discount at checkout"
...
Split:
"As a user, I want to upload image files (JPG, PNG)"
"As a user, I want to upload PDF documents"
"As a user, I want to upload video files (MP4, MOV)"
...
"As a user, I want to remove items from my cart so I can change my mind"
"As a user, I want to update item quantities so I can buy the right amount"
...
Split:
"As a user, I want to see who else is viewing the document (read-only presence)"
"As a user, I want to see live cursor positions of other editors"
"As a user, I want to see live edits from other users in real-time"
...
"As a user, I want to log in with Facebook OAuth"
"As a user, I want to log in with Twitter OAuth"
...
Split:
"As a user, I want to upload small files (<10MB) to cloud storage"
"As a user, I want to upload large files (10MB-1GB) with progress tracking"
"As a user, I want to resume interrupted uploads"
...
TADs:
Prototype 3 recommendation algorithms and test with 10 users
Define success criteria (click-through rate, user satisfaction)
Build the simplest recommendation engine (collaborative filtering)
Measure and iterate
...
Does each split deliver user value? (Not just "front-end done")
Can each split be developed independently? (No hard dependencies)
Can each split be tested independently? (Clear acceptance criteria)
Is each split small enough for a sprint? (1-5 days of work)
Do the splits, when combined, equal the original? (Nothing lost in translation)
