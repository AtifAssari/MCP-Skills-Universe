...
url: https://skills.sh/jwynia/agent-skills/dna-extraction
---

# dna-extraction

skills/jwynia/agent-skills/dna-extraction
dna-extraction
Installation
...
Check for dna-library/ in the project
If not found, ask: "Where should I save extraction output? Suggest: dna-library/extractions/"
Store preference in context/output-config.md if context network exists
Primary Output
