---
title: streamlit
url: https://skills.sh/silvainfm/claude-skills/streamlit
---

# streamlit

skills/silvainfm/claude-skills/streamlit
streamlit
Installation
...
Best Practices
Use caching - Cache expensive operations with @st.cache_data and @st.cache_resource
Session state for persistence - Use st.session_state to persist data across reruns
...
Wide layout for dashboards - Use st.set_page_config(layout="wide") for dashboards
