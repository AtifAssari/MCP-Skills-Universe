---
title: ppw:visualization
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:visualization
---

# ppw:visualization

skills/lylll9436/paper-polish-workflow-skill/ppw:visualization
ppw:visualization
Installation
...
Data description: What is the data? (data type, key variables, spatial or non-spatial, sample size if relevant) — ask if not included in the trigger.
Research question for this figure: What should the chart communicate? (e.g., distribution, comparison, trend, spatial pattern, correlation) — ask if not included in the trigger.
...
Skill: visualization-skill Conventions: references/skill-conventions.md
