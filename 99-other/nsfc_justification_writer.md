---
title: nsfc-justification-writer
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-justification-writer
---

# nsfc-justification-writer

skills/huangwb8/chineseresearchlatex/nsfc-justification-writer
nsfc-justification-writer
Installation
$ npx skills add https://github.com/huangwb8/chineseresearchlatex --skill nsfc-justification-writer
SKILL.md
科研立项依据写作器
...
定位项目与目标文件。
抽取现有小标题骨架与正文范围。
用 scripts/run.py coach --stage auto 判断当前处于 skeleton / draft / revise / polish 哪一阶段。
围绕 4 段闭环组织内容：
价值与必要性
现状与不足
科学问题 / 科学假设
