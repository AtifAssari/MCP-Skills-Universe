---
title: midjourney-card-news-backgrounds
url: https://skills.sh/bear2u/my-skills/midjourney-card-news-backgrounds
---

# midjourney-card-news-backgrounds

skills/bear2u/my-skills/midjourney-card-news-backgrounds
midjourney-card-news-backgrounds
Installation
$ npx skills add https://github.com/bear2u/my-skills --skill midjourney-card-news-backgrounds
SKILL.md
...
Core Workflow
Identify the topic: Extract the main subject from user's request
Determine style category: Match to predefined style patterns
Generate prompt: Create Midjourney prompt with optimal parameters
Provide variations: Offer 3-5 different style options
Prompt Structure
...
Primary prompt: The most suitable style
Alternative 1: Different mood/style for same topic
Alternative 2: Another variation
Brief explanation: Why these styles work for the topic
