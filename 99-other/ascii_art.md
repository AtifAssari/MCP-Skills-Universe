---
title: ascii-art
url: https://skills.sh/neethanwu/ascii-art/ascii-art
---

# ascii-art

skills/neethanwu/ascii-art/ascii-art
ascii-art
Installation
...
Input Detection
File path → check extension: .jpg/.jpeg/.png/.webp/.bmp/.tiff → image, .mp4/.webm/.avi/.mov/.mkv → video, .gif → check if animated (video) or static (image)
...
Round 2 (only if export is interactive or tsx): Mouse Mode → Animation
