---
title: ctf misc solver
url: https://skills.sh/tokeii0/ctfskill/ctf-misc-solver
---

# ctf misc solver

skills/tokeii0/ctfskill/CTF Misc Solver
CTF Misc Solver
Installation
...
🚨 重要约束
Flag 格式 通常为 flag{...}, ctfshow{...}, XXX{...} - 在输出中优先匹配这些模式
