---
title: peyton-jones-practical-haskell
url: https://skills.sh/copyleftdev/sk1llz/peyton-jones-practical-haskell
---

# peyton-jones-practical-haskell

skills/copyleftdev/sk1llz/peyton-jones-practical-haskell
peyton-jones-practical-haskell
Installation
...
Laziness by Default: Evaluate only what's needed, when it's needed.

Purity Enables Optimization: The compiler can transform pure code freely.

Types Prevent Bugs: Strong static typing catches errors at compile time.

Understand the Runtime: Know how your code executes to write it well.
...
What gets evaluated when? Understand lazy vs strict
Where are the thunks? Potential space leaks
Will this fuse? Intermediate structures eliminated?
What does Core look like? The ground truth
Is this inlined? Key for performance
Signature SPJ Moves
