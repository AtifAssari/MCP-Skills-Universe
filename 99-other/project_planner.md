...
url: https://skills.sh/jmsktm/claude-settings/project-planner
---

# project planner

skills/jmsktm/claude-settings/Project Planner
Project Planner
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Project Planner'
SKILL.md
Project Planner
