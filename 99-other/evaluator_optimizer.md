...
url: https://skills.sh/nickcrew/claude-ctx-plugin/evaluator-optimizer
---

# evaluator-optimizer

skills/nickcrew/claude-ctx-plugin/evaluator-optimizer
evaluator-optimizer
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill evaluator-optimizer
SKILL.md
Evaluator-Optimizer
