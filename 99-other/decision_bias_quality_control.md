---
title: decision-bias-quality-control
url: https://skills.sh/timlai666/skills/decision-bias-quality-control
---

# decision-bias-quality-control

skills/timlai666/skills/decision-bias-quality-control
decision-bias-quality-control
Installation
$ npx skills add https://github.com/timlai666/skills --skill decision-bias-quality-control
SKILL.md
Decision Bias Quality Control
Overview
...
核心原則與來源：references/01-source-principles.md
12 問題庫：references/02-12-question-bank.md
三種模式流程：references/03-mode-workflows.md
評分與門檻：references/04-scoring-thresholds.md
統一輸出模板：references/05-output-templates.md
Input Contract
...
依 references/04-scoring-thresholds.md 計算，使用固定模型：
...
Execution Workflow
確認模式與決策邊界。
進行 Data Sufficiency Gate。
逐題執行 12 問，收集證據與評分。
計算分組分數、總分、風險等級。
輸出雙軌結果與 mode-specific 結論。
附上「下一步驗證行動」與「可逆/不可逆提醒」。
...
詳見 references/03-mode-workflows.md。
