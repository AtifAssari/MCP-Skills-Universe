---
rating: ⭐⭐⭐
title: human-architect-mindset
url: https://skills.sh/bencium/bencium-marketplace/human-architect-mindset
---

# human-architect-mindset

skills/bencium/bencium-marketplace/human-architect-mindset
human-architect-mindset
Installation
...
Navigate corporate reality - Politics, approvals, relationships
Prevent system collapse - Systems thinking across boundaries
Make value judgments - Tradeoffs, priorities, ethics
...
Deviations are visible - Any human edit stands out
Patterns are learnable - AI can predict what should exist
Verification is automatable - Constitution violations are detectable
Technical debt is measurable - Deviations from spec are countable
...
Constitution defines immutable rules
Blueprint captures complete intent
Tasks cover 100% of specifications (traceability matrix)
Each task is atomic and verifiable
Dependencies are explicit (no missing imports)
