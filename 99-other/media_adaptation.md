...
url: https://skills.sh/jwynia/agent-skills/media-adaptation
---

# media-adaptation

skills/jwynia/agent-skills/media-adaptation
media-adaptation
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill media-adaptation
SKILL.md
Media Adaptation
Purpose
...
Maintain the underlying function
Create new forms that serve the same story purpose
Ensure replacements emerge logically from new setting
Test that replacements generate similar emotional responses
Phase 3: Systemic Translation
Environmental Pressure Analysis
Identify survival/social pressures in original
Map equivalent pressures in new environment
Trace how new pressures modify social structures
Identify new conflict opportunities
Power Structure Evolution
List all sources of power/influence in original
For each, identify underlying principle (competence, resources, legitimacy)
Create equivalents operating on same principles
Consider entirely new power sources from new setting
Conflict Evolution Mapping
Map conflict resolution barriers in original
Identify which barriers persist in new setting
Determine how new elements create new barriers
Discover how new elements provide new solution paths
