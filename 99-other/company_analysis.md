...
url: https://skills.sh/sixtysecondsapp/use60/company-analysis
---

# company analysis

skills/sixtysecondsapp/use60/Company Analysis
Company Analysis
Installation
...
"[Company Name]" company about -- official site, Wikipedia, Crunchbase
"[Company Name]" product OR platform OR pricing -- what they sell and how
"[Company Name]" funding OR investors OR Crunchbase OR valuation -- financial context
"[Company Name]" news OR announcement OR launch 2025 OR 2026 -- recent activity
"[Company Name]" competitors OR alternative OR "compared to" -- competitive landscape
"[Company Name]" careers OR hiring OR jobs -- growth signals and tech stack
"[Company Name]" review G2 OR Capterra OR Trustpilot -- market reputation
...
Interpret the fact -- what does it mean?
Connect to sales implication -- why does this matter for selling to them?
...
Direct competitors: Companies selling the same thing to the same buyers
Adjacent competitors: Companies solving adjacent problems that could expand into this space
Upstream/downstream players: Companies in the value chain that may integrate or compete
...
Pain proximity: They personally feel the problem that ${company_name}'s product solves
Budget influence: They can either approve spending or champion it to someone who can
Accessibility: They're reachable (not behind layers of gatekeepers)
Openness: Something has recently changed that makes them receptive (new role, new mandate, new challenge)
...
If company_website or industry is provided, use those to disambiguate
If not, search for "[Company Name]" [any contextual clues from the conversation]
If still ambiguous, present the top 2-3 matches with distinguishing details and ask: "I found multiple companies named [Name]. Which one? [Company A - SaaS in Austin, TX, 200 employees] or [Company B - consulting firm in London, 50 employees]?"
