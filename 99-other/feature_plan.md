---
title: feature-plan
url: https://skills.sh/orziz/aiskills/feature-plan
---

# feature-plan

skills/orziz/aiskills/feature-plan
feature-plan
Installation
...
若规格已经稳定，但用户可见行为、状态体验、页面流程或验收口径仍然说不清，要明确把问题压给 design-spec 做 BDD 层收口。
命中附件、低信息输入、步进式提问或候选方案扩展时，读 references/planning-playbook.md；命中 bug、输出策略或交付边界时，读 references/delivery-playbook.md。
理解、校准与扩展
