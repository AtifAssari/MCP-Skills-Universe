---
title: wiki-query
url: https://skills.sh/djalmajr/essential-skills/wiki-query
---

# wiki-query

skills/djalmajr/essential-skills/wiki-query
wiki-query
Installation
$ npx skills add https://github.com/djalmajr/essential-skills --skill wiki-query
SKILL.md
...
Plan the search — turn the user's question into a structured query document. Always provide an intent: line so reranking and snippet extraction stay anchored to the actual goal:
...
CLI: qmd query "$(cat <<EOF intent: ... lex: ... vec: ... hyde: ... EOF )" --json --files -n 8 --min-score 0.3
