---
title: note-outline-checklist
url: https://skills.sh/z-soulx/ai-toolkit/note-outline-checklist
---

# note-outline-checklist

skills/z-soulx/ai-toolkit/note-outline-checklist
note-outline-checklist
Installation
$ npx skills add https://github.com/z-soulx/ai-toolkit --skill note-outline-checklist
SKILL.md
...
生成 -待整理.md 框架内容，放在 target_file 同级目录
框架文件必须：
顶部元信息（源文件、范围、规则）
主体：新大纲结构（含引导注释）
