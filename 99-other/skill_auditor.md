---
title: skill-auditor
url: https://skills.sh/petekp/claude-code-setup/skill-auditor
---

# skill-auditor

skills/petekp/claude-code-setup/skill-auditor
skill-auditor
Installation
...
Project skills: ./skills/*/SKILL.md or ./.claude/skills/*/SKILL.md
...
Missing meta-skill: Is there a skill for creating/improving skills? (skill-creator)
Missing checkpoint skill: Is there a way to pause and assess? (checkpoint)
Missing handoff skill: Can sessions be continued? (bootstrap)
Missing review skills: Are there skills for quality gates? (code review, design critique)
Running the Audit
...
Read each SKILL.md frontmatter and assess
Check for reference/script directories
Compile findings into report format above
When to Audit
