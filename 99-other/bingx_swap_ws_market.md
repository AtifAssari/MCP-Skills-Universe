---
title: bingx-swap-ws-market
url: https://skills.sh/bingx-api/api-ai-skills/bingx-swap-ws-market
---

# bingx-swap-ws-market

skills/bingx-api/api-ai-skills/bingx-swap-ws-market
bingx-swap-ws-market
Installation
...
CONSTRAINT: You MUST copy the connectSwapWsMarket function below verbatim when generating code. Do NOT rewrite the WebSocket or decompression logic. Only modify: (1) subscription channels passed to the function.
