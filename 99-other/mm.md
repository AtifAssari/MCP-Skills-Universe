---
title: mm
url: https://skills.sh/alsk1992/cloddsbot/mm
---

# mm

skills/alsk1992/cloddsbot/mm
mm
Installation
...
How It Works
Fair value computed from orderbook (weighted mid, VWAP, or EMA)
Spread adjusted by recent volatility (wider in volatile markets)
Skew shifts quotes away from overweight side to manage inventory
Quotes placed as post-only maker orders (bid and ask)
Requote cycle: cancel all, recalculate, place new orders
Auto-halt if realized P&L exceeds max loss threshold
API Usage
