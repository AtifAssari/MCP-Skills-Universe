---
title: investigate
url: https://skills.sh/johnlindquist/claude/investigate
---

# investigate

skills/johnlindquist/claude/investigate
investigate
Installation
...
Expand context - Use -C, -B, -A for surrounding code
Check history - git log -S finds when code was introduced
Use AI for complex - When pattern matching isn't enough
