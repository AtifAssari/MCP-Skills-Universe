---
title: excel-parser
url: https://skills.sh/harryoung/efka/excel-parser
---

# excel-parser

skills/harryoung/efka/excel-parser
excel-parser
Installation
...
Metadata Scanning - Use openpyxl to scan file structure without loading data
Complexity Scoring - Calculate score based on merged cells, row count, and layout
