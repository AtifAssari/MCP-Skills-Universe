---
title: secondme
url: https://skills.sh/mindverse/second-me-skills/secondme
---

# secondme

skills/mindverse/second-me-skills/secondme
secondme
Installation
...
Read ~/.secondme/credentials
If not found, fall back to ~/.openclaw/.credentials (legacy path)
If either contains valid JSON with accessToken, continue
If it only contains legacy access_token, continue, but normalize future writes to accessToken
If both files are missing, empty, or invalid, start the login flow in this same skill
