---
title: uniappx-project
url: https://skills.sh/teachingai/full-stack-skills/uniappx-project
---

# uniappx-project

skills/teachingai/full-stack-skills/uniappx-project
uniappx-project
Installation
$ npx skills add https://github.com/teachingai/full-stack-skills --skill uniappx-project
SKILL.md
...
Use conditional compilation: Use #ifdef/#endif for platform-specific logic.
Keep examples aligned: Use the official documentation examples as the source of truth.
Prefer references for specs: Use references/ for full parameter tables and compatibility.
Resources
