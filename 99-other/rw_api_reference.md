...
url: https://skills.sh/runwayml/skills/rw-api-reference
---

# rw-api-reference

skills/runwayml/skills/rw-api-reference
rw-api-reference
Installation
...
Submit — POST /v1/<endpoint> → returns { "id": "task_xxx" }
Poll — GET /v1/tasks/{id} → returns task with status
Retrieve output — When status === "SUCCEEDED", the output array contains signed URLs
Task Statuses
Status	Meaning
