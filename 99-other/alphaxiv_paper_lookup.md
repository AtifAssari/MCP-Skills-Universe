...
url: https://skills.sh/mhliulgy/my-skills/alphaxiv-paper-lookup
---

# alphaxiv-paper-lookup

skills/mhliulgy/my-skills/alphaxiv-paper-lookup
alphaxiv-paper-lookup
Installation
$ npx skills add https://github.com/mhliulgy/my-skills --skill alphaxiv-paper-lookup
SKILL.md
AlphaXiv Paper Lookup
