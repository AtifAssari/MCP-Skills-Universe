---
rating: ⭐⭐
title: litestar-lifecycle-hooks
url: https://skills.sh/alti3/litestar-skills/litestar-lifecycle-hooks
---

# litestar-lifecycle-hooks

skills/alti3/litestar-skills/litestar-lifecycle-hooks
litestar-lifecycle-hooks
Installation
...
Execution Workflow
Decide which stage matches the requirement: before_request, after_request, or after_response (the exact lifecycle stage needed for behavior injection).
Choose the layer intentionally: app, router, controller, or handler (the layer to place the hook in).
...
For exact hook semantics, short-circuit behavior, handler-to-response boundaries, and layered precedence, read references/request-response-hooks.md.
For deciding between lifecycle hooks and middleware, including exception-path and ASGI-boundary differences, read references/hook-vs-middleware.md.
Hook Semantics
before_request
