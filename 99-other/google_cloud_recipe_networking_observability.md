---
rating: ⭐⭐
title: google-cloud-recipe-networking-observability
url: https://skills.sh/google/skills/google-cloud-recipe-networking-observability
---

# google-cloud-recipe-networking-observability

skills/google/skills/google-cloud-recipe-networking-observability
google-cloud-recipe-networking-observability
Installation
$ npx skills add https://github.com/google/skills --skill google-cloud-recipe-networking-observability
SKILL.md
...
Search Cloud Logging MCP for the resource name to find correct labels.
...
Validate Schema: Run bq show --schema --format=json {project_id}:{dataset_id}.{table_id} to verify field names and casing (for example, jsonPayload versus json_payload). 2. Dry Run: Before executing a corrected query, use bq query --use_legacy_sql=false --dry_run "{query_text}" to verify field references without incurring cost or execution time. 3. Retry: Apply identified fixes to the original query and execute.
