---
title: ai-drawio
url: https://skills.sh/gbsoss/ai-drawio/ai-drawio
---

# ai-drawio

skills/gbsoss/ai-drawio/ai-drawio
ai-drawio
Installation
$ npx skills add https://github.com/gbsoss/ai-drawio --skill ai-drawio
SKILL.md
...
Start a local HTTP server: python -m http.server 8765
Use browser automation tools to open the file:
