...
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/file-reference
---

# file-reference

skills/vangongwanxiaowan/screen-creative-skills/file-reference
file-reference
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill file-reference
SKILL.md
文件引用解析专家
功能
