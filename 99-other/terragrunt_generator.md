...
url: https://skills.sh/akin-ozer/cc-devops-skills/terragrunt-generator
---

# terragrunt-generator

skills/akin-ozer/cc-devops-skills/terragrunt-generator
terragrunt-generator
Installation
...
State key uses path_relative_to_include() - This automatically includes environment path
...
Before generating, READ these files in order:
 ...
 ../terragrunt-validator/references/best_practices.md - Know the rules
 Relevant template(s) from assets/templates/ - Structural reference
