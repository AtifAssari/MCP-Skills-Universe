---
title: title-expert
url: https://skills.sh/reggiechan74/vp-real-estate/title-expert
---

# title-expert

skills/reggiechan74/vp-real-estate/title-expert
title-expert
Installation
$ npx skills add https://github.com/reggiechan74/vp-real-estate --skill title-expert
SKILL.md
...
Transmission easement (registered 2010):
...
Restrictive covenant (registered 1995):
...
Stormwater drainage easement (registered 2015):
...
First mortgage (registered 2022):
...
Easement impact: Reduces collateral value (lender wants maximum value)

Workaround: Appraiser adjusts for easement, lender advances lower LTV (loan-to-value ratio)

Environmental lien: Increases lender risk (remediation cost reduces equity)

Workaround: Require environmental insurance, lower LTV, escrow remediation costs

Restrictive covenant risk: Affects use/development (limits exit options)
...
Identify specific income loss from encumbrance
Determine annual impact amount
Select capitalization rate (3-7% depending on permanence/risk)
Divide annual impact by cap rate to derive present value loss
...
Formula for cumulative discount: Discounted Value = Original Value × (1 - D₁) × (1 - D₂) × (1 - D₃)...
...
Transmission easement: 5% discount
Stormwater drainage: 3% discount
"Residential use only" covenant: 8% discount (restrictive in commercial zone)
...
Phase II ESA: Environmental consultant completes detailed assessment of soil contamination
Remediation plan: Develop plan for in-situ treatment or excavation/off-site disposal
Regulatory approval: Obtain Ministry of Environment approval of remediation plan
Execute remediation: Complete cleanup according to approved plan
Closure letter: Obtain Ministry letter confirming remediation complete, environmental liability cleared
