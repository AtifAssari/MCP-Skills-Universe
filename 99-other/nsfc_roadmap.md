---
title: nsfc-roadmap
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-roadmap
---

# nsfc-roadmap

skills/huangwb8/chineseresearchlatex/nsfc-roadmap
nsfc-roadmap
Installation
$ npx skills add https://github.com/huangwb8/chineseresearchlatex --skill nsfc-roadmap
SKILL.md
NSFC 技术路线图生成器
...
运行 plan_roadmap.py 生成 plan_request.json/plan_request.md
宿主 AI 写 roadmap-plan.md 和 spec_draft.yaml
再次运行脚本校验 spec_draft.yaml
