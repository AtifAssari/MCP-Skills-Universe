---
title: metabolic-cultures
url: https://skills.sh/jwynia/agent-skills/metabolic-cultures
---

# metabolic-cultures

skills/jwynia/agent-skills/metabolic-cultures
metabolic-cultures
Installation
...
Integration Philosophy (Purist 1 ← → 5 Synthesis)
Temporal Rigidity (Strict 1 ← → 5 Fluid)
Boundary Permeability (Closed 1 ← → 5 Open)
Death Orthodoxy (Traditional 1 ← → 5 Innovative)
Power Concentration (Centralized 1 ← → 5 Distributed)
...
If not found, ask user: "Where should I save metabolic culture designs?"
Suggest: worldbuilding/cultures/ or explorations/worldbuilding/
Primary Output
