---
title: css
url: https://skills.sh/jaredlander/freshbooks-speed/css
---

# css

skills/jaredlander/freshbooks-speed/css
css
Installation
...
CSS cascade and specificity - Understand and leverage, don't fight against it
Performance matters - Minimize reflows, optimize animations, reduce file size
Maintainability - Use consistent naming, logical organization, clear documentation
...
Workflow
Start with context7 - Look up unfamiliar properties or modern features
Mobile-first - Design and code for mobile, enhance for larger screens
Use feature queries - Progressive enhancement with @supports
Test across browsers - Verify in Chrome, Firefox, Safari, Edge
Validate - Use W3C CSS Validator for standard compliance
Optimize - Minimize reflows, use contain, leverage GPU acceleration
Document - Comment complex calculations, magic numbers, browser hacks
Tools and Resources
