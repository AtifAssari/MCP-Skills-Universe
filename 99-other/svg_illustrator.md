...
url: https://skills.sh/zxhfighter/skills-hub/svg-illustrator
---

# svg-illustrator

skills/zxhfighter/skills-hub/svg-illustrator
svg-illustrator
Installation
...
编写代码：直接在文档对应位置插入 <svg> 代码。
添加释义：在插画下方添加简短、有深度的“寓意解说”。
禁止行为
❌ 严禁生成低质量、卡通化、业余美感的图标。
