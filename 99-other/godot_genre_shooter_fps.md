---
title: godot-genre-shooter-fps
url: https://skills.sh/thedivergentai/gd-agentic-skills/godot-genre-shooter-fps
---

# godot-genre-shooter-fps

skills/thedivergentai/gd-agentic-skills/godot-genre-shooter-fps
godot-genre-shooter-fps
Installation
...
Godot-Specific Tips
Raycasts: Use PhysicsRayQueryParameters3D with proper layer masks
Projectiles: CharacterBody3D or RigidBody3D depending on physics needs
Audio: Multiple AudioStreamPlayer3D for layered gun sounds
Animations: AnimationTree for weapon state machines (idle, aim, fire, reload)
Reference
