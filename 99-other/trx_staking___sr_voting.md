---
title: trx staking & sr voting
url: https://skills.sh/bofai/skills/trx-staking-&-sr-voting
---

# trx staking & sr voting

skills/bofai/skills/TRX Staking & SR Voting
TRX Staking & SR Voting
Installation
...
Stake TRX (via energy-bandwidth skill): node stake.js 1000 ENERGY
Check TRON Power: node scripts/status.js
Browse SRs: node scripts/sr-list.js --top 10
Vote: node scripts/vote.js TSRAddress --dry-run → confirm → execute
Check rewards periodically: node scripts/rewards.js
Claim: node scripts/rewards.js --claim
...
Verify SR addresses before voting — confirm via sr-list.js.
