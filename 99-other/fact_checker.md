...
rating: ⭐⭐⭐
title: fact-checker
url: https://skills.sh/shubhamsaboo/awesome-llm-apps/fact-checker
---

# fact-checker

skills/shubhamsaboo/awesome-llm-apps/fact-checker
fact-checker
Installation
...
Detects common manipulation patterns including statistical cherry-picking, context removal, false equivalences, and logical fallacies
Provides structured output with verdict, analysis, evidence, context, and corrected information when claims are inaccurate
SKILL.md
Fact Checker
