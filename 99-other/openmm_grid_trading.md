...
url: https://skills.sh/qbt-labs/openmm-ai/openmm-grid-trading
---

# openmm-grid-trading

skills/qbt-labs/openmm-ai/openmm-grid-trading
openmm-grid-trading
Installation
$ npx skills add https://github.com/qbt-labs/openmm-ai --skill openmm-grid-trading
SKILL.md
OpenMM Grid Trading
