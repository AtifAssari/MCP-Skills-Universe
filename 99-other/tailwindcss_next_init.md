---
rating: ⭐⭐
title: tailwindcss-next-init
url: https://skills.sh/adonis0123/adonis-skills/tailwindcss-next-init
---

# tailwindcss-next-init

skills/adonis0123/adonis-skills/tailwindcss-next-init
tailwindcss-next-init
Installation
...
用本 skill 为目标仓库生成 Tailwind v4 初始化骨架，并给出可复制的依赖安装命令、布局导入检查结果、@source 与 @reference 使用建议。 优先运行脚本完成标准化输出，避免手工遗漏。
