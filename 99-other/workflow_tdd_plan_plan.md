---
rating: ⭐⭐
title: workflow-tdd-plan-plan
url: https://skills.sh/catlog22/claude-code-workflow/workflow-tdd-plan-plan
---

# workflow-tdd-plan-plan

skills/catlog22/claude-code-workflow/workflow-tdd-plan-plan
workflow-tdd-plan-plan
Installation
...
sentinel fallback → Phase 5/6 包含 compact sentinel；若 compact 后仅存 sentinel 而无完整 Step 协议，必须立即 Read() 恢复对应 phase 文件
9. Core Rules
...
Warnings logged to .process/tdd-warnings.log
Summary displayed in Phase 6 output
User decides whether to address before workflow-execute skill
