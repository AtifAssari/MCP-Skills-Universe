...
url: https://skills.sh/steelan9199/wechat-publisher/feishu-bitable
---

# feishu-bitable

skills/steelan9199/wechat-publisher/feishu-bitable
feishu-bitable
Installation
...
前置要求
有效的 tenant_access_token：所有 API 操作都需要
app_token：标识要操作的多维表格
table_id：标识要操作的数据表（部分操作需要）
参数传递方式
