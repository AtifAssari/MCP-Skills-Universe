...
url: https://skills.sh/nickcrew/claude-ctx-plugin/socratic-questioning
---

# socratic-questioning

skills/nickcrew/claude-ctx-plugin/socratic-questioning
socratic-questioning
Installation
...
Gauge level -- beginner (concrete observations), intermediate (pattern recognition), advanced (synthesis and application)
Identify goals -- what does the learner want to understand or improve?
Map prior knowledge -- what principles do they already apply?
Choose strategy -- select questioning depth and scaffolding level
Phase 2: Explore
...
Summarize -- have the learner articulate what they discovered
Connect -- link the discovery to broader principles and patterns
Practice -- propose an exercise that applies the new understanding
Plan -- outline what to explore next based on gaps revealed
Session Types
Session	Focus	Flow
