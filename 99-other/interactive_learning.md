...
url: https://skills.sh/geekjourneyx/interactive-learning/interactive-learning
---

# interactive-learning

skills/geekjourneyx/interactive-learning/interactive-learning
interactive-learning
Installation
...
接收输入
自动分诊：skim / study / park
产出初步概念边界与依赖
仅在必要时问最多 3 个短问题
锁定一个最小 concept cluster
执行最小诊断，再进入验证闭环：讲一点 -> 让用户说 -> 测一下 -> 修一下 -> 换场景再测
给一个碎片时间可完成的 next step
如有需要，动态生成 checkpoint HTML
