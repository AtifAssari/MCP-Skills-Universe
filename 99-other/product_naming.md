...
url: https://skills.sh/yunshu0909/yunshu_skillshub/product-naming
---

# product-naming

skills/yunshu0909/yunshu_skillshub/product-naming
product-naming
Installation
$ npx skills add https://github.com/yunshu0909/yunshu_skillshub --skill product-naming
SKILL.md
...
用户是谁？ — 什么人在用？什么场景下用？使用频率？
产品本质 — 用一句话介绍这个产品是什么？（不是功能列表，是角色/定位/比喻）
产品边界 — 做什么、不做什么、未来往哪个方向长？
品牌气质 — 用户看到这个名字时，应该有什么第一反应？（专业/亲切/极客/轻松/...）
硬性约束 — 语言偏好？长度限制？需要避开的词？
...
关键词 — 从用户的描述中提炼核心语素（如：编程、助手、伙伴、工具、管理）
识别张力 — 用户的多个诉求之间是否存在矛盾？（如"要像人名一样有温度" vs "一眼看出跟编程有关"）
明确优先级 — 如果有张力，哪个诉求优先？
