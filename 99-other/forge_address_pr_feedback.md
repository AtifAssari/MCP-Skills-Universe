---
title: forge-address-pr-feedback
url: https://skills.sh/mgratzer/forge/forge-address-pr-feedback
---

# forge-address-pr-feedback

skills/mgratzer/forge/forge-address-pr-feedback
forge-address-pr-feedback
Installation
...
If no PR input is provided, detect it from the current branch: gh pr view --json number. Use any additional context to prioritize reviewer concerns, constraints, or follow-up expectations.
...
Commit: git commit -m "fix: address PR feedback — <brief description>"
Reply to the thread:
gh api graphql -f query='
mutation {
...
Markdown: create a new issue file per the plan-folder-spec with the PR context in the body, and commit it.
