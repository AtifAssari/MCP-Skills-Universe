---
title: headless-checkout-proxy
url: https://skills.sh/vtex/skills/headless-checkout-proxy
---

# headless-checkout-proxy

skills/vtex/skills/headless-checkout-proxy
headless-checkout-proxy
Installation
$ npx skills add https://github.com/vtex/skills --skill headless-checkout-proxy
SKILL.md
...
General BFF architecture and API routing (use headless-bff-architecture)
Search API integration (use headless-intelligent-search)
Caching strategy decisions (use headless-caching-strategy)
Decision rules
