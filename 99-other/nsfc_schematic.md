---
title: nsfc-schematic
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-schematic
---

# nsfc-schematic

skills/huangwb8/chineseresearchlatex/nsfc-schematic
nsfc-schematic
Installation
...
推荐首次使用时先走“规划 → 审阅 → 生成”。
默认 planning_mode=ai：
plan_schematic.py 生成规划请求
宿主 AI 产出 schematic-plan.md 和 spec_draft.yaml
复跑脚本做合法性校验
