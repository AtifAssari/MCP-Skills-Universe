---
title: doc-tspec-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-tspec-fixer
---

# doc-tspec-fixer

skills/vladm3105/aidoc-flow-framework/doc-tspec-fixer
doc-tspec-fixer
Installation
$ npx skills add https://github.com/vladm3105/aidoc-flow-framework --skill doc-tspec-fixer
SKILL.md
doc-tspec-fixer
Purpose
...
Select report with latest timestamp/version.
If timestamps/versions tie, prefer .A_audit_report_vNNN.md over .R_review_report_vNNN.md.
Skill Dependencies
...
Generate regeneration request for doc-tspec-autopilot
...
Create backup in tmp/backup/TSPEC-NN_YYYYMMDD_HHMMSS/
Copy all TSPEC files to backup location
