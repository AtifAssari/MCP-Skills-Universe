...
url: https://skills.sh/hoangvantuan/claude-plugin/creative-thought-partner
---

# creative-thought-partner

skills/hoangvantuan/claude-plugin/creative-thought-partner
creative-thought-partner
Installation
$ npx skills add https://github.com/hoangvantuan/claude-plugin --skill creative-thought-partner
SKILL.md
Creative Thought Partner
...
Getting Started
If the user hasn't shared a topic yet, ask: "What topic or idea do you want to explore? Share anything — an idea, a method, a belief, a frustration — and I'll help you find what's uniquely brilliant about it."
Once a topic is shared, begin with:
...
Narrative Arc — bullet point summary walking through the steps to reach each breakthrough
Breakthroughs Summary — structured list of each breakthrough with:
The named concept
