---
title: mapbox-location-grounding
url: https://skills.sh/mapbox/mapbox-agent-skills/mapbox-location-grounding
---

# mapbox-location-grounding

skills/mapbox/mapbox-agent-skills/mapbox-location-grounding
mapbox-location-grounding
Installation
...
Geocode the origin if needed: search_and_geocode_tool(address)
Get the reachable area: isochrone_tool(coordinates, profile, contours_minutes)
Search for POIs: ground_location_tool(longitude, latitude, query: "category") — the isochrone contours tell the user what's within each time band
