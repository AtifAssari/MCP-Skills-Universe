---
title: chapter2-guide
url: https://skills.sh/orientpine/honeypot/chapter2-guide
---

# chapter2-guide

skills/orientpine/honeypot/chapter2-guide
chapter2-guide
Installation
$ npx skills add https://github.com/orientpine/honeypot --skill chapter2-guide
SKILL.md
Chapter 2 작성 가이드
...
2. 작성 지침
시장 규모 작성
출처 명시 필수 (조사기관, 보고서명, 연도)
현재 규모, CAGR, 전망치 3가지 포함
달러 또는 원화 단위 일관성 유지
그래프 위치 표시 (<시장규모 그래프>)
[예시]
...
경쟁력 비교표 작성
영역(Depth 1) - 기술(Depth 2) 계층 구조
선진기관명과 국가 명시
기술수준: TRL 1-9 또는 점수(1-5)
KIMM 현재/목표 수준 구분
[예시]
| Depth 1 (영역) | Depth 2 (기술) | 선진기관 | 국가 | 기술수준 | KIMM 현재 | KIMM 목표 |
|---------------|---------------|---------|-----|---------|----------|----------|
...
글로벌 시장 규모 (IDC, MarketsandMarkets)
국내 시장 규모 (KISTEP, KIET)
산업별 시장 세분화
지역별 시장 점유율
