...
url: https://skills.sh/groeimetai/snow-flow/mcp-tool-discovery
---

# mcp-tool-discovery

skills/groeimetai/snow-flow/mcp-tool-discovery
mcp-tool-discovery
Installation
$ npx skills add https://github.com/groeimetai/snow-flow --skill mcp-tool-discovery
SKILL.md
