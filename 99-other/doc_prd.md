---
title: doc-prd
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-prd
---

# doc-prd

skills/vladm3105/aidoc-flow-framework/doc-prd
doc-prd
Installation
...
Upstream BRD: Read the BRD that drives this PRD Note on Sectioned BRDs: If BRD is split into multiple section files (0-18), read ALL files as ONE logical document. See PRD-MVP-TEMPLATE.md Section 22.
...
ID format errors: Use unified format PRD.NN.xxxx (not F-XXX, US-XXX, etc.)
