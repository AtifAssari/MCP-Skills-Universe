---
title: story-short-scan
url: https://skills.sh/worldwonderer/oh-story-claudecode/story-short-scan
---

# story-short-scan

skills/worldwonderer/oh-story-claudecode/story-short-scan
story-short-scan
Installation
$ npx skills add https://github.com/worldwonderer/oh-story-claudecode --skill story-short-scan
SKILL.md
...
scripts/dz-browse-scraper.js	点众短篇采集（男频/女频），文本解析+评分提取，配合 browser-cdp 使用
scripts/heiyan-booklist-scraper.js	黑岩书库列表采集，后端 API 模式（Bearer token），含字数/标签/价格/时间，支持 --detail 获取标签简介
语言
