...
url: https://skills.sh/chrisvoncsefalvay/claude-skills/electron-scaffold
---

# electron-scaffold

skills/chrisvoncsefalvay/claude-skills/electron-scaffold
electron-scaffold
Installation
...
Version Control: Git ignore dist/, node_modules/, .env
Use Process Manager: Handle main process crashes gracefully
...
✅ Review and customize package.json metadata
✅ Add application icons (all platforms)
