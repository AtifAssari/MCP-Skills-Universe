---
title: live-feed
url: https://skills.sh/marketcalls/openalgo-indicator-skills/live-feed
---

# live-feed

skills/marketcalls/openalgo-indicator-skills/live-feed
live-feed
Installation
...
Create charts/live/ directory (on-demand)
Create {symbol}_live_feed.py
Use the template from rules/assets/live_feed/template.py
Feed Types
