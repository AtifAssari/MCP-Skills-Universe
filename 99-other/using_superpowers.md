...
url: https://skills.sh/nickcrew/claude-ctx-plugin/using-superpowers
---

# using-superpowers

skills/nickcrew/claude-ctx-plugin/using-superpowers
using-superpowers
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill using-superpowers
SKILL.md
