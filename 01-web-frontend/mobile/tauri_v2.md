...
rating: ⭐⭐⭐
title: tauri-v2
url: https://skills.sh/cruldra/skills/tauri-v2
---

# tauri-v2

skills/cruldra/skills/tauri-v2
tauri-v2
Installation
...
参考 config-reference.md 获取 tauri.conf.json 的详细解析与指南：
...
参考 best-practices.md 获取架构和安全指南：
