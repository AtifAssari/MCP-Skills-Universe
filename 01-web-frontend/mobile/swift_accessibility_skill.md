...
url: https://skills.sh/pasqualevittoriosi/swift-accessibility-skill/swift-accessibility-skill
---

# swift-accessibility-skill

skills/pasqualevittoriosi/swift-accessibility-skill/swift-accessibility-skill
swift-accessibility-skill
Installation
...
Prefer native controls (Button, Toggle, Stepper, Slider, Picker, TextField) — they get full accessibility automatically. Custom interactive views require explicit work. For AppKit, prefer native controls (NSButton, NSPopUpButton, NSSlider, NSSegmentedControl, NSTextField) before custom NSView interaction.
...
Symptom: SwiftUI modifiers used in UIKit/AppKit code, or platform APIs mixed across frameworks. Fix: Identify framework from imports (import SwiftUI, import UIKit, import AppKit) before applying APIs. SwiftUI uses modifiers, UIKit uses UIAccessibility properties, and AppKit uses NSAccessibility APIs.
...
Prefer multi-platform guards when code is shared: if #available(iOS 17, macOS 14, tvOS 17, watchOS 10, visionOS 1, *) { ... }
