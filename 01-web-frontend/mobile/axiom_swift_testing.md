---
rating: ⭐⭐⭐
title: axiom-swift-testing
url: https://skills.sh/charleswiltgen/axiom/axiom-swift-testing
---

# axiom-swift-testing

skills/charleswiltgen/axiom/axiom-swift-testing
axiom-swift-testing
Installation
...
File → New → Workspace
Drag your .xcodeproj into the workspace
File → Add Package Dependencies → Add Local → select MyAppCore/
Add MyAppCore framework to your app target's "Frameworks, Libraries, and Embedded Content"
...
Single-test XCTestCase → global @Test function
Common Mistakes
❌ Mixing Assertions
