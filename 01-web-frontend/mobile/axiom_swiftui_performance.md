---
rating: ⭐⭐
title: axiom-swiftui-performance
url: https://skills.sh/charleswiltgen/axiom/axiom-swiftui-performance
---

# axiom-swiftui-performance

skills/charleswiltgen/axiom/axiom-swiftui-performance
axiom-swiftui-performance
Installation
...
State storage — Keeps isOn value (persists entire view lifetime)
Signal attribute — Tracks when state changes
...
Each view calls isFavorite(), accessing favoritesCollection.landmarks array
@Observable creates dependency: Each view depends on entire array
Tapping button calls toggleFavorite(), modifying array
All views marked as outdated (array changed)
...
All views with @Environment dependency notified
Each view checks if the specific value it reads changed
...
EnvironmentWriter — Changes inside SwiftUI via .environment() modifier
