---
rating: ⭐⭐⭐
title: android-e2e-testing-setup
url: https://skills.sh/hitoshura25/claude-devtools/android-e2e-testing-setup
---

# android-e2e-testing-setup

skills/hitoshura25/claude-devtools/android-e2e-testing-setup
android-e2e-testing-setup
Installation
...
For release testing: Install release APK and run tests against it (see android-release-validation)
Add more comprehensive tests if needed (use android-additional-tests skill)
