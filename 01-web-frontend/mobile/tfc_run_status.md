---
title: tfc-run-status
url: https://skills.sh/laurigates/claude-plugins/tfc-run-status
---

# tfc-run-status

skills/laurigates/claude-plugins/tfc-run-status
tfc-run-status
Installation
$ npx skills add https://github.com/laurigates/claude-plugins --skill tfc-run-status
SKILL.md
