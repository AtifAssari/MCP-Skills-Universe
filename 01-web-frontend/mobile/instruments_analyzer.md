---
title: instruments-analyzer
url: https://skills.sh/jlreyes/instruments-analyzer/instruments-analyzer
---

# instruments-analyzer

skills/jlreyes/instruments-analyzer/instruments-analyzer
instruments-analyzer
Installation
...
Workflow overview
Record a trace (or use an existing one)
Export the trace to DuckDB
Explore the exported tables
Prepare derived views (optional, for frame-level analysis)
Analyze using SQL queries against the DuckDB database
...
scroll_and_animation.md — SwiftUI scroll and animation jank diagnosis
Weekly Installs
9
Repository
jlreyes/instrum…analyzer
GitHub Stars
21
First Seen
11 days ago
