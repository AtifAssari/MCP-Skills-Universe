---
title: expo-gaode-map-search
url: https://skills.sh/tomwq/expo-gaode-map/expo-gaode-map-search
---

# expo-gaode-map-search

skills/tomwq/expo-gaode-map/expo-gaode-map-search
expo-gaode-map-search
Installation
$ npx skills add https://github.com/tomwq/expo-gaode-map --skill expo-gaode-map-search
SKILL.md
原生搜索开发 (Search)
描述
...
需要高性能搜索，无额外网络请求开销。
开发指令
依赖：确保已安装任一基础包 (core 或 navigation) 并完成 Key 配置。
