...
url: https://skills.sh/marimo-team/skills/marimo-notebook
---
...
For external editing and --watch mode WATCHING.md
For expensive notebooks (caching, lazy eval, mo.stop) EXPENSIVE.md
For configuration (pyproject.toml, marimo.toml) CONFIGURATION.md
For reactivity model (DAG, variable scoping, mutations) REACTIVITY.md
Weekly Installs
2.2K
Repository
marimo-team/skills
