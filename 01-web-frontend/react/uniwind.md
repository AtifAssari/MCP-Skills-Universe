...
rating: ⭐⭐⭐
title: uniwind
url: https://skills.sh/uni-stack/uniwind/uniwind
---

# uniwind

skills/uni-stack/uniwind/uniwind
uniwind
Installation
...
Offers scalable theming via CSS variables, custom themes, platform selectors (ios:, android:, web:), data selectors, and interactive states (active:, focus:, disabled:)
Pro version adds Reanimated animations, transitions, native insets, and theme transition effects; free version requires react-native-safe-area-context setup
SKILL.md
...
No tailwind.config.js — All config goes in global.css via @theme and @layer theme.
...
Can I customize the default border color? Yes — use @utility border to override the class entirely:
