---
title: sveltia-cms
url: https://skills.sh/ovachiever/droid-tings/sveltia-cms
---

# sveltia-cms

skills/ovachiever/droid-tings/sveltia-cms
sveltia-cms
Installation
$ npx skills add https://github.com/ovachiever/droid-tings --skill sveltia-cms
SKILL.md
Sveltia CMS Skill
...
Add passthrough copy to .eleventy.js:
...
Use Sveltia's local repository feature:
...
Deploy OAuth serverless function (see Vercel setup section)
...
Use Cloudflare Workers for OAuth (recommended over Netlify Functions)
...
Deploy OAuth Worker for authentication
