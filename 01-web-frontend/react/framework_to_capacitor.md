---
title: framework-to-capacitor
url: https://skills.sh/cap-go/capgo-skills/framework-to-capacitor
---

# framework-to-capacitor

skills/cap-go/capgo-skills/framework-to-capacitor
framework-to-capacitor
Installation
...
Local storage: Use @capacitor/preferences
...
Check build output directory matches webDir in capacitor.config.ts
