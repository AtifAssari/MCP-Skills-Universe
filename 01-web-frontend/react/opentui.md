...
skills/msmps/opentui-skill/opentui
opentui
Installation
...
Use create-tui for new projects. See framework REFERENCE.md quick starts.
create-tui options must come before arguments. bunx create-tui -t react my-app works, bunx create-tui my-app -t react does NOT.
Never call process.exit() directly. Use renderer.destroy() (see core/gotchas.md).
Text styling requires nested tags in React/Solid. Use modifier elements, not props (see components/text-display.md).
...
Reading Order
Start with REFERENCE.md for your chosen framework
