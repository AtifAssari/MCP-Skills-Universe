...
url: https://skills.sh/sickn33/antigravity-awesome-skills/vercel-deployment
---

# vercel-deployment

skills/sickn33/antigravity-awesome-skills/vercel-deployment
vercel-deployment
Installation
...
// BUILD TIME (baked into bundle): // - NEXT_PUBLIC_* variables // - next.config.js // - generateStaticParams // - Static pages
...
// For config that must be runtime: // Don't use NEXT_PUBLIC_, read on server and pass to client
