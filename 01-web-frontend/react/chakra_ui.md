...
rating: ⭐⭐⭐
title: chakra-ui
url: https://skills.sh/mgd34msu/goodvibes-gemini/chakra-ui
---

# chakra-ui

skills/mgd34msu/goodvibes-gemini/chakra-ui
chakra-ui
Installation
...
Best Practices
Use compound components - Prefer Dialog.Root, Dialog.Content over flat imports
Leverage semantic tokens - Use brand.solid instead of brand.500 for theme flexibility
Use snippets - Run npx @chakra-ui/cli snippet add for pre-built patterns
Responsive object syntax - Clearer than array syntax for complex responsive styles
Recipes for variants - Define component variants in theme, not inline
Reference Files
