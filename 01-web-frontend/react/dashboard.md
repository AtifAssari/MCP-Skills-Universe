---
title: dashboard
url: https://skills.sh/mwguerra/claude-code-plugins/dashboard
---

# dashboard

skills/mwguerra/claude-code-plugins/dashboard
dashboard
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill dashboard
SKILL.md
