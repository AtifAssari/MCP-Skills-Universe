---
title: react-pdf
url: https://skills.sh/trailofbits/skills-curated/react-pdf
---

# react-pdf

skills/trailofbits/skills-curated/react-pdf
react-pdf
Installation
$ npx skills add https://github.com/trailofbits/skills-curated --skill react-pdf
SKILL.md
...
Wrap async code in IIFE - Top-level await causes errors. Always use (async () => { ... })() pattern.
Disable hyphenation for custom fonts - Custom fonts lack hyphenation dictionaries and may crash or break words incorrectly. Always call Font.registerHyphenationCallback((word) => [word]); after registering custom fonts.
Files
...
{baseDir}/skills/react-pdf/assets/example-template.tsx - Minimal working example demonstrating fixed footers, page numbers, and unbreakable content. Read this before starting to understand the basic patterns. Note: not all APIs are shown here — always refer to the docs and {baseDir}/skills/react-pdf/references/components.md for the full API.
Prerequisites
