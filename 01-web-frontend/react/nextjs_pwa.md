---
title: nextjs-pwa
url: https://skills.sh/just-mpm/conformai/nextjs-pwa
---

# nextjs-pwa

skills/just-mpm/conformai/nextjs-pwa
nextjs-pwa
Installation
...
Migrating from next-pwa? → Use Serwist (direct replacement)
Already have custom service worker? → Keep it or refactor to Serwist
