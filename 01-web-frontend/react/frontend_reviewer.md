...
url: https://skills.sh/olehsvyrydov/ai-development-team/frontend-reviewer
---

# frontend-reviewer

skills/olehsvyrydov/ai-development-team/frontend-reviewer
frontend-reviewer
Installation
...
Navigate to page
Get HTML structure → Analyze semantic markup
Screenshot → Check color contrast visually
Resize to mobile → Verify touch targets
...
Ignoring A11y: Accessibility is mandatory
