---
title: ahooks
url: https://skills.sh/blockmatic/basilic/ahooks
---

# ahooks

skills/blockmatic/basilic/ahooks
ahooks
Installation
...
Grouped state not in URL → Use useSetState (form state, game engine, ephemeral UI)
Async operations → Use TanStack Query (data fetching, mutations, caching)
localStorage persistence → Use useLocalStorageState (preferences, settings)
