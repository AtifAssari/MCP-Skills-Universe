...
url: https://skills.sh/jackspace/claudeskillz/ai-elements-chatbot
---

# ai-elements-chatbot

skills/jackspace/claudeskillz/ai-elements-chatbot
ai-elements-chatbot
Installation
...
Check references/common-issues.md for troubleshooting
Verify all prerequisites (Next.js 15+, AI SDK v5+, shadcn/ui)
Check official docs: https://www.shadcn.io/ai
Ensure Tailwind v4 is configured correctly (use tailwind-v4-shadcn skill)
Related Skills
