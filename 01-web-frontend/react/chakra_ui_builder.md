---
rating: ⭐⭐⭐
title: chakra-ui-builder
url: https://skills.sh/chakra-ui/chakra-ui/chakra-ui-builder
---

# chakra-ui-builder

skills/chakra-ui/chakra-ui/chakra-ui-builder
chakra-ui-builder
Installation
$ npx skills add https://github.com/chakra-ui/chakra-ui --skill chakra-ui-builder
SKILL.md
Chakra UI Builder
...
Complete, runnable code — correct imports, no placeholders like TODO or ...rest of component
Proper import statements — group Chakra imports, then local imports
...
Responsive styles — at minimum base and md breakpoints for layout
Brief explanation after the code — 2–4 sentences on the key decisions made (layout approach, accessibility choices, responsive strategy). Skip the explanation if the request was trivial.
// Good import style
