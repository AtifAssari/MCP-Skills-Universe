---
title: copilotkit-agui
url: https://skills.sh/copilotkit/skills/copilotkit-agui
---

# copilotkit-agui

skills/copilotkit/skills/copilotkit-agui
copilotkit-agui
Installation
$ npx skills add https://github.com/copilotkit/skills --skill copilotkit-agui
SKILL.md
...
Define your endpoint -- Accept POST with RunAgentInput body, respond with text/event-stream
Parse input -- Extract threadId, runId, messages, tools, state, context from the request body
Emit events in order -- RUN_STARTED first, then content events, then RUN_FINISHED or RUN_ERROR
Encode as SSE -- Use @ag-ui/encoder's EventEncoder.encode() or manually write data: JSON\n\n
Handle tool results -- Client sends TOOL_CALL_RESULT back; agent processes and continues
