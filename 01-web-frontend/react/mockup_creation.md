...
url: https://skills.sh/dauquangthanh/hanoi-rainbow/mockup-creation
---

# mockup-creation

skills/dauquangthanh/hanoi-rainbow/mockup-creation
mockup-creation
Installation
$ npx skills add https://github.com/dauquangthanh/hanoi-rainbow --skill mockup-creation
SKILL.md
Mockup Creation
...
SEO: Use useHead() and useSeoMeta() for meta tags
...
Route Handlers: Use route.ts for API endpoints in app/api/
Weekly Installs
18
Repository
