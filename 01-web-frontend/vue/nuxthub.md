...
rating: ⭐⭐⭐
title: nuxthub
url: https://skills.sh/onmax/nuxt-skills/nuxthub
---

# nuxthub

skills/onmax/nuxt-skills/nuxthub
nuxthub
Installation
$ npx skills add https://github.com/onmax/nuxt-skills --skill nuxthub
Summary
...
Response and function caching with TTL and invalidation; virtual module imports (hub:db, hub:kv, hub:blob) auto-available on server-side
Multi-cloud deployment to Cloudflare (auto-generated wrangler config), Vercel, Netlify, Deno Deploy, and AWS with environment-specific bindings
SKILL.md
NuxtHub v0.10.6
