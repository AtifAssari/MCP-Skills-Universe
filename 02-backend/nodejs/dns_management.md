...
url: https://skills.sh/bagelhole/devops-security-agent-skills/dns-management
---

# dns-management

skills/bagelhole/devops-security-agent-skills/dns-management
dns-management
Installation
$ npx skills add https://github.com/bagelhole/devops-security-agent-skills --skill dns-management
SKILL.md
DNS Management
