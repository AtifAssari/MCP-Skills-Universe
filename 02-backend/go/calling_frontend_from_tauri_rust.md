---
rating: ⭐⭐⭐
title: calling-frontend-from-tauri-rust
url: https://skills.sh/dchuk/claude-code-tauri-skills/calling-frontend-from-tauri-rust
---

# calling-frontend-from-tauri-rust

skills/dchuk/claude-code-tauri-skills/calling-frontend-from-tauri-rust
calling-frontend-from-tauri-rust
Installation
