---
rating: ⭐⭐⭐
title: telnyx-account-notifications-python
url: https://skills.sh/team-telnyx/skills/telnyx-account-notifications-python
---

# telnyx-account-notifications-python

skills/team-telnyx/skills/telnyx-account-notifications-python
telnyx-account-notifications-python
Installation
$ npx skills add https://github.com/team-telnyx/skills --skill telnyx-account-notifications-python
SKILL.md
Telnyx Account Notifications - Python
Installation
pip install telnyx
