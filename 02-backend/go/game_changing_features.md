...
url: https://skills.sh/davila7/claude-code-templates/game-changing-features
---

# game-changing-features

skills/davila7/claude-code-templates/game-changing-features
game-changing-features
Originally fromsoftaworks/agent-toolkit
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill game-changing-features
SKILL.md
10x Mode
