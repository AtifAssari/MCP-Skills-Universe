...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/testing-for-json-web-token-vulnerabilities
---
...
testing-for-json-web-token-vulnerabilities
Installation
$ npx skills add https://github.com/mukul975/anthropic-cybersecurity-skills --skill testing-for-json-web-token-vulnerabilities
SKILL.md
Testing for JSON Web Token Vulnerabilities
When to Use
