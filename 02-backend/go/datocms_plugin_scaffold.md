---
rating: ⭐⭐
title: datocms-plugin-scaffold
url: https://skills.sh/datocms/agent-skills/datocms-plugin-scaffold
---

# datocms-plugin-scaffold

skills/datocms/agent-skills/datocms-plugin-scaffold
datocms-plugin-scaffold
Installation
$ npx skills add https://github.com/datocms/agent-skills --skill datocms-plugin-scaffold
SKILL.md
DatoCMS Plugin Scaffold
...
Check for an existing plugin project (package.json with datocms-plugin-sdk, a connect() entrypoint, and Vite config).
If a plugin already exists and the request is an edit, switch to datocms-plugin-builder.
Infer the likely starting surface from the request before asking questions.
