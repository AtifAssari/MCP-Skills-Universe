---
title: tooyoung:gh-star-list
url: https://skills.sh/shiqkuangsan/oh-my-daily-skills/tooyoung:gh-star-list
---

# tooyoung:gh-star-list

skills/shiqkuangsan/oh-my-daily-skills/tooyoung:gh-star-list
tooyoung:gh-star-list
Installation
...
Create new lists: bash scripts/manage_lists.sh create "<name>" "<description>"
Collect all list IDs (existing + new)
Add repos to lists: bash scripts/manage_lists.sh add <repo_node_id> <list_id>
