...
rating: ⭐⭐⭐
title: cto-advisor
url: https://skills.sh/davila7/claude-code-templates/cto-advisor
---

# cto-advisor

skills/davila7/claude-code-templates/cto-advisor
cto-advisor
Installation
...
Covers five core CTO responsibilities: technology strategy, team leadership, architecture governance, vendor management, and engineering excellence
Includes weekly cadence, quarterly planning cycles, crisis management protocols, and stakeholder communication templates for executive and cross-functional alignment
SKILL.md
CTO Advisor
