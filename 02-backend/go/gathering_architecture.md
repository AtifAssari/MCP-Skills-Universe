---
title: gathering-architecture
url: https://skills.sh/autumnsgrove/groveengine/gathering-architecture
---

# gathering-architecture

skills/autumnsgrove/groveengine/gathering-architecture
gathering-architecture
Installation
...
Resume Eagle with Crow's specific findings
Eagle produces revised architecture
Optionally resume Crow for re-challenge (max 2 iterations)
