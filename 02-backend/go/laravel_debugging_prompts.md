---
title: laravel:debugging-prompts
url: https://skills.sh/jpcaparas/superpowers-laravel/laravel:debugging-prompts
---

# laravel:debugging-prompts

skills/jpcaparas/superpowers-laravel/laravel:debugging-prompts
laravel:debugging-prompts
Installation
$ npx skills add https://github.com/jpcaparas/superpowers-laravel --skill laravel:debugging-prompts
SKILL.md
Debugging Prompts
...
Price is in cents (2999) instead of formatted dollars ("29.99")
Category is null even though product has category_id = 5
...
Updated product price in database: UPDATE products SET price = 3999 WHERE id = 1
Database shows: SELECT price FROM products WHERE id = 1 → 3999
API returns old price: GET /api/products/1 → "price": "29.99"
After php artisan cache:clear, API returns correct price: "price": "39.99"
