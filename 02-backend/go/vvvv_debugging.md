---
rating: ⭐⭐⭐
title: vvvv-debugging
url: https://skills.sh/tebjan/vvvv-skills/vvvv-debugging
---

# vvvv-debugging

skills/tebjan/vvvv-skills/vvvv-debugging
vvvv-debugging
Installation
$ npx skills add https://github.com/tebjan/vvvv-skills --skill vvvv-debugging
SKILL.md
...
Debug > Debug Properties (or Project Properties > Debug > General)
...
Attach to Process
Launch vvvv normally (add --debug if you need breakpoints)
Debug > Attach to Process (Ctrl+Alt+P)
Find vvvv.exe in the process list
Select Managed (.NET Core, .NET 5+) as code type
Click Attach
