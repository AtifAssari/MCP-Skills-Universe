---
title: skill-creator
url: https://skills.sh/arjenschwarz/agentic-coding/skill-creator
---

# skill-creator

skills/arjenschwarz/agentic-coding/skill-creator
skill-creator
Installation
$ npx skills add https://github.com/arjenschwarz/agentic-coding --skill skill-creator
SKILL.md
Skill Creator
...
Guides Claude's behaviour through detailed instructions, rather than performing operations itself
...
Level 1: Metadata (name + description) - Always loaded into Claude's context and is how Claude knows when it should use the skill (~100 words)
Level 2: SKILL.md body - Loaded only after the skill triggers (<5k words)
Level 3: Bundled resources - Loaded by Claude as needed (unlimited, since scripts can execute without reading)
...
What Skills Provide
Specialised workflows - Multi-step procedures for specific domains
...
Initialise the skill (run init_skill.py)
