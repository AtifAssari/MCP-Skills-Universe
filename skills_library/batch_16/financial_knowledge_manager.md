---
title: financial-knowledge-manager
url: https://skills.sh/khw1031/ai-library/financial-knowledge-manager
---

# financial-knowledge-manager

skills/khw1031/ai-library/financial-knowledge-manager
financial-knowledge-manager
Installation
$ npx skills add https://github.com/khw1031/ai-library --skill financial-knowledge-manager
SKILL.md
Financial Knowledge Manager
...
500줄 초과 시 파일 분할을 제안
데이터 추가 규칙
기존 형식 유지: 대상 파일의 마크다운 헤딩 구조, 리스트 스타일, 테이블 형식을 그대로 따름
적절한 섹션에 추가: 관련 섹션 하단에 추가, 새로운 카테고리면 섹션 신설
테이블 구조 보존: 기존 테이블에 행을 추가할 때 컬럼 정렬과 구분선 유지
출처 명시: 데이터 출처가 있으면 각주 또는 인라인으로 기록
날짜 태그: 추가 시점을 <!-- updated: YYYY-MM-DD --> 형식으로 섹션 상단에 기록
Weekly Installs
10
Repository
khw1031/ai-library
