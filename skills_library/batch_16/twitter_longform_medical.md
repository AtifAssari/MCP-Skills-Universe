---
title: twitter-longform-medical
url: https://skills.sh/drshailesh88/integrated_content_os/twitter-longform-medical
---

# twitter-longform-medical

skills/drshailesh88/integrated_content_os/twitter-longform-medical
twitter-longform-medical
Installation
$ npx skills add https://github.com/drshailesh88/integrated_content_os --skill twitter-longform-medical
SKILL.md
...
PubMed:search_articles - Find relevant trials, meta-analyses, guidelines
PubMed:get_article_metadata - Get full details for key references
PubMed:get_full_text_article - Access full text when available (PMC)
PubMed:find_related_articles - Discover connected evidence
...
Kaplan-Meier curves - Show survival/event-free survival over time
Forest plots - Display effect sizes across subgroups or trials
Bar/column charts - Compare outcomes across groups
Line graphs - Show trends over time
Tables - Present trial characteristics or multi-study comparisons
...
Cite Q1 journals. NEJM, JAMA, Lancet, Circulation, JACC, EHJ, BMJ.
Include visuals. At least one chart or figure per post.
Be confident. State conclusions directly. Hedging wastes reader attention.
Not newsletters. No "dear reader," no subscription talk, no email structure.
Not academic. Accessible to educated laypeople. No jargon walls.
Not dumbed down. Your reader can handle hazard ratios and CI.
Channel Topol-Attia-Patrick-Huberman rigor. That's your peer set.
1,500-2,500 words. Long enough to be comprehensive. Short enough for Twitter.
Sources at the end. Full citations. DOIs when available.
Weekly Installs
27
Repository
