---
title: hz-platform-sdk
url: https://skills.sh/meta-quest/agentic-tools/hz-platform-sdk
---

# hz-platform-sdk

skills/meta-quest/agentic-tools/hz-platform-sdk
hz-platform-sdk
Installation
$ npx skills add https://github.com/meta-quest/agentic-tools --skill hz-platform-sdk
SKILL.md
...
How to Use
First, read references/common-setup.md for shared setup instructions, initialization code, and common status codes that apply to all APIs.
