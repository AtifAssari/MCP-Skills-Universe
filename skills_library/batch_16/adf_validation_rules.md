---
title: adf-validation-rules
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/adf-validation-rules
---

# adf-validation-rules

skills/josiahsiegel/claude-plugin-marketplace/adf-validation-rules
adf-validation-rules
Installation
$ npx skills add https://github.com/josiahsiegel/claude-plugin-marketplace --skill adf-validation-rules
SKILL.md
...
VERIFY required properties are set (e.g., accountKind for managed identity)
