...
url: https://skills.sh/giuseppe-trisciuoglio/developer-kit/clean-architecture-php
---

# clean-architecture-php

skills/giuseppe-trisciuoglio/developer-kit/clean-architecture-php
clean-architecture-php
Installation
$ npx skills add https://github.com/giuseppe-trisciuoglio/developer-kit --skill clean-architecture-php
SKILL.md
...
Create Value Objects with validation at construction time - they must be immutable using PHP 8.1+ readonly
Create Entities with domain logic and business rules - entities should encapsulate behavior, not just be data bags
