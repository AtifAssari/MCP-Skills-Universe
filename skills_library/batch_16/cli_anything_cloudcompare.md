---
title: cli-anything-cloudcompare
url: https://skills.sh/hkuds/cli-anything/cli-anything-cloudcompare
---

# cli-anything-cloudcompare

skills/hkuds/cli-anything/cli-anything-cloudcompare
cli-anything-cloudcompare
Installation
...
Chain with --add-to-project to build multi-step pipelines without re-loading files
Use cloud list --json to discover valid cloud indices before each operation
Use export formats --json to discover available format presets
Version
Component	Version
