---
title: hk-open-data
url: https://skills.sh/errchh/hk-open-data/hk-open-data
---

# hk-open-data

skills/errchh/hk-open-data/hk-open-data
hk-open-data
Installation
$ npx skills add https://github.com/errchh/hk-open-data --skill hk-open-data
SKILL.md
...
CKAN API - Dataset discovery and metadata
Data Filtering API - Query and filter dataset resources
Historical Archive API - Access historical versions
Nearest Facilities API - Location-based queries
Language Endpoints
...
Discover datasets using CKAN package_list or group_show
Get metadata using package_show to find resource URLs
Query data using v2 Filtering API with proper filters and sections
For historical data use Historical Archive APIs
Error Handling
