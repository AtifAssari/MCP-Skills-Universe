...
url: https://skills.sh/hughyau/qiushi-skill/investigation-first
---
...
investigation-first
Installation
$ npx skills add https://github.com/hughyau/qiushi-skill --skill investigation-first
SKILL.md
调查研究
...
声明调查目的：一句话写出"我要弄清楚的是：[具体问题]"
列调查清单：用 checkbox 列出需要调查的具体项目，例如：
- [ ] 读取 [具体文件/模块] 了解现状
- [ ] 检查 [具体接口/配置] 了解约束条件
- [ ] 确认 [具体数据/状态] 的实际情况
执行调查：逐项完成，完成后标记 - [x]
