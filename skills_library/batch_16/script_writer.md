---
title: script-writer
url: https://skills.sh/kambleakash0/agent-skills/script-writer
---

# script-writer

skills/kambleakash0/agent-skills/script-writer
script-writer
Installation
$ npx skills add https://github.com/kambleakash0/agent-skills --skill script-writer
SKILL.md
...
The full set of 26 Winston heuristics -- each with its principle, cognitive basis, transcript evidence, and format-specific application rules -- is in resources.md.
...
Symbol -- what visual or conceptual icon represents this?
Slogan -- what short phrase gives a handle on it?
Surprise -- what violates the audience's assumptions?
Salient Idea -- what one idea sticks out above all others?
Story -- what is the narrative of how it was done / how it works / why it matters?
