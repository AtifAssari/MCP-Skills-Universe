---
title: abundance_every_year_market_notes
url: https://skills.sh/cyhzzz/finance_aigc_skills/abundance_every_year_market_notes
---

# abundance_every_year_market_notes

skills/cyhzzz/finance_aigc_skills/abundance_every_year_market_notes
abundance_every_year_market_notes
Installation
$ npx skills add https://github.com/cyhzzz/finance_aigc_skills --skill abundance_every_year_market_notes
SKILL.md
[品牌名称]市场评论撰写
任务目标
...
必须保存MD评论文章：润色后的终稿保存为 market_article_YYYYMMDD.md 文件，此步骤必须在生成HTML之前完成
必须生成HTML海报：使用润色后的终稿生成可视化HTML海报文件 market_report_YYYYMMDD.html
使用示例
示例1：撰写盘前展望
