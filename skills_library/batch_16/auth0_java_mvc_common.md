---
title: auth0-java-mvc-common
url: https://skills.sh/auth0/agent-skills/auth0-java-mvc-common
---

# auth0-java-mvc-common

skills/auth0/agent-skills/auth0-java-mvc-common
auth0-java-mvc-common
Installation
...
After login, the callback servlet handles the response and redirects to /dashboard
Common Mistakes
Mistake	Fix
