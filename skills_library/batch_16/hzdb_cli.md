---
title: hzdb-cli
url: https://skills.sh/meta-quest/agentic-tools/hzdb-cli
---

# hzdb-cli

skills/meta-quest/agentic-tools/hzdb-cli
hzdb-cli
Installation
...
Device Management — device commands, screenshots, logs, shell access
App Management — app lifecycle, crash debugging, common log tags
Performance Tools — trace capture, frame budgets, SQL queries, GPU counters
