---
title: gate-exchange-launchpool
url: https://skills.sh/gate/gate-skills/gate-exchange-launchpool
---

# gate-exchange-launchpool

skills/gate/gate-skills/gate-exchange-launchpool
gate-exchange-launchpool
Installation
$ npx skills add https://github.com/gate/gate-skills --skill gate-exchange-launchpool
SKILL.md
...
Read and strictly follow references/gate-cli.md, then execute this skill's LaunchPool workflow.
