...
url: https://skills.sh/chaiwithjai/claude-code-mastery/standup-formatter
---

# standup-formatter

skills/chaiwithjai/claude-code-mastery/standup-formatter
standup-formatter
Installation
$ npx skills add https://github.com/chaiwithjai/claude-code-mastery --skill standup-formatter
SKILL.md
