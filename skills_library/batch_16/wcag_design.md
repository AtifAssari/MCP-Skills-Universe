---
title: wcag-design
url: https://skills.sh/alexsnchz/skills/wcag-design
---

# wcag-design

skills/alexsnchz/skills/wcag-design
wcag-design
Installation
$ npx skills add https://github.com/alexsnchz/skills --skill wcag-design
SKILL.md
WCAG-Design Skill
...
Dark Mode Note: Dark themes must still meet contrast ratios. Avoid pure black #000000 (causes halation/eye strain); use soft blacks like #0f0f0f or #121212. High-saturation colors on dark backgrounds may vibrate visually — reduce saturation.
...
Heading hierarchy rule: Never skip levels. <h1> → <h2> → <h3> (not h1 → h3). Multiple <h1> elements are acceptable but first should be page/section title.
...
Alt text: Every informative image has descriptive alt; decorative has alt=""
Keyboard: 100% of functionality reachable and operable via keyboard alone
Focus visible: Visible focus indicator that is never removed
Labels: Every form input has an associated visible <label>
Errors: Errors identified in text, not color alone; aria-invalid used; suggestions provided
Headings: Logical hierarchy, no skipped levels
Language: <html lang="..."> always set
Semantic HTML: Use <button>, <a>, <nav>, <main> etc., not <div> substitutes
No color-only info: Never use color as the sole means to convey any information
