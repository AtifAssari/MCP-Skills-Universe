---
title: mesh-wallet
url: https://skills.sh/meshjs/skills/mesh-wallet
---

# mesh-wallet

skills/meshjs/skills/mesh-wallet
mesh-wallet
Installation
$ npx skills add https://github.com/meshjs/skills --skill mesh-wallet
SKILL.md
...
Important Notes
Browser wallet requires user interaction - enable() prompts the user
Headless wallet needs fetcher - For UTxO queries and signing
