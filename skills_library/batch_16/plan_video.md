---
title: plan-video
url: https://skills.sh/kenneth-liao/ai-launchpad-marketplace/plan-video
---

# plan-video

skills/kenneth-liao/ai-launchpad-marketplace/plan-video
plan-video
Installation
...
Invoke creator-stack:research to conduct research first (YouTube MCP tools are available)
Planning Workflow
...
Common Pitfalls
Skipping skill invocation: Generating titles/thumbnails/hooks manually — the foundation skills have proven patterns you'd miss.
Single option: Only providing one recommendation — always provide all options so the user can choose.
Missing research: Starting without research — load research or invoke the research skill first.
Ignoring complementarity: Title/thumbnail/hook don't work together — verify alignment before finalizing.
No rationale: Recommendations without explanation — back everything with research insights.
...
Load research — Read ./youtube/episode/18_ai_agents_with_memory/research.md, extract key insights
Create plan file at ./youtube/episode/18_ai_agents_with_memory/plan.md
Invoke creator-stack:title — 3 title options focused on practical implementation
Invoke creator-stack:thumbnail — 2 concepts per title (6 total)
Present all options, user selects title + thumbnail pairing
Invoke creator-stack:hook — 3 hook strategies for selected pairing
User selects hook
Invoke creator-stack:write — high-level content outline
Invoke creator-stack:thumbnail — 3 AB testing thumbnails for final plan
Update plan file with complete final selections
