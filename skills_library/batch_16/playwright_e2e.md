...
url: https://skills.sh/darraghh1/my-claude-setup/playwright-e2e
---

# playwright-e2e

skills/darraghh1/my-claude-setup/playwright-e2e
playwright-e2e
Installation
...
Always use await for every Playwright action and assertion
Leverage page.waitForLoadState(), waitForSelector(), and waitForResponse() appropriately
Use expect() with Playwright's web-first assertions for automatic retries
Implement Page Object Model when tests become complex
Never use page.waitForTimeout() except as an absolute last resort
Chain actions logically: interact -> wait for response -> assert -> proceed
