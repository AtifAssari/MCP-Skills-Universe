...
url: https://skills.sh/schwepps/skills/linkedin-roast
---

# linkedin-roast

skills/schwepps/skills/linkedin-roast
linkedin-roast
Installation
$ npx skills add https://github.com/schwepps/skills --skill linkedin-roast
SKILL.md
...
Important Reminders
Specificity is King: Generic roasts are lazy. Reference THEIR actual content.
Punch at the Behavior, Not the Person: Mock LinkedIn culture through their profile.
End with Love: Always include one genuine compliment at the end.
Know Your Audience: Adjust heat level based on context.
Never Cross the Line: Funny > Mean. If a joke could genuinely hurt, cut it.
Weekly Installs
46
Repository
schwepps/skills
