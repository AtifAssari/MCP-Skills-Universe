...
url: https://skills.sh/vercel/vercel-plugin/benchmark-agents
---

# benchmark-agents

skills/vercel/vercel-plugin/benchmark-agents
benchmark-agents
Installation
...
Run gates — bun run typecheck && bun test && bun run validate
Release — bump version, bun run build, commit, push
