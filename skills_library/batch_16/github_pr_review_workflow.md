...
url: https://skills.sh/uwe-schwarz/skills/github-pr-review-workflow
---

# github-pr-review-workflow

skills/uwe-schwarz/skills/github-pr-review-workflow
github-pr-review-workflow
Installation
...
Resolve outdated threads (isOutdated: true) - no reply needed
Reply to active threads explaining fixes (or non-changes)
Wait up to 5 minutes for a response
Resolve active threads after confirmation or no response
...
Resources
gh-pr-review GitHub
GitHub GraphQL API: Pull Requests
