...
url: https://skills.sh/kenneth-liao/ai-launchpad-marketplace/business-competitor-analysis
---

# business-competitor-analysis

skills/kenneth-liao/ai-launchpad-marketplace/business-competitor-analysis
business-competitor-analysis
Installation
...
Workflow Overview
Extract business information from provided details or website
Define target customer profile (required)
Identify top 5 competitors via web search
Research each competitor across key dimensions
Identify market gaps and opportunities
Synthesize findings into structured report with citations
Step 1: Extract Business Information

If user provides a website URL:

Fetch the URL using web_fetch
Extract: company name, value proposition, target market, products/services, pricing (if visible), key differentiators

If user provides business details directly:

Parse the provided information
Identify any gaps that require web research to fill
