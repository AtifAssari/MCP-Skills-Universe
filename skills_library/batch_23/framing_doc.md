---
title: framing-doc
url: https://skills.sh/rjs/shaping-skills/framing-doc
---

# framing-doc

skills/rjs/shaping-skills/framing-doc
framing-doc
Installation
...
Which transcripts? Get specific file paths. Read them in the order the user specifies — conversation order often matters because ideas build across calls.
What's the topic area? A rough sense of what these conversations were about (e.g., "AI features," "onboarding redesign") so you know what to listen for.
...
Read each bullet
Ask: what's my evidence for this claim?
If the evidence is a direct quote — cite it parenthetically
If the evidence is implied — say so explicitly
If there's no evidence — drop the line
