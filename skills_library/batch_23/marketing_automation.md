...
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/marketing-automation
---

# marketing-automation

skills/indranilbanerjee/digital-marketing-pro/marketing-automation
marketing-automation
Installation
$ npx skills add https://github.com/indranilbanerjee/digital-marketing-pro --skill marketing-automation
SKILL.md
Marketing Automation
...
Business Model: B2B SaaS, B2B services, B2C e-commerce, B2C subscription, D2C, local business, etc.
Sales Motion: Product-led, sales-led, hybrid, or self-serve (determines automation complexity)
Current Platform: Which MAP is in use? CRM? CDP? (or is this a greenfield selection)
Lifecycle Stages: Are stages defined? What criteria determine each stage transition?
Lead Volume: Monthly inbound leads, website traffic, list size (determines scoring model complexity)
Sales Team Structure: SDRs, AEs, self-serve — who receives handoffs and at what threshold?
Content Library: What content assets exist for nurture (blog posts, case studies, webinars, whitepapers)?
Current Automations: What workflows already exist? Are they performing?
Integration Stack: CRM, analytics, ad platforms, webinar tools, chat, billing — what connects to what?
Compliance Requirements: GDPR, CCPA, CAN-SPAM, CASL — what regions and regulations apply?
...
Pull inventory of all active workflows, their trigger conditions, and current performance
Identify zombie workflows (active but no contacts entering), underperformers (low completion or conversion), and conflicts (overlapping triggers or suppression gaps)
Audit lead scoring accuracy by comparing score-to-conversion correlation
Review data hygiene (duplicate rates, field completeness, decay)
Assess deliverability health (bounce rates, spam complaints, authentication status)
