...
url: https://skills.sh/spjoshis/claude-code-plugins/excel-analysis
---

# excel-analysis

skills/spjoshis/claude-code-plugins/excel-analysis
excel-analysis
Installation
$ npx skills add https://github.com/spjoshis/claude-code-plugins --skill excel-analysis
SKILL.md
Excel Analysis
