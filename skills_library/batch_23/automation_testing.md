...
url: https://skills.sh/naodeng/awesome-qa-skills/automation-testing
---

# automation-testing

skills/naodeng/awesome-qa-skills/automation-testing
automation-testing
Installation
$ npx skills add https://github.com/naodeng/awesome-qa-skills --skill automation-testing
SKILL.md
...
How to Use
Open prompts/automation-testing.md and use it as the main prompt.
