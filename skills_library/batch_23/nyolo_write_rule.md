---
title: nyolo-write-rule
url: https://skills.sh/qdozaq/nyolo/nyolo-write-rule
---

# nyolo-write-rule

skills/qdozaq/nyolo/nyolo-write-rule
nyolo-write-rule
Installation
$ npx skills add https://github.com/qdozaq/nyolo --skill nyolo-write-rule
SKILL.md
...
What to match — a command, file path, URL, or search query pattern
Which tool — Bash, Edit, Write, WebFetch, WebSearch, or a combination (pipe-delimited, e.g. Write|Edit). Omit to match any tool.
What action — deny (block outright), ask (require confirmation), or allow (permit without prompt)
Why — a short reason shown to Claude when the rule triggers
