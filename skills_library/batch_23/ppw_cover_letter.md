---
title: ppw:cover-letter
url: https://skills.sh/lylll9436/paper-polish-workflow-skill/ppw:cover-letter
---

# ppw:cover-letter

skills/lylll9436/paper-polish-workflow-skill/ppw:cover-letter
ppw:cover-letter
Installation
...
Target journal — required; determines which template to load. Ask if not specified.
Paper file or text — required; for extracting paper title and key contribution. Ask for file path or paste if not provided.
Correspondence author details (name, email, institution) — required; ask as a single grouped question if not provided.
Data/code availability — optional; are datasets or code publicly available? If yes, ask for repository URLs. Default to "Data are not publicly available" if user declines or does not know.
...
Skill loads references/journals/ceus.md — extracts Aims & Scope.
Skill reads my_paper.tex — extracts title and key contribution.
Skill asks: "Please provide your name, email, and institution for the correspondence block."
Skill asks: "Are your data or code publicly available? If yes, please share the repository URL(s)."
Skill generates letter and writes to my_paper_cover_letter.md.
