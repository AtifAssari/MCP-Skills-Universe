---
title: sqs
url: https://skills.sh/claude-dev-suite/claude-dev-suite/sqs
---

# sqs

skills/claude-dev-suite/claude-dev-suite/sqs
sqs
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill sqs
SKILL.md
