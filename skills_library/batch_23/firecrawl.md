---
title: firecrawl
url: https://skills.sh/founderjourney/claude-skills/firecrawl
---

# firecrawl

skills/founderjourney/claude-skills/firecrawl
firecrawl
Installation
$ npx skills add https://github.com/founderjourney/claude-skills --skill firecrawl
SKILL.md
Firecrawl
Overview
...
Use firecrawl_scrape on the best results for full content
Analyze a Documentation Site
Use firecrawl_map to discover all pages
Use firecrawl_scrape on specific sections
Extract Product Information
Use firecrawl_extract with a prompt describing what to extract
