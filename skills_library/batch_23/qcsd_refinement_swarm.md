---
title: qcsd-refinement-swarm
url: https://skills.sh/proffesor-for-testing/agentic-qe/qcsd-refinement-swarm
---

# qcsd-refinement-swarm

skills/proffesor-for-testing/agentic-qe/qcsd-refinement-swarm
qcsd-refinement-swarm
Installation
...
Steps
Flag Detection -- steps/01-flag-detection.md -- Analyze story content, evaluate all 7 flags
Core Agents -- steps/02-core-agents.md -- Spawn qe-product-factors-assessor, qe-bdd-generator, qe-requirements-validator
Batch 1 Results -- steps/03-batch1-results.md -- Wait and extract metrics
Conditional Agents -- steps/04-conditional-agents.md -- Spawn flagged agents
Decision Synthesis -- steps/05-decision-synthesis.md -- Apply READY/CONDITIONAL/NOT-READY logic
Report Generation -- steps/06-report-generation.md -- Generate refinement report
Learning Persistence -- steps/07-learning-persistence.md -- Store findings to memory
Transformation -- steps/08-transformation.md -- Run test idea rewriter on all test ideas
Final Output -- steps/09-final-output.md -- Display completion summary
