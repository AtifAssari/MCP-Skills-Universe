---
title: ralph
url: https://skills.sh/q00/ouroboros/ralph
---

# ralph

skills/q00/ouroboros/ralph
ralph
Installation
...
On termination, display a next-step:
...
If user says "continue": call ouroboros_query_events(aggregate_id=<lineage_id>) to reconstruct iteration history from EventStore
