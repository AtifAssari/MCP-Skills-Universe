...
url: https://skills.sh/aaaaqwq/claude-code-skills/context-manager
---

# context-manager

skills/aaaaqwq/claude-code-skills/context-manager
context-manager
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill context-manager
SKILL.md
