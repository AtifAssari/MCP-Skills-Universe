---
title: pw-cover-image
url: https://skills.sh/plugins-world/pw-skills/pw-cover-image
---

# pw-cover-image

skills/plugins-world/pw-skills/pw-cover-image
pw-cover-image
Installation
$ npx skills add https://github.com/plugins-world/pw-skills --skill pw-cover-image
SKILL.md
封面图生成器
...
分析内容 → 提取主题、语气、关键词
确定选项 → 自动选择或使用指定的风格、宽高比
确认选项 → 一次性确认所有参数 (风格、宽高比、语言)
生成概念 → 创建标题和视觉元素
创建提示词 → 保存到 prompts/cover.md
生成图片 → 调用图片生成服务
输出摘要 → 显示结果和文件位置
...
生成: 使用提示词文件、输出路径和确认的宽高比调用选定的图片生成技能。
...
.pw-skills/pw-cover-image/EXTEND.md (项目级)
~/.pw-skills/pw-cover-image/EXTEND.md (用户级)
