---
title: upkuajing-trade-company-search
url: https://skills.sh/upkuajing/upkuajing-trade-company-search/upkuajing-trade-company-search
---

# upkuajing-trade-company-search

skills/upkuajing/upkuajing-trade-company-search/upkuajing-trade-company-search
upkuajing-trade-company-search
Installation
$ npx skills add https://github.com/upkuajing/upkuajing-trade-company-search --skill upkuajing-trade-company-search
SKILL.md
...
User doesn't have one: You can apply using the interface (auth.py --new_key), the new key will be automatically saved to ~/.upkuajing/.env Wait for user selection;
Account Top-up

When API response indicates insufficient balance, explain and guide user to top up:

Create top-up order (auth.py --new_rec_order)
Based on order response, send payment page URL to user, guide user to open URL and pay, user confirms after successful payment;
