...
url: https://skills.sh/cap-go/capgo-skills/capgo-live-updates
---

# capgo-live-updates

skills/cap-go/capgo-skills/capgo-live-updates
capgo-live-updates
Installation
...
Check notifyAppReady() is called
Verify app ID matches Capgo dashboard
Check channel assignment
Review Capgo dashboard logs
Issue: Rollback Loop
App crashes before notifyAppReady()
Fix: Ensure notifyAppReady() is called early
...
Use CDN (enterprise)
Best Practices
Always call notifyAppReady() - First thing after app initializes
