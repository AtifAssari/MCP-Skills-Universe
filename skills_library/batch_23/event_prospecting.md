...
Extract people — people.jsonl
Group by company — seed_companies.txt
...
bb search "{name} {company} linkedin" (always)
bb search "{name} podcast OR talk OR blog 2026" (deep+)
bb search "{name} github" (deeper)
bb search "{name} site:x.com OR site:twitter.com" (deeper)
