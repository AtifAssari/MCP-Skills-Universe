---
title: ripgrep
url: https://skills.sh/ratacat/claude-skills/ripgrep
---

# ripgrep

skills/ratacat/claude-skills/ripgrep
ripgrep
Installation
...
Use file types - -t py is faster than -g "*.py"
Use fixed strings - -F when you don't need regex
Limit depth - --max-depth when you know structure
Let gitignore work - Don't use --no-ignore unless needed
Use word boundaries - -w is optimized
Common Patterns
