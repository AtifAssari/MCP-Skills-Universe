---
title: help
url: https://skills.sh/q00/ouroboros/help
---

# help

skills/q00/ouroboros/help
help
Installation
$ npx skills add https://github.com/q00/ouroboros --skill help
SKILL.md
/ouroboros:help
...
Plugin = Works immediately after ooo setup. MCP = Requires ooo setup (Python >= 3.12 auto-detected). Run setup once to unlock all features.
