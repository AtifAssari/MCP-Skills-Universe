---
title: obs-cpp-qt-patterns
url: https://skills.sh/meriley/claude-code-skills/obs-cpp-qt-patterns
---

# obs-cpp-qt-patterns

skills/meriley/claude-code-skills/obs-cpp-qt-patterns
obs-cpp-qt-patterns
Installation
$ npx skills add https://github.com/meriley/claude-code-skills --skill obs-cpp-qt-patterns
SKILL.md
