---
title: paper-index
url: https://skills.sh/chang-pw/paper2obsidian_skill/paper-index
---

# paper-index

skills/chang-pw/paper2obsidian_skill/paper-index
paper-index
Installation
$ npx skills add https://github.com/chang-pw/paper2obsidian_skill --skill paper-index
SKILL.md
Paper Index
...
一篇论文可以属于多个分类（只要 tags 匹配多个分类规则）。 遇到无法归类的新 tag 时，自行创建合理的英文分类名。
