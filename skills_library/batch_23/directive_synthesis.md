...
url: https://skills.sh/qodex-ai/ai-agent-skills/directive-synthesis
---

# directive-synthesis

skills/qodex-ai/ai-agent-skills/directive-synthesis
directive-synthesis
Installation
...
allowed-tools includes correct Bash permissions
Using ! prefix: !command``
Backticks are correct: `command` not 'command'
