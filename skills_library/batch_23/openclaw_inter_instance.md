---
title: openclaw-inter-instance
url: https://skills.sh/aaaaqwq/claude-code-skills/openclaw-inter-instance
---

# openclaw-inter-instance

skills/aaaaqwq/claude-code-skills/openclaw-inter-instance
openclaw-inter-instance
Installation
...
派活即走 — sessions_send 不带 timeoutSeconds（或设为 1-5s），发完指令立刻做下一件事
不转发 — 员工自己在群里发消息，你不替他们转发回复
