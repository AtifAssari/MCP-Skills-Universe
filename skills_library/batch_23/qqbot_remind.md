---
title: qqbot-remind
url: https://skills.sh/sliverp/qqbot/qqbot-remind
---

# qqbot-remind

skills/sliverp/qqbot/qqbot-remind
qqbot-remind
Installation
$ npx skills add https://github.com/sliverp/qqbot --skill qqbot-remind
SKILL.md
QQ Bot 定时提醒
⚠️ 强制规则
...
调用 qqbot_remind：{ "action": "add", "content": "喝水", "time": "5m" }
收到返回的 cronParams → 立即调用 cron 工具，参数为该 cronParams
回复用户：⏰ 好的，5分钟后提醒你喝水~
备用方案（直接使用 cron 工具）
