---
title: qcsd-development-swarm
url: https://skills.sh/proffesor-for-testing/agentic-qe/qcsd-development-swarm
---
...
Steps
Flag Detection -- steps/01-flag-detection.md -- Scan source code and tests, detect all 6 flags
Core Agents -- steps/02-core-agents.md -- Spawn qe-tdd-specialist, qe-code-complexity, qe-coverage-specialist in parallel
...
Decision Synthesis -- steps/05-decision-synthesis.md -- Apply SHIP/CONDITIONAL/HOLD logic
...
Defect Predictor -- steps/08-defect-predictor.md -- Run qe-defect-predictor analysis on all code changes
Final Output -- steps/09-final-output.md -- Display completion summary with all scores
Execution Instructions
Use the Read tool to load the current step file (e.g., Read({ file_path: ".claude/skills/qcsd-development-swarm/steps/01-flag-detection.md" }))
