...
url: https://skills.sh/crossoverjie/skills/agent-notifier
---

# agent-notifier

skills/crossoverjie/skills/agent-notifier
agent-notifier
Installation
$ npx skills add https://github.com/crossoverjie/skills --skill agent-notifier
SKILL.md
