...
url: https://skills.sh/didi/mpx/changelog-generator
---

# changelog-generator

skills/didi/mpx/changelog-generator
changelog-generator
Installation
$ npx skills add https://github.com/didi/mpx --skill changelog-generator
SKILL.md
创建版本变更日志
...
New Features：当前版本的新增功能与特性，按需可选生成
Bug Fixes：当前版本修复的bug，按需可选生成
Packages：当前版本涉及的npm包版本变更记录，通常可以从当前活跃终端的日志信息中查询到，如无法获取到准确信息可以留空
