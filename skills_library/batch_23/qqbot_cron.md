---
title: qqbot-cron
url: https://skills.sh/tencent-connect/openclaw-qqbot/qqbot-cron
---

# qqbot-cron

skills/tencent-connect/openclaw-qqbot/qqbot-cron
qqbot-cron
Installation
$ npx skills add https://github.com/tencent-connect/openclaw-qqbot --skill qqbot-cron
SKILL.md
QQ Bot 定时提醒
⚠️ 强制规则
...
周期任务不加 deleteAfterRun。群聊 to 格式为 "group:{group_openid}"。
