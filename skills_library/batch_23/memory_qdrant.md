---
title: memory-qdrant
url: https://skills.sh/zuiho-kai/openclaw-memory-qdrant/memory-qdrant
---

# memory-qdrant

skills/zuiho-kai/openclaw-memory-qdrant/memory-qdrant
memory-qdrant
Installation
$ npx skills add https://github.com/zuiho-kai/openclaw-memory-qdrant --skill memory-qdrant
SKILL.md
memory-qdrant
