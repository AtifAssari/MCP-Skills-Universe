---
title: pnp-markets-solana
url: https://skills.sh/pnp-protocol/solana-skill/pnp-markets-solana
---
...
Resources
PNP SDK: pnp-sdk on npm
PNP Docs: docs.pnp.exchange/pnp-sdk
Mainnet Explorer: Solscan
SDK Documentation: references/api-reference.md
Types & Precision: references/types-and-precision.md
PDA & Addresses: references/program-addresses.md
