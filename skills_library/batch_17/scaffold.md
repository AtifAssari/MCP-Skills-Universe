---
title: scaffold
url: https://skills.sh/keiji-miyake/agent-skills/scaffold
---

# scaffold

skills/keiji-miyake/agent-skills/scaffold
scaffold
Installation
...
Action: 以下のテンプレートを使用して AGENTS.md を作成してください。
...
[!TIP] 一般的なスキル: dev-support, architect, developer, qa, devops など。 Tech Stack固有のスキルがある場合はそれらも提案してください。
