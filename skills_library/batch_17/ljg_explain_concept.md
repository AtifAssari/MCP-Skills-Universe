---
title: ljg-explain-concept
url: https://skills.sh/lijigang/ljg-explain-concept/ljg-explain-concept
---

# ljg-explain-concept

skills/lijigang/ljg-explain-concept/ljg-explain-concept
ljg-explain-concept
Installation
$ npx skills add https://github.com/lijigang/ljg-explain-concept --skill ljg-explain-concept
SKILL.md
Usage
Instructions
...
将结果写入 ~/Documents/notes/{timestamp}--概念解剖-{概念名}__concept.org。
向用户报告文件路径，任务完成。
Weekly Installs
33
Repository
lijigang/ljg-ex…-concept
GitHub Stars
199
First Seen
Feb 12, 2026
