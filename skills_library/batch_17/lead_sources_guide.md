...
url: https://skills.sh/sachacoldiq/coldiq-s-gtm-skills/lead-sources-guide
---

# lead-sources-guide

skills/sachacoldiq/coldiq-s-gtm-skills/lead-sources-guide
lead-sources-guide
Installation
$ npx skills add https://github.com/sachacoldiq/coldiq-s-gtm-skills --skill lead-sources-guide
SKILL.md
...
Mix sources - Don't rely on just one
Scraping = step 1 - Still need Clay enrichment
Templates are modular - Adjust for campaign goals
Don't reinvent the wheel - Start with template, tweak
