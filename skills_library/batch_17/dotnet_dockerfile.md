---
title: dotnet-dockerfile
url: https://skills.sh/jkappers/agent-skills/dotnet-dockerfile
---

# dotnet-dockerfile

skills/jkappers/agent-skills/dotnet-dockerfile
dotnet-dockerfile
Installation
...
Locate project file path (e.g., src/MyApp/MyApp.csproj)
Choose optimization: standard, chiseled (smaller), or native AOT (smallest/fastest startup)
