---
title: email-drafter
url: https://skills.sh/rysweet/amplihack/email-drafter
---

# email-drafter

skills/rysweet/amplihack/email-drafter
email-drafter
Installation
$ npx skills add https://github.com/rysweet/amplihack --skill email-drafter
SKILL.md
Email Drafter Skill
...
Opening: What period/project this covers
Completed items: What was accomplished
In-progress items: Current work
Upcoming items: What's next
Blockers/Issues: Any challenges (if applicable)
Closing: Invitation for questions/discussion
...
Context: Why this request is important
What's being asked: Clear, specific request
Why it matters: Benefits or urgency
Timeline: When needed
Next steps: How to respond
Closing: Appreciation and contact info
...
Hook: Lead with the announcement
Context: Why this change/news matters
Details: Specific information
Impact: How it affects recipients
Next steps: What recipients should know/do
Closing: Point of contact for questions
...
Reference: What previous conversation/commitment this relates to
Update: What's happened since
Call to action: What's needed next
Offer to help: Your contribution/availability
...
Appreciation: Thank them for reaching out
Answer: Direct response to their question/request
Details: Additional relevant information
Next steps: How to proceed
Closing: Reaffirm helpfulness
...
Outstanding issues: What still needs resolution
Closing: Confirmation and next meeting
...
Be Specific: Provide concrete details rather than vague summaries
Include Priorities: Highlight what matters most if information is extensive
Clarify Action Items: Specify who should do what and by when
Provide Context: Help Claude understand why this information matters
Specify Recipients: Mention if email is for executives, teammates, or external parties
