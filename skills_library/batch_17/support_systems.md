...
url: https://skills.sh/jk-0001/skills/support-systems
---

# support-systems

skills/jk-0001/skills/support-systems
support-systems
Installation
$ npx skills add https://github.com/jk-0001/skills --skill support-systems
SKILL.md
Support Systems
Overview
...
Getting Started (how to sign up, onboard, and get to first value)
FAQ (top 10-15 questions you get asked repeatedly)
Feature Guides (how to use each major feature)
Troubleshooting (common errors and how to fix them)
Billing / Account (how to upgrade, cancel, update payment)
...
P0 - Critical (site down, major bug, account locked): Drop everything, fix now
P1 - High (billing issue, feature not working): Respond within 4 hours
P2 - Normal (questions, minor bugs): Respond within 24 hours
P3 - Low (feature requests, general feedback): Respond within 48 hours

Triage workflow:

Read subject line → tag with category + priority
Quick answer → reply immediately (< 2 min)
Longer answer → move to dedicated support block
Needs investigation → flag for later, send acknowledgment: "Looking into this — will update you by [timeframe]"
