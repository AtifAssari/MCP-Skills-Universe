...
url: https://skills.sh/blink-new/claude/wysiwyg-editor
---

# wysiwyg-editor

skills/blink-new/claude/wysiwyg-editor
wysiwyg-editor
Installation
...
Lists may not show bullets/numbers without explicit list-disc/list-decimal
Left padding (pl-5 or pl-6) is required for list markers to be visible
Without prose-li:my-0, list items have excessive vertical spacing
