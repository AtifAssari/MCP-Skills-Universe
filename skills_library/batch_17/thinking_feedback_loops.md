...
url: https://skills.sh/tjboudreaux/cc-thinking-skills/thinking-feedback-loops
---

# thinking-feedback-loops

skills/tjboudreaux/cc-thinking-skills/thinking-feedback-loops
thinking-feedback-loops
Installation
...
Specific loop identification techniques (vs. general systems mapping)
Meadows' leverage point hierarchy (vs. general intervention ideas)
Pattern library (exponential, oscillating, limits to growth, etc.)
Delay analysis methodology (root cause of oscillation)
