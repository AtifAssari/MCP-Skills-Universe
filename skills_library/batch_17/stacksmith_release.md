---
title: stacksmith-release
url: https://skills.sh/timlai666/skills/stacksmith-release
---

# stacksmith-release

skills/timlai666/skills/stacksmith-release
stacksmith-release
Installation
$ npx skills add https://github.com/timlai666/skills --skill stacksmith-release
SKILL.md
Command routing
...
Step 1 - Pre-flight
If BRANCH == BASE: abort with "You're on the base branch. Ship from a feature branch."
git status - if uncommitted changes exist, describe them and ask whether to commit, stash, or abort.
...
trace every function, branch, and error path
...
Step 1 - Pre-flight
If no PR found: ask for the PR number or URL.
Validate PR state:
...
Tell the user what PR was found and current CI status.
...
show the exact diff you're about to make
ask: "Update this? (A: yes / B: no / C: show more context)"
on yes: apply change
commit: git commit -m "docs: update [filename] - [what changed and why]"
