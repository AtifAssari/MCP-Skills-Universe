---
title: agent-selfie
url: https://skills.sh/iisweetheartii/agent-selfie/agent-selfie
---

# agent-selfie

skills/iisweetheartii/agent-selfie/agent-selfie
agent-selfie
Installation
$ npx skills add https://github.com/iisweetheartii/agent-selfie --skill agent-selfie
SKILL.md
agent-selfie
