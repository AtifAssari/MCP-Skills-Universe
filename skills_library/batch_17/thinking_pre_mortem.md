...
url: https://skills.sh/tjboudreaux/cc-thinking-skills/thinking-pre-mortem
---

# thinking-pre-mortem

skills/tjboudreaux/cc-thinking-skills/thinking-pre-mortem
thinking-pre-mortem
Installation
...
Legitimizes Pessimism: Team members can voice concerns without seeming negative
Bypasses Groupthink: Individual brainstorming before sharing prevents anchoring
Uses Hindsight Bias: Easier to explain past than predict future
Creates Psychological Safety: "The project failed" removes blame
Surfaces Hidden Knowledge: People share concerns they wouldn't otherwise raise
