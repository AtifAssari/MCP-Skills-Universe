...
url: https://skills.sh/sachacoldiq/coldiq-s-gtm-skills/cold-call-scripts
---

# cold-call-scripts

skills/sachacoldiq/coldiq-s-gtm-skills/cold-call-scripts
cold-call-scripts
Installation
$ npx skills add https://github.com/sachacoldiq/coldiq-s-gtm-skills --skill cold-call-scripts
SKILL.md
Cold Call Scripts

For objection responses, see references/objections.md.
