...
url: https://skills.sh/jdforsythe/forge/mission-planner
---

# mission-planner

skills/jdforsythe/forge/mission-planner
mission-planner
Installation
$ npx skills add https://github.com/jdforsythe/forge --skill mission-planner
SKILL.md
Mission Planner
...
Phase 4: Finalize
Log library usage. IF any library items were loaded (agents, templates, skills): Append usage record to usage-log.jsonl with: timestamp, item loaded, goal context, modifications made.
Output Format
