---
title: swiftui-simulator-ui
url: https://skills.sh/vladimirbrejcha/ios-ai-skills/swiftui-simulator-ui
---

# swiftui-simulator-ui

skills/vladimirbrejcha/ios-ai-skills/swiftui-simulator-ui
swiftui-simulator-ui
Installation
...
Project builds successfully (run xcodebuild -list to verify)
...
Run the UI feedback loop after making changes
Capture a screenshot
Include the screenshot path in your handoff file
...
Key Principles
Always verify visually - Don't assume UI code is correct; run it and see
Use consistent device - Pick one simulator and stick with it for consistency
Clean screenshots - Override status bar for professional captures
Test edge cases - Dark mode, small screens, Dynamic Type
Document with screenshots - Include paths in handoffs for traceability
Weekly Installs
9
Repository
vladimirbrejcha…i-skills
GitHub Stars
11
First Seen
Jan 31, 2026
