---
title: form builder
url: https://skills.sh/jmsktm/claude-settings/form-builder
---

# form builder

skills/jmsktm/claude-settings/Form Builder
Form Builder
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Form Builder'
SKILL.md
Form Builder
