---
title: lazycat-auth-integration
url: https://skills.sh/whoamihappyhacking/lazycat-skills/lazycat-auth-integration
---
...
声明 OIDC 回调路径 (application.oidc_redirect_path)。系统只要检测到这个字段，就会在部署时自动注入相关的环境变量。
将系统生成的 OIDC 环境变量传递给应用。
