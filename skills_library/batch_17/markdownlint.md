---
title: markdownlint
url: https://skills.sh/jcardif/agent-skills/markdownlint
---

# markdownlint

skills/jcardif/agent-skills/markdownlint
markdownlint
Installation
$ npx skills add https://github.com/jcardif/agent-skills --skill markdownlint
SKILL.md
Markdownlint
...
.markdownlint-cli2.jsonc / .markdownlint-cli2.yaml (full CLI config)
.markdownlint.jsonc / .markdownlint.json / .markdownlint.yaml (rules only)
Inline HTML comment directives in the file itself
Inline directives
...
Write or edit the markdown content
Run the linter: npx markdownlint-cli2 "path/to/file.md"
If errors are found:
...
If a rule should be permanently disabled, update .markdownlint.json
For one-off exceptions, use inline directives
Tips
