...
url: https://skills.sh/jmsktm/claude-settings/expense-tracker
---

# expense tracker

skills/jmsktm/claude-settings/Expense Tracker
Expense Tracker
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Expense Tracker'
SKILL.md
Expense Tracker
