---
title: manuscript-writing-review
url: https://skills.sh/labarba/sciwrite/manuscript-writing-review
---

# manuscript-writing-review

skills/labarba/sciwrite/manuscript-writing-review
manuscript-writing-review
Installation
...
Spot the pattern: "to-be" verb + past participle ("was observed," "were analyzed")
Identify the actor: Who performed the action? Default to "We" if the authors did it.
Reconstruct as Subject–Verb–Object.
...
Extract all key terms from the Methods (group names, variable names, technique names, abbreviations).
Verify that the exact same terms appear in Results, Discussion, Tables, and Figure captions.
Flag every instance where a synonym was substituted for a defined term.
...
Show a revised version with all five passes applied
Explain the key changes made and why
