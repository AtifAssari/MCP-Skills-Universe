...
url: https://skills.sh/masslab-sii/open-agent-skills/shopping-browser-automation
---

# shopping-browser-automation

skills/masslab-sii/open-agent-skills/shopping-browser-automation
shopping-browser-automation
Installation
...
Usage Principles
Prefer combined skills for fixed workflows: e.g., advanced search, add quantity to cart, fill forms
Use basic tools flexibly for changing scenarios: e.g., click, input, select and other atomic operations
Make good use of snapshot() to understand page state: confirm state before and after critical steps
Weekly Installs
44
Repository
masslab-sii/ope…t-skills
GitHub Stars
132
First Seen
Feb 10, 2026
