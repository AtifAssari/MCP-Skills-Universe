---
title: linkedin
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/linkedin
---

# linkedin

skills/manojbajaj95/claude-gtm-plugin/linkedin
linkedin
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill linkedin
SKILL.md
LinkedIn

Two modes — often used together:

Profile Audit — analyze and optimize your LinkedIn profile (photo, headline, About, experience, skills, SSI, engagement rate)
Content Creation — write high-engagement posts, build thought leadership, grow your audience
...
Executive Summary
Classification (Industry, Profile Type, Target Audience)
Profile Scorecard
Calculated Metrics (Engagement Rate, SSI)
