...
url: https://skills.sh/absolutelyskilled/absolutelyskilled/localization-i18n
---

# localization-i18n

skills/absolutelyskilled/absolutelyskilled/localization-i18n
localization-i18n
Installation
...
Never concatenate translated strings - String concatenation breaks in languages with different word order. Use ICU MessageFormat placeholders instead: "Hello, {name}" not "Hello, " + name. This is the single most common i18n bug.
...
Locale is not language - en-US and en-GB are the same language but format dates, currencies, and numbers differently. Always use full BCP 47 locale tags (language-region), not just language codes.

Pluralization is not just singular/plural - English has 2 plural forms. Arabic has 6. Polish has 4. Russian has 3. Always use CLDR plural rules through ICU MessageFormat rather than count === 1 ? "item" : "items" conditionals.
