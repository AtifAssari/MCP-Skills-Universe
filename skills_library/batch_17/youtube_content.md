...
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/youtube-content
---

# youtube-content

skills/manojbajaj95/claude-gtm-plugin/youtube-content
youtube-content
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill youtube-content
SKILL.md
YouTube Content Planning

Two modes in one skill:

Hook Creation — Design or review the opening 5–30 seconds for maximum retention
Video Planning — Orchestrate title, thumbnail, and hook into a complete production-ready plan
When to Use
