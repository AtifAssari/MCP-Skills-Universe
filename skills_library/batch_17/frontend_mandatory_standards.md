---
title: frontend-mandatory-standards
url: https://skills.sh/giikin/skills/frontend-mandatory-standards
---

# frontend-mandatory-standards

skills/giikin/skills/frontend-mandatory-standards
frontend-mandatory-standards
Installation
...
使用流程
如果提供了接口地址，第一步找到 @/api/xxx/controller 中定义的请求方法
仔细阅读接口文件中的类型定义，不要自己编参数
根据场景选择 useXxx 版本或原始版本
下拉框、单选框等数据源可从接口文档注释获取，获取后在 useXxxOptions 中抽离复用
