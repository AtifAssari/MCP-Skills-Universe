---
title: 1k-i18n
url: https://skills.sh/onekeyhq/app-monorepo/1k-i18n
---

# 1k-i18n

skills/onekeyhq/app-monorepo/1k-i18n
1k-i18n
Installation
$ npx skills add https://github.com/onekeyhq/app-monorepo --skill 1k-i18n
SKILL.md
...
Design provides translation key like prime::restore_purchases
Run sync command: yarn fetch:locale
Convert key format: prime::restore_purchases → ETranslations.prime_restore_purchases
Use in code:
