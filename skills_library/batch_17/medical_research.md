...
url: https://skills.sh/gexijin/vibe/medical-research
---

# medical-research

skills/gexijin/vibe/medical-research
medical-research
Installation
...
Run: python3 .claude/skills/medical-research/pubmed_search.py "immunotherapy melanoma"
Analyze ~10 recent papers
...
Save as Research_Summary_Immunotherapy_Melanoma_2025-12-13.md
...
Run: python3 .claude/skills/medical-research/pubmed_search.py "Alzheimer's disease pathogenesis"
Synthesize findings on amyloid, tau, inflammation, genetic factors
...
Run: python3 .claude/skills/medical-research/pubmed_search.py "CRISPR gene therapy clinical trials"
Focus on clinical applications, safety, efficacy
