---
title: ascii-diagram-boxflow
url: https://skills.sh/teachingai/full-stack-skills/ascii-diagram-boxflow
---

# ascii-diagram-boxflow

skills/teachingai/full-stack-skills/ascii-diagram-boxflow
ascii-diagram-boxflow
Installation
$ npx skills add https://github.com/teachingai/full-stack-skills --skill ascii-diagram-boxflow
SKILL.md
...
Line width <= width; no trailing spaces
Long node names must be truncated or wrapped consistently
Keywords
