...
url: https://skills.sh/hieutrtr/ai1-skills/ui-design-system
---

# ui-design-system

skills/hieutrtr/ai1-skills/ui-design-system
ui-design-system
Installation
...
Read tailwind.config.ts (or .js) for custom theme extensions
Read src/styles/globals.css or app/globals.css for CSS custom properties
Read components.json if shadcn/ui is configured
...
Visible label or aria-label: <Button aria-label="Close dialog">X</Button>
Focus indicator: Tailwind's ring utilities: focus-visible:ring-2 focus-visible:ring-ring
Keyboard access: Reachable via Tab, activatable via Enter/Space
Disabled state: Both visual and aria-disabled or disabled attribute
ARIA Patterns
