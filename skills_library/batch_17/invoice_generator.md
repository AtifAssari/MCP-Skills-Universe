...
url: https://skills.sh/jmsktm/claude-settings/invoice-generator
---

# invoice generator

skills/jmsktm/claude-settings/Invoice Generator
Invoice Generator
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Invoice Generator'
SKILL.md
Invoice Generator
