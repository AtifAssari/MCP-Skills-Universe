---
title: stacksmith-qa
url: https://skills.sh/timlai666/skills/stacksmith-qa
---

# stacksmith-qa

skills/timlai666/skills/stacksmith-qa
stacksmith-qa
Installation
...
locate root cause first
write the minimal fix
write a regression test that would have caught this specific bug
commit atomically:
git add -p
