---
title: litestar-responses
url: https://skills.sh/alti3/litestar-skills/litestar-responses
---

# litestar-responses

skills/alti3/litestar-skills/litestar-responses
litestar-responses
Installation
...
Responses
Execution Workflow
Start with the simplest return form that matches the contract: plain typed data, Response[T], or a specialized response container.
Set status code, media type, headers, and cookies explicitly when defaults are not enough.
...
For plain typed returns, Response[T], status codes, layered response_class, custom response classes, and background tasks, read references/response-basics.md.
For headers, cookies, redirects, files, streams, SSE, templates, and ASGI app returns, read references/response-containers.md.
