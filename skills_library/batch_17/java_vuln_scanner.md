---
title: java-vuln-scanner
url: https://skills.sh/ruoji6/java-audit-skills/java-vuln-scanner
---

# java-vuln-scanner

skills/ruoji6/java-audit-skills/java-vuln-scanner
java-vuln-scanner
Installation
...
输出为单个文件 — 不得拆分为多个文件
文件命名格式: {project_name}_vuln_report_{YYYYMMDD_HHMMSS}.md
必须严格按照 references/OUTPUT_TEMPLATE.md 模板填充输出
不得增删章节、不得调整章节顺序
