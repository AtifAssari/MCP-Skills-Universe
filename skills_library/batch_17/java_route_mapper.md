---
title: java-route-mapper
url: https://skills.sh/ruoji6/java-audit-skills/java-route-mapper
---

# java-route-mapper

skills/ruoji6/java-audit-skills/java-route-mapper
java-route-mapper
Installation
...
反编译该 namespace 下所有 Action 类（排除 getter/setter、ActionSupport 继承方法）
输出模式族 + 实例列表：
...
主索引包含各详情文件的相对子目录路径（如 admin/myapp_module_admin_xxx.md）
详情文件顶部注明所属模块和生成时间
