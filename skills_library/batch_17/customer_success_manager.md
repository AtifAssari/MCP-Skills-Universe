...
url: https://skills.sh/jmsktm/claude-settings/customer-success-manager
---

# customer success manager

skills/jmsktm/claude-settings/Customer Success Manager
Customer Success Manager
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Customer Success Manager'
SKILL.md
Customer Success Manager
