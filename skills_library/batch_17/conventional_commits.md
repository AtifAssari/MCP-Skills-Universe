...
url: https://skills.sh/jgamaraalv/ts-dev-kit/conventional-commits
---

# conventional-commits

skills/jgamaraalv/ts-dev-kit/conventional-commits
conventional-commits
Installation
...
<live_context> Staged changes (summary): !git diff --cached --stat 2>/dev/null || echo "(nothing staged)"
