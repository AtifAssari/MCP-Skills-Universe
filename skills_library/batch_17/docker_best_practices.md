...
url: https://skills.sh/hieutrtr/ai1-skills/docker-best-practices
---

# docker-best-practices

skills/hieutrtr/ai1-skills/docker-best-practices
docker-best-practices
Installation
...
Never use latest tag -- always pin major.minor version
Prefer -slim variants for Python (avoids musl issues)
Prefer -alpine variants for Node.js and Nginx (smaller images)
...
Never deploy using latest tag -- always use the SHA tag
Use latest only as a convenience alias after a successful production deploy
