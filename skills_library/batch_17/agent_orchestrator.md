...
url: https://skills.sh/jmsktm/claude-settings/agent-orchestrator
---

# agent orchestrator

skills/jmsktm/claude-settings/Agent Orchestrator
Agent Orchestrator
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Agent Orchestrator'
SKILL.md
Agent Orchestrator
