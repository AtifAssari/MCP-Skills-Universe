...
url: https://skills.sh/jdevalk/skills/metadata-check
---

# metadata-check

skills/jdevalk/skills/metadata-check
metadata-check
Installation
...
Open Graph description: usually shown at ~200 chars. Anything past the cut should be disposable, not a key promise.
