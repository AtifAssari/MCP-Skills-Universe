---
title: script writer
url: https://skills.sh/jmsktm/claude-settings/script-writer
---

# script writer

skills/jmsktm/claude-settings/Script Writer
Script Writer
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Script Writer'
SKILL.md
Script Writer
...
Hook Development - Write attention-grabbing first 10 seconds
Value Promise - Clearly state what viewer will learn/gain
Content Structure - Organize into clear segments with timestamps
Visual Cues - Note B-roll, graphics, screenshots needed
Engagement Triggers - Add prompts for likes, comments, subscribes
Call-to-Action - End with clear next step for viewer
Time Optimization - Hit target length without filler
Workflow 2: Podcast Episode Script
Intro & Positioning - Open with episode topic and guest intro
Question Flow - Structure interview questions for natural conversation
Segment Breaks - Plan ad placement and transition points
Sound Design Notes - Mark music, sound effects, editing cues
Story Integration - Weave anecdotes and examples throughout
Outro & Promotion - Thank guests, preview next episode, calls-to-action
Show Notes - Create companion text with links and references
Workflow 3: Presentation Script
Opening Impact - Create memorable start that sets tone
Slide Alignment - Write narration that complements visuals, not duplicates
Transition Phrases - Smooth bridges between sections
Story Weaving - Integrate case studies and examples
Audience Interaction - Plan questions, polls, discussion moments
Timing Marks - Note where to pause, speed up, emphasize
Strong Close - End with memorable takeaway and clear action
Workflow 4: Short-Form Video (Ads, Reels, TikTok)
Pattern Interrupt - Open with unexpected visual or statement
Quick Value - Deliver core message in first 3 seconds
Visual Storytelling - Write minimal, punchy text overlay
Hook Maintenance - Keep attention through constant movement
Sound Integration - Align script with trending audio/music
CTA Clarity - Make action obvious and frictionless
Platform Optimization - Adapt for vertical, platform-specific features
Quick Reference
