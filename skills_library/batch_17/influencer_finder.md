...
url: https://skills.sh/jmsktm/claude-settings/influencer-finder
---

# influencer finder

skills/jmsktm/claude-settings/Influencer Finder
Influencer Finder
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Influencer Finder'
SKILL.md
Influencer Finder
...
Criteria Definition - Ideal influencer profile
Platform Selection - Where your audience engages
Search Strategy - Hashtags, keywords, competitors
Tool Utilization - Platforms for influencer search
Initial List Building - Broad candidate pool
Quick Qualification - First-pass filtering
Shortlist Creation - Top candidates for evaluation
Workflow 2: Influencer Evaluation
Audience Demographics - Who follows them
Engagement Rate Calculation - True engagement vs vanity metrics
Content Quality Assessment - Production value, authenticity
Brand Alignment Check - Values and positioning fit
Past Partnership Review - How they work with brands
Fake Follower Detection - Audience authenticity
Scoring and Ranking - Objective comparison
Workflow 3: Partnership Structuring
Campaign Objectives - What you want to achieve
Deliverable Definition - Posts, stories, videos, etc.
Compensation Model - Flat fee, performance, product
Rights and Usage - Content ownership and reuse
Exclusivity Terms - Competitor restrictions
Timeline Planning - Campaign schedule
Contract Essentials - Key terms to include
Workflow 4: Influencer Relationship Management
Outreach Strategy - How to approach influencers
Brief Development - Creative direction that allows authenticity
Communication Protocol - How to work together
Content Review Process - Approval workflow
Performance Tracking - Measure campaign results
Relationship Nurturing - Build long-term partnerships
Program Optimization - Learn and improve
Quick Reference
