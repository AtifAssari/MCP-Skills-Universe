...
url: https://skills.sh/jmsktm/claude-settings/sprint-planner
---

# sprint planner

skills/jmsktm/claude-settings/Sprint Planner
Sprint Planner
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Sprint Planner'
SKILL.md
Sprint Planner
...
Pre-Planning Preparation (before ceremony)
