---
title: test
url: https://skills.sh/webriq/claude-skills/test
---

# test

skills/webriq/claude-skills/test
test
Installation
$ npx skills add https://github.com/webriq/claude-skills --skill test
SKILL.md
...
Create .mcp.json in your project root (not in .claude/ or subdirectories):
...
Restart Claude Code (required after adding/modifying .mcp.json)

Verify MCP is active - you should see mcp__playwright__browser_* tools available
...
Do NOT fall back to curl commands or source code inspection as a substitute for browser testing. This produces misleading test reports.
CI Mode (--ci flag)
...
How to check for Playwright MCP: Look for tools starting with mcp__playwright__browser_ in your available tools. If you see tools like mcp__playwright__browser_navigate, mcp__playwright__browser_click, etc., Playwright MCP is available.
...
## Implementation Notes — written by /simplify, contains exactly how to access and test what was built (URL, credentials, setup). Use this as your execution guide.
## Acceptance Criteria — written by /task, contains the specific Given/When/Then scenarios to verify. These are your test cases.
If ## Implementation Notes is missing (older tasks), fall back to ## Requirements and ## File Changes.
...
vercel-react-best-practices	vercel-labs/agent-skills	React/Next.js debugging
supabase-postgres-best-practices	supabase/agent-skills	Database-related test issues
Weekly Installs
31
Repository
