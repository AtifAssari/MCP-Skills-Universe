---
title: bootstrap
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/bootstrap
---

# bootstrap

skills/manojbajaj95/claude-gtm-plugin/bootstrap
bootstrap
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill bootstrap
SKILL.md
...
Check if BRAND.md, SOUL.md, MEMORY.md, artifacts/, or archive/ exist in the working directory
If any exist: read their contents, merge into the corresponding new file (or create it), then delete the old file/folder
If none exist: skip this phase entirely — no action needed
If a new-format file already exists (e.g., strategy/brand.md), merge the old content into it rather than overwriting
