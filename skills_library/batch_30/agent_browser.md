---
title: agent-browser
url: https://skills.sh/ansarullahanasz360/cc-guide/agent-browser
---

# agent-browser

skills/ansarullahanasz360/cc-guide/agent-browser
agent-browser
Installation
$ npx skills add https://github.com/ansarullahanasz360/cc-guide --skill agent-browser
SKILL.md
Agent Browser CLI
...
Best Practices
Always use sessions for test isolation
Use snapshots to get element refs before interactions
Wait for elements before interacting with dynamic content
Take screenshots at key checkpoints for debugging
Clean up sessions with close when done
