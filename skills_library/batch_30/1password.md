---
title: 1password
url: https://skills.sh/julianobarbosa/claude-code-skills/1password
---

# 1password

skills/julianobarbosa/claude-code-skills/1password
1password
Installation
...
Credentials file (1password-credentials.json)
...
Best Practices
Use secret references (op://) instead of hardcoding vault/item names in scripts
