...
url: https://skills.sh/the1studio/theone-training-skills/github-pr-review
---

# github-pr-review

skills/the1studio/theone-training-skills/github-pr-review
github-pr-review
Installation
...
Apply general checklists (Review Checklists)
Trigger tech-specific skill (e.g., theone-unity-standards) for detailed analysis
Create inline suggestions using github-pr-review
Submit review decision (APPROVE/REQUEST_CHANGES) per Approval Criteria
Developer applies suggestions via GitHub UI
Review Process
...
🔒 Security checklist (secrets, injection, auth)
✅ Correctness checklist (logic, state, API)
🧪 Testing checklist (coverage, quality)
🧹 Quality checklist (structure, DRY)
⚡ Performance checklist (queries, memory)
...
✅ Applies technology-agnostic review checklists
✅ Fetches PR details and diff
✅ Analyzes code against standards (general + tech-specific)
✅ Creates inline suggestions with ````suggestion` blocks
✅ Uses GitHub API for programmatic comments
✅ Submits review decision (APPROVE/REQUEST_CHANGES)
✅ Enables one-click fixes via GitHub UI
...
TheOne Studio Standards
ClaudeAssistant Repository
Weekly Installs
17
Repository
