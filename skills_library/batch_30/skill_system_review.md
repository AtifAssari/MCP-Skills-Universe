---
title: skill-system-review
url: https://skills.sh/arthur0824hao/skills/skill-system-review
---

# skill-system-review

skills/arthur0824hao/skills/skill-system-review
skill-system-review
Installation
...
tkt.sh close generates review.yaml stub
PM Agent calls generate-review-prompt to assemble review context
Prometheus receives the structured context and produces:
...
write-review-inbox converts Prometheus output into TKT-ingestible tickets
refresh_review_inbox() picks up new tickets automatically
...
Prometheus writes plan to .sisyphus/drafts/
plan-to-bundle reads the plan and generates TKT commands
PM Agent executes the commands to create roadmap goal + bundle + worker tickets
