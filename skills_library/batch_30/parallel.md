---
title: parallel
url: https://skills.sh/jay-523/agent-skills/parallel
---

# parallel

skills/jay-523/agent-skills/parallel
parallel
Installation
...
Scope: What this agent is responsible for building
File Ownership: Files this agent may create/modify (exclusive)
Read-Only Files: Files this agent may read but must not modify
...
Progress Tracking: Write status to ../shared/progress/{agent-name}.json after each major milestone using this format:
{
  "agent": "{agent-name}",
  "timestamp": "ISO-8601",
