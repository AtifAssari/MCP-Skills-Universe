---
title: stonebraker-database-architecture
url: https://skills.sh/copyleftdev/sk1llz/stonebraker-database-architecture
---

# stonebraker-database-architecture

skills/copyleftdev/sk1llz/stonebraker-database-architecture
stonebraker-database-architecture
Installation
...
Workload-Specific Design: OLTP, OLAP, streaming, and scientific data need different architectures.

Main Memory is the New Disk: Design for RAM-resident data; disk is for durability, not performance.

Shared-Nothing Scales: Horizontal partitioning beats shared-disk for scalability.

The Log is the Database: Write-ahead logging is fundamental; the log can be the source of truth.

Clean Abstractions Endure: Postgres has lasted 30+ years because of its extensible, clean design.
...
What is the workload? OLTP, OLAP, streaming, scientific?
Where is the data? Memory, SSD, disk, distributed?
What is the access pattern? Point queries, range scans, full table scans?
What consistency is required? ACID, eventual, something in between?
How will it scale? Vertical, horizontal, both?
