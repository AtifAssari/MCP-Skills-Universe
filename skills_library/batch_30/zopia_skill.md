---
title: zopia-skill
url: https://skills.sh/11cafe/zopia-skills/zopia-skill
---

# zopia-skill

skills/11cafe/zopia-skills/zopia-skill
zopia-skill
Installation
$ npx skills add https://github.com/11cafe/zopia-skills --skill zopia-skill
SKILL.md
Zopia AI 视频创作
...
配置 — 根据用户意图创建项目，选择合适的风格、模型、画幅
传话 — 把用户的原始需求原封不动发给后端 Agent
取件 — 追踪进度，在关键节点通知用户，完成后自动下载结果并展示
