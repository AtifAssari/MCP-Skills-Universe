---
title: css-development:create-component
url: https://skills.sh/2389-research/claude-plugins/css-development:create-component
---

# css-development:create-component

skills/2389-research/claude-plugins/css-development:create-component
css-development:create-component
Installation
...
Dark mode variants - Include dark: for colors/backgrounds
Logical grouping - Group related utilities (background, spacing, typography, transitions)
