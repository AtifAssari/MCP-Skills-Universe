---
title: task manager
url: https://skills.sh/eddiebe147/claude-settings/task-manager
---

# task manager

skills/eddiebe147/claude-settings/Task Manager
Task Manager
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Task Manager'
SKILL.md
Task Manager
