---
title: ln-160-docs-skill-extractor
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-160-docs-skill-extractor
---

# ln-160-docs-skill-extractor

skills/levnikolaevich/claude-code-skills/ln-160-docs-skill-extractor
ln-160-docs-skill-extractor
Installation
$ npx skills add https://github.com/levnikolaevich/claude-code-skills --skill ln-160-docs-skill-extractor
SKILL.md
...
Discovery Rules
If docs/project/.context/doc_registry.json exists, prioritize:
canonical docs first
DOC_KIND=how-to before reference
reference before index and explanation
Read markdown with the shared section-first protocol:
...
Ignore standard doc shell sections as extraction candidates:
Quick Navigation
Agent Entry
Maintenance
