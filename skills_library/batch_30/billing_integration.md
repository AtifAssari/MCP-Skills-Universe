...
url: https://skills.sh/vanman2024/ai-dev-marketplace/billing-integration
---

# billing-integration

skills/vanman2024/ai-dev-marketplace/billing-integration
billing-integration
Installation
...
Navigate to Clerk Dashboard > Configure > Billing
Click "Enable Billing"
Connect your Stripe account (or use sandbox mode for development)
Configure billing settings and defaults
...
Navigate to Dashboard > Configure > Subscription Plans
Click "Add User Plan" (B2C) or "Add Organization Plan" (B2B)
Enter plan details:
Name (e.g., "Pro Plan")
...
Feature description
Set feature limits if usage-based
...
Create "Free" plan with basic features
Create "Pro" plan with premium features
Implement feature gates throughout app
...
Enable Organization Plans in Dashboard
Configure team-based pricing
Implement organization billing interface
...
Configure usage-based features in Dashboard
