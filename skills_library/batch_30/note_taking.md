---
title: note-taking
url: https://skills.sh/seb1n/awesome-ai-agent-skills/note-taking
---

# note-taking

skills/seb1n/awesome-ai-agent-skills/note-taking
note-taking
Installation
...
Create or Locate the Note: Check if a relevant note already exists by searching the notes directory by filename and content. If the user wants to add to an existing topic, open and append to that note. If it is a new topic, create a new file with a descriptive, date-prefixed filename (e.g., 2026-02-12-sprint-planning.md).
