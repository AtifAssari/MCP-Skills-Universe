---
title: ln-150-presentation-creator
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-150-presentation-creator
---

# ln-150-presentation-creator

skills/levnikolaevich/claude-code-skills/ln-150-presentation-creator
ln-150-presentation-creator
Installation
...
Use Glob tool: pattern: "docs/project/{filename}"
If NOT found:
Add to missing list
If found:
...
Placeholders: Detect {{PLACEHOLDER}}, [Add your ...], TODO: patterns
Content length: requirements.md >500 words, architecture.md >1000 words, tech_stack.md >200 words
...
Inject content: Replace {{PLACEHOLDER}} in 6 tab files with parsed content
Delete examples: Remove <!-- EXAMPLE START -->...<!-- EXAMPLE END --> blocks from all tabs
