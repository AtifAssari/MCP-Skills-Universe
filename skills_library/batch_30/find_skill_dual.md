---
title: find-skill-dual
url: https://skills.sh/susu81184/find-skill-dual/find-skill-dual
---

# find-skill-dual

skills/susu81184/find-skill-dual/find-skill-dual
find-skill-dual
Installation
...
Acknowledge — "没有找到与「X」相关的 skill"
Offer direct help — "我可以直接帮你解决这个问题"
Suggest creating — "如果经常用到，可以自己发布: clawhub publish"
Prerequisites
...
clawhub search pdf
curl -s "https://agentskill.work/api/skills?q=pdf&limit=10&sort=stars"
gh search repos "openclaw skill pdf" --limit 10 --json name,fullName,description,url,stargazersCount
Merge, deduplicate, sort; show tables (use description_zh for Chinese)
User picks one → offer inspect → optionally fetch related → provide install command
Weekly Installs
15
Repository
susu81184/find-…ill-dual
First Seen
Mar 10, 2026
Security Audits
