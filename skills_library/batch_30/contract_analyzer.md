...
url: https://skills.sh/eddiebe147/claude-settings/contract-analyzer
---

# contract analyzer

skills/eddiebe147/claude-settings/Contract Analyzer
Contract Analyzer
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Contract Analyzer'
SKILL.md
Contract Analyzer
