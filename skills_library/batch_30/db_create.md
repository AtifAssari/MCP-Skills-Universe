---
title: db-create
url: https://skills.sh/arman-kudaibergenov/1c-ai-development-kit/db-create
---

# db-create

skills/arman-kudaibergenov/1c-ai-development-kit/db-create
db-create
Installation
...
Если указан шаблон /UseTemplate — предупреди что конфигурация будет загружена из шаблона
Примеры
