---
title: binary-re:synthesis
url: https://skills.sh/2389-research/claude-plugins/binary-re:synthesis
---

# binary-re:synthesis

skills/2389-research/claude-plugins/binary-re:synthesis
binary-re:synthesis
Installation
$ npx skills add https://github.com/2389-research/claude-plugins --skill binary-re:synthesis
SKILL.md
