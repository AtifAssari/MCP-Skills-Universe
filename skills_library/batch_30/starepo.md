---
title: starepo
url: https://skills.sh/yangyang0507/starepo/starepo
---

# starepo

skills/yangyang0507/starepo/starepo
starepo
Installation
$ npx skills add https://github.com/yangyang0507/starepo --skill starepo
SKILL.md
...
Workflow Tips
First search fails or returns nothing → Run npx starepo sync
Stale results → Run npx starepo sync to fetch new stars (smart incremental)
Poor semantic relevance → Run npx starepo embed --force to fix incomplete embeddings
Filter + search → Combine --query with --lang/--topic/--days for precise results
Automation → Use --json flag to pipe results to jq or other tools
Weekly Installs
10
Repository
