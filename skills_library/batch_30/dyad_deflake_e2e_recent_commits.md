---
title: dyad:deflake-e2e-recent-commits
url: https://skills.sh/dyad-sh/dyad/dyad:deflake-e2e-recent-commits
---

# dyad:deflake-e2e-recent-commits

skills/dyad-sh/dyad/dyad:deflake-e2e-recent-commits
dyad:deflake-e2e-recent-commits
Installation
...
Gather flaky tests from recent CI runs on main:
...
Gather flaky tests from recent PRs by wwwillchen, keppo-bot, and dyad-assistant:
...
Deflake each flaky test spec file (sequentially):
