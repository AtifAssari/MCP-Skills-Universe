---
title: particle-modifier
url: https://skills.sh/958877748/skills/particle-modifier
---

# particle-modifier

skills/958877748/skills/particle-modifier
particle-modifier
Installation
...
步骤 3：在编辑器中配置
在粒子系统节点上添加 ParticleModifier 组件
添加自定义修饰器组件
配置参数并运行
修饰器开发模板
基础模板
...
最佳实践
优先使用 X 轴旋转：长方形图片避免跳变
避免对象创建：在 onParticleUpdate 中不创建新对象
合理控制粒子数：建议 < 1000 个粒子
使用 priority 控制顺序：修饰器按 priority 从小到大执行
在 onParticleEmit 初始化：粒子自定义数据在发射时初始化
扩展 IParticle 接口：使用 TypeScript 接口扩展自定义数据类型
Weekly Installs
34
Repository
958877748/skills
