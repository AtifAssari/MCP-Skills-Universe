...
url: https://skills.sh/eddiebe147/claude-settings/llm-prompt-optimizer
---

# llm prompt optimizer

skills/eddiebe147/claude-settings/LLM Prompt Optimizer
LLM Prompt Optimizer
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'LLM Prompt Optimizer'
SKILL.md
LLM Prompt Optimizer
