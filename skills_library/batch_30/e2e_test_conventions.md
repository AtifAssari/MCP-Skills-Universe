---
title: e2e-test-conventions
url: https://skills.sh/agentmantis/test-skills/e2e-test-conventions
---

# e2e-test-conventions

skills/agentmantis/test-skills/e2e-test-conventions
e2e-test-conventions
Installation
...
e2e/.env — base file (can hold TEST_ENV and all variables)
e2e/.env.{env} — optional environment-specific override
