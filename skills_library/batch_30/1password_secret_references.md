...
url: https://skills.sh/jem-open/jem-agent-skills/1password-secret-references
---

# 1password-secret-references

skills/jem-open/jem-agent-skills/1password-secret-references
1password-secret-references
Installation
...
op read executes and returns the plaintext secret to stdout
The shell substitutes it into the parent command — the full command string now contains the real secret
...
Restart the agent session — the secret is in the conversation context and cannot be removed; starting a new session is the only way to purge it
