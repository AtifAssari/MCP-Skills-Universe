---
title: graphic-2d-pr
url: https://skills.sh/openharmonyinsight/openharmony-skills/graphic-2d-pr
---

# graphic-2d-pr

skills/openharmonyinsight/openharmony-skills/graphic-2d-PR
graphic-2d-PR
Installation
...
Important Notes
Base branch: Always use master, not main
Sign commits: Always use git commit -s for DCO compliance
Branch naming: Use descriptive names like refactor/feature-name, fix/bug-description
Issue-PR linking: Include Closes #<issue-number> in PR body
Remote names:
