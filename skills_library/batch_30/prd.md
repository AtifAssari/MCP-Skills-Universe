---
title: prd
url: https://skills.sh/ansarullahanasz360/cc-guide/prd
---

# prd

skills/ansarullahanasz360/cc-guide/prd
prd
Installation
$ npx skills add https://github.com/ansarullahanasz360/cc-guide --skill prd
SKILL.md
PRD Creation Skill
...
Write tests first - All tests related to the feature being implemented
Run story-specific tests - No test is left out from the implementation:
Lint and typecheck
Unit tests for new code
Integration tests for touched code paths
E2E tests if the story has UI components
All tests must pass - Story is not complete until tests are written AND passing
What to Run	When
...
Provide input if BLOCKED
If truly stuck, Ctrl+C to stop and restart
