...
url: https://skills.sh/will-17173/wechat-article-to-markdown-skill/wechat-article-to-markdown
---

# wechat-article-to-markdown

skills/will-17173/wechat-article-to-markdown-skill/wechat-article-to-markdown
wechat-article-to-markdown
Installation
$ npx skills add https://github.com/will-17173/wechat-article-to-markdown-skill --skill wechat-article-to-markdown
SKILL.md
...
下载正文图片到本地输出目录
将正文转换为 Markdown
先执行脚本内置的 Markdown formatter，清理标题、空行、无效链接、缺失图片和公众号噪音内容
如果当前环境存在 markdown-formatter skill，再对生成的 Markdown 自动执行一次 markdown-formatter 规则清理
输出文章目录、Markdown 路径和处理摘要
输出结构
articles/
├── 01_文章标题/
│   ├── 文章标题.md
