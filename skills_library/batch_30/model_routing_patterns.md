---
title: model-routing-patterns
url: https://skills.sh/vanman2024/ai-dev-marketplace/model-routing-patterns
---

# model-routing-patterns

skills/vanman2024/ai-dev-marketplace/model-routing-patterns
model-routing-patterns
Installation
$ npx skills add https://github.com/vanman2024/ai-dev-marketplace --skill model-routing-patterns
SKILL.md
Model Routing Patterns
...
Skill Location: plugins/openrouter/skills/model-routing-patterns/ Version: 1.0.0 Supported Frameworks: Node.js, Python, TypeScript, any OpenRouter-compatible client
