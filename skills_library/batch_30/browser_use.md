---
title: browser-use
url: https://skills.sh/jackiexiao/jackie-skills-cn-top50/browser-use
---

# browser-use

skills/jackiexiao/jackie-skills-cn-top50/browser-use
browser-use
Installation
$ npx skills add https://github.com/jackiexiao/jackie-skills-cn-top50 --skill browser-use
SKILL.md
使用浏览器使用的CLI实现浏览器自动化
