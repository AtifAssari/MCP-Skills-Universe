---
title: breezing
url: https://skills.sh/chachamaru127/claude-code-harness/breezing
---

# breezing

skills/chachamaru127/claude-code-harness/breezing
breezing
Installation
$ npx skills add https://github.com/chachamaru127/claude-code-harness --skill breezing
SKILL.md
...
Depends が - のタスクを先に実行。独立タスクが複数あれば並列 spawn 可能
