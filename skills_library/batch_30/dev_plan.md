---
title: dev-plan
url: https://skills.sh/okazuki58/agent-skills/dev-plan
---

# dev-plan

skills/okazuki58/agent-skills/dev-plan
dev-plan
Installation
$ npx skills add https://github.com/okazuki58/agent-skills --skill dev-plan
SKILL.md
...
Step 5: Wave構造の決定
Issue内容から依存関係を分析し、Wave構造を提案
AskUserQuestion で確認・修正
...
各Issueに対し、references/prompt-template.md のテンプレートに従ってプロンプトを生成。
...
出力形式は references/output-example.md を参照。
