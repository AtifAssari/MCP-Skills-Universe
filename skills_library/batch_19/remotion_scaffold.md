---
title: remotion-scaffold
url: https://skills.sh/ncklrs/startup-os-skills/remotion-scaffold
---

# remotion-scaffold

skills/ncklrs/startup-os-skills/remotion-scaffold
remotion-scaffold
Installation
...
Next Steps
Define animations → Run /remotion-animation to generate animation configs
Build composition → Run /remotion-composition to structure Sequence layout
Implement scenes → Run /remotion-component-gen for each scene
Configure render → Run /remotion-render-config for output settings
Add assets → Run /remotion-asset-coordinator for asset preparation
