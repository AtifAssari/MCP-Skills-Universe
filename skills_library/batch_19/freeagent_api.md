---
title: freeagent-api
url: https://skills.sh/markpitt/claude-skills/freeagent-api
---

# freeagent-api

skills/markpitt/claude-skills/freeagent-api
freeagent-api
Installation
...
Sandbox by default — Use https://api.sandbox.freeagent.com/v2/ for all write operations unless the user explicitly names the production environment.
Read-Only Default
...
Get authorization code: https://api.freeagent.com/v2/approve_app?client_id=YOUR_ID
Exchange for tokens at https://api.freeagent.com/v2/token_endpoint
Store in environment variables: FREEAGENT_ACCESS_TOKEN, FREEAGENT_REFRESH_TOKEN
Include in every request: Authorization: Bearer $FREEAGENT_ACCESS_TOKEN
