...
url: https://skills.sh/blacktwist/social-media-skills/audience-growth-tracker-sms
---

# audience-growth-tracker-sms

skills/blacktwist/social-media-skills/audience-growth-tracker-sms
audience-growth-tracker-sms
Installation
...
get_follower_growth — retrieve follower counts over time (use the maximum available window, minimum 30 days)
get_metric_timeseries — pull follower count as a time series alongside engagement rate to identify correlation patterns
list_posts — retrieve posts from the same window to correlate content with growth events
get_consistency — check posting frequency and whether consistency correlates with growth rate shifts
get_daily_recap — surface any anomaly days (unusual spikes or drops in followers)
...
Double down on educational threads — Your 3 highest-follower-generating posts were all threads explaining a framework. Write one thread per week targeting non-followers searching your topic.
Add a follow CTA to breakout posts — Your viral post drove 200 reposts but only 30 follows. End high-reach posts with a direct invitation: "Follow for more on [topic]."
Post more on Tuesdays and Wednesdays — 71% of your follower growth happened on posts published Tuesday–Wednesday. Shift your highest-effort content to those days.
Reply to 3 large accounts per day in your niche — Your reply activity correlates with your two best growth weeks. Increase reply volume before publishing your next thread.
Milestone Tracking
