---
title: humanizer
url: https://skills.sh/petekp/claude-code-setup/humanizer
---

# humanizer

skills/petekp/claude-code-setup/humanizer
humanizer
Installation
$ npx skills add https://github.com/petekp/claude-code-setup --skill humanizer
SKILL.md
