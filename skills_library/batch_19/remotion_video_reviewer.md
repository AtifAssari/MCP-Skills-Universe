---
title: remotion-video-reviewer
url: https://skills.sh/ncklrs/startup-os-skills/remotion-video-reviewer
---

# remotion-video-reviewer

skills/ncklrs/startup-os-skills/remotion-video-reviewer
remotion-video-reviewer
Installation
$ npx skills add https://github.com/ncklrs/startup-os-skills --skill remotion-video-reviewer
SKILL.md
Remotion Video Reviewer
...
Category: Asset Quality Location: public/images/product.png Impact: Slower render times, larger output file
...
Performance check: Run /remotion-performance-optimizer if render times increase
Archive: Save REVIEW_REPORT.md with project files
Approval
