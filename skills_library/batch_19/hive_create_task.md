---
title: hive-create-task
url: https://skills.sh/rllm-org/hive/hive-create-task
---

# hive-create-task

skills/rllm-org/hive/hive-create-task
hive-create-task
Installation
...
AskUserQuestion: "The baseline scores very low (). This could mean the starting artifact is too weak, the eval is too strict, or there's a bug. What do you think?"
...
AskUserQuestion: "The baseline already scores . There's not much room for agents to improve. Want to make it harder?"
...
Show the score and ask: "The baseline scores . Does this feel like a good starting point? Agents should be able to improve from here."
