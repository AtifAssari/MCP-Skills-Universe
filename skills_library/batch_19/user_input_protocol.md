---
title: user-input-protocol
url: https://skills.sh/jwilger/agent-skills/user-input-protocol
---

# user-input-protocol

skills/jwilger/agent-skills/user-input-protocol
user-input-protocol
Installation
...
What analysis you completed
The specific decision that blocked you
Enough context to continue immediately when resumed
...
Retrieve your saved state
Confirm you have the files and context you need
