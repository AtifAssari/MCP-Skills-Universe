---
title: model-first-reasoning
url: https://skills.sh/petekp/agent-skills/model-first-reasoning
---

# model-first-reasoning

skills/petekp/agent-skills/model-first-reasoning
model-first-reasoning
Installation
...
If you need something not in the model: output exactly MODEL INCOMPLETE + what to add, then STOP
No invented APIs or dependencies. If not provided, either ask (unknowns) or create a stub clearly marked STUB
...
Emit a MODEL PATCH (minimal change)
Restart Phase 2 from scratch using the updated model
Validation
