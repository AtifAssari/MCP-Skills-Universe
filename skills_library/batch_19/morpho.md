---
title: morpho
url: https://skills.sh/okx/plugin-store/morpho
---

# morpho

skills/okx/plugin-store/morpho
morpho
Installation
$ npx skills add https://github.com/okx/plugin-store --skill morpho
SKILL.md
...
Safety Rules
Dry-run first: Always simulate with --dry-run before any on-chain write
Ask user to confirm: Show the user what will happen and wait for explicit confirmation before executing
