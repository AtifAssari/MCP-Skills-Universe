...
url: https://skills.sh/ck42bb/procedural-stars-threejs/procedural-starfield
---

# procedural-starfield

skills/ck42bb/procedural-stars-threejs/procedural-starfield
procedural-starfield
Installation
...
Common Pitfalls
Stars visible through Moon / planets: Sky layers need explicit render order. Set renderOrder so dome < stars < milky way < nebulae < moon.
Stars look like a flat grid: Ensure uniform sphere distribution using acos(2r-1) for phi, not linear sampling. Linear creates polar clustering.
