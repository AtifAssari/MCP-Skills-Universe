...
url: https://skills.sh/sickn33/antigravity-awesome-skills/k6-load-testing
---

# k6-load-testing

skills/sickn33/antigravity-awesome-skills/k6-load-testing
k6-load-testing
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill k6-load-testing
SKILL.md
k6 Load Testing
Overview
