...
url: https://skills.sh/marketcalls/openalgo-indicator-skills/custom-indicator
---

# custom-indicator

skills/marketcalls/openalgo-indicator-skills/custom-indicator
custom-indicator
Installation
...
Check first: If the indicator already exists in openalgo.ta, tell the user and show the existing API
Create custom_indicators/{indicator_name}/ directory (on-demand)
Create {indicator_name}.py with:
File Structure
"""
...
Create chart.py for visualization:
