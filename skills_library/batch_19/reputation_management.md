...
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/reputation-management
---

# reputation-management

skills/indranilbanerjee/digital-marketing-pro/reputation-management
reputation-management
Installation
$ npx skills add https://github.com/indranilbanerjee/digital-marketing-pro --skill reputation-management
SKILL.md
Reputation Management
...
Assess the review -- Read carefully. Determine if the complaint is legitimate, exaggerated, or fabricated. Check if the reviewer is an actual customer. Assess the platform and visibility of the review.
Check for legal triggers -- Does the review mention legal action, allege illegal behavior, or involve a regulated topic? If yes, route through legal before responding.
Draft the response -- Follow the framework: acknowledge, empathize, explain (briefly and without excuses), offer resolution, and invite offline conversation. Keep it under 150 words for public responses.
Tone check -- Ensure the response is empathetic, professional, and non-defensive. Read it from the perspective of a potential customer seeing both the review and the response. The response should make the brand look better, not worse.
Post and track -- Publish the response, log it in the review management system, and set a follow-up reminder to check if the customer responded or updated their review.
Resolve offline -- If the customer engages, resolve the issue through direct communication. Document the resolution for internal process improvement.
Pattern analysis -- Regularly analyze negative reviews for recurring themes. Feed patterns back to product, operations, and customer service teams for systemic fixes.
Crisis Response Activation
Severity assessment -- Classify the crisis as Tier 1, 2, or 3 based on reach, media involvement, customer impact, and legal exposure.
Assemble the team -- Activate the appropriate stakeholders based on tier level. Establish a communication channel for real-time coordination.
Fact-finding -- Gather all available information. What happened, when, who is affected, what is the scope, and what do we know vs what is speculation.
Holding statement -- Issue a brief acknowledgment that the brand is aware of the situation and is investigating. This buys time without leaving a silence vacuum.
Detailed response -- Craft the full response addressing what happened, what the brand is doing about it, and what affected parties should do. Tailor messaging per stakeholder group.
Distribution -- Publish the response through appropriate channels (website statement, social media, email to affected customers, press release if media is involved).
Monitor and update -- Track conversation in real time. Update stakeholders and the public at regular intervals. Correct misinformation promptly.
Post-crisis review -- After the crisis subsides, conduct a retrospective. What caused it, how was the response, what should change in the crisis playbook, and what operational changes prevent recurrence.
Reference Files
