---
title: pancakeswap-clmm-plugin
url: https://skills.sh/okx/plugin-store/pancakeswap-clmm-plugin
---

# pancakeswap-clmm-plugin

skills/okx/plugin-store/pancakeswap-clmm-plugin
pancakeswap-clmm-plugin
Installation
...
Create a V3 LP position (requires the pancakeswap-v3 plugin — note the token ID from the output)
...
Run with --confirm to execute — NFT is returned to wallet and CAKE is harvested
...
Run with --confirm to execute — CAKE is transferred to the recipient address
...
Run with --confirm to execute — fees are transferred to the recipient address
