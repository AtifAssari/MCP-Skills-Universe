---
title: app-store
url: https://skills.sh/rshankras/claude-code-apple-skills/app-store
---

# app-store

skills/rshankras/claude-code-apple-skills/app-store
app-store
Installation
...
How to Use
User requests App Store help
For strategy questions → Read marketing-strategy/SKILL.md
For paid acquisition → Read apple-search-ads/SKILL.md
For rejections or submission prep → Read rejection-handler/SKILL.md
For specific content → Read the relevant sub-skill's SKILL.md
For code/implementation → Read the relevant generator skill
Ask clarifying questions about the app
Generate optimized content
Provide alternatives and explain choices
Key Principles
1. User-Focused Copy
