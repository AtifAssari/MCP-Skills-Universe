---
title: recon
url: https://skills.sh/danielmiessler/personal_ai_infrastructure/recon
---

# recon

skills/danielmiessler/personal_ai_infrastructure/Recon
Recon
Installation
$ npx skills add https://github.com/danielmiessler/personal_ai_infrastructure --skill Recon
SKILL.md
Customization
...
Explicit user confirmation for each active scan
Documented authorization (pentest engagement, bug bounty program, owned assets)
Scope validation (ensure target is in-scope)
Rate limiting (respectful scanning, no DoS)
Session logging (record all active recon for audit trail)
