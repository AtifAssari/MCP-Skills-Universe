...
url: https://skills.sh/rohitg00/kubectl-mcp-server/k8s-troubleshoot
---

# k8s-troubleshoot

skills/rohitg00/kubectl-mcp-server/k8s-troubleshoot
k8s-troubleshoot
Installation
$ npx skills add https://github.com/rohitg00/kubectl-mcp-server --skill k8s-troubleshoot
SKILL.md
