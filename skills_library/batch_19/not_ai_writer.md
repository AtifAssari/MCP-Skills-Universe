---
title: not-ai-writer
url: https://skills.sh/dimitrigilbert/ai-skills/not-ai-writer
---

# not-ai-writer

skills/dimitrigilbert/ai-skills/not-ai-writer
not-ai-writer
Installation
$ npx skills add https://github.com/dimitrigilbert/ai-skills --skill not-ai-writer
SKILL.md
Not AI Writer
...
Action Verbs to Avoid: dive, unlock, unleash, harness, leverage, orchestrate, foster, elevate, align, bolster, burgeon, captivate, catalyze, compel, demystify, elucidate

Generic Adjectives to Replace: significant, important, effective, essential, valuable, crucial, noteworthy

For complete vocabulary lists, see VOCABULARY.md
...
Additive: moreover, furthermore, in addition, additionally, also, likewise Consecutive: consequently, therefore, thus, hence, as a result Summative: in summary, in conclusion, overall, to summarize Introductory: "It's important to note," "It's worth noting that," "Remember that"
...
For more transition guidance, see VOCABULARY.md
...
Mix lengths deliberately: 3-word sentence → 25-word sentence → 8-word sentence
Start differently: Prepositions, verbs, clauses, adverbs
Use fragments intentionally: For emphasis. Like this.
Combine short sentences into flowing, complex ones
Break predictable patterns with unexpected phrasing

Before (low burstiness): "The system is effective. It is important for users. It helps them work faster. The results are valuable."

After (high burstiness): "This system works. When you need it most, it's there—transforming how users work, making the impossible possible. The results? Game-changing."

For detailed structure guidance, see STRUCTURE.md
...
Use contractions naturally: you're, can't, won't, it's
Include specific examples from real life
Express opinions confidently: not "It could be argued that"
Use idioms appropriately: hit the nail on the head, break a leg
Add humor when it fits: light jokes, playful phrasing
Be specific, not generic: actual numbers, real names, concrete details
...
For voice development guidance, see STYLE.md
...
Find generic statements in your text
Replace with specific examples from your experience
Add contractions and conversational phrasing
Include a strong opinion or emotional reaction

Before: "The course provides comprehensive instruction on holistic development methodologies. It is essential for professionals seeking to enhance their skills."

After: "This course changed how I build software. After 10 years in the industry, I finally understood why my projects kept failing—and how to fix it. If you're serious about shipping better products, take this course."
...
Highlight every third sentence
Rewrite those sentences to be noticeably different in length
Vary how sentences start
Add 1-2 intentional fragments for emphasis

Before: "The API is easy to use. It provides comprehensive functionality. Developers can leverage it effectively. The documentation is impressive."

After: "The API is easy to use. Really easy. While it handles just about everything you need, the beauty is in the simplicity—no complexity for complexity's sake. And the documentation? Actually helpful."
...
Search your text for AI red flag words (delve, tapestry, symphony, etc.)
For each match, ask: "Would I say this in conversation?"
Replace with simpler, more natural alternatives
Prioritize specific, concrete language over vague abstractions

Before: "We must delve into the intricacies of this comprehensive tapestry to unlock its full potential and orchestrate meaningful outcomes."

After: "Let's examine how these pieces fit together. When you understand the connections, you can make better decisions."
...
Circle every transition word (moreover, furthermore, therefore, etc.)
For each one, ask: "Does this add value or just fill space?"
Delete unnecessary transitions
When needed, replace with simple connectors (and, but, so)

Before: "The system is scalable. Furthermore, it is user-friendly. Additionally, it is cost-effective. Therefore, we recommend it for enterprise deployment."

After: "The system scales effortlessly, remains user-friendly even as it grows, and costs less than competitors. For enterprise deployments, it's the clear choice."
...
AI Version: "In today's digital landscape, it is important to understand the comprehensive nature of cybersecurity. This multifaceted realm encompasses various critical aspects that organizations must meticulously consider. Moreover, the evolving threat landscape necessitates a holistic approach to safeguarding digital assets."

Human Revision: "Cybersecurity keeps me up at night. Last month, a friend's startup lost everything in a ransomware attack—not because they were careless, but because they missed one basic security setting. That's the scary reality: most breaches aren't sophisticated hacks. They're simple, preventable failures."
...
AI Version: "Dear Team, I am writing to inform you that the project has reached significant milestones. Furthermore, it is important to note that the collaboration has been exemplary. Consequently, we should leverage this momentum to propel us toward successful completion. Best regards, Alex"

Human Revision: "Hi team, Big news: we hit our major targets ahead of schedule. The way everyone's been working together? Exactly what I hoped for when we started this project. Let's keep this energy up and push through the final stretch. Thanks for all the hard work—Alex"
...
AI Version: "This API provides comprehensive functionality for data manipulation. It encompasses intricate methods that enable users to harness the full potential of their datasets. The meticulous design ensures optimal performance across various use cases."

Human Revision: "This API handles everything you need to work with data. Filter, sort, transform—whatever you need to do, there's a method for it. We built it to be fast even with large datasets, so you can process millions of records without performance issues."
...
For specialized academic guidance, see ACADEMIC.md

"My content was flagged as AI"

If your authentic content was flagged, you may need to add more distinctive human elements:

Add specific examples from your experience or knowledge
Include a personal story relevant to the topic
Express clear opinions with confident language
Use sentence fragments for emphasis (like this)
Add contractions and conversational phrasing
Include cultural references or specific domain knowledge
Share strong emotions or reactions
...
Quick Start Checklist - 10-minute content review workflow
Complete Vocabulary Guide - 200+ AI words with natural alternatives
Structure & Flow - Master burstiness and perplexity for natural rhythm
Voice Development - Build authentic writing personality and tone
Before/After Examples - 20+ transformation examples across writing types
Academic Writing - Specialized guidance for scholarly content
Research Basis
