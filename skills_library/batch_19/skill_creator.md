---
title: skill-creator
url: https://skills.sh/nextlevelbuilder/skillx/skill-creator
---

# skill-creator

skills/nextlevelbuilder/skillx/skill-creator
skill-creator
Installation
...
Research (activate /docs-seeker, /research skills)
Plan reusable contents (scripts, references, assets)
Initialize (scripts/init_skill.py <name> --path <dir>)
Edit (implement resources, write SKILL.md, optimize for benchmarks)
Package & validate (scripts/package_skill.py <path>)
Iterate based on real usage and benchmark results
