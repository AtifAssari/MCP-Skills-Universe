---
title: gemini
url: https://skills.sh/zpankz/mcp-skillset/gemini
---

# gemini

skills/zpankz/mcp-skillset/gemini
gemini
Installation
$ npx skills add https://github.com/zpankz/mcp-skillset --skill gemini
SKILL.md
Gemini Skill Guide
...
User explicitly requests gemini CLI execution (Mode 1: Direct CLI)
Large-context analysis requiring 1M token window (Mode 2: Gemini Delegation)
...
Execute: gemini "<DETAILED CONTEXT>" --output-format json
Synthesize Gemini response into actionable insights
...
Trigger: Flag skill for healing via /heal-skill gemini
Analysis: Healing agent analyzes current CLI with gemini --help and gemini --version
Update: Updates skill documentation to match current API
