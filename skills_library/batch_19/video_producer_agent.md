---
title: video-producer-agent
url: https://skills.sh/michaelboeding/skills/video-producer-agent
---

# video-producer-agent

skills/michaelboeding/skills/video-producer-agent
video-producer-agent
Installation
$ npx skills add https://github.com/michaelboeding/skills --skill video-producer-agent
SKILL.md
Video Producer
...
Generate video scenes (Veo 3.1)
Strip audio from scenes (if custom audio)
