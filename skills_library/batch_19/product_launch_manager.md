...
url: https://skills.sh/ncklrs/startup-os-skills/product-launch-manager
---

# product-launch-manager

skills/ncklrs/startup-os-skills/product-launch-manager
product-launch-manager
Installation
$ npx skills add https://github.com/ncklrs/startup-os-skills --skill product-launch-manager
SKILL.md
Product Launch Manager
