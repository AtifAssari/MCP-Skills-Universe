---
title: nothing-design
url: https://skills.sh/dominikmartn/nothing-design-skill/nothing-design
---

# nothing-design

skills/dominikmartn/nothing-design-skill/nothing-design
nothing-design
Installation
...
Data as beauty. 36GB/s in Space Mono at 48px IS the visual. No illustrations needed.
...
4. WORKFLOW
Declare fonts — tell the user which Google Fonts to load (see references/tokens.md)
...
Check tokens — consult references/tokens.md for exact values
Build components — consult references/components.md for patterns
Adapt to platform — consult references/platform-mapping.md for output conventions
5. REFERENCE FILES
