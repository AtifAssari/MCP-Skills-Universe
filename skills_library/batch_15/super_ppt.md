---
title: super-ppt
url: https://skills.sh/huyansheng3/ppt-skills/super-ppt
---

# super-ppt

skills/huyansheng3/ppt-skills/super-ppt
super-ppt
Installation
$ npx skills add https://github.com/huyansheng3/ppt-skills --skill super-ppt
SKILL.md
...
核心功能
编辑现有 PPT - 打开、修改指定页面、保存
风格预设系统 - 如 promotion（晋升答辩风格），新增/修改页面自动保持一致
样式提取 - 从 PPT/PDF 提取配色、字体，保存为用户自定义主题
动画支持 - 通过自然语言描述添加动画，支持银河系旋转效果
快速开始
安装依赖
