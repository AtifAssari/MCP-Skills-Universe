...
url: https://skills.sh/catlog22/claude-code-workflow/team-lifecycle
---

# team-lifecycle

skills/catlog22/claude-code-workflow/team-lifecycle
team-lifecycle
Installation
...
Scan .workflow/.team/TLS-*/team-session.json for files with status: "active" or status: "paused"
No sessions found -> proceed to Phase 1
...
Read team-session.json from session directory
