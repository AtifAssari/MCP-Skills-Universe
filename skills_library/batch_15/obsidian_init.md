---
title: obsidian-init
url: https://skills.sh/richfrem/agent-plugins-skills/obsidian-init
---

# obsidian-init

skills/richfrem/agent-plugins-skills/obsidian-init
obsidian-init
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill obsidian-init
SKILL.md
Dependencies
...
What It Does
Validates the target directory exists and contains .md files
Creates the .obsidian/ configuration directory (if not present)
Writes app.json with sensible exclusion filters for developer repos
Updates .gitignore to exclude .obsidian/ (user-specific config)
...
Verify indexing → Check that 01_PROTOCOLS/, ADRs/, etc. appear in sidebar
Test wikilinks → Click any [[link]] to confirm navigation works
Set VAULT_PATH → export VAULT_PATH=/path/to/vault
Portability Note
