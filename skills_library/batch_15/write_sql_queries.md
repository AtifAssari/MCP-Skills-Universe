...
url: https://skills.sh/g4brym/workers-qb/write-sql-queries
---

# write-sql-queries

skills/g4brym/workers-qb/write-sql-queries
write-sql-queries
Installation
$ npx skills add https://github.com/g4brym/workers-qb --skill write-sql-queries
SKILL.md
Write Queries Skill
When to Use
