---
title: canvas-morning-check
url: https://skills.sh/vishalsachdev/canvas-mcp/canvas-morning-check
---

# canvas-morning-check

skills/vishalsachdev/canvas-mcp/canvas-morning-check
canvas-morning-check
Installation
...
Draft and send a message to struggling students (uses send_conversation)
Send reminders about upcoming deadlines (uses send_peer_review_reminders or send_conversation)
Get detailed analytics for a specific assignment (uses get_assignment_analytics)
