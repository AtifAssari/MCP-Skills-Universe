---
title: promotion-doc-designer
url: https://skills.sh/huyansheng3/ppt-skills/promotion-doc-designer
---

# promotion-doc-designer

skills/huyansheng3/ppt-skills/promotion-doc-designer
promotion-doc-designer
Installation
$ npx skills add https://github.com/huyansheng3/ppt-skills --skill promotion-doc-designer
SKILL.md
...
3. 视觉层次
信息架构
一级标题: 品牌橙色 #fc5a1f，大字号，简短有力
二级标题: 深色灰 #434343，中等字号，说明性文字
正文内容: 中性灰 #707070，标准字号，清晰易读
辅助说明: 浅灰色，小字号，补充信息
留白策略
...
最佳实践
保持一致性: 所有页面使用相同的颜色、字体、间距体系
突出重点: 每页只有 1-2 个核心观点
数据说话: 用具体数字和可视化支撑结论
视觉引导: 通过颜色、大小、位置引导阅读顺序
留白呼吸: 不要填满所有空间，让内容有呼吸感
移动友好: 确保在投影仪和小屏幕上都清晰可读
质量检查清单
 所有页面使用 16:9 比例
 品牌色 #fc5a1f 用于关键元素
