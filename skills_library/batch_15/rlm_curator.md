---
title: rlm-curator
url: https://skills.sh/richfrem/agent-plugins-skills/rlm-curator
---

# rlm-curator

skills/richfrem/agent-plugins-skills/rlm-curator
rlm-curator
Installation
...
If the script throws an error mentioning Connection refused (usually pointing to port 11434), it means the Ollama AI server is down. Do not attempt to retry indefinitely or modify python. You MUST IMMEDIATELY refer to ./fallback-tree.md.
📂 Execution Protocol
