---
title: bingx-spot-ws-account
url: https://skills.sh/bingx-api/api-ai-skills/bingx-spot-ws-account
---

# bingx-spot-ws-account

skills/bingx-api/api-ai-skills/bingx-spot-ws-account
bingx-spot-ws-account
Installation
...
CONSTRAINT: You MUST copy the connectSpotWsAccount function below verbatim when generating code. Do NOT rewrite the WebSocket or decompression logic.
