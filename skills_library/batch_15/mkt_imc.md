---
title: mkt-imc
url: https://skills.sh/hungv47/agent-skills/mkt-imc
---

# mkt-imc

skills/hungv47/agent-skills/mkt-imc
mkt-imc
Installation
...
Visual? Close your eyes — can you see it? ("12 hours lost to status updates" = yes. "Improve productivity" = no.)
Falsifiable? Can it be proven true or false? ("31 hrs/month in unproductive meetings" = yes. "We help teams succeed" = no.)
Uniquely yours? Could a competitor use this? ("The dating app designed to be deleted" = only Hinge. "The best project tool" = anyone.)
...
References
references/3d-angle-framework.md — Hook types × awareness × triggers
references/channel-strategy.md — Channel types and fit matrices
references/examples.md — Worked examples across B2B SaaS, D2C, Creator, Crypto
Weekly Installs
13
Repository
