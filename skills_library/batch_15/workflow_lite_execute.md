---
title: workflow-lite-execute
url: https://skills.sh/catlog22/claude-code-workflow/workflow-lite-execute
---

# workflow-lite-execute

skills/catlog22/claude-code-workflow/workflow-lite-execute
workflow-lite-execute
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill workflow-lite-execute
SKILL.md
Workflow-Lite-Execute
