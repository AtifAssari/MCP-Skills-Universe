...
url: https://skills.sh/catlog22/claude-code-workflow/workflow-lite-plan
---

# workflow-lite-plan

skills/catlog22/claude-code-workflow/workflow-lite-plan
workflow-lite-plan
Installation
...
<auto_mode> When workflowPreferences.autoYes === true (entire plan+execute workflow):

Clarification: Skipped | Plan Confirmation: Allow & Execute | Execution: Auto | Review: Skip

Auto mode authorizes the complete plan-and-execute workflow with a single confirmation. No further prompts. </auto_mode>
...
<success_criteria>
 ...
 No code execution in planning phases -- all execution deferred to lite-execute </success_criteria>
Weekly Installs
45
Repository
