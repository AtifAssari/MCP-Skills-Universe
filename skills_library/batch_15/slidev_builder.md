---
title: slidev-builder
url: https://skills.sh/hoangvantuan/claude-plugin/slidev-builder
---

# slidev-builder

skills/hoangvantuan/claude-plugin/slidev-builder
slidev-builder
Installation
...
Tạo output folder: output/{slug}-{YYMMDD-HHmm}/
Slidev Theme List
...
Đọc references/slide-templates.md (relative to this skill folder) để nắm Slidev Markdown patterns
...
Slidev skill tạo project: package.json (deps: @slidev/cli, {theme-package}, playwright-chromium) + slides.md (headmatter + all slides)

Install: pnpm install trong Slidev project folder
