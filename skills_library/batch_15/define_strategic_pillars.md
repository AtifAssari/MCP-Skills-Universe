...
url: https://skills.sh/nesnilnehc/ai-cortex/define-strategic-pillars
---

# define-strategic-pillars

skills/nesnilnehc/ai-cortex/define-strategic-pillars
define-strategic-pillars
Installation
$ npx skills add https://github.com/nesnilnehc/ai-cortex --skill define-strategic-pillars
SKILL.md
技能（Skill）：定义战略支柱
目的（目的）
...
✅ 文档持久化：写入商定的路径（默认 docs/project-overview/strategic-pillars.md 或每个项目规范）。
...
执行过程
加载愿景和北极星：阅读 docs/project-overview/vision.md 和 docs/project-overview/north-star.md 或用户提供的摘要。
引出：哪 3-5 个高层主题或支柱将构建战略并指导目标/路线图？
...
任务/愿景/北极星：使用define-mission、define-vision、define-north-star。
战略目标：使用设计-战略-目标；目标可以映射到支柱。
里程碑/路线图：使用define-里程碑、define-路线图。
