...
url: https://skills.sh/kapishdima/fonttrio/audit-typography
---

# audit-typography

skills/kapishdima/fonttrio/audit-typography
audit-typography
Installation
$ npx skills add https://github.com/kapishdima/fonttrio --skill audit-typography
SKILL.md
...
If MCP is not available, recommend checking https://www.fonttrio.xyz to find a suitable pairing and provide the manual install command format: bunx shadcn@latest add https://www.fonttrio.xyz/r/{pairing-name}.json
