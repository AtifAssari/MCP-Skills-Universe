---
title: copilot-cli-agent
url: https://skills.sh/richfrem/agent-plugins-skills/copilot-cli-agent
---

# copilot-cli-agent

skills/richfrem/agent-plugins-skills/copilot-cli-agent
copilot-cli-agent
Installation
...
copilot login
If copilot -p ... still fails with authentication errors, check for overriding env vars:
GITHUB_TOKEN
GH_TOKEN
