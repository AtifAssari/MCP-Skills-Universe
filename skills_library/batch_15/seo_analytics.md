---
title: seo-analytics
url: https://skills.sh/eng0ai/eng0-template-skills/seo-analytics
---

# seo-analytics

skills/eng0ai/eng0-template-skills/seo-analytics
seo-analytics
Installation
$ npx skills add https://github.com/eng0ai/eng0-template-skills --skill seo-analytics
SKILL.md
SEO Analytics Skill
...
As a command line argument: npx ts-node analyze.ts <URL> <API_KEY>
As an environment variable: PAGESPEED_API_KEY
Quick Start
...
Console Summary - Quick overview of all scores
seo-report.html - Interactive HTML report with:
