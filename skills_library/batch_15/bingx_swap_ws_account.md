---
title: bingx-swap-ws-account
url: https://skills.sh/bingx-api/api-ai-skills/bingx-swap-ws-account
---

# bingx-swap-ws-account

skills/bingx-api/api-ai-skills/bingx-swap-ws-account
bingx-swap-ws-account
Installation
...
CONSTRAINT: You MUST copy the connectSwapWsAccount function below verbatim when generating code. Do NOT rewrite the WebSocket or decompression logic.
...
GET-only execution. Only execute HTTP GET requests. Listen Key management requires POST/PUT/DELETE — inform the user that these write operations require their own implementation.
