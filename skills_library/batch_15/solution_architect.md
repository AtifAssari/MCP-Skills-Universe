...
url: https://skills.sh/shining319/claude-code-single-person-workflow/solution-architect
---

# solution-architect

skills/shining319/claude-code-single-person-workflow/solution-architect
solution-architect
Installation
$ npx skills add https://github.com/shining319/claude-code-single-person-workflow --skill solution-architect
SKILL.md
Solution Architect
Overview
