---
title: csv-wave-pipeline
url: https://skills.sh/catlog22/claude-code-workflow/csv-wave-pipeline
---

# csv-wave-pipeline

skills/catlog22/claude-code-workflow/csv-wave-pipeline
csv-wave-pipeline
Installation
...
CSV findings (structured): context_from column → prev_context injection — task-specific directed context
NDJSON discoveries (broadcast): discoveries.ndjson — general exploration findings available to all
Wave 1 agents:
...
Write discoveries immediately via echo >> → don't batch
