---
title: canvas-accessibility-auditor
url: https://skills.sh/vishalsachdev/canvas-mcp/canvas-accessibility-auditor
---

# canvas-accessibility-auditor

skills/vishalsachdev/canvas-mcp/canvas-accessibility-auditor
canvas-accessibility-auditor
Installation
...
Call get_page_content(course_identifier, page_url) to retrieve the HTML
Identify the <img> tags without alt attributes
Ask the user for alt text descriptions (or suggest based on surrounding context)
Call edit_page_content(course_identifier, page_url, new_content) with corrected HTML

For non-descriptive links:

Retrieve the page content
Show the current link: <a href="...">click here</a>
Suggest descriptive replacement: <a href="...">Download the syllabus (PDF)</a>
...
Convert <td> to <th> elements and apply
