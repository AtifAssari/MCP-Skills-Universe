---
title: find-skills-x
url: https://skills.sh/jpwang1208/find-skills-x/find-skills-x
---

# find-skills-x

skills/jpwang1208/find-skills-x/find-skills-x
find-skills-x
Installation
$ npx skills add https://github.com/jpwang1208/find-skills-x --skill find-skills-x
SKILL.md
Find Skills X
工作流程
用户输入
...
🟢 官方认证 ─────────────────────────────────────── 🎯 {skill-1} {描述} 📦 skills.sh ｜ 📊 50,000+ 安装方式:/install skills.sh:xxx

⭐ 社区推荐 ─────────────────────────────────────── 🎯 {skill-2} {描述} 📦 SkillHub ｜ 📊 10,000+ 安装方式:/install skillhub:xxx
