...
url: https://skills.sh/sipengxie2024/superpower-planning/parallel-agents
---

# parallel-agents

skills/sipengxie2024/superpower-planning/parallel-agents
parallel-agents
Installation
...
Read each agent's .planning/agents/{role}/findings.md and progress.md
Extract critical items, errors, and test results from each
Append to top-level .planning/findings.md under agent/task headings
Update top-level .planning/progress.md: update Task Status Dashboard table + append completion details
...
Knowledge capture - Per-agent planning dirs preserve findings for orchestrator
Verification

After agents return:

Aggregate findings - Read each agent's planning dir, compile into top-level .planning/
