---
title: bingx-spot-market
url: https://skills.sh/bingx-api/api-ai-skills/bingx-spot-market
---

# bingx-spot-market

skills/bingx-api/api-ai-skills/bingx-spot-market
bingx-spot-market
Installation
...
CONSTRAINT: You MUST copy the fetchSpotMarket function below verbatim when generating code. Do NOT rewrite the request or JSON parsing logic. Only modify: (1) BASE_URLS entries for custom environments, (2) business parameters passed to fetchSpotMarket.
