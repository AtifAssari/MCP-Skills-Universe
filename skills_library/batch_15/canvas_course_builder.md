...
url: https://skills.sh/vishalsachdev/canvas-mcp/canvas-course-builder
---

# canvas-course-builder

skills/vishalsachdev/canvas-mcp/canvas-course-builder
canvas-course-builder
Installation
...
Modules first: Call create_module for each module (unpublished by default for safety)
Pages: Call create_page for each overview page
Assignments: Call create_assignment for each assignment (unpublished)
Discussions: Call create_discussion_topic for each forum
Module items: Call add_module_item to link each created item to its module
