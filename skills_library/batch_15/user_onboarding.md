...
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/user-onboarding
---

# user-onboarding

skills/manojbajaj95/claude-gtm-plugin/user-onboarding
user-onboarding
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill user-onboarding
SKILL.md
User Onboarding
Scope
...
“First 30 seconds” experience spec (magic moment + success criteria)
“First mile” onboarding plan (milestones to activation; mechanics per milestone)
Experiment backlog (prioritized) + 3–5 experiment cards
