---
title: review-code
url: https://skills.sh/catlog22/claude-code-workflow/review-code
---

# review-code

skills/catlog22/claude-code-workflow/review-code
review-code
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill review-code
SKILL.md
Review Code
...
多维度审查: 覆盖正确性、可读性、性能、安全性、测试覆盖、架构一致性六大维度
...
phases/actions/action-collect-context.md	收集上下文
phases/actions/action-quick-scan.md	快速扫描
phases/actions/action-deep-review.md	深入审查
phases/actions/action-generate-report.md	生成报告
phases/actions/action-complete.md	完成审查
