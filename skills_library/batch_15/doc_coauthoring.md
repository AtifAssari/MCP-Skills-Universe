...
url: https://skills.sh/zephyrwang6/myskill/doc-coauthoring
---

# doc-coauthoring

skills/zephyrwang6/myskill/doc-coauthoring
doc-coauthoring
Installation
$ npx skills add https://github.com/zephyrwang6/myskill --skill doc-coauthoring
SKILL.md
...
自问自答句式：❌ "这意味着什么？它意味着..." → ✅ 直接陈述
过度对比：❌ "不是...而是..." 连用多次 → ✅ 直接说是什么
小标题分割案例：❌ 每个案例都加粗标题 → ✅ 合并流畅叙述
设问开头：❌ "为什么会这样？" → ✅ 直接说原因
重复总结：❌ "总之、综上所述、这意味着" → ✅ 省略或精简
过度解释：❌ 每个概念都展开说明 → ✅ 假设读者有基础
