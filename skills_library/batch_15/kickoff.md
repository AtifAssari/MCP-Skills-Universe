---
title: kickoff
url: https://skills.sh/marswang42/orbitos/kickoff
---

# kickoff

skills/marswang42/orbitos/kickoff
kickoff
Installation
...
When /kickoff is invoked, spawn the planning agent
...
File path: A path to an inbox note (e.g., /kickoff 00_收件箱/MyIdea.md) - read the file contents
Inline text: A short description of a project idea (e.g., /kickoff Build a habit tracker app)
No input: If nothing provided, list files from 00_收件箱/ and ask the user to select one
...
After the planning agent returns, notify the user in Chinese: "我已在 [plan file path] 创建了项目启动计划。请查看并按需修改，确认后继续执行。"
