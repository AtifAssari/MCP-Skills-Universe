---
title: spec-kitty-analyze
url: https://skills.sh/richfrem/agent-plugins-skills/spec-kitty-analyze
---

# spec-kitty-analyze

skills/richfrem/agent-plugins-skills/spec-kitty-analyze
spec-kitty-analyze
Installation
$ npx skills add https://github.com/richfrem/agent-plugins-skills --skill spec-kitty-analyze
SKILL.md
🔗 Workflow Provenance

Source: This skill augments the baseline workflow located at ./workflows/spec-kitty.analyze.md. It acts as an intelligent wrapper that is continuously improved with each execution.
