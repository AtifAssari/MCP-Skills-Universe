...
url: https://skills.sh/trancong12102/agentskills/council-review
---

# council-review

skills/trancong12102/agentskills/council-review
council-review
Installation
...
Validate external findings — For each finding from Codex and /simplify:
...
Add Claude's own findings — Include any issues from /review that the other reviewers didn't catch.
Note cross-reviewer agreement — Track which findings were flagged by multiple reviewers (higher confidence).
