---
title: eng-system-architecture
url: https://skills.sh/hungv47/agent-skills/eng-system-architecture
---

# eng-system-architecture

skills/hungv47/agent-skills/eng-system-architecture
eng-system-architecture
Installation
$ npx skills add https://github.com/hungv47/agent-skills --skill eng-system-architecture
SKILL.md
