...
url: https://skills.sh/shining319/claude-code-single-person-workflow/product-manager
---

# product-manager

skills/shining319/claude-code-single-person-workflow/product-manager
product-manager
Installation
$ npx skills add https://github.com/shining319/claude-code-single-person-workflow --skill product-manager
SKILL.md
产品经理 Skill
核心设计原则
