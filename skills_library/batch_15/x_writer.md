---
title: x-writer
url: https://skills.sh/ognjengt/founder-skills/x-writer
---

# x-writer

skills/ognjengt/founder-skills/x-writer
x-writer
Installation
$ npx skills add https://github.com/ognjengt/founder-skills --skill x-writer
SKILL.md
X Writer
Purpose
...
Analyze the topic and FOUNDER_CONTEXT.md brand voice
Auto-suggest the best match based on topic:
...
Select 3 DIFFERENT formats from formats.md that best fit the user's topic and goal
Study the example posts in posts.md for those formats — internalize the rhythm, structure, and length
Apply the selected voice from voices.md — match their sentence structure, rhythm, and signature patterns (not their exact words or examples)
Draft each post following the format's structure template, the voice's DNA, and all Writing Rules below
Run each post through the Screenshot Test: "Would someone screenshot this and share it?" If no → rewrite before continuing
