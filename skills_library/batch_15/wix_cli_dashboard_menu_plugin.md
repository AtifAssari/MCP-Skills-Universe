---
title: wix-cli-dashboard-menu-plugin
url: https://skills.sh/wix/skills/wix-cli-dashboard-menu-plugin
---

# wix-cli-dashboard-menu-plugin

skills/wix/skills/wix-cli-dashboard-menu-plugin
wix-cli-dashboard-menu-plugin
Installation
...
Follow these steps in order when creating a dashboard menu plugin:
 ...
 Create plugin folder: src/extensions/dashboard/menu-plugins/<plugin-name>/
 Create <plugin-name>.extension.ts with extensions.dashboardMenuPlugin() and unique UUID
 Configure the action field to either navigate to a dashboard page or open a modal
...
Appear as labeled items with an icon in a menu slot on a Wix app's dashboard page
When clicked, perform one of two actions:
