...
url: https://skills.sh/ognjengt/founder-skills/marketing-ideas
---

# marketing-ideas

skills/ognjengt/founder-skills/marketing-ideas
marketing-ideas
Installation
$ npx skills add https://github.com/ognjengt/founder-skills --skill marketing-ideas
SKILL.md
Marketing Ideas
Purpose
...
Score every idea in the database against the user's business using these criteria:
...
Select the top 5 ideas with the highest combined score.

Ensure variety: Pick ideas from at least 3 different categories when possible. Don't cluster all 5 in one category unless the user's goal is extremely specific.
