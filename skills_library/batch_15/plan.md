---
title: plan
url: https://skills.sh/launchdarkly/agent-skills/plan
---

# plan

skills/launchdarkly/agent-skills/plan
plan
Installation
...
Entrypoint file(s) (e.g. instrumentation.ts, API entry, main.py)
Env vars (typically LAUNCHDARKLY_SDK_KEY)
...
Dependency file
Entrypoint file(s) (e.g. app/providers.tsx, root layout, main.tsx)
Env vars (bundler-prefixed client-side ID, e.g. NEXT_PUBLIC_...)
...
Install [package name] using [install command]
Add SDK dependency to [dependency file]
Add import and initialization to [entrypoint file]
Add [env var] to .env (create if missing; real value after user consent)
Ensure .env is in .gitignore
Add placeholder to .env.example if the project uses one
