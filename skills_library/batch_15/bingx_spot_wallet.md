---
title: bingx-spot-wallet
url: https://skills.sh/bingx-api/api-ai-skills/bingx-spot-wallet
---

# bingx-spot-wallet

skills/bingx-api/api-ai-skills/bingx-spot-wallet
bingx-spot-wallet
Installation
...
Ask for coin (e.g., USDT)
Ask for network (e.g., BEP20, ERC20, TRC20). Suggest fetching /capital/config/getall first to see available networks and fees.
Ask for address (destination wallet address)
Ask for addressTag if the coin requires a memo/tag (e.g., XRP, EOS, XLM)
Ask for amount
Ask for walletType (source account):
