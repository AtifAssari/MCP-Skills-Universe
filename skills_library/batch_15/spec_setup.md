---
title: spec-setup
url: https://skills.sh/catlog22/claude-code-workflow/spec-setup
---

# spec-setup

skills/catlog22/claude-code-workflow/spec-setup
spec-setup
Installation
$ npx skills add https://github.com/catlog22/claude-code-workflow --skill spec-setup
SKILL.md
...
Selected option -> Use the option's description as the guideline string (it's more precise than the label)
"Other" with custom text -> Use the user's text directly as the guideline string
Deduplication -> Skip entries that already exist in the guidelines (exact string match)
Quality rules -> Convert to { rule: description, scope: "all", enforced_by: "code-review" } format
Step 7: Display Summary
