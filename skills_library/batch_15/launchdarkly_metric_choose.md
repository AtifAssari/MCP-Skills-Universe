---
title: launchdarkly-metric-choose
url: https://skills.sh/launchdarkly/agent-skills/launchdarkly-metric-choose
---

# launchdarkly-metric-choose

skills/launchdarkly/agent-skills/launchdarkly-metric-choose
launchdarkly-metric-choose
Installation
...
Related Skills
launchdarkly-metric-create — create a metric that doesn't exist yet
launchdarkly-metric-instrument — add a track() call so events start flowing
Weekly Installs
161
Repository
