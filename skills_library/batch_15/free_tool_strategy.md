...
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/free-tool-strategy
---

# free-tool-strategy

skills/manojbajaj95/claude-gtm-plugin/free-tool-strategy
free-tool-strategy
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill free-tool-strategy
SKILL.md
...
Free: Get score/result
Email: Get detailed breakdown
Account: Get historical tracking
User Experience
...
Promotion Strategy
Launch Phase
Announce to existing audience (email, social)
...
Tool Optimization
A/B Test Ideas
Gate timing (when to ask for email)
Fields required
Output format
CTA copy
...
Tool concept with problem solved
User flow from landing to conversion
Input/output specification
Gate strategy for lead capture
SEO keywords to target
Promotion plan for launch
Success metrics and targets
Technical approach (build vs buy)
Related Skills
