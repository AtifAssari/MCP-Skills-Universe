---
title: douyin-video-analyzer
url: https://skills.sh/site/skills.volces.com/douyin-video-analyzer
---

# douyin-video-analyzer

skills/skills.volces.com/douyin-video-analyzer
douyin-video-analyzer
...
环境要求
二进制工具: ffmpeg, yt-dlp, node 必须在系统 PATH 中。
凭据: 需要有效的 ZHIPU_API_KEY 环境变量。
使用
# 输入抖音链接执行拆解
