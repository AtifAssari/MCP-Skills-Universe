---
title: nuwa-skill
url: https://skills.sh/site/skills.volces.com/nuwa-skill
---

# nuwa-skill

skills/skills.volces.com/nuwa-skill
nuwa-skill
$ npx skills add https://skills.volces.com/skills/clawhub/alchaincyf
SKILL.md
...
Read existing SKILL.md, note last research date
Only launch Agent 2 (latest conversations) + Agent 5 (latest decisions) + Agent 6 (timeline update)
Compare new info with existing content — strengthen, update, or add
Update SKILL.md incrementally, don't rewrite entirely
Taste Guidelines
...
Research Taste
Primary > Secondary: Their own words > others' accounts
Long-form > Quotes: A 3000-word essay reveals more thinking structure than 50 tweets
Controversy > Consensus: Most disputed views reveal the most uniqueness
Change > Fixed: Changed positions carry more information than consistent ones
Behavior > Words: Actual decisions > public statements
Extraction Taste
Less is more: 3 deep mental models > 15 shallow principles
Contradictions are features, not bugs: Preserve internal tensions
Don't beautify: Blind spots and limitations are part of the personality
Falsifiable: Each mental model should be verifiable or refutable by specific cases
Never Do
