---
title: geek-skills-weather-forecast-report
url: https://skills.sh/staruhub/claudeskills/geek-skills-weather-forecast-report
---

# geek-skills-weather-forecast-report

skills/staruhub/claudeskills/Geek-skills-weather-forecast-report
Geek-skills-weather-forecast-report
Installation
$ npx skills add https://github.com/staruhub/claudeskills --skill Geek-skills-weather-forecast-report
SKILL.md
天气要素专题研究报告生成器
概述
...
第三步：内容撰写
阅读撰写指南：先阅读 references/writing-guidelines.md
使用报告模板：参考 assets/report-template.md
格式规范：遵循 references/format-standards.md
第四步：生成DOCX文档

使用docx skill生成规范的Word文档：

读取 /mnt/skills/public/docx/SKILL.md 了解docx生成方法
读取 /mnt/skills/public/docx/docx-js.md 了解具体API
按规范格式生成最终报告
关键要求
学术规范性要求
一级标题：黑体四号加粗
