---
title: copilotkit-nextjs-integration
url: https://skills.sh/raphaelmansuy/edgequake/copilotkit-nextjs-integration
---

# copilotkit-nextjs-integration

skills/raphaelmansuy/edgequake/copilotkit-nextjs-integration
copilotkit-nextjs-integration
Installation
$ npx skills add https://github.com/raphaelmansuy/edgequake --skill copilotkit-nextjs-integration
SKILL.md
...
Setup Runtime: Deploy or configure Copilot Runtime endpoint
Wrap App: Wrap your Next.js app with <CopilotKit> provider
Share State: Use useCopilotReadable to expose relevant app data
Define Actions: Use useCopilotAction to enable AI-triggered operations
Add UI: Include <CopilotPopup>, <CopilotSidebar>, or custom chat UI
Test & Refine: Iterate on state exposure and action definitions
...
Check the CopilotKit documentation
Review the examples in the skill directory
