---
title: apple-mail
url: https://skills.sh/mitsuhiko/agent-stuff/apple-mail
---

# apple-mail

skills/mitsuhiko/agent-stuff/apple-mail
apple-mail
Installation
...
Output Format
search returns pipe-delimited table with header row: id|sender|sender_name|subject|received|status|flagged|mailbox|attachments
