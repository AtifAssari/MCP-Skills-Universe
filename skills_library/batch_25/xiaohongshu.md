---
title: xiaohongshu
url: https://skills.sh/stvlynn/skills/xiaohongshu
---

# xiaohongshu

skills/stvlynn/skills/xiaohongshu
xiaohongshu
Installation
$ npx skills add https://github.com/stvlynn/skills --skill xiaohongshu
SKILL.md
小红书 Skill
...
搜索关键词：获取帖子列表
选择帖子：从列表中选择感兴趣的帖子
获取详情：使用 note_id 和 xsec_token 获取完整内容
总结信息：提取关键信息（景点、拍摄机位、tips 等）
注意事项
