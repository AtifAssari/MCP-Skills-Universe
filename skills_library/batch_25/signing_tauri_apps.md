---
title: signing-tauri-apps
url: https://skills.sh/dchuk/claude-code-tauri-skills/signing-tauri-apps
---

# signing-tauri-apps

skills/dchuk/claude-code-tauri-skills/signing-tauri-apps
signing-tauri-apps
Installation
...
Download and convert: base64 -i profile.mobileprovision
...
Download and double-click .cer to install
Configuration
