---
title: wordpress-uploader
url: https://skills.sh/notque/claude-code-toolkit/wordpress-uploader
---

# wordpress-uploader

skills/notque/claude-code-toolkit/wordpress-uploader
wordpress-uploader
Installation
...
Verify ~/.env exists in the home directory
Check it contains WORDPRESS_SITE, WORDPRESS_USER, and WORDPRESS_APP_PASSWORD
...
Verify the username matches the WordPress account exactly
Error: "403 Forbidden"
...
Verify the file path with ls -la <path>
Confirm the file has content (not zero bytes)
