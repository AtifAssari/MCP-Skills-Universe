---
title: deep-research
url: https://skills.sh/wshuyi/deep-research/deep-research
---

# deep-research

skills/wshuyi/deep-research/deep-research
deep-research
Installation
...
搜索时带时间约束（time_range: "month"）
官方源优先（文档、博客、Changelog）
版本号强制标注（禁止「最新版本支持」）
超过 6 个月的博客仅作历史参考
关键信息至少 2 个独立来源确认
