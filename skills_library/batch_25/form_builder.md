---
title: form_builder
url: https://skills.sh/vuralserhat86/antigravity-agentic-skills/form_builder
---

# form_builder

skills/vuralserhat86/antigravity-agentic-skills/form_builder
form_builder
Installation
...
Start with semantic HTML - Use native <input>, <select>, <textarea> when possible
Label everything - Every input needs a visible, descriptive label
Validate on blur - Best UX balance for most forms
Provide helpful errors - Explain what's wrong and how to fix it
Support keyboard navigation - Tab order, arrow keys, escape to dismiss
Mobile-first - Large touch targets, appropriate keyboards
Progressive disclosure - Don't overwhelm with all fields at once
Autosave when possible - Prevent data loss
Test with screen readers - Ensure ARIA attributes work correctly
Use design tokens - Consistent styling, theme support
