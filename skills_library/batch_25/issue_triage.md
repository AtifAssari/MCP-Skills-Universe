---
title: issue-triage
url: https://skills.sh/yunshu0909/yunshu_skillshub/issue-triage
---

# issue-triage

skills/yunshu0909/yunshu_skillshub/issue-triage
issue-triage
Installation
$ npx skills add https://github.com/yunshu0909/yunshu_skillshub --skill issue-triage
SKILL.md
...
用户提供 issue 链接或仓库地址
通过 gh issue view 或 WebFetch 获取 issue 详情
提取关键信息：用户环境、复现步骤、期望行为、实际行为、用户的猜测
...
通过 gh issue comment 发布评论
根据定性结果打标签（bug / enhancement / wontfix / question）
