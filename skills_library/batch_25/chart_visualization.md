...
url: https://skills.sh/antvis/gpt-vis/chart-visualization
---

# chart-visualization

skills/antvis/gpt-vis/chart-visualization
chart-visualization
Installation
...
多维数据字段映射：有两个分类维度时，x 轴维度写 time/category，另一个写 group
语法模式优先用 Syntax 格式（流式友好）
