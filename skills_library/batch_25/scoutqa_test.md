---
title: scoutqa-test
url: https://skills.sh/site/smithery.ai/scoutqa-test
---

# scoutqa-test

skills/smithery.ai/scoutqa-test
scoutqa-test
$ npx skills add https://smithery.ai/skills/github/scoutqa-test
SKILL.md
...
Create a verification execution for the issue
Show the execution ID and browser URL
Stream the agent's verification progress in real-time
Display a completion summary with a link to results
...
Alternatively, use scoutqa get-execution --execution-id <id> to fetch results via CLI
