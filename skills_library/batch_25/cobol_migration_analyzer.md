---
title: cobol-migration-analyzer
url: https://skills.sh/dauquangthanh/hanoi-rainbow/cobol-migration-analyzer
---

# cobol-migration-analyzer

skills/dauquangthanh/hanoi-rainbow/cobol-migration-analyzer
cobol-migration-analyzer
Installation
...
ALWAYS use BigDecimal for COMP-3 and numeric with decimals (never float/double)
Preserve precision: Use BigDecimal with exact scale for financial calculations
