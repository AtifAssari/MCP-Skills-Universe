---
title: listening-to-tauri-events
url: https://skills.sh/dchuk/claude-code-tauri-skills/listening-to-tauri-events
---

# listening-to-tauri-events

skills/dchuk/claude-code-tauri-skills/listening-to-tauri-events
listening-to-tauri-events
Installation
$ npx skills add https://github.com/dchuk/claude-code-tauri-skills --skill listening-to-tauri-events
SKILL.md
