---
title: onboarding
url: https://skills.sh/huytieu/cog-second-brain/onboarding
---

# onboarding

skills/huytieu/cog-second-brain/onboarding
onboarding
Installation
$ npx skills add https://github.com/huytieu/cog-second-brain --skill onboarding
SKILL.md
...
Read each role pack file's YAML frontmatter (role_id and aliases)
Compare the user's extracted role text (case-insensitive) against:
...
Generate 00-inbox/MY-INTEGRATIONS.md:
...
If no role pack was matched, ask about common integrations conversationally:
...
MY-PROFILE.md created in 00-inbox/ with role_pack in frontmatter
MY-INTERESTS.md created in 00-inbox/
MY-INTEGRATIONS.md created in 00-inbox/ with active/disabled sections
Role pack matched (or set to custom) and recommendations presented
Project directories and overviews created (if applicable)
WELCOME-TO-COG.md guide created with role-specific skill ordering
