...
url: https://skills.sh/antvis/infographic/infographic-creator
---

# infographic-creator

skills/antvis/infographic/infographic-creator
infographic-creator
Installation
...
template：用模板表达信息结构。
data：信息图数据，包含 title、desc 和主数据字段。
theme：主题配置，包含 palette、字体、风格化等。
