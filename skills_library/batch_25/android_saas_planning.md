---
title: android-saas-planning
url: https://skills.sh/peterbamuhigire/skills-web-dev/android-saas-planning
---
...
android-saas-planning
Installation
$ npx skills add https://github.com/peterbamuhigire/skills-web-dev --skill android-saas-planning
SKILL.md
...
Numbered requirement IDs — FR-AUTH-001, NFR-PERF-003, etc.
Real Kotlin code — not pseudocode; include actual imports and versions
...
Remove sds/04-offline-sync.md entirely
Simplify Repository pattern (no local-first fallback)
