---
title: learn
url: https://skills.sh/notque/claude-code-toolkit/learn
---

# learn

skills/notque/claude-code-toolkit/learn
learn
Installation
$ npx skills add https://github.com/notque/claude-code-toolkit --skill learn
SKILL.md
...
Cause: scripts/learning-db.py not found or not synced to ~/.claude/scripts/ Solution: Verify working directory is the repo root, or use ~/.claude/scripts/learning-db.py for cross-repo access.
