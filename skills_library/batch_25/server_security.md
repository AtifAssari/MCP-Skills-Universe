...
url: https://skills.sh/majiayu000/claude-arsenal/server-security
---

# server-security

skills/majiayu000/claude-arsenal/server-security
server-security
Installation
$ npx skills add https://github.com/majiayu000/claude-arsenal --skill server-security
SKILL.md
服务器安全审计与加固工具
...
危险服务检查（rpcbind、telnet、ftp、NFS 等）
...
全部自动修复（推荐）— 按优先级依次修复所有发现的问题
仅修复严重和高危 — 只修复红色和黄色标记的问题
选择性修复 — 让我逐项确认
仅生成报告，不修复
修复操作库
