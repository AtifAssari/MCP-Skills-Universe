---
title: yuque-group-meeting-notes
url: https://skills.sh/yuque/yuque-plugin/yuque-group-meeting-notes
---

# yuque-group-meeting-notes

skills/yuque/yuque-plugin/yuque-group-meeting-notes
yuque-group-meeting-notes
Installation
...
议题 (Agenda Items) — What was discussed
讨论要点 (Discussion Points) — Key arguments, opinions, data shared
决议 (Decisions) — What was decided
待办事项 (Action Items) — Who does what by when
备注 (Notes) — Anything else worth recording
...
List available group repos and ask the user to pick one
If there's an obvious "会议纪要" or "Meeting Notes" repo, suggest it
If the user says "就放那个会议的库", match by name
