---
title: commit
url: https://skills.sh/mitsuhiko/agent-commands/commit
---

# commit

skills/mitsuhiko/agent-commands/commit
commit
Installation
$ npx skills add https://github.com/mitsuhiko/agent-commands --skill commit
SKILL.md
