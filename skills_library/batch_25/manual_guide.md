---
title: manual-guide
url: https://skills.sh/peterbamuhigire/skills-web-dev/manual-guide
---

# manual-guide

skills/peterbamuhigire/skills-web-dev/manual-guide
manual-guide
Installation
...
Plans: Scan docs/plans/**/*.md to understand business intent and user stories.
Schema: Scan database/schema/*.sql to identify constraints, triggers, and auto-generated fields.
Codebase: Read implementation in src/ or app/ to see actual UI behavior and data flow.
Documentation: Check docs/* for style guides or technical debt notes.
...
Check if /public/user-manuals.php exists.
Check if /manuals/ exists and contains subdirectories.
If no folders exist, study the codebase and create up to 10 top-level manual sections.
Create /manuals/AGENTS.md describing the directory purpose and what each subfolder should contain.
Create the manual PHP file for the requested module in its subfolder.
