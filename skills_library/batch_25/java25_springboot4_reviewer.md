---
title: java25-springboot4-reviewer
url: https://skills.sh/a-pavithraa/springboot-skills-marketplace/java25-springboot4-reviewer
---

# java25-springboot4-reviewer

skills/a-pavithraa/springboot-skills-marketplace/java25-springboot4-reviewer
java25-springboot4-reviewer
Installation
...
Read changed files
Load java-25-features.md and spring-boot-4-patterns.md
Run Quick Security + Performance checks
...
Glob for controllers, services, security config
...
Glob for repositories, services
...
Understand current pattern (Layered? DDD? Hexagonal?)
...
Reads OrderService.java
Loads java-25-features.md, spring-boot-4-patterns.md, performance-patterns.md, security-checklist.md
Analyzes code against checklists
Reports findings:
## Critical Issues
...
Uses Glob to find all files in order/ module
Loads architecture-patterns.md
Checks for layer violations, DDD patterns, module boundaries
Reports architectural findings with recommendations
Weekly Installs
12
Repository
a-pavithraa/spr…ketplace
GitHub Stars
33
First Seen
Feb 7, 2026
