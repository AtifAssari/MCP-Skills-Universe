...
url: https://skills.sh/nguyenhuuca/assessment/application-security
---

# application-security

skills/nguyenhuuca/assessment/application-security
application-security
Installation
$ npx skills add https://github.com/nguyenhuuca/assessment --skill application-security
SKILL.md
Application Security
OWASP Top 10 (2021)
