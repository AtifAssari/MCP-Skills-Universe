---
title: x-article-publisher
url: https://skills.sh/wshuyi/x-article-publisher-skill/x-article-publisher
---

# x-article-publisher

skills/wshuyi/x-article-publisher-skill/x-article-publisher
x-article-publisher
Installation
...
检查 JSON 输出中的 missing_images 字段
手动将图片复制到 Markdown 文件同目录的 assets/ 子目录
或修改 Markdown 中的图片路径为绝对路径
Weekly Installs
157
Repository
wshuyi/x-articl…er-skill
GitHub Stars
743
First Seen
Jan 20, 2026
