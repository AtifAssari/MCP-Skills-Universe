---
title: slides
url: https://skills.sh/majiayu000/claude-arsenal/slides
---

# slides

skills/majiayu000/claude-arsenal/slides
slides
Installation
$ npx skills add https://github.com/majiayu000/claude-arsenal --skill slides
SKILL.md
PPT 幻灯片生成器
...
slide_01 或 slide_02 必须有专门一页展示身份（用 vo-stat 或 vo-big + vo-tech 高亮）
如果人物有多个身份，选目标受众最熟悉的那个，其他身份可以在后续页补充
...
检查最近 3 套幻灯片用了什么主题（ls voiceover/*/slide_01.html | tail -3 然后读 body class）
不连续重复同一主题
...
背景主题用和内页相同的主题，加 vo-cover-bg-boost 增强
用 Write 工具写 cover.html
截图 → cover.png
...
告知输出目录路径
提示 open preview.html 可在浏览器翻页预览
视频已含字幕，可直接发布
文件组织
<工作目录>/voiceover/
└── <slug>/
...
生成口播稿 — script_notes.md
生成预览器 — preview.html（同口播模式的预览器模板）
展示结果 — 读 PNG 预览 + 告知路径
