---
title: daily-news
url: https://skills.sh/qiaoshouqing/skills/daily-news
---

# daily-news

skills/qiaoshouqing/skills/daily-news
daily-news
Installation
$ npx skills add https://github.com/qiaoshouqing/skills --skill daily-news
SKILL.md
...
Response Guidelines
Always confirm language detection at start
Show progress as sources are collected
Present final report in user's language
Include collection statistics
Save report to file and confirm path
Prioritize visual and inspiring content over text-heavy articles
CRITICAL: Every item MUST include a clickable link to the original source. No item should be listed without a URL. Use markdown link format: [Title](URL)
Include images when available. For Dribbble, use the CDN thumbnail URLs (cdn.dribbble.com/userupload/...?resize=400x0). For other visual platforms, extract image URLs from page data. Use markdown image format: ![alt](image_url)
Weekly Installs
37
Repository
qiaoshouqing/skills
