...
url: https://skills.sh/peterbamuhigire/skills-web-dev/saas-accounting-system
---
...
Balance test: SELECT SUM(debit) - SUM(credit) FROM journal_entry_lines = 0.00
Entry test: Every journal entry has SUM(debit) = SUM(credit)
