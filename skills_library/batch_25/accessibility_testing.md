...
url: https://skills.sh/vuralserhat86/antigravity-agentic-skills/accessibility_testing
---

# accessibility_testing

skills/vuralserhat86/antigravity-agentic-skills/accessibility_testing
accessibility_testing
Installation
...
Capture screenshots of focus states and interactive states
Analyze console for accessibility errors
Document findings with visual evidence (screenshots)
...
WCAG Version: WCAG 2.1 or WCAG 2.2
...
Interactive Component Assessment
...
✅ Use the finding numbering format: A-001, A-002, A-003 (not 1, 2, 3)
✅ Include code examples with proper syntax highlighting
✅ Write a compelling narrative intro paragraph (see template)
...
❌ DO NOT number issues as "1, 2, 3" - use A-001, A-002, A-003 format
...
Use the page's tag if available in the HTML (e.g., "Amazon.com: Online Shopping" → "Amazon")
...
Add alternative text to all images - Affects 12 images across 6 components
Associate labels with all form inputs - Affects contact form, newsletter signup
Implement keyboard accessibility for custom widgets - Affects modals, dropdowns
Restore focus indicators - Affects all interactive elements
Fix ARIA implementation - Correct roles, states, and properties
High Priority Accessibility Enhancements
Improve color contrast ratios - Update color palette to meet WCAG AA minimums
Add skip navigation link - Allow keyboard users to bypass repetitive content
Implement proper heading hierarchy - Ensure logical document structure
Add error announcements to forms - Use aria-live regions for error messages
Fix button/link semantics - Use correct elements for their semantic purpose
Medium Priority Improvements
Enhance form error handling - Provide specific error suggestions
Improve link text - Make links descriptive out of context
Add ARIA landmarks - Properly label page regions for screen readers
Implement proper dialog pattern - Focus trap, ESC key, focus management
Add autocomplete attributes - Help users fill forms (SC 1.3.5)
Long-term Accessibility Strategy
Establish accessibility testing in CI/CD - Automated accessibility checks
Conduct user testing with people with disabilities - Validate real-world usability
Create accessibility component library - Reusable accessible patterns
Implement accessibility training - Educate development team on WCAG
Regular accessibility audits - Quarterly reviews to maintain compliance
Code Remediation Examples
...
Address all Critical severity findings within 1 week
Implement High priority fixes within 1 month
Establish accessibility testing in development workflow
Conduct user testing with assistive technology users
Create accessibility guidelines for ongoing development
...
Test with Actual Assistive Technologies: Automated tools catch only ~30-40% of accessibility issues. Manual testing with screen readers (NVDA, JAWS, VoiceOver) is essential for comprehensive accessibility validation.

Include Users with Disabilities: The most valuable accessibility testing comes from actual users with disabilities. Their lived experience reveals usability issues automated and expert testing may miss.

Progressive Enhancement Approach: Build accessible first, then enhance. Starting with semantic HTML and progressive enhancement ensures baseline accessibility even if JavaScript fails.

Document Accessibility Patterns: Create reusable accessible component patterns and document implementation guidelines to prevent regression and ensure consistency across the application.

Establish Accessibility Testing in CI/CD: Integrate automated accessibility testing (axe-core, Lighthouse) into development workflow to catch issues before production.

Educate Development Team: Accessibility is everyone's responsibility. Provide WCAG training and resources to developers, designers, and content creators.

Regular Accessibility Audits: Conduct quarterly accessibility reviews to catch regressions and ensure ongoing compliance as the application evolves.

Consider Context: Accessibility requirements may vary based on user base, industry regulations, and organizational policies. Align recommendations with specific compliance requirements.
