---
title: wix-cli-extension-registration
url: https://skills.sh/wix/skills/wix-cli-extension-registration
---

# wix-cli-extension-registration

skills/wix/skills/wix-cli-extension-registration
wix-cli-extension-registration
Installation
...
Import the extension from its extensions.ts file
Add .use(extensionName) to the app chain
