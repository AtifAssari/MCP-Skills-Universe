...
url: https://skills.sh/aradotso/trending-skills/llm-wiki-skill
---

# llm-wiki-skill

skills/aradotso/trending-skills/llm-wiki-skill
llm-wiki-skill
Installation
...
Bidirectional links — every entity and topic links to related nodes with [[name]]
Immutable raw — source files in raw/ are never modified after ingestion
...
Obsidian-compatible — open your-wiki/ directly in Obsidian at any time
