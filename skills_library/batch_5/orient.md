---
title: orient
url: https://skills.sh/camacho/ai-skills/orient
---

# orient

skills/camacho/ai-skills/orient
orient
Installation
...
Check for interrupted work: If .branch-context.md exists, read it and include in the brief (resuming work).
