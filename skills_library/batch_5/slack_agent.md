---
title: slack-agent
url: https://skills.sh/vercel-labs/slack-agent-skill/slack-agent
---

# slack-agent

skills/vercel-labs/slack-agent-skill/slack-agent
slack-agent
Installation
...
No package.json with chat or @slack/bolt → Treat as new, start Phase 1
Has project but no customized manifest.json → Start Phase 2
