...
url: https://skills.sh/cline/cline/create-pull-request
---

# create-pull-request

skills/cline/cline/create-pull-request
create-pull-request
Installation
...
Related Issue Number: Look for patterns like #123, fixes #123, or closes #123 in commit messages
