---
title: brainstorm
url: https://skills.sh/buiducnhat/agent-skills/brainstorm
---

# brainstorm

skills/buiducnhat/agent-skills/brainstorm
brainstorm
Installation
...
Produce a concrete, validated design brief in artifacts or a handoff to planning
Workflow
...
If the user picks Write artifacts, proceed to Step 6. Once the draft artifacts exist, use Question Tool again to validate them with options:
