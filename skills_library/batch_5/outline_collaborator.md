---
title: outline-collaborator
url: https://skills.sh/jwynia/agent-skills/outline-collaborator
---

# outline-collaborator

skills/jwynia/agent-skills/outline-collaborator
outline-collaborator
Installation
...
Pause before accepting the first name that comes to mind
Consider the world's cultural logic
Propose 3+ alternatives, none of which are LLM defaults
Use character-naming skill or entropy tools
If unsure, ask: "What cultural background should inform this name?"
Scene Sequencing
...
Generate beat-by-beat proposal
Note key structural choices you made
Ask what to adjust
When asked for plot alternatives:
Provide 2-4 distinct structural options
...
Identify current arc state (if any)
Propose lie/want/need if not established
Map transformation beats to plot points
Show where arc and plot intersect
When they share their outline:
Note what's structurally working
Identify gaps or inconsistencies
Offer specific structural alternatives
Generate exploratory samples for weak points
...
If they want polished, ready-to-use prose: "For finished draft content, you'd switch to story-collaborator. Want me to add some sample approaches to the outline first?"
