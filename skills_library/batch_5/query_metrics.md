---
title: query-metrics
url: https://skills.sh/axiomhq/skills/query-metrics
---

# query-metrics

skills/axiomhq/skills/query-metrics
query-metrics
Installation
...
Workflow
List datasets: Run scripts/datasets <deployment> to see available datasets and their edge deployments
Fetch the spec: Run scripts/metrics-spec <deployment> <dataset> — this step is mandatory before writing any query
Discover metrics: List available metrics via scripts/metrics-info <deployment> <dataset> metrics
Explore tags: List tags and tag values to understand filtering options. If metrics listing fails, use tags and tag values to identify relevant entities, then use those to list metrics for specific tags.
Write and execute query: Compose a metrics query and run it via scripts/metrics-query
