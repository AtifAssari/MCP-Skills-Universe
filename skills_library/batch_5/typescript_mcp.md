...
url: https://skills.sh/jezweb/claude-skills/typescript-mcp
---
...
Prevents critical issues including server instance reuse breaking concurrent sessions, unclosed transport memory leaks, export syntax errors, CORS misconfigurations, and task validation failures
Tasks enable long-running operations with polling; sampling with tools enables server-side agentic behavior using standard MCP primitives
SKILL.md
