---
title: ln-629-lifecycle-auditor
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-629-lifecycle-auditor
---

# ln-629-lifecycle-auditor

skills/levnikolaevich/claude-code-skills/ln-629-lifecycle-auditor
ln-629-lifecycle-auditor
Installation
...
Calculate score
Write Report: Build full markdown report in memory per shared/templates/audit_worker_report_template.md, write to {output_dir}/ln-629--global.md in single Write call
