---
title: twitter-cli
url: https://skills.sh/jackwener/twitter-cli/twitter-cli
---

# twitter-cli

skills/jackwener/twitter-cli/twitter-cli
twitter-cli
Installation
$ npx skills add https://github.com/jackwener/twitter-cli --skill twitter-cli
SKILL.md
...
在页面上刷新，点击任意 x.com 请求
找到 Request Headers → Cookie: 这一行，右键 → 复制值
把完整 Cookie 字符串发给我
