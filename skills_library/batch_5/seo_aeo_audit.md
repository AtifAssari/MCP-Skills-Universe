---
title: seo-aeo-audit
url: https://skills.sh/warpdotdev/oz-skills/seo-aeo-audit
---

# seo-aeo-audit

skills/warpdotdev/oz-skills/seo-aeo-audit
seo-aeo-audit
Installation
...
Audit workflow
Baseline: run Lighthouse and PageSpeed on key templates (home, category, detail, blog).
Crawl: verify indexability, canonicals, and duplicate content (use Search Console + crawler).
Fix blockers: noindex, robots.txt, canonical mismatches, redirect chains.
On-page: titles, meta descriptions, headings, internal linking, image alt.
Structured data: add JSON-LD and validate rich results.
Re-verify: re-run Lighthouse/PageSpeed and check Search Console coverage.
Common pitfalls
...
Author + Organization (trust signals)
Template: references/json-ld-templates.md
