---
title: skills-vote
url: https://skills.sh/memtensor/skills-vote/skills-vote
---

# skills-vote

skills/memtensor/skills-vote/skills-vote
skills-vote
Installation
$ npx skills add https://github.com/memtensor/skills-vote --skill skills-vote
SKILL.md
...
Confirm SKILLS_VOTE_API_KEY is set:
...
Verify that uv is installed: uv -V
If uv is missing, install it from the official docs.
macOS or Linux:
