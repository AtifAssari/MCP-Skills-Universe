---
title: web-design-methodology
url: https://skills.sh/jezweb/claude-skills/web-design-methodology
---

# web-design-methodology

skills/jezweb/claude-skills/web-design-methodology
web-design-methodology
Installation
...
variables.css — tokens first
favicon.svg — simple SVG from brand colour
styles.css — all BEM components
mobile-nav.css — responsive navigation
JS files — from assets/ templates
index.html — homepage first
...
Typography Rules
Dramatic size contrast. Headlines 3-4x body size. clamp(2.5rem, 6vw, 5rem) for hero titles.
...
Letter spacing on uppercase. Add letter-spacing: 0.05em minimum.
Colour Usage
