---
title: assess
url: https://skills.sh/kazukinagata/shinkoku/assess
---

# assess

skills/kazukinagata/shinkoku/assess
assess
Installation
...
概算金額: 年間の譲渡益/損、配当金額、源泉徴収済み税額
1-2b. FX取引の詳細確認（該当者のみ）

FX取引がある場合、以下を確認する:

取引の種類: 店頭FX / 取引所FX（いずれも分離課税）
年間の損益: 実現損益 + スワップ収入 - 取引手数料等
繰越損失: 前年以前の繰越損失（最大3年）の有無
注意: FXの損益は株式とは通算不可（別プール）
1-2c. 仮想通貨（暗号資産）の詳細確認（該当者のみ）

暗号資産の取引がある場合、以下を確認する:

取引の種類: 売却、交換、決済利用、マイニング等
年間の損益: 総平均法または移動平均法で計算
課税区分: 雑所得（総合課税）として申告
注意: 暗号資産の損失は他の所得と通算不可（雑所得内でのみ通算可）
1-3. 控除関連の確認
