---
title: blitzreels-video-editing
url: https://skills.sh/blitzreels/agent-skills/blitzreels-video-editing
---

# blitzreels-video-editing

skills/blitzreels/agent-skills/blitzreels-video-editing
blitzreels-video-editing
Installation
...
Primary Workflow
Create project — POST /projects {"name":"...", "aspect_ratio":"9:16"}
Upload media — editor.sh upload-url (URL import) or 2-step presigned upload
Add to timeline — editor.sh add-media places media on the timeline
Transcribe — editor.sh transcribe generates word-level captions
Get context — editor.sh context to see timeline state
Edit timeline — trim, split, delete, reorder, auto-remove silences
Apply captions — editor.sh captions <presetId> for styled subtitles
Add overlays — text overlays, motion code, motion graphics
Add background — fill layers (gradients, cinematic, patterns)
Export — editor.sh export renders final video with download URL
Scripts
scripts/editor.sh
