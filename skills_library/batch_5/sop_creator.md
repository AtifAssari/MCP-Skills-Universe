---
title: sop-creator
url: https://skills.sh/ognjengt/founder-skills/sop-creator
---

# sop-creator

skills/ognjengt/founder-skills/sop-creator
sop-creator
Installation
...
Write at 5th-grade reading level — short sentences, simple words
One action per step — no compound instructions
Start each step with action verbs — "Click", "Open", "Verify", "Enter"
Include expected results — tell users what they should see
Add warnings for critical steps — prevent common mistakes
Create quality checks — define "done" explicitly
5. Format and Verify
