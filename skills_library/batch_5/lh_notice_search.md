---
title: lh-notice-search
url: https://skills.sh/nomadamas/k-skill/lh-notice-search
---

# lh-notice-search

skills/nomadamas/k-skill/lh-notice-search
lh-notice-search
Installation
...
마감 여부는 KST 기준 현재 날짜와 clsg_dt 를 비교해 판정한다. 오늘 = 마감일이면 "오늘 마감"으로 표기한다.
