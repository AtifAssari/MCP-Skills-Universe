...
url: https://skills.sh/anthropics/knowledge-work-plugins/roadmap-management
---

# roadmap-management

skills/anthropics/knowledge-work-plugins/roadmap-management
roadmap-management
Installation
$ npx skills add https://github.com/anthropics/knowledge-work-plugins --skill roadmap-management
Summary

Strategic product roadmap planning using RICE, MoSCoW, ICE, and dependency mapping frameworks.

Supports multiple roadmap formats: Now/Next/Later for simplicity, Quarterly Themes for strategic alignment, OKR-aligned roadmaps for accountability, and Gantt views for execution planning
Includes four prioritization frameworks (RICE scoring, MoSCoW categorization, ICE scoring, and Value vs Effort matrices) to defend prioritization decisions across different contexts
Provides dependency mapping across technical, team, external, knowledge, and sequential categories, with strategies for identifying owners, setting "need by" dates, and reducing cross-team coordination risk
Covers capacity planning with allocation guidance (70% features, 20% tech health, 10% unplanned buffer) and frameworks for communicating roadmap changes and tradeoffs to stakeholders
SKILL.md
