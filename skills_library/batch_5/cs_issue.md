---
title: cs-issue
url: https://skills.sh/liuzhengdongfortest/codestable/cs-issue
---
...
问题描述只在脑子里改完就忘——三个月后 bug 再现没复现步骤留存
根因没分析就动手——改了表面现象深层问题等下次爆发
修复范围扩散——发现一个 bug 顺手改五处引入新问题，无法追溯
没验收闭环——怎么判断改好了？改好了什么？没记录
...
AI 读完代码后对根因高度有把握（能明确指出 file:line + 原因）
修复改动很小（1-2 处）
无跨模块影响风险
