---
title: wix-cli-orchestrator
url: https://skills.sh/wix/skills/wix-cli-orchestrator
---

# wix-cli-orchestrator

skills/wix/skills/wix-cli-orchestrator
wix-cli-orchestrator
Installation
...
App Namespace Requirement: When creating a Data Collection, you MUST ask the user for their app namespace. If not provided, read APP_IDENTIFIERS.md and give the user the instructions to obtain it.

Code Identifier Requirement: When creating a Site Component, you need the user's Code Identifier. If not provided, read APP_IDENTIFIERS.md and give the user the instructions to obtain it.
