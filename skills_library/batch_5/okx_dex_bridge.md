---
title: okx-dex-bridge
url: https://skills.sh/okx/onchainos-skills/okx-dex-bridge
---

# okx-dex-bridge

skills/okx/onchainos-skills/okx-dex-bridge
okx-dex-bridge
Installation
...
Net effect: ~{minimumReceived} arriving on the destination chain after ~{estimateTime}s. Then ask "confirm to proceed?".
