---
title: deno-expert
url: https://skills.sh/denoland/skills/deno-expert
---

# deno-expert

skills/denoland/skills/deno-expert
deno-expert
Installation
...
First choice: jsr: packages (e.g., jsr:@std/http)
Second choice: npm: packages when no JSR alternative exists
Never recommend the old URL-based registry — it is deprecated
...
Run deno add jsr:@package/name
Use the bare specifier
