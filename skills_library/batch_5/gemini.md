---
title: gemini
url: https://skills.sh/davila7/claude-code-templates/gemini
---

# gemini

skills/davila7/claude-code-templates/gemini
gemini
Installation
...
For background/automated tasks, ALWAYS use --approval-mode yolo or add timeout wrapper. NEVER use default in non-interactive shells.
