---
title: ln-623-code-principles-auditor
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-623-code-principles-auditor
---

# ln-623-code-principles-auditor

skills/levnikolaevich/claude-code-skills/ln-623-code-principles-auditor
ln-623-code-principles-auditor
Installation
...
Write Report: Build full markdown report in memory per shared/templates/audit_worker_report_template.md, write to {output_dir}/ln-623--{domain}.md (or 623-principles.md in global mode) in single Write call. Include <!-- FINDINGS-EXTENDED --> JSON block with pattern_signature fields for cross-domain DRY analysis
