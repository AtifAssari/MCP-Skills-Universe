---
title: nexus-mapper
url: https://skills.sh/haaaiawd/nexus-skills/nexus-mapper
---

# nexus-mapper

skills/haaaiawd/nexus-skills/nexus-mapper
nexus-mapper
Installation
...
[!IMPORTANT] 写入 concept_model.json 前，必须先区分节点是 implemented、planned 还是 inferred。 只有 implemented 节点允许写入 code_path，且必须亲手验证存在。
