---
title: memory
url: https://skills.sh/yonatangross/orchestkit/memory
---

# memory

skills/yonatangross/orchestkit/memory
memory
Installation
...
MCP mcp__memory__search_nodes for anything the filesystem index doesn't answer (typed graph traversal)
