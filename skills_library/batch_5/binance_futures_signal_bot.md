...
url: https://skills.sh/aradotso/trending-skills/binance-futures-signal-bot
---

# binance-futures-signal-bot

skills/aradotso/trending-skills/binance-futures-signal-bot
binance-futures-signal-bot
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill binance-futures-signal-bot
SKILL.md
Binance Futures Signal Bot
...
Never commit config.json with real keys — it is .gitignored by default.
...
Verify telegram_channel_id starts with -100
Send a test message to the channel after adding the bot
Check bot token with: https://api.telegram.org/bot<TOKEN>/getMe
