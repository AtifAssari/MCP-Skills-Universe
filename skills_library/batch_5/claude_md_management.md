...
url: https://skills.sh/giuseppe-trisciuoglio/developer-kit/claude-md-management
---

# claude-md-management

skills/giuseppe-trisciuoglio/developer-kit/claude-md-management
claude-md-management
Installation
$ npx skills add https://github.com/giuseppe-trisciuoglio/developer-kit --skill claude-md-management
SKILL.md
CLAUDE.md Management
