---
title: aiconfig-create
url: https://skills.sh/launchdarkly/agent-skills/aiconfig-create
---

# aiconfig-create

skills/launchdarkly/agent-skills/aiconfig-create
aiconfig-create
Installation
...
create-ai-config -- create the config shell
create-ai-config-variation -- add the variation with model, prompts, and parameters
get-ai-config -- verify the result
...
Config exists with the correct mode
...
Opening the AI Config in the LD UI, switching to the correct environment, and confirming "Default rule serves: {variationName}" is shown with targeting On.
Running a quick test: ai_config = ai_client.{completion|agent}_config(...) and asserting ai_config.enabled is True.
