---
title: geo-llmstxt
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-llmstxt
---

# geo-llmstxt

skills/zubair-trabzada/geo-seo-claude/geo-llmstxt
geo-llmstxt
Installation
$ npx skills add https://github.com/zubair-trabzada/geo-seo-claude --skill geo-llmstxt
SKILL.md
...
Use WebFetch to retrieve [domain]/llms.txt.
Also check for [domain]/llms-full.txt.
...
Footer links
Fetch /sitemap.xml to discover all public pages.
Identify the site's primary business type (SaaS, E-commerce, Local, Publisher, Agency).
...
Use absolute URLs. Always include the full https:// URL, never relative paths.
Test after deployment. After uploading, verify the file is accessible at https://yourdomain.com/llms.txt with no redirects.
Coordinate with robots.txt. Ensure pages listed in llms.txt are not blocked in robots.txt for AI crawlers.
