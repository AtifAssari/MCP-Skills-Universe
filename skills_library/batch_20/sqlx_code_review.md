---
title: sqlx-code-review
url: https://skills.sh/existential-birds/beagle/sqlx-code-review
---

# sqlx-code-review

skills/existential-birds/beagle/sqlx-code-review
sqlx-code-review
Installation
$ npx skills add https://github.com/existential-birds/beagle --skill sqlx-code-review
SKILL.md
sqlx Code Review
Review Workflow
...
Check query patterns — Compile-time checked (query!, query_as!) vs runtime (query, query_as)
