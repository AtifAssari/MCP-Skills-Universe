---
title: vm-code-refactor
url: https://skills.sh/zeal422/dev-toolbelt-by-vm/vm-code-refactor
---

# vm-code-refactor

skills/zeal422/dev-toolbelt-by-vm/vm-code-refactor
vm-code-refactor
Installation
$ npx skills add https://github.com/zeal422/dev-toolbelt-by-vm --skill vm-code-refactor
SKILL.md
...
Path Validation: After receiving paths, validate each one:
...
Update User class to compose services
...
Strategy Pattern - DataSorter, Validators (3 places)
Factory Pattern - User creation, Response builders (2 places)
Observer Pattern - Event handling, State updates (4 places)
Decorator Pattern - API middleware, Logging (2 places)
...
Before: Code Health: 68/100 Page Load: 8.2s Complexity: 18

After: Code Health: 85/100 Page Load: 0.8s Complexity: 8
