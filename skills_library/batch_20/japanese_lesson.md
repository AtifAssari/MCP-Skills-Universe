...
url: https://skills.sh/m00nl1ghtp00l/podpilot/japanese-lesson
---

# japanese-lesson

skills/m00nl1ghtp00l/podpilot/japanese-lesson
japanese-lesson
Installation
...
Example: | 火事 | かじ | fire | Noun | 山火事が起きました | 15 | | 山 | やま | mountain | Noun | 山の方に行きました | 12 |
...
Example: | 野次馬 | やじうま | onlooker (pejorative) | Noun | やじうま根性 | 6 | | 野次 | やじ | heckling | Noun | 野次馬 | 1 | | 馬 | うま | horse | Noun | 野次馬 | 1 |
...
Review for obvious misclassifications (e.g., basic words like 面白い should be N4, not N1)
...
Read both the plain transcript (.txt) and linked transcript (_linked.txt)
Use the linked transcript to get YouTube timestamps for examples
Generate lesson following the structure above, with hyperlinked examples
Save to $PODPILOT_DATA/{channel}/{date}_{title}_lesson.md
Required Files
