...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/auditing-aws-s3-bucket-permissions
---

# auditing-aws-s3-bucket-permissions

skills/mukul975/anthropic-cybersecurity-skills/auditing-aws-s3-bucket-permissions
auditing-aws-s3-bucket-permissions
Installation
$ npx skills add https://github.com/mukul975/anthropic-cybersecurity-skills --skill auditing-aws-s3-bucket-permissions
SKILL.md
Auditing AWS S3 Bucket Permissions
When to Use
...
Run aws s3api get-bucket-acl and find a grant to AllUsers with READ permission
Check get-bucket-policy and discover a policy with Principal: "*" and s3:GetObject
Confirm Block Public Access is not enabled at the bucket or account level
Enumerate bucket contents to assess data sensitivity
Immediately enable Block Public Access on the bucket
Review CloudTrail S3 data events to determine if unauthorized access occurred
Report the finding with timeline, data inventory, and remediation confirmation
