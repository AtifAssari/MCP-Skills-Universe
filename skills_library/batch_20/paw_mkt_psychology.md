---
title: paw-mkt-psychology
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-psychology
---

# paw-mkt-psychology

skills/pawbytes/skill-suites/paw-mkt-psychology
paw-mkt-psychology
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-mkt-psychology
SKILL.md
...
Identify the requesting context — Determine which channel or skill needs psychology input (CRO, email, pricing, retention, etc.). Psychology is a cross-cutting advisory skill — the recommendation must fit the requesting context.
Read strategic context — Pre-Flight: brand and SOSTAC first when available. Understand the audience's beliefs, motivations, and decision-making context before applying any framework.
Load the workflow — Read ./references/workflow.md and identify the appropriate workflow phase based on the user's request.
Diagnose behavioral barriers — Before prescribing techniques, identify the specific cognitive or motivational barrier blocking the desired action (fear, confusion, inertia, distrust, etc.).
Apply frameworks — Match the barrier to the highest-leverage psychological frameworks. Prioritize the top three interventions — not an exhaustive list.
Deliver with ethical verification — Every recommendation must pass the ethical gate: would the customer feel well-served if they understood exactly what technique was being used? Provide before/after rewrites when applicable.
Save deliverables — Write to the resolved path (see Path Resolution).
Recommend next steps — Route implementation back to the originating skill (CRO for page changes, email for sequence rewrites, etc.) or suggest the next workflow phase.
Escalation Routes
