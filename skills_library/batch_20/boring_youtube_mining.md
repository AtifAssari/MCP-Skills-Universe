---
title: boring-youtube-mining
url: https://skills.sh/mrpaulscrivens/boring-zoo/boring-youtube-mining
---

# boring-youtube-mining

skills/mrpaulscrivens/boring-zoo/boring-youtube-mining
boring-youtube-mining
Installation
...
Strip all timestamp lines (lines matching XX:XX:XX.XXX --> XX:XX:XX.XXX)
Strip the WEBVTT header and Kind:/Language: metadata lines
Remove duplicate consecutive lines (VTT repeats lines across cue boundaries)
Remove position/alignment tags like <c>, </c>, align:start position:0%
Join into paragraphs (group sentences, add line breaks at natural pauses)
