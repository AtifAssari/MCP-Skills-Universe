---
title: amq-spec
url: https://skills.sh/avivsinai/agent-message-queue/amq-spec
---

# amq-spec

skills/avivsinai/agent-message-queue/amq-spec
amq-spec
Installation
...
Pre-flight
Verify AMQ is available: which amq
Verify the AMQ root is discoverable (.amqrc, AMQ env vars, or the default .agent-mail layout); otherwise run: amq coop init
Use thread name: spec/<topic>
