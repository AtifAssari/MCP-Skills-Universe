---
title: axiom-hig-ref
url: https://skills.sh/charleswiltgen/axiom/axiom-hig-ref
---

# axiom-hig-ref

skills/charleswiltgen/axiom/axiom-hig-ref
axiom-hig-ref
Installation
...
Ultra-thin — Minimal separation, content clearly visible
Thin — Lighter-weight interactions
Regular — Default, works well in most circumstances
Thick — Most separation from background
...
Launch — System displays launch screen, transitions to first screen
Onboarding (optional) — Can include branding and education
Continued use — "Restore the previous state when your app restarts so people can continue where they left off"
Platform-Specific Guidance
iOS
