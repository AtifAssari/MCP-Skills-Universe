...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/conducting-external-reconnaissance-with-osint
---

# conducting-external-reconnaissance-with-osint

skills/mukul975/anthropic-cybersecurity-skills/conducting-external-reconnaissance-with-osint
conducting-external-reconnaissance-with-osint
Installation
...
GitHub search discovers a former developer's public repository containing a .env file with AWS access keys
LinkedIn analysis reveals the company uses Okta for SSO, Jira for project management, and AWS for hosting
