---
title: aile-using-superpowers
url: https://skills.sh/zhucl1006/ailesuperpowers/aile-using-superpowers
---

# aile-using-superpowers

skills/zhucl1006/ailesuperpowers/aile-using-superpowers
aile-using-superpowers
Installation
$ npx skills add https://github.com/zhucl1006/ailesuperpowers --skill aile-using-superpowers
SKILL.md
...
在克勞德代碼中： 使用Skill工具。當您調用一項技能時，其內容將被加載並呈現給您 - 直接遵循它。切勿對技能文件使用讀取工具。
...
「讓我們眼前X」→先集思廣益，然後是實作技巧。 “修復此錯誤”→ 首先調試，然後再進行特定領域的技能。
