...
url: https://skills.sh/abelv22/project-foundation/supabase-backend
---

# supabase-backend

skills/abelv22/project-foundation/supabase-backend
supabase-backend
Installation
$ npx skills add https://github.com/abelv22/project-foundation --skill supabase-backend
SKILL.md
