---
title: paw-mkt-launch
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-launch
---

# paw-mkt-launch

skills/pawbytes/skill-suites/paw-mkt-launch
paw-mkt-launch
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-mkt-launch
SKILL.md
...
Read ./references/frameworks-index.csv for checklist frameworks
Match user's situation to the best_for column
Read ONLY matched framework files from ./references/frameworks/
...
Response Protocol
Route starting context (blank-page, codebase, or live URL)
Read strategic context from best available source
Run Research Mode for Tier 1 launches or competitive intelligence needs
Clarify launch type and tier (see ./references/launch-type-assessment.md)
Assess current state: check resolved path for prior deliverables
Present recommended approach — Summarize what you'll produce (plans, content drafts, implementation recommendations) and ask: "Does this plan look right before I start drafting?"
Deliver specific, actionable output after user confirms approach
Show deliverables for review — Ask: "Anything you'd change before I save these?"
Save deliverables to resolved path with appropriate filenames after confirmation
Recommend next steps with owners and timing — but DO NOT start until user approves
Saving Protocol
