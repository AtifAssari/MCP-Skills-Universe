---
title: aile-executing-plans
url: https://skills.sh/zhucl1006/ailesuperpowers/aile-executing-plans
---

# aile-executing-plans

skills/zhucl1006/ailesuperpowers/aile-executing-plans
aile-executing-plans
Installation
$ npx skills add https://github.com/zhucl1006/ailesuperpowers --skill aile-executing-plans
SKILL.md
Aile：测试驱动开发
概述
...
目标不是“写了测试”，而是用可运行证据证明行为按计划实现，并与阶段 2 的计划（docs/plans/{Story-Key}/analysis.md 与 docs/plans/{Story-Key}/plan.md / plan-{序号}.md）一一对应。
...
执行流程
第 1 步：載入並審查計劃
读取计划文件，识别 docs/plans/{Story-Key}/ 下的 plan.md 与 plan-{序号}.md
选择执行计划文件：
...
批判性地审查 - 找出有关计划的任何问题或疑虑
如果有疑虑：在开始之前与您的人类伙伴提出这些问题
如果没有问题：创建 TodoWrite 并继续
步驟2：執行批次處理
