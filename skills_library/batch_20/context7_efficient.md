---
title: context7-efficient
url: https://skills.sh/bilalmk/todo_correct/context7-efficient
---

# context7-efficient

skills/bilalmk/todo_correct/context7-efficient
context7-efficient
Installation
...
fetch-docs.sh calls fetch-raw.sh (which uses mcp-client.py)
Full response (934 tokens) stays in subprocess memory
