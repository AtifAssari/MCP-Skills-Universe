---
title: qt test patterns
url: https://skills.sh/l3digital-net/claude-code-plugins/qt-test-patterns
---

# qt test patterns

skills/l3digital-net/claude-code-plugins/Qt Test Patterns
Qt Test Patterns
Installation
$ npx skills add https://github.com/l3digital-net/claude-code-plugins --skill 'Qt Test Patterns'
SKILL.md
Qt Test Patterns
