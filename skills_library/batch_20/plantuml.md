---
title: plantuml
url: https://skills.sh/spillwavesolutions/plantuml/plantuml
---

# plantuml

skills/spillwavesolutions/plantuml/plantuml
plantuml
Installation
$ npx skills add https://github.com/spillwavesolutions/plantuml --skill plantuml
SKILL.md
...
Convert standalone .puml files to PNG or SVG images
Extract puml code blocks from markdown and convert to images
Process linked .puml files in markdown (![diagram](path/to/diagram.puml))
...
Check references/troubleshooting/toc.md for error classification
Load specific guide from references/troubleshooting/[category]_guide.md
Check references/common_syntax_errors.md for diagram type

Step 4: Validate & Integrate

Verify image file exists
Add image link: ![title](diagrams/filename.png)
...
Review example in examples/[app-type]/
Map code structure to diagram patterns
Copy and adapt the example .puml file
Use Unicode symbols from references/unicode_symbols.md for semantic clarity
Converting Diagrams to Images
...
Check syntax: java -jar plantuml.jar --check-syntax file.puml
Identify error type
Load troubleshooting guide: references/troubleshooting/toc.md
...
Navigate types: Start with references/toc.md
Learn syntax: Open references/[diagram_type]_diagrams.md
Apply styling: Use references/styling_guide.md
Add symbols: Use references/unicode_symbols.md
Convert files: scripts/convert_puml.py
Process markdown: scripts/process_markdown_puml.py
Troubleshoot: references/troubleshooting/toc.md
