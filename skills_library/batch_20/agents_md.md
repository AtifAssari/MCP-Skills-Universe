---
title: agents-md
url: https://skills.sh/mblode/agent-skills/agents-md
---

# agents-md

skills/mblode/agent-skills/agents-md
agents-md
Installation
...
Run smoke checks for core commands (dev, test, build, lint/typecheck) when applicable
If commands cannot be run, verify script existence and note the limitation
