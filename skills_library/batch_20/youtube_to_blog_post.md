...
url: https://skills.sh/wlzh/skills/youtube-to-blog-post
---

# youtube-to-blog-post

skills/wlzh/skills/youtube-to-blog-post
youtube-to-blog-post
Installation
...
配置优先级
~/.youtube-blog-config.json (本地用户配置)
--config 指定的配置文件
博客目录下的 youtube-blog-config.json
📄 文章格式
...
禁止中英双语标签 - 不要写 海外应用-Foreign-Apps 这种格式，统一用中文
禁止大小写重复 - 统一用 Telegram 而非 telegram，AI工具 而非 ai工具
标准标签表（67 个，按分类）
