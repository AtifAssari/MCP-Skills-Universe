---
title: multi-repository-orchestrator
url: https://skills.sh/jackspace/claudeskillz/multi-repository-orchestrator
---

# multi-repository-orchestrator

skills/jackspace/claudeskillz/multi-repository-orchestrator
multi-repository-orchestrator
Installation
...
Best Practices
✅ DO
Use workspace files to define repository collections
Batch operations for efficiency
Check status before batch commits
Test before pushing across all repos
Use retry logic for network operations
Maintain consistency in branch naming
Track dependencies between repositories
Document relationships in workspace config
❌ DON'T
Don't assume all repos need same changes
Don't skip individual repo status checks
Don't force push without careful consideration
Don't ignore test failures in any repo
Don't commit unrelated changes together
Don't break cross-repo dependencies
Don't forget to update shared libraries first
Don't over-parallelize (3-5 concurrent max)
Quick Reference
