---
title: understanding-streamlit-architecture
url: https://skills.sh/streamlit/streamlit/understanding-streamlit-architecture
---

# understanding-streamlit-architecture

skills/streamlit/streamlit/understanding-streamlit-architecture
understanding-streamlit-architecture
Installation
...
Widget interaction: User clicks button, moves slider, etc.
Source code change: File watcher detects script modification
st.rerun(): Explicit programmatic rerun
Fragment timer: @st.fragment(run_every=...) periodic reruns
...
Proto definition: proto/streamlit/proto/<Element>.proto
Register in Element.proto: Add to oneof type
Backend mixin: lib/streamlit/elements/<element>.py
Frontend component: frontend/lib/src/components/elements/<Element>/ or frontend/lib/src/components/widgets/<Element>/ (depending on element vs widget)
Register in ElementNodeRenderer: Add case to switch statement
Compile protos: make protobuf
