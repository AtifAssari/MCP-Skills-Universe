---
title: paw-mkt-influencer
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-influencer
---

# paw-mkt-influencer

skills/pawbytes/skill-suites/paw-mkt-influencer
paw-mkt-influencer
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-mkt-influencer
SKILL.md
...
Read ./references/frameworks-index.csv for indexed framework files.
...
Clarify scope: Strategy, identification, outreach, campaign planning, UGC, affiliate, or performance?
Assess current state: Check resolved path for prior deliverables.
Deliver actionable output: Specific strategies, shortlists, briefs, templates.
Save deliverables: Write all outputs to resolved path.
