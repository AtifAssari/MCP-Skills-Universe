---
title: qt-bindings
url: https://skills.sh/l3digital-net/claude-code-plugins/qt-bindings
---

# qt-bindings

skills/l3digital-net/claude-code-plugins/qt-bindings
qt-bindings
Installation
$ npx skills add https://github.com/l3digital-net/claude-code-plugins --skill qt-bindings
SKILL.md
Python Qt Bindings
Choosing a Binding
