...
url: https://skills.sh/dlimkin/agent-skills/ionic-components
---

# ionic-components

skills/dlimkin/agent-skills/ionic-components
ionic-components
Installation
$ npx skills add https://github.com/dlimkin/agent-skills --skill ionic-components
SKILL.md
...
Use Ionic component if available — with proper ion- tags and Ionic properties
Custom HTML/CSS only if Ionic has no equivalent component or lacks required functionality
...
Context7 first (if available) — resolve ionic and fetch relevant docs
Fallback — check https://ionicframework.com/docs/components directly
Icons — Ionicons
...
❌ Using slot="icon-only" outside of a button ❌ Using slot="start" on text content in ion-item (use default slot) ❌ Placing ion-buttons directly in ion-toolbar without a slot ❌ Using slot="fixed" anywhere other than ion-content
