---
title: module-class-session-planner
url: https://skills.sh/jorgealves/agent_skills/module-class-session-planner
---

# module-class-session-planner

skills/jorgealves/agent_skills/module-class-session-planner
module-class-session-planner
Installation
$ npx skills add https://github.com/jorgealves/agent_skills --skill module-class-session-planner
SKILL.md
Module Class Session Planner
Purpose and Intent
