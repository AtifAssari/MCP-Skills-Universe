---
title: vsl-script-writing
url: https://skills.sh/dmend3z/tribo-skills/vsl-script-writing
---
...
vsl-script-writing
Installation
$ npx skills add https://github.com/dmend3z/tribo-skills --skill vsl-script-writing
SKILL.md
VSL Script Writing
Overview
...
Product/Service: What exactly are you selling? Please provide a name and a brief description.
Target Audience: Who is your ideal customer? Describe their demographics, biggest pain points, desires, and what they've already tried to solve their problem.
Primary Goal: What is the single most important action you want the viewer to take after watching this video (e.g., click a link, buy a product, schedule a call)?
The "Big Promise": What is the single biggest, most desirable result or outcome your product delivers for your customers?
Unique Mechanism: What is the unique name or process behind how your product works? (e.g., "The Metabolic Flip," "The 3-Step Profit Activator"). This is what makes your solution different.
Offer Details: What is included in the offer? Please list the core product and any bonuses. What is the price?
Your Story (Epiphany Bridge): What is your personal story related to the problem this product solves? What was the "aha" moment or epiphany that led you to create this solution?
Tone & Style: What should the tone of the video be (e.g., energetic and hyped, serious and professional, empathetic and caring)?
Known Objections: What are the most common reasons people might hesitate to buy? What are their biggest doubts or fears?
Call to Action: What is the specific URL or next step you want to direct viewers to? Is there any urgency or scarcity (e.g., limited spots, price increasing soon)?
Core Frameworks
...
Nail the Hook: Spend the majority of your time perfecting the first 10 seconds. If you don't get the hook right, the rest of the VSL doesn't matter.
Three Levels of Pain: When agitating the problem, you must address the external (physical/tangible), internal (emotional), and philosophical (purpose/status) struggles of your audience.
The Epiphany Bridge is a Story, Not a Lecture: Tell a real, vulnerable story. Don't just list facts. The goal is for the viewer to feel like they are having the epiphany with you.
Value-Anchored Offer Stack: The perceived value of your offer stack should be at least 10x the actual price. Anchor each item with a high value before revealing the final, much lower price.
Strong, Clear Call to Action: Be direct. Tell them exactly where to click and what will happen next. Use phrases like "Click the button below this video right now."
Future Pacing: Help the viewer imagine their life after they've used your product and achieved their desired result. Paint a vivid picture of their success.
Incorporate a "Unique Mechanism": Your solution needs a unique name or process that makes it distinct. This isn't just a "course"; it's the "Profit Path Accelerator." This makes your solution proprietary and harder to commoditize.
A-Tier Tactics (Highly Effective)
Use Open Loops: Create curiosity by opening a story or idea at the beginning of the VSL and only closing it later. This keeps viewers engaged.
"If/Then" Statements: Use "If you're someone who..." statements to segment your audience and make them feel understood.
Social Proof: Weave in testimonials, case studies, and statistics throughout the script, not just in one section.
Scarcity and Urgency: Use real (or ethically framed) scarcity and urgency to drive action. Examples: "Only 50 spots available," "Price increases tomorrow."
Handle Objections Before They Arise: Address common questions and doubts ("Is this for me?", "What if I don't have time?") directly in your script.
Use Simple Language: Write like you talk. Avoid jargon and complex vocabulary. The goal is clarity and connection, not to sound smart.
Visual Cues in Script: Write visual cues in your script (e.g., [Show image of a frustrated business owner]) to guide video production.
B-Tier Tactics (Good to Have)
The "One Thing" Focus: Center your entire VSL around the "one big thing" your product solves. Don't try to be everything to everyone.
"Feel, Felt, Found" for Objections: When addressing an objection, say "I know how you feel. I felt the same way. But here's what I found..."
Use a Catchy Tagline: A memorable phrase that summarizes your big promise.
Down-sell or Up-sell Paths: For more advanced funnels, script out what happens if they say "no" (down-sell) or "yes" (up-sell).
Common Mistakes to Avoid (D-Tier)
Revealing the Solution Too Early: If you give away the "what" and "how" before building value, there's no reason for them to buy.
Being Boring: A monotone delivery or a script devoid of personality will kill your conversion rate. Be energetic and passionate.
A Weak or Unclear Offer: If the viewer is confused about what they get or what it costs, they won't buy. Be crystal clear.
No Risk Reversal: A lack of a guarantee signals a lack of confidence in your own product.
Focusing on Features, Not Benefits: People don't buy a drill; they buy a hole in the wall. Sell the result, not the process.
Making It All About You: While you tell a personal story, the focus must always be on the viewer and their problems. Your story is a vehicle to connect with them.
Hiding the Price: Be upfront about the price when it's time to reveal it. Don't make them click to find out.
...
Phase 2: The Hook (First 30 Seconds)
...
Phase 3: The Story (10-20 Minutes for Long-Form)
...
Phase 4: The Offer (5-10 Minutes)
