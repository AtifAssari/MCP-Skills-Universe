---
title: okx-buildx-hackathon-agent-track
url: https://skills.sh/okx/plugin-store/okx-buildx-hackathon-agent-track
---

# okx-buildx-hackathon-agent-track

skills/okx/plugin-store/okx-buildx-hackathon-agent-track
okx-buildx-hackathon-agent-track
Installation
$ npx skills add https://github.com/okx/plugin-store --skill okx-buildx-hackathon-agent-track
SKILL.md
...
OnchainOS API key: Only send to OnchainOS endpoints. Your human obtains it from the Dev Portal. Never include in submissions, repos, or public content.
