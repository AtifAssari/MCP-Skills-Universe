---
title: goodvibes-codebase-review
url: https://skills.sh/mgd34msu/goodvibes-plugin/goodvibes-codebase-review
---

# goodvibes-codebase-review

skills/mgd34msu/goodvibes-plugin/goodvibes-codebase-review
goodvibes-codebase-review
Installation
...
Spawns agent with run_in_background: true
Stops taking actions (turn ends)
...
First: Check mcp-cli info then mcp-cli call plugin_goodvibes_*
Second: Use precision tools (precision_edit, precision_read, etc.)
...
Follow the fix_guidance provided for each issue
Use precision tools for all operations
