...
url: https://skills.sh/mgd34msu/goodvibes-plugin/fullstack-feature
---

# fullstack-feature

skills/mgd34msu/goodvibes-plugin/fullstack-feature
fullstack-feature
Installation
...
Review (runtime-driven) - WRFC chains from prior phases complete via runtime <gv> directives
Commit + Log - Triggered when runtime issues complete directives; git commit, update memory/logs, report to user
...
Evaluates the output against the configured score_threshold (default: 9.5 from goodvibes.json)
...
Vibecoding: Checkpoint after this phase. Commit with message checkpoint: foundation - schema and types. Justvibes: Auto-proceed to Phase 3.
...
Vibecoding: Checkpoint after this phase. Commit with message checkpoint: core implementation. Justvibes: Auto-proceed to Phase 4.
...
Vibecoding: Checkpoint after this phase. Commit with message checkpoint: integration. Justvibes: Auto-proceed to Phase 5.
...
Vibecoding: Checkpoint after this phase. Commit with message checkpoint: quality checks. Justvibes: Auto-proceed; runtime handles review cycles.
...
Each work agent from Phases 2-5 completes and emits a <gv> tag
...
Discover: Use discover tool to run parallel grep/glob/symbol queries
Plan: Identify files to create/modify, order of operations, batch opportunities
