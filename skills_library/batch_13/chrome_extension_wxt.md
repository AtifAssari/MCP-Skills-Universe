---
title: chrome-extension-wxt
url: https://skills.sh/tenequm/claude-plugins/chrome-extension-wxt
---

# chrome-extension-wxt

skills/tenequm/claude-plugins/chrome-extension-wxt
chrome-extension-wxt
Installation
...
CSP violations: Update content_security_policy in manifest
Hot reload not working: Check browser console for errors
Storage not persisting: Use storage.local or storage.sync correctly
