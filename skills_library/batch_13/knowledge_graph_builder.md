...
url: https://skills.sh/eddiebe147/claude-settings/knowledge-graph-builder
---

# knowledge graph builder

skills/eddiebe147/claude-settings/Knowledge Graph Builder
Knowledge Graph Builder
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Knowledge Graph Builder'
SKILL.md
Knowledge Graph Builder
