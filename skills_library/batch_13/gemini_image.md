---
title: gemini-image
url: https://skills.sh/binjie09/zknow-skills/gemini-image
---

# gemini-image

skills/binjie09/zknow-skills/gemini-image
gemini-image
Installation
$ npx skills add https://github.com/binjie09/zknow-skills --skill gemini-image
SKILL.md
Gemini 图像生成 Skill
...
用户在命令中直接提供的参数
环境变量 GEMINI_API_KEY / GEMINI_BASE_URL，或 ANTHROPIC_AUTH_TOKEN / ANTHROPIC_BASE_URL,使用ANTHROPIC_BASE_URL 和 ANTHROPIC_AUTH_TOKEN 也同样能调用通后面的接口的，请放心
若均未提供，使用 AskUserQuestion 工具询问用户
