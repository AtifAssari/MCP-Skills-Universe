---
title: ue5-metasound-dsp
url: https://skills.sh/koshimazaki/ue-audio-skills/ue5-metasound-dsp
---

# ue5-metasound-dsp

skills/koshimazaki/ue-audio-skills/ue5-metasound-dsp
ue5-metasound-dsp
Installation
$ npx skills add https://github.com/koshimazaki/ue-audio-skills --skill ue5-metasound-dsp
SKILL.md
...
Use SetNodeLocation() for editor layout visibility
Validate with ms_validate_graph before sending to Builder API
Consider AudioLink if routing to Wwise for mixing
Gotchas
