...
url: https://skills.sh/eddiebe147/claude-settings/landing-page-optimizer
---

# landing page optimizer

skills/eddiebe147/claude-settings/Landing Page Optimizer
Landing Page Optimizer
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Landing Page Optimizer'
SKILL.md
Landing Page Optimizer
...
First Impression Test - 5-second clarity assessment
Message Match - Ad to landing page consistency
Value Proposition Review - Headline and subhead evaluation
Visual Hierarchy - Eye-tracking pattern analysis
CTA Assessment - Placement, copy, design review
Trust Signal Inventory - Social proof, credibility elements
Friction Analysis - Identify conversion barriers
Mobile Experience - Responsive design evaluation
Workflow 2: Above-the-Fold Optimization
Headline Testing - Multiple value proposition angles
Subhead Refinement - Supporting message clarity
Hero Image/Video - Visual impact assessment
CTA Positioning - Optimal placement and visibility
Navigation Decisions - Keep or remove nav links
Loading Speed - Performance impact on conversions
Clarity Score - Can visitors understand in 5 seconds?
Workflow 3: Conversion Element Optimization
CTA Copy Variations - Button text testing
CTA Design - Color, size, shape optimization
Form Optimization - Field reduction, smart defaults
Social Proof Placement - Testimonials, logos, stats
Urgency Elements - Scarcity, countdown timers
Risk Reducers - Guarantees, trust badges
Objection Handling - FAQ, concerns addressed
Workflow 4: Full Page Restructure
Story Arc Design - Logical flow through page
Section Prioritization - Order by impact
Content Pruning - Remove what doesn't convert
Scanability Enhancement - Headers, bullets, whitespace
Multiple CTAs - Strategic repetition
Exit Intent Strategy - Capture abandoning visitors
Cross-Device Consistency - Desktop and mobile flows
Quick Reference
