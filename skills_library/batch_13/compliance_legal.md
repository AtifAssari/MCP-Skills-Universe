...
url: https://skills.sh/dmend3z/tribo-skills/compliance-legal
---
...
compliance-legal
Installation
$ npx skills add https://github.com/dmend3z/tribo-skills --skill compliance-legal
SKILL.md
Compliance & Legal
Overview
...
Workflow
Identify the specific legal or compliance question: Understand the user's request and the context of the marketing activity.
Gather relevant information: Collect all necessary details about the marketing campaign, data handling process, or advertising materials.
Consult best practices: Review the S-tier and A-tier tactics to identify the relevant legal and ethical principles.
Identify red flags: Use the D-tier tactics to check for any practices that should be avoided.
Provide actionable recommendations: Deliver a clear, concise, and actionable response that helps the user ensure their marketing practices are compliant and ethical.
Weekly Installs
14
Repository
