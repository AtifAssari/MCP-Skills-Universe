---
title: svelte-kit
url: https://skills.sh/tomlord1122/tomtom-skill/svelte-kit
---

# svelte-kit

skills/tomlord1122/tomtom-skill/svelte-kit
svelte-kit
Installation
$ npx skills add https://github.com/tomlord1122/tomtom-skill --skill svelte-kit
SKILL.md
...
Check package.json for svelte and @sveltejs/kit versions
Look for svelte.config.js adapter configuration
Note any prerender settings
...
Only use $state for values that need to trigger updates
Use $derived for any computed values (not manual updates)
Use $effect sparingly - prefer declarative patterns
Never mutate $derived values
