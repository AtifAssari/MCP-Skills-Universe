---
title: create-skill
url: https://skills.sh/cpave3/skills/create-skill
---

# create-skill

skills/cpave3/skills/create-skill
create-skill
Installation
...
agents/comparator.md — How to do blind A/B comparison between outputs
agents/analyzer.md — How to analyze benchmark results and why one version beat another
References
references/schemas.md — JSON schemas for evals.json, grading.json, timing.json, benchmark.json, comparison.json, analysis.json
references/eval-workflow.md — Detailed eval/testing/benchmarking workflow, iteration mechanics, description optimization, and environment-specific instructions
Scripts
