...
url: https://skills.sh/manutej/luxor-claude-marketplace/microservices-patterns
---

# microservices-patterns

skills/manutej/luxor-claude-marketplace/microservices-patterns
microservices-patterns
Installation
$ npx skills add https://github.com/manutej/luxor-claude-marketplace --skill microservices-patterns
SKILL.md
Microservices Patterns
