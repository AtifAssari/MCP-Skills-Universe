...
url: https://skills.sh/eddiebe147/claude-settings/competitive-intelligence
---

# competitive intelligence

skills/eddiebe147/claude-settings/Competitive Intelligence
Competitive Intelligence
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Competitive Intelligence'
SKILL.md
Competitive Intelligence
...
Strengths: Internal advantages (product, team, technology, brand) Weaknesses: Internal disadvantages (gaps, resource constraints) Opportunities: External favorable conditions (trends, market gaps) Threats: External challenges (new entrants, substitutes, regulations)
