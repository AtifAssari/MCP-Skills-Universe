---
title: daily brief planner
url: https://skills.sh/sixtysecondsapp/use60/daily-brief-planner
---

# daily brief planner

skills/sixtysecondsapp/use60/Daily Brief Planner
Daily Brief Planner
Installation
...
execute_action("get_meetings_for_period", { period: "today" })
execute_action("get_pipeline_deals", { filter: "closing_soon", period: "this_week", include_health: true, limit: 10 })
execute_action("get_contacts_needing_attention", { days_since_contact: 7, limit: 10 })
execute_action("list_tasks", { status: "pending", filter: "today", limit: 15 })
