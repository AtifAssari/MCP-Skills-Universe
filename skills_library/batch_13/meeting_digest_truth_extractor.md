---
title: meeting digest truth extractor
url: https://skills.sh/sixtysecondsapp/use60/meeting-digest-truth-extractor
---

# meeting digest truth extractor

skills/sixtysecondsapp/use60/Meeting Digest Truth Extractor
Meeting Digest Truth Extractor
Installation
$ npx skills add https://github.com/sixtysecondsapp/use60 --skill 'Meeting Digest Truth Extractor'
SKILL.md
...
Explicit statements (high confidence): "We've decided to go with your proposal." "Our budget is $150K." "We need this live by April 1."
Conditional statements (medium confidence): "If pricing works out, we'd be interested." "Assuming legal approves, we could move forward next month."
Exploratory statements (low confidence): "We might consider..." "I wonder if..." "What would it look like if..."
Retracted statements (ignore): "Actually, scratch that." "Let me rethink that." "That's not what I meant."
...
Changes the state of an agreement, plan, or commitment
Has an identifiable decision-maker (someone with authority)
Is stated with commitment language (not exploration or brainstorming)
...
Responsible: Who is doing the work? (The person who said "I'll do X")
Accountable: Who is ultimately accountable? (The person whose reputation is on the line)
Consulted: Who needs to provide input? ("I'll need to check with Legal first")
Informed: Who needs to know the outcome? ("I'll loop in the team")
...
Missing information flags: Every commitment must have an owner and a deadline. If either is missing, flag it:
...
Unanswered questions: Questions asked during the meeting that received vague or deferred answers
Unasked questions: Questions that SHOULD have been asked but weren't (based on deal stage and MEDDICC gaps)
Contradictions: Statements that conflict with each other or with CRM data
Assumptions: Things the rep or prospect assumed but never validated
Missing stakeholders: Decision-makers or influencers who haven't been engaged
Timeline gaps: Unclear timelines, undefined milestones, vague deadlines
...
Fetch transcript: Use meeting/transcript capability to get full transcript text
Fetch CRM deal data: execute_action("get_deal", { id: deal_id }) -- stage, amount, MEDDICC, custom fields
Fetch contact details: execute_action("get_contact", { id: contact_id }) -- name, title, company, relationship history
Fetch company info: execute_action("get_company_status", { company_name }) -- overview, health score
Fetch previous meeting digests (if available): Compare against previous commitments to detect unfulfilled promises
Output Contract
...
The first 5 minutes (agenda setting and context)
The last 10 minutes (conclusions and next steps)
Any segments with decision or commitment language
Segments with risk indicators
No CRM deal found
