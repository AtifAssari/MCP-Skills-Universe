---
title: dx-expert
url: https://skills.sh/agustinoberg/dx-expert-skill/dx-expert
---

# dx-expert

skills/agustinoberg/dx-expert-skill/dx-expert
dx-expert
Installation
...
If using useEffect:
Keep the dependency array fully controlled and explicit
Keep the effect body small and focused (< 10 lines)
...
A Provider that holds the context and defines the shared interface (state + actions)
Sub-components that consume the context and render specific parts
A namespace export that groups everything under Component.Root, Component.Header, etc.
