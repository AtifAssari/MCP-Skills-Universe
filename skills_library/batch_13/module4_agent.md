---
title: module4-agent
url: https://skills.sh/olorolor/fundamentals-with-ai/module4-agent
---

# module4-agent

skills/olorolor/fundamentals-with-ai/module4-agent
module4-agent
Installation
...
assistive vs agentic — 답변만 하는 AI vs 행동하는 AI의 차이
ReAct loop + tool calling — 생각(Thought)→행동(Action)→관찰(Observation) 반복 루프
MCP + human-in-the-loop — 도구 연결의 표준화와 안전 장치
