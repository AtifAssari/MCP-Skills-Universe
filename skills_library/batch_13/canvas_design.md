---
title: canvas-design
url: https://skills.sh/404kidwiz/claude-supercode-skills/canvas-design
---

# canvas-design

skills/404kidwiz/claude-supercode-skills/canvas-design
canvas-design
Installation
...
Choose appropriate style (minimal, bold, elegant, playful, etc.)
Select color palette (2-5 colors)
Pick typography (1-3 fonts)
Sketch rough layout concept
...
Apply color palette
Set typography with hierarchy
Add visual elements (shapes, icons, illustrations)
Apply effects (shadows, gradients, textures)
