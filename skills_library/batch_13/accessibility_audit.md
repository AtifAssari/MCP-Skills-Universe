...
url: https://skills.sh/mgd34msu/goodvibes-plugin/accessibility-audit
---

# accessibility-audit

skills/mgd34msu/goodvibes-plugin/accessibility-audit
accessibility-audit
Installation
$ npx skills add https://github.com/mgd34msu/goodvibes-plugin --skill accessibility-audit
SKILL.md
Resources
scripts/
...
Priority Actions
Critical: Add alt text to all images (affects 100% of screen reader users)
Critical: Fix keyboard navigation in dropdown (blocks keyboard users)
High: Fix color contrast on primary buttons (affects ~4.5% of users)
High: Add form labels (affects screen reader and cognitive users)
