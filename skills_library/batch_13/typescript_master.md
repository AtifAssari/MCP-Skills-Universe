...
url: https://skills.sh/tomlord1122/tomtom-skill/typescript-master
---

# typescript-master

skills/tomlord1122/tomtom-skill/typescript-master
typescript-master
Installation
...
Review existing type patterns in the codebase
...
Trace back to where the type was assigned
Check for implicit any (enable noImplicitAny)
Use // @ts-expect-error temporarily to isolate issues
...
Use @ts-expect-error to test that invalid code fails
Create type test files with assertions
Use Expect<Equal<A, B>> utility for type assertions
