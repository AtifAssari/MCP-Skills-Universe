---
title: copywriter
url: https://skills.sh/eddiebe147/claude-settings/copywriter
---

# copywriter

skills/eddiebe147/claude-settings/Copywriter
Copywriter
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill Copywriter
SKILL.md
Copywriter
...
Audience Research - Identify target customer pain points and desires
Value Proposition - Craft clear, compelling unique selling proposition
Headline Creation - Write attention-grabbing headline with subheadline
Feature-Benefit Translation - Convert features into customer benefits
Social Proof Integration - Add testimonials, stats, trust signals
CTA Optimization - Create irresistible call-to-action copy
Objection Handling - Address concerns and remove friction
Workflow 2: Ad Campaign Copy
Platform Selection - Tailor copy for Google Ads, Facebook, LinkedIn, etc.
Hook Development - Create scroll-stopping opening lines
Message Variants - Write 5-10 versions for A/B testing
Character Optimization - Work within platform character limits
Audience Segmentation - Customize copy for different customer segments
CTA Testing - Create multiple call-to-action variations
Performance Prediction - Estimate which variants will perform best
Workflow 3: Email Sequence
Sequence Planning - Map out email series flow and timing
Subject Line Creation - Write compelling, open-worthy subject lines
Preview Text - Optimize the first sentence for email previews
Story Arc - Build narrative across multiple emails
Value Delivery - Balance education with promotion
Link Placement - Strategic CTA positioning throughout
Re-engagement - Create follow-up for non-openers
Workflow 4: Product Launch Copy
Pre-Launch Teaser - Build anticipation with mystery and exclusivity
Launch Announcement - Create big reveal messaging
Benefit Stacking - Highlight multiple value propositions
Urgency Creation - Add time-sensitive elements authentically
Cross-Channel Consistency - Align messaging across all platforms
Post-Launch Follow-Up - Keep momentum with results and updates
Quick Reference
