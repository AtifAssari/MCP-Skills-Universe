...
url: https://skills.sh/cafe3310/public-agent-skills/project_management
---

# project_management

skills/cafe3310/public-agent-skills/project_management
project_management
Installation
$ npx skills add https://github.com/cafe3310/public-agent-skills --skill project_management
SKILL.md
Skill - 项目管理
...
获取时间戳: 必须先运行 date +'%Y-%m-%d-%H-%M' 命令获取当前时间；
命名文件: 文件名必须是 YYYY-MM-DD-HH-mm-{文档名称}.md 的格式，方便按时间排序和检索；
更新 TODO: 在创建文档后，应在相应的 TODO.md 任务中添加对该文档的引用链接。
...
记录在对应的 TODO.md 文件中进行追踪；
将 TODO.md 的条目链接到更详细的文档；
根据任务要求，编写对应的需求、缺陷、Spec 文档。 即使助手自身具备 todo 类的工具，也必须遵循上述规范。
