---
title: flutter-control-and-screenshot
url: https://skills.sh/rodydavis/skills/flutter-control-and-screenshot
---

# flutter-control-and-screenshot

skills/rodydavis/skills/flutter-control-and-screenshot
flutter-control-and-screenshot
Installation
...
Prerequisites
Dart MCP Server: Ensure the dart-mcp-server is active.
...
Get App URL: Use mcp_dart-mcp-server_get_app_logs with the app's PID. Look for lines like A Dart VM Service on Chrome is available at: http://127.0.0.1:XXXXX. The app logs usually contain the local HTTP URL.
Navigate & Snapshot: Call browser_subagent.
