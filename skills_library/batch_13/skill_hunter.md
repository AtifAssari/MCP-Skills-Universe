---
title: skill-hunter
url: https://skills.sh/ce0alex/skill-hunter/skill-hunter
---

# skill-hunter

skills/ce0alex/skill-hunter/skill-hunter
skill-hunter
Installation
$ npx skills add https://github.com/ce0alex/skill-hunter --skill skill-hunter
SKILL.md
Skill Hunter
Overview
...
Optional: Skills Directory for curated, quality-reviewed skills.
...
Confirm each skill folder exists at the expected path
Read each SKILL.md frontmatter to verify it loads
List installed skills to the user with a brief description
Suggest a quick "run/use" test for key skills
