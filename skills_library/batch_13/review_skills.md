---
title: review-skills
url: https://skills.sh/base44/skills/review-skills
---

# review-skills

skills/base44/skills/review-skills
review-skills
Installation
...
./references/skill-creator/SKILL.md - Core principles, anatomy, and progressive disclosure
references/spec.md - Complete Agent Skills specification (required for compliance checks)
references/validate.md - Validation checklist (used in Step 2)
./references/skill-creator/references/workflows.md - Workflow patterns (if relevant)
./references/skill-creator/references/output-patterns.md - Output patterns (if relevant)
