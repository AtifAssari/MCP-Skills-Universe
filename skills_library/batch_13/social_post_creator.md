...
url: https://skills.sh/eddiebe147/claude-settings/social-post-creator
---

# social post creator

skills/eddiebe147/claude-settings/Social Post Creator
Social Post Creator
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Social Post Creator'
SKILL.md
Social Post Creator
...
Define Goal: Understand what you want to achieve
Choose Platform: Select primary social channel
Craft Message: Write platform-optimized content
Add Media: Include images, videos, or links
Optimize Hashtags: Add relevant tags for discovery
Schedule: Determine optimal posting time
Workflow 2: Cross-Platform Campaign
Develop Core Message: Create main theme
Adapt per Platform: Customize for each channel
Maintain Consistency: Keep key points across all versions
Vary Format: Use each platform's strengths
Coordinate Timing: Stagger or synchronize posts
Track Performance: Monitor which versions resonate
Workflow 3: Content Calendar Planning
Identify Themes: Plan content pillars
Map to Calendar: Schedule posts in advance
Balance Content Types: Mix promotional, educational, entertaining
Create Templates: Build reusable formats
Batch Create: Write multiple posts efficiently
Quick Reference
