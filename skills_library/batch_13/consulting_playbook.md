...
url: https://skills.sh/dzw310/consulting-playbook-skill/consulting-playbook
---

# consulting-playbook

skills/dzw310/consulting-playbook-skill/consulting-playbook
consulting-playbook
Installation
...
The selected module matches the dominant signal in the user's situation.
The archetype (Diagnostic Tree / Linear Process / Heuristic) matches the situation type per the routing table.
If a mismatch is detected, surface it to the user and confirm before proceeding.
...
Write or update blueprint/Blueprint-YYYY-MM-DD.md.
Add this header:
...
Then write the full 8-section skeleton and keep all sections present. Use these exact placeholders:
## 1. Situation Summary
...
Update the blueprint in-place throughout coaching.
