---
title: uniapp-frontend
url: https://skills.sh/enze00/uniapp-frontend-skills/uniapp-frontend
---

# uniapp-frontend

skills/enze00/uniapp-frontend-skills/uniapp-frontend
uniapp-frontend
Installation
...
Check vite.config.ts has additionalData configuration
...
Component registered in pages.json
Correct import path (use @/ alias)
Component name in PascalCase for Vue components
Build Errors
...
Performance - Lazy load images and long lists
Accessibility - Use semantic HTML and ARIA labels
Code organization - Follow consistent file structure
Version control - Commit frequently with meaningful messages
Weekly Installs
17
Repository
enze00/uniapp-f…d-skills
GitHub Stars
11
First Seen
Jan 29, 2026
