...
url: https://skills.sh/ed1s0nz/cyberstrikeai/sql-injection-testing
---

# sql-injection-testing

skills/ed1s0nz/cyberstrikeai/sql-injection-testing
sql-injection-testing
Installation
$ npx skills add https://github.com/ed1s0nz/cyberstrikeai --skill sql-injection-testing
SKILL.md
SQL注入测试技能
概述
