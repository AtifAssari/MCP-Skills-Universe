---
title: agency-whimsy-injector
url: https://skills.sh/nordz0r/skills/agency-whimsy-injector
---

# agency-whimsy-injector

skills/nordz0r/skills/agency-whimsy-injector
agency-whimsy-injector
Installation
$ npx skills add https://github.com/nordz0r/skills --skill agency-whimsy-injector
SKILL.md
Agency Whimsy Injector
...
Core workflow
Identify where emotion matters: onboarding, success, waiting, recovery, empty states, or discovery.
Choose a small number of high-leverage moments instead of scattering novelty everywhere.
Tie each delight moment to a function: reduce anxiety, reward progress, humanize failure, or reinforce brand character.
Check accessibility and performance before committing to motion or layered effects.
Preserve seriousness for security, billing, destructive actions, and critical operational states.
