...
url: https://skills.sh/manutej/luxor-claude-marketplace/responsive-design
---

# responsive-design

skills/manutej/luxor-claude-marketplace/responsive-design
responsive-design
Installation
...
Design Principles
Mobile-First Always: Start with mobile and enhance for larger screens
Content-First: Let content dictate breakpoints, not devices
Progressive Enhancement: Build a solid foundation, then add enhancements
Performance Matters: Optimize images, lazy load, use critical CSS
Accessibility First: Touch targets, readable text, keyboard navigation
Flexible Everything: Use relative units, fluid layouts, scalable typography
