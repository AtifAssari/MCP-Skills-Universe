---
title: cli
url: https://skills.sh/lobehub/lobehub/cli
---

# cli

skills/lobehub/lobehub/cli
cli
Installation
$ npx skills add https://github.com/lobehub/lobehub --skill cli
SKILL.md
...
Call POST http://localhost:3011/oidc/device/auth to get a device code
Print a URL like http://localhost:3011/oidc/device?user_code=XXXX-YYYY
Open the URL in your browser — log in and authorize
Save credentials to apps/cli/.lobehub-dev/credentials.json
Save server URL to apps/cli/.lobehub-dev/settings.json
