---
title: long-audio-to-obsidian
url: https://skills.sh/cafe3310/public-agent-skills/long-audio-to-obsidian
---

# long-audio-to-obsidian

skills/cafe3310/public-agent-skills/long-audio-to-obsidian
long-audio-to-obsidian
Installation
...
确定项目标题：根据原始目录名或核心文件名，提取一个清晰的项目标题（例如 2024-01-01 会议转写 - 项目 A）。
重命名文件：使用 run_shell_command 的 mv 命令，将 obsidian_archive 中的标准文件重命名为带前缀的格式。
...
原始录音汇总：包含所有原始录音文本。
最终输出脚本汇总：包含所有经过校对、合并后的分段文本。顺序至关重要。
整理要求与日志汇总：
工作日志 (0-工作日志.md)
校对术语表 (3-校对和术语表.md)
分段主题 (4-分段主题.md)
