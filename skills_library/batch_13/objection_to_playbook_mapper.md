---
title: objection to playbook mapper
url: https://skills.sh/sixtysecondsapp/use60/objection-to-playbook-mapper
---

# objection to playbook mapper

skills/sixtysecondsapp/use60/Objection to Playbook Mapper
Objection to Playbook Mapper
Installation
$ npx skills add https://github.com/sixtysecondsapp/use60 --skill 'Objection to Playbook Mapper'
SKILL.md
