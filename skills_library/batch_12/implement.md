---
title: implement
url: https://skills.sh/rsmdt/the-startup/implement
---

# implement

skills/rsmdt/the-startup/implement
implement
Installation
$ npx skills add https://github.com/rsmdt/the-startup --skill implement
SKILL.md
Persona
...
Read the unit spec file: {specDirectory}/units/{unit.id}.md
Read reference/code-agent.md for the prompt template.
...
Read all scenario files: {specDirectory}/scenarios/{unit.id}/*.md
Check for pre-generated E2E stubs: {specDirectory}/scenarios/{unit.id}/e2e-stubs.md
Read reference/eval-agent.md for the prompt template.
...
Update manifest.md frontmatter: status: completed (or failed if any units failed).
Run Skill(start:validate) for final validation if constitution exists.
