...
url: https://skills.sh/oocx/tfplan2md/validate-agent
---

# validate-agent

skills/oocx/tfplan2md/validate-agent
validate-agent
Installation
$ npx skills add https://github.com/oocx/tfplan2md --skill validate-agent
SKILL.md
