---
title: project-mngt
url: https://skills.sh/vladm3105/aidoc-flow-framework/project-mngt
---

# project-mngt

skills/vladm3105/aidoc-flow-framework/project-mngt
project-mngt
Installation
...
Use Cases
Initial Project Planning: Analyze requirements and create structured implementation plan
Plan Updates: Modify existing plans when requirements change while preserving completed work
Progress Tracking: Update plans with current status and adjust remaining work
Release Strategy: Define logical stages and atomic groups for incremental delivery
Adaptability
...
Functional Cohesion: Group by feature area
Technical Layer: Group by architectural component
User Journey: Group by end-to-end workflow
Dependency Cluster: Group tightly coupled requirements
...
Dependency-Driven: Higher priority = fewer dependencies
Risk-First: Address high-risk/uncertainty early
Value-Weighed: Balance technical dependencies with business value
Resource-Aware: Consider team size and skill distribution
...
Every atomic group MUST have a status
Completed work is IMMUTABLE - never modify in plan updates
In-progress work requires careful impact assessment
Only planned work can be freely rearranged
All status changes MUST be documented in change log
...
Execute Steps 1-6 (Requirements Discovery through Timeline Estimation)
All atomic groups marked as PLANNED
Timeline starts from project kickoff (Week 1)
...
Identify all groups with status COMPLETED
Mark as LOCKED - do NOT modify
Rule: Never delete, rename, or change scope of completed work

Phase 2: Assess In-Progress Work

Identify groups with status IN_PROGRESS
Assess: Does BRD change affect scope? Should work continue?
Document assessment
Decision: Continue as-is / Adjust scope / Cancel

Phase 3: Analyze BRD Changes

Identify added/modified/removed requirements
Map changes to atomic groups
Determine affected groups and new groups needed

Phase 4: Replan PLANNED Work Only

Only modify groups with status PLANNED
Options: Regroup, Reprioritize, Add new, Cancel, Modify scope
Re-run dependency analysis
Re-run stage assignment

Phase 5: Update Timeline

Start from current date, NOT project start
Calculate remaining work
Re-estimate remaining groups
Update end date projection
Calculate timeline variance

Phase 6: Document Changes

Create detailed change log
Document BRD changes and rationale
List all affected groups
...
Mark completed groups with dates
Update progress metrics
Adjust timeline if pace differs
...
Group X: MODIFIED - Added REQ-041, REQ-042
Group Y: NEW - Created for REQ-043, REQ-044, REQ-045
Group Z: CANCELLED - Requirement removed
