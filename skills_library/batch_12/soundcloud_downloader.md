...
url: https://skills.sh/serpdownloaders/skills/soundcloud-downloader
---

# soundcloud-downloader

skills/serpdownloaders/skills/soundcloud-downloader
soundcloud-downloader
Installation
$ npx skills add https://github.com/serpdownloaders/skills --skill soundcloud-downloader
SKILL.md
...
Open SoundCloud in your browser and sign in to your account.
Navigate to the track, playlist, set, or podcast you want to save.
Begin playback so the browser loads the audio stream.
Open the extension popup to see the detected audio source.
Select the track or episode you want to export.
Choose your preferred quality if multiple options are available.
Start the download and save the file to your local machine.
Expected Formats
...
When will SoundCloud Downloader be released? A release date has not been set. Sign up at the waitlist link above to be notified as soon as it is available.

Will it work with the SoundCloud desktop app? SoundCloud does not have a traditional desktop app. This extension targets the SoundCloud website as accessed through a standard web browser.

What audio quality will it support? Quality will depend on what SoundCloud delivers to the browser during playback. SoundCloud streams at different bitrates depending on the uploader's source file and whether the listener has a Go+ subscription.

Will it preserve track metadata? The plan is to include artist name, track title, and album artwork metadata in exported files where that data is available from the page.

Is it free? Pricing details will be announced closer to launch. SERP extensions typically include a free trial period.

Can I download entire playlists or sets at once? Playlist-level and set-level export is a planned feature, though the exact workflow will depend on browser capabilities and playback constraints.

Does it support private or unlisted tracks? If a private or unlisted track is accessible in your browser through a shared link and you can play it back, the extension is expected to detect it the same way it detects any other stream.
