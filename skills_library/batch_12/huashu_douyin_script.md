---
title: huashu-douyin-script
url: https://skills.sh/alchaincyf/huashu-skills/huashu-douyin-script
---

# huashu-douyin-script

skills/alchaincyf/huashu-skills/huashu-douyin-script
huashu-douyin-script
Installation
$ npx skills add https://github.com/alchaincyf/huashu-skills --skill huashu-douyin-script
SKILL.md
抖音爆款脚本创作
...
提示用户确认Chrome已登录抖音
建议手动下载视频放入 _temp/douyin-downloads/
如果有douyin-mcp-server可用，尝试通过MCP下载
...
读取 references/script-style-samples.md 获取口语风格范例
读取 references/analysis-dimensions.md 中的种草/千川区别表
读取Step 4的爆款分析汇总
...
展示分析汇总，确认方向（Step 4）
生成脚本，确认后审校（Step 5-6）
将新品类公式追加到 references/proven-formulas.md

无竞品视频时（「帮我写个XX产品的种草脚本」）：

收集产品信息（Step 1，跳过视频链接）
跳过 Step 2-3
从 references/proven-formulas.md 选取品类公式（Step 4）
生成脚本，确认后审校（Step 5-6）
