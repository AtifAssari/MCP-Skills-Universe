---
title: midjourney-replicate-flux
url: https://skills.sh/rawveg/skillsforge-marketplace/midjourney-replicate-flux
---

# midjourney-replicate-flux

skills/rawveg/skillsforge-marketplace/midjourney-replicate-flux
midjourney-replicate-flux
Installation
$ npx skills add https://github.com/rawveg/skillsforge-marketplace --skill midjourney-replicate-flux
SKILL.md
...
Identify genre: Portrait photography in outdoor setting
Consult references/midjourney-style-guide.md for portrait pattern
...
Apply FLUX optimizations from references/flux-model-optimization.md:
...
Generate via MCP server with aspect_ratio "16:9", output_format "png"
...
Create three variations emphasizing different aspects
Reference references/midjourney-style-guide.md for urban photography vocabulary

Variation 1 - Blue Hour: "Modern city skyline at blue hour twilight, glowing office building windows, cinematic urban photography, dramatic perspective from elevated viewpoint, shot on Sony A7R IV 24mm, deep focus, cool color grading with blue and purple tones, atmospheric haze, highly detailed, 8k resolution"
...
Generate all three via MCP server, present options to user
Important Notes
...
✅ Transform generic requests into rich, detailed descriptions
✅ Maintain 40-75 word length for optimal results
✅ Include all core elements: subject, style, lighting, technical specs, color, quality
✅ Read naturally and coherently without contradictions
✅ Leverage FLUX's strengths (photorealism, detail, complex compositions)
✅ Compensate for FLUX's differences from Midjourney (explicit artistic treatment)
✅ Generate images via Replicate MCP server with appropriate parameters
✅ Produce outputs matching Midjourney's distinctive aesthetic quality
