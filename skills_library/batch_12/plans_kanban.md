---
title: plans-kanban
url: https://skills.sh/duc01226/easyplatform/plans-kanban
---

# plans-kanban

skills/duc01226/easyplatform/plans-kanban
plans-kanban
Installation
$ npx skills add https://github.com/duc01226/easyplatform --skill plans-kanban
SKILL.md
...
Start Server — Point at a plans directory with CLI options
Browse Dashboard — View plan cards with progress bars, phase status, activity heatmap
Inspect Plans — Gantt-style timeline, priority indicators, issue/branch links
