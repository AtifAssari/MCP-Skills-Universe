---
title: docs-update
url: https://skills.sh/duc01226/easyplatform/docs-update
---

# docs-update

skills/duc01226/easyplatform/docs-update
docs-update
Installation
...
If still empty, run git diff --name-only origin/develop...HEAD (branch changes)
...
Check if docs/business-features/{Module}/ exists
Check if docs/business-features/{Module}/detailed-features/ has feature docs
Check if docs/test-specs/{Module}/ exists
Record: hasFeatureDocs, hasTestSpecs, hasTestSpecsDashboard
...
Spawn 2-4 scout-external (preferred) or scout (fallback) via Task tool
Target directories that actually exist — adapt to project structure
...
If gaps found → re-invoke /feature-docs for missed sections
