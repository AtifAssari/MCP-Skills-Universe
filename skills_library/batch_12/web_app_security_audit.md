...
url: https://skills.sh/ahmedhamadto/software-forge/web-app-security-audit
---

# web-app-security-audit

skills/ahmedhamadto/software-forge/web-app-security-audit
web-app-security-audit
Installation
$ npx skills add https://github.com/ahmedhamadto/software-forge --skill web-app-security-audit
SKILL.md
...
Read the relevant chapter summary from cybersecurity/web-application-hackers-handbook/ for detailed guidance
Suggest and execute concrete tests (grep patterns in source code, curl commands, Burp Suite steps, automated scripts)
Flag findings with severity: CRITICAL / HIGH / MEDIUM / LOW / INFO
