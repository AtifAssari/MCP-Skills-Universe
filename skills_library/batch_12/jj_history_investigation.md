---
title: jj-history-investigation
url: https://skills.sh/edmundmiller/dotfiles/jj-history-investigation
---

# jj-history-investigation

skills/edmundmiller/dotfiles/jj-history-investigation
jj-history-investigation
Installation
...
Don't split without investigation: Always jj show first to understand what's in a commit
Save state before split: cp important-file /tmp/ before major history rewrites
Split incrementally: Don't try to split everything at once; do one logical piece at a time
Update TODO immediately: Mark TODO items in the same commit that does the work
Verify after each step: Check jj log frequently during split/rebase operations
When NOT to Split
