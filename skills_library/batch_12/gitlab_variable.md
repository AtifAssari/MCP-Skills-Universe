---
title: gitlab-variable
url: https://skills.sh/grandcamel/gitlab-assistant-skills/gitlab-variable
---

# gitlab-variable

skills/grandcamel/gitlab-assistant-skills/gitlab-variable
gitlab-variable
Installation
...
Always mask secrets: Use --masked for any sensitive values
Protect production secrets: Use --protected for production credentials
