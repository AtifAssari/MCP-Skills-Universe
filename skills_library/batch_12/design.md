---
title: design
url: https://skills.sh/johnlindquist/claude/design
---

# design

skills/johnlindquist/claude/design
design
Installation
...
Best Practices
Use semantic names - --color-error not --color-red
Document tokens - Explain when to use each
