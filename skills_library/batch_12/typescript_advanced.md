...
url: https://skills.sh/pedronauck/skills/typescript-advanced
---

# typescript-advanced

skills/pedronauck/skills/typescript-advanced
typescript-advanced
Installation
$ npx skills add https://github.com/pedronauck/skills --skill typescript-advanced
SKILL.md
...
Prefer interface for object shapes: Better error messages, declaration merging
Use type for unions and complex types: More flexible for computed types
