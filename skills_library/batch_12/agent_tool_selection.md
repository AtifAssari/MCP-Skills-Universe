...
url: https://skills.sh/oocx/tfplan2md/agent-tool-selection
---

# agent-tool-selection

skills/oocx/tfplan2md/agent-tool-selection
agent-tool-selection
Installation
$ npx skills add https://github.com/oocx/tfplan2md --skill agent-tool-selection
SKILL.md
...
❌ Using snake_case: read_file, run_in_terminal ✅ Correct naming: readFile, runInTerminal

❌ Assuming all tools work in cloud: execute, edit ✅ Cloud-aware: Use conditional logic or stick to universal tools
