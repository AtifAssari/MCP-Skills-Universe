...
url: https://skills.sh/rmyndharis/antigravity-skills/database-optimizer
---

# database-optimizer

skills/rmyndharis/antigravity-skills/database-optimizer
database-optimizer
Installation
$ npx skills add https://github.com/rmyndharis/antigravity-skills --skill database-optimizer
SKILL.md
Use this skill when
