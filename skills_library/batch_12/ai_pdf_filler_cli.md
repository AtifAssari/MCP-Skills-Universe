---
title: ai-pdf-filler-cli
url: https://skills.sh/askyourpdf/ai-pdf-filler/ai-pdf-filler-cli
---
...
Core Workflow
Confirm simplicity-cli is installed by running simplicity-cli --help.
...
Ensure authentication is available (create an account and get API key at https://simplicity.ai):
