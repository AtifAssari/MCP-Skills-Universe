---
title: secondme-init
url: https://skills.sh/mindverse/second-me-skills/secondme-init
---

# secondme-init

skills/mindverse/second-me-skills/secondme-init
secondme-init
Installation
...
检查当前目录内容（除 .secondme/、.git/、CLAUDE.md、.claude/ 等配置文件外）：
