---
title: codemap
url: https://skills.sh/jellydn/my-ai-tools/codemap
---

# codemap

skills/jellydn/my-ai-tools/codemap
codemap
Installation
...
Critical Rules
Write documents directly - Use the Write tool, don't return contents
Always include file paths - Every finding needs a file path in backticks
Use the templates - Fill in the template structure exactly
Be thorough - Read actual files, don't guess
Return only confirmation - Response should be ~10 lines with file paths and line counts
Don't commit - The orchestrator handles git operations
Benefits
