---
title: vidu-skills
url: https://skills.sh/saerdna/vidu-skills/vidu-skills
---

# vidu-skills

skills/saerdna/vidu-skills/vidu-skills
vidu-skills
Installation
$ npx skills add https://github.com/saerdna/vidu-skills --skill vidu-skills
SKILL.md
...
Prepare inputs: for reference2image / character2video, --image and/or --material so combined count is 1–7; optional [@name] in prompt per references/parameters.md.
...
Build the timeline JSON following the exact structure: video_tracks[].video_track_clips[], audio_tracks[].audio_track_clips[], subtitle_tracks[].subtitle_track_clips[], effect_tracks[].effect_track_items[].
...
vidu-cli task compose --timeline <file_or_json> [--width N --height N] → returns task_id.
