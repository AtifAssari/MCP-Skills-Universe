---
title: lovstudio:any2docx
url: https://skills.sh/lovstudio/skills/lovstudio:any2docx
---

# lovstudio:any2docx

skills/lovstudio/skills/lovstudio:any2docx
lovstudio:any2docx
Installation
...
CJK font switching: _split_mixed() detects CJK runs and assigns Songti SC / SimSun / Noto CJK
Inline markdown: _parse_inline() handles bold, italic, code, links
Images: Local paths (relative to .md) and remote URLs — auto-downloaded and embedded via add_picture()
Code blocks: Shaded paragraph with monospace font and border
...
TOC: Field code with static fallback entries; updateFields=true triggers auto-refresh on open
YAML frontmatter: Automatically stripped (won't leak status: draft etc. into output)
Adaptive cover title: Font size scales down for long titles (36pt → 22pt)
