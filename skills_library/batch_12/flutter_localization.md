...
url: https://skills.sh/dhruvanbhalara/skills/flutter-localization
---

# flutter-localization

skills/dhruvanbhalara/skills/flutter-localization
flutter-localization
Installation
$ npx skills add https://github.com/dhruvanbhalara/skills --skill flutter-localization
SKILL.md
Localization Setup
...
Create app_{locale}.arb with all keys translated
Run flutter gen-l10n (or rely on auto-generation)
Add the Locale to supportedLocales in MaterialApp
Verify with widget tests using the new locale
Weekly Installs
89
Repository
