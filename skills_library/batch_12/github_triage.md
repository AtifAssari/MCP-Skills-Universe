---
title: github-triage
url: https://skills.sh/blogic-cz/blogic-marketplace/github-triage
---

# github-triage

skills/blogic-cz/blogic-marketplace/github-triage
github-triage
Installation
$ npx skills add https://github.com/blogic-cz/blogic-marketplace --skill github-triage
SKILL.md
GitHub Triage
...
For detailed per-item execution prompts, use references/subagent-templates.md.
...
Read existing comments to understand history
Investigate root cause — read code, check logs, search codebase, inspect Sentry, inspect Kubernetes state when relevant
Identify the concrete fix (which file, what change, what config)
...
The plan must include specific root cause and concrete fix — not "investigate" or "needs analysis". If root cause remains unknown after investigation, document what was checked and what remains unknown.
