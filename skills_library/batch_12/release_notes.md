---
title: release-notes
url: https://skills.sh/duc01226/easyplatform/release-notes
---

# release-notes

skills/duc01226/easyplatform/release-notes
release-notes
Installation
$ npx skills add https://github.com/duc01226/easyplatform --skill release-notes
SKILL.md
...
Parse Commits — parse-commits.cjs <base> <head> extracts structured data from git
Categorize — Pipe through categorize-commits.cjs for user-facing vs internal sections
Render — render-template.cjs --version vX.Y.Z generates markdown with Summary, What's New, Improvements, Bug Fixes, Breaking Changes, Technical Details
