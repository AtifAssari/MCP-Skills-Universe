...
url: https://skills.sh/erichowens/some_claude_skills/adhd-design-expert
---

# adhd-design-expert

skills/erichowens/some_claude_skills/adhd-design-expert
adhd-design-expert
Installation
$ npx skills add https://github.com/erichowens/some_claude_skills --skill adhd-design-expert
SKILL.md
...
Design Workflow
Research: mcp__firecrawl__firecrawl_search for ADHD UX studies
Pattern Analysis: Read existing codebase
Component Generation: mcp__magic__21st_magic_component_builder with ADHD principles
Visual Assets: mcp__stability-ai for engaging illustrations
Refinement: mcp__magic__21st_magic_component_refiner for accessibility
Audit Checklist
