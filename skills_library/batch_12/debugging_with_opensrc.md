---
title: debugging-with-opensrc
url: https://skills.sh/blogic-cz/blogic-marketplace/debugging-with-opensrc
---

# debugging-with-opensrc

skills/blogic-cz/blogic-marketplace/debugging-with-opensrc
debugging-with-opensrc
Installation
...
Locate relevant source files in opensrc/repos/github.com/ using available project search tools.
...
Read opensrc/repos/github.com/TanStack/form/packages/react-form/src/useForm.ts.
...
Read opensrc/repos/github.com/trpc/trpc/packages/server/src/core/middleware.ts.
Trace how context flows through middleware chain.
Verify middleware returns and opts.next() behavior in the active version.
Scenario: Effect Layer Not Providing Service
Read opensrc/repos/github.com/Effect-TS/effect/packages/effect/src/Layer.ts.
Compare Layer.effect and Layer.succeed behavior.
Verify Context.Tag usage against library patterns.
Scenario: Better Auth Session Not Persisting
Read opensrc/repos/github.com/better-auth/better-auth/packages/better-auth/src/.
...
Read opensrc/repos/github.com/TanStack/query/packages/react-query/src/useSuspenseQuery.ts and nearby type definitions.
