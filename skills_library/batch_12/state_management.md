...
url: https://skills.sh/mgd34msu/goodvibes-plugin/state-management
---

# state-management

skills/mgd34msu/goodvibes-plugin/state-management
state-management
Installation
$ npx skills add https://github.com/mgd34msu/goodvibes-plugin --skill state-management
SKILL.md
Resources
scripts/
  validate-state.sh
