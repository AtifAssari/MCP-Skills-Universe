---
title: integrating-tauri-rust-frontends
url: https://skills.sh/dchuk/claude-code-tauri-skills/integrating-tauri-rust-frontends
---

# integrating-tauri-rust-frontends

skills/dchuk/claude-code-tauri-skills/integrating-tauri-rust-frontends
integrating-tauri-rust-frontends
Installation
...
withGlobalTauri - Must be enabled for WASM frontends to access Tauri APIs via window.__TAURI__ and wasm-bindgen.
