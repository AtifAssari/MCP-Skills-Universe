---
title: spec-product-prd
url: https://skills.sh/zixun-github/aisdlc/spec-product-prd
---

# spec-product-prd

skills/zixun-github/aisdlc/spec-product-prd
spec-product-prd
Installation
...
R2 的目标是把 {FEATURE_DIR}/requirements/solution.md 的推荐决策转写为 {FEATURE_DIR}/requirements/prd.md：让研发能拆任务、QA 能写用例、干系人能评审与验收。
