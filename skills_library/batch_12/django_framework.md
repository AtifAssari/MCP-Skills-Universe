...
url: https://skills.sh/bobmatnyc/claude-mpm-skills/django-framework
---

# django-framework

skills/bobmatnyc/claude-mpm-skills/django-framework
django-framework
Installation
$ npx skills add https://github.com/bobmatnyc/claude-mpm-skills --skill django-framework
SKILL.md
