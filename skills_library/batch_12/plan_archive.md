---
title: plan-archive
url: https://skills.sh/duc01226/easyplatform/plan-archive
---

# plan-archive

skills/duc01226/easyplatform/plan-archive
plan-archive
Installation
$ npx skills add https://github.com/duc01226/easyplatform --skill plan-archive
SKILL.md
...
Identify -- Find plans to archive (specific or all completed)
Journal -- Write summary journal entry for archived plans
Archive -- Move plans to archive location or mark as completed
...
Else read all plans in the plans directory
Workflow
...
Use AskUserQuestion tool to ask if user wants to document journal entries or not. Skip this step if user selects "No". If user selects "Yes":
...
IMPORTANT: Only ask questions about genuine decision points - don't manufacture artificial choices. IMPORTANT: Sacrifice grammar for the sake of concision when writing outputs. IMPORTANT: In the last summary report, list any unresolved questions at the end, if any. IMPORTANT: Ensure token efficiency while maintaining high quality.
