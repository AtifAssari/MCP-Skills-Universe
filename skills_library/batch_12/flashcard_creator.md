...
url: https://skills.sh/blazewicz/claude-flashcards/flashcard-creator
---

# flashcard-creator

skills/blazewicz/claude-flashcards/flashcard-creator
flashcard-creator
Installation
...
Use **Front:** exactly - with bold markdown (**) and colon
Use **Back:** exactly - with bold markdown (**) and colon
Front and Back must be on separate, consecutive lines
Both keywords are case-sensitive
...
Use read_page or get_page_text to extract content from the current page
Take a screenshot if visual context would be helpful
...
Rule Card - Present the grammar pattern

**Front:** Cuando + presente de subjuntivo (futuro)
**Back:** Cuando me jubile, me iré a vivir a la costa.


Fill-in-blank Card - Test conjugation/application

**Front:** Cuando _____ (jubilarse - yo), me _____ (ir) a vivir a la costa.
**Back:** Cuando me jubile, me iré a vivir a la costa.


Translation Card - Apply in context

**Front:** When I retire, I will go live on the coast.
**Back:** Cuando me jubile, me iré a vivir a la costa.


Quick Reference Card - Test rule knowledge
...
Immediately run the conversion script:
...
What to Prioritize
Grammar patterns with examples - highest value for language learning
Conjugation tables - convert to fill-in-blank exercises
Vocabulary words and phrases - with translations and context
Example sentences - use as-is or convert to translation practice
Language rules and explanations - convert to Q&A format
Common mistakes sections - create error correction cards
Idiomatic expressions - with usage examples
...
Wrong Keywords - Not using **Front:** and **Back:** exactly
Merged Lines - Putting Front and Back on the same line
Too Much Text - Making cards too long (keep under 2-3 sentences)
No Organization - Not using headers to categorize cards
Missing Hints - Fill-in-blanks without verb/tense hints
No Variety - Only one card type (need drills, Q&A, translation, etc.)
Skipping Verification - Not checking accent marks and grammar
Random Order - Not organizing by difficulty or category
Examples
...
Access content: Use tabs_context_mcp and get_page_text
Analyze: Identify temporal connectors lesson with 6 main concepts
...
Common mistakes
Memory aids
Write file: flashcards/temporal-connectors.md
Convert: Run python3 parse_flashcards.py flashcards/temporal-connectors.md
Verify: Check line count shows 153 flashcards created
Report: "Created temporal-connectors.txt with 153 flashcards ready to import into Anki"
