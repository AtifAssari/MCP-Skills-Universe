---
title: code
url: https://skills.sh/duc01226/easyplatform/code
---

# code

skills/duc01226/easyplatform/code
code
Installation
...
AUTO-COMMIT: Call git-manager subagent. Run only if Steps 1-2 successful + User approved + Tests passed.
...
Activate refactor workflow (Recommended) — scout → investigate → plan → code → review → sre-review → test → docs
Execute /code directly — run this skill standalone
