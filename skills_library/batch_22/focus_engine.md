---
title: focus-engine
url: https://skills.sh/dpearson2699/swift-ios-skills/focus-engine
---

# focus-engine

skills/dpearson2699/swift-ios-skills/focus-engine
focus-engine
Installation
...
Storing @FocusState in shared models instead of the owning view.
Setting multiple competing default focus targets on one screen.
Using .focusable() on decorative views.
Forgetting focus restoration after sheets, popovers, or custom overlays.
Reaching for UIFocusGuide before trying focusSection() on macOS or tvOS, or better layout grouping in SwiftUI.
Using gesture handlers for primary actions on custom focusable controls instead of a semantic Button when possible.
Review Checklist
