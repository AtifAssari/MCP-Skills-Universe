...
url: https://skills.sh/akin-ozer/cc-devops-skills/azure-pipelines-generator
---

# azure-pipelines-generator

skills/akin-ozer/cc-devops-skills/azure-pipelines-generator
azure-pipelines-generator
Installation
...
Official docs search (Microsoft Learn first)
...
Validate with azure-pipelines-validator.
Fix findings.
...
Hierarchy sanity (stages -> jobs -> steps)
Task format sanity (Task@Major)
Secret exposure scan (no plaintext credentials/tokens)
...
Read docs/yaml-schema.md, docs/best-practices.md, and examples/multi-stage-cicd.yml.
Add requested customizations (stages, branch gates, environments, tasks).
Validate with azure-pipelines-validator; fix and re-run.
Return YAML + setup + validation + assumptions + references.
...
Skip full validation and state Validation status: Skipped (snippet-only).
Return snippet + assumptions + references.
