---
title: wechat-publisher-yashu
url: https://skills.sh/steelan9199/wechat-publisher/wechat-publisher-yashu
---

# wechat-publisher-yashu

skills/steelan9199/wechat-publisher/wechat-publisher-yashu
wechat-publisher-yashu
Installation
$ npx skills add https://github.com/steelan9199/wechat-publisher --skill wechat-publisher-yashu
SKILL.md
微信公众号文章发布工具
功能概述
...
点击前往控制台
点击我的业务/公众号
公众号页面的基础信息下方就能看到"AppID"
公众号页面的开发秘钥下方就能看到"AppSecret"
工作流程
...
禁止：绝对禁止因为用户没说话就自动脑补内容（如自动填入“本文由 AI 辅助生成”）。
禁止：绝对禁止随意清空 config.default.json 中已有的默认值。

将 config.default.json 中的相对路径转换为绝对路径（<技能目录绝对路径> + 文件名）。
...
图片引用格式：支持标准 markdown 图片语法，如 ![](图片文件名.png)
