---
title: seedance2
url: https://skills.sh/zhanghaonan777/seedance2-skill/seedance2
---

# seedance2

skills/zhanghaonan777/seedance2-skill/seedance2
seedance2
Installation
...
词库选词：从 reference.md 的镜头语言/风格词汇库中取词，不自编
...
看图读意：分析图片的场景、情绪、潜在故事性、视觉张力
发散创意方向：从图片出发，构思 2–3 个完全不同的创意角度。比如一张咖啡杯照片：
治愈路线：晨光中咖啡升起的热气缓缓幻化成回忆片段
广告路线：咖啡豆从高空坠落、爆裂、组装成一杯拿铁的 3D 特效
悬疑路线：咖啡表面的纹路缓缓变成一张地图，镜头推入进入另一个世界
挑最有意思的展开成完整 prompt，或者简要呈现几个方向让用户选
展开时依然要过创意审核——不是"能跑"就行，要"有意思"
工作方式
...
质量红线
提示词必须中文，可直接复制到即梦使用
@ 引用只用 @图片1@图片9、@视频1@视频3、@音频1~@音频3，每个标清用途
区分「参考」（借鉴风格/动作）与「编辑」（在原素材上改）
禁止写实真人脸素材
运镜/风格词从 reference.md 词库中选，不自造
台词用引号，标角色与情绪
搜索建议
场景	搜索词
