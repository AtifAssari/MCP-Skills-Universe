---
title: yahoo-finance
url: https://skills.sh/xiaonan0527/openclaw-stock-market-skills/yahoo-finance
---

# yahoo-finance

skills/xiaonan0527/openclaw-stock-market-skills/yahoo-finance
yahoo-finance
Installation
$ npx skills add https://github.com/xiaonan0527/openclaw-stock-market-skills --skill yahoo-finance
SKILL.md
...
功能
实时股票报价 - 获取股票的实时报价（延迟约15分钟）
公司基本信息 - 查询公司概况、行业、市值等信息
历史价格数据 - 获取历史价格数据（支持多种时间范围和间隔）
搜索股票 - 根据公司名称或代码搜索股票
支持的市场
...
注意事项
数据延迟：Yahoo Finance 免费数据通常有15分钟左右的延迟
请求频率：虽然没有明确的请求限制，但建议合理使用，避免过于频繁的请求
数据准确性：数据仅供参考，不构成投资建议
API 稳定性：Yahoo Finance 是非官方 API，可能会有变动
技术细节
