---
title: claude-code-clawdbot
url: https://skills.sh/win4r/claude-code-clawdbot-skill/claude-code-clawdbot
---

# claude-code-clawdbot

skills/win4r/claude-code-clawdbot-skill/claude-code-clawdbot
claude-code-clawdbot
Installation
...
Recommended: set an origin remote (can be a local bare repo) so git fetch --all --prune won’t behave oddly:
