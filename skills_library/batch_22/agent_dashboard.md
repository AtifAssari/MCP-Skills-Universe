...
url: https://skills.sh/tahseen137/agent-dashboard/agent-dashboard
---

# agent-dashboard

skills/tahseen137/agent-dashboard/agent-dashboard
agent-dashboard
Installation
$ npx skills add https://github.com/tahseen137/agent-dashboard --skill agent-dashboard
SKILL.md
Mission Control 🚀
