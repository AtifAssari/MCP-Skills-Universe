---
title: load-test-builder
url: https://skills.sh/patricio0312rev/skills/load-test-builder
---

# load-test-builder

skills/patricio0312rev/skills/load-test-builder
load-test-builder
Installation
$ npx skills add https://github.com/patricio0312rev/skills --skill load-test-builder
SKILL.md
Load Test Builder
