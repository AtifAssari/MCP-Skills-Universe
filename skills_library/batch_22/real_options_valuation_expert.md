---
title: real-options-valuation-expert
url: https://skills.sh/reggiechan74/vp-real-estate/real-options-valuation-expert
---

# real-options-valuation-expert

skills/reggiechan74/vp-real-estate/real-options-valuation-expert
real-options-valuation-expert
Installation
...
Current Market Rent ($/SF)
Expected Market Rent at option date (forecast or use current + expected growth)
Option Exercise Rent (predetermined rent or formula)
Time to Option (years)
Market Rent Volatility (historical standard deviation)
Discount Rate (risk-free rate or landlord's cost of capital)
