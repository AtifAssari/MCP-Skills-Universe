...
url: https://skills.sh/akin-ozer/cc-devops-skills/jenkinsfile-validator
---

# jenkinsfile-validator

skills/akin-ozer/cc-devops-skills/jenkinsfile-validator
jenkinsfile-validator
Installation
...
Check local reference: devops-skills-plugin/skills/jenkinsfile-validator/references/common_plugins.md
Context7 lookup:
...
If missing, use Context7 (resolve-library-id then query-docs).
If still missing, use web search against official plugin index/docs.
