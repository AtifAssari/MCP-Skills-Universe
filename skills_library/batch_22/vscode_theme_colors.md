---
title: vscode-theme-colors
url: https://skills.sh/steelan9199/wechat-publisher/vscode-theme-colors
---

# vscode-theme-colors

skills/steelan9199/wechat-publisher/vscode-theme-colors
vscode-theme-colors
Installation
$ npx skills add https://github.com/steelan9199/wechat-publisher --skill vscode-theme-colors
SKILL.md
VSCode 主题颜色设置
概述
...
创建新主题
使用 Developer: Generate Color Theme from Current Settings 命令生成主题文件
或使用 Yeoman 生成器创建主题扩展：
