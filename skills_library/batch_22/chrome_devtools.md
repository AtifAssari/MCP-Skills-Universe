...
url: https://skills.sh/huynguyen03dev/opencode-setup/chrome-devtools
---

# chrome-devtools

skills/huynguyen03dev/opencode-setup/chrome-devtools
chrome-devtools
Installation
$ npx skills add https://github.com/huynguyen03dev/opencode-setup --skill chrome-devtools
SKILL.md
