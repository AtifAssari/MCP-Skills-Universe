---
title: cross-domain-seeing
url: https://skills.sh/dragoon0x/taste-skills/cross-domain-seeing
---

# cross-domain-seeing

skills/dragoon0x/taste-skills/cross-domain-seeing
cross-domain-seeing
Installation
$ npx skills add https://github.com/dragoon0x/taste-skills --skill cross-domain-seeing
SKILL.md
Cross-Domain Seeing
...
How to use
/cross-domain-seeing Apply cross-domain observation principles to this conversation.
/cross-domain-seeing <domain> Extract design principles from a specific non-digital domain.
Constraints
