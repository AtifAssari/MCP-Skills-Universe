...
url: https://skills.sh/dragoon0x/taste-skills/self-assessment
---

# self-assessment

skills/dragoon0x/taste-skills/self-assessment
self-assessment
Installation
$ npx skills add https://github.com/dragoon0x/taste-skills --skill self-assessment
SKILL.md
Self-Assessment
...
How to use
/self-assessment Generate a taste self-assessment for the user.
Constraints
Six Skill Areas
