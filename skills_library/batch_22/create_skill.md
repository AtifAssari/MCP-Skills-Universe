---
title: create-skill
url: https://skills.sh/n8n-io/n8n/create-skill
---

# create-skill

skills/n8n-io/n8n/create-skill
create-skill
Installation
...
Examples — follow an existing skill in .claude/skills/ if one fits.
...
Progressive disclosure — essentials in SKILL.md; long reference in reference.md. Link one level deep from SKILL.md.
Prefer one default — e.g. one library or one workflow; add an escape hatch only if needed.
...
Paths — forward slashes only (scripts/foo.py).
...
Implement — SKILL.md first; add reference.md / scripts/ only if they save tokens or reduce errors.
Check — third-person description; terminology consistent; no duplicate encyclopedic content the model already knows.
Anti-patterns
