...
url: https://skills.sh/patricio0312rev/skills/mcp-server-builder
---

# mcp-server-builder

skills/patricio0312rev/skills/mcp-server-builder
mcp-server-builder
Installation
$ npx skills add https://github.com/patricio0312rev/skills --skill mcp-server-builder
SKILL.md
MCP Server Builder
