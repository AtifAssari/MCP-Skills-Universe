---
title: openclaw-troubleshooter
url: https://skills.sh/tighten724-hub/openclaw-troubleshooter/openclaw-troubleshooter
---

# openclaw-troubleshooter

skills/tighten724-hub/openclaw-troubleshooter/openclaw-troubleshooter
openclaw-troubleshooter
Installation
$ npx skills add https://github.com/tighten724-hub/openclaw-troubleshooter --skill openclaw-troubleshooter
SKILL.md
OpenClaw 故障排除技能
...
或让用户确认后再执行
4. 如果必须重启
警告用户："即将重启Gateway，我会暂时断开连接"
执行 openclaw gateway restart
提醒用户："Gateway已重启，请刷新页面或重新发送消息"
📖 查阅官方文档
...
运行 openclaw logs --follow 查看详细日志
将日志复制到 Discord 社区寻求帮助：https://discord.gg/clawd
