---
title: groq-observability
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/groq-observability
---

# groq-observability

skills/jeremylongshore/claude-code-plugins-plus-skills/groq-observability
groq-observability
Installation
$ npx skills add https://github.com/jeremylongshore/claude-code-plugins-plus-skills --skill groq-observability
SKILL.md
Groq Observability
Overview
