...
url: https://skills.sh/iskysun96/aptos-agent-skills/deploy-contracts
---

# deploy-contracts

skills/iskysun96/aptos-agent-skills/deploy-contracts
deploy-contracts
Installation
$ npx skills add https://github.com/iskysun96/aptos-agent-skills --skill deploy-contracts
SKILL.md
