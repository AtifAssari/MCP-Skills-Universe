---
title: use-topbar
url: https://skills.sh/cognitedata/dune-skills/use-topbar
---

# use-topbar

skills/cognitedata/dune-skills/use-topbar
use-topbar
Installation
...
Check whether .cursor/hooks.json exists in the project root.
...
If .cursor/hooks.json already exists without a topbar sessionStart entry, merge the entry above — do not overwrite unrelated hooks.
Confirm to the user, then continue.
