---
title: architecture-domain-analysis
url: https://skills.sh/baotoq/agent-skills/architecture-domain-analysis
---

# architecture-domain-analysis

skills/baotoq/agent-skills/architecture-domain-analysis
architecture-domain-analysis
Installation
$ npx skills add https://github.com/baotoq/agent-skills --skill architecture-domain-analysis
SKILL.md
