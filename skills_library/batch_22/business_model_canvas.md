...
url: https://skills.sh/flpbalada/my-opencode-config/business-model-canvas
---

# business-model-canvas

skills/flpbalada/my-opencode-config/business-model-canvas
business-model-canvas
Installation
$ npx skills add https://github.com/flpbalada/my-opencode-config --skill business-model-canvas
SKILL.md
