---
title: planning-with-files-es
url: https://skills.sh/othmanadi/planning-with-files/planning-with-files-es
---

# planning-with-files-es

skills/othmanadi/planning-with-files/planning-with-files-es
planning-with-files-es
Installation
...
Si task_plan.md existe, lee inmediatamente task_plan.md, progress.md y findings.md.
Luego verifica si la sesión anterior tiene contexto no sincronizado:
# Linux/macOS
...
Crear task_plan.md — Consulta la plantilla templates/task_plan.md
Crear findings.md — Consulta la plantilla templates/findings.md
Crear progress.md — Consulta la plantilla templates/progress.md
