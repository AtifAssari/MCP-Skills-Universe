...
skills/sickn33/antigravity-awesome-skills/api-documentation-generator
api-documentation-generator
Installation
...
Produces OpenAPI/Swagger specifications and Postman collections for interactive testing and API exploration
Includes usage guidelines covering authentication setup, rate limiting, pagination, filtering, and common use cases with troubleshooting sections
SKILL.md
API Documentation Generator
Overview
