...
url: https://skills.sh/conorluddy/ios-simulator-skill/ios-simulator-skill
---

# ios-simulator-skill

skills/conorluddy/ios-simulator-skill/ios-simulator-skill
ios-simulator-skill
Installation
...
All scripts support --json for machine-readable output and auto-detect booted simulators; batch operations available for device management
Token-efficient screenshots with configurable sizing (quarter/half/full) and structured output designed for minimal AI agent overhead
SKILL.md
iOS Simulator Skill
