---
title: resume-tailor
url: https://skills.sh/claude-office-skills/skills/resume-tailor
---

# resume-tailor

skills/claude-office-skills/skills/resume-tailor
resume-tailor
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill resume-tailor
SKILL.md
Resume Tailor Skill
Overview
...
Your current resume (paste text or upload)
The job description you're applying for
Any additional context (career change? internal transfer? specific concerns?)
Step 2: I'll Analyze
...
Scans for keywords matching job description
Ranks candidates by keyword match percentage
Only top-ranked resumes reach human reviewers
...
Weak: "Responsible for sales" Strong: "Generated $2.5M in new revenue by acquiring 45 enterprise accounts"
...
5+ years Python experience ✅ (you have 6 years)
AWS expertise ⚠️ (mentioned briefly - let's expand)
Team leadership ✅ (managed 3 engineers)
Microservices ⚠️ (not mentioned - do you have experience?)

Recommended Changes:

Add "AWS" to skills section with specific services
Expand your Project X bullet to mention the microservices architecture
Quantify your team leadership impact
Move Python experience higher in skills list
...
Add "Instructional Design" to your headline
Reframe bullets using ID terminology
Highlight any digital content you've created
Add relevant tools (Articulate, Adobe, etc.) if you've used them
Tips for Better Results
Include the full job description - Don't summarize, I need the exact keywords
Share your complete resume - I need to see all your experience to choose what to highlight
Tell me your concerns - Worried about a gap? Career change? Let me know
Specify the company - Different companies have different cultures
Iterate - We can refine together based on your feedback
Common Questions

Q: Should I have multiple versions of my resume? A: Yes! Have a "base" resume with everything, then tailor for each application. Keep 2-3 versions for different role types.

Q: How long should my resume be? A:
...
Q: Should I include every job I've had? A: Focus on relevant experience. Old or unrelated jobs can be summarized in one line or omitted.

Q: What about personal projects? A: Include if relevant! Especially for tech roles or career changers. Show initiative and passion.
...
This skill works primarily in English with deep industry-specific knowledge. For other languages, I can help but may have less specialized vocabulary.
