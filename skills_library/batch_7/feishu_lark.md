---
title: feishu-lark
url: https://skills.sh/openclaudia/openclaudia-skills/feishu-lark
---

# feishu-lark

skills/openclaudia/openclaudia-skills/feishu-lark
feishu-lark
Installation
...
Add required permissions: im:message:send_as_bot, im:chat:readonly
Publish and approve the app, then add to .env:
...
Include both timestamp and sign in the request JSON body
