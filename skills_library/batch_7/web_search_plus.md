...
url: https://skills.sh/robbyczgw-cla/web-search-plus/web-search-plus
---

# web-search-plus

skills/robbyczgw-cla/web-search-plus/web-search-plus
web-search-plus
Installation
...
Includes automatic fallback to alternate providers on rate limits or failures, with confidence scoring and optional routing explanation
Supports override mode to force a specific provider when auto-routing doesn't match your intent
SKILL.md
Web Search Plus
