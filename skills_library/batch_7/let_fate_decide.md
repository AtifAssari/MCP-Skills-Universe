...
url: https://skills.sh/trailofbits/skills/let-fate-decide
---

# let-fate-decide

skills/trailofbits/skills/let-fate-decide
let-fate-decide
Installation
...
Performs a Fisher-Yates shuffle via secrets.randbelow() (no modulo bias)
