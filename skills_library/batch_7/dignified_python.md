...
url: https://skills.sh/dagster-io/skills/dignified-python
---

# dignified-python

skills/dagster-io/skills/dignified-python
dignified-python
Installation
...
pyproject.toml - Look for requires-python field (e.g., requires-python = ">=3.12")
setup.py or setup.cfg - Look for python_requires
...
Core knowledge is loaded automatically (defaults, pathlib, imports, anti-patterns)
