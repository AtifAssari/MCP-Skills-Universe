...
url: https://skills.sh/dengineproblem/agents-monorepo/social-media-marketing
---

# social-media-marketing

skills/dengineproblem/agents-monorepo/social-media-marketing
social-media-marketing
Installation
...
Weekly content calendar structure with 40/20/20/10/10 content mix (educational, entertaining, promotional, engagement, curated)
Paid social guidance covering campaign objectives, audience targeting, lookalike strategies, and A/B testing approaches
Engagement benchmarks and metrics tracking for awareness, engagement, and conversion across all platforms
SKILL.md
...
Twitter/X
twitter_x:
  audience: "News, real-time, conversations"
  content_types:
    tweets:
      length: "100-200 characters optimal"
      frequency: "3-10 per day"
      formats: ["Text", "Images", "Polls", "Threads"]
  ...
  best_practices:
    engagement:
      ...
      - "Join conversations"
    timing: "Morning, lunch, evening peaks"
    hashtags: "1-2 max"
...
content_calendar:
  weekly_structure:
    monday:
      theme: "Educational"
      content: "Tips, how-tos, tutorials"

    tuesday:
      theme: "Industry trends"
      content: "News, insights, opinions"

    wednesday:
      theme: "Behind the scenes"
      content: "Team, process, culture"

    thursday:
      theme: "Customer spotlight"
      content: "Testimonials, case studies, UGC"

    friday:
      theme: "Engagement"
      content: "Questions, polls, fun content"

    saturday:
      theme: "Curated"
      content: "Third-party content, shares"

    sunday:
      theme: "Cultural/Inspirational"
      content: "Quotes, stories, values"
...
engagement_strategy:
  response_framework:
    positive_comments:
      ...
      approach: "Thank, add value, engage"

    questions:
      response_time: "Within 1 hour"
      approach: "Answer thoroughly, offer more help"

    complaints:
      response_time: "Within 30 minutes"
      approach: "Acknowledge, empathize, resolve"
      escalation: "Take to DM if sensitive"

    negative_comments:
      assessment: "Legitimate concern vs troll"
      legitimate: "Address publicly, show resolution"
      troll: "Don't engage, hide if needed"

  proactive_engagement:
    daily_tasks:
      - "Like relevant posts (30-50)"
      - "Comment meaningfully (20-30)"
      - "Share valuable content (5-10)"
      - "Respond to all mentions"
      - "Check brand hashtags"

  crisis_management:
    assessment:
      level_1: "Minor complaint (individual)"
      level_2: "Growing concern (spreading)"
      level_3: "Full crisis (viral, media)"
...
paid_social_strategy:
  ...
  targeting:
    ...
    lookalike_audiences:
      ...
      percentage: "1-3% for quality, 5-10% for reach"
  ...
  optimization:
    a_b_testing:
      ...
      - "Placements"
      - "Copy"
    frequency_cap: "3-5 per week per user"
...
Лучшие практики
Platform native — адаптируй контент под каждую платформу
Consistency — регулярный постинг важнее идеального
Engage authentically — общайся как человек, не бренд
Test and iterate — анализируй что работает
Community first — строй отношения, не только followers
Video priority — все платформы продвигают видео
Weekly Installs
1.2K
Repository
