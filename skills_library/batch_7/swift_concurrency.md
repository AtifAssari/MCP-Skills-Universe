...
url: https://skills.sh/dpearson2699/swift-ios-skills/swift-concurrency
---

# swift-concurrency

skills/dpearson2699/swift-ios-skills/swift-concurrency
swift-concurrency
Installation
...
Migrate from @preconcurrency imports to full Swift 6 strict concurrency while handling actor reentrancy and cross-isolation callbacks
SKILL.md
Swift Concurrency
...
Retain cycles in Tasks. Use [weak self] when capturing self in long-lived stored tasks.
