...
url: https://skills.sh/paramchoudhary/resumeskills/cover-letter-generator
---

# cover letter generator

skills/paramchoudhary/resumeskills/Cover Letter Generator
Cover Letter Generator
Installation
$ npx skills add https://github.com/paramchoudhary/resumeskills --skill 'Cover Letter Generator'
Summary

Generate personalized, compelling cover letters from resume and job description inputs.
...
Includes industry-specific guidance for tech, marketing, finance, consulting, and startup vs. enterprise contexts
Delivers alternative opening options and interview talking points alongside the final letter
SKILL.md
Cover Letter Generator
