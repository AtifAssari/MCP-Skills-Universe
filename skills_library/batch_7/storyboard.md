---
title: storyboard
url: https://skills.sh/deanpeters/product-manager-skills/storyboard
---

# storyboard

skills/deanpeters/product-manager-skills/storyboard
storyboard
Installation
$ npx skills add https://github.com/deanpeters/product-manager-skills --skill storyboard
Summary
...
Frame 1: Main Character — Introduce the persona and their context
Frame 2: The Problem Emerges — Show the challenge or obstacle they face
Frame 3: The "Oh Crap" Moment — Escalate the problem to create urgency
Frame 4: The Solution Appears — Introduce your product/feature
Frame 5: The "Aha" Moment — Show the user experiencing the breakthrough
Frame 6: Life After the Solution — Illustrate the improved state
Why This Works
