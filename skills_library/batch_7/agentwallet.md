---
title: agentwallet
url: https://skills.sh/frames-engineering/skills/agentwallet
---

# agentwallet

skills/frames-engineering/skills/agentwallet
agentwallet
Installation
...
How MPP Works
Agent calls target API via /x402/fetch
Target API returns 402 with WWW-Authenticate: Payment id="...", method="tempo", ...
Server detects MPP, creates payment credential using Tempo
Server retries request with Authorization: Payment ... header
