...
url: https://skills.sh/sickn33/antigravity-awesome-skills/ai-agents-architect
---

# ai-agents-architect

skills/sickn33/antigravity-awesome-skills/ai-agents-architect
ai-agents-architect
Installation
...
Identifies critical sharp edges including infinite loops, vague tool specs, memory bloat, and workflow persistence, with solutions for each
Requires LLM API access, function calling support, and basic prompt engineering knowledge
SKILL.md
AI Agents Architect
