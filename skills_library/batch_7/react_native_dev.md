...
url: https://skills.sh/minimax-ai/skills/react-native-dev
---

# react-native-dev

skills/minimax-ai/skills/react-native-dev
react-native-dev
Installation
$ npx skills add https://github.com/minimax-ai/skills --skill react-native-dev
SKILL.md
...
Set entry point in package.json: "main": "expo-router/entry"
Add scheme in app.json: "scheme": "my-app"
Delete App.tsx and index.ts
Create app/_layout.tsx as root Stack layout
Create app/(tabs)/_layout.tsx for tab navigation
Create route files in app/(tabs)/ (see navigation.md)
