---
title: autoresearch
url: https://skills.sh/github/awesome-copilot/autoresearch
---

# autoresearch

skills/github/awesome-copilot/autoresearch
autoresearch
Installation
...
The command to run (e.g., dotnet test, npm run benchmark, time ./build.sh, pytest --tb=short)
