...
url: https://skills.sh/openai/skills/skill-installer
---

# skill-installer

skills/openai/skills/skill-installer
skill-installer
Installation
...
Supports git sparse checkout as a fallback for authentication-protected repos; uses existing git credentials or optional GITHUB_TOKEN environment variable
Installs to $CODEX_HOME/skills (defaults to ~/.codex/skills) with configurable destination, ref, and installation method (auto, download, or git)
SKILL.md
Skill Installer
