...
url: https://skills.sh/bytedance/deer-flow/consulting-analysis
---

# consulting-analysis

skills/bytedance/deer-flow/consulting-analysis
consulting-analysis
Installation
...
Selects from 20+ professional frameworks (SWOT, Porter's Five Forces, TAM-SAM-SOM, Consumer Decision Journey, DuPont Analysis, Blue Ocean Strategy, etc.) matched to the analytical domain
Embeds charts and comparison tables following a "Visual Anchor → Data Contrast → Integrated Analysis" flow, with every insight tracing the chain: Data → User Psychology → Strategy Implication
Outputs in McKinsey/BCG consulting voice with strict adherence to provided data—no hallucinations, all claims traceable to input sources, references formatted per GB/T 7714-2015
SKILL.md
...
Visual Evidence Block: Embed charts using ![Image Description](Actual_File_Path) — use the file paths collected in Step 2.3
