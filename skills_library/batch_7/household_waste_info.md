---
title: household-waste-info
url: https://skills.sh/nomadamas/k-skill/household-waste-info
---
...
serviceKey 값은 proxy 서버가 관리하고 주입한다.
사용자 측 로컬 환경에 DATA_GO_KR_API_KEY를 둘 필요가 없다.
