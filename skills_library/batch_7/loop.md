---
title: loop
url: https://skills.sh/alirezarezvani/claude-skills/loop
---

# loop

skills/alirezarezvani/claude-skills/loop
loop
Installation
...
Read .autoresearch/{domain}/{name}/loop.json to get the cron ID
Call CronDelete with that ID
Delete loop.json
