...
url: https://skills.sh/composiohq/awesome-claude-skills/slack-gif-creator
---

# slack-gif-creator

skills/composiohq/awesome-claude-skills/slack-gif-creator
slack-gif-creator
Installation
...
Offers helper utilities for GIF assembly, text rendering, color palettes, particle effects, easing functions, and frame composition
Distinguishes emoji GIFs (10-15 frames, 32-48 colors, simple designs) from message GIFs (higher frame counts and color budgets) with mode-specific guidance
SKILL.md
