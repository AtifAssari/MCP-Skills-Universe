...
url: https://skills.sh/claude-office-skills/skills/image-generation
---

# image-generation

skills/claude-office-skills/skills/image-generation
image-generation
Installation
...
Be specific - "golden retriever" > "dog"
Describe what you want, not what you don't (use negative prompts separately)
Use quality modifiers - "professional", "detailed", "8k"
Reference styles - "in the style of [artist/genre]"
Specify composition - "close-up", "wide shot", "bird's eye view"
Include lighting - dramatically affects mood
Iterate - refine based on results
Use consistent seeds for variations (when possible)
Limitations
