---
title: seoul-subway-arrival
url: https://skills.sh/nomadamas/k-skill/seoul-subway-arrival
---

# seoul-subway-arrival

skills/nomadamas/k-skill/seoul-subway-arrival
seoul-subway-arrival
Installation
...
KSKILL_PROXY_BASE_URL 이 있으면 그 값을 사용한다.
없으면 사용자/운영자에게 self-host 또는 배포 확인이 끝난 proxy URL 을 먼저 확보한다.
직접 proxy를 운영하는 경우에만 proxy 서버 upstream key를 서버 쪽에만 설정한다.
