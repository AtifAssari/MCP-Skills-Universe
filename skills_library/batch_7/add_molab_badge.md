---
title: add-molab-badge
url: https://skills.sh/marimo-team/skills/add-molab-badge
---

# add-molab-badge

skills/marimo-team/skills/add-molab-badge
add-molab-badge
Installation
...
Find all marimo notebook files (.py files) in the repository. Use Glob with patterns like **/*.py and then check for the marimo header (import marimo or app = marimo.App) to confirm they are marimo notebooks.
If the README already has links to notebooks (e.g., via marimo.app links or existing badges), replace those.
Otherwise, ask the user which notebooks should be linked.
