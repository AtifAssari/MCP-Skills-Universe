---
title: autocli
url: https://skills.sh/nashsu/autocli-skill/autocli
---

# autocli

skills/nashsu/autocli-skill/autocli
autocli
Installation
...
Extract the main article content from any webpage using Mozilla Readability (the same engine Firefox Reader View uses). Returns clean Markdown by default.
