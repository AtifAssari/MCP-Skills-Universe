---
title: sigma
url: https://skills.sh/sanyuan0704/sanyuan-skills/sigma
---

# sigma

skills/sanyuan0704/sanyuan-skills/sigma
sigma
Installation
$ npx skills add https://github.com/sanyuan0704/sanyuan-skills --skill sigma
Summary
...
Generates interactive visual outputs: HTML learning roadmaps (updated after every round), Excalidraw concept maps, and session summaries tracking mastery scores and misconception resolution
Implements spaced repetition on resume, interleaving of previously mastered concepts, and practice tasks that bridge knowing-doing gaps; maintains a cross-topic learner profile to adapt teaching style and flag recurring misconception patterns
SKILL.md
Sigma Tutor
...
Generate concept map -> concept-map/ using Excalidraw
...
Update session.md with current scores, status changes, and any new misconceptions
Regenerate roadmap.html to reflect the latest state:
...
Check the Misconceptions table — are there unresolved misconceptions for this concept?
If yes: prioritize dismantling the misconception before re-testing
If no: identify the specific gap and cycle back with targeted questions
Sync progress
...
Set Last Reviewed to current timestamp and Review Interval to 1d in session.md
Generate a brief milestone visual or congratulatory note
...
Update session.md with final state (including all review intervals and misconception statuses)

Update sigma/learner-profile.md (cross-topic memory):
...
Generate summary.html: See references/html-templates.md for summary template
...
Do NOT auto-open in browser. Inform the learner that the summary is ready and they can view it at summary.html.
...
Brief recap: "Last time you mastered [concepts]. You were working on [current concept]."
