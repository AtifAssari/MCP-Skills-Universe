...
url: https://skills.sh/jwynia/agent-skills/presentation-design
---

# presentation-design

skills/jwynia/agent-skills/presentation-design
presentation-design
Installation
...
Covers five common anti-patterns (data dumps, script reading, template traps, animation overuse, bullet point disease) with specific fixes for each
Offers implementation checklists, time-flexibility marking (essential vs. expandable content), and progressive disclosure techniques for sequential information reveal
Works across any presentation tool (PowerPoint, Keynote, reveal.js, Google Slides) with accessibility considerations for contrast, font sizing, and inclusive content
SKILL.md
