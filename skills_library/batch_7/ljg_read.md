---
title: ljg-read
url: https://skills.sh/lijigang/ljg-skills/ljg-read
---

# ljg-read

skills/lijigang/ljg-skills/ljg-read
ljg-read
Installation
...
运行 date "+%Y-%m-%d %a %H:%M" 获取可读时间
写入 ~/Documents/notes/{时间戳}--伴读-{文本关键词}__reading.org
