...
url: https://skills.sh/sickn33/antigravity-awesome-skills/test-driven-development
---

# test-driven-development

skills/sickn33/antigravity-awesome-skills/test-driven-development
test-driven-development
...
Applies to all new features, bug fixes, refactoring, and behavior changes; code written before tests must be deleted and restarted
Tests should use real code and demonstrate desired behavior, not mock implementation details; test names should clearly describe what should happen
SKILL.md
