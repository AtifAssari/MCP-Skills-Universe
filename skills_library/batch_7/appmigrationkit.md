...
url: https://skills.sh/dpearson2699/swift-ios-skills/appmigrationkit
---

# appmigrationkit

skills/dpearson2699/swift-ios-skills/appmigrationkit
appmigrationkit
Installation
...
App extension -- An AppMigrationExtension conforming type that the system invokes during migration. It handles data export and import.
System orchestration -- The OS manages the device-to-device session, transport, and scheduling. The extension does not control when it runs.
Containing app -- After migration completes, the app checks MigrationStatus.importStatus on first launch to determine whether migration occurred and whether it succeeded.
