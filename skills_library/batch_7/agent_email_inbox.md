...
url: https://skills.sh/resend/resend-skills/agent-email-inbox
---

# agent-email-inbox

skills/resend/resend-skills/agent-email-inbox
agent-email-inbox
Installation
...
Set up tunneling (local dev) — Use Tailscale Funnel (recommended) or ngrok. See references/webhook-setup.md
...
Environment file method: Human creates .env file directly: echo "RESEND_API_KEY=re_xxx" >> .env
Password manager / secrets manager: Human stores key in 1Password, Vault, etc.
