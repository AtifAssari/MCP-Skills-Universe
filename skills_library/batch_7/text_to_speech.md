...
url: https://skills.sh/heygen-com/skills/text-to-speech
---

# text-to-speech

skills/heygen-com/skills/text-to-speech
text-to-speech
Installation
...
Requires HEYGEN_API_KEY environment variable; prefer MCP tools (mcp__heygen__list_audio_voices, mcp__heygen__text_to_speech) over direct HTTP calls when available
SKILL.md
