---
title: compound
url: https://skills.sh/ai-native-camp/camp-2/compound
---

# compound

skills/ai-native-camp/camp-2/compound
compound
Installation
$ npx skills add https://github.com/ai-native-camp/camp-2 --skill compound
SKILL.md
compound 스킬
...
knowledge/patterns/critical-patterns.md에 추가 (순번 유지)
해당 문서에 교차 참조 추가
확인: "크리티컬 패턴에 추가되었습니다."
...
knowledge/[category]/[filename].md에 파일 생성됨
...
파일명 생성: 20260304-skill-references-improve-accuracy.md
YAML 검증: 통과
문서 작성: knowledge/tool-discoveries/20260304-skill-references-improve-accuracy.md
교차 참조: 없음 (유사 문서 없음)
