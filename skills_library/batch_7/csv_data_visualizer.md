...
url: https://skills.sh/ailabs-393/ai-labs-claude-skills/csv-data-visualizer
---

# csv-data-visualizer

skills/ailabs-393/ai-labs-claude-skills/csv-data-visualizer
csv-data-visualizer
Installation
...
Best Practices
Starting Analysis
Always profile first for unfamiliar datasets: python3 scripts/data_profile.py data.csv
Review the profiling output to understand:
