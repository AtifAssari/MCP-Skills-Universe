---
title: pdf-ocr-skill
url: https://skills.sh/yejinlei/pdf-ocr-skill/pdf-ocr-skill
---

# pdf-ocr-skill

skills/yejinlei/pdf-ocr-skill/pdf-ocr-skill
pdf-ocr-skill
Installation
...
解析用户意图，确定要使用的引擎
调用 PDFOCRProcessor(engine="rapid")、PDFOCRProcessor(engine="rapidoc")、PDFOCRProcessor(engine="paddle") 或 PDFOCRProcessor(engine="siliconflow")
执行 OCR 识别并返回结果
🎯 最佳实践
...
Parse the user's intent to determine the engine to use
Call PDFOCRProcessor(engine="rapid"), PDFOCRProcessor(engine="rapidoc"), PDFOCRProcessor(engine="paddle"), or PDFOCRProcessor(engine="siliconflow")
Execute OCR recognition and return the result
🎯 Best Practices
