...
url: https://skills.sh/claude-office-skills/skills/template-engine
---

# template-engine

skills/claude-office-skills/skills/template-engine
template-engine
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill template-engine
SKILL.md
