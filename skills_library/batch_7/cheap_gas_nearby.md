---
title: cheap-gas-nearby
url: https://skills.sh/nomadamas/k-skill/cheap-gas-nearby
---

# cheap-gas-nearby

skills/nomadamas/k-skill/cheap-gas-nearby
cheap-gas-nearby
Installation
$ npx skills add https://github.com/nomadamas/k-skill --skill cheap-gas-nearby
SKILL.md
Cheap Gas Nearby
...
좌표를 KATEC으로 변환한다.
Opinet aroundAll.do 를 sort=1 가격순으로 조회한다.
상위 후보에 대해 detailById.do 를 호출해 도로명주소, 전화번호, 셀프 여부, 세차장, 경정비, 품질인증 여부를 보강한다.
보통 3~5개만 짧게 정리한다.
Responding
