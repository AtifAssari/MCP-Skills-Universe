...
url: https://skills.sh/rudrankriyam/app-store-connect-cli-skills/asc-shots-pipeline
---

# asc-shots-pipeline

skills/rudrankriyam/app-store-connect-cli-skills/asc-shots-pipeline
asc-shots-pipeline
Installation
...
asc cli pins framing to Koubou 0.18.1. Install and verify before running framing steps:
