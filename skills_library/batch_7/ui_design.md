---
title: ui-design
url: https://skills.sh/tencentcloudbase/skills/ui-design
---

# ui-design

skills/tencentcloudbase/skills/ui-design
ui-design
Installation
...
Requires professional icon libraries (FontAwesome, Heroicons, Material Icons) and distinctive typography paired with context-aware aesthetic directions (brutalist, maximalist, retro-futuristic, luxury, organic, etc.)
Includes self-audit checklists for color, font, icon, layout, and specification compliance before submission
SKILL.md
