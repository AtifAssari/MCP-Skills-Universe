---
title: rover
url: https://skills.sh/apollographql/skills/rover
---

# rover

skills/apollographql/skills/rover
rover
Installation
...
rover dev command starts a local Router with automatic schema composition for development workflows
Supports CI/CD patterns with check-before-publish validation and JSON output for scripting
Requires authentication via rover config auth or APOLLO_KEY environment variable; works on Node.js v18+, Linux/macOS/Windows
SKILL.md
