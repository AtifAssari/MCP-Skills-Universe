...
skills/claude-office-skills/skills/crypto-report
crypto-report
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill crypto-report
SKILL.md
Crypto Report Skill
Overview
...
Max Supply: [X] tokens Total Supply: [X] tokens ([X]% of max) Circulating Supply: [X] tokens ([X]% of total) Inflation Rate: [X]% annually
...
Provide on-chain data if you have access (TVL, users, etc.)
Specify your investment horizon (trading vs long-term holding)
Mention specific concerns you want addressed
Include recent news that might be relevant
Ask for comparisons with specific competitors
Limitations
