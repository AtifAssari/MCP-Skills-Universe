...
url: https://skills.sh/paramchoudhary/resumeskills/reference-list-builder
---

# reference list builder

skills/paramchoudhary/resumeskills/Reference List Builder
Reference List Builder
Installation
$ npx skills add https://github.com/paramchoudhary/resumeskills --skill 'Reference List Builder'
SKILL.md
Reference List Builder
