---
title: ios-hig-design
url: https://skills.sh/wondelai/skills/ios-hig-design
---

# ios-hig-design

skills/wondelai/skills/ios-hig-design
ios-hig-design
Installation
...
Apple Human Interface Guidelines --- The definitive reference for iOS, iPadOS, macOS, watchOS, and visionOS design
SF Symbols --- Apple's icon system with 5,000+ configurable symbols
Apple Design Resources (Figma/Sketch) --- Official design templates and UI kits
WWDC Design Sessions --- Video sessions covering design principles and new features
"Designed by Apple in California" --- Photo book documenting Apple's design process and philosophy
"The Design of Everyday Things" by Don Norman --- The foundational text on human-centered design that influenced Apple's approach
"Universal Principles of Design" by William Lidwell, Kritina Holden, and Jill Butler --- 125 design principles applicable to iOS interface design
About the Author
