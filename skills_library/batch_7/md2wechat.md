---
title: md2wechat
url: https://skills.sh/geekjourneyx/md2wechat-skill/md2wechat
---

# md2wechat

skills/geekjourneyx/md2wechat-skill/md2wechat
md2wechat
Installation
...
environment variables such as MD2WECHAT_BASE_URL
project-local md2wechat.yaml, md2wechat.yml, or md2wechat.json
...
判断内容：是观点 / 数据 / 教程 / 发布 / 综合？
挑选最少模块：每个模块只服务这 4 件事之一：
