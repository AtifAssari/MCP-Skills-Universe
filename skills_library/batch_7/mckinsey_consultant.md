...
url: https://skills.sh/fleurytian/awesome-claude-skills/mckinsey-consultant
---

# mckinsey-consultant

skills/fleurytian/awesome-claude-skills/mckinsey-consultant
mckinsey-consultant
Installation
...
Supports cross-conversation project continuation via Dummy Pages markdown files that document page designs, dependencies, and data requirements
Uses progressive disclosure architecture: loads methodology, design specs, and data templates only when needed to minimize context consumption and enable stable generation of 20–25 page presentations
SKILL.md
