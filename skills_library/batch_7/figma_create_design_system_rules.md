...
url: https://skills.sh/figma/mcp-server-guide/figma-create-design-system-rules
---

# figma-create-design-system-rules

skills/figma/mcp-server-guide/figma-create-design-system-rules
figma-create-design-system-rules
Installation
...
Verify the agent follows the rules correctly
...
Run create_design_system_rules(clientLanguages="typescript,javascript", clientFrameworks="react")
...
Save to the appropriate rule file for the user's agent
Test with a simple button implementation
...
Run create_design_system_rules(clientLanguages="typescript,javascript", clientFrameworks="vue")
Discover that project uses CSS modules and a custom design token system
Generate rules:
# Figma MCP Integration Rules
...
Save to the appropriate rule file for the user's agent
Validate with a card component
...
Run create_design_system_rules(clientLanguages="typescript", clientFrameworks="react")
Analyze the monorepo structure with design system package
...
Save to the appropriate rule file and share with team
