---
title: react-email
url: https://skills.sh/resend/resend-skills/react-email
---

# react-email

skills/resend/resend-skills/react-email
react-email
Originally fromresend/react-email
Installation
...
Provide plain text version - Required for accessibility
Keep file size under 102KB - Gmail clips larger emails
Add proper TypeScript types - Define interfaces for all email props
Include preview props - Add .PreviewProps for development testing
Use verified domains - For production from addresses
