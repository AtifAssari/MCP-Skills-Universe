...
url: https://skills.sh/anthropics/knowledge-work-plugins/financial-statements
---

# financial-statements

skills/anthropics/knowledge-work-plugins/financial-statements
financial-statements
Installation
...
Provides GAAP presentation guidance (ASC 220/210/230) covering revenue disaggregation, stock-based compensation, lease accounting, and discontinued operations
Integrates with ERP and data warehouse connectors to pull trial balance and account hierarchy data; accepts manual data entry or spreadsheet uploads when no connector is available
SKILL.md
/financial-statements
