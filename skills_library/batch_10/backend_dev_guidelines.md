...
url: https://skills.sh/bbeierle12/skill-mcp-claude/backend-dev-guidelines
---

# backend-dev-guidelines

skills/bbeierle12/skill-mcp-claude/backend-dev-guidelines
backend-dev-guidelines
Installation
$ npx skills add https://github.com/bbeierle12/skill-mcp-claude --skill backend-dev-guidelines
SKILL.md
