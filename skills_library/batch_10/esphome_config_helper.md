---
title: esphome-config-helper
url: https://skills.sh/nodnarbnitram/claude-code-extensions/esphome-config-helper
---

# esphome-config-helper

skills/nodnarbnitram/claude-code-extensions/esphome-config-helper
esphome-config-helper
Installation
...
Review logs: Use esphome logs device.yaml to see runtime errors
Consult references: Check references/troubleshooting.md for specific error
Validate config: Run validation workflow (see below)
Validation Workflow
...
Validate configuration using scripts/validate-config.sh
Fix any errors using references/troubleshooting.md
Flash device with validated configuration
Monitor logs and troubleshoot if needed

For adding to existing config:

Consult references for component configuration
Check GPIO availability in references/gpio-pinouts.md
