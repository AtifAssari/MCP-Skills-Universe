---
title: a2a-role-auditor
url: https://skills.sh/i9wa4/dotfiles/a2a-role-auditor
---

# a2a-role-auditor

skills/i9wa4/dotfiles/a2a-role-auditor
a2a-role-auditor
Installation
...
4. Workflow
Read postman.toml — extract edges, build adjacency map
Read each nodes/{node}.toml (source of truth; runtime session templates are NOT compared)
For each node: run Pre-check, then Checks 1–6 in order
Produce findings report sorted by severity
Propose concrete patch text for every finding
Present to user for feedback; iterate until approved
