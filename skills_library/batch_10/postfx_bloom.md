---
title: postfx-bloom
url: https://skills.sh/bbeierle12/skill-mcp-claude/postfx-bloom
---

# postfx-bloom

skills/bbeierle12/skill-mcp-claude/postfx-bloom
postfx-bloom
Installation
$ npx skills add https://github.com/bbeierle12/skill-mcp-claude --skill postfx-bloom
SKILL.md
...
Blur — Extracted pixels are blurred in multiple passes
Composite — Blurred result is added back to original image
Key Parameters
