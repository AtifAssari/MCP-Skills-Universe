---
title: convex-tenants
url: https://skills.sh/dbjpanda/convex-tenants/convex-tenants
---

# convex-tenants

skills/dbjpanda/convex-tenants/convex-tenants
convex-tenants
Installation
$ npx skills add https://github.com/dbjpanda/convex-tenants --skill convex-tenants
SKILL.md
Convex Tenants
...
Use in React — useQuery(api.tenants.listOrganizations), or use pre-built components with TenantsProvider. See node_modules/@djpanda/convex-tenants/docs/react-components.md.
Key Concepts
