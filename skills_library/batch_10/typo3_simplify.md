---
title: typo3-simplify
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-simplify
---

# typo3-simplify

skills/dirnbauer/webconsulting-skills/typo3-simplify
typo3-simplify
Installation
...
Process
Identify recently modified files (use git diff --name-only HEAD~1 or staged changes)
Run three parallel review passes: Reuse, Quality, Efficiency
