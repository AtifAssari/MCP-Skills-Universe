---
title: pptx
url: https://skills.sh/bbeierle12/skill-mcp-claude/pptx
---

# pptx

skills/bbeierle12/skill-mcp-claude/pptx
pptx
Installation
$ npx skills add https://github.com/bbeierle12/skill-mcp-claude --skill pptx
SKILL.md
...
For creating new presentations: Read html2pptx.md and css.md in their entirety
For editing existing presentations: Read ooxml.md in its entirety
For template-based creation: Read the relevant sections of this file plus css.md
...
Increase margins - Add more padding/spacing around problematic elements
Adjust font size - Reduce text size to fit within available space
Rethink the layout entirely - If the above fixes don't work, redesign the slide layout
...
Workflow
Read documentation: Read ooxml.md completely (see "CRITICAL: Read All Documentation First" section above)
...
CRITICAL: Validate immediately after each edit: python ooxml/scripts/validate.py <dir> --original <file>
