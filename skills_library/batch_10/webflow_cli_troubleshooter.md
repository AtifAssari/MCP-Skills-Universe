---
title: webflow-cli:troubleshooter
url: https://skills.sh/webflow/webflow-skills/webflow-cli:troubleshooter
---

# webflow-cli:troubleshooter

skills/webflow/webflow-skills/webflow-cli:troubleshooter
webflow-cli:troubleshooter
Installation
...
Check CLI installation: Run webflow --version
Check authentication: Run webflow auth login if needed
Run command with --verbose: Execute failed command with --verbose flag for detailed output
Use --debug-bundler (if bundle issue): Run with --debug-bundler flag to see bundler config
Check --help: Run webflow <command> --help to verify command syntax
Phase 3: Analyze & Fix
...
Check CLI version: webflow --version
Check command syntax: webflow <command> --help
Run with verbose: Add --verbose flag

For Build/Bundle Issues:

Use --verbose for detailed output
Use --debug-bundler to see config
Check import paths
...
Install CLI globally: npm install -g @webflow/cli
Verify installation: webflow --version
Quick Reference
