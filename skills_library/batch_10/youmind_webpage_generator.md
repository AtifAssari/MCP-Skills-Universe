---
title: youmind-webpage-generator
url: https://skills.sh/youmind-openlab/skills/youmind-webpage-generator
---
...
youmind-webpage-generator
Installation
$ npx skills add https://github.com/youmind-openlab/skills --skill youmind-webpage-generator
SKILL.md
AI Webpage Creator
...
Add it to your OpenClaw config (~/.openclaw/openclaw.json) — see setup guide for details.
...
✅ Response received — extract id as chatId from the JSON response
⚠️ Connection closed / "fetch failed" error — this is normal, proceed to Step 3b
