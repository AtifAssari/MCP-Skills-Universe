---
title: typo3-accessibility
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-accessibility
---

# typo3-accessibility

skills/dirnbauer/webconsulting-skills/typo3-accessibility
typo3-accessibility
Installation
$ npx skills add https://github.com/dirnbauer/webconsulting-skills --skill typo3-accessibility
SKILL.md
...
Backend modals migrated from Bootstrap Modal to native <dialog> element (Forge #107443). The native dialog provides better accessibility out of the box:
