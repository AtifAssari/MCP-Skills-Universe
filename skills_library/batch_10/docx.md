---
title: docx
url: https://skills.sh/bbeierle12/skill-mcp-claude/docx
---

# docx

skills/bbeierle12/skill-mcp-claude/docx
docx
Installation
...
Create and run a Python script using the Document library (set PYTHONPATH per "Initialization" section in ooxml.md)
