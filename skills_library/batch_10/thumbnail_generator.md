...
url: https://skills.sh/aiagentwithdhruv/skills/thumbnail-generator
---

# thumbnail-generator

skills/aiagentwithdhruv/skills/thumbnail-generator
thumbnail-generator
Installation
$ npx skills add https://github.com/aiagentwithdhruv/skills --skill thumbnail-generator
SKILL.md
...
ALWAYS plain black t-shirt — NEVER hoodie, jacket, suit, or anything else
ALWAYS realistic base — real room, natural wooden desk, warm ambient light, natural skin tones
ALWAYS MacBook Pro with actual app/terminal visible on screen
ALWAYS include specific details — real app names, real numbers, real tools
Futuristic elements are OVERLAYS — floating icons, neon glow lines, holographic panels are added ON TOP of the realistic base
NEVER full CGI/sci-fi — must feel like a real photograph first, futuristic second
NEVER over-process — 70% realistic photography, 30% futuristic elements
ALWAYS include quality modifiers — 8K, sharp focus, photorealistic, natural lighting
...
Layer 1 (Realistic base): Describe a real photo in a real room Layer 2 (Futuristic overlay): Add floating holographic elements on top
...
Process (Every Time)
Identify topic — what's the video/post about?
Pick color palette — Blue Metallic (B) by default, Purple Neon (A) for automation/clone topics
Pick visual hook — which of the 7 hooks tells this story best?
Fill in specifics — real app names, real numbers, real tools, real screens
Add materials — frosted glass, brushed metal, chrome (blue metallic) or translucent glow (purple)
Add lighting — rim light + volumetric fog + neon ambient (ALWAYS)
Add quality modifiers — 8K + sharp focus + hyperrealistic + Unreal Engine 5
Set ratio — 16:9 YouTube, 4:5 LinkedIn
Suggest text overlay — max 6 words, 2-3 highlighted
Generate 2-3 options — different hooks for same topic
