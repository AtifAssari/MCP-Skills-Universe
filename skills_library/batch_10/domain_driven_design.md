...
url: https://skills.sh/bfollington/terma/domain-driven-design
---

# domain-driven-design

skills/bfollington/terma/domain-driven-design
domain-driven-design
Installation
...
Map Current State: Document existing types, relationships, and patterns
Identify Affected Concepts: Which existing concepts does this change touch?
Check Consistency: Does new design follow existing patterns? If not, why?
Assess Impact: What breaks if we make this change?
Migration Path: How do we evolve from current to desired state?
Update Ubiquitous Language: Ensure all usage points are updated
Visualize Before/After: Create diagrams showing current and proposed models
