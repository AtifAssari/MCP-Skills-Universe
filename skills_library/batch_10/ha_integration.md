...
url: https://skills.sh/nodnarbnitram/claude-code-extensions/ha-integration
---

# ha-integration

skills/nodnarbnitram/claude-code-extensions/ha-integration
ha-integration
Installation
$ npx skills add https://github.com/nodnarbnitram/claude-code-extensions --skill ha-integration
SKILL.md
