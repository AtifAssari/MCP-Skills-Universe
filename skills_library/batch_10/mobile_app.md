---
title: mobile-app
url: https://skills.sh/popup-studio-ai/bkit-claude-code/mobile-app
---

# mobile-app

skills/popup-studio-ai/bkit-claude-code/mobile-app
mobile-app
Installation
$ npx skills add https://github.com/popup-studio-ai/bkit-claude-code --skill mobile-app
SKILL.md
