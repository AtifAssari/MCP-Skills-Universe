...
url: https://skills.sh/bmad-code-org/bmad-method/bmad-party-mode
---

# bmad-party-mode

skills/bmad-code-org/bmad-method/bmad-party-mode
bmad-party-mode
Installation
...
Parse arguments — check for --model and --solo flags from the user's invocation.
...
Load project context — search for **/project-context.md. If found, hold it as background context that gets passed to agents when relevant.
