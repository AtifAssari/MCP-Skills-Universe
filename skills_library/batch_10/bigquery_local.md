---
title: bigquery-local
url: https://skills.sh/i9wa4/dotfiles/bigquery-local
---

# bigquery-local

skills/i9wa4/dotfiles/bigquery-local
bigquery-local
Installation
$ npx skills add https://github.com/i9wa4/dotfiles --skill bigquery-local
SKILL.md
