---
title: slack
url: https://skills.sh/i9wa4/dotfiles/slack
---

# slack

skills/i9wa4/dotfiles/slack
slack
Installation
$ npx skills add https://github.com/i9wa4/dotfiles --skill slack
SKILL.md
Slack API Skill
...
NOTE: Enterprise Grid may restrict search.messages API with enterprise_is_restricted error.
