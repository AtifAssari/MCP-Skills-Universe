...
url: https://skills.sh/timlai666/skills/bcg-growth-share-matrix
---

# bcg-growth-share-matrix

skills/timlai666/skills/bcg-growth-share-matrix
bcg-growth-share-matrix
Installation
$ npx skills add https://github.com/timlai666/skills --skill bcg-growth-share-matrix
SKILL.md
BCG 成長佔有率矩陣
Overview
...
要追蹤的 KPI
Workflow
讀 references/02-intake-and-data-sufficiency.md 做資料檢查
讀 references/01-bcg-foundation-and-metrics.md 確認計算與門檻
讀 references/03-quadrant-strategy-playbook.md 產出各象限策略
讀 references/04-modern-caveats-and-portfolio-logic.md 加上現代化 caveats
若使用者要快速交付版，套用 assets/templates/bcg-portfolio-analysis-template.md
Quality Rules
...
References
BCG 基礎與衡量：references/01-bcg-foundation-and-metrics.md
資料齊備與追問：references/02-intake-and-data-sufficiency.md
四象限策略手冊：references/03-quadrant-strategy-playbook.md
現代化限制與組合邏輯：references/04-modern-caveats-and-portfolio-logic.md
常見用例與 prompts：references/05-use-cases-and-prompts.md
輸出模板：assets/templates/bcg-portfolio-analysis-template.md
Suggested Prompt
