---
title: sqlite-notes
url: https://skills.sh/bfollington/terma/sqlite-notes
---

# sqlite-notes

skills/bfollington/terma/sqlite-notes
sqlite-notes
Installation
$ npx skills add https://github.com/bfollington/terma --skill sqlite-notes
SKILL.md
...
Query recent notes as JSON for analysis
Fetch previous breadcrumb for context
Analyze themes, connections, momentum
INSERT new breadcrumb with prev_breadcrumb_id
Batch INSERT...SELECT into links for analyzedNotes relationships
...
Query notes from past week
Fetch recent breadcrumbs
Generate synthesis
INSERT reflection
Batch INSERT...SELECT into links for basedOnNotes and basedOnBreadcrumbs relationships
Link Related Notes
...
Query notes with relevant tags
Analyze content for conceptual connections
INSERT INTO links with linksTo relationships
Report on connections made
Tips & Best Practices

Capture First, Organize Later: Get ideas out of your head immediately. Weekly review is when you organize.

Trust the Folder Workflow: inbox → working → permanent mirrors how ideas mature. Don't force notes into permanent prematurely.

Use Origin Consistently: Always set the correct origin (me/llm/external/llm-assisted) for provenance clarity.

Generate Breadcrumbs Regularly: Weekly breadcrumbs create continuity and surface patterns you might miss.

Review Reflections: Rate and give feedback on AI-generated reflections to improve future generations.

Promote Selectively: Only promote reflections that genuinely add value. Not every reflection needs to become a permanent note.

Archive, Don't Delete: Move old working notes to archive instead of deleting. Preserves thinking history.

Full Lineage Always: When creating reflections or derived notes, always link back to source material.

Tag During Review: Don't stress about tagging during capture. Add tags during weekly review when context is clearer.

Leverage FTS5: Use full-text search with boolean operators for discovery. It's faster and more powerful than LIKE.

Use Views, Not Memorized Queries: Views are pre-optimized and self-documenting. Reference them by name.

JSON Output for Agent Processing: Use sqlite3 -json when Claude Code needs to process results. It's already parsed.

Human-Readable for Display: Use sqlite3 -header -column for tabular output that humans read.

Batch Link Creation: Use INSERT...SELECT to create N links at once. SQL shines here.

Trust CHECK Constraints: Don't validate enums in the agent. The database enforces them. If an INSERT fails, the constraint message tells you why.
