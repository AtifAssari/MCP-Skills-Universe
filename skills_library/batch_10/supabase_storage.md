...
url: https://skills.sh/raudbjorn/claude/supabase-storage
---

# supabase-storage

skills/raudbjorn/claude/supabase-storage
supabase-storage
Installation
$ npx skills add https://github.com/raudbjorn/claude --skill supabase-storage
SKILL.md
...
Use folder structure for logical organization (e.g., userId/avatars/filename.png)
Include metadata in upload options for better file management
