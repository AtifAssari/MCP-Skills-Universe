---
title: using-crabnebula-cloud-with-tauri
url: https://skills.sh/dchuk/claude-code-tauri-skills/using-crabnebula-cloud-with-tauri
---

# using-crabnebula-cloud-with-tauri

skills/dchuk/claude-code-tauri-skills/using-crabnebula-cloud-with-tauri
using-crabnebula-cloud-with-tauri
Installation
...
Add as CN_API_KEY repository secret in GitHub
...
Check that createUpdaterArtifacts is set to true
Verify capabilities include required permissions
Build Fails on Upload
Ensure CN_API_KEY is set as repository secret (not environment secret)
Verify the draft was created successfully before upload
Check that signing keys are properly configured
Signature Mismatch
Ensure TAURI_SIGNING_PRIVATE_KEY matches the public key in config
Verify the same key pair is used across all builds
For v1 migrations, use "createUpdaterArtifacts": "v1Compatible"
Resources
CrabNebula Cloud Documentation
Tauri Updater Plugin
CrabNebula Cloud Release Action
