---
title: headless-bff-architecture
url: https://skills.sh/vtex/skills/headless-bff-architecture
---

# headless-bff-architecture

skills/vtex/skills/headless-bff-architecture
headless-bff-architecture
Installation
$ npx skills add https://github.com/vtex/skills --skill headless-bff-architecture
SKILL.md
...
Checkout-specific proxy logic and OrderForm management (use headless-checkout-proxy)
Search API integration details (use headless-intelligent-search)
Caching and TTL strategy (use headless-caching-strategy)
Decision rules
