---
title: fastapi
url: https://skills.sh/srbhr/resume-matcher/fastapi
---

# fastapi

skills/srbhr/resume-matcher/fastapi
fastapi
Installation
$ npx skills add https://github.com/srbhr/resume-matcher --skill fastapi
SKILL.md
FastAPI Skill
...
Use dependency injection - Depends() for database, auth, validation
Return proper status codes - 201 for create, 204 for delete, etc.
Never Do
Never use blocking calls in async routes - No time.sleep(), use asyncio.sleep()
