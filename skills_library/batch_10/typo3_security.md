...
url: https://skills.sh/dirnbauer/webconsulting-skills/typo3-security
---

# typo3-security

skills/dirnbauer/webconsulting-skills/typo3-security
typo3-security
Installation
...
MFA is built into TYPO3 v14. Users can configure in: User Settings > Account Security
...
Enable CSP through config/system/settings.php / Install Tool. Frontend toggles (names may evolve — verify in Core for your minor) commonly include: $GLOBALS['TYPO3_CONF_VARS']['SYS']['features']['security.frontend.enforceContentSecurityPolicy'] and security.frontend.reportContentSecurityPolicy. Backend CSP is enforced by default since v13 — there is no equivalent FE-style toggle for BE.
