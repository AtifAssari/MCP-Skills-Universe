---
title: cinema4d-mcp
url: https://skills.sh/vladmdgolam/agent-skills/cinema4d-mcp
---

# cinema4d-mcp

skills/vladmdgolam/agent-skills/cinema4d-mcp
cinema4d-mcp
Installation
...
get_scene_info - verify connection
execute_python_script with print("ok") - verify Python works
If both work, extraction is possible even when other tools are broken
Critical Rules
...
Health check — confirm get_scene_info returns scene name and doc.GetFps() returns 30.

Identify the cloner name from list_objects or get_scene_info. Assume it is "SphereCloner".
...
Convert to Three.js-compatible format — the JSON structure frames[frame][clone_index].position maps directly to BufferAttribute update per frame in an AnimationMixer-driven loop.
