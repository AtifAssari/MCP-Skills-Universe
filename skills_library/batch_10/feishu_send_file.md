---
title: feishu-send-file
url: https://skills.sh/rabbitmeaw/feishu-send-file/feishu-send-file
---

# feishu-send-file

skills/rabbitmeaw/feishu-send-file/feishu-send-file
feishu-send-file
Installation
$ npx skills add https://github.com/rabbitmeaw/feishu-send-file --skill feishu-send-file
SKILL.md
飞书文件/图片发送 Skill
快速开始
1. 配置文件
