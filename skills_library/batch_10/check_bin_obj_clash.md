...
url: https://skills.sh/dotnet/skills/check-bin-obj-clash
---

# check-bin-obj-clash

skills/dotnet/skills/check-bin-obj-clash
check-bin-obj-clash
Installation
...
Use different configurations - Build solutions with different Configuration values that result in different output paths
...
Use RemoveGlobalProperties metadata - On ProjectReference items, use RemoveGlobalProperties="PublishReadyToRun" to strip the property before building the referenced project
