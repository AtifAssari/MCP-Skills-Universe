---
title: dev-plan
url: https://skills.sh/andreaserradev-gbj/dev-workflow/dev-plan
---

# dev-plan

skills/andreaserradev-gbj/dev-workflow/dev-plan
dev-plan
Installation
...
Verify PRD structure — Run the CLI to confirm the PRD is parseable:
