---
title: jobgpt
url: https://skills.sh/sickn33/antigravity-awesome-skills/jobgpt
---

# jobgpt

skills/sickn33/antigravity-awesome-skills/jobgpt
jobgpt
Installation
...
Get an API key - Go to 6figr.com/account, scroll to MCP Integrations, and click Generate API Key. The key starts with mcp_.
Add the MCP server:
