...
url: https://skills.sh/bmad-code-org/bmad-method/bmad-technical-research
---

# bmad-technical-research

skills/bmad-code-org/bmad-method/bmad-technical-research
bmad-technical-research
Installation
$ npx skills add https://github.com/bmad-code-org/bmad-method --skill bmad-technical-research
SKILL.md
...
Set research_goals = [discovered goals from discussion]
Derive research_topic_slug from {{research_topic}}: lowercase, trim, replace whitespace with -, strip path separators (/, \), .., and any character that is not alphanumeric, -, or _. Collapse repeated - and strip leading/trailing -. If the result is empty, use untitled.
Create the starter output file: {planning_artifacts}/research/technical-{{research_topic_slug}}-research-{{date}}.md with exact copy of the ./research.template.md contents
