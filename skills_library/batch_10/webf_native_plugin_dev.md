...
url: https://skills.sh/openwebf/webf/webf-native-plugin-dev
---

# webf-native-plugin-dev

skills/openwebf/webf/webf-native-plugin-dev
webf-native-plugin-dev
Installation
...
Check that .module.d.ts file exists in the same directory
Verify the module interface is properly named (WebF{ModuleName})
Run webf module-codegen again
