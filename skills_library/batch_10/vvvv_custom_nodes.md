---
title: vvvv-custom-nodes
url: https://skills.sh/tebjan/vvvv-skills/vvvv-custom-nodes
---

# vvvv-custom-nodes

skills/tebjan/vvvv-skills/vvvv-custom-nodes
vvvv-custom-nodes
Installation
...
Rule of thumb
If the attribute has only default values, don't write the attribute.
If you only need ONE non-default property, write only that one (e.g. [Pin(Visibility = PinVisibility.Optional)]).
The presence of an attribute should always communicate "I'm overriding a default", never "I'm restating the default".
