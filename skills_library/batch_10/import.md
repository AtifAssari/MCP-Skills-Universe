---
title: import
url: https://skills.sh/subframeapp/subframe/import
---

# import

skills/subframeapp/subframe/import
import
Installation
...
Project ID — Call list_projects to get the list of projects. Each project includes a projectId, name, teamId, and teamName.
...
Auth token — Call generate_auth_token with the teamId from the user's selected project. Do not use a teamId from a different project.
...
Look for tailwind.config.* at the project root
Look for global CSS in src/styles/, src/, app/, styles/
Look for components in common directories: src/components/, components/, src/ui/, ui/, lib/components/
