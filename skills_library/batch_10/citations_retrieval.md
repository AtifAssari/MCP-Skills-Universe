---
title: citations-retrieval
url: https://skills.sh/lobbi-docs/claude/citations-retrieval
---

# citations-retrieval

skills/lobbi-docs/claude/citations-retrieval
citations-retrieval
Installation
$ npx skills add https://github.com/lobbi-docs/claude --skill citations-retrieval
SKILL.md
