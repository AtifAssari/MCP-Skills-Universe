---
title: artifactory-module-architecture
url: https://skills.sh/tencentblueking/bk-ci/artifactory-module-architecture
---

# artifactory-module-architecture

skills/tencentblueking/bk-ci/artifactory-module-architecture
artifactory-module-architecture
Installation
...
九、开发规范
9.1 新增存储后端
实现 ArchiveFileService 接口
创建对应的 *ArchiveFileServiceImpl 类
在配置中添加存储后端选择逻辑
实现文件上传、下载、删除等方法
9.2 文件操作示例
// 上传文件
