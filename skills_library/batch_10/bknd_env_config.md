---
title: bknd-env-config
url: https://skills.sh/cameronapak/bknd-skills/bknd-env-config
---

# bknd-env-config

skills/cameronapak/bknd-skills/bknd-env-config
bknd-env-config
Installation
...
.dev.vars - Development-specific overrides (Cloudflare style)
...
--db-url CLI argument
Config file connection.url
--memory flag (uses :memory:)
