...
url: https://skills.sh/bjoernbethge/mcp-b/smart-workflows
---

# smart-workflows

skills/bjoernbethge/mcp-b/smart-workflows
smart-workflows
Installation
...
Spatial	lindel, a5, spatial
Model	infera (ONNX), vss (HNSW)
Analytics	datasketches, bitfilters, jsonata
Realtime	radio, http_client, ducklake
MCP-B Protocol
