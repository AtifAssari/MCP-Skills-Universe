...
url: https://skills.sh/moizibnyousaf/ai-agent-skills/database-design
---

# database-design

skills/moizibnyousaf/ai-agent-skills/database-design
database-design
Installation
$ npx skills add https://github.com/moizibnyousaf/ai-agent-skills --skill database-design
SKILL.md
Database Design
