---
title: vitest-dev
url: https://skills.sh/bjornmelin/dev-skills/vitest-dev
---

# vitest-dev

skills/bjornmelin/dev-skills/vitest-dev
vitest-dev
Installation
...
half when watch is enabled It also accepts a percentage string like "50%". (See: https://vitest.dev/config/maxworkers)
...
Spies (vi.spyOn) for verifying interactions
Module mocks (vi.mock) only when necessary
Mock reset policy
