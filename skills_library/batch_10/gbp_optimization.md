...
url: https://skills.sh/garrettjsmith/localseoskills/gbp-optimization
---

# gbp-optimization

skills/garrettjsmith/localseoskills/gbp-optimization
gbp-optimization
Installation
$ npx skills add https://github.com/garrettjsmith/localseoskills --skill gbp-optimization
SKILL.md
...
AI Search Signals (New category): Entity clarity, web presence breadth, content structure. See ai-local-search for strategy
