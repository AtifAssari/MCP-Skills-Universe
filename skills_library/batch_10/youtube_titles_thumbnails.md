...
url: https://skills.sh/chongdashu/cc-skills/youtube-titles-thumbnails
---

# youtube-titles-thumbnails

skills/chongdashu/cc-skills/youtube-titles-thumbnails
youtube-titles-thumbnails
Installation
$ npx skills add https://github.com/chongdashu/cc-skills --skill youtube-titles-thumbnails
SKILL.md
YouTube Titles & Thumbnails
...
Core Principles
Complementarity over Redundancy: Title and thumbnail should reinforce each other, not repeat the same information
Neutrality Builds Trust: Neutral language ("The Real Reason...") outperforms hype ("YOU WON'T BELIEVE...")
Specificity Beats Generic: "3 Python Tricks for Async" > "Python Tips"
Strategic Curiosity Gap: Promise value without revealing the answer
Conceptual Alignment: Thumbnail and title must tell the same story
...
Thumbnail: "Google" Title: "Why Google Killed Their Best Developer Tool"

Why it works: Thumbnail shows who, title reveals what/why

Pattern 5: Thumbnail = Emotion, Title = Specificity

Thumbnail: "The Hidden Problem" Title: "What 10,000 Hours of Coding Taught Me About Abstractions"
...
Specificity test: Can you make it more specific?

"APIs" → "REST APIs" → "REST API Versioning"

Curiosity test: Does it create a gap?

"How Redux Works" → "Why Redux Works Differently Than You Think"

Value test: Is the outcome clear?

"JavaScript Patterns" → "3 JavaScript Patterns That Prevent Bugs"

Audience test: Does it speak to a specific person?
...
Ask first — Use AskUserQuestion to gather context before generating
Tailor output — Apply answers to select appropriate patterns
Explain choices — Help users understand why recommendations fit their needs
