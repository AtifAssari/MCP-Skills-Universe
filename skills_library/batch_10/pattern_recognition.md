...
url: https://skills.sh/xbklairith/kisune/pattern-recognition
---

# pattern-recognition

skills/xbklairith/kisune/pattern-recognition
pattern-recognition
Installation
$ npx skills add https://github.com/xbklairith/kisune --skill pattern-recognition
SKILL.md
