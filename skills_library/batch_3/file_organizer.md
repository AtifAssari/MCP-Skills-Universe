...
url: https://skills.sh/sickn33/antigravity-awesome-skills/file-organizer
---

# file-organizer

skills/sickn33/antigravity-awesome-skills/file-organizer
file-organizer
Installation
...
Proposes context-aware folder structures based on file types, purpose, and date ranges, then executes moves and renames with full logging
Provides maintenance tips and custom commands to help keep directories organized long-term after initial cleanup
SKILL.md
File Organizer
