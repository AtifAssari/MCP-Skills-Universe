...
url: https://skills.sh/everyinc/compound-engineering-plugin/agent-native-architecture
---

# agent-native-architecture

skills/everyinc/compound-engineering-plugin/agent-native-architecture
agent-native-architecture
Installation
