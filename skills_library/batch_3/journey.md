---
title: journey
url: https://skills.sh/journeykits/skill/journey
---

# journey

skills/journeykits/skill/journey
journey
Installation
$ npx skills add https://github.com/journeykits/skill --skill journey
SKILL.md
...
Workflow
Search — GET .../api/kits/search?q=... and pick a result (kitRef is owner/slug).
Inspect — optional GET .../api/kits/<owner>/<slug> before installing.
Install — GET .../api/kits/<owner>/<slug>/install?target=<target>&ref=latest.
Process the install response in order:
