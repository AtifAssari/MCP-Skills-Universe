---
title: web-search
url: https://skills.sh/claude-office-skills/skills/web-search
---

# web-search

skills/claude-office-skills/skills/web-search
web-search
Installation
...
Start with the end in mind - know what type of answer you need
Use quotes for exact phrases
Combine operators for precision
Try multiple query variations
Check source dates - information expires
Cross-reference findings across sources
Use specialized engines for specific content types
Limitations
