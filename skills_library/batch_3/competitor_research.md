...
url: https://skills.sh/kostja94/marketing-skills/competitor-research
---

# competitor-research

skills/kostja94/marketing-skills/competitor-research
competitor-research
Installation
...
Obtain URLs: From user, project-context Section 11, or web search for "[target keyword]" to find top-ranking pages
...
Enrich — Web search, visit competitor sites; read project-context.md if present
