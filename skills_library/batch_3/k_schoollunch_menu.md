---
title: k-schoollunch-menu
url: https://skills.sh/nomadamas/k-skill/k-schoollunch-menu
---
...
교육청 — 자연어 허용 (예: 서울특별시교육청, 서울, 경기도교육청).
학교명 — 자연어 (예: 미래초등학교, ○○중학교).
급식일 — YYYYMMDD 또는 사용자가 말한 날짜를 한국 시간 기준으로 YYYYMMDD로 정한다. 생략 시 오늘(한국 시간).
