---
title: aceternity-ui
url: https://skills.sh/secondsky/claude-skills/aceternity-ui
---

# aceternity-ui

skills/secondsky/claude-skills/aceternity-ui
aceternity-ui
Installation
...
Add utility function to lib/utils.ts:
...
Incorrect shadcn CLI initialization
Missing cn utility function
Missing "use client" directive
Incorrect registry configuration
Wrong Next.js configuration (Pages Router vs App Router)
