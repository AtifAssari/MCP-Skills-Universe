...
url: https://skills.sh/jamesrochabrun/skills/trading-plan-generator
---

# trading-plan-generator

skills/jamesrochabrun/skills/trading-plan-generator
trading-plan-generator
Installation
$ npx skills add https://github.com/jamesrochabrun/skills --skill trading-plan-generator
Summary

Comprehensive trading plan framework with risk management, position sizing, entry/exit rules, and performance tracking.

Covers five trading styles (day, swing, position, options, investing) with specific rules and best practices for each
Includes mandatory risk management components: 1% rule, 2R minimum reward-to-risk, position sizing formulas, and daily loss limits to prevent account blowup
Provides detailed entry and exit strategies using technical patterns, support/resistance, ATR-based stops, and trailing stop methods
Features trading psychology guidelines including pre-market routines, tilt recognition, emotional state checks, and discipline enforcement
Includes trade journal templates, performance metrics (win rate, profit factor, expectancy, Sharpe ratio), and daily/weekly/monthly review schedules
SKILL.md
Trading Plan Generator
