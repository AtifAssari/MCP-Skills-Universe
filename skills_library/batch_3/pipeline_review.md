...
url: https://skills.sh/anthropics/knowledge-work-plugins/pipeline-review
---

# pipeline-review

skills/anthropics/knowledge-work-plugins/pipeline-review
pipeline-review
Installation
...
Tips
Review weekly — Pipeline health decays fast. Weekly reviews catch issues early.
Kill dead deals — Stale opportunities inflate your pipeline and distort forecasts. Be ruthless.
Multi-thread everything — If one person goes dark, you need a backup contact.
Close dates should mean something — A close date is when you expect signature, not when you hope for one.
Weekly Installs
825
Repository
