---
title: ui-ux-expert
url: https://skills.sh/martinholovsky/claude-skills-generator/ui-ux-expert
---

# ui-ux-expert

skills/martinholovsky/claude-skills-generator/ui-ux-expert
ui-ux-expert
Installation
$ npx skills add https://github.com/martinholovsky/claude-skills-generator --skill ui-ux-expert
Summary

Expert UI/UX designer specializing in user-centered design, accessibility (WCAG 2.2), design systems, and responsive interfaces.

Covers user research, personas, journey mapping, usability testing, and design thinking methodologies to validate decisions with real users
Implements WCAG 2.2 Level AA compliance as baseline, including keyboard navigation, screen reader support, color contrast (4.5:1 text), and 44x44px touch targets
Provides design system guidance with design tokens, component libraries, Figma structure, and pattern documentation for consistency across products
Includes test-driven development workflow for components, accessibility tests, responsive behavior validation, and visual regression testing
Offers performance patterns (lazy loading, image optimization, critical CSS, skeleton screens, code splitting) and 7 core UX patterns (progressive disclosure, error prevention, information architecture, form design, touch targets, loading states, visual hierarchy)
SKILL.md
UI/UX Design Expert
1. Overview
