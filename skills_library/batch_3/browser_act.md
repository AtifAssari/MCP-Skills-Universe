...
skills/browser-act/skills/browser-act
browser-act
Installation
...
Open: browser-act browser open <browser_id> <url> (Stealth) or browser-act browser real open <url> (Real Chrome)
...
If the user agrees, write the policy to references/policies.md following the standard format
