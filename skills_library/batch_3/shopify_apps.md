---
title: shopify-apps
url: https://skills.sh/sickn33/antigravity-awesome-skills/shopify-apps
---

# shopify-apps

skills/sickn33/antigravity-awesome-skills/shopify-apps
shopify-apps
Installation
...
Highlights critical sharp edges: GDPR handler implementation, App Bridge script tag usage, protected customer data access, and URL format compatibility
SKILL.md
Shopify Apps
...
Under "Protected customer data access"
Request access for needed data types
Justify your use case
Wait for Shopify approval (can take days)
