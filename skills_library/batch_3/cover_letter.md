---
title: cover-letter
url: https://skills.sh/claude-office-skills/skills/cover-letter
---

# cover-letter

skills/claude-office-skills/skills/cover-letter
cover-letter
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill cover-letter
SKILL.md
Cover Letter
Overview
...
How to Use
Share the job posting or describe the role
Tell me about your relevant experience
Mention any specific points you want to highlight
I'll create a tailored cover letter
...
Repeating your resume - Add new insights, not summaries
Being too generic - Customize for each application
Focusing on what you want - Focus on what you offer
Too long - Keep to one page, 3-4 paragraphs
Typos and errors - Proofread multiple times
Wrong company name - Double-check before sending
Salary discussion - Save for interview
Negative language - Stay positive throughout
Output Format
## Cover Letter
