...
url: https://skills.sh/jezweb/claude-skills/react-native-expo
---

# react-native-expo

skills/jezweb/claude-skills/react-native-expo
react-native-expo
Installation
...
Upgrade to 0.76-0.81 / SDK 54 first (if on 0.75 or earlier)
Test with New Architecture enabled
Fix incompatible dependencies (Redux, i18n, CodePush, Reanimated v3 → v4)
Then upgrade to 0.82+ / SDK 55+
...
Install react-native-worklets (required for v4)
Follow official Reanimated v3 → v4 migration guide
Skip babel.config.js changes if using babel-preset-expo (auto-configured)
...
Check references/new-architecture-errors.md for build errors
Check references/react-19-migration.md for React 19 issues
Check official docs: https://reactnative.dev/docs/new-architecture-intro
