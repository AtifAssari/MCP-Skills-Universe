---
title: web-access-claude-skill
url: https://skills.sh/aradotso/trending-skills/web-access-claude-skill
---

# web-access-claude-skill

skills/aradotso/trending-skills/web-access-claude-skill
web-access-claude-skill
Installation
...
Open chrome://inspect/#remote-debugging in your Chrome
...
/clickAt the visible upload button first
Wait 500ms
Then /setFiles
