---
title: planning-with-files-ar
url: https://skills.sh/othmanadi/planning-with-files/planning-with-files-ar
---
...
إذا كان task_plan.md موجودًا، اقرأ فورًا task_plan.md و progress.md و findings.md.
ثم تحقق مما إذا كانت الجلسة السابقة تحتوي على سياق غير متزامن:
# Linux/macOS
...
نفذ git diff --stat لرؤية تغييرات الكود الفعلية
اقرأ ملفات التخطيط الحالية
...
أنشئ task_plan.md — راجع قالب templates/task_plan.md
أنشئ findings.md — راجع قالب templates/findings.md
أنشئ progress.md — راجع قالب templates/progress.md
أعد قراءة الخطة قبل القرارات — حدّث الأهداف في نافذة الانتباه
