---
title: opencli-rs-web-scraper
url: https://skills.sh/aradotso/trending-skills/opencli-rs-web-scraper
---
...
opencli-rs-web-scraper
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill opencli-rs-web-scraper
SKILL.md
...
Download opencli-rs-chrome-extension.zip from GitHub Releases
Extract to any directory
Open chrome://extensions → enable Developer mode → Load unpacked → select the extracted folder
