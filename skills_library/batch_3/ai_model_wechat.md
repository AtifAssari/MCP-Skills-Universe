---
title: ai-model-wechat
url: https://skills.sh/tencentcloudbase/skills/ai-model-wechat
---

# ai-model-wechat

skills/tencentcloudbase/skills/ai-model-wechat
ai-model-wechat
Installation
...
Use callbacks for UI updates - onText is great for real-time display
Check for [DONE] - When using eventStream, check event.data === "[DONE]" to stop
Handle errors gracefully - Wrap AI calls in try/catch
Remember the data wrapper - streamText params must be wrapped in data: {...}
Weekly Installs
800
Repository
