---
title: runpodctl
url: https://skills.sh/runpod/skills/runpodctl
---

# runpodctl

skills/runpod/skills/runpodctl
runpodctl
Installation
...
List flags: --include-template, --include-workers Update flags: --name, --workers-min, --workers-max, --idle-timeout, --scaler-type (QUEUE_DELAY or REQUEST_COUNT), --scaler-value Create flags: --name, --template-id or --hub-id (one required), --gpu-id, --gpu-count, --compute-type, --workers-min, --workers-max, --network-volume-id, --data-center-ids, --env
...
List flags: --type (official, community, user), --limit, --offset, --all Create flags: --name, --image, --container-disk-in-gb, --volume-in-gb, --volume-mount-path, --ports, --env, --docker-start-cmd, --docker-entrypoint, --serverless, --readme
