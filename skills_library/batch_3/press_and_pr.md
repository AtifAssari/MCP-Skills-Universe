---
title: press-and-pr
url: https://skills.sh/eronred/aso-skills/press-and-pr
---

# press-and-pr

skills/eronred/aso-skills/press-and-pr
press-and-pr
Installation
...
Search the target publication for recent app reviews in your category
Note the byline — pitch that specific writer
Check their Twitter/X bio for DM preference
Use tools like Hunter.io for email guessing (format: first@publication.com)
Embargo Strategy
