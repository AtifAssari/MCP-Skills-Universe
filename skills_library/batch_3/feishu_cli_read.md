---
title: feishu-cli-read
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-read
---

# feishu-cli-read

skills/riba2534/feishu-cli/feishu-cli-read
feishu-cli-read
Installation
...
~/.feishu-cli/token.json（通过 auth login 保存）
config.yaml 中的 user_access_token
...
在飞书开放平台 → 你的应用 → 权限管理 → 开通 docx:document:readonly
执行 feishu-cli auth login
