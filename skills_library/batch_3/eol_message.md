---
title: eol-message
url: https://skills.sh/deanpeters/product-manager-skills/eol-message
---

# eol-message

skills/deanpeters/product-manager-skills/eol-message
eol-message
Installation
...
Includes anti-patterns section (terse shutdowns, vague timelines, defensive tone) and common pitfalls with fixes to avoid customer abandonment
Fill-in template format with positioning statement integration for clearly communicating replacement products and migration support
SKILL.md
Purpose
