---
title: ui-mobile
url: https://skills.sh/alinaqi/claude-bootstrap/ui-mobile
---

# ui-mobile

skills/alinaqi/claude-bootstrap/ui-mobile
ui-mobile
Installation
...
Includes production-ready component patterns for buttons, cards, text fields, lists, headers, and tab navigation with proper focus states and touch feedback
Provides semantic color system, 4pt spacing grid, typography scale, and native animation guidance using Animated API and React Native Reanimated
SKILL.md
