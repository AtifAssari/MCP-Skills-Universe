...
url: https://skills.sh/jezweb/claude-skills/wordpress-setup
---

# wordpress-setup

skills/jezweb/claude-skills/wordpress-setup
wordpress-setup
Installation
...
Navigate to https://example.com/wp-admin/profile.php (or use browser automation)
