---
title: style-guide
url: https://skills.sh/daleseo/korean-skills/style-guide
---

# style-guide

skills/daleseo/korean-skills/style-guide
style-guide
Installation
...
텍스트 읽기 - 사용자가 제공한 텍스트(파일, 인자, 또는 대화 컨텍스트)
스타일 분석 - 7가지 카테고리의 일관성 검사
불일치 식별 - 동일 문서 내 또는 프로젝트 내 스타일 충돌 발견
통일안 제시 - 문맥에 맞는 일관된 스타일 제안
교정 버전 제공 - 일관된 스타일로 재작성된 텍스트
...
어조 및 격식 (최고) - 경어체/반말 혼용, 주어 불일치
용어 통일 (높음) - 동일 개념의 다른 표현, 외래어 표기
숫자 및 단위 (중간) - 아라비아 vs 한글 숫자, 단위 띄어쓰기
목록 구조 (중간) - 목록 부호, 종결어미 일관성
인용 및 강조 (낮음) - 따옴표 스타일, 강조 표기
날짜 및 시간 (낮음) - 날짜/시간 형식
링크 및 참조 (낮음) - 링크 텍스트, 각주 형식
상세 패턴 설명
