---
title: korean-character-count
url: https://skills.sh/nomadamas/k-skill/korean-character-count
---

# korean-character-count

skills/nomadamas/k-skill/korean-character-count
korean-character-count
Installation
...
node scripts/korean_character_count.js 로 결정론적 카운트를 실행한다.
필요한 프로필(default/neis)과 출력 형식(json/text)을 고른다.
결과를 그대로 반환하고, 어떤 계약으로 셌는지 함께 알려준다.
CLI examples
