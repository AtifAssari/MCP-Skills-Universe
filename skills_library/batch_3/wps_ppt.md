---
title: wps-ppt
url: https://skills.sh/lc2panda/wps-skills/wps-ppt
---

# wps-ppt

skills/lc2panda/wps-skills/wps-ppt
wps-ppt
Installation
$ npx skills add https://github.com/lc2panda/wps-skills --skill wps-ppt
SKILL.md
WPS 演示智能助手
...
调用 wps_ppt_get_slide_info 获取当前页面上下文
分析页面元素和布局
调用 wps_ppt_beautify（参数：slide_index, color_scheme）
报告美化结果
场景2: 全文风格统一
...
调用 wps_ppt_get_open_presentations 获取演示文稿上下文
询问用户期望的风格（商务/科技/简约/创意）
调用 wps_ppt_beautify（参数：beautify_all: true, color_scheme）
报告统一结果
场景3: 添加新幻灯片
...
调用 wps_ppt_add_slide（参数：layout: "title_content", title: "项目进度"）
告知已添加，询问是否需要添加内容
场景4: 创建流程图
...
使用多个形状工具组合创建流程图（当前无专用MCP工具，需通过基础形状操作实现）
告知流程图已创建
可用MCP工具
