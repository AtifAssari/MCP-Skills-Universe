---
title: ppt-creator
url: https://skills.sh/daymade/claude-code-skills/ppt-creator
---

# ppt-creator

skills/daymade/claude-code-skills/ppt-creator
ppt-creator
Installation
...
Applies Pyramid Principle and assertion-evidence storytelling to structure content with one core conclusion supported by 3-5 reasons and evidence
...
Includes built-in chart selection guidance, accessibility compliance (WCAG AA), and self-scoring rubric that automatically refines decks below 75 points
Supports multiple input formats (topics, documents, CSV data) with safe defaults for missing context; optional chart generation via Python if data is provided
SKILL.md
PPT Creator
