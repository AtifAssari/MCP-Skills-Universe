---
title: form-builder
url: https://skills.sh/claude-office-skills/skills/form-builder
---

# form-builder

skills/claude-office-skills/skills/form-builder
form-builder
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill form-builder
SKILL.md
Form Builder Skill
Overview
