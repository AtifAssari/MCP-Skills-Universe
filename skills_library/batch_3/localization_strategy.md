...
url: https://skills.sh/kostja94/marketing-skills/localization-strategy
---
...
Add generateMetadata() with alternates (hreflang) per page.
Add JSON-LD with inLanguage and translated fields.
Add page to sitemap with hreflang annotations.
Set lang attribute on <html>; UTF-8 encoding.
New locale
Add locale code to config; create {code}.json dictionary.
Register in sitemap locale list; regenerate.
Add OpenGraph locale and alternateLocale.
