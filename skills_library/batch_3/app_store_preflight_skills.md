...
url: https://skills.sh/truongduy2611/app-store-preflight-skills/app-store-preflight-skills
---

# app-store-preflight-skills

skills/truongduy2611/app-store-preflight-skills/app-store-preflight-skills
app-store-preflight-skills
Installation
...
Prerequisites
asc CLI — Install via Homebrew: brew install asc (App-Store-Connect-CLI)
ASC CLI Skills — app-store-connect-cli-skills for asc usage patterns
