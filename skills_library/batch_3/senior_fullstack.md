...
url: https://skills.sh/davila7/claude-code-templates/senior-fullstack
---

# senior-fullstack

skills/davila7/claude-code-templates/senior-fullstack
senior-fullstack
Originally fromsickn33/antigravity-awesome-skills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill senior-fullstack
Summary

Fullstack development toolkit with scaffolding, code analysis, and architecture guidance for modern web applications.

Three core Python scripts automate project scaffolding, code quality analysis, and best practices implementation across React, Next.js, Node.js, GraphQL, and PostgreSQL stacks
Includes reference documentation covering tech stack patterns, architecture design, development workflows, security, performance, and scalability guidelines
Supports multiple languages (TypeScript, JavaScript, Python, Go, Swift, Kotlin) and deployment platforms (Docker, Kubernetes, AWS, GCP, Azure)
Built-in quality checks, performance metrics, and automated recommendations for code optimization and architectural decisions
SKILL.md
Senior Fullstack
