...
url: https://skills.sh/davila7/claude-code-templates/senior-prompt-engineer
---

# senior-prompt-engineer

skills/davila7/claude-code-templates/senior-prompt-engineer
senior-prompt-engineer
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill senior-prompt-engineer
Summary

Expert guidance on prompt optimization, LLM evaluation, and agentic system design for production AI applications.

Covers advanced prompt engineering patterns, few-shot learning, chain-of-thought techniques, and structured output design for Claude, GPT-4, and other LLMs
Includes RAG optimization frameworks, LLM evaluation methodologies, and performance tuning strategies with reference documentation
Provides agentic system design principles, multi-agent orchestration patterns, and deployment best practices for distributed inference
Supports MLOps workflows with integration guidance for LangChain, LlamaIndex, DSPy, and monitoring tools like MLflow and Weights & Biases
SKILL.md
Senior Prompt Engineer
