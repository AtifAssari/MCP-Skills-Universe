---
title: inngest-setup
url: https://skills.sh/inngest/inngest-skills/inngest-setup
---

# inngest-setup

skills/inngest/inngest-skills/inngest-setup
inngest-setup
Installation
...
Next Steps
Create your first Inngest function with inngest.createFunction()
Test functions using the dev server's "Invoke" button
Send events with inngest.send() to trigger functions
