...
url: https://skills.sh/bencium/bencium-claude-code-design-skill/bencium-innovative-ux-designer
---

# bencium-innovative-ux-designer

skills/bencium/bencium-claude-code-design-skill/bencium-innovative-ux-designer
bencium-innovative-ux-designer
Originally frombencium/bencium-marketplace
Installation
$ npx skills add https://github.com/bencium/bencium-claude-code-design-skill --skill bencium-innovative-ux-designer
Summary

Create distinctive, production-grade frontend interfaces that break from generic AI aesthetics.

Emphasizes design thinking protocol: ask about purpose, tone, constraints, and differentiation before committing to a bold aesthetic direction
Provides 11 tone options (brutally minimal, maximalist, retro-futuristic, organic, luxury, playful, editorial, brutalist, art deco, soft, industrial) with guidance on executing each with precision
Covers foundational design principles including color systems, typography excellence, layout discipline, interaction patterns, and accessibility standards (WCAG 2.1 AA)
Integrates with shadcn components, Tailwind CSS, Phosphor Icons, and sonner toasts; includes specific implementation patterns and responsive design strategies
Explicitly avoids overused patterns: Inter/Roboto fonts, generic SaaS blue, glass morphism, Apple mimicry; encourages shadows, gradients, textures, and distinctive typography as creative tools
SKILL.md
