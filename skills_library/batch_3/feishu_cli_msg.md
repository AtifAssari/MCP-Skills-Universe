---
title: feishu-cli-msg
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-msg
---

# feishu-cli-msg

skills/riba2534/feishu-cli/feishu-cli-msg
feishu-cli-msg
Installation
...
执行流程
发送消息流程
确定接收者：默认 user@example.com（email），或从上下文获取
选择消息类型：
用户明确指定类型 → 使用指定类型
