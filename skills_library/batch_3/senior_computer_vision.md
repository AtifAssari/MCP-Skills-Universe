...
url: https://skills.sh/davila7/claude-code-templates/senior-computer-vision
---

# senior-computer-vision

skills/davila7/claude-code-templates/senior-computer-vision
senior-computer-vision
Installation
...
Supports PyTorch, TensorFlow, YOLO, and vision transformers with containerization (Docker, Kubernetes) and cloud deployment (AWS/GCP/Azure)
Provides performance targets (P99 latency <200ms, >1000 req/s throughput) and security/compliance best practices including encryption, PII handling, and GDPR compliance
Emphasizes team leadership, code quality standards, and incident response for production systems at scale
SKILL.md
