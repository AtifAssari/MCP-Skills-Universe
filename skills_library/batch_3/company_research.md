...
url: https://skills.sh/claude-office-skills/skills/company-research
---

# company-research

skills/claude-office-skills/skills/company-research
company-research
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill company-research
SKILL.md
...
Threat of Substitutes: Alternative solutions, switching costs
Industry Rivalry: Number of competitors, market growth, differentiation
...
Specify the purpose of your research (investment, partnership, competitive intel)
Provide any known information to focus the analysis
Ask for specific frameworks if you prefer particular analysis methods
Request comparison with specific competitors
Indicate depth level needed (quick scan vs deep dive)
Limitations
