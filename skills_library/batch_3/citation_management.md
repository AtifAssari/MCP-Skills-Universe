...
url: https://skills.sh/davila7/claude-code-templates/citation-management
---

# citation-management

skills/davila7/claude-code-templates/citation-management
citation-management
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill citation-management
Summary

Search academic databases, extract metadata, validate citations, and generate properly formatted BibTeX entries.
...
Formats and cleans BibTeX entries with sorting, deduplication, and syntax validation for publication-ready bibliographies
SKILL.md
Citation Management
Overview
