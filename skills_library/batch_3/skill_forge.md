---
title: skill-forge
url: https://skills.sh/sanyuan0704/code-review-expert/skill-forge
---

# skill-forge

skills/sanyuan0704/code-review-expert/skill-forge
skill-forge
Originally fromsanyuan0704/sanyuan-skills
Installation
$ npx skills add https://github.com/sanyuan0704/code-review-expert --skill skill-forge
SKILL.md
Skill Forge
...
What operations are deterministic and repeatable? → scripts/
What domain knowledge does Claude need at specific steps? → references/
What files are used in output but not in reasoning? → assets/
