---
title: templates
url: https://skills.sh/railwayapp/railway-skills/templates
---

# templates

skills/railwayapp/railway-skills/templates
templates
Installation
...
Use public URL variables (e.g., ${{MongoDB.MONGO_PUBLIC_URL}})
Better: Route through a backend API
