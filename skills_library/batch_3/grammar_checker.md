...
url: https://skills.sh/daleseo/korean-skills/grammar-checker
---

# grammar-checker

skills/daleseo/korean-skills/grammar-checker
grammar-checker
Installation
...
Considers document context including formality level (formal vs. conversational), document type (business, blog, technical), and intentional stylistic choices
Provides educational explanations showing why errors occur and referencing standard Korean language rules, not just corrections
SKILL.md
...
마침표 누락
가운뎃점(·) 오남용 — 단순 열거(A·B·C)에 사용한 경우. 가운뎃점은 짝/공통성분 축약(금·은·동메달, 한·미 정상회담)에만 사용하고, 독립적 대안 나열(쿠키·세션·JWT)에는 쉼표를 권장. 상세 규정은 references/rules.md 6번 항목 참조
3단계: 참조 문서 로드 (필요 시)
