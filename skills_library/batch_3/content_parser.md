...
url: https://skills.sh/marswaveai/skills/content-parser
---

# content-parser

skills/marswaveai/skills/content-parser
content-parser
Installation
...
Submit (foreground): POST the creation request, extract taskId from the response.
Poll (background): Run the polling loop with run_in_background: true. You will be notified automatically when it completes.
