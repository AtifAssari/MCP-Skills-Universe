---
title: sensorkit
url: https://skills.sh/dpearson2699/swift-ios-skills/sensorkit
---

# sensorkit

skills/dpearson2699/swift-ios-skills/sensorkit
sensorkit
Installation
...
SensorKit entitlement -- Apple grants com.apple.developer.sensorkit.reader.allow only for approved studies.
Manual provisioning profile -- Xcode requires an explicit App ID with the SensorKit capability enabled.
