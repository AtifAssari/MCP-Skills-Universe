---
title: app-icon
url: https://skills.sh/code-with-beto/skills/app-icon
---

# app-icon

skills/code-with-beto/skills/app-icon
app-icon
Installation
...
Produces Android-optimized adaptive icons by scaling the main icon to 66% safe area and centering on transparent canvas to prevent clipping across device shapes
Configures both platforms in app.json with support for Android's Material You theming via monochromeImage field
Requires SnapAI CLI with OpenAI API key (~$0.04 per icon); handles key setup and validation before generation
SKILL.md
...
Create assets/app-icon.icon/icon.json with this basic configuration:
{
  "fill": "automatic",
  "groups": [
    {
