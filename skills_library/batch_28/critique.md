---
title: critique
url: https://skills.sh/nexu-io/open-design/critique
---

# critique

skills/nexu-io/open-design/critique
critique
Installation
$ npx skills add https://github.com/nexu-io/open-design --skill critique
SKILL.md
...
Header — what artifact was reviewed, date, reviewer ("OD · Critique skill"), 1-line verdict
Radar chart (inline SVG, no library) showing the 5 scores
...
Combined action lists at the bottom:
...
Project file — user said "review the index.html I just made": open it from the project folder.
Pasted HTML — user pasted code in the chat: read it from the message.
Generated by you in this turn — you just emitted an artifact above and want to self-critique: re-read your own <artifact>.
