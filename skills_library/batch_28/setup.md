---
title: setup
url: https://skills.sh/proficientlyjobs/proficiently-claude-skills/setup
---

# setup

skills/proficientlyjobs/proficiently-claude-skills/setup
setup
Installation
...
Download the ZIP and find Connections.csv inside
Upload or paste the path to that file here
