...
url: https://skills.sh/zixun-github/aisdlc/project-discover
---

# project-discover

skills/zixun-github/aisdlc/project-discover
project-discover
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill project-discover
SKILL.md
