---
title: xhs-login
url: https://skills.sh/site/skills.volces.com/xhs-login
---

# xhs-login

skills/skills.volces.com/xhs-login
xhs-login
$ npx skills add https://skills.volces.com/skills/clawhub/xmznini
SKILL.md
执行流程
1. 检查登录状态
...
调用 delete_cookies（⚠️ 需用户确认）— 清除当前登录状态
调用 get_login_qrcode — 获取新二维码
引导用户扫码
约束
