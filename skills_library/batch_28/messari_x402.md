---
title: messari-x402
url: https://skills.sh/moonpay/skills/messari-x402
---

# messari-x402

skills/moonpay/skills/messari-x402
messari-x402
Installation
$ npx skills add https://github.com/moonpay/skills --skill messari-x402
SKILL.md
Messari x402 API
Goal
...
Prerequisites
Wallet with USDC on Base: mp token balance list --wallet main --chain base
Small ETH on Base for gas
If no USDC: bridge from Ethereum or swap via mp token swap --chain base
Core command
mp x402 request \
  --method <GET|POST> \
