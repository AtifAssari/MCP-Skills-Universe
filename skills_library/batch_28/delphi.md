---
title: delphi
url: https://skills.sh/cygnusfear/agent-skills/delphi
---

# delphi

skills/cygnusfear/agent-skills/delphi
delphi
Installation
$ npx skills add https://github.com/cygnusfear/agent-skills --skill delphi
SKILL.md
...
Prior research tickets - Search for tickets tagged research,oracle using tk list --tag research
Full git history - Err toward too much history
Plan tickets - Search for tickets tagged plan using tk list --tag plan
docs/ - Relevant documentation
Raw symptoms - Logs and errors, not your interpretation
...
Core Question - The specific question needing investigation
Prior Research - Explicitly point to ALL prior research tickets (tagged research,oracle)
Full History - Instruct oracles to review the FULL relevant git history
Context - Essential factual context without guiding hypotheses
Success Criteria - What a good answer looks like
Export Instructions - Tell the oracle to export its full thinking
...
Note: Close the epic after synthesis is complete — it's documentation, not actionable work.
...
When complete, save your findings as a ticket and close it immediately (research is a record, not a TODO):



todos_oneshot( title: "Oracle {N}: ", description: "", tags: "research,oracle", type: "task" ) todos close
...
Save the synthesis as a ticket and close it immediately:



todos_oneshot( title: "Delphi synthesis: ", description: "", tags: "research,delphi-synthesis", type: "task" ) todos close
...
Offer to dive deeper into any specific oracle's findings
Example Invocation

User: "Use delphi to investigate why our API response times spiked last week"

Create epic ticket: "Delphi: API latency spike investigation" (tagged research,delphi)
Delegate 3 oracle workers in parallel with identical prompts about API latency investigation
Each oracle independently explores: logs, code changes, dependencies, infrastructure
Each saves findings as a ticket tagged research,oracle
Synthesis worker reads all oracle tickets and creates synthesis ticket tagged research,delphi-synthesis
