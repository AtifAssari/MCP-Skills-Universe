...
url: https://skills.sh/chadboyda/agent-gtm-skills/multi-platform-launch
---

# multi-platform-launch

skills/chadboyda/agent-gtm-skills/multi-platform-launch
multi-platform-launch
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill multi-platform-launch
SKILL.md
...
Product type - SaaS, dev tool, AI tool, marketplace, mobile app, physical product
Target buyer - developers, SMB owners, enterprise, creators, consumers
Current assets - existing audience size, email list, social following, community
Launch goal - signups, revenue, press, backlinks, community building, fundraising signal
Timeline - how many weeks until desired launch date
Budget - $0 bootstrap, <$500 indie, <$5K startup, $5K+ funded
Team size - solo founder, 2-3 person team, full team with marketing
...
Distinctive - clearly different from existing solutions
User-Friendly - polished, easy to try
Complete - feels like a finished product, not a landing page
...
Credit bundles - Include monthly credit refresh, not unlimited usage
BYOK (Bring Your Own Key) - Let users connect their own API keys
Usage tiers - Cap usage per plan tier with clear limits
Annual refresh - Structure as "lifetime access with annual credit renewal"
...
Screenshot-worthy UI - Design moments users want to share (results screens, dashboards)
Built-in sharing triggers - "Share your results" buttons, public profile pages
Template the format - Create a repeatable content format users can fill in
Badge/certification outputs - Generate shareable badges users display in bios/websites
Before/after framing - Show transformation that creates "how did you do that?" reactions
...
What does your product do, and who is the primary buyer?
Do you have an existing audience (email list, social following, community)?
What is your launch timeline - when do you want to go live?
What is your budget for launch activities?
Is this a first launch or a relaunch with significant updates?
Do you have a working product or is this pre-MVP waitlist building?
Are you targeting developers, business users, or consumers?
Do you want to prioritize signups, revenue, press coverage, or all three?
Have you launched on Product Hunt or Hacker News before?
Do you have 20+ people who would support your launch on Day 0?
Related Skills
