---
title: tunnel-doctor
url: https://skills.sh/daymade/claude-code-skills/tunnel-doctor
---

# tunnel-doctor

skills/daymade/claude-code-skills/tunnel-doctor
tunnel-doctor
Installation
...
Add domain to proxy app bypass list (skip-proxy for Shadowrocket).
Add domain to shell bypass list (NO_PROXY/no_proxy).
