---
title: ai-seo
url: https://skills.sh/chadboyda/agent-gtm-skills/ai-seo
---

# ai-seo

skills/chadboyda/agent-gtm-skills/ai-seo
ai-seo
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill ai-seo
SKILL.md
AI SEO Skill
...
Before Starting
Confirm the user's current SEO stack (CMS, analytics, keyword tools, content tools)
Identify their primary goal: programmatic pages at scale, competitor alternative play, AI Overviews visibility, or full-stack AI SEO
Ask about their domain authority range (DR/DA) - this changes which strategies are viable
Understand their content production capacity (solo founder vs. team vs. agency)
Check if they have Google Search Console access and DataForSEO/Semrush API credentials
Identify their top 3-5 competitors for alternative page targeting
Determine their CMS (Webflow, WordPress, Shopify, Next.js, custom) - this dictates the programmatic approach
...
DataForSEO MCP: find top 50 keywords for [competitor] with volume > 500
...
Set Google Alerts for acquisitions in your category
Within 48 hours: draft "[Acquired Tool] alternatives" page
Within 2 weeks: publish full comparison + migration guide
Target the 3-6 month window of peak search volume
...
500-1,000+ words of helpful content - not filler
Conditional content logic - if/then rules tailoring recommendations per data variant
Unique data points - proprietary metrics, ratings, comparisons per page
Rich elements - HTML tables, charts, embedded tools
Internal linking mesh - 3-5 related programmatic page links each
Schema markup - FAQ, Product, or Review schema per page type
...
Answer-first format - Direct answer in first 1-2 sentences, then supporting detail
Self-contained sections - Each H2/H3 independently understandable. Never "as mentioned above"
Question-pattern headings - "What is [X]?", "How does [X] work?", "Best [X] for [Y]"
Scannable formatting - Bullets, numbered lists, tables over dense paragraphs
Entity optimization - Name specific tools, companies, people. Generic gets skipped
Statistical backing - "Improved 3.2x" beats "improved significantly"
Freshness signals - Dates, "Updated [Month] [Year]", reference recent events
...
Pull GSC data via MCP: top growing + declining pages
Declining pages: check for AI Overview appearance, update freshness, re-optimize scores, add missing entities
Growing pages: create related programmatic pages, build internal links, add FAQ schema
"Not cited" in AI Overviews: restructure to answer-first, add extractable sections, include specific data
Unindexed pages: check for thin content (< 500 words unique), verify no cannibalization, resubmit via IndexNow
Quick Reference
Launch Checklist
...
Questions to Ask
"What's your current domain rating? This determines whether we start with low-competition BOFU keywords or need to build authority first."
"Which 5 competitors do your customers most often compare you against? These become alternative page targets."
"Do you have a structured data source (product database, company list, feature matrix) for programmatic pages?"
"What CMS are you on? Webflow and WordPress have the strongest programmatic SEO support."
"Are you tracking AI Overview appearances for your keywords?"
"What is your monthly content production capacity?"
"Do you have DataForSEO or Semrush API access?"
"Is your content structured for AI extraction - self-contained sections, answer-first format, specific data?"
Related Skills
