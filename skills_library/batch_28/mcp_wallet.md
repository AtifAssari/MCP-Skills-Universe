---
title: mcp-wallet
url: https://skills.sh/casualsecurityinc/xno-skills/mcp-wallet
---

# mcp-wallet

skills/casualsecurityinc/xno-skills/mcp-wallet
mcp-wallet
Installation
...
Representative - Required for opening new accounts. Well-known representatives:
...
Set useLocalPow: false in config_set.
Provide a workUrl (defaults to rpcUrl).
