---
title: spec-merge-back
url: https://skills.sh/zixun-github/aisdlc/spec-merge-back
---

# spec-merge-back

skills/zixun-github/aisdlc/spec-merge-back
spec-merge-back
Installation
...
{FEATURE_DIR}/merge_back.md 是本次 merge-back 的需求级 SSOT：每条都必须写清楚：
