---
title: nano-validate-address
url: https://skills.sh/casualsecurityinc/xno-skills/nano-validate-address
---

# nano-validate-address

skills/casualsecurityinc/xno-skills/nano-validate-address
nano-validate-address
Installation
$ npx skills add https://github.com/casualsecurityinc/xno-skills --skill nano-validate-address
SKILL.md
...
Take the 32-byte public key
Compute Blake2b hash (5 bytes)
Reverse the bytes
Encode in Base32
...
Validation Steps
Check prefix - Must be nano_ or xrb_
Check length - Total 65 chars (nano_) or 64 chars (xrb_)
Check characters - Valid Base32 alphabet only
Verify checksum - Blake2b hash matches last 8 chars
Offline Validation
