---
title: create-skill
url: https://skills.sh/antinomyhq/forge/create-skill
---

# create-skill

skills/antinomyhq/forge/create-skill
create-skill
Installation
$ npx skills add https://github.com/antinomyhq/forge --skill create-skill
SKILL.md
Skill Creator
...
A scripts/rotate_pdf.sh script would be helpful to store in the skill
