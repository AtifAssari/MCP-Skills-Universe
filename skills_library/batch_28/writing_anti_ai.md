...
url: https://skills.sh/galaxy-dawn/claude-scholar/writing-anti-ai
---

# writing-anti-ai

skills/galaxy-dawn/claude-scholar/writing-anti-ai
writing-anti-ai
Installation
...
Workflow (工作流程)
For English Text:
Identify patterns - Scan for AI patterns listed above
Rewrite sections - Replace AI-isms with natural alternatives
Preserve meaning - Keep core message intact
Maintain voice - Match intended tone (formal, casual, technical)
Add soul - Inject personality and opinions
For Chinese Text (中文文本):
识别 AI 模式 - 扫描上述列出的模式
重写问题片段 - 用自然替代方案替换
保留含义 - 保持核心信息完整
维持语调 - 匹配预期的语气（正式、随意、技术）
注入灵魂 - 添加个性和观点
Quick Scoring (快速评分)
...
Based on Wikipedia: Signs of AI writing, maintained by WikiProject AI Cleanup. Merges content from humanizer, humanizer-zh, and stop-slop skills.
