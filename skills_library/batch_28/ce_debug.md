---
title: ce-debug
url: https://skills.sh/everyinc/compound-engineering-plugin/ce-debug
---

# ce-debug

skills/everyinc/compound-engineering-plugin/ce-debug
ce-debug
Installation
...
Rethink the design (/ce-brainstorm) — only when the root cause reveals a design problem (see below)
...
Commit and open a PR (/ce-commit-push-pr) — default for most cases
Commit the fix (/ce-commit) — local commit only
