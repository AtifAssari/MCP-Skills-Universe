---
title: dotnet-xml-docs
url: https://skills.sh/wshaddix/dotnet-skills/dotnet-xml-docs
---

# dotnet-xml-docs

skills/wshaddix/dotnet-skills/dotnet-xml-docs
dotnet-xml-docs
Installation
$ npx skills add https://github.com/wshaddix/dotnet-skills --skill dotnet-xml-docs
SKILL.md
dotnet-xml-docs
...
Every public type must have a <summary> -- this is the minimum for IntelliSense to display useful information
Every public method parameter must have a <param> -- describe what the parameter controls, valid ranges, and null behavior
Every method that can throw must document exceptions with <exception> -- callers need to know what to catch
Return values must have <returns> -- describe the return value semantics, especially for nullable returns
Properties should have <value> -- describe what the property represents and its default value
Generic type parameters must have <typeparam> -- describe constraints and expected usage
Complex APIs should include <example> -- show real usage, not trivial one-liners
Use <remarks> for caveats and threading behavior -- important context that does not belong in the summary
Writing Style
