...
url: https://skills.sh/cortexreach/memory-lancedb-pro-skill/memory-lancedb-pro
---

# memory-lancedb-pro

skills/cortexreach/memory-lancedb-pro-skill/memory-lancedb-pro
memory-lancedb-pro
Installation
...
Open the markdown file(s) containing memories
For each memory entry, create a JSON object with text, category, importance
Save as a JSON file following the schema above
Run openclaw memory-pro import
...
Vector pre-filter: Similarity ≥ 0.7 finds candidates
LLM decision: CREATE | MERGE | SKIP | SUPPORT | CONTEXTUALIZE | CONTRADICT
Embedding Providers
