...
url: https://skills.sh/galaxy-dawn/claude-scholar/obsidian-project-memory
---

# obsidian-project-memory

skills/galaxy-dawn/claude-scholar/obsidian-project-memory
obsidian-project-memory
Installation
...
Default workflow
1. Detect and bind
Run scripts/project_kb.py detect --cwd "$PWD".
If the repo is already bound, continue with the existing project.
If the repo is not yet bound but is a strong research-project candidate, bootstrap it with project_kb.py bootstrap.
