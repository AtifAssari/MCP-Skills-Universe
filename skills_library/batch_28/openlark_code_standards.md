---
title: openlark-code-standards
url: https://skills.sh/foxzool/open-lark/openlark-code-standards
---

# openlark-code-standards

skills/foxzool/open-lark/openlark-code-standards
openlark-code-standards
Installation
...
建议行动项（按优先级排序）
推荐执行顺序
先读 AGENTS.md 与目标 crate 的 AGENTS.md/CLAUDE.md
再扫规则高频证据：api_endpoints、execute_with_options、validate_required、prelude、mod.rs
最后输出规则-证据对与整改建议
重点提醒
结论必须基于代码证据，不做“纯经验判断”
