---
title: huashu-image-upload
url: https://skills.sh/alchaincyf/huashu-skills/huashu-image-upload
---

# huashu-image-upload

skills/alchaincyf/huashu-skills/huashu-image-upload
huashu-image-upload
Installation
$ npx skills add https://github.com/alchaincyf/huashu-skills --skill huashu-image-upload
SKILL.md
图片配图与上传
...
A: 会。所以必须调用upload_image.py上传到ImgBB，获取永久链接。
