...
url: https://skills.sh/youstudyeveryday/academic-citation-manager/academic-citation-manager
---

# academic-citation-manager

skills/youstudyeveryday/academic-citation-manager/academic-citation-manager
academic-citation-manager
Installation
$ npx skills add https://github.com/youstudyeveryday/academic-citation-manager --skill academic-citation-manager
SKILL.md
...
Use ISBN (applicable only to books)
Search using title and author information
Manually enter complete reference information
Extract metadata from PDF or other sources
...
Validate volume, issue, and page number formats
Confirm DOI or URL display
Check display of special characters and non-Latin characters
更新日志 | Changelog
