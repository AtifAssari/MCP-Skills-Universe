...
url: https://skills.sh/zh-xx/legal-assistant-skills/ad-compliance-review
---

# ad-compliance-review

skills/zh-xx/legal-assistant-skills/ad-compliance-review
ad-compliance-review
Installation
$ npx skills add https://github.com/zh-xx/legal-assistant-skills --skill ad-compliance-review
SKILL.md
广告合规审核
...
审核原则
有疑从严： 对模糊表述倾向于标记风险，而非放行
分层输出： 高风险问题必须突出标注，低风险问题可合并说明
给出替代方案： 每个问题尽量提供可操作的修改建议
区分事实判断与法律判断： 无法仅凭广告文本判断的事项（如资质文件是否齐全），标注为"建议核实"而非直接判定违规
许可证
