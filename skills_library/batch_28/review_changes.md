...
url: https://skills.sh/cygnusfear/agent-skills/review-changes
---

# review-changes

skills/cygnusfear/agent-skills/review-changes
review-changes
Installation
$ npx skills add https://github.com/cygnusfear/agent-skills --skill review-changes
SKILL.md
Review Git Changes
Instructions
...
Fix logic bug in auth.ts:125 - Security issue
Add error handling in client.ts:67 - Stability issue
Remove temporary file temp-processor.ts - Plan violation
Should Fix
