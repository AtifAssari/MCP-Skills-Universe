...
url: https://skills.sh/galaxy-dawn/claude-scholar/obsidian-research-log
---

# obsidian-research-log

skills/galaxy-dawn/claude-scholar/obsidian-research-log
obsidian-research-log
Installation
$ npx skills add https://github.com/galaxy-dawn/claude-scholar --skill obsidian-research-log
SKILL.md
Obsidian Research Log
