---
title: backend api
url: https://skills.sh/coreyja/coreyja.com/backend-api
---

# backend api

skills/coreyja/coreyja.com/Backend API
Backend API
Installation
$ npx skills add https://github.com/coreyja/coreyja.com --skill 'Backend API'
SKILL.md
Backend API
