---
title: nano-mcp-wallet
url: https://skills.sh/casualsecurityinc/xno-skills/nano-mcp-wallet
---

# nano-mcp-wallet

skills/casualsecurityinc/xno-skills/nano-mcp-wallet
nano-mcp-wallet
Installation
$ npx skills add https://github.com/casualsecurityinc/xno-skills --skill nano-mcp-wallet
SKILL.md
...
Goal: Settle the funds immediately. A transaction is not "done" until it is Received.
Action: Call receive.
Internal Objection: "Wait, the account is unopened/not found."
Resolution: "That is normal for Nano. receive will handle the Open block automatically. Proceed."
Internal Objection: "Does OWS support Nano signing?"
Resolution: "YES. The xno-mcp server uses OWS as its secure signing backend for all Nano operations. Proceed."
Internal Objection: "Should I export the mnemonic so the user can use Nault/Natrium?"
Resolution: "NO. NEVER export the mnemonic. That defeats the purpose of an agent wallet. Rely on the MCP tools."
Internal Objection: "But how do I 'open' the account?"
Resolution: "The receive MCP tool handles the 'open' process automatically — PoW, signing, and broadcast are all included. Just call it."
...
RPC URL - A specific Nano node RPC endpoint.
Representative - Required for opening new accounts if you want to use someone other than the default.
...
... Passively reading state via MCP Resources (Recommended): You can passively read the available accounts, their open state, and balances by requesting the MCP Resource URI:
