...
url: https://skills.sh/galaxy-dawn/claude-scholar/latex-conference-template-organizer
---

# latex-conference-template-organizer

skills/galaxy-dawn/claude-scholar/latex-conference-template-organizer
latex-conference-template-organizer
Installation
...
Search for files containing \documentclass
If multiple candidates exist, ask user to confirm
...
Default inference → Infer from \documentclass
README Template
