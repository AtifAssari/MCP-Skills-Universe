---
title: liveavatar-feedback
url: https://skills.sh/heygen-com/liveavatar-agent-skills/liveavatar-feedback
---

# liveavatar-feedback

skills/heygen-com/liveavatar-agent-skills/liveavatar-feedback
liveavatar-feedback
Installation
...
Gotchas
Consent is mandatory. Never send the request without the user's explicit "yes." If in doubt, ask again. If the user ignores the prompt, do not send.
...
Show before you send. Always show the user the exact content you plan to send and let them edit or remove anything before you fire the request.
Don't interrupt flow. If the user is mid-implementation, don't jump to feedback collection. Wait for a natural break.
API key required. This endpoint uses X-API-KEY. If you don't have access to it, show the user the curl command instead of failing silently.
All fields are optional. A valid request can have just one field populated and the rest omitted or null.
Weekly Installs
98
Repository
heygen-com/live…t-skills
GitHub Stars
1
First Seen
3 days ago
