...
url: https://skills.sh/kent-daniel/regexfast/cloudflare-workers
---

# cloudflare-workers

skills/kent-daniel/regexfast/cloudflare-workers
cloudflare-workers
Installation
$ npx skills add https://github.com/kent-daniel/regexfast --skill cloudflare-workers
SKILL.md
...
Creation: Lazy - created on first access via getByName() or get()
Execution: Single-threaded, strongly consistent within the object
Hibernation: Evicted from memory when idle, but storage persists
Wake-up: Re-initialized when accessed again (constructor runs)
...
References
Storage API: See references/storage-api.md for SQL, KV, and transaction methods
WebSocket API: See references/websocket-api.md for hibernation patterns
Best Practices: See references/best-practices.md for production patterns
Deployment Checklist
✅ Set appropriate compatibility_date in wrangler config
✅ Define migrations for all Durable Object classes
✅ Use SQLite storage (new_sqlite_classes) for new projects
✅ Handle constructor re-initialization for hibernation
✅ Implement error handling in WebSocket handlers
✅ Test locally with wrangler dev before deploying
✅ Monitor with wrangler tail for logs
Weekly Installs
9
Repository
