---
title: react-to-axure
url: https://skills.sh/lintendo/axhub-skills/react-to-axure
---

# react-to-axure

skills/lintendo/axhub-skills/react-to-axure
react-to-axure
Installation
$ npx skills add https://github.com/lintendo/axhub-skills --skill react-to-axure
SKILL.md
React 导出到 Axure
概述
...
运行时封装：使用 forwardRef + useImperativeHandle 包装的组件代码
何时使用
...
Props 接口：组件当前接收哪些 props？
内部状态：有哪些 useState / useReducer 状态需要暴露？
交互行为：有哪些用户交互事件（click、change、submit 等）？
外部依赖：组件依赖哪些第三方库？
DOM 操作：是否直接操作 DOM（如图表库、地图库）？
