---
title: ce-demo-reel
url: https://skills.sh/everyinc/compound-engineering-plugin/ce-demo-reel
---

# ce-demo-reel

skills/everyinc/compound-engineering-plugin/ce-demo-reel
ce-demo-reel
Installation
...
Involves motion or interaction? (animations, typing flows, drag-and-drop, real-time updates, continuous CLI output) -> classify as motion.
Involves discrete states? (before/after UI, new page, command with output, API response) -> classify as states.
