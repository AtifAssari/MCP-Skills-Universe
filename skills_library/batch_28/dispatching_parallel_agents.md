...
url: https://skills.sh/zixun-github/aisdlc/dispatching-parallel-agents
---

# dispatching-parallel-agents

skills/zixun-github/aisdlc/dispatching-parallel-agents
dispatching-parallel-agents
Installation
$ npx skills add https://github.com/zixun-github/aisdlc --skill dispatching-parallel-agents
SKILL.md
派发并行智能体
概述
