...
url: https://skills.sh/galaxy-dawn/claude-scholar/planning-with-files
---

# planning-with-files

skills/galaxy-dawn/claude-scholar/planning-with-files
planning-with-files
Installation
$ npx skills add https://github.com/galaxy-dawn/claude-scholar --skill planning-with-files
SKILL.md
Planning with Files
