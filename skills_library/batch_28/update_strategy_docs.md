---
title: update-strategy-docs
url: https://skills.sh/unarmedpuppy/polyjuiced/update-strategy-docs
---
...
update-strategy-docs
Installation
$ npx skills add https://github.com/unarmedpuppy/polyjuiced --skill update-strategy-docs
SKILL.md
