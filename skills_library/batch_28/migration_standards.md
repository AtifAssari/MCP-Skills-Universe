...
url: https://skills.sh/maxritter/claude-codepro/migration-standards
---

# migration standards

skills/maxritter/claude-codepro/Migration Standards
Migration Standards
Installation
...
Run migration up: rake db:migrate or equivalent
Verify schema changes: Check database structure
Run migration down: rake db:rollback or equivalent
Verify rollback worked: Check schema restored
Run migration up again: Ensure it's repeatable
