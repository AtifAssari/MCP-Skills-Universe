...
url: https://skills.sh/chadboyda/agent-gtm-skills/partner-affiliate
---

# partner-affiliate

skills/chadboyda/agent-gtm-skills/partner-affiliate
partner-affiliate
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill partner-affiliate
SKILL.md
...
Partner must register deals within 14 days of first customer contact
Registration expires after 120 days if no signed contract. Partner can re-register once.
First valid registration wins. Timestamp in the PRM system is authoritative.
Direct sales team checks deal registration before engaging any account
Disputes escalated to partner manager within 48 hours, resolved within 5 business days

Account Protection Rules:

Solution partners (Tier 3) receive quarterly protected account lists (max 50 accounts)
...
Questions to Ask
What percentage of your current pipeline comes from word-of-mouth or informal referrals? This is your organic partner signal.
Which tools do your customers use alongside your product daily? These are your top integration partner candidates.
Have any customers or users already referred others without a formal program? Recruit them first.
What does your competitive partner landscape look like? Do competitors offer partner programs, and what commissions do they pay?
Do you have API documentation and a sandbox environment ready for integration partners?
What is your average customer lifetime value? This determines how much commission you can afford.
How does your sales team currently handle leads that come from referrals or partners? Is there a process, or is it ad hoc?
What is your current gross margin? Commission structures must preserve healthy unit economics after model costs.
Do you have the bandwidth for a dedicated partner manager, or will this be founder-led initially?
Are there existing agency or consultant relationships that could convert to formal partnerships?
What co-marketing assets exist today? Case studies, webinars, blog posts that could support partner campaigns?
How are you currently tracking referral attribution? CRM field, UTM parameters, manual tracking, or nothing?
Related Skills
