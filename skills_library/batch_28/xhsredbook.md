---
title: xhsredbook
url: https://skills.sh/site/skills.volces.com/xhsredbook
---

# xhsredbook

skills/skills.volces.com/xiaohongshu-publisher
xiaohongshu-publisher
$ npx skills add https://skills.volces.com/skills/clawhub/harveyzzzz
SKILL.md
小红书自动发布技能
...
点击下拉箭头 → 选择"上传图文"
通过 accept 属性定位图片 file input（区分视频/图片）
逐张上传图片（每张间隔3秒）
等待编辑器出现（轮询+滚动，最多30秒）
填写正文（逐字输入）
填写标题
