---
title: law-to-markdown
url: https://skills.sh/zh-xx/legal-assistant-skills/law-to-markdown
---

# law-to-markdown

skills/zh-xx/legal-assistant-skills/law-to-markdown
law-to-markdown
Installation
$ npx skills add https://github.com/zh-xx/legal-assistant-skills --skill law-to-markdown
SKILL.md
Law To Markdown
处理规则
输入为 .txt：直接转存为 .md。
