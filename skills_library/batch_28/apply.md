---
title: apply
url: https://skills.sh/proficientlyjobs/proficiently-claude-skills/apply
---

# apply

skills/proficientlyjobs/proficiently-claude-skills/apply
apply
Installation
$ npx skills add https://github.com/proficientlyjobs/proficiently-claude-skills --skill apply
SKILL.md
Apply Skill
...
Save to DATA_DIR/application-data.md using this format:
# Application Data
...
Application data — match from application-data.md per the Field Matching Reference below
Reasonable defaults — for common fields not in application data:
...
Custom Answers — check the "Custom Answers" section of application-data.md for previously cached answers
Best guess — for any remaining fields, generate a reasonable answer based on the field label and job context
...
File upload handling: MCP tools can only upload images via upload_image. For PDF/DOCX resume and cover letter uploads, tell the user the file path and ask them to upload manually. This is a known limitation — include the path in the Step 6 summary so the user can upload while reviewing.
