...
url: https://skills.sh/dexhorthy/slopfiles/html-presentations
---

# html-presentations

skills/dexhorthy/slopfiles/html-presentations
html-presentations
Installation
...
Read the spec markdown file (e.g., spec.md)
...
Write output to index.html in the same directory as the spec, offer to open it using Bash for the user
