...
url: https://skills.sh/quick-brown-foxxx/coding_rules_python/writing-python-code
---

# writing-python-code

skills/quick-brown-foxxx/coding_rules_python/writing-python-code
writing-python-code
Installation
...
Async Rules
Never call subprocess.run(), time.sleep(), or synchronous HTTP in async context
Never use shell=True in subprocess calls
Always use asyncio.create_subprocess_exec() for subprocesses
Always use async with for resource management (HTTP clients, file handles)
Never mix sync and async in the same call chain
Always handle TimeoutError for operations that may hang
Code Style
Rule	Value
Line length	120
