---
title: claude-permissions-optimizer
url: https://skills.sh/everyinc/compound-engineering-plugin/claude-permissions-optimizer
---

# claude-permissions-optimizer

skills/everyinc/compound-engineering-plugin/claude-permissions-optimizer
claude-permissions-optimizer
Installation
...
Apply all to user settings (~/.claude/settings.json)
Apply all to project settings (.claude/settings.json)
Skip
...
Read the current file (create { "permissions": { "allow": [] } } if it doesn't exist)
Append new patterns to permissions.allow, avoiding duplicates
Sort the allow array alphabetically
