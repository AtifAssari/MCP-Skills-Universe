---
title: humanizalo
url: https://skills.sh/hainrixz/humanizalo/humanizalo
---

# humanizalo

skills/hainrixz/humanizalo/humanizalo
humanizalo
Installation
...
Scan for all 40 patterns listed below
Rewrite: remove every AI tell you find
Inject personality using the Soul guidelines
Score the draft on 6 dimensions
Run the audit loop until the score passes or you hit 3 iterations
Deliver the final version with score and change summary
...
How to add voice
Have opinions. React to facts. "That number is wild" beats "The results were notable."
Vary rhythm. A three-word sentence. Then a longer one that meanders a bit before landing. Mix it up.
Acknowledge complexity. Show mixed feelings. "I'm torn on this" is more honest than pretending certainty.
Use "I" when appropriate. First person signals honesty. Avoiding it signals committee-written prose.
Let some mess in. A tangent, a half-formed thought, a parenthetical aside. Humans are messy writers.
Be specific about feelings. Not "concerning" but "something about this keeps bugging me."
Put the reader in the room. "You" beats "people" or "one." Address them directly.
Trust readers. State facts. Skip the justification, the softening, the hand-holding. They get it.
Cut anything quotable. If a sentence sounds like it belongs on a motivational poster or a LinkedIn post, rewrite it. Real writing doesn't try to be memorable.
Example
