---
title: buy
url: https://skills.sh/must-be-ash/x402-skills/buy
---

# buy

skills/must-be-ash/x402-skills/buy
buy
Installation
$ npx skills add https://github.com/must-be-ash/x402-skills --skill buy
SKILL.md
x402 Buy Skill
...
Setup Checklist
Create wallet - Run echo "1" | npx add-wallet evm (non-interactive)
Note the address - Check .env for WALLET_ADDRESS
Fund wallet - Send USDC on Base mainnet (or npx add-wallet topup testnet)
Check endpoint - curl -i <url> to see:
x402 version (v1 or v2)
Price (amount field)
Network (mainnet or testnet)
If 405, try curl -i -X POST <url>
Extract schema - Decode PAYMENT-REQUIRED header to find method, body format, required fields
Install correct packages - v1: x402-fetch, v2: @x402/fetch @x402/evm
Use correct code pattern - v1: createSigner(), v2: registerExactEvmScheme()
Build request - Use method/body from schema, SDK handles 402 → payment → retry
Troubleshooting
...
Check the network field in the 402 response matches your setup
Protocol References
