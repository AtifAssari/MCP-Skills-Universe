...
url: https://skills.sh/anagrambuild/breeze-agent-kit/breeze-x402-payment-api
---

# breeze-x402-payment-api

skills/anagrambuild/breeze-agent-kit/breeze-x402-payment-api
breeze-x402-payment-api
Installation
$ npx skills add https://github.com/anagrambuild/breeze-agent-kit --skill breeze-x402-payment-api
SKILL.md
Breeze x402 Payment API
...
x402 (this skill)	https://x402.breeze.baby	/balance/:fund_user/deposit/withdraw/healthz (free)	USDC micropayment via x402 protocol
Direct REST API	https://api.breeze.baby	/deposit/tx/withdraw/tx/strategy-info/:id	x-api-key header
