---
title: deep-research
url: https://skills.sh/daymade/claude-code-skills/deep-research
---

# deep-research

skills/daymade/claude-code-skills/deep-research
deep-research
Installation
...
Every source line includes Source-Type and As Of
...
SWOT analysis — each entry with evidence + source + impact assessment
Competitive barrier quantification — 7 dimensions with weighted scoring → A+/A/B+/B/C+/C rating
Risk matrix — 8 mandatory categories, probability × impact → Red/Yellow/Green
Comprehensive scorecard — 6-dimension weighted total → X/10
...
Registry Process
Read every task file's ## Sources section
...
Are stale sources used for time-sensitive claims?
Find ≥3 issues (re-examine if 0 found)
...
Registry cross-check: List every [n] in report vs approved registry
Spot-check 5+ claims: Trace to task notes
Remove/fix non-traceable claims
Validate no dropped source resurrected
Check source concentration for key claims
