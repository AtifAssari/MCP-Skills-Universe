---
title: web-reader
url: https://skills.sh/hainrixz/claude-webkit/web-reader
---

# web-reader

skills/hainrixz/claude-webkit/web-reader
web-reader
Installation
$ npx skills add https://github.com/hainrixz/claude-webkit --skill web-reader
SKILL.md
Web Reader Skill
