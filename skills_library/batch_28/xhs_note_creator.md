...
url: https://skills.sh/site/skills.volces.com/xhs-note-creator
---

# xhs-note-creator

skills/skills.volces.com/xhs-note-creator
xhs-note-creator
$ npx skills add https://skills.volces.com/skills/clawhub/linkrogers
SKILL.md
小红书笔记创作技能
...
技能目录 (md2Redbook/) 仅存放脚本和模板，不存放用户数据
图片尺寸会根据内容自动调整，但保持 3:4 比例
Cookie 有有效期限制，过期后需要重新获取
发布功能依赖 xhs 库，需要安装：pip install xhs
Weekly Installs
10
Source
skills.volces.c…nkrogers
First Seen
Mar 23, 2026