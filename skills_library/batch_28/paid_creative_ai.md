---
title: paid-creative-ai
url: https://skills.sh/chadboyda/agent-gtm-skills/paid-creative-ai
---

# paid-creative-ai

skills/chadboyda/agent-gtm-skills/paid-creative-ai
paid-creative-ai
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill paid-creative-ai
SKILL.md
Paid Creative AI
...
Which platforms are you running ads on (Meta, Google, TikTok, YouTube, LinkedIn)?
What is your monthly ad spend budget?
What is your primary KPI (ROAS, CPA, CPL, brand awareness)?
Do you have existing creative assets or are you starting from scratch?
Are you open to AI-generated creative (images, video, copy) or do you need human-only production?
What does your current creative testing process look like?
...
Produce hero creative for your primary platform
Re-edit hook for each secondary platform (first 3 seconds differ most)
Adjust aspect ratio and swap music/sounds per platform norms
Update CTA text and add platform-specific captions
Test repurposed creative independently (do not assume cross-platform performance)
