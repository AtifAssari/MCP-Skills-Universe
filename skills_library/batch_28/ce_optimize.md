---
title: ce-optimize
url: https://skills.sh/everyinc/compound-engineering-plugin/ce-optimize
---

# ce-optimize

skills/everyinc/compound-engineering-plugin/ce-optimize
ce-optimize
Installation
...
Create the experiment log file at .context/compound-engineering/ce-optimize/<spec-name>/experiment-log.yaml
...
Write strategy digest to .context/compound-engineering/ce-optimize/<spec-name>/strategy-digest.md:
...
Run /ce-code-review on the cumulative diff (baseline to final). Load the ce-code-review skill with mode:autofix on the optimization branch.
Run /ce-compound to document the winning strategy as an institutional learning.
