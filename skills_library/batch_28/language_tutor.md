...
url: https://skills.sh/tatat/agents-playground/language-tutor
---

# language-tutor

skills/tatat/agents-playground/language-tutor
language-tutor
Installation
$ npx skills add https://github.com/tatat/agents-playground --skill language-tutor
SKILL.md
Language Tutor
