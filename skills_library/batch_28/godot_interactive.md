---
title: godot-interactive
url: https://skills.sh/alexmeckes/godot-claude-skills/godot-interactive
---

# godot-interactive

skills/alexmeckes/godot-claude-skills/godot-interactive
godot-interactive
Installation
...
Core Workflow
Build a QA inventory before changing anything.
...
Confirm the active project and current scene state.
...
Refresh or save based on how the change was made.
...
Update the QA inventory if exploration reveals new states, controls, failure modes, or visible claims.
Sign off only from explicit evidence, and note any remaining manual verification gaps.
Fast Probe Presets
...
Edit with the appropriate godot_* file tool.
Validate the changed file.
If Godot is open, call godot_editor_refresh_filesystem.
Open or rerun the scene in the editor to verify behavior.
