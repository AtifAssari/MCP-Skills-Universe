---
title: simple-deck
url: https://skills.sh/nexu-io/open-design/simple-deck
---

# simple-deck

skills/nexu-io/open-design/simple-deck
simple-deck
Installation
...
Workflow
Step 0 — Pre-flight
Read assets/template.html end-to-end through the <style> block AND the <script> block. The script solves five iframe-specific bugs (real scroller detection, dual capture-phase listeners, auto-focus, no scrollIntoView, position persistence) — do not rewrite it.
Read references/layouts.md so you know the 8 layouts. Pay special attention to the "Theme rhythm" section — it's the rule that prevents the deck from feeling sleepy.
