---
title: animejs
url: https://skills.sh/delexw/claude-code-misc/animejs
---

# animejs

skills/delexw/claude-code-misc/animejs
animejs
Installation
$ npx skills add https://github.com/delexw/claude-code-misc --skill animejs
SKILL.md
...
No default anime object — use named imports
direction is gone — use alternate: true and reversed: true
Easing names dropped ease prefix — outQuad not easeOutQuad
Spring syntax changed — use createSpring({...}) not 'spring(1,80,10,0)'
SVG helpers moved — svg.createMotionPath() not anime.path()
