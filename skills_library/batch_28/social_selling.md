...
url: https://skills.sh/chadboyda/agent-gtm-skills/social-selling
---

# social-selling

skills/chadboyda/agent-gtm-skills/social-selling
social-selling
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill social-selling
SKILL.md
...
Platform focus - LinkedIn only, or multi-platform (LinkedIn + X + YouTube)?
Current state - Active LinkedIn profile? SSI score?
ICP clarity - Who are they selling to? (title, company size, industry)
Content cadence - Already posting? How often?
Tool stack - Sales Navigator, Taplio, Expandi, etc.?
Sales cycle - Average deal size and cycle length
Goal - Pipeline meetings, inbound leads, brand authority, or all three?
...
Hook (first 3 lines): State the problem your ICP faces. Be specific.
Bridge: How you solve it. Reference your method or framework.
Proof: 2-3 specific results with numbers.
CTA: "DM me [keyword]" or "Book 15 min here: [link]"
...
Three Core Signals
Initial engagement quality - First 60 minutes critical
Dwell time - Most important metric (how long people actually read)
Creator authenticity - Genuine expertise vs. engagement bait
What Hurts Reach
...
PDF carousels (highest engagement + dwell time)
LinkedIn Live (7x reactions vs. standard video)
Text-only with specifics (strong reach per effort ratio)
Standard video (good engagement, moderate reach)
Text with single image (underperforms text-only by 30%)
Posts with external links (60% reach penalty)
Quick Reference
...
Questions to Ask
What is your ICP? (Title, company size, industry, geography)
What is your current LinkedIn SSI score?
Do you have Sales Navigator? Which tier?
How many posts per week are you publishing?
Average deal size and sales cycle?
Solo or team to activate for advocacy?
Existing content to repurpose (blog, newsletter, podcast)?
What CRM for pipeline tracking?
Comfort level with DM outreach?
Budget for LinkedIn automation tools?
Related Skills
