---
title: beaver-xhs-images
url: https://skills.sh/beaverslab/beaver-skill/beaver-xhs-images
---

# beaver-xhs-images

skills/beaverslab/beaver-skill/beaver-xhs-images
beaver-xhs-images
Installation
$ npx skills add https://github.com/beaverslab/beaver-skill --skill beaver-xhs-images
SKILL.md
...
┌────────────────────────────────────────────────────┬───────────────────┐ │ Path │ Location │ ├────────────────────────────────────────────────────┼───────────────────┤ │ .beaver-skill/beaver-xhs-images/EXTEND.md │ Project directory │ ├────────────────────────────────────────────────────┼───────────────────┤ │ $HOME/.beaver-skill/beaver-xhs-images/EXTEND.md │ User home │ └────────────────────────────────────────────────────┴───────────────────┘
...
Read source content
Deep analysis following references/workflows/analysis-framework.md:
...
Generate image 1 (cover) FIRST — without --ref
...
Quick quality check after each generation:
