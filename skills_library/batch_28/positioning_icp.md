...
url: https://skills.sh/chadboyda/agent-gtm-skills/positioning-icp
---

# positioning-icp

skills/chadboyda/agent-gtm-skills/positioning-icp
positioning-icp
Installation
$ npx skills add https://github.com/chadboyda/agent-gtm-skills --skill positioning-icp
SKILL.md
...
Questions to Ask
Who are your 5 best customers by revenue retention, and what do they have in common?
What do prospects compare you to most often? Include non-software alternatives like "doing it manually."
What is the single biggest reason deals stall or get lost?
When a customer churns, what do they switch to?
What job title signs the contract, and what job title championed the deal internally?
Can you describe the last time your positioning or messaging was updated?
What is your current Sean Ellis score? If you do not know, how many active users do you have available to survey?
How are you currently scoring and prioritizing inbound leads?
What is your average deal cycle from first touch to signed contract?
Do you have documented proof vectors (case studies, metrics, testimonials) for your top 3 use cases?
What does your competitor monitoring process look like today?
How is your pricing structured, and when was it last changed?
What content or page on your site converts visitors to pipeline most effectively?
Do you have separate messaging for different buyer personas, or one message for all?
What trigger events (funding, hiring, tech changes) most often precede a new customer signing?
Related Skills
