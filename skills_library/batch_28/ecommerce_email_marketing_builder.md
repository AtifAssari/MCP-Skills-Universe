---
title: ecommerce-email-marketing-builder
url: https://skills.sh/nexscope-ai/ecommerce-skills/ecommerce-email-marketing-builder
---

# ecommerce-email-marketing-builder

skills/nexscope-ai/ecommerce-skills/ecommerce-email-marketing-builder
ecommerce-email-marketing-builder
Installation
$ npx skills add https://github.com/nexscope-ai/ecommerce-skills --skill ecommerce-email-marketing-builder
SKILL.md
...
Flow overview — purpose, expected revenue impact, priority level
...
Branching logic — conditions that split the flow (purchased vs didn't, opened vs didn't)
