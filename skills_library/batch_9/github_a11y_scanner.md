...
url: https://skills.sh/community-access/accessibility-agents/github-a11y-scanner
---

# github-a11y-scanner

skills/community-access/accessibility-agents/github-a11y-scanner
github-a11y-scanner
Installation
...
Match by rule ID: Both sources use axe-core rule IDs (e.g., color-contrast, image-alt)
Match by URL: Compare the scanned URL from the scanner issue with the local scan target
Match by element: Compare CSS selectors or HTML paths for the affected element
Boost confidence: Findings confirmed by both sources automatically receive high confidence
