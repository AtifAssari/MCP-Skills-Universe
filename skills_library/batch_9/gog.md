---
title: gog
url: https://skills.sh/naoterumaker/openclaw-gog-skills/gog
---

# gog

skills/naoterumaker/openclaw-gog-skills/gog
gog
Installation
...
Common options include JSON/TSV output, account selection, dry-run mode, and result limiting via --max
SKILL.md
...
-n, --dry-run	実行せずプレビュー
Tips
SpreadsheetId: URL https://docs.google.com/spreadsheets/d/<ID>/edit から取得
FileId: URL https://drive.google.com/file/d/<ID>/view から取得
CalendarId: primary でメインカレンダー、または共有カレンダーのメールアドレス
TasklistId: gog tasks lists list で確認
Weekly Installs
497
Repository
naoterumaker/op…g-skills
GitHub Stars
3
First Seen
Feb 18, 2026
