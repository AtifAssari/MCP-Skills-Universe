...
skills/github/awesome-copilot/create-implementation-plan
create-implementation-plan
Installation
...
Supports multiple plan types via naming convention (upgrade, refactor, feature, architecture, infrastructure, etc.) with status tracking and front matter metadata
SKILL.md
Create Implementation Plan
Primary Directive
