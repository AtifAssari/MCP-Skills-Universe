---
title: boost-prompt
url: https://skills.sh/github/awesome-copilot/boost-prompt
---

# boost-prompt

skills/github/awesome-copilot/boost-prompt
boost-prompt
Installation
...
Requires the Joyride extension for VSCode clipboard integration and human input requests
SKILL.md
