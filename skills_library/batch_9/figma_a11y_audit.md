...
url: https://skills.sh/weaaare/a11y-agents-kit/figma-a11y-audit
---

# figma-a11y-audit

skills/weaaare/a11y-agents-kit/figma-a11y-audit
figma-a11y-audit
Installation
...
figma-console MCP server configured in .vscode/mcp.json with a Figma Personal Access Token
Python 3 with openpyxl (pip3 install openpyxl) for Excel generation
