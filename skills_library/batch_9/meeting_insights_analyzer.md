...
url: https://skills.sh/davila7/claude-code-templates/meeting-insights-analyzer
---

# meeting-insights-analyzer

skills/davila7/claude-code-templates/meeting-insights-analyzer
meeting-insights-analyzer
Originally fromcomposiohq/awesome-claude-skills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill meeting-insights-analyzer
SKILL.md
Meeting Insights Analyzer
