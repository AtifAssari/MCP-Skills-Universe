---
title: background-agent-pings
url: https://skills.sh/parcadei/continuous-claude-v3/background-agent-pings
---

# background-agent-pings

skills/parcadei/continuous-claude-v3/background-agent-pings
background-agent-pings
Installation
