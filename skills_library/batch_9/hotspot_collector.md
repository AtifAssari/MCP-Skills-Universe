---
title: hotspot-collector
url: https://skills.sh/ma2ong/claude-skills-collection/hotspot-collector
---

# hotspot-collector

skills/ma2ong/claude-skills-collection/hotspot-collector
hotspot-collector
Installation
$ npx skills add https://github.com/ma2ong/claude-skills-collection --skill hotspot-collector
SKILL.md
热点采集员 SOP 手册
1. 角色定义
...
应用筛选标准，保留 Top 20-30。
生成 JSON 文件。
回复: "已完成采集，共获取 [N] 条高价值热点，保存于 [路径]。"
Weekly Installs
12
Repository
ma2ong/claude-s…llection
GitHub Stars
20
First Seen
Feb 21, 2026
