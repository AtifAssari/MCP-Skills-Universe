...
url: https://skills.sh/aaaaqwq/claude-code-skills/project-planner
---

# project-planner

skills/aaaaqwq/claude-code-skills/project-planner
project-planner
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill project-planner
SKILL.md
项目路径规划与执行助手
核心定位

这是一个专注于项目执行规划的技能，帮助你从想法到落地，系统性地规划项目路径，确保项目按时、高质量地交付。不同于产品需求分析（PRD），这个技能更关注如何做和如何做好。
...
项目 ├── 模块1 │ ├── 任务1.1 │ ├── 任务1.2 │ └── 任务1.3 ├── 模块2 │ ├── 任务2.1 │ └── 任务2.2 └── 模块3 ├── 任务3.1 └── 任务3.2
