...
url: https://skills.sh/s-hiraoku/synapse-a2a/anthropic-skill-creator
---

# anthropic-skill-creator

skills/s-hiraoku/synapse-a2a/anthropic-skill-creator
anthropic-skill-creator
Installation
$ npx skills add https://github.com/s-hiraoku/synapse-a2a --skill anthropic-skill-creator
SKILL.md
Create Skills
...
Design reusable resources (scripts/, references/, assets/).
Write actionable instructions and error handling.
