...
url: https://skills.sh/aaaaqwq/claude-code-skills/feishu-automation
---

# feishu-automation

skills/aaaaqwq/claude-code-skills/feishu-automation
feishu-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill feishu-automation
SKILL.md
飞书全通道自动化
...
生成本地 Markdown 文件
上传到飞书云盘 → drive/v1/files/upload_all
导入为云文档 → drive/v1/import_tasks
设置权限为组织内可编辑 → drive/v1/permissions/{token}/public
发送链接到目标群
# 完整流程脚本
TOKEN=$(curl -s -X POST 'https://open.feishu.cn/open-apis/auth/v3/tenant_access_token/internal' \
  -H 'Content-Type: application/json' \
