---
title: feishu-cli-drive
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-drive
---

# feishu-cli-drive

skills/riba2534/feishu-cli/feishu-cli-drive
feishu-cli-drive
Installation
...
drive 命令组提供与老 file / media / comment add 命令并存的增强能力： 分块上传、markdown 快捷导出、异步任务 resume、富文本评论、wiki 链接解析。
...
导出有界轮询：10 次 × 5 秒（总共 50 秒），超时不报错而是返回 next_command
