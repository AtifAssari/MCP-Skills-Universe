...
url: https://skills.sh/aaaaqwq/claude-code-skills/notion-automation
---

# notion-automation

skills/aaaaqwq/claude-code-skills/notion-automation
notion-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill notion-automation
SKILL.md
Notion 自动化管理
功能说明
...
数据库设置流程
创建数据库：创建新数据库
定义字段：配置属性类型（文本、数字、日期等）
设置视图：创建不同视图（表格、看板、日历）
添加记录：批量添加初始记录
配置筛选：设置常用筛选条件
设置模板：创建页面模板
内容更新流程
