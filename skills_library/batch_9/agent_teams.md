---
title: agent-teams
url: https://skills.sh/alinaqi/claude-bootstrap/agent-teams
---

# agent-teams

skills/alinaqi/claude-bootstrap/agent-teams
agent-teams
Installation
...
Read _project_specs/features/*.md to identify all features
Break each feature into the 10-task dependency chain (see below)
...
Send shutdown_request to all agents when all PRs are created
...
Read _project_specs/features/*.md
For each feature spec, spawn a feature agent:
...
Stages ONLY files changed for this feature (never git add -A)
Commits with descriptive message including verification results
git push -u origin feature/{feature-name}
gh pr create with full template including:
