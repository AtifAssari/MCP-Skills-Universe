---
title: ln-522-manual-tester
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-522-manual-tester
---

# ln-522-manual-tester

skills/levnikolaevich/claude-code-skills/ln-522-manual-tester
ln-522-manual-tester
Installation
...
When running test scripts expected to take >30 seconds: Monitor(command="bash tests/manual/{suite}/test-{slug}.sh 2>&1", timeout_ms=300000, description="manual test: {slug}")
