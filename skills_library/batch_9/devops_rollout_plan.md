...
skills/github/awesome-copilot/devops-rollout-plan
devops-rollout-plan
Installation
...
Provides rollback decision criteria, automated revert procedures, and post-rollback verification to minimize recovery time
Adapts plan scope and rigor based on infrastructure type (Kubernetes, VMs, serverless, databases), risk level, change type, and target environment
Includes communication templates with stakeholder matrices, contingency scenarios for partial failures and dependency issues, and contact escalation paths
SKILL.md
