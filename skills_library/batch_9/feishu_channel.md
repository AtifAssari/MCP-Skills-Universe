...
url: https://skills.sh/aaaaqwq/claude-code-skills/feishu-channel
---

# feishu-channel

skills/aaaaqwq/claude-code-skills/feishu-channel
feishu-channel
Installation
...
2. 配置事件订阅
在应用管理页面，进入「事件订阅」
配置请求地址：https://your-domain.com/webhook/feishu
订阅事件：
