---
title: major-version-mode
url: https://skills.sh/vercel/ai/major-version-mode
---

# major-version-mode

skills/vercel/ai/major-version-mode
major-version-mode
Installation
...
Deprecate in @ai-sdk/provider-utils rather than removing immediately, if feasible. Mark deprecated types/members with a @deprecated JSDoc comment and a TODO note to remove in the following major version.
Keep deprecated equivalents in packages/ai/src/prompt/content-part.ts — this file is the consumer-facing layer and should retain the old shapes in the Zod schemas so existing consumer code continues to compile with a deprecation warning. Include a similar note about deprecation and removal in the following major version.
If clean deprecation isn't feasible without meaningful technical debt, a hard removal may be preferred — but check with the user first.
