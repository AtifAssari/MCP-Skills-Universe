---
title: unity-vrc-world-sdk-3
url: https://skills.sh/niaka3dayo/agent-skills-vrc-udon/unity-vrc-world-sdk-3
---

# unity-vrc-world-sdk-3

skills/niaka3dayo/agent-skills-vrc-udon/unity-vrc-world-sdk-3
unity-vrc-world-sdk-3
Installation
...
Did you run "Setup Layers for VRChat"? (SDK > Builder tab)
...
Collider present? No → Add a Collider component.
Rigidbody present? No → Add a Rigidbody component.
VRC_Pickup component present? No → Add it.
