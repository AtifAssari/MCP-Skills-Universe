...
url: https://skills.sh/ahmedasmar/devops-claude-skills/monitoring-observability
---
...
Actionable - If you can't act on it, don't alert
Symptom-based - Alert on user experience, not components
SLO-tied - Connect to business impact
Low noise - Only page for critical issues
