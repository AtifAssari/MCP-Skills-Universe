...
url: https://skills.sh/joeseesun/qiaomu-mondo-poster-design/qiaomu-mondo-poster-design
---

# qiaomu-mondo-poster-design

skills/joeseesun/qiaomu-mondo-poster-design/qiaomu-mondo-poster-design
qiaomu-mondo-poster-design
Installation
$ npx skills add https://github.com/joeseesun/qiaomu-mondo-poster-design --skill qiaomu-mondo-poster-design
Summary
...
Features AI prompt enhancement, three-style side-by-side comparisons, and image-to-image transformation to convert existing designs into Mondo aesthetic
Built on screen-print fundamentals: limited color palettes (2–5 colors), negative space storytelling, symbolic silhouettes, and vintage typography from the 1960s–1980s
SKILL.md
...
Artistic Reinterpretation - Not literal film scenes, but conceptual visual distillations
Screen Print Aesthetics - Limited color palettes (2-5 colors), flat color blocks, halftone textures
Minimalist Symbolism - Key props, silhouettes, negative space over character faces
Bold Vintage Typography - Hand-drawn lettering, condensed sans-serifs, Art Deco influences
Retro Color Palettes - High saturation, vintage duotones, bold contrasts (orange/teal, red/cream, etc.)
Prompt Structure
...
For different Mondo artist styles, see references/artist-styles.md.
...
Workflow
Identify the subject - Film, book, album, band, event, or concept
Choose symbolic element - What single image captures the essence?
Select composition pattern - Minimalist symbolic OR layered atmospheric
Select color palette - 2-4 colors max, high contrast, vintage-inspired
Add texture keywords - Screen print, halftone, risograph effects
Set the era - Specify 60s/70s/80s for period-accurate aesthetics
...
references/genre-templates.md - Horror, Sci-Fi, Western, Noir, etc.
references/composition-patterns.md - Layout strategies and visual hierarchy
references/book-covers.md - Book cover design patterns and best practices
references/artist-styles.md - Tyler Stout, Olly Moss, Martin Ansin, etc.
...
"What's your subject?" (movie/book/album title)
"Which style feels right?" (show 3-4 options with previews)
"Any color preferences?" (or let AI suggest)
"Want to see comparisons?" (generate 3 versions)
...
Use this skill to generate the Mondo-style prompt
Pass the prompt to:
