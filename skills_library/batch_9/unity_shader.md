---
title: unity-shader
url: https://skills.sh/cortexa233/game-dev-toolkit-skills/unity-shader
---

# unity-shader

skills/cortexa233/game-dev-toolkit-skills/unity-shader
unity-shader
Installation
$ npx skills add https://github.com/cortexa233/game-dev-toolkit-skills --skill unity-shader
SKILL.md
Unity Shader
Goal
...
Workflow
Confirm render pipeline, Unity version, target platforms, and requested task type.
Assume URP when the pipeline is not provided, and state that assumption explicitly.
Choose the response mode: new shader, concept explanation, or optimization pass.
Read references/pipeline-rules.md for pipeline API conventions and coding constraints.
Read references/performance-and-response.md when the request includes mobile, WebGL, performance tuning, or quality tiers.
Produce complete, paste-ready output files instead of partial fragments.
Validate platform and pipeline compatibility before responding.
Response Contracts
