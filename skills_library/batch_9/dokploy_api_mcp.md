---
title: dokploy-api-mcp
url: https://skills.sh/sattva2020/skills/dokploy-api-mcp
---

# dokploy-api-mcp

skills/sattva2020/skills/dokploy-api-mcp
dokploy-api-mcp
Installation
...
Domain & SSL
Add domain via Dashboard or API (domain.create)
Point DNS A-record to VPS IP
Dokploy auto-provisions Let's Encrypt certificate via Traefik v3
HTTPS works automatically after DNS propagation
