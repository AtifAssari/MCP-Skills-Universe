---
title: outline-coach
url: https://skills.sh/jwynia/agent-skills/outline-coach
---

# outline-coach

skills/jwynia/agent-skills/outline-coach
outline-coach
Installation
$ npx skills add https://github.com/jwynia/agent-skills --skill outline-coach
SKILL.md
...
Pattern: {project}-outline-coaching-{date}.md Example: novel-outline-coaching-2025-01-15.md
