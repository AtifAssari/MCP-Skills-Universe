...
url: https://skills.sh/lixiaolin94/skills/web-shader-extractor
---

# web-shader-extractor

skills/lixiaolin94/skills/web-shader-extractor
web-shader-extractor
Installation
...
用 Agent 分析 JS bundle（1MB+ 不适合主上下文）。 → Agent prompt 模板和反混淆规则 references/extraction-workflow.md
