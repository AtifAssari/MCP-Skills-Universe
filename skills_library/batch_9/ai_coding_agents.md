...
url: https://skills.sh/xiaolai/vmark/ai-coding-agents
---

# ai-coding-agents

skills/xiaolai/vmark/ai-coding-agents
ai-coding-agents
Installation
...
Set spending limits with --max-budget-usd
Review diffs before applying (/diff, codex cloud diff)
