...
url: https://skills.sh/alinaqi/claude-bootstrap/session-management
---

# session-management

skills/alinaqi/claude-bootstrap/session-management
session-management
Installation
...
Create archive entry: archive/YYYY-MM-DD[-topic].md
Full checkpoint
...
Mark todo complete in active.md
Update current-state.md progress
...
Check if current-state.md exists and read it
Announce what it found: "Resuming from: [last state]"
