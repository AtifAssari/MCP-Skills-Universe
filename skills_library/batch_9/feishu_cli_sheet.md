---
title: feishu-cli-sheet
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-sheet
---

# feishu-cli-sheet

skills/riba2534/feishu-cli/feishu-cli-sheet
feishu-cli-sheet
Installation
...
最佳实践
简单数据用 V2 API：纯文本/数值使用 sheet read/write 更简单
富文本用 V3 API：需要 @用户、公式等时使用 sheet read-rich/write-rich
批量操作：V3 API 支持一次请求多个范围
使用 --simple 模式：insert 和 append-rich 支持 --simple 简化输入
范围格式：始终使用 SheetID!A1:B2 格式，避免歧义
单元格图片
