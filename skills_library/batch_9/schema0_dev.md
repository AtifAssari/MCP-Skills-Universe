---
title: schema0-dev
url: https://skills.sh/schema0/skills/schema0-dev
---

# schema0-dev

skills/schema0/skills/schema0-dev
schema0-dev
Installation
...
Understand -- Invoke Skill("schema0-cli") to learn sandbox commands. Then schema0 sandbox ls -L 2 to see structure. Read project instruction files (CLAUDE.md / AGENTS.md / GEMINI.md) via schema0 sandbox read. Check platforms (apps/web/, apps/mobile/).
Clarify -- Summarize understanding, ask one round of questions max if unclear, then proceed.
...
Deploy -- Commit changes, then schema0 sandbox deploy. For version management / preview / production, invoke Skill("schema0-cli") references as needed.
Summary -- Share the live URL, summarize what was built, key decisions, suggested next steps.
Skill Directory
Skill	Invoke when
