...
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/sql-server-2025
---

# sql-server-2025

skills/josiahsiegel/claude-plugin-marketplace/sql-server-2025
sql-server-2025
Installation
$ npx skills add https://github.com/josiahsiegel/claude-plugin-marketplace --skill sql-server-2025
SKILL.md
🚨 CRITICAL GUIDELINES
...
Implement Sensitivity Classification:
