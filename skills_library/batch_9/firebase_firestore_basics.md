...
url: https://skills.sh/firebase/skills/firebase-firestore-basics
---

# firebase-firestore-basics

skills/firebase/skills/firebase-firestore-basics
firebase-firestore-basics
Originally fromfirebase/agent-skills
Installation
$ npx skills add https://github.com/firebase/skills --skill firebase-firestore-basics
SKILL.md
Firestore Basics
