...
url: https://skills.sh/liangdabiao/claude-code-stock-deep-research-agent/citation-validator
---

# citation-validator

skills/liangdabiao/claude-code-stock-deep-research-agent/citation-validator
citation-validator
Installation
$ npx skills add https://github.com/liangdabiao/claude-code-stock-deep-research-agent --skill citation-validator
SKILL.md
Citation Validator
Role
