---
title: debugging-streamlit
url: https://skills.sh/streamlit/streamlit/debugging-streamlit
---

# debugging-streamlit

skills/streamlit/streamlit/debugging-streamlit
debugging-streamlit
Installation
...
Workflow
Create or use a test script in work-tmp/debug/ (e.g., work-tmp/debug/test_feature.py)
Run make debug work-tmp/debug/test_feature.py
Verify startup: Check work-tmp/debug/latest/backend.log for Error/Exception and work-tmp/debug/latest/frontend.log for console errors to ensure both servers started correctly
Access the printed App URL in your browser (default http://localhost:3001, but it may be 3002+)
Verify script execution: Check work-tmp/debug/latest/backend.log again for any errors after the first app access
Monitor logs by inspecting work-tmp/debug/latest/backend.log and work-tmp/debug/latest/frontend.log
Edit code - changes apply automatically via hot-reload
...
Related Skills
understanding-streamlit-architecture skill: For deeper understanding of backend/frontend internals when debugging cross-layer issues
Weekly Installs
270
Repository
streamlit/streamlit
