---
title: e-bookkeeping-compliance
url: https://skills.sh/kazukinagata/shinkoku/e-bookkeeping-compliance
---

# e-bookkeeping-compliance

skills/kazukinagata/shinkoku/e-bookkeeping-compliance
e-bookkeeping-compliance
Installation
$ npx skills add https://github.com/kazukinagata/shinkoku --skill e-bookkeeping-compliance
SKILL.md
優良な電子帳簿コンプライアンス診断
...
DB パス: --db-path に使用するデータベースファイルのパス
対象年度: --fiscal-year に使用する会計年度
届出書の提出状況: 「国税関係帳簿の電磁的記録等による保存等に係る届出書」を所轄税務署に提出済みか
...
G5: 任意の勘定科目で総勘定元帳を出力する（仕訳が存在する科目を使用）
