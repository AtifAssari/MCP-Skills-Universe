---
title: init
url: https://skills.sh/flora131/atomic/init
---

# init

skills/flora131/atomic/init
init
Installation
...
Detect installed language servers and prepare an installation plan:
...
Populate the template below with discovered values. Replace every {{placeholder}} with actual values from the repo. Delete sections that don't apply (e.g., Environment if there are no env files). Remove the "How to Fill This Template" meta-section entirely.

Write the populated content to both CLAUDE.md and AGENTS.md at the project root with identical content.
