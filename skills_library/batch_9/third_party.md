---
title: third-party
url: https://skills.sh/patternsdev/skills/third-party
---

# third-party

skills/patternsdev/skills/third-party
third-party
Installation
...
Replace or remove: If the value provided by the third-party script is not proportional to its performance cost, consider removing it. You can also evaluate other alternatives that are lightweight but provide similar functionality.
...
Source
patterns.dev/vanilla/third-party
Weekly Installs
261
Repository
patternsdev/skills
