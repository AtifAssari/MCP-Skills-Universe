---
title: git-2025-features
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/git-2025-features
---

# git-2025-features

skills/josiahsiegel/claude-plugin-marketplace/git-2025-features
git-2025-features
Installation
$ npx skills add https://github.com/josiahsiegel/claude-plugin-marketplace --skill git-2025-features
SKILL.md
