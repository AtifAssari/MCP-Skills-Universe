...
url: https://skills.sh/microsoft/vscode/memory-leak-audit
---

# memory-leak-audit

skills/microsoft/vscode/memory-leak-audit
memory-leak-audit
Installation
...
Running ensureNoDisposablesAreLeakedInTestSuite() in tests
Confirming object counts stabilize (don't grow linearly with usage)
Weekly Installs
754
Repository
microsoft/vscode
