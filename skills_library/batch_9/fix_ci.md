---
title: fix-ci
url: https://skills.sh/s-hiraoku/synapse-a2a/fix-ci
---

# fix-ci

skills/s-hiraoku/synapse-a2a/fix-ci
fix-ci
Installation
...
Stage only modified files (do NOT stage untracked files):

git add -u


Commit with a descriptive message indicating which categories were fixed:
...
Report a summary of what was fixed, including:
