...
url: https://skills.sh/aaaaqwq/claude-code-skills/github-automation
---

# github-automation

skills/aaaaqwq/claude-code-skills/github-automation
github-automation
Installation
...
为什么使用 GitHub MCP？
✅ 不需要 Personal Access Token - 使用已认证的 GitHub Copilot token
✅ 避免认证问题 - SSH key 未配置或 HTTPS token 过期时仍可工作
✅ 批量提交 - 一次提交多个文件
✅ 更可靠 - 直接通过 GitHub API，不受本地 git 配置影响
推送代码示例
