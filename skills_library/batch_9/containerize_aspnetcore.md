...
url: https://skills.sh/github/awesome-copilot/containerize-aspnetcore
---

# containerize-aspnetcore

skills/github/awesome-copilot/containerize-aspnetcore
containerize-aspnetcore
Installation
...
Determine the .NET version from the project's .csproj file by checking the TargetFramework element
Select the appropriate Linux container image based on:
...
Replace YourProject.csproj, YourProject.dll, etc. with your actual project names
Adjust the .NET version and Linux distribution as needed
