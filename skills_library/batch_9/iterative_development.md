...
url: https://skills.sh/alinaqi/claude-bootstrap/iterative-development
---

# iterative-development

skills/alinaqi/claude-bootstrap/iterative-development
iterative-development
Installation
...
Remove or rename the Stop hook in .claude/settings.json
Or set MAX_ITERATIONS=1 in the script
Or delete scripts/tdd-loop-check.sh
