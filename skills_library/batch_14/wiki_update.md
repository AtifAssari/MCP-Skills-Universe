---
title: wiki-update
url: https://skills.sh/kfchou/wiki-skills/wiki-update
---

# wiki-update

skills/kfchou/wiki-skills/wiki-update
wiki-update
Installation
$ npx skills add https://github.com/kfchou/wiki-skills --skill wiki-update
SKILL.md
Wiki Update
...
Current: <quote the existing text> Proposed: <replacement text> Reason: <why this change is warranted> Source: <URL, file path, or description of where this information comes from>
