---
title: openclaw-image-generator
url: https://skills.sh/pengjiyuan/openclaw-image-generator/openclaw-image-generator
---

# openclaw-image-generator

skills/pengjiyuan/openclaw-image-generator/openclaw-image-generator
openclaw-image-generator
Installation
...
Tiny Stable Diffusion generates background image
Pillow renders optional title/subtitle text with customizable styling
Output images can be used in any system (blogs, social media, presentations, documentation, etc.)
Trigger Conditions
...
Item summary (1 line describing the image concept)
Final prompt used for generation
Output path where image was saved
Configuration notes (seed, steps, text styling applied)
Status (success/failure with any issues)
