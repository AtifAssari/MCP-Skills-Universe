---
title: nsfc-abstract
url: https://skills.sh/huangwb8/chineseresearchlatex/nsfc-abstract
---

# nsfc-abstract

skills/huangwb8/chineseresearchlatex/nsfc-abstract
nsfc-abstract
Installation
...
研究内容（3-4 点）（35–40%）：用动词开头，写清”做什么→怎么做→要验证什么/得到什么判据”（点数默认以 config.yaml:limits.content_points_min/max 为准）；此句是摘要主体，应获得最多篇幅。
意义/价值（10–15%）：总结预期贡献（科学机制 + 方法/策略/应用潜力），与第 2 句的问题形成闭环。
输出格式（便于粘贴与校验）
