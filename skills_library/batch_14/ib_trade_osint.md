---
title: ib_trade-osint
url: https://skills.sh/crtvrffnrt/skills/ib_trade-osint
---

# ib_trade-osint

skills/crtvrffnrt/skills/ib_trade-osint
ib_trade-osint
Installation
$ npx skills add https://github.com/crtvrffnrt/skills --skill ib_trade-osint
SKILL.md
...
ticker: Affected asset(s).
catalyst_score: Numerical value based on the prefilter.
direction: bullish, bearish, or mixed.
impact_horizon: 0-24h, 24-72h, or 7d.
confidence: confirmed, probable, or possible.
source_refs: List of URLs or source IDs.
Weekly Installs
9
Repository
crtvrffnrt/skills
