---
title: idml
url: https://skills.sh/sungkhum/agent-skills/idml
---

# idml

skills/sungkhum/agent-skills/idml
idml
Installation
...
MANDATORY - READ ENTIRE FILE: Read references/idml-xml.md before editing XML directly.
Unpack the file: python scripts/unpack_idml.py file.idml unpacked
Edit the specific component XML (stories/spreads/resources).
Repack: python scripts/pack_idml.py unpacked out.idml
Validate: python scripts/validate_idml.py unpacked --original out.idml
