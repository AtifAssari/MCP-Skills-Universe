---
title: tfc-plan-json
url: https://skills.sh/laurigates/claude-plugins/tfc-plan-json
---

# tfc-plan-json

skills/laurigates/claude-plugins/tfc-plan-json
tfc-plan-json
Installation
$ npx skills add https://github.com/laurigates/claude-plugins --skill tfc-plan-json
SKILL.md
