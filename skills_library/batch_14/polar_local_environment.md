---
title: polar-local-environment
url: https://skills.sh/fcakyon/claude-codex-settings/polar-local-environment
---

# polar-local-environment

skills/fcakyon/claude-codex-settings/polar-local-environment
polar-local-environment
Installation
...
CONDUCTOR_PORT env var → (port - 55000) / 10 + 1
Workspace path hash → stable instance derived from the repo root path
