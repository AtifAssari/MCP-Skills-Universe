---
title: cloudflare
url: https://skills.sh/andrehfp/tinyplate/cloudflare
---

# cloudflare

skills/andrehfp/tinyplate/cloudflare
cloudflare
Installation
...
Clerk DNS records (paste from Clerk dashboard)
Vercel project name (e.g., my-app)
Email addresses to create (e.g., contact, support)
Redirect target email (e.g., me@gmail.com)
Step 2: Get Zone ID
# If using API token
