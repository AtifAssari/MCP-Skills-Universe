---
title: easysdd-feature
url: https://skills.sh/liuzhengdongfortest/easysdd/easysdd-feature
---

# easysdd-feature

skills/liuzhengdongfortest/easysdd/easysdd-feature
easysdd-feature
Installation
...
日期取首次创建当天，定了就不动——后续 slug 改了，日期前缀也保持原样
...
什么时候别走 fastforward：跨多个子系统、有术语冲突风险、推进步骤超过 4 步。遇到这几种情况就劝用户走标准流程，原因是范围一大，跳过 design 阶段意味着 AI 和用户在同一份方案上没共同确认过，实现完很容易发现彼此理解的不是同一回事。
