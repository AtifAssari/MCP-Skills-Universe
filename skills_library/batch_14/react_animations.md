...
url: https://skills.sh/fcsouza/agent-skills/react-animations
---
...
CSS for simple, JS for complex — if Tailwind transition works, use it; don't add Framer Motion for hover states
Only animate composited properties — transform and opacity; never width, height, top, left (causes reflow)
AnimatePresence wraps conditional renders — without it, exit animations are skipped
