---
title: fp-plan
url: https://skills.sh/fiberplane/claude-code-plugins/fp-plan
---

# fp-plan

skills/fiberplane/claude-code-plugins/fp-plan
fp-plan
Installation
$ npx skills add https://github.com/fiberplane/claude-code-plugins --skill fp-plan
SKILL.md
FP Plan Skill
