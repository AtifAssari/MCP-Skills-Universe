---
title: gcp
url: https://skills.sh/aibangjuxin/knowledge/gcp
---

# gcp

skills/aibangjuxin/knowledge/gcp
gcp
Installation
$ npx skills add https://github.com/aibangjuxin/knowledge --skill gcp
SKILL.md
...
节点标签中若包含括号，必须使用双引号包裹，例如：A["节点(示例)"]。
...
如果涉及交互流程或架构，必须生成 Mermaid 代码块。
Check: 再次检查 Mermaid 语法中是否转义了括号。
