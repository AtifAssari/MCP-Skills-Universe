...
url: https://skills.sh/davila7/claude-code-templates/paywall-upgrade-cro
---

# paywall-upgrade-cro

skills/davila7/claude-code-templates/paywall-upgrade-cro
paywall-upgrade-cro
Originally fromcoreyhaines31/marketingskills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill paywall-upgrade-cro
SKILL.md
