...
url: https://skills.sh/jeffallan/claude-skills/fastapi-expert
---

# fastapi-expert

skills/jeffallan/claude-skills/fastapi-expert
fastapi-expert
Installation
...
Test — Write async tests with pytest and httpx; run pytest after each endpoint group and verify OpenAPI docs at /docs
