...
url: https://skills.sh/wshobson/agents/python-type-safety
---

# python-type-safety

skills/wshobson/agents/python-type-safety
python-type-safety
Installation
...
Use T | None - Modern union syntax over Optional[T]
...
Minimize Any - Use specific types or generics. Any is acceptable for truly dynamic data or when interfacing with untyped third-party code
