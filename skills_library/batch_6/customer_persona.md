...
url: https://skills.sh/inference-sh/skills/customer-persona
---

# customer-persona

skills/inference-sh/skills/customer-persona
customer-persona
Originally frominfsh-skills/skills
Installation
$ npx skills add https://github.com/inference-sh/skills --skill customer-persona
SKILL.md
Customer Persona
