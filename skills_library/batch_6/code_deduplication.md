...
url: https://skills.sh/alinaqi/claude-bootstrap/code-deduplication
---

# code-deduplication

skills/alinaqi/claude-bootstrap/code-deduplication
code-deduplication
Installation
...
Claude Instructions
At Session Start
Read CODE_INDEX.md if it exists
Note the categories and key functions available
...
If unsure, search the codebase: grep -r "functionName\|similar_term" src/
Only create new if confirmed nothing suitable exists
