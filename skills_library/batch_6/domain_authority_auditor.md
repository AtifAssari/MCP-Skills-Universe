...
url: https://skills.sh/aaron-he-zhu/seo-geo-claude-skills/domain-authority-auditor
---
...
Cap Enforcement (Runbook §2): walk the decision table. Identify which scenario matches your input (0 veto, 1 veto above cap, 1 veto below cap, or 2+ veto). Apply the cap rule — remember it's a ceiling, not a floor. Set cap_applied in the handoff. For CITE, single-veto fails also raise a Manipulation Alert entry in open_loops.
