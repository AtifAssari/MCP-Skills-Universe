---
title: web-access
url: https://skills.sh/eze-is/web-access/web-access
---

# web-access

skills/eze-is/web-access/web-access
web-access
Installation
...
用户指向本人访问过的页面（"我之前看的那个讲 X 的文章"、"上次打开过的 XX 面板"）或组织内部系统（"我们的 XX 平台"、"公司那个 YY 系统"等公网搜不到的目标）时，检索本地 Chrome 书签/历史：
