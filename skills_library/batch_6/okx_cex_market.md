---
title: okx-cex-market
url: https://skills.sh/okx/agent-skills/okx-cex-market
---

# okx-cex-market

skills/okx/agent-skills/okx-cex-market
okx-cex-market
Installation
...
Supports filtering by instrument type (SPOT, SWAP, FUTURES, OPTION) and includes stock token perpetuals (TSLA, NVDA, AAPL, etc.)
Integrates with okx-cex-trade and okx-cex-portfolio for complete trading workflows: research market data, check balances, then place orders
SKILL.md
