...
url: https://skills.sh/composiohq/awesome-claude-skills/file-organizer
---

# file-organizer

skills/composiohq/awesome-claude-skills/file-organizer
file-organizer
Originally fromlangchain-ai/deepagentsjs
Installation
...
Executes moves, renames, and deletions with user approval, preserving file metadata and offering undo capability through detailed logging
Handles common workflows including Downloads cleanup, project restructuring, photo organization by date, and work/personal file separation
SKILL.md
File Organizer
