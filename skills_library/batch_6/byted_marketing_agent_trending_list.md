---
title: byted-marketing-agent-trending-list
url: https://skills.sh/site/skills.volces.com/byted-marketing-agent-trending-list
---

# byted-marketing-agent-trending-list

skills/skills.volces.com/byted-marketing-agent-trending-list
byted-marketing-agent-trending-list
...
用户选定行业后，使用本 Skill 固定的 type 查询该行业下的趋势榜单列表。
