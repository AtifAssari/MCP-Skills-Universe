...
url: https://skills.sh/teachingai/full-stack-skills/mybatis-plus-generator
---

# mybatis-plus-generator

skills/teachingai/full-stack-skills/mybatis-plus-generator
mybatis-plus-generator
Installation
...
Ask user for base package path (e.g., com.example.order)
...
Load appropriate template from templates/ directory based on object type and language
