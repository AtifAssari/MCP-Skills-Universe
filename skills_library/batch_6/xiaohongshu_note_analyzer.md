---
title: xiaohongshu-note-analyzer
url: https://skills.sh/softbread/xiaohongshu-doctor/xiaohongshu-note-analyzer
---

# xiaohongshu-note-analyzer

skills/softbread/xiaohongshu-doctor/xiaohongshu-note-analyzer
xiaohongshu-note-analyzer
Installation
$ npx skills add https://github.com/softbread/xiaohongshu-doctor --skill xiaohongshu-note-analyzer
Summary
...
Delivers actionable optimization recommendations including keyword placement formulas, headline templates (numeric, pain-point, curiosity, comparison, authority, emotional types), and commercial authenticity scoring from 1-10
Outputs structured analysis reports with priority-ranked modifications and optimized versions of titles and opening paragraphs
SKILL.md
