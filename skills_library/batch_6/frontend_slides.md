...
url: https://skills.sh/affaan-m/everything-claude-code/frontend-slides
---

# frontend-slides

skills/affaan-m/everything-claude-code/frontend-slides
frontend-slides
Installation
...
Defaults to visual exploration over abstract questionnaires: generates 3 single-slide preview files in different styles, then builds the full deck based on user preference
Includes keyboard, touch, wheel, and swipe navigation with progress indicators, semantic HTML structure, and prefers-reduced-motion support for accessibility
SKILL.md
Frontend Slides
...
Generate 3 single-slide preview files in .ecc-design/slide-previews/.
...
Prefer python3 with python-pptx to extract text, images, and notes.
If python-pptx is unavailable, ask whether to install it or fall back to a manual/export-based workflow.
