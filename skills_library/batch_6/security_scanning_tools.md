...
url: https://skills.sh/davila7/claude-code-templates/security-scanning-tools
---

# security scanning tools

skills/davila7/claude-code-templates/Security Scanning Tools
Security Scanning Tools
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill 'Security Scanning Tools'
SKILL.md
Security Scanning Tools
Purpose
