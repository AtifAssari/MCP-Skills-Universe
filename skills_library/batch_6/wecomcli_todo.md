---
title: wecomcli-todo
url: https://skills.sh/wecomteam/wecom-cli/wecomcli-todo
---

# wecomcli-todo

skills/wecomteam/wecom-cli/wecomcli-todo
wecomcli-todo
Installation
...
查询待办列表 - 按创建时间和提醒时间过滤，支持分页，返回待办概要信息
获取待办详情 - 根据待办 ID 列表批量获取完整信息（含内容和分派人）
创建待办 - 创建新的待办事项，可指定内容、分派人和提醒时间
更新待办 - 修改已有待办的内容、分派人、状态或提醒时间
删除待办 - 删除指定的待办事项
变更用户待办状态 - 更改当前用户在某个待办中的状态（拒绝/接受/已完成）
命令调用方式
