---
title: puremac-macos-cleaner
url: https://skills.sh/aradotso/trending-skills/puremac-macos-cleaner
---
...
puremac-macos-cleaner
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill puremac-macos-cleaner
SKILL.md
PureMac macOS Cleaner
...
Define the category in CleanCategory.swift:
// CleanCategory.swift
...
Add scanning logic in ScannerService.swift:
...
Add cleaning logic in CleanerService.swift:
...
Create a feature branch: git checkout -b feature/gradle-cache-cleaning
Follow existing patterns in ScannerService / CleanerService.
