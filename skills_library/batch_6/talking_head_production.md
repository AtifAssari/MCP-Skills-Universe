...
url: https://skills.sh/inference-sh/skills/talking-head-production
---

# talking-head-production

skills/inference-sh/skills/talking-head-production
talking-head-production
Originally frominfsh-skills/skills
Installation
$ npx skills add https://github.com/inference-sh/skills --skill talking-head-production
SKILL.md
Talking Head Production
