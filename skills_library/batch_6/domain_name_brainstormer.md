...
skills/softaworks/agent-toolkit/domain-name-brainstormer
domain-name-brainstormer
...
Provides branding rationale for each suggestion and actionable next steps for registration and brand protection
SKILL.md
Domain Name Brainstormer
