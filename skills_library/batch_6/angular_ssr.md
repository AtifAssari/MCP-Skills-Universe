---
title: angular-ssr
url: https://skills.sh/analogjs/angular-skills/angular-ssr
---

# angular-ssr

skills/analogjs/angular-skills/angular-ssr
angular-ssr
Installation
...
Platform detection utilities and afterNextRender/afterRender hooks safely isolate browser-only code from server execution
Dynamic prerendering via getPrerenderParams() for parameterized routes; automatic HTTP response transfer between server and client via TransferState
SKILL.md
Angular SSR
