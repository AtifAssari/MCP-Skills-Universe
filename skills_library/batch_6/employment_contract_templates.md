...
skills/wshobson/agents/employment-contract-templates
employment-contract-templates
Installation
...
Incorporates essential legal protections including confidentiality agreements, intellectual property assignment, non-compete and non-solicitation clauses, and anti-harassment policies
Provides best practices guidance on legal review, manager training, policy updates, and documentation retention; includes explicit disclaimer that templates require legal counsel review before use
SKILL.md
Employment Contract Templates
