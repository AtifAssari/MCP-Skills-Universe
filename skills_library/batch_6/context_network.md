...
url: https://skills.sh/jwynia/agent-skills/context-network
---

# context-network

skills/jwynia/agent-skills/context-network
context-network
Installation
...
Import findings: Knowledge gaps, navigation issues, guidance assessments
Map to states: Which CN state do these findings indicate?
Prioritize: Use retrospective priority levels (Critical/High/Medium/Low)
Execute: Run appropriate maintenance mode interventions
Anti-Patterns
The Empty Scaffold
...
Check for existing .context-network.md
Check for existing context/ directory
If starting fresh, confirm target location with user
Primary Output
...
Scan for existing documentation (package.json, README, etc.)
Ask: "What's the primary domain? (e.g., API, CLI, library, full-stack app)"
Generate software-project scaffold based on answer
Create .context-network.md and context/ structure
Coach: "Start with status.md - what's the current state of the project?"
Weekly Installs
255
Repository
jwynia/agent-skills
