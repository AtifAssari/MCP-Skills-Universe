...
url: https://skills.sh/aviz85/claude-skills-library/presentation-architect
---

# presentation-architect

skills/aviz85/claude-skills-library/presentation-architect
presentation-architect
Installation
...
Best Practices
Be exhaustive, not excessive: Include all necessary detail, but avoid verbose explanations
Maintain consistency: Typography, colors, and visual style should be coherent across slides
Write for action: Every description should enable immediate implementation
Think narratively: Each slide should advance the story
Consider the audience: Tailor complexity and tone to the intended viewers
Success Criteria
