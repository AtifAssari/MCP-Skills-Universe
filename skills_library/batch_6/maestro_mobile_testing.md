---
title: maestro-mobile-testing
url: https://skills.sh/tovimx/maestro-mobile-testing-skill/maestro-mobile-testing
---

# maestro-mobile-testing

skills/tovimx/maestro-mobile-testing-skill/maestro-mobile-testing
maestro-mobile-testing
Installation
...
Store as MAESTRO_API_KEY secret in your CI provider
Running from CLI
...
Run it via MCP's runFlow / launchApp + interaction tools
...
Maestro MCP Server
Maestro GitHub
GraalJS HTTP Requests
Conditions & Adaptive Flows
GitHub Actions Integration
BrowserStack: Maestro Testing Guide
DEV.to: Tips & Tricks for Maestro + React Native
Weekly Installs
248
Repository
tovimx/maestro-…ng-skill
GitHub Stars
9
First Seen
Feb 24, 2026
