---
title: maoxuan-skill-cognitive-framework
url: https://skills.sh/aradotso/trending-skills/maoxuan-skill-cognitive-framework
---

# maoxuan-skill-cognitive-framework

skills/aradotso/trending-skills/maoxuan-skill-cognitive-framework
maoxuan-skill-cognitive-framework
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill maoxuan-skill-cognitive-framework
SKILL.md
...
7 Mental Models — operational frameworks extracted from core writings
10 Decision Heuristics — concrete rules for ambiguous situations
Expression DNA — the rhetorical style (direct address, historical analogy, dialectical structure)
Honest Boundaries — what it can and cannot do
