...
url: https://skills.sh/davila7/claude-code-templates/onboarding-cro
---

# onboarding-cro

skills/davila7/claude-code-templates/onboarding-cro
onboarding-cro
Originally fromcoreyhaines31/marketingskills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill onboarding-cro
SKILL.md
Onboarding CRO
