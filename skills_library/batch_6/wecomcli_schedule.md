---
title: wecomcli-schedule
url: https://skills.sh/wecomteam/wecom-cli/wecomcli-schedule
---

# wecomcli-schedule

skills/wecomteam/wecom-cli/wecomcli-schedule
wecomcli-schedule
Installation
...
若涉及参与人，先通过 wecomcli-contact 查询 userid；存在同名时展示候选让用户选择
...
通过 wecomcli-contact 获取目标人员 userid；存在同名时展示候选让用户选择
通过查询工作流定位目标日程
...
通过 wecomcli-contact 获取相关人员 userid
