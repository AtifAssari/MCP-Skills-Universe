---
title: coinglass
url: https://skills.sh/starchild-ai-agent/official-skills/coinglass
---

# coinglass

skills/starchild-ai-agent/official-skills/coinglass
coinglass
Installation
...
Batch endpoints like cg_coins_market_data() return 100+ coins in one call; supports OHLC history, cumulative volume delta, and premium/discount analysis for ETF arbitrage
Requires COINGLASS_API_KEY; professional plan allows 6000 requests/minute with real-time to daily update frequency depending on data type
SKILL.md
Coinglass
