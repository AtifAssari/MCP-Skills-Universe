...
skills/supercent-io/skills-template/ralph
ralph
Installation
...
Supports Claude Code (native hooks), Codex CLI (bash loop), Gemini CLI (AfterAgent hook), and OpenCode with unified ooo command syntax across all platforms
SKILL.md
