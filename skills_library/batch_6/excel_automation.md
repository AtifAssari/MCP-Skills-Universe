...
url: https://skills.sh/claude-office-skills/skills/excel-automation
---

# excel-automation

skills/claude-office-skills/skills/excel-automation
excel-automation
Installation
...
Includes application-level controls (screen updating, calculation mode) and batch processing patterns for multi-file workflows
Requires Excel installed locally; best suited for desktop automation, dashboards, and report generation rather than server-side processing
SKILL.md
