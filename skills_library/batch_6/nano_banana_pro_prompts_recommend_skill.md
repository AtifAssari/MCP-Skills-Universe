...
url: https://skills.sh/youmind-openlab/nano-banana-pro-prompts-recommend-skill/nano-banana-pro-prompts-recommend-skill
---

# nano-banana-pro-prompts-recommend-skill

skills/youmind-openlab/nano-banana-pro-prompts-recommend-skill/nano-banana-pro-prompts-recommend-skill
nano-banana-pro-prompts-recommend-skill
Installation
...
Recommend curated AI image generation prompts from 10,000+ templates optimized for Nano Banana Pro.

Access a library of 10,000+ community-curated prompts organized by use case (social media, product marketing, avatars, posters, e-commerce, games, comics, web UI, and more)
Every recommendation includes a sample image showing what the prompt produces, helping you preview results before generation
Works with any text-to-image model: Nano Banana Pro, Gemini, GPT Image 1.5, Seedream 5.0, Midjourney, DALL-E, Flux, and Stable Diffusion
Supports two workflows: direct image generation (describe what you want) or content illustration (provide article/video/podcast text and get prompts tailored to your content)
Automatically syncs with the latest community prompts daily via GitHub; no manual updates needed
SKILL.md
