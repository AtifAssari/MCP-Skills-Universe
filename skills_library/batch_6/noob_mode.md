...
skills/github/awesome-copilot/noob-mode
noob-mode
Installation
...
Automatically defines technical terms on first use and provides step-by-step roadmaps for multi-step tasks so users always know what's coming
Includes completion summaries showing what files were created, changed, or deleted, plus undo instructions for every action
Uses real-world analogies (git branch as "photocopy of a document," API as "waiter between you and the kitchen") to explain complex concepts
SKILL.md
Noob Mode
