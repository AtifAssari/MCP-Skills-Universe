...
url: https://skills.sh/apify/agent-skills/apify-ecommerce
---

# apify-ecommerce

skills/apify/agent-skills/apify-ecommerce
apify-ecommerce
Installation
...
Optional AI-powered analysis generates insights on price ranges, sentiment trends, and seller patterns; results exportable as CSV or JSON
Requires Apify token in ~/.claude/.env and Node.js 20.6+
SKILL.md
