...
skills/wshobson/agents/pci-compliance
pci-compliance
Installation
...
Outlines compliance levels (1–4) based on transaction volume and SAQ questionnaire types (A, A-EP, D) to determine assessment scope
SKILL.md
PCI Compliance
