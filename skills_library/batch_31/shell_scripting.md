...
url: https://skills.sh/89jobrien/steve/shell-scripting
---

# shell-scripting

skills/89jobrien/steve/shell-scripting
shell-scripting
Installation
$ npx skills add https://github.com/89jobrien/steve --skill shell-scripting
SKILL.md
Shell Scripting
