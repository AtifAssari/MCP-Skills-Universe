---
title: example-skill
url: https://skills.sh/89jobrien/steve/example-skill
---

# example-skill

skills/89jobrien/steve/example-skill
example-skill
Installation
$ npx skills add https://github.com/89jobrien/steve --skill example-skill
SKILL.md
Example Skill
...
Use the template from steve/templates/AGENT_SKILL.template.md
