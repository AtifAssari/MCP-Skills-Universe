...
url: https://skills.sh/davila7/claude-code-templates/scientific-slides
---

# scientific-slides

skills/davila7/claude-code-templates/scientific-slides
scientific-slides
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill scientific-slides
Summary
...
Generates complete slide decks as PDF images using Nano Banana Pro AI, with support for PowerPoint and LaTeX Beamer workflows for editable or publication-quality output
Enforces visual-first design philosophy: high-quality figures, diagrams, and graphics dominate each slide, with minimal text (3–4 bullets, 4–6 words each) serving as speaker notes
Integrates research-lookup skill to gather 8–15 papers for proper citations in introduction and discussion sections, establishing scientific credibility
Provides talk-specific structures for conferences (15 min), seminars (45 min), thesis defenses (60 min), grant pitches, and journal clubs, with timing guidance and practice workflows
SKILL.md
Scientific Slides
Overview
...
List files in working directory: ls -la figures/ or ls -la results/
...
Plan the deck: Create content plan for each slide
Generate visuals: Use Nano Banana Pro with --visual-only flag to create images for slides
Build PPTX: Use the PPTX skill (html2pptx or template-based) to create slides with generated visuals and separate text
...
Plan each slide (title, content, visual elements)
Generate each slide with generate_slide_image.py
Combine into PDF with slides_to_pdf.py
# Generate slides
