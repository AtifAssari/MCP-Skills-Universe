---
title: flutter-adaptive-ui
url: https://skills.sh/madteacher/mad-agents-skills/flutter-adaptive-ui
---

# flutter-adaptive-ui

skills/madteacher/mad-agents-skills/flutter-adaptive-ui
flutter-adaptive-ui
Installation
...
Inspect existing widgets before changing layout. Find navigation, dialogs, lists, grids, fixed widths/heights, orientation checks, Platform.* layout checks, and custom input/focus handling.
Abstract shared data before branching. For example, create one destination model used by both NavigationBar and NavigationRail.
...
Run flutter analyze.
Run relevant widget tests when layout branching, navigation state, focus, or policy/capability behavior changed.
