...
url: https://skills.sh/composiohq/awesome-claude-skills/invoice-organizer
---

# invoice-organizer

skills/composiohq/awesome-claude-skills/invoice-organizer
invoice-organizer
Installation
...
Generates a CSV summary with all extracted invoice details for accountant import and expense tracking
Preserves original files while creating an organized copy structure, with flagging for files requiring manual review
SKILL.md
Invoice Organizer
