---
title: frontend-dev
url: https://skills.sh/minimax-ai/skills/frontend-dev
---

# frontend-dev

skills/minimax-ai/skills/frontend-dev
frontend-dev
Installation
$ npx skills add https://github.com/minimax-ai/skills --skill frontend-dev
SKILL.md
Frontend Studio
...
Intelligent List — auto-sorting with layoutId
...
Save: <project>/public/assets/{images,videos,audio}/ as {type}-{descriptor}-{timestamp}.{ext} — MUST save locally
...
Read templates/viewer.html first
