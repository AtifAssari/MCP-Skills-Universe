---
title: x-mastery-mentor
url: https://skills.sh/alchaincyf/x-mentor-skill/x-mastery-mentor
---

# x-mastery-mentor

skills/alchaincyf/x-mentor-skill/x-mastery-mentor
x-mastery-mentor
Installation
...
检查 user-data/ 是否有当前用户的数据
如有 → 静默读取 strategy.md，将用户画像作为上下文
超过30天 → 提醒重新诊断
如无 → 适当时机建议做一次诊断
