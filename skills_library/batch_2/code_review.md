---
title: code-review
url: https://skills.sh/skillcreatorai/ai-agent-skills/code-review
---

# code-review

skills/skillcreatorai/ai-agent-skills/code-review
code-review
Installation
...
Includes a review checklist covering secrets, input validation, error handling, types, tests, performance, readability, and breaking changes
SKILL.md
Code Review
Review Categories
1. Security Review
