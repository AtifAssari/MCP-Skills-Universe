...
url: https://skills.sh/sickn33/antigravity-awesome-skills/prompt-engineer
---

# prompt-engineer

skills/sickn33/antigravity-awesome-skills/prompt-engineer
prompt-engineer
Installation
...
Blends multiple frameworks for complex tasks spanning different dimensions (e.g., structure plus reasoning)
Works universally in any terminal context, independent of project structure or external dependencies
SKILL.md
Purpose
