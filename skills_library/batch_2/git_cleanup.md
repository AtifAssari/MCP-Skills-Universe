---
title: git-cleanup
url: https://skills.sh/trailofbits/skills/git-cleanup
---

# git-cleanup

skills/trailofbits/skills/git-cleanup
git-cleanup
Installation
...
Uses correct delete flags (-d for merged, -D for squash-merged) and protects main, master, develop, and release/* branches
SKILL.md
Git Cleanup
