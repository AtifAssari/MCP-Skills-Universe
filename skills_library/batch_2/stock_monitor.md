---
title: stock-monitor
url: https://skills.sh/chjm-ai/stock-monitor-skill/stock-monitor
---

# stock-monitor

skills/chjm-ai/stock-monitor-skill/stock-monitor
stock-monitor
Installation
$ npx skills add https://github.com/chjm-ai/stock-monitor-skill --skill stock-monitor
Summary
...
Runs as a background daemon with intelligent monitoring frequency: every 5 minutes during trading hours (9:30–15:00), every 30 minutes after-hours, hourly on weekends
Customizable thresholds for each rule and per-asset configuration; includes AI-powered analysis with actionable trading suggestions
SKILL.md
