---
title: django-expert
url: https://skills.sh/jeffallan/claude-skills/django-expert
---

# django-expert

skills/jeffallan/claude-skills/django-expert
django-expert
Installation
...
Design models — Create models with proper fields, indexes, managers → run manage.py makemigrations and manage.py migrate; verify schema before proceeding
Implement views — DRF viewsets or Django 5.0 async views
Validate endpoints — Confirm each endpoint returns expected status codes with a quick APITestCase or curl check before adding auth
