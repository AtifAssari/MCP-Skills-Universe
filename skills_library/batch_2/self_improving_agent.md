...
url: https://skills.sh/site/skills.volces.com/self-improving-agent
---
...
self-improving-agent
$ npx skills add https://skills.volces.com/c/arkclaw-personal/skills/clawhub/zhengxinjipai
SKILL.md
Self-Improving Agent
...
自动记录纠正到 corrections.jsonl
更新 AGENTS.md 添加代码风格规则
回复: "已记录，下次会使用单引号"
场景2：命令反复失败
...
记录错误到 errors.jsonl
下次执行前检查记忆
自动改用: sudo npm install -g xxx 或本地安装
场景3：发现更好做法
...
记录最佳实践到 best_practices.jsonl
后续安装Python包时优先使用 editable 模式
注意事项
记忆文件定期备份到git
敏感信息脱敏后记录
定期review并清理过时记忆
