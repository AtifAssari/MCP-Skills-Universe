---
title: ui-demo
url: https://skills.sh/affaan-m/everything-claude-code/ui-demo
---

# ui-demo

skills/affaan-m/everything-claude-code/ui-demo
ui-demo
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill ui-demo
SKILL.md
...
Placeholder select values look real - watch for "0" and "Select...".
Popups create separate videos - capture popup pages explicitly and merge later if needed.
Weekly Installs
1.6K
Repository
