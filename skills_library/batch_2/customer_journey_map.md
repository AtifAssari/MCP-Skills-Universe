...
url: https://skills.sh/deanpeters/product-manager-skills/customer-journey-map
---

# customer-journey-map

skills/deanpeters/product-manager-skills/customer-journey-map
customer-journey-map
Installation
...
Key stakeholders: Marketing, sales, product, customer service representatives
Buyer personas: Detailed personas with demographics, psychographics, goals, challenges (reference skills/proto-persona/SKILL.md)
Defined stages: Main stages of your buying process (typically: Awareness, Consideration, Decision, Service, Loyalty)
Touchpoint inventory: All places customers interact with your brand (website, social, email, store, support, etc.)
...
Where are the biggest pain points? (Look for negative emotions + high drop-off rates)
Which stages have the weakest KPIs? (Prioritize low-performing stages)
Are teams aligned? (Do teams understand their role in each stage?)
What opportunities exist? (Where can small improvements create big impact?)
