...
url: https://skills.sh/wondelai/skills/improve-retention
---

# improve-retention

skills/wondelai/skills/improve-retention
improve-retention
Installation
$ npx skills add https://github.com/wondelai/skills --skill improve-retention
SKILL.md
...
Start tiny → User opens the dashboard (Starter Step)
Grows naturally → User checks two or three metrics
Expands → User customizes the dashboard
Habit formed → User checks dashboard every morning automatically
