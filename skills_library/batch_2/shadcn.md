...
Includes smart update workflows with --dry-run and --diff flags for merging upstream changes while preserving local modifications; supports preset switching with reinstall, merge, or skip options
SKILL.md
