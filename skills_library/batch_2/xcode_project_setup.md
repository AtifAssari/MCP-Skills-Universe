...
skills/firebase/agent-skills/xcode-project-setup
xcode-project-setup
Installation
...
Usage
Locate the package path: Find the absolute path to this skill's scripts/xcode_spm_setup directory on disk.
Execute: Run the native swift run command using the signature below:
