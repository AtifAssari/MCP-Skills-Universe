...
url: https://skills.sh/claude-office-skills/skills/competitive-analysis
---

# competitive-analysis

skills/claude-office-skills/skills/competitive-analysis
competitive-analysis
Installation
$ npx skills add https://github.com/claude-office-skills/skills --skill competitive-analysis
SKILL.md
...
Low ─────────────────┼───────────────────── High Innovation │ Innovation │ [Comp C] │ [Comp B] │ Low Price
...
Provide your company context for relevant comparison
Name specific competitors or describe the criteria to identify them
Specify focus areas (features, pricing, positioning, etc.)
Share any known information about competitors
Indicate the purpose (strategic planning, sales enablement, etc.)
Request battle cards for sales teams
Limitations
