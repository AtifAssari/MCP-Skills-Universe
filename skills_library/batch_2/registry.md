---
title: registry
url: https://skills.sh/frames-engineering/skills/registry
---

# registry

skills/frames-engineering/skills/registry
registry
Installation
$ npx skills add https://github.com/frames-engineering/skills --skill registry
Summary
...
AgentWallet (recommended for agents) — server-side wallet that handles 402 detection, payment signing, and retries automatically via a single POST /x402/fetch call. No private key management needed on your side.
...
Discover services: GET https://registry.frames.ag/api/services
Read service docs: GET https://registry.frames.ag/api/service/{slug}/skill.md
Check pricing: GET https://registry.frames.ag/api/pricing
Make a paid request — via AgentWallet's /x402/fetch or directly with x402 headers (see Payment Protocol below)
Services (10)
...
x402 Test Service	test	Test x402 payment flows on Base Sepolia (EVM) and Solana Devnet. Use this service to verify your x402 client integration is working correctly.	2	$0.001
...
Base: https://registry.frames.ag/api/service/twitter | Docs | OpenAPI | Skill
...
Base: https://registry.frames.ag/api/service/ai-gen | Docs | OpenAPI | Skill

Endpoint	Price	Description
POST /api/invoke	$0.01	Run AI model prediction (price varies by model)
x402 Test Service (test)

Base: https://registry.frames.ag/api/service/test | Docs | OpenAPI | Skill
...
Base: https://registry.frames.ag/api/service/exa | Docs | OpenAPI | Skill
...
Base: https://registry.frames.ag/api/service/wordspace | Docs | OpenAPI | Skill

Endpoint	Price	Description
POST /api/invoke	$2	Run wordspace AI agent loop
Jupiter API (jupiter)

Base: https://registry.frames.ag/api/service/jupiter | Docs | OpenAPI | Skill
...
Base: https://registry.frames.ag/api/service/near-intents | Docs | OpenAPI | Skill

Endpoint	Price	Description
POST /api/quote	$0.01	Cross-chain swap quote and deposit address
AgentMail API (agentmail)

Base: https://registry.frames.ag/api/service/agentmail | Docs | OpenAPI | Skill
...
Base: https://registry.frames.ag/api/service/coingecko | Docs | OpenAPI | Skill
...
Receive 402 Payment Required with a PAYMENT-REQUIRED header (Base64 JSON with price, network, payTo address)
Sign a payment for the requested amount on your chosen network
Retry the same request with the PAYMENT-SIGNATURE header
Receive the response plus a PAYMENT-RESPONSE confirmation header
...
Parse the PAYMENT-REQUIRED header from the 402 response (Base64 JSON with price, network, payTo)
Sign a payment authorization for the exact amount
