---
title: roundup-setup
url: https://skills.sh/github/awesome-copilot/roundup-setup
---

# roundup-setup

skills/github/awesome-copilot/roundup-setup
roundup-setup
Installation
...
Use the create tool to write the config file at ~/.config/roundup/config.md.

Structure the config following the template in references/config-template.md. The key sections:
