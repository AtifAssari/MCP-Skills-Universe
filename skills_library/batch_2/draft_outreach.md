...
url: https://skills.sh/anthropics/knowledge-work-plugins/draft-outreach
---

# draft-outreach

skills/anthropics/knowledge-work-plugins/draft-outreach
draft-outreach
Installation
...
Supports three delivery modes: auto-create email draft if email connector enabled, output text for manual copy, or LinkedIn connection/follow-up message templates
Includes follow-up sequence templates and avoids generic openers by anchoring every message to specific research findings (news, hiring, content, mutual connections)
SKILL.md
Draft Outreach
