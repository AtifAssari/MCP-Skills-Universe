...
url: https://skills.sh/gracefullight/stock-checker/trading-analysis
---

# trading-analysis

skills/gracefullight/stock-checker/trading-analysis
trading-analysis
Installation
...
Outputs institutional-grade Markdown reports with executive summary, technical analysis, AI-powered market sentiment, investment recommendations, and risk assessment, plus structured JSON data
Includes automatic investment disclaimers and risk warnings; processes each symbol in 15–30 seconds using real-time Yahoo Finance data
SKILL.md
