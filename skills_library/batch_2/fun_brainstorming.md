---
title: fun-brainstorming
url: https://skills.sh/roin-orca/skills/fun-brainstorming
---

# fun-brainstorming

skills/roin-orca/skills/fun-brainstorming
fun-brainstorming
Installation
$ npx skills add https://github.com/roin-orca/skills --skill fun-brainstorming
Summary

Structured brainstorming for rapid design decisions before implementation begins.

Guides you through discovery, proposal, convergence, and capture phases to move from idea to approved direction without unnecessary ceremony
Asks focused clarifying questions upfront (batched together) to understand project context, intent, and constraints before proposing options
Presents 2 approaches with trade-offs and a recommendation, then captures the chosen direction as inline comments rather than separate design docs
Enforces a hard boundary: no code or file scaffolding until you explicitly approve a direction, ensuring thinking happens before building
SKILL.md
