...
url: https://skills.sh/rudrankriyam/app-store-connect-cli-skills/asc-subscription-localization
---

# asc-subscription-localization

skills/rudrankriyam/app-store-connect-cli-skills/asc-subscription-localization
asc-subscription-localization
Installation
...
Handles both single display names applied uniformly across all locales and locale-specific translated names for granular control
Requires App Store Connect authentication and app ID; integrates with asc-id-resolver skill for name-based ID lookup
SKILL.md
asc subscription localization
