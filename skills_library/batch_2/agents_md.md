...
skills/getsentry/skills/agents-md
agents-md
Installation
...
Package manager — Check for lock files (pnpm-lock.yaml, yarn.lock, package-lock.json, uv.lock, poetry.lock)
Linter/formatter configs — Look for .eslintrc, biome.json, ruff.toml, .prettierrc, etc. (don't duplicate these in AGENTS.md)
CI/build commands — Check Makefile, package.json scripts, CI configs for canonical commands
Monorepo indicators — Check for pnpm-workspace.yaml, nx.json, Cargo workspace, or subdirectory package.json files
Existing conventions — Check for existing CONTRIBUTING.md, docs/, or README patterns
Writing Rules
