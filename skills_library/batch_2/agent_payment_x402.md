...
url: https://skills.sh/affaan-m/everything-claude-code/agent-payment-x402
---

# agent-payment-x402

skills/affaan-m/everything-claude-code/agent-payment-x402
agent-payment-x402
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill agent-payment-x402
SKILL.md
