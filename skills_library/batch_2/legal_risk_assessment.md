...
url: https://skills.sh/anthropics/knowledge-work-plugins/legal-risk-assessment
---

# legal-risk-assessment

skills/anthropics/knowledge-work-plugins/legal-risk-assessment
legal-risk-assessment
Installation
...
Includes documentation standards for risk assessment memos and risk register entries to ensure consistent tracking and communication across the legal team
Covers when to engage outside counsel, including mandatory triggers (active litigation, government investigations, criminal exposure) and strongly recommended scenarios (novel legal issues, material financial exposure, specialized expertise needed)
SKILL.md
