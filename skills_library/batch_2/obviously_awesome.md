...
url: https://skills.sh/wondelai/skills/obviously-awesome
---

# obviously-awesome

skills/wondelai/skills/obviously-awesome
obviously-awesome
Installation
$ npx skills add https://github.com/wondelai/skills --skill obviously-awesome
SKILL.md
...
Pre-work: Gather customer research, competitive data, and win/loss analysis (1-2 weeks before)
Workshop: Walk through all 5 steps as a team, building consensus at each step (2-3 hours)
Post-work: Document the positioning canvas, create messaging, and align all customer-facing materials (1-2 weeks after)
