---
title: humanizer
url: https://skills.sh/daleseo/korean-skills/humanizer
---

# humanizer

skills/daleseo/korean-skills/humanizer
humanizer
Installation
...
Rewrites detected text to sound naturally human-written while preserving original meaning, tone, and formality level
Supports analysis of ChatGPT, Claude, and Gemini-generated Korean content; ideal for removing AI traces from LLM outputs
SKILL.md
...
텍스트 분석 - 아래에 설명된 24가지 검출 패턴에 대해 분석
...
문장부호 (7가지, 최고: 94.88% AUC) - 쉼표 과다, 영어식 배치, 연결어미 뒤 쉼표, 콜론 과다
띄어쓰기 (3가지, 높음: 79.51% AUC) - 경직된 의존명사, 보조용언, 숫자 띄어쓰기
품사 다양성 (3가지, 높음: 82.99% AUC) - 명사 과다, 동사/형용사 빈곤
어휘 (7가지, 중간) - AI 유행어, 불필요한 한자어, 영어 직역, 복수형 과다, 대명사 과다, 지시관형사 과다, 주어 생략 미흡
구조 (4가지, 중간) - 문장 리듬, 3박자, 접속사, 경어체
