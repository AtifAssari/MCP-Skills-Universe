...
url: https://skills.sh/anthropics/knowledge-work-plugins/account-research
---

# account-research

skills/anthropics/knowledge-work-plugins/account-research
account-research
Installation
$ npx skills add https://github.com/anthropics/knowledge-work-plugins --skill account-research
Summary

Complete company and person research powered by web search, enriched with verified contact data and CRM history when available.

Researches companies and individuals via web search alone, extracting business overview, recent news, hiring signals, leadership team, and product details
...
Integrates with CRM to surface prior relationship history, past opportunities, and existing contacts for warm outreach context
Generates structured output with qualification signals, talking points, recommended entry points, and discovery questions tailored to sales outreach
SKILL.md
Account Research
