...
url: https://skills.sh/anthropics/knowledge-work-plugins/product-brainstorming
---

# product-brainstorming

skills/anthropics/knowledge-work-plugins/product-brainstorming
product-brainstorming
Installation
...
State the problem or assumption you want to examine
Break it down: What are the fundamental components or constraints?
Question each component: Why does this have to be this way? Is this a law of physics or a convention?
Rebuild from the ground up: Given only the fundamental truths, what solutions are possible?
...
Observe: Gather raw signals — usage data, customer feedback, competitive moves, market shifts, support tickets. Do not filter yet. Cast wide.
Orient: Make sense of what you observed. This is the critical step. Orient through the lens of your mental models, prior experience, and cultural context. Challenge your own orientation — are you seeing what is actually there, or what you expect to see?
Decide: Choose a direction. Not a final commitment — a hypothesis to test. The decision should be proportional to what you know. Small bets when uncertain, bigger moves when the signal is clear.
Act: Execute the decision. Ship something. Run the experiment. Make the change. Then immediately return to Observe with new data.
...
Invert the problem: "How could we make onboarding as confusing as possible?"
Generate ideas: List everything that would make the problem worse (more steps, jargon, hidden buttons, no feedback)
Reverse each idea: Each "make it worse" idea contains the seed of a "make it better" solution
Evaluate: Which reversed ideas are most promising?
