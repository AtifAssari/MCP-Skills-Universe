...
skills/apollographql/skills/apollo-connectors
apollo-connectors
Installation
...
Handles response mapping with field selection, aliasing, sub-selections for nested data, and entity relationships for federated types
