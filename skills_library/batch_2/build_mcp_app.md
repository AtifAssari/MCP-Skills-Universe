---
title: build-mcp-app
url: https://skills.sh/anthropics/claude-plugins-official/build-mcp-app
---

# build-mcp-app

skills/anthropics/claude-plugins-official/build-mcp-app
build-mcp-app
Installation
...
The tool declares a UI resource via _meta.ui.resourceUri. Its handler returns plain text/JSON — NOT the HTML.
