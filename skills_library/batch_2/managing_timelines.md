...
url: https://skills.sh/refoundai/lenny-skills/managing-timelines
---

# managing-timelines

skills/refoundai/lenny-skills/managing-timelines
managing-timelines
Installation
$ npx skills add https://github.com/refoundai/lenny-skills --skill managing-timelines
Summary
...
Ship early and iterate with remaining time instead of front-loading estimation; use hill charts to visualize uncertainty and identify high-risk work stuck in discovery
Account for the planning fallacy (tasks take 3x longer than estimated due to distractions) and treat deadlines as hard constraints; use weekly RAG status reviews to surface and unblock issues early
SKILL.md
Managing Timelines
