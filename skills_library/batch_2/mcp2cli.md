---
title: mcp2cli
url: https://skills.sh/knowsuchagency/mcp2cli/mcp2cli
---

# mcp2cli

skills/knowsuchagency/mcp2cli/mcp2cli
mcp2cli
Installation
...
Discover available commands with --list (or filter with --search)
Inspect a specific command with <command> --help
