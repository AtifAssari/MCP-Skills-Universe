---
title: refero-design
url: https://skills.sh/referodesign/refero_skill/refero-design
---

# refero-design

skills/referodesign/refero_skill/refero-design
refero-design
Installation
$ npx skills add https://github.com/referodesign/refero_skill --skill refero-design
Summary

Research-backed design methodology using Refero tools to ground every decision in real product patterns.

Systematic four-phase workflow: discover (brief), research (50+ references), analyze (extract patterns), design (craft execution), implement (validate)
Research-first mindset that hunts for top 10% tactics with exact details (copy, numbers, conditions), not generic best practices
Includes discovery framework (8 questions), search strategy (7 query types), deep-dive tool usage (get_screen, search_flows, get_design_guidance), and analysis templates (pattern table, steal list)
Prevents generic "AI slop" through intentional typography, color, spacing, motion, and at least one memorable distinctive element; includes quality gates and side-by-side validation against references
Covers persuasion layer (hook, objections, trust signals, urgency) before visual execution, plus detailed craft guides for typography scale, letter-spacing, color tokens, spacing rhythm, and accessibility
SKILL.md
...
Typography — What fonts? Serif or sans? What makes headlines feel premium?
Color — Warm or cool? How many colors? What's the accent?
Spacing — Tight or airy? What's the rhythm?
Details — Shadows, borders, radii, gradients?
Icons/Illustrations — Style? Stroke width? Custom or library?
Overall vibe — Premium? Playful? Technical? Minimal?
...
Does this serve THEIR users or MINE?
What's the bold choice that makes it memorable?
What to Extract
...
Patterns identified across references
Specific choices for your design
...
mcp-tools.md	Detailed Refero tool parameters and usage
