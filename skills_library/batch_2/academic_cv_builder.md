...
url: https://skills.sh/paramchoudhary/resumeskills/academic-cv-builder
---

# academic cv builder

skills/paramchoudhary/resumeskills/Academic CV Builder
Academic CV Builder
Installation
$ npx skills add https://github.com/paramchoudhary/resumeskills --skill 'Academic CV Builder'
SKILL.md
Academic CV Builder
