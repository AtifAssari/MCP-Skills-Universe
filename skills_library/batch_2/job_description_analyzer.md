...
url: https://skills.sh/paramchoudhary/resumeskills/job-description-analyzer
---

# job description analyzer

skills/paramchoudhary/resumeskills/Job Description Analyzer
Job Description Analyzer
Installation
...
✅ Extract all requirements (required vs preferred)
✅ Identify all keywords (hard skills, soft skills, industry terms)
✅ Calculate match score
✅ Identify strengths to emphasize
✅ Identify gaps and strategies to address
✅ Detect red flags
✅ Create resume customization plan
✅ Generate cover letter talking points
✅ Research company
✅ Provide application recommendation and timeline
Edge Cases
