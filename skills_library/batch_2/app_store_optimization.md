...
url: https://skills.sh/sickn33/antigravity-awesome-skills/app-store-optimization
---

# app-store-optimization

skills/sickn33/antigravity-awesome-skills/app-store-optimization
app-store-optimization
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill app-store-optimization
Summary
...
Provides ASO health scoring across metadata quality, ratings, keyword performance, and conversion metrics with prioritized improvement recommendations
Supports multi-language localization strategies, pre-launch checklists, and launch timing optimization for global reach
Built-in Python scripts for keyword analysis, competitor benchmarking, review tracking, and test planning across both platforms
SKILL.md
