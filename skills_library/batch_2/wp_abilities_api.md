...
url: https://skills.sh/wordpress/agent-skills/wp-abilities-api
---

# wp-abilities-api

skills/wordpress/agent-skills/wp-abilities-api
wp-abilities-api
Installation
...
Requires WordPress 6.9+ (PHP 7.2.24+) and works with WP core, plugins, and themes; some workflows need WP-CLI
SKILL.md
WP Abilities API
When to use
