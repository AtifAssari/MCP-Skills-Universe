---
title: email-drafter
url: https://skills.sh/github/awesome-copilot/email-drafter
---

# email-drafter

skills/github/awesome-copilot/email-drafter
email-drafter
Installation
$ npx skills add https://github.com/github/awesome-copilot --skill email-drafter
SKILL.md
Email Drafter
...
Save the final draft to outputs/<year>/<month>/ with a descriptive filename (e.g., 2026-03-26-email-acme-followup.md)
Important Rules
