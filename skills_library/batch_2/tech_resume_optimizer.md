...
url: https://skills.sh/paramchoudhary/resumeskills/tech-resume-optimizer
---

# tech resume optimizer

skills/paramchoudhary/resumeskills/Tech Resume Optimizer
Tech Resume Optimizer
Installation
$ npx skills add https://github.com/paramchoudhary/resumeskills --skill 'Tech Resume Optimizer'
Summary
...
Includes role-specific examples for SWE, Data Engineer, DevOps/SRE, and Product Manager with concrete metrics on users, latency, cost savings, and uptime
Covers GitHub profile optimization, project section strategy for early-career candidates, and handling tech stack mismatches in applications
Balances ATS requirements (keyword inclusion, standard headers) with recruiter expectations (system design understanding, collaborative abilities, growth trajectory)
SKILL.md
Tech Resume Optimizer
