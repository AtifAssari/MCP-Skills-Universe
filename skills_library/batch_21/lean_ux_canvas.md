...
url: https://skills.sh/deanpeters/product-manager-skills/lean-ux-canvas
---

# lean-ux-canvas

skills/deanpeters/product-manager-skills/lean-ux-canvas
lean-ux-canvas
Installation
...
I'm not sure what the business problem is — [Agent suggests starting with skills/problem-statement/SKILL.md or skills/problem-framing-canvas/SKILL.md first]
...
I have personas already — [Reference skills/proto-persona/SKILL.md or paste persona]
Help me identify target users — [Agent asks: Who experiences the business problem most? Who's most likely to adopt? Who's easiest to reach?]
I need to create personas first — [Agent suggests using skills/proto-persona/SKILL.md component skill]
...
I need to research this first — [Agent suggests skills/jobs-to-be-done/SKILL.md or skills/discovery-interview-prep/SKILL.md]
...
Suggest related skills to use next (e.g., skills/discovery-interview-prep/SKILL.md for customer interviews)?
Refine a specific box (if something feels incomplete)?
Examples
