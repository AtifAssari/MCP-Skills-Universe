---
title: maplibre-pmtiles-patterns
url: https://skills.sh/maplibre/maplibre-agent-skills/maplibre-pmtiles-patterns
---

# maplibre-pmtiles-patterns

skills/maplibre/maplibre-agent-skills/maplibre-pmtiles-patterns
maplibre-pmtiles-patterns
Installation
...
pmtiles CLI — Simplest way to create PMTiles (convert, show, verify, extract)
Planetiler — OSM → PMTiles/MBTiles
