---
title: figma-design-extraction
url: https://skills.sh/petbrains/mvp-builder/figma-design-extraction
---

# figma-design-extraction

skills/petbrains/mvp-builder/figma-design-extraction
figma-design-extraction
Installation
...
Start at the provided nodeId (or page level like 0:1) to get top-level frames
If response is too large or truncated → narrow to individual pages
For each page, identify top-level frames — these are your screens
...
Focus on top-level frames — skip deeply nested component internals
...
If response is too large → call get_metadata first to get the node map
Identify specific child nodes from metadata
Fetch children individually with get_design_context
Merge results
