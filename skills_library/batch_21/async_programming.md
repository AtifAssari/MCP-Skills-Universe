...
url: https://skills.sh/martinholovsky/claude-skills-generator/async-programming
---

# async-programming

skills/martinholovsky/claude-skills-generator/async-programming
async-programming
Installation
...
Apply semaphores to limit concurrent connections
Use TaskGroup (Python 3.11+) for automatic cleanup
Never block event loop - use run_in_executor for CPU work
Reuse event loops, don't create new ones
