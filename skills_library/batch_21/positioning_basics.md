...
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/positioning-basics
---

# positioning-basics

skills/brianrwagner/ai-marketing-claude-code-skills/positioning-basics
positioning-basics
Installation
$ npx skills add https://github.com/brianrwagner/ai-marketing-claude-code-skills --skill positioning-basics
SKILL.md
Positioning Basics
