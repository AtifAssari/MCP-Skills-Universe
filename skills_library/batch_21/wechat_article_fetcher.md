---
title: wechat-article-fetcher
url: https://skills.sh/nanzhipro/questskills/wechat-article-fetcher
---

# wechat-article-fetcher

skills/nanzhipro/questskills/wechat-article-fetcher
wechat-article-fetcher
Installation
$ npx skills add https://github.com/nanzhipro/questskills --skill wechat-article-fetcher
SKILL.md
微信公众号文章抓取助手
...
图文混排： 保持原有的段落和图片位置关系。
图片本地化： 自动下载远程图片到 images/ 目录，并更新 Markdown 引用路径。
结构化输出： 自动识别标题层级（H1-H6），生成易于阅读的文档。
