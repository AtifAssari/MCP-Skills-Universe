---
title: secretary
url: https://skills.sh/mwguerra/claude-code-plugins/secretary
---

# secretary

skills/mwguerra/claude-code-plugins/secretary
secretary
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill secretary
SKILL.md
Secretary Skill
