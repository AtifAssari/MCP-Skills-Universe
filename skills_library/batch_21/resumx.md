---
title: resumx
url: https://skills.sh/resumx/skills/resumx
---

# resumx

skills/resumx/skills/resumx
resumx
Installation
$ npx skills add https://github.com/resumx/skills --skill resumx
SKILL.md
Resumx
...
Coming from another renderer or builder? Convert and quickstart in one step: resumx.dev/#import. Drop PDF, DOCX, LaTeX, JSON Resume, or RenderCV YAML to get Markdown you can edit and render with Resumx.

Resources
Resource	When
writing-resume.md	Interactive step-by-step resume creation
tagging-resume.md	Systematic tagging for tailored output, hierarchical tag taxonomy
Markdown Syntax
