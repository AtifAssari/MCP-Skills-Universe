---
title: doc-adr-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-adr-fixer
---

# doc-adr-fixer

skills/vladm3105/aidoc-flow-framework/doc-adr-fixer
doc-adr-fixer
Installation
...
Update affected @ref: tags with new upstream version
Refresh decision context if wording changed
Increment ADR patch version (e.g., 1.0.0 -> 1.0.1)
...
Mark decisions as needing review with [REVIEW-SUGGESTED]
Increment ADR minor version (e.g., 1.0.1 -> 1.1.0)
...
Mark all decisions as [SUPERSEDED] (not deleted)
...
If timestamps are equal, prefer ADR-NN.A_audit_report_vNNN.md over ADR-NN.R_review_report_vNNN.md.
Fix Types
Type	Description
...
Create backup in tmp/backup/ADR-NN_YYYYMMDD_HHMMSS/
