---
title: zenmux-usage
url: https://skills.sh/zenmux/skills/zenmux-usage
---

# zenmux-usage

skills/zenmux/skills/zenmux-usage
zenmux-usage
Installation
...
Help them set it: Ask for the key value, then append export ZENMUX_MANAGEMENT_KEY="<key>" to ~/.zshrc and run source ~/.zshrc.
Let them do it themselves: Point them to https://zenmux.ai/platform/management to create the key, and tell them to add it to their shell profile.
