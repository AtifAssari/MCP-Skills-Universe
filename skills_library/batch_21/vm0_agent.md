---
title: vm0-agent
url: https://skills.sh/vm0-ai/vm0-skills/vm0-agent
---

# vm0-agent

skills/vm0-ai/vm0-skills/vm0-agent
vm0-agent
Installation
...
List schedules: Run vm0 schedule ls to show scheduled tasks
List agents: Run vm0 agent ls to show deployed agents
Summarize: Present a clear overview of what's running, when, and any recent activity
...
If not declared in the skill, add it to vm0.yaml's environment section:
...
Ensure the value is stored remotely:
