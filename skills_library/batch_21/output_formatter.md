...
url: https://skills.sh/vangongwanxiaowan/screen-creative-skills/output-formatter
---

# output-formatter

skills/vangongwanxiaowan/screen-creative-skills/output-formatter
output-formatter
Installation
$ npx skills add https://github.com/vangongwanxiaowan/screen-creative-skills --skill output-formatter
SKILL.md
输出整理专家
功能
