---
title: widgets
url: https://skills.sh/mwguerra/claude-code-plugins/widgets
---

# widgets

skills/mwguerra/claude-code-plugins/widgets
widgets
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill widgets
SKILL.md
