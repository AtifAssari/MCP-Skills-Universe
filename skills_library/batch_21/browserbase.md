---
title: browserbase
url: https://skills.sh/vm0-ai/vm0-skills/browserbase
---

# browserbase

skills/vm0-ai/vm0-skills/browserbase
browserbase
Installation
...
Guidelines
Session Lifecycle: Sessions auto-terminate after timeout (default 5 minutes). Use keepAlive: true for longer sessions.
Contexts: Use contexts to persist login state and avoid repeated authentication.
