...
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/newsletter-creation-curation
---

# newsletter-creation-curation

skills/brianrwagner/ai-marketing-claude-code-skills/newsletter-creation-curation
newsletter-creation-curation
Installation
$ npx skills add https://github.com/brianrwagner/ai-marketing-claude-code-skills --skill newsletter-creation-curation
SKILL.md
...
Template match: Which industry template best fits? (Sales Tech = data-heavy; HR Tech = research-led; Fintech = compliance-aware; Ops Tech = practical)
Cadence match: Series A = weekly/bi-weekly for simplicity; Series B = weekly with process; Series C+ = media-grade weekly with pillars
Role constraints: Founder = direct POV allowed; Employee = approval checkpoint required before final draft
Geography adjustments: India-first = IST timing + local examples; US-first = EST/PST + US benchmarks
Goal-content alignment: Lead gen needs a clear conversion CTA; thought leadership needs original insight, not general content
...
Ask: "Does the hook earn the read? Does the playbook feel actionable for your audience?"
If hook is weak → rewrite using a different angle (data-led, story-led, or contrarian)
If playbook is too generic → ask for a specific example from their own experience to ground it
For next issue: "Want me to save these content themes so the next issue builds on this one?"
Output Structure
