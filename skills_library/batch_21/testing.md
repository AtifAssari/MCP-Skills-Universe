---
title: testing
url: https://skills.sh/mwguerra/claude-code-plugins/testing
---

# testing

skills/mwguerra/claude-code-plugins/testing
testing
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill testing
SKILL.md
