---
title: test-plan
url: https://skills.sh/mwguerra/claude-code-plugins/test-plan
---

# test-plan

skills/mwguerra/claude-code-plugins/test-plan
test-plan
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill test-plan
SKILL.md
E2E Test Plan Skill
Overview
