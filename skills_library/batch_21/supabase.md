---
title: supabase
url: https://skills.sh/vm0-ai/vm0-skills/supabase
---

# supabase

skills/vm0-ai/vm0-skills/supabase
supabase
Installation
...
Avoid full-table operations without filters to prevent accidental data loss
API Reference
