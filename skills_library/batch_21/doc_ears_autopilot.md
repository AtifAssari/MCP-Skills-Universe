---
title: doc-ears-autopilot
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-ears-autopilot
---

# doc-ears-autopilot

skills/vladm3105/aidoc-flow-framework/doc-ears-autopilot
doc-ears-autopilot
Installation
...
Validation: Generated documents MUST have document_type: ears-document
...
Skill Delegation: This phase follows rules defined in doc-ears skill. See: .claude/skills/doc-ears/SKILL.md for complete EARS creation guidance.
...
Generate EARS Statements by Category:
...
WHEN [trigger condition], THE [system component] SHALL [action 1], [action 2], and [action 3] WITHIN [timing constraint] (@threshold: PRD.NN.category.key).
...
Generate Quality Attributes Section:
...
Add Threshold References Section:
...
Chunk Formation: Group PRD documents into chunks of maximum 3 at a time
Sequential Chunk Processing: Process one chunk at a time, completing all EARS in a chunk before starting the next
Context Pause: After completing each chunk, provide a summary and pause for user acknowledgment
Progress Tracking: Display chunk progress (e.g., "Chunk 2/5: Processing PRD-04, PRD-05, PRD-06")
