---
title: doc-prd-audit
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-prd-audit
---

# doc-prd-audit

skills/vladm3105/aidoc-flow-framework/doc-prd-audit
doc-prd-audit
Installation
...
Create if .drift_cache.json does not exist
Update last_reviewed timestamp
Append to review_history array with current audit results
Compute SHA-256 hashes for all tracked upstream BRD documents
Set drift_detected: true if any upstream hash changed since last review
...
validator runs (internal)
reviewer runs (internal)
