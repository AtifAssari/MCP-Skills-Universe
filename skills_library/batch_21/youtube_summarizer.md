...
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/youtube-summarizer
---

# youtube-summarizer

skills/brianrwagner/ai-marketing-claude-code-skills/youtube-summarizer
youtube-summarizer
Installation
$ npx skills add https://github.com/brianrwagner/ai-marketing-claude-code-skills --skill youtube-summarizer
SKILL.md
...
Search across transcripts - Use grep or text search to find mentions of specific topics
Track trends - Same topic across multiple videos = rising trend
