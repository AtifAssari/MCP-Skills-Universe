---
title: page-test
url: https://skills.sh/mwguerra/claude-code-plugins/page-test
---

# page-test

skills/mwguerra/claude-code-plugins/page-test
page-test
Installation
...
Detect Build Issues After loading a page, check for:
...
Verify Correct Application Check the snapshot for:
...
Port Discovery (if verification fails) If the page doesn't match expected application:
...
Check Project Configuration If port discovery fails, look for hints in:
...
Best Practices
Wait for Page Load - Don't check elements too quickly
Use Snapshots - Capture state at each step
Check Console/Network - Look for hidden errors
Test All Viewports - Responsive issues are common
Document Everything - Note all elements tested
Test Interactions - Don't just check static content
Handle Dynamic Content - Wait for data to load
Weekly Installs
13
Repository
