---
title: chanjing-avatar
url: https://skills.sh/chanjing-ai/chan-skills/chanjing-avatar
---

# chanjing-avatar

skills/chanjing-ai/chan-skills/chanjing-avatar
chanjing-avatar
Installation
$ npx skills add https://github.com/chanjing-ai/chan-skills --skill chanjing-avatar
SKILL.md
...
Upload your video/audio files using the File Management API to get file_id
Create a lip-syncing task with video and audio/text using these file_id values
Poll the Query Task Detail API or use Task List API to check status
