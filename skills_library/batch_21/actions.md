---
title: actions
url: https://skills.sh/mwguerra/claude-code-plugins/actions
---

# actions

skills/mwguerra/claude-code-plugins/actions
actions
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill actions
SKILL.md
