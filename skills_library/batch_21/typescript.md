---
title: typescript
url: https://skills.sh/martinholovsky/claude-skills-generator/typescript
---

# typescript

skills/martinholovsky/claude-skills-generator/typescript
typescript
Installation
...
No Any Escape Hatch: Use unknown instead of any, then narrow with type guards
Immutable by Default: Prefer readonly and as const for data integrity
Discriminated Unions: Use tagged unions for state machines and error handling
...
Type Guards: Safely narrow unknown data with predicates
