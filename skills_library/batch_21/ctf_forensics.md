---
title: ctf-forensics
url: https://skills.sh/ramzxy/ctf/ctf-forensics
---

# ctf-forensics

skills/ramzxy/ctf/ctf-forensics
ctf-forensics
Installation
...
Look for deceptive names (Unicode lookalikes: ṙ instead of r)
Dump suspicious executables from memory
If PyInstaller-packed: pyinstxtractor → decompile .pyc
...
Extract server certificate from Server Hello packet (Export Packet Bytes → public.der)
Get modulus: openssl x509 -in public.der -inform DER -noout -modulus
Factor weak modulus (dCode, factordb.com, yafu)
Generate private key: rsatool -p P -q Q -o private.pem
