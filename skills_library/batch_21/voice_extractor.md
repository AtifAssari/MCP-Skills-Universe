...
url: https://skills.sh/brianrwagner/ai-marketing-claude-code-skills/voice-extractor
---

# voice-extractor

skills/brianrwagner/ai-marketing-claude-code-skills/voice-extractor
voice-extractor
Installation
...
Casual Slack or email (raw, unedited voice)
Podcast or call transcript
LinkedIn posts or articles
Website copy (often edited, less authentic)
...
Sample authenticity: Are these samples from edited/polished contexts (website, press) or raw contexts (Slack, email)? More polish = less authentic voice.
Sample variety: Do the samples cover different contexts (professional, casual, educational)? Single-context samples produce single-dimension voice guides.
Exclusion check: Identify and flag patterns that are NOT the authentic voice:
...
Sample size adequacy: Is there enough material for full mode, or should I use quick mode?
...
Note 3 things they'd never say
Write 1 sentence describing their energy
