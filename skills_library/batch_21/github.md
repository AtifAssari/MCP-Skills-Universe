---
title: github
url: https://skills.sh/vercel-labs/emulate/github
---

# github

skills/vercel-labs/emulate/github
github
Installation
$ npx skills add https://github.com/vercel-labs/emulate --skill github
SKILL.md
GitHub API Emulator
...
OAuth Flow
Redirect user to $GITHUB_EMULATOR_URL/login/oauth/authorize?client_id=...&redirect_uri=...&scope=user+repo&state=...
User picks a seeded user on the emulator's UI
Emulator redirects back with ?code=...&state=...
Exchange code for token via POST /login/oauth/access_token
Use token to call API endpoints
Weekly Installs
35
Repository
vercel-labs/emulate
