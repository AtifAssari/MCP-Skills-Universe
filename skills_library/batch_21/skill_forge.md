---
title: skill-forge
url: https://skills.sh/spm1001/claude-suite/skill-forge
---

# skill-forge

skills/spm1001/claude-suite/skill-forge
skill-forge
Installation
...
BEFORE conditions in description
Specific trigger phrases in quotes
Method preview that's actionable
Clear anti-patterns that catch mistakes
