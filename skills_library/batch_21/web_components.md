...
url: https://skills.sh/manzdev/web-core/web-components
---

# web-components

skills/manzdev/web-core/web-components
web-components
Installation
$ npx skills add https://github.com/manzdev/web-core --skill web-components
SKILL.md
