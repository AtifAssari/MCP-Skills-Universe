...
url: https://skills.sh/spm1001/claude-suite/github-cleanup
---

# github-cleanup

skills/spm1001/claude-suite/github-cleanup
github-cleanup
Installation
...
Search all source files for third-party imports
Report two lists:
...
References
gh-cli-patterns.md - Complete CLI reference with jq patterns
audit-checklist.md - Comprehensive "what did we miss?" checklist
cleanup-operations.md - Safe patterns for destructive operations
Weekly Installs
12
Repository
