---
title: doc-ears-fixer
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-ears-fixer
---

# doc-ears-fixer

skills/vladm3105/aidoc-flow-framework/doc-ears-fixer
doc-ears-fixer
Installation
...
Upstream: PRD (Layer 2) Downstream: BDD (Layer 4) ID Pattern: EARS.NN.xxxx (e.g., EARS.01.2513)
...
Run /doc-ears-fixer EARS-01 --acknowledge-drift
Fixer prompts: "Review drift for PRD-01.md Section 8?"
User confirms no EARS changes needed
...
If timestamps are equal, prefer EARS-NN.A_audit_report_vNNN.md over EARS-NN.R_review_report_vNNN.md.
Fix Types
Type	Description
...
Create backup in tmp/backup/EARS-NN_YYYYMMDD_HHMMSS/
Copy all EARS files to backup location
