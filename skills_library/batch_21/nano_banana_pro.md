...
url: https://skills.sh/enzed/skills/nano-banana-pro
---

# nano-banana-pro

skills/enzed/skills/nano-banana-pro
nano-banana-pro
Installation
...
API Key: The script loads from .env automatically. Only ask the user if the script fails with "No API key found".
