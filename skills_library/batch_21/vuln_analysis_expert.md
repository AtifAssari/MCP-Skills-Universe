---
title: vuln-analysis-expert
url: https://skills.sh/tanweai/wooyun-legacy/vuln-analysis-expert
---

# vuln-analysis-expert

skills/tanweai/wooyun-legacy/vuln-analysis-expert
vuln-analysis-expert
Installation
...
边界思维: 所有漏洞都发生在信任边界上
数据流追踪: 跟踪数据从输入到输出的完整路径
假设挑战: 质疑每一个"理所当然"的校验
组合利用: 单个低危漏洞可组合成高危攻击链
