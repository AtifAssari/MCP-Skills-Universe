---
title: business-model-auditor
url: https://skills.sh/shipshitdev/library/business-model-auditor
---

# business-model-auditor

skills/shipshitdev/library/business-model-auditor
business-model-auditor
Installation
$ npx skills add https://github.com/shipshitdev/library --skill business-model-auditor
SKILL.md
...
First: Fix the lowest-cost, highest-impact bottleneck
Second: Fix what directly impacts revenue
Third: Fix what impacts margin
Fourth: Fix what impacts customer experience
Output Format
...
Ignoring your time cost: Counting "profit" without valuing your hours
Hoping margins improve: They usually get worse at scale without action
Hiring to fix bottlenecks: Sometimes the fix is automation or elimination
Scaling before fixing: 10x a broken model = 10x the problems
Complexity creep: Adding services that don't scale
Vanity revenue: Growing revenue while margins shrink
