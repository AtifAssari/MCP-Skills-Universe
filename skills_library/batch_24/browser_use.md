---
title: browser-use
url: https://skills.sh/kudosx/claude-skill-browser-use/browser-use
---

# browser-use

skills/kudosx/claude-skill-browser-use/browser-use
browser-use
Installation
$ npx skills add https://github.com/kudosx/claude-skill-browser-use --skill browser-use
SKILL.md
Browser Use Skill
Overview
