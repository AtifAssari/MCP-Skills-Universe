---
title: create-opencode-plugin
url: https://skills.sh/igorwarzocha/opencode-workflows/create-opencode-plugin
---

# create-opencode-plugin

skills/igorwarzocha/opencode-workflows/create-opencode-plugin
create-opencode-plugin
Installation
