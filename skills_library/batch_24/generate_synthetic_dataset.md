...
url: https://skills.sh/orq-ai/assistant-plugins/generate-synthetic-dataset
---

# generate-synthetic-dataset

skills/orq-ai/assistant-plugins/generate-synthetic-dataset
generate-synthetic-dataset
Installation
$ npx skills add https://github.com/orq-ai/assistant-plugins --skill generate-synthetic-dataset
SKILL.md
Generate Synthetic Dataset
...
Generate in batches of 10-20. Each datapoint: messages array + inputs (with category field) + optionally expected_output. Vary input lengths, ensure diverse categories.
...
orq MCP tools — query live data first (create_dataset, create_datapoints); API responses are always authoritative
