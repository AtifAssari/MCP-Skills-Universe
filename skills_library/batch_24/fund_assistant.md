...
url: https://skills.sh/xer97/fund-assistant/fund-assistant
---

# fund-assistant

skills/xer97/fund-assistant/fund-assistant
fund-assistant
Installation
...
注意事项
首次使用需运行 portfolio.py init 初始化数据目录
实时估值使用天天基金接口 http://fundgz.1234567.com.cn/js/{code}.js
交易时段：9:30-11:30, 13:00-15:00（排除节假日）
QDII基金估值可能延迟，部分新发基金无估值数据
Weekly Installs
188
Repository
xer97/fund-assistant
GitHub Stars
2
First Seen
Feb 18, 2026
