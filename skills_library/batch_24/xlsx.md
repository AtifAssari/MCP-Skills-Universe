---
title: xlsx
url: https://skills.sh/marcelleon/skills-zh/xlsx
---

# xlsx

skills/marcelleon/skills-zh/xlsx
xlsx
Installation
...
通用工作流
选工具：数据处理用 pandas，公式/格式用 openpyxl
新建或加载工作簿
修改数据、公式、样式
保存文件
若含公式，必须执行 scripts/recalc.py
读取 JSON 报告，修复错误后再次回算，直到零错误
