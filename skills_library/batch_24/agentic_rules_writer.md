---
title: agentic-rules-writer
url: https://skills.sh/krzysztofsurdy/code-virtuoso/agentic-rules-writer
---

# agentic-rules-writer

skills/krzysztofsurdy/code-virtuoso/agentic-rules-writer
agentic-rules-writer
Installation
$ npx skills add https://github.com/krzysztofsurdy/code-virtuoso --skill agentic-rules-writer
SKILL.md
Agentic Rules Writer
...
Q14. Boundaries (never-do list) Options:
...
Q15. Agent parallelization Options:
...
Q18. Communication style Options:
...
Q20. Additional comments Free-text. Ask: "Any additional rules, preferences, or comments you'd like included?"
...
Skills section -- one bullet per installed skill: When [trigger from description] -> use /skill-name
Custom Agents section -- agents with capability summary (read-only vs worktree, specialist vs role)
Agent Roles section -- role agents with their domain of responsibility
Teams section -- pre-composed teams with lead and use case
