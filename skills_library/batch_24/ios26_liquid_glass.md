...
url: https://skills.sh/site/smithery.ai/ios26-liquid-glass
---

# ios26-liquid-glass

skills/smithery.ai/ios26-liquid-glass
ios26-liquid-glass
$ npx skills add https://smithery.ai/skills/praveenperera/ios26-liquid-glass
SKILL.md
...
Elements must be within the same GlassEffectContainer
Each view needs glassEffectID with shared namespace
Views must be conditionally shown/hidden
