...
url: https://skills.sh/igorwarzocha/opencode-workflows/user-onboarding-sop
---

# user-onboarding-sop

skills/igorwarzocha/opencode-workflows/user-onboarding-sop
user-onboarding-sop
Installation
$ npx skills add https://github.com/igorwarzocha/opencode-workflows --skill user-onboarding-sop
SKILL.md
User Onboarding SOP
