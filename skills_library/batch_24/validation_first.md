...
url: https://skills.sh/juliusbrussee/cavekit/validation-first
---

# validation-first

skills/juliusbrussee/cavekit/validation-first
validation-first
Installation
...
Clean up after each merge: delete the merged branch (git branch -D <branch>).
If a merge fails validation, fix it before proceeding to the next merge
Completion Signals
