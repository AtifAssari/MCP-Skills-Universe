---
title: plot-deliver
url: https://skills.sh/eins78/skills/plot-deliver
---

# plot-deliver

skills/eins78/skills/plot-deliver
plot-deliver
Installation
...
Extract deliverables from the plan file. Look for actionable items in sections like ## Design, ## Branches, or bulleted lists that describe what should be built. Number each deliverable for reference.
...
Changesets: Does .changeset/config.json exist? If so, the project uses @changesets/cli. Check if .changeset/*.md files (excluding README.md) exist on main.
