---
title: plan-execute
url: https://skills.sh/longranger2/claude-gpt-workflow/plan-execute
---

# plan-execute

skills/longranger2/claude-gpt-workflow/plan-execute
plan-execute
Installation
...
I write the review into the reviews/ directory, then ask Codex to inspect and fix the issues.
...
Run pnpm build to confirm the compilation status.
