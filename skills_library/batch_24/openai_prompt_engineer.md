---
title: openai-prompt-engineer
url: https://skills.sh/jamesrochabrun/skills/openai-prompt-engineer
---

# openai-prompt-engineer

skills/jamesrochabrun/skills/openai-prompt-engineer
openai-prompt-engineer
Installation
...
FIRST: Identify key metrics and trends
THEN: Calculate:
Growth rate (month-over-month)
Average values
Anomalies or outliers
NEXT: Draw business insights
