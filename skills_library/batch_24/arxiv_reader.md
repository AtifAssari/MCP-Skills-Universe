---
title: arxiv-reader
url: https://skills.sh/site/skills.volces.com/arxiv-reader
---

# arxiv-reader

skills/skills.volces.com/arxiv-reader
arxiv-reader
$ npx skills add https://skills.volces.com/skills/clawhub/willamhou
SKILL.md
arxiv-reader
...
Process
Quick look — Use arxiv_abstract to get a paper's abstract before committing to a full read
Survey structure — Use arxiv_sections to understand the paper's outline
Deep read — Use arxiv_fetch to get the full flattened LaTeX for analysis
Tools
arxiv_fetch
