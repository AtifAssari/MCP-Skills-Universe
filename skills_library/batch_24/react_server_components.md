...
url: https://skills.sh/patternsdev/skills/react-server-components
---

# react-server-components

skills/patternsdev/skills/react-server-components
react-server-components
Installation
$ npx skills add https://github.com/patternsdev/skills --skill react-server-components
SKILL.md
React Server Components
Table of Contents
When to Use
...
The React Server Components reference is the best current overview.
The RFC is still useful for deeper implementation context.
Next.js App Router documentation for the modern approach to Server Components
...
Source
patterns.dev/react/react-server-components
References
