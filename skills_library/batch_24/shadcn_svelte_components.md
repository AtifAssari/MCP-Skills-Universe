...
url: https://skills.sh/exceptionless/exceptionless/shadcn-svelte-components
---

# shadcn-svelte components

skills/exceptionless/exceptionless/shadcn-svelte Components
shadcn-svelte Components
Installation
$ npx skills add https://github.com/exceptionless/exceptionless --skill 'shadcn-svelte Components'
SKILL.md
shadcn-svelte Components
