...
url: https://skills.sh/igorwarzocha/opencode-workflows/model-researcher
---

# model-researcher

skills/igorwarzocha/opencode-workflows/model-researcher
model-researcher
Installation
$ npx skills add https://github.com/igorwarzocha/opencode-workflows --skill model-researcher
SKILL.md
Model Researcher
...
Confirm the model actually exists
Find the exact model identifier (API name, not marketing name)
Get verified context and output token limits
Identify required provider configuration
...
Official provider documentation/blog posts
Provider's API reference or changelog
Official GitHub repos or release notes
OpenRouter/Together model pages (they list specs)
Reputable tech news (for very new announcements)
