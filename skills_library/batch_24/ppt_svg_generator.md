---
title: ppt-svg-generator
url: https://skills.sh/vigorx777/ppt-svg-generator/ppt-svg-generator
---

# ppt-svg-generator

skills/vigorx777/ppt-svg-generator/ppt-svg-generator
ppt-svg-generator
Installation
$ npx skills add https://github.com/vigorx777/ppt-svg-generator --skill ppt-svg-generator
SKILL.md
PPT SVG 生成器
...
分析文稿 - 智能拆解内容，生成页面结构清单
设计风格 - 5种预设风格 + 自定义 + AI智能推荐
批量生成 - 输出符合 PPT 兼容性规范的 SVG 文件
👋 使用提示
...
文稿分析 - 提取核心关键词、识别文章调性（正式/轻松、理性/感性）
联网搜索 - 搜索相关主题的 PPT 设计案例和趋势
综合推荐 - 输出每页的风格推荐、配色方案、视觉隐喻建议
