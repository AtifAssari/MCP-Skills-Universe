...
url: https://skills.sh/tiancheng91/wechat-msg-send/wechat-message
---

# wechat-message

skills/tiancheng91/wechat-msg-send/wechat-message
wechat-message
Installation
...
工作流程
激活微信 - 将微信窗口置于最前
打开搜索 - 使用 Cmd+F 打开联系人搜索框
搜索联系人 - 粘贴用户名并选择第一个匹配结果
定位输入框 - 通过 Tab 键和点击确保焦点在输入框
发送消息 - 粘贴消息内容并按回车发送
隐藏窗口 - 发送完成后隐藏微信窗口
注意事项
