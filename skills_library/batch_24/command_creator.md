...
url: https://skills.sh/igorwarzocha/opencode-workflows/command-creator
---

# command-creator

skills/igorwarzocha/opencode-workflows/command-creator
command-creator
Installation
...
"Should it make changes or just analyze?"

Changes → default agent (build)
Analysis only → set agent: plan

"Should it run as a background subtask?"

Long-running or parallel work → set subtask: true
Interactive or quick → leave unset

"Project-specific or use everywhere?"

Project → .opencode/command/
Global → ~/.config/opencode/command/
Phase 3: Review & Refine
Show the draft command, ask for feedback
