---
title: drawio
url: https://skills.sh/agents365-ai/drawio-skill/drawio
---

# drawio

skills/agents365-ai/drawio-skill/drawio
drawio
Installation
$ npx skills add https://github.com/agents365-ai/drawio-skill --skill drawio
SKILL.md
Draw.io Diagrams
Overview
...
Generate — write .drawio XML file to disk (output dir same as user's working dir)
Export draft — run CLI to produce PNG for preview
