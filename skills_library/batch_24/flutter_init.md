---
title: flutter-init
url: https://skills.sh/bear2u/my-skills/flutter-init
---

# flutter-init

skills/bear2u/my-skills/flutter-init
flutter-init
Installation
...
Android 설정 업데이트 (CRITICAL for flutter_local_notifications):

android/app/build.gradle.kts에 core library desugaring 활성화:
android {
    compileOptions {
