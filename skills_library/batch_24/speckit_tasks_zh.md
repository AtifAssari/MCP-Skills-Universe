---
title: speckit-tasks-zh
url: https://skills.sh/forztf/open-skilled-sdd/speckit-tasks-zh
---

# speckit-tasks-zh

skills/forztf/open-skilled-sdd/speckit-tasks-zh
speckit-tasks-zh
Installation
...
设置：从仓库根目录运行 {SCRIPT} 并解析 FEATURE_DIR 和 AVAILABLE_DOCS 列表。所有路径必须是绝对的。对于参数中的单引号，如 "I'm Groot"，使用转义语法：例如 'I'''m Groot'（或者如果可能的话使用双引号："I'm Groot"）。
...
复选框：始终以 - [ ] 开头（markdown 复选框）
任务 ID：按执行顺序的序列号（T001, T002, T003...）
