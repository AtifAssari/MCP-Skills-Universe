...
url: https://skills.sh/alirezarezvani/claude-code-skill-factory/ms365-tenant-manager
---

# ms365-tenant-manager

skills/alirezarezvani/claude-code-skill-factory/ms365-tenant-manager
ms365-tenant-manager
Installation
$ npx skills add https://github.com/alirezarezvani/claude-code-skill-factory --skill ms365-tenant-manager
SKILL.md
