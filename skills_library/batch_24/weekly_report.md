---
title: weekly-report
url: https://skills.sh/adonis0123/adonis-skills/weekly-report
---

# weekly-report

skills/adonis0123/adonis-skills/weekly-report
weekly-report
Installation
$ npx skills add https://github.com/adonis0123/adonis-skills --skill weekly-report
SKILL.md
周报生成技能
...
标题行固定为 下周计划（无 # 前缀，与项目名同级）
从本周周报正文中提取所有出现过的项目名（不含"其他"），按原顺序列出
每个项目名下放一行 - 作为占位符，方便用户后续填写
如果用户在交互中主动提供了下周计划内容，直接填入对应项目下，不再使用占位符
示例输出
# 周报 (2026-01-06 ~ 2026-01-12)
