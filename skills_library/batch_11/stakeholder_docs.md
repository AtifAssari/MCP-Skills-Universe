---
title: stakeholder-docs
url: https://skills.sh/anton-abyzov/specweave/stakeholder-docs
---

# stakeholder-docs

skills/anton-abyzov/specweave/stakeholder-docs
stakeholder-docs
Installation
...
Focus on outcomes - "Reduced wait time by 40%" not "Optimized database queries"
Include metrics - Numbers make impact tangible
Highlight risks early - Stakeholders need to know blockers
Show progress visually - Tables, percentages, trends
DON'T
Don't include technical details - No code, no architecture diagrams
Don't use developer terminology - "API" → "integration", "deploy" → "release"
Don't bury bad news - Lead with blockers if they exist
Don't overload with data - Curate, don't dump
Output Locations
