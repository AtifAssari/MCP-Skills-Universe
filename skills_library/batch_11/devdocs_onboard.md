---
title: devdocs-onboard
url: https://skills.sh/ab300819/skills/devdocs-onboard
---
...
下一步
交接方（工具 A）
完成阶段性工作后，运行 /devdocs-onboard --update
将 00-context.md 内容传递给新 AI 工具
接手方（工具 B）
运行 /devdocs-onboard --read 了解项目
从"待办任务"部分继续开发
完成工作后运行 /devdocs-onboard --update 更新上下文
Weekly Installs
37
Repository
ab300819/skills
