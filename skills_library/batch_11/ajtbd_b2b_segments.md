---
title: ajtbd-b2b-segments
url: https://skills.sh/snowtema/ajtbd-skills/ajtbd-b2b-segments
---

# ajtbd-b2b-segments

skills/snowtema/ajtbd-skills/ajtbd-b2b-segments
ajtbd-b2b-segments
Installation
$ npx skills add https://github.com/snowtema/ajtbd-skills --skill ajtbd-b2b-segments
SKILL.md
...
Проверь наличие папки .ajtbd/ в текущем проекте с помощью Bash (ls .ajtbd/ 2>/dev/null).
Если папки нет — создай её: mkdir -p .ajtbd
Если файл .ajtbd/segments.md уже существует — прочитай его и предупреди пользователя: «Найдено предыдущее исследование сегментов. Продолжить и перезаписать?». Дождись подтверждения.
После выполнения
...
Важно: Сегмент — это не просто отрасль, не "малый бизнес" и не должность. Это совокупность компаний и людей с похожими наборами бизнес- и личных работ, выполняемых в схожем контексте и по схожим критериям.
...
Критерии выполнения: – [ключевые критерии успеха — по мнению компании и/или ЛПР]

Что за люди: – [тип компании, роль ЛПР, жизненная или организационная ситуация, внешний триггер]
...
Почему сегмент привлекателен: – [1–2 абзаца: высокая ценность, личная мотивация ЛПР, влияние на покупку, повторные сделки, простота выхода, незакрытые работы, апсейлы и т.д.]
