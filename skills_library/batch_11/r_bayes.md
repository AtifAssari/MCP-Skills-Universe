---
title: r-bayes
url: https://skills.sh/ab604/claude-code-r-skills/r-bayes
---

# r-bayes

skills/ab604/claude-code-r-skills/r-bayes
r-bayes
Installation
$ npx skills add https://github.com/ab604/claude-code-r-skills --skill r-bayes
SKILL.md
Core Packages
library(brms)
library(cmdstanr)
