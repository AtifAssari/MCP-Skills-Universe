---
title: shadcn-component-discovery
url: https://skills.sh/mattbx/shadcn-skills/shadcn-component-discovery
---

# shadcn-component-discovery

skills/mattbx/shadcn-skills/shadcn-component-discovery
shadcn-component-discovery
Installation
...
For the full catalog including URLs, configuration snippets, and registry specialties, see references/registries.md.

Response Requirements

Every discovery response should surface:

What was searched — the query used
Top 2–3 recommendations — registry-qualified name, one-line description, why it fits
Install command — ready to copy
A recommendation — which to pick, when there's a clear fit
Next-step options — install, view code, see more, build custom
...
@reui/data-grid-table — Full-featured grid with sorting, filtering, pagination
@shadcn/table — Unstyled primitives (pair with TanStack Table for sorting)
