...
url: https://skills.sh/pcvelz/superpowers/dispatching-parallel-agents
---

# dispatching-parallel-agents

skills/pcvelz/superpowers/dispatching-parallel-agents
dispatching-parallel-agents
Originally fromobra/superpowers
Installation
$ npx skills add https://github.com/pcvelz/superpowers --skill dispatching-parallel-agents
SKILL.md
Dispatching Parallel Agents
Overview
