---
title: tidbx-nextjs
url: https://skills.sh/pingcap/agent-rules/tidbx-nextjs
---

# tidbx-nextjs

skills/pingcap/agent-rules/tidbx-nextjs
tidbx-nextjs
Installation
...
Use a direct driver (mysql2) only for minimal demos or when you need raw SQL without an ORM.
Run TCP database clients in the Node.js runtime (not Edge).
