---
title: client-dev
url: https://skills.sh/contextvm/cvmi/client-dev
---
...
Reference Materials
references/nostr-way-without-sdks.md - The Nostr primitives behind CVM (raw events, JSON-RPC, manual implementation)
references/discovery.md - Server discovery patterns
references/proxy-pattern.md - Using NostrMCPProxy
references/stateless-mode.md - Stateless connection details
Weekly Installs
31
Repository
contextvm/cvmi
