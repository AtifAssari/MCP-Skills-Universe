...
url: https://skills.sh/mcp-use/skills/chatgpt-app-builder
---

# chatgpt-app-builder

skills/mcp-use/skills/chatgpt-app-builder
chatgpt-app-builder
Installation
...
Use exact domains - avoid wildcards in production
Test in Inspector before deploying to catch CSP issues early
Environment variable alternative: Set CSP_URLS environment variable with comma-separated domains
