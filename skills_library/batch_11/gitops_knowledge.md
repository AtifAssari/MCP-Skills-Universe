---
title: gitops-knowledge
url: https://skills.sh/fluxcd/agent-skills/gitops-knowledge
---

# gitops-knowledge

skills/fluxcd/agent-skills/gitops-knowledge
gitops-knowledge
Installation
...
Create a FluxInstance named flux in the flux-system namespace
Configure .spec.sync to point to your Git repo or OCI registry
Organize manifests in the source repo using Kustomize base+overlay pattern
Create Kustomization resources to apply manifests from the source
Add Provider + Alert for notifications
