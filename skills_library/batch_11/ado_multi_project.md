---
title: ado-multi-project
url: https://skills.sh/anton-abyzov/specweave/ado-multi-project
---

# ado-multi-project

skills/anton-abyzov/specweave/ado-multi-project
ado-multi-project
Installation
...
Creating project-specific folder structures in .specweave/docs/internal/specs/
Mapping user stories to correct projects based on keywords and context
...
✅ Intelligent project detection from spec content
✅ Automatic folder organization by project/area/team
✅ Task splitting across multiple projects
✅ Cross-project linking and dependency tracking
