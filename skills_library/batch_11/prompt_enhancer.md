...
url: https://skills.sh/sammcj/agentic-coding/prompt-enhancer
---

# prompt-enhancer

skills/sammcj/agentic-coding/prompt-enhancer
prompt-enhancer
Installation
...
Identify the domain - Who would professionally handle this? What terminology and standards apply?
Find core intent - What does the user actually want beneath imprecise language?
Surface ambiguity - Fill obvious gaps with reasonable defaults. Only flag genuine ambiguities where guessing could go wrong.
Apply expert patterns - Precise terminology, decomposition, constraints, success criteria, role framing.
Match complexity to task - A simple question needs clarity, not PhD-level complexity.
Examples
