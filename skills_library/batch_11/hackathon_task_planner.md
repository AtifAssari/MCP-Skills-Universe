---
title: hackathon-task-planner
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-task-planner
---

# hackathon-task-planner

skills/bernieweb3/hackathon-ai-devkit/hackathon-task-planner
hackathon-task-planner
Installation
...
Rules
Decompose every MVP feature into tasks of 30 minutes to 3 hours each.
Include setup, integration, and deployment tasks explicitly.
Assign each task to exactly one role from team_roles (or "any" if unspecified).
Identify the critical path as the longest dependency chain.
Reserve buffer_hours = 15% of remaining hackathon time minimum.
Order milestones at 25%, 50%, 75%, and 90% of remaining time.
Flag any task without a clear owner as [UNASSIGNED].
Output Format
tasks:
  - id: "T-<number>"
    title: "<task title>"
