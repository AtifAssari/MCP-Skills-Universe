...
url: https://skills.sh/ericgandrade/claude-superskills/agent-skill-orchestrator
---

# agent-skill-orchestrator

skills/ericgandrade/claude-superskills/agent-skill-orchestrator
agent-skill-orchestrator
Installation
$ npx skills add https://github.com/ericgandrade/claude-superskills --skill agent-skill-orchestrator
SKILL.md
agent-skill-orchestrator
Purpose
...
Analysis/discovery resources first (if task requires understanding existing state)
Implementation resources in the middle (create, build, transform)
Validation/review resources last (check, audit, confirm)
