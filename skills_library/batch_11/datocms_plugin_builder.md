---
title: datocms-plugin-builder
url: https://skills.sh/datocms/agent-skills/datocms-plugin-builder
---

# datocms-plugin-builder

skills/datocms/agent-skills/datocms-plugin-builder
datocms-plugin-builder
Installation
...
Read package.json and confirm the plugin uses datocms-plugin-sdk.
Find the entry file that calls connect() (src/main.tsx, src/index.tsx, or equivalent).
Inspect the existing connect() call before changing any hook.
