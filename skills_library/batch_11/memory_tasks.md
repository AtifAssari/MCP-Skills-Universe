---
title: memory-tasks
url: https://skills.sh/basicmachines-co/basic-memory-skills/memory-tasks
---

# memory-tasks

skills/basicmachines-co/basic-memory-skills/memory-tasks
memory-tasks
Installation
...
Find all active tasks: search_notes(note_types=["task"], status="active")
For each, update:
