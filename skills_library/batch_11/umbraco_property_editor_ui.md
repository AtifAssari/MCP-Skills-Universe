---
title: umbraco-property-editor-ui
url: https://skills.sh/umbraco/umbraco-cms-backoffice-skills/umbraco-property-editor-ui
---

# umbraco-property-editor-ui

skills/umbraco/umbraco-cms-backoffice-skills/umbraco-property-editor-ui
umbraco-property-editor-ui
Installation
...
WARNING: The propertyEditorSchemaAlias below uses Umbraco.Plain.String, a built-in schema. If you use a custom alias like MyPackage.CustomSchema, you MUST have a corresponding C# DataEditor on the server or you'll get a 404 error when creating a Data Type.
