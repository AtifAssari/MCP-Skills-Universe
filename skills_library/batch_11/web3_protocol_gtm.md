---
title: web3-protocol-gtm
url: https://skills.sh/tenequm/skills/web3-protocol-gtm
---

# web3-protocol-gtm

skills/tenequm/skills/web3-protocol-gtm
web3-protocol-gtm
Installation
$ npx skills add https://github.com/tenequm/skills --skill web3-protocol-gtm
SKILL.md
Web3 Protocol GTM
...
First 100 Users
Weeks 1-4: Map 20-30 CT accounts, engage genuinely, join 3-5 Telegram groups
Weeks 5-6: Launch via CT + Telegram + hackathon communities + Reddit
Weeks 6-12: Personally onboard every user, ask for 1 referral each, create case studies
