---
title: byted-bytehouse-load-analyzer
url: https://skills.sh/site/skills.volces.com/byted-bytehouse-load-analyzer
---

# byted-bytehouse-load-analyzer

skills/skills.volces.com/byted-bytehouse-load-analyzer
byted-bytehouse-load-analyzer
...
resource_usage_{timestamp}.json - 资源使用报告
query_load_{timestamp}.json - 查询负载报告
table_load_{timestamp}.json - 表负载报告
bottleneck_analysis_{timestamp}.json - 瓶颈分析报告
💻 负载分析维度
资源维度
CPU: 使用率、等待时间、上下文切换
内存: 使用量、缓存、Swap使用
