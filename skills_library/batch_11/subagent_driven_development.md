...
url: https://skills.sh/pcvelz/superpowers/subagent-driven-development
---

# subagent-driven-development

skills/pcvelz/superpowers/subagent-driven-development
subagent-driven-development
Originally fromobra/superpowers
Installation
$ npx skills add https://github.com/pcvelz/superpowers --skill subagent-driven-development
SKILL.md
Subagent-Driven Development
...
Read the task's description via TaskGet — metadata is embedded as a json:metadata code fence at the end
