---
title: trust-web3-provider
url: https://skills.sh/trustwallet/tw-agent-skills/trust-web3-provider
---

# trust-web3-provider

skills/trustwallet/tw-agent-skills/trust-web3-provider
trust-web3-provider
Installation
$ npx skills add https://github.com/trustwallet/tw-agent-skills --skill trust-web3-provider
SKILL.md
...
See references/chain-providers.md for full setup examples for each chain (Ethereum, Solana, Cosmos, Bitcoin, Aptos, TON, Tron) and multi-chain configuration. Read that file when you need chain-specific provider configuration, constructor options, or method signatures.
