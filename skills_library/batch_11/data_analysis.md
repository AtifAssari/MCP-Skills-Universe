---
title: data-analysis
url: https://skills.sh/pedrohcgs/claude-code-my-workflow/data-analysis
---

# data-analysis

skills/pedrohcgs/claude-code-my-workflow/data-analysis
data-analysis
Installation
...
Background-launch: Rscript scripts/R/03_analyze.R with run_in_background: true. Capture the bash_id.
Use Monitor on the bash_id until a milestone fires (e.g., Coefficients table written, or process exit).
