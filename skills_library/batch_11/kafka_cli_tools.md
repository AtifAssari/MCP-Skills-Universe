...
url: https://skills.sh/anton-abyzov/specweave/kafka-cli-tools
---

# kafka-cli-tools

skills/anton-abyzov/specweave/kafka-cli-tools
kafka-cli-tools
Installation
...
Use SSL/TLS in production - Configure -X security.protocol=SASL_SSL
Prefer SCRAM over PLAIN - Use -X sasl.mechanism=SCRAM-SHA-256
Rotate credentials regularly - Update passwords and certificates
Least privilege - Grant only necessary ACLs to users
Related Skills
