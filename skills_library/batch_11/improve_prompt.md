...
url: https://skills.sh/b4r7x/agent-skills/improve-prompt
---

# improve-prompt

skills/b4r7x/agent-skills/improve-prompt
improve-prompt
Installation
$ npx skills add https://github.com/b4r7x/agent-skills --skill improve-prompt
SKILL.md
Improve Prompt
