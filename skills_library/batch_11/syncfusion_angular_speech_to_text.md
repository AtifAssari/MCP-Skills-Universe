---
title: syncfusion-angular-speech-to-text
url: https://skills.sh/syncfusion/angular-ui-components-skills/syncfusion-angular-speech-to-text
---

# syncfusion-angular-speech-to-text

skills/syncfusion/angular-ui-components-skills/syncfusion-angular-speech-to-text
syncfusion-angular-speech-to-text
Installation
