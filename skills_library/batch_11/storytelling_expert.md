...
url: https://skills.sh/ericgandrade/claude-superskills/storytelling-expert
---

# storytelling-expert

skills/ericgandrade/claude-superskills/storytelling-expert
storytelling-expert
Installation
$ npx skills add https://github.com/ericgandrade/claude-superskills --skill storytelling-expert
SKILL.md
📖 Storytelling Expert
...
Context Analysis: Identifies the target audience, objective, and central message.
If the request is vague, asks short clarifying questions.
Framework Selection: Picks ONE of the 8 frameworks that best fits.
Narrative Development: Rewrites the content applying the framework.
Makes the structure visible (e.g., separating sections).
Uses clear formatting (bold, bullet points).
Final Delivery: Presents only the result. Does not explain the thought process.
