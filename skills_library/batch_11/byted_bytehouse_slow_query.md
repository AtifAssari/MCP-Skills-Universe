---
title: byted-bytehouse-slow-query
url: https://skills.sh/site/skills.volces.com/byted-bytehouse-slow-query
---

# byted-bytehouse-slow-query

skills/skills.volces.com/byted-bytehouse-slow-query
byted-bytehouse-slow-query
...
slow_queries_{timestamp}.json - 慢查询列表
query_stats_{timestamp}.json - 查询统计报告
optimization_suggestions_{timestamp}.json - 优化建议
💻 慢查询分析维度
时间维度分析
按小时: 每小时慢查询数量
按天: 每天慢查询趋势
