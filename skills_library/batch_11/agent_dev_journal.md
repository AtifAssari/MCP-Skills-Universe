---
title: agent-dev-journal
url: https://skills.sh/lmcjt37/agent-dev-journal/agent-dev-journal
---

# agent-dev-journal

skills/lmcjt37/agent-dev-journal/agent-dev-journal
agent-dev-journal
Installation
...
Golden rules
Never write outside the repo root. Determine the closest git root before writing anything.
Keep journal.md readable. It’s a narrative “best-of album”, medium-fun, ~400–500 words per entry max.
Always keep receipts. Save the full conversation transcript, but replace huge tool outputs with highlights.
Decisions must be explicit. Record the decision, why, alternatives, tradeoffs, and consequences.
Observations for comparison. Record observations for later analysis and clear separation.
Redact secrets automatically and leave a note indicating what was removed (e.g., “[REDACTED: API_TOKEN]”).
