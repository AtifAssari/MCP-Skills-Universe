---
title: create-skill
url: https://skills.sh/dcjanus/prompts/create-skill
---

# create-skill

skills/dcjanus/prompts/create-skill
create-skill
Installation
$ npx skills add https://github.com/dcjanus/prompts --skill create-skill
SKILL.md
Create Skill（本仓库约定）
1) 目录结构与命名
...
Quick start（最短可复制示例）
常用场景/命令（3-7 条为宜）
输出约定（如机器可读输出，明确 --json 等约定）
冷门参数怎么查（--help + reference 指针）
资源（指向脚本/参考资料/模板）
