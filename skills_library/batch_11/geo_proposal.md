---
title: geo-proposal
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-proposal
---

# geo-proposal

skills/zubair-trabzada/geo-seo-claude/geo-proposal
geo-proposal
Installation
$ npx skills add https://github.com/zubair-trabzada/geo-seo-claude --skill geo-proposal
SKILL.md
...
Pulls findings directly from the prospect's GEO audit
Translates technical gaps into business pain points
Presents 3 service tiers with clear pricing
Includes a realistic ROI projection
Outputs a professional markdown document ready to send
Command
...
Check if ~/.geo-prospects/audits/<domain>*.md exists
If not, suggest running /geo quick <domain> first
Extract from audit:
...
Output to ~/.geo-prospects/proposals/<domain>-proposal-<date>.md Also update prospect record if it exists in ~/.geo-prospects/prospects.json
...
Output
Save proposal to ~/.geo-prospects/proposals/<domain>-proposal-<date>.md
Update prospect record: set status to proposal, save proposal_file path
Print confirmation:
