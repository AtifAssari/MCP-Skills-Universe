---
title: nutmeg-acquire
url: https://skills.sh/withqwerty/nutmeg/nutmeg-acquire
---

# nutmeg-acquire

skills/withqwerty/nutmeg/nutmeg-acquire
nutmeg-acquire
Installation
...
Search the football-docs index: search_docs(query="[source name]")
If not found, search the web for "[source] football data API" or "[source] football dataset"
