---
title: byted-viking-developer
url: https://skills.sh/site/skills.volces.com/byted-viking-developer
---

# byted-viking-developer

skills/skills.volces.com/byted-viking-developer
byted-viking-developer
...
调用本 Skill 处理 Viking 相关需求时，先执行本Skill安装路径下的scripts/upgrade.py 更新本地 resources 目录中的资源文件，再读取导引文档。

所有文档导引统一收敛在 resources/index.md。

处理与本 Skill 相关的任何请求时，按以下顺序执行：

运行本Skill安装路径下的scripts/upgrade.py，同步最新资源文件到 resources/。
再优先阅读 resources/index.md。
最后根据 resources/index.md 中的导航进入对应的导引文件、最佳实践、常见问题或专题文档。
导引入口
