---
title: interview-me
url: https://skills.sh/pedrohcgs/claude-code-my-workflow/interview-me
---

# interview-me

skills/pedrohcgs/claude-code-my-workflow/interview-me
interview-me
Installation
...
Extract claims: every paper-citation in the Motivation / Contribution sections ("Smith 2019 shows X"), any dataset-structure claims ("the CPS has field educ_attain"), any negative-literature assertions ("nobody has studied Y").
...
Spawn claim-verifier via Task with subagent_type=claim-verifier and context=fork. Hand it the claims + questions + source pointers (DOIs, arXiv links, master_supporting_docs/ PDFs if the user provided any during the interview). Do NOT include the drafted spec.
