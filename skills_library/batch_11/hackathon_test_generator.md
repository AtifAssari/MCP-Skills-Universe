---
title: hackathon-test-generator
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-test-generator
---

# hackathon-test-generator

skills/bernieweb3/hackathon-ai-devkit/hackathon-test-generator
hackathon-test-generator
Installation
...
Rules
Prioritize tests that protect the mvp_demo_flow above all other coverage.
Generate at minimum one test per done_criterion.
Mark any test not critical to the demo as [NICE-TO-HAVE].
Include at least one negative/edge case test per MVP feature.
test_scaffolds must use the testing framework standard for the primary tech_stack language.
manual_checks must be completable in under 5 minutes total.
Any scenario that would cause a live demo failure must appear in demo_blockers.
Output Format
test_cases:
  - id: "TC-<number>"
