---
title: hackathon-problem-space
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-problem-space
---

# hackathon-problem-space

skills/bernieweb3/hackathon-ai-devkit/hackathon-problem-space
hackathon-problem-space
Installation
$ npx skills add https://github.com/bernieweb3/hackathon-ai-devkit --skill hackathon-problem-space
SKILL.md
hackathon-problem-space
Goal
...
Rules
Identify at least 2 distinct user segments.
Rank pain points from most to least severe for each segment.
List at least 3 existing solutions with their key limitations.
Derive solution gaps from the delta between pain points and existing solution limitations.
Write the problem statement as: "How might we [action] for [user] so that [outcome]?"
Do not invent market signals; clearly mark inferred signals as [INFERRED].
Output Format
user_segments:
  - segment: "<name>"
