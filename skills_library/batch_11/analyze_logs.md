---
title: analyze-logs
url: https://skills.sh/hugorcd/evlog/analyze-logs
---

# analyze-logs

skills/hugorcd/evlog/analyze-logs
analyze-logs
Installation
...
What happened: summarize the path, method, status, level
Why it failed (errors): read error.message, error.data.why, and the stack trace
How to fix: check error.data.fix for suggested remediation
