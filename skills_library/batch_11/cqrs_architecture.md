...
url: https://skills.sh/melodic-software/claude-code-plugins/cqrs-architecture
---

# cqrs-architecture

skills/melodic-software/claude-code-plugins/cqrs-architecture
cqrs-architecture
Installation
$ npx skills add https://github.com/melodic-software/claude-code-plugins --skill cqrs-architecture
SKILL.md
