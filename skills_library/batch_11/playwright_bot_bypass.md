...
url: https://skills.sh/greekr4/playwright-bot-bypass/playwright-bot-bypass
---

# playwright-bot-bypass

skills/greekr4/playwright-bot-bypass/playwright-bot-bypass
playwright-bot-bypass
Installation
...
For Python, recommends undetected-chromedriver over playwright-stealth for full bot detection bypass; Node.js subprocess calls also supported
Does not bypass CAPTCHAs themselves, only prevents triggering them through detection avoidance
SKILL.md
Playwright Bot Bypass
