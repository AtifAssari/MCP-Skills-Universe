---
title: extract-tikz
url: https://skills.sh/pedrohcgs/claude-code-my-workflow/extract-tikz
---

# extract-tikz

skills/pedrohcgs/claude-code-my-workflow/extract-tikz
extract-tikz
Installation
$ npx skills add https://github.com/pedrohcgs/claude-code-my-workflow --skill extract-tikz
SKILL.md
...
Apply the recommended fixes to the Beamer .tex source (single source of truth).
Re-copy the updated block to extract_tikz.tex.
Re-run the prevention pre-check (Step 1) and compile.
