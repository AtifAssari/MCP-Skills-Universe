---
title: byted-seedance-video-generate
url: https://skills.sh/bytedance/agentkit-samples/byted-seedance-video-generate
---

# byted-seedance-video-generate

skills/bytedance/agentkit-samples/byted-seedance-video-generate
byted-seedance-video-generate
Installation
$ npx skills add https://github.com/bytedance/agentkit-samples --skill byted-seedance-video-generate
SKILL.md
...
File format, return the video file (if you have some other methods to send the video file) and the local path of the video, for example: local_path: /root/.openclaw/workspace/skills/video-generate/xxx.mp4
