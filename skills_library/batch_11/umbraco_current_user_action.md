---
title: umbraco-current-user-action
url: https://skills.sh/umbraco/umbraco-cms-backoffice-skills/umbraco-current-user-action
---

# umbraco-current-user-action

skills/umbraco/umbraco-cms-backoffice-skills/umbraco-current-user-action
umbraco-current-user-action
Installation
...
Ask questions - What action? Navigate or execute? Conditions needed?
