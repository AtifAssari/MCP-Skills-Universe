---
title: rails-upgrade
url: https://skills.sh/robzolkos/skill-rails-upgrade/rails-upgrade
---

# rails-upgrade

skills/robzolkos/skill-rails-upgrade/rails-upgrade
rails-upgrade
Installation
$ npx skills add https://github.com/robzolkos/skill-rails-upgrade --skill rails-upgrade
SKILL.md
...
DO NOT run rails app:update directly - use the selective merge process below
