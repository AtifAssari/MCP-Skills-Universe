...
url: https://skills.sh/mmcmedia/openclaw-agents/etsy-keyword-research
---

# etsy-keyword-research

skills/mmcmedia/openclaw-agents/etsy-keyword-research
etsy-keyword-research
Installation
$ npx skills add https://github.com/mmcmedia/openclaw-agents --skill etsy-keyword-research
SKILL.md
Etsy Keyword Research
Overview
...
Go to etsy.com
Type seed keyword + each letter a-z
...
Autocomplete ranking - Higher = more searches
Number of results - More results = proven demand
Bestseller badges - Badges = sales happening
Review velocity - Recent reviews = active buyers
Seasonal trends - Check if keyword is seasonal
...
Search Etsy for keywords
Capture autocomplete suggestions
Analyze first-page listings
Check competitor tags (view page source or listing details)
Common Mistakes to Avoid
Trusting tools blindly - Tools estimate; manual research validates
Ignoring long-tail - "lds easter printable for kids" beats "easter printable"
Keyword stuffing - 13 relevant tags > 13 random tags
Copying competitors exactly - Find gaps they missed
Ignoring seasonality - Easter keywords tank after April
Output Checklist
...
Check references/feedback-log.md for past learnings
Check references/lds-keywords.md for proven performers
Apply lessons from previous research

After products launch (30 days later):

Log results in references/feedback-log.md
Update references/lds-keywords.md with new proven keywords
Note any patterns that worked/failed
Reference Files
