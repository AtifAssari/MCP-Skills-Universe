---
title: design-decision-audit
url: https://skills.sh/freeacger/loom/design-decision-audit
---

# design-decision-audit

skills/freeacger/loom/design-decision-audit
design-decision-audit
Installation
$ npx skills add https://github.com/freeacger/loom --skill design-decision-audit
SKILL.md
Design Decision Audit
Overview
...
Repo-wide review contracts such as AGENTS.md or CONTRIBUTING.md
...
Do not replace the required sections with a free-form review. Even short audits must keep the exact section names.
...
Use the repo's established report directory if one clearly exists, such as docs/reports/, and repo conventions are in scope
...
Draft handling: If the document was marked draft/WIP, downgrade [GAP] findings by one priority level and prefix with [DRAFT].
