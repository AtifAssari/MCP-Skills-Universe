---
title: arcgis-widgets-ui
url: https://skills.sh/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-widgets-ui
---

# arcgis-widgets-ui

skills/saschabrunnerch/arcgis-maps-sdk-js-ai-context/arcgis-widgets-ui
arcgis-widgets-ui
Installation
...
Widget container conflicts: Do not add the same widget to both a DOM container and view.ui.
...
Core API widgets missing CSS: When using Core API widgets (not Map Components), you must import @arcgis/core/assets/esri/themes/light/main.css. Map Components handle CSS automatically.
