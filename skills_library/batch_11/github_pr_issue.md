...
url: https://skills.sh/dcjanus/prompts/github-pr-issue
---

# github-pr-issue

skills/dcjanus/prompts/github-pr-issue
github-pr-issue
Installation
$ npx skills add https://github.com/dcjanus/prompts --skill github-pr-issue
SKILL.md
...
确认 git status 干净，git push 到远端。
标题风格：英文、遵循语义化提交规范（如 feat(scope): short summary），简洁且描述核心目的；即使标题要求中文，语义化前缀仍需英文。
