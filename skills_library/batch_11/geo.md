---
title: geo
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo
---

# geo

skills/zubair-trabzada/geo-seo-claude/geo
geo
Installation
...
Execute the PDF generator: python3 ~/.claude/skills/geo/scripts/generate_pdf_report.py data.json GEO-REPORT.pdf
...
Workflow
First run /geo audit <url> to collect all data
Then run /geo report-pdf <url> to generate the PDF
The tool will compile audit data into JSON, then generate the PDF
Output: GEO-REPORT.pdf in the current directory
Quality Gates
