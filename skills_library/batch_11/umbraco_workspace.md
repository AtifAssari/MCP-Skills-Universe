---
title: umbraco-workspace
url: https://skills.sh/umbraco/umbraco-cms-backoffice-skills/umbraco-workspace
---

# umbraco-workspace

skills/umbraco/umbraco-cms-backoffice-skills/umbraco-workspace
umbraco-workspace
Installation
...
Choose kind - Use kind: 'routable' for tree navigation, kind: 'default' for static pages
Generate files - Create manifest + workspace context + views + actions based on the fetched docs
