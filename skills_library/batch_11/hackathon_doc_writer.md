---
title: hackathon-doc-writer
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-doc-writer
---

# hackathon-doc-writer

skills/bernieweb3/hackathon-ai-devkit/hackathon-doc-writer
hackathon-doc-writer
Installation
...
Rules
Use the corresponding template from templates/ directory as the output structure.
Do not omit any section from the template; use [TBD] for missing information.
Keep language direct and scannable — no filler paragraphs.
...
Flag all [TBD] sections in missing_fields output.
Output Format
