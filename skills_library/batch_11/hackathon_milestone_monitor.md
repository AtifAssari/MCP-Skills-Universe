---
title: hackathon-milestone-monitor
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-milestone-monitor
---

# hackathon-milestone-monitor

skills/bernieweb3/hackathon-ai-devkit/hackathon-milestone-monitor
hackathon-milestone-monitor
Installation
...
Rules
Compute percent_complete as completed_tasks / total_tasks × 100.
Compute percent_time_used as elapsed_hours / hackathon_duration_hours × 100.
If percent_complete < percent_time_used - 15, flag status as behind.
If percent_complete > percent_time_used, flag status as ahead.
Otherwise flag status as on_track.
Any task on the critical path that is blocked must generate a critical recommended action.
If percent_time_used > 75 and the demo flow is not yet connected end-to-end, recommend scope cuts immediately.
scope_recommendations must only cut features that are not [FAKE-OK] impossible and not the wow-factor feature.
Output Format
progress_report:
