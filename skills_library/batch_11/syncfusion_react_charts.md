---
title: syncfusion-react-charts
url: https://skills.sh/syncfusion/react-ui-components-skills/syncfusion-react-charts
---

# syncfusion-react-charts

skills/syncfusion/react-ui-components-skills/syncfusion-react-charts
syncfusion-react-charts
Installation
...
Real-time Monitoring: Use addPoint/removePoint for live feeds with smooth animation
Remote Data from REST API: Bind DataManager with WebApiAdaptor or ODataAdaptor directly to series
Server-side OData: Use ODataV4Adaptor with a Query to filter and paginate at the server
Next Steps
