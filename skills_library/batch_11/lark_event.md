---
title: lark-event
url: https://skills.sh/site/open.feishu.cn/lark-event
---

# lark-event

skills/open.feishu.cn/lark-event
lark-event
...
Call flow
lark-cli event list --json → pick a legal key
lark-cli event schema <key> --json → read resolved_output_schema + jq_root_path to determine field paths
lark-cli event consume <key> [--jq '<expr>'] → consume
Subprocess contract
Ready marker
