...
url: https://skills.sh/dcjanus/prompts/confluence-cli
---

# confluence-cli

skills/dcjanus/prompts/confluence-cli
confluence-cli
Installation
$ npx skills add https://github.com/dcjanus/prompts --skill confluence-cli
SKILL.md
