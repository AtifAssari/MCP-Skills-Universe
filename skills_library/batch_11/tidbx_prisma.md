---
title: tidbx-prisma
url: https://skills.sh/pingcap/agent-rules/tidbx-prisma
---

# tidbx-prisma

skills/pingcap/agent-rules/tidbx-prisma
tidbx-prisma
Installation
$ npx skills add https://github.com/pingcap/agent-rules --skill tidbx-prisma
SKILL.md
...
Choose a guide (guides/quickstart.md or guides/troubleshooting.md)
Generate the minimal Prisma files/commands to get you unblocked
Weekly Installs
9
Repository
pingcap/agent-rules
