---
title: hackathon-wow-detector
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-wow-detector
---
...
Rules
Evaluate each feature for emotional impact, novelty, and relevance to evaluation_axes.
Select primary_wow_moment as the feature with highest combined impact × judging weight.
primary_wow_moment must be demonstrable live, not just described.
amplification_tactics must include at least: visual framing, narration timing, contrast setup.
demo_placement must be within the first 40% of the demo runtime.
differentiation_statement must be falsifiable — it must not apply to generic projects.
If competitor_ideas are known, ensure differentiation_statement is distinct from all of them.
Output Format
wow_moments:
  - rank: <number>
