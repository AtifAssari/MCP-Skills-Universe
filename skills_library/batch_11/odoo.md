---
title: odoo
url: https://skills.sh/marcfargas/odoo-toolbox/odoo
---

# odoo

skills/marcfargas/odoo-toolbox/odoo
odoo
Installation
...
base/connection.md — createClient(), authentication, environment variables
base/field-types.md — Odoo type system (read/write asymmetry)
base/domains.md — Query filter syntax
Additional Modules
