---
title: geo-platform-optimizer
url: https://skills.sh/zubair-trabzada/geo-seo-claude/geo-platform-optimizer
---

# geo-platform-optimizer

skills/zubair-trabzada/geo-seo-claude/geo-platform-optimizer
geo-platform-optimizer
Installation
$ npx skills add https://github.com/zubair-trabzada/geo-seo-claude --skill geo-platform-optimizer
SKILL.md
GEO Platform Optimizer
Core Insight
...
Bing Index Coverage: Use site:domain.com on Bing to verify key pages are indexed. Bing may have different indexed pages than Google.
Reddit Authority: Check for brand mentions on Reddit. Identify relevant subreddits. Assess whether the brand participates authentically in discussions.
...
IndexNow Implementation: Implement the IndexNow protocol to notify Bing of content changes in real-time. Submit a key file at /.well-known/indexnow-key.txt and ping the IndexNow API on content publish/update.
LinkedIn Company Page: Ensure the company LinkedIn page is complete with accurate description, employee connections, and regular posts. Copilot indexes LinkedIn content.
