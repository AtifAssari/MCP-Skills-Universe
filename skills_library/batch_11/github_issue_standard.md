---
title: github-issue-standard
url: https://skills.sh/anton-abyzov/specweave/github-issue-standard
---

# github-issue-standard

skills/anton-abyzov/specweave/github-issue-standard
github-issue-standard
Installation
...
Link work to a Feature (FS-XXX) in living docs
Create User Story (US-YYY) under that feature
Use GitHub labels for categorization: bug, enhancement, hotfix
Validation
...
Working GitHub URLs (v5.0.0+ - NO _features folder)
...
GitHubFeatureSync (plugins/specweave-github/lib/github-feature-sync.ts)
