---
title: hackathon-idea-scoring
url: https://skills.sh/bernieweb3/hackathon-ai-devkit/hackathon-idea-scoring
---

# hackathon-idea-scoring

skills/bernieweb3/hackathon-ai-devkit/hackathon-idea-scoring
hackathon-idea-scoring
Installation
$ npx skills add https://github.com/bernieweb3/hackathon-ai-devkit --skill hackathon-idea-scoring
SKILL.md
hackathon-idea-scoring
Goal
...
Rules
Score every idea on every evaluation axis using a 1–5 scale.
Apply axis weights when computing total score; default weight is 1.0 if not specified.
Apply a feasibility_penalty (-0.5 per axis point) if the team lacks skills required.
Apply a time_penalty (-1.0) if the idea cannot realistically ship in hackathon_duration_hours.
Surface at least one risk flag per top-3 idea.
Select top_recommendation based on highest adjusted total score.
Break ties in favor of the idea with the highest feasibility score.
Output Format
scored_ideas:
  - id: "<idea-N>"
    title: "<title>"
