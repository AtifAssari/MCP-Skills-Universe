---
title: agents-hooks
url: https://skills.sh/vasilyu1983/ai-agents-public/agents-hooks
---

# agents-hooks

skills/vasilyu1983/ai-agents-public/agents-hooks
agents-hooks
Installation
...
Keep destructive or broad shells (rm, git reset --hard, generic interpreters with arbitrary input) out of auto-approval rules.
Re-check approved prefixes periodically; remove stale ones.
