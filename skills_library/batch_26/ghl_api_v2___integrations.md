---
title: ghl api v2 & integrations
url: https://skills.sh/justin322322/ghl-skills/ghl-api-v2-&-integrations
---

# ghl api v2 & integrations

skills/justin322322/ghl-skills/GHL API v2 & Integrations
GHL API v2 & Integrations
Installation
...
Setup
Go to Settings → Integrations → Webhooks in your sub-account
Add a webhook URL
...
Best Practices
Respond with 200 quickly — Process webhook data asynchronously
Validate payloads — Check for required fields before processing
Handle duplicates — Implement idempotency for webhook handlers
Log everything — Store raw payloads for debugging
Set up retry logic — GHL retries failed webhook deliveries
Building Marketplace Apps
Steps
Create a developer account at marketplace.gohighlevel.com
Register your app — Set redirect URIs, scopes, and app details
Implement OAuth 2.0 — Handle auth flow, token storage, and refresh
Build your integration — Use API endpoints to interact with GHL data
Submit for review — GHL reviews before publishing to the marketplace
Maintain and update — Monitor for API changes and update accordingly
Required Scopes
...
Key Resources
API Docs: marketplace.gohighlevel.com/docs
GitHub: GoHighLevel/highlevel-api-docs
Postman Collection: Available in the official GitHub repo
Developer Community: GHL Developer Facebook Group
Weekly Installs
–
Repository
