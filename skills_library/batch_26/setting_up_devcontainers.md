---
title: setting-up-devcontainers
url: https://skills.sh/taisukeoe/agentic-ai-skills-creator/setting-up-devcontainers
---

# setting-up-devcontainers

skills/taisukeoe/agentic-ai-skills-creator/setting-up-devcontainers
setting-up-devcontainers
Installation
...
Read source path (e.g., "./plugins/plugin-name")
Check for .claude-plugin/plugin.json in source directory
Find skills path from plugin.json or use ./skills/ default
...
Write all generated files (without .template suffix)
Make shell scripts executable: chmod +x .devcontainer/*.sh
