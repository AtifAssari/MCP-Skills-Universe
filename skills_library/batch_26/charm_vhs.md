---
title: charm-vhs
url: https://skills.sh/benjaminwestern/google-engineer-skills/charm-vhs
---

# charm-vhs

skills/benjaminwestern/google-engineer-skills/charm-vhs
charm-vhs
Installation
...
Every Type string must be closed before Sleep/Enter on the same line
Multi-line Type sequences that build a single shell command: ensure the final line closes its string and includes Enter
Sleep durations after commands should be long enough for the command to finish (network calls may need 8s+)
Settings go at the top — only TypingSpeed can appear later
Test locally with vhs <file>.tape before committing
Weekly Installs
12
Repository
