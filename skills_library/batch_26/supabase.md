---
title: supabase
url: https://skills.sh/heyvhuang/ship-faster/supabase
---

# supabase

skills/heyvhuang/ship-faster/supabase
supabase
Installation
$ npx skills add https://github.com/heyvhuang/ship-faster --skill supabase
SKILL.md
...
Default LIMIT 50: All SELECT queries default to LIMIT 50, unless user explicitly requests more
Write operation confirmation: INSERT/UPDATE/DELETE must before execution:
...
Batch threshold: Affecting > 100 rows → force double confirmation + suggest SELECT count(*) first
DDL via migration: Schema changes must use migrations, not direct DDL
