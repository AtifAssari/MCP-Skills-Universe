...
url: https://skills.sh/vasilyu1983/ai-agents-public/marketing-product-analytics
---

# marketing-product-analytics

skills/vasilyu1983/ai-agents-public/marketing-product-analytics
marketing-product-analytics
Installation
...
Write the tracking plan: use assets/tracking-plan-saas.md as the starting template; define required properties and ownership.
Implement instrumentation: pick the platform guide in Quick Reference (PostHog/Pendo/Amplitude/Mixpanel/Heap; server-side if needed).
QA and harden: use assets/analytics-qa-checklist.md + references/event-quality-rules.md + references/production-hardening.md.
Core Principles
...
Cohort retention	references/cohort-retention-analysis.md
Experimentation	references/experimentation-framework.md
User segmentation	references/user-segmentation.md
Data governance	references/data-governance.md
Session replay & heatmaps	references/session-replay-heatmaps.md
Attribution modeling	references/attribution-modeling.md
