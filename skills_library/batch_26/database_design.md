...
url: https://skills.sh/cloudai-x/claude-workflow-v2/database-design
---

# database-design

skills/cloudai-x/claude-workflow-v2/database-design
database-design
Installation
$ npx skills add https://github.com/cloudai-x/claude-workflow-v2 --skill database-design
SKILL.md
Database Design
When to Load
