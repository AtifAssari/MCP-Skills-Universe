---
title: shapely
url: https://skills.sh/tondevrel/scientific-agent-skills/shapely
---

# shapely

skills/tondevrel/scientific-agent-skills/shapely
shapely
Installation
...
Best Practices
Always validate geometry with .is_valid before complex operations
Use unary_union instead of looping over unions
Prepare geometries with prepare() when checking many points against the same shape
Use vectorized operations in Shapely 2.0+ for performance
