---
title: agents-project-memory
url: https://skills.sh/vasilyu1983/ai-agents-public/agents-project-memory
---

# agents-project-memory

skills/vasilyu1983/ai-agents-public/agents-project-memory
agents-project-memory
Installation
$ npx skills add https://github.com/vasilyu1983/ai-agents-public --skill agents-project-memory
SKILL.md
...
Keep AGENTS.md short (target 50-120 lines).
Move long catalogs/checklists to skill docs and reference them by path.
