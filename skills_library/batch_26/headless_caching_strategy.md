---
title: headless-caching-strategy
url: https://skills.sh/vtex/skills/headless-caching-strategy
---

# headless-caching-strategy

skills/vtex/skills/headless-caching-strategy
headless-caching-strategy
Installation
$ npx skills add https://github.com/vtex/skills --skill headless-caching-strategy
SKILL.md
...
BFF architecture and API routing decisions (use headless-bff-architecture)
Intelligent Search API integration specifics (use headless-intelligent-search)
Checkout proxy and OrderForm management (use headless-checkout-proxy)
Decision rules
