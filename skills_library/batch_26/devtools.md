---
title: devtools
url: https://skills.sh/vercel-labs/json-render/devtools
---

# devtools

skills/vercel-labs/json-render/devtools
devtools
Installation
$ npx skills add https://github.com/vercel-labs/json-render --skill devtools
SKILL.md
...
Actions and the picker are already global — registerActionObserver captures dispatches from any ActionProvider in the tree, and data-jr-key is written by the renderer itself, so Pick works across every rendered element regardless of which message produced it.
