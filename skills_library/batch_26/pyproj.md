---
title: pyproj
url: https://skills.sh/tondevrel/scientific-agent-skills/pyproj
---

# pyproj

skills/tondevrel/scientific-agent-skills/pyproj
pyproj
Installation
...
Best Practices
Always use always_xy=True when creating Transformers to ensure consistent (lon, lat) ordering
Create Transformers once and reuse them for bulk operations
Use Geod for distance calculations on the ellipsoid rather than projecting to flat coordinates
Prefer EPSG codes over Proj4 strings for better robustness and modern datum support
Vectorize transformations by passing arrays/lists instead of looping over individual points
Check CRS validity and area of use before transforming coordinates
Be aware of datum transformations when converting between different reference systems
Use itransform for memory-efficient processing of large datasets from generators
