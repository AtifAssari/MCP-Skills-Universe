...
url: https://skills.sh/vivy-yi/xiaohongshu-skills/team-collaboration
---
...
team-collaboration
Installation
$ npx skills add https://github.com/vivy-yi/xiaohongshu-skills --skill team-collaboration
SKILL.md
...
What works: "I love the bright colors you used"
What to improve: "Can we increase the font size? It's hard to read on mobile"
Why it matters: "I want to make sure audiences can easily read our content"
Positive closing: "Other than that, great job! Looking forward to final version"
...
Audit your time: What tasks take time that others could do better?
Identify first hire: Choose highest-ROI task to delegate first
Find collaborators: Use platforms, referrals, Xiaohongshu search
Test with small project: Hire for one small task, evaluate fit
Create clear briefs: Develop templates for common tasks
Set up tools: Asana/Trello for tasks, Google Drive for files, WeChat for comms
Establish routines: Weekly planning meeting, regular check-ins, feedback loops
Invest in relationships: Fair pay, recognition, growth opportunities
