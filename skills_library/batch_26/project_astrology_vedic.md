---
title: project-astrology-vedic
url: https://skills.sh/vasilyu1983/ai-agents-public/project-astrology-vedic
---

# project-astrology-vedic

skills/vasilyu1983/ai-agents-public/project-astrology-vedic
project-astrology-vedic
Installation
$ npx skills add https://github.com/vasilyu1983/ai-agents-public --skill project-astrology-vedic
SKILL.md
...
Classify the request (calculation, interpretation, timing, compatibility, prashna, muhurta).
Collect missing inputs (avoid long questionnaires).
Confirm defaults (sidereal/Lahiri/Whole Sign/Vimshottari) or adapt to the user’s tradition.
Compute or verify the chart/timing (prefer a reliable ephemeris; see references/sidereal-calculations.md).
...
Offer remedies only if asked, and keep them safe (see “Safety”).
