---
title: pull-merge-request-creation
url: https://skills.sh/keminghe/common-devx/pull-merge-request-creation
---

# pull-merge-request-creation

skills/keminghe/common-devx/pull-merge-request-creation
pull-merge-request-creation
Installation
...
If both directories exist, ask user which platform to target
If neither directory exists, ask user which platform to target
Template Resolution
GitHub
Search .github/pull_request_template.md for PR template
If not found, search **/pull_request_template.md across repository
If still not found, ask user for template or use minimal structure
GitLab
Search .gitlab/merge_request_templates/merge_request_template.md for MR template
If not found, search **/merge_request_templates/** across repository
If still not found, ask user for template or use minimal structure
