---
title: seaborn
url: https://skills.sh/tondevrel/scientific-agent-skills/seaborn
---

# seaborn

skills/tondevrel/scientific-agent-skills/seaborn
seaborn
Installation
$ npx skills add https://github.com/tondevrel/scientific-agent-skills --skill seaborn
SKILL.md
...
Prefer figure-level functions - Use relplot, displot, and catplot for better default layouts and faceting
Always use the data= parameter - Pass the DataFrame directly to keep code clean and readable
Set themes early - Use sns.set_theme() at the beginning of your script for consistent styling
Leverage semantic mappings - Use hue, size, and style to add dimensions to your plots
Choose appropriate context - Use sns.set_context("paper") for publications or "talk" for presentations
Remember Seaborn returns Matplotlib objects - Use Matplotlib methods like ax.set_title() for fine-tuning
Don't overcrowd plots - Limit semantic mappings to maintain readability
Use figure-level functions for faceting - They handle subplot layouts automatically
Sample large datasets - Use df.sample() before plotting to improve performance with big data
