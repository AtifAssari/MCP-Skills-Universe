---
title: chat-customizations-editor
url: https://skills.sh/microsoft/vscode/chat-customizations-editor
---

# chat-customizations-editor

skills/microsoft/vscode/chat-customizations-editor
chat-customizations-editor
Installation
...
Include BUILTIN_STORAGE in the harness descriptor's visible sources
Mock IProductService.defaultChatAgent.chatExtensionId (e.g., 'GitHub.copilot-chat')
Give mock items extension provenance via extensionId / extensionDisplayName matching that ID
