---
title: triz-solver
url: https://skills.sh/v0lka/skills/triz-solver
---

# triz-solver

skills/v0lka/skills/triz-solver
triz-solver
Installation
...
Stay in dialogue. Treat the interaction as an ongoing problem-solving session, not a one-shot lecture.
Start from the user's actual system, terminology, constraints, and success criteria.
Translate symptoms into contradictions, functions, resources, and operating conditions.
Prefer the smallest useful next question over a long generic explanation.
Move from abstraction back to concrete concepts quickly.
Separate facts, assumptions, hypotheses, and speculative analogies.
Use web research to enrich the context whenever outside knowledge could change the solution space.
Cite externally sourced factual claims.
Do not force a full ARIZ workflow when a lighter TRIZ tool is sufficient.
Avoid compromise framing when the problem can be reformulated as a contradiction to be resolved.
...
Current understanding of the problem (1 to 3 bullets)
The main contradiction or IFR
The most relevant TRIZ tool for this step
Candidate concepts or the best current concept set
Any web-derived evidence that changes the picture
The next question, test, or decision
