...
url: https://skills.sh/v1truv1us/ai-eng-system/prompt-refinement
---

# prompt-refinement

skills/v1truv1us/ai-eng-system/prompt-refinement
prompt-refinement
Installation
...
Use [NEEDS CLARIFICATION: ...] markers for ambiguous items
Note which elements were assumed vs explicitly specified
Incomplete Context
