---
title: create-docs
url: https://skills.sh/mhaibaraai/movk-nuxt-docs/create-docs
---

# create-docs

skills/mhaibaraai/movk-nuxt-docs/create-docs
create-docs
Installation
$ npx skills add https://github.com/mhaibaraai/movk-nuxt-docs --skill create-docs
SKILL.md
创建文档
...
工作流程
分析 - 检测包管理器、monorepo 结构、读取上下文
初始化 - 使用正确的设置创建文档目录
生成 - 使用模板编写文档页面
配置 - 设置 AI 集成（MCP、llms.txt）
最终化 - 提供后续步骤和正确的命令
包管理器参考
...
更新 Monorepo 配置（如适用）
pnpm Monorepo
将文档添加到工作区并配置 onlyBuiltDependencies（better-sqlite3 必需）：
packages:
  - 'apps/*'
  - 'docs'
...
生成页面
登陆页（index.md）- Hero + 功能网格
介绍 - 什么和为什么，使用案例
安装 - 前提条件、安装命令
指南页面 - 功能文档，使用基于动作的 H2 标题

有关写作风格，见 references/writing-guide.md。 有关 MDC 组件，见 references/mdc-components.md。
