---
title: agent-browser
url: https://skills.sh/chachamaru127/claude-code-harness/agent-browser
---

# agent-browser

skills/chachamaru127/claude-code-harness/agent-browser
agent-browser
Installation
$ npx skills add https://github.com/chachamaru127/claude-code-harness --skill agent-browser
SKILL.md
Agent Browser Skill
