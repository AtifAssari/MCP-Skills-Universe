---
title: arch-mmd
url: https://skills.sh/aravhawk/claude-code-utils/arch-mmd
---

# arch-mmd

skills/aravhawk/claude-code-utils/arch-mmd
arch-mmd
Installation
...
Write the diagram to ARCHITECTURE.mmd in the project root
If ARCHITECTURE.mmd already exists, read it first, then update it to reflect the current state — don't start from scratch unless the existing diagram is fundamentally wrong
The file should contain ONLY the Mermaid diagram — no markdown fences, no frontmatter, no prose
CONSTRAINTS
