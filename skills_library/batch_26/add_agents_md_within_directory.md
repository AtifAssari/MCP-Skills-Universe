---
title: add agents.md within directory
url: https://skills.sh/strativd/ai-skills/add-agents.md-within-directory
---

# add agents.md within directory

skills/strativd/ai-skills/Add AGENTS.md Within Directory
Add AGENTS.md Within Directory
Installation
...
You have a deep understanding of the AGENTS.md standard
You have a deep understanding of the best practices derived from large-scale real-world usage of AGENTS.md
