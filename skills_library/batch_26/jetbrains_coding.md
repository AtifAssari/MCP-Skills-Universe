---
title: jetbrains-coding
url: https://skills.sh/maidevberlin/logikids/jetbrains-coding
---

# jetbrains-coding

skills/maidevberlin/logikids/jetbrains-coding
jetbrains-coding
Installation
$ npx skills add https://github.com/maidevberlin/logikids --skill jetbrains-coding
SKILL.md
...
After completing a file: Call get_file_problems
...
If not available: Use git mv for rename, then update imports with replace_text_in_file using replaceAll: true
