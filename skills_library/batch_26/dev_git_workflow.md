---
title: dev-git-workflow
url: https://skills.sh/vasilyu1983/ai-agents-public/dev-git-workflow
---

# dev-git-workflow

skills/vasilyu1983/ai-agents-public/dev-git-workflow
dev-git-workflow
Installation
...
Create one worktree per feature branch (git worktree add .worktrees/<feature> -b feature/<name>).
Verify the worktree directory is in .gitignore (git check-ignore -q .worktrees).
