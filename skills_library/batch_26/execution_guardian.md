...
url: https://skills.sh/cleanexpo/nodejs-starter-v1/execution-guardian
---

# execution-guardian

skills/cleanexpo/nodejs-starter-v1/execution-guardian
execution-guardian
Installation
...
If pass → proceed
If fail again → escalate to BLOCKING: YES
