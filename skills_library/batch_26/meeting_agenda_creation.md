...
url: https://skills.sh/keminghe/common-devx/meeting-agenda-creation
---

# meeting-agenda-creation

skills/keminghe/common-devx/meeting-agenda-creation
meeting-agenda-creation
Installation
$ npx skills add https://github.com/keminghe/common-devx --skill meeting-agenda-creation
SKILL.md
...
Asset Resolution
Check ./assets/agenda-template.md for standard meeting agendas
If not found, search **/agenda-template.md in repository
