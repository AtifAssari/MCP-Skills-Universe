...
url: https://skills.sh/cloudai-x/claude-workflow-v2/security-patterns
---

# security-patterns

skills/cloudai-x/claude-workflow-v2/security-patterns
security-patterns
Installation
$ npx skills add https://github.com/cloudai-x/claude-workflow-v2 --skill security-patterns
SKILL.md
Security Patterns
When to Load
