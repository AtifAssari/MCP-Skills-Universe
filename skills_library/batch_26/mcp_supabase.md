---
title: mcp-supabase
url: https://skills.sh/heyvhuang/ship-faster/mcp-supabase
---

# mcp-supabase

skills/heyvhuang/ship-faster/mcp-supabase
mcp-supabase
Installation
...
DDL via migration: Schema changes must use apply_migration, execute_sql cannot run DDL directly
