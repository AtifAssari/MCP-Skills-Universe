---
title: handlebars
url: https://skills.sh/avvale/aurora-cli/handlebars
---

# handlebars

skills/avvale/aurora-cli/handlebars
handlebars
Installation
$ npx skills add https://github.com/avvale/aurora-cli --skill handlebars
SKILL.md
When to Use
...
Missing whitespace control: Use ~ to trim unwanted whitespace
...
Wrong context access: Use ../ to access parent context in loops
...
Forgetting to register helper: Add import in src/@cliter/handlebars/helpers/index.ts

Using {{ instead of {{{: For HTML/code output, use triple braces to avoid escaping
