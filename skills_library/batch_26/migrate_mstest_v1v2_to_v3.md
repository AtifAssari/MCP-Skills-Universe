...
url: https://skills.sh/dotnet/skills/migrate-mstest-v1v2-to-v3
---

# migrate-mstest-v1v2-to-v3

skills/dotnet/skills/migrate-mstest-v1v2-to-v3
migrate-mstest-v1v2-to-v3
Installation
...
Check if the project uses a .testsettings file (indicated by <LegacySettings> in test configuration)
Check if the target framework is dropped in v3 (see Step 4)
...
Remove the reference to Microsoft.VisualStudio.QualityTools.UnitTestFramework.dll
