---
title: lovstudio:any2deck
url: https://skills.sh/lovstudio/skills/lovstudio:any2deck
---

# lovstudio:any2deck

skills/lovstudio/skills/lovstudio:any2deck
lovstudio:any2deck
Installation
$ npx skills add https://github.com/lovstudio/skills --skill lovstudio:any2deck
SKILL.md
...
Composites brand logo(s) (top-right) and optional QR code onto generated slides. Supports dual logos (e.g. brand + partner), tight-crops logos via getbbox(), and converts JPG white backgrounds to alpha automatically.
...
If any slide shows frame/card conflict, add it to --patch-slides and re-run. If edges still leak through, add it to --frame-slides (more aggressive strip). If problems persist (content-integrated card), regenerate that slide with explicit "NO card containing all content, NO tilted paper" in the prompt.

The script is idempotent: originals are backed up to _original/ and reused on every run.
...
Run: /lovstudio:any2deck <dir> --regenerate N
