---
title: numba
url: https://skills.sh/tondevrel/scientific-agent-skills/numba
---

# numba

skills/tondevrel/scientific-agent-skills/numba
numba
Installation
...
Best Practices
Always use @njit - Never use @jit without nopython=True
Pre-allocate arrays - Avoid creating arrays inside hot loops
Use prange for parallelism - Enable automatic multi-threading with parallel=True and prange
Cache compiled functions - Use cache=True to avoid recompilation
Warm up functions - Call jitted functions once before benchmarking
Pass NumPy arrays - Convert Python lists to NumPy arrays before calling jitted functions
Avoid Python objects - Use numba.typed.List and numba.typed.Dict if you need containers
Check compilation mode - Use inspect_types() to verify nopython mode
Handle first-call overhead - Remember the first call compiles the function
