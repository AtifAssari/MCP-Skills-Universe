---
title: data-metabase
url: https://skills.sh/vasilyu1983/ai-agents-public/data-metabase
---

# data-metabase

skills/vasilyu1983/ai-agents-public/data-metabase
data-metabase
Installation
...
Workflow
Confirm API availability (GET /api/util/health).
Authenticate with an API key (preferred) or a short-lived session (fallback).
