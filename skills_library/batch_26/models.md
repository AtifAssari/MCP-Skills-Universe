---
title: models
url: https://skills.sh/dvf/opinionated-django/models
---

# models

skills/dvf/opinionated-django/models
models
Installation
...
Anything else (ordering, abstract, etc.)
...
Identifiers — primary key, slugs, external reference codes, SKUs
Time fields — created_at, updated_at, published_at, any date or datetime
Workflow / status / state — status, stage, is_active, is_published (skip if the model has no lifecycle)
Domain fields — everything else: name, description, price, quantity, etc.
Relations — ForeignKey, OneToOneField, ManyToManyField — always last among fields
