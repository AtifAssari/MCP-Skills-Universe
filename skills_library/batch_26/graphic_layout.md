...
url: https://skills.sh/vivy-yi/xiaohongshu-skills/graphic-layout
---

# graphic-layout

skills/vivy-yi/xiaohongshu-skills/graphic-layout
graphic-layout
Installation
...
Squint at your design (blur vision)
Can you still identify the main element? If yes, hierarchy works
If everything blends together, strengthen size/color contrast
...
Choose 2-3 layout patterns that fit your content type
Create reusable templates in Canva/Figma with your brand colors, fonts
Save as templates for consistent, rapid content creation
Customize images and text for each post while maintaining structure
...
Sketch layout for mobile screen size first
Test readability on phone (hold at arm's length)
Simplify: Remove non-essential elements
Scale up for desktop/tablet (not vice versa)
Common Mistakes
...
Audit your current posts: What are your top 3 design weaknesses?
Define your brand palette: Choose 2-3 primary colors + neutrals
Select 2 fonts: One for headlines, one for body text
Create templates: Design 2-3 reusable layouts in Canva
Test on mobile: Always preview on phone before publishing
