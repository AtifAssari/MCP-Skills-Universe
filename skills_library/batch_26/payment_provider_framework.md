...
url: https://skills.sh/vtex/skills/payment-provider-framework
---

# payment-provider-framework

skills/vtex/skills/payment-provider-framework
payment-provider-framework
Installation
...
Idempotency and duplicate paymentId handling — use payment-idempotency
...
Related skills
payment-provider-protocol — PPP endpoints, HTTP methods, and response shapes
payment-idempotency — paymentId / requestId and retries
payment-async-flow — undefined status, callbackUrl (IO retry vs notification), and redirect-based flows
payment-pci-security — PCI and Secure Proxy semantics beyond IO wiring
Reference
