---
title: revx-monitor
url: https://skills.sh/revolut-engineering/revolut-x-api/revx-monitor
---

# revx-monitor

skills/revolut-engineering/revolut-x-api/revx-monitor
revx-monitor
Installation
$ npx skills add https://github.com/revolut-engineering/revolut-x-api --skill revx-monitor
SKILL.md
...
Periodically read the background task output file with the Read tool to monitor status and report key events to the user (alerts triggered, errors)
