...
url: https://skills.sh/okx/plugin-store/pancakeswap-v2
---

# pancakeswap-v2

skills/okx/plugin-store/pancakeswap-v2
pancakeswap-v2
Installation
$ npx skills add https://github.com/okx/plugin-store --skill pancakeswap-v2
SKILL.md
...
Execute only after explicit user approval (re-run without --dry-run)
...
Report txHash and LP tokens received
