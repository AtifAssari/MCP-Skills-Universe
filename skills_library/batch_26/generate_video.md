...
url: https://skills.sh/chachamaru127/claude-code-harness/generate-video
---

# generate-video

skills/chachamaru127/claude-code-harness/generate-video
generate-video
Installation
$ npx skills add https://github.com/chachamaru127/claude-code-harness --skill generate-video
SKILL.md
...
実行手順
ユーザーが /generate-video を実行
Remotion セットアップ確認
analyzer.md でコードベース分析
planner.md でシナリオ提案 + ユーザー確認
generator.md で並列生成
完了報告
動画タイプ（ファネル別）
