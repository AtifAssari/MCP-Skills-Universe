---
title: v0
url: https://skills.sh/vm0-ai/vm0-skills/v0
---

# v0

skills/vm0-ai/vm0-skills/v0
v0
Installation
$ npx skills add https://github.com/vm0-ai/vm0-skills --skill v0
SKILL.md
How to Use
...
Guidelines
Premium plan required: API access requires a v0 Premium or Team subscription with Vercel usage-based billing enabled
Iterate with follow-ups: Use POST /chats/<id>/messages to refine code — it preserves full conversation context and is more token-efficient than creating a new chat
demoUrl is the live preview: Each chat response contains latestVersion.demoUrl — the live sandbox URL to preview the generated app; webUrl is the link to the v0.app chat interface
Use projects for organization: Group related chats under a project (via projectId) to share instructions and context across conversations
Rate limits: 1,000 chat messages and 100 deployments per day — prefer iterating within existing chats over creating new ones
Weekly Installs
15
Repository
vm0-ai/vm0-skills
