---
title: dot-ai-prd-done
url: https://skills.sh/vfarcic/dot-ai/dot-ai-prd-done
---

# dot-ai-prd-done

skills/vfarcic/dot-ai/dot-ai-prd-done
dot-ai-prd-done
Installation
...
Selection priority:
If any breaking changes → use breaking-change or breaking
If primarily new functionality → use feat, feature, or enhancement
If primarily fixing bugs → use fix, bug, or bugfix
If primarily documentation → use documentation or docs
If primarily dependencies → use dependencies, deps, or dependency
Otherwise → no specific label needed (will appear in "Other Changes")
