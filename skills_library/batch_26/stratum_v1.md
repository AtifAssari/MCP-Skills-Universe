---
title: stratum-v1
url: https://skills.sh/b-open-io/bsv-skills/stratum-v1
---

# stratum-v1

skills/b-open-io/bsv-skills/stratum-v1
stratum-v1
Installation
...
Every retargetTime seconds, calculate average share time
If average outside targetTime +/- variancePercent, adjust:
newDiff = currentDiff * targetTime / averageTime

Apply maxDelta limit and clamp to [minDiff, maxDiff]
...
Miner sends mining.configure with version-rolling extension
Pool responds with allowed mask
Miner includes version_bits parameter in mining.submit
Pool validates: (version_bits & ~mask) == 0
Error Codes
...
Braiins Stratum V1 Docs
GorillaNode Implementation
Weekly Installs
20
Repository
