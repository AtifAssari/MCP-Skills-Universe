---
title: headless-intelligent-search
url: https://skills.sh/vtex/skills/headless-intelligent-search
---

# headless-intelligent-search

skills/vtex/skills/headless-intelligent-search
headless-intelligent-search
Installation
$ npx skills add https://github.com/vtex/skills --skill headless-intelligent-search
SKILL.md
...
Checkout or cart API integration (use headless-checkout-proxy)
Caching strategy and TTL configuration (use headless-caching-strategy)
Decision rules
