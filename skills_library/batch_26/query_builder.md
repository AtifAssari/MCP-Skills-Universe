---
title: query-builder
url: https://skills.sh/curiouslearner/devkit/query-builder
---

# query-builder

skills/curiouslearner/devkit/query-builder
query-builder
Installation
$ npx skills add https://github.com/curiouslearner/devkit --skill query-builder
SKILL.md
Query Builder Skill
