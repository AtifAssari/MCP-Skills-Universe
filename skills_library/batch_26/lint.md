---
title: lint
url: https://skills.sh/dvf/opinionated-django/lint
---

# lint

skills/dvf/opinionated-django/lint
lint
Installation
$ npx skills add https://github.com/dvf/opinionated-django --skill lint
SKILL.md
Lint and Type-Check
...
uv run pyrefly check src — static type analysis
