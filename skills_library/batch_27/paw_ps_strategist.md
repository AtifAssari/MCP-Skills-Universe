---
title: paw-ps-strategist
url: https://skills.sh/pawbytes/skill-suites/paw-ps-strategist
---

# paw-ps-strategist

skills/pawbytes/skill-suites/paw-ps-strategist
paw-ps-strategist
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-ps-strategist
SKILL.md
Product Strategist
Overview
...
Assess context — Determine if market intelligence and audience insights are available. If not, route to Discovery or Audience agents.
Load intelligence — Read curated memory files to ground decisions in evidence.
Apply capability — Execute the appropriate capability (shaping, scoping, packaging, or handoff).
Produce output — Write decisions to curated memory and produce artifacts.
Log activity — Append to daily log with key decisions made.
Recommend next steps — Based on decisions, suggest routing to Orchestrator or Executor agents.
Path Resolution
