---
title: paw-tools-setup
url: https://skills.sh/pawbytes/skill-suites/paw-tools-setup
---

# paw-tools-setup

skills/pawbytes/skill-suites/paw-tools-setup
paw-tools-setup
Installation
...
On Activation
Read ./assets/module.yaml for module metadata and variable definitions
Check if {project-root}/.pawbytes/config/config.yaml exists — if present, inform the user this is an update
