...
url: https://skills.sh/andrewgleave/skills/critical-reasoning
---

# critical-reasoning

skills/andrewgleave/skills/critical-reasoning
critical-reasoning
Installation
$ npx skills add https://github.com/andrewgleave/skills --skill critical-reasoning
SKILL.md
Critical Reasoning
...
popper.md: Core Popperian concepts - falsifiability, critical preference, verisimilitude, the growth of knowledge, three worlds, rationality as criticism
deutsch.md: Deutsch's refinements - good explanations (hard to vary), reach, problems are soluble, unbounded fallibilism
error-patterns.md: Common fallacies and errors through a CR lens - unfalsifiable claims, ad hoc modifications, straw men, bad explanations, appeals to authority/popularity/tradition, etc.
Weekly Installs
51
Repository
andrewgleave/skills
