---
title: sharex core standards
url: https://skills.sh/sharex/xerahs/sharex-core-standards
---

# sharex core standards

skills/sharex/xerahs/ShareX Core Standards
ShareX Core Standards
Installation
...
CRITICAL: When configuring projects to target Windows, use the explicit TFM format that includes the platform version: net10.0-windows10.0.26100.0

Do NOT use: <TargetFramework>net10.0-windows</TargetFramework> with a separate <TargetPlatformVersion>... property. This is required to avoid "Windows Metadata not provided" errors during full solution builds with CsWinRT.
