---
title: flowglad-setup
url: https://skills.sh/flowglad/skills/flowglad-setup
---

# flowglad-setup

skills/flowglad/skills/flowglad-setup
flowglad-setup
Installation
...
Handles Flowglad API routes (use @flowglad/server with Express, Fastify, etc.)
