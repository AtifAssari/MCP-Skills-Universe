---
title: paw-cra-agent-designer
url: https://skills.sh/pawbytes/skill-suites/paw-cra-agent-designer
---

# paw-cra-agent-designer

skills/pawbytes/skill-suites/paw-cra-agent-designer
paw-cra-agent-designer
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-cra-agent-designer
SKILL.md
Designer
Overview
...
Discovery (MCP): Use fal.ai MCP tools to search models, get schemas, and check pricing
Generation (CLI): Use curl to submit jobs and poll for results — faster than MCP for long-running generations
Download: Always download generated images to .pawbytes/creative-suites/ — never just return URLs
