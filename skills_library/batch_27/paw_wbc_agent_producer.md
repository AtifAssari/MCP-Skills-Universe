---
title: paw-wbc-agent-producer
url: https://skills.sh/pawbytes/skill-suites/paw-wbc-agent-producer
---

# paw-wbc-agent-producer

skills/pawbytes/skill-suites/paw-wbc-agent-producer
paw-wbc-agent-producer
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-wbc-agent-producer
SKILL.md
Producer
Overview
...
Check for {webinar-slug}/brief.md — the initial brief and audience context
Check for {webinar-slug}/research-context.md — compressed research findings
Check for {webinar-slug}/hook-selected.md — chosen hook and reasoning
...
Load discovery outputs — Read brief.md, research-context.md, hook-selected.md
Understand the hook — Why was this angle chosen? What makes it compelling?
...
Select narrative arc — Based on webinar kind and hook, choose the best structure pattern (see webinar-structure.md)
Create section outline — Define opener, body sections, and close. Each section has a purpose.
Plan key moments — Identify 3-5 moments that must land. These get extra attention in script.
Phase 3: Slide Deck Outline
Generate slide-by-slide outline — Using slide-deck-format.md, create detailed slides with:
Title
...
Save to recommendations.md
Phase 6: Daily Log
Log activity — Write to {project-root}/.pawbytes/webinar-suites/daily/YYYY-MM-DD.md with [producer] tag
Path Resolution
...
Read ./references/frameworks-index.csv — lightweight index of available frameworks
Match production need to best_for column
Read ONLY matched framework file(s) from ./references/frameworks/
Never bulk-read all framework files — load on demand
Escalation Routes
Signal	Routes To
