---
title: wechat-red-envelope-cover-designer
...
skills/wuchubuzai2018/expert-skills-hub/wechat-red-envelope-cover-designer
wechat-red-envelope-cover-designer
Installation
$ npx skills add https://github.com/wuchubuzai2018/expert-skills-hub --skill wechat-red-envelope-cover-designer
SKILL.md
技能概述
...
步骤6：调整图片尺寸并自动压缩
使用scripts/readme.md中的说明内容，理解图片尺寸规范和智能压缩策略
...
常见场景处理
场景1：用户选择节日主题
从 references/festival-prompts.md 中选择对应的节日模板
使用节日专属的元素和配色方案
按照节日主题的设计要求生成素材
场景2：用户有自定义品牌需求
使用 references/prompt-templates.md 中的通用模板
