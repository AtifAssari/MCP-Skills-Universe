...
url: https://skills.sh/luongnv89/skills/idea-validator
---

# idea-validator

skills/luongnv89/skills/idea-validator
idea-validator
Installation
...
Create project folder under resolved root: YYYY_MM_DD_<short_snake_case_name>/
...
A summary table of competitors found
A "white space" analysis — what's missing in the current market
Honest assessment: is the user's differentiation real or imagined given what exists?
