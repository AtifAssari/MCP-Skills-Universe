---
title: laravel-boost
url: https://skills.sh/pixel-process-ug/superkit-agents/laravel-boost
---

# laravel-boost

skills/pixel-process-ug/superkit-agents/laravel-boost
laravel-boost
Installation
...
Check if an MCP configuration already exists (.mcp.json)
Review existing guideline and skill customizations in .ai/
...
Add project-specific guidelines in .ai/guidelines/
Create domain-specific skills in .ai/skills/
...
Check that boost:update keeps resources current after dependency changes
