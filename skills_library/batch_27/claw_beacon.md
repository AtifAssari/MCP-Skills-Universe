---
title: claw-beacon
url: https://skills.sh/clawbeacon/clawbeacon/claw-beacon
---

# claw-beacon

skills/clawbeacon/clawbeacon/claw-beacon
claw-beacon
Installation
$ npx skills add https://github.com/clawbeacon/clawbeacon --skill claw-beacon
SKILL.md
...
Deploy Claw Beacon - Three paths: one-click, bot-assisted, or fully automated
...
One-click deploy: 👉 railway.app/deploy/claw-beacon

Or self-host: 📦 github.com/adarshmishra07/claw-beacon
...
Report their liveness via PUT /api/agents/:id/heartbeat
Get the next available task via GET /api/agents/:id/next-task
Self-assign and begin work if tasks are available
# Agent heartbeat
