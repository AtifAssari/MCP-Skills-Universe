...
url: https://skills.sh/trewknowledge/agent-skills/project-documentation
---

# project-documentation

skills/trewknowledge/agent-skills/project-documentation
project-documentation
Installation
...
Create the doc file - Use a clear, descriptive name in docs/
Start with "What" - Describe what the feature does in simple terms
...
Add to index - Add entry to docs/README.md with summary and relationships
Review for clarity - Would a non-developer understand this? Would an AI agent know what's expected?
...
Add to index - Add each feature to docs/README.md after documenting it (see Feature Index section above for template)
Link related features - Cross-reference where features interact in each doc
