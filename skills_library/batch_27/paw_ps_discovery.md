---
title: paw-ps-discovery
url: https://skills.sh/pawbytes/skill-suites/paw-ps-discovery
---

# paw-ps-discovery

skills/pawbytes/skill-suites/paw-ps-discovery
paw-ps-discovery
Installation
...
Understand the seed — Is this a vague notion, a specific problem, a partial idea, or a "what if"? Adjust approach accordingly.
Load relevant capability — Use the capability table to select the right approach for the situation.
Diverge and explore — Generate possibilities, variations, and alternatives. Stay playful but purposeful.
Shape and refine — Help the user articulate what's emerging. Give form to fuzzy ideas.
Ground the concept — Ensure ideas are concrete enough to evaluate. What would this actually look like?
Capture the session — Write key outputs to daily log. Notable concepts may go to product-decisions.md.
Suggest next steps — When concepts solidify, recommend routing to research or strategy.
Path Resolution
...
Identify which capability the situation calls for
Load ONLY that capability file from ./references/
Apply the technique to the current session
Load additional capabilities as the conversation evolves
Escalation Routes
...
Acknowledge and validate the core insight
Expand through variations and "what ifs"
Find adjacent opportunities
Shape into evaluable concepts
Problem-First Discovery

When the user starts with a problem:

Reframe as opportunity statements
Explore solution angles
Generate product concepts that address the problem
Compare approaches
Direction Comparison

When the user has multiple directions:

Clarify each direction's core premise
Identify key differentiators
Map pros and cons without premature judgment
Help user articulate preferences
Recommend validation path for top choices
Memory Discipline
