---
title: monitor
url: https://skills.sh/whawkinsiv/claude-code-skills/monitor
---

# monitor

skills/whawkinsiv/claude-code-skills/monitor
monitor
Installation
$ npx skills add https://github.com/whawkinsiv/claude-code-skills --skill monitor
SKILL.md
Monitor
