...
url: https://skills.sh/glittercowboy/taches-cc-resources/the-pirate-bay
---

# the-pirate-bay

skills/glittercowboy/taches-cc-resources/the-pirate-bay
the-pirate-bay
Installation
$ npx skills add https://github.com/glittercowboy/taches-cc-resources --skill the-pirate-bay
SKILL.md
...
API: api-reference.md — Endpoints, response shapes, rate limits, tracker list Intelligence: search-intelligence.md — Quality tiers, content type detection, query strategies, scoring Categories: categories.md — Complete numeric category code mapping </reference_index>
...
Rate limiting is handled with automatic retry/backoff </success_criteria>
Weekly Installs
29
Repository
