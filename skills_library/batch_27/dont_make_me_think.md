...
url: https://skills.sh/luongnv89/skills/dont-make-me-think
---

# dont-make-me-think

skills/luongnv89/skills/dont-make-me-think
dont-make-me-think
Installation
...
Before any file edit: show the planned changes (file path, selector, and what will change) and wait for user confirmation. For screenshot/spec output only, no confirmation is needed.
...
For each fix, show a before/after in the commit or response
