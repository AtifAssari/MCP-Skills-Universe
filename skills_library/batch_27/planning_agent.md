...
url: https://skills.sh/parcadei/continuous-claude-v3/planning-agent
---

# planning-agent

skills/parcadei/continuous-claude-v3/planning-agent
planning-agent
Installation
...
Handoff directory - Where to save your handoff (usually thoughts/handoffs/<session>/)
Codebase map (brownfield only) - Pre-generated by scout/pathfinder if this is an existing codebase
