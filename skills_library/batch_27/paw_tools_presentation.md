---
title: paw-tools-presentation
url: https://skills.sh/pawbytes/skill-suites/paw-tools-presentation
---

# paw-tools-presentation

skills/pawbytes/skill-suites/paw-tools-presentation
paw-tools-presentation
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-tools-presentation
SKILL.md
Presentation Maker
Overview
...
Pexels API — Free stock photos. Requires pexels_api_key in config.
fal.ai — AI-generated images. Requires fal_api_key in config.
