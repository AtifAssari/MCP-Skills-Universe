---
title: payments
url: https://skills.sh/whawkinsiv/claude-code-skills/payments
---

# payments

skills/whawkinsiv/claude-code-skills/payments
payments
Installation
...
How to Set Up
Stripe Dashboard -> Products -> Create one Product per tier (e.g., "Starter", "Pro")
Add two Prices per product — monthly and annual
Copy the Price IDs (price_...) into your app config
Use lookup keys for cleaner code (e.g., starter_monthly, pro_annual)
Pricing Tips
...
Automatic Recovery
Enable Smart Retries (Settings -> Billing -> Automatic collection) — Stripe retries 3 times over ~3 weeks, recovers 30-40% of failures automatically
Add your own email sequence on top of Smart Retries:
...
Stripe automatically calculates and collects tax by customer location
Cost: 0.5% per transaction. Worth it.
