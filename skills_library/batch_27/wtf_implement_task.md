---
title: wtf.implement-task
url: https://skills.sh/xiduzo/wtf/wtf.implement-task
---

# wtf.implement-task

skills/xiduzo/wtf/wtf.implement-task
wtf.implement-task
Installation
...
Commit — atomic semantic commit per ../references/commit-conventions.md. Use the Scenario: and Task: trailers:
