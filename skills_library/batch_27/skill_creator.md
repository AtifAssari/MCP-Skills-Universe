---
title: skill-creator
url: https://skills.sh/0xdarkmatter/claude-mods/skill-creator
---

# skill-creator

skills/0xdarkmatter/claude-mods/skill-creator
skill-creator
Installation
...
Agent Skills GitHub Repository - Official examples and specification
Creating Custom Skills - Step-by-step guide
What are Skills? - Overview and concepts
The Complete Guide to Building Skills for Claude - Comprehensive PDF guide
...
Multi-step processes: See references/workflows.md for sequential workflows, conditional logic, and subagent delegation patterns
Specific output formats or quality standards: See references/output-patterns.md for template and example patterns
Official examples: Browse Anthropic's skills repository for production-ready examples
