---
title: wtf.create-pr
url: https://skills.sh/xiduzo/wtf/wtf.create-pr
---

# wtf.create-pr

skills/xiduzo/wtf/wtf.create-pr
wtf.create-pr
Installation
...
If found, ask "I found Task # linked to this branch. Is that the right task?" — header Linked task:

Yes, that's correct → use Task #
...
For multiple reviewers, pass a comma-separated list: --add-reviewer user1,user2. Print the PR URL.
