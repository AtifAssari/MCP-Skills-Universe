---
title: axiom-xcode-mcp-setup
url: https://skills.sh/charleswiltgen/axiom/axiom-xcode-mcp-setup
---

# axiom-xcode-mcp-setup

skills/charleswiltgen/axiom/axiom-xcode-mcp-setup
axiom-xcode-mcp-setup
Installation
$ npx skills add https://github.com/charleswiltgen/axiom --skill axiom-xcode-mcp-setup
SKILL.md
Xcode MCP Setup
Prerequisites
...
If multiple → uses the one matching xcode-select
