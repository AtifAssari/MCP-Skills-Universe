---
title: browser-use
url: https://skills.sh/aaaaqwq/claude-code-skills/browser-use
---

# browser-use

skills/aaaaqwq/claude-code-skills/browser-use
browser-use
Installation
...
优化技巧
禁用视觉：use_vision=False
限制历史：max_history_items=10
压缩消息：message_compaction=True
减少步骤：max_actions_per_step=3
使用 Flash 模式：flash_mode=True（快速模式）
完整示例
import asyncio
from browser_use import Agent
from langchain_openai import ChatOpenAI
