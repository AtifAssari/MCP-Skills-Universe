---
title: deploy
url: https://skills.sh/whawkinsiv/claude-code-skills/deploy
---

# deploy

skills/whawkinsiv/claude-code-skills/deploy
deploy
Installation
...
Buy a domain (Namecheap, Cloudflare, or Google Domains)
In your Lovable/Replit dashboard, go to Settings → Custom Domain
Add your domain name
Update DNS records at your domain registrar (they'll tell you what to add)
Wait 5-30 minutes for DNS propagation
SSL certificate is automatic — your site will be HTTPS
...
"My site is down"
Check your hosting dashboard for deploy errors or resource limits
Check your database — is it running? Is it full?
Check environment variables — did any API keys expire?
Check Stripe/Supabase/other service status pages
If you can't figure it out within 30 minutes, check your hosting platform's logs
