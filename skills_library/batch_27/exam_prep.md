---
title: exam-prep
url: https://skills.sh/szeyu/vibe-study-skills/exam-prep
---

# exam-prep

skills/szeyu/vibe-study-skills/exam-prep
exam-prep
Installation
$ npx skills add https://github.com/szeyu/vibe-study-skills --skill exam-prep
SKILL.md
Exam Prep
...
Workflow
flowchart LR
    A[Assess Time & Material] --> B[Create Study Plan]
    B --> C[Build Review Materials]
    C --> D[Practice & Test]
...
Total study hours: Days × Hours = ___
Material Assessment
...
Source questions from textbook, past exams, problem sets
Match format to actual exam (MCQ, short answer, essay)
Time it realistically
Grade honestly with answer key
During Practice
