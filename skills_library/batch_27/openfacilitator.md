---
title: openfacilitator
url: https://skills.sh/rawgroundbeef/openfacilitator/openfacilitator
---

# openfacilitator

skills/rawgroundbeef/openfacilitator/openfacilitator
openfacilitator
Installation
$ npx skills add https://github.com/rawgroundbeef/openfacilitator --skill openfacilitator
SKILL.md
...
Middleware (recommended) — Drop-in Express or Hono middleware that handles the full 402 flow automatically.
Manual verify + settle — Call verify() and settle() yourself for full control over business logic between verification and settlement.
