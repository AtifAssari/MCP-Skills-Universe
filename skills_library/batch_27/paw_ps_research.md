---
title: paw-ps-research
url: https://skills.sh/pawbytes/skill-suites/paw-ps-research
---

# paw-ps-research

skills/pawbytes/skill-suites/paw-ps-research
paw-ps-research
Installation
...
Clarify scope — What specific question needs answering? What decisions will this inform?
Determine depth — Quick scan or deep dive? Adjust time investment accordingly
Load relevant capability — Read the matched capability file from ./references/
Execute research — Gather data using appropriate tools and sources
Synthesize with confidence — Organize findings with explicit confidence levels
Flag uncertainty — Clearly separate evidence from inference
Save to memory — Write to curated/market-intelligence.md and daily log
Recommend decisions — What product decisions does this inform?
Path Resolution
...
{project-root}/.pawbytes/prodig-suites/memory/paw-ps-sidecar/index.md — sidecar orientation
{project-root}/.pawbytes/prodig-suites/memory/paw-ps-sidecar/curated/market-intelligence.md — existing research
{project-root}/.pawbytes/prodig-suites/memory/paw-ps-sidecar/curated/product-context.md — if active product exists
What to Write
Output	Path
