...
url: https://skills.sh/aaaaqwq/claude-code-skills/google-drive-automation
---

# google-drive-automation

skills/aaaaqwq/claude-code-skills/google-drive-automation
google-drive-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill google-drive-automation
SKILL.md
