...
url: https://skills.sh/ederheisler/agent-skills/tailwind-v4-shadcn
---

# tailwind-v4-shadcn

skills/ederheisler/agent-skills/tailwind-v4-shadcn
tailwind-v4-shadcn
Installation
...
Use @apply with @layer base or @layer components classes (v4 breaking change - use @utility instead)
Wrap ANY styles in @layer base without understanding CSS layer ordering (see error #8)
...
Error: Styles defined in @layer base seem to be ignored Source: GitHub Discussion #16002
