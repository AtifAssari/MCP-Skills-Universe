---
title: pricing
url: https://skills.sh/whawkinsiv/claude-code-skills/pricing
---

# pricing

skills/whawkinsiv/claude-code-skills/pricing
pricing
Installation
$ npx skills add https://github.com/whawkinsiv/claude-code-skills --skill pricing
SKILL.md
