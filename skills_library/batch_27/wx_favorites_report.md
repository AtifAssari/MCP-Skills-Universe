---
title: wx-favorites-report
url: https://skills.sh/aradotso/trending-skills/wx-favorites-report
---

# wx-favorites-report

skills/aradotso/trending-skills/wx-favorites-report
wx-favorites-report
Installation
...
Check log for any entries: wc -l /tmp/wechat_frida_keys.log
Salt mismatch — re-read salt: xxd ~/…/favorite.db | head -2 (bytes 16–31 after the ASCII header).
