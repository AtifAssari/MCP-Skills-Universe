---
title: self-learning
url: https://skills.sh/pixel-process-ug/superkit-agents/self-learning
---

# self-learning

skills/pixel-process-ug/superkit-agents/self-learning
self-learning
Installation
...
Check Last updated dates — flag anything older than 30 days
Spot-check 2-3 facts against current codebase (e.g., does package.json still list the same framework?)
If discrepancies found, run a targeted re-scan of the changed area
