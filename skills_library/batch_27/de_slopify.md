---
title: de-slopify
url: https://skills.sh/dicklesworthstone/agent_flywheel_clawdbot_skills_and_integrations/de-slopify
---

# de-slopify

skills/dicklesworthstone/agent_flywheel_clawdbot_skills_and_integrations/de-slopify
de-slopify
Installation
...
Context matters — Sometimes an emdash is actually the right choice
Recasting sentences — Often the fix isn't substitution but rewriting
Tone consistency — Need to maintain voice throughout
Judgment calls — Some patterns are fine in moderation
Emdash Alternatives
