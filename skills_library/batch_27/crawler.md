---
title: crawler
url: https://skills.sh/alpoxdev/hypercore/crawler
---

# crawler

skills/alpoxdev/hypercore/crawler
crawler
Installation
...
Use playwriter-commands.md when you need session control, page interaction, visual inspection, or selector validation.
Use cdp-capture.md when you need structured network, cookie, token, storage, or rate-limit evidence with lower token cost.
Use network-crawling.md when turning Playwriter/CDP evidence into API.md, NETWORK.md, and raw evidence files.
...
Use action-manifest.md when the run needs a durable state file under .hypercore/crawler/<ACTION>.json.
Use document-templates.md when writing .hypercore/crawler/[site]/ artifacts.
