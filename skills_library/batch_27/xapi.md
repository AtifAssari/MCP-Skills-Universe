---
title: xapi
url: https://skills.sh/xapi-labs/xapi-cli/xapi
---

# xapi

skills/xapi-labs/xapi-cli/xapi
xapi
Installation
$ npx skills add https://github.com/xapi-labs/xapi-cli --skill xapi
SKILL.md
xapi CLI Skill
...
Capabilities (--source capability) — Built-in APIs with known IDs (Twitter, crypto, AI, web search, news)
Third-party APIs (--source api) — Proxied services, discovered via list, search, or services
