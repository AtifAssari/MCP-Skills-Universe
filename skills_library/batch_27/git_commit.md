---
title: git-commit
url: https://skills.sh/alpoxdev/hypercore/git-commit
---

# git-commit

skills/alpoxdev/hypercore/git-commit
git-commit
Installation
...
If git rev-parse --show-toplevel succeeds, inspect the current repository:
scripts/repo-status.sh

If the current directory is not a repository but descendant repositories exist, inspect each repository independently:
