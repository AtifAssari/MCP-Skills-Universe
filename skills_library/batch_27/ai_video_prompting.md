...
url: https://skills.sh/guia-matthieu/clawfu-skills/ai-video-prompting
---

# ai-video-prompting

skills/guia-matthieu/clawfu-skills/ai-video-prompting
ai-video-prompting
Installation
$ npx skills add https://github.com/guia-matthieu/clawfu-skills --skill ai-video-prompting
SKILL.md
AI Video Prompting
...
Sélectionne le modèle optimal - Selon le type de shot et les besoins
Structure les prompts par modèle - Formats optimisés pour chaque plateforme
Configure les paramètres techniques - Durée, résolution, aspect ratio
Guide le workflow image-to-video - Upload et animation des frames
Planifie les extensions de scène - Clips continus au-delà de 8 secondes
How to Use
...
Medium shot of a confident businesswoman walking through a modern glass office lobby. Slow dolly following her from the side. Warm morning sunlight streaming through windows, creating lens flares. Cinematic corporate style, shallow depth of field. Sound of heels clicking on marble floor, ambient office murmur in background.
...
Prompt: A mysterious forest at twilight, fog rolling between ancient trees, fireflies beginning to glow. Ethereal fantasy atmosphere, cinematic color grading.

Camera: Dolly In, Medium intensity

First Frame: [Upload image du storyboard] Duration: 10 seconds
...
Prompt: An astronaut in a futuristic space station, speaking directly to camera. Sci-fi movie lighting, volumetric fog, control panels glowing in background. Transfer facial expressions and lip movements from driving video.

Duration: 10 seconds Resolution: 1080p
...
Prompt: Smooth transformation from messy to organized office space, papers flying into place, magical organization sequence. Time-lapse feel, 5 seconds.
...
Prompt: Replace the coffee cup with a futuristic glowing red energy drink, matching lighting and hand movements perfectly.
...
Prompt: A colorful cartoon dragon flying through the scene, casting shadow on the street, looking down curiously at the people below.
...
Clip 1 (0:00-0:08): Génération initiale ↓ Dernière frame de Clip 1 ↓ Clip 2 (0:08-0:16): Scene extension avec cette frame ↓ Répéter
...
Post-production
Assembler les 2 clips
Ajouter votre voix originale (ou garder Kling audio)
Ajuster couleurs pour cohérence
Ajouter texte/CTA en post
...
References
Google Developers - Veo 3.1
Runway Help - Gen-3 Alpha
Higgsfield - Kling 2.6 Guide
Pika Labs Documentation
MKTG Skills - Étude Écosystème Vidéo IA
Related Skills
ai-storyboard-2x2 - Étape précédente: frames à animer
ai-voice-design - Pour la création audio/voix
ai-video-qa - Étape suivante: contrôle qualité
Skill Metadata
Mode: cyborg
