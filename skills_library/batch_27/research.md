---
title: research
url: https://skills.sh/alpoxdev/hypercore/research
---

# research

skills/alpoxdev/hypercore/research
research
Installation
...
"Research react useEffectEvent" or a local slash invocation such as "/research react useEffectEvent" Use research only if the user wants synthesis across multiple sources; otherwise do a direct official-doc lookup.
"Research" with no topic, or a local slash invocation such as "/research" Ask immediately for the missing topic before doing any collection work.
...
This core SKILL.md to confirm that the job is research and to pick the depth.
instructions/sourcing/reliable-search.md before running multiple live searches so query dedupe, recency handling, and stop conditions stay explicit.
...
references/report-template.md when drafting or saving the report.
