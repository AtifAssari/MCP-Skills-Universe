---
title: jira
url: https://skills.sh/jwmossmoz/agent-skills/jira
---

# jira

skills/jwmossmoz/agent-skills/jira
jira
Installation
...
Humanize the description - Use /humanizer to remove AI writing patterns from the description text
Submit the story - Use the humanized description with --create
Example Workflow
