---
title: wuritu-stock-technical-analysis
url: https://skills.sh/site/skills.volces.com/wuritu-stock-technical-analysis
---

# wuritu-stock-technical-analysis

skills/skills.volces.com/stock_technical_analysis
stock_technical_analysis
$ npx skills add https://skills.volces.com/skills/clawhub/wuritu
SKILL.md
股票技术分析技能
触发条件
...
以结构化 Markdown 报告输出，包含数据表格和文字解读 必须包含⚠️风险提示：技术分析仅供参考，不构成投资建议

Weekly Installs
28
Source
skills.volces.c…b/wuritu
First Seen
3 days ago