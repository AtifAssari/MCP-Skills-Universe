---
title: spec-writing
url: https://skills.sh/pixel-process-ug/superkit-agents/spec-writing
---

# spec-writing

skills/pixel-process-ug/superkit-agents/spec-writing
spec-writing
Installation
...
Check each against the Cardinal Rule (no code, no implementation details)
