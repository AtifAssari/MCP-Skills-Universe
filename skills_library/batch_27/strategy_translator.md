---
title: strategy-translator
url: https://skills.sh/xbklairith/kisune/strategy-translator
---

# strategy-translator

skills/xbklairith/kisune/strategy-translator
strategy-translator
Installation
...
Reads strategy document
Identifies RSI indicator needed
Notes entry rules (RSI < 30, then crosses above)
Generates Python code with:
calculate_rsi() function
check_entry_conditions() function
calculate_position_size() function
Complete usage example
Provides code with docstrings and type hints
