---
title: paw-wbc-setup
url: https://skills.sh/pawbytes/skill-suites/paw-wbc-setup
---

# paw-wbc-setup

skills/pawbytes/skill-suites/paw-wbc-setup
paw-wbc-setup
Installation
...
On Activation
Read ./assets/module.yaml for module metadata
Check if {project-root}/.pawbytes/webinar-suites/ exists — if present, inform the user this is an update
Check for core Pawbytes config at {project-root}/.pawbytes/config/config.yaml
...
webinars/{webinar-slug}/ ├── brief.md # Initial brief + audience context ├── research-context.md # Compressed research findings ├── hook-selected.md # Chosen hook + reasoning ├── slide-deck-outline.md # LLM-ready slide structure ├── script.md # Full + partial script └── recommendations.md # Surfaced insights to consider
