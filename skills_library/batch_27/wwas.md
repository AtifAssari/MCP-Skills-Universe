---
title: wwas
url: https://skills.sh/borghei/claude-skills/wwas
---

# wwas

skills/borghei/claude-skills/wwas
wwas
Installation
...
New users who complete the setup wizard activate within 3 days (measured by creating their first dashboard).
The wizard is accessible on mobile and desktop browsers.
Users can skip the wizard at any step and resume later from where they left off.
Users who skip the wizard can access it again from the help menu.
...
Acceptance Criteria:
 ...
 Users can skip the wizard at any step and return to it later from the help menu.
 Each milestone (data source, teammate, dashboard) can be completed independently and in any order.
 Users who complete all three milestones see a completion confirmation with suggested next steps.
 The wizard does not appear for existing users who have already completed setup.
 The wizard is functional on both desktop and mobile browsers.
