---
title: tanstack-start-architecture
url: https://skills.sh/alpoxdev/hypercore/tanstack-start-architecture
---

# tanstack-start-architecture

skills/alpoxdev/hypercore/tanstack-start-architecture
tanstack-start-architecture
Installation
...
architecture-rules.md for the rule taxonomy and blocking gate summary.
Topic rules by changed surface:
...
references/official/tanstack-start-2026-04-30.md when Start API behavior matters.
references/official/tanstack-router-2026-04-30.md when Router/file-route/search/loading behavior matters.
references/official/api-drift-notes.md when docs conflict or current package behavior is uncertain.
rules/validation.md before claiming completion.
