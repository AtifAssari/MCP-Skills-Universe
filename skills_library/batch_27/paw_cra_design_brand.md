---
title: paw-cra-design-brand
url: https://skills.sh/pawbytes/skill-suites/paw-cra-design-brand
---

# paw-cra-design-brand

skills/pawbytes/skill-suites/paw-cra-design-brand
paw-cra-design-brand
Installation
...
Use the AI-generated image as background
Build HTML/CSS overlay with headline, body copy, CTA, brand logo, and contact info
Apply brand typography and colors from guidelines
Render via Puppeteer/Playwright using element-specific screenshots (never fullPage: true)
For print: render at 300 DPI equivalent resolution (A4 = 2480x3508px)
