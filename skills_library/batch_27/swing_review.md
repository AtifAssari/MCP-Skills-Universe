---
title: swing-review
url: https://skills.sh/whynowlab/swing-skills/swing-review
---

# swing-review

skills/whynowlab/swing-skills/swing-review
swing-review
Installation
...
Gotchas
Steel-man first, always. Skipping it produces straw-man critiques the author will dismiss. If you can't articulate why the current approach was chosen, you don't understand it well enough to critique it.
Don't pad with style nitpicks. "Rename this variable" and "add comments" are not adversarial findings. Attack the architecture, the logic, the edge cases — not formatting.
Verdict must follow the threshold rules. Don't upgrade PASS to PASS WITH CONDITIONS because you "feel" something is off. No Major finding = PASS. Period.
Every criticism needs a fix AND a trade-off. "This is bad" without a concrete alternative is venting, not reviewing. And every fix has a cost — state it.
Read the code before reviewing. Never critique based on file names or descriptions alone. Use Read/Grep to examine actual implementation.
Integration Notes
