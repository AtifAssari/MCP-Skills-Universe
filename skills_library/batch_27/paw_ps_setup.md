---
title: paw-ps-setup
url: https://skills.sh/pawbytes/skill-suites/paw-ps-setup
---

# paw-ps-setup

skills/pawbytes/skill-suites/paw-ps-setup
paw-ps-setup
Installation
...
On Activation
Read ./assets/module.yaml for module metadata and variable definitions (the code field ps is the module identifier)
Check if {project-root}/.pawbytes/prodig-suites/ exists — if present, inform the user this is an update
