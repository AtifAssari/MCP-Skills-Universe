...
url: https://skills.sh/aaaaqwq/claude-code-skills/zendesk-automation
---

# zendesk-automation

skills/aaaaqwq/claude-code-skills/zendesk-automation
zendesk-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill zendesk-automation
SKILL.md
