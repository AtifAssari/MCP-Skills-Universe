---
title: brewcode:plan
url: https://skills.sh/kochetkov-ma/claude-brewcode/brewcode:plan
---

# brewcode:plan

skills/kochetkov-ma/claude-brewcode/brewcode:plan
brewcode:plan
Installation
...
Project templates: .claude/tasks/templates/{name}.template (adapted by /brewcode:setup)
Plugin fallback: $BC_PLUGIN_ROOT/skills/setup/templates/{name}.template
