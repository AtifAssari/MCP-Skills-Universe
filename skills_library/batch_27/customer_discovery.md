...
url: https://skills.sh/guia-matthieu/clawfu-skills/customer-discovery
---

# customer-discovery

skills/guia-matthieu/clawfu-skills/customer-discovery
customer-discovery
Installation
...
Documents business hypotheses - Turns assumptions into testable statements
Designs validation experiments - Creates tests that can prove you wrong
Structures customer conversations - Gets real insights, not false positives
Evaluates problem-solution fit - Determines if you should proceed, pivot, or stop
Creates learning roadmap - Prioritizes what to validate first
Tracks validation progress - Maintains evidence-based decision making
How to Use
