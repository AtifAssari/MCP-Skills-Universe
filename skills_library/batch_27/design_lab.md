---
title: design-lab
url: https://skills.sh/0xdesign/design-plugin/design-lab
---

# design-lab

skills/0xdesign/design-plugin/design-lab
design-lab
Installation
...
User: /design-variations:design CheckoutSummary
Plugin detects: Next.js App Router, Tailwind, pnpm
Plugin finds: No existing Design Memory
Plugin asks: Interview questions (5 steps)
Plugin generates: Design Brief summary
Plugin creates: .claude-design/lab/ with 5 variants
Plugin creates: app/__design_lab/page.tsx
Plugin starts: pnpm dev
Plugin outputs: "Open http://localhost:3000/__design_lab"
...
User: "Looks good"
Plugin creates: Final preview at /__design_preview
User: "Confirmed"
Plugin: Deletes all temp files
Plugin: Generates DESIGN_PLAN.md
Plugin: Creates DESIGN_MEMORY.md
Plugin: "Done! See DESIGN_PLAN.md for implementation steps"
Weekly Installs
218
Repository
