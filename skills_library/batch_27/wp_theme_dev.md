---
title: wp-theme-dev
url: https://skills.sh/wpacademy/wordpress-dev-skills/wp-theme-dev
---

# wp-theme-dev

skills/wpacademy/wordpress-dev-skills/wp-theme-dev
wp-theme-dev
Installation
...
Determine theme type — Ask if the user wants a block theme (recommended), classic theme, or child theme
Gather requirements — Design goals, color palette, typography, features needed
Scaffold — Generate the directory structure, required files, and theme.json
Build templates & patterns — Create each template/pattern as a separate file
Generate readme.txt — Always include a WordPress.org-compliant readme.txt
Deliver — Ask user if they want files for download or a custom path
...
Always include readme.txt and style.css with all required headers
Provide a brief summary of generated files
If using a build process (block theme with custom blocks), note npm install && npm run build is needed
