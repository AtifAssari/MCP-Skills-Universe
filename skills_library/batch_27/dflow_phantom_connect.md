---
title: dflow-phantom-connect
url: https://skills.sh/dflowprotocol/dflow_phantom-connect-skill/dflow-phantom-connect
---

# dflow-phantom-connect

skills/dflowprotocol/dflow_phantom-connect-skill/dflow-phantom-connect
dflow-phantom-connect
Installation
$ npx skills add https://github.com/dflowprotocol/dflow_phantom-connect-skill --skill dflow-phantom-connect
SKILL.md
...
Use useModal hook for a connect button
Use useAccounts to display the connected wallet address
...
Read references/react-sdk.md and references/token-gating.md
...
Read references/dflow-crypto-trading.md
If unsure on trade type, suggest imperative /order flow (simpler, synchronous)
Connect wallet with Phantom, sign and submit transaction to Solana RPC
...
Read references/dflow-prediction-markets.md and references/dflow-proof.md
Build market discovery UI from Metadata API
...
Read the relevant SDK reference AND references/dflow-crypto-trading.md
Set up wallet connection with Phantom
Build swap form, proxy /order calls through backend
Sign transaction with connected wallet, submit to RPC
