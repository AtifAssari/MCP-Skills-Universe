---
title: web-search
url: https://skills.sh/aaaaqwq/claude-code-skills/web-search
---

# web-search

skills/aaaaqwq/claude-code-skills/web-search
web-search
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill web-search
SKILL.md
网络搜索与网页内容获取
功能说明
