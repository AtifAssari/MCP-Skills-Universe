---
title: vscode-extension-publisher
url: https://skills.sh/luongnv89/skills/vscode-extension-publisher
---

# vscode-extension-publisher

skills/luongnv89/skills/vscode-extension-publisher
vscode-extension-publisher
Installation
...
Node.js installed: node --version (requires v18+)
npm installed: npm --version
vsce installed: vsce --version — if missing, run npm install -g @vscode/vsce
package.json exists in the extension root directory
...
Verify by running: vsce login <publisher-id>
...
Publishing triggers on git tags matching v* (e.g., v1.0.0)
...
Package with vsce package and test locally
...
Copy assets/github-actions-publish.yml to .github/workflows/publish.yml
Guide user to add VSCE_PAT secret to GitHub repo
Explain tagging workflow: git tag v1.0.0 && git push origin v1.0.0
...
Scope: Marketplace > Manage
Re-login: vsce login <publisher-id>
