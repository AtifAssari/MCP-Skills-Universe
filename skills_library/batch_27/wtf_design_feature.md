---
title: wtf.design-feature
url: https://skills.sh/xiduzo/wtf/wtf.design-feature
---

# wtf.design-feature

skills/xiduzo/wtf/wtf.design-feature
wtf.design-feature
Installation
...
Path A — Human provides frames: Collect the top-level Figma file URL plus individual frame URLs. For each screen in the journey map (step 5), check whether a frame covers it. Present a coverage matrix: screen → frame URL (or ⚠ gap). If gaps exist, ask "How should I handle the uncovered screens?" — header Gaps:
...
Partial: Collect available frame URLs, run Path A validation on covered screens. For uncovered screens, ask "How should I handle the remaining screens?" — header Remainder:
