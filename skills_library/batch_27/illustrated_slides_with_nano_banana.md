---
title: illustrated-slides-with-nano-banana
url: https://skills.sh/fluxa-agent-payment/skills/illustrated-slides-with-nano-banana
---

# illustrated-slides-with-nano-banana

skills/fluxa-agent-payment/skills/illustrated-slides-with-nano-banana
illustrated-slides-with-nano-banana
Installation
$ npx skills add https://github.com/fluxa-agent-payment/skills --skill illustrated-slides-with-nano-banana
SKILL.md
Illustrated Slides with Nano Banana
...
API Details
Endpoint: https://proxy-monetize.fluxapay.xyz/api/nano-banana/gen-image
Method: POST
