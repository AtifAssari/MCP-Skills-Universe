---
title: growth
url: https://skills.sh/whawkinsiv/claude-code-skills/growth
---

# growth

skills/whawkinsiv/claude-code-skills/growth
growth
Installation
$ npx skills add https://github.com/whawkinsiv/claude-code-skills --skill growth
SKILL.md
...
Duration: Run for 1-2 weeks minimum, or until 100+ users have been through the flow.
Decide: Did the metric improve? Ship it or revert.
Document: Write down what you learned, even (especially) from failures.
