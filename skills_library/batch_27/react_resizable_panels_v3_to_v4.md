---
title: react-resizable-panels-v3-to-v4
url: https://skills.sh/wenerme/ai/react-resizable-panels-v3-to-v4
---

# react-resizable-panels-v3-to-v4

skills/wenerme/ai/react-resizable-panels-v3-to-v4
react-resizable-panels-v3-to-v4
Installation
...
关键陷阱: v3 的 data-panel-group-direction 是组的方向，v4 的 aria-orientation 是分隔条自身的方向。语义完全翻转！
