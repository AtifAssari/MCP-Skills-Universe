---
title: whiteboard-video-workflow
url: https://skills.sh/yangagent/whiteboard-animation-skill/whiteboard-video-workflow
---

# whiteboard-video-workflow

skills/yangagent/whiteboard-animation-skill/whiteboard-video-workflow
whiteboard-video-workflow
Installation
...
在 <skill-dir>/.env 文件中添加一行：RUNNINGHUB_API_KEY=你的API密钥
如果文件不存在，先创建它
API Key 可在 RunningHub 获取
配置完成后重新运行即可
...
请确认你的 Python 版本为 3.9 或更高版本
然后重新运行本工作流，脚本会再次尝试自动安装
