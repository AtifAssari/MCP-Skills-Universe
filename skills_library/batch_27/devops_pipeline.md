...
url: https://skills.sh/luongnv89/skills/devops-pipeline
---
...
Builds/installs the CLI in a temp environment
Runs each command with representative inputs (including edge cases: empty input, invalid flags, --help)
Asserts exit codes and key output patterns
...
scripts/e2e_test.sh (CLI projects only) — executable script exercising every CLI command/subcommand.
