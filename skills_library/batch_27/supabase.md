---
title: supabase
url: https://skills.sh/jawwadfirdousi/agent-skills/supabase
---

# supabase

skills/jawwadfirdousi/agent-skills/supabase
supabase
Installation
$ npx skills add https://github.com/jawwadfirdousi/agent-skills --skill supabase
SKILL.md
Supabase CLI

Interact with Supabase projects: queries and schema management. The script auto-loads .env.supabase.* files as needed.
