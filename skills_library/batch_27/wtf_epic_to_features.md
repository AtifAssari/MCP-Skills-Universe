---
title: wtf.epic-to-features
url: https://skills.sh/xiduzo/wtf/wtf.epic-to-features
---

# wtf.epic-to-features

skills/xiduzo/wtf/wtf.epic-to-features
wtf.epic-to-features
Installation
...
Follow the wtf.write-feature process, passing:
...
Before moving to the next Feature, ask "Feature [N] created. Ready to continue to Feature [N+1]: [next capability name]?" — header Continue?:
