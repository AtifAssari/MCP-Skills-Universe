...
url: https://skills.sh/aaaaqwq/claude-code-skills/mailchimp-automation
---

# mailchimp-automation

skills/aaaaqwq/claude-code-skills/mailchimp-automation
mailchimp-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill mailchimp-automation
SKILL.md
