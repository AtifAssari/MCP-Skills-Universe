---
title: preline-theme-generator
url: https://skills.sh/htmlstreamofficial/preline/preline-theme-generator
---

# preline-theme-generator

skills/htmlstreamofficial/preline/preline-theme-generator
preline-theme-generator
Installation
...
Theme scoping block (@theme theme-<name> inline { }) — contains custom color palettes only
Light mode theme selector block (full semantic token set using var() references)
Dark mode theme selector block (override only what differs, use var() for consistency)
Optional theme-scoped @layer utilities overrides (only if requested)
Additional guidance
