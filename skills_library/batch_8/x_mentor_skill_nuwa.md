---
title: x-mentor-skill-nuwa
url: https://skills.sh/aradotso/trending-skills/x-mentor-skill-nuwa
---

# x-mentor-skill-nuwa

skills/aradotso/trending-skills/x-mentor-skill-nuwa
x-mentor-skill-nuwa
Installation
...
KPI Dashboard — followers, ER rate, posting frequency
Content ROI — which content types deliver most engagement per hour invested
Distribution Funnel — impressions → likes → replies → follows
Time Analysis — best/worst posting windows
Brand Narrative — positioning clarity score
Action Plan — top 3 highest-ROI changes
