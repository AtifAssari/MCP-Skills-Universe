---
title: generating-custom-lightning-type
url: https://skills.sh/forcedotcom/afv-library/generating-custom-lightning-type
---

# generating-custom-lightning-type

skills/forcedotcom/afv-library/generating-custom-lightning-type
generating-custom-lightning-type
Installation
...
(Optional) Draft editor.json (only if custom UI is required)
...
(Optional) Draft renderer.json (only if custom UI is required)
