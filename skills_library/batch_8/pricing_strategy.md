...
url: https://skills.sh/kostja94/marketing-skills/pricing-strategy
---

# pricing-strategy

skills/kostja94/marketing-skills/pricing-strategy
pricing-strategy
Installation
$ npx skills add https://github.com/kostja94/marketing-skills --skill pricing-strategy
SKILL.md
Strategies: Pricing
...
Product type: SaaS, tool, e-commerce
Value metric: What drives value (seats, usage, features)
Market: Competitor pricing; willingness to pay
Goals: Revenue, adoption, retention
Pricing Models
Model	Use
