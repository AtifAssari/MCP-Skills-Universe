...
url: https://skills.sh/davila7/claude-code-templates/scientific-schematics
---

# scientific-schematics

skills/davila7/claude-code-templates/scientific-schematics
scientific-schematics
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill scientific-schematics
Summary
...
Uses Nano Banana Pro for generation and Gemini 3 Pro for quality review, with smart iteration that stops early if quality meets the threshold for your document type (journal: 8.5/10, poster: 7.0/10, presentation: 6.5/10, etc.)
Handles layout, labels, colors, and styling automatically; no coding, templates, or manual drawing required
Includes accessibility features like colorblind-friendly palettes, grayscale compatibility, and overlap detection for publication readiness
SKILL.md
