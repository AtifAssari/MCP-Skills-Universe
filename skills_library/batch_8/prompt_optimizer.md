...
url: https://skills.sh/daymade/claude-code-skills/prompt-optimizer
---

# prompt-optimizer

skills/daymade/claude-code-skills/prompt-optimizer
prompt-optimizer
Installation
...
Generates structured prompts using Role/Skills/Workflows/Examples/Formats framework with concrete examples and real data
Includes reference materials for EARS syntax, 40+ domain theories, complete transformation examples, and advanced techniques for multi-stakeholder or non-functional requirements
SKILL.md
Prompt Optimizer
Overview
