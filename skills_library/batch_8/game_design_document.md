...
url: https://skills.sh/ityes22/game-design-document/game-design-document
---

# game-design-document

skills/ityes22/game-design-document/game-design-document
game-design-document
Installation
$ npx skills add https://github.com/ityes22/game-design-document --skill game-design-document
SKILL.md
...
.docx via scripts/generate_gdd_docx.py — Professional Word document with TOC, custom styles, tables, callout boxes, page numbers, cover page
.pdf via scripts/generate_gdd_pdf.py — Print-ready PDF suitable for email to publishers/investors
...
User-supplied — explicitly attributed: [User-provided: ...]
Sourced — with a citation: [Source: title, year, URL or publication]
Declared as an assumption — flagged for validation: [Assumption: ...; validate before external use]
