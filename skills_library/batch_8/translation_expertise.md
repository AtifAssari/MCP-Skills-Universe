...
url: https://skills.sh/shino369/claude-code-personal-workspace/translation-expertise
---

# translation-expertise

skills/shino369/claude-code-personal-workspace/translation-expertise
translation-expertise
Installation
...
Read the entire source text to understand context and intent
Identify key terminology and create a glossary
Translate section by section, maintaining context
...
Verify idioms are culturally appropriate (see translation-challenges.md)
...
Review feedback from proofreading
Resolve all marked uncertainties
Improve awkward phrasings
Polish for naturalness and readability
...
Technical Correctness:
 ...
 No typos or errors
Best Practices
Always Translate in Context: Never translate sentences in isolation
Maintain Terminology Consistency: Use glossaries and translation memories
Research Thoroughly: Look up unfamiliar terms and verify meanings
Read Aloud: Natural translations sound good when read aloud
Get Feedback: Have native speakers review when possible
Iterate: First draft is rarely perfect, refinement is essential
Document Decisions: Keep notes on difficult translation choices
Stay Updated: Language evolves, keep learning new expressions and terms
Know Your Limits: Flag areas requiring subject matter expertise
Preserve Intent: When in doubt, prioritize the author's intended meaning
Tools and Resources
...
Read entire source text first for context
Create terminology glossary for consistency
Choose appropriate formality level early
Handle idioms culturally, not literally
Verify punctuation conventions for target language
Proofread for naturalness and accuracy
Get native speaker feedback when possible
