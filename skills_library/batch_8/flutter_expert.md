...
url: https://skills.sh/sickn33/antigravity-awesome-skills/flutter-expert
---

# flutter-expert

skills/sickn33/antigravity-awesome-skills/flutter-expert
flutter-expert
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill flutter-expert
Summary
...
Provides platform integration expertise for iOS, Android, web, and desktop with native plugin development and bidirectional communication
Includes advanced UI implementation, comprehensive testing strategies (unit, widget, integration, golden files), and accessibility-first development with Material Design 3
Addresses security, offline-first data persistence, CI/CD deployment automation, and emerging technology integration (AR, ML, IoT)
SKILL.md
Use this skill when
