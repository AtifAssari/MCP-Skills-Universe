---
title: flask
url: https://skills.sh/jezweb/claude-skills/flask
---

# flask

skills/jezweb/claude-skills/flask
flask
Installation
...
Import routes at bottom of blueprint __init__.py - After bp is created
Use current_app not app - Inside request context
Use with app.app_context() - When accessing db outside requests
Never Do
