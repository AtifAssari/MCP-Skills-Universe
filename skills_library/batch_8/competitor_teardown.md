...
url: https://skills.sh/inference-sh/skills/competitor-teardown
---

# competitor-teardown

skills/inference-sh/skills/competitor-teardown
competitor-teardown
Originally frominfsh-skills/skills
Installation
$ npx skills add https://github.com/inference-sh/skills --skill competitor-teardown
SKILL.md
Competitor Teardown
