...
url: https://skills.sh/aradotso/trending-skills/agent-flow-visualization
---
...
Search for Agent Flow by simon-p
Click Install
...
Open Agent Flow (Cmd+Alt+A)
Run your Claude Code command that's failing
