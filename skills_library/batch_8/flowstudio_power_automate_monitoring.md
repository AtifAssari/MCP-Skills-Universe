---
title: flowstudio-power-automate-monitoring
url: https://skills.sh/github/awesome-copilot/flowstudio-power-automate-monitoring
---

# flowstudio-power-automate-monitoring

skills/github/awesome-copilot/flowstudio-power-automate-monitoring
flowstudio-power-automate-monitoring
Installation
...
If their question can be answered with live tools (e.g. "list flows in one environment"), offer to use the power-automate-mcp skill instead
