---
title: n8n
url: https://skills.sh/vladm3105/aidoc-flow-framework/n8n
---

# n8n

skills/vladm3105/aidoc-flow-framework/n8n
n8n
Installation
...
Offers multiple execution models: manual, webhook, schedule, event-based, and error-triggered workflows with modular sub-workflow patterns
Provides Code node execution in JavaScript and Python for inline transformations, API calls, and data processing without building custom nodes
Covers self-hosted and cloud deployment options with queue mode scaling, database configuration (SQLite/PostgreSQL/MySQL), and monitoring strategies for high-volume automation
SKILL.md
