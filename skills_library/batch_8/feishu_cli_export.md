---
title: feishu-cli-export
url: https://skills.sh/riba2534/feishu-cli/feishu-cli-export
---

# feishu-cli-export

skills/riba2534/feishu-cli/feishu-cli-export
feishu-cli-export
Installation
...
完整流程
导出时添加图片参数：--download-images --assets-dir <dir>
检查图片文件：ls <assets_dir>/
读取图片内容：使用 Read 工具逐个读取图片
整合分析：将图片描述与文档文本结合
错误处理与边界情况
1. 常见错误
错误	原因	解决
