---
title: draw-io
url: https://skills.sh/softaworks/agent-toolkit/draw-io
---

# draw-io

skills/softaworks/agent-toolkit/draw-io
draw-io
...
Open .drawio file in text editor (plain XML format)
Find mxCell for element to adjust (search by value attribute for text)
Adjust coordinates in mxGeometry tag
