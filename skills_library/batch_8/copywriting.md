---
title: copywriting
url: https://skills.sh/davila7/claude-code-templates/copywriting
---

# copywriting

skills/davila7/claude-code-templates/copywriting
copywriting
Originally fromcoreyhaines31/marketingskills
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill copywriting
Summary

Expert conversion copywriting for marketing pages that clarifies value and drives action.

Gathers audience, product, and context before writing to ensure copy speaks directly to customer pain points and motivations
Applies core principles: clarity over cleverness, benefits over features, specificity over vagueness, and customer language over company jargon
Provides structured copy organized by page type (homepage, landing page, pricing, feature, about) with section frameworks and CTA formulas
Includes headline alternatives, rationale for each choice, and annotations explaining copywriting decisions
Complements the copy-editing skill for line-by-line polish and the page-cro skill for broader page strategy and structure
SKILL.md
Copywriting
