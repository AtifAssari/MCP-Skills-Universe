...
url: https://skills.sh/sickn33/antigravity-awesome-skills/multi-agent-brainstorming
---
...
Sequential review workflow where the designer proposes, then three reviewer agents provide feedback in order, with mandatory Decision Log recording all objections and resolutions
Exit criteria enforce completion: Understanding Lock, all reviewers invoked, objections resolved or rejected, and Arbiter approval required before proceeding
Prevents idea swarm chaos, hallucinated consensus, and overconfident designs by centralizing creativity while distributing constrained critique
SKILL.md
