...
url: https://skills.sh/pproenca/dot-skills/react-hook-form
---
...
Includes integration patterns for shadcn, Material-UI, and Ant Design components with specific wiring guidance
Focused on client-side controlled forms; does not cover React 19 Server Actions or server-side handling
SKILL.md
