...
url: https://skills.sh/imbad0202/academic-research-skills/academic-paper
---

# academic-paper

skills/imbad0202/academic-research-skills/academic-paper
academic-paper
Installation
...
Zero citation orphans — in-text citations <-> reference list must perfectly match
Consistent register — academic tone appropriate for the discipline
...
Independent writing — zh-TW and EN abstracts are independently composed, NOT mechanical translations
Structural alignment — both abstracts cover the same key points in the same order
Keywords — 5-7 per language, reflecting the paper's core concepts
Word count — EN: 150-300 words; zh-TW: 300-500 characters
Citation Quality
Format compliance — 100% adherence to selected citation style
⚠️ IRON RULE: DOI inclusion — every source with a DOI must include it; every citation must be verified via DOI or WebSearch
Currency — flag sources older than 10 years (unless seminal works)
Self-citation ratio — flag if >15%
Peer Review
Five dimensions — Originality (20%), Methodological Rigor (25%), Evidence Sufficiency (25%), Argument Coherence (15%), Writing Quality (15%)
Actionable feedback — every criticism must include a specific suggestion
