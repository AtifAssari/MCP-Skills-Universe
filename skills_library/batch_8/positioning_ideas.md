...
url: https://skills.sh/phuryn/pm-skills/positioning-ideas
---

# positioning-ideas

skills/phuryn/pm-skills/positioning-ideas
positioning-ideas
Installation
$ npx skills add https://github.com/phuryn/pm-skills --skill positioning-ideas
SKILL.md
Positioning Ideas
...
Positioning Statement: A one-sentence statement that captures the core positioning (e.g., "The [product] is the only [category] designed for [target segment] who want to [primary benefit]")
Strategic Rationale: Explain why this positioning would resonate with the audience and create differentiation
Supporting Message: Key supporting messages that reinforce this positioning
Competitive Advantage: What specific advantages enable this positioning claim
