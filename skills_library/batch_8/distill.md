---
title: distill
url: https://skills.sh/juxt/allium/distill
---

# distill

skills/juxt/allium/distill
distill
Installation
...
Identify entry points. API routes, CLI commands, message handlers, scheduled jobs.
Find the domain models. Usually in models/, entities/, domain/.
Locate business logic. Services, use cases, handlers.
Note external integrations. What third parties does it talk to?
