---
title: ratchet
url: https://skills.sh/boshu2/agentops/ratchet
---

# ratchet

skills/boshu2/agentops/ratchet
ratchet
Installation
...
Agent calls ao ratchet status 2>/dev/null to check current state
CLI reads .agents/ao/chain.jsonl and parses progress
Agent reports which steps are completed, in-progress, or pending
...
Agent calls ao ratchet record research --output ".agents/research/auth.md"
CLI appends completion entry to .agents/ao/chain.jsonl
Agent locks research step as permanently completed
