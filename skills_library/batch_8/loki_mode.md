---
title: loki-mode
url: https://skills.sh/sickn33/antigravity-awesome-skills/loki-mode
---

# loki-mode

skills/sickn33/antigravity-awesome-skills/loki-mode
loki-mode
Installation
...
READ .loki/CONTINUITY.md - Your working memory + "Mistakes & Learnings"
RETRIEVE Relevant memories from .loki/memory/ (episodic patterns, anti-patterns)
CHECK .loki/state/orchestrator.json - Current phase/metrics
REVIEW .loki/queue/pending.json - Next tasks
...
Feature implemented and unit tests pass
Start dev server via init script
Use Playwright MCP to automate browser
Verify UI renders correctly
Test user interactions (clicks, forms, navigation)
Only mark feature complete after visual verification
...
Input Guardrails - Validate scope, detect injection, check constraints (OpenAI SDK pattern)
Static Analysis - CodeQL, ESLint/Pylint, type checking
Blind Review System - 3 reviewers in parallel, no visibility of each other's findings
Anti-Sycophancy Check - If unanimous approval, run Devil's Advocate reviewer
Output Guardrails - Validate code quality, spec compliance, no secrets (tripwire on fail)
Severity-Based Blocking - Critical/High/Medium = BLOCK; Low/Cosmetic = TODO comment
Test Coverage Gates - Unit: 100% pass, >80% coverage; Integration: 100% pass
