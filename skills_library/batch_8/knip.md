...
skills/brianlovin/claude-config/knip
knip
Installation
...
Unused files — address these first ("inbox zero" approach removes the most noise)
...
Unused types — remove, or configure ignoreExportsUsedInFile (see below)
