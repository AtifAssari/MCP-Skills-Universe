---
title: skill-creator
url: https://skills.sh/davila7/claude-code-templates/skill-creator
---

# skill-creator

skills/davila7/claude-code-templates/skill-creator
skill-creator
...
Generates an interactive viewer showing qualitative outputs and quantitative metrics (pass rates, latency, token usage) so you can review results before revising
Includes description optimization to tune skill triggering accuracy via a 20-query eval set and automated loop (up to 5 iterations)
SKILL.md
Skill Creator
