---
title: cc-connect-ai-bridge
url: https://skills.sh/aradotso/trending-skills/cc-connect-ai-bridge
---

# cc-connect-ai-bridge

skills/aradotso/trending-skills/cc-connect-ai-bridge
cc-connect-ai-bridge
Installation
...
Troubleshooting
Bot not responding
Check that cc-connect is running: ps aux | grep cc-connect
Verify the platform token/credentials in config
For Telegram: ensure the bot token is valid (/start in BotFather chat)
