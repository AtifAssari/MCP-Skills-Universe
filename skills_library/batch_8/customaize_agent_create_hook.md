---
title: customaize-agent:create-hook
url: https://skills.sh/neolabhq/context-engineering-kit/customaize-agent:create-hook
---

# customaize-agent:create-hook

skills/neolabhq/context-engineering-kit/customaize-agent:create-hook
customaize-agent:create-hook
Installation
$ npx skills add https://github.com/neolabhq/context-engineering-kit --skill customaize-agent:create-hook
SKILL.md
Contains Hooks
