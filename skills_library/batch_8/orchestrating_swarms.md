...
url: https://skills.sh/everyinc/compound-engineering-plugin/orchestrating-swarms
---

# orchestrating-swarms

skills/everyinc/compound-engineering-plugin/orchestrating-swarms
orchestrating-swarms
Installation
...
$TMUX environment variable → inside tmux
$TERM_PROGRAM === "iTerm.app" or $ITERM_SESSION_ID → in iTerm2
which tmux → tmux available
which it2 → it2 CLI installed
...
Outside tmux (external session): Creates a new tmux session called claude-swarm
