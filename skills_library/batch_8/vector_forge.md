---
title: vector-forge
url: https://skills.sh/trailofbits/skills/vector-forge
---

# vector-forge

skills/trailofbits/skills/vector-forge
vector-forge
Installation
$ npx skills add https://github.com/trailofbits/skills --skill vector-forge
SKILL.md
Vector Forge
...
Or run gremlins with --test-pkg ./... (if supported)
