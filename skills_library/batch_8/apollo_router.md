...
skills/apollographql/skills/apollo-router
apollo-router
Installation
...
Use this apollo-router skill to validate readiness (validation/checklist.md) and walk through runtime startup inputs.
