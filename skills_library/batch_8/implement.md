---
title: implement
url: https://skills.sh/hyperb1iss/hyperskills/implement
---

# implement

skills/hyperb1iss/hyperskills/implement
implement
Installation
...
Error types (thiserror enum with #[from])
Type definitions (structs, enums)
Core logic (impl blocks)
Module wiring (mod.rs re-exports)
...
Context rot — after ~15-20 iterations, /clear and start fresh. A clean session with a better prompt beats accumulated corrections every time.
