...
url: https://skills.sh/serpdownloaders/skills/facebook-video-downloader
---

# facebook-video-downloader

skills/serpdownloaders/skills/facebook-video-downloader
facebook-video-downloader
Installation
$ npx skills add https://github.com/serpdownloaders/skills --skill facebook-video-downloader
SKILL.md
...
Links
:rocket: Get it here: Facebook Downloader
...
Open Facebook and navigate to a feed, profile, Reel, watch page, or post.
Scroll until the content you want is visible on the page.
Use the in-page controls or open the extension popup.
Download individual items or save the visible set in bulk.
Open the exported files from your Downloads folder.
Step-by-Step Tutorial: How to Download Content from Facebook
Install Facebook Downloader from the latest GitHub release.
Sign in to Facebook if the content you want requires login access.
Open the page, post, Reel, or profile section you want to save from.
Scroll until the target media is fully visible and loaded.
...
Start here: https://serp.ly/facebook-video-downloader

Installation Instructions
Open the latest release page: https://github.com/serpapps/facebook-video-downloader/releases/latest
Download the extension build for your browser.
Install the extension.
Open Facebook and navigate to the content you want to save.
Use the extension controls to download visible media or post text.
FAQ
