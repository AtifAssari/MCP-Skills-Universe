---
title: generating-lightning-app
url: https://skills.sh/forcedotcom/afv-library/generating-lightning-app
---

# generating-lightning-app

skills/forcedotcom/afv-library/generating-lightning-app
generating-lightning-app
Installation
