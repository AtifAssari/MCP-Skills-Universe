---
title: code-review:review-local-changes
url: https://skills.sh/neolabhq/context-engineering-kit/code-review:review-local-changes
---

# code-review:review-local-changes

skills/neolabhq/context-engineering-kit/code-review:review-local-changes
code-review:review-local-changes
Installation
$ npx skills add https://github.com/neolabhq/context-engineering-kit --skill code-review:review-local-changes
SKILL.md
...
Min-impact cutoff (applied first): Exclude any issue with an impact score below MIN_IMPACT_SCORE (resolved from --min-impact argument in the Command Arguments section above, default: high / 61).
...
[Description] - file:location - [Reasoning and benefit]
