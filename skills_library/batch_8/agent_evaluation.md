...
url: https://skills.sh/sickn33/antigravity-awesome-skills/agent-evaluation
---

# agent-evaluation

skills/sickn33/antigravity-awesome-skills/agent-evaluation
agent-evaluation
Installation
...
class LeakageDetector { async detectLeakage( agent: Agent, testSuite: TestCase[], trainingData: TrainingExample[], systemPrompt: string ): Promise { const leaks: Leak[] = [];
