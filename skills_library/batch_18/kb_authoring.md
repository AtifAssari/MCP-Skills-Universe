---
title: kb-authoring
url: https://skills.sh/vm0-ai/vm0-skills/kb-authoring
---

# kb-authoring

skills/vm0-ai/vm0-skills/kb-authoring
kb-authoring
Installation
$ npx skills add https://github.com/vm0-ai/vm0-skills --skill kb-authoring
SKILL.md
Article Anatomy
...
Title: Outcome-oriented or symptom-oriented. Written in the language a customer would type into a search bar -- never internal jargon.
Summary: 1-2 plain-language sentences stating what the article covers and who benefits from it.
Content body: Organized by article type (see below).
Cross-references: Links to companion articles for adjacent topics.
Metadata: Category, tags, intended audience, last-modified date.
...
Live: Published and accessible to customers
Flagged: Marked for revision due to product changes, user feedback, or age
Archived: Retired from customer view but retained internally for reference
Deleted: Permanently removed from the knowledge base
...
Guiding Principles
Write for the frustrated customer who is mid-search for an answer -- be direct, specific, and immediately helpful.
Every article must be discoverable using the words a real customer would type.
Validate your work: follow the steps yourself or have someone unfamiliar with the topic attempt them.
Maintain focus: one problem, one resolution per article. Split when scope creeps.
Tend the garden aggressively: an outdated article is more harmful than a missing one.
Track the gaps: every ticket that could have been deflected by an article represents a content opportunity.
Measure outcomes: articles with low traffic, poor ratings, or no ticket-deflection impact need rework or retirement.
Weekly Installs
18
Repository
vm0-ai/vm0-skills
