---
title: codanna-codebase-intelligence
url: https://skills.sh/nickcrew/claude-ctx-plugin/codanna-codebase-intelligence
---

# codanna-codebase-intelligence

skills/nickcrew/claude-ctx-plugin/codanna-codebase-intelligence
codanna-codebase-intelligence
Installation
...
find_callers - identify all usage sites
analyze_impact - assess blast radius
Then proceed with changes
Understanding Unfamiliar Code
semantic_search_docs - "how does X work"
find_symbol - get entry point details
get_calls - trace execution flow
Finding Where to Add Code
semantic_search_docs - "similar patterns"
find_callers - how existing code integrates
