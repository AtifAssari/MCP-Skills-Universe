...
url: https://skills.sh/bejranonda/llm-autonomous-agent-plugin-for-claude/security-patterns
---

# security-patterns

skills/bejranonda/llm-autonomous-agent-plugin-for-claude/security-patterns
security-patterns
Installation
$ npx skills add https://github.com/bejranonda/llm-autonomous-agent-plugin-for-claude --skill security-patterns
SKILL.md
