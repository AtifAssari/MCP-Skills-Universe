---
title: create-ex
url: https://skills.sh/perkfly/ex-skill/create-ex
---

# create-ex

skills/perkfly/ex-skill/create-ex
create-ex
Installation
$ npx skills add https://github.com/perkfly/ex-skill --skill create-ex
SKILL.md
...
昵称/代号（必填）
基本信息（一句话：在一起多久、怎么认识的、分手多久、她做什么的，想到什么写什么）
示例：在一起三年 大学同学 分手一年 她做设计
性格画像（一句话：MBTI、星座、依恋类型、恋爱标签、你对她的印象）
...
按 Step 2 的方式读取新内容
用 Read 读取现有 exes/{slug}/memories.md 和 persona.md
...
重新生成 SKILL.md（合并最新 memories.md + persona.md）
...
判断属于 Memories（时间/地点/偏好）还是 Persona（性格/沟通）
生成 correction 记录
...
Nickname / Codename (required)
Basic info (one sentence: how long together, how you met, how long since breakup, what she does)
Example: together 3 years, college classmates, broke up 1 year ago, she's a designer
Personality profile (one sentence: MBTI, zodiac, attachment style, relationship traits, your impression)
...
Read existing exes/{slug}/memories.md and persona.md
...
Regenerate SKILL.md (merge latest memories.md + persona.md)
...
Determine if it belongs to Memories (dates/places/preferences) or Persona (personality/communication)
