---
title: quicknode-skill
url: https://skills.sh/quiknode-labs/blockchain-skills/quicknode-skill
---

# quicknode-skill

skills/quiknode-labs/blockchain-skills/quicknode-skill
quicknode-skill
Installation
...
Use Info API (/info) for account state and market metadata
Historical Trading Analysis with SQL Explorer
Query historical trades — SELECT * FROM hyperliquid_trades WHERE block_time > ...
Aggregate metrics — Use GROUP BY for volume, counts, averages
Join tables — Combine trades, orders, funding for comprehensive analysis
