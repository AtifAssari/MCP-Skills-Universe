---
title: mcp-builder
url: https://skills.sh/jnmetacode/superpowers-zh/mcp-builder
---

# mcp-builder

skills/jnmetacode/superpowers-zh/mcp-builder
mcp-builder
Installation
...
使用 isError: true — 让 AI 知道调用失败
区分错误类型 — 参数错误、权限不足、资源不存在、服务不可用
5. 资源管理和生命周期
// 资源注册
