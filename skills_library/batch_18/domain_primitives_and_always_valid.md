---
title: domain-primitives-and-always-valid
url: https://skills.sh/j5ik2o/okite-ai/domain-primitives-and-always-valid
---

# domain-primitives-and-always-valid

skills/j5ik2o/okite-ai/domain-primitives-and-always-valid
domain-primitives-and-always-valid
Installation
...
プリミティブ型の露出: String, int, f64などがドメインの概念を表現していないか
構築時検証: コンストラクタ/ファクトリで不変条件を検証しているか
不変性: フィールドはprivateかつfinal/readonly/不変か
カプセル化: 内部状態へのアクセスは制限されているか（breachEncapsulationOf命名）
ドメイン操作: 関連する操作は型に集約されているか
適用指針
推奨
