...
url: https://skills.sh/nickcrew/claude-ctx-plugin/accessibility-audit
---

# accessibility-audit

skills/nickcrew/claude-ctx-plugin/accessibility-audit
accessibility-audit
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill accessibility-audit
SKILL.md
