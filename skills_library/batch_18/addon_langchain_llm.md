---
title: addon-langchain-llm
url: https://skills.sh/ajrlewis/ai-skills/addon-langchain-llm
---

# addon-langchain-llm

skills/ajrlewis/ai-skills/addon-langchain-llm
addon-langchain-llm
Installation
...
If USE_RAG=yes, compose retriever + prompt + model chain:
