---
title: attach-db
url: https://skills.sh/duckdb/duckdb-skills/attach-db
---

# attach-db

skills/duckdb/duckdb-skills/attach-db
attach-db
Installation
...
In the project directory (.duckdb-skills/state.sql) — colocated with the project, easy to find. You can choose to gitignore it.
In your home directory (~/.duckdb-skills/<project-id>/state.sql) — keeps the project directory clean.
