...
url: https://skills.sh/civitai/civitai/clickhouse-query
---

# clickhouse-query

skills/civitai/civitai/clickhouse-query
clickhouse-query
Installation
...
Safety Features
Read-only by default: Blocks INSERT/ALTER/DROP unless --writable flag is used
30 second timeout: Prevents runaway queries (override with --timeout)
