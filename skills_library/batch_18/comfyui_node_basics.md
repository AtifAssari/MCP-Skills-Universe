---
title: comfyui-node-basics
url: https://skills.sh/jtydhr88/comfyui-custom-node-skills/comfyui-node-basics
---

# comfyui-node-basics

skills/jtydhr88/comfyui-custom-node-skills/comfyui-node-basics
comfyui-node-basics
Installation
...
define_schema(cls) - classmethod returning io.Schema
execute(cls, ...) - classmethod performing the computation
