---
title: architect-python-uv-fastapi-sqlalchemy
url: https://skills.sh/ajrlewis/ai-skills/architect-python-uv-fastapi-sqlalchemy
---

# architect-python-uv-fastapi-sqlalchemy

skills/ajrlewis/ai-skills/architect-python-uv-fastapi-sqlalchemy
architect-python-uv-fastapi-sqlalchemy
Installation
...
Add infrastructure and CI files (NO_DOCKER=no):
Dockerfile
.dockerignore
docker-compose.yml
