---
title: addon-google-agent-dev-kit
url: https://skills.sh/ajrlewis/ai-skills/addon-google-agent-dev-kit
---

# addon-google-agent-dev-kit

skills/ajrlewis/ai-skills/addon-google-agent-dev-kit
addon-google-agent-dev-kit
Installation
$ npx skills add https://github.com/ajrlewis/ai-skills --skill addon-google-agent-dev-kit
SKILL.md
...
Enforce agent policy boundaries:
...
If addon-llm-judge-evals is also selected:
