...
url: https://skills.sh/zjy365/seakills/docker-to-sealos
---

# docker-to-sealos

skills/zjy365/seakills/docker-to-sealos
docker-to-sealos
Installation
$ npx skills add https://github.com/zjy365/seakills --skill docker-to-sealos
SKILL.md
...
(CI / one-shot) python scripts/quality_gate.py (requires template/*/index.yaml by default; set DOCKER_TO_SEALOS_ALLOW_EMPTY_ARTIFACTS=1 only for dev/debug without artifacts)
