---
title: repository-placement
url: https://skills.sh/j5ik2o/okite-ai/repository-placement
---
...
レビューチェックリスト
配置確認: リポジトリインターフェースがユースケース層にあるか？
結合確認: ドメインモデル（エンティティ/集約）がリポジトリをimportしていないか？
ID参照確認: 集約が他の集約を実体ではなくIDで参照しているか？
参考
