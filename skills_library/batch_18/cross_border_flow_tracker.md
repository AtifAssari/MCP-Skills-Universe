---
title: cross-border-flow-tracker
url: https://skills.sh/nicepkg/ai-workflow/cross-border-flow-tracker
---

# cross-border-flow-tracker

skills/nicepkg/ai-workflow/cross-border-flow-tracker
cross-border-flow-tracker
Installation
$ npx skills add https://github.com/nicepkg/ai-workflow --skill cross-border-flow-tracker
SKILL.md
