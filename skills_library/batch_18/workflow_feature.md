...
url: https://skills.sh/nickcrew/claude-ctx-plugin/workflow-feature
---

# workflow-feature

skills/nickcrew/claude-ctx-plugin/workflow-feature
workflow-feature
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill workflow-feature
SKILL.md
