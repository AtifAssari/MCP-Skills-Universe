---
title: ui-cloner
url: https://skills.sh/ragnar-pwninskjold/tech-snacks/ui-cloner
---

# ui-cloner

skills/ragnar-pwninskjold/tech-snacks/ui-cloner
ui-cloner
Installation
$ npx skills add https://github.com/ragnar-pwninskjold/tech-snacks --skill ui-cloner
SKILL.md
...
MANDATORY: Open references/phase-1-forensic-audit.md and execute its instructions. Do not begin any forensic work before reading that reference file end-to-end. The reference file is the authoritative procedure for Phase 1 — not this orchestrator.
