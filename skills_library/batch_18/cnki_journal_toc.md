---
title: cnki-journal-toc
url: https://skills.sh/cookjohn/cnki-skills/cnki-journal-toc
---

# cnki-journal-toc

skills/cookjohn/cnki-skills/cnki-journal-toc
cnki-journal-toc
Installation
$ npx skills add https://github.com/cookjohn/cnki-skills --skill cnki-journal-toc
SKILL.md
...
Replace YEAR and ISSUE with actual values (e.g., "2025", "No.01"). The "刊期浏览" tab is the default active view — no need to click it.
...
Find the link with text "原版目录浏览" in the snapshot (class btn-preview)
Click it — this opens a new tab with the reader page (kns.cnki.net/reader/report)
Use mcp__chrome-devtools__list_pages to find the new reader tab
Use mcp__chrome-devtools__select_page to switch to it
Use mcp__chrome-devtools__wait_for with text ["下载"]
Take snapshot — find the link with text "下载" (the download button in the reader toolbar)
Click the download link — triggers PDF download via Chrome
