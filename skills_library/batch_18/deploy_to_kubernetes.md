...
url: https://skills.sh/pjt222/development-guides/deploy-to-kubernetes
---

# deploy-to-kubernetes

skills/pjt222/development-guides/deploy-to-kubernetes
deploy-to-kubernetes
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill deploy-to-kubernetes
SKILL.md
Deploy to Kubernetes
