---
title: sealos-deploy
url: https://skills.sh/zjy365/seakills/sealos-deploy
---

# sealos-deploy

skills/zjy365/seakills/sealos-deploy
sealos-deploy
Installation
$ npx skills add https://github.com/zjy365/seakills --skill sealos-deploy
SKILL.md
Sealos Deploy
...
modules/preflight.md — Environment checks & Sealos auth
modules/pipeline.md — Full deployment pipeline (Phase 1–6)
Logging
