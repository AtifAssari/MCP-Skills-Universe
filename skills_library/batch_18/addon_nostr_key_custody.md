---
title: addon-nostr-key-custody
url: https://skills.sh/ajrlewis/ai-skills/addon-nostr-key-custody
---

# addon-nostr-key-custody

skills/ajrlewis/ai-skills/addon-nostr-key-custody
addon-nostr-key-custody
Installation
$ npx skills add https://github.com/ajrlewis/ai-skills --skill addon-nostr-key-custody
SKILL.md
...
Implement local encrypted custody:
