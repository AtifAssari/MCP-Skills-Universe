...
url: https://skills.sh/nickcrew/claude-ctx-plugin/gitops-workflows
---

# gitops-workflows

skills/nickcrew/claude-ctx-plugin/gitops-workflows
gitops-workflows
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill gitops-workflows
SKILL.md
GitOps Workflows
