...
url: https://skills.sh/jackjin1997/clawforge/langchain-agents
---

# langchain-agents

skills/jackjin1997/clawforge/langchain-agents
langchain-agents
Installation
...
Custom control flow / multi-agent / advanced context? → LangGraph (this guide) Use this for: Custom routing logic, supervisor patterns, specialized state management, non-standard workflows.
...
Pattern applies to: SQL agents, search agents, Q&A bots, tool-calling workflows. Replaces: Legacy convenience helpers and LLMChain patterns.
