---
title: zread-expert
url: https://skills.sh/tianxiao1430-jpg/zai-skills/zread-expert
---

# zread-expert

skills/tianxiao1430-jpg/zai-skills/zread-expert
zread-expert
Installation
...
关键点
Hook 链表 - 每个组件维护 Hook 链表
依赖比较 - 使用 Object.is 逐项比较
延迟执行 - effect 在 commit 阶段执行
清理函数 - 上次 render 的 cleanup 在本次 effect 前执行
相关 Issue
