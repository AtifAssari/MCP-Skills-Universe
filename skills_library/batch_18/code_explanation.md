...
url: https://skills.sh/nickcrew/claude-ctx-plugin/code-explanation
---

# code-explanation

skills/nickcrew/claude-ctx-plugin/code-explanation
code-explanation
Installation
$ npx skills add https://github.com/nickcrew/claude-ctx-plugin --skill code-explanation
SKILL.md
Code Explanation
Overview
