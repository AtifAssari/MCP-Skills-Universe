---
title: prose-style
url: https://skills.sh/jwynia/agent-skills/prose-style
---

# prose-style

skills/jwynia/agent-skills/prose-style
prose-style
Installation
...
Use the active voice (generally)
...
Identify state: P1 (Flat Prose)
Run rhythm.ts to check variety
Ask: "Read a paragraph aloud. What do you notice?"
Check: sentence lengths, word precision, rhythm
Recommend: vary sentence length, replace generic words with specific
...
Identify state: P3 (Overwrought)
Distinguish: Rich prose serves the story; purple overwhelms it
Ask: "Does the style serve the story or call attention to itself?"
Check for: adjective stacking, adverb abuse, mixed metaphors
Recommend: cut modifiers, simplify metaphors, let strong nouns/verbs work
...
Identify state: P6 (Inconsistent Voice)
Ask: "What's your narrator's baseline voice?"
Check: diction level shifts, rhythm pattern changes
Recommend: establish baseline, vary intentionally from it
Output Persistence
