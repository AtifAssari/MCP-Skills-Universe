---
title: unity-skills
url: https://skills.sh/besty0728/unity-skills/unity-skills
---

# unity-skills

skills/besty0728/unity-skills/unity-skills
unity-skills
Installation
$ npx skills add https://github.com/besty0728/unity-skills --skill unity-skills
SKILL.md
Unity Skills
...
Core Rules
If the user specifies a Unity version or editor line, set instance/version routing first with unity_skills.set_unity_version(...).
In Full-Auto mode, prefer *_batch skills whenever the task touches 2+ objects.
For multi-step editor mutations, prefer workflow wrappers instead of free-form mutation sequences.
Script edits, define changes, package changes, some imports, and test template creation can trigger compilation or Domain Reload. Wait and retry on transient unavailability.
test_* skills are async. They return a jobId and must be polled with test_get_result(jobId).
Route
