---
title: log-analyzer
url: https://skills.sh/zrt-ai-lab/opencode-skills/log-analyzer
---

# log-analyzer

skills/zrt-ai-lab/opencode-skills/log-analyzer
log-analyzer
Installation
...
类型适配	不同日志类型用专用解析器
注意事项
Binlog 不记录客户端 IP：只有 server_id 和 thread_id，需结合 general_log 确认操作者
敏感信息脱敏：报告中注意不要暴露密码、密钥
结合多源日志：binlog + 应用日志 + 审计日志 才能完整还原
Weekly Installs
36
Repository
