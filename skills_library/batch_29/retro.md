---
title: retro
url: https://skills.sh/kazdenc/builder-skills/retro
---

# retro

skills/kazdenc/builder-skills/retro
retro
Installation
$ npx skills add https://github.com/kazdenc/builder-skills --skill retro
SKILL.md
...
Cluster related items. If three people mention deployment issues, that's a theme.
Name each theme clearly. "Deployment reliability" not "various issues."
Find root causes. For the biggest themes, use the 5 Whys:
...
Rank themes by impact. Which ones, if fixed, would make the biggest difference next time?
