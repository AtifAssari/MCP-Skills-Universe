...
url: https://skills.sh/alirezarezvani/claude-code-skill-factory/codex-cli-bridge
---

# codex-cli-bridge

skills/alirezarezvani/claude-code-skill-factory/codex-cli-bridge
codex-cli-bridge
Installation
...
Execution Helpers: Python wrappers for Codex CLI commands (always uses codex exec)
Skill Documentation: Makes Claude Skills accessible to Codex CLI users
Key Capabilities
...
For Codex Execution
Use codex exec always (never plain codex in Claude Code)
...
Enable search when needed (--search flag)
