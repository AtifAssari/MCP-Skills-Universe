---
title: agent-teams
url: https://skills.sh/dmitriyyukhanov/claude-plugins/agent-teams
---

# agent-teams

skills/dmitriyyukhanov/claude-plugins/agent-teams
agent-teams
Installation
$ npx skills add https://github.com/dmitriyyukhanov/claude-plugins --skill agent-teams
SKILL.md
Agent Teams
...
Best Practices
Give teammates enough context in spawn prompts - they don't inherit the lead's conversation history
Size tasks appropriately - self-contained units producing clear deliverables (a function, test file, or review)
