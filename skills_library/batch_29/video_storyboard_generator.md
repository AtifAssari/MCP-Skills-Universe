...
url: https://skills.sh/oyyh-apple/video-storyboard-generator/video-storyboard-generator
---

# video-storyboard-generator

skills/oyyh-apple/video-storyboard-generator/video-storyboard-generator
video-storyboard-generator
Installation
$ npx skills add https://github.com/oyyh-apple/video-storyboard-generator --skill video-storyboard-generator
SKILL.md
Video Storyboard Generator
...
📋 新手推荐: 查看 references/quick-reference.md 获取一页纸速查表
...
阶段7: 更新用户画像
技术参考
运镜类型参考 - 基础运镜 vs 电影级运镜
画面布局参考 - 构图法则与景别系统
参考资产 - 所有reference文件索引
核心原则
...
情绪强度 - 通过词汇选择：眼神微微、眉头略动、眉头紧锁、泪水涌出
发生原因 - 融入情境：站在会议室门口等待汇报时...
时间演变 - 用动态词：逐渐紧锁、缓缓舒展、突然瞪大
...
📐 专业构图布局技术详见 references/cinematic-layouts.md
...
推荐新手先查阅: references/quick-reference.md - 一页纸速查表，涵盖所有常用参数和规则
