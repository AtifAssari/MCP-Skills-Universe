---
title: seo-strategy
url: https://skills.sh/sanky369/vibe-building-skills/seo-strategy
---

# seo-strategy

skills/sanky369/vibe-building-skills/seo-strategy
seo-strategy
Installation
$ npx skills add https://github.com/sanky369/vibe-building-skills --skill seo-strategy
SKILL.md
SEO Strategy Skill
Overview
...
Step 4: Manually Evaluate SERP Don't trust KD scores alone. Check:
...
Keyword research takes days
Content briefs are manual
Writing is slow
Optimization is sporadic
Publishing is error-prone
...
Step 1: Keyword Clustering Group keywords into logical clusters. Each cluster = content pillar + supporting articles.

Step 2: Data Collection Gather data needed for pages (specs, locations, features, case studies).

Step 3: Template Design Create reusable template:
...
Step 4: Automation Use tools to create pages from templates:

Zapier / Make (workflow automation)
WordPress + ACF (template-based)
Custom scripts (maximum control)

Step 5: Editorial Review Checklist for each page:
...
Step 6: Performance Monitoring Track via Google Search Console + Looker Studio:
...
Step 3: Make Linking Easy Provide: direct link, embed code, suggested anchor text, preview image.

Step 4: Follow Up 5-7 days later if no response.
...
Common Pitfalls
Chasing Volume Over Quality — 10 excellent articles > 100 mediocre ones
Ignoring Search Intent — Wrong format = no ranking
Neglecting Internal Linking — Connect supporting articles to pillars
Low-Quality Backlinks — Quality > quantity always
Not Monitoring Performance — Track weekly, adjust based on data
Ignoring E-E-A-T — Include credentials, cite sources, show expertise
...
Assess Current State — Where are you in the 90-day plan?
Identify Blockers — Keyword research? Content? Links?
Pick the Right Phase — Foundation → Content → Links
Execute Systematically — Follow checklists, track metrics
Reference the Playbook — See references/Complete_SEO_Playbook.md for full details
