---
title: amazon-teneo
url: https://skills.sh/teneoprotocolai/teneo-skills/amazon-teneo
---

# amazon-teneo

skills/teneoprotocolai/teneo-skills/amazon-teneo
amazon-teneo
Installation
$ npx skills add https://github.com/teneoprotocolai/teneo-skills --skill amazon-teneo
SKILL.md
...
product		$0.0025/per-query	Extract product details
search		$0.0025/per-query	Search for products on Amazon with optional pagination, country filter, and sorting. Results can be sorted by bestsellers, most_recent, price_low_to_high, price_high_to_low, featured, or average_review. Use quotes for multi-word queries (e.g., "word1 word2").
reviews		$0.001/per-query	Extract product reviews
