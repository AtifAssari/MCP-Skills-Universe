...
url: https://skills.sh/phrazzld/claude-config/stripe-scaffold
---

# stripe-scaffold

skills/phrazzld/claude-config/stripe-scaffold
stripe-scaffold
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill stripe-scaffold
SKILL.md
Stripe Scaffold
...
Subscription Management UX (Required): Reference stripe-subscription-ux for full requirements.
