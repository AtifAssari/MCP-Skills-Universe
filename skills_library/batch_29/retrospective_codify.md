---
title: retrospective-codify
url: https://skills.sh/mizchi/chezmoi-dotfiles/retrospective-codify
---

# retrospective-codify

skills/mizchi/chezmoi-dotfiles/retrospective-codify
retrospective-codify
Installation
$ npx skills add https://github.com/mizchi/chezmoi-dotfiles --skill retrospective-codify
SKILL.md
Retrospective Codify
...
書き出し: 選んだ形式のテンプレート（後述）に沿って artifact を生成する。
