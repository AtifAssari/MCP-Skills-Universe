---
title: playwright-ci-caching
url: https://skills.sh/aaronontheweb/dotnet-skills/playwright-ci-caching
---

# playwright-ci-caching

skills/aaronontheweb/dotnet-skills/playwright-ci-caching
playwright-ci-caching
Installation
...
Core Pattern
Extract Playwright version from Directory.Packages.props (CPM) to use as cache key
Cache browser binaries using platform-appropriate paths
