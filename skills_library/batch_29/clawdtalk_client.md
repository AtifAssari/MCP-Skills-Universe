---
title: clawdtalk-client
url: https://skills.sh/team-telnyx/clawdtalk-client/clawdtalk-client
---

# clawdtalk-client

skills/team-telnyx/clawdtalk-client/clawdtalk-client
clawdtalk-client
Installation
$ npx skills add https://github.com/team-telnyx/clawdtalk-client --skill clawdtalk-client
SKILL.md
ClawdTalk
...
ClawdTalk includes server-side input sanitization and prompt injection protection powered by Lakera Guard. External caller transcripts are screened for prompt injection attempts before reaching the agent.
