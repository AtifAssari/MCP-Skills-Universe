---
title: tuzi-markdown-to-html
url: https://skills.sh/tuziapi/tuzi-skills/tuzi-markdown-to-html
---

# tuzi-markdown-to-html

skills/tuziapi/tuzi-skills/tuzi-markdown-to-html
tuzi-markdown-to-html
Installation
...
User explicitly specified theme (CLI --theme or conversation)
EXTEND.md default_theme (this skill's own EXTEND.md, checked in Step 0)
tuzi-post-to-wechat EXTEND.md default_theme (cross-skill fallback)
If none found → use AskUserQuestion to confirm
