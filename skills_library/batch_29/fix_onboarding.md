...
url: https://skills.sh/phrazzld/claude-config/fix-onboarding
---

# fix-onboarding

skills/phrazzld/claude-config/fix-onboarding
fix-onboarding
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill fix-onboarding
SKILL.md
/fix-onboarding
...
P0: No onboarding flow, broken auth, paywall before value
P1: No empty states, no guidance, complex forms, no loading
P2: No progressive disclosure, no tooltips, no tour
P3: Retention hooks
3. Execute Fix

No onboarding flow (P0): Create app/onboarding/page.tsx:
...
No empty states (P1): Create components/empty-state.tsx:
