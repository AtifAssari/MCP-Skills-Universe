---
title: release-notes
url: https://skills.sh/sunny0826/open-source-skills/release-notes
---

# release-notes

skills/sunny0826/open-source-skills/release-notes
release-notes
Installation
$ npx skills add https://github.com/sunny0826/open-source-skills --skill release-notes
SKILL.md
...
Analyze and Categorize: Read through the commit messages. Identify the intent of each commit based on standard conventional commit prefixes (like feat:, fix:, chore:, BREAKING CHANGE:) or the semantic meaning of the message.

Format the Output: Group the relevant commits into the following specific sections:
