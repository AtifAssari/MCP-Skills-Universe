---
title: yy-frontend-commit
url: https://skills.sh/bulls-cows/skills/yy-frontend-commit
---

# yy-frontend-commit

skills/bulls-cows/skills/yy-frontend-commit
yy-frontend-commit
Installation
$ npx skills add https://github.com/bulls-cows/skills --skill yy-frontend-commit
SKILL.md
yy-frontend-commit

目录范围限制：处理 src 目录下的所有文件，但以下目录下的文件禁止提交： src/router
