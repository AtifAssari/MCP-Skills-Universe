...
url: https://skills.sh/mizchi/chezmoi-dotfiles/conventional-changelog
---

# conventional-changelog

skills/mizchi/chezmoi-dotfiles/conventional-changelog
conventional-changelog
Installation
$ npx skills add https://github.com/mizchi/chezmoi-dotfiles --skill conventional-changelog
SKILL.md
Conventional Changelog
...
keepachangelog.com に準拠。version 降順、semver、セクションは決まった 6 種:
...
prerelease-type: "beta" で commit を積む → v2.0.0-beta.1 が切られる
追加 commit で v2.0.0-beta.2 / beta.3 ... が積み重なる
RC 昇格時: config を "prerelease-type": "rc" に書き換え → v2.0.0-rc.1
正式リリース時: "prerelease": false（or フィールド削除）→ v2.0.0
...
commit scope に package 名を入れる運用:
...
cargo release minor --execute → Cargo.toml の version bump
pre-release-hook で git cliff が次 version の [Unreleased] を [v0.2.0] - 2026-04-19 に確定し CHANGELOG.md を更新
cargo-release が Cargo.toml + CHANGELOG.md を release commit にまとめる
tag-name で v0.2.0 を annotated tag として打つ
cargo publish + git push --tags
