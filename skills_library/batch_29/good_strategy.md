---
title: good-strategy
url: https://skills.sh/tomaszstaniak/pm-ai-skills/good-strategy
---

# good-strategy

skills/tomaszstaniak/pm-ai-skills/good-strategy
good-strategy
Installation
$ npx skills add https://github.com/tomaszstaniak/pm-ai-skills --skill good-strategy
SKILL.md
...
See: references/strategic-diagnosis.md
...
See: references/guiding-policy.md
...
See: references/coherent-actions.md
...
Early warning signal — what would you see in the first 3 months?
Mitigation — what changes now to reduce this risk?
...
Reference Files
Strategic Diagnosis — How to diagnose the critical challenge, reframing techniques, asymmetry identification, common diagnostic traps, and worked examples across product, market, and organizational challenges
Guiding Policy Design — Trade-off identification, the "opposite test" for real strategic choices, policy-to-action translation, and examples of strong vs. weak guiding policies
Coherent Actions — Porter's three levels of activity fit, activity system mapping, coherence audits, resource allocation as strategy, and how to detect and fix incoherence
Bad Strategy Detection — The four hallmarks in depth with real-world examples, fluff-detection techniques, the "goals vs. strategy" trap, and how to convert bad strategy into good strategy
Further Reading
