---
title: intelligems-test-verdict
url: https://skills.sh/victorpay1/intelligems-analytics/intelligems-test-verdict
---

# intelligems-test-verdict

skills/victorpay1/intelligems-analytics/intelligems-test-verdict
intelligems-test-verdict
Installation
...
Copy setup_workspace.sh from the intelligems-core skill's references/ folder and run it.
Copy all four core Python files (ig_client.py, ig_metrics.py, ig_helpers.py, ig_config.py) from intelligems-core/references/ into ~/intelligems-analytics/.
Step 1: Get API Key
...
Fetch overview analytics for the selected test
Run a maturity check (enough time, visitors, orders?)
Compute the verdict based on confidence and uplift
Check revenue vs. conversion alignment
Fetch device-type segments for a quick contradiction check
