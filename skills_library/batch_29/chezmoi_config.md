...
skills/faintghost/skills/chezmoi-config
chezmoi-config
Installation
...
Best Practices
Use templates for cross-platform configs - Leverage .chezmoi.os, .chezmoi.arch
Store secrets in password managers - Never hardcode sensitive data
Make scripts idempotent - Safe to run multiple times
Use descriptive filenames - run_once_000-bootstrap.sh.tmpl
Test templates locally - Use chezmoi execute-template < file.tmpl
Organize .chezmoidata - Separate concerns into multiple files
