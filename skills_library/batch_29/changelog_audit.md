...
url: https://skills.sh/phrazzld/claude-config/changelog-audit
---

# changelog-audit

skills/phrazzld/claude-config/changelog-audit
changelog-audit
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill changelog-audit
SKILL.md
Changelog Audit
