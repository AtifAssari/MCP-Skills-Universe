---
title: refactor
url: https://skills.sh/phrazzld/claude-config/refactor
---

# refactor

skills/phrazzld/claude-config/refactor
refactor
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill refactor
SKILL.md
...
Clarity — Simplify code without changing behavior
Architecture — Improve module depth and information hiding
...
Commit: refactor: improve module depth
Completion
