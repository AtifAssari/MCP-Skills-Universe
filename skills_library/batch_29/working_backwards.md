...
url: https://skills.sh/tomaszstaniak/pm-ai-skills/working-backwards
---

# working-backwards

skills/tomaszstaniak/pm-ai-skills/working-backwards
working-backwards
Installation
$ npx skills add https://github.com/tomaszstaniak/pm-ai-skills --skill working-backwards
SKILL.md
...
Early warning signal — how would you detect this is happening?
Mitigation — what can you do now to prevent it?
...
Sources of Power by Gary Klein (origin of the pre-mortem technique)
About the Authors
