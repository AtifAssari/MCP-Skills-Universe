---
title: distill
url: https://skills.sh/phrazzld/claude-config/distill
---

# distill

skills/phrazzld/claude-config/distill
distill
Installation
...
Surprising? Does this describe something counter-intuitive or unexpected? If not → DELETE
Earned by pain? Did this instruction come from something going wrong? → KEEP
...
Draft new CLAUDE.md (Codex produces first draft)
