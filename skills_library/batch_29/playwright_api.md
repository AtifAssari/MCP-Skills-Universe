...
url: https://skills.sh/microsoft/playwright/playwright-api
---

# playwright-api

skills/microsoft/playwright/playwright-api
playwright-api
Installation
$ npx skills add https://github.com/microsoft/playwright --skill playwright-api
SKILL.md
API
