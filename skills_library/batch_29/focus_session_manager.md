...
url: https://skills.sh/daffy0208/ai-dev-standards/focus-session-manager
---

# focus session manager

skills/daffy0208/ai-dev-standards/Focus Session Manager
Focus Session Manager
Installation
$ npx skills add https://github.com/daffy0208/ai-dev-standards --skill 'Focus Session Manager'
SKILL.md
Focus Session Manager
