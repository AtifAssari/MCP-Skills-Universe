---
title: code-review
url: https://skills.sh/yelban/orz99-skills/code-review
---

# code-review

skills/yelban/orz99-skills/code-review
code-review
Installation
...
檔案路徑 → 讀取指定檔案
PR 編號（如 #123）→ gh pr diff 123 取得變更
diff → git diff + git diff --staged 取得所有未提交變更
空白 → 預設行為同 diff
分支名 → git diff main...<branch> 取得分支差異
...
問題描述 — 具體指出 file:line 或 file:SymbolName
