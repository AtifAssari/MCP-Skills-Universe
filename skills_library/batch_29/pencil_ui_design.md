---
title: pencil-ui-design
url: https://skills.sh/allenai2014/pencil-ui-design/pencil-ui-design
---

# pencil-ui-design

skills/allenai2014/pencil-ui-design/pencil-ui-design
pencil-ui-design
Installation
...
先创建容器 - 必须先用 I() 创建 frame，再用 G() 应用图片
设置正确尺寸 - frame 的 width/height 决定显示尺寸
圆角裁剪 - 设置 cornerRadius: 9999 可实现圆形图片
文本处理规范
防止文本溢出
...
第一步：设置设计系统
打开或创建 .pen 文件
使用 mcp_pencil_set_variables 设置颜色变量
创建可复用组件
第二步：创建页面结构
...
保持设计一致性
第四步：验证设计
使用 mcp_pencil_get_screenshot 截图检查
验证对齐、间距、颜色
检查字体和图标一致性
第五步：迭代优化
根据反馈调整细节
