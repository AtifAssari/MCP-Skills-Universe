...
url: https://skills.sh/phrazzld/claude-config/documentation-standards
---

# documentation-standards

skills/phrazzld/claude-config/documentation-standards
documentation-standards
Installation
...
Grep for the constant. grep -rn "ExitCodeFoo" internal/ reveals actual usage.
