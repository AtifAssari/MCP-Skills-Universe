...
url: https://skills.sh/besty0728/unity-skills/unity-animator
---

# unity-animator

skills/besty0728/unity-skills/unity-animator
unity-animator
Installation
...
Best Practices
Create controller before adding parameters
Use meaningful parameter names
Triggers reset automatically after firing
Set parameters before playing states
Use layers for independent animations (body + face)
States must exist in controller before playing
Exact Signatures
