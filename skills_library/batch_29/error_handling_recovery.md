...
url: https://skills.sh/sanky369/vibe-building-skills/error-handling-recovery
---

# error-handling-recovery

skills/sanky369/vibe-building-skills/error-handling-recovery
error-handling-recovery
Installation
...
Why it happened — Context for the user
What to do — Actionable next steps
Where to get help — Support resources if needed
