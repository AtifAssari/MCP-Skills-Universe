---
title: image-service
url: https://skills.sh/zrt-ai-lab/opencode-skills/image-service
---

# image-service

skills/zrt-ai-lab/opencode-skills/image-service
image-service
Installation
...
🎨 单图	core直接调用	单张
第四步：质量校验
生成完成后，含中文文字的图用 core/image_to_text.py -m ocr 校验文字是否清晰
OCR结果与预期不符 → 用 core/image_to_image.py 迭代修复（参考 guides/text-rendering.md）
多图场景完成后，逐张展示给用户确认，不满意的单张重新生成
🛠️ 脚本速查
场景脚本
# 📊 信息图 — 20布局×17风格=340种
