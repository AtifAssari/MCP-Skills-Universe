...
url: https://skills.sh/monkey1sai/openai-cli/ai-agent-orchestrator
---

# ai-agent-orchestrator

skills/monkey1sai/openai-cli/ai-agent-orchestrator
ai-agent-orchestrator
Installation
$ npx skills add https://github.com/monkey1sai/openai-cli --skill ai-agent-orchestrator
SKILL.md
AI Agent Orchestrator
