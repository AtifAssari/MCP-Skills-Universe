...
url: https://skills.sh/monkey1sai/openai-cli/integration-test-builder
---

# integration-test-builder

skills/monkey1sai/openai-cli/integration-test-builder
integration-test-builder
Installation
$ npx skills add https://github.com/monkey1sai/openai-cli --skill integration-test-builder
SKILL.md
Integration Test Builder
