---
title: telnyx-porting-out-python
url: https://skills.sh/team-telnyx/skills/telnyx-porting-out-python
---

# telnyx-porting-out-python

skills/team-telnyx/skills/telnyx-porting-out-python
telnyx-porting-out-python
Installation
$ npx skills add https://github.com/team-telnyx/skills --skill telnyx-porting-out-python
SKILL.md
Telnyx Porting Out - Python
Installation
pip install telnyx
