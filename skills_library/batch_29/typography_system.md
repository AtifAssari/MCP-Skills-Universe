...
url: https://skills.sh/sanky369/vibe-building-skills/typography-system
---

# typography-system

skills/sanky369/vibe-building-skills/typography-system
typography-system
Installation
...
Contrast — Pair fonts with different characteristics (serif + sans-serif, or geometric + humanist)
Personality Match — Fonts should match your brand personality
Readability — Prioritize readability over style
Versatility — Fonts should work across sizes and weights
...
Size — Larger text is more prominent
Weight — Bolder text is more prominent
Color — Brighter or more saturated colors are more prominent
Spacing — More space around text makes it more prominent
Position — Top-left is more prominent than bottom-right
