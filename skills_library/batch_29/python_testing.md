...
url: https://skills.sh/dmitriyyukhanov/claude-plugins/python-testing
---

# python-testing

skills/dmitriyyukhanov/claude-plugins/python-testing
python-testing
Installation
$ npx skills add https://github.com/dmitriyyukhanov/claude-plugins --skill python-testing
SKILL.md
