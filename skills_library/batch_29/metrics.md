---
title: metrics
url: https://skills.sh/kazdenc/builder-skills/metrics
---

# metrics

skills/kazdenc/builder-skills/metrics
metrics
Installation
...
Adoption — did users find and try it? (feature_activated / eligible users)
Completion — did they succeed at the core task? (task_completed / task_started)
Return — did they come back? (feature_used where usage_count > 1 within 14 days)
...
Goal — one sentence
Primary metric — name, definition, target
Supporting metrics — leading, lagging, guardrails in table format
Instrumentation plan — events, properties, where tracked
Anti-metrics — what you're deliberately not tracking and why
Weekly Installs
9
Repository
