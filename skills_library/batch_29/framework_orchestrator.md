...
url: https://skills.sh/daffy0208/ai-dev-standards/framework-orchestrator
---

# framework orchestrator

skills/daffy0208/ai-dev-standards/Framework Orchestrator
Framework Orchestrator
Installation
$ npx skills add https://github.com/daffy0208/ai-dev-standards --skill 'Framework Orchestrator'
SKILL.md
Framework Orchestrator
Overview
...
simple_feature_framework - Lightweight requirements and validation
code-quality-enforcer - Ensure code standards
testing-strategist - Unit test coverage
deployment-advisor - Ship quickly
...
user-researcher skill → User interviews
product-strategist skill → Market validation
prp-generator skill → Create PRP
...
simple_feature_framework → Define requirements
api-designer skill → Design export endpoint
