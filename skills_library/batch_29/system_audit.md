---
title: system-audit
url: https://skills.sh/yelban/orz99-skills/system-audit
---

# system-audit

skills/yelban/orz99-skills/system-audit
system-audit
Installation
$ npx skills add https://github.com/yelban/orz99-skills --skill system-audit
SKILL.md
System Audit
...
全域 ~/.claude/CLAUDE.md
專案 CLAUDE.md（當前目錄）
專案私有 .claude/CLAUDE.md（如存在）
讀取 MEMORY.md
Auto Memory — 專案級 .claude/projects/*/memory/MEMORY.md
該目錄下的所有 .md 附屬檔案
掃描 Skills
全域 skills — ~/.claude/skills/*/SKILL.md（含 references/ 子目錄）
專案 skills — 當前目錄下任何含 SKILL.md 的子目錄
