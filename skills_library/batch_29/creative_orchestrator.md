...
url: https://skills.sh/sanky369/vibe-building-skills/creative-orchestrator
---

# creative-orchestrator

skills/sanky369/vibe-building-skills/creative-orchestrator
creative-orchestrator
Installation
...
Coordinates all creative skills — Tells Claude which skills to use in which order
Manages Claude Code integration — Shows Claude how to run Python code to generate assets
Automates workflows — Chains multiple generation tasks together
Handles file organization — Manages asset storage and organization
Provides templates — Pre-built workflows for common scenarios
How Claude Code Uses This Skill

When you ask Claude to generate creative assets, the Orchestrator tells Claude Code:

Where the automation system is — File paths and imports
How to set up the environment — API keys, dependencies
What Python code to run — Exact function calls
How to chain operations — Multiple assets in sequence
Where to save results — Organized folder structure
...
Next Steps
Extract automation system to your project
Install dependencies: pip install requests
Set API key: export FAL_API_KEY="your_key"
Test connection: Ask Claude to test the API
Choose your workflow: Pick a template above
Generate assets: Start creating!
Quick Commands
