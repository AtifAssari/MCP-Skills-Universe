...
url: https://skills.sh/phrazzld/claude-config/code-review-checklist
---

# code-review-checklist

skills/phrazzld/claude-config/code-review-checklist
code-review-checklist
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill code-review-checklist
SKILL.md
Code Review Checklist
