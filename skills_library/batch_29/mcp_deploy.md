---
title: mcp-deploy
url: https://skills.sh/zrong/skills/mcp-deploy
---

# mcp-deploy

skills/zrong/skills/mcp-deploy
mcp-deploy
Installation
$ npx skills add https://github.com/zrong/skills --skill mcp-deploy
SKILL.md
MCP Deploy
...
工作流程
确认 MCP 平台：询问用户要部署哪个平台的 MCP
收集配置信息：根据平台询问必要的配置（如 API Key、URL 等）
执行配置：使用 mcporter 命令添加 MCP 服务器
验证部署：测试 MCP 服务器是否正常工作
报告结果：展示部署结果和可用工具
常用配置参考
智谱 MCP (HTTP)
# 视觉理解
