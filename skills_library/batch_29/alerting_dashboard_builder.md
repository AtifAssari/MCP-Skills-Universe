...
url: https://skills.sh/monkey1sai/openai-cli/alerting-dashboard-builder
---

# alerting-dashboard-builder

skills/monkey1sai/openai-cli/alerting-dashboard-builder
alerting-dashboard-builder
Installation
$ npx skills add https://github.com/monkey1sai/openai-cli --skill alerting-dashboard-builder
SKILL.md
Alerting & Dashboard Builder
