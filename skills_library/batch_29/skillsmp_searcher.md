---
title: skillsmp-searcher
url: https://skills.sh/gccszs/skillsmp-searcher/skillsmp-searcher
---

# skillsmp-searcher

skills/gccszs/skillsmp-searcher/skillsmp-searcher
skillsmp-searcher
Installation
$ npx skills add https://github.com/gccszs/skillsmp-searcher --skill skillsmp-searcher
SKILL.md
SkillsMP 技能搜索
...
使用流程
确保 API Key 已配置在 references/api_key.txt
根据用户需求选择搜索模式：
明确关键词 → 关键词搜索
自然语言描述 → AI 语义搜索
运行相应的脚本获取结果
