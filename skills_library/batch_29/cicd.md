---
title: cicd
url: https://skills.sh/krzysztofsurdy/code-virtuoso/cicd
---

# cicd

skills/krzysztofsurdy/code-virtuoso/cicd
cicd
Installation
$ npx skills add https://github.com/krzysztofsurdy/code-virtuoso --skill cicd
SKILL.md
