---
title: videocut-clip
url: https://skills.sh/zrt-ai-lab/opencode-skills/videocut-clip
---

# videocut-clip

skills/zrt-ai-lab/opencode-skills/videocut-clip
videocut-clip
Installation
$ npx skills add https://github.com/zrt-ai-lab/opencode-skills --skill videocut-clip
SKILL.md
剪辑
...
⚠️ 关键规则
直接用时间戳：从 (start-end) 解析，不要搜索文本
不要重新搜索：审查稿已经计算好精确时间戳
勾选 = 删除，未勾选 = 保留
二、FFmpeg 命令
