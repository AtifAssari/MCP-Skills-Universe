---
title: critique
url: https://skills.sh/phrazzld/claude-config/critique
---

# critique

skills/phrazzld/claude-config/critique
critique
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill critique
SKILL.md
description: Adversarial expert review from a specific persona argument-hint: [context]
CRITIQUE
