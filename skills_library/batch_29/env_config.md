---
title: env-config
url: https://skills.sh/kazdenc/builder-skills/env-config
---

# env-config

skills/kazdenc/builder-skills/env-config
env-config
Installation
$ npx skills add https://github.com/kazdenc/builder-skills --skill env-config
SKILL.md
...
.env.[environment].local (e.g., .env.development.local, git-ignored)
