...
url: https://skills.sh/sanky369/vibe-building-skills/design-foundation
---

# design-foundation

skills/sanky369/vibe-building-skills/design-foundation
design-foundation
Installation
...
Suggest a migration path if you're formalizing an existing design
...
Create design principles tailored to your product
Generate a complete color system with accessibility considerations
Define typography scales and usage
Create spacing systems
Scaffold a component library structure
...
Extract and organize your existing tokens
Document your components
Create design principles that reflect your current design
Identify and suggest fixes for inconsistencies
...
Markdown documentation for your design system
Code examples for each section
Visual examples (if using Claude's image generation)
