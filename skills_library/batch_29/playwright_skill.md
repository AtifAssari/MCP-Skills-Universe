...
url: https://skills.sh/dedalus-erp-pas/foundation-skills/playwright-skill
---

# playwright-skill

skills/dedalus-erp-pas/foundation-skills/playwright-skill
playwright-skill
Installation
...
Wait for dynamic content - Use waitForLoadState('networkidle') before inspecting dynamic webapps
...
Don't hardcode URLs - Use constants at top of script for easy modificationeadless: false, // Visible browser slowMo: 50 // Slow down by 50ms });
