---
title: log-landing-issues
url: https://skills.sh/phrazzld/claude-config/log-landing-issues
---

# log-landing-issues

skills/phrazzld/claude-config/log-landing-issues
log-landing-issues
Installation
$ npx skills add https://github.com/phrazzld/claude-config --skill log-landing-issues
SKILL.md
/log-landing-issues
...
What This Does
Invoke /check-landing to audit landing page quality
