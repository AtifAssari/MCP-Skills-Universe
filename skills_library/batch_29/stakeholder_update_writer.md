...
url: https://skills.sh/krzysztofsurdy/code-virtuoso/stakeholder-update-writer
---

# stakeholder-update-writer

skills/krzysztofsurdy/code-virtuoso/stakeholder-update-writer
stakeholder-update-writer
Installation
$ npx skills add https://github.com/krzysztofsurdy/code-virtuoso --skill stakeholder-update-writer
SKILL.md
