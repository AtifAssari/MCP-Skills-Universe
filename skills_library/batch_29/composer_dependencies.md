...
url: https://skills.sh/krzysztofsurdy/code-virtuoso/composer-dependencies
---

# composer-dependencies

skills/krzysztofsurdy/code-virtuoso/composer-dependencies
composer-dependencies
Installation
...
Search the web for {package-name} CHANGELOG or {package-name} UPGRADE guide (e.g., doctrine/orm UPGRADE.md github)
Or ask the user to provide the changelog / release notes
Check the package's GitHub repository for CHANGELOG.md, UPGRADE.md, or release notes
...
Use composer why vendor/package to understand who depends on it
Wrap risky dependencies behind interfaces (adapter pattern) to make future replacement easier
Use composer-unused to find packages in composer.json that are not actually used in code
