---
title: skill-router
url: https://skills.sh/yuzc-001/skill-router/skill-router
---

# skill-router

skills/yuzc-001/skill-router/skill-router
skill-router
Installation
$ npx skills add https://github.com/yuzc-001/skill-router --skill skill-router
SKILL.md
Skill Router
...
Can an installed skill accept the task input?
Can an installed skill produce the needed output?
Is the quality sufficient for the user’s real purpose?

If all three are yes, stay with the installed path. If any answer is no, continue.
...
This skill is successful only if it reduces decision waste. If it is adding commentary without changing the decision, it is failing. n mind

This skill is successful only if it reduces decision waste. If it is adding commentary without changing the decision, it is failing. sion, it is failing.

Weekly Installs
12
Repository
yuzc-001/skill-router
GitHub Stars
36
First Seen
Mar 15, 2026
