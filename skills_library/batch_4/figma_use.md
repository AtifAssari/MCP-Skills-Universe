---
title: figma-use
url: https://skills.sh/openai/skills/figma-use
---

# figma-use

skills/openai/skills/figma-use
figma-use
...
Pages load incrementally — use await figma.setCurrentPageAsync(page) to switch pages and load their content (see Page Rules below)
...
Validate after each step. Use get_metadata to verify structure (counts, names, hierarchy, positions). Use get_screenshot after major milestones to catch visual issues.
