...
url: https://skills.sh/sickn33/antigravity-awesome-skills/competitor-alternatives
---
...
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill competitor-alternatives
Summary
...
Includes centralized competitor data architecture to maintain single source of truth for pricing, features, and positioning across all pages
Provides section templates for TL;DR summaries, feature comparisons, pricing breakdowns, migration guides, and social proof from switcher customers
SKILL.md
