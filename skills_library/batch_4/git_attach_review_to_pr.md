---
title: git:attach-review-to-pr
url: https://skills.sh/neolabhq/context-engineering-kit/git:attach-review-to-pr
---

# git:attach-review-to-pr

skills/neolabhq/context-engineering-kit/git:attach-review-to-pr
git:attach-review-to-pr
Installation
...
For single comments: Use the /comments endpoint (see Adding a Single Line-Specific Comment)
For multiple comments: Use the /reviews endpoint (see Adding Multiple Line-Specific Comments Together)
Overview
