---
title: add-provider-package
url: https://skills.sh/vercel/ai/add-provider-package
---

# add-provider-package

skills/vercel/ai/add-provider-package
add-provider-package
Installation
...
Specifications (@ai-sdk/provider): Defines interfaces like LanguageModelV4, EmbeddingModelV4, etc.
Utilities (@ai-sdk/provider-utils): Shared code for implementing providers
Providers (@ai-sdk/<provider>): Concrete implementations for each AI service
Core (ai): High-level functions like generateText, streamText, generateObject
Step-by-Step Guide
