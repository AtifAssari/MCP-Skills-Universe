---
title: byted-seedream-image-generate
url: https://skills.sh/site/skills.volces.com/byted-seedream-image-generate
---

# byted-seedream-image-generate

skills/skills.volces.com/byted-seedream-image-generate
byted-seedream-image-generate
$ npx skills add https://skills.volces.com/c/arkclaw-personal/skills/volcengine/seedream
SKILL.md
byted-seedream-image-generate
Description
...
Environment variables (ARK_API_KEY, MODEL_IMAGE_API_KEY, MODEL_AGENT_API_KEY)
Environment variables (ARK_BASE_URL, MODEL_IMAGE_API_BASE)
Default values
Usage
...
Use the message tool to send the image with these parameters:
...
Verify success: Check that the tool returns {"ok": true} to confirm the image was sent successfully

Normal Text not message tool: After generation, show list of images with Markdown format, for example：  Very important: The image URL must be an original online resource link starting with https://, not a local image address you have downloaded.
