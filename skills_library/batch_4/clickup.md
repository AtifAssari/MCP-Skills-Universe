---
title: clickup
url: https://skills.sh/civitai/civitai/clickup
---

# clickup

skills/civitai/civitai/clickup
clickup
Installation
...
Setup
Copy .env-example to .env in this skill directory
Add your ClickUp Personal API Token (starts with pk_)
