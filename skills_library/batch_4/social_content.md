...
url: https://skills.sh/sickn33/antigravity-awesome-skills/social-content
---

# social-content

skills/sickn33/antigravity-awesome-skills/social-content
social-content
Originally fromcoreyhaines31/marketingskills
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill social-content
Summary
...
Provides platform-specific best practices, posting frequency recommendations, optimal timing, and content formats that perform well on each network
...
Offers a reverse-engineering system to analyze top-performing content in your niche and extract repeatable patterns for hooks, formats, and CTAs
Covers content pillar development, repurposing workflows, batching strategies, and weekly engagement routines to build consistent presence without burnout
Guides audience research, brand voice definition, analytics tracking, and optimization tactics to align social activity with business goals
SKILL.md
Social Content
