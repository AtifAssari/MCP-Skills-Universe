---
title: recharts
url: https://skills.sh/ansanabria/skills/recharts
---

# recharts

skills/ansanabria/skills/recharts
recharts
Installation
...
Domain coordinates - Data values (e.g., x="March", y=5000). Used by ReferenceLine, ReferenceDot, ReferenceArea. Automatically converted to pixels.
Pixel coordinates - Positions relative to chart viewBox. Used for custom SVG shapes. Access via usePlotArea(), useOffset(), useChartWidth() hooks.
Mouse event coordinates - Browser viewport coordinates. Convert with getRelativeCoordinate(event, element).
