...
url: https://skills.sh/jezweb/claude-skills/product-showcase
---

# product-showcase

skills/jezweb/claude-skills/product-showcase
product-showcase
Installation
$ npx skills add https://github.com/jezweb/claude-skills --skill product-showcase
SKILL.md
...
Chrome MCP (mcp__claude-in-chrome__*) — preferred for authenticated apps
Playwright MCP (mcp__plugin_playwright_playwright__*) — for public apps
...
Forms must submit somewhere — never ship a form that goes nowhere
Every page needs navigation — consistent nav, mobile hamburger, CTA always visible
Deploy to a real URL — don't leave it as local files. A showcase needs to be shareable.
Weekly Installs
447
Repository
