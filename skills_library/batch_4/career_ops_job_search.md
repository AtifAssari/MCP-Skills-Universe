---
title: career-ops-job-search
url: https://skills.sh/aradotso/trending-skills/career-ops-job-search
---
...
Single source of truth — data/pipeline.tsv is the canonical record; all commands read/write it consistently
Gitignore your data — data/, reports/, output/, and cv.md are gitignored by default; your personal info stays local
Weekly Installs
450
Repository
