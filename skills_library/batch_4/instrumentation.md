...
url: https://skills.sh/pydantic/skills/instrumentation
---

# instrumentation

skills/pydantic/skills/instrumentation
instrumentation
Installation
...
Run logfire auth to check authentication (or set LOGFIRE_TOKEN)
Start the app and trigger a request
