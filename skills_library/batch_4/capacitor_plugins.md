...
url: https://skills.sh/capawesome-team/skills/capacitor-plugins
---

# capacitor-plugins

skills/capawesome-team/skills/capacitor-plugins
capacitor-plugins
Installation
...
iOS dependency manager: Check if ios/App/Podfile exists (CocoaPods) or if SPM is used.
...
If the registry is already configured, skip this and move on.
