---
title: ads-youtube
url: https://skills.sh/agricidaniel/claude-ads/ads-youtube
---

# ads-youtube

skills/agricidaniel/claude-ads/ads-youtube
ads-youtube
Installation
$ npx skills add https://github.com/agricidaniel/claude-ads --skill ads-youtube
SKILL.md
YouTube Ads Analysis
Process
Collect YouTube Ads data (Google Ads export filtered to Video campaigns)
Read ads/references/google-audit.md for YouTube-relevant checks (incl. G-DG1 through G-DG3, G-CTV1)
Read ads/references/platform-specs.md for video specifications
Read ads/references/benchmarks.md for YouTube benchmarks
Read ads/references/scoring-system.md for health score algorithm
Validate: confirm at least one active video campaign exists before proceeding
