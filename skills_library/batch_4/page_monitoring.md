...
url: https://skills.sh/jamditis/claude-skills-journalism/page-monitoring
---

# page-monitoring

skills/jamditis/claude-skills-journalism/page-monitoring
page-monitoring
Installation
...
Covers RSS feed generation for pages without feeds, Twitter/X archiving with Twarc, and webhook-based alerts (Slack, Discord, email)
Provides cron scheduling templates and best practices for rate limiting, monitoring frequency by use case, and legal considerations for competitive intelligence
SKILL.md
