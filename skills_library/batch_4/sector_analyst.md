...
url: https://skills.sh/tradermonty/claude-trading-skills/sector-analyst
---

# sector-analyst

skills/tradermonty/claude-trading-skills/sector-analyst
sector-analyst
Installation
...
Run the analysis script: python3 scripts/analyze_sector_rotation.py
