...
url: https://skills.sh/davila7/claude-code-templates/file-organizer
---

# file-organizer

skills/davila7/claude-code-templates/file-organizer
file-organizer
Originally fromlangchain-ai/deepagentsjs
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill file-organizer
SKILL.md
File Organizer
