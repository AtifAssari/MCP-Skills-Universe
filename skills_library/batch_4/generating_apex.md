---
title: generating-apex
url: https://skills.sh/forcedotcom/afv-library/generating-apex
---

# generating-apex

skills/forcedotcom/afv-library/generating-apex
generating-apex
Installation
...
Generate test classes -- Load the skill generating-apex-test to create {ClassName}Test.cls and {ClassName}Test.cls-meta.xml. Apex tests are always required to be generated to deploy. No test file creation or edits can occur without loading the generating-apex-test skill to generate tests.
