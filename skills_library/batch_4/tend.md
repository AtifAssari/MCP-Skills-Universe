---
title: tend
url: https://skills.sh/juxt/allium/tend
---

# tend

skills/juxt/allium/tend
tend
Installation
...
Read the relevant .allium files (search the project to find them if not specified).
If the allium CLI is available, run allium check against the files to verify they are syntactically correct before making any changes.
Understand the existing domain model before proposing changes.
What you do
