---
title: browser-use
url: https://skills.sh/site/skills.volces.com/browser-use
---

# browser-use

skills/skills.volces.com/browser-use
browser-use
$ npx skills add https://skills.volces.com/c/arkclaw-personal/skills/clawhub/shawnpana
SKILL.md
