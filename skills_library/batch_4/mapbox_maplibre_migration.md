---
title: mapbox-maplibre-migration
url: https://skills.sh/mapbox/mapbox-agent-skills/mapbox-maplibre-migration
---

# mapbox-maplibre-migration

skills/mapbox/mapbox-agent-skills/mapbox-maplibre-migration
mapbox-maplibre-migration
Installation
...
Note your token (starts with pk. for public tokens)
2. Update Package
# Remove MapLibre
