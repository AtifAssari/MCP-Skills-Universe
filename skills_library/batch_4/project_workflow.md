...
url: https://skills.sh/jezweb/claude-skills/project-workflow
---

# project-workflow

skills/jezweb/claude-skills/project-workflow
project-workflow
Installation
...
/release performs eight-phase safety checks including secret scanning, documentation validation, and build testing before publishing
/brief and /reflect capture decisions and operational knowledge for future sessions, with /reflect suggesting custom agents for repeatable processes
SKILL.md
