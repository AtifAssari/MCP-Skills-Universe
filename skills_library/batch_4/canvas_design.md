---
title: canvas-design
url: https://skills.sh/sickn33/antigravity-awesome-skills/canvas-design
---

# canvas-design

skills/sickn33/antigravity-awesome-skills/canvas-design
canvas-design
...
Create visually-driven design artifacts by first establishing an aesthetic philosophy, then expressing it through museum-quality .png or .pdf outputs.

Two-step workflow: develop a named design philosophy (4–6 paragraphs articulating visual principles around form, space, color, and composition), then interpret it as a single-page or multi-page visual composition with minimal, integrated text
Emphasizes expert craftsmanship and meticulous execution; output should appear labored over by someone at the top of their field, suitable for gallery or magazine publication
Supports embedded conceptual references—subtle thematic DNA woven into form and color rather than literal illustration—so the work rewards both casual viewing and informed recognition
Text treated as a visual element, not explanation; typography and language choices vary by context but always remain design-forward and sparse, with careful attention to spacing, margins, and composition balance
SKILL.md
