---
title: openspec-proposal-creation-cn
url: https://skills.sh/forztf/open-skilled-sdd/openspec-proposal-creation-cn
---

# openspec-proposal-creation-cn

skills/forztf/open-skilled-sdd/openspec-proposal-creation-cn
openspec-proposal-creation-cn
Installation
...
proposal.md - 为什么、做什么、影响摘要
tasks.json - 编号的实施清单
spec-delta.md - 正式的需求变更（ADDED/MODIFIED/REMOVED）
