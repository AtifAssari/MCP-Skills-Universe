---
title: dune
url: https://skills.sh/duneanalytics/skills/dune
---

# dune

skills/duneanalytics/skills/dune
dune
Installation
$ npx skills add https://github.com/duneanalytics/skills --skill dune
SKILL.md
Prerequisites
...
Create, get, update, delete, or list visualizations on saved queries	visualization-management.md
Create, get, update, or archive dashboards	dashboard-management.md
