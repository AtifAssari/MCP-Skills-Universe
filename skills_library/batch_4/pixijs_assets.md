---
title: pixijs-assets
url: https://skills.sh/pixijs/pixijs-skills/pixijs-assets
---

# pixijs-assets

skills/pixijs/pixijs-skills/pixijs-assets
pixijs-assets
Installation
...
LoadOptions: the second argument to Assets.load/loadBundle. Controls error recovery, retries, progress, and completion callbacks across a whole load.
data: a field on each asset descriptor. Forwards parser-specific options (scale mode, resolution, font family, autoplay flags, etc.) to the specific loader for that asset.
