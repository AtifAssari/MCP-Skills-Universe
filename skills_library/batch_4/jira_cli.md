---
title: jira-cli
url: https://skills.sh/code-and-sorts/awesome-copilot-agents/jira-cli
---

# jira-cli

skills/code-and-sorts/awesome-copilot-agents/jira-cli
jira-cli
Installation
...
Prerequisites
Install jira-cli: brew install ankitpokhrel/jira-cli/jira-cli (macOS) or download from releases
Set API token: export JIRA_API_TOKEN="your-token"
Initialize: jira init and follow prompts
Issue Commands
List Issues
