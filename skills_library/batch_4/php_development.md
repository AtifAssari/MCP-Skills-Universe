...
url: https://skills.sh/mindrally/skills/php-development
---

# php-development

skills/mindrally/skills/php-development
php-development
Installation
$ npx skills add https://github.com/mindrally/skills --skill php-development
SKILL.md
PHP Development
