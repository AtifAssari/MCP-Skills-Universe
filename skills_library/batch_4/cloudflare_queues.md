...
url: https://skills.sh/jezweb/claude-skills/cloudflare-queues
---

# cloudflare-queues

skills/jezweb/claude-skills/cloudflare-queues
cloudflare-queues
Installation
...
Processes up to 5,000 messages/second per queue with auto-scaling concurrency (up to 250 concurrent invocations) and 128 KB message size limit
Includes HTTP publishing API (May 2025+) for external services, event subscriptions from R2/KV/AI (August 2025+), and pause/purge management commands
Prevents 13 documented issues including multi-dev queue isolation, remote binding conflicts, and DLQ data loss scenarios
SKILL.md
Cloudflare Queues
