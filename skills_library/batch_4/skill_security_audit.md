...
url: https://skills.sh/smartchainark/skill-security-audit/skill-security-audit
---

# skill-security-audit

skills/smartchainark/skill-security-audit/skill-security-audit
skill-security-audit
Installation
...
Read references/remediation-guide.md for incident response steps
...
Script audit — Read all .sh, .py, .js files. Look for obfuscation, unexpected network calls.
Dependency check — Run npm audit or pip-audit if the skill has package dependencies.
...
Update references/ioc-database.md to keep the human-readable version in sync
Reference Documents
