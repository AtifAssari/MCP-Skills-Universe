---
title: product
url: https://skills.sh/boshu2/agentops/product
---

# product

skills/boshu2/agentops/product
product
Installation
...
Directory listing — ls the project root for structural hints
...
Check .agents/planning-rules/ — compiled planning principles
Check .agents/patterns/ — battle-tested patterns from usage
Check .agents/learnings/ — accumulated learnings
...
What was created: PRODUCT.md at {path}
What it unlocks:
...
Next steps: Suggest running /pre-mortem on their next plan to see product perspectives in action
Examples
...
Agent asks about competitors, gathers honest where-they-win and where-we-win for each
Agent asks for strategic bet: "We bet that dependency security will become a compliance requirement, not a best practice"
Agent auto-pulls GitHub stats (142 stars, 2.3K clones/14d) and asks about measured impact
Agent pushes for known gaps: user admits "onboarding is confusing" and "no Windows support"
Agent scans .agents/ — finds 12 planning rules and 45 learnings, includes as validated principles
Agent writes PRODUCT.md with Evidence, Competitive Positioning, Known Gaps, and Strategic Bet sections
...
Agent updates PRODUCT.md with new persona, updates last_reviewed date
