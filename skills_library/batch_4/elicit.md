---
title: elicit
url: https://skills.sh/juxt/allium/elicit
---

# elicit

skills/juxt/allium/elicit
elicit
Installation
...
Is this value a design decision? Include it.
Might it vary per deployment or customer? Make it configurable.
Is it arbitrary? Consider whether to include it at all.
...
"What is this system fundamentally about? In one sentence?"
"Where does this system start and end? What's in scope vs out?"
"Who are the users? Are there different roles?"
"Are there existing systems this integrates with? What do they handle?"
...
"Looking at [entity], are these states complete? Can it be in any other state?"
"Is there anything we haven't covered?"
"This rule references [X], do we need to define that, or is it external?"
"Is this detail essential here, or should it live in a detailed spec?"
