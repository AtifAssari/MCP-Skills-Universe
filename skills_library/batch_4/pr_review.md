---
title: pr review
url: https://skills.sh/angular/angular/pr-review
---

# pr review

skills/angular/angular/PR Review
PR Review
Installation
...
Create a pending review using mcp_github-mcp-server_pull_request_review_write (method create).
Add your inline comments to the pending review using mcp_github-mcp-server_add_comment_to_pending_review.
Submit the review using mcp_github-mcp-server_pull_request_review_write (method submit_pending).
