...
url: https://skills.sh/sickn33/antigravity-awesome-skills/frontend-slides
---

# frontend-slides

skills/sickn33/antigravity-awesome-skills/frontend-slides
frontend-slides
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill frontend-slides
SKILL.md
Frontend Slides
...
Extract content — Run python scripts/extract-pptx.py <input.pptx> <output_dir> (install python-pptx if needed: pip install python-pptx)
...
Phase 5: Delivery
Clean up — Delete .claude-design/slide-previews/ if it exists
Open — Use open [filename].html to launch in browser
