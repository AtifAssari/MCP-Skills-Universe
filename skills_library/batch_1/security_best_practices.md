...
url: https://skills.sh/openai/skills/security-best-practices
---

# security-best-practices

skills/openai/skills/security-best-practices
security-best-practices
Installation
...
Generates detailed markdown reports with line-number references, impact statements, and numeric IDs for easy tracking and remediation
Provides fix recommendations that account for existing project functionality and follow the project's normal change and testing workflows
SKILL.md
Security Best Practices
Overview
