...
url: https://skills.sh/sickn33/antigravity-awesome-skills/product-manager-toolkit
---

# product-manager-toolkit

skills/sickn33/antigravity-awesome-skills/product-manager-toolkit
product-manager-toolkit
Installation
$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill product-manager-toolkit
Summary

Complete product management toolkit with RICE prioritization, interview analysis, and PRD templates.
...
Provides four PRD template formats (Standard, One-Page, Agile Epic, Feature Brief) plus discovery frameworks including hypothesis templates and opportunity solution trees
Covers metrics frameworks (North Star, funnel analysis, feature success metrics) and best practices for stakeholder management, discovery, and avoiding common PM pitfalls
SKILL.md
Product Manager Toolkit
