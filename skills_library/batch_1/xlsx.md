---
title: xlsx
url: https://skills.sh/tfriedel/claude-office-skills/xlsx
---

# xlsx

skills/tfriedel/claude-office-skills/xlsx
xlsx
...
Provides data analysis capabilities via pandas for statistics, visualization, and bulk operations
Automatically recalculates all formulas and scans for errors (#REF!, #DIV/0!, #VALUE!, #N/A, #NAME?) using LibreOffice integration
Enforces zero formula errors and dynamic spreadsheets using cell references instead of hardcoded values
SKILL.md
