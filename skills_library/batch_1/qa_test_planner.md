...
skills/softaworks/agent-toolkit/qa-test-planner
qa-test-planner
Installation
...
Validate UI implementations against Figma designs with component-by-component comparison and discrepancy tracking
Document bugs with reproducible steps, environment details, severity/priority, and visual evidence
SKILL.md
QA Test Planner
