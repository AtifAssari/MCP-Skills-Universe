...
url: https://skills.sh/supercent-io/skills-template/marketing-automation
---

# marketing-automation

skills/supercent-io/skills-template/marketing-automation
marketing-automation
Installation
$ npx skills add https://github.com/supercent-io/skills-template --skill marketing-automation
Summary

23 specialized marketing sub-skills for generating CRO, copywriting, SEO, analytics, and growth deliverables with clear KPI alignment.

Covers five marketing categories: CRO (landing pages, signup flows, forms, paywalls), copywriting (ads, email sequences, social content), SEO (audits, programmatic pages, comparison pages, schema markup), ads and analytics (tracking setup, paid ads strategy, A/B testing), and growth strategy (launch, pricing, retention, churn analysis, referral programs)
Structured workflow: define objective and constraints, select the appropriate sub-skill, build a prompt with product context and audience details, generate and validate output, then implement with tracking events and success thresholds
Each sub-skill generates actionable deliverables with prioritized recommendations, A/B test hypotheses, and measurement frameworks tied to specific KPIs
Includes multi-agent validation across orchestration, analysis, and execution roles for consistency and coverage
SKILL.md
...
Cause: Vague product/audience information Solution: Provide positioning, competitors, proof points

Issue: Output conflicts with brand voice

Cause: No tone/voice constraints Solution: Provide brand do/don't list and sample copy

Issue: Can't measure impact

Cause: Tracking events not defined Solution: Define events and success thresholds in advance
