...
url: https://skills.sh/ailabs-393/ai-labs-claude-skills/research-paper-writer
---

# research-paper-writer

skills/ailabs-393/ai-labs-claude-skills/research-paper-writer
research-paper-writer
Installation
...
Applies formal writing conventions including third-person perspective, technical precision, quantified claims, and logical argumentation tailored to each section
Handles IEEE and ACM formatting specifications including layout, typography, figure/table placement, and citation styles
Generates outlines, drafts iteratively starting with methodology, and ensures consistency in terminology and citation completeness throughout
SKILL.md
Research Paper Writer
Overview
