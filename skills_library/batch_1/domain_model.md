---
title: domain-model
url: https://skills.sh/mattpocock/skills/domain-model
---

# domain-model

skills/mattpocock/skills/domain-model
domain-model
Installation
$ npx skills add https://github.com/mattpocock/skills --skill domain-model
SKILL.md
