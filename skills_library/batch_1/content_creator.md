...
url: https://skills.sh/shubhamsaboo/awesome-llm-apps/content-creator
---

# content-creator

skills/shubhamsaboo/awesome-llm-apps/content-creator
content-creator
Installation
...
Provides six headline formulas (How To, List, Question, Negative, Curiosity Gap, Before/After) and five emotional trigger patterns for engagement
Features storytelling, social proof, and scannability techniques with a pre-publish checklist to validate hook strength, flow, and actionability
SKILL.md
Content Creator
