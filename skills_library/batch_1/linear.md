...
Executes operations in logical batches: read first for context, then create or update with all required fields, followed by result summary and next-action proposals
SKILL.md
Linear
Overview
