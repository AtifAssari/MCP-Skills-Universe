...
url: https://skills.sh/composiohq/awesome-claude-skills/lead-research-assistant
---

# lead-research-assistant

skills/composiohq/awesome-claude-skills/lead-research-assistant
lead-research-assistant
Installation
$ npx skills add https://github.com/composiohq/awesome-claude-skills --skill lead-research-assistant
Summary

Identifies high-quality leads by analyzing your business, searching for target companies, and ranking them with personalized outreach strategies.
...
Generates personalized outreach strategies, value propositions, and conversation starters tailored to each lead's specific business
Works with codebase context when run from your product directory for automatic product understanding
Outputs results in scannable format ready for CRM import or direct outreach campaigns
SKILL.md
Lead Research Assistant
