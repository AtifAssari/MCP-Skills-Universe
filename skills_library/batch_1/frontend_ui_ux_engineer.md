...
url: https://skills.sh/404kidwiz/claude-supercode-skills/frontend-ui-ux-engineer
---

# frontend-ui-ux-engineer

skills/404kidwiz/claude-supercode-skills/frontend-ui-ux-engineer
frontend-ui-ux-engineer
Installation
...
Includes reusable patterns for glassmorphism cards, skeleton loaders, and common UI components with production-ready code examples
Provides quality checklists for visual polish, responsive design, and performance optimization across mobile and desktop
SKILL.md
Frontend UI/UX Engineer
Purpose
