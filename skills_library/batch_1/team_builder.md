---
title: team-builder
url: https://skills.sh/affaan-m/everything-claude-code/team-builder
---

# team-builder

skills/affaan-m/everything-claude-code/team-builder
team-builder
Installation
$ npx skills add https://github.com/affaan-m/everything-claude-code --skill team-builder
SKILL.md
Team Builder
...
claude agents command (primary) — run claude agents to get all agents known to the CLI, including user agents, plugin agents (e.g. everything-claude-code:architect), and built-in agents. This automatically covers ECC marketplace installs without any path configuration.
