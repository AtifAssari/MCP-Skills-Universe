...
url: https://skills.sh/apify/agent-skills/apify-audience-analysis
---

# apify-audience-analysis

skills/apify/agent-skills/apify-audience-analysis
apify-audience-analysis
Installation
...
Includes structured workflow with platform selection, schema inspection, user preference collection, and result summarization
SKILL.md
Audience Analysis
