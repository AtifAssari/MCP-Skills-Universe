...
Automatic environment setup with virtual environment creation, dependency installation, and idle daemon management; all data stored locally in ~/.claude/skills/notebooklm/data/
SKILL.md
