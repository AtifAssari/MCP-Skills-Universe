---
title: xiaohongshu
url: https://skills.sh/autoclaw-cc/xiaohongshu-mcp-skills/xiaohongshu
---

# xiaohongshu

skills/autoclaw-cc/xiaohongshu-mcp-skills/xiaohongshu
xiaohongshu
Installation
...
Routes user requests to specialized sub-skills based on intent: setup, login, posting, search, exploration, interactions, profile viewing, or content planning
Enforces user confirmation for write operations (publishing, commenting) and derives feed IDs and tokens from actual search/browse results rather than user input
SKILL.md
