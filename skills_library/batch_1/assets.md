---
title: assets
url: https://skills.sh/binance/binance-skills-hub/assets
---

# assets

skills/binance/binance-skills-hub/assets
assets
Installation
...
Requires API key and secret key authentication; includes credential masking, account management, and HMAC SHA256/RSA/Ed25519 signing support
Returns all responses in JSON format with configurable receive windows and pagination via current/size parameters
SKILL.md
