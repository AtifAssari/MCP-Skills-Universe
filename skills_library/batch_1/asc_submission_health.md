...
url: https://skills.sh/rudrankriyam/app-store-connect-cli-skills/asc-submission-health
---

# asc-submission-health

skills/rudrankriyam/app-store-connect-cli-skills/asc-submission-health
asc-submission-health
Installation
...
Offers monitoring and cancellation commands to track submission status and retry failed submissions after fixing issues
Documents common submission errors (invalid version state, export compliance, multiple app infos) with diagnostic steps and remediation paths
SKILL.md
asc submission health
