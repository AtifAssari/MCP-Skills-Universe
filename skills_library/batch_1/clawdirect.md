...
skills/napoleond/clawdirect/clawdirect
clawdirect
Installation
...
Obtain HTTP-only authentication cookies via MCP for browser-based interactions, with automatic URL cleanup after cookie setup
SKILL.md
ClawDirect
