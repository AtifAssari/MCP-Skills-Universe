...
url: https://skills.sh/aradotso/trending-skills/openclaw-control-center
---

# openclaw-control-center

skills/aradotso/trending-skills/openclaw-control-center
openclaw-control-center
Installation
...
Open Settings → 接线状态 (Wiring Status) — it lists exactly which connectors are connected, partial, or missing.
Common causes:
