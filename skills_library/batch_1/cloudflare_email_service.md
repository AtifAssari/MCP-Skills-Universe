...
url: https://skills.sh/cloudflare/skills/cloudflare-email-service
---

# cloudflare-email-service

skills/cloudflare/skills/cloudflare-email-service
cloudflare-email-service
Installation
...
Domain onboarded? Run npx wrangler email sending list to see which domains have email sending enabled. If the domain isn't listed, run npx wrangler email sending enable userdomain.com or see cli-and-mcp.md for full setup instructions.
