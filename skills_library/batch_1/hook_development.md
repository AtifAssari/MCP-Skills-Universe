...
url: https://skills.sh/anthropics/claude-plugins-official/hook-development
---

# hook-development

skills/anthropics/claude-plugins-official/hook-development
hook-development
...
Validate configuration with scripts/validate-hook-schema.sh hooks/hooks.json
Test hooks with scripts/test-hook.sh before deployment
Test in Claude Code with claude --debug
