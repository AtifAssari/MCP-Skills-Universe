...
url: https://skills.sh/flutter/skills/flutter-setup-declarative-routing
---
...
Modify Info.plist: Opt-in to Flutter's default deep link handler. Note: If using a third-party deep linking plugin (e.g., app_links), set this to NO to prevent conflicts.
