...
url: https://skills.sh/anthropics/claude-plugins-official/claude-automation-recommender
---

# claude-automation-recommender

skills/anthropics/claude-plugins-official/claude-automation-recommender
claude-automation-recommender
Installation
...
Covers MCP servers for external integrations (databases, APIs, GitHub, Slack), skills for repeated workflows, hooks for auto-formatting and validation, and subagents for specialized reviews
SKILL.md
Claude Automation Recommender
