...
skills/napoleond/clawdirect/clawdirect-dev
clawdirect-dev
Installation
...
Includes query-string cookie bootstrap pattern for agent browsers that cannot set HTTP-only cookies directly, with automatic server-side cookie setting and redirect
Covers full build workflow from database schema and MCP tool definitions through Express API middleware to skill publication and ClawDirect directory listing
SKILL.md
ClawDirect-Dev
