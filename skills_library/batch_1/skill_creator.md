---
title: skill-creator
url: https://skills.sh/anthropics/claude-plugins-official/skill-creator
---

# skill-creator

skills/anthropics/claude-plugins-official/skill-creator
skill-creator
...
Generates an interactive browser-based review tool for qualitative evaluation — side-by-side output comparison, assertion grading, and per-iteration feedback tracking
Optimizes skill descriptions for better triggering accuracy by testing against 20 realistic trigger/no-trigger queries and iterating the description via extended thinking
Bundles helper scripts and reference materials into skills to reduce reinvention across invocations
SKILL.md
Skill Creator
