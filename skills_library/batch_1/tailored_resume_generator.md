...
url: https://skills.sh/composiohq/awesome-claude-skills/tailored-resume-generator
---

# tailored-resume-generator

skills/composiohq/awesome-claude-skills/tailored-resume-generator
tailored-resume-generator
Installation
$ npx skills add https://github.com/composiohq/awesome-claude-skills --skill tailored-resume-generator
Summary

Analyzes job descriptions and generates customized resumes highlighting relevant experience and keywords to improve interview prospects.

Extracts key requirements, skills, and keywords from job postings, then reorganizes your experience to match employer priorities
Optimizes resumes for ATS (Applicant Tracking Systems) by incorporating job-specific terminology naturally while maintaining professional formatting
Handles career transitions by identifying and emphasizing transferable skills across industries or roles
Provides strategic recommendations including gap analysis, interview talking points, and cover letter hooks tailored to the position
SKILL.md
Tailored Resume Generator
