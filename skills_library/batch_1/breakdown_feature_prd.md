...
skills/github/awesome-copilot/breakdown-feature-prd
breakdown-feature-prd
Installation
...
Organizes output into a consistent file structure (/docs/ways-of-work/plan/{epic-name}/{feature-name}/prd.md) for centralized documentation management
Includes explicit out-of-scope definition to prevent scope creep and establish clear feature boundaries
SKILL.md
Feature PRD Prompt
Goal
