...
url: https://skills.sh/samhvw8/dot-claude/ui-design-system
---

# ui-design-system

skills/samhvw8/dot-claude/ui-design-system
ui-design-system
Installation
...
Design token system with three-tier structure (primitive, semantic, component) using OKLCH color space and CSS variables for theming and dark mode
Form architecture with React Hook Form and Zod, component customization via CVA variants, and mobile-first responsive patterns with container queries
SKILL.md
