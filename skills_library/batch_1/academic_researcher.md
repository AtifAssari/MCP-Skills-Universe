...
url: https://skills.sh/shubhamsaboo/awesome-llm-apps/academic-researcher
---

# academic-researcher

skills/shubhamsaboo/awesome-llm-apps/academic-researcher
academic-researcher
Installation
$ npx skills add https://github.com/shubhamsaboo/awesome-llm-apps --skill academic-researcher
Summary

Comprehensive academic research assistant for literature reviews, paper analysis, and scholarly writing.
...
Enforces academic writing standards including formal language, evidence-based argumentation, and proper acknowledgment of study limitations
Delivers standardized output formats for paper summaries, literature overviews, and research synthesis with consistent organization
SKILL.md
Academic Researcher
