...
url: https://skills.sh/supercent-io/skills-template/video-production
---

# video-production

skills/supercent-io/skills-template/video-production
video-production
Installation
...
Includes scene templates, asset checklists, and Remotion component examples for product intros, onboarding walkthroughs, and marketing videos
Multi-agent validation workflow with orchestrator, analyst, and executor roles for spec completeness, narrative consistency, and render-readiness checks
SKILL.md
