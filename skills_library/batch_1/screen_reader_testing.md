...
skills/wshobson/agents/screen-reader-testing
screen-reader-testing
Installation
...
Provides browse vs. focus mode navigation strategies, landmark discovery, heading structure validation, and dynamic content announcement testing
Features common accessibility issues with code fixes for button labeling, live regions, form errors, and focus management in single-page applications
SKILL.md
Screen Reader Testing
