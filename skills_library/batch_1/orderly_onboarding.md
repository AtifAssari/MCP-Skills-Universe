---
title: orderly-onboarding
url: https://skills.sh/starchild-ai-agent/official-skills/orderly-onboarding
---

# orderly-onboarding

skills/starchild-ai-agent/official-skills/orderly-onboarding
orderly-onboarding
Installation
...
Offers 15+ installable agent skills covering API authentication, order management, position tracking, WebSocket streaming, wallet integration, React SDK hooks, and white-label DEX creation
Supports three developer paths: SDK-based DEX builders, REST API and bot developers, and Orderly One white-label platform operators
SKILL.md
