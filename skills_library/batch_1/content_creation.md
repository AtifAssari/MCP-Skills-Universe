...
url: https://skills.sh/anthropics/knowledge-work-plugins/content-creation
---

# content-creation

skills/anthropics/knowledge-work-plugins/content-creation
content-creation
Installation
...
Provides headline and hook formulas (contrarian statements, statistics, scenarios), CTA principles with action verbs, and on-page SEO checklist covering title tags, meta descriptions, and internal linking
Writing guidance emphasizes active voice, scannable formatting, benefit-driven copy, and keyword placement without stuffing
SKILL.md
