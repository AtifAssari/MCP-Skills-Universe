---
title: eraser-diagrams
url: https://skills.sh/eraserlabs/eraser-io/eraser-diagrams
---

# eraser-diagrams

skills/eraserlabs/eraser-io/eraser-diagrams
eraser-diagrams
Installation
...
Requires ERASER_API_KEY environment variable and network access to the Eraser API
SKILL.md
...
How It Works
Analyze the source: Extract architecture information from code, files, or descriptions
Generate Eraser DSL: Create Eraser DSL code that describes the diagram
Call the Eraser API: Make an HTTP POST request to render the diagram
Return the result: Present the image URL and editor link to the user
