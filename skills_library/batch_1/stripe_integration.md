...
skills/wshobson/agents/stripe-integration
stripe-integration
Installation
...
Includes customer management, payment method storage, and customer portal for self-service subscription management
Provides secure webhook verification, idempotent event processing patterns, and test mode support with example card numbers for development
SKILL.md
Stripe Integration
