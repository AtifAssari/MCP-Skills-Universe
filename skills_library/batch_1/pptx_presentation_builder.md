...
Includes multi-step review workflow: layout balance, typography hierarchy, content clarity, and accessibility checks before export
Delivers complete handoff packages with PPTX, PDF backup, speaker notes, and editing guidance for each slide
SKILL.md
Presentation Builder
