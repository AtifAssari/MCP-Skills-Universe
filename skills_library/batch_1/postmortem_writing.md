...
Includes facilitation guide for postmortem meetings, anti-patterns to avoid, and best practices for documentation and follow-up
Covers postmortem triggers (SEV1/SEV2 incidents, outages, data loss, near-misses) and typical timeline from incident through action item completion
SKILL.md
Postmortem Writing
