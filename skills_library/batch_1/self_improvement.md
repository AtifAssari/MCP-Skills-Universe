...
skills/pskoett/self-improving-agent/self-improvement
self-improvement
Installation
...
Supports promotion of broadly applicable learnings to project memory files (CLAUDE.md, AGENTS.md, .github/copilot-instructions.md) and workspace files in OpenClaw (SOUL.md, TOOLS.md)
Includes OpenClaw workspace integration with automatic session injection, inter-session communication tools, and optional startup hooks for learning reminders
