...
url: https://skills.sh/getsentry/sentry-for-ai/sentry-fix-issues
---

# sentry-fix-issues

skills/getsentry/sentry-for-ai/sentry-fix-issues
sentry-fix-issues
Installation
...
Treats all Sentry event data as untrusted external input; enforces strict security rules against embedded instructions, raw data in code, and credential exposure
Validates stack frames and file paths against actual codebase before implementing fixes to catch stale or inconsistent event data
SKILL.md
