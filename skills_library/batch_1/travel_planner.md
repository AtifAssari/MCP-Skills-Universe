...
url: https://skills.sh/ailabs-393/ai-labs-claude-skills/travel-planner
---

# travel-planner

skills/ailabs-393/ai-labs-claude-skills/travel-planner
travel-planner
Installation
...
Generates complete trip plans including day-by-day itineraries with timing and costs, budget breakdowns by category, packing checklists tailored to climate and activities, and cultural do's/don'ts for any destination
Performs destination research via web search covering visas, safety, transportation, attractions, dining, neighborhoods, and practical logistics
Tracks expenses during trips and provides pre-trip preparation timelines with milestone checklists leading up to departure
SKILL.md
Travel Planner
Overview
...
Cultural Norms - Do's and don'ts (use references/cultural_etiquette.md as guide)
Local Transportation - Metro, buses, taxis, apps
...
Best Practices
Research Thoroughly - Use web search for current, accurate information
Be Realistic - Don't over-schedule; allow for rest and spontaneity
Book Ahead - Popular attractions sell out, especially in peak season
Budget Buffer - Add 10-20% extra for unexpected costs
Cultural Respect - Research and follow local customs
Safety First - Check travel advisories, register with embassy
Stay Flexible - Weather and circumstances change
Document Everything - Save confirmations, important info offline
Example Interaction
