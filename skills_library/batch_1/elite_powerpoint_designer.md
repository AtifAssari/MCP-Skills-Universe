...
Strict design system enforcement: typography hierarchy, spacing grid, color palette adherence, and animation timing validated across every slide
Supports markdown-to-PowerPoint conversion with optional frontmatter for style selection, custom colors, and animation levels
SKILL.md
Elite PowerPoint Designer
