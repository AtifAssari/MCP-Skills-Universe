...
url: https://skills.sh/prisma/skills/prisma-upgrade-v7
---

# prisma-upgrade-v7

skills/prisma/skills/prisma-upgrade-v7
prisma-upgrade-v7
Installation
...
Choose your module format (esm by default, cjs if needed)
...
Replace deprecated helper patterns like Prisma.validator
Run prisma generate and test
...
Resources
Official v7 Upgrade Guide
Driver Adapters Documentation
