---
title: r2-storage
url: https://skills.sh/null-shot/cloudflare-skills/r2-storage
---

# r2-storage

skills/null-shot/cloudflare-skills/r2-storage
r2-storage
Installation
...
Best Practices
Set appropriate Content-Type: Always specify httpMetadata.contentType for proper browser handling
Use unique keys: Prefix with UUIDs or timestamps to avoid collisions
Leverage custom metadata: Store searchable metadata without downloading objects
Use ETags for consistency: Implement conditional operations for race condition prevention
Stream large uploads: Use multipart uploads for files > 100MB
Cache control headers: Set appropriate cacheControl in httpMetadata
Use presigned URLs for direct uploads: Reduce Worker bandwidth and latency
List with pagination: Always handle truncated results when listing objects
Use R2Bucket binding by default: Only use AWS SDK when you need presigned URLs or S3-specific features
Handle 404s gracefully: bucket.get() returns null when object doesn't exist
Common Patterns
