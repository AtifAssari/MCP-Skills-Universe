...
url: https://skills.sh/mukul975/anthropic-cybersecurity-skills/testing-oauth2-implementation-flaws
---

# testing-oauth2-implementation-flaws

skills/mukul975/anthropic-cybersecurity-skills/testing-oauth2-implementation-flaws
testing-oauth2-implementation-flaws
Installation
$ npx skills add https://github.com/mukul975/anthropic-cybersecurity-skills --skill testing-oauth2-implementation-flaws
SKILL.md
Testing OAuth2 Implementation Flaws
When to Use
...
Analyze the OAuth configuration at /.well-known/openid-configuration for both providers
Test redirect URI validation: discover that the application registers https://app.example.com/callback but the server accepts https://app.example.com/callback/..%2fevil
Test state parameter: authorization request includes state but the callback handler does not validate it (CSRF possible)
...
Test scope: application requests openid profile email but the authorization server also grants read:repos without explicit consent
Test authorization code replay: code can be exchanged twice, indicating lack of single-use enforcement
