---
title: cloudflare-r2
url: https://skills.sh/bagelhole/devops-security-agent-skills/cloudflare-r2
---

# cloudflare-r2

skills/bagelhole/devops-security-agent-skills/cloudflare-r2
cloudflare-r2
Installation
$ npx skills add https://github.com/bagelhole/devops-security-agent-skills --skill cloudflare-r2
SKILL.md
Cloudflare R2
...
Enable and set a custom domain (e.g., assets.example.com).
Objects are accessible at https://assets.example.com/<key>.
