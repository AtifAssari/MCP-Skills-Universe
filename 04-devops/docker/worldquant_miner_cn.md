---
title: worldquant-miner-cn
url: https://skills.sh/site/skills.volces.com/worldquant-miner-cn
---
...
worldquant-miner-cn
$ npx skills add https://skills.volces.com/skills/clawhub/guohongbin-git
SKILL.md
...
注意事项
每日限制 - WorldQuant 每天只能提交一次
相关性测试 - 提交前检查相关性
凭据安全 - 不要提交 credential.txt
资源消耗 - GPU 推理需要显存
相关链接
WorldQuant Brain
worldquant-miner
