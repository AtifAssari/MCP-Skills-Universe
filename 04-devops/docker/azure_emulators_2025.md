---
rating: ⭐⭐⭐
title: azure-emulators-2025
url: https://skills.sh/josiahsiegel/claude-plugin-marketplace/azure-emulators-2025
---

# azure-emulators-2025

skills/josiahsiegel/claude-plugin-marketplace/azure-emulators-2025
azure-emulators-2025
Installation
...
Data Explorer: Access at https://localhost:8081/_explorer/index.html
...
Best Practices
Use health checks - Ensure dependencies are ready before app starts
Network isolation - Keep databases on internal backend network
Resource limits - Prevent emulators from consuming all system resources
Persistence - Use named volumes for data that should survive restarts
Secrets management - Use Docker secrets or environment files
Version pinning - Use specific tags, not latest
Security hardening - Drop capabilities, run as non-root where possible
Documentation - Document differences between emulators and Azure services
Known Limitations
