---
title: compose
url: https://skills.sh/mwguerra/claude-code-plugins/compose
---

# compose

skills/mwguerra/claude-code-plugins/compose
compose
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill compose
SKILL.md
