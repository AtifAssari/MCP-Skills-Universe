...
url: https://skills.sh/pjt222/development-guides/create-dockerfile
---

# create-dockerfile

skills/pjt222/development-guides/create-dockerfile
create-dockerfile
Installation
$ npx skills add https://github.com/pjt222/development-guides --skill create-dockerfile
SKILL.md
Create Dockerfile
