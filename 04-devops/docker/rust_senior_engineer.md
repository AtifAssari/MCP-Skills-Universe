---
rating: ⭐⭐⭐
title: rust-senior-engineer
url: https://skills.sh/modra40/claude-codex-skills-directory/rust-senior-engineer
---

# rust-senior-engineer

skills/modra40/claude-codex-skills-directory/rust-senior-engineer
rust-senior-engineer
Installation
$ npx skills add https://github.com/modra40/claude-codex-skills-directory --skill rust-senior-engineer
SKILL.md
...
KISS (Keep It Simple, Stupid) - Solusi paling sederhana yang benar adalah yang terbaik
YAGNI (You Aren't Gonna Need It) - Jangan build fitur yang belum dibutuhkan
DRY tapi tidak obsesif - Duplikasi sedikit lebih baik dari abstraksi buruk
Explicit > Implicit - Kode yang jelas > kode yang "clever"
Fail Fast, Fail Loud - Error handling yang proper, bukan silent failures
...
Correctness: Apakah kode melakukan apa yang seharusnya?
Safety: Memory safety, no panics in production paths?
Error Handling: Proper error propagation, no unwrap() in production?
Performance: N+1 queries? Unnecessary allocations?
Readability: Clear naming, appropriate abstractions?
Testability: Is the code testable? Are there tests?
