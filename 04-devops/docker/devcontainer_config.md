---
rating: ⭐⭐
title: devcontainer-config
url: https://skills.sh/prulloac/agent-skills/devcontainer-config
---

# devcontainer-config

skills/prulloac/agent-skills/devcontainer-config
devcontainer-config
Installation
$ npx skills add https://github.com/prulloac/agent-skills --skill devcontainer-config
SKILL.md
...
Basic Workflow
Start with template: Copy the appropriate template from assets/
Configure basics: Set name, add features, configure customizations
Add lifecycle scripts: Set postCreateCommand, postStartCommand, etc.
Configure ports: Add forwardPorts and portsAttributes as needed
Validate: Run scripts/validate.py to check for issues
