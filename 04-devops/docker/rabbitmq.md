---
title: rabbitmq
url: https://skills.sh/claude-dev-suite/claude-dev-suite/rabbitmq
---

# rabbitmq

skills/claude-dev-suite/claude-dev-suite/rabbitmq
rabbitmq
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill rabbitmq
SKILL.md
