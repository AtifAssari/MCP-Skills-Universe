---
rating: ⭐⭐
title: actions-and-utilities
url: https://skills.sh/phaserjs/phaser/actions-and-utilities
---

# actions-and-utilities

skills/phaserjs/phaser/actions-and-utilities
actions-and-utilities
Installation
$ npx skills add https://github.com/phaserjs/phaser --skill actions-and-utilities
SKILL.md
...
First argument is always an array of Game Objects (or any objects with the required public properties like x, y, alpha, etc.).
Returns the same array, enabling chaining or pass-through.
Works with Groups by passing group.getChildren().
Actions do NOT store state. They are one-shot batch operations.
