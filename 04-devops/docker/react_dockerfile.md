...
url: https://skills.sh/jkappers/agent-skills/react-dockerfile
---
...
Identify Node.js version from .nvmrc, package.json engines, or use Node 22 LTS
Check for existing nginx configuration files
