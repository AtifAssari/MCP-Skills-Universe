---
rating: ⭐⭐⭐
title: robotics-security
url: https://skills.sh/arpitg1304/robotics-agent-skills/robotics-security
---

# robotics-security

skills/arpitg1304/robotics-agent-skills/robotics-security
robotics-security
Installation
$ npx skills add https://github.com/arpitg1304/robotics-agent-skills --skill robotics-security
SKILL.md
...
SROS2 enabled with Enforce strategy — all nodes use encrypted, authenticated DDS
Per-node enclaves with least-privilege permissions — each node publishes/subscribes only to required topics
