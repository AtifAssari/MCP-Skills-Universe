---
title: activemq
url: https://skills.sh/claude-dev-suite/claude-dev-suite/activemq
---

# activemq

skills/claude-dev-suite/claude-dev-suite/activemq
activemq
Installation
$ npx skills add https://github.com/claude-dev-suite/claude-dev-suite --skill activemq
SKILL.md
