...
url: https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills/docker-compose-creator
---

# docker-compose-creator

skills/jeremylongshore/claude-code-plugins-plus-skills/docker-compose-creator
docker-compose-creator
Installation
$ npx skills add https://github.com/jeremylongshore/claude-code-plugins-plus-skills --skill docker-compose-creator
SKILL.md
Docker Compose Creator
Purpose
