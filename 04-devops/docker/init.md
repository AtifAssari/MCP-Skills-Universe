---
title: init
url: https://skills.sh/mwguerra/claude-code-plugins/init
---

# init

skills/mwguerra/claude-code-plugins/init
init
Installation
$ npx skills add https://github.com/mwguerra/claude-code-plugins --skill init
SKILL.md
