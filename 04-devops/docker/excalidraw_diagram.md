...
url: https://skills.sh/aiagentwithdhruv/skills/excalidraw-diagram
---

# excalidraw-diagram

skills/aiagentwithdhruv/skills/excalidraw-diagram
excalidraw-diagram
Installation
...
Save to [concept-slug].excalidraw in the current directory
Show the full JSON in a code block so the user can copy it directly
...
Work top-to-bottom within sections: next_y = current_y + current_height + gap
