...
url: https://skills.sh/akin-ozer/cc-devops-skills/helm-validator
---

# helm-validator

skills/akin-ozer/cc-devops-skills/helm-validator
helm-validator
Installation
...
quote - Safely quote string values:
env:
  - name: DATABASE_HOST
    value: {{ .Values.database.host | quote }}

include - Use helpers with pipeline:
metadata:
  labels:
...
lookup - Query cluster resources (use carefully):
...
Named templates with custom context:
