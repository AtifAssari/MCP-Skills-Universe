---
rating: ⭐⭐⭐
title: k8s-image-audit
url: https://skills.sh/lobbi-docs/claude/k8s-image-audit
---

# k8s-image-audit

skills/lobbi-docs/claude/k8s-image-audit
k8s-image-audit
Installation
$ npx skills add https://github.com/lobbi-docs/claude --skill k8s-image-audit
SKILL.md
