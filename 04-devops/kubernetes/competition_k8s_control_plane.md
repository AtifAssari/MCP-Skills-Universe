---
rating: ⭐⭐
title: competition-k8s-control-plane
url: https://skills.sh/galiais/ctf-sandbox-orchestrator/competition-k8s-control-plane
---

# competition-k8s-control-plane

skills/galiais/ctf-sandbox-orchestrator/competition-k8s-control-plane
competition-k8s-control-plane
Installation
$ npx skills add https://github.com/galiais/ctf-sandbox-orchestrator --skill competition-k8s-control-plane
SKILL.md
Competition K8s Control Plane
