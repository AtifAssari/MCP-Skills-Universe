---
rating: ⭐⭐⭐
title: learn-docker-k8s-game
url: https://skills.sh/aradotso/trending-skills/learn-docker-k8s-game
---

# learn-docker-k8s-game

skills/aradotso/trending-skills/learn-docker-k8s-game
learn-docker-k8s-game
Installation
$ npx skills add https://github.com/aradotso/trending-skills --skill learn-docker-k8s-game
SKILL.md
Learn Docker & K8s Game
...
"AI isn't staying in character" Remind it: "You are Sarah from NoCappuccino. Read engine/narrator.md and continue the game."
