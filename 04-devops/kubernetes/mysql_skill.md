...
rating: ⭐⭐⭐
title: mysql-skill
url: https://skills.sh/cooloo9871/my-awesome-skill/mysql-skill
---

# mysql-skill

skills/cooloo9871/my-awesome-skill/mysql-skill
mysql-skill
Installation
...
Command: Convert to JPG using: dot -Tjpg input.dot -o output.jpg
...
Generate Secret Manifest: Name mysql-secret. Must include MYSQL_ROOT_PASSWORD AND a .my.cnf key.
.my.cnf Template:
[client]
user=root
...
Generate Headless Service Manifest: Name mysql-headless, Ports 3306 and 9104.
...
Architecture Diagram: Generate mysql-arch.jpg.
Performance Report: Markdown with JPG, K8s manifests, and sysbench results.
...
Prerequisites: Ensure the MySQL pod is running and the mysql-secret is accessible.
Prepare Test Data:
