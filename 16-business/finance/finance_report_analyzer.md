...
url: https://skills.sh/qiujiahong/finance-report-analyzer/finance-report-analyzer
---

# finance-report-analyzer

skills/qiujiahong/finance-report-analyzer/finance-report-analyzer
finance-report-analyzer
Installation
...
Python script → Extract data, build tables/charts, render HTML/PDF (deterministic, zero-cost)
LLM (OpenClaw agent) → Write in-depth analysis for each section + competitor analysis + news summary
Web search → Fetch recent company news and hot topics
Report Sections
#	Section	Source
