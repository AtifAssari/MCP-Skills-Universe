---
title: ifrs-accounting-standards-advisor
url: https://skills.sh/camiloespinoza/ifrs-accounting-standards-advisor/ifrs-accounting-standards-advisor
---

# ifrs-accounting-standards-advisor

skills/camiloespinoza/ifrs-accounting-standards-advisor/ifrs-accounting-standards-advisor
ifrs-accounting-standards-advisor
Installation
...
Identify candidate primary standards
Test scope and scope exclusions
Identify supporting standards (presentation, fair value, impairment, disclosures, etc.)
Consider IFRIC/SIC if directly relevant
Use Conceptual Framework only to support judgment when no specific standard governs (never to override a standard)
...
Disclosure
Transition / comparative implications (if relevant)
Judgments and estimates
Implementation impacts (systems, controls, data, JE mechanics)
