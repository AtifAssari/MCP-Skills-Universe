...
url: https://skills.sh/mike-coulbourn/claude-vibes/platform-optimization
---

# platform-optimization

skills/mike-coulbourn/claude-vibes/platform-optimization
platform-optimization
Installation
$ npx skills add https://github.com/mike-coulbourn/claude-vibes --skill platform-optimization
SKILL.md
...
Key Ranking Factors
Watch time — Primary factor
Likes per reach — Engagement quality
Shares per reach — Especially DM shares from non-followers
What Gets Pushed
...
Spend more time on pre-production than filming
Create "curiosity loops" throughout the video
Focus on Audience Retention graphs
The idea sets the ceiling, execution determines result
