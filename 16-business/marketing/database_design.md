...
url: https://skills.sh/krzysztofsurdy/code-virtuoso/database-design
---

# database-design

skills/krzysztofsurdy/code-virtuoso/database-design
database-design
Installation
...
Always keep the normalized source of truth -- denormalized data is a derived cache
Define how and when the denormalized copy is updated (trigger, application event, batch job)
Monitor for drift between the source and the copy
Document why the denormalization exists and what access pattern it serves
...
Equality conditions first -- columns compared with =
Range conditions last -- columns compared with >, <, BETWEEN
Most selective column first among equals
...
Migrate -- backfill data from old to new, dual-write during transition
