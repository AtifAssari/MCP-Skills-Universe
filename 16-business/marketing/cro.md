---
title: cro
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/cro
---

# cro

skills/indranilbanerjee/digital-marketing-pro/cro
cro
Installation
$ npx skills add https://github.com/indranilbanerjee/digital-marketing-pro --skill cro
SKILL.md
...
Calculate requirements -- Determine sample size needed based on current conversion rate and minimum detectable effect. Estimate test duration based on daily traffic.
...
Analyze and document -- At the end of the test, evaluate statistical significance, check segment-level results, calculate revenue impact, and document learnings regardless of outcome.
Reference Files
