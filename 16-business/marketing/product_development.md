...
url: https://skills.sh/rshankras/claude-code-apple-skills/product-development
---

# product-development

skills/rshankras/claude-code-apple-skills/product-development
product-development
Installation
$ npx skills add https://github.com/rshankras/claude-code-apple-skills --skill product-development
SKILL.md
...
How to Use
Identify where user is in product lifecycle
Read relevant module SKILL.md for detailed process
Generate requested specifications
Save outputs to appropriate files
Example Workflows

User doesn't have an idea yet:

Use idea-generator/ to brainstorm and rank ideas
Pick top idea from shortlist
Run product-agent/ to validate the idea
Continue with market research and specs

User has new app idea:

Use product-agent/ for initial validation
Run market-research/ for market sizing
Run competitive-analysis/ for competitor insights
Generate PRD with prd-generator/

User wants full spec package:

Use implementation-spec/ orchestrator
It coordinates all spec generators
Produces complete documentation set
Weekly Installs
189
Repository
