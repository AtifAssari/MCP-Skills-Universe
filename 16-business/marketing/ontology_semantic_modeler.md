---
title: ontology-semantic-modeler
url: https://skills.sh/sfc-gh-tjia/coco_skill_ontology/ontology-semantic-modeler
---

# ontology-semantic-modeler

skills/sfc-gh-tjia/coco_skill_ontology/ontology-semantic-modeler
ontology-semantic-modeler
Installation
...
OWL file path - Local .owl, .rdf, or .ttl file
Target Snowflake location - DATABASE.SCHEMA where objects will be created
Data source - One or both of:
Snowflake table names (will introspect columns via DESCRIBE TABLE)
Existing semantic model YAML file path
Ontology name - Short identifier (e.g., BIOMED, GENE, PHARMA)
...
If tables were provided, run DESCRIBE TABLE on each to get column metadata
If a semantic model YAML was provided, read it to extract table/column info
