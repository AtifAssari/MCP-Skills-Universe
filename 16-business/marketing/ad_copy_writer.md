...
url: https://skills.sh/eddiebe147/claude-settings/ad-copy-writer
---

# ad copy writer

skills/eddiebe147/claude-settings/Ad Copy Writer
Ad Copy Writer
Installation
$ npx skills add https://github.com/eddiebe147/claude-settings --skill 'Ad Copy Writer'
SKILL.md
Ad Copy Writer
...
Hook Development - Stop the scroll in first 3 seconds
Primary Text - Compelling body copy (125-250 chars visible)
Headline Creation - Benefit-driven, action-oriented
Description Writing - Supporting value proposition
CTA Selection - Match button to campaign goal
Format Adaptation - Feed, Stories, Reels variations
Creative Alignment - Copy that complements visuals
Workflow 2: Google Search Ads
Keyword Integration - Include search terms naturally
Headline Set - 15 headlines for responsive search ads
Description Set - 4 descriptions for rotation
Character Optimization - Max impact in 30/90 char limits
CTA Inclusion - Clear action words
USP Highlighting - Differentiate from competitors
Extension Copy - Sitelinks, callouts, snippets
Workflow 3: LinkedIn Ads
Professional Tone - B2B appropriate messaging
Pain Point Focus - Address business challenges
Credibility Building - Stats, awards, recognition
Single Image Ads - 150 char intro, headline, description
Carousel Copy - Story across multiple cards
Video Ad Scripts - Professional video hooks
Thought Leadership - Document ads, conversation ads
Workflow 4: Ad Creative Testing
Hypothesis Formation - What are you testing and why
Variable Isolation - Test one element at a time
Hook Variations - Multiple opening approaches
Benefit Angles - Different value props
CTA Testing - Various call-to-action options
Emotional vs Logical - Different persuasion styles
Winner Iteration - Build on what works
Quick Reference
