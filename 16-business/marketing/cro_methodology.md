...
url: https://skills.sh/wondelai/skills/cro-methodology
---

# cro-methodology

skills/wondelai/skills/cro-methodology
cro-methodology
Installation
$ npx skills add https://github.com/wondelai/skills --skill cro-methodology
Summary

Scientific, customer-centric approach to conversion rate optimization through research-driven experimentation and objection elimination.

Six core frameworks: the 9-step CRO process, customer research and objection discovery, persuasion asset auditing, the Objection/Counter-Objection (O/CO) table, hypothesis design with ICE scoring, and A/B testing methodology with statistical rigor
Emphasizes discovering why visitors don't convert through exit surveys, chat logs, support tickets, and sales call analysis rather than guessing or copying competitors
Includes quick diagnostic checklist and scoring system (0-10) for auditing landing pages, funnels, and checkout flows against CRE principles
Covers funnel mapping to identify "blocked arteries" (high-traffic underperforming paths), persuasion asset inventory, and bold experimental design based on research evidence, not "meek tweaks"
SKILL.md
CRO Methodology
