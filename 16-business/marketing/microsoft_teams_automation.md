...
url: https://skills.sh/aaaaqwq/claude-code-skills/microsoft-teams-automation
---

# microsoft-teams-automation

skills/aaaaqwq/claude-code-skills/microsoft-teams-automation
microsoft-teams-automation
Installation
$ npx skills add https://github.com/aaaaqwq/claude-code-skills --skill microsoft-teams-automation
SKILL.md
...
Call RUBE_MANAGE_CONNECTIONS with toolkit microsoft_teams
