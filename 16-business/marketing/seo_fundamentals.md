...
url: https://skills.sh/sickn33/antigravity-awesome-skills/seo-fundamentals
---

# seo-fundamentals

skills/sickn33/antigravity-awesome-skills/seo-fundamentals
seo-fundamentals
Installation
...
Technical SEO ensures crawlability, indexability, and accessibility through sitemaps, canonical tags, HTTPS, mobile optimization, and semantic HTML
Content quality depends on depth, originality, accuracy, clarity, and usefulness; AI-assisted content is evaluated on output quality, not authorship method
Structured data enables rich results eligibility but does not directly boost rankings; sustainable SEO prioritizes useful content and trust over tactical shortcuts
SKILL.md
SEO Fundamentals
