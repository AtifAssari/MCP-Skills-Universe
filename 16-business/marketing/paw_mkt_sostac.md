---
title: paw-mkt-sostac
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-sostac
---

# paw-mkt-sostac

skills/pawbytes/skill-suites/paw-mkt-sostac
paw-mkt-sostac
Installation
...
Read ./references/shared-patterns.md for operating patterns.
...
Read ./references/frameworks-index.csv — lightweight index (~40 rows)
Match the situation to the best_for column
...
Quality Scorecard — Load ./references/quality-scorecard.md and score each phase
Cross-Phase Consistency Audit — Verify alignment across all phases
Industry Standard Checklist — Confirm plan meets professional marketing plan standards
Present for Final Approval — Show summary and ask for sign-off or changes
