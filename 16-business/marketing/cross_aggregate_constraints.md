---
rating: ⭐⭐
title: cross-aggregate-constraints
url: https://skills.sh/j5ik2o/okite-ai/cross-aggregate-constraints
---

# cross-aggregate-constraints

skills/j5ik2o/okite-ai/cross-aggregate-constraints
cross-aggregate-constraints
Installation
...
関連スキルとの関係
スキル	関係
aggregate-design	集約内部の設計原則。本スキルは集約間の制約を扱う
aggregate-transaction-boundary	トランザクション境界と結果整合性。本スキルは制約チェックに焦点
cqrs-tradeoffs	結果整合性の概念的トレードオフ。本スキルは実践的な覚悟を扱う
レビューチェックリスト
要件
