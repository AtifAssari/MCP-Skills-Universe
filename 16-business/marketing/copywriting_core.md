---
title: copywriting-core
url: https://skills.sh/manojbajaj95/claude-gtm-plugin/copywriting-core
---

# copywriting-core

skills/manojbajaj95/claude-gtm-plugin/copywriting-core
copywriting-core
Installation
$ npx skills add https://github.com/manojbajaj95/claude-gtm-plugin --skill copywriting-core
SKILL.md
Copywriting Core
Check Context First
...
Creating copy: references/patterns.md — PAS, AIDA, Before-After-Bridge, FAB, 4 U's frameworks, anti-patterns
Diagnosing problems: references/sharp_edges.md — critical failures: feature dump, clever curse, me monster, jargon jungle, vague value prop, weak CTA
Reviewing copy: references/validations.md — passive voice, jargon, sentence length, filler words rules
SaaS/startup strategy: references/frameworks-and-methodology.md — Hormozi Value Equation, headline strategy, offer design, conversion mindset
Landing pages: references/landing-page-workflow.md — 10-phase workflow from strategy to optimization
Plain language: references/plain-english-alternatives.md — A–Z replacements for complex words
