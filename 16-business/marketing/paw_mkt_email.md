---
title: paw-mkt-email
url: https://skills.sh/pawbytes/skill-suites/paw-mkt-email
---

# paw-mkt-email

skills/pawbytes/skill-suites/paw-mkt-email
paw-mkt-email
Installation
$ npx skills add https://github.com/pawbytes/skill-suites --skill paw-mkt-email
SKILL.md
...
Campaign mode: ./.pawbytes/marketing-suites/brands/{brand-slug}/campaigns/{type}-{campaign-slug}/channels/email/content/ Standalone mode: ./.pawbytes/marketing-suites/brands/{brand-slug}/channels/email/content/ Legacy fallback: ./.pawbytes/marketing-suites/brands/{brand-slug}/content/email/ (suggest migration)
