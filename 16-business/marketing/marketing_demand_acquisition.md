...
url: https://skills.sh/davila7/claude-code-templates/marketing-demand-acquisition
---

# marketing-demand-acquisition

skills/davila7/claude-code-templates/marketing-demand-acquisition
marketing-demand-acquisition
Installation
$ npx skills add https://github.com/davila7/claude-code-templates --skill marketing-demand-acquisition
Summary

Demand generation, paid media optimization, SEO strategy, and partnership programs for scaling B2B SaaS.

Multi-channel framework covering LinkedIn, Google Ads, SEO, and partnerships with role-specific KPIs for demand gen, paid media, SEO, and partnerships managers
HubSpot integration for campaign tracking, lead scoring, attribution, and handoff workflows with SQL qualification criteria and SLAs
Paid media playbooks for LinkedIn (ABM targeting, creative frameworks), Google Search (keyword tiers, bid strategies), and Meta Ads with CAC benchmarks and scaling rules
SEO strategy including technical audits, keyword research by funnel stage, on-page optimization templates, and link-building tactics for organic acquisition
Partnership and affiliate program setup with tier definitions, co-marketing playbooks, and HubSpot tracking for partner-sourced pipeline
A/B testing framework using ICE scoring, experimentation templates, and common tests across landing pages, ads, and email
SKILL.md
Marketing Demand & Acquisition
