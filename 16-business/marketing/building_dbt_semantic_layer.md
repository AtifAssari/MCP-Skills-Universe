...
url: https://skills.sh/dbt-labs/dbt-agent-skills/building-dbt-semantic-layer
---

# building-dbt-semantic-layer

skills/dbt-labs/dbt-agent-skills/building-dbt-semantic-layer
building-dbt-semantic-layer
Installation
...
Core 1.12+ or Fusion → Use latest spec guide (no need to ask).
Core 1.6-1.11 → Ask if they want to upgrade to Core 1.12+ for the easier authoring experience. If yes, help upgrade. If no, use legacy spec guide.
...
Read the model SQL and existing YAML config
...
Parse Validation: Run dbt parse (or dbtf parse for Fusion) to confirm YAML syntax and references
