...
url: https://skills.sh/hack23/riksdagsmonitor/economic-policy-analysis
---

# economic-policy-analysis

skills/hack23/riksdagsmonitor/economic-policy-analysis
economic-policy-analysis
Installation
$ npx skills add https://github.com/hack23/riksdagsmonitor --skill economic-policy-analysis
SKILL.md
...
Core Principles
Data-Driven - Base analysis on official statistics and credible forecasts
Policy Focus - Link economic data to political decisions and impacts
Accessible - Explain complex economics clearly for general audience
Distributional - Analyze who wins and loses from policy choices
International Context - Compare Swedish policy to global trends
This Skill Enforces
...
IMF is PRIMARY for all economic context. World Bank is retained only for non-economic residue. Follow the provider decision matrix in analysis/imf/README.md § 2 and the full methodology in analysis/methodologies/imf-indicator-mapping.md v2.0.
