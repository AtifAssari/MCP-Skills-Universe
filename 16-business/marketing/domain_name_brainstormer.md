...
url: https://skills.sh/composiohq/awesome-claude-skills/domain-name-brainstormer
---

# domain-name-brainstormer

skills/composiohq/awesome-claude-skills/domain-name-brainstormer
domain-name-brainstormer
Installation
$ npx skills add https://github.com/composiohq/awesome-claude-skills --skill domain-name-brainstormer
Summary
...
Supports advanced workflows including variation checking, industry-specific naming, and competitor domain pattern analysis
SKILL.md
Domain Name Brainstormer
