...
rating: ⭐⭐
title: anti-render
url: https://skills.sh/lionad-morotar/anti-render-skill/anti-render
---

# anti-render

skills/lionad-morotar/anti-render-skill/anti-render
anti-render
Installation
$ npx skills add https://github.com/lionad-morotar/anti-render-skill --skill anti-render
Summary
...
Works with image-to-prompt and prompt-to-image skills for end-to-end workflow
SKILL.md
...
执行流程
接收图像 → 分析内容，识别所属领域为 $domain，计算图片宽高比为 $ratio
状态判断 → 确定当前状态（破败/普通/理想）
意图识别 → 根据用户指令确定输出模式
