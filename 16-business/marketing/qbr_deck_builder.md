...
url: https://skills.sh/athina-ai/goose-skills/qbr-deck-builder
---

# qbr-deck-builder

skills/athina-ai/goose-skills/qbr-deck-builder
qbr-deck-builder
Installation
$ npx skills add https://github.com/athina-ai/goose-skills --skill qbr-deck-builder
SKILL.md
QBR Deck Builder
...
Phase 0: Intake
Account Context
Customer name — Who is this for?
Primary contact — Name, title of the person you're presenting to
Contract details — Plan, MRR/ARR, contract start, renewal date
Review period — What quarter/timeframe are you reviewing? (e.g., Q1 2026)
QBR goals — What outcome do you want? (Renewal confidence, expansion, executive alignment, feature adoption)
Data Inputs (provide what you have)
Usage data — Key metrics for the review period (logins, feature usage, API calls, active users, etc.)
Support history — Tickets opened, resolved, avg resolution time, any escalations
NPS/CSAT — Scores + verbatim comments from this customer
Milestones achieved — Features launched, integrations completed, goals hit
ROI data — Any measurable outcomes: time saved, revenue impacted, efficiency gains
Customer goals — What did they say they wanted to achieve? (From onboarding or last QBR)
Open issues — Anything unresolved, feature requests, known gaps
Expansion opportunity — New use cases, additional teams, upsell potential
Preferences
Deck length — Quick (8-10 slides) or comprehensive (15-20 slides)?
Tone — Executive summary (high-level) or operational deep-dive (detailed)?
