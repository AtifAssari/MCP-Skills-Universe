---
title: axiom-liquid-glass
url: https://skills.sh/charleswiltgen/axiom/axiom-liquid-glass
---

# axiom-liquid-glass

skills/charleswiltgen/axiom/axiom-liquid-glass
axiom-liquid-glass
Installation
...
Highlights — Light sources produce highlights responding to geometry; some respond to device motion
Shadows — Content-aware: stronger over text, weaker over light backgrounds
Internal Glow — Material illuminates from within on interaction; spreads to nearby glass elements
Adaptive Tinting — Multiple layers adapt together to maintain hierarchy; all built-in automatically
Scroll Edge Effects
