...
url: https://skills.sh/tkersey/dotfiles/creative-problem-solver
---
...
Reframe once using the supported technique for the stage.
Aha Check. If none, run one second and final pass with First Principles.
