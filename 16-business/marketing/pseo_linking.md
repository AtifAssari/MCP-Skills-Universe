---
title: pseo-linking
url: https://skills.sh/lisbeth718/pseo-skills/pseo-linking
---

# pseo-linking

skills/lisbeth718/pseo-skills/pseo-linking
pseo-linking
Installation
...
Core Principles
Hub-and-spoke architecture: Category hubs link to all child pages; child pages link back to their hub
Topical clustering: Pages within the same topic cluster interlink
Every page reachable: No orphan pages — every page is linked from at least 2 other pages
Crawl depth <= 3: Any page reachable within 3 clicks from the homepage
Descriptive anchor text: Link text describes the target page, not generic "click here"
Architecture
Homepage
...
Alphabetically adjacent (fallback)
