---
title: styling
url: https://skills.sh/epicenterhq/epicenter/styling
---

# styling

skills/epicenterhq/epicenter/styling
styling
Installation
...
Prefer plain overflow-y-auto on a div with flex-1 min-h-0 (simpler, always works)
If you need styled scrollbars, wrap ScrollArea.Root in a div with flex-1 min-h-0 overflow-hidden to give it a bounded ancestor
