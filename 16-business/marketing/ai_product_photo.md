...
url: https://skills.sh/anit-1to10x/10x-accountability-coach/ai-product-photo
---

# ai-product-photo

skills/anit-1to10x/10x-accountability-coach/ai-product-photo
ai-product-photo
Installation
$ npx skills add https://github.com/anit-1to10x/10x-accountability-coach --skill ai-product-photo
SKILL.md
AI Product Photo
...
Use this skill when: You need product shots for e-commerce, hero banners, marketing campaigns, or catalogs. Route here from: ai-creative-workflow when product imagery is needed.

Why This Skill Exists

The problem: Most AI product photos fail because they:

Look obviously AI-generated (uncanny details, wrong reflections)
Don't follow commercial photography principles
Miss what makes products sell (features hidden, benefits unclear)
Ignore platform-specific requirements (Amazon vs Instagram vs hero banners)
...
Challenges: Reflective surfaces, screens, small details Opportunities: Premium tech aesthetic, innovation positioning
...
Challenges: Fabric texture, accurate colors, shape/drape Opportunities: Lifestyle aspiration, styling context
...
Challenges: Appetite appeal, freshness, color accuracy Opportunities: Sensory triggers, desire creation
...
Challenges: Color accuracy, texture rendering, premium feel Opportunities: Aspirational beauty, sensory luxury
...
Challenges: Reflections, sparkle, small scale Opportunities: Ultimate luxury positioning
...
Challenges: Scale, context, room integration Opportunities: Lifestyle aspiration, room transformation
...
What Actually Sells
Show the benefit, not just the product — Headphones in use > headphones floating
Lighting creates desire — Dramatic lighting = premium perception
Context triggers imagination — "I could use that here"
Details signal quality — Close-ups show craftsmanship
Consistency builds brand — Same style across all product shots
Common Amateur Mistakes
Flat front lighting — Use directional light for depth
Random backgrounds — Match background to positioning
Product too small — Fill the frame (especially e-commerce)
Competing props — Props enhance, never distract
Inconsistent style — Build a system, not one-offs
The 80/20 of Product Photography

80% of results come from:

Specific product description in prompt
Appropriate lighting direction/type
Background that supports positioning
Platform-correct composition
