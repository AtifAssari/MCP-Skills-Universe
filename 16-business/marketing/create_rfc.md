---
title: create-rfc
url: https://skills.sh/tech-leads-club/agent-skills/create-rfc
---

# create-rfc

skills/tech-leads-club/agent-skills/create-rfc
create-rfc
Installation
$ npx skills add https://github.com/tech-leads-club/agent-skills --skill create-rfc
SKILL.md
RFC Creator
...
Relevant Data — metrics, research, evidence
Pros and Cons (per option)
Estimated Cost (effort/complexity/monetary)
Resources — links, references, prior art
Section Templates
