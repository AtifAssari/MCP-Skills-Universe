...
url: https://skills.sh/sgcarstrends/sgcarstrends/design-language-system
---

# design-language-system

skills/sgcarstrends/sgcarstrends/design-language-system
design-language-system
Installation
...
CSS variables (var(--chart-1), var(--primary))
HeroUI semantic classes (text-foreground, bg-primary, text-default-500)
Tailwind colour classes mapped to CSS variables (text-primary, bg-muted)
