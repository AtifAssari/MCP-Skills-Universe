...
url: https://skills.sh/secondsky/claude-skills/seo-keyword-cluster-builder
---

# seo-keyword-cluster-builder

skills/secondsky/claude-skills/seo-keyword-cluster-builder
seo-keyword-cluster-builder
Installation
$ npx skills add https://github.com/secondsky/claude-skills --skill seo-keyword-cluster-builder
SKILL.md
SEO Keyword Cluster Builder
Overview
...
Understand context and goals: Clarify user's industry, target audience, and objectives
Generate comprehensive output: Create detailed cluster analysis with practical structure
Provide actionable recommendations: Include specific next steps and priorities
Include examples and templates: Show real-world applications and copy-paste formats
Suggest next steps: Outline content calendar and implementation timeline
Core Concepts
Topic Clusters
...
Topic similarity: Semantic relationships
User journey stage: Awareness, consideration, decision
Content type: How-to, comparison, definition, list
Clustering Process
...
Create pillar page for Cluster 1
Write top 3 cluster articles (highest volume keywords)
Implement internal linking structure
Phase 2: Expansion (Months 3-4)
Add remaining Cluster 1 articles
Create pillar page for Cluster 2
Write Cluster 2 core articles
Phase 3: Depth (Months 5-6)
Add supporting content for both clusters
Create comparison/versus articles
...
Analyze keywords → Identify themes
Group by similarity → Create 3-4 main clusters
Recommend structure → Pillar + cluster content
Suggest titles → SEO-optimized content titles
Plan linking → Internal link strategy
Prioritize → Content creation roadmap
Provide template → Formatted output ready to use
Philosophy
