...
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/budget-optimizer
---

# budget-optimizer

skills/indranilbanerjee/digital-marketing-pro/budget-optimizer
budget-optimizer
Installation
...
Run budget-optimizer.py script: Execute scripts/budget-optimizer.py with the provided channel data to compute baseline efficiency metrics and generate optimization scenarios
