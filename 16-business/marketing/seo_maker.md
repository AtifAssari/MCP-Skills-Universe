...
rating: ⭐⭐⭐
title: seo-maker
url: https://skills.sh/alpoxdev/hypercore/seo-maker
---

# seo-maker

skills/alpoxdev/hypercore/seo-maker
seo-maker
Installation
...
Gather evidence and write/update results.json.
Generate results.js for direct local browser viewing.
Render dashboard.html from the current results.
Write report.md and sources.md with links or file references.
