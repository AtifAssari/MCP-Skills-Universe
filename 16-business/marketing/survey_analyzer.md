...
url: https://skills.sh/jmsktm/claude-settings/survey-analyzer
---

# survey analyzer

skills/jmsktm/claude-settings/Survey Analyzer
Survey Analyzer
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Survey Analyzer'
SKILL.md
Survey Analyzer
