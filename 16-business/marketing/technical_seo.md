---
title: technical-seo
url: https://skills.sh/indranilbanerjee/digital-marketing-pro/technical-seo
---

# technical-seo

skills/indranilbanerjee/digital-marketing-pro/technical-seo
technical-seo
Installation
$ npx skills add https://github.com/indranilbanerjee/digital-marketing-pro --skill technical-seo
SKILL.md
Technical SEO
...
Website URL: The domain to audit or optimize
CMS / Platform: WordPress, Shopify, Webflow, custom, headless, etc. — determines implementation paths
Hosting Environment: Shared, VPS, dedicated, cloud (AWS/GCP/Azure), CDN provider — affects server-side recommendations
Current Performance Data: Google Search Console access, PageSpeed Insights scores, CrUX data, or existing audit reports
Site Scale: Approximate page count (hundreds, thousands, hundreds of thousands) — determines crawl budget relevance
Rendering Method: Static HTML, server-side rendered, client-side rendered (React/Angular/Vue), hybrid (Next.js/Nuxt) — critical for JavaScript SEO
International Presence: Target countries and languages, current URL structure for international versions
Known Issues: Existing problems the user is aware of (crawl errors, indexation drops, speed complaints, ranking losses)
Migration Plans: Any upcoming domain changes, platform migrations, or URL restructuring
Tech Stack Constraints: Development team availability, deployment processes, CDN limitations, plugin/extension restrictions
