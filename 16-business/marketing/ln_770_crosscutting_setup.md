---
rating: ⭐⭐⭐
title: ln-770-crosscutting-setup
url: https://skills.sh/levnikolaevich/claude-code-skills/ln-770-crosscutting-setup
---

# ln-770-crosscutting-setup

skills/levnikolaevich/claude-code-skills/ln-770-crosscutting-setup
ln-770-crosscutting-setup
Installation
...
If not found, Glob for pyproject.toml or requirements.txt
If Python, check for FastAPI in dependencies
...
Mark configured concerns as skip: true
Update Context Store with findings
