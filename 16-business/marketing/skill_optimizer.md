...
url: https://skills.sh/chujianyun/skills/skill-optimizer
---

# skill-optimizer

skills/chujianyun/skills/skill-optimizer
skill-optimizer
Installation
$ npx skills add https://github.com/chujianyun/skills --skill skill-optimizer
SKILL.md
Skill Optimizer
...
先修敏感信息泄露、敏感操作失控、触发失败、确认缺失、流程不可执行的问题
再修异常处理缺失、依赖不可安装、结构臃肿、重复内容、资源组织混乱的问题
最后处理粒度微调、README/索引补充、措辞润色、示例补充、可读性增强
Weekly Installs
54
Repository
chujianyun/skills
