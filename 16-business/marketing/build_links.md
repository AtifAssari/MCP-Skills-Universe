...
rating: ⭐⭐
title: build-links
url: https://skills.sh/calm-north/seojuice-skills/build-links
---

# build-links

skills/calm-north/seojuice-skills/build-links
build-links
Installation
$ npx skills add https://github.com/calm-north/seojuice-skills --skill build-links
Summary

Design and execute a targeted link acquisition campaign with prospect scoring and outreach strategy.
...
Score each link prospect using a six-factor Link Quality Score (domain authority, topical relevance, traffic, position, anchor text, follow status) to focus outreach on high-value opportunities
Personalize outreach with specific hooks and value propositions; expect 5-15% response rates and 1-5 links per 100 emails from cold outreach
SKILL.md
Build Links
