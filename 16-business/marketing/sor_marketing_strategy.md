---
title: sor-marketing-strategy
url: https://skills.sh/timlai666/skills/sor-marketing-strategy
---

# sor-marketing-strategy

skills/timlai666/skills/sor-marketing-strategy
sor-marketing-strategy
Installation
$ npx skills add https://github.com/timlai666/skills --skill sor-marketing-strategy
SKILL.md
S-O-R 行銷策略
Overview
...
Workflow
先讀 01-sor-foundation-and-research.md 校準模型邏輯與研究邊界。
依 02-stimulus-design-playbook.md 盤點現有刺激與缺口。
依 03-organism-psychology-map.md 判讀心理機制與風險。
依 04-response-metrics-and-experiments.md 連到 KPI、tracking 與實驗。
需要場景化輸出時，套用 05-use-cases-and-prompts.md。
需要快速填表時，使用 sor-strategy-template.md。
Suggested Prompts
