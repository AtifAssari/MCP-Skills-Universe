...
url: https://skills.sh/petekp/claude-code-setup/stress-testing
---

# stress-testing

skills/petekp/claude-code-setup/stress-testing
stress-testing
Installation
$ npx skills add https://github.com/petekp/claude-code-setup --skill stress-testing
SKILL.md
Stress Testing
