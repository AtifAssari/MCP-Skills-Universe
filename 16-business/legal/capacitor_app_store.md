---
rating: ⭐⭐⭐
title: capacitor-app-store
url: https://skills.sh/cap-go/capgo-skills/capacitor-app-store
---

# capacitor-app-store

skills/cap-go/capgo-skills/capacitor-app-store
capacitor-app-store
Installation
$ npx skills add https://github.com/cap-go/capgo-skills --skill capacitor-app-store
SKILL.md
