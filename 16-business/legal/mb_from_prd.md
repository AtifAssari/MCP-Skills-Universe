---
title: mb-from-prd
url: https://skills.sh/mrvladd-d/memobank/mb-from-prd
---

# mb-from-prd

skills/mrvladd-d/memobank/mb-from-prd
mb-from-prd
Installation
...
Seed .memory-bank/tasks/backlog.md with a short structure (waves + placeholders).
