---
title: doc-bdd-autopilot
url: https://skills.sh/vladm3105/aidoc-flow-framework/doc-bdd-autopilot
---

# doc-bdd-autopilot

skills/vladm3105/aidoc-flow-framework/doc-bdd-autopilot
doc-bdd-autopilot
Installation
$ npx skills add https://github.com/vladm3105/aidoc-flow-framework --skill doc-bdd-autopilot
SKILL.md
doc-bdd-autopilot
Purpose
...
Set document_type in generated document:
...
Validation: Generated documents MUST indicate document_type: bdd-document
...
Skill Delegation: This phase uses validation rules from doc-ears-validator skill. See: .claude/skills/doc-ears-validator/SKILL.md for complete EARS validation rules.
...
Skill Delegation: This phase follows rules defined in doc-bdd skill. See: .claude/skills/doc-bdd/SKILL.md for complete BDD creation guidance.
...
Generate Index File (BDD-NN.0_index.md):
...
Generate Feature Files by Section:
...
Add Cumulative Traceability Tags:
...
Skill Delegation: This phase uses validation rules from doc-bdd-validator skill. See: .claude/skills/doc-bdd-validator/SKILL.md for complete validation rules.
...
ADR-Ready Report (with Visual Indicators):
...
Format: WITHIN @threshold:PRD.NN.category.field
