...
url: https://skills.sh/hack23/riksdagsmonitor/osint-methodologies
---

# osint-methodologies

skills/hack23/riksdagsmonitor/osint-methodologies
osint-methodologies
Installation
...
Voting Records (vote_data table)
...
Documents (document_element, document_status_container)
...
Politicians (person_data, assignment_data)
...
Intelligence Data Flow: INTELLIGENCE_DATA_FLOW.md
Data Analysis Frameworks: DATA_ANALYSIS_INTOP_OSINT.md
