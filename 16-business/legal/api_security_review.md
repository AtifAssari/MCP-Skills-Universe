...
url: https://skills.sh/thomast1906/github-copilot-agent-skills/api-security-review
---

# api-security-review

skills/thomast1906/github-copilot-agent-skills/api-security-review
api-security-review
Installation
...
Front Door origin type = Private Link (not Custom or Public)
Private Link target = APIM resource ID
Private Link status = Approved (not Pending)
APIM has no public DNS record resolving to public IP
...
Update Front Door origin to use Private Link (not public IP)
Verify no public DNS resolution: nslookup apim-api-marketplace-prod-uks.azure-api.net should return internal IP only
