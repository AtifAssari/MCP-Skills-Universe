...
url: https://skills.sh/mastepanoski/claude-skills/wcag-accessibility-audit
---

# wcag-accessibility-audit

skills/mastepanoski/claude-skills/wcag-accessibility-audit
wcag-accessibility-audit
Installation
...
Add alt text - 1.1.1 (A) - 1-2 days
Fix color contrast - 1.4.3 (AA) - 4-8 hours
Add focus indicators - 2.4.7 (AA) - 2-4 hours
Add page titles - 2.4.2 (A) - 1-2 hours
Add lang attribute - 3.1.1 (A) - 30 minutes
Add form labels - 3.3.2 (A) - 4-8 hours
Fix HTML validation errors - 4.1.1 (A) - 2-4 hours
Best Practices
Test with real users: People with disabilities provide insights automation misses
Start early: Build accessibility in, don't bolt on later
Educate team: Accessibility is everyone's responsibility
Use semantic HTML: Proper HTML is 80% of accessibility
Test with keyboard: If it works with keyboard, it usually works with assistive tech
Don't rely on color alone: Use icons, patterns, text
Provide alternatives: Captions, transcripts, text descriptions
Keep it simple: Complex interfaces are harder to make accessible
Stay updated: WCAG evolves (2.0 → 2.1 → 2.2 → 3.0 coming)
Legal compliance ≠ great UX: Aim higher than minimum standards
