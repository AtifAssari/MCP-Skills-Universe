---
title: vite-expert
url: https://skills.sh/cin12211/orca-q/vite-expert
---

# vite-expert

skills/cin12211/orca-q/vite-expert
vite-expert
Installation
...
Force include problematic packages: Add to optimizeDeps.include
Exclude heavy packages: Use optimizeDeps.exclude for large libraries
...
Configure HMR accept handlers: Add import.meta.hot.accept()
Fix circular dependencies: Refactor module structure
Enable warmup: Configure server.warmup.clientFiles
...
Implement code splitting: Use dynamic imports import()
Configure manual chunks: Optimize build.rollupOptions.output.manualChunks
...
Configure path aliases: Set up resolve.alias mapping
Add file extensions: Include in resolve.extensions
...
Handle client-only code: Use import.meta.env.SSR guards
External server dependencies: Configure external in server build
...
Symptoms: process.env undefined, environment variables not available in client Diagnosis:
...
Use VITE_ prefix: Rename env vars to start with VITE_
Use import.meta.env: Replace process.env with import.meta.env
Configure define: Add custom variables to define config
