...
url: https://skills.sh/haroutkhac/code-comprehension-quiz/code-comprehension-quiz
---

# code-comprehension-quiz

skills/haroutkhac/code-comprehension-quiz/code-comprehension-quiz
code-comprehension-quiz
Installation
$ npx skills add https://github.com/haroutkhac/code-comprehension-quiz --skill code-comprehension-quiz
SKILL.md
Code Comprehension Quiz
...
Tradeoff analysis - "What's the downside of this approach?"
Failure modes - "When/how would this break?"
Alternative reasoning - "Why wasn't [other approach] used?"
Implication chains - "What else needs to change as a result?"
Root cause - "What was the underlying issue this solved?"
...
Write the stem (question) first
Write the correct answer
Write 2-3 distractors that match the correct answer in length, grammar, and style
Ensure each question targets a different concept from the most recent work
Stem Guidelines
...
Show score: "You got X/N correct"
...
Offer recap or deeper dive: Ask whether the user wants a short recap or a deeper dive. If score < 80%, recommend a deeper dive.
