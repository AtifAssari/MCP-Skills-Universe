...
url: https://skills.sh/hieutrtr/ai1-skills/fastapi-patterns
---

# fastapi-patterns

skills/hieutrtr/ai1-skills/fastapi-patterns
fastapi-patterns
Installation
...
Query parameter: ws://host/ws?token=xxx (simplest, token visible in logs)
First message: Connect, then send token as first message (more secure)
