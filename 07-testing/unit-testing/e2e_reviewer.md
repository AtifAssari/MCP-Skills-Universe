---
title: e2e-reviewer
url: https://skills.sh/dididy/e2e-skills/e2e-reviewer
---

# e2e-reviewer

skills/dididy/e2e-skills/e2e-reviewer
e2e-reviewer
Installation
$ npx skills add https://github.com/dididy/e2e-skills --skill e2e-reviewer
SKILL.md
...
Check if any POM class has zero members beyond what it inherits — empty wrappers add no value unless the convention is intentional
