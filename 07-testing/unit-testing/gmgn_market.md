...
rating: ⭐⭐⭐
title: gmgn-market
url: https://skills.sh/gmgnai/gmgn-skills/gmgn-market
---

# gmgn-market

skills/gmgnai/gmgn-skills/gmgn-market
gmgn-market
Installation
...
Full workflow for discovering market opportunities: docs/workflow-market-opportunities.md
...
When results contain interesting tokens, proceed to full token due diligence: docs/workflow-token-research.md

For new / launchpad tokens (market trenches): apply the structured early project screening workflow that includes security check and smart money entry detection — docs/workflow-early-project-screening.md

For a daily market overview (user asks "what's the market like today", "give me a daily brief", "what is smart money buying today"): combine market trending + market trenches with gmgn-track smartmoney — docs/workflow-daily-brief.md
...
For full due diligence on any token surfaced here: docs/workflow-token-research.md
