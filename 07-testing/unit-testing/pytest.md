...
rating: ⭐⭐⭐
title: pytest
url: https://skills.sh/manutej/luxor-claude-marketplace/pytest
---

# pytest

skills/manutej/luxor-claude-marketplace/pytest
pytest
Installation
...
External Integrations: Email services (SendGrid, AWS SES), CRM systems (Salesforce, HubSpot), payment processors
Async Operations: Background jobs, email queues, notification services, webhook deliveries
Data Validation: Strict validation for customer PII, ticket priorities, SLA requirements, escalation rules
Multi-tenancy: Isolation between different customer organizations or workspaces
API-First Design: RESTful APIs requiring comprehensive endpoint coverage
...
Troubleshooting
Common Issues
Import errors: Ensure PYTHONPATH includes project root or use pip install -e .
Fixture not found: Check conftest.py location and fixture name spelling
