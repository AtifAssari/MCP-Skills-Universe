...
rating: ⭐⭐
title: vitest-v4
url: https://skills.sh/nodnarbnitram/claude-code-extensions/vitest-v4
---

# vitest-v4

skills/nodnarbnitram/claude-code-extensions/vitest-v4
vitest-v4
Installation
...
Hanging agent runs from using watch mode instead of vitest run
Broken coverage configs from using removed coverage.all or coverage.extensions
...
Invalid multi-project setup from using deprecated workspace terminology
Wrong APIs from mixing Jest helpers into Vitest tests
Flaky browser interactions from using synthetic helpers instead of vitest/browser
