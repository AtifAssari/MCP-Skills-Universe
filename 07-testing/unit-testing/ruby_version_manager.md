...
url: https://skills.sh/st0012/ruby-skills/ruby-version-manager
---

# ruby-version-manager

skills/st0012/ruby-skills/ruby-version-manager
ruby-version-manager
Installation
...
Check VERSION_AVAILABLE - install if false
Verify manager installation at VERSION_MANAGER_PATH
chruby: Check ~/.rubies or /opt/rubies for installations
rvm: Check both ~/.rvm and /usr/local/rvm
Weekly Installs
9
Repository
st0012/ruby-skills
