---
title: testing
url: https://skills.sh/cloudflare/sandbox-sdk/testing
---

# testing

skills/cloudflare/sandbox-sdk/testing
testing
Installation
...
npm run check - catch type errors first
npm test - verify unit tests pass
npm run test:e2e - if touching core functionality
