...
url: https://skills.sh/jmsktm/claude-settings/test-generator
---

# test generator

skills/jmsktm/claude-settings/Test Generator
Test Generator
Installation
$ npx skills add https://github.com/jmsktm/claude-settings --skill 'Test Generator'
SKILL.md
Test Generator
