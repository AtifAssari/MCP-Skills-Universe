---
rating: ⭐⭐⭐
title: solidity-deploy
url: https://skills.sh/0xlayerghost/solidity-agent-kit/solidity-deploy
---

# solidity-deploy

skills/0xlayerghost/solidity-agent-kit/solidity-deploy
solidity-deploy
Installation
...
Update addresses in config/*.json and deployments/latest.env
Test critical functions: cast call to verify on-chain state is correct
Record changes in docs/CHANGELOG.md
Submit PR with deployment transaction hash link
If verification needed, run forge verify-contract separately
Key Security Rule
